...
def create_custom_group():
    ...
    group_doc_lines = [
        f"SHORT  Custom group to extract MFLOP/s, Memory bandwidth in MBytes/s and Operational Intensity in FLOP/Byte for {architecture} architecture\n",
        "\n",
        "EVENTSET\n",
    ...
    group_doc_lines += [
        flop_long_line + "\n",
        memory_long_line + '\n',
        memory_long_line.replace("Memory write bandwidth [MBytes/s]", "Memory write data volume [GBytes]")[:-5] + '\n',
