...
ACCESS_RIGHTS = {
    ...
    "global_manage_third_parties": {
        ...
        # TODO : Donner le droit par défaut aux EA (l'ajouter au groupe par défaut pour les comptes 'equipe_appui' via migration)
        # TODO : Créer un rôle 'manager' dans les PREDEFINED_GROUPS pour s'assurer de son existance (voir les droits associés)
    },
