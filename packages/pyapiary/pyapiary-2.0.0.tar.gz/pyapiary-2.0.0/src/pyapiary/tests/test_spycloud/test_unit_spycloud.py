...
from pyapiary.api_connectors.spycloud import SpycloudConnector
...
@patch("pyapiary.api_connectors.broker.combine_env_configs", return_value={})
...
@patch("pyapiary.api_connectors.spycloud.SpycloudConnector._make_request")
