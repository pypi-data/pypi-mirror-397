...
from pyapiary.api_connectors.twilio import AsyncTwilioConnector
...
@patch("pyapiary.api_connectors.twilio.AsyncTwilioConnector._make_request", new_callable=AsyncMock)
@pytest.mark.asyncio
