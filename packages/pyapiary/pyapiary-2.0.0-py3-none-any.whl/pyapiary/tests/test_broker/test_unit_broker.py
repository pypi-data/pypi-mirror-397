import pytest
from pyapiary.api_connectors.broker import Broker
...
def test_logging_enabled_logs_message(mocker):
    ...
    mock_setup_logger = mocker.patch("pyapiary.api_connectors.broker.setup_logger", return_value=mock_logger)
...
def test_env_only_proxy_from_dotenv(monkeypatch, mocker):
    ...
    mock_combine = mocker.patch(
        "pyapiary.api_connectors.broker.combine_env_configs",
