...
class InferTypeOpInterface:
    ...
    def inferReturnTypes(self, operands: list | None = None, attributes: Attribute | None = None, properties: types.CapsuleType | None = None, regions: Sequence[Region] | None = None, context: Context | None = None, loc: Location | None = None) -> list[Type]:
        """
...
class InferShapedTypeOpInterface:
    ...
    def inferReturnTypeComponents(self, operands: list | None = None, attributes: Attribute | None = None, regions: types.CapsuleType | None = None, properties: Sequence[Region] | None = None, context: Context | None = None, loc: Location | None = None) -> list[ShapedTypeComponents]:
        """
        Given the arguments required to build an operation, attempts to infer
