...
class BarrierInitOp(_ods_ir.OpView):
  ...
  def __init__(self, ptr, id, *, loc=None, ip=None):
    operands = []
    attributes = {}
    regions = None
    operands.append(ptr)
...
def s_barrier_init(ptr, id, *, loc=None, ip=None) -> BarrierInitOp:
  return BarrierInitOp(ptr=ptr, id=id, loc=loc, ip=ip)
...
def s_barrier_signal_var(ptr, id, *, loc=None, ip=None) -> BarrierSignalVarOp:
  return BarrierSignalVarOp(ptr=ptr, id=id, loc=loc, ip=ip)
...
class TensorLoadToLDSD2Op(_ods_ir.OpView):
  ...
  @builtins.property
  def dgroup0(self) -> _ods_ir.Value:
    return self.operation.operands[0]

  @builtins.property
  def dgroup1(self) -> _ods_ir.Value:
    return self.operation.operands[1]
...
class TensorLoadToLDSOp(_ods_ir.OpView):
  ...
  @builtins.property
  def dgroup2(self) -> _ods_ir.Value:
    return self.operation.operands[2]

  @builtins.property
  def dgroup3(self) -> _ods_ir.Value:
    return self.operation.operands[3]
...
def wmma_bf16_16x16x32_bf16_(res, args, *, loc=None, ip=None) -> _ods_ir.OpResult:
  return wmma_bf16_16x16x32_bf16(res=res, args=args, loc=loc, ip=ip).result
...
def wmma_bf16f32_16x16x32_bf16_(res, args, *, loc=None, ip=None) -> _ods_ir.OpResult:
  return wmma_bf16f32_16x16x32_bf16(res=res, args=args, loc=loc, ip=ip).result
...
def wmma_f16_16x16x32_f16_(res, args, *, loc=None, ip=None) -> _ods_ir.OpResult:
  return wmma_f16_16x16x32_f16(res=res, args=args, loc=loc, ip=ip).result
...
def wmma_f16_16x16x64_bf8_bf8_(res, args, *, loc=None, ip=None) -> _ods_ir.OpResult:
  return wmma_f16_16x16x64_bf8_bf8(res=res, args=args, loc=loc, ip=ip).result
...
def wmma_f16_16x16x64_bf8_fp8_(res, args, *, loc=None, ip=None) -> _ods_ir.OpResult:
  return wmma_f16_16x16x64_bf8_fp8(res=res, args=args, loc=loc, ip=ip).result
...
def wmma_f16_16x16x64_fp8_bf8_(res, args, *, loc=None, ip=None) -> _ods_ir.OpResult:
  return wmma_f16_16x16x64_fp8_bf8(res=res, args=args, loc=loc, ip=ip).result
...
def wmma_f16_16x16x64_fp8_fp8_(res, args, *, loc=None, ip=None) -> _ods_ir.OpResult:
  return wmma_f16_16x16x64_fp8_fp8(res=res, args=args, loc=loc, ip=ip).result
...
def wmma_f16_16x16x128_bf8_bf8_(res, args, *, loc=None, ip=None) -> _ods_ir.OpResult:
  return wmma_f16_16x16x128_bf8_bf8(res=res, args=args, loc=loc, ip=ip).result
...
def wmma_f16_16x16x128_bf8_fp8_(res, args, *, loc=None, ip=None) -> _ods_ir.OpResult:
  return wmma_f16_16x16x128_bf8_fp8(res=res, args=args, loc=loc, ip=ip).result
...
def wmma_f16_16x16x128_fp8_bf8_(res, args, *, loc=None, ip=None) -> _ods_ir.OpResult:
  return wmma_f16_16x16x128_fp8_bf8(res=res, args=args, loc=loc, ip=ip).result
...
def wmma_f16_16x16x128_fp8_fp8_(res, args, *, loc=None, ip=None) -> _ods_ir.OpResult:
  return wmma_f16_16x16x128_fp8_fp8(res=res, args=args, loc=loc, ip=ip).result
...
def wmma_f32_16x16x4_f32_(res, args, *, loc=None, ip=None) -> _ods_ir.OpResult:
  return wmma_f32_16x16x4_f32(res=res, args=args, loc=loc, ip=ip).result
...
def wmma_f32_16x16x32_bf16_(res, args, *, loc=None, ip=None) -> _ods_ir.OpResult:
  return wmma_f32_16x16x32_bf16(res=res, args=args, loc=loc, ip=ip).result
...
def wmma_f32_16x16x32_f16_(res, args, *, loc=None, ip=None) -> _ods_ir.OpResult:
  return wmma_f32_16x16x32_f16(res=res, args=args, loc=loc, ip=ip).result
...
def wmma_f32_16x16x64_bf8_bf8_(res, args, *, loc=None, ip=None) -> _ods_ir.OpResult:
  return wmma_f32_16x16x64_bf8_bf8(res=res, args=args, loc=loc, ip=ip).result
...
def wmma_f32_16x16x64_bf8_fp8_(res, args, *, loc=None, ip=None) -> _ods_ir.OpResult:
  return wmma_f32_16x16x64_bf8_fp8(res=res, args=args, loc=loc, ip=ip).result
...
def wmma_f32_16x16x64_fp8_bf8_(res, args, *, loc=None, ip=None) -> _ods_ir.OpResult:
  return wmma_f32_16x16x64_fp8_bf8(res=res, args=args, loc=loc, ip=ip).result
...
def wmma_f32_16x16x64_fp8_fp8_(res, args, *, loc=None, ip=None) -> _ods_ir.OpResult:
  return wmma_f32_16x16x64_fp8_fp8(res=res, args=args, loc=loc, ip=ip).result
...
def wmma_f32_16x16x128_bf8_bf8_(res, args, *, loc=None, ip=None) -> _ods_ir.OpResult:
  return wmma_f32_16x16x128_bf8_bf8(res=res, args=args, loc=loc, ip=ip).result
...
def wmma_f32_16x16x128_bf8_fp8_(res, args, *, loc=None, ip=None) -> _ods_ir.OpResult:
  return wmma_f32_16x16x128_bf8_fp8(res=res, args=args, loc=loc, ip=ip).result
...
def wmma_f32_16x16x128_fp8_bf8_(res, args, *, loc=None, ip=None) -> _ods_ir.OpResult:
  return wmma_f32_16x16x128_fp8_bf8(res=res, args=args, loc=loc, ip=ip).result
...
def wmma_f32_16x16x128_fp8_fp8_(res, args, *, loc=None, ip=None) -> _ods_ir.OpResult:
  return wmma_f32_16x16x128_fp8_fp8(res=res, args=args, loc=loc, ip=ip).result
...
def wmma_i32_16x16x64_iu8_(res, args, *, loc=None, ip=None) -> _ods_ir.OpResult:
  return wmma_i32_16x16x64_iu8(res=res, args=args, loc=loc, ip=ip).result
