  ...
  def __init__(self, old, src, kind, *, permArgument=None, row_mask=None, bank_mask=None, bound_ctrl=None, results=None, loc=None, ip=None):
    ...
    if permArgument is not None: attributes["permArgument"] = (permArgument if (
        ...
        not _ods_ir.AttrBuilder.contains('anonymous_651')) else
          _ods_ir.AttrBuilder.get('anonymous_651')(permArgument, context=_ods_context))
...
@_ods_cext.register_operation(_Dialect)
class ScaledExtPacked816Op(_ods_ir.OpView):
  r"""
...
def scaled_ext_packed816(res, source, scale, block_size, first_scale_lane, first_scale_byte, *, loc=None, ip=None) -> _ods_ir.OpResult:
  return ScaledExtPacked816Op(res=res, source=source, scale=scale, blockSize=block_size, firstScaleLane=first_scale_lane, firstScaleByte=first_scale_byte, loc=loc, ip=ip).result
