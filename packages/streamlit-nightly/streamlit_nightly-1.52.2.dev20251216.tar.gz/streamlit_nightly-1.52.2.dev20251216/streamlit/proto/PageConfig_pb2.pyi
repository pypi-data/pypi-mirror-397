...
class PageConfig(google.protobuf.message.Message):
    ...
    class SidebarWidthConfig(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["pixel_width", b"pixel_width", "width_spec", b"width_spec"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["pixel_width", b"pixel_width", "width_spec", b"width_spec"]) -> None: ...
        def WhichOneof(self, oneof_group: typing.Literal["width_spec", b"width_spec"]) -> typing.Literal["pixel_width"] | None: ...
    ...
    def HasField(self, field_name: typing.Literal["_initial_sidebar_width", b"_initial_sidebar_width", "initial_sidebar_width", b"initial_sidebar_width", "menu_items", b"menu_items"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_initial_sidebar_width", b"_initial_sidebar_width", "favicon", b"favicon", "initial_sidebar_state", b"initial_sidebar_state", "initial_sidebar_width", b"initial_sidebar_width", "layout", b"layout", "menu_items", b"menu_items", "title", b"title"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["_initial_sidebar_width", b"_initial_sidebar_width"]) -> typing.Literal["initial_sidebar_width"] | None: ...
