...
class PageLink(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["_use_container_width", b"_use_container_width", "disabled", b"disabled", "external", b"external", "help", b"help", "icon", b"icon", "icon_position", b"icon_position", "label", b"label", "page", b"page", "page_script_hash", b"page_script_hash", "query_string", b"query_string", "use_container_width", b"use_container_width"]) -> None: ...
