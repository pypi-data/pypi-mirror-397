...
class Metric(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["body", b"body", "chart_data", b"chart_data", "chart_type", b"chart_type", "color", b"color", "delta", b"delta", "direction", b"direction", "format", b"format", "help", b"help", "label", b"label", "label_visibility", b"label_visibility", "show_border", b"show_border"]) -> None: ...
