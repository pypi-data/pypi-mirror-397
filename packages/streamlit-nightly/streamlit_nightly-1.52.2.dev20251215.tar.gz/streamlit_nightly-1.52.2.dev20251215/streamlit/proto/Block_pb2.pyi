...
class Block(google.protobuf.message.Message):
    ...
    class Dialog(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["_is_open", b"_is_open", "dismissible", b"dismissible", "icon", b"icon", "id", b"id", "is_open", b"is_open", "title", b"title", "width", b"width"]) -> None: ...
