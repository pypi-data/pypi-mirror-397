...
try:
    ...
    print("[WARNING]  Alembic not installed. Run: pip install alembic")
...
class AlembicMigrationManager:
    ...
    def init_migrations(self) -> bool:
        ...
        Returns:
            True if successful
        """
        print("[INIT] Initializing CREATESONLINE migrations...")
        
        try:
            # Check if already initialized
            if self.migrations_dir.exists():
                print(f"[WARNING]  Migrations directory already exists: {self.migrations_dir}")
                return False
            ...
            print(f"\n[OK] Migrations initialized successfully!")
            print(f"[DIR] Migrations: {self.migrations_dir}")
            print(f"[CONFIG]  Config: {self.alembic_ini}")
            print(f"[INIT] Commands: manage.py")
            print("\n[NOTE] Next steps:")
            ...
            print(f"\n[ERROR] Error initializing migrations:")
            import traceback
            traceback.print_exc()
            return False
    ...
    def create_migration(self, message: str = "auto") -> bool:
        ...
        """
        print(f"[SEARCH] Detecting model changes...")
        ...
        try:
            ...
            print("[NOTE] Next step: Run 'createsonline-admin migrate' to apply")
    ...
    def apply_migrations(self, revision: str = "head") -> bool:
        ...
        Returns:
            True if successful
        """
        print(f"[RUN] Applying migrations to: {self.database_url}")
    ...
    def downgrade_migration(self, steps: int = 1) -> bool:
        ...
        Returns:
            True if successful
        """
        print(f"[ROLLBACK] Rolling back {steps} migration(s)...")
        ...
        try:
            ...
            print(f"[ERROR] Error rolling back: {e}")
            import traceback
            traceback.print_exc()
            return False
    ...
    def show_current(self) -> bool:
        ...
        try:
            ...
            print(f"[ERROR] Error showing current revision: {e}")
            return False
    ...
    def show_pending(self) -> bool:
        ...
        try:
            ...
            print(f"[ERROR] Error checking pending migrations: {e}")
            return False
