...
from alxhttp.typescript.type_checks import TypeType, is_alias, is_dict, is_list, is_model_type, is_optional, is_union_of_models_recursive
...
def recursive_json_loads(typ: TypeType, data: Any) -> Any:
  ...
  if is_union_of_models_recursive(typ):
