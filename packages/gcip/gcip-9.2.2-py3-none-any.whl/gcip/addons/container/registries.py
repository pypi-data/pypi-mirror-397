...
class Registry:
    ...
    @staticmethod
    def AWS(*, account_id: str | None = None, region: str | None = None) -> str:
        ...
        Args:
            account_id (str | None): AWS account id. Defaults internally to `gcip.addons.aws.helper.aws_account_id()`.
            region (str | None): AWS region where the ECR repository lives in. Defaults internally to `gcip.addons.aws.helper.aws_region`.
