...
configuration file from a previous job](https://docs.gitlab.com/ee/ci/yaml/#trigger-child-pipeline-with-generated-configuration-file):
...
class IncludeFile(Include):
    ...
    Args:
        ...
        ref (str | None, optional): Project branch to include the file from. Defaults to None.
    """
