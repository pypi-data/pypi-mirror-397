...
originated from
https://github.com/tensorflow/addons/blob/v0.20.0/tensorflow_addons/optimizers/lamb.py
"""
import re
    ...
    def __init__(
        ...
        **kwargs,
        ...
        Args:
            ...
            beta_1 (float, optional): The exponential decay rate
                for the 1st moment estimates. Defaults to 0.9.
            beta_2 (float, optional): The exponential decay rate
                for the 2nd moment estimates. Defaults to 0.999.
            epsilon (float, optional): A small constant for numerical stability.
                Defaults to 1e-6.
            weight_decay (float, optional): weight decay. Defaults to 0.0.
            exclude_from_weight_decay: List of regex patterns of variables
                excluded from weight decay. Variables whose name contain a
                substring matching the pattern will be excluded. Defaults to None.
            exclude_from_layer_adaptation: List of regex patterns of variables
                ...
                substring matching the pattern will be excluded. Defaults to None.
            name (str, optional): Optional name for the operations created when applying
