...
This script is used in dvs_train.py to generate images from DVS data from NPY files. It's mandatory
because Tensorflow doesn't handle events data.
"""

__all__ = ["DVS_DataGenerator"]
