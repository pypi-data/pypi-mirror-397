...
parser.add_argument(
    ...
    "--buffer_type",
    type=str,
    help='Accepted values are "HSP_BUFFER", "HSP_ARCHIVES" and "HSP_FILES"; \
                        Default is "HSP_BUFFER"',
    required=False,
    default="HSP_BUFFER",
    metavar="",
)
...
#stream_id = "35c3a098-5541-11ef-8e92-0c9a3c76bab9"

conn = highspeedport_client.HighSpeedPortClient()

client_instance, connection_instance = conn.init_websocket_stream(
    url,
    port,
    route,
    username,
