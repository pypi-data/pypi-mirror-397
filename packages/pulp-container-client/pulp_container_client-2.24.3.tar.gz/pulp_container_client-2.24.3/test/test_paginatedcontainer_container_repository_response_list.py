...
class TestPaginatedcontainerContainerRepositoryResponseList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PaginatedcontainerContainerRepositoryResponseList:
        """Test PaginatedcontainerContainerRepositoryResponseList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedcontainerContainerRepositoryResponseList`
        """
        model = PaginatedcontainerContainerRepositoryResponseList()
        if include_optional:
