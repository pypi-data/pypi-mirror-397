...
class TestContainerContainerRemote(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ContainerContainerRemote:
        """Test ContainerContainerRemote
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContainerContainerRemote`
        """
        model = ContainerContainerRemote()
        if include_optional:
