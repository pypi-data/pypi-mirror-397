...
class RemotesContainerApi:
    ...
    def add_role(
        self,
        container_container_remote_href: StrictStr,
        ...
        :param container_container_remote_href: (required)
        :type container_container_remote_href: str
        ...
        _param = self._add_role_serialize(
            container_container_remote_href=container_container_remote_href,
    ...
    def _add_role_serialize(
        ...
        if container_container_remote_href is not None:
            _path_params['container_container_remote_href'] = container_container_remote_href
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='{container_container_remote_href}add_role/',
    ...
    def create(
        self,
        container_container_remote: ContainerContainerRemote,
        x_task_diagnostics: Annotated[Optional[List[StrictStr]], Field(description="List of profilers to use on tasks.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param container_container_remote: (required)
        :type container_container_remote: ContainerContainerRemote
        :param x_task_diagnostics: List of profilers to use on tasks.
        :type x_task_diagnostics: List[str]
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._create_serialize(
            container_container_remote=container_container_remote,
            x_task_diagnostics=x_task_diagnostics,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "ContainerContainerRemoteResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def create_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ContainerContainerRemoteResponse]:
        """Create a container remote
    ...
    def _create_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if container_container_remote is not None:
            _body_params = container_container_remote
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/pulp/api/v3/remotes/container/container/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _delete_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='{container_container_remote_href}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PaginatedcontainerContainerRemoteResponseList",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def list_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PaginatedcontainerContainerRemoteResponseList]:
        """List container remotes
    ...
    def _list_roles_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='{container_container_remote_href}list_roles/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _my_permissions_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='{container_container_remote_href}my_permissions/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def partial_update(
        self,
        container_container_remote_href: StrictStr,
        patchedcontainer_container_remote: PatchedcontainerContainerRemote,
        x_task_diagnostics: Annotated[Optional[List[StrictStr]], Field(description="List of profilers to use on tasks.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param container_container_remote_href: (required)
        :type container_container_remote_href: str
        :param patchedcontainer_container_remote: (required)
        :type patchedcontainer_container_remote: PatchedcontainerContainerRemote
        :param x_task_diagnostics: List of profilers to use on tasks.
        :type x_task_diagnostics: List[str]
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._partial_update_serialize(
            container_container_remote_href=container_container_remote_href,
            patchedcontainer_container_remote=patchedcontainer_container_remote,
            x_task_diagnostics=x_task_diagnostics,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _partial_update_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if patchedcontainer_container_remote is not None:
            _body_params = patchedcontainer_container_remote
    ...
    def read(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ContainerContainerRemoteResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def _remove_role_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='{container_container_remote_href}remove_role/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _set_label_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='{container_container_remote_href}set_label/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _unset_label_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='{container_container_remote_href}unset_label/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
