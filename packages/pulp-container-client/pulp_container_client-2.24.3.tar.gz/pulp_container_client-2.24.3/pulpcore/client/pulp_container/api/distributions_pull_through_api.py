...
class DistributionsPullThroughApi:
    ...
    def add_role(
        self,
        container_container_pull_through_distribution_href: StrictStr,
        ...
        :param container_container_pull_through_distribution_href: (required)
        :type container_container_pull_through_distribution_href: str
        ...
        _param = self._add_role_serialize(
            container_container_pull_through_distribution_href=container_container_pull_through_distribution_href,
    ...
    def _add_role_serialize(
        ...
        if container_container_pull_through_distribution_href is not None:
            _path_params['container_container_pull_through_distribution_href'] = container_container_pull_through_distribution_href
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='{container_container_pull_through_distribution_href}add_role/',
    ...
    def create(
        self,
        container_container_pull_through_distribution: ContainerContainerPullThroughDistribution,
        x_task_diagnostics: Annotated[Optional[List[StrictStr]], Field(description="List of profilers to use on tasks.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param container_container_pull_through_distribution: (required)
        :type container_container_pull_through_distribution: ContainerContainerPullThroughDistribution
        :param x_task_diagnostics: List of profilers to use on tasks.
        :type x_task_diagnostics: List[str]
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._create_serialize(
            container_container_pull_through_distribution=container_container_pull_through_distribution,
            x_task_diagnostics=x_task_diagnostics,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _create_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if container_container_pull_through_distribution is not None:
            _body_params = container_container_pull_through_distribution
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/pulp/api/v3/distributions/container/pull-through/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _delete_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='{container_container_pull_through_distribution_href}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PaginatedcontainerContainerPullThroughDistributionResponseList",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def list_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PaginatedcontainerContainerPullThroughDistributionResponseList]:
        """List container pull through distributions
    ...
    def _list_roles_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='{container_container_pull_through_distribution_href}list_roles/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _my_permissions_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='{container_container_pull_through_distribution_href}my_permissions/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def partial_update(
        self,
        container_container_pull_through_distribution_href: StrictStr,
        patchedcontainer_container_pull_through_distribution: PatchedcontainerContainerPullThroughDistribution,
        x_task_diagnostics: Annotated[Optional[List[StrictStr]], Field(description="List of profilers to use on tasks.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param container_container_pull_through_distribution_href: (required)
        :type container_container_pull_through_distribution_href: str
        :param patchedcontainer_container_pull_through_distribution: (required)
        :type patchedcontainer_container_pull_through_distribution: PatchedcontainerContainerPullThroughDistribution
        :param x_task_diagnostics: List of profilers to use on tasks.
        :type x_task_diagnostics: List[str]
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._partial_update_serialize(
            container_container_pull_through_distribution_href=container_container_pull_through_distribution_href,
            patchedcontainer_container_pull_through_distribution=patchedcontainer_container_pull_through_distribution,
            x_task_diagnostics=x_task_diagnostics,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _partial_update_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if patchedcontainer_container_pull_through_distribution is not None:
            _body_params = patchedcontainer_container_pull_through_distribution
    ...
    def read(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ContainerContainerPullThroughDistributionResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def read_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ContainerContainerPullThroughDistributionResponse]:
        """Inspect a container pull through distribution
    ...
    def _remove_role_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='{container_container_pull_through_distribution_href}remove_role/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _set_label_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='{container_container_pull_through_distribution_href}set_label/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _unset_label_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='{container_container_pull_through_distribution_href}unset_label/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
