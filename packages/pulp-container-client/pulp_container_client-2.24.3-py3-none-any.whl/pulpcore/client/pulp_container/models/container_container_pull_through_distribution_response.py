...
class ContainerContainerPullThroughDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["base_path", "name", "prn", "pulp_labels", "content_guard", "no_content_change_since", "pulp_created", "pulp_last_updated", "repository", "hidden", "pulp_href", "remote", "distributions", "namespace", "private", "description"]
