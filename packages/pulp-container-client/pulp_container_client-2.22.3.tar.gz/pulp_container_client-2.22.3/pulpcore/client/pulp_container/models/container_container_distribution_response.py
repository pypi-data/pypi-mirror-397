...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, base_path=None, content_guard=None, pulp_href=None, pulp_last_updated=None, name=None, pulp_created=None, prn=None, hidden=False, no_content_change_since=None, repository=None, pulp_labels=None, repository_version=None, registry_path=None, remote=None, namespace=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
