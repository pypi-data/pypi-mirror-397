...
class ContainerContainerPullThroughDistribution(object):
    ...
    def __init__(self, base_path=None, content_guard=None, name=None, hidden=False, repository=None, pulp_labels=None, remote=None, distributions=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
