...
class RepositoriesContainerApi(object):
    ...
    def build_image(self, container_container_repository_href,  **kwargs):  # noqa: E501
        ...
        Trigger an asynchronous task to build an OCI image from a Containerfile. A new repository version is created with the new image and tag. This API is in tech preview. Backwards compatibility when upgrading is not guaranteed.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param async_req bool: execute request asynchronously
        :param str container_container_repository_href: (required)
        :param str containerfile_name: Name of the Containerfile, from build_context, that should be used to run podman-build.
        ...
        :param str build_context: RepositoryVersion to be used as the build context for container images.
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def build_image_with_http_info(self, container_container_repository_href,  **kwargs):  # noqa: E501
        ...
        form_params = []
        local_var_files = {}
        if 'containerfile_name' in local_var_params:
            form_params.append(('containerfile_name', local_var_params['containerfile_name']))  # noqa: E501
        ...
        if 'build_context' in local_var_params:
            form_params.append(('build_context', local_var_params['build_context']))  # noqa: E501
