...
class AnalysisDiagnostics(object):
    ...
    :var application_logs: retrieve :ref:`log files<Application Logs>` generated by verify identity access runtime applications
    :var remote_syslog: manage :ref:`remote syslog<Remote Syslog>` configuration used by Verify Identity Access.
    '''
