...
from ntnx_monitoring_py_client.models.monitoring.v4.serviceability.GroupEntityType import GroupEntityType  # noqa: F401,E501

class GroupFilter(object):

    """Group of entities on which the User-Defined Alert policy should be set up.

    :param ext_id: (:attr:`ext_id`) Entity UUID of the group entity type on which the User-Defined Alert policy should be set up.
    ...
    swagger_types = {
        'ext_id': 'str',
        'type': 'monitoring.v4.serviceability.GroupEntityType',
    ...
    def __init__(self, ext_id=None, type=None, *args, **kwargs):  # noqa: E501
        self.__ext_id = None
        self.__type = None
    ...
    def _initialize_object_type(self):
        return 'monitoring.v4.serviceability.GroupFilter'
    ...
    def type(self):
        ...
        :type:
            :class:`~ntnx_monitoring_py_client.models.monitoring.v4.serviceability.GroupEntityType`
        """  # noqa: E501
        return self.__type
