...
from ntnx_monitoring_py_client.models.monitoring.v4.serviceability.PropertyState import PropertyState  # noqa: F401,E501

class SeverityConfig(object):
    ...
    :param threshold_parameters: (:attr:`threshold_parameters`) Captures alert-related thresholds that correspond to a particular severity.
    ...
    """  # noqa: E501
    swagger_types = {
        'state': 'monitoring.v4.serviceability.PropertyState',
        'threshold_parameters': 'list[monitoring.v4.serviceability.AlertPolicyConfigurableParameter]',
    ...
    def __init__(self, state=None, threshold_parameters=None, *args, **kwargs):  # noqa: E501
        self.__state = None
        self.__threshold_parameters = None
        self.discriminator = None
        if state is not None:
            self.__state = state
        if threshold_parameters is not None:
            self.__threshold_parameters = threshold_parameters
        # populate hidden vars if not empty
        self._populate_hidden_vars(kwargs)

    def _initialize_object_type(self):
        return 'monitoring.v4.serviceability.SeverityConfig'
    ...
    def state(self):
        ...
        :type:
            :class:`~ntnx_monitoring_py_client.models.monitoring.v4.serviceability.PropertyState`
        """  # noqa: E501
        return self.__state
    ...
    def threshold_parameters(self):
        ...
        """  # noqa: E501
        return self.__threshold_parameters

    @threshold_parameters.setter
    def threshold_parameters(self, threshold_parameters):
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(SeverityConfig, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SeverityConfig):
            return False
