...
from ntnx_monitoring_py_client.models.monitoring.v4.serviceability.TagOpts import TagOpts  # noqa: F401,E501
...
class LogCollectionSpec(object):
    ...
    swagger_types = {
        ...
        'description': 'str',
        'tag_opts': 'monitoring.v4.serviceability.TagOpts',
    ...
    def __init__(self, start_time=None, end_time=None, include_tags=None, should_anonymize=False, node_ip_list=None, should_collect_from_disabled_node=False, exclude_tags=None, archive_opts=None, description='Log collection via V4 API', tag_opts=None, *args, **kwargs):  # noqa: E501
        ...
        if tag_opts is not None:
            self.__tag_opts = tag_opts
    ...
    def tag_opts(self):
        ...
        :type:
            :class:`~ntnx_monitoring_py_client.models.monitoring.v4.serviceability.TagOpts`
        """  # noqa: E501
        return self.__tag_opts

    @tag_opts.setter
    def tag_opts(self, tag_opts):
