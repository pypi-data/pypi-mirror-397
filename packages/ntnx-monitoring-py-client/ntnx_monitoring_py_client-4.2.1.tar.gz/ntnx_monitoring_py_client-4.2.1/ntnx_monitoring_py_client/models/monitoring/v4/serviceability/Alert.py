...
class Alert(ExternalizableAbstractModel):
    ...
    :param kb_articles: (:attr:`kb_articles`) List of knowledge base article links.
    :type kb_articles: 
    
    
    :param cluster_name: (:attr:`cluster_name`) Name of the cluster associated with the entity.
    :type cluster_name: 
     max=1000 chars
    
    :param is_runnable: (:attr:`is_runnable`) Indicates whether the policy associated with the alert is runnable or not. (**Default** False)
    :type is_runnable: 
    ...
    def __init__(self, is_acknowledged=False, acknowledged_by_username=None, acknowledged_time=None, is_auto_resolved=False, is_resolved=False, resolved_by_username=None, resolved_time=None, source_entity=None, affected_entities=None, severity_trails=None, metric_details=None, title=None, alert_type=None, classifications=None, cluster_uuid=None, creation_time=None, impact_types=None, last_updated_time=None, message=None, originating_cluster_uuid=None, severity=None, is_user_defined=False, parameters=None, service_name=None, root_cause_analysis=None, kb_articles=None, cluster_name=None, is_runnable=False, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
        ...
        if is_runnable is not None:
            self.__is_runnable = is_runnable
    ...
    def cluster_name(self, cluster_name):
        if cluster_name is not None and len(cluster_name) > 1000:
            raise ValueError("Invalid value for `cluster_name`, length must be less than or equal to `1000`")  # noqa: E501
    ...
    def is_runnable(self):
        ...
        :type:
                :class:`~bool`
        """  # noqa: E501
        return self.__is_runnable

    @is_runnable.setter
    def is_runnable(self, is_runnable):
