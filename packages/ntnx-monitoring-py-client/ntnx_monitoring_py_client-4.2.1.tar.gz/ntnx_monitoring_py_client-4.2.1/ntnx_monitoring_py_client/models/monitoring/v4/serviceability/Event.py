...
class Event(ExternalizableAbstractModel):
    ...
    def __init__(self, source_entity=None, affected_entities=None, metric_details=None, event_type=None, classifications=None, source_cluster_uuid=None, creation_time=None, message=None, cluster_uuid=None, parameters=None, service_name=None, operation_type=None, cluster_name=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
