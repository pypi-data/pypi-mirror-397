...
class ServiceCenter(object):
    ...
    :param name: (:attr:`name`) Name of service center.
    :type name: 
     max=1000 chars
    
    :param ip_address: (:attr:`ip_address`) IP address of the service center.
    :type ip_address: 
    ...
    :param port: (:attr:`port`) Port number.
    :type port: 
    ...
    def __init__(self, name=None, ip_address=None, username=None, port=None, *args, **kwargs):  # noqa: E501
        self.__name = None
    ...
    def _initialize_object_type(self):
        return 'monitoring.v4.serviceability.ServiceCenter'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ServiceCenter, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ServiceCenter):
            return False
