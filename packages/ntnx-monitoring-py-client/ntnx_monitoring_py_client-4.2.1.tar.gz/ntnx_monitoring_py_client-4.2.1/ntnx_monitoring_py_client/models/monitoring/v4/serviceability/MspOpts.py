...
class MspOpts(object):

    """Additional arguments that are applicable only for MSP tag.

    :param cluster_ext_ids: (:attr:`cluster_ext_ids`) List of MSP cluster UUID from where logs would be collected.
    ...
    def _initialize_object_type(self):
        return 'monitoring.v4.serviceability.MspOpts'
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MspOpts):
            return False
