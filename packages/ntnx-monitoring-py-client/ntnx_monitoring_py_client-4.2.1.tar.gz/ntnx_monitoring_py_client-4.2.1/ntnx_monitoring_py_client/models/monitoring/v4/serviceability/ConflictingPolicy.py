...
class ConflictingPolicy(object):

    """Details of the policy conflicting with a given User-Defined Alert policy.

    :param ext_id: (:attr:`ext_id`) Unique UUID associated with the User-Defined Alert policy, that conflicts with the given policy.
    ...
    def _initialize_object_type(self):
        return 'monitoring.v4.serviceability.ConflictingPolicy'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ConflictingPolicy, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ConflictingPolicy):
            return False
