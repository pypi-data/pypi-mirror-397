...
class UpdateAlertEmailConfigurationApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<monitoring.v4.error.AppMessage>': 'list[monitoring.v4.error.AppMessage]',
    ...
    def _initialize_object_type(self):
        return 'OneOfmonitoring.v4.serviceability.UpdateAlertEmailConfigurationApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in UpdateAlertEmailConfigurationApiResponsedata.discriminator_value_class_map.values():
            return list(UpdateAlertEmailConfigurationApiResponsedata.discriminator_value_class_map.keys())[list(UpdateAlertEmailConfigurationApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(UpdateAlertEmailConfigurationApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateAlertEmailConfigurationApiResponsedata):
            return False
