...
class Conditionthreshold_value(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfmonitoring.v4.serviceability.Conditionthreshold_value'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in Conditionthreshold_value.discriminator_value_class_map.values():
            return list(Conditionthreshold_value.discriminator_value_class_map.keys())[list(Conditionthreshold_value.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(Conditionthreshold_value, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, Conditionthreshold_value):
            return False
