...
class ListEventsApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<monitoring.v4.serviceability.Event>': 'list[monitoring.v4.serviceability.Event]',
    ...
    def _initialize_object_type(self):
        return 'OneOfmonitoring.v4.serviceability.ListEventsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListEventsApiResponsedata.discriminator_value_class_map.values():
            return list(ListEventsApiResponsedata.discriminator_value_class_map.keys())[list(ListEventsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListEventsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListEventsApiResponsedata):
            return False
