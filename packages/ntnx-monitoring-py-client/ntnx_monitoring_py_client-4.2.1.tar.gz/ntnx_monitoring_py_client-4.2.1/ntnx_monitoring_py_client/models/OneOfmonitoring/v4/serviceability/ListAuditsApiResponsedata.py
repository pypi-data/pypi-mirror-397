...
class ListAuditsApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<monitoring.v4.serviceability.Audit>': 'list[monitoring.v4.serviceability.Audit]',
    ...
    def _initialize_object_type(self):
        return 'OneOfmonitoring.v4.serviceability.ListAuditsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListAuditsApiResponsedata.discriminator_value_class_map.values():
            return list(ListAuditsApiResponsedata.discriminator_value_class_map.keys())[list(ListAuditsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListAuditsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListAuditsApiResponsedata):
            return False
