...
class GetEventApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'monitoring.v4.serviceability.Event': 'monitoring.v4.serviceability.Event',
    ...
    def _initialize_object_type(self):
        return 'OneOfmonitoring.v4.serviceability.GetEventApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetEventApiResponsedata.discriminator_value_class_map.values():
            return list(GetEventApiResponsedata.discriminator_value_class_map.keys())[list(GetEventApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetEventApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetEventApiResponsedata):
            return False
