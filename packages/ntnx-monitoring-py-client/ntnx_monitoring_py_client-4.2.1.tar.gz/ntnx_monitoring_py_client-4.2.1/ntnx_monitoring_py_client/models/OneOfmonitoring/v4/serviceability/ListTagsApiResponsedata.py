...
class ListTagsApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<monitoring.v4.serviceability.Tag>': 'list[monitoring.v4.serviceability.Tag]',
    ...
    def _initialize_object_type(self):
        return 'OneOfmonitoring.v4.serviceability.ListTagsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListTagsApiResponsedata.discriminator_value_class_map.values():
            return list(ListTagsApiResponsedata.discriminator_value_class_map.keys())[list(ListTagsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListTagsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListTagsApiResponsedata):
            return False
