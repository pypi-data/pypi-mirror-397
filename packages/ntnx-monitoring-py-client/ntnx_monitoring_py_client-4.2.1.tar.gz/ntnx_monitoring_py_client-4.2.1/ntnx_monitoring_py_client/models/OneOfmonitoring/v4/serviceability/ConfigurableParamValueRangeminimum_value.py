...
class ConfigurableParamValueRangeminimum_value(object):
    ...
    ONE_OF_ITEM_DISCRIMINATOR_NAME = '$minimumValueItemDiscriminator'
    ...
    def _initialize_object_type(self):
        return 'OneOfmonitoring.v4.serviceability.ConfigurableParamValueRangeminimum_value'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ConfigurableParamValueRangeminimum_value.discriminator_value_class_map.values():
            return list(ConfigurableParamValueRangeminimum_value.discriminator_value_class_map.keys())[list(ConfigurableParamValueRangeminimum_value.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ConfigurableParamValueRangeminimum_value, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ConfigurableParamValueRangeminimum_value):
            return False
