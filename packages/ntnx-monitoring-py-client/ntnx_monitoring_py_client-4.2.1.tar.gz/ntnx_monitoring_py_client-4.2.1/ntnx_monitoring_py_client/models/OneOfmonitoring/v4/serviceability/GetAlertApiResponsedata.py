...
class GetAlertApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'monitoring.v4.serviceability.Alert': 'monitoring.v4.serviceability.Alert',
    ...
    def _initialize_object_type(self):
        return 'OneOfmonitoring.v4.serviceability.GetAlertApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetAlertApiResponsedata.discriminator_value_class_map.values():
            return list(GetAlertApiResponsedata.discriminator_value_class_map.keys())[list(GetAlertApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetAlertApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetAlertApiResponsedata):
            return False
