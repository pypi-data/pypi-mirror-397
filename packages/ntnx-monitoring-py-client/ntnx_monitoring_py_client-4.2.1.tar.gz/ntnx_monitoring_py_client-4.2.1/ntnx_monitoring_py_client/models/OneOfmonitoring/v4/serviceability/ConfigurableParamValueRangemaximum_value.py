...
class ConfigurableParamValueRangemaximum_value(object):
    ...
    ONE_OF_ITEM_DISCRIMINATOR_NAME = '$maximumValueItemDiscriminator'
    ...
    def _initialize_object_type(self):
        return 'OneOfmonitoring.v4.serviceability.ConfigurableParamValueRangemaximum_value'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ConfigurableParamValueRangemaximum_value.discriminator_value_class_map.values():
            return list(ConfigurableParamValueRangemaximum_value.discriminator_value_class_map.keys())[list(ConfigurableParamValueRangemaximum_value.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ConfigurableParamValueRangemaximum_value, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ConfigurableParamValueRangemaximum_value):
            return False
