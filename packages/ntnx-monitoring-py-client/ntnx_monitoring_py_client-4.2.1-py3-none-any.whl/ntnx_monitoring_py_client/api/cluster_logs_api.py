...
class ClusterLogsApi(object):
    ...
    def collect_logs(self, extId, body, **kwargs):  # noqa: E501
        """Collect logs

        >>> response = api.collect_logs(extId, body)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.collect_logs(extId, body, async_req=True)
        >>> result = thread.get()

        :param extId: The UUID of the cluster for which you want to collect logs.
        :type extId:
            :class:`str`, required
        :param body: Input parameters for collecting logs.
        :type body:
            :class:`~ntnx_monitoring_py_client.models.monitoring.v4.serviceability.LogCollectionSpec`, required
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::

                           async_req=True
        :return: An instance of class :class:`~ntnx_monitoring_py_client.models.monitoring.v4.serviceability.CollectLogsApiResponse`.
        ...
        if ('extId' not in params or params['extId'] is None):
            raise ValueError("Missing the required parameter `extId` when calling `collect_logs`")  # noqa: E501
        # verify the required parameter 'body' is set
        if ('body' not in params or params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `collect_logs`")  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/monitoring/v4.2/serviceability/clusters/{extId}/$actions/collect-logs', 'POST',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
                    ...
                    response_type='monitoring.v4.serviceability.CollectLogsApiResponse',  # noqa: E501
    ...
    def list_tags(self, clusterExtId, _page=None, _limit=None, _filter=None, _orderby=None, _select=None, **kwargs):  # noqa: E501
        """List tags

        >>> response = api.list_tags(clusterExtId, (optional) _page, (optional) _limit, (optional) _filter, (optional) _orderby, (optional) _select)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.list_tags(clusterExtId, async_req=True)
        >>> result = thread.get()

        :param clusterExtId: Cluster UUID for which log collection tags are requested.
        :type clusterExtId:
            :class:`str`, required
        ...
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
                           ...
                           async_req=True
        :return: An instance of class :class:`~ntnx_monitoring_py_client.models.monitoring.v4.serviceability.ListTagsApiResponse`.
        ...
        if ('clusterExtId' not in params or params['clusterExtId'] is None):
            raise ValueError("Missing the required parameter `clusterExtId` when calling `list_tags`")  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/monitoring/v4.2/serviceability/clusters/{clusterExtId}/tags', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
                    post_params=form_params,
                    files=local_var_files,
                    response_type='monitoring.v4.serviceability.ListTagsApiResponse',  # noqa: E501
                    auth_settings=auth_settings,
                    async_req=params.get('async_req'),
                    _return_http_data_only=params.get('_return_http_data_only'),
                    _preload_content=params.get('_preload_content', True),
