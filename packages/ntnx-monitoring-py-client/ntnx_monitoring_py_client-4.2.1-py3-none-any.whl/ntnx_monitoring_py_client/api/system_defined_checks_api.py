...
class SystemDefinedChecksApi(object):
    """IGNORE:
    ...
    def run_system_defined_checks(self, clusterExtId, body, **kwargs):  # noqa: E501
        """Run System-Defined Checks

        >>> response = api.run_system_defined_checks(clusterExtId, body)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.run_system_defined_checks(clusterExtId, body, async_req=True)
        >>> result = thread.get()

        :param clusterExtId: Unique identifier for the cluster for which run System-Defined Checks is requested.
        :type clusterExtId:
            :class:`str`, required
        :param body: Required parameters for running the System-Defined Checks.
        :type body:
            :class:`~ntnx_monitoring_py_client.models.monitoring.v4.serviceability.RunSystemDefinedChecksSpec`, required
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::

                           async_req=True
        :return: An instance of class :class:`~ntnx_monitoring_py_client.models.monitoring.v4.serviceability.RunSystemDefinedChecksApiResponse`.
        ...
        if ('clusterExtId' not in params or params['clusterExtId'] is None):
            raise ValueError("Missing the required parameter `clusterExtId` when calling `run_system_defined_checks`")  # noqa: E501
        # verify the required parameter 'body' is set
        if ('body' not in params or params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `run_system_defined_checks`")  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/monitoring/v4.2/serviceability/clusters/{clusterExtId}/$actions/run-system-defined-checks', 'POST',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
                    ...
                    response_type='monitoring.v4.serviceability.RunSystemDefinedChecksApiResponse',  # noqa: E501
