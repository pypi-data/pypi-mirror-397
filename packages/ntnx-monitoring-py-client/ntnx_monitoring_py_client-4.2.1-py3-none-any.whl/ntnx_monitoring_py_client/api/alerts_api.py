...
class AlertsApi(object):
    ...
    def get_alert_by_id(self, extId, **kwargs):  # noqa: E501
        """Get alert details

        >>> response = api.get_alert_by_id(extId)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.get_alert_by_id(extId, async_req=True)
        >>> result = thread.get()

        :param extId: UUID of the generated alert.
        :type extId:
            :class:`str`, required
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
                           ...
                           async_req=True
        :return: An instance of class :class:`~ntnx_monitoring_py_client.models.monitoring.v4.serviceability.GetAlertApiResponse`.
        ...
        if ('extId' not in params or params['extId'] is None):
            raise ValueError("Missing the required parameter `extId` when calling `get_alert_by_id`")  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/monitoring/v4.2/serviceability/alerts/{extId}', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
                    ...
                    response_type='monitoring.v4.serviceability.GetAlertApiResponse',  # noqa: E501
    ...
    def list_alerts(self, _page=None, _limit=None, _filter=None, _orderby=None, _select=None, **kwargs):  # noqa: E501
        """List alerts

        >>> response = api.list_alerts((optional) _page, (optional) _limit, (optional) _filter, (optional) _orderby, (optional) _select)
        ...
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
                           ...
                           async_req=True
        :return: An instance of class :class:`~ntnx_monitoring_py_client.models.monitoring.v4.serviceability.ListAlertsApiResponse`.
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/monitoring/v4.2/serviceability/alerts', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
                    post_params=form_params,
                    files=local_var_files,
                    response_type='monitoring.v4.serviceability.ListAlertsApiResponse',  # noqa: E501
                    auth_settings=auth_settings,
                    async_req=params.get('async_req'),
                    _return_http_data_only=params.get('_return_http_data_only'),
                    _preload_content=params.get('_preload_content', True),
