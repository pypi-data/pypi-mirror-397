...
class ServerUploadProtocol(object):
    ...
    Allowed enum values:
        ...
        - _UNKNOWN
        - _REDACTED
        - SFTP: Use SFTP protocol for server upload.
        - FTP: Use FTP protocol for server upload.
    """
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    SFTP = "SFTP"
    ...
    def _initialize_object_type(self):
        return 'monitoring.v4.serviceability.ServerUploadProtocol'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ServerUploadProtocol, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ServerUploadProtocol):
            return False
