...
from ntnx_monitoring_py_client.models.OneOfmonitoring.v4.serviceability.Conditionthreshold_value import Conditionthreshold_value  # noqa: F401,E501
...
class Condition(object):
    ...
    :type metric_name: required
     min=1 chars, max=150 chars
    
    :param operator: (:attr:`operator`) 
    ...
    swagger_types = {
        'metric_name': 'str',
        'operator': 'monitoring.v4.common.ComparisonOperator',
        'threshold_value': 'OneOfmonitoring.v4.serviceability.Conditionthreshold_value',
    ...
    def __init__(self, metric_name=None, operator=None, threshold_value=None, *args, **kwargs):  # noqa: E501
    ...
    def _initialize_object_type(self):
        return 'monitoring.v4.serviceability.Condition'
    ...
    def metric_name(self, metric_name):
        ...
        if metric_name is not None and len(metric_name) > 150:
            raise ValueError("Invalid value for `metric_name`, length must be less than or equal to `150`")  # noqa: E501
        if metric_name is not None and len(metric_name) < 1:
            raise ValueError("Invalid value for `metric_name`, length must be greater than or equal to `1`")  # noqa: E501
