...
from ntnx_monitoring_py_client.models.monitoring.v4.serviceability.MspOpts import MspOpts  # noqa: F401,E501

class TagOpts(object):

    """This parameter allows the user to pass additional arguments that are specific to a particular tag.

    :param msp_opts: (:attr:`msp_opts`) 
    :type msp_opts: 
    ...
    """  # noqa: E501
    swagger_types = {
        'msp_opts': 'monitoring.v4.serviceability.MspOpts',
    ...
    def __init__(self, msp_opts=None, *args, **kwargs):  # noqa: E501
        self.__msp_opts = None
        self.discriminator = None
        if msp_opts is not None:
            self.__msp_opts = msp_opts
        # populate hidden vars if not empty
        self._populate_hidden_vars(kwargs)

    def _initialize_object_type(self):
        return 'monitoring.v4.serviceability.TagOpts'
    ...
    def msp_opts(self):
        ...
        :type:
            :class:`~ntnx_monitoring_py_client.models.monitoring.v4.serviceability.MspOpts`
        """  # noqa: E501
        return self.__msp_opts

    @msp_opts.setter
    def msp_opts(self, msp_opts):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TagOpts):
            return False
