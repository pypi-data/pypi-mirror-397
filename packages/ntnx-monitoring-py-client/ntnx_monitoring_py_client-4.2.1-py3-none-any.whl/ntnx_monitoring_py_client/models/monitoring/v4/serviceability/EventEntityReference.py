...
class EventEntityReference(object):

    """The source entity associated with the alert, event, or audit.

    :param type: (:attr:`type`) The type of entity. For example, VM, node, or cluster.
    :type type: 
    ...
    :param ext_id: (:attr:`ext_id`) UUID of the entity.
    :type ext_id: 
    ...
    def __init__(self, type=None, name=None, ext_id=None, *args, **kwargs):  # noqa: E501
        self.__type = None
        self.__name = None
        self.__ext_id = None
    ...
    def _initialize_object_type(self):
        return 'monitoring.v4.serviceability.EventEntityReference'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(EventEntityReference, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EventEntityReference):
            return False
