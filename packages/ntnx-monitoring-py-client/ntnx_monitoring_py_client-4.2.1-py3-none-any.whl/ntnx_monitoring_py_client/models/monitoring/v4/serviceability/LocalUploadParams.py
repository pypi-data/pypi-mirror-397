...
class LocalUploadParams(object):

    """The parameters for uploading the archive if the destination is a local server.

    :param path: (:attr:`path`) Path where the archive will be stored. The path should pre-exist. Note the Janitor service will not clean up the data from these custom paths. It only monitors the default path. (**Default** '/home/nutanix/data/logbay/bundles')
    :type path: 
     max=100 chars
    ...
    def __init__(self, path='/home/nutanix/data/logbay/bundles', *args, **kwargs):  # noqa: E501
        self.__path = None
    ...
    def _initialize_object_type(self):
        return 'monitoring.v4.serviceability.LocalUploadParams'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(LocalUploadParams, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LocalUploadParams):
            return False
