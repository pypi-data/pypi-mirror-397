...
from ntnx_monitoring_py_client.models.common.v1.config.KVStringPair import KVStringPair  # noqa: F401,E501

class ParameterizedMessage(object):

    """To store any custom message and attributes.

    :param message: (:attr:`message`) Message.
    :type message: 
    
    
    :param attributes: (:attr:`attributes`) Attributes.
    :type attributes: 
    ...
    swagger_types = {
        'message': 'str',
        'attributes': 'list[common.v1.config.KVStringPair]',
    ...
    def __init__(self, message=None, attributes=None, *args, **kwargs):  # noqa: E501
        self.__message = None
    ...
    def _initialize_object_type(self):
        return 'monitoring.v4.serviceability.ParameterizedMessage'
    ...
    def attributes(self):
        ...
        :type:
             list[ :class:`~ntnx_monitoring_py_client.models.common.v1.config.KVStringPair` ]
        """  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ParameterizedMessage, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ParameterizedMessage):
            return False
