...
from ntnx_monitoring_py_client.models.OneOfmonitoring.v4.serviceability.ConfigurableParamValueRangemaximum_value import ConfigurableParamValueRangemaximum_value  # noqa: F401,E501
from ntnx_monitoring_py_client.models.OneOfmonitoring.v4.serviceability.ConfigurableParamValueRangeminimum_value import ConfigurableParamValueRangeminimum_value  # noqa: F401,E501

class ConfigurableParamValueRange(object):

    """Valid values for the parameter.

    :param minimum_value: (:attr:`minimum_value`) Captures the minimum value the parameter can have.
    :type minimum_value: required
    
    
    :param maximum_value: (:attr:`maximum_value`) Captures the maximum value the parameter can have.
    :type maximum_value: required
    ...
    """  # noqa: E501
    swagger_types = {
        'minimum_value': 'OneOfmonitoring.v4.serviceability.ConfigurableParamValueRangeminimum_value',
        'maximum_value': 'OneOfmonitoring.v4.serviceability.ConfigurableParamValueRangemaximum_value',
    ...
    def __init__(self, minimum_value=None, maximum_value=None, *args, **kwargs):  # noqa: E501
    ...
    def _initialize_object_type(self):
        return 'monitoring.v4.serviceability.ConfigurableParamValueRange'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ConfigurableParamValueRange, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ConfigurableParamValueRange):
            return False
