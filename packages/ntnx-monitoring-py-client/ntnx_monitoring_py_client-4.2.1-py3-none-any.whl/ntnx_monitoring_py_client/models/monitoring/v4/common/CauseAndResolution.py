...
class CauseAndResolution(object):

    """Possible causes, resolutions and additional details to troubleshoot this alert.

    :param cause: (:attr:`cause`) Possible cause for the generated alert or event.
    :type cause: 
     max=500 chars
    
    :param resolution: (:attr:`resolution`) Possible resolution for the generated alert or event.
    :type resolution: 
     max=500 chars
    ...
    def __init__(self, cause=None, resolution=None, *args, **kwargs):  # noqa: E501
        self.__cause = None
    ...
    def _initialize_object_type(self):
        return 'monitoring.v4.common.CauseAndResolution'
    ...
    def cause(self, cause):
        if cause is not None and len(cause) > 500:
            raise ValueError("Invalid value for `cause`, length must be less than or equal to `500`")  # noqa: E501
    ...
    def resolution(self, resolution):
        if resolution is not None and len(resolution) > 500:
            raise ValueError("Invalid value for `resolution`, length must be less than or equal to `500`")  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(CauseAndResolution, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CauseAndResolution):
            return False
