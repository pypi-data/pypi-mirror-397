...
class FloatValue(object):
    ...
    :param float_value: (:attr:`float_value`) Denotes a value of type float.
    :type float_value: required
    ...
    def __init__(self, float_value=None, *args, **kwargs):  # noqa: E501
    ...
    def _initialize_object_type(self):
        return 'monitoring.v4.common.FloatValue'
    ...
    def float_value(self, float_value):
        if float_value is None:
            raise ValueError("Invalid value for `float_value`, must not be `None`")  # noqa: E501
