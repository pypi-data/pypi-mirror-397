...
class AlertPolicyConfigurableParameterparam_value(object):
    ...
    discriminator_value_class_map = {
        ...
        'monitoring.v4.serviceability.IntConfigurableParamValue': 'monitoring.v4.serviceability.IntConfigurableParamValue',
        'monitoring.v4.serviceability.FloatConfigurableParamValue': 'monitoring.v4.serviceability.FloatConfigurableParamValue',
        'monitoring.v4.serviceability.BooleanConfigurableParamValue': 'monitoring.v4.serviceability.BooleanConfigurableParamValue',
        'monitoring.v4.serviceability.StringConfigurableParamValue': 'monitoring.v4.serviceability.StringConfigurableParamValue'
    }

    ONE_OF_ITEM_DISCRIMINATOR_NAME = '$paramValueItemDiscriminator'
    ...
    def _initialize_object_type(self):
        return 'OneOfmonitoring.v4.serviceability.AlertPolicyConfigurableParameterparam_value'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in AlertPolicyConfigurableParameterparam_value.discriminator_value_class_map.values():
            return list(AlertPolicyConfigurableParameterparam_value.discriminator_value_class_map.keys())[list(AlertPolicyConfigurableParameterparam_value.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(AlertPolicyConfigurableParameterparam_value, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AlertPolicyConfigurableParameterparam_value):
            return False
