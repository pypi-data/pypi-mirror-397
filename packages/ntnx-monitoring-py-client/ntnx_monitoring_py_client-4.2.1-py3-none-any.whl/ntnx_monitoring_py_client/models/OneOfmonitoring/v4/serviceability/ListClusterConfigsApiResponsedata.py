...
class ListClusterConfigsApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<monitoring.v4.serviceability.ClusterConfig>': 'list[monitoring.v4.serviceability.ClusterConfig]',
        'monitoring.v4.error.ErrorResponse': 'monitoring.v4.error.ErrorResponse',
        'List<monitoring.v4.serviceability.ClusterConfigProjection>': 'list[monitoring.v4.serviceability.ClusterConfigProjection]'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOfmonitoring.v4.serviceability.ListClusterConfigsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListClusterConfigsApiResponsedata.discriminator_value_class_map.values():
            return list(ListClusterConfigsApiResponsedata.discriminator_value_class_map.keys())[list(ListClusterConfigsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListClusterConfigsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListClusterConfigsApiResponsedata):
            return False
