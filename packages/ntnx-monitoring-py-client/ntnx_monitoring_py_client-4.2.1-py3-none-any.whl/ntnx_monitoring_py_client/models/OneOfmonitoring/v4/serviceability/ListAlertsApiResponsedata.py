...
class ListAlertsApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<monitoring.v4.serviceability.Alert>': 'list[monitoring.v4.serviceability.Alert]',
    ...
    def _initialize_object_type(self):
        return 'OneOfmonitoring.v4.serviceability.ListAlertsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListAlertsApiResponsedata.discriminator_value_class_map.values():
            return list(ListAlertsApiResponsedata.discriminator_value_class_map.keys())[list(ListAlertsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListAlertsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListAlertsApiResponsedata):
            return False
