...
class ArchiveOptsupload_params(object):
    ...
    discriminator_value_class_map = {
        ...
        'monitoring.v4.serviceability.LocalUploadParams': 'monitoring.v4.serviceability.LocalUploadParams',
        'monitoring.v4.serviceability.NtnxServerUploadParams': 'monitoring.v4.serviceability.NtnxServerUploadParams',
        'monitoring.v4.serviceability.CustomServerUploadParams': 'monitoring.v4.serviceability.CustomServerUploadParams',
        'monitoring.v4.serviceability.StorageContainerUploadParams': 'monitoring.v4.serviceability.StorageContainerUploadParams'
    }

    ONE_OF_ITEM_DISCRIMINATOR_NAME = '$uploadParamsItemDiscriminator'
    ...
    def _initialize_object_type(self):
        return 'OneOfmonitoring.v4.serviceability.ArchiveOptsupload_params'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ArchiveOptsupload_params.discriminator_value_class_map.values():
            return list(ArchiveOptsupload_params.discriminator_value_class_map.keys())[list(ArchiveOptsupload_params.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ArchiveOptsupload_params, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ArchiveOptsupload_params):
            return False
