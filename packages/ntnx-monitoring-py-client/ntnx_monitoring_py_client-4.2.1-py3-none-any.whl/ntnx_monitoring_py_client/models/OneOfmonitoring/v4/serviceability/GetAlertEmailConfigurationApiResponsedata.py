...
class GetAlertEmailConfigurationApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'monitoring.v4.serviceability.AlertEmailConfiguration': 'monitoring.v4.serviceability.AlertEmailConfiguration',
    ...
    def _initialize_object_type(self):
        return 'OneOfmonitoring.v4.serviceability.GetAlertEmailConfigurationApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetAlertEmailConfigurationApiResponsedata.discriminator_value_class_map.values():
            return list(GetAlertEmailConfigurationApiResponsedata.discriminator_value_class_map.keys())[list(GetAlertEmailConfigurationApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetAlertEmailConfigurationApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetAlertEmailConfigurationApiResponsedata):
            return False
