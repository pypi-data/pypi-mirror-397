...
class GetAuditApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'monitoring.v4.serviceability.Audit': 'monitoring.v4.serviceability.Audit',
    ...
    def _initialize_object_type(self):
        return 'OneOfmonitoring.v4.serviceability.GetAuditApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetAuditApiResponsedata.discriminator_value_class_map.values():
            return list(GetAuditApiResponsedata.discriminator_value_class_map.keys())[list(GetAuditApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetAuditApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetAuditApiResponsedata):
            return False
