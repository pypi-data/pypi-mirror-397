...
class LcRunInfo(_ModelerObject):
    ...
    def __init__(self,
        ...
        if run_nick_name is None:
            raise Exception("run_nick_name cannot be None")
        ...
        if artifact_location is None:
            raise Exception("artifact_location cannot be None")
        ...
        if is_evaluation is None:
            raise Exception("is_evaluation cannot be None")
        
        self._run_name = run_name
        self._user_id = user_id
        self._run_nick_name = run_nick_name
    ...
    @property
    def run_nick_name(self):
        """String ID of the user who initiated this run."""
        return self._run_nick_name
    ...
    def is_evaluation(self):
        """
        model generation or evaluation.
        """
    ...
    def to_proto(self):
        ...
        proto.runNickName = self.run_nick_name
        ...
        proto.isEvaluation = self.is_evaluation
        return proto
    ...
    def from_proto(cls, proto):
        ...
        return cls(user_id=proto.userId,
                   run_nick_name=proto.runNickName,
                   ...
                   run_name=proto.name,
                   note=proto.note,
                   is_evaluation=proto.isEvaluation)
