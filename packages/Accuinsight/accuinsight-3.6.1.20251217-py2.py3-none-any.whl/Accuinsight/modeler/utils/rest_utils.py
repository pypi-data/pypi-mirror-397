...
def _make_feature_data(json_body, run_info_json):
    json_body['feature'] = {}
...
def call_endpoint(host_creds, endpoint, method, json_body, response_proto, current_run_meta):
    ...
    if json_body:
        ...
        json_body = _make_feature_data(json_body, current_run_meta)
    if method == 'GET':
