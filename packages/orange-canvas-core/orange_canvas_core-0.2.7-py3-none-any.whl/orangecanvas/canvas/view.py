...
class CanvasView(QGraphicsView):
    ...
    def __init__(self, *args):
        ...
        self.__zoomInAction = QAction(
            self.tr(_tr.m[312, "Zoom in"]), self, objectName="action-zoom-in",
        ...
        self.__zoomOutAction = QAction(
            self.tr(_tr.m[313, "Zoom out"]), self, objectName="action-zoom-out",
            shortcut=QKeySequence.ZoomOut,
            triggered=self.zoomOut
        )
        self.__zoomResetAction = QAction(
            self.tr(_tr.m[314, "Reset Zoom"]), self, objectName="action-zoom-reset",
