...
class TextAnnotation(Annotation):
    ...
    def __init__(self, parent=None, **kwargs):
        ...
        self.__textItem.setPlaceholderText(self.tr(_tr.m[315, "Enter text here"]))
    ...
    def contextMenuEvent(self, event):
        ...
        formatmenu = menu.addMenu(_tr.m[316, "Render as"])
        ...
        formatactions = [
            makeaction(_tr.m[317, "Plain Text"], group, checkable=True,
                       toolTip=self.tr(_tr.m[318, "Render contents as plain text"]),
                       data="text/plain"),
            makeaction("HTML", group, checkable=True,
                       toolTip=self.tr(_tr.m[319, "Render contents as HTML"]),
                       data="text/html"),
            makeaction(_tr.m[320, "RST"], group, checkable=True,
                       toolTip=self.tr((_tr.m[321, "Render contents as RST "] + "(reStructuredText)")),
                       data="text/rst"),
            makeaction("Markdown", group, checkable=True,
                       toolTip=self.tr(_tr.m[322, "Render contents as Markdown"]),
                       data="text/markdown")
        ]
