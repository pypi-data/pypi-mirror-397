...
def createStandardContextMenu(
    ...
    if flags & (Qt.LinksAccessibleByMouse | Qt.LinksAccessibleByKeyboard):
        addAction(
            menu, _tr.m[327, "Copy &Link Location"], copyLinkLocation,
            enabled=bool(link),
    ...
    if flags & Qt.TextEditable:
        ...
        addAction(
            menu, _tr.m[329, "Delete"], deleteSelected,
            enabled=cursor.hasSelection(),
    ...
    if showTextSelectionActions:
        addAction(
            menu, _tr.m[330, "Select All"], selectAll,
