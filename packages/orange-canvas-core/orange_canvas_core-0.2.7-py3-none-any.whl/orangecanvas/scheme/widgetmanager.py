...
class WidgetManager(QObject):
    ...
    def __add_widget_for_node(self, node):
        ...
        raise_canvas = QAction(
            self.tr(_tr.m[462, "Raise Canvas to Front"]), w,
            objectName="action-canvas-raise-canvas",
            toolTip=self.tr(_tr.m[463, "Raise containing canvas workflow window"]),
            shortcut=QKeySequence("Ctrl+Up")
        )
        raise_canvas.triggered.connect(self.__on_activate_parent)
        raise_descendants = QAction(
            self.tr(_tr.m[464, "Raise Descendants"]), w,
            objectName="action-canvas-raise-descendants",
            toolTip=self.tr(_tr.m[465, "Raise all immediate descendants of this node"]),
        ...
        raise_ancestors = QAction(
            self.tr(_tr.m[466, "Raise Ancestors"]), w,
            objectName="action-canvas-raise-ancestors",
            toolTip=self.tr(_tr.m[467, "Raise all immediate ancestors of this node"]),
