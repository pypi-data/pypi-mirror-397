...
from src.FloorplanAnalytics import run_signedDistance
...
# "lines" along 2 outsides of the array
target_array = np.zeros(shape, dtype=np.int32)
target_array[0:10, 0:1000] = 10
#target_array[990:1000, 0:1000] = 1
target_array[0:1000, 0:10] = 10
#target_array[0:200, 199:200] = 1
...
%%time
results = run_signedDistance(mask=obstacle_array, reference=target_array, threads_per_block=(32,32), resize_for_compute=resize, max_size=max_size, use_cuda=use_cuda)
...
colors = np.array([(255, 255, 102), (255, 178, 102), (163, 163, 163)])
positions = np.array([0.0, 0.5, 1])
