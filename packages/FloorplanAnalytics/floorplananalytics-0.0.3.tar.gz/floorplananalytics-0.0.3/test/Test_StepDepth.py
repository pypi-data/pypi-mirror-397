...
from src.FloorplanAnalytics import run_stepDepth
...
%%time
geodesicDistancesResults = run_stepDepth(obstacle_array=obstacle_array, start_positions=start_points, threads_per_block=(32,32), resize_for_compute=resize, max_size=max_size, max_iterations=100, use_cuda=use_cuda)
