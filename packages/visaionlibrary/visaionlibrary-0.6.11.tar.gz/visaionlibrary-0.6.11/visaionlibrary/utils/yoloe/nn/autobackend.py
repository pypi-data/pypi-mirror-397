...
from visaionlibrary.utils.yoloe.utils import ARM64, IS_JETSON, IS_RASPBERRYPI, LINUX, ROOT, yaml_load
from visaionlibrary.utils.yoloe.utils.checks import check_requirements, check_suffix, check_version, check_yaml
from visaionlibrary.utils.yoloe.utils.downloads import attempt_download_asset, is_url
...
class AutoBackend(nn.Module):
    ...
    def __init__(
        ...
        # PyTorch
            ...
            from visaionlibrary.utils.yoloe.nn.tasks import attempt_load_weights
        ...
        # TF GraphDef
            ...
            from visaionlibrary.utils.yoloe.engine.exporter import gd_outputs
        ...
        # NVIDIA Triton Inference Server
            ...
            from visaionlibrary.utils.yoloe.utils.triton import TritonRemoteModel

            model = TritonRemoteModel(w)

        # Any other format (unsupported)
        else:
            from visaionlibrary.utils.yoloe.engine.exporter import export_formats
