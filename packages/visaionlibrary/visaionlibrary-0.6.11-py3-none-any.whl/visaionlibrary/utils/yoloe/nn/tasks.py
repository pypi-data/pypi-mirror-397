...
from visaionlibrary.utils.yoloe.nn.modules import (
    AIFI,
    C1,
    C2,
    C2PSA,
...
from visaionlibrary.utils.yoloe.utils import DEFAULT_CFG_DICT, DEFAULT_CFG_KEYS, colorstr, emojis, yaml_load
from visaionlibrary.utils.yoloe.utils.checks import check_requirements, check_suffix, check_yaml
from visaionlibrary.utils.yoloe.utils.loss import (
    E2EDetectLoss,
...
from visaionlibrary.utils.yoloe.utils.ops import make_divisible
from visaionlibrary.utils.yoloe.utils.plotting import feature_visualization
from visaionlibrary.utils.yoloe.utils.torch_utils import (
    fuse_conv_and_bn,
    fuse_deconv_and_bn,
    initialize_weights,
    intersect_dicts,
...
class YOLOEModel(DetectionModel):
    ...
    def get_text_pe(self, text, batch=80, cache_clip_model=False):
        ...
        from visaionlibrary.utils.yoloe.nn.text_model import build_text_model
...
def temporary_modules(modules=None, attributes=None):
    ...
    try:
        # Set modules in sys.modules under their old name FIRST
        # This must happen before setting attributes, as attributes may reference these modules
