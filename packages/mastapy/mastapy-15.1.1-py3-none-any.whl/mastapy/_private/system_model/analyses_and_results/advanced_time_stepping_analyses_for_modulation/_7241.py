...
class GearSetAdvancedTimeSteppingAnalysisForModulation(
    ...
    @property
    @exception_bridge
    def eignenmodes_indexed_by_mode_id(self: "Self") -> "List[_1720.Eigenmodes]":
    ...
    def gears_advanced_time_stepping_analysis_for_modulation(
        self: "Self",
    ) -> "List[_7239.GearAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def meshes_advanced_time_stepping_analysis_for_modulation(
        self: "Self",
    ) -> "List[_7240.GearMeshAdvancedTimeSteppingAnalysisForModulation]":
