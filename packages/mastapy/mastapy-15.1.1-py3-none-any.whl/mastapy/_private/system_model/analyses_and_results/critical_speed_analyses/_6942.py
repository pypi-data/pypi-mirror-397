...
class ConceptGearSetCriticalSpeedAnalysis(_6974.GearSetCriticalSpeedAnalysis):
    """ConceptGearSetCriticalSpeedAnalysis
    ...
    def gears_critical_speed_analysis(
        self: "Self",
    ) -> "List[_6940.ConceptGearCriticalSpeedAnalysis]":
    ...
    def meshes_critical_speed_analysis(
        self: "Self",
    ) -> "List[_6941.ConceptGearMeshCriticalSpeedAnalysis]":
