...
class WormGearSetCriticalSpeedAnalysis(_6974.GearSetCriticalSpeedAnalysis):
    """WormGearSetCriticalSpeedAnalysis
    ...
    def gears_critical_speed_analysis(
        self: "Self",
    ) -> "List[_7039.WormGearCriticalSpeedAnalysis]":
    ...
    def meshes_critical_speed_analysis(
        self: "Self",
    ) -> "List[_7040.WormGearMeshCriticalSpeedAnalysis]":
