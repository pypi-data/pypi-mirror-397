...
class CylindricalGearSetLoadCase(_7816.GearSetLoadCase):
    """CylindricalGearSetLoadCase
    ...
    @property
    @exception_bridge
    def reset_micro_geometry(self: "Self") -> "_7864.ResetMicroGeometryOptions":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.static_loads._7864",
    ...
    def reset_micro_geometry(
        self: "Self", value: "_7864.ResetMicroGeometryOptions"
    ) -> None:
    ...
    @property
    @exception_bridge
    def gears_load_case(self: "Self") -> "List[_7782.CylindricalGearLoadCase]":
    ...
    def cylindrical_gears_load_case(
        self: "Self",
    ) -> "List[_7782.CylindricalGearLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.CylindricalGearLoadCase]
    ...
    @property
    @exception_bridge
    def meshes_load_case(self: "Self") -> "List[_7784.CylindricalGearMeshLoadCase]":
    ...
    def cylindrical_meshes_load_case(
        self: "Self",
    ) -> "List[_7784.CylindricalGearMeshLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.CylindricalGearMeshLoadCase]
