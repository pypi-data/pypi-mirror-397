...
class SpiralBevelGearSetHarmonicAnalysis(_6039.BevelGearSetHarmonicAnalysis):
    """SpiralBevelGearSetHarmonicAnalysis
    ...
    def bevel_gears_harmonic_analysis(
        self: "Self",
    ) -> "List[_6160.SpiralBevelGearHarmonicAnalysis]":
    ...
    def bevel_meshes_harmonic_analysis(
        self: "Self",
    ) -> "List[_6161.SpiralBevelGearMeshHarmonicAnalysis]":
