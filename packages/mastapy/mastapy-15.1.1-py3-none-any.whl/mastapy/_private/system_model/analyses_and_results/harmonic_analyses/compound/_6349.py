...
class StraightBevelGearSetCompoundHarmonicAnalysis(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6172.StraightBevelGearSetHarmonicAnalysis]":
    ...
    def straight_bevel_gears_compound_harmonic_analysis(
        self: "Self",
    ) -> "List[_6347.StraightBevelGearCompoundHarmonicAnalysis]":
    ...
    def straight_bevel_meshes_compound_harmonic_analysis(
        self: "Self",
    ) -> "List[_6348.StraightBevelGearMeshCompoundHarmonicAnalysis]":
