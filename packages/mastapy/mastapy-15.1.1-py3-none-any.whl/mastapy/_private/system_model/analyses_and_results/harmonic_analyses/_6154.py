...
class ShaftHarmonicAnalysis(
    _6022.AbstractShaftHarmonicAnalysis, _2948.IHaveShaftHarmonicResults
):
    """ShaftHarmonicAnalysis
    ...
    @property
    @exception_bridge
    def coupled_modal_analysis(self: "Self") -> "_5004.ShaftModalAnalysis":
    ...
    @property
    @exception_bridge
    def export(self: "Self") -> "_6113.HarmonicAnalysisShaftExportOptions":
    ...
    @property
    @exception_bridge
    def system_deflection_results(self: "Self") -> "_3098.ShaftSystemDeflection":
