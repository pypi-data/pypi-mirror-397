...
class SynchroniserHarmonicAnalysis(_6158.SpecialisedAssemblyHarmonicAnalysis):
    """SynchroniserHarmonicAnalysis
    ...
    @property
    @exception_bridge
    def assembly_load_case(self: "Self") -> "_7893.SynchroniserLoadCase":
    ...
    @property
    @exception_bridge
    def system_deflection_results(self: "Self") -> "_3118.SynchroniserSystemDeflection":
