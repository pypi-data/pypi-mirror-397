...
from mastapy._private.system_model.analyses_and_results.harmonic_analyses import _6146
...
class CVTPulleyHarmonicAnalysis(_6146.PulleyHarmonicAnalysis):
    """CVTPulleyHarmonicAnalysis
    ...
    @property
    @exception_bridge
    def system_deflection_results(self: "Self") -> "_3025.CVTPulleySystemDeflection":
