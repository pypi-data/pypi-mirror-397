...
class FaceGearSetCompoundHarmonicAnalysis(_6297.GearSetCompoundHarmonicAnalysis):
    """FaceGearSetCompoundHarmonicAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6092.FaceGearSetHarmonicAnalysis]":
    ...
    def face_gears_compound_harmonic_analysis(
        self: "Self",
    ) -> "List[_6290.FaceGearCompoundHarmonicAnalysis]":
    ...
    def face_meshes_compound_harmonic_analysis(
        self: "Self",
    ) -> "List[_6291.FaceGearMeshCompoundHarmonicAnalysis]":
