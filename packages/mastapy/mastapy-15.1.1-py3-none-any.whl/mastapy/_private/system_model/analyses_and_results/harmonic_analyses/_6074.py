...
class DatumHarmonicAnalysis(_6047.ComponentHarmonicAnalysis):
    """DatumHarmonicAnalysis
    ...
    @property
    @exception_bridge
    def component_load_case(self: "Self") -> "_7790.DatumLoadCase":
    ...
    @property
    @exception_bridge
    def system_deflection_results(self: "Self") -> "_3043.DatumSystemDeflection":
