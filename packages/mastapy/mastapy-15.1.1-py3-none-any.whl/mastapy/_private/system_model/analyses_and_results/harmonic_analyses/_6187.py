...
class WormGearMeshHarmonicAnalysis(_6098.GearMeshHarmonicAnalysis):
    """WormGearMeshHarmonicAnalysis
    ...
    @property
    @exception_bridge
    def connection_load_case(self: "Self") -> "_7909.WormGearMeshLoadCase":
    ...
    @property
    @exception_bridge
    def system_deflection_results(self: "Self") -> "_3131.WormGearMeshSystemDeflection":
