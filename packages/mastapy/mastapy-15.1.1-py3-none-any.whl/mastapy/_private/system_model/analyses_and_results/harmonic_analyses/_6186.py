...
from mastapy._private.system_model.analyses_and_results.harmonic_analyses import _6096
...
class WormGearHarmonicAnalysis(_6096.GearHarmonicAnalysis):
    """WormGearHarmonicAnalysis
    ...
    @property
    @exception_bridge
    def component_design(self: "Self") -> "_2833.WormGear":
    ...
    @property
    @exception_bridge
    def component_load_case(self: "Self") -> "_7908.WormGearLoadCase":
    ...
    @property
    @exception_bridge
    def system_deflection_results(self: "Self") -> "_3133.WormGearSystemDeflection":
