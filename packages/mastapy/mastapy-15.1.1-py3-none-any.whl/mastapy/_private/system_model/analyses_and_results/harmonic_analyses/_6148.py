...
class RingPinsHarmonicAnalysis(_6134.MountableComponentHarmonicAnalysis):
    """RingPinsHarmonicAnalysis
    ...
    @property
    @exception_bridge
    def component_load_case(self: "Self") -> "_7868.RingPinsLoadCase":
    ...
    @property
    @exception_bridge
    def system_deflection_results(self: "Self") -> "_3088.RingPinsSystemDeflection":
