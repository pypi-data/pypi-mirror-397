...
class RootAssemblySystemDeflection(_2984.AssemblySystemDeflection):
    """RootAssemblySystemDeflection
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4446.RootAssemblyPowerFlow":
    ...
    @property
    @exception_bridge
    def system_deflection_inputs(self: "Self") -> "_3119.SystemDeflection":
    ...
    def shaft_deflection_results(
        self: "Self",
    ) -> "List[_3008.ConcentricPartGroupCombinationSystemDeflectionResults]":
