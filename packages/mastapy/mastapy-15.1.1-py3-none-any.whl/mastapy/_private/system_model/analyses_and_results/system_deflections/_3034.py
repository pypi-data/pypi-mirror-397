...
class CylindricalGearSetSystemDeflection(_3052.GearSetSystemDeflection):
    """CylindricalGearSetSystemDeflection
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4395.CylindricalGearSetPowerFlow":
    ...
    def meshes_system_deflection(
        self: "Self",
    ) -> "List[_3031.CylindricalGearMeshSystemDeflection]":
