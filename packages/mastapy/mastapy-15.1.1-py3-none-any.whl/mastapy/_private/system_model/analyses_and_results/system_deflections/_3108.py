...
class StraightBevelDiffGearSetSystemDeflection(_2999.BevelGearSetSystemDeflection):
    """StraightBevelDiffGearSetSystemDeflection
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4459.StraightBevelDiffGearSetPowerFlow":
