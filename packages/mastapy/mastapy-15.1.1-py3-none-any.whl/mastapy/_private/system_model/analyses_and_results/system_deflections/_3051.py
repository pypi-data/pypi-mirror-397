...
class GearMeshSystemDeflection(_3059.InterMountableComponentConnectionSystemDeflection):
    """GearMeshSystemDeflection
    ...
    @property
    @exception_bridge
    def gear_a(self: "Self") -> "_3053.GearSystemDeflection":
    ...
    @property
    @exception_bridge
    def gear_b(self: "Self") -> "_3053.GearSystemDeflection":
        """mastapy.system_model.analyses_and_results.system_deflections.GearSystemDeflection
    ...
    @property
    @exception_bridge
    def mesh_separations(self: "Self") -> "List[_3073.MeshSeparationsAtFaceWidth]":
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4406.GearMeshPowerFlow":
