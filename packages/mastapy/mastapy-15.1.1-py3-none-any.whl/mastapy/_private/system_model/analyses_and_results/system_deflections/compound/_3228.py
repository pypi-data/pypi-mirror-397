...
class PartCompoundSystemDeflection(_7942.PartCompoundAnalysis):
    """PartCompoundSystemDeflection
    ...
    @property
    @exception_bridge
    def component_analysis_cases(self: "Self") -> "List[_3079.PartSystemDeflection]":
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3079.PartSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.PartSystemDeflection]
