...
class SystemDeflection(_7940.FEAnalysis):
    """SystemDeflection
    ...
    @property
    @exception_bridge
    def analysis_options(self: "Self") -> "_3121.SystemDeflectionOptions":
    ...
    def overall_efficiency_results(
        self: "Self",
    ) -> "_3069.LoadCaseOverallEfficiencyResult":
