...
from mastapy._private.system_model.analyses_and_results.system_deflections import _3116
...
class SynchroniserHalfSystemDeflection(_3116.SynchroniserPartSystemDeflection):
    """SynchroniserHalfSystemDeflection
    ...
    @property
    @exception_bridge
    def component_load_case(self: "Self") -> "_7892.SynchroniserHalfLoadCase":
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4465.SynchroniserHalfPowerFlow":
