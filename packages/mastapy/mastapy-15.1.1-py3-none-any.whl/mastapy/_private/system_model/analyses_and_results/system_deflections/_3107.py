...
class StraightBevelDiffGearMeshSystemDeflection(_2998.BevelGearMeshSystemDeflection):
    """StraightBevelDiffGearMeshSystemDeflection
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4457.StraightBevelDiffGearMeshPowerFlow":
