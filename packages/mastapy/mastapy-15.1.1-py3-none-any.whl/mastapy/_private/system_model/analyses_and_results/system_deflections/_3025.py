...
from mastapy._private.system_model.analyses_and_results.system_deflections import _3087
...
class CVTPulleySystemDeflection(_3087.PulleySystemDeflection):
    """CVTPulleySystemDeflection
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4387.CVTPulleyPowerFlow":
    ...
    @property
    @exception_bridge
    def fixed_sheave_contact_results(self: "Self") -> "List[_1778.NodeResults]":
    ...
    @property
    @exception_bridge
    def moving_sheave_contact_results(self: "Self") -> "List[_1778.NodeResults]":
        """List[mastapy.math_utility.measured_vectors.NodeResults]
