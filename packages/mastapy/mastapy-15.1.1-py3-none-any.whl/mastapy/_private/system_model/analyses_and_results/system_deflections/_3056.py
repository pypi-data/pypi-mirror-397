...
class HypoidGearSetSystemDeflection(_2982.AGMAGleasonConicalGearSetSystemDeflection):
    """HypoidGearSetSystemDeflection
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4412.HypoidGearSetPowerFlow":
    ...
    def agma_gleason_conical_gears_system_deflection(
        self: "Self",
    ) -> "List[_3057.HypoidGearSystemDeflection]":
