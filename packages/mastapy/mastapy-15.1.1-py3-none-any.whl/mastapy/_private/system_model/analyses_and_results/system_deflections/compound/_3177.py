...
class ConceptGearSetCompoundSystemDeflection(_3207.GearSetCompoundSystemDeflection):
    """ConceptGearSetCompoundSystemDeflection
    ...
    def concept_gears_compound_system_deflection(
        self: "Self",
    ) -> "List[_3175.ConceptGearCompoundSystemDeflection]":
    ...
    def concept_meshes_compound_system_deflection(
        self: "Self",
    ) -> "List[_3176.ConceptGearMeshCompoundSystemDeflection]":
