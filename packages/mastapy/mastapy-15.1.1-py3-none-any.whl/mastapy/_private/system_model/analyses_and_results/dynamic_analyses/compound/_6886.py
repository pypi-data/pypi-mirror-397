...
class StraightBevelGearSetCompoundDynamicAnalysis(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6755.StraightBevelGearSetDynamicAnalysis]":
    ...
    def straight_bevel_gears_compound_dynamic_analysis(
        self: "Self",
    ) -> "List[_6884.StraightBevelGearCompoundDynamicAnalysis]":
    ...
    def straight_bevel_meshes_compound_dynamic_analysis(
        self: "Self",
    ) -> "List[_6885.StraightBevelGearMeshCompoundDynamicAnalysis]":
