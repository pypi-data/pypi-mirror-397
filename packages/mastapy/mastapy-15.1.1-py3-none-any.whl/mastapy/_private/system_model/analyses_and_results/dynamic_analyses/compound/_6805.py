...
class ConceptGearSetCompoundDynamicAnalysis(_6834.GearSetCompoundDynamicAnalysis):
    """ConceptGearSetCompoundDynamicAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6672.ConceptGearSetDynamicAnalysis]":
    ...
    def concept_gears_compound_dynamic_analysis(
        self: "Self",
    ) -> "List[_6803.ConceptGearCompoundDynamicAnalysis]":
    ...
    def concept_meshes_compound_dynamic_analysis(
        self: "Self",
    ) -> "List[_6804.ConceptGearMeshCompoundDynamicAnalysis]":
