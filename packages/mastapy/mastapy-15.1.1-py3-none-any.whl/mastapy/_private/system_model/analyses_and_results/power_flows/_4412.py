...
class HypoidGearSetPowerFlow(_4351.AGMAGleasonConicalGearSetPowerFlow):
    """HypoidGearSetPowerFlow
    ...
    def agma_gleason_conical_gears_power_flow(
        self: "Self",
    ) -> "List[_4411.HypoidGearPowerFlow]":
    ...
    @property
    @exception_bridge
    def hypoid_gears_power_flow(self: "Self") -> "List[_4411.HypoidGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.HypoidGearPowerFlow]
    ...
    def agma_gleason_conical_meshes_power_flow(
        self: "Self",
    ) -> "List[_4410.HypoidGearMeshPowerFlow]":
    ...
    @property
    @exception_bridge
    def hypoid_meshes_power_flow(self: "Self") -> "List[_4410.HypoidGearMeshPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.HypoidGearMeshPowerFlow]
