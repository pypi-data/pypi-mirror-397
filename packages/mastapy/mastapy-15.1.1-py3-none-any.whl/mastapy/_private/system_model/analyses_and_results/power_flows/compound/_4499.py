...
class BevelGearMeshCompoundPowerFlow(_4487.AGMAGleasonConicalGearMeshCompoundPowerFlow):
    """BevelGearMeshCompoundPowerFlow
    ...
    @property
    @exception_bridge
    def connection_analysis_cases(self: "Self") -> "List[_4361.BevelGearMeshPowerFlow]":
