...
class StraightBevelDiffGearSetCompoundPowerFlow(_4500.BevelGearSetCompoundPowerFlow):
    """StraightBevelDiffGearSetCompoundPowerFlow
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4459.StraightBevelDiffGearSetPowerFlow]":
    ...
    def straight_bevel_diff_gears_compound_power_flow(
        self: "Self",
    ) -> "List[_4589.StraightBevelDiffGearCompoundPowerFlow]":
    ...
    def straight_bevel_diff_meshes_compound_power_flow(
        self: "Self",
    ) -> "List[_4590.StraightBevelDiffGearMeshCompoundPowerFlow]":
