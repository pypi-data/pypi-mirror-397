...
class CylindricalGearSetCompoundPowerFlow(_4542.GearSetCompoundPowerFlow):
    """CylindricalGearSetCompoundPowerFlow
    ...
    def cylindrical_gears_compound_power_flow(
        self: "Self",
    ) -> "List[_4529.CylindricalGearCompoundPowerFlow]":
    ...
    def cylindrical_meshes_compound_power_flow(
        self: "Self",
    ) -> "List[_4530.CylindricalGearMeshCompoundPowerFlow]":
