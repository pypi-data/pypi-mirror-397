...
class PlanetCarrierCompoundPowerFlow(_4561.MountableComponentCompoundPowerFlow):
    """PlanetCarrierCompoundPowerFlow
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4435.PlanetCarrierPowerFlow]":
    ...
    @property
    @exception_bridge
    def component_analysis_cases(self: "Self") -> "List[_4435.PlanetCarrierPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.PlanetCarrierPowerFlow]
