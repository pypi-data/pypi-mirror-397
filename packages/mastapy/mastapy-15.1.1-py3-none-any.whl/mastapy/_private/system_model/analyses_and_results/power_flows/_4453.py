...
class SpiralBevelGearSetPowerFlow(_4363.BevelGearSetPowerFlow):
    """SpiralBevelGearSetPowerFlow
    ...
    @property
    @exception_bridge
    def bevel_gears_power_flow(self: "Self") -> "List[_4452.SpiralBevelGearPowerFlow]":
    ...
    def bevel_meshes_power_flow(
        self: "Self",
    ) -> "List[_4451.SpiralBevelGearMeshPowerFlow]":
