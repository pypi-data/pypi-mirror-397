...
class StraightBevelGearSetCompoundPowerFlow(_4500.BevelGearSetCompoundPowerFlow):
    """StraightBevelGearSetCompoundPowerFlow
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4462.StraightBevelGearSetPowerFlow]":
    ...
    def straight_bevel_gears_compound_power_flow(
        self: "Self",
    ) -> "List[_4592.StraightBevelGearCompoundPowerFlow]":
    ...
    def straight_bevel_meshes_compound_power_flow(
        self: "Self",
    ) -> "List[_4593.StraightBevelGearMeshCompoundPowerFlow]":
