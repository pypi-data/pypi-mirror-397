...
class MicrophoneArrayCompoundPowerFlow(_4582.SpecialisedAssemblyCompoundPowerFlow):
    """MicrophoneArrayCompoundPowerFlow
    ...
    @property
    @exception_bridge
    def component_design(self: "Self") -> "_2736.MicrophoneArray":
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4425.MicrophoneArrayPowerFlow]":
    ...
    @property
    @exception_bridge
    def assembly_analysis_cases(self: "Self") -> "List[_4425.MicrophoneArrayPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.MicrophoneArrayPowerFlow]
