...
class StraightBevelDiffGearSetPowerFlow(_4363.BevelGearSetPowerFlow):
    """StraightBevelDiffGearSetPowerFlow
    ...
    def bevel_gears_power_flow(
        self: "Self",
    ) -> "List[_4458.StraightBevelDiffGearPowerFlow]":
    ...
    def bevel_meshes_power_flow(
        self: "Self",
    ) -> "List[_4457.StraightBevelDiffGearMeshPowerFlow]":
