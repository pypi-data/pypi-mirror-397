...
class BevelDifferentialGearSetCompoundPowerFlow(_4500.BevelGearSetCompoundPowerFlow):
    """BevelDifferentialGearSetCompoundPowerFlow
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4358.BevelDifferentialGearSetPowerFlow]":
    ...
    def bevel_differential_gears_compound_power_flow(
        self: "Self",
    ) -> "List[_4493.BevelDifferentialGearCompoundPowerFlow]":
    ...
    def bevel_differential_meshes_compound_power_flow(
        self: "Self",
    ) -> "List[_4494.BevelDifferentialGearMeshCompoundPowerFlow]":
