...
class AssemblyModalAnalysisAtASpeed(_5448.AbstractAssemblyModalAnalysisAtASpeed):
    """AssemblyModalAnalysisAtASpeed
    ...
    @property
    @exception_bridge
    def bearings(self: "Self") -> "List[_5456.BearingModalAnalysisAtASpeed]":
    ...
    @property
    @exception_bridge
    def belt_drives(self: "Self") -> "List[_5458.BeltDriveModalAnalysisAtASpeed]":
    ...
    def bevel_differential_gear_sets(
        self: "Self",
    ) -> "List[_5461.BevelDifferentialGearSetModalAnalysisAtASpeed]":
    ...
    @property
    @exception_bridge
    def bolted_joints(self: "Self") -> "List[_5467.BoltedJointModalAnalysisAtASpeed]":
    ...
    @property
    @exception_bridge
    def bolts(self: "Self") -> "List[_5468.BoltModalAnalysisAtASpeed]":
    ...
    @property
    @exception_bridge
    def cv_ts(self: "Self") -> "List[_5489.CVTModalAnalysisAtASpeed]":
    ...
    @property
    @exception_bridge
    def clutches(self: "Self") -> "List[_5471.ClutchModalAnalysisAtASpeed]":
    ...
    def concept_couplings(
        self: "Self",
    ) -> "List[_5476.ConceptCouplingModalAnalysisAtASpeed]":
    ...
    def concept_gear_sets(
        self: "Self",
    ) -> "List[_5479.ConceptGearSetModalAnalysisAtASpeed]":
    ...
    def cycloidal_assemblies(
        self: "Self",
    ) -> "List[_5491.CycloidalAssemblyModalAnalysisAtASpeed]":
    ...
    def cycloidal_discs(
        self: "Self",
    ) -> "List[_5493.CycloidalDiscModalAnalysisAtASpeed]":
    ...
    @property
    @exception_bridge
    def fe_parts(self: "Self") -> "List[_5504.FEPartModalAnalysisAtASpeed]":
    ...
    @property
    @exception_bridge
    def face_gear_sets(self: "Self") -> "List[_5503.FaceGearSetModalAnalysisAtASpeed]":
    ...
    def flexible_pin_assemblies(
        self: "Self",
    ) -> "List[_5505.FlexiblePinAssemblyModalAnalysisAtASpeed]":
    ...
    def hypoid_gear_sets(
        self: "Self",
    ) -> "List[_5512.HypoidGearSetModalAnalysisAtASpeed]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: "Self",
    ) -> "List[_5519.KlingelnbergCycloPalloidHypoidGearSetModalAnalysisAtASpeed]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_5522.KlingelnbergCycloPalloidSpiralBevelGearSetModalAnalysisAtASpeed]":
    ...
    @property
    @exception_bridge
    def mass_discs(self: "Self") -> "List[_5523.MassDiscModalAnalysisAtASpeed]":
    ...
    def measurement_components(
        self: "Self",
    ) -> "List[_5524.MeasurementComponentModalAnalysisAtASpeed]":
    ...
    @property
    @exception_bridge
    def microphones(self: "Self") -> "List[_5526.MicrophoneModalAnalysisAtASpeed]":
    ...
    @property
    @exception_bridge
    def oil_seals(self: "Self") -> "List[_5529.OilSealModalAnalysisAtASpeed]":
    ...
    def planet_carriers(
        self: "Self",
    ) -> "List[_5536.PlanetCarrierModalAnalysisAtASpeed]":
    ...
    @property
    @exception_bridge
    def point_loads(self: "Self") -> "List[_5537.PointLoadModalAnalysisAtASpeed]":
    ...
    @property
    @exception_bridge
    def power_loads(self: "Self") -> "List[_5538.PowerLoadModalAnalysisAtASpeed]":
    ...
    @property
    @exception_bridge
    def ring_pins(self: "Self") -> "List[_5540.RingPinsModalAnalysisAtASpeed]":
    ...
    def rolling_ring_assemblies(
        self: "Self",
    ) -> "List[_5542.RollingRingAssemblyModalAnalysisAtASpeed]":
    ...
    def shaft_hub_connections(
        self: "Self",
    ) -> "List[_5546.ShaftHubConnectionModalAnalysisAtASpeed]":
    ...
    @property
    @exception_bridge
    def shafts(self: "Self") -> "List[_5547.ShaftModalAnalysisAtASpeed]":
    ...
    def spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_5552.SpiralBevelGearSetModalAnalysisAtASpeed]":
    ...
    @property
    @exception_bridge
    def spring_dampers(self: "Self") -> "List[_5555.SpringDamperModalAnalysisAtASpeed]":
    ...
    def straight_bevel_gear_sets(
        self: "Self",
    ) -> "List[_5561.StraightBevelGearSetModalAnalysisAtASpeed]":
    ...
    @property
    @exception_bridge
    def synchronisers(self: "Self") -> "List[_5565.SynchroniserModalAnalysisAtASpeed]":
    ...
    def torque_converters(
        self: "Self",
    ) -> "List[_5569.TorqueConverterModalAnalysisAtASpeed]":
    ...
    def unbalanced_masses(
        self: "Self",
    ) -> "List[_5572.UnbalancedMassModalAnalysisAtASpeed]":
    ...
    @property
    @exception_bridge
    def worm_gear_sets(self: "Self") -> "List[_5576.WormGearSetModalAnalysisAtASpeed]":
    ...
    def zerol_bevel_gear_sets(
        self: "Self",
    ) -> "List[_5579.ZerolBevelGearSetModalAnalysisAtASpeed]":
