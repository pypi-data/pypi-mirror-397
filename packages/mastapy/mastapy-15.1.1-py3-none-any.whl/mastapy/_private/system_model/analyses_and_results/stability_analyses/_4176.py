...
class SpiralBevelGearSetStabilityAnalysis(_4089.BevelGearSetStabilityAnalysis):
    """SpiralBevelGearSetStabilityAnalysis
    ...
    def bevel_gears_stability_analysis(
        self: "Self",
    ) -> "List[_4177.SpiralBevelGearStabilityAnalysis]":
    ...
    def bevel_meshes_stability_analysis(
        self: "Self",
    ) -> "List[_4175.SpiralBevelGearMeshStabilityAnalysis]":
