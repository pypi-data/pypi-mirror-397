...
class WormGearSetCompoundStabilityAnalysis(_4268.GearSetCompoundStabilityAnalysis):
    """WormGearSetCompoundStabilityAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4203.WormGearSetStabilityAnalysis]":
    ...
    def worm_gears_compound_stability_analysis(
        self: "Self",
    ) -> "List[_4333.WormGearCompoundStabilityAnalysis]":
    ...
    def worm_meshes_compound_stability_analysis(
        self: "Self",
    ) -> "List[_4334.WormGearMeshCompoundStabilityAnalysis]":
