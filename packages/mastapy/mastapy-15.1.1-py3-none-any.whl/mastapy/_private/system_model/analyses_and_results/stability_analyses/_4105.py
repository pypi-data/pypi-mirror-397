...
class ConicalGearSetStabilityAnalysis(_4133.GearSetStabilityAnalysis):
    """ConicalGearSetStabilityAnalysis
    ...
    def gears_stability_analysis(
        self: "Self",
    ) -> "List[_4106.ConicalGearStabilityAnalysis]":
    ...
    def meshes_stability_analysis(
        self: "Self",
    ) -> "List[_4104.ConicalGearMeshStabilityAnalysis]":
