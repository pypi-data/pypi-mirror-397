...
class CylindricalGearMeshCompoundModalAnalysis(_5112.GearMeshCompoundModalAnalysis):
    """CylindricalGearMeshCompoundModalAnalysis
    ...
    @property
    @exception_bridge
    def component_design(self: "Self") -> "_2568.CylindricalGearMesh":
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4942.CylindricalGearMeshModalAnalysis]":
