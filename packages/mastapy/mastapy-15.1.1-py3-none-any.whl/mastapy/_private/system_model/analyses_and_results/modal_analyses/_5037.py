...
class WormGearSetModalAnalysis(_4959.GearSetModalAnalysis):
    """WormGearSetModalAnalysis
    ...
    @property
    @exception_bridge
    def system_deflection_results(self: "Self") -> "_3132.WormGearSetSystemDeflection":
    ...
    @property
    @exception_bridge
    def gears_modal_analysis(self: "Self") -> "List[_5036.WormGearModalAnalysis]":
    ...
    @property
    @exception_bridge
    def worm_gears_modal_analysis(self: "Self") -> "List[_5036.WormGearModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.WormGearModalAnalysis]
    ...
    @property
    @exception_bridge
    def meshes_modal_analysis(self: "Self") -> "List[_5035.WormGearMeshModalAnalysis]":
