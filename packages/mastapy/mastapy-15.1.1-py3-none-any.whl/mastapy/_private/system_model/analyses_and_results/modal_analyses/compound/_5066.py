...
class BevelDifferentialGearSetCompoundModalAnalysis(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4907.BevelDifferentialGearSetModalAnalysis]":
    ...
    def bevel_differential_gears_compound_modal_analysis(
        self: "Self",
    ) -> "List[_5064.BevelDifferentialGearCompoundModalAnalysis]":
    ...
    def bevel_differential_meshes_compound_modal_analysis(
        self: "Self",
    ) -> "List[_5065.BevelDifferentialGearMeshCompoundModalAnalysis]":
