...
class ComponentCompoundModalAnalysis(_5134.PartCompoundModalAnalysis):
    """ComponentCompoundModalAnalysis
    ...
    @property
    @exception_bridge
    def component_analysis_cases(self: "Self") -> "List[_4919.ComponentModalAnalysis]":
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4919.ComponentModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.ComponentModalAnalysis]
