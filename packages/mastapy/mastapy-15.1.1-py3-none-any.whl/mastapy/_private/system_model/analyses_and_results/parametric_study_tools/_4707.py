...
class ParametricStudyTool(_7931.AnalysisCase):
    """ParametricStudyTool
    ...
    @property
    @exception_bridge
    def parametric_analysis_options(self: "Self") -> "_4708.ParametricStudyToolOptions":
