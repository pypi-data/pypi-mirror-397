...
class WormGearSetCompoundParametricStudyTool(_4823.GearSetCompoundParametricStudyTool):
    """WormGearSetCompoundParametricStudyTool
    ...
    @property
    @exception_bridge
    def properties_changing_all_load_cases(self: "Self") -> "_7910.WormGearSetLoadCase":
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4759.WormGearSetParametricStudyTool]":
    ...
    def worm_gears_compound_parametric_study_tool(
        self: "Self",
    ) -> "List[_4888.WormGearCompoundParametricStudyTool]":
    ...
    def worm_meshes_compound_parametric_study_tool(
        self: "Self",
    ) -> "List[_4889.WormGearMeshCompoundParametricStudyTool]":
