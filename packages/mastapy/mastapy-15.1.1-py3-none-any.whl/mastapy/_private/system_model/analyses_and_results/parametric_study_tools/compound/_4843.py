...
class OilSealCompoundParametricStudyTool(_4799.ConnectorCompoundParametricStudyTool):
    """OilSealCompoundParametricStudyTool
    ...
    @property
    @exception_bridge
    def properties_changing_all_load_cases(self: "Self") -> "_7849.OilSealLoadCase":
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4701.OilSealParametricStudyTool]":
