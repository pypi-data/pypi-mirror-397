...
class CylindricalGearSetParametricStudyTool(_4680.GearSetParametricStudyTool):
    """CylindricalGearSetParametricStudyTool
    ...
    def assembly_system_deflection_results(
        self: "Self",
    ) -> "List[_3034.CylindricalGearSetSystemDeflection]":
    ...
    def meshes_parametric_study_tool(
        self: "Self",
    ) -> "List[_4660.CylindricalGearMeshParametricStudyTool]":
