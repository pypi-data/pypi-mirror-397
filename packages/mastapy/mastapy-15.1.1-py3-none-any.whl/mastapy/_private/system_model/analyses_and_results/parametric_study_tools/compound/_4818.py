...
class FaceGearSetCompoundParametricStudyTool(_4823.GearSetCompoundParametricStudyTool):
    """FaceGearSetCompoundParametricStudyTool
    ...
    @property
    @exception_bridge
    def properties_changing_all_load_cases(self: "Self") -> "_7807.FaceGearSetLoadCase":
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4675.FaceGearSetParametricStudyTool]":
    ...
    def face_gears_compound_parametric_study_tool(
        self: "Self",
    ) -> "List[_4816.FaceGearCompoundParametricStudyTool]":
    ...
    def face_meshes_compound_parametric_study_tool(
        self: "Self",
    ) -> "List[_4817.FaceGearMeshCompoundParametricStudyTool]":
