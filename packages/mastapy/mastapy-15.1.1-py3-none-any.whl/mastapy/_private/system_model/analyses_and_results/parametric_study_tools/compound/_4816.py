...
class FaceGearCompoundParametricStudyTool(_4821.GearCompoundParametricStudyTool):
    """FaceGearCompoundParametricStudyTool
    ...
    @property
    @exception_bridge
    def properties_changing_all_load_cases(self: "Self") -> "_7805.FaceGearLoadCase":
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4674.FaceGearParametricStudyTool]":
