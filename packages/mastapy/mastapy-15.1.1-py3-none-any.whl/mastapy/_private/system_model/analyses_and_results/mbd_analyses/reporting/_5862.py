...
class _Cast_AbstractMeasuredDynamicResponseAtTime:
    ...
    def dynamic_force_result_at_time(
        self: "CastSelf",
    ) -> "_5863.DynamicForceResultAtTime":
        from mastapy._private.system_model.analyses_and_results.mbd_analyses.reporting import (
            _5863,
        )

        return self.__parent__._cast(_5863.DynamicForceResultAtTime)

    @property
    def dynamic_torque_result_at_time(
        self: "CastSelf",
    ) -> "_5865.DynamicTorqueResultAtTime":
        from mastapy._private.system_model.analyses_and_results.mbd_analyses.reporting import (
            _5865,
        )

        return self.__parent__._cast(_5865.DynamicTorqueResultAtTime)
