...
class ConceptGearSetMultibodyDynamicsAnalysis(_5776.GearSetMultibodyDynamicsAnalysis):
    """ConceptGearSetMultibodyDynamicsAnalysis
    ...
    def gears_multibody_dynamics_analysis(
        self: "Self",
    ) -> "List[_5745.ConceptGearMultibodyDynamicsAnalysis]":
    ...
    def meshes_multibody_dynamics_analysis(
        self: "Self",
    ) -> "List[_5744.ConceptGearMeshMultibodyDynamicsAnalysis]":
