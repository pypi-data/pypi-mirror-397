...
class PartSteadyStateSynchronousResponseOnAShaft(_7944.PartStaticLoadAnalysisCase):
    """PartSteadyStateSynchronousResponseOnAShaft
    ...
    @exception_bridge
    def create_viewable(self: "Self") -> "_2517.SteadyStateSynchronousResponseViewable":
