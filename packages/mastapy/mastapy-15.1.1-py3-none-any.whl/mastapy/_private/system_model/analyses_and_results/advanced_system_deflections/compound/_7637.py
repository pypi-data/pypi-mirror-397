...
class FaceGearSetCompoundAdvancedSystemDeflection(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_7504.FaceGearSetAdvancedSystemDeflection]":
    ...
    def face_gears_compound_advanced_system_deflection(
        self: "Self",
    ) -> "List[_7635.FaceGearCompoundAdvancedSystemDeflection]":
    ...
    def face_meshes_compound_advanced_system_deflection(
        self: "Self",
    ) -> "List[_7636.FaceGearMeshCompoundAdvancedSystemDeflection]":
