...
class HypoidGearSetCompoundAdvancedSystemDeflection(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_7513.HypoidGearSetAdvancedSystemDeflection]":
    ...
    def hypoid_gears_compound_advanced_system_deflection(
        self: "Self",
    ) -> "List[_7644.HypoidGearCompoundAdvancedSystemDeflection]":
    ...
    def hypoid_meshes_compound_advanced_system_deflection(
        self: "Self",
    ) -> "List[_7645.HypoidGearMeshCompoundAdvancedSystemDeflection]":
