...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.drawing import _2506, _2516, _2517
...
class _Cast_RotorDynamicsViewable:
    ...
    def critical_speed_analysis_viewable(
        self: "CastSelf",
    ) -> "_2506.CriticalSpeedAnalysisViewable":
        from mastapy._private.system_model.drawing import _2506

        return self.__parent__._cast(_2506.CriticalSpeedAnalysisViewable)

    @property
    def stability_analysis_viewable(
        self: "CastSelf",
    ) -> "_2516.StabilityAnalysisViewable":
        from mastapy._private.system_model.drawing import _2516

        return self.__parent__._cast(_2516.StabilityAnalysisViewable)

    @property
    def steady_state_synchronous_response_viewable(
        self: "CastSelf",
    ) -> "_2517.SteadyStateSynchronousResponseViewable":
        from mastapy._private.system_model.drawing import _2517

        return self.__parent__._cast(_2517.SteadyStateSynchronousResponseViewable)
...
class RotorDynamicsViewable(_0.APIBase):
    ...
    @property
    @exception_bridge
    def rotor_dynamics(self: "Self") -> "_4339.RotorDynamicsDrawStyle":
