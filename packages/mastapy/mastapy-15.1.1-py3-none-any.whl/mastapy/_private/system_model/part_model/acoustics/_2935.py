...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.acoustics import _2932, _2933
...
class _Cast_ResultSurfaceOptions:
    ...
    @property
    def result_plane_options(self: "CastSelf") -> "_2932.ResultPlaneOptions":
        from mastapy._private.system_model.part_model.acoustics import _2932

        return self.__parent__._cast(_2932.ResultPlaneOptions)

    @property
    def result_sphere_options(self: "CastSelf") -> "_2933.ResultSphereOptions":
        from mastapy._private.system_model.part_model.acoustics import _2933

        return self.__parent__._cast(_2933.ResultSphereOptions)
...
class ResultSurfaceOptions(_0.APIBase):
    ...
    @exception_bridge
    @enforce_parameter_types
    def reference_component(self: "Self", value: "_2714.Component") -> None:
        generic_type = (
    ...
    @exception_bridge
    @enforce_parameter_types
    def reference_component_type(self: "Self", value: "_2452.DesignEntityId") -> None:
