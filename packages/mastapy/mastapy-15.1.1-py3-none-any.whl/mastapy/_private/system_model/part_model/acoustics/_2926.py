...
class _Cast_MeshedResultSurfaceBase:
    ...
    @property
    def meshed_reflecting_plane(self: "CastSelf") -> "_2922.MeshedReflectingPlane":
        from mastapy._private.system_model.part_model.acoustics import _2922

        return self.__parent__._cast(_2922.MeshedReflectingPlane)
    ...
    @property
    def meshed_result_surface(self: "CastSelf") -> "_2925.MeshedResultSurface":
        from mastapy._private.system_model.part_model.acoustics import _2925

        return self.__parent__._cast(_2925.MeshedResultSurface)
