...
class StraightBevelDiffGearSet(_2801.BevelGearSet):
    """StraightBevelDiffGearSet
    ...
    @property
    @exception_bridge
    def straight_bevel_diff_gears(self: "Self") -> "List[_2827.StraightBevelDiffGear]":
    ...
    def straight_bevel_diff_meshes(
        self: "Self",
    ) -> "List[_2584.StraightBevelDiffGearMesh]":
