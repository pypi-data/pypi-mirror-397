...
class Overridable_WidthSeries(mixins.OverridableMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls: "Type[Overridable_WidthSeries]") -> "_2423.WidthSeries":
    ...
    def implicit_type(cls: "Type[Overridable_WidthSeries]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2423.WidthSeries.type_()

    @property
    @exception_bridge
    def value(self: "Self") -> "_2423.WidthSeries":
    ...
    @property
    @exception_bridge
    def override_value(self: "Self") -> "_2423.WidthSeries":
        """mastapy.bearings.bearing_designs.rolling.WidthSeries
    ...
    @property
    @exception_bridge
    def calculated_value(self: "Self") -> "_2423.WidthSeries":
        """mastapy.bearings.bearing_designs.rolling.WidthSeries
