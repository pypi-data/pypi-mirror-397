...
class Overridable_NodeSelectionDepthOption(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
    ...
    ) -> "_2668.NodeSelectionDepthOption":
        ...
        Returns:
            _2668.NodeSelectionDepthOption
        """
        return _2668.NodeSelectionDepthOption
    ...
    def implicit_type(cls: "Type[Overridable_NodeSelectionDepthOption]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2668.NodeSelectionDepthOption.type_()

    @property
    @exception_bridge
    def value(self: "Self") -> "_2668.NodeSelectionDepthOption":
    ...
    @property
    @exception_bridge
    def override_value(self: "Self") -> "_2668.NodeSelectionDepthOption":
        """mastapy.system_model.fe.NodeSelectionDepthOption
    ...
    @property
    @exception_bridge
    def calculated_value(self: "Self") -> "_2668.NodeSelectionDepthOption":
        """mastapy.system_model.fe.NodeSelectionDepthOption
