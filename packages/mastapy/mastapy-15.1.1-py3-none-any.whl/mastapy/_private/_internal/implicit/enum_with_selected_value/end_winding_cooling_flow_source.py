...
class EnumWithSelectedValue_EndWindingCoolingFlowSource(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_EndWindingCoolingFlowSource]",
    ) -> "_1493.EndWindingCoolingFlowSource":
        ...
        Returns:
            _1493.EndWindingCoolingFlowSource
        """
        return _1493.EndWindingCoolingFlowSource
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1493.EndWindingCoolingFlowSource.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_1493.EndWindingCoolingFlowSource":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_1493.EndWindingCoolingFlowSource]":
