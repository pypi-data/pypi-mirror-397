...
class EnumWithSelectedValue_ProSolveSolverType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _1388.ProSolveSolverType
        """
        return _1388.ProSolveSolverType
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_ProSolveSolverType]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1388.ProSolveSolverType.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_1388.ProSolveSolverType":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_1388.ProSolveSolverType]":
