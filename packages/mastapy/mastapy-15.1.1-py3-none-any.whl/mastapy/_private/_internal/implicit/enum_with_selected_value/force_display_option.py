...
class EnumWithSelectedValue_ForceDisplayOption(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _1590.ForceDisplayOption
        """
        return _1590.ForceDisplayOption
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_ForceDisplayOption]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1590.ForceDisplayOption.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_1590.ForceDisplayOption":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_1590.ForceDisplayOption]":
