...
class EnumWithSelectedValue_DynamicsResponseScaling(
    ...
    def wrapped_type(
        ...
        Returns:
            _1717.DynamicsResponseScaling
        """
        return _1717.DynamicsResponseScaling
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1717.DynamicsResponseScaling.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_1717.DynamicsResponseScaling":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_1717.DynamicsResponseScaling]":
