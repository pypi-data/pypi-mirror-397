...
class EnumWithSelectedValue_TorqueConverterLockupRule(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_TorqueConverterLockupRule]",
    ) -> "_5848.TorqueConverterLockupRule":
        ...
        Returns:
            _5848.TorqueConverterLockupRule
        """
        return _5848.TorqueConverterLockupRule
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _5848.TorqueConverterLockupRule.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_5848.TorqueConverterLockupRule":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_5848.TorqueConverterLockupRule]":
