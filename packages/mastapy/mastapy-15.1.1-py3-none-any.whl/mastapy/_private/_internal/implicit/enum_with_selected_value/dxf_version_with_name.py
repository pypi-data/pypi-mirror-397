...
class EnumWithSelectedValue_DxfVersionWithName(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _2068.DxfVersionWithName
        """
        return _2068.DxfVersionWithName
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_DxfVersionWithName]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2068.DxfVersionWithName.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_2068.DxfVersionWithName":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_2068.DxfVersionWithName]":
