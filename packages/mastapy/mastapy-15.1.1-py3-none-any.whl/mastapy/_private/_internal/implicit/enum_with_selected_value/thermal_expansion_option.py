...
class EnumWithSelectedValue_ThermalExpansionOption(
    ...
    def wrapped_type(
        ...
        Returns:
            _2679.ThermalExpansionOption
        """
        return _2679.ThermalExpansionOption
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2679.ThermalExpansionOption.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_2679.ThermalExpansionOption":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_2679.ThermalExpansionOption]":
