...
class EnumWithSelectedValue_DampingSpecification(
    ...
    def wrapped_type(
        ...
        Returns:
            _6073.DampingSpecification
        """
        return _6073.DampingSpecification
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_DampingSpecification]") -> "Any":
        ...
        Returns:
            Any
        """
        return _6073.DampingSpecification.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_6073.DampingSpecification":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_6073.DampingSpecification]":
