...
class EnumWithSelectedValue_TorqueRippleInputType(
    ...
    def wrapped_type(
        ...
        Returns:
            _7902.TorqueRippleInputType
        """
        return _7902.TorqueRippleInputType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _7902.TorqueRippleInputType.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_7902.TorqueRippleInputType":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_7902.TorqueRippleInputType]":
