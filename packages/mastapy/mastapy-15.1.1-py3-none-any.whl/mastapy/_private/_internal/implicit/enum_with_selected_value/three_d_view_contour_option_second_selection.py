...
class EnumWithSelectedValue_ThreeDViewContourOptionSecondSelection(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_ThreeDViewContourOptionSecondSelection]",
    ) -> "_2054.ThreeDViewContourOptionSecondSelection":
        ...
        Returns:
            _2054.ThreeDViewContourOptionSecondSelection
        """
        return _2054.ThreeDViewContourOptionSecondSelection
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2054.ThreeDViewContourOptionSecondSelection.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_2054.ThreeDViewContourOptionSecondSelection":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_2054.ThreeDViewContourOptionSecondSelection]":
