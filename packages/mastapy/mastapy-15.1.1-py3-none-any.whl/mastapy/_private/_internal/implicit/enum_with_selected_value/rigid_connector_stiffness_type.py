...
class EnumWithSelectedValue_RigidConnectorStiffnessType(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_RigidConnectorStiffnessType]",
    ) -> "_2877.RigidConnectorStiffnessType":
        ...
        Returns:
            _2877.RigidConnectorStiffnessType
        """
        return _2877.RigidConnectorStiffnessType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2877.RigidConnectorStiffnessType.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_2877.RigidConnectorStiffnessType":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_2877.RigidConnectorStiffnessType]":
