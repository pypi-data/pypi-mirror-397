...
class EnumWithSelectedValue_DudleyEffectiveLengthApproximationOption(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_DudleyEffectiveLengthApproximationOption]",
    ) -> "_1606.DudleyEffectiveLengthApproximationOption":
        ...
        Returns:
            _1606.DudleyEffectiveLengthApproximationOption
        """
        return _1606.DudleyEffectiveLengthApproximationOption
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1606.DudleyEffectiveLengthApproximationOption.type_()
    ...
    def available_values(
        self: "Self",
    ) -> "List[_1606.DudleyEffectiveLengthApproximationOption]":
