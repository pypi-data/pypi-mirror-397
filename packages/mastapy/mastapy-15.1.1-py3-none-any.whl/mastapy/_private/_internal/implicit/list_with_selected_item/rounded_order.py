...
class ListWithSelectedItem_RoundedOrder(
    _1745.RoundedOrder, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_RoundedOrder]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1745.RoundedOrder.TYPE

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_1745.RoundedOrder":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_1745.RoundedOrder]":
