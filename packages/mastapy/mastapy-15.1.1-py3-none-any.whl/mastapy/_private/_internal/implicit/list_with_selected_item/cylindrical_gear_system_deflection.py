...
class ListWithSelectedItem_CylindricalGearSystemDeflection(
    _3037.CylindricalGearSystemDeflection, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _3037.CylindricalGearSystemDeflection.TYPE

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_3037.CylindricalGearSystemDeflection":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_3037.CylindricalGearSystemDeflection]":
