...
class ListWithSelectedItem_SystemDirectory(
    _1824.SystemDirectory, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_SystemDirectory]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1824.SystemDirectory.TYPE

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_1824.SystemDirectory":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_1824.SystemDirectory]":
