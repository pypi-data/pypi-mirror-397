...
class ListWithSelectedItem_ElectricMachineDataImportType(
    ...
    def wrapped_type(
        cls: "Type[ListWithSelectedItem_ElectricMachineDataImportType]",
    ) -> "_7791.ElectricMachineDataImportType":
        ...
        Returns:
            _7791.ElectricMachineDataImportType
        """
        return _7791.ElectricMachineDataImportType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _7791.ElectricMachineDataImportType.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_7791.ElectricMachineDataImportType":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_7791.ElectricMachineDataImportType]":
