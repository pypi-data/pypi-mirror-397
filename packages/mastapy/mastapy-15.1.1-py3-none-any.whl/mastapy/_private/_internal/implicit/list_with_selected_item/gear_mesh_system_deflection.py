...
class ListWithSelectedItem_GearMeshSystemDeflection(
    _3051.GearMeshSystemDeflection, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _3051.GearMeshSystemDeflection.TYPE

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_3051.GearMeshSystemDeflection":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_3051.GearMeshSystemDeflection]":
