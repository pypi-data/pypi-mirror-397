...
class ListWithSelectedItem_ElectricMachineSetup(
    _1420.ElectricMachineSetup, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_ElectricMachineSetup]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1420.ElectricMachineSetup.TYPE

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_1420.ElectricMachineSetup":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_1420.ElectricMachineSetup]":
