...
class ListWithSelectedItem_DesignState(
    _6005.DesignState, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_DesignState]") -> "Any":
        ...
        Returns:
            Any
        """
        return _6005.DesignState.TYPE

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_6005.DesignState":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_6005.DesignState]":
