...
from mastapy._private.system_model.fe import _2677
...
class ListWithSelectedItem_SelectableNodeAtAngle(
    _2677.SelectableNodeAtAngle, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_SelectableNodeAtAngle]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2677.SelectableNodeAtAngle.TYPE

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_2677.SelectableNodeAtAngle":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_2677.SelectableNodeAtAngle]":
