...
class ListWithSelectedItem_DutyCycle(_6006.DutyCycle, mixins.ListWithSelectedItemMixin):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_DutyCycle]") -> "Any":
        ...
        Returns:
            Any
        """
        return _6006.DutyCycle.TYPE

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_6006.DutyCycle":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_6006.DutyCycle]":
