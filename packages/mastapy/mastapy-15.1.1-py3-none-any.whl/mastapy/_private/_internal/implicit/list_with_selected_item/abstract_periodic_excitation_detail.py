...
class ListWithSelectedItem_AbstractPeriodicExcitationDetail(
    _6021.AbstractPeriodicExcitationDetail, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _6021.AbstractPeriodicExcitationDetail.TYPE

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_6021.AbstractPeriodicExcitationDetail":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_6021.AbstractPeriodicExcitationDetail]":
