...
class ListWithSelectedItem_SimpleElectricMachineTooth(
    _1594.SimpleElectricMachineTooth, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1594.SimpleElectricMachineTooth.TYPE

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_1594.SimpleElectricMachineTooth":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_1594.SimpleElectricMachineTooth]":
