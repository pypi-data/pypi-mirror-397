...
class ListWithSelectedItem_AcousticAnalysisSetup(
    _2911.AcousticAnalysisSetup, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_AcousticAnalysisSetup]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2911.AcousticAnalysisSetup.TYPE

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_2911.AcousticAnalysisSetup":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_2911.AcousticAnalysisSetup]":
