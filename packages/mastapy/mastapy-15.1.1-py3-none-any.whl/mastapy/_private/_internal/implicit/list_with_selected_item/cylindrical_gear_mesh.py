...
class ListWithSelectedItem_CylindricalGearMesh(
    _2568.CylindricalGearMesh, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_CylindricalGearMesh]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2568.CylindricalGearMesh.TYPE

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_2568.CylindricalGearMesh":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_2568.CylindricalGearMesh]":
