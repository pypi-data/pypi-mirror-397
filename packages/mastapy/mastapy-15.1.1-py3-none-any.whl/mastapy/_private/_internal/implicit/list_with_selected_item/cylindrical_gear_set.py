...
class ListWithSelectedItem_CylindricalGearSet(
    _2807.CylindricalGearSet, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_CylindricalGearSet]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2807.CylindricalGearSet.TYPE

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_2807.CylindricalGearSet":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_2807.CylindricalGearSet]":
