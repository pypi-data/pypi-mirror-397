...
class _Cast_LoadedBearingResults:
    ...
    def loaded_linear_bearing_results(
        self: "CastSelf",
    ) -> "_2195.LoadedLinearBearingResults":
        from mastapy._private.bearings.bearing_results import _2195

        return self.__parent__._cast(_2195.LoadedLinearBearingResults)
...
class LoadedBearingResults(_2112.BearingLoadCaseResultsLightweight):
    """LoadedBearingResults
    ...
    @property
    @exception_bridge
    def bearing(self: "Self") -> "_2377.BearingDesign":
    ...
    @property
    @exception_bridge
    def ring_results(self: "Self") -> "List[_2313.RingForceAndDisplacement]":
