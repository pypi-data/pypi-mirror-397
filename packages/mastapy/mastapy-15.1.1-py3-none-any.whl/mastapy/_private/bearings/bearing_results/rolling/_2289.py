...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results import _2188, _2196, _2199
...
class LoadedTaperRollerBearingDutyCycle(_2265.LoadedNonBarrelRollerBearingDutyCycle):
    """LoadedTaperRollerBearingDutyCycle
