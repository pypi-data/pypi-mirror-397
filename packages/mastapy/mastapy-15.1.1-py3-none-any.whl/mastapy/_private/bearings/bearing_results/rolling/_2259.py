...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2213, _2276
...
class LoadedFourPointContactBallBearingResults(_2244.LoadedBallBearingResults):
    """LoadedFourPointContactBallBearingResults
    ...
    @property
    @exception_bridge
    def raceway_control(self: "Self") -> "_2213.FrictionModelForGyroscopicMoment":
