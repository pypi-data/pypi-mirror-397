...
class ProfileSet(_0.APIBase):
    ...
    @property
    @exception_bridge
    def active_profile_type(self: "Self") -> "_2128.RollerBearingProfileTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings._2128", "RollerBearingProfileTypes"
        )(value)
    ...
    def active_profile_type(
        self: "Self", value: "_2128.RollerBearingProfileTypes"
    ) -> None:
    ...
    @property
    @exception_bridge
    def active_profile(self: "Self") -> "_2175.RollerBearingProfile":
