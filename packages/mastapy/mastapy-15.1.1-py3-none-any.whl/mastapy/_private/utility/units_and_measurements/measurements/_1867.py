...
class _Cast_Force:
    ...
    @property
    def measurement_base(self: "CastSelf") -> "_1829.MeasurementBase":
        return self.__parent__._cast(_1829.MeasurementBase)
...
class Force(_1829.MeasurementBase):
    """Force
    ...
    @property
    @exception_bridge
    def kilograms_force(self: "Self") -> "_1834.Unit":
    ...
    @property
    @exception_bridge
    def kilonewtons(self: "Self") -> "_1834.Unit":
        """mastapy.utility.units_and_measurements.Unit
    ...
    @property
    @exception_bridge
    def millinewtons(self: "Self") -> "_1834.Unit":
        """mastapy.utility.units_and_measurements.Unit
    ...
    @property
    @exception_bridge
    def newtons(self: "Self") -> "_1834.Unit":
        """mastapy.utility.units_and_measurements.Unit
    ...
    @property
    @exception_bridge
    def ounces_force(self: "Self") -> "_1834.Unit":
        """mastapy.utility.units_and_measurements.Unit
    ...
    @property
    @exception_bridge
    def pounds_force(self: "Self") -> "_1834.Unit":
        """mastapy.utility.units_and_measurements.Unit
