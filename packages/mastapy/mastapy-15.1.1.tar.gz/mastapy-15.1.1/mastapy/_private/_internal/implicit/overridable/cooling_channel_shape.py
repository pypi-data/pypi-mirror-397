...
class Overridable_CoolingChannelShape(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _1404.CoolingChannelShape
        """
        return _1404.CoolingChannelShape
    ...
    def implicit_type(cls: "Type[Overridable_CoolingChannelShape]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1404.CoolingChannelShape.type_()

    @property
    @exception_bridge
    def value(self: "Self") -> "_1404.CoolingChannelShape":
    ...
    @property
    @exception_bridge
    def override_value(self: "Self") -> "_1404.CoolingChannelShape":
        """mastapy.electric_machines.CoolingChannelShape
    ...
    @property
    @exception_bridge
    def calculated_value(self: "Self") -> "_1404.CoolingChannelShape":
        """mastapy.electric_machines.CoolingChannelShape
