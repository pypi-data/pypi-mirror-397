...
class ListWithSelectedItem_ElectricMachineResults(
    _1537.ElectricMachineResults, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1537.ElectricMachineResults.TYPE

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_1537.ElectricMachineResults":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_1537.ElectricMachineResults]":
