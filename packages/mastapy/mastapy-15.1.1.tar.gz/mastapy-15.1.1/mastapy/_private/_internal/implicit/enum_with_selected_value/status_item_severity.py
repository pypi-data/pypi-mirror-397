...
class EnumWithSelectedValue_StatusItemSeverity(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _2022.StatusItemSeverity
        """
        return _2022.StatusItemSeverity
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_StatusItemSeverity]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2022.StatusItemSeverity.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_2022.StatusItemSeverity":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_2022.StatusItemSeverity]":
