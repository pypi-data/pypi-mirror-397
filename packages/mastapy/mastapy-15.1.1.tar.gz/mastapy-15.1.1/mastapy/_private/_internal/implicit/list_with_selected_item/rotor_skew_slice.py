...
class ListWithSelectedItem_RotorSkewSlice(
    _1458.RotorSkewSlice, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_RotorSkewSlice]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1458.RotorSkewSlice.TYPE

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_1458.RotorSkewSlice":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_1458.RotorSkewSlice]":
