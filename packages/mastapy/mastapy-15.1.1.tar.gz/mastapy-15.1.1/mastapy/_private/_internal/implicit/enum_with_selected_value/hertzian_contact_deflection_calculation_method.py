...
class EnumWithSelectedValue_HertzianContactDeflectionCalculationMethod(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_HertzianContactDeflectionCalculationMethod]",
    ) -> "_1798.HertzianContactDeflectionCalculationMethod":
        ...
        Returns:
            _1798.HertzianContactDeflectionCalculationMethod
        """
        return _1798.HertzianContactDeflectionCalculationMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1798.HertzianContactDeflectionCalculationMethod.type_()
    ...
    def available_values(
        self: "Self",
    ) -> "List[_1798.HertzianContactDeflectionCalculationMethod]":
