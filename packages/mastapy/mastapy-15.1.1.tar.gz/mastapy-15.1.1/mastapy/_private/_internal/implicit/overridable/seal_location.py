...
class Overridable_SealLocation(mixins.OverridableMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls: "Type[Overridable_SealLocation]") -> "_2135.SealLocation":
    ...
    def implicit_type(cls: "Type[Overridable_SealLocation]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2135.SealLocation.type_()

    @property
    @exception_bridge
    def value(self: "Self") -> "_2135.SealLocation":
    ...
    @property
    @exception_bridge
    def override_value(self: "Self") -> "_2135.SealLocation":
        """mastapy.bearings.SealLocation
    ...
    @property
    @exception_bridge
    def calculated_value(self: "Self") -> "_2135.SealLocation":
        """mastapy.bearings.SealLocation
