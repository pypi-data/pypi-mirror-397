...
class EnumWithSelectedValue_HarmonicLoadDataType(
    ...
    def wrapped_type(
        ...
        Returns:
            _1593.HarmonicLoadDataType
        """
        return _1593.HarmonicLoadDataType
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_HarmonicLoadDataType]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1593.HarmonicLoadDataType.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_1593.HarmonicLoadDataType":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_1593.HarmonicLoadDataType]":
