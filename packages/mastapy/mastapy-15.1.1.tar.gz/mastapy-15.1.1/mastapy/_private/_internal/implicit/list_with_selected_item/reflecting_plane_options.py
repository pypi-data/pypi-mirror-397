...
class ListWithSelectedItem_ReflectingPlaneOptions(
    _2931.ReflectingPlaneOptions, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2931.ReflectingPlaneOptions.TYPE

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_2931.ReflectingPlaneOptions":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_2931.ReflectingPlaneOptions]":
