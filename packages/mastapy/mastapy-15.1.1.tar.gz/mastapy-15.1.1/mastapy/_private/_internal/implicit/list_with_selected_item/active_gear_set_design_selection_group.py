...
class ListWithSelectedItem_ActiveGearSetDesignSelectionGroup(
    _2793.ActiveGearSetDesignSelectionGroup, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2793.ActiveGearSetDesignSelectionGroup.TYPE

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_2793.ActiveGearSetDesignSelectionGroup":
