...
from mastapy._private.math_utility.hertzian_contact import _1797
...
class Overridable_ContactDampingModel(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _1797.ContactDampingModel
        """
        return _1797.ContactDampingModel
    ...
    def implicit_type(cls: "Type[Overridable_ContactDampingModel]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1797.ContactDampingModel.type_()

    @property
    @exception_bridge
    def value(self: "Self") -> "_1797.ContactDampingModel":
    ...
    @property
    @exception_bridge
    def override_value(self: "Self") -> "_1797.ContactDampingModel":
        """mastapy.math_utility.hertzian_contact.ContactDampingModel
    ...
    @property
    @exception_bridge
    def calculated_value(self: "Self") -> "_1797.ContactDampingModel":
        """mastapy.math_utility.hertzian_contact.ContactDampingModel
