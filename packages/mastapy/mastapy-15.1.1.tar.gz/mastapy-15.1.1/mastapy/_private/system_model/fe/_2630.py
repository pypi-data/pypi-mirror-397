...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.fe import _2631, _2632
...
class _Cast_DegreeOfFreedomBoundaryCondition:
    ...
    def degree_of_freedom_boundary_condition_angular(
        self: "CastSelf",
    ) -> "_2631.DegreeOfFreedomBoundaryConditionAngular":
        from mastapy._private.system_model.fe import _2631

        return self.__parent__._cast(_2631.DegreeOfFreedomBoundaryConditionAngular)

    @property
    def degree_of_freedom_boundary_condition_linear(
        self: "CastSelf",
    ) -> "_2632.DegreeOfFreedomBoundaryConditionLinear":
        from mastapy._private.system_model.fe import _2632

        return self.__parent__._cast(_2632.DegreeOfFreedomBoundaryConditionLinear)
