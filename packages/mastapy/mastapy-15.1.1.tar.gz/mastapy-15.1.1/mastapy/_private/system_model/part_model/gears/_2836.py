...
class ZerolBevelGearSet(_2801.BevelGearSet):
    """ZerolBevelGearSet
    ...
    @property
    @exception_bridge
    def zerol_bevel_gears(self: "Self") -> "List[_2835.ZerolBevelGear]":
    ...
    @property
    @exception_bridge
    def zerol_bevel_meshes(self: "Self") -> "List[_2590.ZerolBevelGearMesh]":
