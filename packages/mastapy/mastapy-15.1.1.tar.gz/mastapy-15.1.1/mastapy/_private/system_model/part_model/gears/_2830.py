...
class StraightBevelGearSet(_2801.BevelGearSet):
    """StraightBevelGearSet
    ...
    @property
    @exception_bridge
    def straight_bevel_gears(self: "Self") -> "List[_2829.StraightBevelGear]":
    ...
    @property
    @exception_bridge
    def straight_bevel_meshes(self: "Self") -> "List[_2586.StraightBevelGearMesh]":
