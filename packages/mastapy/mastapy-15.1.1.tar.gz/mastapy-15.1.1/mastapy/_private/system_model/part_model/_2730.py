...
from mastapy._private.bearings.tolerances import _2139, _2141
...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model import _2707, _2748
...
class _Cast_InternalClearanceTolerance:
    ...
    def axial_internal_clearance_tolerance(
        ...
        return self.__parent__._cast(_2707.AxialInternalClearanceTolerance)
    ...
    def radial_internal_clearance_tolerance(
        ...
        return self.__parent__._cast(_2748.RadialInternalClearanceTolerance)
...
class InternalClearanceTolerance(_0.APIBase):
    ...
    def clearance_class(self: "Self", value: "_2139.InternalClearanceClass") -> None:
