...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.gears import _2804, _2811
...
class KlingelnbergCycloPalloidHypoidGear(_2817.KlingelnbergCycloPalloidConicalGear):
    """KlingelnbergCycloPalloidHypoidGear
