...
class SpiralBevelGearSet(_2801.BevelGearSet):
    """SpiralBevelGearSet
    ...
    @property
    @exception_bridge
    def spiral_bevel_gears(self: "Self") -> "List[_2825.SpiralBevelGear]":
    ...
    @property
    @exception_bridge
    def spiral_bevel_meshes(self: "Self") -> "List[_2582.SpiralBevelGearMesh]":
