...
class ConceptGearSetCompoundCriticalSpeedAnalysis(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6942.ConceptGearSetCriticalSpeedAnalysis]":
    ...
    def concept_gears_compound_critical_speed_analysis(
        self: "Self",
    ) -> "List[_7074.ConceptGearCompoundCriticalSpeedAnalysis]":
    ...
    def concept_meshes_compound_critical_speed_analysis(
        self: "Self",
    ) -> "List[_7075.ConceptGearMeshCompoundCriticalSpeedAnalysis]":
