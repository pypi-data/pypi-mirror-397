...
class CVTCompoundSystemDeflection(_3156.BeltDriveCompoundSystemDeflection):
    """CVTCompoundSystemDeflection
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3026.CVTSystemDeflection]":
    ...
    @property
    @exception_bridge
    def assembly_analysis_cases(self: "Self") -> "List[_3026.CVTSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.CVTSystemDeflection]
