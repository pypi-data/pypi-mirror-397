...
class ZerolBevelGearSetCompoundAdvancedSystemDeflection(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_7581.ZerolBevelGearSetAdvancedSystemDeflection]":
    ...
    def zerol_bevel_gears_compound_advanced_system_deflection(
        self: "Self",
    ) -> "List[_7710.ZerolBevelGearCompoundAdvancedSystemDeflection]":
    ...
    def zerol_bevel_meshes_compound_advanced_system_deflection(
        self: "Self",
    ) -> "List[_7711.ZerolBevelGearMeshCompoundAdvancedSystemDeflection]":
