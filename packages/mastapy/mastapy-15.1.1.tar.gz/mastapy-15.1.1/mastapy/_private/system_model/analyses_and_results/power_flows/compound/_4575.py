...
class RollingRingAssemblyCompoundPowerFlow(_4582.SpecialisedAssemblyCompoundPowerFlow):
    """RollingRingAssemblyCompoundPowerFlow
    ...
    @property
    @exception_bridge
    def component_design(self: "Self") -> "_2883.RollingRingAssembly":
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4443.RollingRingAssemblyPowerFlow]":
