...
class CylindricalGearSetCompoundDynamicAnalysis(_6834.GearSetCompoundDynamicAnalysis):
    """CylindricalGearSetCompoundDynamicAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6690.CylindricalGearSetDynamicAnalysis]":
    ...
    def cylindrical_gears_compound_dynamic_analysis(
        self: "Self",
    ) -> "List[_6821.CylindricalGearCompoundDynamicAnalysis]":
    ...
    def cylindrical_meshes_compound_dynamic_analysis(
        self: "Self",
    ) -> "List[_6822.CylindricalGearMeshCompoundDynamicAnalysis]":
