...
class SpiralBevelGearSetSystemDeflection(_2999.BevelGearSetSystemDeflection):
    """SpiralBevelGearSetSystemDeflection
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4453.SpiralBevelGearSetPowerFlow":
    ...
    def bevel_gears_system_deflection(
        self: "Self",
    ) -> "List[_3103.SpiralBevelGearSystemDeflection]":
    ...
    def bevel_meshes_system_deflection(
        self: "Self",
    ) -> "List[_3101.SpiralBevelGearMeshSystemDeflection]":
