...
class HypoidGearSetCompoundHarmonicAnalysisOfSingleExcitation(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6433.HypoidGearSetHarmonicAnalysisOfSingleExcitation]":
    ...
    def hypoid_gears_compound_harmonic_analysis_of_single_excitation(
        self: "Self",
    ) -> "List[_6563.HypoidGearCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def hypoid_meshes_compound_harmonic_analysis_of_single_excitation(
        self: "Self",
    ) -> "List[_6564.HypoidGearMeshCompoundHarmonicAnalysisOfSingleExcitation]":
