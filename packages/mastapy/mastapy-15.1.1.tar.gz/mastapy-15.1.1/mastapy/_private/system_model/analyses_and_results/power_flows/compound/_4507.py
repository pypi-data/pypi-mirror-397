...
class ComponentCompoundPowerFlow(_4563.PartCompoundPowerFlow):
    """ComponentCompoundPowerFlow
    ...
    @property
    @exception_bridge
    def component_analysis_cases(self: "Self") -> "List[_4370.ComponentPowerFlow]":
