...
class OilSealHarmonicAnalysis(_6058.ConnectorHarmonicAnalysis):
    """OilSealHarmonicAnalysis
    ...
    @property
    @exception_bridge
    def component_load_case(self: "Self") -> "_7849.OilSealLoadCase":
    ...
    @property
    @exception_bridge
    def system_deflection_results(self: "Self") -> "_3078.OilSealSystemDeflection":
