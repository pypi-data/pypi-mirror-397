...
class AbstractAssemblySystemDeflection(_3079.PartSystemDeflection):
    """AbstractAssemblySystemDeflection
    ...
    def rigidly_connected_groups(
        self: "Self",
    ) -> "List[_3143.RigidlyConnectedComponentGroupSystemDeflection]":
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4345.AbstractAssemblyPowerFlow":
