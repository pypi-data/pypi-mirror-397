...
class WormGearSetDynamicAnalysis(_6703.GearSetDynamicAnalysis):
    """WormGearSetDynamicAnalysis
    ...
    @property
    @exception_bridge
    def gears_dynamic_analysis(self: "Self") -> "List[_6768.WormGearDynamicAnalysis]":
    ...
    def meshes_dynamic_analysis(
        self: "Self",
    ) -> "List[_6769.WormGearMeshDynamicAnalysis]":
