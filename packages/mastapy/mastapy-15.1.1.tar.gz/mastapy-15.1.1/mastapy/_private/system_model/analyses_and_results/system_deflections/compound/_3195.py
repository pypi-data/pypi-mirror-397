...
class CylindricalGearSetCompoundSystemDeflection(_3207.GearSetCompoundSystemDeflection):
    """CylindricalGearSetCompoundSystemDeflection
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3036.CylindricalGearSetSystemDeflectionWithLTCAResults]":
    ...
    def cylindrical_gears_compound_system_deflection(
        self: "Self",
    ) -> "List[_3193.CylindricalGearCompoundSystemDeflection]":
    ...
    def cylindrical_meshes_compound_system_deflection(
        self: "Self",
    ) -> "List[_3194.CylindricalGearMeshCompoundSystemDeflection]":
