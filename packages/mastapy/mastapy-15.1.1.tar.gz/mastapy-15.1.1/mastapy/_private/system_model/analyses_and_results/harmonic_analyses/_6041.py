...
class BoltHarmonicAnalysis(_6047.ComponentHarmonicAnalysis):
    """BoltHarmonicAnalysis
    ...
    @property
    @exception_bridge
    def component_load_case(self: "Self") -> "_7752.BoltLoadCase":
    ...
    @property
    @exception_bridge
    def system_deflection_results(self: "Self") -> "_3002.BoltSystemDeflection":
