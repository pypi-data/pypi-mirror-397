...
class ZerolBevelGearSetStabilityAnalysis(_4089.BevelGearSetStabilityAnalysis):
    """ZerolBevelGearSetStabilityAnalysis
    ...
    def bevel_gears_stability_analysis(
        self: "Self",
    ) -> "List[_4207.ZerolBevelGearStabilityAnalysis]":
    ...
    def bevel_meshes_stability_analysis(
        self: "Self",
    ) -> "List[_4205.ZerolBevelGearMeshStabilityAnalysis]":
