...
class BevelDifferentialGearSetCompoundCriticalSpeedAnalysis(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6924.BevelDifferentialGearSetCriticalSpeedAnalysis]":
    ...
    def bevel_differential_gears_compound_critical_speed_analysis(
        self: "Self",
    ) -> "List[_7056.BevelDifferentialGearCompoundCriticalSpeedAnalysis]":
    ...
    def bevel_differential_meshes_compound_critical_speed_analysis(
        self: "Self",
    ) -> "List[_7057.BevelDifferentialGearMeshCompoundCriticalSpeedAnalysis]":
