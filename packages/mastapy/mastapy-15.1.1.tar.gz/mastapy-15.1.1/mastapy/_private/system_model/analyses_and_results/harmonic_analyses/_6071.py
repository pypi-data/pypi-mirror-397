...
class CylindricalGearSetHarmonicAnalysis(_6101.GearSetHarmonicAnalysis):
    """CylindricalGearSetHarmonicAnalysis
    ...
    def gears_harmonic_analysis(
        self: "Self",
    ) -> "List[_6069.CylindricalGearHarmonicAnalysis]":
    ...
    def meshes_harmonic_analysis(
        self: "Self",
    ) -> "List[_6070.CylindricalGearMeshHarmonicAnalysis]":
