...
class GearMultibodyDynamicsAnalysis(_5802.MountableComponentMultibodyDynamicsAnalysis):
    """GearMultibodyDynamicsAnalysis
    ...
    @property
    @exception_bridge
    def peak_gear_torque(self: "Self") -> "List[_5865.DynamicTorqueResultAtTime]":
