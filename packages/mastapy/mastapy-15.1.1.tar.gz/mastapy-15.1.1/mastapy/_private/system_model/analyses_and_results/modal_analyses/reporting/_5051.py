...
class _Cast_SingleExcitationResultsModalAnalysis:
    ...
    def design_entity_modal_analysis_group_results(
        self: "CastSelf",
    ) -> "_5044.DesignEntityModalAnalysisGroupResults":
        return self.__parent__._cast(_5044.DesignEntityModalAnalysisGroupResults)
...
class SingleExcitationResultsModalAnalysis(_5044.DesignEntityModalAnalysisGroupResults):
    """SingleExcitationResultsModalAnalysis
    ...
    def all_rigidly_connected_groups(
        ...
        "List[_5047.RigidlyConnectedDesignEntityGroupForSingleExcitationModalAnalysis]"
    ):
