...
class WormGearSetCompoundDynamicAnalysis(_6834.GearSetCompoundDynamicAnalysis):
    """WormGearSetCompoundDynamicAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6770.WormGearSetDynamicAnalysis]":
    ...
    def worm_gears_compound_dynamic_analysis(
        self: "Self",
    ) -> "List[_6899.WormGearCompoundDynamicAnalysis]":
    ...
    def worm_meshes_compound_dynamic_analysis(
        self: "Self",
    ) -> "List[_6900.WormGearMeshCompoundDynamicAnalysis]":
