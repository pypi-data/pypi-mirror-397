...
class MicrophoneCompoundParametricStudyTool(_4788.ComponentCompoundParametricStudyTool):
    """MicrophoneCompoundParametricStudyTool
    ...
    @property
    @exception_bridge
    def properties_changing_all_load_cases(self: "Self") -> "_7846.MicrophoneLoadCase":
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4698.MicrophoneParametricStudyTool]":
