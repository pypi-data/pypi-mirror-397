...
class CylindricalGearSetPowerFlow(_4408.GearSetPowerFlow):
    """CylindricalGearSetPowerFlow
    ...
    @property
    @exception_bridge
    def gears_power_flow(self: "Self") -> "List[_4394.CylindricalGearPowerFlow]":
    ...
    def cylindrical_gears_power_flow(
        self: "Self",
    ) -> "List[_4394.CylindricalGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.CylindricalGearPowerFlow]
    ...
    @property
    @exception_bridge
    def meshes_power_flow(self: "Self") -> "List[_4393.CylindricalGearMeshPowerFlow]":
    ...
    def cylindrical_meshes_power_flow(
        self: "Self",
    ) -> "List[_4393.CylindricalGearMeshPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.CylindricalGearMeshPowerFlow]
