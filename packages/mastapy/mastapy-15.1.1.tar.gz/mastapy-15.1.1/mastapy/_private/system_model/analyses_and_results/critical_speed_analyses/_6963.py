...
class CylindricalGearSetCriticalSpeedAnalysis(_6974.GearSetCriticalSpeedAnalysis):
    """CylindricalGearSetCriticalSpeedAnalysis
    ...
    def gears_critical_speed_analysis(
        self: "Self",
    ) -> "List[_6961.CylindricalGearCriticalSpeedAnalysis]":
    ...
    def meshes_critical_speed_analysis(
        self: "Self",
    ) -> "List[_6962.CylindricalGearMeshCriticalSpeedAnalysis]":
