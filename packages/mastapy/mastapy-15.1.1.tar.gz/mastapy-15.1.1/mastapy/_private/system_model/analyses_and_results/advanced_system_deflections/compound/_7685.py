...
class SpiralBevelGearSetCompoundAdvancedSystemDeflection(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_7553.SpiralBevelGearSetAdvancedSystemDeflection]":
    ...
    def spiral_bevel_gears_compound_advanced_system_deflection(
        self: "Self",
    ) -> "List[_7683.SpiralBevelGearCompoundAdvancedSystemDeflection]":
    ...
    def spiral_bevel_meshes_compound_advanced_system_deflection(
        self: "Self",
    ) -> "List[_7684.SpiralBevelGearMeshCompoundAdvancedSystemDeflection]":
