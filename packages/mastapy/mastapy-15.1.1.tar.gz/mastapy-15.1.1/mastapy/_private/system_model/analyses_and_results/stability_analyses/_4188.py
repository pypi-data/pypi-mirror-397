...
class StraightBevelGearSetStabilityAnalysis(_4089.BevelGearSetStabilityAnalysis):
    """StraightBevelGearSetStabilityAnalysis
    ...
    def bevel_gears_stability_analysis(
        self: "Self",
    ) -> "List[_4189.StraightBevelGearStabilityAnalysis]":
    ...
    def bevel_meshes_stability_analysis(
        self: "Self",
    ) -> "List[_4187.StraightBevelGearMeshStabilityAnalysis]":
