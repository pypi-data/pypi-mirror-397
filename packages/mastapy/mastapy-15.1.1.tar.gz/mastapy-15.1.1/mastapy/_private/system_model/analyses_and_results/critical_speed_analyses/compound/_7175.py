...
class ZerolBevelGearSetCompoundCriticalSpeedAnalysis(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_7044.ZerolBevelGearSetCriticalSpeedAnalysis]":
    ...
    def zerol_bevel_gears_compound_critical_speed_analysis(
        self: "Self",
    ) -> "List[_7173.ZerolBevelGearCompoundCriticalSpeedAnalysis]":
    ...
    def zerol_bevel_meshes_compound_critical_speed_analysis(
        self: "Self",
    ) -> "List[_7174.ZerolBevelGearMeshCompoundCriticalSpeedAnalysis]":
