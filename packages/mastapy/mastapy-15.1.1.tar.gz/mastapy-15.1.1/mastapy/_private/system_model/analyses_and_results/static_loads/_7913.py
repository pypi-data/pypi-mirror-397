...
class ZerolBevelGearSetLoadCase(_7750.BevelGearSetLoadCase):
    """ZerolBevelGearSetLoadCase
    ...
    @property
    @exception_bridge
    def bevel_gears_load_case(self: "Self") -> "List[_7911.ZerolBevelGearLoadCase]":
    ...
    def zerol_bevel_gears_load_case(
        self: "Self",
    ) -> "List[_7911.ZerolBevelGearLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.ZerolBevelGearLoadCase]
    ...
    def bevel_meshes_load_case(
        self: "Self",
    ) -> "List[_7912.ZerolBevelGearMeshLoadCase]":
