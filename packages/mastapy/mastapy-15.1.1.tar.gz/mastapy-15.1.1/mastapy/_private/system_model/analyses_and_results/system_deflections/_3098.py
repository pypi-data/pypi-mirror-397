...
class ShaftSystemDeflection(_2979.AbstractShaftSystemDeflection):
    """ShaftSystemDeflection
    ...
    @property
    @exception_bridge
    def component_load_case(self: "Self") -> "_7875.ShaftLoadCase":
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4448.ShaftPowerFlow":
    ...
    def shaft_section_end_with_worst_fatigue_safety_factor(
        self: "Self",
    ) -> "_3096.ShaftSectionEndResultsSystemDeflection":
    ...
    @property
    @exception_bridge
    def mounted_components_applying_torque(self: "Self") -> "List[_1777.ForceResults]":
    ...
    def shaft_section_end_results_by_offset_with_worst_safety_factor(
        self: "Self",
    ) -> "List[_3096.ShaftSectionEndResultsSystemDeflection]":
    ...
    def shaft_section_results(
        self: "Self",
    ) -> "List[_3097.ShaftSectionSystemDeflection]":
