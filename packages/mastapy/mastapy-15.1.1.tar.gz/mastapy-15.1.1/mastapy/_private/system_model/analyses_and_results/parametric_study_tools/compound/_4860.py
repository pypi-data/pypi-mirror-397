...
class ShaftCompoundParametricStudyTool(_4764.AbstractShaftCompoundParametricStudyTool):
    """ShaftCompoundParametricStudyTool
    ...
    @property
    @exception_bridge
    def properties_changing_all_load_cases(self: "Self") -> "_7875.ShaftLoadCase":
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4730.ShaftParametricStudyTool]":
