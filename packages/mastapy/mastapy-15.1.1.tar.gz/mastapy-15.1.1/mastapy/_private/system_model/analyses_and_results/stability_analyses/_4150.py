...
from mastapy._private.system_model.analyses_and_results.stability_analyses import _4201
...
class MeasurementComponentStabilityAnalysis(_4201.VirtualComponentStabilityAnalysis):
    """MeasurementComponentStabilityAnalysis
    ...
    @property
    @exception_bridge
    def component_load_case(self: "Self") -> "_7843.MeasurementComponentLoadCase":
