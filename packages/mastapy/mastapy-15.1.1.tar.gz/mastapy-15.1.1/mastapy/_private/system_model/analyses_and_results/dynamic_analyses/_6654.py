...
class BevelDifferentialGearSetDynamicAnalysis(_6659.BevelGearSetDynamicAnalysis):
    """BevelDifferentialGearSetDynamicAnalysis
    ...
    def bevel_gears_dynamic_analysis(
        self: "Self",
    ) -> "List[_6652.BevelDifferentialGearDynamicAnalysis]":
    ...
    def bevel_meshes_dynamic_analysis(
        self: "Self",
    ) -> "List[_6653.BevelDifferentialGearMeshDynamicAnalysis]":
