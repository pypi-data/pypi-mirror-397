...
class ConceptGearMeshSystemDeflection(_3051.GearMeshSystemDeflection):
    """ConceptGearMeshSystemDeflection
    ...
    @property
    @exception_bridge
    def connection_load_case(self: "Self") -> "_7763.ConceptGearMeshLoadCase":
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4374.ConceptGearMeshPowerFlow":
