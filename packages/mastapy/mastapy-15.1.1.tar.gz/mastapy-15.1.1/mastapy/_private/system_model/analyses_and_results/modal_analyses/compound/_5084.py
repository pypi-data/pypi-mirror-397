...
class ConceptGearSetCompoundModalAnalysis(_5113.GearSetCompoundModalAnalysis):
    """ConceptGearSetCompoundModalAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4925.ConceptGearSetModalAnalysis]":
    ...
    def concept_gears_compound_modal_analysis(
        self: "Self",
    ) -> "List[_5082.ConceptGearCompoundModalAnalysis]":
    ...
    def concept_meshes_compound_modal_analysis(
        self: "Self",
    ) -> "List[_5083.ConceptGearMeshCompoundModalAnalysis]":
