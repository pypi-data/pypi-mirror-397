...
class WormGearSetPowerFlow(_4408.GearSetPowerFlow):
    """WormGearSetPowerFlow
    ...
    @property
    @exception_bridge
    def gears_power_flow(self: "Self") -> "List[_4477.WormGearPowerFlow]":
    ...
    @property
    @exception_bridge
    def worm_gears_power_flow(self: "Self") -> "List[_4477.WormGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.WormGearPowerFlow]
    ...
    @property
    @exception_bridge
    def meshes_power_flow(self: "Self") -> "List[_4476.WormGearMeshPowerFlow]":
    ...
    @property
    @exception_bridge
    def worm_meshes_power_flow(self: "Self") -> "List[_4476.WormGearMeshPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.WormGearMeshPowerFlow]
