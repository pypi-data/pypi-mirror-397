...
class SpringDamperConnectionSystemDeflection(_3021.CouplingConnectionSystemDeflection):
    """SpringDamperConnectionSystemDeflection
    ...
    @property
    @exception_bridge
    def connection_load_case(self: "Self") -> "_7881.SpringDamperConnectionLoadCase":
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4454.SpringDamperConnectionPowerFlow":
