...
class CouplingCompoundModalAnalysis(_5153.SpecialisedAssemblyCompoundModalAnalysis):
    """CouplingCompoundModalAnalysis
    ...
    @property
    @exception_bridge
    def assembly_analysis_cases(self: "Self") -> "List[_4934.CouplingModalAnalysis]":
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4934.CouplingModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.CouplingModalAnalysis]
