...
class HypoidGearSetHarmonicAnalysis(_6027.AGMAGleasonConicalGearSetHarmonicAnalysis):
    """HypoidGearSetHarmonicAnalysis
    ...
    def agma_gleason_conical_gears_harmonic_analysis(
        self: "Self",
    ) -> "List[_6116.HypoidGearHarmonicAnalysis]":
    ...
    def agma_gleason_conical_meshes_harmonic_analysis(
        self: "Self",
    ) -> "List[_6117.HypoidGearMeshHarmonicAnalysis]":
