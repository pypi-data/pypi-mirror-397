...
class ConnectorCompoundPowerFlow(_4561.MountableComponentCompoundPowerFlow):
    """ConnectorCompoundPowerFlow
    ...
    @property
    @exception_bridge
    def component_analysis_cases(self: "Self") -> "List[_4381.ConnectorPowerFlow]":
