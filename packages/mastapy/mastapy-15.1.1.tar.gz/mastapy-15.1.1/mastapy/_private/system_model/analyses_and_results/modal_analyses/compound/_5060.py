...
class AssemblyCompoundModalAnalysis(_5053.AbstractAssemblyCompoundModalAnalysis):
    """AssemblyCompoundModalAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4901.AssemblyModalAnalysis]":
    ...
    @property
    @exception_bridge
    def bearings(self: "Self") -> "List[_5061.BearingCompoundModalAnalysis]":
    ...
    @property
    @exception_bridge
    def belt_drives(self: "Self") -> "List[_5063.BeltDriveCompoundModalAnalysis]":
    ...
    def bevel_differential_gear_sets(
        self: "Self",
    ) -> "List[_5066.BevelDifferentialGearSetCompoundModalAnalysis]":
    ...
    @property
    @exception_bridge
    def bolted_joints(self: "Self") -> "List[_5073.BoltedJointCompoundModalAnalysis]":
    ...
    @property
    @exception_bridge
    def bolts(self: "Self") -> "List[_5072.BoltCompoundModalAnalysis]":
    ...
    @property
    @exception_bridge
    def cv_ts(self: "Self") -> "List[_5094.CVTCompoundModalAnalysis]":
    ...
    @property
    @exception_bridge
    def clutches(self: "Self") -> "List[_5074.ClutchCompoundModalAnalysis]":
    ...
    def concept_couplings(
        self: "Self",
    ) -> "List[_5079.ConceptCouplingCompoundModalAnalysis]":
    ...
    def concept_gear_sets(
        self: "Self",
    ) -> "List[_5084.ConceptGearSetCompoundModalAnalysis]":
    ...
    def cycloidal_assemblies(
        self: "Self",
    ) -> "List[_5096.CycloidalAssemblyCompoundModalAnalysis]":
    ...
    def cycloidal_discs(
        self: "Self",
    ) -> "List[_5098.CycloidalDiscCompoundModalAnalysis]":
    ...
    def cylindrical_gear_sets(
        self: "Self",
    ) -> "List[_5102.CylindricalGearSetCompoundModalAnalysis]":
    ...
    @property
    @exception_bridge
    def fe_parts(self: "Self") -> "List[_5109.FEPartCompoundModalAnalysis]":
    ...
    @property
    @exception_bridge
    def face_gear_sets(self: "Self") -> "List[_5108.FaceGearSetCompoundModalAnalysis]":
    ...
    def flexible_pin_assemblies(
        self: "Self",
    ) -> "List[_5110.FlexiblePinAssemblyCompoundModalAnalysis]":
    ...
    def hypoid_gear_sets(
        self: "Self",
    ) -> "List[_5117.HypoidGearSetCompoundModalAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: "Self",
    ) -> "List[_5124.KlingelnbergCycloPalloidHypoidGearSetCompoundModalAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_5127.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundModalAnalysis]":
    ...
    @property
    @exception_bridge
    def mass_discs(self: "Self") -> "List[_5128.MassDiscCompoundModalAnalysis]":
    ...
    def measurement_components(
        self: "Self",
    ) -> "List[_5129.MeasurementComponentCompoundModalAnalysis]":
    ...
    @property
    @exception_bridge
    def microphones(self: "Self") -> "List[_5131.MicrophoneCompoundModalAnalysis]":
    ...
    @property
    @exception_bridge
    def oil_seals(self: "Self") -> "List[_5133.OilSealCompoundModalAnalysis]":
    ...
    def part_to_part_shear_couplings(
        self: "Self",
    ) -> "List[_5135.PartToPartShearCouplingCompoundModalAnalysis]":
    ...
    def planet_carriers(
        self: "Self",
    ) -> "List[_5140.PlanetCarrierCompoundModalAnalysis]":
    ...
    @property
    @exception_bridge
    def point_loads(self: "Self") -> "List[_5141.PointLoadCompoundModalAnalysis]":
    ...
    @property
    @exception_bridge
    def power_loads(self: "Self") -> "List[_5142.PowerLoadCompoundModalAnalysis]":
    ...
    @property
    @exception_bridge
    def ring_pins(self: "Self") -> "List[_5144.RingPinsCompoundModalAnalysis]":
    ...
    def rolling_ring_assemblies(
        self: "Self",
    ) -> "List[_5146.RollingRingAssemblyCompoundModalAnalysis]":
    ...
    def shaft_hub_connections(
        self: "Self",
    ) -> "List[_5151.ShaftHubConnectionCompoundModalAnalysis]":
    ...
    @property
    @exception_bridge
    def shafts(self: "Self") -> "List[_5150.ShaftCompoundModalAnalysis]":
    ...
    def spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_5156.SpiralBevelGearSetCompoundModalAnalysis]":
    ...
    @property
    @exception_bridge
    def spring_dampers(self: "Self") -> "List[_5157.SpringDamperCompoundModalAnalysis]":
    ...
    def straight_bevel_diff_gear_sets(
        self: "Self",
    ) -> "List[_5162.StraightBevelDiffGearSetCompoundModalAnalysis]":
    ...
    def straight_bevel_gear_sets(
        self: "Self",
    ) -> "List[_5165.StraightBevelGearSetCompoundModalAnalysis]":
    ...
    @property
    @exception_bridge
    def synchronisers(self: "Self") -> "List[_5168.SynchroniserCompoundModalAnalysis]":
    ...
    def torque_converters(
        self: "Self",
    ) -> "List[_5172.TorqueConverterCompoundModalAnalysis]":
    ...
    def unbalanced_masses(
        self: "Self",
    ) -> "List[_5176.UnbalancedMassCompoundModalAnalysis]":
    ...
    @property
    @exception_bridge
    def worm_gear_sets(self: "Self") -> "List[_5180.WormGearSetCompoundModalAnalysis]":
    ...
    def zerol_bevel_gear_sets(
        self: "Self",
    ) -> "List[_5183.ZerolBevelGearSetCompoundModalAnalysis]":
    ...
    @property
    @exception_bridge
    def assembly_analysis_cases(self: "Self") -> "List[_4901.AssemblyModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.AssemblyModalAnalysis]
