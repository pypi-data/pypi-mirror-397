...
class FaceGearSetDynamicAnalysis(_6703.GearSetDynamicAnalysis):
    """FaceGearSetDynamicAnalysis
    ...
    @property
    @exception_bridge
    def gears_dynamic_analysis(self: "Self") -> "List[_6696.FaceGearDynamicAnalysis]":
    ...
    def face_gears_dynamic_analysis(
        self: "Self",
    ) -> "List[_6696.FaceGearDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.FaceGearDynamicAnalysis]
    ...
    def meshes_dynamic_analysis(
        self: "Self",
    ) -> "List[_6697.FaceGearMeshDynamicAnalysis]":
