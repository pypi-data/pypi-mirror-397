...
class DatumCompoundParametricStudyTool(_4788.ComponentCompoundParametricStudyTool):
    """DatumCompoundParametricStudyTool
    ...
    @property
    @exception_bridge
    def component_design(self: "Self") -> "_2718.Datum":
    ...
    @property
    @exception_bridge
    def properties_changing_all_load_cases(self: "Self") -> "_7790.DatumLoadCase":
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4664.DatumParametricStudyTool]":
