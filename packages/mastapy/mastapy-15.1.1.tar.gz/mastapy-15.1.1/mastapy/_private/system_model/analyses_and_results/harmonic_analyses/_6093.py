...
class FEPartHarmonicAnalysis(
    _6023.AbstractShaftOrHousingHarmonicAnalysis,
    _2946.IHaveFEPartHarmonicAnalysisResults,
):
    """FEPartHarmonicAnalysis
    ...
    @property
    @exception_bridge
    def coupled_modal_analysis(self: "Self") -> "_4954.FEPartModalAnalysis":
    ...
    @property
    @exception_bridge
    def export(self: "Self") -> "_6108.HarmonicAnalysisFEExportOptions":
    ...
    @property
    @exception_bridge
    def results(self: "Self") -> "_6215.FEPartHarmonicAnalysisResultsPropertyAccessor":
    ...
    @property
    @exception_bridge
    def system_deflection_results(self: "Self") -> "_3049.FEPartSystemDeflection":
