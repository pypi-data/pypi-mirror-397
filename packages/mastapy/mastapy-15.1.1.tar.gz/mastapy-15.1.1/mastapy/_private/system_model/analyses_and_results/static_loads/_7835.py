...
class KlingelnbergCycloPalloidConicalGearSetLoadCase(_7769.ConicalGearSetLoadCase):
    """KlingelnbergCycloPalloidConicalGearSetLoadCase
    ...
    def conical_gears_load_case(
        self: "Self",
    ) -> "List[_7833.KlingelnbergCycloPalloidConicalGearLoadCase]":
    ...
    def conical_meshes_load_case(
        self: "Self",
    ) -> "List[_7834.KlingelnbergCycloPalloidConicalGearMeshLoadCase]":
