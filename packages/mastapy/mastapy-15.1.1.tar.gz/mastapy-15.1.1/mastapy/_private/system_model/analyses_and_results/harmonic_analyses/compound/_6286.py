...
class CylindricalGearSetCompoundHarmonicAnalysis(_6297.GearSetCompoundHarmonicAnalysis):
    """CylindricalGearSetCompoundHarmonicAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6071.CylindricalGearSetHarmonicAnalysis]":
    ...
    def cylindrical_gears_compound_harmonic_analysis(
        self: "Self",
    ) -> "List[_6284.CylindricalGearCompoundHarmonicAnalysis]":
    ...
    def cylindrical_meshes_compound_harmonic_analysis(
        self: "Self",
    ) -> "List[_6285.CylindricalGearMeshCompoundHarmonicAnalysis]":
