...
class FaceGearSetCompoundSystemDeflection(_3207.GearSetCompoundSystemDeflection):
    """FaceGearSetCompoundSystemDeflection
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3047.FaceGearSetSystemDeflection]":
    ...
    def face_gears_compound_system_deflection(
        self: "Self",
    ) -> "List[_3200.FaceGearCompoundSystemDeflection]":
    ...
    def face_meshes_compound_system_deflection(
        self: "Self",
    ) -> "List[_3201.FaceGearMeshCompoundSystemDeflection]":
