...
class BearingHarmonicAnalysis(_6058.ConnectorHarmonicAnalysis):
    """BearingHarmonicAnalysis
    ...
    def rolling_bearing_speed_results(
        self: "Self",
    ) -> "_2317.RollingBearingSpeedResults":
    ...
    @property
    @exception_bridge
    def system_deflection_results(self: "Self") -> "_2990.BearingSystemDeflection":
