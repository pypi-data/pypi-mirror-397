...
class _Cast_CylindricalGearManufactureError:
    ...
    @property
    def gear_manufacture_error(self: "CastSelf") -> "_7812.GearManufactureError":
        return self.__parent__._cast(_7812.GearManufactureError)
...
class CylindricalGearManufactureError(_7812.GearManufactureError):
    """CylindricalGearManufactureError
    ...
    @property
    @exception_bridge
    def pitch_errors_left_flank(self: "Self") -> "_1750.Vector2DListAccessor":
    ...
    @property
    @exception_bridge
    def pitch_errors_right_flank(self: "Self") -> "_1750.Vector2DListAccessor":
        """mastapy.math_utility.Vector2DListAccessor"""
