...
class AssemblyAdvancedTimeSteppingAnalysisForModulation(
    ...
    @property
    @exception_bridge
    def system_deflection_results(self: "Self") -> "_2984.AssemblySystemDeflection":
    ...
    def bolted_joints(
        self: "Self",
    ) -> "List[_7201.BoltedJointAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def concept_gear_sets(
        self: "Self",
    ) -> "List[_7212.ConceptGearSetAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def shaft_hub_connections(
        self: "Self",
    ) -> "List[_7280.ShaftHubConnectionAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def zerol_bevel_gear_sets(
        self: "Self",
    ) -> "List[_7312.ZerolBevelGearSetAdvancedTimeSteppingAnalysisForModulation]":
