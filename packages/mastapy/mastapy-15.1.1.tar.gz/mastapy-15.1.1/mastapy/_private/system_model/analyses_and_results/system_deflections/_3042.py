...
from mastapy._private.system_model.analyses_and_results.system_deflections import _3039
...
class CylindricalPlanetGearSystemDeflection(
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4396.CylindricalPlanetGearPowerFlow":
