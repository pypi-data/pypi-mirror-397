...
class PowerLoadAdvancedSystemDeflection(_7575.VirtualComponentAdvancedSystemDeflection):
    """PowerLoadAdvancedSystemDeflection
    ...
    def component_system_deflection_results(
        self: "Self",
    ) -> "List[_3086.PowerLoadSystemDeflection]":
    ...
    def transmission_error_to_other_power_loads(
        self: "Self",
    ) -> "List[_7573.TransmissionErrorToOtherPowerLoad]":
