...
class WormGearSetCompoundSystemDeflection(_3207.GearSetCompoundSystemDeflection):
    """WormGearSetCompoundSystemDeflection
    ...
    def worm_gears_compound_system_deflection(
        self: "Self",
    ) -> "List[_3273.WormGearCompoundSystemDeflection]":
    ...
    def worm_meshes_compound_system_deflection(
        self: "Self",
    ) -> "List[_3274.WormGearMeshCompoundSystemDeflection]":
