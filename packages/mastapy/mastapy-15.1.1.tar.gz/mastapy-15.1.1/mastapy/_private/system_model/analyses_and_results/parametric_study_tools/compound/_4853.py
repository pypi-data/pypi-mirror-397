...
class PulleyCompoundParametricStudyTool(_4802.CouplingHalfCompoundParametricStudyTool):
    """PulleyCompoundParametricStudyTool
    ...
    @property
    @exception_bridge
    def properties_changing_all_load_cases(self: "Self") -> "_7863.PulleyLoadCase":
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4722.PulleyParametricStudyTool]":
