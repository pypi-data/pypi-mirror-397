...
class SpiralBevelGearSetModalAnalysisAtASpeed(_5466.BevelGearSetModalAnalysisAtASpeed):
    """SpiralBevelGearSetModalAnalysisAtASpeed
    ...
    def bevel_gears_modal_analysis_at_a_speed(
        self: "Self",
    ) -> "List[_5551.SpiralBevelGearModalAnalysisAtASpeed]":
    ...
    def bevel_meshes_modal_analysis_at_a_speed(
        self: "Self",
    ) -> "List[_5550.SpiralBevelGearMeshModalAnalysisAtASpeed]":
