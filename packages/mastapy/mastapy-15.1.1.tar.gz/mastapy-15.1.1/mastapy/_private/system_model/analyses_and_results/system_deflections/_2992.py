...
class BeltDriveSystemDeflection(_3100.SpecialisedAssemblySystemDeflection):
    """BeltDriveSystemDeflection
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4355.BeltDrivePowerFlow":
    ...
    @property
    @exception_bridge
    def belts(self: "Self") -> "List[_2991.BeltConnectionSystemDeflection]":
