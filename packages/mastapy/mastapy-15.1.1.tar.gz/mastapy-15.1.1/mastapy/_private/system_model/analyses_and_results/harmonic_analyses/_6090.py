...
class FaceGearHarmonicAnalysis(_6096.GearHarmonicAnalysis):
    """FaceGearHarmonicAnalysis
    ...
    @property
    @exception_bridge
    def component_load_case(self: "Self") -> "_7805.FaceGearLoadCase":
    ...
    @property
    @exception_bridge
    def system_deflection_results(self: "Self") -> "_3048.FaceGearSystemDeflection":
