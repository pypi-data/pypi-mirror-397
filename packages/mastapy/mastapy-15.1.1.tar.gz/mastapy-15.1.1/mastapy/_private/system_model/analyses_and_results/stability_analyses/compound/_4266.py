...
class GearCompoundStabilityAnalysis(_4287.MountableComponentCompoundStabilityAnalysis):
    """GearCompoundStabilityAnalysis
    ...
    @property
    @exception_bridge
    def component_analysis_cases(self: "Self") -> "List[_4134.GearStabilityAnalysis]":
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4134.GearStabilityAnalysis]":
        """List[mastapy.system_model.analyses_and_results.stability_analyses.GearStabilityAnalysis]
