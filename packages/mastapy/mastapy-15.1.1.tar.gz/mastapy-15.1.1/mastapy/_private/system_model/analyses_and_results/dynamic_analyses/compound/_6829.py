...
class FaceGearSetCompoundDynamicAnalysis(_6834.GearSetCompoundDynamicAnalysis):
    """FaceGearSetCompoundDynamicAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6698.FaceGearSetDynamicAnalysis]":
    ...
    def face_gears_compound_dynamic_analysis(
        self: "Self",
    ) -> "List[_6827.FaceGearCompoundDynamicAnalysis]":
    ...
    def face_meshes_compound_dynamic_analysis(
        self: "Self",
    ) -> "List[_6828.FaceGearMeshCompoundDynamicAnalysis]":
