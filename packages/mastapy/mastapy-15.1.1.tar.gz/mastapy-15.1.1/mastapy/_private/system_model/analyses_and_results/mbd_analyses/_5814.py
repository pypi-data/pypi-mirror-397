...
class PulleyMultibodyDynamicsAnalysis(_5753.CouplingHalfMultibodyDynamicsAnalysis):
    """PulleyMultibodyDynamicsAnalysis
    ...
    @property
    @exception_bridge
    def peak_pulley_torque(self: "Self") -> "List[_5865.DynamicTorqueResultAtTime]":
