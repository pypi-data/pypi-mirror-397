...
class ConceptGearSetCompoundPowerFlow(_4542.GearSetCompoundPowerFlow):
    """ConceptGearSetCompoundPowerFlow
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4376.ConceptGearSetPowerFlow]":
    ...
    def concept_gears_compound_power_flow(
        self: "Self",
    ) -> "List[_4511.ConceptGearCompoundPowerFlow]":
    ...
    def concept_meshes_compound_power_flow(
        self: "Self",
    ) -> "List[_4512.ConceptGearMeshCompoundPowerFlow]":
    ...
    @property
    @exception_bridge
    def assembly_analysis_cases(self: "Self") -> "List[_4376.ConceptGearSetPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.ConceptGearSetPowerFlow]
