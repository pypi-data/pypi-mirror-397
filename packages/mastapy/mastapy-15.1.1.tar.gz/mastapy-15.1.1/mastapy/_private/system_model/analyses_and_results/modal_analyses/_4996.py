...
class PulleyModalAnalysis(_4933.CouplingHalfModalAnalysis):
    """PulleyModalAnalysis
    ...
    @property
    @exception_bridge
    def component_load_case(self: "Self") -> "_7863.PulleyLoadCase":
    ...
    @property
    @exception_bridge
    def system_deflection_results(self: "Self") -> "_3087.PulleySystemDeflection":
