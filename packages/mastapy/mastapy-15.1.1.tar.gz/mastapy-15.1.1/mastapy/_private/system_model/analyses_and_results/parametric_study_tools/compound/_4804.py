...
class CVTCompoundParametricStudyTool(_4773.BeltDriveCompoundParametricStudyTool):
    """CVTCompoundParametricStudyTool
    ...
    @property
    @exception_bridge
    def properties_changing_all_load_cases(self: "Self") -> "_7776.CVTLoadCase":
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4654.CVTParametricStudyTool]":
    ...
    @property
    @exception_bridge
    def assembly_analysis_cases(self: "Self") -> "List[_4654.CVTParametricStudyTool]":
        """List[mastapy.system_model.analyses_and_results.parametric_study_tools.CVTParametricStudyTool]
