...
class GuideDxfModelSystemDeflection(_3007.ComponentSystemDeflection):
    """GuideDxfModelSystemDeflection
    ...
    @property
    @exception_bridge
    def component_load_case(self: "Self") -> "_7817.GuideDxfModelLoadCase":
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4409.GuideDxfModelPowerFlow":
