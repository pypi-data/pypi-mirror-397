...
class SynchroniserCompoundPowerFlow(_4582.SpecialisedAssemblyCompoundPowerFlow):
    """SynchroniserCompoundPowerFlow
    ...
    @property
    @exception_bridge
    def component_design(self: "Self") -> "_2892.Synchroniser":
    ...
    @property
    @exception_bridge
    def assembly_design(self: "Self") -> "_2892.Synchroniser":
        """mastapy.system_model.part_model.couplings.Synchroniser
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4467.SynchroniserPowerFlow]":
    ...
    @property
    @exception_bridge
    def assembly_analysis_cases(self: "Self") -> "List[_4467.SynchroniserPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.SynchroniserPowerFlow]
