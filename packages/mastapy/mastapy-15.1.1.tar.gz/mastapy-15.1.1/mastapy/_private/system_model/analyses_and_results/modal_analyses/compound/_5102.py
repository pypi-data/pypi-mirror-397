...
class CylindricalGearSetCompoundModalAnalysis(_5113.GearSetCompoundModalAnalysis):
    """CylindricalGearSetCompoundModalAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4944.CylindricalGearSetModalAnalysis]":
    ...
    def cylindrical_gears_compound_modal_analysis(
        self: "Self",
    ) -> "List[_5100.CylindricalGearCompoundModalAnalysis]":
    ...
    def cylindrical_meshes_compound_modal_analysis(
        self: "Self",
    ) -> "List[_5101.CylindricalGearMeshCompoundModalAnalysis]":
