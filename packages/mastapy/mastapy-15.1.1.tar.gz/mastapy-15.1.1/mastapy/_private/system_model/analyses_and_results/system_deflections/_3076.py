...
class MountableComponentSystemDeflection(_3007.ComponentSystemDeflection):
    """MountableComponentSystemDeflection
    ...
    @property
    @exception_bridge
    def inner_fe_part(self: "Self") -> "_3049.FEPartSystemDeflection":
    ...
    @property
    @exception_bridge
    def inner_fe_substructure_nodes(self: "Self") -> "List[_2647.FESubstructureNode]":
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4427.MountableComponentPowerFlow":
