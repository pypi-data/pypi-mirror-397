...
class GearSetCompoundDynamicAnalysis(_6874.SpecialisedAssemblyCompoundDynamicAnalysis):
    """GearSetCompoundDynamicAnalysis
    ...
    @property
    @exception_bridge
    def assembly_analysis_cases(self: "Self") -> "List[_6703.GearSetDynamicAnalysis]":
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6703.GearSetDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.GearSetDynamicAnalysis]
