...
class HarmonicAnalysis(_7933.CompoundAnalysisCase):
    """HarmonicAnalysis
    ...
    @property
    @exception_bridge
    def acoustic_analysis(self: "Self") -> "_7717.HarmonicAcousticAnalysis":
    ...
    @property
    @exception_bridge
    def transfer_path_analysis(self: "Self") -> "_6198.TransferPathAnalysis":
