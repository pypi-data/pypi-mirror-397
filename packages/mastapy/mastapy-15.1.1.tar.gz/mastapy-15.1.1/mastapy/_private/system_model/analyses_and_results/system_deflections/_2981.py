...
from mastapy._private.system_model.analyses_and_results.system_deflections import _3016
...
class AGMAGleasonConicalGearMeshSystemDeflection(_3016.ConicalGearMeshSystemDeflection):
    """AGMAGleasonConicalGearMeshSystemDeflection
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4349.AGMAGleasonConicalGearMeshPowerFlow":
