...
class PowerLoadSystemDeflection(_3130.VirtualComponentSystemDeflection):
    """PowerLoadSystemDeflection
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4439.PowerLoadPowerFlow":
    ...
    def transmission_error_to_other_power_loads(
        self: "Self",
    ) -> "List[_3127.TransmissionErrorResult]":
