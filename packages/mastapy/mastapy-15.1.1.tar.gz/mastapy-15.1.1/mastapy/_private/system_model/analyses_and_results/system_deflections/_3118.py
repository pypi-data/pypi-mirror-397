...
class SynchroniserSystemDeflection(_3100.SpecialisedAssemblySystemDeflection):
    """SynchroniserSystemDeflection
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4467.SynchroniserPowerFlow":
    ...
    @property
    @exception_bridge
    def cones(self: "Self") -> "List[_3115.SynchroniserHalfSystemDeflection]":
