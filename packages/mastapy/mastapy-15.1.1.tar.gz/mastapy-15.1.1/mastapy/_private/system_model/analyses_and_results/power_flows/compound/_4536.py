...
class FaceGearMeshCompoundPowerFlow(_4541.GearMeshCompoundPowerFlow):
    """FaceGearMeshCompoundPowerFlow
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4399.FaceGearMeshPowerFlow]":
    ...
    @property
    @exception_bridge
    def connection_analysis_cases(self: "Self") -> "List[_4399.FaceGearMeshPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.FaceGearMeshPowerFlow]
