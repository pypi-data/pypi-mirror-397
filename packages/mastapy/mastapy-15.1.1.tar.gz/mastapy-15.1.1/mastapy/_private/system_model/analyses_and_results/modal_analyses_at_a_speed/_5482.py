...
class ConicalGearSetModalAnalysisAtASpeed(_5508.GearSetModalAnalysisAtASpeed):
    """ConicalGearSetModalAnalysisAtASpeed
    ...
    def gears_modal_analysis_at_a_speed(
        self: "Self",
    ) -> "List[_5481.ConicalGearModalAnalysisAtASpeed]":
    ...
    def meshes_modal_analysis_at_a_speed(
        self: "Self",
    ) -> "List[_5480.ConicalGearMeshModalAnalysisAtASpeed]":
