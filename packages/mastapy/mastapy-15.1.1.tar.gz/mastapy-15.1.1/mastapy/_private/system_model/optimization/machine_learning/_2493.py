...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.optimization.machine_learning import _2492
...
class CylindricalGearFlankOptimisationParameters(_2061.NamedDatabaseItem):
    """CylindricalGearFlankOptimisationParameters
    ...
    def optimization_properties(
        self: "Self",
    ) -> "List[_2492.CylindricalGearFlankOptimisationParameter]":
