...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines import _1397, _1442
...
class _Cast_MagnetDesign:
    ...
    @property
    def cad_magnets_for_layer(self: "CastSelf") -> "_1397.CADMagnetsForLayer":
        from mastapy._private.electric_machines import _1397

        return self.__parent__._cast(_1397.CADMagnetsForLayer)

    @property
    def magnet_for_layer(self: "CastSelf") -> "_1442.MagnetForLayer":
        from mastapy._private.electric_machines import _1442

        return self.__parent__._cast(_1442.MagnetForLayer)
