...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines import _1412, _1413, _1467
...
class SurfacePermanentMagnetMachine(_1447.NonCADElectricMachineDetail):
    """SurfacePermanentMagnetMachine
    ...
    @property
    @exception_bridge
    def rotor(self: "Self") -> "_1467.SurfacePermanentMagnetRotor":
