...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines.harmonic_load_data import _1597, _1598
...
class _Cast_StatorToothInterpolator:
    ...
    def stator_tooth_load_interpolator(
        ...
        return self.__parent__._cast(_1597.StatorToothLoadInterpolator)
    ...
    def stator_tooth_moment_interpolator(
        ...
        return self.__parent__._cast(_1598.StatorToothMomentInterpolator)
