...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines.thermal import _1512, _1515
...
class ThermalStator(_0.APIBase):
    ...
    @property
    @exception_bridge
    def housing(self: "Self") -> "_1512.ThermalHousing":
    ...
    @property
    @exception_bridge
    def windings(self: "Self") -> "_1515.ThermalWindings":
