...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings import _2124
    from mastapy._private.bearings.bearing_designs import _2377, _2378, _2381
    from mastapy._private.bearings.bearing_designs.fluid_film import _2430, _2431, _2432
...
class PlainOilFedJournalBearing(_2439.PlainJournalBearing):
    """PlainOilFedJournalBearing
    ...
    @property
    @exception_bridge
    def feed_type(self: "Self") -> "_2124.JournalOilFeedType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings._2124", "JournalOilFeedType"
        )(value)

    @feed_type.setter
    @exception_bridge
    @enforce_parameter_types
    def feed_type(self: "Self", value: "_2124.JournalOilFeedType") -> None:
    ...
    @property
    @exception_bridge
    def axial_groove_oil_feed(self: "Self") -> "_2430.AxialGrooveJournalBearing":
    ...
    @property
    @exception_bridge
    def axial_hole_oil_feed(self: "Self") -> "_2431.AxialHoleJournalBearing":
    ...
    def circumferential_groove_oil_feed(
        self: "Self",
    ) -> "_2432.CircumferentialFeedJournalBearing":
