...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2247, _2277
...
class LoadedCrossedRollerBearingRow(_2273.LoadedRollerBearingRow):
    """LoadedCrossedRollerBearingRow
    ...
    @property
    @exception_bridge
    def loaded_bearing(self: "Self") -> "_2247.LoadedCrossedRollerBearingResults":
