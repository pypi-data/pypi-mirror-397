...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2272, _2276
...
class LoadedTaperRollerBearingResults(_2266.LoadedNonBarrelRollerBearingResults):
    """LoadedTaperRollerBearingResults
