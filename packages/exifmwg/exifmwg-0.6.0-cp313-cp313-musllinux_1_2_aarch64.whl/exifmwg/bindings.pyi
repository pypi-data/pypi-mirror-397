...
class ImageMetadata:
    @overload
    def __init__(self, image_height: int, image_width: int, title: str | None = None, description: str | None = None, region_info: RegionInfo | None = None, orientation: ExifOrientation | None = None, keyword_info: KeywordInfo | None = None, country: str | None = None, city: str | None = None, state: str | None = None, location: str | None = None) -> None: ...
