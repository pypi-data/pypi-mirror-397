...
FAIL_INVLD_RSC_STATE = long(243 | MASK_ERROR)
...
WARN_VLMDFN_RESIZE_SAME_SIZE = long(1023 | MASK_WARN)
...
API_STATUS_CRYPT_PASS = str('StatusCryptPass')
...
KEY_QUORUM_SET_BY = str('QuorumSetBy')
...
KEY_BACKUP_L2L_SKIP_WAIT_FOR_START = str('L2LSkipWaitForStart')
...
NAMESPC_INTERNAL_DRBD = str('Internal/Drbd')
...
KEY_ZFS_ROLLBACK_STRATEGY = str('RollbackStrategy')
KEY_ZFS_DELETE_STRATEGY = str('DeleteStrategy')
...
# ## Storage pool ZFS values ###
VAL_STOR_POOL_ZFS_ROLLBACK_STRAT_ROLLBACK = str('Rollback')
VAL_STOR_POOL_ZFS_ROLLBACK_STRAT_CLONE = str('Clone')
VAL_STOR_POOL_ZFS_ROLLBACK_STRAT_DYNAMIC = str('Dynamic')
VAL_STOR_POOL_ZFS_DELETE_STRAT_DESTROY = str('Destroy')
VAL_STOR_POOL_ZFS_DELETE_STRAT_RENAME = str('Rename')
VAL_STOR_POOL_ZFS_DELETE_STRAT_DYNAMIC = str('Dynamic')
...
FLAG_CLONING = str('CLONING')
FLAG_FAILED = str('FAILED')
FLAG_RESTORE_TARGET = str('RESTORE_TARGET')
...
if __name__ == "__main__":
    MAP_MASK = {
        ...
        'FAIL_INVLD_RSC_STATE': FAIL_INVLD_RSC_STATE,
        ...
        'WARN_VLMDFN_RESIZE_SAME_SIZE': WARN_VLMDFN_RESIZE_SAME_SIZE,
