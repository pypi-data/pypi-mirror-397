...
class IOChannelQTM(Component):
    """
    This class represents a single QTM IO channel. It combines all QTM IO channel
    ...
    def __init__(
        ...
        for attr_name in IOChannelQTM._get_required_parent_attr_names():
