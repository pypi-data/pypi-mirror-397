...
class Module(InstrumentChannel):
    ...
    # ------------------------------------------------------------------------
    def _register(self, attr_name: str, *, new_name: Optional[str] = None) -> None:
        """
        ...
        new_name : Optional[str]
            If present, registers the attribute with a new name.
        """
        ...
        if hasattr(self.parent, attr_name):
            ...
            setattr(self, new_name or attr_name, partial_func)
        else:
            ...
            setattr(self, new_name or attr_name, raise_not_implemented_error)
