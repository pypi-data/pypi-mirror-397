...
def list_evaluations(
    app: str = cli_args.app_key_option, is_json_output: bool = cli_args.json_flag_option
) -> None:
    ...
    ai_app = client.ai_apps.get_ai_app_by_key(app)
    try:
...
def _overview(
    app: str = cli_args.app_key_option,
