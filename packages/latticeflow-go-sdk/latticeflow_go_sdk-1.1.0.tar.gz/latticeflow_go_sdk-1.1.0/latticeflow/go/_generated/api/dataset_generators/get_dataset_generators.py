...
def _get_kwargs(
    *, key: Union[Unset, str] = UNSET, user_only: Union[Unset, bool] = False
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
) -> Union[Error, StoredDatasetGenerators]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Error, StoredDatasetGenerators]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    user_only: Union[Unset, bool] = False,
) -> Response[Union[Error, StoredDatasetGenerators]]:
    ...
    Args:
        key (Union[Unset, str]):
        user_only (Union[Unset, bool]):  Default: False.
