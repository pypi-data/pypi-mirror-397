...
impl<'e> MajoranaEncoding<'e> {
    ...
    pub fn hartree_fock_state(
        ...
        let (x_block, z_block) = self.symplectics.split_at(Axis(1), half_length);
...
impl Encode<MajoranaProduct> for MajoranaEncoding<'_> {
...
mod tests {
    ...
    fn test_hartree_fock() {
        ...
        let symplectics: ArrayView2<bool> = ArrayView2::from(&[
            [
