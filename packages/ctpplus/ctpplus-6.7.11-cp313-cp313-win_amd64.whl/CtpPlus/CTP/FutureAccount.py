...
SIMULATE_SERVER = {
    '电信1': {'BrokerID': 9999, 'TDServer': "182.254.243.31:30001", 'MDServer': '182.254.243.31:30011', 'AppID': 'simnow_client_test', 'AuthCode': '0000000000000000'},
    '电信2': {'BrokerID': 9999, 'TDServer': "182.254.243.31:30002", 'MDServer': '182.254.243.31:30012', 'AppID': 'simnow_client_test', 'AuthCode': '0000000000000000'},
    '移动': {'BrokerID': 9999, 'TDServer': "182.254.243.31:30003", 'MDServer': '182.254.243.31:30013', 'AppID': 'simnow_client_test', 'AuthCode': '0000000000000000'},
    'TEST': {'BrokerID': 9999, 'TDServer': "182.254.243.31:40001", 'MDServer': '182.254.243.31:40011', 'AppID': 'simnow_client_test', 'AuthCode': '0000000000000000'},
    'N视界': {'BrokerID': 10010, 'TDServer': "210.14.72.12:4600", 'MDServer': '210.14.72.12:4602', 'AppID': '', 'AuthCode': ''},
}


class FutureAccount:
    def __init__(self, broker_id, server_dict, reserve_server_dict, investor_id, password, app_id, auth_code,
                 subscribe_list, md_flow_path=MD_LOCATION, td_flow_path=TD_LOCATION, production_mode=True,
                 period='1m'):
        ...
        self.production_mode = production_mode  # true 为生产模式（默认值）, false为测评模式
        self.period = period  # 合成k线周期（默认1m), 可填：1m、5m、10m、15m、30m、1h


def get_simulate_account(investor_id, password, subscribe_list=None, server_name='电信1', md_flow_path=MD_LOCATION,
                         td_flow_path=TD_LOCATION,  production_mode=True, period='1m'):
    ...
    return FutureAccount(
        ...
        production_mode=production_mode,  # true 为生产模式（默认值）, false为测评模式
        period=period  # 合成k线周期（默认1m), 可填：1m、5m、10m、15m、30m、1h
    )
