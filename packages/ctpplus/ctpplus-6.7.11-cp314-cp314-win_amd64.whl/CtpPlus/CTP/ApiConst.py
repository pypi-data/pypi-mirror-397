...
#///交易业务处理
InstrumentStatus_TransactionProcessing = b'7'
#///自动切换
...
PwdRcdSrc_Sync = b'1'
#///来源于用户修改
PwdRcdSrc_UserUpd = b'2'
#///来源于超户修改，很可能来自主席同步数据
PwdRcdSrc_SuperUserUpd = b'3'
#///来源于次席同步的修改
PwdRcdSrc_SecUpd = b'4'
#///交易地址
AddrSrvMode_Trade = b'0'
#///行情地址
AddrSrvMode_MarketData = b'1'
#///其他
AddrSrvMode_Other = b'2'
#///IPV4
AddrVer_V4 = b'0'
#///IPV6
AddrVer_V6 = b'1'
#///查询状态空闲
TGSessionQryStatus_QryIdle = b'1'
#///查询状态频繁
TGSessionQryStatus_QryBusy = b'2'
#///期权对冲
OffsetType_OPT_OFFSET = b'0'
#///期货对冲
OffsetType_FUT_OFFSET = b'1'
#///行权后期货对冲
OffsetType_EXEC_OFFSET = b'2'
#///履约后期货对冲
OffsetType_PERFORM_OFFSET = b'3'
#///交易
ApplySrcType_AS_Trade = b'0'
# ///会服
ApplySrcType_AS_Member = b'1'
