...
class RspUserLoginField(BaseField):
    ...
    _fields_ = [
        ...
        ('LoginDRIdentityID', c_int),  # 当前登录中心号
        ('UserDRIdentityID', c_int),  # 用户所属中心号
        ('LastLoginTime', c_char * 17),  # 上次登陆时间
        ('ReserveInfo', c_char * 65)  # 预留信息
    ]
...
class ProductField(BaseField):
    ...
    _fields_ = [
        ...
        ('ExchangeProductID', c_char * 81),  # 交易所产品代码
...
class InputOrderField(BaseField):
    ...
    _fields_ = [
        ...
        ('InstrumentID', c_char * 81),  # 合约代码
        ('IPAddress', c_char * 16),  # IP地址
        ('OrderMemo', c_char * 13),  # 报单回显字段
        ('SessionReqSeq', c_int)  # session上请求计数 api自动维护
    ]
...
class InvestorPositionDetailField(BaseField):
    ...
    _fields_ = [
        ...
        ('InstrumentID', c_char * 81),  # 合约代码
        ('CombInstrumentID', c_char * 81)  # 组合合约代码
    ]
...
class QryCombinationLegField(BaseField):
    ...
    _fields_ = [
        ...
        ('reserve2', c_char * 31),  # 保留的无效字段
        ('CombInstrumentID', c_char * 81),  # 组合合约代码
        ('LegInstrumentID', c_char * 81)  # 单腿合约代码
    ]
...
class InvestorPositionCombineDetailField(BaseField):
    ...
    _fields_ = [
        ...
        ('InvestUnitID', c_char * 17),  # 投资单元代码
        ('InstrumentID', c_char * 81),  # 合约代码
        ('CombInstrumentID', c_char * 81)  # 组合持仓合约编码
    ]
...
class QryInvestorProductGroupMarginField(BaseField):
    ...
    _fields_ = [
        ...
        ('ExchangeID', c_char * 9),  # 交易所代码
        ('InvestUnitID', c_char * 17),  # 投资单元代码
        ('ProductGroupID', c_char * 81)  # 品种/跨品种标示
    ]
...
class ProductGroupField(BaseField):
    ...
    _fields_ = [
        ...
        ('reserve1', c_char * 31),  # 保留的无效字段
        ('ProductID', c_char * 81),  # 产品代码
        ('ProductGroupID', c_char * 81)  # 产品组代码
    ]
...
class SyncDeltaDceCombInstrumentField(BaseField):
    """风险结算追平组合优先级"""
    _fields_ = [
        ('CombInstrumentID', c_char * 81),  # 合约代码
        ('ExchangeID', c_char * 9),  # 交易所代码
        ('ExchangeInstID', c_char * 81),  # 合约在交易所的代码
        ('TradeGroupID', c_int),  # 成交组号
...
class RULEInstrParameterField(BaseField):
    ...
    _fields_ = [
        ...
        ('StdInstrumentID', c_char * 81),  # 标准合约
...
class IpAddrParamField(BaseField):
    """服务地址参数"""
    _fields_ = [
        ('BrokerID', c_char * 11),  # 经纪公司代码
        ('Address', c_char * 129),  # 服务地址
        ('DRIdentityID', c_int),  # 交易中心代码
        ('DRIdentityName', c_char * 65),  # 交易中心名称
        ('AddrSrvMode', c_char * 1),  # 交易地址OR行情地址
        ('AddrVer', c_char * 1),  # 地址版本
        ('AddrNo', c_int),  # 服务地址编号
        ('AddrName', c_char * 65),  # 服务地址名称
        ('IsSM', c_int),  # 是否是国密地址
        ('IsLocalAddr', c_int),  # 是否是内网地址
        ('Remark', c_char * 161)  # 地址补充信息
    ]


class QryIpAddrParamField(BaseField):
    """服务地址参数查询"""
    _fields_ = [
        ('BrokerID', c_char * 11)  # 经纪公司代码
    ]
...
class TGIpAddrParamField(BaseField):
    """服务地址参数"""
    _fields_ = [
        ('BrokerID', c_char * 11),  # 经纪公司代码
        ('UserID', c_char * 16),  # 用户代码
...
class QryTGIpAddrParamField(BaseField):
    """服务地址参数查询"""
    _fields_ = [
        ('BrokerID', c_char * 11),  # 经纪公司代码
        ('UserID', c_char * 16)  # 用户代码
...
class TGSessionQryStatusField(BaseField):
    """TGate会话查询状态"""
    _fields_ = [
        ('LastQryFreq', c_int),  # 最近30s的查询频率
        ('QryStatus', c_char * 1)  # 查询状态
    ]


class LocalAddrConfigField(BaseField):
    """"""
    _fields_ = [
        ('BrokerID', c_char * 11),  # 经纪公司代码
        ('PeerAddr', c_char * 129),  # 对端地址
        ('NetMask', c_char * 129),  # 子网掩码
        ('DRIdentityID', c_int),  # 交易中心代码
        ('LocalAddress', c_char * 129)  # 内网服务地址
    ]


class QryLocalAddrConfigField(BaseField):
    """内网地址配置查询"""
    _fields_ = [
        ('BrokerID', c_char * 11)  # 经纪公司代码
    ]
...
class ReqQueryBankAccountBySecField(BaseField):
    """次席查询银行资金帐户信息请求"""
    _fields_ = [
        ('TradeCode', c_char * 7),  # 业务功能码
        ('BankID', c_char * 4),  # 银行代码
        ...
        ('LongCustomerName', c_char * 161),  # 长客户姓名
        ('DRIdentityID', c_int),  # 交易中心代码
        ('SecFutureSerial', c_int)  # 次中心发起转账期货公司流水号
    ]


class RspQueryBankAccountBySecField(BaseField):
    """次席查询银行资金帐户信息回报"""
    _fields_ = [
        ('TradeCode', c_char * 7),  # 业务功能码
        ('BankID', c_char * 4),  # 银行代码
...
class ReqTransferBySecField(BaseField):
    """次中心发起的转帐交易"""
    _fields_ = [
        ('TradeCode', c_char * 7),  # 业务功能码
        ('BankID', c_char * 4),  # 银行代码
...
class RspTransferBySecField(BaseField):
    """次中心发起的转帐交易回报"""
    _fields_ = [
        ('TradeCode', c_char * 7),  # 业务功能码
        ('BankID', c_char * 4),  # 银行代码
...
class NotifyQueryFutureAccountBySecField(BaseField):
    """查询银行资金帐户信息通知 要发往次席"""
    _fields_ = [
        ('TradeCode', c_char * 7),  # 业务功能码
        ('BankID', c_char * 4),  # 银行代码
...
class ExitEmergencyField(BaseField):
    """退出紧急状态参数"""
    _fields_ = [
        ('BrokerID', c_char * 11)  # 经纪公司代码
    ]
...
class InvestorPortfMarginModelField(BaseField):
    """新组保保证金系数投资者模板对应关系"""
    _fields_ = [
        ('BrokerID', c_char * 11),  # 经纪公司代码
        ('InvestorID', c_char * 13),  # 投资者代码
        ('MarginModelID', c_char * 13)  # 保证金系数模板
    ]


class InvestorPortfSettingField(BaseField):
    """投资者新组保设置"""
    _fields_ = [
        ('ExchangeID', c_char * 9),  # 交易所代码
        ('BrokerID', c_char * 11),  # 经纪公司代码
        ('InvestorID', c_char * 13),  # 投资者编号
        ('HedgeFlag', c_char * 1),  # 投机套保标志
        ('UsePortf', c_int)  # 是否开启新组保
    ]


class QryInvestorPortfSettingField(BaseField):
    """投资者新组保设置查询"""
    _fields_ = [
        ('ExchangeID', c_char * 9),  # 交易所代码
        ('BrokerID', c_char * 11),  # 经纪公司代码
...
class UserPasswordUpdateFromSecField(BaseField):
    """来自次席的用户口令变更"""
    _fields_ = [
        ('BrokerID', c_char * 11),  # 经纪公司代码
        ('UserID', c_char * 16),  # 用户代码
        ('OldPassword', c_char * 1),  # 原来的口令
        ('NewPassword', c_char * 1),  # 新的口令
        ('FromSec', c_int)  # 次席的交易中心代码
    ]


class SettlementInfoConfirmFromSecField(BaseField):
    """来自次席的结算结果确认"""
    _fields_ = [
        ('BrokerID', c_char * 11),  # 经纪公司代码
        ('InvestorID', c_char * 13),  # 投资者代码
...
class TradingAccountPasswordUpdateFromSecField(BaseField):
    """来自次席的资金账户口令变更"""
    _fields_ = [
        ('BrokerID', c_char * 11),  # 经纪公司代码
        ('AccountID', c_char * 13),  # 投资者代码
        ('OldPassword', c_char * 1),  # 原来的口令
        ('NewPassword', c_char * 1),  # 新的口令
        ('CurrencyID', c_char * 4),  # 币种代码
        ('FromSec', c_int)  # 次席的交易中心代码
...
class RiskForbiddenRightField(BaseField):
    """风控禁止的合约交易权限"""
    _fields_ = [
        ('BrokerID', c_char * 11),  # 经纪公司代码
        ('AccountID', c_char * 13),  # 投资者代码
        ('InstrumentID', c_char * 81),  # 合约/产品代码
        ('UserID', c_char * 16)  # 用户代码
    ]


class InvestorInfoCommRecField(BaseField):
    """投资者申报费阶梯收取记录"""
    _fields_ = [
        ('ExchangeID', c_char * 9),  # 交易所代码
        ('BrokerID', c_char * 11),  # 经纪公司代码
        ('InvestorID', c_char * 13),  # 投资者代码
        ('InstrumentID', c_char * 81),  # 商品代码
        ('OrderCount', c_int),  # 报单总笔数
        ('OrderActionCount', c_int),  # 撤单总笔数
        ('ForQuoteCnt', c_int),  # 询价总次数
        ('InfoComm', c_double),  # 申报费
        ('IsOptSeries', c_int),  # 是否期权系列
        ('ProductID', c_char * 41),  # 品种代码
        ('InfoCnt', c_int)  # 信息量总量
    ]


class QryInvestorInfoCommRecField(BaseField):
    """投资者申报费阶梯收取记录查询"""
    _fields_ = [
        ('InvestorID', c_char * 13),  # 投资者代码
        ('InstrumentID', c_char * 81),  # 商品代码
...
class QryCombLegField(BaseField):
    """组合腿信息查询"""
    _fields_ = [
        ('LegInstrumentID', c_char * 81)  # 单腿合约代码
    ]
...
class InputOffsetSettingField(BaseField):
    """输入的对冲设置"""
    _fields_ = [
        ('BrokerID', c_char * 11),  # 经纪公司代码
        ('InvestorID', c_char * 13),  # 投资者代码
        ('InstrumentID', c_char * 81),  # 合约代码
        ('UnderlyingInstrID', c_char * 81),  # 标的期货合约代码
        ('ProductID', c_char * 41),  # 产品代码
        ('OffsetType', c_char * 1),  # 对冲类型
        ('Volume', c_int),  # 申请对冲的合约数量
        ('IsOffset', c_int),  # 是否对冲
        ('RequestID', c_int),  # 请求编号
        ('UserID', c_char * 16),  # 用户代码
        ('ExchangeID', c_char * 9),  # 交易所代码
...
class OffsetSettingField(BaseField):
    """对冲设置"""
    _fields_ = [
        ('BrokerID', c_char * 11),  # 经纪公司代码
        ('InvestorID', c_char * 13),  # 投资者代码
        ...
        ('IPAddress', c_char * 33),  # IP地址
        ('MacAddress', c_char * 21),  # Mac地址
        ('ExchangeInstID', c_char * 81),  # 交易所合约代码
        ('ExchangeSerialNo', c_char * 81),  # 交易所期权系列号
        ('ExchangeProductID', c_char * 41),  # 交易所产品代码
        ('ParticipantID', c_char * 11),  # 会员代码
        ('ClientID', c_char * 11),  # 客户代码
        ('TraderID', c_char * 21),  # 交易所交易员代码
        ('InstallID', c_int),  # 安装编号
        ('OrderSubmitStatus', c_char * 1),  # 对冲提交状态
        ('TradingDay', c_char * 9),  # 交易日
        ('SettlementID', c_int),  # 结算编号
        ('InsertDate', c_char * 9),  # 报单日期
        ('InsertTime', c_char * 9),  # 插入时间
        ('CancelTime', c_char * 9),  # 撤销时间
        ('ExecResult', c_char * 1),  # 对冲设置结果
        ('SequenceNo', c_int),  # 序号
        ('FrontID', c_int),  # 前置编号
        ('SessionID', c_int),  # 会话编号
        ('StatusMsg', c_char * 81),  # 状态信息
        ('ActiveUserID', c_char * 16),  # 操作用户代码
        ('BrokerOffsetSettingSeq', c_int),  # 经纪公司报单编号
        ('ApplySrc', c_char * 1)  # 申请来源
    ]


class CancelOffsetSettingField(BaseField):
    """撤销对冲设置"""
    _fields_ = [
        ('BrokerID', c_char * 11),  # 经纪公司代码
        ('InvestorID', c_char * 13),  # 投资者代码
...
class QryOffsetSettingField(BaseField):
    """查询对冲设置"""
    _fields_ = [
        ('BrokerID', c_char * 11),  # 经纪公司代码
        ('InvestorID', c_char * 13),  # 投资者代码
...
class AddrAppIDRelationField(BaseField):
    """服务地址和AppID的关系"""
    _fields_ = [
        ('BrokerID', c_char * 11),  # 经纪公司代码
        ('Address', c_char * 129),  # 服务地址
...
class QryAddrAppIDRelationField(BaseField):
    """服务地址和AppID的关系查询"""
    _fields_ = [
        ('BrokerID', c_char * 11)  # 经纪公司代码
    ]
...
class WechatUserSystemInfoField(BaseField):
    """微信小程序等用户系统信息"""
    _fields_ = [
        ('BrokerID', c_char * 11),  # 经纪公司代码
        ('UserID', c_char * 16),  # 用户代码
        ('WechatCltSysInfoLen', c_int),  # 微信小程序等用户端系统内部信息长度
        ('WechatCltSysInfo', c_char * 273),  # 微信小程序等用户端系统内部信息
        ('ClientIPPort', c_int),  # 终端IP端口
        ('ClientLoginTime', c_char * 9),  # 登录成功时间
        ('ClientAppID', c_char * 33),  # App代码
        ('ClientPublicIP', c_char * 33),  # 用户公网IP
...
class InvestorReserveInfoField(BaseField):
    """投资者预留信息"""
    _fields_ = [
        ('BrokerID', c_char * 11),  # 经纪公司代码
        ('UserID', c_char * 16),  # 用户代码
...
class QryInvestorDepartmentFlatField(BaseField):
    """查询组织架构投资者对应关系"""
    _fields_ = [
        ('BrokerID', c_char * 11)  # 经纪公司代码
    ]
...
class InvestorDepartmentFlatField(BaseField):
    """组织架构投资者对应关系"""
    _fields_ = [
        ('BrokerID', c_char * 11),  # 经纪公司代码
        ('InvestorID', c_char * 13),  # 投资者代码
        ('DepartmentID', c_char * 13)  # 组织架构代码
    ]


class QryDepartmentUserField(BaseField):
    """查询操作员组织架构关系"""
    _fields_ = [
        ('BrokerID', c_char * 11)  # 经纪公司代码
    ]
...
class FrontInfoField(BaseField):
    """前置信息"""
    _fields_ = [
        ('FrontAddr', c_char * 101),  # 前置地址
        ('QryFreq', c_int),  # 查询流控
        ('FTDPkgFreq', c_int)  # FTD流控
    ]
