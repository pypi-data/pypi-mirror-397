...
class RejectTransferResponseExternalAccountTypedDict(TypedDict):
...
class RejectTransferResponseExternalAccount(BaseModel):
    r"""The external account information"""
...
class RejectTransferResponseDelivererTypedDict(TypedDict):
    ...
    external_account: NotRequired[
        Nullable[RejectTransferResponseExternalAccountTypedDict]
    ]
    r"""The external account information"""


class RejectTransferResponseDeliverer(BaseModel):
    r"""The delivering party information"""

    apex_account_id: Optional[str] = None
    r"""The internal apex account id"""

    external_account: OptionalNullable[RejectTransferResponseExternalAccount] = UNSET
    r"""The external account information"""
...
class RejectTransferResponseDirection(str, Enum, metaclass=utils.OpenEnumMeta):
...
class RejectTransferResponseNsccStatus(str, Enum, metaclass=utils.OpenEnumMeta):
...
class RejectTransferResponseTransferExternalAccountTypedDict(TypedDict):
    r"""The external account information"""
...
class RejectTransferResponseTransferExternalAccount(BaseModel):
    r"""The external account information"""
...
class RejectTransferResponseReceiverTypedDict(TypedDict):
    r"""The receiving party information"""

    apex_account_id: NotRequired[str]
    r"""The internal apex account id"""
    external_account: NotRequired[
        Nullable[RejectTransferResponseTransferExternalAccountTypedDict]
    ]
    r"""The external account information"""


class RejectTransferResponseReceiver(BaseModel):
    r"""The receiving party information"""
...
class RejectTransferResponseRejectCode(str, Enum, metaclass=utils.OpenEnumMeta):
    r"""The reject code"""
...
class RejectTransferResponseState(str, Enum, metaclass=utils.OpenEnumMeta):
...
class RejectTransferResponseTransferTypedDict(TypedDict):
    r"""The rejected transfer's resource"""
    ...
    deliverer: NotRequired[Nullable[RejectTransferResponseDelivererTypedDict]]
    r"""The delivering party information"""
    direction: NotRequired[RejectTransferResponseDirection]
    r"""The direction of the transfer"""
    ...
    nscc_status: NotRequired[RejectTransferResponseNsccStatus]
    r"""The NSCC transfer status"""
    original_control_number: NotRequired[str]
    r"""An associated NSCC transfer identifier, if applicable"""
    receiver: NotRequired[Nullable[RejectTransferResponseReceiverTypedDict]]
    r"""The receiving party information"""
    reject_code: NotRequired[RejectTransferResponseRejectCode]
    r"""The reject code"""
    state: NotRequired[RejectTransferResponseState]
    r"""The transfer state"""
    state_reason: NotRequired[str]
    r"""A reason for the state if applicable"""
    transfer_type: NotRequired[RejectTransferResponseTransferType]
    r"""The type of transfer"""


class RejectTransferResponseTransfer(BaseModel):
    r"""The rejected transfer's resource"""
    ...
    deliverer: OptionalNullable[RejectTransferResponseDeliverer] = UNSET
    r"""The delivering party information"""

    direction: Annotated[
        Optional[RejectTransferResponseDirection],
    ...
    nscc_status: Annotated[
        Optional[RejectTransferResponseNsccStatus],
        PlainValidator(validate_open_enum(False)),
    ] = None
    r"""The NSCC transfer status"""
    ...
    receiver: OptionalNullable[RejectTransferResponseReceiver] = UNSET
    r"""The receiving party information"""

    reject_code: Annotated[
        Optional[RejectTransferResponseRejectCode],
        PlainValidator(validate_open_enum(False)),
    ] = None
    r"""The reject code"""

    state: Annotated[
        Optional[RejectTransferResponseState], PlainValidator(validate_open_enum(False))
    ] = None
    r"""The transfer state"""
    ...
    transfer_type: Annotated[
        Optional[RejectTransferResponseTransferType],
        PlainValidator(validate_open_enum(False)),
    ] = None
    r"""The type of transfer"""
...
class RejectTransferResponseTypedDict(TypedDict):
    r"""Response from rejecting internal Ascend transfers. If this is the first side (delivering/receiving) of an internal transfer that is being rejected, the contra side would be implicitly rejected at the same time."""

    transfer: NotRequired[Nullable[RejectTransferResponseTransferTypedDict]]
    r"""The rejected transfer's resource"""


class RejectTransferResponse(BaseModel):
    r"""Response from rejecting internal Ascend transfers. If this is the first side (delivering/receiving) of an internal transfer that is being rejected, the contra side would be implicitly rejected at the same time."""

    transfer: OptionalNullable[RejectTransferResponseTransfer] = UNSET
    r"""The rejected transfer's resource"""
