...
class CustomerIdentificationBirthDateTypedDict(TypedDict):
...
class CustomerIdentificationBirthDate(BaseModel):
    r"""**Field Dependencies:**
...
class CustomerIdentificationLegalAddressTypedDict(TypedDict):
    r"""**Field Dependencies:**
...
class CustomerIdentificationLegalAddress(BaseModel):
    r"""**Field Dependencies:**
...
class IdentityTypedDict(TypedDict):
    ...
    birth_date: NotRequired[Nullable[CustomerIdentificationBirthDateTypedDict]]
    r"""**Field Dependencies:**
    ...
    Otherwise, must be empty.
    """
    identifications: NotRequired[List[IdentityIdentificationTypedDict]]
    r"""**Field Dependencies:**
    ...
    Otherwise, must be empty.
    """
    legal_address: NotRequired[Nullable[CustomerIdentificationLegalAddressTypedDict]]
    r"""**Field Dependencies:**
    ...
    Otherwise, must be empty.
    """
    middle_names: NotRequired[List[str]]
    r"""Middle names"""
...
class Identity(BaseModel):
    ...
    birth_date: OptionalNullable[CustomerIdentificationBirthDate] = UNSET
    r"""**Field Dependencies:**
    ...
    identifications: Optional[List[IdentityIdentification]] = None
    r"""**Field Dependencies:**
    ...
    legal_address: OptionalNullable[CustomerIdentificationLegalAddress] = UNSET
    r"""**Field Dependencies:**
    ...
    def serialize_model(self, handler):
        ...
        nullable_fields = ["birth_date", "legal_address"]
        null_default_fields = []
...
class CustomerIdentificationTypedDict(TypedDict):
    ...
    r"""The types of checks being requested Must either be DATABASE or DOCUMENTARY else will return INVALID_ARGUMENT"""
    identity: NotRequired[Nullable[IdentityTypedDict]]
    r"""**Field Dependencies:**
...
class CustomerIdentification(BaseModel):
    ...
    identity: OptionalNullable[Identity] = UNSET
    r"""**Field Dependencies:**
    ...
    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = ["check_types", "identity", "name", "results"]
        nullable_fields = ["identity"]
        null_default_fields = []
