...
class TransfersFeeAmountTypedDict(TypedDict):
...
class TransfersFeeAmount(BaseModel):
    r"""The amount of the fee being charged from the investor's account"""
...
class TransfersFeeStateState(str, Enum, metaclass=utils.OpenEnumMeta):
...
class TransfersFeeStateTypedDict(TypedDict):
    r"""The current state of the fee"""
    ...
    """
    state: NotRequired[TransfersFeeStateState]
    r"""The high level state of a transfer, one of:
    - `PROCESSING` - The transfer is being processed and will be posted if successful.
    - `PENDING_REVIEW` - The transfer is pending review and will continue processing if approved.
    - `POSTED` - The transfer has been posted to the ledger and will be completed at the end of the processing window if not canceled first.
...
class TransfersFeeState(BaseModel):
    r"""The current state of the fee"""
    ...
    state: Annotated[
        Optional[TransfersFeeStateState], PlainValidator(validate_open_enum(False))
    ] = None
    r"""The high level state of a transfer, one of:
    - `PROCESSING` - The transfer is being processed and will be posted if successful.
    - `PENDING_REVIEW` - The transfer is pending review and will continue processing if approved.
...
class TransfersFeeType(str, Enum, metaclass=utils.OpenEnumMeta):
...
class TransfersFeeTypedDict(TypedDict):
    ...
    r"""The current state of the fee"""
    type: NotRequired[TransfersFeeType]
    r"""The type of the fee being charged"""


class TransfersFee(BaseModel):
    r"""A transfer using the FEE mechanism. Funds are moved from a customer's brokerage account to the firm account"""
    ...
    state: OptionalNullable[TransfersFeeState] = UNSET
    r"""The current state of the fee"""

    type: Annotated[
        Optional[TransfersFeeType], PlainValidator(validate_open_enum(False))
    ] = None
    r"""The type of the fee being charged"""
