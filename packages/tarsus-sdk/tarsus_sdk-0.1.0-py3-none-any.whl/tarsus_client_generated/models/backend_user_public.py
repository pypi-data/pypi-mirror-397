...
from ..models.backend_user_public_subscription_status_type_0 import (
    BackendUserPublicSubscriptionStatusType0,
)
from ..models.backend_user_public_subscription_tier_type_0 import (
...
class BackendUserPublic:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.subscription_status, Unset):
            ...
            self.subscription_status, BackendUserPublicSubscriptionStatusType0
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        stripe_payment_method_id = _parse_stripe_payment_method_id(
            d.pop("stripe_payment_method_id", UNSET)
        )
        ...
        payment_method_last4 = _parse_payment_method_last4(
            d.pop("payment_method_last4", UNSET)
        )
        ...
        payment_method_brand = _parse_payment_method_brand(
            d.pop("payment_method_brand", UNSET)
        )
        ...
        payment_method_exp_month = _parse_payment_method_exp_month(
            d.pop("payment_method_exp_month", UNSET)
        )
        ...
        payment_method_exp_year = _parse_payment_method_exp_year(
            d.pop("payment_method_exp_year", UNSET)
        )
        ...
        stripe_customer_id = _parse_stripe_customer_id(
            d.pop("stripe_customer_id", UNSET)
        )
        ...
        stripe_subscription_id = _parse_stripe_subscription_id(
            d.pop("stripe_subscription_id", UNSET)
        )

        def _parse_subscription_tier(
            data: object,
        ) -> BackendUserPublicSubscriptionTierType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_subscription_status(
            data: object,
        ) -> BackendUserPublicSubscriptionStatusType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                subscription_status_type_0 = BackendUserPublicSubscriptionStatusType0(
                    data
                )
