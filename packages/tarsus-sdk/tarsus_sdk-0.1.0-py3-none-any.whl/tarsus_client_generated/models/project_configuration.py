...
class ProjectConfiguration:
    ...
    Attributes:
        enabled_product_types (list[ProductType] | Unset): List of enabled product types for this project
        enabled_payment_types (list[PaymentType] | Unset): List of enabled payment types for this project
        default_product_type (None | ProductType | Unset): Default product type for new products (primary selection at
            creation) Default: ProductType.STANDARD_PHYSICAL.
    ...
    enabled_product_types: list[ProductType] | Unset = UNSET
    enabled_payment_types: list[PaymentType] | Unset = UNSET
    default_product_type: None | ProductType | Unset = ProductType.STANDARD_PHYSICAL
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _enabled_product_types is not UNSET:
            ...
            for enabled_product_types_item_data in _enabled_product_types:
                enabled_product_types_item = ProductType(
                    enabled_product_types_item_data
                )
        ...
        if _enabled_payment_types is not UNSET:
            ...
            for enabled_payment_types_item_data in _enabled_payment_types:
                enabled_payment_types_item = PaymentType(
                    enabled_payment_types_item_data
                )
