...
class APIKeyCreate:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.endpoint_permissions, Unset):
            ...
            self.endpoint_permissions, APIKeyCreateEndpointPermissionsType0
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_endpoint_permissions(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                endpoint_permissions_type_0 = (
                    APIKeyCreateEndpointPermissionsType0.from_dict(data)
                )
        ...
        endpoint_permissions = _parse_endpoint_permissions(
            d.pop("endpoint_permissions", UNSET)
        )
        ...
        rate_limit_per_minute = _parse_rate_limit_per_minute(
            d.pop("rate_limit_per_minute", UNSET)
        )
        ...
        rate_limit_per_hour = _parse_rate_limit_per_hour(
            d.pop("rate_limit_per_hour", UNSET)
        )
        ...
        rate_limit_per_day = _parse_rate_limit_per_day(
            d.pop("rate_limit_per_day", UNSET)
        )
