...
class EnforcedSchema:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        schema_definition = EnforcedSchemaSchemaDefinition.from_dict(
            d.pop("schema_definition")
        )
        ...
        def _parse_validation_report(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                validation_report_type_0 = (
                    EnforcedSchemaValidationReportType0.from_dict(data)
                )
