...
class ProjectCreate:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        primary_product_type = _parse_primary_product_type(
            d.pop("primary_product_type", UNSET)
        )
        ...
        primary_payment_type = _parse_primary_payment_type(
            d.pop("primary_payment_type", UNSET)
        )
