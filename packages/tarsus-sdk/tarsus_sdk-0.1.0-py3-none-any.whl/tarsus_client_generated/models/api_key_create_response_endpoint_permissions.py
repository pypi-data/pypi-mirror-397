...
class APIKeyCreateResponseEndpointPermissions:
    ...
    additional_properties: dict[
        str, list[APIKeyCreateResponseEndpointPermissionsAdditionalPropertyItem]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_key_create_response_endpoint_permissions.additional_properties = (
            additional_properties
        )
    ...
    def __getitem__(
        self, key: str
    ) -> list[APIKeyCreateResponseEndpointPermissionsAdditionalPropertyItem]:
