...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/products/{product_id}/modifications".format(
...
) -> Any | HTTPValidationError | list[ModificationDefinitionModel] | None:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = ModificationDefinitionModel.from_dict(
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | HTTPValidationError | list[ModificationDefinitionModel]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """List all modifications for a product

     Retrieves all modifications for a product.
...
def sync(
    ...
    *,
    ...
    Returns:
        Any | HTTPValidationError | list[ModificationDefinitionModel]
    """
