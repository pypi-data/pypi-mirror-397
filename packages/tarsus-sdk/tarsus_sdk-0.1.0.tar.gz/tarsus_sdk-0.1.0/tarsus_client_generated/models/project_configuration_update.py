...
T = TypeVar("T", bound="ProjectConfigurationUpdate")


@_attrs_define
class ProjectConfigurationUpdate:
    ...
    Attributes:
        ...
        default_product_type (None | ProductType | Unset):
        default_payment_type (None | PaymentType | Unset):
    """

    enabled_product_types: list[ProductType] | None | Unset = UNSET
    enabled_payment_types: list[PaymentType] | None | Unset = UNSET
    default_product_type: None | ProductType | Unset = UNSET
    default_payment_type: None | PaymentType | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.enabled_product_types, Unset):
            ...
            for enabled_product_types_type_0_item_data in self.enabled_product_types:
                enabled_product_types_type_0_item = (
                    enabled_product_types_type_0_item_data.value
                )
        ...
        if isinstance(self.enabled_payment_types, Unset):
            ...
            for enabled_payment_types_type_0_item_data in self.enabled_payment_types:
                enabled_payment_types_type_0_item = (
                    enabled_payment_types_type_0_item_data.value
                )
        ...
        elif isinstance(self.default_product_type, ProductType):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_enabled_product_types(
            ...
            try:
                ...
                for (
                    enabled_product_types_type_0_item_data
                ) in _enabled_product_types_type_0:
                    enabled_product_types_type_0_item = ProductType(
                        enabled_product_types_type_0_item_data
                    )

                    enabled_product_types_type_0.append(
                        enabled_product_types_type_0_item
                    )
        ...
        enabled_product_types = _parse_enabled_product_types(
            d.pop("enabled_product_types", UNSET)
        )
        ...
        def _parse_enabled_payment_types(
            ...
            try:
                ...
                for (
                    enabled_payment_types_type_0_item_data
                ) in _enabled_payment_types_type_0:
                    enabled_payment_types_type_0_item = PaymentType(
                        enabled_payment_types_type_0_item_data
                    )

                    enabled_payment_types_type_0.append(
                        enabled_payment_types_type_0_item
                    )
        ...
        enabled_payment_types = _parse_enabled_payment_types(
            d.pop("enabled_payment_types", UNSET)
        )

        def _parse_default_product_type(data: object) -> None | ProductType | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                default_product_type_type_0 = ProductType(data)
        ...
        default_product_type = _parse_default_product_type(
            d.pop("default_product_type", UNSET)
        )
        ...
        default_payment_type = _parse_default_payment_type(
            d.pop("default_payment_type", UNSET)
        )

        project_configuration_update = cls(
        ...
        project_configuration_update.additional_properties = d
        return project_configuration_update
