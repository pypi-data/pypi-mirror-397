...
class CreateSubscriptionWithWalletRequest:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.metadata, Unset):
            ...
            self.metadata, CreateSubscriptionWithWalletRequestMetadataType0
        ):
        ...
        def _parse_metadata(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                metadata_type_0 = (
                    CreateSubscriptionWithWalletRequestMetadataType0.from_dict(data)
                )
                ...
                pass
            return cast(
                CreateSubscriptionWithWalletRequestMetadataType0 | None | Unset, data
            )
