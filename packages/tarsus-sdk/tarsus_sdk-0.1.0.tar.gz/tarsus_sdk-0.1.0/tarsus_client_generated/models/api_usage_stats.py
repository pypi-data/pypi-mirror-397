...
class APIUsageStats:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        average_response_time_ms = _parse_average_response_time_ms(
            d.pop("average_response_time_ms")
        )

        requests_by_endpoint = APIUsageStatsRequestsByEndpoint.from_dict(
            d.pop("requests_by_endpoint")
        )

        requests_by_status_code = APIUsageStatsRequestsByStatusCode.from_dict(
            d.pop("requests_by_status_code")
        )
        ...
        total_data_transferred_bytes = _parse_total_data_transferred_bytes(
            d.pop("total_data_transferred_bytes")
        )
