...
if TYPE_CHECKING:
    from ..models.wallet_payment_intent_request_metadata_type_0 import (
...
class WalletPaymentIntentRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_metadata(
            data: object,
        ) -> None | Unset | WalletPaymentIntentRequestMetadataType0:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                metadata_type_0 = WalletPaymentIntentRequestMetadataType0.from_dict(
                    data
                )
