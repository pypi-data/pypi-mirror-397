...
if TYPE_CHECKING:
    from ..models.payment_method_info_billing_details_type_0 import (
...
class PaymentMethodInfo:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_billing_details(
            data: object,
        ) -> None | PaymentMethodInfoBillingDetailsType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                billing_details_type_0 = PaymentMethodInfoBillingDetailsType0.from_dict(
                    data
                )
