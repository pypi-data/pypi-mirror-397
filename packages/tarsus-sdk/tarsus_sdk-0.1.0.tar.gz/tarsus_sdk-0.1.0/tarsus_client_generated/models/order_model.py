...
class OrderModel:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        stripe_payment_intent_id = _parse_stripe_payment_intent_id(
            d.pop("stripe_payment_intent_id", UNSET)
        )
        ...
        stripe_payment_status = _parse_stripe_payment_status(
            d.pop("stripe_payment_status", UNSET)
        )
