...
class APIUsageLog:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        request_size_bytes = _parse_request_size_bytes(
            d.pop("request_size_bytes", UNSET)
        )
        ...
        response_size_bytes = _parse_response_size_bytes(
            d.pop("response_size_bytes", UNSET)
        )
