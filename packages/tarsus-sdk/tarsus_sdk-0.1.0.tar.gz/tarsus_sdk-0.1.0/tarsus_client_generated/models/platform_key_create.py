...
T = TypeVar("T", bound="PlatformKeyCreate")


@_attrs_define
class PlatformKeyCreate:
    """Model for creating a new platform key
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        stripe_publishable_key = _parse_stripe_publishable_key(
            d.pop("stripe_publishable_key", UNSET)
        )
        ...
        stripe_webhook_secret = _parse_stripe_webhook_secret(
            d.pop("stripe_webhook_secret", UNSET)
        )
        ...
        platform_key_create.additional_properties = d
        return platform_key_create
