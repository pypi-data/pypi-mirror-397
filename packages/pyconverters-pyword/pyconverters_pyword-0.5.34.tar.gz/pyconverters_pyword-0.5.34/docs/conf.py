...
import pyconverters_pyword


# -- Project information -----------------------------------------------------

project = "pyconverters_pyword"
copyright = "2021, Olivier Terrier"
author = "Olivier Terrier"
version = pyconverters_pyword.__version__
release = pyconverters_pyword.__version__
...
apidoc_module_dir = os.path.dirname(pyconverters_pyword.__file__)
