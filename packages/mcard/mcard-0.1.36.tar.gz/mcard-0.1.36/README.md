...
- **Schema principles**: [schema/README.md](schema/README.md) — The Empty Schema Principle, Monadic Duality, and Three-Table sufficiency
...
### Version 0.1.36 / 2.1.16 — December 15, 2025

#### UPTV Protocol Alignment

Updated the documentation and implementation to align with the **Unifying Protocol of Truth Verification (UPTV)**.

**Key Updates:**
-   **UPTV Alignment**: Refined PTR, CLM, and PCard documentation to reflect the **Categorical Petri Net** architecture (Handle=Place, PCard=Transition, VCard=Token).
-   **CLM Triad**: Formally defined the abstract-concrete-balanced ($A \times C \times B$) triad as the unit of verification.
