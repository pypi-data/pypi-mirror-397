...
def _run_openswath_assay_generator(regtest, temp_folder):
    ...
    conn = sqlite3.connect("library_targets.pqp")
...
def test_openswath_assay_generator(tmpdir, regtest):
    _run_openswath_assay_generator(regtest, tmpdir.strpath)