...
class StatusInfo(ExternalizableAbstractModel):
    ...
    :param is_restricted_mode: (:attr:`is_restricted_mode`) Boolean that indicates if LCM is running in restricted mode or not (**Default** False)
    :type is_restricted_mode: 
    ...
    attribute_map = {
        ...
        'is_restricted_mode': 'isRestrictedMode',
    ...
    def __init__(self, framework_version=None, in_progress_operation=None, is_cancel_intent_set=False, upload_task_uuid=None, is_url_accessible=True, is_restricted_mode=False, connectivity_type=None, restricted_mode_type=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
        ...
        self.__is_restricted_mode = None
        ...
        if is_restricted_mode is not None:
            self.__is_restricted_mode = is_restricted_mode
    ...
    def is_restricted_mode(self):
        ...
        :type:
                :class:`~bool`
        """  # noqa: E501
        return self.__is_restricted_mode

    @is_restricted_mode.setter
    def is_restricted_mode(self, is_restricted_mode):
