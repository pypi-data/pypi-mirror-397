...
class ExportHistorySpec(object):
    ...
    def _initialize_object_type(self):
        return 'lifecycle.v4.resources.ExportHistorySpec'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ExportHistorySpec, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ExportHistorySpec):
            return False
