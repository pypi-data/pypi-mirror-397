...
from ntnx_lifecycle_py_client.models.lifecycle.v4.common.FileFormat import FileFormat  # noqa: F401,E501

class ExportInventorySpec(object):

    """Specification for exporting inventory.

    :param file_format: (:attr:`file_format`) 
    :type file_format: required
    ...
    """  # noqa: E501
    swagger_types = {
        'file_format': 'lifecycle.v4.common.FileFormat',
    ...
    def __init__(self, file_format=None, *args, **kwargs):  # noqa: E501
    ...
    def _initialize_object_type(self):
        return 'lifecycle.v4.resources.ExportInventorySpec'
    ...
    def file_format(self):
        ...
        :type:
            :class:`~ntnx_lifecycle_py_client.models.lifecycle.v4.common.FileFormat`
        """  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ExportInventorySpec, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ExportInventorySpec):
            return False
