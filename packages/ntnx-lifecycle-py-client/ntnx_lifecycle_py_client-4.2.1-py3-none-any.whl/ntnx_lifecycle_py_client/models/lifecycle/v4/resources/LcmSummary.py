...
from ntnx_lifecycle_py_client.models.lifecycle.v4.common.ClusterType import ClusterType  # noqa: F401,E501
...
from ntnx_lifecycle_py_client.models.lifecycle.v4.resources.RestrictedModeType import RestrictedModeType  # noqa: F401,E501
...
class LcmSummary(ExternalizableAbstractModel):
    ...
    :param is_url_accessible: (:attr:`is_url_accessible`) Boolean that indicates if LCM url is accessible or not (**Default** True)
    :type is_url_accessible: 
    
    
    :param restricted_mode_type: (:attr:`restricted_mode_type`) 
    :type restricted_mode_type: 
    
    
    :param compatibility_bundle_version: (:attr:`compatibility_bundle_version`) Installed Nutanix Compatibility version on the cluster.
    :type compatibility_bundle_version: 
     min=1 chars, max=128 chars
    ...
    swagger_types = {
        ...
        'cluster_ext_id': 'str',
        'is_url_accessible': 'bool',
        'restricted_mode_type': 'lifecycle.v4.resources.RestrictedModeType',
        'compatibility_bundle_version': 'str',
        'connectivity_type': 'lifecycle.v4.resources.ConnectivityType',
        'cluster_type': 'lifecycle.v4.common.ClusterType',
        'ext_id': 'str',
    ...
    attribute_map = {
        ...
        'is_url_accessible': 'isUrlAccessible',
        'restricted_mode_type': 'restrictedModeType',
        'compatibility_bundle_version': 'compatibilityBundleVersion',
    ...
    def __init__(self, current_version=None, available_version=None, hardware_vendor=None, capabilities=None, in_progress_operation=None, cluster_ext_id=None, is_url_accessible=True, restricted_mode_type=None, compatibility_bundle_version=None, connectivity_type=None, cluster_type=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
        ...
        self.__is_url_accessible = None
        self.__restricted_mode_type = None
        self.__compatibility_bundle_version = None
        ...
        if is_url_accessible is not None:
            self.__is_url_accessible = is_url_accessible
        if restricted_mode_type is not None:
            self.__restricted_mode_type = restricted_mode_type
        if compatibility_bundle_version is not None:
            self.__compatibility_bundle_version = compatibility_bundle_version
    ...
    def is_url_accessible(self):
        ...
        :type:
                :class:`~bool`
        """  # noqa: E501
        return self.__is_url_accessible

    @is_url_accessible.setter
    def is_url_accessible(self, is_url_accessible):

        self.__is_url_accessible = is_url_accessible

    @property
    def restricted_mode_type(self):
        """
        

        :type:
            :class:`~ntnx_lifecycle_py_client.models.lifecycle.v4.resources.RestrictedModeType`
        """  # noqa: E501
        return self.__restricted_mode_type

    @restricted_mode_type.setter
    def restricted_mode_type(self, restricted_mode_type):

        self.__restricted_mode_type = restricted_mode_type

    @property
    def compatibility_bundle_version(self):
        """
        ...
        :type:
                :class:`~str`
        """  # noqa: E501
        return self.__compatibility_bundle_version

    @compatibility_bundle_version.setter
    def compatibility_bundle_version(self, compatibility_bundle_version):
        if compatibility_bundle_version is not None and len(compatibility_bundle_version) > 128:
            raise ValueError("Invalid value for `compatibility_bundle_version`, length must be less than or equal to `128`")  # noqa: E501
        if compatibility_bundle_version is not None and len(compatibility_bundle_version) < 1:
            raise ValueError("Invalid value for `compatibility_bundle_version`, length must be greater than or equal to `1`")  # noqa: E501
    ...
    def cluster_type(self):
        ...
        :type:
            :class:`~ntnx_lifecycle_py_client.models.lifecycle.v4.common.ClusterType`
        """  # noqa: E501
