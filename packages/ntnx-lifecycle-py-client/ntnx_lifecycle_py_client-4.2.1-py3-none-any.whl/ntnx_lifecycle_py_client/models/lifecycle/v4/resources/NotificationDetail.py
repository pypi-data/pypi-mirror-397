...
from ntnx_lifecycle_py_client.models.lifecycle.v4.resources.SeverityLevel import SeverityLevel  # noqa: F401,E501

class NotificationDetail(object):
    ...
    :param message: (:attr:`message`) A message with notification details. The description of the most disruptive action that will occur on the node or the cluster. INFO, WARNING or NOTICE based message for an entity.
    :type message: 
    ...
    """  # noqa: E501
    swagger_types = {
        'severity_level': 'lifecycle.v4.resources.SeverityLevel',
        'message': 'str',
    ...
    def _initialize_object_type(self):
        return 'lifecycle.v4.resources.NotificationDetail'
    ...
    def severity_level(self):
        ...
        :type:
            :class:`~ntnx_lifecycle_py_client.models.lifecycle.v4.resources.SeverityLevel`
        """  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(NotificationDetail, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NotificationDetail):
            return False
