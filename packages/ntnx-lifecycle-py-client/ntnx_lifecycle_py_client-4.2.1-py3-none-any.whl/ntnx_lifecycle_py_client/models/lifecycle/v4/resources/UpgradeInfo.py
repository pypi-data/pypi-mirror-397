...
from ntnx_lifecycle_py_client.models.lifecycle.v4.resources.ComponentDetails import ComponentDetails  # noqa: F401,E501

class UpgradeInfo(object):

    """Details of the upgrade operation relevant for History.

    :param component_details: (:attr:`component_details`) Details of the component that was upgraded.
    ...
    """  # noqa: E501
    swagger_types = {
        'component_details': 'list[lifecycle.v4.resources.ComponentDetails]',
    ...
    def __init__(self, component_details=None, *args, **kwargs):  # noqa: E501
        self.__component_details = None
        self.discriminator = None
        if component_details is not None:
            self.__component_details = component_details
        # populate hidden vars if not empty
        self._populate_hidden_vars(kwargs)

    def _initialize_object_type(self):
        return 'lifecycle.v4.resources.UpgradeInfo'
    ...
    def component_details(self):
        ...
        :type:
             list[ :class:`~ntnx_lifecycle_py_client.models.lifecycle.v4.resources.ComponentDetails` ]
        """  # noqa: E501
        return self.__component_details
