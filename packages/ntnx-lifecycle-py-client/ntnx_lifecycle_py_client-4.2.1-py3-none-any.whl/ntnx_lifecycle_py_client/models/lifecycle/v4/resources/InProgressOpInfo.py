...
class InProgressOpInfo(object):

    """Operation type and UUID of an ongoing operation in LCM.

    :param operation_id: (:attr:`operation_id`) Root task UUID of the operation, if it is in running state.
    :type operation_id: 
    ...
    def __init__(self, operation_id=None, operation_type=None, *args, **kwargs):  # noqa: E501
    ...
    def _initialize_object_type(self):
        return 'lifecycle.v4.resources.InProgressOpInfo'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(InProgressOpInfo, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InProgressOpInfo):
            return False
