...
from ntnx_lifecycle_py_client.models.OneOflifecycle.v4.svcmgr.ClientConfigconfig import ClientConfigconfig  # noqa: F401,E501

class ClientConfig(object):

    """Access configuration of the client used to access AHV or ESX clusters.

    :param name: (:attr:`name`) Name of the client configuration.
    :type name: required
     min=1 chars,
    
    :param type: (:attr:`type`) Type of platform client.
    :type type: required
    ...
    swagger_types = {
        'name': 'str',
        'type': 'str',
        'config': 'OneOflifecycle.v4.svcmgr.ClientConfigconfig',
    ...
    def __init__(self, name=None, type=None, config=None, *args, **kwargs):  # noqa: E501
        self.__name = None
        self.__type = None
        self.__config = None
    ...
    def _initialize_object_type(self):
        return 'lifecycle.v4.svcmgr.ClientConfig'
    ...
    def type(self, type):
        ...
        allowed_values = ["AHV", "ESX"]  # noqa: E501
    ...
    def config(self):
        ...
        :type:
                :class:`~ntnx_lifecycle_py_client.models.lifecycle.v4.svcmgr.AhvClientConfig` | 
                :class:`~ntnx_lifecycle_py_client.models.lifecycle.v4.svcmgr.EsxClientConfig`
        """  # noqa: E501
