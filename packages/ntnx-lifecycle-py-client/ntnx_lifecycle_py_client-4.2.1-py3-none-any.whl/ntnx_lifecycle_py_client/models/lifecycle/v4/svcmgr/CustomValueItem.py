...
from ntnx_lifecycle_py_client.models.OneOflifecycle.v4.svcmgr.CustomValueItemvalue import CustomValueItemvalue  # noqa: F401,E501

class CustomValueItem(object):
    ...
    swagger_types = {
        'key': 'str',
        'value': 'OneOflifecycle.v4.svcmgr.CustomValueItemvalue',
    ...
    def _initialize_object_type(self):
        return 'lifecycle.v4.svcmgr.CustomValueItem'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(CustomValueItem, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CustomValueItem):
            return False
