...
class Nic(object):
    ...
    :param nic_usage: (:attr:`nic_usage`) 
    :type nic_usage: 
    ...
    def __init__(self, network=None, nic_usage=None, *args, **kwargs):  # noqa: E501
        self.__network = None
        self.__nic_usage = None
        self.discriminator = None
        if network is not None:
            self.__network = network
        if nic_usage is not None:
            self.__nic_usage = nic_usage
        # populate hidden vars if not empty
        self._populate_hidden_vars(kwargs)

    def _initialize_object_type(self):
        return 'lifecycle.v4.svcmgr.Nic'
    ...
    def nic_usage(self):
        ...
        :type:
             list[ :class:`~ntnx_lifecycle_py_client.models.lifecycle.v4.svcmgr.NicUsage` ]
        """  # noqa: E501
        return self.__nic_usage

    @nic_usage.setter
    def nic_usage(self, nic_usage):
