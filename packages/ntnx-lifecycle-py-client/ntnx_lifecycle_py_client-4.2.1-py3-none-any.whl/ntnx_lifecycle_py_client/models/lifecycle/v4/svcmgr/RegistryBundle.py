...
class RegistryBundle(object):

    """

    :param filepath: (:attr:`filepath`) 
    :type filepath: required
    
    
    :param cluster_uuid: (:attr:`cluster_uuid`) UUID of a cluster, optional. If not specified, the default controller_msp will be used
    :type cluster_uuid: 
    ...
    def __init__(self, filepath=None, cluster_uuid=None, *args, **kwargs):  # noqa: E501
    ...
    def _initialize_object_type(self):
        return 'lifecycle.v4.svcmgr.RegistryBundle'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(RegistryBundle, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RegistryBundle):
            return False
