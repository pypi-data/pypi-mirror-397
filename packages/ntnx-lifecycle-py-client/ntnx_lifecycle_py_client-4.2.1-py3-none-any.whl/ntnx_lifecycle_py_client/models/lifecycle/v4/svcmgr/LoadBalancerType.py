...
class LoadBalancerType(object):
    ...
    Allowed enum values:
        ...
        - _UNKNOWN
        - _REDACTED
        - VM: Load Balancer instance should run on a separate VM.
        - CONTAINER_MASTERS: Load Balancer instance should run as a container on the same node as K8s master.
    """
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    VM = "VM"
    CONTAINER_MASTERS = "CONTAINER_MASTERS"
    ...
    def _initialize_object_type(self):
        return 'lifecycle.v4.svcmgr.LoadBalancerType'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(LoadBalancerType, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LoadBalancerType):
            return False
