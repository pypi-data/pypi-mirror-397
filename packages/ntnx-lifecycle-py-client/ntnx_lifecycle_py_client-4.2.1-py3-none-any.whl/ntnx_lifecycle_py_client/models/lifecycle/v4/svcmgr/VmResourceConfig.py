...
class VmResourceConfig(object):

    """Resource configuration for the vm.

    :param cpu: (:attr:`cpu`) Number of VCPUs to be allocated to the vm.
    :type cpu: 
    
     min=1,
    :param disk_mib: (:attr:`disk_mib`) Memory requirements of VM.
    :type disk_mib: 
    
    
    :param memory_mib: (:attr:`memory_mib`) Memory requirements of VM.
    :type memory_mib: 
    ...
    def __init__(self, cpu=None, disk_mib=None, memory_mib=None, *args, **kwargs):  # noqa: E501
        self.__cpu = None
        self.__disk_mib = None
        self.__memory_mib = None
        self.discriminator = None
        if cpu is not None:
            self.__cpu = cpu
        if disk_mib is not None:
            self.__disk_mib = disk_mib
        if memory_mib is not None:
            self.__memory_mib = memory_mib
        # populate hidden vars if not empty
        self._populate_hidden_vars(kwargs)

    def _initialize_object_type(self):
        return 'lifecycle.v4.svcmgr.VmResourceConfig'
    ...
    def disk_mib(self):
        ...
        :type:
                :class:`~int`
        """  # noqa: E501
        return self.__disk_mib

    @disk_mib.setter
    def disk_mib(self, disk_mib):
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VmResourceConfig, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VmResourceConfig):
            return False
