...
class AppProtectionPolicyStart(object):
    ...
    def _initialize_object_type(self):
        return 'lifecycle.v4.svcmgr.AppProtectionPolicyStart'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(AppProtectionPolicyStart, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AppProtectionPolicyStart):
            return False
