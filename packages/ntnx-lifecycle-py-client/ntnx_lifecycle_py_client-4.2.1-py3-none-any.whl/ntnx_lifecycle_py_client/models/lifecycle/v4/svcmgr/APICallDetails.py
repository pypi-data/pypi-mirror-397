...
class APICallDetails(object):
    ...
    :param endpoint: (:attr:`endpoint`) Endpoint path to invoke.
    :type endpoint: required
    
    
    :param host: (:attr:`host`) Host of the API endpoint.
    :type host: required
    
    
    :param port: (:attr:`port`) Port of the API endpoint.
    :type port: required
    
    
    :param request_body: (:attr:`request_body`) Request body sent with the API call.
    :type request_body: 
    ...
    def __init__(self, endpoint=None, host=None, port=None, request_body=None, *args, **kwargs):  # noqa: E501
    ...
    def _initialize_object_type(self):
        return 'lifecycle.v4.svcmgr.APICallDetails'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(APICallDetails, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, APICallDetails):
            return False
