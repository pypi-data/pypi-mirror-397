...
class VmNetworkResourceConfig(object):

    """Network resources for Vm.

    :param network: (:attr:`network`) Network id to be used for this vm config.
    :type network: required
     min=1 chars,
    
    :param cluster_id: (:attr:`cluster_id`) Cluster Id of the Prism Element which hosts the Kubernetes cluster.
    :type cluster_id: 
    ...
    def __init__(self, network=None, cluster_id=None, *args, **kwargs):  # noqa: E501
        self.__network = None
    ...
    def _initialize_object_type(self):
        return 'lifecycle.v4.svcmgr.VmNetworkResourceConfig'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VmNetworkResourceConfig, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VmNetworkResourceConfig):
            return False
