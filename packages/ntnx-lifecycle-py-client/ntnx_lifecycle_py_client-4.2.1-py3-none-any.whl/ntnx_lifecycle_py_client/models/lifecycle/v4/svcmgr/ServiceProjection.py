...
class ServiceProjection(Service):
    ...
    def __init__(self, name=None, version=None, apptype=None, uuid=None, cluster_uuid=None, action=None, status=None, created_timestamp=None, last_updated_timestamp=None, is_inactive=None, *args, **kwargs):  # noqa: E501
        Service.__init__(self, name, version, apptype, uuid, cluster_uuid, action, status, created_timestamp, last_updated_timestamp, is_inactive, *args, **kwargs)
        self.discriminator = None

    def _initialize_object_type(self):
        return 'lifecycle.v4.svcmgr.ServiceProjection'
