...
class VendorManagementName(object):
    ...
    Allowed enum values:
        ...
        - _UNKNOWN
        - _REDACTED
        - UCS: Thirdparty vendor - Cisco UCS server management software.
        - ISM: Thirdparty vendor - Cisco Intersight management software.
        - VCENTER: Thirdparty vendor - ESX Vcenter Server management software.
    """
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    UCS = "UCS"
    ...
    def _initialize_object_type(self):
        return 'lifecycle.v4.common.VendorManagementName'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VendorManagementName, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VendorManagementName):
            return False
