...
class InProgressOpDetails(object):

    """Details of the in progress LCM operation.

    :param task_ext_id: (:attr:`task_ext_id`) Task ext id of the in progress LCM operation.
    :type task_ext_id: 
    ...
    def __init__(self, task_ext_id=None, operation_type=None, *args, **kwargs):  # noqa: E501
    ...
    def _initialize_object_type(self):
        return 'lifecycle.v4.common.InProgressOpDetails'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(InProgressOpDetails, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InProgressOpDetails):
            return False
