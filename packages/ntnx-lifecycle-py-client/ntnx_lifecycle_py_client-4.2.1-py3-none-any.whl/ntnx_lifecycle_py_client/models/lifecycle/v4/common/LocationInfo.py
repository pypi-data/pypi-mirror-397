...
from ntnx_lifecycle_py_client.models.lifecycle.v4.common.LocationType import LocationType  # noqa: F401,E501

class LocationInfo(object):

    """Location info corresponds to a tuple of location type (either node/cluster) and ExtID

    :param uuid: (:attr:`uuid`) Location UUID of the resource.
    :type uuid: 
    
    
    :param location_type: (:attr:`location_type`) 
    :type location_type: 
    
    
    :param location_name: (:attr:`location_name`) Name of the location.
    :type location_name: 
    ...
    swagger_types = {
        'uuid': 'str',
        'location_type': 'lifecycle.v4.common.LocationType',
        'location_name': 'str',
    ...
    def __init__(self, uuid=None, location_type=None, location_name=None, *args, **kwargs):  # noqa: E501
        self.__uuid = None
        self.__location_type = None
        self.__location_name = None
    ...
    def _initialize_object_type(self):
        return 'lifecycle.v4.common.LocationInfo'
    ...
    def location_type(self):
        ...
        :type:
            :class:`~ntnx_lifecycle_py_client.models.lifecycle.v4.common.LocationType`
        """  # noqa: E501
    ...
    def location_name(self, location_name):
        if location_name is not None and len(location_name) > 256:
            raise ValueError("Invalid value for `location_name`, length must be less than or equal to `256`")  # noqa: E501
        if location_name is not None and len(location_name) < 1:
            raise ValueError("Invalid value for `location_name`, length must be greater than or equal to `1`")  # noqa: E501
