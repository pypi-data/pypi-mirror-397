...
class AvailableVersionStatus(object):
    ...
    def _initialize_object_type(self):
        return 'lifecycle.v4.common.AvailableVersionStatus'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(AvailableVersionStatus, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AvailableVersionStatus):
            return False
