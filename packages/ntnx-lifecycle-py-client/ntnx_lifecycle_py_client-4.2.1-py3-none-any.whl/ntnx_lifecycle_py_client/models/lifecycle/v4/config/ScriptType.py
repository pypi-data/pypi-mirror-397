...
class ScriptType(object):
    ...
    Allowed enum values:
        ...
        - _UNKNOWN
        - _REDACTED
        - ESCRIPT: Escript is a type of script that is executed on the cluster, typically used for automation tasks.
    """
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    ESCRIPT = "ESCRIPT"
    ...
    def _initialize_object_type(self):
        return 'lifecycle.v4.config.ScriptType'
