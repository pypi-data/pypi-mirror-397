...
from ntnx_lifecycle_py_client.models.prism.v4.management.Credentials import Credentials  # noqa: F401,E501

class RemoteClusterSpec(object):
    ...
    swagger_types = {
        ...
        'credentials': 'prism.v4.management.Credentials',
    ...
    def _initialize_object_type(self):
        return 'prism.v4.management.RemoteClusterSpec'
    ...
    def credentials(self):
        ...
        :type:
            :class:`~ntnx_lifecycle_py_client.models.prism.v4.management.Credentials`
        """  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(RemoteClusterSpec, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RemoteClusterSpec):
            return False
