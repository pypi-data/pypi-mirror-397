...
class IntersightConnectionType(object):
    ...
    Allowed enum values:
        ...
        - _UNKNOWN
        - _REDACTED
        - INTERSIGHT_SAAS: Intersight SaaS connection.
        - INTERSIGHT_VIRTUAL_APPLIANCE: Intersight Virtual Appliance connection.
    """
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    INTERSIGHT_SAAS = "INTERSIGHT_SAAS"
    INTERSIGHT_VIRTUAL_APPLIANCE = "INTERSIGHT_VIRTUAL_APPLIANCE"
    ...
    def _initialize_object_type(self):
        return 'security.v4.config.IntersightConnectionType'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(IntersightConnectionType, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IntersightConnectionType):
            return False
