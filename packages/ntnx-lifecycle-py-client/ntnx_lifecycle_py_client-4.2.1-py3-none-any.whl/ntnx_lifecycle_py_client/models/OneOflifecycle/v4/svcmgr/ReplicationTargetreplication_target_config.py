...
class ReplicationTargetreplication_target_config(object):
    ...
    discriminator_value_class_map = {
        ...
        'lifecycle.v4.svcmgr.AsyncReplicationTargetConfig': 'lifecycle.v4.svcmgr.AsyncReplicationTargetConfig',
        'lifecycle.v4.svcmgr.SyncReplicationTargetConfig': 'lifecycle.v4.svcmgr.SyncReplicationTargetConfig'
    }

    ONE_OF_ITEM_DISCRIMINATOR_NAME = '$replicationTargetConfigItemDiscriminator'
    ...
    def _initialize_object_type(self):
        return 'OneOflifecycle.v4.svcmgr.ReplicationTargetreplication_target_config'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ReplicationTargetreplication_target_config.discriminator_value_class_map.values():
            return list(ReplicationTargetreplication_target_config.discriminator_value_class_map.keys())[list(ReplicationTargetreplication_target_config.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ReplicationTargetreplication_target_config, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ReplicationTargetreplication_target_config):
            return False
