...
class ClusterResourceConfigresource_config(object):
    ...
    discriminator_value_class_map = {
        ...
        'lifecycle.v4.svcmgr.AhvResourceConfig': 'lifecycle.v4.svcmgr.AhvResourceConfig',
        'lifecycle.v4.svcmgr.EsxResourceConfig': 'lifecycle.v4.svcmgr.EsxResourceConfig'
    }

    ONE_OF_ITEM_DISCRIMINATOR_NAME = '$resourceConfigItemDiscriminator'
    ...
    def _initialize_object_type(self):
        return 'OneOflifecycle.v4.svcmgr.ClusterResourceConfigresource_config'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ClusterResourceConfigresource_config.discriminator_value_class_map.values():
            return list(ClusterResourceConfigresource_config.discriminator_value_class_map.keys())[list(ClusterResourceConfigresource_config.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ClusterResourceConfigresource_config, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ClusterResourceConfigresource_config):
            return False
