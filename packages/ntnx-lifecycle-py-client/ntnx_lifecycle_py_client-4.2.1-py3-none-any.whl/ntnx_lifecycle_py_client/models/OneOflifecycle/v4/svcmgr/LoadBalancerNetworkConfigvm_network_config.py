...
class LoadBalancerNetworkConfigvm_network_config(object):
    ...
    discriminator_value_class_map = {
        ...
        'lifecycle.v4.svcmgr.AhvNetworkResourceConfig': 'lifecycle.v4.svcmgr.AhvNetworkResourceConfig',
        'lifecycle.v4.svcmgr.EsxNetworkResourceConfig': 'lifecycle.v4.svcmgr.EsxNetworkResourceConfig'
    }

    ONE_OF_ITEM_DISCRIMINATOR_NAME = '$vmNetworkConfigItemDiscriminator'
    ...
    def _initialize_object_type(self):
        return 'OneOflifecycle.v4.svcmgr.LoadBalancerNetworkConfigvm_network_config'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in LoadBalancerNetworkConfigvm_network_config.discriminator_value_class_map.values():
            return list(LoadBalancerNetworkConfigvm_network_config.discriminator_value_class_map.keys())[list(LoadBalancerNetworkConfigvm_network_config.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(LoadBalancerNetworkConfigvm_network_config, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LoadBalancerNetworkConfigvm_network_config):
            return False
