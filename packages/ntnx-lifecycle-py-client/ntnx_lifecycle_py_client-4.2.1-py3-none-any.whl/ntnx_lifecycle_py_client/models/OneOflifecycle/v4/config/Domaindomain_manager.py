...
class Domaindomain_manager(object):
    ...
    def _initialize_object_type(self):
        return 'OneOflifecycle.v4.config.Domaindomain_manager'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in Domaindomain_manager.discriminator_value_class_map.values():
            return list(Domaindomain_manager.discriminator_value_class_map.keys())[list(Domaindomain_manager.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(Domaindomain_manager, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, Domaindomain_manager):
            return False
