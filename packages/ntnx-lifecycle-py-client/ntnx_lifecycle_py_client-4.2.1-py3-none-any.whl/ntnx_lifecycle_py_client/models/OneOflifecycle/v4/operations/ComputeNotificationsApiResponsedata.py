...
class ComputeNotificationsApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOflifecycle.v4.operations.ComputeNotificationsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ComputeNotificationsApiResponsedata.discriminator_value_class_map.values():
            return list(ComputeNotificationsApiResponsedata.discriminator_value_class_map.keys())[list(ComputeNotificationsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ComputeNotificationsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ComputeNotificationsApiResponsedata):
            return False
