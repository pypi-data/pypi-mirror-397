...
class DeleteUpgradeSelectionApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOflifecycle.v4.resources.DeleteUpgradeSelectionApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in DeleteUpgradeSelectionApiResponsedata.discriminator_value_class_map.values():
            return list(DeleteUpgradeSelectionApiResponsedata.discriminator_value_class_map.keys())[list(DeleteUpgradeSelectionApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(DeleteUpgradeSelectionApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteUpgradeSelectionApiResponsedata):
            return False
