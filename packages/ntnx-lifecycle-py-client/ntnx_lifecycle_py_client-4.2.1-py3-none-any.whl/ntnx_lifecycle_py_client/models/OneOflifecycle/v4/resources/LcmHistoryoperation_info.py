...
class LcmHistoryoperation_info(object):
    ...
    discriminator_value_class_map = {
        ...
        'lifecycle.v4.resources.UploadInfo': 'lifecycle.v4.resources.UploadInfo',
        'lifecycle.v4.resources.UpgradeInfo': 'lifecycle.v4.resources.UpgradeInfo'
    }

    ONE_OF_ITEM_DISCRIMINATOR_NAME = '$operationInfoItemDiscriminator'
    ...
    def _initialize_object_type(self):
        return 'OneOflifecycle.v4.resources.LcmHistoryoperation_info'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in LcmHistoryoperation_info.discriminator_value_class_map.values():
            return list(LcmHistoryoperation_info.discriminator_value_class_map.keys())[list(LcmHistoryoperation_info.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(LcmHistoryoperation_info, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LcmHistoryoperation_info):
            return False
