...
class ExportHistoriesApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOflifecycle.v4.resources.ExportHistoriesApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ExportHistoriesApiResponsedata.discriminator_value_class_map.values():
            return list(ExportHistoriesApiResponsedata.discriminator_value_class_map.keys())[list(ExportHistoriesApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ExportHistoriesApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ExportHistoriesApiResponsedata):
            return False
