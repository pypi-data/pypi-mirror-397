...
class GetLcmHistoryByIdApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'lifecycle.v4.resources.LcmHistory': 'lifecycle.v4.resources.LcmHistory',
    ...
    def _initialize_object_type(self):
        return 'OneOflifecycle.v4.resources.GetLcmHistoryByIdApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetLcmHistoryByIdApiResponsedata.discriminator_value_class_map.values():
            return list(GetLcmHistoryByIdApiResponsedata.discriminator_value_class_map.keys())[list(GetLcmHistoryByIdApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetLcmHistoryByIdApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetLcmHistoryByIdApiResponsedata):
            return False
