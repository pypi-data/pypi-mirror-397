...
class ListImagesApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<lifecycle.v4.resources.Image>': 'list[lifecycle.v4.resources.Image]',
    ...
    def _initialize_object_type(self):
        return 'OneOflifecycle.v4.resources.ListImagesApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListImagesApiResponsedata.discriminator_value_class_map.values():
            return list(ListImagesApiResponsedata.discriminator_value_class_map.keys())[list(ListImagesApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListImagesApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListImagesApiResponsedata):
            return False
