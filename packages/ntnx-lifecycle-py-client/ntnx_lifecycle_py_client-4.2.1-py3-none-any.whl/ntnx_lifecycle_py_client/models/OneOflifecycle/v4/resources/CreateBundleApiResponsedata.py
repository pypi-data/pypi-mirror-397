...
class CreateBundleApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOflifecycle.v4.resources.CreateBundleApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in CreateBundleApiResponsedata.discriminator_value_class_map.values():
            return list(CreateBundleApiResponsedata.discriminator_value_class_map.keys())[list(CreateBundleApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(CreateBundleApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateBundleApiResponsedata):
            return False
