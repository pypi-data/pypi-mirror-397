...
class ListBundlesApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<lifecycle.v4.resources.Bundle>': 'list[lifecycle.v4.resources.Bundle]',
    ...
    def _initialize_object_type(self):
        return 'OneOflifecycle.v4.resources.ListBundlesApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListBundlesApiResponsedata.discriminator_value_class_map.values():
            return list(ListBundlesApiResponsedata.discriminator_value_class_map.keys())[list(ListBundlesApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListBundlesApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListBundlesApiResponsedata):
            return False
