...
class RecommendationSpecrecommendation_spec(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<lifecycle.v4.common.EntityType>': 'list[lifecycle.v4.common.EntityType]',
        'List<lifecycle.v4.resources.TargetEntity>': 'list[lifecycle.v4.resources.TargetEntity]',
        'List<lifecycle.v4.common.EntityUpdateSpec>': 'list[lifecycle.v4.common.EntityUpdateSpec]',
        'List<lifecycle.v4.common.EntityDeploySpec>': 'list[lifecycle.v4.common.EntityDeploySpec]'
    }

    ONE_OF_ITEM_DISCRIMINATOR_NAME = '$recommendationSpecItemDiscriminator'
    ...
    def _initialize_object_type(self):
        return 'OneOflifecycle.v4.resources.RecommendationSpecrecommendation_spec'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in RecommendationSpecrecommendation_spec.discriminator_value_class_map.values():
            return list(RecommendationSpecrecommendation_spec.discriminator_value_class_map.keys())[list(RecommendationSpecrecommendation_spec.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(RecommendationSpecrecommendation_spec, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RecommendationSpecrecommendation_spec):
            return False
