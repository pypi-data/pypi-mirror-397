...
class VendorManagementCredentialcredential_spec(object):
    ...
    discriminator_value_class_map = {
        ...
        'security.v4.config.IntersightCredential': 'security.v4.config.IntersightCredential',
        'security.v4.config.VcenterCredential': 'security.v4.config.VcenterCredential'
    }

    ONE_OF_ITEM_DISCRIMINATOR_NAME = '$credentialSpecItemDiscriminator'
    ...
    def _initialize_object_type(self):
        return 'OneOflifecycle.v4.common.VendorManagementCredentialcredential_spec'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in VendorManagementCredentialcredential_spec.discriminator_value_class_map.values():
            return list(VendorManagementCredentialcredential_spec.discriminator_value_class_map.keys())[list(VendorManagementCredentialcredential_spec.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VendorManagementCredentialcredential_spec, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VendorManagementCredentialcredential_spec):
            return False
