...
class Credentialcredential_detail(object):
    ...
    discriminator_value_class_map = {
        ...
        'lifecycle.v4.common.CredentialReference': 'lifecycle.v4.common.CredentialReference',
        'lifecycle.v4.common.VendorManagementCredential': 'lifecycle.v4.common.VendorManagementCredential'
    }

    ONE_OF_ITEM_DISCRIMINATOR_NAME = '$credentialDetailItemDiscriminator'
    ...
    def _initialize_object_type(self):
        return 'OneOflifecycle.v4.common.Credentialcredential_detail'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in Credentialcredential_detail.discriminator_value_class_map.values():
            return list(Credentialcredential_detail.discriminator_value_class_map.keys())[list(Credentialcredential_detail.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(Credentialcredential_detail, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, Credentialcredential_detail):
            return False
