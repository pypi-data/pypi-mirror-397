...
class StatusApi(object):
    ...
    def get_status(self, X_Cluster_Id=None, **kwargs):  # noqa: E501
        """Get the LCM framework status.

        >>> response = api.get_status((optional) X_Cluster_Id)
        ...
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
                           ...
                           async_req=True
        :return: An instance of class :class:`~ntnx_lifecycle_py_client.models.lifecycle.v4.resources.GetStatusApiResponse`.
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/lifecycle/v4.2/resources/status', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
                    ...
                    response_type='lifecycle.v4.resources.GetStatusApiResponse',  # noqa: E501
