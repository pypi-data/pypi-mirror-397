...
class ConfigApi(object):
    ...
    def get_config(self, X_Cluster_Id=None, **kwargs):  # noqa: E501
        """Get the present LCM configuration.

        >>> response = api.get_config((optional) X_Cluster_Id)
        ...
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
                           ...
                           async_req=True
        :return: An instance of class :class:`~ntnx_lifecycle_py_client.models.lifecycle.v4.resources.GetConfigApiResponse`.
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/lifecycle/v4.2/resources/config', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
                    ...
                    response_type='lifecycle.v4.resources.GetConfigApiResponse',  # noqa: E501
    ...
    def update_config(self, body, X_Cluster_Id=None, **kwargs):  # noqa: E501
        """Change the LCM configuration.

        >>> response = api.update_config(body, (optional) X_Cluster_Id)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.update_config(body, async_req=True)
        >>> result = thread.get()

        :param body: 
        :type body:
            :class:`~ntnx_lifecycle_py_client.models.lifecycle.v4.resources.Config`, required
        :param X_Cluster_Id: Cluster uuid on which the resource is present or operation is being performed.
        :type X_Cluster_Id:
            :class:`str`
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
                           ...
                           async_req=True
        :return: An instance of class :class:`~ntnx_lifecycle_py_client.models.lifecycle.v4.resources.UpdateConfigApiResponse`.
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/lifecycle/v4.2/resources/config', 'PUT',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
                    post_params=form_params,
                    files=local_var_files,
                    response_type='lifecycle.v4.resources.UpdateConfigApiResponse',  # noqa: E501
                    auth_settings=auth_settings,
                    async_req=params.get('async_req'),
                    _return_http_data_only=params.get('_return_http_data_only'),
                    _preload_content=params.get('_preload_content', True),
