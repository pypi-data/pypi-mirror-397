...
class UpgradesApi(object):
    ...
    def perform_upgrade(self, body, X_Cluster_Id=None, _dryrun=None, **kwargs):  # noqa: E501
        """Perform an LCM upgrade operation.

        >>> response = api.perform_upgrade(body, (optional) X_Cluster_Id, (optional) _dryrun)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.perform_upgrade(body, async_req=True)
        >>> result = thread.get()

        :param body: 
        :type body:
            :class:`~ntnx_lifecycle_py_client.models.lifecycle.v4.common.UpgradeSpec`, required
        ...
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
                           ...
                           async_req=True
        :return: An instance of class :class:`~ntnx_lifecycle_py_client.models.lifecycle.v4.operations.UpgradeApiResponse`.
        ...
        if ('body' not in params or params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `perform_upgrade`")  # noqa: E501
        ...
        all_params = set(['body', 'X_Cluster_Id', '_dryrun'])
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/lifecycle/v4.2/operations/$actions/upgrade', 'POST',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
                    ...
                    response_type='lifecycle.v4.operations.UpgradeApiResponse',  # noqa: E501
