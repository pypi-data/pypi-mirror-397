...
class InventoryApi(object):
    ...
    def perform_inventory(self, X_Cluster_Id=None, body=None, _dryrun=None, **kwargs):  # noqa: E501
        """Perform an inventory operation to identify/scan entities on the cluster that can be updated through LCM.

        >>> response = api.perform_inventory((optional) X_Cluster_Id, (optional) body, (optional) _dryrun)
        ...
        :param body: 
        :type body:
            :class:`~ntnx_lifecycle_py_client.models.lifecycle.v4.operations.InventorySpec`
        ...
        all_params = set(['X_Cluster_Id', 'body', '_dryrun'])
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/lifecycle/v4.2/operations/$actions/inventory', 'POST',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
