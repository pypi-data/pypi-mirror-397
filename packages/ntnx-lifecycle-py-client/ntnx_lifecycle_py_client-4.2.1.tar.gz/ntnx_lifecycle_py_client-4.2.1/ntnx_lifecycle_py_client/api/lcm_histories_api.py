...
class LcmHistoriesApi(object):
    ...
    def export_histories(self, body, **kwargs):  # noqa: E501
        """Export the history information of connected clusters.

        >>> response = api.export_histories(body)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.export_histories(body, async_req=True)
        >>> result = thread.get()

        :param body: 
        :type body:
            :class:`~ntnx_lifecycle_py_client.models.lifecycle.v4.resources.ExportHistorySpec`, required
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::

                           async_req=True
        :return: An instance of class :class:`~ntnx_lifecycle_py_client.models.lifecycle.v4.resources.ExportHistoriesApiResponse`.
        ...
        if ('body' not in params or params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `export_histories`")  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/lifecycle/v4.2/resources/lcm-histories/$actions/export', 'POST',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
                    ...
                    response_type='lifecycle.v4.resources.ExportHistoriesApiResponse',  # noqa: E501
    ...
    def get_lcm_history_by_id(self, extId, **kwargs):  # noqa: E501
        """Get details about an LCM history entry.

        >>> response = api.get_lcm_history_by_id(extId)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.get_lcm_history_by_id(extId, async_req=True)
        >>> result = thread.get()

        :param extId: UUID of the LCM history.
        :type extId:
            :class:`str`, required
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
                           ...
                           async_req=True
        :return: An instance of class :class:`~ntnx_lifecycle_py_client.models.lifecycle.v4.resources.GetLcmHistoryByIdApiResponse`.
        ...
        if ('extId' not in params or params['extId'] is None):
            raise ValueError("Missing the required parameter `extId` when calling `get_lcm_history_by_id`")  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/lifecycle/v4.2/resources/lcm-histories/{extId}', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
                    post_params=form_params,
                    files=local_var_files,
                    response_type='lifecycle.v4.resources.GetLcmHistoryByIdApiResponse',  # noqa: E501
                    auth_settings=auth_settings,
                    async_req=params.get('async_req'),
                    _return_http_data_only=params.get('_return_http_data_only'),
                    _preload_content=params.get('_preload_content', True),
    ...
    def list_lcm_histories(self, _page=None, _limit=None, _filter=None, _orderby=None, _select=None, **kwargs):  # noqa: E501
        """Summary of the queried LCM histories.

        >>> response = api.list_lcm_histories((optional) _page, (optional) _limit, (optional) _filter, (optional) _orderby, (optional) _select)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.list_lcm_histories(async_req=True)
        >>> result = thread.get()
        ...
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
                           ...
                           async_req=True
        :return: An instance of class :class:`~ntnx_lifecycle_py_client.models.lifecycle.v4.resources.ListLcmHistoriesApiResponse`.
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/lifecycle/v4.2/resources/lcm-histories', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
                    post_params=form_params,
                    files=local_var_files,
                    response_type='lifecycle.v4.resources.ListLcmHistoriesApiResponse',  # noqa: E501
                    auth_settings=auth_settings,
                    async_req=params.get('async_req'),
                    _return_http_data_only=params.get('_return_http_data_only'),
                    _preload_content=params.get('_preload_content', True),
