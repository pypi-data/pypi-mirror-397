...
class PrechecksApi(object):
    ...
    def perform_prechecks(self, body, X_Cluster_Id=None, _dryrun=None, **kwargs):  # noqa: E501
        """Perform LCM prechecks operation.

        >>> response = api.perform_prechecks(body, (optional) X_Cluster_Id, (optional) _dryrun)
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/lifecycle/v4.2/operations/$actions/prechecks', 'POST',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
