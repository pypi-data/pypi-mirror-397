...
class ListUpgradeSelectionsApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<lifecycle.v4.resources.UpgradeSelection>': 'list[lifecycle.v4.resources.UpgradeSelection]',
        'lifecycle.v4.error.ErrorResponse': 'lifecycle.v4.error.ErrorResponse'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOflifecycle.v4.resources.ListUpgradeSelectionsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListUpgradeSelectionsApiResponsedata.discriminator_value_class_map.values():
            return list(ListUpgradeSelectionsApiResponsedata.discriminator_value_class_map.keys())[list(ListUpgradeSelectionsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListUpgradeSelectionsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListUpgradeSelectionsApiResponsedata):
            return False
