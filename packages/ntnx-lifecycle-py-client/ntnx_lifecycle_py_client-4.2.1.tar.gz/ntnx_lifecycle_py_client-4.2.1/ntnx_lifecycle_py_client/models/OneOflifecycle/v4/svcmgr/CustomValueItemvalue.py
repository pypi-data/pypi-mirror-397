...
class CustomValueItemvalue(object):
    ...
    def _initialize_object_type(self):
        return 'OneOflifecycle.v4.svcmgr.CustomValueItemvalue'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in CustomValueItemvalue.discriminator_value_class_map.values():
            return list(CustomValueItemvalue.discriminator_value_class_map.keys())[list(CustomValueItemvalue.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(CustomValueItemvalue, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CustomValueItemvalue):
            return False
