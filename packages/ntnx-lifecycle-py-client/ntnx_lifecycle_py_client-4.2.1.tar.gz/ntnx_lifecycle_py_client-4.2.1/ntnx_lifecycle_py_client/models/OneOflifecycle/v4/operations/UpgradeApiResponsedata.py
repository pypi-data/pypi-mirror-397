...
class UpgradeApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOflifecycle.v4.operations.UpgradeApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in UpgradeApiResponsedata.discriminator_value_class_map.values():
            return list(UpgradeApiResponsedata.discriminator_value_class_map.keys())[list(UpgradeApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(UpgradeApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpgradeApiResponsedata):
            return False
