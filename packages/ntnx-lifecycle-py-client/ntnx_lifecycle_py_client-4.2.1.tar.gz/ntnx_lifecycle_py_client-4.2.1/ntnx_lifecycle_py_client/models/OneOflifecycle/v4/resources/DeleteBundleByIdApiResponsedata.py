...
class DeleteBundleByIdApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOflifecycle.v4.resources.DeleteBundleByIdApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in DeleteBundleByIdApiResponsedata.discriminator_value_class_map.values():
            return list(DeleteBundleByIdApiResponsedata.discriminator_value_class_map.keys())[list(DeleteBundleByIdApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(DeleteBundleByIdApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteBundleByIdApiResponsedata):
            return False
