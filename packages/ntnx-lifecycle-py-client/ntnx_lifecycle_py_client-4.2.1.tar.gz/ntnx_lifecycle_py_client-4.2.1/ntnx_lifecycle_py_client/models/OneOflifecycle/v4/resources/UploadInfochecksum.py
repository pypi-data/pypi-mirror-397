...
class UploadInfochecksum(object):
    ...
    discriminator_value_class_map = {
        ...
        'lifecycle.v4.common.LcmSha256Sum': 'lifecycle.v4.common.LcmSha256Sum',
        'lifecycle.v4.common.LcmMd5Sum': 'lifecycle.v4.common.LcmMd5Sum'
    }

    ONE_OF_ITEM_DISCRIMINATOR_NAME = '$checksumItemDiscriminator'
    ...
    def _initialize_object_type(self):
        return 'OneOflifecycle.v4.resources.UploadInfochecksum'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in UploadInfochecksum.discriminator_value_class_map.values():
            return list(UploadInfochecksum.discriminator_value_class_map.keys())[list(UploadInfochecksum.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(UploadInfochecksum, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UploadInfochecksum):
            return False
