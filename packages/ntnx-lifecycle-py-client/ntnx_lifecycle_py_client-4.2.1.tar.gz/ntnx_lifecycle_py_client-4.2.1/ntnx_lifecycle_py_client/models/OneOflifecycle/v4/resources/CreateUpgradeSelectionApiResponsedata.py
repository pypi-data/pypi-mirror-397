...
class CreateUpgradeSelectionApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOflifecycle.v4.resources.CreateUpgradeSelectionApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in CreateUpgradeSelectionApiResponsedata.discriminator_value_class_map.values():
            return list(CreateUpgradeSelectionApiResponsedata.discriminator_value_class_map.keys())[list(CreateUpgradeSelectionApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(CreateUpgradeSelectionApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateUpgradeSelectionApiResponsedata):
            return False
