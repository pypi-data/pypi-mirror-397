...
class PrePostActionaction_details(object):
    ...
    discriminator_value_class_map = {
        ...
        'lifecycle.v4.svcmgr.HelmJobDetails': 'lifecycle.v4.svcmgr.HelmJobDetails',
        'lifecycle.v4.svcmgr.APICallDetails': 'lifecycle.v4.svcmgr.APICallDetails'
    }

    ONE_OF_ITEM_DISCRIMINATOR_NAME = '$actionDetailsItemDiscriminator'
    ...
    def _initialize_object_type(self):
        return 'OneOflifecycle.v4.svcmgr.PrePostActionaction_details'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in PrePostActionaction_details.discriminator_value_class_map.values():
            return list(PrePostActionaction_details.discriminator_value_class_map.keys())[list(PrePostActionaction_details.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(PrePostActionaction_details, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PrePostActionaction_details):
            return False
