...
class ClientConfigconfig(object):
    ...
    discriminator_value_class_map = {
        ...
        'lifecycle.v4.svcmgr.AhvClientConfig': 'lifecycle.v4.svcmgr.AhvClientConfig',
        'lifecycle.v4.svcmgr.EsxClientConfig': 'lifecycle.v4.svcmgr.EsxClientConfig'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOflifecycle.v4.svcmgr.ClientConfigconfig'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ClientConfigconfig.discriminator_value_class_map.values():
            return list(ClientConfigconfig.discriminator_value_class_map.keys())[list(ClientConfigconfig.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ClientConfigconfig, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ClientConfigconfig):
            return False
