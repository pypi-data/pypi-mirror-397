...
class GetNotificationsByIdApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'lifecycle.v4.resources.Notification': 'lifecycle.v4.resources.Notification',
    ...
    def _initialize_object_type(self):
        return 'OneOflifecycle.v4.resources.GetNotificationsByIdApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetNotificationsByIdApiResponsedata.discriminator_value_class_map.values():
            return list(GetNotificationsByIdApiResponsedata.discriminator_value_class_map.keys())[list(GetNotificationsByIdApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetNotificationsByIdApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetNotificationsByIdApiResponsedata):
            return False
