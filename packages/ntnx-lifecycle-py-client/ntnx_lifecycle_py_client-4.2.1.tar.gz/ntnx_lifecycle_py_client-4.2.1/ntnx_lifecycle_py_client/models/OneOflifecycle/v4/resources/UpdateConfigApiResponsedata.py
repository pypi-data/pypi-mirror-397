...
class UpdateConfigApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOflifecycle.v4.resources.UpdateConfigApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in UpdateConfigApiResponsedata.discriminator_value_class_map.values():
            return list(UpdateConfigApiResponsedata.discriminator_value_class_map.keys())[list(UpdateConfigApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(UpdateConfigApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateConfigApiResponsedata):
            return False
