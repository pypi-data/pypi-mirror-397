...
class ErrorResponseerror(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<lifecycle.v4.error.AppMessage>': 'list[lifecycle.v4.error.AppMessage]',
        'lifecycle.v4.error.SchemaValidationError': 'lifecycle.v4.error.SchemaValidationError'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOflifecycle.v4.error.ErrorResponseerror'
