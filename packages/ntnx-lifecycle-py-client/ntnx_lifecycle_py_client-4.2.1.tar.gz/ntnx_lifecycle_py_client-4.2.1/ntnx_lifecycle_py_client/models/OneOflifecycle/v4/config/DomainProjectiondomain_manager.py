...
class DomainProjectiondomain_manager(object):
    ...
    discriminator_value_class_map = {
        ...
        'prism.v4.config.DomainManager': 'prism.v4.config.DomainManager',
        'prism.v4.management.RemoteClusterSpec': 'prism.v4.management.RemoteClusterSpec'
    }

    ONE_OF_ITEM_DISCRIMINATOR_NAME = '$domainManagerItemDiscriminator'
    ...
    def _initialize_object_type(self):
        return 'OneOflifecycle.v4.config.DomainProjectiondomain_manager'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in DomainProjectiondomain_manager.discriminator_value_class_map.values():
            return list(DomainProjectiondomain_manager.discriminator_value_class_map.keys())[list(DomainProjectiondomain_manager.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(DomainProjectiondomain_manager, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DomainProjectiondomain_manager):
            return False
