...
class BundleVendor(object):
    ...
    Allowed enum values:
        ...
        - _UNKNOWN
        - _REDACTED
        - NUTANIX: Nutanix created Bundle
        - THIRD_PARTY: Third Party created Bundle
    """
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    NUTANIX = "NUTANIX"
    ...
    def _initialize_object_type(self):
        return 'lifecycle.v4.resources.BundleVendor'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(BundleVendor, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BundleVendor):
            return False
