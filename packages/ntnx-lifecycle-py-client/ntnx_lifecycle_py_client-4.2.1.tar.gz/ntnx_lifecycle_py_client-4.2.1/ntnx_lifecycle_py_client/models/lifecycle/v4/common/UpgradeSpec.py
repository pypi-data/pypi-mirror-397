...
class UpgradeSpec(PrechecksSpec):
    ...
    def __init__(self, auto_handle_flags=None, max_wait_time_in_secs=None, management_server=None, entity_update_specs=None, skipped_precheck_flags=None, credentials=None, *args, **kwargs):  # noqa: E501
        PrechecksSpec.__init__(self, management_server, entity_update_specs, skipped_precheck_flags, credentials, *args, **kwargs)
