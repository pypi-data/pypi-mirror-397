...
class LoadBalancerConfigType(object):
    ...
    def _initialize_object_type(self):
        return 'lifecycle.v4.svcmgr.LoadBalancerConfigType'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(LoadBalancerConfigType, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LoadBalancerConfigType):
            return False
