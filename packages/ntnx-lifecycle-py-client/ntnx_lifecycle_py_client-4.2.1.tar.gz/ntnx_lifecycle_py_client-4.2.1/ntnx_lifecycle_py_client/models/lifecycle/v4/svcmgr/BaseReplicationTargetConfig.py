...
class BaseReplicationTargetConfig(object):
    ...
    def _initialize_object_type(self):
        return 'lifecycle.v4.svcmgr.BaseReplicationTargetConfig'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(BaseReplicationTargetConfig, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BaseReplicationTargetConfig):
            return False
