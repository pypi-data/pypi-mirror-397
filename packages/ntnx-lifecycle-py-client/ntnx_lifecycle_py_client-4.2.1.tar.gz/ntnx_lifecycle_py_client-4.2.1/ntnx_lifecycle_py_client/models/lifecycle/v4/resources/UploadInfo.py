...
from ntnx_lifecycle_py_client.models.OneOflifecycle.v4.resources.UploadInfochecksum import UploadInfochecksum  # noqa: F401,E501
...
class UploadInfo(object):
    ...
    :param name: (:attr:`name`) LCM subrepo name.
    :type name: 
    ...
    swagger_types = {
        ...
        'checksum': 'OneOflifecycle.v4.resources.UploadInfochecksum',
    ...
    def __init__(self, name=None, type=None, checksum=None, *args, **kwargs):  # noqa: E501
        self.__name = None
        self.__type = None
    ...
    def _initialize_object_type(self):
        return 'lifecycle.v4.resources.UploadInfo'
