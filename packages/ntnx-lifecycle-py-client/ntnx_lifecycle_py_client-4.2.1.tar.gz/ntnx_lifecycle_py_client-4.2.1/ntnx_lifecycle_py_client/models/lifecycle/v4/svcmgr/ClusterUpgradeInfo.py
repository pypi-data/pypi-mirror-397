...
class ClusterUpgradeInfo(object):
    ...
    :param current_version: (:attr:`current_version`) Current version of the cluster.
    :type current_version: required
    
    
    :param compatible_versions: (:attr:`compatible_versions`) List of compatible versions for the cluster.
    :type compatible_versions: required
    ...
    def __init__(self, cluster_ext_id=None, current_version=None, compatible_versions=None, *args, **kwargs):  # noqa: E501
        self.__cluster_ext_id = None
        self.__current_version = None
        self.__compatible_versions = None
        self.discriminator = None
        self.__cluster_ext_id = cluster_ext_id
        self.__current_version = current_version
        self.__compatible_versions = compatible_versions
        # populate hidden vars if not empty
        self._populate_hidden_vars(kwargs)

    def _initialize_object_type(self):
        return 'lifecycle.v4.svcmgr.ClusterUpgradeInfo'
    ...
    def compatible_versions(self, compatible_versions):
        if compatible_versions is None:
            raise ValueError("Invalid value for `compatible_versions`, must not be `None`")  # noqa: E501
