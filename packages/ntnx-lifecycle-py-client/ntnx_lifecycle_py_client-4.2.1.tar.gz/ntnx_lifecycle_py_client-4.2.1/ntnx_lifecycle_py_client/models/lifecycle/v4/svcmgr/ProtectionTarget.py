...
from ntnx_lifecycle_py_client.models.lifecycle.v4.svcmgr.ResourceLabelSelector import ResourceLabelSelector  # noqa: F401,E501

class ProtectionTarget(object):

    """Protection target grouping Kubernetes resources to protect.

    :param name: (:attr:`name`) Name of the protection target. Used when deploying NDK Application custom resource.
    :type name: required
    
    
    :param namespace: (:attr:`namespace`) Namespace where protected resources are located.
    :type namespace: required
    
    
    :param selectors: (:attr:`selectors`) Selectors for protected resources. Each RLS selects resources based on specified label selector and then applies excludes and includes rules for those returned resources. Omitting this will protect all the resources in the namespace.
    :type selectors: 
    ...
    swagger_types = {
        'name': 'str',
        'namespace': 'str',
        'selectors': 'list[lifecycle.v4.svcmgr.ResourceLabelSelector]',
    ...
    def __init__(self, name=None, namespace=None, selectors=None, *args, **kwargs):  # noqa: E501
        self.__name = None
    ...
    def _initialize_object_type(self):
        return 'lifecycle.v4.svcmgr.ProtectionTarget'
    ...
    def selectors(self):
        ...
        :type:
             list[ :class:`~ntnx_lifecycle_py_client.models.lifecycle.v4.svcmgr.ResourceLabelSelector` ]
        """  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ProtectionTarget, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ProtectionTarget):
            return False
