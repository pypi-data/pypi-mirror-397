...
class ClusterManagementIps(object):

    """IPs to manage the cluster.

    :param master_vip: (:attr:`master_vip`) 
    :type master_vip: 
    
    
    :param msp_dns_ip: (:attr:`msp_dns_ip`) 
    :type msp_dns_ip: 
    
    
    :param network: (:attr:`network`) IPAM Name to be used for fetching static IPs that are not provided in the payload.
    :type network: 
     min=1 chars,
    ...
    """  # noqa: E501
    swagger_types = {
        'master_vip': 'common.v1.config.IPv4Address',
        'msp_dns_ip': 'common.v1.config.IPv4Address',
        'network': 'str',
    ...
    def __init__(self, master_vip=None, msp_dns_ip=None, network=None, *args, **kwargs):  # noqa: E501
        self.__master_vip = None
        self.__msp_dns_ip = None
        self.__network = None
        self.discriminator = None
        if master_vip is not None:
            self.__master_vip = master_vip
        if msp_dns_ip is not None:
            self.__msp_dns_ip = msp_dns_ip
    ...
    def _initialize_object_type(self):
        return 'lifecycle.v4.svcmgr.ClusterManagementIps'
    ...
    def master_vip(self):
        ...
        """  # noqa: E501
        return self.__master_vip

    @master_vip.setter
    def master_vip(self, master_vip):
    ...
    def msp_dns_ip(self):
        ...
        :type:
            :class:`~ntnx_lifecycle_py_client.models.common.v1.config.IPv4Address`
        """  # noqa: E501
        return self.__msp_dns_ip

    @msp_dns_ip.setter
    def msp_dns_ip(self, msp_dns_ip):
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ClusterManagementIps, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ClusterManagementIps):
            return False
