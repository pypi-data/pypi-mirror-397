...
class RestrictedModeType(object):
    ...
    Allowed enum values:
        ...
        - _UNKNOWN
        - _REDACTED
        - NON_UNIFORM_AHV: Cluster has non uniform AHV versions
        - EMERGENCY_UPDATES: Cluster has emergency update available
        - EOL_AOS: Cluster is running on end of life AOS/PC version
    """
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    NON_UNIFORM_AHV = "NON_UNIFORM_AHV"
    ...
    def _initialize_object_type(self):
        return 'lifecycle.v4.resources.RestrictedModeType'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(RestrictedModeType, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RestrictedModeType):
            return False
