...
class LcmSha256Sum(object):

    """Sha256sum of the bundle.

    :param hex_digest: (:attr:`hex_digest`) Hex digest of the SHA256 sum.
    ...
    def _initialize_object_type(self):
        return 'lifecycle.v4.common.LcmSha256Sum'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(LcmSha256Sum, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LcmSha256Sum):
            return False
