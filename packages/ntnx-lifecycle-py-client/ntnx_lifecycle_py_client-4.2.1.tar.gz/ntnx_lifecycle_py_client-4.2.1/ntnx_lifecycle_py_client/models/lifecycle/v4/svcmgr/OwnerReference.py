...
class OwnerReference(object):
    ...
    :param ext_id: (:attr:`ext_id`) A globally unique identifier of the task owner.
    :type ext_id: 
    
    
    :param name: (:attr:`name`) Username of the task owner.
    :type name: 
    ...
    def _initialize_object_type(self):
        return 'lifecycle.v4.svcmgr.OwnerReference'
