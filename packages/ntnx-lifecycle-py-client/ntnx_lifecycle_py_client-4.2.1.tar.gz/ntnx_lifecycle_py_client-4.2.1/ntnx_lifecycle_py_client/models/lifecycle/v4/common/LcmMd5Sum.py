...
class LcmMd5Sum(object):

    """MD5Sum of the bundle.

    :param hex_digest: (:attr:`hex_digest`) Hex digest of the MD5 sum.
    ...
    def _initialize_object_type(self):
        return 'lifecycle.v4.common.LcmMd5Sum'
    ...
    def hex_digest(self, hex_digest):
        ...
        if hex_digest is not None and not re.search('^[a-f0-9]{32}$', hex_digest):  # noqa: E501
            raise ValueError(r"Invalid value for `hex_digest`, must be a follow pattern or equal to `/^[a-f0-9]{32}$/`")  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LcmMd5Sum):
            return False
