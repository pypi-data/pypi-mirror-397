...
from ntnx_lifecycle_py_client.models.lifecycle.v4.svcmgr.LoadBalancerNetworkConfig import LoadBalancerNetworkConfig  # noqa: F401,E501

class LoadBalancer(object):

    """Load balancer representing id and network config for it.

    :param network_config: (:attr:`network_config`) 
    :type network_config: 
    
    
    :param id: (:attr:`id`) Identifier for each load balancer. This is generated during cluster creation.
    :type id: 
    ...
    """  # noqa: E501
    swagger_types = {
        'network_config': 'lifecycle.v4.svcmgr.LoadBalancerNetworkConfig',
        'id': 'str',
    ...
    def __init__(self, network_config=None, id=None, *args, **kwargs):  # noqa: E501
    ...
    def _initialize_object_type(self):
        return 'lifecycle.v4.svcmgr.LoadBalancer'
    ...
    def network_config(self):
        ...
        :type:
            :class:`~ntnx_lifecycle_py_client.models.lifecycle.v4.svcmgr.LoadBalancerNetworkConfig`
        """  # noqa: E501
