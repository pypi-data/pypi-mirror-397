...
class VcenterLocation(object):

    """Location configuration of the VCenter server.

    :param cluster_name: (:attr:`cluster_name`) Cluster name in Vcenter.
    :type cluster_name: 
     min=1 chars,
    
    :param datacenter: (:attr:`datacenter`) Data center name in Vcenter.
    :type datacenter: 
     min=1 chars,
    ...
    def __init__(self, cluster_name=None, datacenter=None, vcenter_ip=None, vcenter_port=None, *args, **kwargs):  # noqa: E501
    ...
    def _initialize_object_type(self):
        return 'lifecycle.v4.svcmgr.VcenterLocation'
    ...
    def datacenter(self, datacenter):
        if datacenter is not None and len(datacenter) < 1:
            raise ValueError("Invalid value for `datacenter`, length must be greater than or equal to `1`")  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VcenterLocation, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VcenterLocation):
            return False
