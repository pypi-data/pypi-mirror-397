...
class GroupKind(object):
    ...
    :param group: (:attr:`group`) API group of the resource.
    :type group: required
    
    
    :param kind: (:attr:`kind`) Kind of the resource.
    :type kind: required
    ...
    def __init__(self, group=None, kind=None, *args, **kwargs):  # noqa: E501
        self.__group = None
        self.__kind = None
    ...
    def _initialize_object_type(self):
        return 'lifecycle.v4.svcmgr.GroupKind'
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GroupKind):
            return False
