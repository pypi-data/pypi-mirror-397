...
class PreloadSpec(object):
    ...
    def __init__(self, entity_update_specs=None, *args, **kwargs):  # noqa: E501
    ...
    def _initialize_object_type(self):
        return 'lifecycle.v4.common.PreloadSpec'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(PreloadSpec, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PreloadSpec):
            return False
