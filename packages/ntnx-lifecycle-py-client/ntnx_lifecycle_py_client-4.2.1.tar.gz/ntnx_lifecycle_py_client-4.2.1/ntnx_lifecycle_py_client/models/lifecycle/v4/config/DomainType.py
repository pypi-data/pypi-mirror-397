...
class DomainType(object):
    ...
    Allowed enum values:
        ...
        - _UNKNOWN
        - _REDACTED
        - MANAGEMENTDOMAIN: Management Domain is a logical construct that collectively refers to Management PC and the components deployed on its clusters
        - APPDOMAIN: App Domain (Application Domain) is a logical construct that collectively refers to App Domain PC and the clusters that are registered to it. 
    """
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    ...
    def _initialize_object_type(self):
        return 'lifecycle.v4.config.DomainType'
