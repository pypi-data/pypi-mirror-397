...
class UpgradeSelectionStatus(object):
    ...
    Allowed enum values:
        ...
        - _UNKNOWN
        - _REDACTED
        - PENDING_UPLOAD: The selected upgrade is awaiting upload of all the images required
        - UPGRADE_READY: All required images have been uploaded and LCM is ready for upgrade
        - STALE_SELECTION: The saved upgrade selection in LCM is stale
    """
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    ...
    def _initialize_object_type(self):
        return 'lifecycle.v4.resources.UpgradeSelectionStatus'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(UpgradeSelectionStatus, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpgradeSelectionStatus):
            return False
