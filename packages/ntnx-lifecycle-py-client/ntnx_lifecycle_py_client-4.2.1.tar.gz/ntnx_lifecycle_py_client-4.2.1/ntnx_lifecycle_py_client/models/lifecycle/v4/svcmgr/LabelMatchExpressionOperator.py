...
class LabelMatchExpressionOperator(object):
    ...
    def _initialize_object_type(self):
        return 'lifecycle.v4.svcmgr.LabelMatchExpressionOperator'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(LabelMatchExpressionOperator, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LabelMatchExpressionOperator):
            return False
