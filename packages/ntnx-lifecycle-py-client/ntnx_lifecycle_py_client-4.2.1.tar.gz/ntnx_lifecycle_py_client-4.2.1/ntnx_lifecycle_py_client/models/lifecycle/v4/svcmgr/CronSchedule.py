...
class CronSchedule(object):
    ...
    :param cron_schedule: (:attr:`cron_schedule`) Cron expression that defines the snapshot schedule.
    :type cron_schedule: required
    
    
    :param start_time: (:attr:`start_time`) First time at which the scheduler should trigger.
    :type start_time: 
    
    
    :param timezone: (:attr:`timezone`) Time zone used to evaluate the cron expression.
    ...
    def __init__(self, cron_schedule=None, start_time=None, timezone=None, *args, **kwargs):  # noqa: E501
    ...
    def _initialize_object_type(self):
        return 'lifecycle.v4.svcmgr.CronSchedule'
