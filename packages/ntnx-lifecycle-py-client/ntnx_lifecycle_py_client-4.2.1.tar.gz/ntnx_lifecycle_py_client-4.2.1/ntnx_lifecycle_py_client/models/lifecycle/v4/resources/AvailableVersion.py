...
class AvailableVersion(object):
    ...
    :param is_image_present: (:attr:`is_image_present`) Indicates if the image is already present in the cluster to perform upgrade (**Default** True)
    :type is_image_present: 
    ...
    attribute_map = {
        ...
        'is_image_present': 'isImagePresent',
        '_reserved': '$reserved',
    ...
    def __init__(self, version=None, status=None, is_enabled=True, available_version_uuid=None, order=None, disablement_reason=None, release_notes=None, release_date=None, custom_message=None, child_entities=None, group_uuid=None, dependencies=None, is_image_present=True, *args, **kwargs):  # noqa: E501
        self.__version = None
        self.__status = None
        ...
        if is_image_present is not None:
            self.__is_image_present = is_image_present
    ...
    def is_image_present(self):
        ...
        :type:
                :class:`~bool`
        """  # noqa: E501
        return self.__is_image_present

    @is_image_present.setter
    def is_image_present(self, is_image_present):
