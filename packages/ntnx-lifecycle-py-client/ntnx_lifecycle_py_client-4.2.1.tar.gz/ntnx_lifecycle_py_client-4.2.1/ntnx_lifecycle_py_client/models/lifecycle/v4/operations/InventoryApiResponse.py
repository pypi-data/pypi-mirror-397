...
from ntnx_lifecycle_py_client.models.OneOflifecycle.v4.operations.InventoryApiResponsedata import InventoryApiResponsedata  # noqa: F401,E501
from ntnx_lifecycle_py_client.models.common.v1.response.ApiResponseMetadata import ApiResponseMetadata  # noqa: F401,E501

class InventoryApiResponse(object):
    ...
    swagger_types = {
        ...
        'data': 'OneOflifecycle.v4.operations.InventoryApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'lifecycle.v4.operations.InventoryApiResponse'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(InventoryApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InventoryApiResponse):
            return False
