...
class SystemAutoMgmtFlag(object):
    ...
    Allowed enum values:
        ...
        - _UNKNOWN
        - _REDACTED
        - POWER_OFF_UVMS: Power off user virtual machines.
        - MIGRATE_POWERED_OFF_UVMS: Migrate Powered off user virtual machines to other hosts in the cluster while entering maintenance mode during upgrade.
    """
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    POWER_OFF_UVMS = "POWER_OFF_UVMS"
    MIGRATE_POWERED_OFF_UVMS = "MIGRATE_POWERED_OFF_UVMS"
    ...
    def _initialize_object_type(self):
        return 'lifecycle.v4.common.SystemAutoMgmtFlag'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(SystemAutoMgmtFlag, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SystemAutoMgmtFlag):
            return False
