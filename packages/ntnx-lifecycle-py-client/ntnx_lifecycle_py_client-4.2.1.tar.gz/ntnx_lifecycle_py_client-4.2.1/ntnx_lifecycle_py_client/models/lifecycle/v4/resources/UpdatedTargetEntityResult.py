...
from ntnx_lifecycle_py_client.models.lifecycle.v4.resources.UpdatedTargetEntity import UpdatedTargetEntity  # noqa: F401,E501

class UpdatedTargetEntityResult(object):

    """LCM error for target entity

    :param target_entity: (:attr:`target_entity`) 
    :type target_entity: 
    
    
    :param message: (:attr:`message`) Error message for the target entity that failed in the input recommendations specification.
    ...
    """  # noqa: E501
    swagger_types = {
        'target_entity': 'lifecycle.v4.resources.UpdatedTargetEntity',
        'message': 'str',
    ...
    def __init__(self, target_entity=None, message=None, *args, **kwargs):  # noqa: E501
        self.__target_entity = None
        self.__message = None
    ...
    def _initialize_object_type(self):
        return 'lifecycle.v4.resources.UpdatedTargetEntityResult'
    ...
    def target_entity(self):
        ...
        :type:
            :class:`~ntnx_lifecycle_py_client.models.lifecycle.v4.resources.UpdatedTargetEntity`
        """  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(UpdatedTargetEntityResult, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdatedTargetEntityResult):
            return False
