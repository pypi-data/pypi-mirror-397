...
class EntityDeploySpec(object):

    """A specification defining the entity being deployed and its version.

    :param entity_identifier: (:attr:`entity_identifier`) 
    :type entity_identifier: required
    ...
    """  # noqa: E501
    swagger_types = {
        'entity_identifier': 'lifecycle.v4.common.EntityBaseModel',
    ...
    def __init__(self, entity_identifier=None, *args, **kwargs):  # noqa: E501
        self.__entity_identifier = None
    ...
    def _initialize_object_type(self):
        return 'lifecycle.v4.common.EntityDeploySpec'
    ...
    def entity_identifier(self):
        ...
        :type:
            :class:`~ntnx_lifecycle_py_client.models.lifecycle.v4.common.EntityBaseModel`
        """  # noqa: E501
    ...
    def entity_identifier(self, entity_identifier):
        if entity_identifier is None:
            raise ValueError("Invalid value for `entity_identifier`, must not be `None`")  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(EntityDeploySpec, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EntityDeploySpec):
            return False
