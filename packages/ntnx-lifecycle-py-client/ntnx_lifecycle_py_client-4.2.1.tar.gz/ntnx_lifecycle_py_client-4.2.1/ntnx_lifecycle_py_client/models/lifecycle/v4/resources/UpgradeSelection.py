...
from ntnx_lifecycle_py_client.models.lifecycle.v4.resources.UpgradeSelectionStatus import UpgradeSelectionStatus  # noqa: F401,E501

class UpgradeSelection(ExternalizableAbstractModel):

    """Details of LCM Upgrade Selections

    :param selected_upgrades: (:attr:`selected_upgrades`) List of upgrades whose selection is made
    :type selected_upgrades: 
    ...
    """  # noqa: E501
    swagger_types = {
        'selected_upgrades': 'list[lifecycle.v4.common.EntityUpdateSpec]',
        'cluster_ext_id': 'str',
        'status': 'lifecycle.v4.resources.UpgradeSelectionStatus',
        'ext_id': 'str',
    ...
    def __init__(self, selected_upgrades=None, cluster_ext_id=None, status=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
        ExternalizableAbstractModel.__init__(self, ext_id, links, tenant_id, *args, **kwargs)
        self.__selected_upgrades = None
        self.__cluster_ext_id = None
        self.__status = None
        self.discriminator = None
        if selected_upgrades is not None:
            self.__selected_upgrades = selected_upgrades
    ...
    def _initialize_object_type(self):
        return 'lifecycle.v4.resources.UpgradeSelection'
    ...
    def selected_upgrades(self):
        ...
        """  # noqa: E501
        return self.__selected_upgrades

    @selected_upgrades.setter
    def selected_upgrades(self, selected_upgrades):
    ...
    def status(self):
        ...
        :type:
            :class:`~ntnx_lifecycle_py_client.models.lifecycle.v4.resources.UpgradeSelectionStatus`
        """  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(UpgradeSelection, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpgradeSelection):
            return False
