...
class ClusterTarget(object):

    """Reference to an SMSP cluster and the Prism Central that manages it.

    :param cluster_ext_id: (:attr:`cluster_ext_id`) External identifier of the SMSP cluster.
    :type cluster_ext_id: required
    
    
    :param domain_manager_ext_id: (:attr:`domain_manager_ext_id`) External identifier of the Prism Central that owns the SMSP cluster.
    ...
    def _initialize_object_type(self):
        return 'lifecycle.v4.svcmgr.ClusterTarget'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ClusterTarget, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ClusterTarget):
            return False
