...
class ComponentDetails(object):
    ...
    :param messages: (:attr:`messages`) Messages published by the component.
    :type messages: 
    
    
    :param error_message: (:attr:`error_message`) Error details if any.
    :type error_message: 
    
    
    :param timestamp: (:attr:`timestamp`) Time when the health is checked.
    :type timestamp: 
    
    
    :param num_failures: (:attr:`num_failures`) Number of failures since the last success.
    :type num_failures: 
    
    
    :param first_failure_time: (:attr:`first_failure_time`) Time when the first health failure is seen.
    :type first_failure_time: 
    ...
    def __init__(self, messages=None, error_message=None, timestamp=None, num_failures=None, first_failure_time=None, *args, **kwargs):  # noqa: E501
        self.__messages = None
        self.__error_message = None
        self.__timestamp = None
        self.__num_failures = None
        self.__first_failure_time = None
        ...
        if num_failures is not None:
            self.__num_failures = num_failures
        if first_failure_time is not None:
            self.__first_failure_time = first_failure_time
        # populate hidden vars if not empty
        self._populate_hidden_vars(kwargs)

    def _initialize_object_type(self):
        return 'lifecycle.v4.svcmgr.ComponentDetails'
    ...
    def first_failure_time(self):
        ...
        :type:
                :class:`~datetime`
        """  # noqa: E501
        return self.__first_failure_time

    @first_failure_time.setter
    def first_failure_time(self, first_failure_time):
