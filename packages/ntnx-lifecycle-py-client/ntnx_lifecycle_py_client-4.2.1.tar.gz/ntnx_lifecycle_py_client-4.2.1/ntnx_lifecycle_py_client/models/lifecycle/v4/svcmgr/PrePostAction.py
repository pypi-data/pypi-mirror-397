...
from ntnx_lifecycle_py_client.models.OneOflifecycle.v4.svcmgr.PrePostActionaction_details import PrePostActionaction_details  # noqa: F401,E501

class PrePostAction(object):

    """Wrapper for an action executed before or after failover.

    :param action_details: (:attr:`action_details`) 
    :type action_details: required
    ...
    """  # noqa: E501
    swagger_types = {
        'action_details': 'OneOflifecycle.v4.svcmgr.PrePostActionaction_details',
    ...
    def __init__(self, action_details=None, *args, **kwargs):  # noqa: E501
        self.__action_details = None
        self.discriminator = None
        self.__action_details = action_details
        # populate hidden vars if not empty
        self._populate_hidden_vars(kwargs)

    def _initialize_object_type(self):
        return 'lifecycle.v4.svcmgr.PrePostAction'
    ...
    def action_details(self):
        ...
        :type:
                :class:`~ntnx_lifecycle_py_client.models.lifecycle.v4.svcmgr.HelmJobDetails` | 
                :class:`~ntnx_lifecycle_py_client.models.lifecycle.v4.svcmgr.APICallDetails`
        """  # noqa: E501
        return self.__action_details
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(PrePostAction, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PrePostAction):
            return False
