...
class AppProtectionPolicyState(object):
    ...
    RUNNING = "RUNNING"
    STOPPED = "STOPPED"
    LOCALLY_PROTECTED = "LOCALLY_PROTECTED"
    ...
    def _initialize_object_type(self):
        return 'lifecycle.v4.svcmgr.AppProtectionPolicyState'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(AppProtectionPolicyState, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AppProtectionPolicyState):
            return False
