...
from ntnx_lifecycle_py_client.models.prism.v4.config.DomainManagerClusterConfig import DomainManagerClusterConfig  # noqa: F401,E501
from ntnx_lifecycle_py_client.models.prism.v4.config.DomainManagerNetwork import DomainManagerNetwork  # noqa: F401,E501
...
class DomainManager(ExternalizableAbstractModel):
    ...
    :param created_time: (:attr:`created_time`) The timestamp when the domain manager (Prism Central) was created.
    :type created_time: 
    ...
    def __init__(self, config=None, is_registered_with_hosting_cluster=None, network=None, hosting_cluster_ext_id=None, should_enable_high_availability=False, node_ext_ids=None, created_time=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
    ...
    def config(self):
        ...
        :type:
            :class:`~ntnx_lifecycle_py_client.models.prism.v4.config.DomainManagerClusterConfig`
        """  # noqa: E501
    ...
    def network(self):
        ...
        :type:
            :class:`~ntnx_lifecycle_py_client.models.prism.v4.config.DomainManagerNetwork`
        """  # noqa: E501
