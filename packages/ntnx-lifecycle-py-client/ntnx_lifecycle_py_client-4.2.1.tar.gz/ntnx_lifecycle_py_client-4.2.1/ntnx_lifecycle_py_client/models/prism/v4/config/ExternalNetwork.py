...
class ExternalNetwork(BaseNetwork):
    ...
    def __init__(self, network_ext_id=None, default_gateway=None, subnet_mask=None, ip_ranges=None, ip_addresses=None, *args, **kwargs):  # noqa: E501
        BaseNetwork.__init__(self, default_gateway, subnet_mask, ip_ranges, ip_addresses, *args, **kwargs)
