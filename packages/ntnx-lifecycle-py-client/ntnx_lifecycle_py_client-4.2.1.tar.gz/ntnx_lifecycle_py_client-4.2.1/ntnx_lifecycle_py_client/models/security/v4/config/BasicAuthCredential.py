...
class BasicAuthCredential(object):
    ...
    def _initialize_object_type(self):
        return 'security.v4.config.BasicAuthCredential'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(BasicAuthCredential, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BasicAuthCredential):
            return False
