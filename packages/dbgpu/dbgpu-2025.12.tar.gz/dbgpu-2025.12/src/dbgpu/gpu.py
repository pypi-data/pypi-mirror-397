...
class GPUSpecification:
    ...
    @classmethod
    def _get_outputs_from_string(cls, output_string: str | None) -> Optional[str]:
        """
    ...
    def from_tpu_dict(
        ...
        return cls(
            ...
            display_connectors=cls._get_outputs_from_string(board.get("Outputs", None)),
