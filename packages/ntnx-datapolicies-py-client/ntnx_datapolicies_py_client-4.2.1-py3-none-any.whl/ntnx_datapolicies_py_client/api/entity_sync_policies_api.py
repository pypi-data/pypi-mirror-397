...
class EntitySyncPoliciesApi(object):
    """IGNORE:
    ...
    def get_entity_sync_policy_by_id(self, extId, **kwargs):  # noqa: E501
        """Get an entity sync policy

        >>> response = api.get_entity_sync_policy_by_id(extId)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.get_entity_sync_policy_by_id(extId, async_req=True)
        >>> result = thread.get()

        :param extId: The external identifier of the entity sync policy.
        :type extId:
            :class:`str`, required
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
                           ...
                           async_req=True
        :return: An instance of class :class:`~ntnx_datapolicies_py_client.models.datapolicies.v4.config.GetEntitySyncPolicyApiResponse`.
        ...
        if ('extId' not in params or params['extId'] is None):
            raise ValueError("Missing the required parameter `extId` when calling `get_entity_sync_policy_by_id`")  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/datapolicies/v4.2/config/entity-sync-policies/{extId}', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
                    ...
                    response_type='datapolicies.v4.config.GetEntitySyncPolicyApiResponse',  # noqa: E501
    ...
    def list_entity_sync_policies(self, _page=None, _limit=None, _filter=None, _orderby=None, _select=None, **kwargs):  # noqa: E501
        """List entity sync policies

        >>> response = api.list_entity_sync_policies((optional) _page, (optional) _limit, (optional) _filter, (optional) _orderby, (optional) _select)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.list_entity_sync_policies(async_req=True)
        >>> result = thread.get()
        ...
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
                           ...
                           async_req=True
        :return: An instance of class :class:`~ntnx_datapolicies_py_client.models.datapolicies.v4.config.ListEntitySyncPoliciesApiResponse`.
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/datapolicies/v4.2/config/entity-sync-policies', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
                    post_params=form_params,
                    files=local_var_files,
                    response_type='datapolicies.v4.config.ListEntitySyncPoliciesApiResponse',  # noqa: E501
                    auth_settings=auth_settings,
                    async_req=params.get('async_req'),
                    _return_http_data_only=params.get('_return_http_data_only'),
                    _preload_content=params.get('_preload_content', True),
    ...
    def sync_entity_sync_policy_by_id(self, extId, **kwargs):  # noqa: E501
        """Sync entity identified by its identifier to a remote domain manager

        >>> response = api.sync_entity_sync_policy_by_id(extId)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.sync_entity_sync_policy_by_id(extId, async_req=True)
        >>> result = thread.get()
        ...
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
                           ...
                           async_req=True
        :return: An instance of class :class:`~ntnx_datapolicies_py_client.models.datapolicies.v4.config.SyncEntitySyncPolicyApiResponse`.
        ...
        # verify the required parameter 'extId' is set
        if ('extId' not in params or params['extId'] is None):
            raise ValueError("Missing the required parameter `extId` when calling `sync_entity_sync_policy_by_id`")  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/datapolicies/v4.2/config/entity-sync-policies/{extId}/$actions/sync-entity', 'POST',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
                    post_params=form_params,
                    files=local_var_files,
                    response_type='datapolicies.v4.config.SyncEntitySyncPolicyApiResponse',  # noqa: E501
                    auth_settings=auth_settings,
                    async_req=params.get('async_req'),
                    _return_http_data_only=params.get('_return_http_data_only'),
                    _preload_content=params.get('_preload_content', True),
