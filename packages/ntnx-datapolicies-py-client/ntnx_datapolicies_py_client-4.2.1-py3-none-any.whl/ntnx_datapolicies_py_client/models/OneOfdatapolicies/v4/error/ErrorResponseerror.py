...
class ErrorResponseerror(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<datapolicies.v4.error.AppMessage>': 'list[datapolicies.v4.error.AppMessage]',
        'datapolicies.v4.error.SchemaValidationError': 'datapolicies.v4.error.SchemaValidationError'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOfdatapolicies.v4.error.ErrorResponseerror'
