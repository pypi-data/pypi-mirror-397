...
class GetProtectionPolicyApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'datapolicies.v4.config.ProtectionPolicy': 'datapolicies.v4.config.ProtectionPolicy',
    ...
    def _initialize_object_type(self):
        return 'OneOfdatapolicies.v4.config.GetProtectionPolicyApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetProtectionPolicyApiResponsedata.discriminator_value_class_map.values():
            return list(GetProtectionPolicyApiResponsedata.discriminator_value_class_map.keys())[list(GetProtectionPolicyApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetProtectionPolicyApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetProtectionPolicyApiResponsedata):
            return False
