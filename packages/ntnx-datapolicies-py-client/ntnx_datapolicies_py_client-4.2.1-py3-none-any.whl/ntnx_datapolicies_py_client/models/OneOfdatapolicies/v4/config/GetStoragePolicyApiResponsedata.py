...
class GetStoragePolicyApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'datapolicies.v4.config.StoragePolicy': 'datapolicies.v4.config.StoragePolicy',
    ...
    def _initialize_object_type(self):
        return 'OneOfdatapolicies.v4.config.GetStoragePolicyApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetStoragePolicyApiResponsedata.discriminator_value_class_map.values():
            return list(GetStoragePolicyApiResponsedata.discriminator_value_class_map.keys())[list(GetStoragePolicyApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetStoragePolicyApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetStoragePolicyApiResponsedata):
            return False
