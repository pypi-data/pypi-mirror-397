...
class ListDataServicesIpMappingsApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<datapolicies.v4.config.DataServicesIpMapping>': 'list[datapolicies.v4.config.DataServicesIpMapping]',
        'datapolicies.v4.error.ErrorResponse': 'datapolicies.v4.error.ErrorResponse',
        'List<datapolicies.v4.config.DataServicesIpMappingProjection>': 'list[datapolicies.v4.config.DataServicesIpMappingProjection]'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOfdatapolicies.v4.config.ListDataServicesIpMappingsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListDataServicesIpMappingsApiResponsedata.discriminator_value_class_map.values():
            return list(ListDataServicesIpMappingsApiResponsedata.discriminator_value_class_map.keys())[list(ListDataServicesIpMappingsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListDataServicesIpMappingsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListDataServicesIpMappingsApiResponsedata):
            return False
