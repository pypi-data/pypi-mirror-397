...
class DeleteProtectionPolicyApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfdatapolicies.v4.config.DeleteProtectionPolicyApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in DeleteProtectionPolicyApiResponsedata.discriminator_value_class_map.values():
            return list(DeleteProtectionPolicyApiResponsedata.discriminator_value_class_map.keys())[list(DeleteProtectionPolicyApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(DeleteProtectionPolicyApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteProtectionPolicyApiResponsedata):
            return False
