...
class StageActionconfig(object):
    ...
    discriminator_value_class_map = {
        ...
        'datapolicies.v4.config.DelayAction': 'datapolicies.v4.config.DelayAction'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOfdatapolicies.v4.config.StageActionconfig'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in StageActionconfig.discriminator_value_class_map.values():
            return list(StageActionconfig.discriminator_value_class_map.keys())[list(StageActionconfig.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(StageActionconfig, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StageActionconfig):
            return False
