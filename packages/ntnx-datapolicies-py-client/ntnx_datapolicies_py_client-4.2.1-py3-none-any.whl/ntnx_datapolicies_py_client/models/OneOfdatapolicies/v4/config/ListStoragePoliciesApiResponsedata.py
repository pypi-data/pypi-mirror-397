...
class ListStoragePoliciesApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<datapolicies.v4.config.StoragePolicy>': 'list[datapolicies.v4.config.StoragePolicy]',
    ...
    def _initialize_object_type(self):
        return 'OneOfdatapolicies.v4.config.ListStoragePoliciesApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListStoragePoliciesApiResponsedata.discriminator_value_class_map.values():
            return list(ListStoragePoliciesApiResponsedata.discriminator_value_class_map.keys())[list(ListStoragePoliciesApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListStoragePoliciesApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListStoragePoliciesApiResponsedata):
            return False
