...
class ListRecoveryStagesApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<datapolicies.v4.config.RecoveryStage>': 'list[datapolicies.v4.config.RecoveryStage]',
        'datapolicies.v4.error.ErrorResponse': 'datapolicies.v4.error.ErrorResponse',
        'List<datapolicies.v4.config.RecoveryStageProjection>': 'list[datapolicies.v4.config.RecoveryStageProjection]'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOfdatapolicies.v4.config.ListRecoveryStagesApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListRecoveryStagesApiResponsedata.discriminator_value_class_map.values():
            return list(ListRecoveryStagesApiResponsedata.discriminator_value_class_map.keys())[list(ListRecoveryStagesApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListRecoveryStagesApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListRecoveryStagesApiResponsedata):
            return False
