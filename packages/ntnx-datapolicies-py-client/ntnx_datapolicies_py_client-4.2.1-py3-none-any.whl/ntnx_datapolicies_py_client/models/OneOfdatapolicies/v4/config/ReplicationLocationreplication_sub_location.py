...
class ReplicationLocationreplication_sub_location(object):
    ...
    discriminator_value_class_map = {
        ...
        'datapolicies.v4.config.NutanixCluster': 'datapolicies.v4.config.NutanixCluster',
        'datapolicies.v4.config.Mst': 'datapolicies.v4.config.Mst'
    }

    ONE_OF_ITEM_DISCRIMINATOR_NAME = '$replicationSubLocationItemDiscriminator'
    ...
    def _initialize_object_type(self):
        return 'OneOfdatapolicies.v4.config.ReplicationLocationreplication_sub_location'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ReplicationLocationreplication_sub_location.discriminator_value_class_map.values():
            return list(ReplicationLocationreplication_sub_location.discriminator_value_class_map.keys())[list(ReplicationLocationreplication_sub_location.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ReplicationLocationreplication_sub_location, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ReplicationLocationreplication_sub_location):
            return False
