...
class VolumeGroupAttachmentclient_features(object):
    ...
    discriminator_value_class_map = {
        ...
        'datapolicies.v4.config.IscsiFeatures': 'datapolicies.v4.config.IscsiFeatures'
    }

    ONE_OF_ITEM_DISCRIMINATOR_NAME = '$clientFeaturesItemDiscriminator'
    ...
    def _initialize_object_type(self):
        return 'OneOfdatapolicies.v4.config.VolumeGroupAttachmentclient_features'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in VolumeGroupAttachmentclient_features.discriminator_value_class_map.values():
            return list(VolumeGroupAttachmentclient_features.discriminator_value_class_map.keys())[list(VolumeGroupAttachmentclient_features.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VolumeGroupAttachmentclient_features, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VolumeGroupAttachmentclient_features):
            return False
