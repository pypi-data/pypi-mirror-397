...
class RecoverySettingrecovery_setting(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfdatapolicies.v4.config.RecoverySettingrecovery_setting'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in RecoverySettingrecovery_setting.discriminator_value_class_map.values():
            return list(RecoverySettingrecovery_setting.discriminator_value_class_map.keys())[list(RecoverySettingrecovery_setting.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(RecoverySettingrecovery_setting, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RecoverySettingrecovery_setting):
            return False
