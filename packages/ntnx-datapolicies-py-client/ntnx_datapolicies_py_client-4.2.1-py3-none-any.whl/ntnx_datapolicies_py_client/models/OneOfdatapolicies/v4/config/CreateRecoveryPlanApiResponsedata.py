...
class CreateRecoveryPlanApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfdatapolicies.v4.config.CreateRecoveryPlanApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in CreateRecoveryPlanApiResponsedata.discriminator_value_class_map.values():
            return list(CreateRecoveryPlanApiResponsedata.discriminator_value_class_map.keys())[list(CreateRecoveryPlanApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(CreateRecoveryPlanApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateRecoveryPlanApiResponsedata):
            return False
