...
class ListProtectionPoliciesApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<datapolicies.v4.config.ProtectionPolicy>': 'list[datapolicies.v4.config.ProtectionPolicy]',
        'datapolicies.v4.error.ErrorResponse': 'datapolicies.v4.error.ErrorResponse',
        'List<datapolicies.v4.config.ProtectionPolicyProjection>': 'list[datapolicies.v4.config.ProtectionPolicyProjection]'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOfdatapolicies.v4.config.ListProtectionPoliciesApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListProtectionPoliciesApiResponsedata.discriminator_value_class_map.values():
            return list(ListProtectionPoliciesApiResponsedata.discriminator_value_class_map.keys())[list(ListProtectionPoliciesApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListProtectionPoliciesApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListProtectionPoliciesApiResponsedata):
            return False
