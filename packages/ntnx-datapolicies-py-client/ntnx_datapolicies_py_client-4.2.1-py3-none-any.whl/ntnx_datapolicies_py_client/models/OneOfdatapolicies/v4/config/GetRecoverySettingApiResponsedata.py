...
class GetRecoverySettingApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'datapolicies.v4.config.RecoverySetting': 'datapolicies.v4.config.RecoverySetting',
    ...
    def _initialize_object_type(self):
        return 'OneOfdatapolicies.v4.config.GetRecoverySettingApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetRecoverySettingApiResponsedata.discriminator_value_class_map.values():
            return list(GetRecoverySettingApiResponsedata.discriminator_value_class_map.keys())[list(GetRecoverySettingApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetRecoverySettingApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetRecoverySettingApiResponsedata):
            return False
