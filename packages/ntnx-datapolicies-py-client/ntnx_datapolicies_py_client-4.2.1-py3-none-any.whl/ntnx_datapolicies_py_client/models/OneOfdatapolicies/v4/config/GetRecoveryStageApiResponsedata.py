...
class GetRecoveryStageApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'datapolicies.v4.config.RecoveryStage': 'datapolicies.v4.config.RecoveryStage',
    ...
    def _initialize_object_type(self):
        return 'OneOfdatapolicies.v4.config.GetRecoveryStageApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetRecoveryStageApiResponsedata.discriminator_value_class_map.values():
            return list(GetRecoveryStageApiResponsedata.discriminator_value_class_map.keys())[list(GetRecoveryStageApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetRecoveryStageApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetRecoveryStageApiResponsedata):
            return False
