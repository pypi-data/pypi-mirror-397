...
class GetConsistencyRuleApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'datapolicies.v4.config.ConsistencyRule': 'datapolicies.v4.config.ConsistencyRule',
    ...
    def _initialize_object_type(self):
        return 'OneOfdatapolicies.v4.config.GetConsistencyRuleApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetConsistencyRuleApiResponsedata.discriminator_value_class_map.values():
            return list(GetConsistencyRuleApiResponsedata.discriminator_value_class_map.keys())[list(GetConsistencyRuleApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetConsistencyRuleApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetConsistencyRuleApiResponsedata):
            return False
