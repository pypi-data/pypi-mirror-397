...
class ListRecoveryPlansApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<datapolicies.v4.config.RecoveryPlan>': 'list[datapolicies.v4.config.RecoveryPlan]',
        'datapolicies.v4.error.ErrorResponse': 'datapolicies.v4.error.ErrorResponse',
        'List<datapolicies.v4.config.RecoveryPlanProjection>': 'list[datapolicies.v4.config.RecoveryPlanProjection]'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOfdatapolicies.v4.config.ListRecoveryPlansApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListRecoveryPlansApiResponsedata.discriminator_value_class_map.values():
            return list(ListRecoveryPlansApiResponsedata.discriminator_value_class_map.keys())[list(ListRecoveryPlansApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListRecoveryPlansApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListRecoveryPlansApiResponsedata):
            return False
