...
class GetRecoveryPlanApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'datapolicies.v4.config.RecoveryPlan': 'datapolicies.v4.config.RecoveryPlan',
    ...
    def _initialize_object_type(self):
        return 'OneOfdatapolicies.v4.config.GetRecoveryPlanApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetRecoveryPlanApiResponsedata.discriminator_value_class_map.values():
            return list(GetRecoveryPlanApiResponsedata.discriminator_value_class_map.keys())[list(GetRecoveryPlanApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetRecoveryPlanApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetRecoveryPlanApiResponsedata):
            return False
