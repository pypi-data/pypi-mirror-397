...
class GetNetworkMappingApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'datapolicies.v4.config.NetworkMapping': 'datapolicies.v4.config.NetworkMapping',
    ...
    def _initialize_object_type(self):
        return 'OneOfdatapolicies.v4.config.GetNetworkMappingApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetNetworkMappingApiResponsedata.discriminator_value_class_map.values():
            return list(GetNetworkMappingApiResponsedata.discriminator_value_class_map.keys())[list(GetNetworkMappingApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetNetworkMappingApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetNetworkMappingApiResponsedata):
            return False
