...
class RecoverySettingProjectionrecovery_setting(object):
    ...
    discriminator_value_class_map = {
        ...
        'datapolicies.v4.config.VmCategoryRecoverySetting': 'datapolicies.v4.config.VmCategoryRecoverySetting',
        'datapolicies.v4.config.VmRecoverySetting': 'datapolicies.v4.config.VmRecoverySetting',
        'datapolicies.v4.config.VolumeGroupRecoverySetting': 'datapolicies.v4.config.VolumeGroupRecoverySetting'
    }

    ONE_OF_ITEM_DISCRIMINATOR_NAME = '$recoverySettingItemDiscriminator'
    ...
    def _initialize_object_type(self):
        return 'OneOfdatapolicies.v4.config.RecoverySettingProjectionrecovery_setting'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in RecoverySettingProjectionrecovery_setting.discriminator_value_class_map.values():
            return list(RecoverySettingProjectionrecovery_setting.discriminator_value_class_map.keys())[list(RecoverySettingProjectionrecovery_setting.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(RecoverySettingProjectionrecovery_setting, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RecoverySettingProjectionrecovery_setting):
            return False
