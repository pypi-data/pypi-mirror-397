...
class GetEntitySyncPolicyApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'datapolicies.v4.config.EntitySyncPolicy': 'datapolicies.v4.config.EntitySyncPolicy',
    ...
    def _initialize_object_type(self):
        return 'OneOfdatapolicies.v4.config.GetEntitySyncPolicyApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetEntitySyncPolicyApiResponsedata.discriminator_value_class_map.values():
            return list(GetEntitySyncPolicyApiResponsedata.discriminator_value_class_map.keys())[list(GetEntitySyncPolicyApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetEntitySyncPolicyApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetEntitySyncPolicyApiResponsedata):
            return False
