...
class ProtectionPolicyEntityType(object):
    ...
    Allowed enum values:
        ...
        - _UNKNOWN
        - _REDACTED
        - VM: Entity of type VM that has been protected under a protection policy.
        - VOLUME_GROUP: Entity of type volume group that has been protected under a protection policy.
    """
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    VM = "VM"
    ...
    def _initialize_object_type(self):
        return 'datapolicies.v4.config.ProtectionPolicyEntityType'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ProtectionPolicyEntityType, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ProtectionPolicyEntityType):
            return False
