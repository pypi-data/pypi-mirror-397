...
from ntnx_datapolicies_py_client.models.OneOfdatapolicies.v4.config.ListNetworkMappingsApiResponsedata import ListNetworkMappingsApiResponsedata  # noqa: F401,E501
from ntnx_datapolicies_py_client.models.common.v1.response.ApiResponseMetadata import ApiResponseMetadata  # noqa: F401,E501

class ListNetworkMappingsApiResponse(object):
    ...
    swagger_types = {
        ...
        'data': 'OneOfdatapolicies.v4.config.ListNetworkMappingsApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'datapolicies.v4.config.ListNetworkMappingsApiResponse'
    ...
    def data(self):
        ...
        :type:
                :class:`~ntnx_datapolicies_py_client.models.datapolicies.v4.config.NetworkMapping` | 
                :class:`~ntnx_datapolicies_py_client.models.datapolicies.v4.error.ErrorResponse` | 
                :class:`~ntnx_datapolicies_py_client.models.datapolicies.v4.config.NetworkMappingProjection`
        """  # noqa: E501
        return self.__data
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListNetworkMappingsApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListNetworkMappingsApiResponse):
            return False
