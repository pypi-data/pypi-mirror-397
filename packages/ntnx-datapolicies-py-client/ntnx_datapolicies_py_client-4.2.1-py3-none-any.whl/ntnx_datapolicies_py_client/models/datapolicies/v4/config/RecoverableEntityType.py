...
class RecoverableEntityType(object):
    ...
    def _initialize_object_type(self):
        return 'datapolicies.v4.config.RecoverableEntityType'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(RecoverableEntityType, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RecoverableEntityType):
            return False
