...
class WitnessConfiguration(object):

    """Witness location and failover configuration.

    :param ext_id: (:attr:`ext_id`) External identifier of the witness service.
    :type ext_id: required
    
    
    :param timeout_secs: (:attr:`timeout_secs`) Maximum time in seconds that the witness must wait before initiating an unplanned failover or pausing synchronous replication in the event of a primary or secondary location failure.
    :type timeout_secs: required
    ...
    def __init__(self, ext_id=None, timeout_secs=None, *args, **kwargs):  # noqa: E501
        self.__ext_id = None
    ...
    def _initialize_object_type(self):
        return 'datapolicies.v4.config.WitnessConfiguration'
    ...
    def timeout_secs(self, timeout_secs):
        if timeout_secs is None:
            raise ValueError("Invalid value for `timeout_secs`, must not be `None`")  # noqa: E501
        if timeout_secs is not None and timeout_secs > 300:  # noqa: E501
            raise ValueError("Invalid value for `timeout_secs`, must be a value less than or equal to `300`")  # noqa: E501
        if timeout_secs is not None and timeout_secs < 30:  # noqa: E501
            raise ValueError("Invalid value for `timeout_secs`, must be a value greater than or equal to `30`")  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(WitnessConfiguration, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WitnessConfiguration):
            return False
