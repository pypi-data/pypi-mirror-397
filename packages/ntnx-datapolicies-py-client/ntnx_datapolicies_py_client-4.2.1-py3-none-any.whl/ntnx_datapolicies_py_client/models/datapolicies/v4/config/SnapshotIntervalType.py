...
class SnapshotIntervalType(object):
    ...
    def _initialize_object_type(self):
        return 'datapolicies.v4.config.SnapshotIntervalType'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(SnapshotIntervalType, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SnapshotIntervalType):
            return False
