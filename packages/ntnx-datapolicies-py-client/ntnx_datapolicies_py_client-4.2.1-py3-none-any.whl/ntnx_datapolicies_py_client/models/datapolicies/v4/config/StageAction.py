...
from ntnx_datapolicies_py_client.models.OneOfdatapolicies.v4.config.StageActionconfig import StageActionconfig  # noqa: F401,E501

class StageAction(object):

    """Information about the action to be executed at the end of a stage.

    :param config: (:attr:`config`) The settings required to control the stage action. For example, stage action of type DELAY requires the number of seconds to delay after a stage completes.
    ...
    """  # noqa: E501
    swagger_types = {
        'config': 'OneOfdatapolicies.v4.config.StageActionconfig',
    ...
    def _initialize_object_type(self):
        return 'datapolicies.v4.config.StageAction'
    ...
    def config(self):
        ...
        :type:
                :class:`~ntnx_datapolicies_py_client.models.datapolicies.v4.config.DelayAction`
        """  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(StageAction, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StageAction):
            return False
