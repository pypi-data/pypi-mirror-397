...
from ntnx_datapolicies_py_client.models.OneOfdatapolicies.v4.config.SyncEntitySyncPolicyApiResponsedata import SyncEntitySyncPolicyApiResponsedata  # noqa: F401,E501
from ntnx_datapolicies_py_client.models.common.v1.response.ApiResponseMetadata import ApiResponseMetadata  # noqa: F401,E501

class SyncEntitySyncPolicyApiResponse(object):
    ...
    swagger_types = {
        ...
        'data': 'OneOfdatapolicies.v4.config.SyncEntitySyncPolicyApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'datapolicies.v4.config.SyncEntitySyncPolicyApiResponse'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(SyncEntitySyncPolicyApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SyncEntitySyncPolicyApiResponse):
            return False
