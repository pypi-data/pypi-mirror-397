...
from ntnx_datapolicies_py_client.models.datapolicies.v4.config.EncryptionState import EncryptionState  # noqa: F401,E501

class EncryptionSpec(object):

    """Encryption parameters for the entities governed by the Storage Policy.

    :param encryption_state: (:attr:`encryption_state`) 
    :type encryption_state: required
    ...
    """  # noqa: E501
    swagger_types = {
        'encryption_state': 'datapolicies.v4.config.EncryptionState',
    ...
    def __init__(self, encryption_state=None, *args, **kwargs):  # noqa: E501
        self.__encryption_state = None
        self.discriminator = None
        self.__encryption_state = encryption_state
        # populate hidden vars if not empty
        self._populate_hidden_vars(kwargs)

    def _initialize_object_type(self):
        return 'datapolicies.v4.config.EncryptionSpec'
    ...
    def encryption_state(self):
        ...
        :type:
            :class:`~ntnx_datapolicies_py_client.models.datapolicies.v4.config.EncryptionState`
        """  # noqa: E501
        return self.__encryption_state

    @encryption_state.setter
    def encryption_state(self, encryption_state):
        if encryption_state is None:
            raise ValueError("Invalid value for `encryption_state`, must not be `None`")  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(EncryptionSpec, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EncryptionSpec):
            return False
