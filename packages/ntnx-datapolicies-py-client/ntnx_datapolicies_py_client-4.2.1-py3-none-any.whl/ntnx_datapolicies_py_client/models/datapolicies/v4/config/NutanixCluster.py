...
class NutanixCluster(object):
    ...
    :param cluster_ext_ids: (:attr:`cluster_ext_ids`) List of Prism Element cluster external identifiers whose associated VMs and volume groups are protected. Only the primary location can have multiple clusters configured, while the other locations can specify only one cluster. Clusters must be specified for replication within the same Prism Central and cannot be specified for an MST type location. All clusters are considered if the cluster external identifier list is empty.
    ...
    def __init__(self, cluster_ext_ids=None, *args, **kwargs):  # noqa: E501
    ...
    def _initialize_object_type(self):
        return 'datapolicies.v4.config.NutanixCluster'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(NutanixCluster, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NutanixCluster):
            return False
