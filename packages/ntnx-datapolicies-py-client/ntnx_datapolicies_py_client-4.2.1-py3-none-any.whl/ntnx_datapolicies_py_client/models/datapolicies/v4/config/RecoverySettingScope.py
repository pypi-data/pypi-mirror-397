...
class RecoverySettingScope(object):
    ...
    Allowed enum values:
        ...
        - _UNKNOWN
        - _REDACTED
        - VM: Recovery setting applicable for a particular VM.
        - VM_CATEGORY: Recovery setting applicable for a particular VM category.
        - VOLUME_GROUP: Recovery setting applicable for a particular Volume Group.
    """
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    VM = "VM"
    VM_CATEGORY = "VM_CATEGORY"
    ...
    def _initialize_object_type(self):
        return 'datapolicies.v4.config.RecoverySettingScope'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(RecoverySettingScope, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RecoverySettingScope):
            return False
