...
from ntnx_datapolicies_py_client.models.OneOfdatapolicies.v4.config.DeleteRecoveryPlanApiResponsedata import DeleteRecoveryPlanApiResponsedata  # noqa: F401,E501
from ntnx_datapolicies_py_client.models.common.v1.response.ApiResponseMetadata import ApiResponseMetadata  # noqa: F401,E501

class DeleteRecoveryPlanApiResponse(object):
    ...
    swagger_types = {
        ...
        'data': 'OneOfdatapolicies.v4.config.DeleteRecoveryPlanApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'datapolicies.v4.config.DeleteRecoveryPlanApiResponse'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(DeleteRecoveryPlanApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteRecoveryPlanApiResponse):
            return False
