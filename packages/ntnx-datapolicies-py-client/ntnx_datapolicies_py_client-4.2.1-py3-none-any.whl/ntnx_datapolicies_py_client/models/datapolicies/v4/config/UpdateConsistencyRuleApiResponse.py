...
from ntnx_datapolicies_py_client.models.OneOfdatapolicies.v4.config.UpdateConsistencyRuleApiResponsedata import UpdateConsistencyRuleApiResponsedata  # noqa: F401,E501
from ntnx_datapolicies_py_client.models.common.v1.response.ApiResponseMetadata import ApiResponseMetadata  # noqa: F401,E501

class UpdateConsistencyRuleApiResponse(object):
    ...
    swagger_types = {
        ...
        'data': 'OneOfdatapolicies.v4.config.UpdateConsistencyRuleApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'datapolicies.v4.config.UpdateConsistencyRuleApiResponse'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(UpdateConsistencyRuleApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateConsistencyRuleApiResponse):
            return False
