...
class EntitySyncStatus(object):
    ...
    Allowed enum values:
        ...
        - _UNKNOWN
        - _REDACTED
        - IN_SYNC: In sync status
        - OUT_OF_SYNC: Out of sync status
        - SYNCING: Is syncing status
    """
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    IN_SYNC = "IN_SYNC"
    ...
    def _initialize_object_type(self):
        return 'datapolicies.v4.config.EntitySyncStatus'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(EntitySyncStatus, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EntitySyncStatus):
            return False
