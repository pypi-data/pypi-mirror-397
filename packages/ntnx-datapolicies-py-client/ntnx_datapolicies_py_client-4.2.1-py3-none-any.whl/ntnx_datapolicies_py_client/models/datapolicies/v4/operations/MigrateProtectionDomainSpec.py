...
class MigrateProtectionDomainSpec(object):

    """

    :param name: (:attr:`name`) Name of the protection domain
    :type name: required
    ...
    def _initialize_object_type(self):
        return 'datapolicies.v4.operations.MigrateProtectionDomainSpec'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(MigrateProtectionDomainSpec, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MigrateProtectionDomainSpec):
            return False
