...
class ListEntitySyncPoliciesApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<datapolicies.v4.config.EntitySyncPolicy>': 'list[datapolicies.v4.config.EntitySyncPolicy]',
        'datapolicies.v4.error.ErrorResponse': 'datapolicies.v4.error.ErrorResponse',
        'List<datapolicies.v4.config.EntitySyncPolicyProjection>': 'list[datapolicies.v4.config.EntitySyncPolicyProjection]'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOfdatapolicies.v4.config.ListEntitySyncPoliciesApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListEntitySyncPoliciesApiResponsedata.discriminator_value_class_map.values():
            return list(ListEntitySyncPoliciesApiResponsedata.discriminator_value_class_map.keys())[list(ListEntitySyncPoliciesApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListEntitySyncPoliciesApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListEntitySyncPoliciesApiResponsedata):
            return False
