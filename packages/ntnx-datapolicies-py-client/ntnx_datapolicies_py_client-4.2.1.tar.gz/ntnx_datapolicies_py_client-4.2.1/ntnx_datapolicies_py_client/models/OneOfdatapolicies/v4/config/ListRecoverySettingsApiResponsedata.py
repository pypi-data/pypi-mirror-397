...
class ListRecoverySettingsApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<datapolicies.v4.config.RecoverySetting>': 'list[datapolicies.v4.config.RecoverySetting]',
        'datapolicies.v4.error.ErrorResponse': 'datapolicies.v4.error.ErrorResponse',
        'List<datapolicies.v4.config.RecoverySettingProjection>': 'list[datapolicies.v4.config.RecoverySettingProjection]'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOfdatapolicies.v4.config.ListRecoverySettingsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListRecoverySettingsApiResponsedata.discriminator_value_class_map.values():
            return list(ListRecoverySettingsApiResponsedata.discriminator_value_class_map.keys())[list(ListRecoverySettingsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListRecoverySettingsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListRecoverySettingsApiResponsedata):
            return False
