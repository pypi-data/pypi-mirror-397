...
class UpdateStoragePolicyApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfdatapolicies.v4.config.UpdateStoragePolicyApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in UpdateStoragePolicyApiResponsedata.discriminator_value_class_map.values():
            return list(UpdateStoragePolicyApiResponsedata.discriminator_value_class_map.keys())[list(UpdateStoragePolicyApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(UpdateStoragePolicyApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateStoragePolicyApiResponsedata):
            return False
