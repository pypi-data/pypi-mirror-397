...
class UpdateConsistencyRuleApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfdatapolicies.v4.config.UpdateConsistencyRuleApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in UpdateConsistencyRuleApiResponsedata.discriminator_value_class_map.values():
            return list(UpdateConsistencyRuleApiResponsedata.discriminator_value_class_map.keys())[list(UpdateConsistencyRuleApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(UpdateConsistencyRuleApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateConsistencyRuleApiResponsedata):
            return False
