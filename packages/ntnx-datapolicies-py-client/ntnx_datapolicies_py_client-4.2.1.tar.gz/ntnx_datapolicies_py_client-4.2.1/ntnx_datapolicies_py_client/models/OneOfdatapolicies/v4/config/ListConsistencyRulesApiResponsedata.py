...
class ListConsistencyRulesApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<datapolicies.v4.config.ConsistencyRule>': 'list[datapolicies.v4.config.ConsistencyRule]',
        'datapolicies.v4.error.ErrorResponse': 'datapolicies.v4.error.ErrorResponse',
        'List<datapolicies.v4.config.ConsistencyRuleProjection>': 'list[datapolicies.v4.config.ConsistencyRuleProjection]'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOfdatapolicies.v4.config.ListConsistencyRulesApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListConsistencyRulesApiResponsedata.discriminator_value_class_map.values():
            return list(ListConsistencyRulesApiResponsedata.discriminator_value_class_map.keys())[list(ListConsistencyRulesApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListConsistencyRulesApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListConsistencyRulesApiResponsedata):
            return False
