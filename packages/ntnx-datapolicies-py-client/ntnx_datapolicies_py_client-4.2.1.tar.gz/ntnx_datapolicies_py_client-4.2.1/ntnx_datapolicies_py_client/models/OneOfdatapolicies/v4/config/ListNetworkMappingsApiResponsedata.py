...
class ListNetworkMappingsApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<datapolicies.v4.config.NetworkMapping>': 'list[datapolicies.v4.config.NetworkMapping]',
        'datapolicies.v4.error.ErrorResponse': 'datapolicies.v4.error.ErrorResponse',
        'List<datapolicies.v4.config.NetworkMappingProjection>': 'list[datapolicies.v4.config.NetworkMappingProjection]'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOfdatapolicies.v4.config.ListNetworkMappingsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListNetworkMappingsApiResponsedata.discriminator_value_class_map.values():
            return list(ListNetworkMappingsApiResponsedata.discriminator_value_class_map.keys())[list(ListNetworkMappingsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListNetworkMappingsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListNetworkMappingsApiResponsedata):
            return False
