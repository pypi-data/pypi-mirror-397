...
class GetDataServicesIpMappingApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'datapolicies.v4.config.DataServicesIpMapping': 'datapolicies.v4.config.DataServicesIpMapping',
    ...
    def _initialize_object_type(self):
        return 'OneOfdatapolicies.v4.config.GetDataServicesIpMappingApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetDataServicesIpMappingApiResponsedata.discriminator_value_class_map.values():
            return list(GetDataServicesIpMappingApiResponsedata.discriminator_value_class_map.keys())[list(GetDataServicesIpMappingApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetDataServicesIpMappingApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetDataServicesIpMappingApiResponsedata):
            return False
