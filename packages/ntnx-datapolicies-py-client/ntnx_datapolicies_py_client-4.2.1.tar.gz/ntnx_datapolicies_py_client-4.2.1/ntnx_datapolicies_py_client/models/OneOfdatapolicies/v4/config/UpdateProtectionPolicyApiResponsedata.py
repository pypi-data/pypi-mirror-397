...
class UpdateProtectionPolicyApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfdatapolicies.v4.config.UpdateProtectionPolicyApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in UpdateProtectionPolicyApiResponsedata.discriminator_value_class_map.values():
            return list(UpdateProtectionPolicyApiResponsedata.discriminator_value_class_map.keys())[list(UpdateProtectionPolicyApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(UpdateProtectionPolicyApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateProtectionPolicyApiResponsedata):
            return False
