...
class Scheduleretention(object):
    ...
    discriminator_value_class_map = {
        ...
        'datapolicies.v4.config.LinearRetention': 'datapolicies.v4.config.LinearRetention',
        'datapolicies.v4.config.AutoRollupRetention': 'datapolicies.v4.config.AutoRollupRetention'
    }

    ONE_OF_ITEM_DISCRIMINATOR_NAME = '$retentionItemDiscriminator'
    ...
    def _initialize_object_type(self):
        return 'OneOfdatapolicies.v4.config.Scheduleretention'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in Scheduleretention.discriminator_value_class_map.values():
            return list(Scheduleretention.discriminator_value_class_map.keys())[list(Scheduleretention.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(Scheduleretention, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, Scheduleretention):
            return False
