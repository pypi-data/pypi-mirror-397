...
class UpdateRecoveryPlanApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfdatapolicies.v4.config.UpdateRecoveryPlanApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in UpdateRecoveryPlanApiResponsedata.discriminator_value_class_map.values():
            return list(UpdateRecoveryPlanApiResponsedata.discriminator_value_class_map.keys())[list(UpdateRecoveryPlanApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(UpdateRecoveryPlanApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateRecoveryPlanApiResponsedata):
            return False
