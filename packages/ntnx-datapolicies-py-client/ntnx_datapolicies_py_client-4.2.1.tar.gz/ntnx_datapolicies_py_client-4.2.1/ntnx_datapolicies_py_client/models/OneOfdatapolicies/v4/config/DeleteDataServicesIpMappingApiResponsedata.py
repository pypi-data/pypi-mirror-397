...
class DeleteDataServicesIpMappingApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfdatapolicies.v4.config.DeleteDataServicesIpMappingApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in DeleteDataServicesIpMappingApiResponsedata.discriminator_value_class_map.values():
            return list(DeleteDataServicesIpMappingApiResponsedata.discriminator_value_class_map.keys())[list(DeleteDataServicesIpMappingApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(DeleteDataServicesIpMappingApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteDataServicesIpMappingApiResponsedata):
            return False
