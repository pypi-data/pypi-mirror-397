...
from ntnx_datapolicies_py_client.models.OneOfdatapolicies.v4.config.UpdateDataServicesIpMappingApiResponsedata import UpdateDataServicesIpMappingApiResponsedata  # noqa: F401,E501
from ntnx_datapolicies_py_client.models.common.v1.response.ApiResponseMetadata import ApiResponseMetadata  # noqa: F401,E501

class UpdateDataServicesIpMappingApiResponse(object):
    ...
    swagger_types = {
        ...
        'data': 'OneOfdatapolicies.v4.config.UpdateDataServicesIpMappingApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'datapolicies.v4.config.UpdateDataServicesIpMappingApiResponse'
    ...
    def data(self):
        ...
        :type:
                :class:`~ntnx_datapolicies_py_client.models.prism.v4.config.TaskReference` | 
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(UpdateDataServicesIpMappingApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateDataServicesIpMappingApiResponse):
            return False
