...
class PowerState(object):
    ...
    Allowed enum values:
        ...
        - _UNKNOWN
        - _REDACTED
        - ON: VMs will be powered on after recovery.
        - OFF: VMs will be kept powered off after recovery. <b>volumeGroupAttachments</b>, <b>ipMappings</b>, <b>inGuestScriptExecutionConfig</b> and <b>floatingIpAssociations</b> are not applicable when <b>powerState</b> is `OFF`.
    """
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    ON = "ON"
    ...
    def _initialize_object_type(self):
        return 'datapolicies.v4.config.PowerState'
