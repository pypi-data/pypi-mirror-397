...
from ntnx_datapolicies_py_client.models.networking.v4.config.IPv4Pool import IPv4Pool  # noqa: F401,E501
...
class IPv4Config(object):
    ...
    :param default_gateway_ip: (:attr:`default_gateway_ip`) Subnet gateway IP address.
    :type default_gateway_ip: required
    
    
    :param prefix_length: (:attr:`prefix_length`) Subnet prefix length.
    :type prefix_length: required
    
     min=0, max=32
    :param ip_pool: (:attr:`ip_pool`) 
    :type ip_pool: 
    ...
    swagger_types = {
        ...
        'prefix_length': 'int',
        'ip_pool': 'networking.v4.config.IPv4Pool',
    ...
    def __init__(self, default_gateway_ip=None, prefix_length=None, ip_pool=None, *args, **kwargs):  # noqa: E501
    ...
    def _initialize_object_type(self):
        return 'datapolicies.v4.config.IPv4Config'
    ...
    def default_gateway_ip(self, default_gateway_ip):
        if default_gateway_ip is None:
            raise ValueError("Invalid value for `default_gateway_ip`, must not be `None`")  # noqa: E501
        if default_gateway_ip is not None and not re.search('^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$', default_gateway_ip):  # noqa: E501
            raise ValueError(r"Invalid value for `default_gateway_ip`, must be a follow pattern or equal to `/^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$/`")  # noqa: E501
    ...
    def ip_pool(self):
        ...
        :type:
            :class:`~ntnx_datapolicies_py_client.models.networking.v4.config.IPv4Pool`
        """  # noqa: E501
        return self.__ip_pool
