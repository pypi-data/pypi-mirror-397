...
class DelayAction(object):
    ...
    :param delay_secs: (:attr:`delay_secs`) The number of seconds for which the Recovery plan needs to be delayed after the stage recovery is completed.
    :type delay_secs: required
    ...
    def __init__(self, delay_secs=None, *args, **kwargs):  # noqa: E501
        self.__delay_secs = None
        self.discriminator = None
        self.__delay_secs = delay_secs
        # populate hidden vars if not empty
        self._populate_hidden_vars(kwargs)

    def _initialize_object_type(self):
        return 'datapolicies.v4.config.DelayAction'
    ...
    def delay_secs(self):
        ...
        :type:
                :class:`~int`
        """  # noqa: E501
        return self.__delay_secs

    @delay_secs.setter
    def delay_secs(self, delay_secs):
        if delay_secs is None:
            raise ValueError("Invalid value for `delay_secs`, must not be `None`")  # noqa: E501
        if delay_secs is not None and delay_secs < 1:  # noqa: E501
            raise ValueError("Invalid value for `delay_secs`, must be a value greater than or equal to `1`")  # noqa: E501
