...
class EncryptionState(object):
    ...
    Allowed enum values:
        ...
        - _UNKNOWN
        - _REDACTED
        - ENABLED: The user wants the data to be encrypted.
        - SYSTEM_DERIVED: The user is not interested in Encryption. The system decides whether to Encrypt the data or not.
    """
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    ENABLED = "ENABLED"
    ...
    def _initialize_object_type(self):
        return 'datapolicies.v4.config.EncryptionState'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(EncryptionState, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EncryptionState):
            return False
