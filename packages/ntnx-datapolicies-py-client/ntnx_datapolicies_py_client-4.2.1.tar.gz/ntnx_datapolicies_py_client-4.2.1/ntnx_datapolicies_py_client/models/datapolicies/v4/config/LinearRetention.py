...
class LinearRetention(object):
    ...
    :param local: (:attr:`local`) Specifies the number of recovery points to retain on the local location.
    :type local: required
    
    
    :param remote: (:attr:`remote`) Specifies the number of recovery points to retain on the remote location.
    :type remote: 
    ...
    def _initialize_object_type(self):
        return 'datapolicies.v4.config.LinearRetention'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(LinearRetention, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LinearRetention):
            return False
