...
from ntnx_datapolicies_py_client.models.OneOfdatapolicies.v4.config.ListRecoveryStagesApiResponsedata import ListRecoveryStagesApiResponsedata  # noqa: F401,E501
from ntnx_datapolicies_py_client.models.common.v1.response.ApiResponseMetadata import ApiResponseMetadata  # noqa: F401,E501

class ListRecoveryStagesApiResponse(object):
    ...
    swagger_types = {
        ...
        'data': 'OneOfdatapolicies.v4.config.ListRecoveryStagesApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'datapolicies.v4.config.ListRecoveryStagesApiResponse'
    ...
    def data(self):
        ...
        :type:
                :class:`~ntnx_datapolicies_py_client.models.datapolicies.v4.config.RecoveryStage` | 
                :class:`~ntnx_datapolicies_py_client.models.datapolicies.v4.error.ErrorResponse` | 
                :class:`~ntnx_datapolicies_py_client.models.datapolicies.v4.config.RecoveryStageProjection`
        """  # noqa: E501
        return self.__data
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListRecoveryStagesApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListRecoveryStagesApiResponse):
            return False
