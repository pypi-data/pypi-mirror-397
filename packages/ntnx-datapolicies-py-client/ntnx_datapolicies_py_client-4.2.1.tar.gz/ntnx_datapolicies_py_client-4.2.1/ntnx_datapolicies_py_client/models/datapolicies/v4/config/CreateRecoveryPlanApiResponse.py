...
from ntnx_datapolicies_py_client.models.OneOfdatapolicies.v4.config.CreateRecoveryPlanApiResponsedata import CreateRecoveryPlanApiResponsedata  # noqa: F401,E501
from ntnx_datapolicies_py_client.models.common.v1.response.ApiResponseMetadata import ApiResponseMetadata  # noqa: F401,E501

class CreateRecoveryPlanApiResponse(object):
    ...
    swagger_types = {
        ...
        'data': 'OneOfdatapolicies.v4.config.CreateRecoveryPlanApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'datapolicies.v4.config.CreateRecoveryPlanApiResponse'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(CreateRecoveryPlanApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateRecoveryPlanApiResponse):
            return False
