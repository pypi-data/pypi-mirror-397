...
from ntnx_datapolicies_py_client.models.datapolicies.v4.config.ReplicationFactor import ReplicationFactor  # noqa: F401,E501

class FaultToleranceSpec(object):
    ...
    """  # noqa: E501
    swagger_types = {
        'replication_factor': 'datapolicies.v4.config.ReplicationFactor',
    ...
    def __init__(self, replication_factor=None, *args, **kwargs):  # noqa: E501
    ...
    def _initialize_object_type(self):
        return 'datapolicies.v4.config.FaultToleranceSpec'
    ...
    def replication_factor(self):
        ...
        :type:
            :class:`~ntnx_datapolicies_py_client.models.datapolicies.v4.config.ReplicationFactor`
        """  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(FaultToleranceSpec, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FaultToleranceSpec):
            return False
