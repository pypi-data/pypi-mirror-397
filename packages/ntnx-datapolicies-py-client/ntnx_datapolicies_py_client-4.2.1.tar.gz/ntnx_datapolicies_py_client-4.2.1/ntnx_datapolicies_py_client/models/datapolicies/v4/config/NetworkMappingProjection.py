...
from ntnx_datapolicies_py_client.models.datapolicies.v4.config.NetworkMapping import NetworkMapping  # noqa: F401,E501

class NetworkMappingProjection(NetworkMapping):
    ...
    def __init__(self, primary_network=None, recovery_network=None, primary_test_network=None, recovery_test_network=None, is_ip_mapping_enabled=False, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
        NetworkMapping.__init__(self, primary_network, recovery_network, primary_test_network, recovery_test_network, is_ip_mapping_enabled, ext_id, links, tenant_id, *args, **kwargs)
        self.discriminator = None

    def _initialize_object_type(self):
        return 'datapolicies.v4.config.NetworkMappingProjection'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(NetworkMappingProjection, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NetworkMappingProjection):
            return False
