...
from ntnx_datapolicies_py_client.models.OneOfdatapolicies.v4.config.DeleteProtectionPolicyApiResponsedata import DeleteProtectionPolicyApiResponsedata  # noqa: F401,E501
from ntnx_datapolicies_py_client.models.common.v1.response.ApiResponseMetadata import ApiResponseMetadata  # noqa: F401,E501

class DeleteProtectionPolicyApiResponse(object):
    ...
    swagger_types = {
        ...
        'data': 'OneOfdatapolicies.v4.config.DeleteProtectionPolicyApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'datapolicies.v4.config.DeleteProtectionPolicyApiResponse'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(DeleteProtectionPolicyApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteProtectionPolicyApiResponse):
            return False
