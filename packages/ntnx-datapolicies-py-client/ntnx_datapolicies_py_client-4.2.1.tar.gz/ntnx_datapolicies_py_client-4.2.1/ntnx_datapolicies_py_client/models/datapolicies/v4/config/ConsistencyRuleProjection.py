...
from ntnx_datapolicies_py_client.models.datapolicies.v4.config.ConsistencyRule import ConsistencyRule  # noqa: F401,E501

class ConsistencyRuleProjection(ConsistencyRule):
    ...
    def __init__(self, name=None, category_ids=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
        ConsistencyRule.__init__(self, name, category_ids, ext_id, links, tenant_id, *args, **kwargs)
        self.discriminator = None

    def _initialize_object_type(self):
        return 'datapolicies.v4.config.ConsistencyRuleProjection'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ConsistencyRuleProjection, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ConsistencyRuleProjection):
            return False
