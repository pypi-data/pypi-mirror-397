...
class InGuestScriptExecutionConfig(object):

    """In guest script.

    :param is_enabled: (:attr:`is_enabled`) Enable in-guest script execution for the VM. By default, the in-guest script execution is disabled.
    :type is_enabled: required
    
    
    :param timeout_secs: (:attr:`timeout_secs`) Enable in-guest script execution for the VM. By default, the in-guest script execution is disabled. (**Default** 120)
    :type timeout_secs: 
    ...
    def __init__(self, is_enabled=None, timeout_secs=120, *args, **kwargs):  # noqa: E501
    ...
    def _initialize_object_type(self):
        return 'datapolicies.v4.config.InGuestScriptExecutionConfig'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(InGuestScriptExecutionConfig, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InGuestScriptExecutionConfig):
            return False
