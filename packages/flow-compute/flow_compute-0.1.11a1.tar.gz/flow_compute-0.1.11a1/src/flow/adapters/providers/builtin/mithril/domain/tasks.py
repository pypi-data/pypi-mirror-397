...
class TaskService:
    ...
    def _get_instance_type_name(self, instance_id: str) -> str:
        ...
        # Check reverse mapping (fallback for known IDs)
        if instance_id in INSTANCE_TYPE_NAMES:
            name = INSTANCE_TYPE_NAMES[instance_id]
            # Normalize to canonical short form using instance spec parser
            try:
                comp = parse_instance_spec(name)
        ...
        # Fallback: infer from instance ID patterns
