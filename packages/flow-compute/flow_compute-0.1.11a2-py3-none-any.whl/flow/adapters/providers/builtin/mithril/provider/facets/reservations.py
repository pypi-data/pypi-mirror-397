...
class ReservationsFacet:
    ...
    @handle_mithril_errors("Extend reservation")
    def extend_reservation(self, reservation_id: str, new_end_time: str) -> Reservation:
        ...
        Returns:
            Updated reservation
        """
        return self.ctx.reservations.extend(reservation_id, new_end_time)

    @handle_mithril_errors("Get extension availability")
    def get_extension_availability(self, reservation_id: str) -> dict[str, Any]:
        ...
        """
        return self.ctx.reservations.get_extension_availability(reservation_id)
