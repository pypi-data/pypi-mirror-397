...
) -> Optional[Union[Any, CreateApiKeyResponse, HTTPValidationError]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, CreateApiKeyResponse, HTTPValidationError]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[Any, CreateApiKeyResponse, HTTPValidationError]
    """
