...
try:
    from ezmsg.zmq.__version__ import version as release
except ImportError:
    release = "unknown"
...
html_baseurl = "https://www.ezmsg.org/ezmsg-zmq/"

html_theme_options = {
    "logo": {
        "text": f"ezmsg.zmq {version}",
    ...
    "icon_links": [
        {
            "name": "GitHub",
            "url": "https://github.com/ezmsg-org/ezmsg-zmq",
...
branch = "main"
code_url = f"https://github.com/ezmsg-org/ezmsg-zmq/blob/{branch}/"
