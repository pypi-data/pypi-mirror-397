...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["pulp_href", "hidden", "prn", "content_guard", "name", "pulp_last_updated", "no_content_change_since", "base_url", "pulp_created", "pulp_labels", "base_path"]
