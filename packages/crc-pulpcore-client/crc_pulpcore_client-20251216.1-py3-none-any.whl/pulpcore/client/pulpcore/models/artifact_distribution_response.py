...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "no_content_change_since", "pulp_labels", "prn", "pulp_last_updated", "base_path", "pulp_created", "hidden", "base_url", "content_guard", "pulp_href"]
