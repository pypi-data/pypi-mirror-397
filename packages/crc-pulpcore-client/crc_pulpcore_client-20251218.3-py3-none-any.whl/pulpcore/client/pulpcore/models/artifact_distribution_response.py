...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["pulp_created", "no_content_change_since", "base_url", "pulp_labels", "content_guard", "name", "prn", "base_path", "pulp_last_updated", "hidden", "pulp_href"]
