...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["base_path", "prn", "hidden", "name", "no_content_change_since", "pulp_created", "pulp_last_updated", "content_guard", "pulp_href", "pulp_labels", "base_url"]
