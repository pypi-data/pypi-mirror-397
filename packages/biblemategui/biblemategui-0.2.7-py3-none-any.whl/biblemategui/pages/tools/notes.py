...
def notes(gui=None, b=1, c=1, v=1, area=2, **_):
    ...
    bible_selector = BibleSelector(version_options=["KJV"], on_book_changed=change_note, on_chapter_changed=change_note, on_verse_changed=change_note, chapter_zero=True, verse_zero=True)
