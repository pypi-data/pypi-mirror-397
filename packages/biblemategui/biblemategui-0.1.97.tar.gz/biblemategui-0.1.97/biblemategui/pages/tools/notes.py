...
def notes(gui=None, b=1, c=1, v=1, area=2, **_):
    ...
    def run_rebuild():
        # Show a loading notification because this might take 2-3 seconds
        n = ui.notification('Scanning Drive for notes...', type='info', spinner=True)
        ...
        if count >= 0:
            ...
            ui.notify(f'Index rebuilt! Found {count} notes.', type='positive')
        else:
