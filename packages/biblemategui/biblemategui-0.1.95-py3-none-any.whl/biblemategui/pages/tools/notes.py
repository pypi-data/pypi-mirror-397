...
def notes(gui=None, b=1, c=1, v=1, area=2, **_):
    ...
    def change_note():
        nonlocal gui, bible_selector
        _, app.storage.user['tool_book_number'], app.storage.user['tool_chapter_number'], app.storage.user['tool_verse_number'] = bible_selector.get_selection()
