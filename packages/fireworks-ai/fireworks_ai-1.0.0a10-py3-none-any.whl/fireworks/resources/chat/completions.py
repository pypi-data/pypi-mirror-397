...
from ...types.shared_params.chat_completion_tool import ChatCompletionTool
    ...
    def create(
        ...
        *,
        ...
        Args:
          ...
          function_call: Deprecated in OpenAI. Use 'tool_choice' instead. This will be automatically
              transformed to tool_choice.

          functions: Deprecated in OpenAI. Use 'tools' instead. This will be automatically
              transformed to tools.
          ...
          prompt_truncate_len: The size (in tokens) to which to truncate chat prompts. This includes the system
              ...
              this length. The system prompt is preserved whenever possible and only truncated
              as a last resort.
