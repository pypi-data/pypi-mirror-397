...
class LoadBalancerSessionStatsApi(object):
    """IGNORE:
    ...
    def get_load_balancer_session_stats(self, extId, _startTime, _endTime, _samplingInterval=None, _statType=None, _select=None, **kwargs):  # noqa: E501
        """Get load balancer session listener and target statistics

        >>> response = api.get_load_balancer_session_stats(extId, _startTime, _endTime, (optional) _samplingInterval, (optional) _statType, (optional) _select)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.get_load_balancer_session_stats(extId, _startTime, _endTime, async_req=True)
        >>> result = thread.get()
        ...
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
                           ...
                           async_req=True
        :return: An instance of class :class:`~ntnx_networking_py_client.models.networking.v4.stats.LoadBalancerSessionStatsApiResponse`.
        ...
        if ('extId' not in params or params['extId'] is None):
            raise ValueError("Missing the required parameter `extId` when calling `get_load_balancer_session_stats`")  # noqa: E501
        # verify the required parameter '_startTime' is set
        if ('_startTime' not in params or params['_startTime'] is None):
            raise ValueError("Missing the required parameter `_startTime` when calling `get_load_balancer_session_stats`")  # noqa: E501
        # verify the required parameter '_endTime' is set
        if ('_endTime' not in params or params['_endTime'] is None):
            raise ValueError("Missing the required parameter `_endTime` when calling `get_load_balancer_session_stats`")  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/networking/v4.2/stats/load-balancer-sessions/{extId}', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
                    ...
                    response_type='networking.v4.stats.LoadBalancerSessionStatsApiResponse',  # noqa: E501
