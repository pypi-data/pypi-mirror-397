...
class RouteTablesApi(object):
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/networking/v4.2/config/route-tables/{extId}', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def list_route_tables(self, _page=None, _limit=None, _filter=None, _orderby=None, **kwargs):  # noqa: E501
        """List route tables

        >>> response = api.list_route_tables((optional) _page, (optional) _limit, (optional) _filter, (optional) _orderby)
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/networking/v4.2/config/route-tables', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
