...
class MacAddressesApi(object):
    ...
    def get_learned_mac_address_for_layer2_stretch_by_id(self, layer2StretchExtId, extId, **kwargs):  # noqa: E501
        """Get a specified learned MAC address of the specified Layer2Stretch

        >>> response = api.get_learned_mac_address_for_layer2_stretch_by_id(layer2StretchExtId, extId)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.get_learned_mac_address_for_layer2_stretch_by_id(layer2StretchExtId, extId, async_req=True)
        >>> result = thread.get()

        :param layer2StretchExtId: External ID of the Layer2Stretch configuration.
        :type layer2StretchExtId:
            :class:`str`, required
        :param extId: External ID of the specified learned MAC address.
        :type extId:
            :class:`str`, required
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
                           ...
                           async_req=True
        :return: An instance of class :class:`~ntnx_networking_py_client.models.networking.v4.config.GetLearnedMacAddressApiResponse`.
        ...
        if ('layer2StretchExtId' not in params or params['layer2StretchExtId'] is None):
            raise ValueError("Missing the required parameter `layer2StretchExtId` when calling `get_learned_mac_address_for_layer2_stretch_by_id`")  # noqa: E501
        # verify the required parameter 'extId' is set
        if ('extId' not in params or params['extId'] is None):
            raise ValueError("Missing the required parameter `extId` when calling `get_learned_mac_address_for_layer2_stretch_by_id`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'layer2StretchExtId' in params and params['layer2StretchExtId'] is not None:
            path_params['layer2StretchExtId'] = params['layer2StretchExtId']  # noqa: E501
        ...
        all_params = set(['layer2StretchExtId', 'extId'])
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/networking/v4.2/config/layer2-stretches/{layer2StretchExtId}/learned-mac-addresses/{extId}', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
                    ...
                    response_type='networking.v4.config.GetLearnedMacAddressApiResponse',  # noqa: E501
    ...
    def list_learned_mac_addresses_by_layer2_stretch_id(self, layer2StretchExtId, _page=None, _limit=None, _filter=None, _orderby=None, **kwargs):  # noqa: E501
        """Get learned MAC addresses of the specified Layer2Stretch

        >>> response = api.list_learned_mac_addresses_by_layer2_stretch_id(layer2StretchExtId, (optional) _page, (optional) _limit, (optional) _filter, (optional) _orderby)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.list_learned_mac_addresses_by_layer2_stretch_id(layer2StretchExtId, async_req=True)
        >>> result = thread.get()
        ...
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
                           ...
                           async_req=True
        :return: An instance of class :class:`~ntnx_networking_py_client.models.networking.v4.config.ListLearnedMacAddressesApiResponse`.
        ...
        # verify the required parameter 'layer2StretchExtId' is set
        if ('layer2StretchExtId' not in params or params['layer2StretchExtId'] is None):
            raise ValueError("Missing the required parameter `layer2StretchExtId` when calling `list_learned_mac_addresses_by_layer2_stretch_id`")  # noqa: E501
        ...
        extra_params.append('_preload_content')
        extra_params.append('_request_timeout')
        all_params = set(['layer2StretchExtId', '_page', '_limit', '_filter', '_orderby'])
        all_params.update(extra_params)
        for key, val in six.iteritems(params):
            if val is not None and key.lower() not in self.__headers_to_skip and key not in all_params:
                if key.lower() == 'if_match'.lower():
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/networking/v4.2/config/layer2-stretches/{layer2StretchExtId}/learned-mac-addresses', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
                    post_params=form_params,
                    files=local_var_files,
                    response_type='networking.v4.config.ListLearnedMacAddressesApiResponse',  # noqa: E501
                    auth_settings=auth_settings,
                    async_req=params.get('async_req'),
                    _return_http_data_only=params.get('_return_http_data_only'),
                    _preload_content=params.get('_preload_content', True),
