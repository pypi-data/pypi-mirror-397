...
class ClusterCapabilitiesApi(object):
    ...
    def list_cluster_capabilities(self, _page=None, _limit=None, _filter=None, _orderby=None, **kwargs):  # noqa: E501
        """Get cluster capabilities

        >>> response = api.list_cluster_capabilities((optional) _page, (optional) _limit, (optional) _filter, (optional) _orderby)
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/networking/v4.2/config/capabilities', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
