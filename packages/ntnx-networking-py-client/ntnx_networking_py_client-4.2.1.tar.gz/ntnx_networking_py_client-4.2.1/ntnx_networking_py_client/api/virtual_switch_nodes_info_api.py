...
class VirtualSwitchNodesInfoApi(object):
    ...
    def list_node_schedulable_status(self, X_Cluster_Id=None, _page=None, _limit=None, _filter=None, _orderby=None, **kwargs):  # noqa: E501
        """Check whether a node in a cluster is a storage-only node or not

        >>> response = api.list_node_schedulable_status((optional) X_Cluster_Id, (optional) _page, (optional) _limit, (optional) _filter, (optional) _orderby)
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/networking/v4.2/config/node-schedulable-statuses', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
