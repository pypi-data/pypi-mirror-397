...
class VpcVirtualSwitchMappingsApi(object):
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/networking/v4.2/config/vpc-virtual-switch-mappings', 'POST',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def list_vpc_virtual_switch_mappings(self, _page=None, _limit=None, _filter=None, _orderby=None, **kwargs):  # noqa: E501
        """Get the VPC for virtual switch mappings config.

        >>> response = api.list_vpc_virtual_switch_mappings((optional) _page, (optional) _limit, (optional) _filter, (optional) _orderby)
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/networking/v4.2/config/vpc-virtual-switch-mappings', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
