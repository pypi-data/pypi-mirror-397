...
class NetworkFunctionsApi(object):
    """IGNORE:
    ...
    def create_network_function(self, body, **kwargs):  # noqa: E501
        """Create a network function.

        >>> response = api.create_network_function(body)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.create_network_function(body, async_req=True)
        >>> result = thread.get()

        :param body: Request schema to create the network function.
        :type body:
            :class:`~ntnx_networking_py_client.models.networking.v4.config.NetworkFunction`, required
        ...
        if ('body' not in params or params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `create_network_function`")  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/networking/v4.2/config/network-functions', 'POST',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def delete_network_function_by_id(self, extId, **kwargs):  # noqa: E501
        """Delete the specified network function.

        >>> response = api.delete_network_function_by_id(extId)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.delete_network_function_by_id(extId, async_req=True)
        >>> result = thread.get()

        :param extId: The UUID of the network function.
        :type extId:
            :class:`str`, required
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
        ...
        if ('extId' not in params or params['extId'] is None):
            raise ValueError("Missing the required parameter `extId` when calling `delete_network_function_by_id`")  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/networking/v4.2/config/network-functions/{extId}', 'DELETE',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def get_network_function_by_id(self, extId, **kwargs):  # noqa: E501
        """Get the network function with the specified UUID.

        >>> response = api.get_network_function_by_id(extId)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.get_network_function_by_id(extId, async_req=True)
        >>> result = thread.get()
        ...
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
                           ...
                           async_req=True
        :return: An instance of class :class:`~ntnx_networking_py_client.models.networking.v4.config.GetNetworkFunctionApiResponse`.
        ...
        # verify the required parameter 'extId' is set
        if ('extId' not in params or params['extId'] is None):
            raise ValueError("Missing the required parameter `extId` when calling `get_network_function_by_id`")  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/networking/v4.2/config/network-functions/{extId}', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
                    post_params=form_params,
                    files=local_var_files,
                    response_type='networking.v4.config.GetNetworkFunctionApiResponse',  # noqa: E501
                    auth_settings=auth_settings,
                    async_req=params.get('async_req'),
                    _return_http_data_only=params.get('_return_http_data_only'),
                    _preload_content=params.get('_preload_content', True),
    ...
    def list_network_functions(self, _page=None, _limit=None, _filter=None, _orderby=None, **kwargs):  # noqa: E501
        """Get the list of existing network functions.

        >>> response = api.list_network_functions((optional) _page, (optional) _limit, (optional) _filter, (optional) _orderby)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.list_network_functions(async_req=True)
        >>> result = thread.get()
        ...
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
                           ...
                           async_req=True
        :return: An instance of class :class:`~ntnx_networking_py_client.models.networking.v4.config.ListNetworkFunctionsApiResponse`.
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/networking/v4.2/config/network-functions', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
                    post_params=form_params,
                    files=local_var_files,
                    response_type='networking.v4.config.ListNetworkFunctionsApiResponse',  # noqa: E501
                    auth_settings=auth_settings,
                    async_req=params.get('async_req'),
                    _return_http_data_only=params.get('_return_http_data_only'),
                    _preload_content=params.get('_preload_content', True),
    ...
    def update_network_function_by_id(self, extId, body, **kwargs):  # noqa: E501
        """Update the specified network function.

        >>> response = api.update_network_function_by_id(extId, body)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.update_network_function_by_id(extId, body, async_req=True)
        >>> result = thread.get()

        :param extId: The UUID of the network function.
        :type extId:
            :class:`str`, required
        :param body: Request schema to update the specified network function.
        :type body:
            :class:`~ntnx_networking_py_client.models.networking.v4.config.NetworkFunction`, required
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
        ...
        # verify the required parameter 'extId' is set
        if ('extId' not in params or params['extId'] is None):
            raise ValueError("Missing the required parameter `extId` when calling `update_network_function_by_id`")  # noqa: E501
        # verify the required parameter 'body' is set
        if ('body' not in params or params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `update_network_function_by_id`")  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/networking/v4.2/config/network-functions/{extId}', 'PUT',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
