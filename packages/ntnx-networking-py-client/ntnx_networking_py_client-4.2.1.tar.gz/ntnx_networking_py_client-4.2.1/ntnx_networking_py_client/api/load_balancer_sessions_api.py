...
class LoadBalancerSessionsApi(object):
    """IGNORE:
    ...
    def create_load_balancer_session(self, body, **kwargs):  # noqa: E501
        """Create a load balancer session.

        >>> response = api.create_load_balancer_session(body)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.create_load_balancer_session(body, async_req=True)
        >>> result = thread.get()

        :param body: Request schema to create the load balancer session.
        :type body:
            :class:`~ntnx_networking_py_client.models.networking.v4.config.LoadBalancerSession`, required
        ...
        if ('body' not in params or params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `create_load_balancer_session`")  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/networking/v4.2/config/load-balancer-sessions', 'POST',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def delete_load_balancer_session_by_id(self, extId, **kwargs):  # noqa: E501
        """Delete the specified load balancer session.

        >>> response = api.delete_load_balancer_session_by_id(extId)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.delete_load_balancer_session_by_id(extId, async_req=True)
        >>> result = thread.get()

        :param extId: The UUID of the load balancer subnet.
        :type extId:
            :class:`str`, required
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
        ...
        if ('extId' not in params or params['extId'] is None):
            raise ValueError("Missing the required parameter `extId` when calling `delete_load_balancer_session_by_id`")  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/networking/v4.2/config/load-balancer-sessions/{extId}', 'DELETE',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def get_load_balancer_session_by_id(self, extId, _select=None, **kwargs):  # noqa: E501
        """Get the load balancer session with the specified UUID.

        >>> response = api.get_load_balancer_session_by_id(extId, (optional) _select)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.get_load_balancer_session_by_id(extId, async_req=True)
        >>> result = thread.get()
        ...
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
                           ...
                           async_req=True
        :return: An instance of class :class:`~ntnx_networking_py_client.models.networking.v4.config.GetLoadBalancerSessionApiResponse`.
        ...
        # verify the required parameter 'extId' is set
        if ('extId' not in params or params['extId'] is None):
            raise ValueError("Missing the required parameter `extId` when calling `get_load_balancer_session_by_id`")  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/networking/v4.2/config/load-balancer-sessions/{extId}', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
                    post_params=form_params,
                    files=local_var_files,
                    response_type='networking.v4.config.GetLoadBalancerSessionApiResponse',  # noqa: E501
                    auth_settings=auth_settings,
                    async_req=params.get('async_req'),
                    _return_http_data_only=params.get('_return_http_data_only'),
                    _preload_content=params.get('_preload_content', True),
    ...
    def list_load_balancer_sessions(self, _page=None, _limit=None, _filter=None, _orderby=None, _select=None, **kwargs):  # noqa: E501
        """Get the list of existing load balancer sessions.

        >>> response = api.list_load_balancer_sessions((optional) _page, (optional) _limit, (optional) _filter, (optional) _orderby, (optional) _select)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.list_load_balancer_sessions(async_req=True)
        >>> result = thread.get()
        ...
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
                           ...
                           async_req=True
        :return: An instance of class :class:`~ntnx_networking_py_client.models.networking.v4.config.ListLoadBalancerSessionsApiResponse`.
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/networking/v4.2/config/load-balancer-sessions', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
                    post_params=form_params,
                    files=local_var_files,
                    response_type='networking.v4.config.ListLoadBalancerSessionsApiResponse',  # noqa: E501
                    auth_settings=auth_settings,
                    async_req=params.get('async_req'),
                    _return_http_data_only=params.get('_return_http_data_only'),
                    _preload_content=params.get('_preload_content', True),
    ...
    def update_load_balancer_session_by_id(self, extId, body, **kwargs):  # noqa: E501
        """Update the specified load balancer session.

        >>> response = api.update_load_balancer_session_by_id(extId, body)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.update_load_balancer_session_by_id(extId, body, async_req=True)
        >>> result = thread.get()

        :param extId: The UUID of the load balancer subnet.
        :type extId:
            :class:`str`, required
        :param body: Request schema to update the specified load balancer session.
        :type body:
            :class:`~ntnx_networking_py_client.models.networking.v4.config.LoadBalancerSession`, required
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
        ...
        # verify the required parameter 'extId' is set
        if ('extId' not in params or params['extId'] is None):
            raise ValueError("Missing the required parameter `extId` when calling `update_load_balancer_session_by_id`")  # noqa: E501
        # verify the required parameter 'body' is set
        if ('body' not in params or params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `update_load_balancer_session_by_id`")  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/networking/v4.2/config/load-balancer-sessions/{extId}', 'PUT',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
