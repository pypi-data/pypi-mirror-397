...
class NodeSchedulableStatusProjection(NodeSchedulableStatus):
    ...
    def __init__(self, is_never_schedulable=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
        NodeSchedulableStatus.__init__(self, is_never_schedulable, ext_id, links, tenant_id, *args, **kwargs)
