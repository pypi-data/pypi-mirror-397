...
class ListenerStats(object):
    ...
    :param virtual_ip_address: (:attr:`virtual_ip_address`) Load balancer session listener virtual IP address
    :type virtual_ip_address: 
    ...
    def __init__(self, virtual_ip_address=None, num_bytes=None, num_requests=None, num_packets=None, *args, **kwargs):  # noqa: E501
    ...
    def _initialize_object_type(self):
        return 'networking.v4.stats.ListenerStats'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListenerStats, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListenerStats):
            return False
