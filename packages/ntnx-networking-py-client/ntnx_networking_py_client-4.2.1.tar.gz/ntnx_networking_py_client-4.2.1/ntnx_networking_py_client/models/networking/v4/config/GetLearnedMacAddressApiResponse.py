...
from ntnx_networking_py_client.models.OneOfnetworking.v4.config.GetLearnedMacAddressApiResponsedata import GetLearnedMacAddressApiResponsedata  # noqa: F401,E501
from ntnx_networking_py_client.models.common.v1.response.ApiResponseMetadata import ApiResponseMetadata  # noqa: F401,E501

class GetLearnedMacAddressApiResponse(object):
    ...
    swagger_types = {
        ...
        'data': 'OneOfnetworking.v4.config.GetLearnedMacAddressApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'networking.v4.config.GetLearnedMacAddressApiResponse'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetLearnedMacAddressApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetLearnedMacAddressApiResponse):
            return False
