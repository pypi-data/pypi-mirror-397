...
class NicTarget(object):
    ...
    :param virtual_nic_reference: (:attr:`virtual_nic_reference`) UUID of the virtual NIC of the load balancer session target.
    ...
    :type port: 
     ...
     min=1, max=65535
    :param vm_reference: (:attr:`vm_reference`) UUID of the VM of the load balancer session target.
    :type vm_reference: 
