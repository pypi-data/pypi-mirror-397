...
class LoadBalancerSessionAssociation(object):
    ...
    :type load_balancer_session_reference: required
    ...
    def __init__(self, load_balancer_session_reference=None, vpc_reference=None, private_ip=None, *args, **kwargs):  # noqa: E501
    ...
    def _initialize_object_type(self):
        return 'networking.v4.config.LoadBalancerSessionAssociation'
    ...
    def load_balancer_session_reference(self, load_balancer_session_reference):
        if load_balancer_session_reference is None:
            raise ValueError("Invalid value for `load_balancer_session_reference`, must not be `None`")  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(LoadBalancerSessionAssociation, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LoadBalancerSessionAssociation):
            return False
