...
class NicHighAvailabilityState(object):
    ...
    Allowed enum values:
        ...
        - _UNKNOWN
        - _REDACTED
        - ACTIVE: NIC Pair is active mode.
    ...
    def _initialize_object_type(self):
        return 'networking.v4.config.NicHighAvailabilityState'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(NicHighAvailabilityState, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NicHighAvailabilityState):
            return False
