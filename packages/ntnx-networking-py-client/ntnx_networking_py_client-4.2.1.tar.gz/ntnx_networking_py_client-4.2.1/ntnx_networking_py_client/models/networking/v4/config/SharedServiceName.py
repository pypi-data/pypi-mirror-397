...
class SharedServiceName(object):
    ...
    Allowed enum values:
        ...
        - _UNKNOWN
        - _REDACTED
        - CORE_SERVICE: Network controller core service(s).
        - CONFIGURATION_DATABASE: Network controller configuration database service.
    """
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    ...
    def _initialize_object_type(self):
        return 'networking.v4.config.SharedServiceName'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(SharedServiceName, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SharedServiceName):
            return False
