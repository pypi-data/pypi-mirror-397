...
from ntnx_networking_py_client.models.networking.v4.config.ExternalDhcpServer import ExternalDhcpServer  # noqa: F401,E501
...
class Subnet(NetworkingBaseModel):
    ...
    :param cluster_reference_list: (:attr:`cluster_reference_list`) List of UUIDs of the cluster this subnet belongs to.
    :type cluster_reference_list: 
    
    
    :param cluster_name_list: (:attr:`cluster_name_list`) List of cluster names this subnet belongs to.
    :type cluster_name_list: 
    ...
    :param layer2_stretch_reference: (:attr:`layer2_stretch_reference`) 
    :type layer2_stretch_reference: 
    ...
    :param external_dhcp_servers: (:attr:`external_dhcp_servers`) List of External DHCP servers used by this subnet.
    :type external_dhcp_servers: 
    ...
    swagger_types = {
        ...
        'layer2_stretch_reference': 'networking.v4.config.Layer2Stretch',
        'ip_prefix': 'str',
        'ip_usage': 'networking.v4.config.IPUsage',
        'migration_state': 'networking.v4.config.MigrationState',
        'external_dhcp_servers': 'list[networking.v4.config.ExternalDhcpServer]',
    ...
    attribute_map = {
        ...
        'vpc': 'vpc',
        'layer2_stretch_reference': 'layer2StretchReference',
        'ip_prefix': 'ipPrefix',
        'ip_usage': 'ipUsage',
        'migration_state': 'migrationState',
        'external_dhcp_servers': 'externalDhcpServers',
        'metadata': 'metadata',
        'ext_id': 'extId',
        'links': 'links',
        'tenant_id': 'tenantId',
    ...
    def __init__(self, name=None, description=None, subnet_type=None, network_id=None, dhcp_options=None, ip_config=None, cluster_reference=None, cluster_reference_list=None, cluster_name_list=None, virtual_switch_reference=None, vpc_reference=None, is_nat_enabled=None, is_external=None, reserved_ip_addresses=None, dynamic_ip_addresses=None, network_function_chain_reference=None, bridge_name=None, is_advanced_networking=None, cluster_name=None, hypervisor_type=None, virtual_switch=None, vpc=None, layer2_stretch_reference=None, ip_prefix=None, ip_usage=None, migration_state=None, external_dhcp_servers=None, metadata=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
        ...
        self.__vpc = None
        self.__layer2_stretch_reference = None
        self.__ip_prefix = None
        self.__ip_usage = None
        self.__migration_state = None
        self.__external_dhcp_servers = None
        ...
        if cluster_name_list is not None:
            self.__cluster_name_list = cluster_name_list
        ...
        if vpc is not None:
            self.__vpc = vpc
        if layer2_stretch_reference is not None:
            self.__layer2_stretch_reference = layer2_stretch_reference
        ...
        if external_dhcp_servers is not None:
            self.__external_dhcp_servers = external_dhcp_servers
    ...
    def cluster_name_list(self):
        ...
        :type:
            list[ :class:`~str` ]
        """  # noqa: E501
        return self.__cluster_name_list
    ...
    @property
    def layer2_stretch_reference(self):
        """
        ...
        """  # noqa: E501
        return self.__layer2_stretch_reference

    @layer2_stretch_reference.setter
    def layer2_stretch_reference(self, layer2_stretch_reference):
    ...
    @property
    def external_dhcp_servers(self):
        """
        List of External DHCP servers used by this subnet.

        :type:
             list[ :class:`~ntnx_networking_py_client.models.networking.v4.config.ExternalDhcpServer` ]
        """  # noqa: E501
        return self.__external_dhcp_servers

    @external_dhcp_servers.setter
    def external_dhcp_servers(self, external_dhcp_servers):
