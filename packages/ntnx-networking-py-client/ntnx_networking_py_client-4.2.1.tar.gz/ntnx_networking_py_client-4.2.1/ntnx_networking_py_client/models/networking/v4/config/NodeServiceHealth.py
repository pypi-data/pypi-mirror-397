...
from ntnx_networking_py_client.models.networking.v4.config.NodeServiceName import NodeServiceName  # noqa: F401,E501

class NodeServiceHealth(object):
    ...
    """  # noqa: E501
    swagger_types = {
        'service': 'networking.v4.config.NodeServiceName',
    ...
    def _initialize_object_type(self):
        return 'networking.v4.config.NodeServiceHealth'
    ...
    def service(self):
        ...
        :type:
            :class:`~ntnx_networking_py_client.models.networking.v4.config.NodeServiceName`
        """  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(NodeServiceHealth, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NodeServiceHealth):
            return False
