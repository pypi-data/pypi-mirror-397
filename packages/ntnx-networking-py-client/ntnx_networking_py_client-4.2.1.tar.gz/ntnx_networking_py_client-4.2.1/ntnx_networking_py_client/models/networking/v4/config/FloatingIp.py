...
from ntnx_networking_py_client.models.networking.v4.config.AssociationStatus import AssociationStatus  # noqa: F401,E501
...
class FloatingIp(NetworkingBaseModel):
    ...
    :param association_status: (:attr:`association_status`) 
    ...
    swagger_types = {
        ...
        'association_status': 'networking.v4.config.AssociationStatus',
        'vpc_reference': 'str',
    ...
    def association_status(self):
        ...
        :type:
            :class:`~ntnx_networking_py_client.models.networking.v4.config.AssociationStatus`
        """  # noqa: E501
