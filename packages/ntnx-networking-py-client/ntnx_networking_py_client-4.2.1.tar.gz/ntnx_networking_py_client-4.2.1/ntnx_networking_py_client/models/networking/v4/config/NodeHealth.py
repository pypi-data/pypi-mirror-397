...
from ntnx_networking_py_client.models.networking.v4.config.NodeServiceHealth import NodeServiceHealth  # noqa: F401,E501

class NodeHealth(object):

    """Health status of AHV node.

    :param node_ext_id: (:attr:`node_ext_id`) Reference of external ID of node.
    :type node_ext_id: 
    
    
    :param node_ip: (:attr:`node_ip`) 
    :type node_ip: 
    
    
    :param node_services: (:attr:`node_services`) List of networking services running on AHV node.
    :type node_services: 
    ...
    swagger_types = {
        'node_ext_id': 'str',
        'node_ip': 'common.v1.config.IPAddress',
        'node_services': 'list[networking.v4.config.NodeServiceHealth]',
    ...
    def __init__(self, node_ext_id=None, node_ip=None, node_services=None, *args, **kwargs):  # noqa: E501
        self.__node_ext_id = None
        self.__node_ip = None
        self.__node_services = None
        ...
        if node_services is not None:
            self.__node_services = node_services
        # populate hidden vars if not empty
        self._populate_hidden_vars(kwargs)

    def _initialize_object_type(self):
        return 'networking.v4.config.NodeHealth'
    ...
    def node_services(self):
        ...
        :type:
             list[ :class:`~ntnx_networking_py_client.models.networking.v4.config.NodeServiceHealth` ]
        """  # noqa: E501
        return self.__node_services

    @node_services.setter
    def node_services(self, node_services):
