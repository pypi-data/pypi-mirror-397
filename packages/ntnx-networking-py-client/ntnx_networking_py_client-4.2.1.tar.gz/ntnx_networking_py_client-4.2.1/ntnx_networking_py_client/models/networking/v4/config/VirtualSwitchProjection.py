...
class VirtualSwitchProjection(VirtualSwitch):
    ...
    :param is_quick_mode: (:attr:`is_quick_mode`) When true, the node is not put in maintenance mode during the Virtual Switch update operation. This may briefly interrupt cluster workloads. (**Default** False)
    :type is_quick_mode: 
