...
class RemoteVpnConnection(VpnConnection):
    ...
    :param cluster_reference: (:attr:`cluster_reference`) Reference to the remote Prism Element cluster where the remote gateway of the VPN connection is located.
    :type cluster_reference: 
    
    
    :param cluster_name: (:attr:`cluster_name`) Name of the remote Prism Element cluster where the remote gateway of the VPN connection is located.
    :type cluster_name: 
     max=128 chars
