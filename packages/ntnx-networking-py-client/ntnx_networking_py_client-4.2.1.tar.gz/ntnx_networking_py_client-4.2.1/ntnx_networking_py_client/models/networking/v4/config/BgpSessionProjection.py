...
class BgpSessionProjection(BgpSession):
    ...
    def __init__(self, gateway_projection=None, name=None, description=None, local_gateway_reference=None, remote_gateway_reference=None, local_gateway_interface_ip_address=None, dynamic_route_priority=None, password=None, status=None, local_gateway=None, remote_gateway=None, should_advertise_all_externally_routable_prefixes=None, externally_routable_prefixes_to_advertise=None, prepended_autonomous_system_path=None, advertised_routes_communities=None, metadata=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
        BgpSession.__init__(self, name, description, local_gateway_reference, remote_gateway_reference, local_gateway_interface_ip_address, dynamic_route_priority, password, status, local_gateway, remote_gateway, should_advertise_all_externally_routable_prefixes, externally_routable_prefixes_to_advertise, prepended_autonomous_system_path, advertised_routes_communities, metadata, ext_id, links, tenant_id, *args, **kwargs)
