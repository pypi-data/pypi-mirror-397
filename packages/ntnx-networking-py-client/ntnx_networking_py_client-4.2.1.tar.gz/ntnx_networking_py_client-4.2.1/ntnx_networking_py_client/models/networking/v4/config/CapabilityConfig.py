...
from ntnx_networking_py_client.models.networking.v4.config.CapabilityType import CapabilityType  # noqa: F401,E501

class CapabilityConfig(object):
    ...
    :param capability_type: (:attr:`capability_type`) 
    ...
    """  # noqa: E501
    swagger_types = {
        'capability_type': 'networking.v4.config.CapabilityType',
    ...
    def __init__(self, capability_type=None, *args, **kwargs):  # noqa: E501
        self.__capability_type = None
        self.discriminator = None
        self.__capability_type = capability_type
        # populate hidden vars if not empty
        self._populate_hidden_vars(kwargs)

    def _initialize_object_type(self):
        return 'networking.v4.config.CapabilityConfig'
    ...
    def capability_type(self):
        ...
        :type:
            :class:`~ntnx_networking_py_client.models.networking.v4.config.CapabilityType`
        """  # noqa: E501
        return self.__capability_type
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(CapabilityConfig, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CapabilityConfig):
            return False
