...
from ntnx_networking_py_client.models.OneOfnetworking.v4.config.ListLoadBalancerSessionsApiResponsedata import ListLoadBalancerSessionsApiResponsedata  # noqa: F401,E501
from ntnx_networking_py_client.models.common.v1.response.ApiResponseMetadata import ApiResponseMetadata  # noqa: F401,E501

class ListLoadBalancerSessionsApiResponse(object):
    ...
    swagger_types = {
        ...
        'data': 'OneOfnetworking.v4.config.ListLoadBalancerSessionsApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'networking.v4.config.ListLoadBalancerSessionsApiResponse'
    ...
    def data(self):
        ...
        :type:
                :class:`~ntnx_networking_py_client.models.networking.v4.config.LoadBalancerSession` | 
                :class:`~ntnx_networking_py_client.models.networking.v4.error.ErrorResponse` | 
                :class:`~ntnx_networking_py_client.models.networking.v4.config.LoadBalancerSessionProjection`
        """  # noqa: E501
        return self.__data
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListLoadBalancerSessionsApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListLoadBalancerSessionsApiResponse):
            return False
