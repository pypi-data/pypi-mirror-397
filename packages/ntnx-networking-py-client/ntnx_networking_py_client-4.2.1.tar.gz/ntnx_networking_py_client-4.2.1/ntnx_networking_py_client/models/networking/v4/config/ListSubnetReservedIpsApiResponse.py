...
from ntnx_networking_py_client.models.OneOfnetworking.v4.config.ListSubnetReservedIpsApiResponsedata import ListSubnetReservedIpsApiResponsedata  # noqa: F401,E501
from ntnx_networking_py_client.models.common.v1.response.ApiResponseMetadata import ApiResponseMetadata  # noqa: F401,E501

class ListSubnetReservedIpsApiResponse(object):
    ...
    swagger_types = {
        ...
        'data': 'OneOfnetworking.v4.config.ListSubnetReservedIpsApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'networking.v4.config.ListSubnetReservedIpsApiResponse'
    ...
    def data(self):
        ...
        :type:
                :class:`~ntnx_networking_py_client.models.networking.v4.config.ReservedIp` | 
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListSubnetReservedIpsApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListSubnetReservedIpsApiResponse):
            return False
