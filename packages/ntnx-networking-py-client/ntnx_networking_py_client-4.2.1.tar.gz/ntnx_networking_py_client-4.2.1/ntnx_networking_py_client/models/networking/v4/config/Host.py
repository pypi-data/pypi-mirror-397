...
class Host(object):
    ...
    :param active_uplink: (:attr:`active_uplink`) Host active uplink interface
    :type active_uplink: 
    ...
    def __init__(self, ext_id=None, internal_bridge_name=None, host_nics=None, ip_address=None, route_table=None, active_uplink=None, *args, **kwargs):  # noqa: E501
        self.__ext_id = None
        self.__internal_bridge_name = None
        self.__host_nics = None
        self.__ip_address = None
        self.__route_table = None
        self.__active_uplink = None
        ...
        if active_uplink is not None:
            self.__active_uplink = active_uplink
    ...
    def active_uplink(self):
        ...
        :type:
                :class:`~str`
        """  # noqa: E501
        return self.__active_uplink

    @active_uplink.setter
    def active_uplink(self, active_uplink):
