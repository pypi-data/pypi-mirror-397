...
from ntnx_networking_py_client.models.OneOfnetworking.v4.config.ListRoutesApiResponsedata import ListRoutesApiResponsedata  # noqa: F401,E501
from ntnx_networking_py_client.models.common.v1.response.ApiResponseMetadata import ApiResponseMetadata  # noqa: F401,E501

class ListRoutesApiResponse(object):
    ...
    swagger_types = {
        ...
        'data': 'OneOfnetworking.v4.config.ListRoutesApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'networking.v4.config.ListRoutesApiResponse'
    ...
    def data(self):
        ...
        :type:
                :class:`~ntnx_networking_py_client.models.networking.v4.config.Route` | 
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListRoutesApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListRoutesApiResponse):
            return False
