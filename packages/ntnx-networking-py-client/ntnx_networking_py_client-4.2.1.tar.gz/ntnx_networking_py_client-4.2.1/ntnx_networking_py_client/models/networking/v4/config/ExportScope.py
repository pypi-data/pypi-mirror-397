...
from ntnx_networking_py_client.models.networking.v4.config.IpFamily import IpFamily  # noqa: F401,E501
...
class ExportScope(object):
    ...
    :param uuid: (:attr:`uuid`) UUID of the PE or PC cluster.
    :type uuid: 
    ...
    :param ip_family: (:attr:`ip_family`) 
    :type ip_family: 
    ...
    swagger_types = {
        ...
        'ip_family': 'networking.v4.config.IpFamily',
    ...
    def __init__(self, uuid=None, scope_type=None, ip_family=None, *args, **kwargs):  # noqa: E501
        self.__uuid = None
        self.__scope_type = None
        self.__ip_family = None
    ...
    def ip_family(self):
        ...
        :type:
            :class:`~ntnx_networking_py_client.models.networking.v4.config.IpFamily`
        """  # noqa: E501
