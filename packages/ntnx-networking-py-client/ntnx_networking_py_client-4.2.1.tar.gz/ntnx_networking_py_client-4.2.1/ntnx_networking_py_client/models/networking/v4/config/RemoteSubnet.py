...
class RemoteSubnet(Subnet):
    ...
    def __init__(self, vpc_name=None, name=None, description=None, subnet_type=None, network_id=None, dhcp_options=None, ip_config=None, cluster_reference=None, cluster_reference_list=None, cluster_name_list=None, virtual_switch_reference=None, vpc_reference=None, is_nat_enabled=None, is_external=None, reserved_ip_addresses=None, dynamic_ip_addresses=None, network_function_chain_reference=None, bridge_name=None, is_advanced_networking=None, cluster_name=None, hypervisor_type=None, virtual_switch=None, vpc=None, layer2_stretch_reference=None, ip_prefix=None, ip_usage=None, migration_state=None, external_dhcp_servers=None, metadata=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
