...
class ClusterFlowStatus(ExternalizableAbstractModel):
    ...
    def __init__(self, cluster_status_list=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
