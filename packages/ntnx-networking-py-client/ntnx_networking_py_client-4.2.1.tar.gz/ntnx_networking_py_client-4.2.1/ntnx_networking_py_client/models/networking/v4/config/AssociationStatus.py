...
class AssociationStatus(object):
    ...
    Allowed enum values:
        ...
        - ASSOCIATED_TO_PRIVATE_IP: Associated to a Private IP.
        - ASSOCIATED_TO_VNIC: Associated to a VM NIC.
        - ASSOCIATED_TO_LOAD_BALANCER_SESSION: Associated to a Load balancer session.
    """
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    NOT_ASSOCIATED = "NOT_ASSOCIATED"
    ASSOCIATED_TO_PRIVATE_IP = "ASSOCIATED_TO_PRIVATE_IP"
    ASSOCIATED_TO_VNIC = "ASSOCIATED_TO_VNIC"
    ASSOCIATED_TO_LOAD_BALANCER_SESSION = "ASSOCIATED_TO_LOAD_BALANCER_SESSION"
    ...
    def _initialize_object_type(self):
        return 'networking.v4.config.AssociationStatus'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(AssociationStatus, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AssociationStatus):
            return False
