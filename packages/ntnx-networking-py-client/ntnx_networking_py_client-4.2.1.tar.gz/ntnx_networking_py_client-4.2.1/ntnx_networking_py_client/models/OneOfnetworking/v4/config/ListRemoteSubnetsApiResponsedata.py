...
class ListRemoteSubnetsApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<networking.v4.config.RemoteSubnet>': 'list[networking.v4.config.RemoteSubnet]',
    ...
    def _initialize_object_type(self):
        return 'OneOfnetworking.v4.config.ListRemoteSubnetsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListRemoteSubnetsApiResponsedata.discriminator_value_class_map.values():
            return list(ListRemoteSubnetsApiResponsedata.discriminator_value_class_map.keys())[list(ListRemoteSubnetsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListRemoteSubnetsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListRemoteSubnetsApiResponsedata):
            return False
