...
class ListRoutesApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<networking.v4.config.Route>': 'list[networking.v4.config.Route]',
    ...
    def _initialize_object_type(self):
        return 'OneOfnetworking.v4.config.ListRoutesApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListRoutesApiResponsedata.discriminator_value_class_map.values():
            return list(ListRoutesApiResponsedata.discriminator_value_class_map.keys())[list(ListRoutesApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListRoutesApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListRoutesApiResponsedata):
            return False
