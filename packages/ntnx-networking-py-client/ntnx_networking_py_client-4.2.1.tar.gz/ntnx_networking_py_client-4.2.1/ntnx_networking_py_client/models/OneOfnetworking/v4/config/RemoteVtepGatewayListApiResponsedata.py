...
class RemoteVtepGatewayListApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<networking.v4.config.RemoteVtepGateway>': 'list[networking.v4.config.RemoteVtepGateway]',
    ...
    def _initialize_object_type(self):
        return 'OneOfnetworking.v4.config.RemoteVtepGatewayListApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in RemoteVtepGatewayListApiResponsedata.discriminator_value_class_map.values():
            return list(RemoteVtepGatewayListApiResponsedata.discriminator_value_class_map.keys())[list(RemoteVtepGatewayListApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(RemoteVtepGatewayListApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RemoteVtepGatewayListApiResponsedata):
            return False
