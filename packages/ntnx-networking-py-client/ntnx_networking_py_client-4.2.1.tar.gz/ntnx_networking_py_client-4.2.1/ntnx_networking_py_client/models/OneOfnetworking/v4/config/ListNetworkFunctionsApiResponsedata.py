...
class ListNetworkFunctionsApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<networking.v4.config.NetworkFunction>': 'list[networking.v4.config.NetworkFunction]',
        'networking.v4.error.ErrorResponse': 'networking.v4.error.ErrorResponse',
        'List<networking.v4.config.NetworkFunctionProjection>': 'list[networking.v4.config.NetworkFunctionProjection]'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOfnetworking.v4.config.ListNetworkFunctionsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListNetworkFunctionsApiResponsedata.discriminator_value_class_map.values():
            return list(ListNetworkFunctionsApiResponsedata.discriminator_value_class_map.keys())[list(ListNetworkFunctionsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListNetworkFunctionsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListNetworkFunctionsApiResponsedata):
            return False
