...
class ListSubnetVnicsApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<networking.v4.config.Vnic>': 'list[networking.v4.config.Vnic]',
    ...
    def _initialize_object_type(self):
        return 'OneOfnetworking.v4.config.ListSubnetVnicsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListSubnetVnicsApiResponsedata.discriminator_value_class_map.values():
            return list(ListSubnetVnicsApiResponsedata.discriminator_value_class_map.keys())[list(ListSubnetVnicsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListSubnetVnicsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListSubnetVnicsApiResponsedata):
            return False
