...
class GetLearnedMacAddressApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'networking.v4.config.LearnedMacAddress': 'networking.v4.config.LearnedMacAddress',
    ...
    def _initialize_object_type(self):
        return 'OneOfnetworking.v4.config.GetLearnedMacAddressApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetLearnedMacAddressApiResponsedata.discriminator_value_class_map.values():
            return list(GetLearnedMacAddressApiResponsedata.discriminator_value_class_map.keys())[list(GetLearnedMacAddressApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetLearnedMacAddressApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetLearnedMacAddressApiResponsedata):
            return False
