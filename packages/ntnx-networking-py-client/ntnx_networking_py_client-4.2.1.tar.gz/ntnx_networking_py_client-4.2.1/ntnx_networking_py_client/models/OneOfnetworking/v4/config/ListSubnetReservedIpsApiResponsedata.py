...
class ListSubnetReservedIpsApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<networking.v4.config.ReservedIp>': 'list[networking.v4.config.ReservedIp]',
    ...
    def _initialize_object_type(self):
        return 'OneOfnetworking.v4.config.ListSubnetReservedIpsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListSubnetReservedIpsApiResponsedata.discriminator_value_class_map.values():
            return list(ListSubnetReservedIpsApiResponsedata.discriminator_value_class_map.keys())[list(ListSubnetReservedIpsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListSubnetReservedIpsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListSubnetReservedIpsApiResponsedata):
            return False
