...
class RemoteVpnConnectionListApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<networking.v4.config.RemoteVpnConnection>': 'list[networking.v4.config.RemoteVpnConnection]',
    ...
    def _initialize_object_type(self):
        return 'OneOfnetworking.v4.config.RemoteVpnConnectionListApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in RemoteVpnConnectionListApiResponsedata.discriminator_value_class_map.values():
            return list(RemoteVpnConnectionListApiResponsedata.discriminator_value_class_map.keys())[list(RemoteVpnConnectionListApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(RemoteVpnConnectionListApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RemoteVpnConnectionListApiResponsedata):
            return False
