...
class ListBgpRoutesApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<networking.v4.config.BgpRoute>': 'list[networking.v4.config.BgpRoute]',
    ...
    def _initialize_object_type(self):
        return 'OneOfnetworking.v4.config.ListBgpRoutesApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListBgpRoutesApiResponsedata.discriminator_value_class_map.values():
            return list(ListBgpRoutesApiResponsedata.discriminator_value_class_map.keys())[list(ListBgpRoutesApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListBgpRoutesApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListBgpRoutesApiResponsedata):
            return False
