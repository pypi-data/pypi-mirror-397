...
class GetNetworkFunctionApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'networking.v4.config.NetworkFunction': 'networking.v4.config.NetworkFunction',
    ...
    def _initialize_object_type(self):
        return 'OneOfnetworking.v4.config.GetNetworkFunctionApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetNetworkFunctionApiResponsedata.discriminator_value_class_map.values():
            return list(GetNetworkFunctionApiResponsedata.discriminator_value_class_map.keys())[list(GetNetworkFunctionApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetNetworkFunctionApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetNetworkFunctionApiResponsedata):
            return False
