...
class GetLoadBalancerSessionApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'networking.v4.config.LoadBalancerSession': 'networking.v4.config.LoadBalancerSession',
    ...
    def _initialize_object_type(self):
        return 'OneOfnetworking.v4.config.GetLoadBalancerSessionApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetLoadBalancerSessionApiResponsedata.discriminator_value_class_map.values():
            return list(GetLoadBalancerSessionApiResponsedata.discriminator_value_class_map.keys())[list(GetLoadBalancerSessionApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetLoadBalancerSessionApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetLoadBalancerSessionApiResponsedata):
            return False
