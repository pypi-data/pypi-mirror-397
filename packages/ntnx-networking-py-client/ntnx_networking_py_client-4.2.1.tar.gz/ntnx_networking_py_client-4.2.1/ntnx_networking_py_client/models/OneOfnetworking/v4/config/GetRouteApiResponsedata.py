...
class GetRouteApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'networking.v4.config.Route': 'networking.v4.config.Route',
    ...
    def _initialize_object_type(self):
        return 'OneOfnetworking.v4.config.GetRouteApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetRouteApiResponsedata.discriminator_value_class_map.values():
            return list(GetRouteApiResponsedata.discriminator_value_class_map.keys())[list(GetRouteApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetRouteApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetRouteApiResponsedata):
            return False
