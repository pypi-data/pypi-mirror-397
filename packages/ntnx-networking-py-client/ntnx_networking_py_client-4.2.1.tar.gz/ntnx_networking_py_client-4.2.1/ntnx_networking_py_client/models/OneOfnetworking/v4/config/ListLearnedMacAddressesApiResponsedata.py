...
class ListLearnedMacAddressesApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<networking.v4.config.LearnedMacAddress>': 'list[networking.v4.config.LearnedMacAddress]',
    ...
    def _initialize_object_type(self):
        return 'OneOfnetworking.v4.config.ListLearnedMacAddressesApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListLearnedMacAddressesApiResponsedata.discriminator_value_class_map.values():
            return list(ListLearnedMacAddressesApiResponsedata.discriminator_value_class_map.keys())[list(ListLearnedMacAddressesApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListLearnedMacAddressesApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListLearnedMacAddressesApiResponsedata):
            return False
