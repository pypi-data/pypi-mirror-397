...
class AwsSubnetsApi(object):
    ...
    def list_aws_subnets(self, X_Cluster_Id, _page=None, _limit=None, _filter=None, _orderby=None, _select=None, **kwargs):  # noqa: E501
        """Get NC2A subnets.

        >>> response = api.list_aws_subnets(X_Cluster_Id, (optional) _page, (optional) _limit, (optional) _filter, (optional) _orderby, (optional) _select)
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/networking/v4.2/aws/config/subnets', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
