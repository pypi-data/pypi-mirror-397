...
class SubnetIPReservationApi(object):
    ...
    def list_reserved_ips_by_subnet_id(self, subnetExtId, _page=None, _limit=None, _filter=None, _orderby=None, _select=None, **kwargs):  # noqa: E501
        """List reserved IPs of a managed subnet

        >>> response = api.list_reserved_ips_by_subnet_id(subnetExtId, (optional) _page, (optional) _limit, (optional) _filter, (optional) _orderby, (optional) _select)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.list_reserved_ips_by_subnet_id(subnetExtId, async_req=True)
        >>> result = thread.get()

        :param subnetExtId: UUID of the subnet.
        :type subnetExtId:
            :class:`str`, required
        ...
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
                           ...
                           async_req=True
        :return: An instance of class :class:`~ntnx_networking_py_client.models.networking.v4.config.ListSubnetReservedIpsApiResponse`.
        ...
        if ('subnetExtId' not in params or params['subnetExtId'] is None):
            raise ValueError("Missing the required parameter `subnetExtId` when calling `list_reserved_ips_by_subnet_id`")  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/networking/v4.2/config/subnets/{subnetExtId}/reserved-ips', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
                    ...
                    response_type='networking.v4.config.ListSubnetReservedIpsApiResponse',  # noqa: E501
    ...
    def reserve_ips_by_subnet_id(self, extId, body, **kwargs):  # noqa: E501
        ...
        :param extId: UUID of the subnet.
        :type extId:
            :class:`str`, required
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/networking/v4.2/config/subnets/{extId}/addresses/$actions/reserve', 'POST',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def unreserve_ips_by_subnet_id(self, extId, body, **kwargs):  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/networking/v4.2/config/subnets/{extId}/addresses/$actions/unreserve', 'POST',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
