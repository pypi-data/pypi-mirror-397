...
from ntnx_networking_py_client.models.OneOfnetworking.v4.config.ListLearnedMacAddressesApiResponsedata import ListLearnedMacAddressesApiResponsedata  # noqa: F401,E501
from ntnx_networking_py_client.models.common.v1.response.ApiResponseMetadata import ApiResponseMetadata  # noqa: F401,E501

class ListLearnedMacAddressesApiResponse(object):
    ...
    swagger_types = {
        ...
        'data': 'OneOfnetworking.v4.config.ListLearnedMacAddressesApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'networking.v4.config.ListLearnedMacAddressesApiResponse'
    ...
    def data(self):
        ...
        :type:
                :class:`~ntnx_networking_py_client.models.networking.v4.config.LearnedMacAddress` | 
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListLearnedMacAddressesApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListLearnedMacAddressesApiResponse):
            return False
