...
class Capability(object):
    ...
    def capability_name(self, capability_name):
        ...
        if capability_name is not None and len(capability_name) > 128:
            raise ValueError("Invalid value for `capability_name`, length must be less than or equal to `128`")  # noqa: E501
