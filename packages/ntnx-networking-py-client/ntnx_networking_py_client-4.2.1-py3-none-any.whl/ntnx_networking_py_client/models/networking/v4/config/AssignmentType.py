...
class AssignmentType(object):
    ...
    Allowed enum values:
        ...
        - _UNKNOWN
        - _REDACTED
        - DYNAMIC: Virtual IP is dynamically assigned by the system.
        - STATIC: Virtual IP is statically assigned by the user.
    """
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    DYNAMIC = "DYNAMIC"
    ...
    def _initialize_object_type(self):
        return 'networking.v4.config.AssignmentType'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(AssignmentType, dict):
