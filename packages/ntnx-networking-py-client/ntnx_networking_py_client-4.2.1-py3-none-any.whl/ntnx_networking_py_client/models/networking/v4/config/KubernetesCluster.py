...
from ntnx_networking_py_client.models.networking.v4.config.GatewayNodesSelector import GatewayNodesSelector  # noqa: F401,E501

class KubernetesCluster(object):

    """Kubernetes cluster associated with the VPC.

    :param ext_id: (:attr:`ext_id`) ExtID of the Kubernetes cluster.
    :type ext_id: required
    
    
    :param gateway_nodes_selector: (:attr:`gateway_nodes_selector`) 
    :type gateway_nodes_selector: 
    ...
    swagger_types = {
        'ext_id': 'str',
        'gateway_nodes_selector': 'networking.v4.config.GatewayNodesSelector',
    ...
    attribute_map = {
        'ext_id': 'extId',
        'gateway_nodes_selector': 'gatewayNodesSelector',
        '_reserved': '$reserved',
    ...
    def __init__(self, ext_id=None, gateway_nodes_selector=None, *args, **kwargs):  # noqa: E501
        self.__ext_id = None
        self.__gateway_nodes_selector = None
        self.discriminator = None
        self.__ext_id = ext_id
        if gateway_nodes_selector is not None:
            self.__gateway_nodes_selector = gateway_nodes_selector
        # populate hidden vars if not empty
        self._populate_hidden_vars(kwargs)

    def _initialize_object_type(self):
        return 'networking.v4.config.KubernetesCluster'
    ...
    def ext_id(self):
        """
        ExtID of the Kubernetes cluster.
    ...
    @property
    def gateway_nodes_selector(self):
        """
        

        :type:
            :class:`~ntnx_networking_py_client.models.networking.v4.config.GatewayNodesSelector`
        """  # noqa: E501
        return self.__gateway_nodes_selector

    @gateway_nodes_selector.setter
    def gateway_nodes_selector(self, gateway_nodes_selector):
