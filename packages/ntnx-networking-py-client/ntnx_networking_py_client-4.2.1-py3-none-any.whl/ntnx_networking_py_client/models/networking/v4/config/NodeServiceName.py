...
class NodeServiceName(object):
    ...
    Allowed enum values:
        ...
        - _UNKNOWN
        - _REDACTED
        - CONTROL_PLANE_AGENT: Networking control plane agent running on AHV nodes.
    """
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    CONTROL_PLANE_AGENT = "CONTROL_PLANE_AGENT"
    ...
    def _initialize_object_type(self):
        return 'networking.v4.config.NodeServiceName'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(NodeServiceName, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NodeServiceName):
            return False
