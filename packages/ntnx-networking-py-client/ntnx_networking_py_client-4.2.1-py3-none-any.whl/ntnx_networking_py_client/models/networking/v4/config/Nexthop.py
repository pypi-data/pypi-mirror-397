...
class Nexthop(object):
    ...
    :param nexthop_reference: (:attr:`nexthop_reference`) Reference to a link, such as a VPN connection or subnet.
    ...
    :param nexthop_name: (:attr:`nexthop_name`) Name of the nexthop, where nexthop is either an IP address, a VPN connection, or a subnet.  
    :type nexthop_name: 
     max=128 chars
