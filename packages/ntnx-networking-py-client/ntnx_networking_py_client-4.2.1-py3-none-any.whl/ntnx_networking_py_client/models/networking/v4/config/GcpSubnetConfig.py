...
class GcpSubnetConfig(object):
    ...
    :param is_nat_enabled: (:attr:`is_nat_enabled`) True if NAT is enabled for the external subnet. (**Default** True)
    :type is_nat_enabled: required
    ...
    def __init__(self, cidr=None, is_nat_enabled=True, *args, **kwargs):  # noqa: E501
        self.__cidr = None
    ...
    def _initialize_object_type(self):
        return 'networking.v4.config.GcpSubnetConfig'
    ...
    def is_nat_enabled(self, is_nat_enabled):
        if is_nat_enabled is None:
            raise ValueError("Invalid value for `is_nat_enabled`, must not be `None`")  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GcpSubnetConfig, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GcpSubnetConfig):
            return False
