...
class TrafficForwardingMode(object):

    """Specifies how traffic is sent to the network function VM for processing, depending on the chosen insertion method.
    ...
    def _initialize_object_type(self):
        return 'networking.v4.config.TrafficForwardingMode'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(TrafficForwardingMode, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TrafficForwardingMode):
            return False
