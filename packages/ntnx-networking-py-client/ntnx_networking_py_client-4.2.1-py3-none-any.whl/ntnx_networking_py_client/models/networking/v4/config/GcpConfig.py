...
from ntnx_networking_py_client.models.networking.v4.config.GcpExternalSubnetConfig import GcpExternalSubnetConfig  # noqa: F401,E501

class GcpConfig(object):

    """GCP configuration

    :param external_subnet_config_list: (:attr:`external_subnet_config_list`) The GCP external subnet configuration list.
    ...
    """  # noqa: E501
    swagger_types = {
        'external_subnet_config_list': 'list[networking.v4.config.GcpExternalSubnetConfig]',
    ...
    def _initialize_object_type(self):
        return 'networking.v4.config.GcpConfig'
    ...
    def external_subnet_config_list(self):
        ...
        :type:
             list[ :class:`~ntnx_networking_py_client.models.networking.v4.config.GcpExternalSubnetConfig` ]
        """  # noqa: E501
