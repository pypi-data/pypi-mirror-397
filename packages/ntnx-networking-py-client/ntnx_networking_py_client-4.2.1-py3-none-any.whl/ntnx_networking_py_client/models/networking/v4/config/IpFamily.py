...
class IpFamily(object):
    ...
    Allowed enum values:
        ...
        - _UNKNOWN
        - _REDACTED
        - V4: Supports only IPv4 family.
        - V6: Supports only IPv6 family.
        - BOTH: Supports both IPv4 and IPv6 families.
    """
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    V4 = "V4"
    ...
    def _initialize_object_type(self):
        return 'networking.v4.config.IpFamily'
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IpFamily):
            return False
