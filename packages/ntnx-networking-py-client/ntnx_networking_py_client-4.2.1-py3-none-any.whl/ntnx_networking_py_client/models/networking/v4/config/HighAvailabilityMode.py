...
class HighAvailabilityMode(object):
    ...
    def _initialize_object_type(self):
        return 'networking.v4.config.HighAvailabilityMode'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(HighAvailabilityMode, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, HighAvailabilityMode):
            return False
