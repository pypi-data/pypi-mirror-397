...
class DataPlaneHealthCheckConfig(object):
    ...
    :type interval_secs: 
     ...
     min=1, max=65535
    :param timeout_secs: (:attr:`timeout_secs`) The time, in seconds, after which a health check times out. (**Default** 1)
    :type timeout_secs: 
    ...
    def __init__(self, interval_secs=5, timeout_secs=1, success_threshold=3, failure_threshold=3, *args, **kwargs):  # noqa: E501
    ...
    def _initialize_object_type(self):
        return 'networking.v4.config.DataPlaneHealthCheckConfig'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(DataPlaneHealthCheckConfig, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DataPlaneHealthCheckConfig):
            return False
