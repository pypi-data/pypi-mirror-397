...
class LoadBalancerSessionType(object):
    ...
    Allowed enum values:
        ...
        - _UNKNOWN
        - _REDACTED
        - NETWORK_LOAD_BALANCER: Network (layer-4) load balancer session.
    """
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    ...
    def _initialize_object_type(self):
        return 'networking.v4.config.LoadBalancerSessionType'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(LoadBalancerSessionType, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LoadBalancerSessionType):
            return False
