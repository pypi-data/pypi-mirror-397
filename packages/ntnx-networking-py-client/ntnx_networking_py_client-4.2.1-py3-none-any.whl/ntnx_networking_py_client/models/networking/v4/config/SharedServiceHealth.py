...
from ntnx_networking_py_client.models.networking.v4.config.SharedServiceName import SharedServiceName  # noqa: F401,E501

class SharedServiceHealth(object):

    """Health of the shared services like OVN, Hermes, Mysql and Policydb.

    :param service: (:attr:`service`) 
    :type service: 
    ...
    """  # noqa: E501
    swagger_types = {
        'service': 'networking.v4.config.SharedServiceName',
        'state': 'networking.v4.config.ControllerStatus',
    ...
    def __init__(self, service=None, state=None, *args, **kwargs):  # noqa: E501
        self.__service = None
        self.__state = None
    ...
    def _initialize_object_type(self):
        return 'networking.v4.config.SharedServiceHealth'
    ...
    def service(self):
        ...
        :type:
            :class:`~ntnx_networking_py_client.models.networking.v4.config.SharedServiceName`
        """  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(SharedServiceHealth, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SharedServiceHealth):
            return False
