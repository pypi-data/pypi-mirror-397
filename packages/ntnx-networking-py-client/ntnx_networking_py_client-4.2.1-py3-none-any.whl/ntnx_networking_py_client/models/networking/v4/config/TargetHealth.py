...
class TargetHealth(object):
    ...
    Allowed enum values:
        ...
        - _UNKNOWN
        - _REDACTED
        - HEALTHY: Load balancer target is healthy.
        - UNHEALTHY: Load balancer target is unhealthy.
    """
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    HEALTHY = "HEALTHY"
    ...
    def _initialize_object_type(self):
        return 'networking.v4.config.TargetHealth'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(TargetHealth, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TargetHealth):
            return False
