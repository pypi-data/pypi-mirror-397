...
class Cluster(object):
    ...
    :param vlan_identifier: (:attr:`vlan_identifier`) VLAN Identifier for this virtual switch cluster; set to 0 to remove VLAN tagging.
    :type vlan_identifier: 
    ...
    attribute_map = {
        ...
        'vlan_identifier': 'vlanIdentifier',
        '_reserved': '$reserved',
    ...
    def __init__(self, ext_id=None, hosts=None, gateway_ip_address=None, vlan_identifier=None, *args, **kwargs):  # noqa: E501
        self.__ext_id = None
        self.__hosts = None
        self.__gateway_ip_address = None
        self.__vlan_identifier = None
        self.discriminator = None
        self.__ext_id = ext_id
        self.__hosts = hosts
        if gateway_ip_address is not None:
            self.__gateway_ip_address = gateway_ip_address
        if vlan_identifier is not None:
            self.__vlan_identifier = vlan_identifier
    ...
    def vlan_identifier(self):
        ...
        :type:
                :class:`~int`
        """  # noqa: E501
        return self.__vlan_identifier

    @vlan_identifier.setter
    def vlan_identifier(self, vlan_identifier):
        if vlan_identifier is not None and vlan_identifier > 4095:  # noqa: E501
            raise ValueError("Invalid value for `vlan_identifier`, must be a value less than or equal to `4095`")  # noqa: E501
        if vlan_identifier is not None and vlan_identifier < 0:  # noqa: E501
            raise ValueError("Invalid value for `vlan_identifier`, must be a value greater than or equal to `0`")  # noqa: E501
