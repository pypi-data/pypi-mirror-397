...
from ntnx_networking_py_client.models.networking.v4.config.CategoryScope import CategoryScope  # noqa: F401,E501

class CategoryVnicSelector(object):

    """Specifies a category and its scope used to select virtual NIC(s) for the load balancer session. 

    :param scope: (:attr:`scope`) 
    :type scope: 
    
    
    :param ext_id: (:attr:`ext_id`) External ID of the category.
    :type ext_id: 
    ...
    """  # noqa: E501
    swagger_types = {
        'scope': 'networking.v4.config.CategoryScope',
        'ext_id': 'str',
    ...
    def __init__(self, scope=None, ext_id=None, *args, **kwargs):  # noqa: E501
        self.__scope = None
        self.__ext_id = None
    ...
    def _initialize_object_type(self):
        return 'networking.v4.config.CategoryVnicSelector'
    ...
    def scope(self):
        ...
        :type:
            :class:`~ntnx_networking_py_client.models.networking.v4.config.CategoryScope`
        """  # noqa: E501
        return self.__scope
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(CategoryVnicSelector, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CategoryVnicSelector):
            return False
