...
class LocalBgpService(object):
    ...
    :param is_bgp_add_path_enabled: (:attr:`is_bgp_add_path_enabled`) If the BGP additional paths capability is enabled on this local gateway. (**Default** False)
    :type is_bgp_add_path_enabled: 
    ...
    attribute_map = {
        ...
        'asn': 'asn',
        'is_bgp_add_path_enabled': 'isBgpAddPathEnabled',
        '_reserved': '$reserved',
    ...
    def __init__(self, vpc_reference=None, asn=None, is_bgp_add_path_enabled=False, *args, **kwargs):  # noqa: E501
        self.__vpc_reference = None
        self.__asn = None
        self.__is_bgp_add_path_enabled = None
        self.discriminator = None
        if vpc_reference is not None:
            self.__vpc_reference = vpc_reference
        self.__asn = asn
        if is_bgp_add_path_enabled is not None:
            self.__is_bgp_add_path_enabled = is_bgp_add_path_enabled
    ...
    @property
    def is_bgp_add_path_enabled(self):
        """
        ...
        :type:
                :class:`~bool`
        """  # noqa: E501
        return self.__is_bgp_add_path_enabled

    @is_bgp_add_path_enabled.setter
    def is_bgp_add_path_enabled(self, is_bgp_add_path_enabled):
