...
from ntnx_networking_py_client.models.networking.v4.config.BgpCommunity import BgpCommunity  # noqa: F401,E501
...
class BgpSession(NetworkingBaseModel):
    ...
    :param should_advertise_all_externally_routable_prefixes: (:attr:`should_advertise_all_externally_routable_prefixes`) Advertise all VPC externally-routable prefixes.
    :type should_advertise_all_externally_routable_prefixes: 
    
    
    :param externally_routable_prefixes_to_advertise: (:attr:`externally_routable_prefixes_to_advertise`) VPC externally-routable prefixes to advertise.
    :type externally_routable_prefixes_to_advertise: 
    
    
    :param prepended_autonomous_system_path: (:attr:`prepended_autonomous_system_path`) List of ASNs to prepend to the AS_path attribute of BGP updates for this session.
    :type prepended_autonomous_system_path: 
    
    
    :param advertised_routes_communities: (:attr:`advertised_routes_communities`) BGP community tags for advertised routes.
    :type advertised_routes_communities: 
    ...
    swagger_types = {
        ...
        'should_advertise_all_externally_routable_prefixes': 'bool',
        'externally_routable_prefixes_to_advertise': 'list[networking.v4.config.IPSubnet]',
        'prepended_autonomous_system_path': 'list[int]',
        'advertised_routes_communities': 'list[networking.v4.config.BgpCommunity]',
    ...
    attribute_map = {
        ...
        'should_advertise_all_externally_routable_prefixes': 'shouldAdvertiseAllExternallyRoutablePrefixes',
        'externally_routable_prefixes_to_advertise': 'externallyRoutablePrefixesToAdvertise',
        'prepended_autonomous_system_path': 'prependedAutonomousSystemPath',
        'advertised_routes_communities': 'advertisedRoutesCommunities',
        'metadata': 'metadata',
        'ext_id': 'extId',
        'links': 'links',
        'tenant_id': 'tenantId',
    ...
    def __init__(self, name=None, description=None, local_gateway_reference=None, remote_gateway_reference=None, local_gateway_interface_ip_address=None, dynamic_route_priority=None, password=None, status=None, local_gateway=None, remote_gateway=None, should_advertise_all_externally_routable_prefixes=None, externally_routable_prefixes_to_advertise=None, prepended_autonomous_system_path=None, advertised_routes_communities=None, metadata=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
        ...
        self.__should_advertise_all_externally_routable_prefixes = None
        self.__externally_routable_prefixes_to_advertise = None
        self.__prepended_autonomous_system_path = None
        self.__advertised_routes_communities = None
        ...
        if should_advertise_all_externally_routable_prefixes is not None:
            self.__should_advertise_all_externally_routable_prefixes = should_advertise_all_externally_routable_prefixes
        if externally_routable_prefixes_to_advertise is not None:
            self.__externally_routable_prefixes_to_advertise = externally_routable_prefixes_to_advertise
        if prepended_autonomous_system_path is not None:
            self.__prepended_autonomous_system_path = prepended_autonomous_system_path
        if advertised_routes_communities is not None:
            self.__advertised_routes_communities = advertised_routes_communities
    ...
    @property
    def should_advertise_all_externally_routable_prefixes(self):
        """
        ...
        :type:
                :class:`~bool`
        """  # noqa: E501
        return self.__should_advertise_all_externally_routable_prefixes

    @should_advertise_all_externally_routable_prefixes.setter
    def should_advertise_all_externally_routable_prefixes(self, should_advertise_all_externally_routable_prefixes):

        self.__should_advertise_all_externally_routable_prefixes = should_advertise_all_externally_routable_prefixes

    @property
    def externally_routable_prefixes_to_advertise(self):
        """
        ...
        """  # noqa: E501
        return self.__externally_routable_prefixes_to_advertise

    @externally_routable_prefixes_to_advertise.setter
    def externally_routable_prefixes_to_advertise(self, externally_routable_prefixes_to_advertise):

        self.__externally_routable_prefixes_to_advertise = externally_routable_prefixes_to_advertise

    @property
    def prepended_autonomous_system_path(self):
        """
        ...
        :type:
            list[ :class:`~int` ]
        """  # noqa: E501
        return self.__prepended_autonomous_system_path

    @prepended_autonomous_system_path.setter
    def prepended_autonomous_system_path(self, prepended_autonomous_system_path):

        self.__prepended_autonomous_system_path = prepended_autonomous_system_path

    @property
    def advertised_routes_communities(self):
        """
        BGP community tags for advertised routes.

        :type:
             list[ :class:`~ntnx_networking_py_client.models.networking.v4.config.BgpCommunity` ]
        """  # noqa: E501
        return self.__advertised_routes_communities

    @advertised_routes_communities.setter
    def advertised_routes_communities(self, advertised_routes_communities):
