...
class BgpRouteType(object):
    ...
    Allowed enum values:
        ...
        - _UNKNOWN
        - _REDACTED
        - ADVERTISED: BGP route is an advertised route.
        - RECEIVED: BGP route is a received route.
        - RECEIVED_AND_IGNORED: BGP route is received but has not been programmed in the route table.
    """
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    ADVERTISED = "ADVERTISED"
    RECEIVED = "RECEIVED"
    RECEIVED_AND_IGNORED = "RECEIVED_AND_IGNORED"
    ...
    def _initialize_object_type(self):
        return 'networking.v4.config.BgpRouteType'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(BgpRouteType, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BgpRouteType):
            return False
