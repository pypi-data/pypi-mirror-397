...
from ntnx_networking_py_client.models.networking.v4.config.KubernetesCluster import KubernetesCluster  # noqa: F401,E501
...
class Vpc(NetworkingBaseModel):
    ...
    :param kubernetes_clusters: (:attr:`kubernetes_clusters`) List of Kubernetes clusters associated with the VPC.
    ...
    swagger_types = {
        ...
        'kubernetes_clusters': 'list[networking.v4.config.KubernetesCluster]',
    ...
    def __init__(self, name=None, description=None, vpc_type=None, common_dhcp_options=None, snat_ips=None, external_subnets=None, external_routing_domain_reference=None, externally_routable_prefixes=None, kubernetes_clusters=None, metadata=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
        ...
        self.__kubernetes_clusters = None
        ...
        if kubernetes_clusters is not None:
            self.__kubernetes_clusters = kubernetes_clusters
    ...
    def kubernetes_clusters(self):
        ...
        :type:
             list[ :class:`~ntnx_networking_py_client.models.networking.v4.config.KubernetesCluster` ]
        """  # noqa: E501
        return self.__kubernetes_clusters

    @kubernetes_clusters.setter
    def kubernetes_clusters(self, kubernetes_clusters):
