...
class GetNicProfileApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'networking.v4.config.NicProfile': 'networking.v4.config.NicProfile',
    ...
    def _initialize_object_type(self):
        return 'OneOfnetworking.v4.config.GetNicProfileApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetNicProfileApiResponsedata.discriminator_value_class_map.values():
            return list(GetNicProfileApiResponsedata.discriminator_value_class_map.keys())[list(GetNicProfileApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetNicProfileApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetNicProfileApiResponsedata):
            return False
