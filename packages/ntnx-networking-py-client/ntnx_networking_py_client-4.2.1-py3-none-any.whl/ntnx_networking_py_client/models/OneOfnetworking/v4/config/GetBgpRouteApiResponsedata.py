...
class GetBgpRouteApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'networking.v4.config.BgpRoute': 'networking.v4.config.BgpRoute',
    ...
    def _initialize_object_type(self):
        return 'OneOfnetworking.v4.config.GetBgpRouteApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetBgpRouteApiResponsedata.discriminator_value_class_map.values():
            return list(GetBgpRouteApiResponsedata.discriminator_value_class_map.keys())[list(GetBgpRouteApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetBgpRouteApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetBgpRouteApiResponsedata):
            return False
