...
class ListLoadBalancerSessionsApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<networking.v4.config.LoadBalancerSession>': 'list[networking.v4.config.LoadBalancerSession]',
        'networking.v4.error.ErrorResponse': 'networking.v4.error.ErrorResponse',
        'List<networking.v4.config.LoadBalancerSessionProjection>': 'list[networking.v4.config.LoadBalancerSessionProjection]'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOfnetworking.v4.config.ListLoadBalancerSessionsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListLoadBalancerSessionsApiResponsedata.discriminator_value_class_map.values():
            return list(ListLoadBalancerSessionsApiResponsedata.discriminator_value_class_map.keys())[list(ListLoadBalancerSessionsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListLoadBalancerSessionsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListLoadBalancerSessionsApiResponsedata):
            return False
