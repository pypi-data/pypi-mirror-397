...
class ListNicProfilesApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<networking.v4.config.NicProfile>': 'list[networking.v4.config.NicProfile]',
        'networking.v4.error.ErrorResponse': 'networking.v4.error.ErrorResponse',
        'List<networking.v4.config.NicProfileProjection>': 'list[networking.v4.config.NicProfileProjection]'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOfnetworking.v4.config.ListNicProfilesApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListNicProfilesApiResponsedata.discriminator_value_class_map.values():
            return list(ListNicProfilesApiResponsedata.discriminator_value_class_map.keys())[list(ListNicProfilesApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListNicProfilesApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListNicProfilesApiResponsedata):
            return False
