...
class RemoteVpnConnectionApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'networking.v4.config.RemoteVpnConnection': 'networking.v4.config.RemoteVpnConnection',
    ...
    def _initialize_object_type(self):
        return 'OneOfnetworking.v4.config.RemoteVpnConnectionApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in RemoteVpnConnectionApiResponsedata.discriminator_value_class_map.values():
            return list(RemoteVpnConnectionApiResponsedata.discriminator_value_class_map.keys())[list(RemoteVpnConnectionApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(RemoteVpnConnectionApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RemoteVpnConnectionApiResponsedata):
            return False
