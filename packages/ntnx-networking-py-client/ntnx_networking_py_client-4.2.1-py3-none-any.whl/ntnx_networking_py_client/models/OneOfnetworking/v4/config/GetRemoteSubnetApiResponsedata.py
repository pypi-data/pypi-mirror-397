...
class GetRemoteSubnetApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'networking.v4.config.RemoteSubnet': 'networking.v4.config.RemoteSubnet',
    ...
    def _initialize_object_type(self):
        return 'OneOfnetworking.v4.config.GetRemoteSubnetApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetRemoteSubnetApiResponsedata.discriminator_value_class_map.values():
            return list(GetRemoteSubnetApiResponsedata.discriminator_value_class_map.keys())[list(GetRemoteSubnetApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetRemoteSubnetApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetRemoteSubnetApiResponsedata):
            return False
