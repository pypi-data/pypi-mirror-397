...
class RemoteVtepGatewayApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'networking.v4.config.RemoteVtepGateway': 'networking.v4.config.RemoteVtepGateway',
    ...
    def _initialize_object_type(self):
        return 'OneOfnetworking.v4.config.RemoteVtepGatewayApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in RemoteVtepGatewayApiResponsedata.discriminator_value_class_map.values():
            return list(RemoteVtepGatewayApiResponsedata.discriminator_value_class_map.keys())[list(RemoteVtepGatewayApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(RemoteVtepGatewayApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RemoteVtepGatewayApiResponsedata):
            return False
