...
class LoadBalancerSessionStatsApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'networking.v4.stats.LoadBalancerSessionStats': 'networking.v4.stats.LoadBalancerSessionStats',
    ...
    def _initialize_object_type(self):
        return 'OneOfnetworking.v4.stats.LoadBalancerSessionStatsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in LoadBalancerSessionStatsApiResponsedata.discriminator_value_class_map.values():
            return list(LoadBalancerSessionStatsApiResponsedata.discriminator_value_class_map.keys())[list(LoadBalancerSessionStatsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(LoadBalancerSessionStatsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LoadBalancerSessionStatsApiResponsedata):
            return False
