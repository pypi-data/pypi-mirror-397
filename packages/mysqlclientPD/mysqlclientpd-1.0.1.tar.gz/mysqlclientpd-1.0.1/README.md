...
This project is a fork of [mysqlclient]([https://github.com/farcepest/MySQLdb1](https://github.com/PyMySQL/mysqlclient)).
This project adds Python 3.14 support until parent project updates

* PyPI: https://pypi.org/project/mysqlclientPD/
* GitHub: [https://github.com/PyMySQL/mysqlclient](https://github.com/MysticEntity-dev/mysqlclient)
