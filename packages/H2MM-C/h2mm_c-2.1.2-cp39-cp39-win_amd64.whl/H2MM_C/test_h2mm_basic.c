...
int main(int argc, char **argv)
{
	...
	for (k = 0; k < argc - 2; k++)
	{
		...
		print_model(&models[k]);
		printf("Begin h2mm_optimize %d\n", argc -2); 
		h2mm_optimize(num_burst, len_bursts, times, detectors, &models[k], out_mod, limits, lim_func[0], minmaxlimit, &baseprint, NULL);
