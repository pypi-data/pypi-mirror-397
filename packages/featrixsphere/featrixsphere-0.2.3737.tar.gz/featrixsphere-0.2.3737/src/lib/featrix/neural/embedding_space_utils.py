...
def write_embedding_space_pickle(embedding_space, local_path: str, filename: str = "embedding_space.pickle", show_progress: bool = True):
    """
    ...
    Args:
        ...
        filename: Name of the pickle file (default: embedding_space.pickle)
