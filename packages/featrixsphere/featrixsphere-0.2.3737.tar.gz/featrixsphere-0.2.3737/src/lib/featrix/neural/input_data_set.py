...
class FeatrixInputDataSet:
    ...
    def _compute_null_distribution(self):
        ...
        logger.info(f"   Mean nulls/row: {mean_nulls:.2f}")
    ...
    def create_string_caches(self, sqlite_file):
        ...
        if string_columns:
            ...
            logger.info(f"📊 Pre-warming cache with {len(all_string_values)} total string values...")
            ...
            logger.info(f"✅ String cache pre-warmed successfully")
        else:
