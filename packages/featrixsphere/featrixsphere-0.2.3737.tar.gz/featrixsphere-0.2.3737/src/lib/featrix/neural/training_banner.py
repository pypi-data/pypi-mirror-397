...
def log_epoch_banner(epoch: int, total_epochs: int, training_type: str = "ES"):
    """
    ...
    # Build simple, useful banner
    lines = [
        "\n",
        "╔" + "═" * 78 + "╗",
        f"║ {pad_to_width(f'EPOCH {epoch} / {total_epochs} ({progress_pct:.0f}%)', 76, 'center')} ║",
        "╚" + "═" * 78 + "╝",
    ]
