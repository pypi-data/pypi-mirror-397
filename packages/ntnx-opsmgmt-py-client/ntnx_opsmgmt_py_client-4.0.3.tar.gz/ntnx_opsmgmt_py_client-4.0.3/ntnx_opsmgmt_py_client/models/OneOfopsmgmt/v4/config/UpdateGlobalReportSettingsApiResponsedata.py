...
class UpdateGlobalReportSettingsApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<opsmgmt.v4.error.AppMessage>': 'list[opsmgmt.v4.error.AppMessage]',
        'opsmgmt.v4.error.ErrorResponse': 'opsmgmt.v4.error.ErrorResponse'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOfopsmgmt.v4.config.UpdateGlobalReportSettingsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in UpdateGlobalReportSettingsApiResponsedata.discriminator_value_class_map.values():
            return list(UpdateGlobalReportSettingsApiResponsedata.discriminator_value_class_map.keys())[list(UpdateGlobalReportSettingsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(UpdateGlobalReportSettingsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateGlobalReportSettingsApiResponsedata):
            return False
