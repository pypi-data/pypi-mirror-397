...
class GetReportApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'opsmgmt.v4.config.Report': 'opsmgmt.v4.config.Report',
    ...
    def _initialize_object_type(self):
        return 'OneOfopsmgmt.v4.config.GetReportApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetReportApiResponsedata.discriminator_value_class_map.values():
            return list(GetReportApiResponsedata.discriminator_value_class_map.keys())[list(GetReportApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetReportApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetReportApiResponsedata):
            return False
