...
class ListReportsApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<opsmgmt.v4.config.Report>': 'list[opsmgmt.v4.config.Report]',
    ...
    def _initialize_object_type(self):
        return 'OneOfopsmgmt.v4.config.ListReportsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListReportsApiResponsedata.discriminator_value_class_map.values():
            return list(ListReportsApiResponsedata.discriminator_value_class_map.keys())[list(ListReportsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListReportsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListReportsApiResponsedata):
            return False
