...
class GetReportConfigApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'opsmgmt.v4.config.ReportConfig': 'opsmgmt.v4.config.ReportConfig',
    ...
    def _initialize_object_type(self):
        return 'OneOfopsmgmt.v4.config.GetReportConfigApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetReportConfigApiResponsedata.discriminator_value_class_map.values():
            return list(GetReportConfigApiResponsedata.discriminator_value_class_map.keys())[list(GetReportConfigApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetReportConfigApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetReportConfigApiResponsedata):
            return False
