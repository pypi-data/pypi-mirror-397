...
class UploadArtifactApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfopsmgmt.v4.content.UploadArtifactApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in UploadArtifactApiResponsedata.discriminator_value_class_map.values():
            return list(UploadArtifactApiResponsedata.discriminator_value_class_map.keys())[list(UploadArtifactApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(UploadArtifactApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UploadArtifactApiResponsedata):
            return False
