...
class UpdateReportConfigApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfopsmgmt.v4.config.UpdateReportConfigApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in UpdateReportConfigApiResponsedata.discriminator_value_class_map.values():
            return list(UpdateReportConfigApiResponsedata.discriminator_value_class_map.keys())[list(UpdateReportConfigApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(UpdateReportConfigApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateReportConfigApiResponsedata):
            return False
