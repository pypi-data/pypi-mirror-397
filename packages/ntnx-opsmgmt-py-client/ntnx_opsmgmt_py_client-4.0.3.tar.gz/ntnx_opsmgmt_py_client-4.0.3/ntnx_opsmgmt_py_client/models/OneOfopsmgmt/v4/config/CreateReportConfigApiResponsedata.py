...
class CreateReportConfigApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfopsmgmt.v4.config.CreateReportConfigApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in CreateReportConfigApiResponsedata.discriminator_value_class_map.values():
            return list(CreateReportConfigApiResponsedata.discriminator_value_class_map.keys())[list(CreateReportConfigApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(CreateReportConfigApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateReportConfigApiResponsedata):
            return False
