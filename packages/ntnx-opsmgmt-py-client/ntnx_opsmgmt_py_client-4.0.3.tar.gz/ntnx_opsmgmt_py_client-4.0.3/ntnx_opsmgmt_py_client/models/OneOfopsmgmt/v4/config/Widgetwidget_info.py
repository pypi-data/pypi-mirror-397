...
class Widgetwidget_info(object):
    ...
    discriminator_value_class_map = {
        ...
        'opsmgmt.v4.config.WidgetTemplate': 'opsmgmt.v4.config.WidgetTemplate',
        'opsmgmt.v4.config.WidgetConfig': 'opsmgmt.v4.config.WidgetConfig'
    }

    ONE_OF_ITEM_DISCRIMINATOR_NAME = '$widgetInfoItemDiscriminator'
    ...
    def _initialize_object_type(self):
        return 'OneOfopsmgmt.v4.config.Widgetwidget_info'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in Widgetwidget_info.discriminator_value_class_map.values():
            return list(Widgetwidget_info.discriminator_value_class_map.keys())[list(Widgetwidget_info.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(Widgetwidget_info, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, Widgetwidget_info):
            return False
