...
class ListReportArtifactsApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<opsmgmt.v4.content.ReportArtifact>': 'list[opsmgmt.v4.content.ReportArtifact]',
    ...
    def _initialize_object_type(self):
        return 'OneOfopsmgmt.v4.content.ListReportArtifactsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListReportArtifactsApiResponsedata.discriminator_value_class_map.values():
            return list(ListReportArtifactsApiResponsedata.discriminator_value_class_map.keys())[list(ListReportArtifactsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListReportArtifactsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListReportArtifactsApiResponsedata):
            return False
