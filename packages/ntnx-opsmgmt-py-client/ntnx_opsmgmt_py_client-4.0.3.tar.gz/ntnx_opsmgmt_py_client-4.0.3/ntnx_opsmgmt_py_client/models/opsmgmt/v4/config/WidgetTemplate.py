...
from ntnx_opsmgmt_py_client.models.opsmgmt.v4.config.WidgetTemplateType import WidgetTemplateType  # noqa: F401,E501

class WidgetTemplate(object):

    """Predefined widget.

    :param widget_template: (:attr:`widget_template`) 
    ...
    """  # noqa: E501
    swagger_types = {
        'widget_template': 'opsmgmt.v4.config.WidgetTemplateType',
    ...
    def __init__(self, widget_template=None, *args, **kwargs):  # noqa: E501
        self.__widget_template = None
    ...
    def _initialize_object_type(self):
        return 'opsmgmt.v4.config.WidgetTemplate'
    ...
    def widget_template(self):
        ...
        :type:
            :class:`~ntnx_opsmgmt_py_client.models.opsmgmt.v4.config.WidgetTemplateType`
        """  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(WidgetTemplate, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WidgetTemplate):
            return False
