...
from ntnx_opsmgmt_py_client.models.OneOfopsmgmt.v4.config.Widgetwidget_info import Widgetwidget_info  # noqa: F401,E501

class Widget(object):

    """Element that displays information in the report.

    :param widget_info: (:attr:`widget_info`) This describes the details of the widget.
    :type widget_info: required
    ...
    """  # noqa: E501
    swagger_types = {
        'widget_info': 'OneOfopsmgmt.v4.config.Widgetwidget_info',
    ...
    def __init__(self, widget_info=None, *args, **kwargs):  # noqa: E501
        self.__widget_info = None
        self.discriminator = None
        self.__widget_info = widget_info
        # populate hidden vars if not empty
        self._populate_hidden_vars(kwargs)

    def _initialize_object_type(self):
        return 'opsmgmt.v4.config.Widget'
    ...
    def widget_info(self):
        ...
        :type:
                :class:`~ntnx_opsmgmt_py_client.models.opsmgmt.v4.config.WidgetTemplate` | 
                :class:`~ntnx_opsmgmt_py_client.models.opsmgmt.v4.config.WidgetConfig`
        """  # noqa: E501
        return self.__widget_info

    @widget_info.setter
    def widget_info(self, widget_info):
        if widget_info is None:
            raise ValueError("Invalid value for `widget_info`, must not be `None`")  # noqa: E501
