...
class EntitySelection(object):
    ...
    :param entity_ext_id: (:attr:`entity_ext_id`) List of entity ExtId.
    :type entity_ext_id: required
    ...
    def __init__(self, entity_type=None, entity_ext_id=None, *args, **kwargs):  # noqa: E501
    ...
    def _initialize_object_type(self):
        return 'opsmgmt.v4.config.EntitySelection'
    ...
    def entity_ext_id(self, entity_ext_id):
        if entity_ext_id is None:
            raise ValueError("Invalid value for `entity_ext_id`, must not be `None`")  # noqa: E501
