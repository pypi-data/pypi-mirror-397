...
class ImportExportParams(object):

    """Contains report configuration(s) UUIDs of those imported or to be exported.

    :param report_config_ids: (:attr:`report_config_ids`) UUID(s) of the report configuration to export
    :type report_config_ids: required
    ...
    def __init__(self, report_config_ids=None, *args, **kwargs):  # noqa: E501
        self.__report_config_ids = None
        self.discriminator = None
        self.__report_config_ids = report_config_ids
        # populate hidden vars if not empty
        self._populate_hidden_vars(kwargs)

    def _initialize_object_type(self):
        return 'opsmgmt.v4.reporting.ImportExportParams'
    ...
    def report_config_ids(self):
        ...
        :type:
            list[ :class:`~str` ]
        """  # noqa: E501
        return self.__report_config_ids

    @report_config_ids.setter
    def report_config_ids(self, report_config_ids):
        if report_config_ids is None:
            raise ValueError("Invalid value for `report_config_ids`, must not be `None`")  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ImportExportParams, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ImportExportParams):
            return False
