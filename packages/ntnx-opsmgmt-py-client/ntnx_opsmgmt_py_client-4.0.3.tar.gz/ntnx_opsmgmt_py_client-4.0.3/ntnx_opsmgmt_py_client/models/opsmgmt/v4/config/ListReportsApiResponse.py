...
from ntnx_opsmgmt_py_client.models.OneOfopsmgmt.v4.config.ListReportsApiResponsedata import ListReportsApiResponsedata  # noqa: F401,E501
from ntnx_opsmgmt_py_client.models.common.v1.response.ApiResponseMetadata import ApiResponseMetadata  # noqa: F401,E501

class ListReportsApiResponse(object):
    ...
    swagger_types = {
        ...
        'data': 'OneOfopsmgmt.v4.config.ListReportsApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'opsmgmt.v4.config.ListReportsApiResponse'
    ...
    def data(self):
        ...
        :type:
                :class:`~ntnx_opsmgmt_py_client.models.opsmgmt.v4.config.Report` | 
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListReportsApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListReportsApiResponse):
            return False
