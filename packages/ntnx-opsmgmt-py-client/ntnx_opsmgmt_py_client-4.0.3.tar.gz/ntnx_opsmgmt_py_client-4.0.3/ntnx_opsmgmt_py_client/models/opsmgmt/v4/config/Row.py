...
from ntnx_opsmgmt_py_client.models.opsmgmt.v4.config.Widget import Widget  # noqa: F401,E501

class Row(object):

    """A row is a list of maximum 3 widgets.

    :param widgets: (:attr:`widgets`) List of widgets in a row.
    :type widgets: required
    ...
    """  # noqa: E501
    swagger_types = {
        'widgets': 'list[opsmgmt.v4.config.Widget]',
    ...
    def __init__(self, widgets=None, *args, **kwargs):  # noqa: E501
        self.__widgets = None
    ...
    def widgets(self):
        ...
        :type:
             list[ :class:`~ntnx_opsmgmt_py_client.models.opsmgmt.v4.config.Widget` ]
        """  # noqa: E501
