...
class FileWrapper(object):
    ...
    :param file: (:attr:`file`) The binary of the exported report configuration(s). Default value is report-{currTime}. For eg:- report-Jan23-062758
    :type file: required
    ...
    def _initialize_object_type(self):
        return 'opsmgmt.v4.reporting.FileWrapper'
