...
from ntnx_opsmgmt_py_client.models.OneOfopsmgmt.v4.config.CreateReportConfigApiResponsedata import CreateReportConfigApiResponsedata  # noqa: F401,E501
from ntnx_opsmgmt_py_client.models.common.v1.response.ApiResponseMetadata import ApiResponseMetadata  # noqa: F401,E501

class CreateReportConfigApiResponse(object):
    ...
    swagger_types = {
        ...
        'data': 'OneOfopsmgmt.v4.config.CreateReportConfigApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'opsmgmt.v4.config.CreateReportConfigApiResponse'
    ...
    def data(self):
        ...
        :type:
                :class:`~ntnx_opsmgmt_py_client.models.prism.v4.config.TaskReference` | 
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(CreateReportConfigApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateReportConfigApiResponse):
            return False
