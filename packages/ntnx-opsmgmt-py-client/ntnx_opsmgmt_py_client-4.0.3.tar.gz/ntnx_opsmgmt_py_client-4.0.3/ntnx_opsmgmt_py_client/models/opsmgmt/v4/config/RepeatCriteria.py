...
class RepeatCriteria(object):
    ...
    :param repetition_rule: (:attr:`repetition_rule`) Rule based on which the widget/section will be repeated.
    :type repetition_rule: 
     max=250 chars
    ...
    def __init__(self, entity_type=None, repetition_rule=None, *args, **kwargs):  # noqa: E501
        self.__entity_type = None
        self.__repetition_rule = None
        self.discriminator = None
        self.__entity_type = entity_type
        if repetition_rule is not None:
            self.__repetition_rule = repetition_rule
        # populate hidden vars if not empty
        self._populate_hidden_vars(kwargs)

    def _initialize_object_type(self):
        return 'opsmgmt.v4.config.RepeatCriteria'
    ...
    def repetition_rule(self):
        ...
        :type:
                :class:`~str`
        """  # noqa: E501
        return self.__repetition_rule

    @repetition_rule.setter
    def repetition_rule(self, repetition_rule):
        if repetition_rule is not None and len(repetition_rule) > 250:
            raise ValueError("Invalid value for `repetition_rule`, length must be less than or equal to `250`")  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(RepeatCriteria, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RepeatCriteria):
            return False
