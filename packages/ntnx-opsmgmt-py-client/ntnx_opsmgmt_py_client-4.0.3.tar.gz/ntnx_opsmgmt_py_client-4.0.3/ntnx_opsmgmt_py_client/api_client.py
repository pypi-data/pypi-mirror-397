...
from ntnx_opsmgmt_py_client import rest
...
class ApiClient(object):
    ...
    # Populated if multiple schemas exist with the same name
        'opsmgmt.v4.config.SortKey' : 'SortKey',
        'opsmgmt.v4.reporting.Operator' : 'Operator',
        'opsmgmt.v4.config.RepeatCriteria' : 'RepeatCriteria',
        'opsmgmt.v4.config.DataCriteria' : 'DataCriteria',
        'opsmgmt.v4.config.Widget' : 'Widget',
        'opsmgmt.v4.config.Section' : 'Section',
        'opsmgmt.v4.config.UpdateGlobalReportSettingsApiResponse' : 'UpdateGlobalReportSettingsApiResponse',
        'common.v1.config.Flag' : 'Flag',
        'opsmgmt.v4.config.WidgetField' : 'WidgetField',
        'OneOfopsmgmt.v4.content.CreateReportArtifactApiResponsedata' : 'CreateReportArtifactApiResponsedata',
        'opsmgmt.v4.config.ReportSchedule' : 'ReportSchedule',
        'opsmgmt.v4.config.AggregateFunction' : 'AggregateFunction',
        'opsmgmt.v4.config.UpdateReportConfigApiResponse' : 'UpdateReportConfigApiResponse',
        'opsmgmt.v4.error.SchemaValidationError' : 'SchemaValidationError',
        'opsmgmt.v4.config.NotifyReportApiResponse' : 'NotifyReportApiResponse',
        'opsmgmt.v4.content.CreateReportArtifactApiResponse' : 'CreateReportArtifactApiResponse',
        'prism.v4.config.TaskReference' : 'TaskReference',
        'opsmgmt.v4.reporting.SortOrder' : 'ReportingSortOrder',
        'OneOfopsmgmt.v4.config.CreateReportApiResponsedata' : 'CreateReportApiResponsedata',
        'opsmgmt.v4.config.WidgetSize' : 'WidgetSize',
        'opsmgmt.v4.reporting.ReportCustomization' : 'ReportingReportCustomization',
        'opsmgmt.v4.config.WidgetTemplate' : 'WidgetTemplate',
        'OneOfopsmgmt.v4.config.ListReportsApiResponsedata' : 'ListReportsApiResponsedata',
        'opsmgmt.v4.reporting.CustomView' : 'CustomView',
        'OneOfopsmgmt.v4.error.ErrorResponseerror' : 'ErrorResponseerror',
        'opsmgmt.v4.error.AppMessage' : 'AppMessage',
        'opsmgmt.v4.config.GetReportConfigApiResponse' : 'GetReportConfigApiResponse',
        'opsmgmt.v4.reporting.ReportFormat' : 'ReportingReportFormat',
        'opsmgmt.v4.error.ErrorResponse' : 'ErrorResponse',
        'opsmgmt.v4.reporting.PredefinedView' : 'PredefinedView',
        'opsmgmt.v4.reporting.FileWrapper' : 'FileWrapper',
        'OneOfopsmgmt.v4.content.UploadArtifactApiResponsedata' : 'UploadArtifactApiResponsedata',
        'opsmgmt.v4.config.CreateReportApiResponse' : 'CreateReportApiResponse',
        'opsmgmt.v4.content.DownloadReportApiResponse' : 'DownloadReportApiResponse',
        'opsmgmt.v4.config.Report' : 'Report',
        'OneOfopsmgmt.v4.config.CreateReportConfigApiResponsedata' : 'CreateReportConfigApiResponsedata',
        'opsmgmt.v4.reporting.ViewFormat' : 'ViewFormat',
        'opsmgmt.v4.config.NotificationPolicy' : 'ConfigNotificationPolicy',
        'common.v1.config.MapOfStringWrapper' : 'MapOfStringWrapper',
        'opsmgmt.v4.config.GetGlobalReportSettingApiResponse' : 'GetGlobalReportSettingApiResponse',
        'opsmgmt.v4.content.DownloadArtifactileApiResponse' : 'DownloadArtifactileApiResponse',
        'opsmgmt.v4.reporting.NotificationPolicy' : 'ReportingNotificationPolicy',
        'OneOfopsmgmt.v4.content.DownloadReportApiResponsedata' : 'DownloadReportApiResponsedata',
        'common.v1.response.ApiResponseMetadata' : 'ApiResponseMetadata',
        'opsmgmt.v4.config.ListReportConfigsApiResponse' : 'ListReportConfigsApiResponse',
        'opsmgmt.v4.config.WidgetTemplateType' : 'WidgetTemplateType',
        'OneOfopsmgmt.v4.config.NotifyReportApiResponsedata' : 'NotifyReportApiResponsedata',
        'opsmgmt.v4.config.ReportCustomization' : 'ConfigReportCustomization',
        'opsmgmt.v4.content.ArtifactType' : 'ArtifactType',
        'opsmgmt.v4.config.SortOrder' : 'ConfigSortOrder',
        'OneOfopsmgmt.v4.config.DeleteReportApiResponsedata' : 'DeleteReportApiResponsedata',
        'common.v1.response.ExternalizableAbstractModel' : 'ExternalizableAbstractModel',
        'opsmgmt.v4.reporting.ViewReport' : 'ViewReport',
        'OneOfopsmgmt.v4.config.GetReportApiResponsedata' : 'GetReportApiResponsedata',
        'common.v1.config.Message' : 'Message',
        'OneOfopsmgmt.v4.config.GetGlobalReportSettingApiResponsedata' : 'GetGlobalReportSettingApiResponsedata',
        'OneOfopsmgmt.v4.config.ListReportConfigsApiResponsedata' : 'ListReportConfigsApiResponsedata',
        'OneOfcommon.v1.config.KVPairvalue' : 'KVPairvalue',
        'opsmgmt.v4.config.GetReportApiResponse' : 'GetReportApiResponse',
        'opsmgmt.v4.config.ReportConfig' : 'ReportConfig',
        'opsmgmt.v4.reporting.ImportExportParams' : 'ImportExportParams',
        'opsmgmt.v4.config.ScheduleInterval' : 'ScheduleInterval',
        'opsmgmt.v4.error.SchemaValidationErrorMessage' : 'SchemaValidationErrorMessage',
        'OneOfopsmgmt.v4.config.UpdateReportConfigApiResponsedata' : 'UpdateReportConfigApiResponsedata',
        'opsmgmt.v4.config.TimeFilter' : 'TimeFilter',
        'common.v1.config.MessageSeverity' : 'MessageSeverity',
        'opsmgmt.v4.config.DeleteReportConfigApiResponse' : 'DeleteReportConfigApiResponse',
        'OneOfopsmgmt.v4.content.DownloadArtifactileApiResponsedata' : 'DownloadArtifactileApiResponsedata',
        'common.v1.response.ApiLink' : 'ApiLink',
        'opsmgmt.v4.reporting.Field' : 'Field',
        'opsmgmt.v4.config.WidgetConfig' : 'WidgetConfig',
        'opsmgmt.v4.config.ReportNotificationSpec' : 'ReportNotificationSpec',
        'opsmgmt.v4.config.Recipient' : 'ConfigRecipient',
        'opsmgmt.v4.config.CreateReportConfigApiResponse' : 'CreateReportConfigApiResponse',
        'OneOfopsmgmt.v4.content.ListReportArtifactsApiResponsedata' : 'ListReportArtifactsApiResponsedata',
        'OneOfopsmgmt.v4.config.DeleteReportConfigApiResponsedata' : 'DeleteReportConfigApiResponsedata',
        'OneOfopsmgmt.v4.config.Widgetwidget_info' : 'Widgetwidget_info',
        'opsmgmt.v4.config.Row' : 'Row',
        'opsmgmt.v4.content.ListReportArtifactsApiResponse' : 'ListReportArtifactsApiResponse',
        'opsmgmt.v4.reporting.Recipient' : 'ReportingRecipient',
        'opsmgmt.v4.reporting.PredefinedType' : 'PredefinedType',
        'OneOfopsmgmt.v4.reporting.Viewtype' : 'Viewtype',
        'opsmgmt.v4.reporting.View' : 'View',
        'OneOfopsmgmt.v4.config.GetReportConfigApiResponsedata' : 'GetReportConfigApiResponsedata',
        'OneOfopsmgmt.v4.config.UpdateGlobalReportSettingsApiResponsedata' : 'UpdateGlobalReportSettingsApiResponsedata',
        'opsmgmt.v4.config.EntitySelection' : 'EntitySelection',
        'opsmgmt.v4.content.ReportArtifact' : 'ReportArtifact',
        'opsmgmt.v4.content.UploadArtifactApiResponse' : 'UploadArtifactApiResponse',
        'opsmgmt.v4.config.WidgetType' : 'WidgetType',
        'common.v1.config.TenantAwareModel' : 'TenantAwareModel',
        'opsmgmt.v4.content.ArtifactFileType' : 'ArtifactFileType',
        'opsmgmt.v4.config.EntityType' : 'EntityType',
        'opsmgmt.v4.config.DeleteReportApiResponse' : 'DeleteReportApiResponse',
        'opsmgmt.v4.config.GlobalReportSetting' : 'GlobalReportSetting',
        'opsmgmt.v4.config.ListReportsApiResponse' : 'ListReportsApiResponse',
        'opsmgmt.v4.config.ReportFormat' : 'ConfigReportFormat',
        'opsmgmt.v4.config.RetentionConfig' : 'RetentionConfig',
    ...
    def negotiate_version(self, auth_settings):
        ...
        """
        try:
            response = self.__call_api('/api/opsmgmt/unversioned/info', 'OPTIONS',
            ...
            if response is not None and "data" in response:
                ...
                self.negotiated_version = None
                self.configuration.negotiation_completed = False
        except ntnx_opsmgmt_py_client.rest.ApiException as e:
    ...
    def __call_api(
        ...
        if response_data.status == 401:
            ...
            if response_data.status == 401:
                raise ntnx_opsmgmt_py_client.rest.ApiException(http_resp=response_data)
    ...
    def __deserialize_response(self, response, response_type):
        ...
        :type response: :class:`~ntnx_opsmgmt_py_client.rest.RESTResponse`, required
    ...
    def _call_api(self, resource_path, method,
        ...
        :param _request_timeout: Timeout setting for this request. It needs to be a pair (list) of
            ...
            the timeouts will be derived from the :class:`~ntnx_opsmgmt_py_client.configuration.Configuration`.
    ...
    def __deserialize_file(self, response):
        ...
        :param response: :class:`~ntnx_opsmgmt_py_client.rest.RESTResponse`
        :return: File path
        """
    ...
    def __deserialize_date(self, string):
        ...
        :param string:
        :type string: str
        :raises :class:`~ntnx_opsmgmt_py_client.rest.ApiException` if provided string is not a valid date
        :return: date object
        """
    ...
    def __deserialize_datatime(self, string):
        ...
        :raises :class:`~ntnx_opsmgmt_py_client.rest.ApiException` if provided string is not a valid datetime
    ...
    def __getattr(self, name):
        if name in self.DUPLICATE_SCHEMA_MAPPING:
            return getattr(ntnx_opsmgmt_py_client.models, self.DUPLICATE_SCHEMA_MAPPING[name])
        if hasattr(ntnx_opsmgmt_py_client.models, name.split('.')[-1]):
            return getattr(ntnx_opsmgmt_py_client.models, name.split('.')[-1])
        else:
            return getattr(ntnx_opsmgmt_py_client.models, name)
