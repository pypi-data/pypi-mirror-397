...
class Viewtype(object):
    ...
    discriminator_value_class_map = {
        ...
        'opsmgmt.v4.reporting.CustomView': 'opsmgmt.v4.reporting.CustomView',
        'opsmgmt.v4.reporting.PredefinedView': 'opsmgmt.v4.reporting.PredefinedView'
    }

    ONE_OF_ITEM_DISCRIMINATOR_NAME = '$typeItemDiscriminator'
    ...
    def _initialize_object_type(self):
        return 'OneOfopsmgmt.v4.reporting.Viewtype'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in Viewtype.discriminator_value_class_map.values():
            return list(Viewtype.discriminator_value_class_map.keys())[list(Viewtype.discriminator_value_class_map.values()).index(disc)]
        return None
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, Viewtype):
            return False
