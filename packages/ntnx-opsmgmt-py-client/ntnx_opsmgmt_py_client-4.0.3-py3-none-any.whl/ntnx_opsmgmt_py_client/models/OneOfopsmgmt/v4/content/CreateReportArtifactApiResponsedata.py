...
class CreateReportArtifactApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'opsmgmt.v4.content.ReportArtifact': 'opsmgmt.v4.content.ReportArtifact',
    ...
    def _initialize_object_type(self):
        return 'OneOfopsmgmt.v4.content.CreateReportArtifactApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in CreateReportArtifactApiResponsedata.discriminator_value_class_map.values():
            return list(CreateReportArtifactApiResponsedata.discriminator_value_class_map.keys())[list(CreateReportArtifactApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(CreateReportArtifactApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateReportArtifactApiResponsedata):
            return False
