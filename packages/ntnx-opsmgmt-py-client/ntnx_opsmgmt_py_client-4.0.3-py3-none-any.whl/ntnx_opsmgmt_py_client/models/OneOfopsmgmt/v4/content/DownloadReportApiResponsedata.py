...
class DownloadReportApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfopsmgmt.v4.content.DownloadReportApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in DownloadReportApiResponsedata.discriminator_value_class_map.values():
            return list(DownloadReportApiResponsedata.discriminator_value_class_map.keys())[list(DownloadReportApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(DownloadReportApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DownloadReportApiResponsedata):
            return False
