...
class DownloadArtifactileApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfopsmgmt.v4.content.DownloadArtifactileApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in DownloadArtifactileApiResponsedata.discriminator_value_class_map.values():
            return list(DownloadArtifactileApiResponsedata.discriminator_value_class_map.keys())[list(DownloadArtifactileApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(DownloadArtifactileApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DownloadArtifactileApiResponsedata):
            return False
