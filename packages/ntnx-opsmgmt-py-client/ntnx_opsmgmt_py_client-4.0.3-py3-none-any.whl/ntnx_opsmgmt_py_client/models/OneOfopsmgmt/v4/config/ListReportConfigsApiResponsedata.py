...
class ListReportConfigsApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<opsmgmt.v4.config.ReportConfig>': 'list[opsmgmt.v4.config.ReportConfig]',
    ...
    def _initialize_object_type(self):
        return 'OneOfopsmgmt.v4.config.ListReportConfigsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListReportConfigsApiResponsedata.discriminator_value_class_map.values():
            return list(ListReportConfigsApiResponsedata.discriminator_value_class_map.keys())[list(ListReportConfigsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListReportConfigsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListReportConfigsApiResponsedata):
            return False
