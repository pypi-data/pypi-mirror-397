...
class CreateReportApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfopsmgmt.v4.config.CreateReportApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in CreateReportApiResponsedata.discriminator_value_class_map.values():
            return list(CreateReportApiResponsedata.discriminator_value_class_map.keys())[list(CreateReportApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(CreateReportApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateReportApiResponsedata):
            return False
