...
class GetGlobalReportSettingApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'opsmgmt.v4.config.GlobalReportSetting': 'opsmgmt.v4.config.GlobalReportSetting',
    ...
    def _initialize_object_type(self):
        return 'OneOfopsmgmt.v4.config.GetGlobalReportSettingApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetGlobalReportSettingApiResponsedata.discriminator_value_class_map.values():
            return list(GetGlobalReportSettingApiResponsedata.discriminator_value_class_map.keys())[list(GetGlobalReportSettingApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetGlobalReportSettingApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetGlobalReportSettingApiResponsedata):
            return False
