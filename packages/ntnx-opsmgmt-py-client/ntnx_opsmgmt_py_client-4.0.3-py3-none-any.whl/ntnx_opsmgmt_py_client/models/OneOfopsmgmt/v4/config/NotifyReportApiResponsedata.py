...
class NotifyReportApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfopsmgmt.v4.config.NotifyReportApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in NotifyReportApiResponsedata.discriminator_value_class_map.values():
            return list(NotifyReportApiResponsedata.discriminator_value_class_map.keys())[list(NotifyReportApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(NotifyReportApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NotifyReportApiResponsedata):
            return False
