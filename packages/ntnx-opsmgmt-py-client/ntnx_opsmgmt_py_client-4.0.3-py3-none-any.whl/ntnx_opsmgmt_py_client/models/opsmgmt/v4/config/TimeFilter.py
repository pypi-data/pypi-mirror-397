...
class TimeFilter(object):
    ...
    Allowed enum values:
        ...
        - _UNKNOWN
        - _REDACTED
        - CREATED_TIME: Created time filter type to select entity data.
        - LAST_OCCURRED_TIME: Last occurred time filter type to select entity data.
    """
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    CREATED_TIME = "CREATED_TIME"
    LAST_OCCURRED_TIME = "LAST_OCCURRED_TIME"
    ...
    def _initialize_object_type(self):
        return 'opsmgmt.v4.config.TimeFilter'
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TimeFilter):
            return False
