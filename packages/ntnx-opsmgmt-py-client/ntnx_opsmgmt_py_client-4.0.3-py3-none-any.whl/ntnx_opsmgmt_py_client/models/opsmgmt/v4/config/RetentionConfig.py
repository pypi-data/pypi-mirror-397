...
class RetentionConfig(object):
    ...
    :param retention_period_seconds: (:attr:`retention_period_seconds`) Retention period in seconds for the generated reports.
    :type retention_period_seconds: 
    
    
    :param retention_count: (:attr:`retention_count`) Number of reports to be retained.
    ...
    def __init__(self, retention_period_seconds=None, retention_count=None, *args, **kwargs):  # noqa: E501
        self.__retention_period_seconds = None
        self.__retention_count = None
        self.discriminator = None
        if retention_period_seconds is not None:
            self.__retention_period_seconds = retention_period_seconds
        if retention_count is not None:
            self.__retention_count = retention_count
        # populate hidden vars if not empty
        self._populate_hidden_vars(kwargs)

    def _initialize_object_type(self):
        return 'opsmgmt.v4.config.RetentionConfig'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(RetentionConfig, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RetentionConfig):
            return False
