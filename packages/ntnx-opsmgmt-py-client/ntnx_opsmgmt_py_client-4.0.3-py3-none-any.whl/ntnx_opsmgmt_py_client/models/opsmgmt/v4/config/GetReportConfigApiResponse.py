...
from ntnx_opsmgmt_py_client.models.OneOfopsmgmt.v4.config.GetReportConfigApiResponsedata import GetReportConfigApiResponsedata  # noqa: F401,E501
from ntnx_opsmgmt_py_client.models.common.v1.response.ApiResponseMetadata import ApiResponseMetadata  # noqa: F401,E501

class GetReportConfigApiResponse(object):
    ...
    swagger_types = {
        ...
        'data': 'OneOfopsmgmt.v4.config.GetReportConfigApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'opsmgmt.v4.config.GetReportConfigApiResponse'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetReportConfigApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetReportConfigApiResponse):
            return False
