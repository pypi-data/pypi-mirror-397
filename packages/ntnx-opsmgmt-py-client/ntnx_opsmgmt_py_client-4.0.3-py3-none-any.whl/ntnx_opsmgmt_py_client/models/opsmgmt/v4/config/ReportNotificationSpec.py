...
class ReportNotificationSpec(ExternalizableAbstractModel):

    """

    :param recipient_formats: (:attr:`recipient_formats`) List specifying the formats in which the report is to be sent.
    :type recipient_formats: required
    
    
    :param recipients: (:attr:`recipients`) Recipients to notify with the report.
    ...
    def __init__(self, recipient_formats=None, recipients=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
    ...
    def _initialize_object_type(self):
        return 'opsmgmt.v4.config.ReportNotificationSpec'
    ...
    def recipient_formats(self, recipient_formats):
        if recipient_formats is None:
            raise ValueError("Invalid value for `recipient_formats`, must not be `None`")  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ReportNotificationSpec, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ReportNotificationSpec):
            return False
