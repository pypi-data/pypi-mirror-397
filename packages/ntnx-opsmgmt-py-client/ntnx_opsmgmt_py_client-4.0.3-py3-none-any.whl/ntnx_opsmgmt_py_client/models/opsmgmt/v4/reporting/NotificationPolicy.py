...
from ntnx_opsmgmt_py_client.models.opsmgmt.v4.reporting.Recipient import Recipient  # noqa: F401,E501

class NotificationPolicy(object):

    """Notification policy for sending the email of the generated report.

    :param recipients: (:attr:`recipients`) Email recipients list.
    :type recipients: required
    
    
    :param email_subject: (:attr:`email_subject`) Subject of the email to be sent for the report.
    :type email_subject: 
     max=100 chars
    
    :param email_body: (:attr:`email_body`) Content of the email body.
    :type email_body: 
     max=1000 chars
    ...
    """  # noqa: E501
    swagger_types = {
        'recipients': 'list[opsmgmt.v4.reporting.Recipient]',
        'email_subject': 'str',
        'email_body': 'str',
    ...
    def __init__(self, recipients=None, email_subject=None, email_body=None, *args, **kwargs):  # noqa: E501
    ...
    def _initialize_object_type(self):
        return 'opsmgmt.v4.reporting.NotificationPolicy'
    ...
    def recipients(self):
        ...
        :type:
             list[ :class:`~ntnx_opsmgmt_py_client.models.opsmgmt.v4.reporting.Recipient` ]
        """  # noqa: E501
    ...
    def email_subject(self, email_subject):
        if email_subject is not None and len(email_subject) > 100:
            raise ValueError("Invalid value for `email_subject`, length must be less than or equal to `100`")  # noqa: E501
    ...
    def email_body(self, email_body):
        if email_body is not None and len(email_body) > 1000:
            raise ValueError("Invalid value for `email_body`, length must be less than or equal to `1000`")  # noqa: E501
