...
class PredefinedType(object):
    ...
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    VM_EFFICIENCY = "VM_EFFICIENCY"
    STORAGE_OVER_PROVISIONING = "STORAGE_OVER-PROVISIONING"
    ...
    CLUSTER_QUICK_ACCESS = "CLUSTER_QUICK_ACCESS"
    CLUSTER_RUNWAY = "CLUSTER_RUNWAY"
    CLUSTER_STORAGE = "CLUSTER_STORAGE"
    CONTROLLER_IOPS = "CONTROLLER_IOPS"
    ...
    PLAYS = "PLAYS"
    REPORTS = "REPORTS"
    DATA_RECOVERY_STATUS = "DATA_RECOVERY_STATUS"
    IMPACTED_CLUSTER = "IMPACTED_CLUSTER"
    ...
    def _initialize_object_type(self):
        return 'opsmgmt.v4.reporting.PredefinedType'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(PredefinedType, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PredefinedType):
            return False
