...
class Recipient(object):
    ...
    :param email_address: (:attr:`email_address`) Email address of the recipient.
    :type email_address: required
    
    
    :param recipient_name: (:attr:`recipient_name`) Name of the recipient.
    :type recipient_name: 
     max=64 chars
    ...
    def __init__(self, email_address=None, recipient_name=None, *args, **kwargs):  # noqa: E501
    ...
    def _initialize_object_type(self):
        return 'opsmgmt.v4.reporting.Recipient'
    ...
    def recipient_name(self, recipient_name):
        if recipient_name is not None and len(recipient_name) > 64:
            raise ValueError("Invalid value for `recipient_name`, length must be less than or equal to `64`")  # noqa: E501
