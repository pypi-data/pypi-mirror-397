...
from ntnx_opsmgmt_py_client.models.opsmgmt.v4.reporting.Operator import Operator  # noqa: F401,E501
...
class Field(object):
    ...
    :param aggregation_operator: (:attr:`aggregation_operator`) 
    ...
    swagger_types = {
        'label': 'str',
        'name': 'str',
        'aggregation_operator': 'opsmgmt.v4.reporting.Operator',
    ...
    def __init__(self, label=None, name=None, aggregation_operator=None, *args, **kwargs):  # noqa: E501
        self.__label = None
        self.__name = None
        self.__aggregation_operator = None
        self.discriminator = None
        if label is not None:
            self.__label = label
        self.__name = name
        if aggregation_operator is not None:
            self.__aggregation_operator = aggregation_operator
        # populate hidden vars if not empty
        self._populate_hidden_vars(kwargs)

    def _initialize_object_type(self):
        return 'opsmgmt.v4.reporting.Field'
    ...
    def aggregation_operator(self):
        ...
        :type:
            :class:`~ntnx_opsmgmt_py_client.models.opsmgmt.v4.reporting.Operator`
        """  # noqa: E501
        return self.__aggregation_operator

    @aggregation_operator.setter
    def aggregation_operator(self, aggregation_operator):
