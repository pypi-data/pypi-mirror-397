...
```bash
pip install --trusted-host pypi.org --trusted-host files.pythonhosted.org vi
```
...
1. [**Quickstart Guide**](quickstart.md) - Get started with basic operations
2. [**Authentication**](authentication.md) - Set up your API credentials
3. [**Configuration**](configuration.md) - Configure logging and other settings
