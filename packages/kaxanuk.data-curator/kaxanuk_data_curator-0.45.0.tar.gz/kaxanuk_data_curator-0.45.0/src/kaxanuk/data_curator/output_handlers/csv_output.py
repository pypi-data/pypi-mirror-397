...
class CsvOutput(OutputHandlerInterface):
    """
    Generates Csv output of the processed columns data.
    ...
    def output_data(
        ...
        *,
        ...
        data_features_output_file_path = f'{self.output_base_dir}/{main_identifier}.csv'
