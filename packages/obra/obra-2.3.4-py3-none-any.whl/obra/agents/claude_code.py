...
class ClaudeCodeAgent:
    ...
    def __init__(self, workspace_path: Optional[Path] = None) -> None:
        ...
        self.workspace_path: Optional[Path] = workspace_path
    ...
    def initialize(self, config: Dict[str, Any]) -> None:
        ...
        self.cli_command = config.get("cli_command") or config.get("command", "claude")
    ...
    def send_prompt(self, prompt: str, context: Optional[Dict] = None) -> str:
        ...
        full_prompt = self.headless_instruction + prompt
