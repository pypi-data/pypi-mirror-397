...
class TestingAgent(BaseAgent):
    ...
    def analyze(
        ...
        tested_functions = self._build_test_index(test_files, deadline)
                ...
                if func_name in tested_functions:
                    ...
                    issues.append(
                        AgentIssue(
                            ...
                            dimension="test_coverage",
                            suggestion=f"Add test__{func_name}() to test file",
                        )
                    )
        ...
        for test_file in test_files:
            ...
            issues.extend(self._check_test_quality(test_file, content, issue_index))
    ...
    def _build_test_index(
        ...
        """Build index of tested function names.
    ...
    def _check_test_quality(
        ...
        for func_name in test_funcs:
            # Find function body (simplified check)
            ...
            if func_match:
                ...
                if "assert" not in body and "pytest.raises" not in body:
                    ...
                    issues.append(
                        AgentIssue(
                            id=self._generate_issue_id("TEST", issue_index),
                            title=f"Test without assertions: {func_name}",
