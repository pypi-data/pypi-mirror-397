...
class ConfigNode:
    ...
    depends_on: Optional[str] = None  # Path of setting this depends on
...
class ConfigTree:
    ...
    def get_node(self, path: str) -> Optional[ConfigNode]:
    ...
    def _find_in_tree(self, root: ConfigNode, path: str) -> Optional[ConfigNode]:
