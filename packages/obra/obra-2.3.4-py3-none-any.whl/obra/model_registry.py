...
MODEL_REGISTRY: dict[str, ProviderConfig] = {
    ...
    "openai": ProviderConfig(
        ...
        cli="codex",
        flag="--model",
        default_model="gpt-5.1-codex-max",  # Current default for Codex CLI
        oauth_supported=True,
        ...
        models={
            "gpt-5.1-codex-max": ModelInfo(
                ...
                note="Recommended for complex tasks",
            ...
            "gpt-5.1-codex-mini": ModelInfo(
                ...
                status=ModelStatus.TESTED,
                description="Cost-effective, less capable",
                context_window=400_000,
            ),
            "gpt-5.2": ModelInfo(
                id="gpt-5.2",
                ...
                status=ModelStatus.TESTED,
                description="Latest general agentic model",
                context_window=400_000,
            ),
            "gpt-5.1": ModelInfo(
                id="gpt-5.1",
