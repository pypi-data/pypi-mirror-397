...
class OutputParser:
    ...
    def _parse_hybrid(
        ...
        if metadata_match:
            try:
                ...
                errors.append(f"Metadata JSON parse error: {str(e)}")
        else:
    ...
    def _extract_completion_signal(self, response: str) -> Optional[CompletionSignal]:
    ...
    def _infer_signal(self, response: str) -> Optional[CompletionSignal]:
