...
class TestCredentialConfiguration:
    ...
    @patch('learning_credentials.models.get_learning_context_name', return_value='Test Course Name')
    def test_generate_credential_for_user(self, mock_get_learning_context_name: Mock, mock_send_email: Mock):
    ...
    def test_generate_credential_for_user_update_existing(
        self, mock_get_learning_context_name: Mock, mock_send_email: Mock
    ):
    ...
    @patch('learning_credentials.models.get_learning_context_name', return_value='Test Course Name')
    def test_generate_credential_for_user_with_exception(self, mock_get_learning_context_name: Mock, mock_module: Mock):
