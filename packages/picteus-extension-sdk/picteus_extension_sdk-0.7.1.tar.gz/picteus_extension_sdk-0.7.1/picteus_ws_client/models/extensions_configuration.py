...
class ExtensionsConfiguration(BaseModel):
    ...
    """ # noqa: E501
    capabilities: List[ConfigurationCapability] = Field(description="The capabilities")
    commands: List[ConfigurationExtensionCommand] = Field(description="The commands")
    __properties: ClassVar[List[str]] = ["capabilities", "commands"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "capabilities": [ConfigurationCapability.from_dict(_item) for _item in obj["capabilities"]] if obj.get("capabilities") is not None else None,
            "commands": [ConfigurationExtensionCommand.from_dict(_item) for _item in obj["commands"]] if obj.get("commands") is not None else None
        })
        return _obj
