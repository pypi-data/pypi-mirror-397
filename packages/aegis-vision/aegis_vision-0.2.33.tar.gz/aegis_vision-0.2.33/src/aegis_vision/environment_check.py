        ...
        try:
            ...
            if not has_rocm_support:
                ...
                return EnvironmentIssue(
                    ...
                    fix_description='Install hardware-optimized PyTorch for ROCm 7.0 (AMD Instinct)',
                    alternative_solution=(
                        'Use the official AMD ROCm Docker image:\n'
                        '  docker run -it --device=/dev/kfd --device=/dev/dri rocm/pytorch:rocm7.0-pytorch2.5-py3.11'
                    )
                )
