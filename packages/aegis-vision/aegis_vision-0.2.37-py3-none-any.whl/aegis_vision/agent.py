            ...
            try:
                ...
                try:
                    ...
                    if result_rocm.returncode == 0:
                        ...
                        result["package_spec"] = "torch torchvision torchaudio --index-url https://download.pytorch.org/whl/rocm7.0"
                        result["install_cmd"] = f"{sys.executable} -m pip install torch torchvision torchaudio --index-url https://download.pytorch.org/whl/rocm7.0"
                        result["device"] = "cuda"
                        result["reason"] = "AMD GPU with ROCm 7.0"
                    else:
                        raise FileNotFoundError
                except (FileNotFoundError, subprocess.TimeoutExpired):
