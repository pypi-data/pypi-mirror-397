...
class EnvironmentChecker:
    ...
    @staticmethod
    def _get_pytorch_reinstall_command(system_cuda_version: Optional[str], pytorch_cuda_version: Optional[str]) -> str:
        """
        Generate PyTorch reinstall command based on system CUDA version.
        
        Args:
            system_cuda_version: System CUDA version from nvcc/nvidia-smi
            pytorch_cuda_version: CUDA version PyTorch was compiled with
