        ...
        """
            {
              "content" : [ {
                ...
                "id" : 10275298,
                "time" : "2025-11-07T16:01:11.423Z",
                "message" : "Starting new HTTPS connection (1): codemie-preview.lab.epam.com:443",
                "level" : "DEBUG",
                "itemId" : 269329
              }, {
                "id" : 10275299,
                "time" : "2025-11-07T16:01:11.622Z",
                "message" : "https://codemie-preview.lab.epam.com:443 \"GET /code-assistant-api/v1/llm_models HTTP/1.1\" 200 11211",
                "level" : "DEBUG",
                "itemId" : 269329
              }, {
                "id" : 10275300,
                "time" : "2025-11-07T16:01:11.628Z",
                "message" : "Received response with status 200",
                "level" : "DEBUG",
                "itemId" : 269329
              }, {
                "id" : 10275301,
                "time" : "2025-11-07T16:01:11.629Z",
                "message" : "Response datasource_type: <class 'list'>",
                "level" : "DEBUG",
                "itemId" : 269329
              }, {
                "id" : 10275302,
                "time" : "2025-11-07T16:01:11.633Z",
                "message" : "Successfully processed /v1/llm_models request to typing.List[codemie_sdk.models.llm.LLMModel]",
                "level" : "INFO",
                "itemId" : 269329
              }, {
                "id" : 10275303,
                "time" : "2025-11-07T16:01:11.641Z",
                "message" : "Making /v1/workflows request to https://codemie-preview.lab.epam.com/code-assistant-api<class 'dict'>",
                "level" : "DEBUG",
                "itemId" : 269329
              }, {
                "id" : 10275304,
                "time" : "2025-11-07T16:01:11.642Z",
                "message" : "Request body: {'project': 'codemie', 'name': 'ptm_qjerifaelgqyhjf', 'description': 'Similarity expert', 'yaml_config': 'tools: []\\nassistants:\\n- id: similarity_analysis\\n  model: gpt-4o-2024-08-06\\n  system_prompt: \"\\\\n            You are a similarity analyzer. Your task is to compare\\\\\\n    \\\\ two texts and rank their semantic similarity.\\\\n            You will receive\\\\\\n    \\\\ two texts from user input: text1 and text2.\\\\n            Your output should\\\\\\n    \\\\ be a JSON object with a single key \\\\\"similarity_rank\\\\\" and an integer value\\\\\\n    \\\\ from 0 to 100.\\\\n            A similarity rank of 0 indicates entirely different\\\\\\n    \\\\ meanings and facts,\\\\n            A similarity rank of 100 means they are entirely\\\\\\n    \\\\ the same.\\\\n            IMPORTANT! Output format MUST be an integer number from\\\\\\n    \\\\ 0 to 100.\\\\n            Do not describe any your thoughts!\\\\n        \"\\nstates:\\n- id: similarity_analysis\\n  assistant_id: similarity_analysis\\n  task: \"\\\\n            Compare two texts from user input: text1 and text2 and rank\\\\\\n    \\\\ their semantic similarity from 0 to 100.\\\\n            A similarity rank of 0\\\\\\n    \\\\ indicates entirely different meanings and facts,\\\\n            A similarity rank\\\\\\n    \\\\ of 100 means they are entirely the same.\\\\n            IMPORTANT! Output format\\\\\\n    \\\\ MUST be an integer number from 0 to 100.\\\\n            Do not describe any your\\\\\\n    \\\\ thoughts!\\\\n        \"\\n  next:\\n    state_id: end\\n  output_schema: \"\\\\n              ```json\\\\n              {\\\\n                \\\\\"similarity_rank\\\\\"\\\\\\n    : \\\\\"...\\\\\"\\\\n              }\\\\n            \"\\n', 'mode': <WorkflowMode.SEQUENTIAL: 'Sequential'>, 'shared': False, 'icon_url': None}",
                "level" : "DEBUG",
                "itemId" : 269329
              }, {
                "id" : 10275305,
                "time" : "2025-11-07T16:01:11.644Z",
                "message" : "Starting new HTTPS connection (1): codemie-preview.lab.epam.com:443",
                "level" : "DEBUG",
                "itemId" : 269329
              }, {
                "id" : 10275306,
                "time" : "2025-11-07T16:01:12.755Z",
                "message" : "https://codemie-preview.lab.epam.com:443 \"POST /code-assistant-api/v1/workflows HTTP/1.1\" 200 4560",
                "level" : "DEBUG",
                "itemId" : 269329
              }, {
                "id" : 10275307,
                "time" : "2025-11-07T16:01:12.783Z",
                "message" : "Received response with status 200",
                "level" : "DEBUG",
                "itemId" : 269329
              }, {
                ...
                "id" : 10275309,
                "time" : "2025-11-07T16:01:12.786Z",
                "message" : "Successfully processed /v1/workflows request to <class 'dict'>",
                "level" : "INFO",
                "itemId" : 269329
              }, {
                "id" : 10275310,
                "time" : "2025-11-07T16:01:12.786Z",
                "message" : "Making /v1/workflows request to https://codemie-preview.lab.epam.com/code-assistant-apityping.List[codemie_sdk.models.workflow.Workflow]",
                "level" : "DEBUG",
                "itemId" : 269329
              }, {
                "id" : 10275311,
                "time" : "2025-11-07T16:01:12.786Z",
                "message" : "Request params: {'page': 0, 'per_page': 50}",
                "level" : "DEBUG",
                "itemId" : 269329
              }, {
                "id" : 10275312,
                "time" : "2025-11-07T16:01:12.788Z",
                "message" : "Starting new HTTPS connection (1): codemie-preview.lab.epam.com:443",
                "level" : "DEBUG",
                "itemId" : 269329
              }, {
                "id" : 10275313,
                "time" : "2025-11-07T16:01:13.377Z",
                "message" : "https://codemie-preview.lab.epam.com:443 \"GET /code-assistant-api/v1/workflows?page=0&per_page=50 HTTP/1.1\" 200 185617",
                "level" : "DEBUG",
                "itemId" : 269329
              }, {
                "id" : 10275314,
                "time" : "2025-11-07T16:01:13.397Z",
                "message" : "Received response with status 200",
                "level" : "DEBUG",
                "itemId" : 269329
              } ],
