...
def test_assistant_with_different_models_with_file_attached(
    ...
    prompt = (
        f"Run {file_test_data[2][2]} tool with the following input:"
        f"{{'query': 'Extract the raw text content from the {file_test_data[2][0]} file.'}}"
    )
