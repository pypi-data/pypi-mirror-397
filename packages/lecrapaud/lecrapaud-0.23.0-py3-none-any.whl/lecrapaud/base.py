        ...
        **kwargs,
        ...
        if (
            ...
            try:
                ...
                # CatBoost plot_tree retourne une image
                tree_plot = actual_model.plot_tree(tree_index=tree_index, pool=pool)
                ...
                # Convertir en image pour matplotlib
                img = PILImage.open(io.BytesIO(tree_plot))
                plt.imshow(img)
                plt.axis("off")
