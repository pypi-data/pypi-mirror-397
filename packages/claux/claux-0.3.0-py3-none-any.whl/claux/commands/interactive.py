...
def quick_install_claux(context):
    """Quick action: Install Claux in current project."""
...
def quick_change_profile(context):
    """Quick action: Change agent profile."""
    agent_profiles_menu()


def quick_switch_mcp(context):
    """Quick action: Switch MCP configuration."""
    mcp_menu()


def quick_update_claux(context):
    """Quick action: Update Claux files."""
...
def show_setup_wizard(context):
    ...
    console.print(f"[bold yellow]{Icons.WARNING}  {t('cli.interactive.setup_title')}[/bold yellow]\n")
    ...
    if not context.is_git:
        ...
        console.print(f"[dim]{t('cli.interactive.setup_no_claux')}[/dim]")
    ...
    if action == "exit":
        ...
        if success:
            console.print()
            console.print(f"[bold green]{t('cli.interactive.setup_install_success')}[/bold green]\n")
