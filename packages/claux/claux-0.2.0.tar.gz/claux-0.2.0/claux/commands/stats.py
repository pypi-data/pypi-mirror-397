...
def show_stats(
    ...
    try:
        ...
        summary_text = Text()
        summary_text.append(f"Total Operations: ", style="bold cyan")
        summary_text.append(f"{summary['total_operations']}\n")

        summary_text.append(f"Total JSON Tokens: ", style="bold yellow")
        summary_text.append(f"{summary['total_json_tokens']:,}\n")

        summary_text.append(f"Total TOON Tokens: ", style="bold green")
        summary_text.append(f"{summary['total_toon_tokens']:,}\n")

        summary_text.append(f"Total Savings: ", style="bold magenta")
