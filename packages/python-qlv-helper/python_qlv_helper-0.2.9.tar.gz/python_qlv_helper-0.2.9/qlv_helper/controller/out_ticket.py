...
from qlv_helper.config.custom_exception import FirstPhaseException, SecondPhaseException, ThirdPhaseException
...
async def order_out_ticket(
    ...
    try:
        ...
        raise FirstPhaseException(str(e))
    try:
        ...
        raise SecondPhaseException(str(e))
    ...
    try:
        ...
        raise ThirdPhaseException(str(e))
