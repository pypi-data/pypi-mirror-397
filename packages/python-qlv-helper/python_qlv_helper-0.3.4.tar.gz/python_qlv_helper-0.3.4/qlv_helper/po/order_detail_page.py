...
class OrderDetailPage(BasePo):
    ...
    async def get_order_lock_state_btn(self, timeout: float = 5.0) -> Tuple[str, Locator]:
        ...
        """
        selector: str = '//div[@class="order_information "]//a[(@class="view_detail_red" and contains(text(), "强制解锁")) or (@class="view_detail_green" and (contains(text(), "锁定") or contains(text(), "解锁返回")))]'
