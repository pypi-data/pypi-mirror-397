...
from clusterondemand.exceptions import ValidationException
...
class VersionedProductKey:
    def __init__(self, versioned_product_key: str) -> None:
        ...
        try:
            ...
            self.validation_error = f"Productkey {versioned_product_key} does not contain a valid BCM version."
            return
