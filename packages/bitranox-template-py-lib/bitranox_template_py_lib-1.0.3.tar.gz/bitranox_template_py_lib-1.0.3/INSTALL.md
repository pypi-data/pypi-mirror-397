...
This guide collects every supported method to install `bitranox_template_py_lib`, including
...
```bash
# run from PyPI
uvx bitranox_template_py_lib
# run from GitHub
uvx --from git+https://github.com/bitranox/bitranox_template_py_lib.git bitranox_template_py_lib
...
# optional install from GitHub
pip install --user "git+https://github.com/bitranox/bitranox_template_py_lib"
...
pipx install "git+https://github.com/bitranox/bitranox_template_py_lib"
# optional install from local
pipx install .
...
pip install dist/bitranox_template_py_lib-*.tar.gz   # sdist
```
...
```bash
# Poetry
poetry add bitranox_template_py_lib     # as dependency
poetry install                          # for local dev

# PDM
pdm add bitranox_template_py_lib
pdm install
```
...
```bash
pip install "git+https://github.com/bitranox/bitranox_template_py_lib#egg=bitranox_template_py_lib"
```
...
All methods register both the `bitranox_template_py_lib` and
