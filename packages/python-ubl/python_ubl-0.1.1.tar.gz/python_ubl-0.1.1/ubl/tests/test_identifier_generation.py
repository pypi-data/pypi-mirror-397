...
class TestIdentifierGeneration(unittest.TestCase):
    ...
    def test_p4x_belgium_vat_only(self):
        ...
        identifiers = generate_all_with_precedence(
            country_code="BE", vat=BE_VAT_1, registration=None, peppol_participant_ids=[],
        )
    ...
    def test_levit_with_peppol_precedence(self):
        ...
        identifiers = generate_all_with_precedence(
            ...
            peppol_participant_ids=[f"9925:{BE_VAT_2.lower()}", f"0208:{BE_REG_2}"],
        )
    ...
    def test_deduplication(self):
        ...
        identifiers = generate_all_with_precedence(
            ...
            vat=BE_VAT_1,
            registration=None,
            peppol_participant_ids=[f"9925:{BE_VAT_1.lower()}"],  # Duplicate iso6523 format
        )
    ...
    def test_only_peppol_ids(self):
        ...
        identifiers = generate_all_with_precedence(
            ...
            vat=None,
            registration=None,
            peppol_participant_ids=[f"9925:{BE_VAT_1.lower()}", f"0208:{BE_REG_2}"],
        )
    ...
    def test_invalid_peppol_format_ignored(self):
        ...
        identifiers = generate_all_with_precedence(
            country_code="BE", vat=BE_VAT_1, registration=None, peppol_participant_ids=["invalid_format"],
        )
    ...
    def test_multiple_registration_schemes(self):
        ...
        identifiers = generate_all_with_precedence(
            country_code="BE", vat=None, registration=BE_REG_2, peppol_participant_ids=[],
        )
    ...
    def test_germany_vat(self):
        ...
        identifiers = generate_all_with_precedence(
            country_code="DE", vat=DE_VAT, registration=None, peppol_participant_ids=[],
        )
    ...
    def test_france_vat_and_sirene(self):
        """French VAT + SIRENE."""
        identifiers = generate_all_with_precedence(
            country_code="FR", vat=FR_VAT, registration=FR_SIRENE, peppol_participant_ids=[],
        )
    ...
    def test_case_insensitive_scheme_lookup(self):
        ...
        identifiers = generate_all_with_precedence(
            country_code="BE", vat=BE_VAT_1.lower(), registration=None, peppol_participant_ids=[f"9925:{BE_VAT_1}"],
        )
