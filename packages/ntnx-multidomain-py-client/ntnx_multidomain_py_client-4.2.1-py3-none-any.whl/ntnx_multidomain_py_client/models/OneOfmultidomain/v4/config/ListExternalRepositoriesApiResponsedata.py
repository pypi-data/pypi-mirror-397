...
class ListExternalRepositoriesApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<multidomain.v4.config.ExternalRepository>': 'list[multidomain.v4.config.ExternalRepository]',
        'multidomain.v4.error.ErrorResponse': 'multidomain.v4.error.ErrorResponse'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOfmultidomain.v4.config.ListExternalRepositoriesApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListExternalRepositoriesApiResponsedata.discriminator_value_class_map.values():
            return list(ListExternalRepositoriesApiResponsedata.discriminator_value_class_map.keys())[list(ListExternalRepositoriesApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListExternalRepositoriesApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListExternalRepositoriesApiResponsedata):
            return False
