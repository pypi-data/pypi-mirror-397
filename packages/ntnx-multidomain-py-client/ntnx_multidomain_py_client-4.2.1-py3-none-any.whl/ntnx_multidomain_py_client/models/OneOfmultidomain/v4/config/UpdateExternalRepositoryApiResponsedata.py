...
class UpdateExternalRepositoryApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfmultidomain.v4.config.UpdateExternalRepositoryApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in UpdateExternalRepositoryApiResponsedata.discriminator_value_class_map.values():
            return list(UpdateExternalRepositoryApiResponsedata.discriminator_value_class_map.keys())[list(UpdateExternalRepositoryApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(UpdateExternalRepositoryApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateExternalRepositoryApiResponsedata):
            return False
