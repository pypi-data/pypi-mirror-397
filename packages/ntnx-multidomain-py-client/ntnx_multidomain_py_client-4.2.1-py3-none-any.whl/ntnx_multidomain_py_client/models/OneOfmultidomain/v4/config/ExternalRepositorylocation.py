...
class ExternalRepositorylocation(object):
    ...
    discriminator_value_class_map = {
        ...
        'multidomain.v4.config.NfsRepository': 'multidomain.v4.config.NfsRepository'
    }

    ONE_OF_ITEM_DISCRIMINATOR_NAME = '$locationItemDiscriminator'
    ...
    def _initialize_object_type(self):
        return 'OneOfmultidomain.v4.config.ExternalRepositorylocation'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ExternalRepositorylocation.discriminator_value_class_map.values():
            return list(ExternalRepositorylocation.discriminator_value_class_map.keys())[list(ExternalRepositorylocation.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ExternalRepositorylocation, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ExternalRepositorylocation):
            return False
