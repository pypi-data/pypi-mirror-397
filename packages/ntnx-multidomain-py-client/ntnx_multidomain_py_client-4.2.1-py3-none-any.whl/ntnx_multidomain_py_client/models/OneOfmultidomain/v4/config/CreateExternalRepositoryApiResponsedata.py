...
class CreateExternalRepositoryApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfmultidomain.v4.config.CreateExternalRepositoryApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in CreateExternalRepositoryApiResponsedata.discriminator_value_class_map.values():
            return list(CreateExternalRepositoryApiResponsedata.discriminator_value_class_map.keys())[list(CreateExternalRepositoryApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(CreateExternalRepositoryApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateExternalRepositoryApiResponsedata):
            return False
