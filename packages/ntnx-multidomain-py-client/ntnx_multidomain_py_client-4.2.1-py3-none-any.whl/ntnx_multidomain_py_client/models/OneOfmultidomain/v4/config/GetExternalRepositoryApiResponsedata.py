...
class GetExternalRepositoryApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'multidomain.v4.config.ExternalRepository': 'multidomain.v4.config.ExternalRepository',
    ...
    def _initialize_object_type(self):
        return 'OneOfmultidomain.v4.config.GetExternalRepositoryApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetExternalRepositoryApiResponsedata.discriminator_value_class_map.values():
            return list(GetExternalRepositoryApiResponsedata.discriminator_value_class_map.keys())[list(GetExternalRepositoryApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetExternalRepositoryApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetExternalRepositoryApiResponsedata):
            return False
