...
class ErrorResponseerror(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<multidomain.v4.error.AppMessage>': 'list[multidomain.v4.error.AppMessage]',
        'multidomain.v4.error.SchemaValidationError': 'multidomain.v4.error.SchemaValidationError'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOfmultidomain.v4.error.ErrorResponseerror'
