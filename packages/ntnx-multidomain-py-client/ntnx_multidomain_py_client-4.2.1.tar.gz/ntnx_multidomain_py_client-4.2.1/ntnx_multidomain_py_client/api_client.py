...
from ntnx_multidomain_py_client import rest
...
class ApiClient(object):
    ...
    # Populated if multiple schemas exist with the same name
        'multidomain.v4.config.ListExternalRepositoriesApiResponse' : 'ListExternalRepositoriesApiResponse',
        'OneOfmultidomain.v4.config.UpdateExternalRepositoryApiResponsedata' : 'UpdateExternalRepositoryApiResponsedata',
        'multidomain.v4.config.CreateExternalRepositoryApiResponse' : 'CreateExternalRepositoryApiResponse',
        'OneOfmultidomain.v4.config.ListExternalRepositoriesApiResponsedata' : 'ListExternalRepositoriesApiResponsedata',
        ...
        'OneOfmultidomain.v4.config.DeleteExternalRepositoryApiResponsedata' : 'DeleteExternalRepositoryApiResponsedata',
        'multidomain.v4.config.UpdateExternalRepositoryApiResponse' : 'UpdateExternalRepositoryApiResponse',
        'multidomain.v4.error.SchemaValidationError' : 'SchemaValidationError',
        'multidomain.v4.error.SchemaValidationErrorMessage' : 'SchemaValidationErrorMessage',
        'common.v1.config.Flag' : 'Flag',
        'multidomain.v4.config.ExternalRepository' : 'ExternalRepository',
        'OneOfmultidomain.v4.error.ErrorResponseerror' : 'ErrorResponseerror',
        'OneOfmultidomain.v4.config.CreateExternalRepositoryApiResponsedata' : 'CreateExternalRepositoryApiResponsedata',
        'common.v1.config.MapOfStringWrapper' : 'MapOfStringWrapper',
        'common.v1.config.IPAddressOrFQDN' : 'IPAddressOrFQDN',
        'multidomain.v4.config.NfsRepository' : 'NfsRepository',
        'OneOfmultidomain.v4.config.GetExternalRepositoryApiResponsedata' : 'GetExternalRepositoryApiResponsedata',
        ...
        'multidomain.v4.config.GetExternalRepositoryApiResponse' : 'GetExternalRepositoryApiResponse',
        'multidomain.v4.error.ErrorResponse' : 'ErrorResponse',
        'common.v1.response.ApiLink' : 'ApiLink',
        'multidomain.v4.config.DeleteExternalRepositoryApiResponse' : 'DeleteExternalRepositoryApiResponse',
        'multidomain.v4.error.AppMessage' : 'AppMessage',
        'OneOfmultidomain.v4.config.ExternalRepositorylocation' : 'ExternalRepositorylocation',
        'multidomain.v4.config.NFSServerAddress' : 'NFSServerAddress',
    ...
    def negotiate_version(self, auth_settings):
        ...
        """
        try:
            response = self.__call_api('/api/multidomain/unversioned/info', 'OPTIONS',
            ...
            if response is not None and "data" in response:
                ...
                self.negotiated_version = None
                self.configuration.negotiation_completed = False
        except ntnx_multidomain_py_client.rest.ApiException as e:
    ...
    def __call_api(
        ...
        if response_data.status == 401:
            ...
            if response_data.status == 401:
                raise ntnx_multidomain_py_client.rest.ApiException(http_resp=response_data)
    ...
    def __deserialize_response(self, response, response_type):
        ...
        :type response: :class:`~ntnx_multidomain_py_client.rest.RESTResponse`, required
    ...
    def _call_api(self, resource_path, method,
        ...
        :param _request_timeout: Timeout setting for this request. It needs to be a pair (list) of
            ...
            the timeouts will be derived from the :class:`~ntnx_multidomain_py_client.configuration.Configuration`.
    ...
    def __deserialize_file(self, response):
        ...
        :param response: :class:`~ntnx_multidomain_py_client.rest.RESTResponse`
        :return: File path
        """
    ...
    def __deserialize_date(self, string):
        ...
        :param string:
        :type string: str
        :raises :class:`~ntnx_multidomain_py_client.rest.ApiException` if provided string is not a valid date
        :return: date object
        """
    ...
    def __deserialize_datatime(self, string):
        ...
        :raises :class:`~ntnx_multidomain_py_client.rest.ApiException` if provided string is not a valid datetime
    ...
    def __getattr(self, name):
        if name in self.DUPLICATE_SCHEMA_MAPPING:
            return getattr(ntnx_multidomain_py_client.models, self.DUPLICATE_SCHEMA_MAPPING[name])
        if hasattr(ntnx_multidomain_py_client.models, name.split('.')[-1]):
            return getattr(ntnx_multidomain_py_client.models, name.split('.')[-1])
        else:
            return getattr(ntnx_multidomain_py_client.models, name)
