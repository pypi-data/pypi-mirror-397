...
class Printer:
    ...
    def link(self, url: str, text: Optional[str] = None) -> str:
    ...
    def metric_logged(self, name: str, value: float, step: Optional[int] = None) -> None:
    ...
    def artifact_logged(self, path: str, remote_path: Optional[str] = None) -> None:
    ...
    def print_success(self, message: str, detail: Optional[str] = None) -> None:
    ...
    def print_failure(self, message: str, error: Optional[str] = None) -> None:
    ...
    def print_progress(self, message: str, current: Optional[int] = None, total: Optional[int] = None) -> None:
    ...
    def print_info(self, message: str, detail: Optional[str] = None) -> None:
