...
def update_mail_sent_status():
    ...
    if json_params:
        db_client = create_db_client(caller_info="update_mail_sent_status")
...
def update_mail_opened_status():
    ...
    if json_params:
        db_client = create_db_client(caller_info="update_mail_opened_status")
...
def update_mail_clicked_status():
    ...
    if json_params:
        db_client = create_db_client(caller_info="update_mail_clicked_status")
...
def update_mail_read_status():
    ...
    if json_params:
        db_client = create_db_client(caller_info="update_mail_read_status")
...
def update_mail_bounce_status():
    ...
    if json_params:
        db_client = create_db_client(caller_info="update_mail_bounce_status")
...
def update_mail_spam_status():
    ...
    if json_params:
        db_client = create_db_client(caller_info="update_mail_spam_status")
...
def update_mail_blocked_status():
    ...
    if json_params:
        db_client = create_db_client(caller_info="update_mail_blocked_status")
