"""Processor class for ultra-sound experiments with analogic or digital demodulation."""
...
from ._types import MetadataProcessor, tEchoProcessor
...
class EchoProcessor(tEchoProcessor, BaseProcessor):
    """Processor class for ultra-sound echoes experiments."""

    def __init__(self, *args, digital: bool | None = None, **kwargs):
        """
        Processor class for ultra-sound echoes experiments.
    ...
    def _reinit(self):
        ...
        # Force garbage collection to avoid accumulating old data in memory
        gc.collect()
    ...
    def load_metadata(self) -> Self:
        ...
        self.metadata = MetadataProcessor(self.metadata | metadata)
