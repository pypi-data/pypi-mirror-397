"""Data workers for the graphical user interface."""

from pathlib import Path

from PyQt6.QtCore import QObject, pyqtSignal, pyqtSlot

from ..processors import EchoProcessor
...
class DataWorker(QObject):
    ...
    def batch_process(
        self, expids: list, rolling_average: bool, save_csv: bool, to_cm: bool, find_f0: bool
    ):
    ...
    @pyqtSlot(str, bool)
    def export_as_csv(self, fname: str, to_cm: bool):
