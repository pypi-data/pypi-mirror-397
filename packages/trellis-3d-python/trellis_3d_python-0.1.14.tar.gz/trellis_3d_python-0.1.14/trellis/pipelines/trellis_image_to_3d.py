...
class TrellisImageTo3DPipeline(Pipeline):
    ...
    def from_pretrained(path: str) -> "TrellisImageTo3DPipeline":
        ...
        shape_pipeline = Tri3DDiTFlowMatchingPipeline.from_pretrained(path)
        ...
        conf.multiview_cfg_path = "trellis_v3/paint3d/cfgs/hunyuan-paint-pbr.yaml"
        conf.custom_pipeline = "trellis_v3/paint3d/tripaintpbr"
    ...
    def run(
        ...
        output_mesh_path = self.paint_pipeline(
