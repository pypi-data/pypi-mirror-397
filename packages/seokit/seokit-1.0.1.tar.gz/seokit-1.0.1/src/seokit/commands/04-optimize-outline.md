...
Specify the outline file to optimize. You can provide the path to `03-outline.md` or any other markdown outline file.

## Instructions

### Step 1: Load and Analyze Outline

Run the outline analyzer using the `seokit outline --file` command:

```bash
seokit outline --file "~/.claude/seokit/<keyword-slug>/03-outline.md"
```
...
Save optimized outline to: `~/.claude/seokit/<keyword-slug>/04-outline-optimized.md`
...
If user requests DOCX export, use the `seokit write --outline` command:

```bash
seokit write --outline "~/.claude/seokit/<keyword-slug>/04-outline-optimized.md" --output "~/.claude/seokit/<keyword-slug>/04-outline-optimized.docx"
```
...
1. Run `seokit write --outline "~/.claude/seokit/<keyword-slug>/04-outline-optimized.md"` to generate the full article.
