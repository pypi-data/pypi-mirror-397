...
Ensure you have:
1. Optimized outline at: `~/.claude/seokit/<keyword-slug>/04-outline-optimized.md`
...
### 4.1 Save Markdown
Save article to: `~/.claude/seokit/<keyword-slug>/05-article.md`

### 4.2 Generate DOCX

```bash
seokit write --outline "~/.claude/seokit/<keyword-slug>/05-article.md"
```
...
### Output Files
- **Markdown**: `~/.claude/seokit/<keyword-slug>/05-article.md`
- **DOCX**: `~/.claude/seokit/<keyword-slug>/05-article.docx`

### Checklist Compliance
- Content Quality: X/Y items checked
- SEO Elements: X/Y items checked
- E-E-A-T Signals: X/Y items checked
- Structure: X/Y items checked
