...
from perplexity_client import query_perplexity, format_output_with_citations
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python top-articles-finder.py <keyword>")
        print("Example: python top-articles-finder.py 'best running shoes'")
        sys.exit(1)
