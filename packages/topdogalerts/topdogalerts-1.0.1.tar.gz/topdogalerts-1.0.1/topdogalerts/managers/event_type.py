...
EventTypeRow = Tuple[
    ...
    Optional[Dict[str, Any]], # event_trigger_map (jsonb)
    Optional[Dict[str, Any]], # listener_trigger_map (jsonb)
    Optional[str],            # message_title
    Optional[str],            # message_description
]


def fetch_event_type(event_type_id: int) -> EventType:
    """
    ...
    return EventType(
        ...
        event_trigger_map=event_trigger_map,
...
def set_listener_health(event_type_id: int, is_healthy: bool) -> bool:
    """
