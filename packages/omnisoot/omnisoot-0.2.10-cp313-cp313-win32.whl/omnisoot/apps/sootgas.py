...
class SootGas(CSootGas):
    ...
    def __init__(self, cantera_gas, init_without_soot = False):
        super().__init__(cantera_gas, init_without_soot);
    ...
    @property
    def TP(self):
        return self.cantera_gas.T, self.cantera_gas.P;

    @TP.setter
    def TP(self, TP):
        self.cantera_gas.TP = TP[0], TP[1];
        self.update_thermo();
    ...
    @property
    def HPY(self):
        return self.cantera_gas.enthalpy_mass, self.cantera_gas.pressure, self.cantera_gas.Y;

    @HPY.setter
    def HPY(self, HPY):
        self.cantera_gas.HPY = HPY[0], HPY[1], HPY[2];
        self.update_thermo();
        self.update_transport();
