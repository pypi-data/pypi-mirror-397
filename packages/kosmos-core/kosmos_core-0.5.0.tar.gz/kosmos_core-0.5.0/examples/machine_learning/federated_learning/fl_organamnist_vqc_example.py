...
from kosmos.ml.datasets.organamnist_dataset import OrganAMNISTDataset
...
def fl_organamnist_vqc_example() -> None:
    """Run example of federated training and testing on the OrganAMNIST dataset using a VQC."""
    network = construct_network()

    # Dataset to train and test on
    dataset = OrganAMNISTDataset()
