...
class FinaticResponseListFDXBrokerOrderEvent(BaseModel):
    """
    ...
    success: SuccessPayloadListFDXBrokerOrderEvent = Field(description="Success payload containing data and optional meta")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FinaticResponseListFDXBrokerOrderEvent from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FinaticResponseListFDXBrokerOrderEvent from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "success": SuccessPayloadListFDXBrokerOrderEvent.from_dict(obj["success"]) if obj.get("success") is not None else None,
            "error": obj.get("error"),
