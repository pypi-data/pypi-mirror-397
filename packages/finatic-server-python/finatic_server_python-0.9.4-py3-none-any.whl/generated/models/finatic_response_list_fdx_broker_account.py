...
class FinaticResponseListFDXBrokerAccount(BaseModel):
    """
    ...
    success: SuccessPayloadListFDXBrokerAccount = Field(description="Success payload containing data and optional meta")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FinaticResponseListFDXBrokerAccount from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FinaticResponseListFDXBrokerAccount from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "success": SuccessPayloadListFDXBrokerAccount.from_dict(obj["success"]) if obj.get("success") is not None else None,
            "error": obj.get("error"),
