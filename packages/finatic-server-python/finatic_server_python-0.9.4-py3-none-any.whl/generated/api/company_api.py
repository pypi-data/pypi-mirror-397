...
from ..models.finatic_response_company_response import FinaticResponseCompanyResponse
...
class CompanyApi:
    ...
    async def get_company_api_v1_company_company_id_get(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "FinaticResponseCompanyResponse",
    ...
    async def get_company_api_v1_company_company_id_get_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[FinaticResponseCompanyResponse]:
        """Get Company
    ...
    @validate_call
    async def get_company_api_v1_company_company_id_get_0(
        self,
        company_id: Annotated[UUID, Field(description="Company ID")],
        _request_timeout: Union[
            None,
        ...
        _param = self._get_company_api_v1_company_company_id_get_0_serialize(
            company_id=company_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    async def get_company_api_v1_company_company_id_get_0_with_http_info(
        self,
        company_id: Annotated[UUID, Field(description="Company ID")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def get_company_api_v1_company_company_id_get_0_without_preload_content(
        self,
        company_id: Annotated[UUID, Field(description="Company ID")],
        _request_timeout: Union[
            None,
    ...
    def _get_company_api_v1_company_company_id_get_0_serialize(
        self,
        company_id,
        _request_auth,
        _content_type,
