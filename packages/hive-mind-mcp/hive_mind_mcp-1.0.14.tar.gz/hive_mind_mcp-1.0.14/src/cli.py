...
async def run_init(args):
    """Scaffold a new Hive Mind MCP project in the current directory."""
    print(f"🚀 Initializing Hive Mind in {os.getcwd()}...")
...
async def run_config(args):
    ...
    config_dir = os.path.expanduser("~/.hive_mind")
    ...
    if not os.path.exists(config_path):
        ...
        if os.path.exists(base_env):
            ...
            with open(config_path, "w") as f:
                f.write("# Hive Mind Configuration\n")
