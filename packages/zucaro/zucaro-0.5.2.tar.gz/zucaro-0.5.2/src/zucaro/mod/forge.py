...
from zucaro.library import Artifact
...
FORGE_WRAPPER = {
    ...
    "library": {
        ...
        "downloads": {
            "artifact": {
                "url": "https://storage.googleapis.com/zucaro-forgewrapper/PicoForgeWrapper-1.3.jar",
...
FORGE_WRAPPER_NEW = {
    ...
    "library": {
        ...
        "downloads": {
            "artifact": {
                "url": "https://storage.googleapis.com/zucaro-forgewrapper/PicoForgeWrapper-1.5.jar",
...
class ForgeInstallContext:
    ...
    version_dir: Path
    libraries_dir: Path
    version_name: str  # Name of the output zucaro profile
...
def install_113(ctx: ForgeInstallContext):
    ...
    if is_wrapper_new:
        ...
        vspec["arguments"]["jvm"] += [f"-Dzucaro.mainClass={original_main_class}"]
