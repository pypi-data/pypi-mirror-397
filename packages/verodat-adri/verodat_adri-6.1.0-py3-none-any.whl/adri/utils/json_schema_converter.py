...
class ADRIToJSONSchemaConverter:
    ...
    def convert(self, adri_spec: Dict[str, Any]) -> Dict[str, Any]:
        ...
        for field_name, field_spec in field_requirements.items():
            try:
                ...
                self.warnings.append(f"Failed to convert field '{field_name}': {str(e)}")
    ...
    def _convert_field(self, field_name: str, field_spec: Dict[str, Any]) -> Dict[str, Any]:
        ...
        property_schema = {
            "type": self.TYPE_MAPPING[adri_type]
        }
    ...
    def _convert_items_spec(self, items_spec: Dict[str, Any]) -> Dict[str, Any]:
        ...
        item_schema = {
            "type": self.TYPE_MAPPING[item_type]
        }
...
def convert_adri_to_json_schema(
    ...
    if warnings:
        logger.warning(f"ADRI to JSON Schema conversion produced {len(warnings)} warnings:")
