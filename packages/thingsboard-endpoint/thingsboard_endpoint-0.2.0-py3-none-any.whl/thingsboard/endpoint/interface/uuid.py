...
class Uuid(object):
    """Interface to represent an object as an uuid (Universally Unique Identifier).
    ...
    order to simplify development and troubleshooting, but this is not actually required.
