...
__all__ = ["RefundResponse", "LineItem", "LineItemProduct", "LineItemTaxJurisdiction"]
...
class RefundResponse(BaseModel):
    ...
    We recommend you store this value. If you need to reverse this refund, you will
    be required to reference this ID.
    """
