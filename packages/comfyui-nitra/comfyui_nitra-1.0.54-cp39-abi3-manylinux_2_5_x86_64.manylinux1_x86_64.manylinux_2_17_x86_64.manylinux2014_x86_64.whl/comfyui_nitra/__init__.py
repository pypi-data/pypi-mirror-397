"""
comfyui_nitra - Nitra extension package for ComfyUI
...
(custom_nodes/ComfyUI-Nitra/__init__.py), NOT when importing this package.
"""

__version__ = "1.0.54"  # Replaced by CI from git tag
__all__ = ["__version__"]
