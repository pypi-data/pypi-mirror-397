...
class App(P2AImage):
    ...
    DOCKERFILE_README_TEMPLATE = """
        The following Docker image was generated by Pydra2App v{} to enable the
        commands to be run in the XNAT container service. See
        https://raw.githubusercontent.com/Australian-Imaging-Service/pydra2app/main/LICENSE
        for licence.
