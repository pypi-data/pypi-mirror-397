...
def colectTestcasesToExecute(paths,tags):
    testList=[]
    print("[dbg]> Collecting testcases to execute... from paths: {}".format(paths))
    for item in paths:        
...
def main():
    ...
    arguments = docopt(__doc__, version='bfan 1.0.13')
    ...
    print("[dbg]> path  '{}'".format(arguments['<path>']))
    ...
    print("[dbg]> Collected {} testcases to run.".format(len(testPathToRun)))
