...
class Config:
    def __init__(self):
        ...
        self.config_file = os.path.join(self.base_dir, "hos_config.json")
        self.system_settings_file = os.path.join(self.base_dir, "system_settings.json")
    ...
    def _load_system_settings(self):
        """加载系统设置"""
        if os.path.exists(self.system_settings_file):
