"""Provide the current Mantarix version."""
...
import mantarix
from mantarix.utils import is_mobile, is_windows, which
...
def update_version():
    ...
    os.chdir(Path(mantarix.__file__).absolute().parent)
    in_repo = (
    ...
    if in_repo:
        ...
        if "cannot describe anything" in err:
            ...
            msg += "If so please clone the original Mantarix repo"
