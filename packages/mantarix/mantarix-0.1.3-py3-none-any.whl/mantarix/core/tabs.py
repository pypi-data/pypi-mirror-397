...
from mantarix.core.form_field_control import IconValueOrControl
...
class Tabs(ConstrainedControl, AdaptiveControl):
            ...
            tabs=[
                mx.Tab(
                    ...
                    content=mx.Container(
                        content=mx.Text("This is Tab 1"), alignment=mx.alignment.center
                    ),
                ),
                mx.Tab(
                    tab_content=mx.Icon(mx.icons.SEARCH),
                    content=mx.Text("This is Tab 2"),
                ),
                mx.Tab(
                    text="Tab 3",
                    icon=mx.icons.SETTINGS,
                    content=mx.Text("This is Tab 3"),
                ),
            ],
            expand=1,
        )
    ...
    Online docs: https://mantarix.dev/docs/controls/tabs
    """
