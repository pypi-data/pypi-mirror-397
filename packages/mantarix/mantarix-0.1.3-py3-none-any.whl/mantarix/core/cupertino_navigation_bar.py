...
from mantarix.core.border import Border
from mantarix.core.constrained_control import ConstrainedControl
from mantarix.core.navigation_bar import NavigationBarDestination
...
class CupertinoNavigationBar(ConstrainedControl):
    ...
    def main(page: mx.Page):
        ...
        page.navigation_bar = mx.CupertinoNavigationBar(
            bgcolor=mx.colors.AMBER_100,
            inactive_color=mx.colors.GREY,
            active_color=mx.colors.BLACK,
            on_change=lambda e: print("Selected tab:", e.control.selected_index),
            destinations=[
                mx.NavigationBarDestination(icon=mx.icons.EXPLORE, label="Explore"),
                mx.NavigationBarDestination(icon=mx.icons.COMMUTE, label="Commute"),
                mx.NavigationBarDestination(
                    icon=mx.icons.BOOKMARK_BORDER,
                    selected_icon=mx.icons.BOOKMARK,
                    label="Explore",
                ),
            ]
        )
        page.add(mx.SafeArea(mx.Text("Body!")))
    ...
    Online docs: https://mantarix.dev/docs/controls/cupertinonavigationbar
    """
