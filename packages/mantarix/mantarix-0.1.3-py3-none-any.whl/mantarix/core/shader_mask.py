...
class ShaderMask(ConstrainedControl):
    ...
    def main(page: mx.Page):
        page.add(
            mx.Row(
                [
                    mx.ShaderMask(
                        mx.Image(src="https://picsum.photos/100/200?2"),
                        blend_mode=mx.BlendMode.DST_IN,
                        shader=mx.LinearGradient(
                            begin=mx.alignment.top_center,
                            end=mx.alignment.bottom_center,
                            colors=[mx.colors.BLACK, mx.colors.TRANSPARENT],
                            stops=[0.5, 1.0],
                        ),
                        border_radius=10,
                    ),
    ...
    Online docs: https://mantarix.dev/docs/controls/shadermask
    """
