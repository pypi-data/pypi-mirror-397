...
from mantarix.core.animation import AnimationCurve, AnimationValue
...
class AnimatedSwitcher(ConstrainedControl):
    ...
    def main(page: mx.Page):
        ...
        c1 = mx.Container(
            mx.Text("Hello!", style=mx.TextThemeStyle.HEADLINE_MEDIUM),
            alignment=mx.alignment.center,
            width=200,
            height=200,
            bgcolor=mx.colors.GREEN,
        )
        c2 = mx.Container(
            mx.Text("Bye!", size=50),
            alignment=mx.alignment.center,
            width=200,
            height=200,
            bgcolor=mx.colors.YELLOW,
        )
        c = mx.AnimatedSwitcher(
            content=c1,
            transition=mx.AnimatedSwitcherTransition.SCALE,
            duration=500,
            reverse_duration=100,
            switch_in_curve=mx.AnimationCurve.BOUNCE_OUT,
            switch_out_curve=mx.AnimationCurve.BOUNCE_IN,
        )
        ...
        page.add(
            c,
            mx.ElevatedButton("Animate!", on_click=animate),
        )
    ...
    Online docs: https://mantarix.dev/docs/controls/animatedswitcher
    """
