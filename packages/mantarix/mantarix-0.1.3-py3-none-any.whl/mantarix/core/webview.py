...
from mantarix.core.exceptions import MantarixUnsupportedPlatformException
...
class WebView(ConstrainedControl):
    ...
    View docs: [WebView](https://mantarix.dev/docs/controls/webview)
    """
    ...
    def _check_mobile_or_mac_platform(self):
        ...
        if self.page.platform not in [
            ...
            raise MantarixUnsupportedPlatformException(
