...
class Slider(ConstrainedControl, AdaptiveControl):
    ...
    def main(page):
        page.add(
            mx.Text("Slider with value:"),
            mx.Slider(value=0.3),
            mx.Text("Slider with a custom range and label:"),
            mx.Slider(min=0, max=100, divisions=10, label="{value}%"))
    ...
    Online docs: https://mantarix.dev/docs/controls/slider
    """
