...
class Card(ConstrainedControl, AdaptiveControl):
            ...
            mx.Card(
                content=mx.Container(
                    content=mx.Column(
                        [
                            mx.ListTile(
                                leading=mx.Icon(mx.icons.ALBUM),
                                title=mx.Text("The Enchanted Nightingale"),
                                subtitle=mx.Text(
                                    "Music by Julie Gable. Lyrics by Sidney Stein."
                                ),
                            ),
                            mx.Row(
                                [mx.TextButton("Buy tickets"), mx.TextButton("Listen")],
                                alignment=mx.MainAxisAlignment.END,
                            ),
                        ]
                    ),
                    width=400,
    ...
    Online docs: https://mantarix.dev/docs/controls/card
    """
