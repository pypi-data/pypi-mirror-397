...
class Chip(ConstrainedControl):
    ...
    def main(page: mx.Page):
        def save_to_favorites_clicked(e):
            ...
            e.control.leading = mx.Icon(mx.icons.FAVORITE_OUTLINED)
        ...
        save_to_favourites = mx.Chip(
            label=mx.Text("Save to favourites"),
            leading=mx.Icon(mx.icons.FAVORITE_BORDER_OUTLINED),
            bgcolor=mx.colors.GREEN_200,
            disabled_color=mx.colors.GREEN_100,
            autofocus=True,
            on_click=save_to_favorites_clicked,
        )

        open_in_maps = mx.Chip(
            label=mx.Text("9 min walk"),
            leading=mx.Icon(mx.icons.MAP_SHARP),
            bgcolor=mx.colors.GREEN_200,
            on_click=open_google_maps,
        )

        page.add(mx.Row([save_to_favourites, open_in_maps]))
    ...
    Online docs: https://mantarix.dev/docs/controls/chip
    """
