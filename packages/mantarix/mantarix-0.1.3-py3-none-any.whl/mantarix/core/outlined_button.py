...
from mantarix.core.buttons import ButtonStyle
...
class OutlinedButton(ConstrainedControl, AdaptiveControl):
    ...
    def main(page: mx.Page):
        ...
        page.add(
            mx.OutlinedButton(text="Outlined button"),
            mx.OutlinedButton("Disabled button", disabled=True),
        )
    ...
    Online docs: https://mantarix.dev/docs/controls/outlinedbutton
    """
