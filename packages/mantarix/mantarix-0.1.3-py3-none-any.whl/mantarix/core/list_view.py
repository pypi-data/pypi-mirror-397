...
class ListView(ConstrainedControl, ScrollableControl, AdaptiveControl):
    ...
    def main(page: mx.Page):
        ...
        lv = mx.ListView(expand=1, spacing=10, padding=20, auto_scroll=True)

        count = 1

        for i in range(0, 60):
            lv.controls.append(mx.Text(f"Line {count}"))
            count += 1
    ...
    Online docs: https://mantarix.dev/docs/controls/listview
    """
