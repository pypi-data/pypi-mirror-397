...
from mantarix.core.animation import AnimationCurve
...
from mantarix.core.box import BoxDecoration
from mantarix.core.client_storage import ClientStorage
from mantarix.core.connection import Connection
...
from mantarix.core.locks import NopeLock
from mantarix.core.navigation_bar import NavigationBar
from mantarix.core.navigation_drawer import NavigationDrawer, NavigationDrawerPosition
...
from mantarix.core.session_storage import SessionStorage
from mantarix.core.snack_bar import SnackBar
from mantarix.core.theme import Theme
...
from mantarix.utils import classproperty, deprecated, is_pyodide
...
_session_page = ContextVar("mantarix_session_page", default=None)
...
class Page(AdaptiveControl):
    """
    Page is a container for `View` (https://mantarix.dev/docs/controls/view) controls.
    ...
    Online docs: https://mantarix.dev/docs/controls/page
    """
    ...
    def login(
        ...
        if saved_token is None:
            ...
            if on_open_authorization_url:
                ...
                self.launch_url(
                    authorization_url, "mantarix_oauth_signin", web_popup_window=self.web
                )
        else:
