...
class TimePicker(Control):
    ...
    def main(page: mx.Page):
        ...
        def handle_change(e):
            page.add(mx.Text(f"TimePicker change: {time_picker.value}"))

        def handle_dismissal(e):
            page.add(mx.Text(f"TimePicker dismissed: {time_picker.value}"))

        def handle_entry_mode_change(e):
            page.add(mx.Text(f"TimePicker Entry mode changed to {e.entry_mode}"))

        time_picker = mx.TimePicker(
    ...
    Online docs: https://mantarix.dev/docs/controls/time_picker
    """
