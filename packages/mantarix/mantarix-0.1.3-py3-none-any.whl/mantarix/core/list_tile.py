...
from mantarix.core.types import (ColorEnums, ColorValue, MouseCursor, OffsetValue,
...
class ListTile(ConstrainedControl, AdaptiveControl):
            ...
            mx.Card(
                content=mx.Container(
                    ...
                    content=mx.Column(
                        [
                            mx.ListTile(
                                title=mx.Text("One-line list tile"),
                            ),
                            mx.ListTile(
                                leading=mx.Icon(mx.icons.SETTINGS),
                                title=mx.Text("One-line selected list tile"),
                                selected=True,
                            ),
                        ],
                        spacing=0,
                    ),
                    padding=mx.padding.symmetric(vertical=10),
                )
            )
        )
    ...
    Online docs: https://mantarix.dev/docs/controls/listtile
    """
