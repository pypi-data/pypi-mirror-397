...
class Checkbox(ConstrainedControl, AdaptiveControl):
    ...
    def main(page):
        ...
        t = mx.Text()
        c1 = mx.Checkbox(label="Unchecked by default checkbox", value=False)
        c2 = mx.Checkbox(label="Undefined by default tristate checkbox", tristate=True)
        c3 = mx.Checkbox(label="Checked by default checkbox", value=True)
        c4 = mx.Checkbox(label="Disabled checkbox", disabled=True)
        c5 = mx.Checkbox(
            label="Checkbox with rendered label_position='left'", label_position=mx.LabelPosition.LEFT
        )
    ...
    Online docs: https://mantarix.dev/docs/controls/checkbox
    """
