...
from mantarix.core.navigation_drawer import NavigationDrawer
...
class Pagelet(ConstrainedControl, AdaptiveControl):
    ...
    def main(page: mx.Page):
        page.add(
            mx.Pagelet(
                appbar=mx.CupertinoAppBar(middle=mx.Text("AppBar title")),
                content=mx.Text("This is pagelet"),
            )
        )
    ...
    mx.app(target=main)
        ...
        Online docs: https://mantarix.dev/docs/controls/pagelet
    """
