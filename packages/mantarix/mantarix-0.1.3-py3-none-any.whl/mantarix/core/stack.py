...
class Stack(ConstrainedControl, AdaptiveControl):
    ...
    Stack is also useful if you want to implement implicit animations (https://mantarix.dev/docs/guides/python/animations/) that require knowing absolute position of a target value.
    ...
    Online docs: https://mantarix.dev/docs/controls/stack
    """
