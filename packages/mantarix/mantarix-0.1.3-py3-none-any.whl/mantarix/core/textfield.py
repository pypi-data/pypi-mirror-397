...
from mantarix.core.autofill_group import AutofillHint
from mantarix.core.badge import BadgeValue
from mantarix.core.box import BoxConstraints
from mantarix.core.control import Control, OptionalNumber
from mantarix.core.form_field_control import FormFieldControl, InputBorder
from mantarix.core.ref import Ref
from mantarix.core.text_style import StrutStyle, TextStyle
...
class TextField(FormFieldControl, AdaptiveControl):
    ...
    def main(page: mx.Page):
        ...
        t = mx.Text()
        tb1 = mx.TextField(label="Standard")
        tb2 = mx.TextField(label="Disabled", disabled=True, value="First name")
        tb3 = mx.TextField(label="Read-only", read_only=True, value="Last name")
        tb4 = mx.TextField(label="With placeholder", hint_text="Please enter text here")
        tb5 = mx.TextField(label="With an icon", icon=mx.icons.EMOJI_EMOTIONS)
    ...
    Online docs: https://mantarix.dev/docs/controls/textfield
    """
