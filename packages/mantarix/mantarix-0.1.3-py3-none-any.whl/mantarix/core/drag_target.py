...
from mantarix.core.types import OptionalControlEventCallable, OptionalEventCallable
...
class DragTarget(Control):
    ...
    def main(page: mx.Page):
        ...
        def drag_will_accept(e):
            e.control.content.border = mx.border.all(
                2, mx.colors.BLACK45 if e.data == "true" else mx.colors.RED
            )
            e.control.update()

        def drag_accept(e: mx.DragTargetEvent):
                ...
                [
                    mx.Column(
                        [
                            mx.Draggable(
                                group="color",
                                content=mx.Container(
                                    width=50,
                                    height=50,
                                    bgcolor=mx.colors.CYAN,
                                    border_radius=5,
                                ),
                                content_feedback=mx.Container(
                                    width=20,
                                    height=20,
                                    bgcolor=mx.colors.CYAN,
                                    border_radius=3,
                    ...
                    mx.DragTarget(
                        ...
                        content=mx.Container(
                            width=50,
                            height=50,
                            bgcolor=mx.colors.BLUE_GREY_100,
                            border_radius=5,
                        ),
    ...
    Online docs: https://mantarix.dev/docs/controls/dragtarget
    """
