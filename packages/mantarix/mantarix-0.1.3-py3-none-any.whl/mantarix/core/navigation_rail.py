...
class NavigationRail(ConstrainedControl):
    ...
    def main(page: mx.Page):
        ...
        rail = mx.NavigationRail(
            selected_index=1,
            label_type=mx.NavigationRailLabelType.ALL,
            # extended=True,
            min_width=100,
            min_extended_width=400,
            leading=mx.FloatingActionButton(icon=mx.icons.CREATE, text="Add"),
            group_alignment=-0.9,
            destinations=[
                mx.NavigationRailDestination(
                    icon=mx.icons.FAVORITE_BORDER, selected_icon=mx.icons.FAVORITE, label="First"
                ),
                mx.NavigationRailDestination(
                    icon_content=mx.Icon(mx.icons.BOOKMARK_BORDER),
                    selected_icon_content=mx.Icon(mx.icons.BOOKMARK),
                    label="Second",
                ),
                mx.NavigationRailDestination(
                    icon=mx.icons.SETTINGS_OUTLINED,
                    selected_icon_content=mx.Icon(mx.icons.SETTINGS),
                    label_content=mx.Text("Settings"),
                ),
            ],
        ...
        page.add(
            mx.Row(
                [
                    rail,
                    mx.VerticalDivider(width=1),
                    mx.Column([ mx.Text("Body!")], alignment=mx.MainAxisAlignment.START, expand=True),
                ],
                expand=True,
            )
        )
    ...
    Online docs: https://mantarix.dev/docs/controls/navigationrail
    """
