...
from mantarix.core.types import ClipBehavior, ColorEnums, ColorValue, OptionalNumber
...
class AppBar(AdaptiveControl):
    ...
    def main(page: mx.Page):
        ...
        page.appbar = mx.AppBar(
            leading=mx.Icon(mx.icons.PALETTE),
            leading_width=40,
            title=mx.Text("AppBar Example"),
            center_title=False,
            bgcolor=mx.colors.SURFACE_VARIANT,
            actions=[
                mx.IconButton(mx.icons.WB_SUNNY_OUTLINED),
                mx.IconButton(mx.icons.FILTER_3),
                mx.PopupMenuButton(
                    items=[
                        mx.PopupMenuItem(text="Item 1"),
                        mx.PopupMenuItem(),  # divider
                        mx.PopupMenuItem(
    ...
    Online docs: https://mantarix.dev/docs/controls/appbar
    """
