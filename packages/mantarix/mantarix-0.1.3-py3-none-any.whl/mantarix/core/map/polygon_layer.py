...
from mantarix.core.map.map import MapLatitudeLongitude
from mantarix.core.map.map_layer import MapLayer
from mantarix.core.ref import Ref
from mantarix.core.text_style import TextStyle
from mantarix.core.types import ColorEnums, ColorValue, StrokeCap, StrokeJoin
...
class PolygonMarker(Control):
    ...
    Online docs: https://mantarix.dev/docs/controls/mappolygonmarker
    """
...
class PolygonLayer(MapLayer):
    ...
    Online docs: https://mantarix.dev/docs/controls/mappolygonlayer
    """
