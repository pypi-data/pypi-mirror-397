...
def market_live_status(mode: str = "Market Status"):
    ...
    DESCRIPTION:
        Get current market status("Capital Market" | "Currency" | "Commodity" | "Debt" | "currencyfuture"), total mcap, or Gift Nifty value.
    PARAMETERS:
        mode: str – "Market Status" | "Mcap" | "Gift Nifty"
    RETURNS:
...
def nifty50_live_contribution():
    ...
    DESCRIPTION:
        Stock-wise how many points contribution to Nifty 50 index movement
    PARAMETERS: None
    RETURNS:
        Contribution data
    CATEGORY:
