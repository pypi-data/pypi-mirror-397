...
- **THEN** documentation SHALL include `DuckDBDatasetIO.insert_dataset`, `upsert_dataset`, `update_dataset`, and `deduplicate_dataset`
- **AND** SHALL include `DuckDBParquetHandler` re-exports
