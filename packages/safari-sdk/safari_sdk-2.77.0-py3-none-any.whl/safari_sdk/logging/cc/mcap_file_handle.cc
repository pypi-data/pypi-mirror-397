...
// reader.hpp is included here to ensure the mcap reader components are compiled
// as part of this single implementation unit, even if not directly used in this
// file. Other files (like tests) depend on these symbols being defined.
#include "third_party/mcap/cpp/mcap/include/mcap/reader.hpp"  // IWYU pragma: keep
