...
class McapFileHandle {
 public:
  ...
  // been registered yet.
  absl::Status WriteMessage(const McapWriteOp& op);

  int64_t total_messages_size_bytes() const;

  int64_t shard_index() const;

  int64_t last_publish_time_ns() const;
