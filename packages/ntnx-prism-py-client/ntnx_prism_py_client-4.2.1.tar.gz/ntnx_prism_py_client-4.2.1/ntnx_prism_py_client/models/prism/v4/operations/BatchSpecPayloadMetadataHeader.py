...
class BatchSpecPayloadMetadataHeader(object):

    """The metadata section on the input specification for performing the batch operation.

    :param name: (:attr:`name`) The name of the header parameter.
    :type name: required
     max=256 chars
    
    :param value: (:attr:`value`) The value of the header parameter.
    :type value: required
    ...
    def _initialize_object_type(self):
        return 'prism.v4.operations.BatchSpecPayloadMetadataHeader'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(BatchSpecPayloadMetadataHeader, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchSpecPayloadMetadataHeader):
            return False
