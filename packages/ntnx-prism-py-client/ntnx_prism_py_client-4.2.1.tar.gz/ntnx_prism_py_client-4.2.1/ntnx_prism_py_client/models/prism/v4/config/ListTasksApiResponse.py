...
from ntnx_prism_py_client.models.OneOfprism.v4.config.ListTasksApiResponsedata import ListTasksApiResponsedata  # noqa: F401,E501
from ntnx_prism_py_client.models.common.v1.response.ApiResponseMetadata import ApiResponseMetadata  # noqa: F401,E501

class ListTasksApiResponse(object):
    ...
    swagger_types = {
        ...
        'data': 'OneOfprism.v4.config.ListTasksApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'prism.v4.config.ListTasksApiResponse'
    ...
    def data(self):
        ...
        :type:
                :class:`~ntnx_prism_py_client.models.prism.v4.config.Task` | 
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListTasksApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListTasksApiResponse):
            return False
