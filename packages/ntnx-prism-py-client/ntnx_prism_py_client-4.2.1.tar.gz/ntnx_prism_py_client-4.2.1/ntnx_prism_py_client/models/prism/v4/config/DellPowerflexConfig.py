...
from ntnx_prism_py_client.models.prism.v4.config.DellPowerflexStoragePool import DellPowerflexStoragePool  # noqa: F401,E501

class DellPowerflexConfig(object):
    ...
    :param system_id: (:attr:`system_id`) The systemId for the Dell PowerFlex system.
    :type system_id: 
     max=256 chars
    
    :param storage_pool: (:attr:`storage_pool`) 
    :type storage_pool: 
    ...
    swagger_types = {
        ...
        'system_id': 'str',
        'storage_pool': 'prism.v4.config.DellPowerflexStoragePool',
    ...
    def __init__(self, address=None, system_id=None, storage_pool=None, *args, **kwargs):  # noqa: E501
        self.__address = None
    ...
    def _initialize_object_type(self):
        return 'prism.v4.config.DellPowerflexConfig'
    ...
    def system_id(self, system_id):
        if system_id is not None and len(system_id) > 256:
            raise ValueError("Invalid value for `system_id`, length must be less than or equal to `256`")  # noqa: E501
    ...
    def storage_pool(self):
        ...
        :type:
            :class:`~ntnx_prism_py_client.models.prism.v4.config.DellPowerflexStoragePool`
        """  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(DellPowerflexConfig, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DellPowerflexConfig):
            return False
