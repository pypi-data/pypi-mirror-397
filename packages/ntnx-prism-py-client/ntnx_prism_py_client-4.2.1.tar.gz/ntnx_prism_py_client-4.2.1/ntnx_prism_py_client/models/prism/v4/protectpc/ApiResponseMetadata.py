...
from ntnx_prism_py_client.models.prism.v4.protectpc.ApiLink import ApiLink  # noqa: F401,E501

class ApiResponseMetadata(object):

    """Metadata associated with API responses.

    :param links: (:attr:`links`) 
    :type links: 
    ...
    """  # noqa: E501
    swagger_types = {
        'links': 'list[prism.v4.protectpc.ApiLink]',
    ...
    def _initialize_object_type(self):
        return 'prism.v4.protectpc.ApiResponseMetadata'
    ...
    def links(self):
        ...
        :type:
             list[ :class:`~ntnx_prism_py_client.models.prism.v4.protectpc.ApiLink` ]
        """  # noqa: E501
        return self.__links
