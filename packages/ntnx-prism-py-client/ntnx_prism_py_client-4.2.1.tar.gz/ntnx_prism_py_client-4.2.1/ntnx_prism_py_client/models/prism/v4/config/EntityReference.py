...
class EntityReference(object):
    ...
    :param ext_id: (:attr:`ext_id`) A globally unique identifier of the entity.
    :type ext_id: 
    
    
    :param rel: (:attr:`rel`) Entity type identified as 'namespace:module[:submodule]:entityType'. For example- vmm:ahv:vm, where vmm is the namespace, ahv is the module, and vm is the entity type.
    :type rel: 
    ...
    def __init__(self, ext_id=None, rel=None, name=None, *args, **kwargs):  # noqa: E501
        self.__ext_id = None
        self.__rel = None
        self.__name = None
