...
from ntnx_prism_py_client.models.OneOfprism.v4.management.GetBackupTargetApiResponsedata import GetBackupTargetApiResponsedata  # noqa: F401,E501
from ntnx_prism_py_client.models.common.v1.response.ApiResponseMetadata import ApiResponseMetadata  # noqa: F401,E501

class GetBackupTargetApiResponse(object):

    """REST response for all response codes in API path /prism/v4.2/management/domain-managers/{domainManagerExtId}/backup-targets/{extId} Get operation
    ...
    swagger_types = {
        ...
        'data': 'OneOfprism.v4.management.GetBackupTargetApiResponsedata',
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetBackupTargetApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetBackupTargetApiResponse):
            return False
