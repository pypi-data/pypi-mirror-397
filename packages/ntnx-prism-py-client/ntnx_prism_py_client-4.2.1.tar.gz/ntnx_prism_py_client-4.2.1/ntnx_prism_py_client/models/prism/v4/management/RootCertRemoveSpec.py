...
class RootCertRemoveSpec(object):

    """Payload to delete root certificate. It contains the external identifier of the remote cluster.

    :param cluster_ext_id: (:attr:`cluster_ext_id`) The external identifier of the domain manager (Prism Central) resource.
    ...
    def _initialize_object_type(self):
        return 'prism.v4.management.RootCertRemoveSpec'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(RootCertRemoveSpec, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RootCertRemoveSpec):
            return False
