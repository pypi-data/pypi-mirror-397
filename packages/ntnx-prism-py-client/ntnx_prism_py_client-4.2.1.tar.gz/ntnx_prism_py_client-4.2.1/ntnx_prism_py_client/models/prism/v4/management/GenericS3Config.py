...
from ntnx_prism_py_client.models.OneOfprism.v4.management.GenericS3Configcredentials import GenericS3Configcredentials  # noqa: F401,E501
...
class GenericS3Config(S3Config):

    """S3 compliant bucket configuration to be used for backing up domain manager. 
    ...
    swagger_types = {
        ...
        'credentials': 'OneOfprism.v4.management.GenericS3Configcredentials',
        'bucket_name': 'str',
        'region': 'str',
    ...
    def _initialize_object_type(self):
        return 'prism.v4.management.GenericS3Config'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GenericS3Config, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GenericS3Config):
            return False
