...
class ProductName(object):
    ...
    Allowed enum values:
        ...
        - _UNKNOWN
        - _REDACTED
        - FLOW_VIRTUAL_NETWORKING: Nutanix Flow Virtual Networking
        - FLOW_NETWORK_SECURITY: Nutanix Flow Network Security
        - NUTANIX_DISASTER_RECOVERY: Nutanix Disaster Recovery
        - SELF_SERVICE: Self Service (Calm)
        - NUTANIX_MARKETPLACE: Nutanix Marketplace
        - INTELLIGENT_OPERATIONS: Intelligent Operations
        - NUTANIX_CLOUD_MANAGER: Nutanix Cloud Manager
        - FLOW_CONTROLLER: Flow Controller
    """
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    FLOW_VIRTUAL_NETWORKING = "FLOW_VIRTUAL_NETWORKING"
    FLOW_NETWORK_SECURITY = "FLOW_NETWORK_SECURITY"
    NUTANIX_DISASTER_RECOVERY = "NUTANIX_DISASTER_RECOVERY"
    SELF_SERVICE = "SELF_SERVICE"
    NUTANIX_MARKETPLACE = "NUTANIX_MARKETPLACE"
    INTELLIGENT_OPERATIONS = "INTELLIGENT_OPERATIONS"
    NUTANIX_CLOUD_MANAGER = "NUTANIX_CLOUD_MANAGER"
    ...
    def _initialize_object_type(self):
        return 'prism.v4.management.ProductName'
