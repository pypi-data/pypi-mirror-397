...
class NetworkCapability(object):
    ...
    Allowed enum values:
        ...
        - _UNKNOWN
        - _REDACTED
        - IPV4: The Domain manager (Prism Central) has only IPv4 network configured.
        - DUAL_STACK: The Domain manager (Prism Central) has both IPv4 and IPv6 network configured.
        - IPV6: The Domain manager (Prism Central) has only IPv6 network configured.
    """
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    IPV4 = "IPV4"
    ...
    def _initialize_object_type(self):
        return 'prism.v4.config.NetworkCapability'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(NetworkCapability, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NetworkCapability):
            return False
