...
class AccessKeyCredentials(object):

    """Secret credentials model for the object store containing access key ID and secret access key.

    :param access_key_id: (:attr:`access_key_id`) Access key ID of the object store provided for the backup target.
    :type access_key_id: required
     min=16 chars, max=128 chars
    
    :param secret_access_key: (:attr:`secret_access_key`) Secret access key of the object store provided for the backup target. 
    ...
    def __init__(self, access_key_id=None, secret_access_key=None, *args, **kwargs):  # noqa: E501
    ...
    def access_key_id(self, access_key_id):
        ...
        if access_key_id is not None and len(access_key_id) > 128:
            raise ValueError("Invalid value for `access_key_id`, length must be less than or equal to `128`")  # noqa: E501
        if access_key_id is not None and len(access_key_id) < 16:
            raise ValueError("Invalid value for `access_key_id`, length must be greater than or equal to `16`")  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(AccessKeyCredentials, dict):
