...
class ExternalStorageProvider(object):
    ...
    Allowed enum values:
        ...
        - _UNKNOWN
        - _REDACTED
        - DELL_POWERFLEX: Configuration details for a Dell PowerFlex external storage.
        - PURE_STORAGE_FLASHARRAY: Configuration details for a Pure Storage FlashArray external storage.
    """
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    DELL_POWERFLEX = "DELL_POWERFLEX"
    PURE_STORAGE_FLASHARRAY = "PURE_STORAGE_FLASHARRAY"
    ...
    def _initialize_object_type(self):
        return 'prism.v4.config.ExternalStorageProvider'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ExternalStorageProvider, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ExternalStorageProvider):
            return False
