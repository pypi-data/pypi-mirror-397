...
class ConnectionConfigurationSpec(object):
    ...
    """  # noqa: E501
    swagger_types = {
        'remote_cluster': 'prism.v4.management.RemoteCluster',
    ...
    def _initialize_object_type(self):
        return 'prism.v4.management.ConnectionConfigurationSpec'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ConnectionConfigurationSpec, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ConnectionConfigurationSpec):
            return False
