...
class ApiError(object):
    ...
    :param error_message_list: (:attr:`error_message_list`) The error message field where the error response will be put.
    :type error_message_list: 
    
    
    :param error_type: (:attr:`error_type`) The type of error, like INVALID_INPUT, INTERNAL_SERVER_ERROR, etc.
    :type error_type: 
    ...
    def __init__(self, error_message_list=None, error_type=None, *args, **kwargs):  # noqa: E501
        self.__error_message_list = None
        self.__error_type = None
        self.discriminator = None
        if error_message_list is not None:
            self.__error_message_list = error_message_list
    ...
    def _initialize_object_type(self):
        return 'prism.v4.protectpc.ApiError'
    ...
    @error_message_list.setter
    def error_message_list(self, error_message_list):
