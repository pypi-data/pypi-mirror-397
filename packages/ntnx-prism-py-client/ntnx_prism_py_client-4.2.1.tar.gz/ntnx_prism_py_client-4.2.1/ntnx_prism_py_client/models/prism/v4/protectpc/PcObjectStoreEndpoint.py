...
class PcObjectStoreEndpoint(object):
    ...
    :param port: (:attr:`port`) The port of the object store endpoint where backup data of Prism Central is stored.  (**Default** '443')
    :type port: 
    ...
    :type backup_retention_days: 
     ...
     min=1,
    :param skip_certificate_validation: (:attr:`skip_certificate_validation`) Skip the verification of certificate during communication with object store endpoint  (**Default** False)
    :type skip_certificate_validation: 
    
    
    :param has_custom_certificate: (:attr:`has_custom_certificate`) Whether custom certificate provided or not. 
    ...
    def __init__(self, endpoint_address=None, endpoint_flavour=None, endpoint_credentials=None, rpo_seconds=None, ip_address_or_domain=None, port='443', bucket=None, region='us-east-1', skip_tls=False, backup_retention_days=31, skip_certificate_validation=False, has_custom_certificate=None, *args, **kwargs):  # noqa: E501
        ...
        self.__skip_certificate_validation = None
        ...
        if skip_certificate_validation is not None:
            self.__skip_certificate_validation = skip_certificate_validation
    ...
    def skip_certificate_validation(self):
        ...
        :type:
                :class:`~bool`
        """  # noqa: E501
        return self.__skip_certificate_validation

    @skip_certificate_validation.setter
    def skip_certificate_validation(self, skip_certificate_validation):
