...
class PcRestoreRootTask(object):
    ...
    :param task_uuid: (:attr:`task_uuid`) Task uuid of the root PC restore task.
    :type task_uuid: 
    ...
    def __init__(self, task_uuid=None, *args, **kwargs):  # noqa: E501
    ...
    def _initialize_object_type(self):
        return 'prism.v4.protectpc.PcRestoreRootTask'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(PcRestoreRootTask, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PcRestoreRootTask):
            return False
