...
class RestorePoint(ExternalizableAbstractModel):
    ...
    :param creation_time: (:attr:`creation_time`) The UTC date and time, in ISO 8601 format, at which the restore point was created. 
    :type creation_time: 
    
    
    :param domain_manager: (:attr:`domain_manager`) 
    :type domain_manager: 
    ...
    swagger_types = {
        ...
        'domain_manager': 'prism.v4.config.DomainManager',
        'ext_id': 'str',
    ...
    def __init__(self, creation_time=None, domain_manager=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
    ...
    def _initialize_object_type(self):
        return 'prism.v4.management.RestorePoint'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(RestorePoint, dict):
