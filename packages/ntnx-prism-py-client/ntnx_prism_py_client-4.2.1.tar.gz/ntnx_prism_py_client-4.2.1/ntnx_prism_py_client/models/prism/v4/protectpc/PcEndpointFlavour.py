...
class PcEndpointFlavour(object):
    ...
    def _initialize_object_type(self):
        return 'prism.v4.protectpc.PcEndpointFlavour'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(PcEndpointFlavour, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PcEndpointFlavour):
            return False
