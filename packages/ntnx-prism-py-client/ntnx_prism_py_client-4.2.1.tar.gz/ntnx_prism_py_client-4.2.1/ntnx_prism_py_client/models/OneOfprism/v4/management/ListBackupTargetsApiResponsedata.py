...
class ListBackupTargetsApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<prism.v4.management.BackupTarget>': 'list[prism.v4.management.BackupTarget]',
    ...
    def _initialize_object_type(self):
        return 'OneOfprism.v4.management.ListBackupTargetsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListBackupTargetsApiResponsedata.discriminator_value_class_map.values():
            return list(ListBackupTargetsApiResponsedata.discriminator_value_class_map.keys())[list(ListBackupTargetsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListBackupTargetsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListBackupTargetsApiResponsedata):
            return False
