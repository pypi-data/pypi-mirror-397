...
class ListRestorePointsApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<prism.v4.management.RestorePoint>': 'list[prism.v4.management.RestorePoint]',
    ...
    def _initialize_object_type(self):
        return 'OneOfprism.v4.management.ListRestorePointsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListRestorePointsApiResponsedata.discriminator_value_class_map.values():
            return list(ListRestorePointsApiResponsedata.discriminator_value_class_map.keys())[list(ListRestorePointsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListRestorePointsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListRestorePointsApiResponsedata):
            return False
