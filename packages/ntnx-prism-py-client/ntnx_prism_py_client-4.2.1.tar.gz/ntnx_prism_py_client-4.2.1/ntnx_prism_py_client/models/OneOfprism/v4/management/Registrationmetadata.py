...
class Registrationmetadata(object):
    ...
    discriminator_value_class_map = {
        ...
        'prism.v4.management.GenericMetadata': 'prism.v4.management.GenericMetadata'
    }

    ONE_OF_ITEM_DISCRIMINATOR_NAME = '$metadataItemDiscriminator'
    ...
    def _initialize_object_type(self):
        return 'OneOfprism.v4.management.Registrationmetadata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in Registrationmetadata.discriminator_value_class_map.values():
            return list(Registrationmetadata.discriminator_value_class_map.keys())[list(Registrationmetadata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(Registrationmetadata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, Registrationmetadata):
            return False
