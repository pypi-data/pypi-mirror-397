...
class DeleteBackupTargetApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfprism.v4.management.DeleteBackupTargetApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in DeleteBackupTargetApiResponsedata.discriminator_value_class_map.values():
            return list(DeleteBackupTargetApiResponsedata.discriminator_value_class_map.keys())[list(DeleteBackupTargetApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(DeleteBackupTargetApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteBackupTargetApiResponsedata):
            return False
