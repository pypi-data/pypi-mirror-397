...
class CreateRestoreSourceApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'prism.v4.management.RestoreSource': 'prism.v4.management.RestoreSource',
    ...
    def _initialize_object_type(self):
        return 'OneOfprism.v4.management.CreateRestoreSourceApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in CreateRestoreSourceApiResponsedata.discriminator_value_class_map.values():
            return list(CreateRestoreSourceApiResponsedata.discriminator_value_class_map.keys())[list(CreateRestoreSourceApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(CreateRestoreSourceApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateRestoreSourceApiResponsedata):
            return False
