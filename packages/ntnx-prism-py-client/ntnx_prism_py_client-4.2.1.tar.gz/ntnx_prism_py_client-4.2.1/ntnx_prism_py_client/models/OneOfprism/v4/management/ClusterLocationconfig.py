...
class ClusterLocationconfig(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfprism.v4.management.ClusterLocationconfig'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ClusterLocationconfig.discriminator_value_class_map.values():
            return list(ClusterLocationconfig.discriminator_value_class_map.keys())[list(ClusterLocationconfig.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ClusterLocationconfig, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ClusterLocationconfig):
            return False
