...
class ListBatchesApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<prism.v4.operations.Batch>': 'list[prism.v4.operations.Batch]',
    ...
    def _initialize_object_type(self):
        return 'OneOfprism.v4.operations.ListBatchesApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListBatchesApiResponsedata.discriminator_value_class_map.values():
            return list(ListBatchesApiResponsedata.discriminator_value_class_map.keys())[list(ListBatchesApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListBatchesApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListBatchesApiResponsedata):
            return False
