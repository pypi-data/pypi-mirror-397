...
class GetRestoreSourceApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfprism.v4.management.GetRestoreSourceApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetRestoreSourceApiResponsedata.discriminator_value_class_map.values():
            return list(GetRestoreSourceApiResponsedata.discriminator_value_class_map.keys())[list(GetRestoreSourceApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetRestoreSourceApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetRestoreSourceApiResponsedata):
            return False
