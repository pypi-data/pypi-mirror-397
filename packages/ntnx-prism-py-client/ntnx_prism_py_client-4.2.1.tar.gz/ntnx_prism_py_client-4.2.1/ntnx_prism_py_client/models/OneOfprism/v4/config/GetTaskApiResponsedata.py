...
class GetTaskApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'prism.v4.config.Task': 'prism.v4.config.Task',
    ...
    def _initialize_object_type(self):
        return 'OneOfprism.v4.config.GetTaskApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetTaskApiResponsedata.discriminator_value_class_map.values():
            return list(GetTaskApiResponsedata.discriminator_value_class_map.keys())[list(GetTaskApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetTaskApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetTaskApiResponsedata):
            return False
