...
class ObjectStoreLocationprovider_config(object):
    ...
    discriminator_value_class_map = {
        ...
        'prism.v4.management.AWSS3Config': 'prism.v4.management.AWSS3Config',
        'prism.v4.management.NutanixObjectsConfig': 'prism.v4.management.NutanixObjectsConfig',
        'prism.v4.management.GenericS3Config': 'prism.v4.management.GenericS3Config'
    }

    ONE_OF_ITEM_DISCRIMINATOR_NAME = '$providerConfigItemDiscriminator'
    ...
    def _initialize_object_type(self):
        return 'OneOfprism.v4.management.ObjectStoreLocationprovider_config'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ObjectStoreLocationprovider_config.discriminator_value_class_map.values():
            return list(ObjectStoreLocationprovider_config.discriminator_value_class_map.keys())[list(ObjectStoreLocationprovider_config.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ObjectStoreLocationprovider_config, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ObjectStoreLocationprovider_config):
            return False
