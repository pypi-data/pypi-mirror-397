...
class ListDomainManagerApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<prism.v4.config.DomainManager>': 'list[prism.v4.config.DomainManager]',
    ...
    def _initialize_object_type(self):
        return 'OneOfprism.v4.config.ListDomainManagerApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListDomainManagerApiResponsedata.discriminator_value_class_map.values():
            return list(ListDomainManagerApiResponsedata.discriminator_value_class_map.keys())[list(ListDomainManagerApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListDomainManagerApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListDomainManagerApiResponsedata):
            return False
