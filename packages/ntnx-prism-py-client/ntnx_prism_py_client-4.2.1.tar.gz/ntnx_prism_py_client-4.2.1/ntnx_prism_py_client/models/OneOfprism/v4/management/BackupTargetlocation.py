...
class BackupTargetlocation(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfprism.v4.management.BackupTargetlocation'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in BackupTargetlocation.discriminator_value_class_map.values():
            return list(BackupTargetlocation.discriminator_value_class_map.keys())[list(BackupTargetlocation.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(BackupTargetlocation, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BackupTargetlocation):
            return False
