...
class ClusterRegistrationSpecremote_cluster(object):
    ...
    discriminator_value_class_map = {
        ...
        'prism.v4.management.DomainManagerRemoteClusterSpec': 'prism.v4.management.DomainManagerRemoteClusterSpec',
        'prism.v4.management.AOSRemoteClusterSpec': 'prism.v4.management.AOSRemoteClusterSpec',
        'prism.v4.management.ClusterReference': 'prism.v4.management.ClusterReference'
    }

    ONE_OF_ITEM_DISCRIMINATOR_NAME = '$remoteClusterItemDiscriminator'
    ...
    def _initialize_object_type(self):
        return 'OneOfprism.v4.management.ClusterRegistrationSpecremote_cluster'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ClusterRegistrationSpecremote_cluster.discriminator_value_class_map.values():
            return list(ClusterRegistrationSpecremote_cluster.discriminator_value_class_map.keys())[list(ClusterRegistrationSpecremote_cluster.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ClusterRegistrationSpecremote_cluster, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ClusterRegistrationSpecremote_cluster):
            return False
