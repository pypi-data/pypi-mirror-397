...
class GetRestorePointApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'prism.v4.management.RestorePoint': 'prism.v4.management.RestorePoint',
    ...
    def _initialize_object_type(self):
        return 'OneOfprism.v4.management.GetRestorePointApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetRestorePointApiResponsedata.discriminator_value_class_map.values():
            return list(GetRestorePointApiResponsedata.discriminator_value_class_map.keys())[list(GetRestorePointApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetRestorePointApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetRestorePointApiResponsedata):
            return False
