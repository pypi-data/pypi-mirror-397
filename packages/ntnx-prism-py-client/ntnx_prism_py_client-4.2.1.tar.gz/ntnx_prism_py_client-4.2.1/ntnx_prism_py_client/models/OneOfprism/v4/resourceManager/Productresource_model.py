...
class Productresource_model(object):
    ...
    discriminator_value_class_map = {
        ...
        'prism.v4.resourceManager.ResourceTypeSpec': 'prism.v4.resourceManager.ResourceTypeSpec',
        'prism.v4.resourceManager.ResourceSpec': 'prism.v4.resourceManager.ResourceSpec'
    }

    ONE_OF_ITEM_DISCRIMINATOR_NAME = '$resourceModelItemDiscriminator'
    ...
    def _initialize_object_type(self):
        return 'OneOfprism.v4.resourceManager.Productresource_model'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in Productresource_model.discriminator_value_class_map.values():
            return list(Productresource_model.discriminator_value_class_map.keys())[list(Productresource_model.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(Productresource_model, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, Productresource_model):
            return False
