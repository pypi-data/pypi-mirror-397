...
class ListTaskJobsApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<prism.v4.config.TaskJob>': 'list[prism.v4.config.TaskJob]',
    ...
    def _initialize_object_type(self):
        return 'OneOfprism.v4.config.ListTaskJobsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListTaskJobsApiResponsedata.discriminator_value_class_map.values():
            return list(ListTaskJobsApiResponsedata.discriminator_value_class_map.keys())[list(ListTaskJobsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListTaskJobsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListTaskJobsApiResponsedata):
            return False
