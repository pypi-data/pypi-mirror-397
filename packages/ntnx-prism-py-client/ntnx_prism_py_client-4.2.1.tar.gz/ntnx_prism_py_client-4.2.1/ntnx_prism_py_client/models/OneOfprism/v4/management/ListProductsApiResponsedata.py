...
class ListProductsApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<prism.v4.management.Product>': 'list[prism.v4.management.Product]',
    ...
    def _initialize_object_type(self):
        return 'OneOfprism.v4.management.ListProductsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListProductsApiResponsedata.discriminator_value_class_map.values():
            return list(ListProductsApiResponsedata.discriminator_value_class_map.keys())[list(ListProductsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListProductsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListProductsApiResponsedata):
            return False
