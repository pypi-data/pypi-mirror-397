...
class ListCategoriesApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<prism.v4.config.Category>': 'list[prism.v4.config.Category]',
        'prism.v4.error.ErrorResponse': 'prism.v4.error.ErrorResponse',
        'List<prism.v4.config.CategoryProjection>': 'list[prism.v4.config.CategoryProjection]'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOfprism.v4.config.ListCategoriesApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListCategoriesApiResponsedata.discriminator_value_class_map.values():
            return list(ListCategoriesApiResponsedata.discriminator_value_class_map.keys())[list(ListCategoriesApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListCategoriesApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListCategoriesApiResponsedata):
            return False
