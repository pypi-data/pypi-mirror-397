...
class Productmetadata(object):
    ...
    discriminator_value_class_map = {
        ...
        'prism.v4.management.FlowControllerMetadata': 'prism.v4.management.FlowControllerMetadata'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOfprism.v4.management.Productmetadata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in Productmetadata.discriminator_value_class_map.values():
            return list(Productmetadata.discriminator_value_class_map.keys())[list(Productmetadata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(Productmetadata, dict):
