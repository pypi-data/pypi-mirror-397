...
class CreateCategoryApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'prism.v4.config.Category': 'prism.v4.config.Category',
    ...
    def _initialize_object_type(self):
        return 'OneOfprism.v4.config.CreateCategoryApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in CreateCategoryApiResponsedata.discriminator_value_class_map.values():
            return list(CreateCategoryApiResponsedata.discriminator_value_class_map.keys())[list(CreateCategoryApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(CreateCategoryApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateCategoryApiResponsedata):
            return False
