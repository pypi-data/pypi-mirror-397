...
class ListTasksApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<prism.v4.config.Task>': 'list[prism.v4.config.Task]',
    ...
    def _initialize_object_type(self):
        return 'OneOfprism.v4.config.ListTasksApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListTasksApiResponsedata.discriminator_value_class_map.values():
            return list(ListTasksApiResponsedata.discriminator_value_class_map.keys())[list(ListTasksApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListTasksApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListTasksApiResponsedata):
            return False
