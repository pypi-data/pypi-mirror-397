...
class BatchesApi(object):
    ...
    def get_batch_by_id(self, extId, **kwargs):  # noqa: E501
        """Get a Batch identified by {extId}.

        >>> response = api.get_batch_by_id(extId)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.get_batch_by_id(extId, async_req=True)
        >>> result = thread.get()

        :param extId: The external identifier of the Batch.
        :type extId:
            :class:`str`, required
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
                           ...
                           async_req=True
        :return: An instance of class :class:`~ntnx_prism_py_client.models.prism.v4.operations.GetBatchApiResponse`.
        ...
        if ('extId' not in params or params['extId'] is None):
            raise ValueError("Missing the required parameter `extId` when calling `get_batch_by_id`")  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/prism/v4.2/operations/batches/{extId}', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
                    ...
                    response_type='prism.v4.operations.GetBatchApiResponse',  # noqa: E501
    ...
    def list_batches(self, _page=None, _limit=None, _filter=None, _orderby=None, _select=None, **kwargs):  # noqa: E501
        """Get a list of all the Batches.

        >>> response = api.list_batches((optional) _page, (optional) _limit, (optional) _filter, (optional) _orderby, (optional) _select)
        ...
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
                           ...
                           async_req=True
        :return: An instance of class :class:`~ntnx_prism_py_client.models.prism.v4.operations.ListBatchesApiResponse`.
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/prism/v4.2/operations/batches', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
                    post_params=form_params,
                    files=local_var_files,
                    response_type='prism.v4.operations.ListBatchesApiResponse',  # noqa: E501
                    auth_settings=auth_settings,
                    async_req=params.get('async_req'),
                    _return_http_data_only=params.get('_return_http_data_only'),
                    _preload_content=params.get('_preload_content', True),
    ...
    def submit_batch(self, body, **kwargs):  # noqa: E501
        """Submit a batch operation.

        >>> response = api.submit_batch(body)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.submit_batch(body, async_req=True)
        >>> result = thread.get()

        :param body: The request payload for the batch operation.
        :type body:
            :class:`~ntnx_prism_py_client.models.prism.v4.operations.BatchSpec`, required
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::

                           async_req=True
        :return: An instance of class :class:`~ntnx_prism_py_client.models.prism.v4.operations.SubmitBatchApiResponse`.
        ...
        if ('body' not in params or params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `submit_batch`")  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/prism/v4.2/operations/$actions/batch', 'POST',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
                    post_params=form_params,
                    files=local_var_files,
                    response_type='prism.v4.operations.SubmitBatchApiResponse',  # noqa: E501
                    auth_settings=auth_settings,
                    async_req=params.get('async_req'),
                    _return_http_data_only=params.get('_return_http_data_only'),
                    _preload_content=params.get('_preload_content', True),
