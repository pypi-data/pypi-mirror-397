...
class RegistrationApi(object):
    ...
    def get_registration_by_id(self, domainManagerExtId, extId, **kwargs):  # noqa: E501
        """Specifications for the specified registration

        >>> response = api.get_registration_by_id(domainManagerExtId, extId)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.get_registration_by_id(domainManagerExtId, extId, async_req=True)
        >>> result = thread.get()
        ...
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
                           ...
                           async_req=True
        :return: An instance of class :class:`~ntnx_prism_py_client.models.prism.v4.management.GetRegistrationApiResponse`.
        ...
        if ('domainManagerExtId' not in params or params['domainManagerExtId'] is None):
            raise ValueError("Missing the required parameter `domainManagerExtId` when calling `get_registration_by_id`")  # noqa: E501
        # verify the required parameter 'extId' is set
        if ('extId' not in params or params['extId'] is None):
            raise ValueError("Missing the required parameter `extId` when calling `get_registration_by_id`")  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/prism/v4.2/management/domain-managers/{domainManagerExtId}/registrations/{extId}', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
                    ...
                    response_type='prism.v4.management.GetRegistrationApiResponse',  # noqa: E501
    ...
    def list_registrations(self, domainManagerExtId, _page=None, _limit=None, _filter=None, _orderby=None, _select=None, **kwargs):  # noqa: E501
        """List of registered clusters

        >>> response = api.list_registrations(domainManagerExtId, (optional) _page, (optional) _limit, (optional) _filter, (optional) _orderby, (optional) _select)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.list_registrations(domainManagerExtId, async_req=True)
        >>> result = thread.get()
        ...
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
                           ...
                           async_req=True
        :return: An instance of class :class:`~ntnx_prism_py_client.models.prism.v4.management.ListRegistrationApiResponse`.
        ...
        # verify the required parameter 'domainManagerExtId' is set
        if ('domainManagerExtId' not in params or params['domainManagerExtId'] is None):
            raise ValueError("Missing the required parameter `domainManagerExtId` when calling `list_registrations`")  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/prism/v4.2/management/domain-managers/{domainManagerExtId}/registrations', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
                    post_params=form_params,
                    files=local_var_files,
                    response_type='prism.v4.management.ListRegistrationApiResponse',  # noqa: E501
                    auth_settings=auth_settings,
                    async_req=params.get('async_req'),
                    _return_http_data_only=params.get('_return_http_data_only'),
                    _preload_content=params.get('_preload_content', True),
