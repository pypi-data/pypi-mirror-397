...
class GetExternalStorageApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'prism.v4.config.ExternalStorage': 'prism.v4.config.ExternalStorage',
    ...
    def _initialize_object_type(self):
        return 'OneOfprism.v4.config.GetExternalStorageApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetExternalStorageApiResponsedata.discriminator_value_class_map.values():
            return list(GetExternalStorageApiResponsedata.discriminator_value_class_map.keys())[list(GetExternalStorageApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetExternalStorageApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetExternalStorageApiResponsedata):
            return False
