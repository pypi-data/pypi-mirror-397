...
class ListTaskEntitiesApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<prism.v4.config.EntityReference>': 'list[prism.v4.config.EntityReference]',
    ...
    def _initialize_object_type(self):
        return 'OneOfprism.v4.config.ListTaskEntitiesApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListTaskEntitiesApiResponsedata.discriminator_value_class_map.values():
            return list(ListTaskEntitiesApiResponsedata.discriminator_value_class_map.keys())[list(ListTaskEntitiesApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListTaskEntitiesApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListTaskEntitiesApiResponsedata):
            return False
