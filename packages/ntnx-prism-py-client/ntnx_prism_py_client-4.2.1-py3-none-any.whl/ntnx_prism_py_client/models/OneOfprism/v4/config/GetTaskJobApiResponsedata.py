...
class GetTaskJobApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'prism.v4.config.TaskJob': 'prism.v4.config.TaskJob',
    ...
    def _initialize_object_type(self):
        return 'OneOfprism.v4.config.GetTaskJobApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetTaskJobApiResponsedata.discriminator_value_class_map.values():
            return list(GetTaskJobApiResponsedata.discriminator_value_class_map.keys())[list(GetTaskJobApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetTaskJobApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetTaskJobApiResponsedata):
            return False
