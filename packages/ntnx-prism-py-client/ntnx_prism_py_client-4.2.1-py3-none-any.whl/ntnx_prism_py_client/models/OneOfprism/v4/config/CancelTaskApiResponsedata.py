...
class CancelTaskApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'prism.v4.error.AppMessage': 'prism.v4.error.AppMessage',
    ...
    def _initialize_object_type(self):
        return 'OneOfprism.v4.config.CancelTaskApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in CancelTaskApiResponsedata.discriminator_value_class_map.values():
            return list(CancelTaskApiResponsedata.discriminator_value_class_map.keys())[list(CancelTaskApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(CancelTaskApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CancelTaskApiResponsedata):
            return False
