...
class UpdateCategoryApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<prism.v4.error.AppMessage>': 'list[prism.v4.error.AppMessage]',
    ...
    def _initialize_object_type(self):
        return 'OneOfprism.v4.config.UpdateCategoryApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in UpdateCategoryApiResponsedata.discriminator_value_class_map.values():
            return list(UpdateCategoryApiResponsedata.discriminator_value_class_map.keys())[list(UpdateCategoryApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(UpdateCategoryApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateCategoryApiResponsedata):
            return False
