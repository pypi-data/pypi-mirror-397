...
class ExternalStorageconfig(object):
    ...
    discriminator_value_class_map = {
        ...
        'prism.v4.config.DellPowerflexConfig': 'prism.v4.config.DellPowerflexConfig',
        'prism.v4.config.PureStorageFlashArrayConfig': 'prism.v4.config.PureStorageFlashArrayConfig'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOfprism.v4.config.ExternalStorageconfig'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ExternalStorageconfig.discriminator_value_class_map.values():
            return list(ExternalStorageconfig.discriminator_value_class_map.keys())[list(ExternalStorageconfig.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ExternalStorageconfig, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ExternalStorageconfig):
            return False
