...
class GetBatchApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'prism.v4.operations.Batch': 'prism.v4.operations.Batch',
    ...
    def _initialize_object_type(self):
        return 'OneOfprism.v4.operations.GetBatchApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetBatchApiResponsedata.discriminator_value_class_map.values():
            return list(GetBatchApiResponsedata.discriminator_value_class_map.keys())[list(GetBatchApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetBatchApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetBatchApiResponsedata):
            return False
