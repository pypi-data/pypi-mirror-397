...
class RestoreSourcelocation(object):
    ...
    discriminator_value_class_map = {
        ...
        'prism.v4.management.ClusterLocation': 'prism.v4.management.ClusterLocation',
        'prism.v4.management.ObjectStoreLocation': 'prism.v4.management.ObjectStoreLocation'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOfprism.v4.management.RestoreSourcelocation'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in RestoreSourcelocation.discriminator_value_class_map.values():
            return list(RestoreSourcelocation.discriminator_value_class_map.keys())[list(RestoreSourcelocation.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(RestoreSourcelocation, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RestoreSourcelocation):
            return False
