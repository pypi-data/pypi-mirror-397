...
class GenericS3Configcredentials(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfprism.v4.management.GenericS3Configcredentials'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GenericS3Configcredentials.discriminator_value_class_map.values():
            return list(GenericS3Configcredentials.discriminator_value_class_map.keys())[list(GenericS3Configcredentials.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GenericS3Configcredentials, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GenericS3Configcredentials):
            return False
