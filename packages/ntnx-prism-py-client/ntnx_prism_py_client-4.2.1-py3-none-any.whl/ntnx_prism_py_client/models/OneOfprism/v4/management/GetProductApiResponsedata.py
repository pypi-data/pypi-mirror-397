...
class GetProductApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'prism.v4.management.Product': 'prism.v4.management.Product',
    ...
    def _initialize_object_type(self):
        return 'OneOfprism.v4.management.GetProductApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetProductApiResponsedata.discriminator_value_class_map.values():
            return list(GetProductApiResponsedata.discriminator_value_class_map.keys())[list(GetProductApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetProductApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetProductApiResponsedata):
            return False
