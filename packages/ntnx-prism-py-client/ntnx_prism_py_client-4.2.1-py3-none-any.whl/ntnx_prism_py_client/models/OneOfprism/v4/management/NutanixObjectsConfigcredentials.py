...
class NutanixObjectsConfigcredentials(object):
    ...
    discriminator_value_class_map = {
        ...
        'prism.v4.management.AccessKeyCredentials': 'prism.v4.management.AccessKeyCredentials'
    }

    ONE_OF_ITEM_DISCRIMINATOR_NAME = '$credentialsItemDiscriminator'
    ...
    def _initialize_object_type(self):
        return 'OneOfprism.v4.management.NutanixObjectsConfigcredentials'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in NutanixObjectsConfigcredentials.discriminator_value_class_map.values():
            return list(NutanixObjectsConfigcredentials.discriminator_value_class_map.keys())[list(NutanixObjectsConfigcredentials.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(NutanixObjectsConfigcredentials, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NutanixObjectsConfigcredentials):
            return False
