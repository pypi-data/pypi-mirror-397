...
class ListRestorableDomainManagersApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<prism.v4.management.RestorableDomainManager>': 'list[prism.v4.management.RestorableDomainManager]',
        'prism.v4.error.ErrorResponse': 'prism.v4.error.ErrorResponse'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOfprism.v4.management.ListRestorableDomainManagersApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListRestorableDomainManagersApiResponsedata.discriminator_value_class_map.values():
            return list(ListRestorableDomainManagersApiResponsedata.discriminator_value_class_map.keys())[list(ListRestorableDomainManagersApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListRestorableDomainManagersApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListRestorableDomainManagersApiResponsedata):
            return False
