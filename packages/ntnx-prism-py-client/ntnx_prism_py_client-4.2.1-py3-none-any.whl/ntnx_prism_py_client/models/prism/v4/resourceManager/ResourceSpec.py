...
class ResourceSpec(object):
    ...
    :param cpu: (:attr:`cpu`) Indicates the number of virtual CPUs used by the application.
    :type cpu: 
    
    
    :param memory: (:attr:`memory`) Indicates the memory allocated for the application.
    :type memory: 
    ...
    def __init__(self, cpu=None, memory=None, *args, **kwargs):  # noqa: E501
        self.__cpu = None
        self.__memory = None
    ...
    def _initialize_object_type(self):
        return 'prism.v4.resourceManager.ResourceSpec'
