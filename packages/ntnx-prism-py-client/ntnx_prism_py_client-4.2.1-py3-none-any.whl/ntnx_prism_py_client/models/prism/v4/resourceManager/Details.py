...
from ntnx_prism_py_client.models.prism.v4.resourceManager.Status import Status  # noqa: F401,E501

class Details(object):

    """

    :param message: (:attr:`message`) Indicates the detailed message associated with the status message
    :type message: 
    ...
    swagger_types = {
        'message': 'str',
        'status': 'prism.v4.resourceManager.Status',
    ...
    def __init__(self, message=None, status=None, *args, **kwargs):  # noqa: E501
        self.__message = None
        self.__status = None
    ...
    def _initialize_object_type(self):
        return 'prism.v4.resourceManager.Details'
    ...
    def status(self):
        ...
        :type:
            :class:`~ntnx_prism_py_client.models.prism.v4.resourceManager.Status`
        """  # noqa: E501
