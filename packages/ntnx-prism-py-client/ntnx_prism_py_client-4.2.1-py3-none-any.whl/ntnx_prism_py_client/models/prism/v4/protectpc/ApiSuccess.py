...
class ApiSuccess(object):
    ...
    :param message: (:attr:`message`) The success message field where the success response message will be put.
    :type message: 
    ...
    def _initialize_object_type(self):
        return 'prism.v4.protectpc.ApiSuccess'
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ApiSuccess):
            return False
