...
class RpoConfig(object):
    ...
    def __init__(self, rpo_seconds=None, *args, **kwargs):  # noqa: E501
    ...
    def _initialize_object_type(self):
        return 'prism.v4.protectpc.RpoConfig'
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RpoConfig):
            return False
