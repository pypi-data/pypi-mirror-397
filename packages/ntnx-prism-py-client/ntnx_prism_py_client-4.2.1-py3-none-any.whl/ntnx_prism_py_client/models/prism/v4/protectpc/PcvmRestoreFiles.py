...
from ntnx_prism_py_client.models.prism.v4.protectpc.PcvmRestoreFile import PcvmRestoreFile  # noqa: F401,E501

class PcvmRestoreFiles(object):

    """List of files to be restored in new PC. 

    :param file_list: (:attr:`file_list`) 
    :type file_list: 
    ...
    """  # noqa: E501
    swagger_types = {
        'file_list': 'list[prism.v4.protectpc.PcvmRestoreFile]',
    ...
    def __init__(self, file_list=None, *args, **kwargs):  # noqa: E501
    ...
    def _initialize_object_type(self):
        return 'prism.v4.protectpc.PcvmRestoreFiles'
    ...
    def file_list(self):
        ...
        :type:
             list[ :class:`~ntnx_prism_py_client.models.prism.v4.protectpc.PcvmRestoreFile` ]
        """  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(PcvmRestoreFiles, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PcvmRestoreFiles):
            return False
