...
class AuthMetadata(object):

    """An Object capturing metadata related to authentication and authorization. 

    :param auth_token: (:attr:`auth_token`) An Auth token generated to be compatible with Component Registry. In request it will be auth token of client and likewise in reponse it will be of PC component. 
    :type auth_token: 
    ...
    def __init__(self, auth_token=None, *args, **kwargs):  # noqa: E501
    ...
    def _initialize_object_type(self):
        return 'prism.v4.trust.AuthMetadata'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(AuthMetadata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AuthMetadata):
            return False
