...
from ntnx_prism_py_client.models.prism.v4.config.PureStorageFlashArrayPod import PureStorageFlashArrayPod  # noqa: F401,E501

class PureStorageFlashArrayConfig(object):
    ...
    :param id: (:attr:`id`) Unique identifier for the Pure Storage FlashArray.
    :type id: 
    ...
    swagger_types = {
        ...
        'id': 'str',
        'pod': 'prism.v4.config.PureStorageFlashArrayPod',
    ...
    def __init__(self, address=None, id=None, pod=None, *args, **kwargs):  # noqa: E501
        self.__address = None
        self.__id = None
        self.__pod = None
    ...
    def _initialize_object_type(self):
        return 'prism.v4.config.PureStorageFlashArrayConfig'
    ...
    def pod(self):
        ...
        :type:
            :class:`~ntnx_prism_py_client.models.prism.v4.config.PureStorageFlashArrayPod`
        """  # noqa: E501
        return self.__pod
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(PureStorageFlashArrayConfig, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PureStorageFlashArrayConfig):
            return False
