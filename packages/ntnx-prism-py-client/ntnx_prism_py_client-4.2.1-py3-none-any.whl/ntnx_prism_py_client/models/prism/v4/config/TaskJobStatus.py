...
class TaskJobStatus(object):
    ...
    Allowed enum values:
        ...
        - _UNKNOWN
        - _REDACTED
        - PENDING: Status indicating that the job is in pending state.
        - SUCCEEDED: Status indicating that the job has been executed and is successful.
        - FAILED: Status indicating that the job has been executed and has failed.
    """
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    PENDING = "PENDING"
    ...
    def _initialize_object_type(self):
        return 'prism.v4.config.TaskJobStatus'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(TaskJobStatus, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TaskJobStatus):
            return False
