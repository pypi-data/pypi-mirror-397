...
class Category(ExternalizableAbstractModel):
    ...
    def key(self):
        """
        The key of a category when it is represented in `key:value` format.  Constraints applicable when field is given in the payload during create and update: * A string of maxlength of 64 * First character must NOT be any of: `$` `/` `,` `!` `\"` `#` `%` `'` `(` `)` `*` `+` `:` `;` `=` `?` `\\` `|` `[` `]` `^` `&` * Remaining characters (0–63) must NOT include: `/` `,` `!` `\"` `#` `%` `'` `(` `)` `*` `+` `:` `;` `=` `?` `\\` `|` `[` `]` `^` `&` * Note: `$` is allowed after the first character  It is a mandatory field in the payload of `createCategory` and `updateCategoryById` APIs.<br> This field can't be updated through `updateCategoryById` API. 
    ...
    def value(self):
        """
        The value of a category when it is represented in `key:value` format.  Constraints applicable when the field is given in the payload during create and update: * A string of max length 64 * First character must NOT be any of: `$` `/` `,` `!` `\"` `#` `%` `'` `(` `)` `*` `+` `:` `;` `=` `?` `\\` `|` `[` `]` `^` `&` * Remaining characters (0–63) must NOT include: `/` `,` `!` `\"` `#` `%` `'` `(` `)` `*` `+` `:` `;` `=` `?` `\\` `|` `[` `]` `^` `&` * Note: `$` is allowed after the first character  It is a mandatory input field in the payload of `createCategory` and `updateCategoryById` APIs.<br> This field can be updated through `updateCategoryById` API.<br> Updating the value will not change the extId of the category. 
