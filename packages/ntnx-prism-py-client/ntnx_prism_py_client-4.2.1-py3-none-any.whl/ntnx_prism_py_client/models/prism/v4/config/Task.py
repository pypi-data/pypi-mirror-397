...
from ntnx_prism_py_client.models.prism.v4.config.ResourceLink import ResourceLink  # noqa: F401,E501
from ntnx_prism_py_client.models.prism.v4.config.TaskBatchSummary import TaskBatchSummary  # noqa: F401,E501
...
class Task(object):
    ...
    :param operation: (:attr:`operation`) The name of the operation being tracked by the task.
    :type operation: 
    
    
    :param operation_description: (:attr:`operation_description`) Description of the operation tracked by the task.
    ...
    :param sub_tasks: (:attr:`sub_tasks`) Reference to tasks spawned as children of the current task. The Task Get API operation response would contain a limited number of subtask references. To retrieve the full list of subtasks for a task, use the parent task filter in the Task List API operation.
    :type sub_tasks: 
    ...
    :param is_cancelable: (:attr:`is_cancelable`) Indicates whether the task can be canceled.
    :type is_cancelable: 
    ...
    :param completion_details: (:attr:`completion_details`) Additional details about the task to help the user take further action after the task is completed.
    :type completion_details: 
    
    
    :param error_messages: (:attr:`error_messages`) Error details that explain a task failure. These would only be populated if a task failed.
    :type error_messages: 
    
    
    :param legacy_error_message: (:attr:`legacy_error_message`) Provides an error message in the absence of a well-defined error message for tasks created by legacy APIs.
    :type legacy_error_message: 
    
    
    :param warnings: (:attr:`warnings`) Warning messages to alert the user of issues which did not directly cause the task to fail.. These can be populated for any task.
    :type warnings: 
    ...
    :param is_background_task: (:attr:`is_background_task`) Indicates whether or not the task is a background task.
    ...
    :param resource_links: (:attr:`resource_links`) Reference to resources associated with the task.
    :type resource_links: 
    
    
    :param app_name: (:attr:`app_name`) Name of the application to which the task belongs.
    :type app_name: 
     max=128 chars
    
    :param batch_summary: (:attr:`batch_summary`) 
    :type batch_summary: 
    ...
    swagger_types = {
        ...
        'resource_links': 'list[prism.v4.config.ResourceLink]',
        'app_name': 'str',
        'batch_summary': 'prism.v4.config.TaskBatchSummary',
    ...
    def __init__(self, ext_id=None, operation=None, operation_description=None, parent_task=None, created_time=None, started_time=None, completed_time=None, status=None, progress_percentage=None, entities_affected=None, sub_tasks=None, sub_steps=None, is_cancelable=None, owned_by=None, completion_details=None, error_messages=None, legacy_error_message=None, warnings=None, last_updated_time=None, cluster_ext_ids=None, root_task=None, is_background_task=None, number_of_subtasks=None, number_of_entities_affected=None, resource_links=None, app_name=None, batch_summary=None, *args, **kwargs):  # noqa: E501
        ...
        self.__resource_links = None
        self.__app_name = None
        self.__batch_summary = None
        ...
        if resource_links is not None:
            self.__resource_links = resource_links
        if app_name is not None:
            self.__app_name = app_name
        if batch_summary is not None:
            self.__batch_summary = batch_summary
    ...
    def resource_links(self):
        ...
        :type:
             list[ :class:`~ntnx_prism_py_client.models.prism.v4.config.ResourceLink` ]
        """  # noqa: E501
        return self.__resource_links
    ...
    def app_name(self, app_name):
        if app_name is not None and len(app_name) > 128:
            raise ValueError("Invalid value for `app_name`, length must be less than or equal to `128`")  # noqa: E501
    ...
    def batch_summary(self):
        ...
        :type:
            :class:`~ntnx_prism_py_client.models.prism.v4.config.TaskBatchSummary`
        """  # noqa: E501
        return self.__batch_summary
