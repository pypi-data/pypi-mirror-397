...
class AssociationDetailOld(CategoryAssociationSummaryOld):
    ...
    def __init__(self, resource_references=None, category_id=None, resource_type=None, resource_group=None, count=None, *args, **kwargs):  # noqa: E501
        ...
        self.__resource_references = None
        self.discriminator = None
        if resource_references is not None:
            self.__resource_references = resource_references

    def _initialize_object_type(self):
        return 'prism.v4.config.AssociationDetailOld'
    ...
    def resource_references(self):
        ...
        :type:
             list[ :class:`~ntnx_prism_py_client.models.prism.v4.config.Reference` ]
        """  # noqa: E501
        return self.__resource_references
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(AssociationDetailOld, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AssociationDetailOld):
            return False
