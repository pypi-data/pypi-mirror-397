...
class CategoryAssociationSummaryOld(object):
    ...
    def _initialize_object_type(self):
        return 'prism.v4.config.CategoryAssociationSummaryOld'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(CategoryAssociationSummaryOld, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CategoryAssociationSummaryOld):
            return False
