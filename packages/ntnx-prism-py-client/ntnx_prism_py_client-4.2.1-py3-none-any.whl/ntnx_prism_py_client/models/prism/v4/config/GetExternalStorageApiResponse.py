...
from ntnx_prism_py_client.models.OneOfprism.v4.config.GetExternalStorageApiResponsedata import GetExternalStorageApiResponsedata  # noqa: F401,E501
from ntnx_prism_py_client.models.common.v1.response.ApiResponseMetadata import ApiResponseMetadata  # noqa: F401,E501

class GetExternalStorageApiResponse(object):
    ...
    swagger_types = {
        ...
        'data': 'OneOfprism.v4.config.GetExternalStorageApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'prism.v4.config.GetExternalStorageApiResponse'
    ...
    def data(self):
        ...
        :type:
                :class:`~ntnx_prism_py_client.models.prism.v4.config.ExternalStorage` | 
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetExternalStorageApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetExternalStorageApiResponse):
            return False
