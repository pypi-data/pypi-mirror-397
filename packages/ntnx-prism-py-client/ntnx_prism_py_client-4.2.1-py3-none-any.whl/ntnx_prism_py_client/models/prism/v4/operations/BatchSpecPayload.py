...
from ntnx_prism_py_client.models.prism.v4.operations.BatchSpecPayloadMetadata import BatchSpecPayloadMetadata  # noqa: F401,E501

class BatchSpecPayload(object):
    ...
    :param data: (:attr:`data`) The data section of the payload provided to the batch operation.
    :type data: 
    ...
    """  # noqa: E501
    swagger_types = {
        'metadata': 'prism.v4.operations.BatchSpecPayloadMetadata',
    ...
    def _initialize_object_type(self):
        return 'prism.v4.operations.BatchSpecPayload'
    ...
    def metadata(self):
        ...
        :type:
            :class:`~ntnx_prism_py_client.models.prism.v4.operations.BatchSpecPayloadMetadata`
        """  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(BatchSpecPayload, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchSpecPayload):
            return False
