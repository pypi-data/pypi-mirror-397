...
class BatchSpecPayloadMetadataPath(object):

    """The metadata section on the input specification for performing the batch operation.

    :param name: (:attr:`name`) The name of the  path parameter.
    :type name: required
     max=256 chars
    
    :param value: (:attr:`value`) The value of the  path parameter.
    :type value: required
    ...
    def _initialize_object_type(self):
        return 'prism.v4.operations.BatchSpecPayloadMetadataPath'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(BatchSpecPayloadMetadataPath, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchSpecPayloadMetadataPath):
            return False
