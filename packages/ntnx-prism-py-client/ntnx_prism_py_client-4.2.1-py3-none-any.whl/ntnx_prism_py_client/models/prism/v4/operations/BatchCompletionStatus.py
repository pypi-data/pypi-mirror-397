...
class BatchCompletionStatus(object):
    ...
    def _initialize_object_type(self):
        return 'prism.v4.operations.BatchCompletionStatus'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(BatchCompletionStatus, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchCompletionStatus):
            return False
