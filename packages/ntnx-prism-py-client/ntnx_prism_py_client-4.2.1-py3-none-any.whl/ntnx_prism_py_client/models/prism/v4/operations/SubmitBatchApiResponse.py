...
from ntnx_prism_py_client.models.OneOfprism.v4.operations.SubmitBatchApiResponsedata import SubmitBatchApiResponsedata  # noqa: F401,E501
from ntnx_prism_py_client.models.common.v1.response.ApiResponseMetadata import ApiResponseMetadata  # noqa: F401,E501

class SubmitBatchApiResponse(object):
    ...
    swagger_types = {
        ...
        'data': 'OneOfprism.v4.operations.SubmitBatchApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'prism.v4.operations.SubmitBatchApiResponse'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(SubmitBatchApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SubmitBatchApiResponse):
            return False
