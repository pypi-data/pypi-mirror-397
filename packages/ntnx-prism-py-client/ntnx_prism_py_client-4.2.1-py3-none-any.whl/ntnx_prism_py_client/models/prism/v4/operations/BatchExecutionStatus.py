...
class BatchExecutionStatus(object):
    ...
    def _initialize_object_type(self):
        return 'prism.v4.operations.BatchExecutionStatus'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(BatchExecutionStatus, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchExecutionStatus):
            return False
