...
class CloudSubstrateType(object):
    ...
    Allowed enum values:
        ...
        - _UNKNOWN
        - _REDACTED
        - AWS: Network controller in AWS substrate
        - AZURE: Network controller in AZURE substrate
        - GCP: Network controller in GCP substrate
    """
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    AWS = "AWS"
    ...
    def _initialize_object_type(self):
        return 'prism.v4.management.CloudSubstrateType'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(CloudSubstrateType, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CloudSubstrateType):
            return False
