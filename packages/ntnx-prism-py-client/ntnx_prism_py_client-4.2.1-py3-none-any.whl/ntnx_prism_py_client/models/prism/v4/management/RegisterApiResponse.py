...
from ntnx_prism_py_client.models.OneOfprism.v4.management.RegisterApiResponsedata import RegisterApiResponsedata  # noqa: F401,E501
from ntnx_prism_py_client.models.common.v1.response.ApiResponseMetadata import ApiResponseMetadata  # noqa: F401,E501

class RegisterApiResponse(object):

    """REST response for all response codes in API path /prism/v4.2/management/domain-managers/{extId}/$actions/register Post operation
    ...
    swagger_types = {
        ...
        'data': 'OneOfprism.v4.management.RegisterApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'prism.v4.management.RegisterApiResponse'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(RegisterApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RegisterApiResponse):
            return False
