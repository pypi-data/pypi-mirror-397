...
class DomainManagerCloudType(object):
    ...
    Allowed enum values:
        ...
        - _UNKNOWN
        - _REDACTED
        - ONPREM_CLOUD: A domain manager (Prism Central) instance which can be reached through a physical address.
        - NUTANIX_HOSTED_CLOUD: A domain manager (Prism Central) instance which is accessed through a My Nutanix credentials.
    """
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    ONPREM_CLOUD = "ONPREM_CLOUD"
    NUTANIX_HOSTED_CLOUD = "NUTANIX_HOSTED_CLOUD"
    ...
    def _initialize_object_type(self):
        return 'prism.v4.management.DomainManagerCloudType'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(DomainManagerCloudType, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DomainManagerCloudType):
            return False
