...
class EnablementState(object):
    ...
    Allowed enum values:
        ...
        - _UNKNOWN
        - _REDACTED
        - DISABLED: Product state is disabled.
        - ENABLED: Product state is enabled.
    """
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    DISABLED = "DISABLED"
    ...
    def _initialize_object_type(self):
        return 'prism.v4.management.EnablementState'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(EnablementState, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EnablementState):
            return False
