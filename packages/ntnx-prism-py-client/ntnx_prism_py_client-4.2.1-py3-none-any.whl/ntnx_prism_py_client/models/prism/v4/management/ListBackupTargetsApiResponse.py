...
from ntnx_prism_py_client.models.OneOfprism.v4.management.ListBackupTargetsApiResponsedata import ListBackupTargetsApiResponsedata  # noqa: F401,E501
from ntnx_prism_py_client.models.common.v1.response.ApiResponseMetadata import ApiResponseMetadata  # noqa: F401,E501

class ListBackupTargetsApiResponse(object):

    """REST response for all response codes in API path /prism/v4.2/management/domain-managers/{domainManagerExtId}/backup-targets Get operation
    ...
    swagger_types = {
        ...
        'data': 'OneOfprism.v4.management.ListBackupTargetsApiResponsedata',
    ...
    def data(self):
        ...
        :type:
                :class:`~ntnx_prism_py_client.models.prism.v4.management.BackupTarget` | 
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListBackupTargetsApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListBackupTargetsApiResponse):
            return False
