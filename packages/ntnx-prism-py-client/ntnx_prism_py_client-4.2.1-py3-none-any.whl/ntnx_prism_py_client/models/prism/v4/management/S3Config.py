...
class S3Config(object):
    ...
    :param bucket_name: (:attr:`bucket_name`) The bucket name of the object store endpoint where the backup data of the domain manager is stored. 
    :type bucket_name: required
     min=3 chars, max=63 chars
    
    :param region: (:attr:`region`) The region name of the object store endpoint where the backup data of the domain manager is stored.  (**Default** 'us-east-1')
    :type region: 
     max=63 chars
    ...
    def __init__(self, bucket_name=None, region='us-east-1', *args, **kwargs):  # noqa: E501
    ...
    def region(self, region):
        if region is not None and len(region) > 63:
            raise ValueError("Invalid value for `region`, length must be less than or equal to `63`")  # noqa: E501
