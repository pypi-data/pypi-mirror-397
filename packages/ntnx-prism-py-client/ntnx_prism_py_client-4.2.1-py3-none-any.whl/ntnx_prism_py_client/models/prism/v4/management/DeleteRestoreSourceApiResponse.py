...
from ntnx_prism_py_client.models.OneOfprism.v4.management.DeleteRestoreSourceApiResponsedata import DeleteRestoreSourceApiResponsedata  # noqa: F401,E501
from ntnx_prism_py_client.models.common.v1.response.ApiResponseMetadata import ApiResponseMetadata  # noqa: F401,E501

class DeleteRestoreSourceApiResponse(object):

    """REST response for all response codes in API path /prism/v4.2/management/restore-sources/{extId} Delete operation
    ...
    swagger_types = {
        ...
        'data': 'OneOfprism.v4.management.DeleteRestoreSourceApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'prism.v4.management.DeleteRestoreSourceApiResponse'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(DeleteRestoreSourceApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteRestoreSourceApiResponse):
            return False
