...
class GenericMetadata(object):
    ...
    """Generic key-value pair metadata model for products enablement/disablement workflow.
    ...
    """  # noqa: E501
    swagger_types = {
        'attributes': 'list[common.v1.config.KVPair]',
    ...
    def __init__(self, attributes=None, *args, **kwargs):  # noqa: E501
    ...
    def _initialize_object_type(self):
        return 'prism.v4.management.GenericMetadata'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GenericMetadata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GenericMetadata):
            return False
