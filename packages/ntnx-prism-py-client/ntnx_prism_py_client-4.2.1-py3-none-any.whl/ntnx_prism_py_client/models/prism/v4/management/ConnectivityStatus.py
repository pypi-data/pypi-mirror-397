...
class ConnectivityStatus(object):
    ...
    """The connectivity status of the registered remote cluster. It can be one of the following - CONNECTED, DISCONNECTED, or UNKNOWN.
    ...
    Allowed enum values:
        ...
        - _UNKNOWN
        - _REDACTED
        - CONNECTED: Registered remote cluster is reachable.
        - DISCONNECTED: Registered remote cluster is not reachable.
        - PENDING: The connectivity status of the registered remote cluster is not known currently. Try again after some time.
    """
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    CONNECTED = "CONNECTED"
    ...
    def _initialize_object_type(self):
        return 'prism.v4.management.ConnectivityStatus'
