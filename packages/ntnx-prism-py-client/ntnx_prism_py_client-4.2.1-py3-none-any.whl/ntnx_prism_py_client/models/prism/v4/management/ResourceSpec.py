...
class ResourceSpec(object):
    ...
    :param cpu_count: (:attr:`cpu_count`) Indicates the number of additional virtual CPUs to be added for a given portfolio product.
    :type cpu_count: 
    
    
    :param memory_size_bytes: (:attr:`memory_size_bytes`) Indicates the memory to be added for a given portfolio product in bytes.
    ...
    def __init__(self, cpu_count=None, memory_size_bytes=None, *args, **kwargs):  # noqa: E501
    ...
    def _initialize_object_type(self):
        return 'prism.v4.management.ResourceSpec'
