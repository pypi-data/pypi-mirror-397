...
from ntnx_prism_py_client.models.prism.v4.management.AccessKeyCredentials import AccessKeyCredentials  # noqa: F401,E501
from ntnx_prism_py_client.models.prism.v4.management.S3Config import S3Config  # noqa: F401,E501

class AWSS3Config(S3Config):
    ...
    """  # noqa: E501
    swagger_types = {
        'credentials': 'prism.v4.management.AccessKeyCredentials',
        'bucket_name': 'str',
        'region': 'str',
    ...
    def __init__(self, credentials=None, bucket_name=None, region='us-east-1', *args, **kwargs):  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(AWSS3Config, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AWSS3Config):
            return False
