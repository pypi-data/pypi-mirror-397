...
class DBConfigStorage(ConfigStorageBase):
    def create_table_if_needed(self, engine, table_name="app_configs"):
        ...
        if not engine.dialect.has_table(engine, table_name):
            ...
            self.logger.warning(f"Table {table_name} was created")

    def __init__(self, session_factory, table, key_column: str, value_column: str, config_id=None,
                 auto_reload: bool = False, service_name: str = None, updated_at_column: str = "updated_at",
                 engine=None, logger: LoggerType | None = None, create_table: bool = False):
    ...
    def load(self) -> dict:
        with self.session_factory() as session:
            ...
            self.logger.info("Config fetched successfully from database")
    ...
    def save(self, data: dict):
        with self.session_factory() as session:
            ...
            self.logger.info("Config saved successfully to database")
