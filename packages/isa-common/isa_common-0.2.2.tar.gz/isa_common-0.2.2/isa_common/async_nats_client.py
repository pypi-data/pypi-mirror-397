...
class AsyncNATSClient(AsyncBaseGRPCClient):
    ...
    async def create_consumer(
        ...
        Args:
            ...
            delivery_policy: Delivery policy - 'all' (default), 'new', or 'last'
                - 'all': Deliver all messages in the stream
                - 'new': Deliver only new messages (published after consumer creation)
                - 'last': Deliver starting from the last message
        ...
        try:
            ...
            # Map string delivery_policy to proto enum
            delivery_policy_map = {
                'all': nats_service_pb2.DELIVERY_ALL,
                'new': nats_service_pb2.DELIVERY_NEW,
                'last': nats_service_pb2.DELIVERY_LAST,
            }
            proto_delivery_policy = delivery_policy_map.get(
                delivery_policy.lower(),
                nats_service_pb2.DELIVERY_ALL
            )
            ...
            config = nats_service_pb2.ConsumerConfig(
                ...
                delivery_policy=proto_delivery_policy,
