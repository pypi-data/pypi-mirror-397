...
# *********** EXPORTED PROFILE FROM SDK VERSION 21.188 ON 2025-12-17 ***********
# ********* PARSED 199 TYPES (4326 VALUES), 123 MESSAGES (1396 FIELDS) *********
...
FIELD_TYPES = {
    ...
    'sleep_disruption_severity': FieldType(
        name='sleep_disruption_severity',
        base_type=BASE_TYPES[0x00],  # enum
        values={
            0: 'none',
            1: 'low',
...
MESSAGE_TYPES = {
    ...
    470: MessageType(
        ...
        fields={
            0: Field(
                name='severity',
                type=FIELD_TYPES['sleep_disruption_severity'],
                def_num=0,
            ),
            253: FIELD_TYPE_TIMESTAMP,
            254: Field(
