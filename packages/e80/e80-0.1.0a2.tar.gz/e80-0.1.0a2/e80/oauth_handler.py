...
def start_oauth_flow(env: CLIEnvironment, verbose: bool):
    ...
    oauth_url = f"{env.platform_host}/accounts/login/oauth"
    ...
    OAuthHandler.platform_host = env.platform_host
    OAuthHandler.verbose = verbose
