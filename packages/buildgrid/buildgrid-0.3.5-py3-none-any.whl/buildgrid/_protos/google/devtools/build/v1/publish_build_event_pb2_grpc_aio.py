...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in google/devtools/build/v1/publish_build_event_pb2_grpc.py depends on'
...
def add_PublishBuildEventServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('google.devtools.build.v1.PublishBuildEvent', rpc_method_handlers)
