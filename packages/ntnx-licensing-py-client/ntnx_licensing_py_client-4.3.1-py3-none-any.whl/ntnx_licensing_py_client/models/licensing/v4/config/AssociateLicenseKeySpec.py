...
class AssociateLicenseKeySpec(object):
    ...
    def _initialize_object_type(self):
        return 'licensing.v4.config.AssociateLicenseKeySpec'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(AssociateLicenseKeySpec, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AssociateLicenseKeySpec):
            return False
