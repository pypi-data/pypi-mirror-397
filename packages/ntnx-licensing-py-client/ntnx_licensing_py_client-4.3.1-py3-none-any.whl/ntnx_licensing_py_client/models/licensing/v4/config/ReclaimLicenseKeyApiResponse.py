...
from ntnx_licensing_py_client.models.OneOflicensing.v4.config.ReclaimLicenseKeyApiResponsedata import ReclaimLicenseKeyApiResponsedata  # noqa: F401,E501
from ntnx_licensing_py_client.models.common.v1.response.ApiResponseMetadata import ApiResponseMetadata  # noqa: F401,E501

class ReclaimLicenseKeyApiResponse(object):

    """REST response for all response codes in API path /licensing/v4.3/config/license-keys/{extId}/$actions/reclaim Post operation
    ...
    swagger_types = {
        ...
        'data': 'OneOflicensing.v4.config.ReclaimLicenseKeyApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'licensing.v4.config.ReclaimLicenseKeyApiResponse'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ReclaimLicenseKeyApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ReclaimLicenseKeyApiResponse):
            return False
