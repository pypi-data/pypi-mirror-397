...
class ReclaimLicenseKeyApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOflicensing.v4.config.ReclaimLicenseKeyApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ReclaimLicenseKeyApiResponsedata.discriminator_value_class_map.values():
            return list(ReclaimLicenseKeyApiResponsedata.discriminator_value_class_map.keys())[list(ReclaimLicenseKeyApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ReclaimLicenseKeyApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ReclaimLicenseKeyApiResponsedata):
            return False
