...
from ntnx_licensing_py_client.models.OneOflicensing.v4.config.AssociateLicenseKeysApiResponsedata import AssociateLicenseKeysApiResponsedata  # noqa: F401,E501
from ntnx_licensing_py_client.models.common.v1.response.ApiResponseMetadata import ApiResponseMetadata  # noqa: F401,E501

class AssociateLicenseKeysApiResponse(object):
    ...
    swagger_types = {
        ...
        'data': 'OneOflicensing.v4.config.AssociateLicenseKeysApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'licensing.v4.config.AssociateLicenseKeysApiResponse'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(AssociateLicenseKeysApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AssociateLicenseKeysApiResponse):
            return False
