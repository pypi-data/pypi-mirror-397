...
class ReclaimLicenseKeySpec(object):

    """Model for capturing attributes required for reclaim.

    :param quantity: (:attr:`quantity`) Attribute for capturing license key quantity for reclaim.
    ...
    def __init__(self, quantity=None, *args, **kwargs):  # noqa: E501
    ...
    def _initialize_object_type(self):
        return 'licensing.v4.config.ReclaimLicenseKeySpec'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ReclaimLicenseKeySpec, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ReclaimLicenseKeySpec):
            return False
