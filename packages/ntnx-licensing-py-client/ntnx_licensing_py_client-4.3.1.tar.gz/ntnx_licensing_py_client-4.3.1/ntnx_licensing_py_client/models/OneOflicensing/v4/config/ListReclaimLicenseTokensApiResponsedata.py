...
class ListReclaimLicenseTokensApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<licensing.v4.config.ReclaimLicenseToken>': 'list[licensing.v4.config.ReclaimLicenseToken]',
        'licensing.v4.error.ErrorResponse': 'licensing.v4.error.ErrorResponse',
        'List<licensing.v4.config.ReclaimLicenseTokenProjection>': 'list[licensing.v4.config.ReclaimLicenseTokenProjection]'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOflicensing.v4.config.ListReclaimLicenseTokensApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListReclaimLicenseTokensApiResponsedata.discriminator_value_class_map.values():
            return list(ListReclaimLicenseTokensApiResponsedata.discriminator_value_class_map.keys())[list(ListReclaimLicenseTokensApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListReclaimLicenseTokensApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListReclaimLicenseTokensApiResponsedata):
            return False
