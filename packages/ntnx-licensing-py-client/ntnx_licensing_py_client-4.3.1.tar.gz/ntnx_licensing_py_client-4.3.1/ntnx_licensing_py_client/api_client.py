...
class ApiClient(object):
    ...
    # Populated if multiple schemas exist with the same name
        ...
        'licensing.v4.config.AssociateLicenseKeySpec' : 'AssociateLicenseKeySpec',
        ...
        'licensing.v4.config.AssociateLicenseKeysApiResponse' : 'AssociateLicenseKeysApiResponse',
        ...
        'OneOflicensing.v4.config.AssociateLicenseKeysApiResponsedata' : 'AssociateLicenseKeysApiResponsedata',
        ...
        'licensing.v4.config.ReclaimLicenseKeySpec' : 'ReclaimLicenseKeySpec',
        'licensing.v4.config.ReclaimLicenseToken' : 'ReclaimLicenseToken',
        ...
        'OneOflicensing.v4.config.ListReclaimLicenseTokensApiResponsedata' : 'ListReclaimLicenseTokensApiResponsedata',
        ...
        'licensing.v4.config.ListReclaimLicenseTokensApiResponse' : 'ListReclaimLicenseTokensApiResponse',
        ...
        'licensing.v4.config.ReclaimLicenseKeyApiResponse' : 'ReclaimLicenseKeyApiResponse',
        ...
        'OneOflicensing.v4.config.ReclaimLicenseKeyApiResponsedata' : 'ReclaimLicenseKeyApiResponsedata',
        ...
        'licensing.v4.config.ReclaimLicenseTokenProjection' : 'ReclaimLicenseTokenProjection',
    ...
    def negotiate_version(self, auth_settings):
        ...
        """
        try:
            response = self.__call_api('/api/licensing/unversioned/info', 'OPTIONS',
                                        response_type = 'object', auth_settings = auth_settings)
            if response is not None and "data" in response:
                server_version = response["data"]
                minimum_supported_version = "v4.3"
                ...
                self.negotiated_version = None
                self.configuration.negotiation_completed = False
        except ntnx_licensing_py_client.rest.ApiException as e:
