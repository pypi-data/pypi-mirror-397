...
class TenantPublicKey(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "created", "created_by_id", "tenant_id", "public_key"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TenantPublicKey from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TenantPublicKey from a dict"""
        if obj is None:
            return None
