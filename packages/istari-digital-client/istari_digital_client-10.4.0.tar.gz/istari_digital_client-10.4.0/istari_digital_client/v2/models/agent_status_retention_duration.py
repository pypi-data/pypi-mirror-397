...
class AgentStatusRetentionDuration(BaseModel):
    """
    AgentStatusRetentionDuration
    """ # noqa: E501
    id: StrictStr
    created: datetime
    retention_days: Optional[StrictInt] = 4
    created_by_id: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["id", "created", "retention_days", "created_by_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AgentStatusRetentionDuration from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "retention_days": obj.get("retention_days") if obj.get("retention_days") is not None else 4,
