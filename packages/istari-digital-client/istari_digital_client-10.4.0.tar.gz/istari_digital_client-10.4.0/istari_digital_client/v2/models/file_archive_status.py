...
class FileArchiveStatus(BaseModel):
    """
    FileArchiveStatus
    """ # noqa: E501
    id: StrictStr
    ...
    file_id: StrictStr
    __properties: ClassVar[List[str]] = ["id", "created", "name", "reason", "created_by_id", "file_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FileArchiveStatus from a dict"""
        if obj is None:
            return None
