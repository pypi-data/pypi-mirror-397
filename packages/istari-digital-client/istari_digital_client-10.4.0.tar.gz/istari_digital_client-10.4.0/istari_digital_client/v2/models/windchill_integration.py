...
class WindchillIntegration(BaseModel):
    """
    WindchillIntegration
    """ # noqa: E501
    description: Optional[StrictStr] = None
    integration_type: Optional[StrictStr] = 'windchill'
    ...
    def integration_type_validate_enum(cls, value):
        ...
        if value not in set(['windchill']):
            raise ValueError("must be one of enum values ('windchill')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WindchillIntegration from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "integration_type": obj.get("integration_type") if obj.get("integration_type") is not None else 'windchill'
        })
        return _obj
