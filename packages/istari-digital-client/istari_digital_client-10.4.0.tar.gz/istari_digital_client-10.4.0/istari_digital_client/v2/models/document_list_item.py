...
class DocumentListItem(BaseModel):
    """
    Document class with minimal data for list operations.
    """ # noqa: E501
    id: StrictStr
    created: datetime
    file: File
    ...
    comment_ids: List[StrictStr]
    configuration_id: StrictStr
    __properties: ClassVar[List[str]] = ["id", "created", "file", "archive_status", "created_by_id", "comment_ids", "configuration_id"]
