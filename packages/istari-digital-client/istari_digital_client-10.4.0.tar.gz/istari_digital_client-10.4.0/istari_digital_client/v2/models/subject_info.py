...
class SubjectInfo(BaseModel):
    ...
    cross_tenant_user: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["username", "email", "cross_tenant_user"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        # set to None if cross_tenant_user (nullable) is None
        # and model_fields_set contains the field
        if self.cross_tenant_user is None and "cross_tenant_user" in self.model_fields_set:
            _dict['cross_tenant_user'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SubjectInfo from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "email": obj.get("email"),
            "cross_tenant_user": obj.get("cross_tenant_user")
        })
        return _obj
