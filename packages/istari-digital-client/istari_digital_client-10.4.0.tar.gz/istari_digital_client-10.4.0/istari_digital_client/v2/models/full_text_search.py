...
class FullTextSearch(BaseModel):
    ...
    """ # noqa: E501
    search_term: Annotated[str, Field(min_length=1, strict=True)] = Field(description="The search term.")
    page: Optional[StrictInt] = Field(default=1, description="The page number for pagination.")
    size: Optional[Annotated[int, Field(le=100, strict=True)]] = Field(default=10, description="The number of items per page.")
    __properties: ClassVar[List[str]] = ["search_term", "page", "size"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FullTextSearch from a dict"""
        if obj is None:
            return None
