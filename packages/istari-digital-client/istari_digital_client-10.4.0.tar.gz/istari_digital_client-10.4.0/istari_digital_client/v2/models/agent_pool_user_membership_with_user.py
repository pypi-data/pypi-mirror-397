...
class AgentPoolUserMembershipWithUser(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "created", "created_by_id", "user_id", "agent_pool_id", "user", "archive_status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AgentPoolUserMembershipWithUser from a dict"""
        if obj is None:
            return None
