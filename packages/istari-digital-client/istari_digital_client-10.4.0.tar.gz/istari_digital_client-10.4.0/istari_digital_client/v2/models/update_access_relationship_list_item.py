...
class UpdateAccessRelationshipListItem(BaseModel):
    """
    UpdateAccessRelationshipListItem
    """ # noqa: E501
    relation: AccessRelation
    resource_id: StrictStr
    __properties: ClassVar[List[str]] = ["relation", "resource_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateAccessRelationshipListItem from a dict"""
        if obj is None:
            return None
