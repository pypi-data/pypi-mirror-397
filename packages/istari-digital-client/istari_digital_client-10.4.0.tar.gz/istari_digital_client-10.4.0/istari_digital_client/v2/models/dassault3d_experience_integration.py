...
class Dassault3dExperienceIntegration(BaseModel):
    """
    Dassault3dExperienceIntegration
    """ # noqa: E501
    description: Optional[StrictStr] = None
    integration_type: Optional[StrictStr] = 'dassault_3d_experience'
    ...
    def integration_type_validate_enum(cls, value):
        ...
        if value not in set(['dassault_3d_experience']):
            raise ValueError("must be one of enum values ('dassault_3d_experience')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Dassault3dExperienceIntegration from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "integration_type": obj.get("integration_type") if obj.get("integration_type") is not None else 'dassault_3d_experience'
        })
        return _obj
