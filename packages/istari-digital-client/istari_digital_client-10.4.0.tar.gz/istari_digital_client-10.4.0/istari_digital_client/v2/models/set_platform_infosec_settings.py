...
class SetPlatformInfosecSettings(BaseModel):
    """
    SetPlatformInfosecSettings
    """ # noqa: E501
    enabled: StrictBool
    infosec_schema_type: InfosecSchemaTypes
    max_level: StrictInt
    default_resource_level: StrictInt
    __properties: ClassVar[List[str]] = ["enabled", "infosec_schema_type", "max_level", "default_resource_level"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SetPlatformInfosecSettings from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "infosec_schema_type": obj.get("infosec_schema_type"),
            "max_level": obj.get("max_level"),
            "default_resource_level": obj.get("default_resource_level")
        })
        return _obj
