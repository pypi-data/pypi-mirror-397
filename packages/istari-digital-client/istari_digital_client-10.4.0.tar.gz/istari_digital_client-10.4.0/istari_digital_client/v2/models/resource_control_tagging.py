...
class ResourceControlTagging(BaseModel):
    """
    ...
    object_id: StrictStr
    inherited_from_object_id: Optional[StrictStr] = None
    inherited_from_object_type: Optional[ControlTaggingObjectType] = None
    __properties: ClassVar[List[str]] = ["id", "created", "created_by_id", "control_tag", "status", "reason", "object_type", "object_id", "inherited_from_object_id", "inherited_from_object_type"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        # set to None if inherited_from_object_id (nullable) is None
        # and model_fields_set contains the field
        if self.inherited_from_object_id is None and "inherited_from_object_id" in self.model_fields_set:
            _dict['inherited_from_object_id'] = None

        # set to None if inherited_from_object_type (nullable) is None
        # and model_fields_set contains the field
        if self.inherited_from_object_type is None and "inherited_from_object_type" in self.model_fields_set:
            _dict['inherited_from_object_type'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ResourceControlTagging from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "inherited_from_object_id": obj.get("inherited_from_object_id"),
            "inherited_from_object_type": obj.get("inherited_from_object_type")
        })
        return _obj
