...
class ResourceArchiveStatus(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "created", "name", "reason", "created_by_id", "resource_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ResourceArchiveStatus from a dict"""
        if obj is None:
            return None
