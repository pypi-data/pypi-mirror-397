...
class FileRevisionArchiveStatus(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "created", "name", "reason", "created_by_id", "file_revision_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FileRevisionArchiveStatus from a dict"""
        if obj is None:
            return None
