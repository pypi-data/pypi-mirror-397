...
class NewJobAssignedAgentPool(BaseModel):
    """
    NewJobAssignedAgentPool
    """ # noqa: E501
    agent_pool_id: StrictStr
    __properties: ClassVar[List[str]] = ["agent_pool_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NewJobAssignedAgentPool from a dict"""
        if obj is None:
            return None
