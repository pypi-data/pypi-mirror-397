...
class UserControlTagging(BaseModel):
    """
    ...
    user_id: StrictStr
    __properties: ClassVar[List[str]] = ["id", "created", "created_by_id", "control_tag", "status", "reason", "user_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserControlTagging from a dict"""
        if obj is None:
            return None
