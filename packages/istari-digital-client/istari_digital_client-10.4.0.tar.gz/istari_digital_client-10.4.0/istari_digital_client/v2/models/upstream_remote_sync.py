...
class UpstreamRemoteSync(BaseModel):
    """
    ...
    upstream_remote_id: StrictStr
    status: UpstreamRemoteSyncStatus
    updated: datetime
    message: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["id", "created", "created_by_id", "upstream_remote_id", "status", "updated", "message"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpstreamRemoteSync from a dict"""
        if obj is None:
            return None
