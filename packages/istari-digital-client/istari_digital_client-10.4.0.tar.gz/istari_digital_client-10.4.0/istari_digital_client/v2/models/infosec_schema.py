...
class InfosecSchema(BaseModel):
    ...
    created: datetime
    name: StrictStr
    infosec_levels: List[InfosecLevel]
    __properties: ClassVar[List[str]] = ["id", "created", "name", "infosec_levels"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in infosec_levels (list)
        _items = []
        if self.infosec_levels:
            for _item_infosec_levels in self.infosec_levels:
                if _item_infosec_levels:
                    _items.append(_item_infosec_levels.to_dict())
            _dict['infosec_levels'] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InfosecSchema from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "infosec_levels": [InfosecLevel.from_dict(_item) for _item in obj["infosec_levels"]] if obj.get("infosec_levels") is not None else None
        })
        return _obj
