...
class AgentDisplayName(BaseModel):
    """
    AgentDisplayName
    """ # noqa: E501
    id: StrictStr
    ...
    __properties: ClassVar[List[str]] = ["id", "created", "agent_id", "display_name", "created_by_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AgentDisplayName from a dict"""
        if obj is None:
            return None
