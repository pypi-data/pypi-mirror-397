...
class ModuleVersionStatus(BaseModel):
    """
    ModuleVersionStatus
    """ # noqa: E501
    id: StrictStr
    ...
    __properties: ClassVar[List[str]] = ["id", "created", "created_by_id", "name", "reason", "module_version_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ModuleVersionStatus from a dict"""
        if obj is None:
            return None
