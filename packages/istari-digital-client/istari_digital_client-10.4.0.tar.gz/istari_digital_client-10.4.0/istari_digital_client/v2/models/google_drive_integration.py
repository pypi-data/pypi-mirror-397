...
class GoogleDriveIntegration(BaseModel):
    ...
    integration_type: Optional[StrictStr] = 'google_drive'
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleDriveIntegration from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "integration_type": obj.get("integration_type") if obj.get("integration_type") is not None else 'google_drive'
        })
        return _obj
