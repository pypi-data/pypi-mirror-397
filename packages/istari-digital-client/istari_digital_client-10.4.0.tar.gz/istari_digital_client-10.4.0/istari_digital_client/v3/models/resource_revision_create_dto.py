...
class ResourceRevisionCreateDto(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["content_token", "properties_token", "name", "extension", "size", "mime", "description", "version_name", "external_identifier", "display_name"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ResourceRevisionCreateDto from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ResourceRevisionCreateDto from a dict"""
        if obj is None:
            return None
