...
class NewTool(BaseModel):
    ...
    """ # noqa: E501
    name: StrictStr
    tool_versions: Optional[List[NewToolVersion]] = None
    __properties: ClassVar[List[str]] = ["name", "tool_versions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NewTool from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "tool_versions": [NewToolVersion.from_dict(_item) for _item in obj["tool_versions"]] if obj.get("tool_versions") is not None else None
        })
        return _obj
