...
class UpdateAccessRelationshipList(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateAccessRelationshipList from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "resources": [UpdateAccessRelationshipListItem.from_dict(_item) for _item in obj["resources"]] if obj.get("resources") is not None else None
        })
        return _obj
