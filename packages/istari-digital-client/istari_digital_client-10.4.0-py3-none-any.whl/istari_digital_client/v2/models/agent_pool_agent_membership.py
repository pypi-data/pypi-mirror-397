...
class AgentPoolAgentMembership(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "created", "created_by_id", "agent_id", "agent_pool_id", "archive_status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AgentPoolAgentMembership from a dict"""
        if obj is None:
            return None
