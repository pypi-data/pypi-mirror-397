...
class AssignInfosecLevel(BaseModel):
    """
    Assign a new info sec level.
    """ # noqa: E501
    infosec_level_id: StrictStr
    __properties: ClassVar[List[str]] = ["infosec_level_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AssignInfosecLevel from a dict"""
        if obj is None:
            return None
