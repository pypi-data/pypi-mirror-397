...
class PageTrackedFile(Pageable[TrackedFile]):
    ...
    This class represents a single page of :class:`TrackedFile` instances returned from
    a paginated API call. It includes pagination metadata such as page size, total count,
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "items": [TrackedFile.from_dict(_item) for _item in obj["items"]]
