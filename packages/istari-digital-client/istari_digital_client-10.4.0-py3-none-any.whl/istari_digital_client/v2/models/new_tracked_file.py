...
class NewTrackedFile(BaseModel):
    """
    NewTrackedFile
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["specifier_type", "file_id", "pinned_file_revision_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NewTrackedFile from a dict"""
        if obj is None:
            return None
