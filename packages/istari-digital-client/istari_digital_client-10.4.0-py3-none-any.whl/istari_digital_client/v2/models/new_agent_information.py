...
class NewAgentInformation(BaseModel):
    """
    NewAgentInformation
    """ # noqa: E501
    agent_version: StrictStr
    host_os: StrictStr
    __properties: ClassVar[List[str]] = ["agent_version", "host_os"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NewAgentInformation from a dict"""
        if obj is None:
            return None
