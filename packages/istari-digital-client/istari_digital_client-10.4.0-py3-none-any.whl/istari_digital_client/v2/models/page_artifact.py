...
class PageArtifact(Pageable[Artifact], ClientHaving):
    """
    A paginated response object for listing artifacts.

    This class represents a page of :class:`Artifact` results retrieved from the API.
    It includes pagination metadata such as page number, size, and total count,
    and provides access to the artifact items returned in the current page.
    """
