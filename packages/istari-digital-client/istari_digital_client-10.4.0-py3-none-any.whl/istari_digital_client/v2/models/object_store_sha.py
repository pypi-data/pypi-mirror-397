...
class ObjectStoreSha(BaseModel):
    """
    :class:`ObjectStoreSha` is a subclass of :class:`Base` and represents where a file is stored.
    """ # noqa: E501
    id: StrictStr
    created: datetime
    sha: StrictStr
    object_store_id: StrictStr
    __properties: ClassVar[List[str]] = ["id", "created", "sha", "object_store_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ObjectStoreSha from a dict"""
        if obj is None:
            return None
