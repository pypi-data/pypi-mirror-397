...
class NewAgentStatusRetentionDuration(BaseModel):
    """
    NewAgentStatusRetentionDuration
    """ # noqa: E501
    retention_days: StrictInt
    __properties: ClassVar[List[str]] = ["retention_days"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NewAgentStatusRetentionDuration from a dict"""
        if obj is None:
            return None
