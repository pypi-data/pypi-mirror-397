...
class InfosecLevel(BaseModel):
    """
    Infosec levels returned by API queries.
    """ # noqa: E501
    id: StrictStr
    created: datetime
    schema_id: StrictStr
    name: StrictStr
    order: StrictInt
    display_color: StrictStr
    __properties: ClassVar[List[str]] = ["id", "created", "schema_id", "name", "order", "display_color"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InfosecLevel from a dict"""
        if obj is None:
            return None
