...
class TeamworkCloudIntegration(BaseModel):
    """
    TeamworkCloudIntegration
    """ # noqa: E501
    description: Optional[StrictStr] = None
    integration_data: TeamworkCloudData
    integration_type: Optional[StrictStr] = 'teamwork_cloud'
    ...
    def integration_type_validate_enum(cls, value):
        ...
        if value not in set(['teamwork_cloud']):
            raise ValueError("must be one of enum values ('teamwork_cloud')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TeamworkCloudIntegration from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "integration_data": TeamworkCloudData.from_dict(obj["integration_data"]) if obj.get("integration_data") is not None else None,
            "integration_type": obj.get("integration_type") if obj.get("integration_type") is not None else 'teamwork_cloud'
        })
        return _obj
