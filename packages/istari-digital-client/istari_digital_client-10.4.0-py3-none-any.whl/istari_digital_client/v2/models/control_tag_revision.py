...
class ControlTagRevision(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "created", "created_by_id", "control_tag_id", "name", "status", "description", "display_color"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ControlTagRevision from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "control_tag_id": obj.get("control_tag_id"),
            "name": obj.get("name"),
