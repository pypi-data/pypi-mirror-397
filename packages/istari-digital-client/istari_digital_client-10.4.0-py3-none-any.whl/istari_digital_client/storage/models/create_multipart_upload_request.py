...
class CreateMultipartUploadRequest(BaseModel):
    ...
    sha: StrictStr
    num_parts: StrictInt
    __properties: ClassVar[List[str]] = ["sha", "num_parts"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateMultipartUploadRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateMultipartUploadRequest from a dict"""
        if obj is None:
            return None
