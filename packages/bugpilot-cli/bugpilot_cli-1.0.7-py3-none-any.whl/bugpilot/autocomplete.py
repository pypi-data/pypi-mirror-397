...
class BugPilotCompleter(Completer):
    ...
    COMMANDS = [
        "/help", "/configure", "/settings", "/tools", "/portfolio",
        "/update", "/mode", "/clear", "/exit", "/quit"
    ]
...
def get_command_input(prompt_text: str = "[+] You: ") -> str:
    """Get input with command autocomplete"""
    return get_user_input_with_autocomplete(prompt_text)
