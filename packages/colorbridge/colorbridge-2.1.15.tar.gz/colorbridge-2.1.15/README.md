...
![ColorBridge Logo](https://img.shields.io/badge/ColorBridge-v2.1.15-blue.svg)
...
### v2.1.15 (2025-12-16) - Linux串口连接修复和版本号统一更新
🔧 **Linux串口连接修复**
- 修复Debian Linux下串口设备识别但连接不上的权限问题
- 优化环境管理器中的Linux串口权限检查逻辑
