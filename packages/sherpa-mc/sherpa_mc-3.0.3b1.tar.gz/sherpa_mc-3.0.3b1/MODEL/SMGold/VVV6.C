...
namespace METOOLS {
  ...
  class VVV6_Calculator: public Lorentz_Calculator {
  public:
    ...
    VVV6_Calculator(const Vertex_Key &key):
      Lorentz_Calculator(key) {}

    std::string Label() const { return "VVV6"; }
...
CVec4<SType>* j0 = NULL;
j0 = CVec4<SType>::New();
(*j0)[0] = 1.0*j10*j20*p20 - 1.0*j11*j20*p21 - 1.0*j12*j20*p22 - 1.0*j13*j20*p23;
(*j0)[ATOOLS::Spinor<SType>::R1()] = 1.0*j10*j21*p20 - 1.0*j11*j21*p21 - 1.0*j12*j21*p22 - 1.0*j13*j21*p23;
(*j0)[ATOOLS::Spinor<SType>::R2()] = 1.0*j10*j22*p20 - 1.0*j11*j22*p21 - 1.0*j12*j22*p22 - 1.0*j13*j22*p23;
(*j0)[ATOOLS::Spinor<SType>::R3()] = 1.0*j10*j23*p20 - 1.0*j11*j23*p21 - 1.0*j12*j23*p22 - 1.0*j13*j23*p23;
j0->SetS(j1.S()|j2.S());
return j0;
...
CVec4<SType>* j1 = NULL;
j1 = CVec4<SType>::New();
(*j1)[0] = 1.0*j00*j20*p20 - 1.0*j01*j21*p20 - 1.0*j02*j22*p20 - 1.0*j03*j23*p20;
(*j1)[ATOOLS::Spinor<SType>::R1()] = 1.0*j00*j20*p21 - 1.0*j01*j21*p21 - 1.0*j02*j22*p21 - 1.0*j03*j23*p21;
(*j1)[ATOOLS::Spinor<SType>::R2()] = 1.0*j00*j20*p22 - 1.0*j01*j21*p22 - 1.0*j02*j22*p22 - 1.0*j03*j23*p22;
(*j1)[ATOOLS::Spinor<SType>::R3()] = 1.0*j00*j20*p23 - 1.0*j01*j21*p23 - 1.0*j02*j22*p23 - 1.0*j03*j23*p23;
j1->SetS(j0.S()|j2.S());
return j1;
...
CVec4<SType>* j2 = NULL;
j2 = CVec4<SType>::New();
(*j2)[0] = 1.0*j00*j10*p20 - 1.0*j00*j11*p21 - 1.0*j00*j12*p22 - 1.0*j00*j13*p23;
(*j2)[ATOOLS::Spinor<SType>::R1()] = 1.0*j01*j10*p20 - 1.0*j01*j11*p21 - 1.0*j01*j12*p22 - 1.0*j01*j13*p23;
(*j2)[ATOOLS::Spinor<SType>::R2()] = 1.0*j02*j10*p20 - 1.0*j02*j11*p21 - 1.0*j02*j12*p22 - 1.0*j02*j13*p23;
(*j2)[ATOOLS::Spinor<SType>::R3()] = 1.0*j03*j10*p20 - 1.0*j03*j11*p21 - 1.0*j03*j12*p22 - 1.0*j03*j13*p23;
j2->SetS(j0.S()|j1.S());
return j2;
  ...
  };// end of class VVV6_Calculator

  template class VVV6_Calculator<double>;
...
DECLARE_GETTER(VVV6_Calculator<double>,"DVVV6",
	       Lorentz_Calculator,Vertex_Key);
Lorentz_Calculator *ATOOLS::Getter
<Lorentz_Calculator,Vertex_Key,VVV6_Calculator<double> >::
operator()(const Vertex_Key &key) const
{ return new VVV6_Calculator<double>(key); }

void ATOOLS::Getter<Lorentz_Calculator,Vertex_Key,
		    VVV6_Calculator<double> >::
