...
namespace METOOLS {
  ...
  class FFV2_Calculator: public Lorentz_Calculator {
  public:
    ...
    FFV2_Calculator(const Vertex_Key &key):
      Lorentz_Calculator(key) {}

    std::string Label() const { return "FFV2"; }
...
default:
 THROW(fatal_error, "Massless spinor optimization error in Lorentz calculator");
  ...
  };// end of class FFV2_Calculator

  template class FFV2_Calculator<double>;
...
DECLARE_GETTER(FFV2_Calculator<double>,"DFFV2",
	       Lorentz_Calculator,Vertex_Key);
Lorentz_Calculator *ATOOLS::Getter
<Lorentz_Calculator,Vertex_Key,FFV2_Calculator<double> >::
operator()(const Vertex_Key &key) const
{ return new FFV2_Calculator<double>(key); }

void ATOOLS::Getter<Lorentz_Calculator,Vertex_Key,
		    FFV2_Calculator<double> >::
