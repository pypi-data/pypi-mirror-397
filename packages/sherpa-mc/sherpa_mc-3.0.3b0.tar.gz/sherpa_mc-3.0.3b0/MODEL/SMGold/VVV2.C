...
namespace METOOLS {
  ...
  class VVV2_Calculator: public Lorentz_Calculator {
  public:
    ...
    VVV2_Calculator(const Vertex_Key &key):
      Lorentz_Calculator(key) {}

    std::string Label() const { return "VVV2"; }
...
CVec4<SType>* j0 = NULL;
j0 = CVec4<SType>::New();
(*j0)[0] = 1.0*j10*j20*p10 - 1.0*j10*j21*p11 - 1.0*j10*j22*p12 - 1.0*j10*j23*p13;
(*j0)[ATOOLS::Spinor<SType>::R1()] = 1.0*j11*j20*p10 - 1.0*j11*j21*p11 - 1.0*j11*j22*p12 - 1.0*j11*j23*p13;
(*j0)[ATOOLS::Spinor<SType>::R2()] = 1.0*j12*j20*p10 - 1.0*j12*j21*p11 - 1.0*j12*j22*p12 - 1.0*j12*j23*p13;
(*j0)[ATOOLS::Spinor<SType>::R3()] = 1.0*j13*j20*p10 - 1.0*j13*j21*p11 - 1.0*j13*j22*p12 - 1.0*j13*j23*p13;
j0->SetS(j1.S()|j2.S());
return j0;
...
CVec4<SType>* j1 = NULL;
j1 = CVec4<SType>::New();
(*j1)[0] = 1.0*j00*j20*p10 - 1.0*j00*j21*p11 - 1.0*j00*j22*p12 - 1.0*j00*j23*p13;
(*j1)[ATOOLS::Spinor<SType>::R1()] = 1.0*j01*j20*p10 - 1.0*j01*j21*p11 - 1.0*j01*j22*p12 - 1.0*j01*j23*p13;
(*j1)[ATOOLS::Spinor<SType>::R2()] = 1.0*j02*j20*p10 - 1.0*j02*j21*p11 - 1.0*j02*j22*p12 - 1.0*j02*j23*p13;
(*j1)[ATOOLS::Spinor<SType>::R3()] = 1.0*j03*j20*p10 - 1.0*j03*j21*p11 - 1.0*j03*j22*p12 - 1.0*j03*j23*p13;
j1->SetS(j0.S()|j2.S());
return j1;
...
CVec4<SType>* j2 = NULL;
j2 = CVec4<SType>::New();
(*j2)[0] = 1.0*j00*j10*p10 - 1.0*j01*j11*p10 - 1.0*j02*j12*p10 - 1.0*j03*j13*p10;
(*j2)[ATOOLS::Spinor<SType>::R1()] = 1.0*j00*j10*p11 - 1.0*j01*j11*p11 - 1.0*j02*j12*p11 - 1.0*j03*j13*p11;
(*j2)[ATOOLS::Spinor<SType>::R2()] = 1.0*j00*j10*p12 - 1.0*j01*j11*p12 - 1.0*j02*j12*p12 - 1.0*j03*j13*p12;
(*j2)[ATOOLS::Spinor<SType>::R3()] = 1.0*j00*j10*p13 - 1.0*j01*j11*p13 - 1.0*j02*j12*p13 - 1.0*j03*j13*p13;
j2->SetS(j0.S()|j1.S());
return j2;
  ...
  };// end of class VVV2_Calculator

  template class VVV2_Calculator<double>;
...
DECLARE_GETTER(VVV2_Calculator<double>,"DVVV2",
	       Lorentz_Calculator,Vertex_Key);
Lorentz_Calculator *ATOOLS::Getter
<Lorentz_Calculator,Vertex_Key,VVV2_Calculator<double> >::
operator()(const Vertex_Key &key) const
{ return new VVV2_Calculator<double>(key); }

void ATOOLS::Getter<Lorentz_Calculator,Vertex_Key,
		    VVV2_Calculator<double> >::
