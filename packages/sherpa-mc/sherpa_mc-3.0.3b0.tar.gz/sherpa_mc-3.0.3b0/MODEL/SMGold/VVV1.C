...
namespace METOOLS {
  ...
  class VVV1_Calculator: public Lorentz_Calculator {
  public:
    ...
    VVV1_Calculator(const Vertex_Key &key):
      Lorentz_Calculator(key) {}

    std::string Label() const { return "VVV1"; }
...
CVec4<SType>* j0 = NULL;
j0 = CVec4<SType>::New();
(*j0)[0] = 1.0*j10*j20*p00 - 1.0*j10*j21*p01 - 1.0*j10*j22*p02 - 1.0*j10*j23*p03;
(*j0)[ATOOLS::Spinor<SType>::R1()] = 1.0*j11*j20*p00 - 1.0*j11*j21*p01 - 1.0*j11*j22*p02 - 1.0*j11*j23*p03;
(*j0)[ATOOLS::Spinor<SType>::R2()] = 1.0*j12*j20*p00 - 1.0*j12*j21*p01 - 1.0*j12*j22*p02 - 1.0*j12*j23*p03;
(*j0)[ATOOLS::Spinor<SType>::R3()] = 1.0*j13*j20*p00 - 1.0*j13*j21*p01 - 1.0*j13*j22*p02 - 1.0*j13*j23*p03;
j0->SetS(j1.S()|j2.S());
return j0;
...
CVec4<SType>* j1 = NULL;
j1 = CVec4<SType>::New();
(*j1)[0] = 1.0*j00*j20*p00 - 1.0*j00*j21*p01 - 1.0*j00*j22*p02 - 1.0*j00*j23*p03;
(*j1)[ATOOLS::Spinor<SType>::R1()] = 1.0*j01*j20*p00 - 1.0*j01*j21*p01 - 1.0*j01*j22*p02 - 1.0*j01*j23*p03;
(*j1)[ATOOLS::Spinor<SType>::R2()] = 1.0*j02*j20*p00 - 1.0*j02*j21*p01 - 1.0*j02*j22*p02 - 1.0*j02*j23*p03;
(*j1)[ATOOLS::Spinor<SType>::R3()] = 1.0*j03*j20*p00 - 1.0*j03*j21*p01 - 1.0*j03*j22*p02 - 1.0*j03*j23*p03;
j1->SetS(j0.S()|j2.S());
return j1;
...
CVec4<SType>* j2 = NULL;
j2 = CVec4<SType>::New();
(*j2)[0] = 1.0*j00*j10*p00 - 1.0*j01*j11*p00 - 1.0*j02*j12*p00 - 1.0*j03*j13*p00;
(*j2)[ATOOLS::Spinor<SType>::R1()] = 1.0*j00*j10*p01 - 1.0*j01*j11*p01 - 1.0*j02*j12*p01 - 1.0*j03*j13*p01;
(*j2)[ATOOLS::Spinor<SType>::R2()] = 1.0*j00*j10*p02 - 1.0*j01*j11*p02 - 1.0*j02*j12*p02 - 1.0*j03*j13*p02;
(*j2)[ATOOLS::Spinor<SType>::R3()] = 1.0*j00*j10*p03 - 1.0*j01*j11*p03 - 1.0*j02*j12*p03 - 1.0*j03*j13*p03;
j2->SetS(j0.S()|j1.S());
return j2;
  ...
  };// end of class VVV1_Calculator

  template class VVV1_Calculator<double>;
...
DECLARE_GETTER(VVV1_Calculator<double>,"DVVV1",
	       Lorentz_Calculator,Vertex_Key);
Lorentz_Calculator *ATOOLS::Getter
<Lorentz_Calculator,Vertex_Key,VVV1_Calculator<double> >::
operator()(const Vertex_Key &key) const
{ return new VVV1_Calculator<double>(key); }

void ATOOLS::Getter<Lorentz_Calculator,Vertex_Key,
		    VVV1_Calculator<double> >::
