...
namespace METOOLS {
  ...
  class FF4_Calculator: public Lorentz_Calculator {
  public:
    ...
    FF4_Calculator(const Vertex_Key &key):
      Lorentz_Calculator(key) {}

    std::string Label() const { return "FF4"; }
...
default:
 THROW(fatal_error, "Massless spinor optimization error in Lorentz calculator");
  ...
  };// end of class FF4_Calculator

  template class FF4_Calculator<double>;
...
DECLARE_GETTER(FF4_Calculator<double>,"DFF4",
	       Lorentz_Calculator,Vertex_Key);
Lorentz_Calculator *ATOOLS::Getter
<Lorentz_Calculator,Vertex_Key,FF4_Calculator<double> >::
operator()(const Vertex_Key &key) const
{ return new FF4_Calculator<double>(key); }

void ATOOLS::Getter<Lorentz_Calculator,Vertex_Key,
		    FF4_Calculator<double> >::
