...
namespace METOOLS {
  ...
  class FF5_Calculator: public Lorentz_Calculator {
  public:
    ...
    FF5_Calculator(const Vertex_Key &key):
      Lorentz_Calculator(key) {}

    std::string Label() const { return "FF5"; }
...
default:
 THROW(fatal_error, "Massless spinor optimization error in Lorentz calculator");
  ...
  };// end of class FF5_Calculator

  template class FF5_Calculator<double>;
...
DECLARE_GETTER(FF5_Calculator<double>,"DFF5",
	       Lorentz_Calculator,Vertex_Key);
Lorentz_Calculator *ATOOLS::Getter
<Lorentz_Calculator,Vertex_Key,FF5_Calculator<double> >::
operator()(const Vertex_Key &key) const
{ return new FF5_Calculator<double>(key); }

void ATOOLS::Getter<Lorentz_Calculator,Vertex_Key,
		    FF5_Calculator<double> >::
