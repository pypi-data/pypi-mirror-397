...
namespace METOOLS {
  ...
  class FF1_Calculator: public Lorentz_Calculator {
  public:
    ...
    FF1_Calculator(const Vertex_Key &key):
      Lorentz_Calculator(key) {}

    std::string Label() const { return "FF1"; }
...
(*j0)[0] = 0;
(*j0)[1] = 0;
(*j0)[2] = 1.0*j10*p00 - 1.0*j10*p03 - 1.0*j11*p01 - 1.0*I*j11*p02;
(*j0)[3] = -1.0*j10*p01 + 1.0*I*j10*p02 + 1.0*j11*p00 + 1.0*j11*p03;
j0->SetS(j1.S());
return j0;
case 8:
...
(*j1)[0] = 1.0*j02*p00 - 1.0*j02*p03 - 1.0*j03*p01 + 1.0*I*j03*p02;
(*j1)[1] = -1.0*j02*p01 - 1.0*I*j02*p02 + 1.0*j03*p00 + 1.0*j03*p03;
(*j1)[2] = 0;
(*j1)[3] = 0;
j1->SetS(j0.S());
return j1;
...
default:
 THROW(fatal_error, "Massless spinor optimization error in Lorentz calculator");
  ...
  };// end of class FF1_Calculator

  template class FF1_Calculator<double>;
...
DECLARE_GETTER(FF1_Calculator<double>,"DFF1",
	       Lorentz_Calculator,Vertex_Key);
Lorentz_Calculator *ATOOLS::Getter
<Lorentz_Calculator,Vertex_Key,FF1_Calculator<double> >::
operator()(const Vertex_Key &key) const
{ return new FF1_Calculator<double>(key); }

void ATOOLS::Getter<Lorentz_Calculator,Vertex_Key,
		    FF1_Calculator<double> >::
