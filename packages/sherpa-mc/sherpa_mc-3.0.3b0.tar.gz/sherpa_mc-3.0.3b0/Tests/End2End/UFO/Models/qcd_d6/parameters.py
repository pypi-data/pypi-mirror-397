...
LAMBDAG = Parameter(name = 'LAMBDAG',
                    nature = 'external',
                    type = 'real',
                    value = 1000.,
                    texname = '\\text{Subscritpt}(\\lambda ,g)',
                    lhablock = 'QCDD6',
                    lhacode = [ 1 ])

LAMBDAQ = Parameter(name = 'LAMBDAQ',
                    nature = 'external',
                    type = 'real',
                    value = 1000.,
                    texname = '\\text{Subscritpt}(\\lambda ,q)',
                    lhablock = 'QCDD6',
                    lhacode = [ 2 ])
...
GO1 = Parameter(name = 'GO1',
                nature = 'internal',
                type = 'real',
                value = 'LAMBDAG**(-2)',
                texname = '\\text{GO1}')

GO2 = Parameter(name = 'GO2',
                nature = 'internal',
                type = 'real',
                value = 'LAMBDAQ**(-2)',
                texname = '\\text{GO2}')

GO4 = Parameter(name = 'GO4',
                nature = 'internal',
                type = 'real',
                value = 'LAMBDAQ**(-2)',
                texname = '\\text{GO4}')
