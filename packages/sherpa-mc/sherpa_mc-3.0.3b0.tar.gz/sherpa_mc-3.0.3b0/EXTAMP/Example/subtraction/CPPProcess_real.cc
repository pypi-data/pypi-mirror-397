...
using namespace MG_Real;

//==========================================================================
// Class member functions for calculating the matrix elements for
// Process: e- e+ > g d d~ QCD<=1 QED<=2 @1
...
double CPPProcess::matrix_1_emep_gddx() 
{
  int i, j; 
  // Local variables
  const int ngraphs = 4; 
