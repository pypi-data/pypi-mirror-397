...
def handle_error(e: Exception):
    ...
    if isinstance(e, AuthenticationError):
        ...
        if "Invalid response" in str(e) or "Empty response" in str(e):
            ...
            console.print(f"\nCurrent API URL: [dim]{os.getenv('FORGEVAULT_BASE_URL', 'https://forgevault.netlify.app/api/v1')}[/dim]")
    else:
...
def login(
    ...
    if not api_key:
        ...
        console.print("[dim](Get your key from https://forgevault.netlify.app/settings)[/dim]\n")
        try:
...
def list_prompts(
    ...
    try:
        ...
        if not prompts:
            ...
            console.print("Create prompts at [cyan]https://forgevault.netlify.app[/cyan]")
            return
