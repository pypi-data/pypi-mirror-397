...
class ListEntityRefundResponseSettlementAmountTypedDict(TypedDict):
...
class ListEntityRefundResponseSettlementAmount(BaseModel):
    r"""This optional field will contain the approximate amount that will be deducted from your account balance, converted
    to the currency your account is settled in.
...
class ListEntityRefundResponseStatus(str, Enum, metaclass=utils.OpenEnumMeta):
    QUEUED = "queued"
    PENDING = "pending"
...
class ListEntityRefundResponseExternalReferenceTypedDict(TypedDict):
...
class ListEntityRefundResponseExternalReference(BaseModel):
    type: Annotated[
...
class ListEntityRefundResponseSourceTypedDict(TypedDict):
    r"""Where the funds will be pulled back from."""

    organization_id: NotRequired[str]


class ListEntityRefundResponseSource(BaseModel):
    r"""Where the funds will be pulled back from."""
...
class ListEntityRefundResponseRoutingReversalTypedDict(TypedDict):
    amount: NotRequired[AmountTypedDict]
    r"""In v2 endpoints, monetary amounts are represented as objects with a `currency` and `value` field."""
    source: NotRequired[ListEntityRefundResponseSourceTypedDict]
    r"""Where the funds will be pulled back from."""


class ListEntityRefundResponseRoutingReversal(BaseModel):
    amount: Optional[Amount] = None
    r"""In v2 endpoints, monetary amounts are represented as objects with a `currency` and `value` field."""

    source: Optional[ListEntityRefundResponseSource] = None
    r"""Where the funds will be pulled back from."""


class ListEntityRefundResponseLinksTypedDict(TypedDict):
...
class ListEntityRefundResponseLinks(BaseModel):
    r"""An object with several relevant URLs. Every URL object will contain an `href` and a `type` field."""
...
class ListEntityRefundResponseTypedDict(TypedDict):
    resource: str
    ...
    links: ListEntityRefundResponseLinksTypedDict
    r"""An object with several relevant URLs. Every URL object will contain an `href` and a `type` field."""
    settlement_amount: NotRequired[
        Nullable[ListEntityRefundResponseSettlementAmountTypedDict]
    ]
    r"""This optional field will contain the approximate amount that will be deducted from your account balance, converted
    to the currency your account is settled in.
    ...
    external_reference: NotRequired[ListEntityRefundResponseExternalReferenceTypedDict]
    routing_reversals: NotRequired[
        Nullable[List[ListEntityRefundResponseRoutingReversalTypedDict]]
    ]
...
class ListEntityRefundResponse(BaseModel):
    resource: str
    r"""Indicates the response contains a refund object. Will always contain the string `refund` for this endpoint."""
    ...
    status: Annotated[
        ListEntityRefundResponseStatus, PlainValidator(validate_open_enum(False))
    ]

    created_at: Annotated[str, pydantic.Field(alias="createdAt")]
    r"""The entity's date and time of creation, in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format."""

    links: Annotated[ListEntityRefundResponseLinks, pydantic.Field(alias="_links")]
    r"""An object with several relevant URLs. Every URL object will contain an `href` and a `type` field."""

    settlement_amount: Annotated[
        OptionalNullable[ListEntityRefundResponseSettlementAmount],
    ...
    external_reference: Annotated[
        Optional[ListEntityRefundResponseExternalReference],
        pydantic.Field(alias="externalReference"),
    ] = None

    routing_reversals: Annotated[
        OptionalNullable[List[ListEntityRefundResponseRoutingReversal]],
