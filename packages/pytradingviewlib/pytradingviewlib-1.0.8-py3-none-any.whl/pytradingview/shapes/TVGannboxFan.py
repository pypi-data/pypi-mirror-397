...
class TVGannboxFanOverrides(TVBaseOverrides):
...
class TVGannboxFan(TVMultipleShape):
    
    def __init__(self, overrides: Optional[TVGannboxFanOverrides] = None, **kwargs):
        shape = TVMultipleShapeType.GannboxFan
