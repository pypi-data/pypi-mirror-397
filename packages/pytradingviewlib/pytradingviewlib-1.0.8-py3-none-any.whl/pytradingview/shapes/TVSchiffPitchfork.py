...
class TVSchiffPitchforkOverrides(TVBaseOverrides):
...
class TVSchiffPitchfork(TVMultipleShape):
    
    def __init__(self, overrides: Optional[TVSchiffPitchforkOverrides] = None, **kwargs):
        shape = TVMultipleShapeType.SchiffPitchfork
