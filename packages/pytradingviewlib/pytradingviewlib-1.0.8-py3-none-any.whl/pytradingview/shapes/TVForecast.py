...
class TVForecastOverrides(TVBaseOverrides):
...
class TVForecast(TVMultipleShape):
    
    def __init__(self, overrides: Optional[TVForecastOverrides] = None, **kwargs):
        shape = TVMultipleShapeType.Forecast
