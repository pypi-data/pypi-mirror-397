...
class TVTableOverrides(TVBaseOverrides):
...
class TVTable(TVSingleShape):
    
    def __init__(self, overrides: Optional[TVTableOverrides] = None, **kwargs):
        shape = TVSingleShapeType.Table
