...
class TVFibSpiralOverrides(TVBaseOverrides):
...
class TVFibSpiral(TVMultipleShape):
    
    def __init__(self, overrides: Optional[TVFibSpiralOverrides] = None, **kwargs):
        shape = TVMultipleShapeType.FibSpiral
