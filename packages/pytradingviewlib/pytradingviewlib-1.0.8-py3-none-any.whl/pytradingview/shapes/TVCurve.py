...
class TVCurveOverrides(TVBaseOverrides):
...
class TVCurve(TVMultipleShape):
    
    def __init__(self, overrides: Optional[TVCurveOverrides] = None, **kwargs):
        shape = TVMultipleShapeType.Curve
