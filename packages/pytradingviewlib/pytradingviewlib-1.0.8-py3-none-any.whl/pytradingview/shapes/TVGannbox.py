...
class TVGannboxOverrides(TVBaseOverrides):
...
class TVGannbox(TVMultipleShape):
    
    def __init__(self, overrides: Optional[TVGannboxOverrides] = None, **kwargs):
        shape = TVMultipleShapeType.Gannbox
