...
class TVPathOverrides(TVBaseOverrides):
...
class TVPath(TVMultipleShape):
    
    def __init__(self, overrides: Optional[TVPathOverrides] = None, **kwargs):
        shape = TVMultipleShapeType.Path
