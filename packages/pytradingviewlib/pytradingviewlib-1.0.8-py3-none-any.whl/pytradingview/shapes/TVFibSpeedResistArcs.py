...
class TVFibSpeedResistArcsOverrides(TVBaseOverrides):

    def __init__(self):
        self.fill_background = True
        self.full_circles = False
...
class TVFibSpeedResistArcs(TVMultipleShape):
    
    def __init__(self, overrides: Optional[TVFibSpeedResistArcsOverrides] = None, **kwargs):
        shape = TVMultipleShapeType.FibSpeedResistArcs
