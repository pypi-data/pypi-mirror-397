...
class TVGannboxSquareOverrides(TVBaseOverrides):
...
class TVGannboxSquare(TVMultipleShape):
    
    def __init__(self, overrides: Optional[TVGannboxSquareOverrides] = None, **kwargs):
        shape = TVMultipleShapeType.GannboxSquare
