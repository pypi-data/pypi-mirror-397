...
class TVTrendLineOverrides(TVBaseOverrides):
...
class TVTrendLine(TVMultipleShape):
    
    def __init__(self, overrides: Optional[TVTrendLineOverrides] = None, **kwargs):
        shape = TVMultipleShapeType.TrendLine
