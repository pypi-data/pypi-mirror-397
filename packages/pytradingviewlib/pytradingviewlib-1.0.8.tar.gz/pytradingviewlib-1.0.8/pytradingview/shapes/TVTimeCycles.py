...
class TVTimeCyclesOverrides(TVBaseOverrides):
...
class TVTimeCycles(TVMultipleShape):
    
    def __init__(self, overrides: Optional[TVTimeCyclesOverrides] = None, **kwargs):
        shape = TVMultipleShapeType.TimeCycles
