...
class TVRayOverrides(TVBaseOverrides):
...
class TVRay(TVMultipleShape):
    
    def __init__(self, overrides: Optional[TVRayOverrides] = None, **kwargs):
        shape = TVMultipleShapeType.Ray
