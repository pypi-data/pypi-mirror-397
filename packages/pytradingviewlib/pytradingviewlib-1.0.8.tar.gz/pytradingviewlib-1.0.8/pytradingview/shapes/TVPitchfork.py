...
class TVPitchforkOverrides(TVBaseOverrides):
...
class TVPitchfork(TVMultipleShape):
    
    def __init__(self, overrides: Optional[TVPitchforkOverrides] = None, **kwargs):
        shape = TVMultipleShapeType.Pitchfork
