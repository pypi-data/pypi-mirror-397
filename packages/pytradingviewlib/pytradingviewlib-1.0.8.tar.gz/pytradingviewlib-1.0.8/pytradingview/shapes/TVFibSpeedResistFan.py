...
class TVFibSpeedResistFanOverrides(TVBaseOverrides):
...
class TVFibSpeedResistFan(TVMultipleShape):
    
    def __init__(self, overrides: Optional[TVFibSpeedResistFanOverrides] = None, **kwargs):
        shape = TVMultipleShapeType.FibSpeedResistFan
