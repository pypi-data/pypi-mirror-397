...
class TVPitchfanOverrides(TVBaseOverrides):
...
class TVPitchfan(TVMultipleShape):
    
    def __init__(self, overrides: Optional[TVPitchfanOverrides] = None, **kwargs):
        shape = TVMultipleShapeType.Pitchfan
