...
class TVDoubleCurveOverrides(TVBaseOverrides):
...
class TVDoubleCurve(TVMultipleShape):
    
    def __init__(self, overrides: Optional[TVDoubleCurveOverrides] = None, **kwargs):
        shape = TVMultipleShapeType.DoubleCurve
