...
class TVFibTrendExtOverrides(TVBaseOverrides):
...
class TVFibTrendExt(TVMultipleShape):
    
    def __init__(self, overrides: Optional[TVFibTrendExtOverrides] = None, **kwargs):
        shape = TVMultipleShapeType.FibTrendExt
