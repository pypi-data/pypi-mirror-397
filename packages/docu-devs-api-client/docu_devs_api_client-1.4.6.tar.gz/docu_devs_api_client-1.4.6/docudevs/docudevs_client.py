...
from .api.document.generate_schema import asyncio_detailed as generate_schema_async
...
from .api.job.get_trace import asyncio_detailed as get_trace_async
from .api.job.get_image import asyncio_detailed as get_image_async
