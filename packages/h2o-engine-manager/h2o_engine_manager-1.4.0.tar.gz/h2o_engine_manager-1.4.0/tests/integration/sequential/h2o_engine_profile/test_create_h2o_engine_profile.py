...
def test_create_h2o_engine_profile(
    ...
    to_create = H2OEngineProfile(
        ...
        java_classpath="added_classpath",
        java_options="java_opts",
        h2o_options="h2o_opts",
    )
    to_create_id = "p1"
    ...
    assert created.java_classpath == "added_classpath"
    assert created.java_options == "java_opts"
    assert created.h2o_options == "h2o_opts"
