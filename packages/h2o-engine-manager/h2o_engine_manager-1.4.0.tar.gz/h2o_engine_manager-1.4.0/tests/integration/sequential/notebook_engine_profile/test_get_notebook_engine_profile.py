...
def test_get_notebook_engine_profile(
    ...
    profile_get: NotebookEngineProfile = notebook_engine_profile_client_super_admin.get_notebook_engine_profile(
        name="workspaces/global/notebookEngineProfiles/p1"
    )

    # user cannot GET profile in the global WS
    with pytest.raises(CustomApiException) as exc:
        notebook_engine_profile_client.get_notebook_engine_profile(name="workspaces/global/notebookEngineProfiles/p1")
    ...
    assert profile_get.name == "workspaces/global/notebookEngineProfiles/p1"
    ...
    assert profile_get.storage_class_name == "sc1"
