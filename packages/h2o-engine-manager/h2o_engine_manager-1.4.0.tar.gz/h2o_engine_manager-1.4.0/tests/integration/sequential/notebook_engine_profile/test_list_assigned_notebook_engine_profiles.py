...
def test_list_assigned_notebook_engine_profiles(
    ...
    profiles = notebook_engine_profile_client_super_admin.list_all_assigned_notebook_engine_profiles(parent=GLOBAL_WORKSPACE)
    ...
    profiles = notebook_engine_profile_client_admin.list_all_assigned_notebook_engine_profiles(parent=GLOBAL_WORKSPACE)
    print(profiles)
    ...
    profiles = notebook_engine_profile_client.list_all_assigned_notebook_engine_profiles(parent=GLOBAL_WORKSPACE)
    print(profiles)
    assert len(profiles) == 1
    assert profiles[0].name == "workspaces/global/notebookEngineProfiles/p3"

    # test pagination
    page = notebook_engine_profile_client_super_admin.list_assigned_notebook_engine_profiles(parent=GLOBAL_WORKSPACE, page_size=1)
    ...
    page = notebook_engine_profile_client_super_admin.list_assigned_notebook_engine_profiles(
        parent=GLOBAL_WORKSPACE,
        page_size=1,
