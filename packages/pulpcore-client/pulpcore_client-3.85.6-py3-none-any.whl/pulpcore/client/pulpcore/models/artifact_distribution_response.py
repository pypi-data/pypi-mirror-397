...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["base_url", "pulp_href", "base_path", "pulp_created", "pulp_last_updated", "hidden", "content_guard", "prn", "no_content_change_since", "pulp_labels", "name"]
