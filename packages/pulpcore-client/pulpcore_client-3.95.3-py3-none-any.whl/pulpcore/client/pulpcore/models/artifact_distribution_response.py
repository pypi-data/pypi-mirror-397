...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "base_url", "pulp_created", "content_guard", "no_content_change_since", "pulp_href", "hidden", "prn", "base_path", "pulp_last_updated", "pulp_labels"]
