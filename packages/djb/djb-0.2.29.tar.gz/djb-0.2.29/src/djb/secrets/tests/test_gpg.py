...
class TestIsGpgEncrypted:
    ...
    def test_returns_true_for_gpg_file(self, tmp_path: Path):
        ...
        mock_result.stdout = ":pubkey enc packet:\n"
        mock_result.stderr = ""
...
class TestGetGpgKeyId:
    ...
    def test_returns_key_id_when_found(self):
        """Test returns key ID when GPG key exists for email."""
        mock_result = MagicMock()
        mock_result.returncode = 0
        mock_result.stdout = "sec:u:4096:1:ABCDEF1234567890:1234567890::u:::scESC:::\n"
    ...
    def test_returns_none_when_not_found(self):
        ...
        mock_result = MagicMock()
        mock_result.returncode = 2  # GPG returns 2 when no key found
        mock_result.stdout = ""
...
class TestGetDefaultGpgEmail:
    ...
    def test_returns_email_when_key_exists(self):
...
class TestHasGpgSecretKey:
    ...
    def test_returns_true_when_secret_key_exists(self):
        """Test returns True when at least one secret key exists."""
        mock_result = MagicMock()
        mock_result.returncode = 0
        mock_result.stdout = "sec:u:4096:1:ABCD1234:1234567890::u:::scESC:::\n"

        with patch("subprocess.run", return_value=mock_result):
            assert has_gpg_secret_key() is True

    def test_returns_false_when_no_secret_keys(self):
...
class TestGenerateGpgKey:
    ...
    def test_generates_key_successfully(self):
    ...
    def test_raises_on_failure(self):
        ...
        mock_result = MagicMock()
        mock_result.returncode = 1
        mock_result.stderr = "key generation failed"
