...
and consistent formatting. Used instead of click.echo and click.secho.
...
Usage:
    from djb.cli.logging import get_logger, setup_logging
...
class CliLogger:
    """CLI logger with semantic methods for different types of output.
    ...
    def fail(self, msg: str):
        ...
        """
        self.logger.info(f"{CliFormatter.FAIL}{msg}{CliFormatter.FAIL_SUFFIX}")
    ...
    def next(self, msg: str):
        ...
        """
        if not msg.endswith(CliFormatter.NEXT_SUFFIX):
            msg = f"{msg}{CliFormatter.NEXT_SUFFIX}"
        self.logger.info(msg)
    ...
    def done(self, msg: str):
        ...
        """
        self.logger.info(f"{CliFormatter.DONE}{msg}{CliFormatter.DONE_SUFFIX}")
    ...
    def skip(self, msg: str):
        ...
        """
        self.logger.info(f"{CliFormatter.SKIP}{msg}")
    ...
    def tip(self, msg: str):
        ...
        """
        self.logger.info(f"{CliFormatter.TIP}{msg}{CliFormatter.TIP_SUFFIX}")
    ...
    def obs(self, msg: str):
        ...
        """
        self.logger.info(f"{CliFormatter.OBS}{msg}")
    ...
    def highlight(self, msg: str):
        ...
        """
        self.logger.info(f"{CliFormatter.HIGHLIGHT}{msg}{CliFormatter.HIGHLIGHT_SUFFIX}")
    ...
    def notice(self, msg: str):
        ...
        """
        self.logger.info(f"{CliFormatter.NOTE}{msg}{CliFormatter.NOTE_SUFFIX}")
    ...
    def section(self, title: str):
        ...
        ============================================================
        """
        sep = "=" * CliFormatter.SECTION_WIDTH
        self.logger.info("")
        self.logger.info(f"{CliFormatter.SECTION}{sep}{CliFormatter.SECTION_SUFFIX}")
        self.logger.info(f"{CliFormatter.SECTION}{title}{CliFormatter.SECTION_SUFFIX}")
        self.logger.info(f"{CliFormatter.SECTION}{sep}{CliFormatter.SECTION_SUFFIX}")
        self.logger.info("")
