...
class TestEncryptFile:
    ...
    def test_encrypts_successfully(self, tmp_path):
...
class TestDecryptFile:
    ...
    def test_decrypts_successfully(self, tmp_path):
...
class TestRotateKeys:
    ...
    def test_rotates_successfully(self, tmp_path):
    ...
    def test_raises_on_failure(self, tmp_path):
        ...
        mock_result = MagicMock()
        mock_result.returncode = 1
        mock_result.stderr = "rotation failed"
...
class TestSecretsManager:
    ...
    def test_load_secrets(self, tmp_path):
        ...
        mock_result = MagicMock()
        mock_result.returncode = 0
        mock_result.stdout = "secret_key: abc123\n"
...
class TestLoadSecrets:
    ...
    def test_loads_secrets(self, tmp_path):
        ...
        mock_result = MagicMock()
        mock_result.returncode = 0
        mock_result.stdout = "api_key: secret123\n"
...
class TestLoadSecretsForMode:
    ...
    def test_loads_for_development_mode(self, tmp_path):
    ...
    def test_loads_for_production_mode(self, tmp_path):
        ...
        mock_result = MagicMock()
        mock_result.returncode = 0
        mock_result.stdout = "debug: false\n"
