...
def mock_deploy_context(tmp_path):
    ...
    Default setup: subprocess returns success with "main" branch, streaming returns (0, "").
    """
    with (
...
class TestDeployHerokuCommand:
    ...
    def test_requires_app_option_or_project_name(self, runner, tmp_path, monkeypatch):
        """Test that --app or project_name is required."""
        ...
        # Config validation catches missing project_name before deploy command
        assert "Missing required config: project_name" in result.output
...
"""
        ...
        with (
            ...
            streaming_mock.return_value = (0, "")  # returncode, captured_output
...
class TestDeployHerokuRevertCommand:
    ...
    def test_revert_to_previous_commit(self, runner, git_repo, tmp_path):
        ...
        with (
            ...
            result = runner.invoke(
                djb_cli, ["deploy", "heroku", "revert", "--app", "testapp"], input="y\n"
            )
    ...
    def test_revert_to_specific_commit(self, runner, git_repo, tmp_path):
        ...
        with (
            ...
            result = runner.invoke(
                djb_cli, ["deploy", "heroku", "revert", "--app", "testapp", "def5678"], input="y\n"
            )
    ...
    def test_revert_invalid_hash(self, runner, git_repo, tmp_path):
        ...
        with (
            ...
            result = runner.invoke(
                djb_cli, ["deploy", "heroku", "revert", "--app", "testapp", "invalid"]
            )
    ...
    def test_revert_cancelled(self, runner, git_repo, tmp_path):
        ...
        with (
            ...
            result = runner.invoke(
                djb_cli, ["deploy", "heroku", "revert", "--app", "testapp"], input="n\n"
            )
    ...
    def test_revert_skip_migrate(self, runner, git_repo, tmp_path):
        ...
        with (
            ...
            result = runner.invoke(
                djb_cli,
                ["deploy", "heroku", "revert", "--app", "testapp", "--skip-migrate"],
                input="y\n",
            )
