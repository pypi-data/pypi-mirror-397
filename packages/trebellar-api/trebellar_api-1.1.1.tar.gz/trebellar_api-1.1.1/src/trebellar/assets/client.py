...
class AssetsClient:
    ...
    def bulk_seat_assignments(
        ...
        *,
        ...
        """
        _response = self._raw_client.bulk_seat_assignments(assignments=assignments, request_options=request_options)
        return _response.data
    ...
    async def bulk_seat_assignments(
        ...
        *,
        ...
        _response = await self._raw_client.bulk_seat_assignments(
            assignments=assignments, request_options=request_options
        )
        return _response.data
