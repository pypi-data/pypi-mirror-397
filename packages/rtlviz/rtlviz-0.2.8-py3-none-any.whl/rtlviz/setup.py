...
Usage:
    rtlviz-setup                # Configure ALL IDEs (default)
    rtlviz-setup --claude       # Configure Claude Desktop only
    rtlviz-setup --claude-code  # Configure Claude Code (VS Code extension) only
...
def detect_and_configure_all() -> bool:
    ...
    if not configured:
        ...
        print("   --claude, --claude-code, --vscode, --cursor, --windsurf")
        return False
...
def configure_all_forced() -> bool:
    ...
    print("1/5 Claude Desktop")
    configure_claude_desktop()
    print()
    
    print("2/5 Claude Code")
    configure_claude_code()
    print()
    
    print("3/5 VS Code Copilot")
    configure_vscode()
    print()
...
def main():
    ...
    if "--claude" in args:
        ...
        # Default: configure all IDEs (users may have multiple)
