...
class ParameterSet:
    ...
    def add_float(self, name: str, low: float, high: float, default: Optional[float] = None, log: bool = False):
    ...
    def add_categorical(self, name: str, choices: List[str], default: Optional[str] = None):
    ...
    @property
    def bounds(self) -> List[Union[Tuple[float, float], Tuple[int, int], Tuple[str, ...]]]:
