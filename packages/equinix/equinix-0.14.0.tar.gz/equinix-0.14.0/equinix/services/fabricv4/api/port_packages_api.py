...
class PortPackagesApi:
    ...
    def get_port_packages(
        ...
        _param = self._get_port_packages_serialize(
    ...
    @validate_call
    def get_port_packages_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AllPortPackagesResponse]:
        """Get All Port Packages
    ...
    @validate_call
    def get_port_packages_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_port_packages_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/fabric/v4/portPackages',
