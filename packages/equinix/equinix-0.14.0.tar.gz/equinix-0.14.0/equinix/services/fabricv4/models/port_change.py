...
class PortChange(BaseModel):
    ...
    type: Optional[PortChangeType] = None
    ...
    data: Optional[PortChangeOperation] = None
    ...
    __properties: ClassVar[List[str]] = ["uuid", "type", "status", "information", "data", "createdDateTime", "updatedDateTime"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": PortChangeOperation.from_dict(obj["data"]) if obj.get("data") is not None else None,
