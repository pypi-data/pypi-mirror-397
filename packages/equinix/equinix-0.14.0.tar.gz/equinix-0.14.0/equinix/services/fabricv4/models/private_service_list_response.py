...
class PrivateServiceListResponse(BaseModel):
    """
    PrivateServiceListResponse
    """ # noqa: E501
    data: Optional[List[PrivateService]] = Field(default=None, description="List of private services")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [PrivateService.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
