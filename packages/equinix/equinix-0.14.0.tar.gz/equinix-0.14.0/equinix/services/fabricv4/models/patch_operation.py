...
class PatchOperation(BaseModel):
    ...
    """ # noqa: E501
    op: PatchOperationOp
    path: Annotated[str, Field(min_length=1, strict=True)] = Field(description="JSON Pointer path to the field to modify (e.g., /name, /description, /summary, /webUrl, /notifications)")
    value: Dict[str, Any] = Field(description="The value to update the field to")
