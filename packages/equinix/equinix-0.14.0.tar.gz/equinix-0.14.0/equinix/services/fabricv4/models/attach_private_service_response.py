...
class AttachPrivateServiceResponse(BaseModel):
    """
    AttachPrivateServiceResponse
    """ # noqa: E501
    href: Optional[StrictStr] = Field(default=None, description="URL to the attached private service")
    type: StrictStr = Field(description="Type of the private service or attachment")
    uuid: StrictStr = Field(description="Unique identifier for the private service")
