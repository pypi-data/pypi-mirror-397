...
class AuthContext(BaseModel):
    ...
    AuthContext
    """ # noqa: E501
    authtype: Optional[AuthContextAuthtype] = None
    authid: Optional[AuthContextAuthid] = None
    name: Optional[StrictStr] = Field(default=None, description="Cloud Event username")
    email: Optional[StrictStr] = Field(default=None, description="Cloud Event email")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["authtype", "authid", "name", "email"]
