...
class GetAllStreamAlertRuleResponse(BaseModel):
    """
    GetAllStreamAlertRuleResponse
    """ # noqa: E501
    pagination: Optional[Pagination] = None
    data: Optional[List[StreamAlertRule]] = Field(default=None, description="Data returned from the API call.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [StreamAlertRule.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
