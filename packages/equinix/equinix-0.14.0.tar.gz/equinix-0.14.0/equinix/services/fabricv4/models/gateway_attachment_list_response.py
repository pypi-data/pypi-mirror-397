...
class GatewayAttachmentListResponse(BaseModel):
    """
    GatewayAttachmentListResponse
    """ # noqa: E501
    pagination: Pagination
    data: List[GatewayAttachmentResponse]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [GatewayAttachmentResponse.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
