...
class AllPortPackagesResponse(BaseModel):
    """
    Port Packages response
    """ # noqa: E501
    data: List[PortPackage] = Field(description="List of Port Packages")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [PortPackage.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
