...
class PlanSpecsDrivesInner(BaseModel):
    ...
    """ # noqa: E501
    category: Optional[StrictStr] = Field(default=None, description="Values may include 'boot', 'cache', 'storage'")
    count: Optional[StrictInt] = None
    href: Optional[StrictStr] = None
    size: Optional[StrictStr] = None
    type: Optional[StrictStr] = Field(default=None, description="Values may include 'HDD', 'SSD', 'NVME'")
