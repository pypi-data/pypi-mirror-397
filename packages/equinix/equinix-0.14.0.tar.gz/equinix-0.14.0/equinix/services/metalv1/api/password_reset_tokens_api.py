...
class PasswordResetTokensApi:
    ...
    def create_password_reset_token(
        self,
        email: Annotated[StrictStr, Field(description="Email of user to create password reset token")],
        ...
        _param = self._create_password_reset_token_serialize(
            email=email,
    ...
    @validate_call
    def create_password_reset_token_with_http_info(
        self,
        email: Annotated[StrictStr, Field(description="Email of user to create password reset token")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def create_password_reset_token_without_preload_content(
        self,
        email: Annotated[StrictStr, Field(description="Email of user to create password reset token")],
        _request_timeout: Union[
            None,
    ...
    def _create_password_reset_token_serialize(
        self,
        email,
        _request_auth,
        _content_type,
