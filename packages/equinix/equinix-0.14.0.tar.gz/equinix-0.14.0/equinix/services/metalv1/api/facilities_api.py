...
class FacilitiesApi:
    ...
    def find_facilities(
        ...
        """(Deprecated) Retrieve all facilities
        ...
        """ # noqa: E501
        warnings.warn("GET /facilities is deprecated.", DeprecationWarning)

        _param = self._find_facilities_serialize(
            include=include,
            exclude=exclude,
    ...
    def _find_facilities_serialize(
        self,
        include,
        exclude,
        _request_auth,
    ...
    def find_facilities_by_organization(
        ...
        :return: Returns the result object.
        """ # noqa: E501
        warnings.warn("GET /organizations/{id}/facilities is deprecated.", DeprecationWarning)

        _param = self._find_facilities_by_organization_serialize(
            id=id,
            include=include,
            exclude=exclude,
            _request_auth=_request_auth,
    ...
    def _find_facilities_by_organization_serialize(
        self,
        id,
        include,
        exclude,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/organizations/{id}/facilities',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def find_facilities_by_project(
        ...
        :return: Returns the result object.
        """ # noqa: E501
        warnings.warn("GET /projects/{id}/facilities is deprecated.", DeprecationWarning)

        _param = self._find_facilities_by_project_serialize(
            id=id,
            include=include,
            exclude=exclude,
            _request_auth=_request_auth,
    ...
    def _find_facilities_by_project_serialize(
        self,
        id,
        include,
        exclude,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/projects/{id}/facilities',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
