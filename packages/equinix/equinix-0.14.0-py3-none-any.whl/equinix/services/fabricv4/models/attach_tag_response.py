...
class AttachTagResponse(BaseModel):
    """
    AttachTagResponse
    """ # noqa: E501
    href: Optional[StrictStr] = Field(default=None, description="URL to the attached tag")
    type: StrictStr = Field(description="Type of the tag or attachment")
    uuid: StrictStr = Field(description="Unique identifier for the tag")
