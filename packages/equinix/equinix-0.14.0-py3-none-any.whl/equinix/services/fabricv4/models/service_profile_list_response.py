...
class ServiceProfileListResponse(BaseModel):
    ...
    """ # noqa: E501
    data: Optional[List[CompanyServiceProfile]] = Field(default=None, description="List of service profiles")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [CompanyServiceProfile.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
