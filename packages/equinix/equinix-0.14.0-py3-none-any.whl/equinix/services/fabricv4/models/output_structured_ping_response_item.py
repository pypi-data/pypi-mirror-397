...
class OutputStructuredPingResponseItem(BaseModel):
    """
    OutputStructuredPingResponseItem
    """ # noqa: E501
    bytes: Optional[StrictInt] = None
    ip: Optional[StrictStr] = None
    icmp_seq: Optional[StrictInt] = Field(default=None, alias="icmpSeq")
    ttl: Optional[StrictInt] = None
    time: Optional[Union[StrictFloat, StrictInt]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["bytes", "ip", "icmpSeq", "ttl", "time"]
