...
class MetricFilters(BaseModel):
    ...
    MetricFilters
    """ # noqa: E501
    var_and: Optional[List[MetricSimpleExpression]] = Field(default=None, alias="and")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "and": [MetricSimpleExpression.from_dict(_item) for _item in obj["and"]] if obj.get("and") is not None else None
        })
