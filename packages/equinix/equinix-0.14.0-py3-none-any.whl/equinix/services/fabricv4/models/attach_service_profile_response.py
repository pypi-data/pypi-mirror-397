...
class AttachServiceProfileResponse(BaseModel):
    """
    AttachServiceProfileResponse
    """ # noqa: E501
    href: Optional[StrictStr] = Field(default=None, description="URL to the attached service profile")
    type: StrictStr = Field(description="Type of the service or attachment")
    uuid: StrictStr = Field(description="Unique identifier for the service profile")
