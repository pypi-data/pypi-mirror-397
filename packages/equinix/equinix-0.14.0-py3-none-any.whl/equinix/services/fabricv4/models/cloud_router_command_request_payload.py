...
class CloudRouterCommandRequestPayload(BaseModel):
    """
    Fabric Cloud Router Command Request
    """ # noqa: E501
    destination: StrictStr = Field(description="Fabric Cloud Router Ping or Traceroute Command Destination")
    ...
    __properties: ClassVar[List[str]] = ["destination", "sourceConnection", "timeout", "dataBytes", "probes", "hopsMax"]
