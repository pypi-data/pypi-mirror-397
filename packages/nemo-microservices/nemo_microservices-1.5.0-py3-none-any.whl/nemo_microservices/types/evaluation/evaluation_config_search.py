...
__all__ = ["EvaluationConfigSearch", "Ownership", "Params"]

Ownership: TypeAlias = Union[ownership.Ownership, List[ownership.Ownership]]

Params: TypeAlias = Union[EvaluationParams, List[EvaluationParams]]


class EvaluationConfigSearch(BaseModel):
    ...
    groups: Union[Dict[str, GroupConfig], List[Dict[str, GroupConfig]], None] = None
    ...
    tasks: Union[Dict[str, TaskConfig], List[Dict[str, TaskConfig]], None] = None
