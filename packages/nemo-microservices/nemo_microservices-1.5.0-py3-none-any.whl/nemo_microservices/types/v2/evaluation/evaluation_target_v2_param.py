...
from .model_v2_param import ModelV2Param
...
__all__ = ["EvaluationTargetV2Param", "Dataset", "Model"]

Dataset: TypeAlias = Union[str, DatasetEvParam]

Model: TypeAlias = Union[str, ModelV2Param]


class EvaluationTargetV2Param(TypedDict, total=False):
