...
__all__ = ["DatasetSearchParam", "Ownership"]

Ownership: TypeAlias = Union[ownership.Ownership, Iterable[ownership.Ownership]]


class DatasetSearchParam(TypedDict, total=False):
    ...
    format: Union[str, SequenceNotStr[str]]

    hf_endpoint: Union[str, SequenceNotStr[str]]

    limit: Union[int, Iterable[int]]
    ...
    split: Union[str, SequenceNotStr[str]]
