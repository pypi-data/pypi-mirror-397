...
__all__ = ["ReviewerAnnotationEvent"]


class ReviewerAnnotationEvent(BaseModel):
    ...
    event_type: Optional[Literal["reviewer_annotation"]] = None
    ...
    response_override: Optional[Dict[str, object]] = None
    """
