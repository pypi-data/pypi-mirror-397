...
from .mcqa_environment_param import McqaEnvironmentParam
from .workbench_environment_param import WorkbenchEnvironmentParam
from .comp_coding_environment_param import CompCodingEnvironmentParam
from .library_judge_math_environment_param import LibraryJudgeMathEnvironmentParam
from .multiverse_math_hard_environment_param import MultiverseMathHardEnvironmentParam
from .instruction_following_environment_param import InstructionFollowingEnvironmentParam

__all__ = ["GrpoParametersParam", "Environment"]

Environment: TypeAlias = Union[
    McqaEnvironmentParam,
    WorkbenchEnvironmentParam,
    MultiverseMathHardEnvironmentParam,
    LibraryJudgeMathEnvironmentParam,
    InstructionFollowingEnvironmentParam,
    CompCodingEnvironmentParam,
]


class GrpoParametersParam(TypedDict, total=False):
