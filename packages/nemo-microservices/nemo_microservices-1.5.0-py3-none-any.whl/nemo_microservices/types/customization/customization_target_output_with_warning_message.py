...
__all__ = ["CustomizationTargetOutputWithWarningMessage"]


class CustomizationTargetOutputWithWarningMessage(BaseModel):
    model_path: str
    ...
    """Warning message when updating the customization target"""
