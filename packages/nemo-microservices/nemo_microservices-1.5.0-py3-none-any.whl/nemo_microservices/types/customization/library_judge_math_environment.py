...
__all__ = ["LibraryJudgeMathEnvironment"]


class LibraryJudgeMathEnvironment(BaseModel):
    ...
    name: Optional[Literal["library_judge_math"]] = None
    """
    ...
    should_use_judge: Optional[bool] = None
