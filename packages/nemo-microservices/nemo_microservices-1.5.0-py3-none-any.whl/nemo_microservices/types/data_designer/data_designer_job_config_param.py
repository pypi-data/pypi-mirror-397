...
from .data_designer_config_param import DataDesignerConfigParam

__all__ = ["DataDesignerJobConfigParam"]


class DataDesignerJobConfigParam(TypedDict, total=False):
    config: Required[DataDesignerConfigParam]
