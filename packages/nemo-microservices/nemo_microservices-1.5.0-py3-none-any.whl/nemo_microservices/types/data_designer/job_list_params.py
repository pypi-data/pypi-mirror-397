...
from .data_designer_jobs_sort_field import DataDesignerJobsSortField
from .data_designer_jobs_search_param import DataDesignerJobsSearchParam
from .data_designer_jobs_list_filter_param import DataDesignerJobsListFilterParam

__all__ = ["JobListParams"]


class JobListParams(TypedDict, total=False):
    filter: DataDesignerJobsListFilterParam
    ...
    search: DataDesignerJobsSearchParam
    """
