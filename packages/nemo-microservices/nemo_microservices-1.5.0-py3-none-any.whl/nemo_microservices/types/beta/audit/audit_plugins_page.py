...
from .audit_plugin_filter import AuditPluginFilter
from ...shared.pagination_data import PaginationData

__all__ = ["AuditPluginsPage"]


class AuditPluginsPage(BaseModel):
    data: List[AuditPlugin]

    filter: Optional[AuditPluginFilter] = None
