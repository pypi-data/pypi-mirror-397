...
from .audit_target_filter import AuditTargetFilter
from ...shared.pagination_data import PaginationData

__all__ = ["AuditTargetsPage"]


class AuditTargetsPage(BaseModel):
    data: List[AuditTarget]

    filter: Optional[AuditTargetFilter] = None
