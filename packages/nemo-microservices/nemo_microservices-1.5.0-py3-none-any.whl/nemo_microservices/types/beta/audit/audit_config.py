...
from .audit_run_data import AuditRunData
from .audit_report_data import AuditReportData
from .audit_system_data import AuditSystemData
from ...shared.ownership import Ownership
from .audit_plugins_data_output import AuditPluginsDataOutput
...
class AuditConfig(BaseModel):
    ...
    plugins: Optional[AuditPluginsDataOutput] = None

    project: Optional[str] = None
    """The URN of the project associated with this entity."""

    reporting: Optional[AuditReportData] = None

    run: Optional[AuditRunData] = None

    schema_version: Optional[str] = None
    """The version of the schema for the object. Internal use only."""

    system: Optional[AuditSystemData] = None
