...
from .audit_config_filter import AuditConfigFilter
from ...shared.pagination_data import PaginationData

__all__ = ["AuditConfigsPage"]


class AuditConfigsPage(BaseModel):
    data: List[AuditConfig]

    filter: Optional[AuditConfigFilter] = None
