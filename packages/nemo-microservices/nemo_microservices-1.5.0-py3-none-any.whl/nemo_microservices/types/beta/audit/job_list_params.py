...
from .audit_jobs_sort_field import AuditJobsSortField
from .audit_jobs_search_param import AuditJobsSearchParam
from .audit_jobs_list_filter_param import AuditJobsListFilterParam

__all__ = ["JobListParams"]


class JobListParams(TypedDict, total=False):
    filter: AuditJobsListFilterParam
