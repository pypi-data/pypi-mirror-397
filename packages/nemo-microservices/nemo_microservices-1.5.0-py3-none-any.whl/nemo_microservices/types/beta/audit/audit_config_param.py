...
from .audit_run_data_param import AuditRunDataParam
from .audit_report_data_param import AuditReportDataParam
from .audit_system_data_param import AuditSystemDataParam
from .audit_plugins_data_param import AuditPluginsDataParam
from ...shared_params.ownership import Ownership

__all__ = ["AuditConfigParam"]


class AuditConfigParam(TypedDict, total=False):
    id: str
    ...
    plugins: AuditPluginsDataParam

    project: str
    """The URN of the project associated with this entity."""

    reporting: AuditReportDataParam

    run: AuditRunDataParam

    schema_version: str
    """The version of the schema for the object. Internal use only."""

    system: AuditSystemDataParam
