...
__all__ = ["DataParameters"]


class DataParameters(BaseModel):
    group_training_examples_by: Optional[str] = None
    ...
    max_sequences_per_example: Union[Literal["auto"], int, None] = None
    """
    ...
    order_training_examples_by: Optional[str] = None
