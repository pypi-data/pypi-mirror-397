...
from ...jobs.datetime_filter_param import DatetimeFilterParam

__all__ = ["SafeSynthesizerJobsListFilterParam"]


class SafeSynthesizerJobsListFilterParam(TypedDict, total=False):
    ...
    updated_at: DatetimeFilterParam
