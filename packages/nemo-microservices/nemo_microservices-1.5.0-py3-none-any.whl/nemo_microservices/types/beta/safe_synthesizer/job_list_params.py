...
from .safe_synthesizer_jobs_sort_field import SafeSynthesizerJobsSortField
from .safe_synthesizer_jobs_search_param import SafeSynthesizerJobsSearchParam
from .safe_synthesizer_jobs_list_filter_param import SafeSynthesizerJobsListFilterParam

__all__ = ["JobListParams"]


class JobListParams(TypedDict, total=False):
    filter: SafeSynthesizerJobsListFilterParam
    ...
    search: SafeSynthesizerJobsSearchParam
    """
