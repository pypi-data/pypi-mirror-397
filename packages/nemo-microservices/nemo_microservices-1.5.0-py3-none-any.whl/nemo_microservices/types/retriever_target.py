...
from .retriever_pipeline_data import RetrieverPipelineData

__all__ = ["RetrieverTarget"]


class RetrieverTarget(BaseModel):
    cached_outputs: Optional[CachedOutputsData] = None
    """An evaluation target which contains cached outputs."""

    dataset: Optional[DatasetEv] = None
    """A dataset that can be used for fine-tuning or evaluation."""

    pipeline: Optional[RetrieverPipelineData] = None
