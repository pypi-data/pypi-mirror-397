...
__all__ = ["PlatformJobStepWithContextsPage"]


class PlatformJobStepWithContextsPage(BaseModel):
    data: List[PlatformJobStepWithContext]

    filter: Optional[PlatformJobStepsListFilter] = None
