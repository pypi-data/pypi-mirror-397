...
from ......types.beta.safe_synthesizer.jobs.results.safe_synthesizer_summary import SafeSynthesizerSummary
...
class SummaryResource(SyncAPIResource):
    ...
    def download(
        ...
        *,
        ...
        return self._get(
            f"/v1beta1/safe-synthesizer/jobs/{job_id}/results/summary/download",
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=SafeSynthesizerSummary,
        )
