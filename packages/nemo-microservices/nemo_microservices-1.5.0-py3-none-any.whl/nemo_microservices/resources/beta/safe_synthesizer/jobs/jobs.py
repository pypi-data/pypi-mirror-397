...
from .....types.beta.safe_synthesizer import (
    SafeSynthesizerJobsSortField,
    SafeSynthesizerJobConfigParam,
    job_list_params,
    job_create_params,
    job_get_logs_params,
)
...
from .....types.beta.safe_synthesizer.safe_synthesizer_job import SafeSynthesizerJob
from .....types.beta.safe_synthesizer.safe_synthesizer_jobs_sort_field import SafeSynthesizerJobsSortField
from .....types.beta.safe_synthesizer.safe_synthesizer_job_config_param import SafeSynthesizerJobConfigParam
from .....types.beta.safe_synthesizer.safe_synthesizer_jobs_search_param import SafeSynthesizerJobsSearchParam
from .....types.beta.safe_synthesizer.safe_synthesizer_jobs_list_filter_param import SafeSynthesizerJobsListFilterParam
...
class JobsResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        Used primarily to configure
              ourselves for a run to the NeMo Jobs Microservice.
    ...
    def retrieve(
        ...
        *,
        ...
        return self._get(
            f"/v1beta1/safe-synthesizer/jobs/{job_id}",
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=SafeSynthesizerJob,
    ...
    def list(
        ...
        *,
        ...
        search: SafeSynthesizerJobsSearchParam | Omit = omit,
    ...
    def cancel(
        ...
        *,
        ...
        if not job_id:
            raise ValueError(f"Expected a non-empty value for `job_id` but received {job_id!r}")
        return self._post(
            f"/v1beta1/safe-synthesizer/jobs/{job_id}/cancel",
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=SafeSynthesizerJob,
    ...
    def get_status(
        ...
        *,
        ...
        if not job_id:
            raise ValueError(f"Expected a non-empty value for `job_id` but received {job_id!r}")
        return self._get(
            f"/v1beta1/safe-synthesizer/jobs/{job_id}/status",
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
