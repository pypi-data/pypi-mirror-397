...
class ResultsResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        return self._get(
            f"/v1/data-designer/jobs/{job_id}/results/{result_name}",
    ...
    def list(
        ...
        *,
        ...
        if not job_id:
            raise ValueError(f"Expected a non-empty value for `job_id` but received {job_id!r}")
        return self._get(
            f"/v1/data-designer/jobs/{job_id}/results",
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
    ...
    def download(
        ...
        *,
        ...
        return self._get(
            f"/v1/data-designer/jobs/{job_id}/results/{result_name}/download",
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
    ...
    def download_analysis(
        ...
        *,
        ...
        if not job_id:
            raise ValueError(f"Expected a non-empty value for `job_id` but received {job_id!r}")
        return self._get(
            f"/v1/data-designer/jobs/{job_id}/results/analysis/download",
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=object,
...
class ResultsResourceWithRawResponse:
    def __init__(self, results: ResultsResource) -> None:
        ...
        self.download_analysis = to_raw_response_wrapper(
            results.download_analysis,
        )
        self.download_dataset = to_custom_raw_response_wrapper(
...
class AsyncResultsResourceWithRawResponse:
    def __init__(self, results: AsyncResultsResource) -> None:
        ...
        self.download_analysis = async_to_raw_response_wrapper(
            results.download_analysis,
        )
        self.download_dataset = async_to_custom_raw_response_wrapper(
            results.download_dataset,
            AsyncBinaryAPIResponse,
        )
...
class ResultsResourceWithStreamingResponse:
    def __init__(self, results: ResultsResource) -> None:
        ...
        self.download_analysis = to_streamed_response_wrapper(
            results.download_analysis,
        )
        self.download_dataset = to_custom_streamed_response_wrapper(
            results.download_dataset,
            StreamedBinaryAPIResponse,
        )
...
class AsyncResultsResourceWithStreamingResponse:
    def __init__(self, results: AsyncResultsResource) -> None:
        ...
        self.download_analysis = async_to_streamed_response_wrapper(
            results.download_analysis,
        )
        self.download_dataset = async_to_custom_streamed_response_wrapper(
            results.download_dataset,
            AsyncStreamedBinaryAPIResponse,
        )
