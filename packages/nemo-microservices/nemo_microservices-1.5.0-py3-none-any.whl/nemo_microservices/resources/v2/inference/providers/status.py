...
from .....types.v2.inference import ModelProviderStatus
from .....types.v2.inference.providers import status_update_params
...
from .....types.v2.inference.served_model_mapping_param import ServedModelMappingParam
...
class StatusResource(SyncAPIResource):
    ...
    def update(
        ...
        *,
        ...
        return self._put(
            f"/v2/inference/providers/{namespace}/{provider_name}/status",
