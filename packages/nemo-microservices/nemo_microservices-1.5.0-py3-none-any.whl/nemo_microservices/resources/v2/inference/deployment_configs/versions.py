...
from .....types.v2.inference.deployment_configs.version_list_response import VersionListResponse
...
class VersionsResource(SyncAPIResource):
    ...
    def delete(
        ...
        *,
        ...
        reference this specific version. Delete the dependent deployments first.
