...
class ResultsResource(SyncAPIResource):
    ...
    @cached_property
    def evaluation_results(self) -> EvaluationResultsResource:
        return EvaluationResultsResource(self._client)
    ...
    def retrieve(
        ...
        *,
        ...
        return self._get(
            f"/v2/evaluation/jobs/{job_id}/results/{result_name}",
    ...
    def list(
        ...
        *,
        ...
        if not job_id:
            raise ValueError(f"Expected a non-empty value for `job_id` but received {job_id!r}")
        return self._get(
            f"/v2/evaluation/jobs/{job_id}/results",
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
    ...
    def download(
        ...
        *,
        ...
        return self._get(
            f"/v2/evaluation/jobs/{job_id}/results/{result_name}/download",
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
...
class AsyncResultsResource(AsyncAPIResource):
    ...
    @cached_property
    def evaluation_results(self) -> AsyncEvaluationResultsResource:
        return AsyncEvaluationResultsResource(self._client)
...
class ResultsResourceWithRawResponse:
    ...
    @cached_property
    def evaluation_results(self) -> EvaluationResultsResourceWithRawResponse:
        return EvaluationResultsResourceWithRawResponse(self._results.evaluation_results)
...
class AsyncResultsResourceWithRawResponse:
    ...
    @cached_property
    def evaluation_results(self) -> AsyncEvaluationResultsResourceWithRawResponse:
        return AsyncEvaluationResultsResourceWithRawResponse(self._results.evaluation_results)
...
class ResultsResourceWithStreamingResponse:
    ...
    @cached_property
    def evaluation_results(self) -> EvaluationResultsResourceWithStreamingResponse:
        return EvaluationResultsResourceWithStreamingResponse(self._results.evaluation_results)
...
class AsyncResultsResourceWithStreamingResponse:
    ...
    @cached_property
    def evaluation_results(self) -> AsyncEvaluationResultsResourceWithStreamingResponse:
        return AsyncEvaluationResultsResourceWithStreamingResponse(self._results.evaluation_results)
