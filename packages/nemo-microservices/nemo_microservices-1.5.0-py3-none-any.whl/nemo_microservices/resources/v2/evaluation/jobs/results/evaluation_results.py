...
from ......types.v2.evaluation.jobs.results.evaluation_result_v2 import EvaluationResultV2
...
class EvaluationResultsResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        """
        Download Job Result Evaluation-Results
        ...
        return self._get(
            f"/v2/evaluation/jobs/{job_id}/results/evaluation-results/download",
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=EvaluationResultV2,
        )
