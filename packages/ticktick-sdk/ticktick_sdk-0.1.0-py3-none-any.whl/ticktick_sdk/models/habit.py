...
class Habit(BaseModel):
    ...
    def from_v2(cls, data: dict[str, Any]) -> Habit:
        ...
        return cls(
            id=data.get("id", ""),
            name=data.get("name", ""),
            icon=data.get("iconRes", "habit_daily_check_in"),
            color=data.get("color", "#97E38B"),
            sort_order=data.get("sortOrder", 0),
            status=data.get("status", 0),
            encouragement=data.get("encouragement", ""),
            total_checkins=data.get("totalCheckIns", 0),
            created_time=cls._parse_datetime(data.get("createdTime")),
            modified_time=cls._parse_datetime(data.get("modifiedTime")),
            ...
            record_enable=data.get("recordEnable", False),
            section_id=data.get("sectionId"),
            target_days=data.get("targetDays", 0),
            target_start_date=data.get("targetStartDate"),
            completed_cycles=data.get("completedCycles", 0),
            ex_dates=data.get("exDates", []),
