...
class PrescriptionMessageTask(BaseModel):
    ...
    statuses: Optional[List[PrescriptionMessageTaskStatus]] = None
    __properties: ClassVar[List[str]] = ["uuid", "task_type", "is_completed", "statuses"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "statuses": [PrescriptionMessageTaskStatus.from_dict(_item) for _item in obj["statuses"]] if obj.get("statuses") is not None else None
        })
        return _obj
