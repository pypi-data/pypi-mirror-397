...
class PatientTask(BaseModel):
    ...
    statuses: Optional[List[PatientTaskStatus]] = None
    __properties: ClassVar[List[str]] = ["uuid", "created_on", "task_type", "manual_review_required", "is_completed", "statuses"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "statuses": [PatientTaskStatus.from_dict(_item) for _item in obj["statuses"]] if obj.get("statuses") is not None else None
        })
        return _obj
