...
class WorkflowApi:
    ...
    def get_workflow_tasks(
        ...
        deep: Annotated[Optional[StrictBool], Field(description="Whether to return contained object for the workflow or just minimal information.  Defaults to false.")] = None,
        ...
        :param deep: Whether to return contained object for the workflow or just minimal information.  Defaults to false.
        :type deep: bool
