...
class PatientAddressData(BaseModel):
    ...
    address_line_one: StrictStr = Field(description="The first line of the address")
    ...
    state_province: StrictStr = Field(description="The state or province using the two alphabetic character abbreviation (e.g. TX, CA, NY)")
    postal_code: StrictStr = Field(description="The postal code in 5 digit format")
    country_code: StrictStr = Field(description="The country code using the two alphabetic character abbreviation (e.g. US, CA, GB)")
    __properties: ClassVar[List[str]] = ["object_type", "address_line_one", "address_line_two", "city", "state_province", "postal_code", "country_code"]
