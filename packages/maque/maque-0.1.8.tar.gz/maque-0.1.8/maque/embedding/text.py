...
class TextEmbedding(BaseEmbedding):
    ...
    def __init__(
        ...
        Args:
            base_url: API 基础 URL，如 http://192.168.1.242:28802
    ...
    def embed_with_response(
        ...
        payload = self._build_payload(texts, task, dimensions)
        ...
        for attempt in range(self.max_retries):
            try:
                ...
                data = response.json()
                return self._parse_response(data, texts)
