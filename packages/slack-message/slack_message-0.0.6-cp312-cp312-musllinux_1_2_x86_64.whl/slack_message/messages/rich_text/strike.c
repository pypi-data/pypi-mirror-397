...
{
    "distutils": {
        "name": "slack_message.messages.rich_text.strike",
        "sources": [
            "src/slack_message/messages/rich_text/strike.py"
        ]
    },
    "module_name": "slack_message.messages.rich_text.strike"
}
END: Cython Metadata */
...
#define __PYX_HAVE__slack_message__messages__rich_text__strike
#define __PYX_HAVE_API__slack_message__messages__rich_text__strike
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "slack_message.messages.rich_text.strike" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "slack_message.messages.rich_text.strike"
extern int __pyx_module_is_main_slack_message__messages__rich_text__strike;
int __pyx_module_is_main_slack_message__messages__rich_text__strike = 0;

/* Implementation of "slack_message.messages.rich_text.strike" */
...
static int __pyx_pymod_exec_strike(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_strike},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
__Pyx_PyMODINIT_FUNC PyInit_strike(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_strike(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_strike(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'strike' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "strike" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_strike", 0);
  ...
  if (__pyx_module_is_main_slack_message__messages__rich_text__strike) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "slack_message.messages.rich_text.strike")) {
      if (unlikely((PyDict_SetItemString(modules, "slack_message.messages.rich_text.strike", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
  ...
  /* "slack_message/messages/rich_text/strike.py":1
             # <<<<<<<<<<<<<<
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init slack_message.messages.rich_text.strike", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init slack_message.messages.rich_text.strike");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
