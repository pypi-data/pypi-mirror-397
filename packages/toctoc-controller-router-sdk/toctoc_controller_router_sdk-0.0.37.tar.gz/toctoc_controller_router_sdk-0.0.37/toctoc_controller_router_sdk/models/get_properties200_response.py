...
class GetProperties200Response(BaseModel):
    """
    ...
    docs: Optional[List[ResponsePropertyDto]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetProperties200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetProperties200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "docs": [ResponsePropertyDto.from_dict(_item) for _item in obj["docs"]] if obj.get("docs") is not None else None
        })
        return _obj
