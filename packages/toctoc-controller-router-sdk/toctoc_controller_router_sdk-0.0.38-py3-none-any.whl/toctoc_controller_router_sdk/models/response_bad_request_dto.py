...
class ResponseBadRequestDto(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["status", "statusCode", "message"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ResponseBadRequestDto from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ResponseBadRequestDto from a dict"""
        if obj is None:
            return None
