...
class TestResponseHighlightSummaryDto(unittest.TestCase):
    """ResponseHighlightSummaryDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResponseHighlightSummaryDto:
        """Test ResponseHighlightSummaryDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResponseHighlightSummaryDto`
        """
        model = ResponseHighlightSummaryDto()
        if include_optional:
            return ResponseHighlightSummaryDto(
                code = '21000390063626',
    ...
    def testResponseHighlightSummaryDto(self):
        """Test ResponseHighlightSummaryDto"""
