...
class TestResponsePropertyDto(unittest.TestCase):
    """ResponsePropertyDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResponsePropertyDto:
        """Test ResponsePropertyDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResponsePropertyDto`
        """
        model = ResponsePropertyDto()
        if include_optional:
    ...
    def testResponsePropertyDto(self):
        """Test ResponsePropertyDto"""
