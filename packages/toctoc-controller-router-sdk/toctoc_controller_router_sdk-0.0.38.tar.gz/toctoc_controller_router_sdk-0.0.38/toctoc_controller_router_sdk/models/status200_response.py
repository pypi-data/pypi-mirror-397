...
class Status200Response(BaseModel):
    """
    Status200Response
    """ # noqa: E501
    status: StrictStr
    ...
    data: Optional[List[ResponseHighlightStatusDto]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [ResponseHighlightStatusDto.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
