...
class ResponsePaginateDto(BaseModel):
    """
    ResponsePaginateDto
    """ # noqa: E501
    status: StrictStr
    ...
    docs: Optional[List[StrictStr]] = Field(default=None, description="List of records")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ResponsePaginateDto from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ResponsePaginateDto from a dict"""
        if obj is None:
            return None
