...
class Summary200Response(BaseModel):
    """
    Summary200Response
    """ # noqa: E501
    status: StrictStr
    ...
    docs: Optional[List[ResponseHighlightSummaryDto]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "docs": [ResponseHighlightSummaryDto.from_dict(_item) for _item in obj["docs"]] if obj.get("docs") is not None else None
        })
        return _obj
