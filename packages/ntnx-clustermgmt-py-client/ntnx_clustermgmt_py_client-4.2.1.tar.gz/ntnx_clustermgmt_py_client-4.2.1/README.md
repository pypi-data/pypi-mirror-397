...
api_client = ntnx_clustermgmt_py_client.ApiClient(allow_version_negotiation=False)
```
...
This library has a full set of [API Reference Documentation](https://developers.nutanix.com/sdk-reference?namespace=clustermgmt&version=v4.2&language=python). This documentation is auto-generated, and the location may change.
