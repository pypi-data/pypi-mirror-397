...
from ntnx_clustermgmt_py_client.models.OneOfclustermgmt.v4.config.UpdateSSLCertificateApiResponsedata import UpdateSSLCertificateApiResponsedata  # noqa: F401,E501
from ntnx_clustermgmt_py_client.models.common.v1.response.ApiResponseMetadata import ApiResponseMetadata  # noqa: F401,E501

class UpdateSSLCertificateApiResponse(object):
    ...
    swagger_types = {
        ...
        'data': 'OneOfclustermgmt.v4.config.UpdateSSLCertificateApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'clustermgmt.v4.config.UpdateSSLCertificateApiResponse'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(UpdateSSLCertificateApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateSSLCertificateApiResponse):
            return False
