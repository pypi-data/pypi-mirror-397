...
class NsBackingType(object):
    ...
    Allowed enum values:
        ...
        - _UNKNOWN
        - _REDACTED
        - ESX_VSS: ESX Standard Virtual Switch
        - ESX_DVS: ESX Distributed Virtual Switch
        - AHV_VS: AHV Virtual Switch
        - AHV_BRIDGE: AHV OVS Bridge
    """
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    ESX_VSS = "ESX_VSS"
    ...
    def _initialize_object_type(self):
        return 'clustermgmt.v4.config.NsBackingType'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(NsBackingType, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NsBackingType):
            return False
