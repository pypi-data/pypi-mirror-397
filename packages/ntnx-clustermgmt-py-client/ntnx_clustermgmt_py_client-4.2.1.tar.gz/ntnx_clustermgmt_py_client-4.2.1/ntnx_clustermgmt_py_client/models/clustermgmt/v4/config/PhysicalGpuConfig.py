...
class PhysicalGpuConfig(object):
    ...
    def __init__(self, type=None, device_id=None, device_name=None, vendor_name=None, is_in_use=False, sbdf=None, numa_node=None, assignable=None, mode=None, frame_buffer_size_bytes=None, *args, **kwargs):  # noqa: E501
        self.__type = None
