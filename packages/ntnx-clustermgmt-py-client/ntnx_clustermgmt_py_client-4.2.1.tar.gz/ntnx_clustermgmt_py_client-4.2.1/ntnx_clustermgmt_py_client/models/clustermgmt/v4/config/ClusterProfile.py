...
from ntnx_clustermgmt_py_client.models.clustermgmt.v4.config.NtpServerConfig import NtpServerConfig  # noqa: F401,E501
...
class ClusterProfile(ExternalizableAbstractModel):
    ...
    :param create_time: (:attr:`create_time`) Creation time of a cluster profile.
    :type create_time: 
    
    
    :param last_update_time: (:attr:`last_update_time`) The last updated time of a cluster profile.
    :type last_update_time: 
    
    
    :param created_by: (:attr:`created_by`) Details of the user who created the cluster profile.
    :type created_by: 
    
    
    :param last_updated_by: (:attr:`last_updated_by`) Details of the user who has recently updated the cluster profile.
    ...
    :param drifted_cluster_count: (:attr:`drifted_cluster_count`) The count indicates the number of clusters associated with a cluster profile that has experienced drift. Drifted clusters are those in which the configuration differs from the defined profile. For example, the NTP server has different values on a cluster as compared to the profile it is attached.
    ...
    :param name_server_ip_list: (:attr:`name_server_ip_list`) List of name servers on a cluster. This is a part of payload for both clusters create and update operations. Currently, only IPv4 address and FQDN (fully qualified domain name) values are supported for the create operation.
    :type name_server_ip_list: 
    
    
    :param ntp_server_ip_list: (:attr:`ntp_server_ip_list`) List of NTP servers on a cluster. This is a part of payload for both cluster create and update operations. Currently, only IPv4 address and FQDN (fully qualified domain name) values are supported for the create operation.
    ...
    :param nfs_subnet_whitelist: (:attr:`nfs_subnet_whitelist`) NFS subnet allowlist addresses. This is part of the payload for cluster update operation only.
    ...
    :param ntp_server_config_list: (:attr:`ntp_server_config_list`) List of NTP server configurations.
    :type ntp_server_config_list: 
    ...
    swagger_types = {
        ...
        'ntp_server_config_list': 'list[clustermgmt.v4.config.NtpServerConfig]',
        'ext_id': 'str',
    ...
    attribute_map = {
        ...
        'ntp_server_config_list': 'ntpServerConfigList',
        'ext_id': 'extId',
        'links': 'links',
        'tenant_id': 'tenantId',
        '_reserved': '$reserved',
    ...
    def __init__(self, name=None, description=None, create_time=None, last_update_time=None, created_by=None, last_updated_by=None, cluster_count=None, drifted_cluster_count=None, clusters=None, allowed_overrides=None, name_server_ip_list=None, ntp_server_ip_list=None, smtp_server=None, nfs_subnet_whitelist=None, snmp_config=None, rsyslog_server_list=None, pulse_status=None, ntp_server_config_list=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
        ...
        self.__ntp_server_config_list = None
        ...
        if ntp_server_config_list is not None:
            self.__ntp_server_config_list = ntp_server_config_list
    ...
    @property
    def ntp_server_config_list(self):
        """
        List of NTP server configurations.

        :type:
             list[ :class:`~ntnx_clustermgmt_py_client.models.clustermgmt.v4.config.NtpServerConfig` ]
        """  # noqa: E501
        return self.__ntp_server_config_list

    @ntp_server_config_list.setter
    def ntp_server_config_list(self, ntp_server_config_list):
