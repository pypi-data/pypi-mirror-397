...
class RebootType(object):
    ...
    Allowed enum values:
        ...
        - _UNKNOWN
        - _REDACTED
        - CONTROLLER_VM: Reboot of the Controller VM
        - HOST: Reboot of the Host
    """
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    ...
    def _initialize_object_type(self):
        return 'clustermgmt.v4.operations.RebootType'
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RebootType):
            return False
