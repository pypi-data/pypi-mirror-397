...
class NsIpPoolType(object):
    ...
    Allowed enum values:
        ...
        - _UNKNOWN
        - _REDACTED
        - PE_IP_POOL: IP pool which was created on PE.
    """
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    PE_IP_POOL = "PE_IP_POOL"
    ...
    def _initialize_object_type(self):
        return 'clustermgmt.v4.config.NsIpPoolType'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(NsIpPoolType, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NsIpPoolType):
            return False
