...
class HypervisorUploadNodeListItem(object):
    ...
    def __init__(self, node_uuid=None, hypervisor_version=None, nos_version=None, model=None, block_id=None, is_light_compute=None, hypervisor_type=None, is_robo_mixed_hypervisor=None, is_minimum_compute_node=None, luks_status=None, *args, **kwargs):  # noqa: E501
