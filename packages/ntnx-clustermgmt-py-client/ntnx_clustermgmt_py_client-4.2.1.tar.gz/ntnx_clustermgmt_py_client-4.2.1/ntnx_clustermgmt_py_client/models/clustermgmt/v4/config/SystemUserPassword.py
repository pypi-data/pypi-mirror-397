...
class SystemUserPassword(ExternalizableAbstractModel):

    """Contains information about system user password.

    :param username: (:attr:`username`) Username.
    :type username: 
     max=199 chars
    ...
    :param last_update_time: (:attr:`last_update_time`) Timestamp of last password change.
    :type last_update_time: 
    
    
    :param expiry_time: (:attr:`expiry_time`) Expiry of a new password.
    :type expiry_time: 
    ...
    :param system_type: (:attr:`system_type`) 
    :type system_type: 
    
    
    :param has_hsp_in_use: (:attr:`has_hsp_in_use`) Indicates whether the high-strength password is in use or not.
    :type has_hsp_in_use: 
    ...
    def __init__(self, username=None, host_ip=None, cluster_ext_id=None, last_update_time=None, expiry_time=None, status=None, system_type=None, has_hsp_in_use=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
        ...
        if has_hsp_in_use is not None:
            self.__has_hsp_in_use = has_hsp_in_use

    def _initialize_object_type(self):
        return 'clustermgmt.v4.config.SystemUserPassword'
    ...
    def username(self, username):
        if username is not None and len(username) > 199:
            raise ValueError("Invalid value for `username`, length must be less than or equal to `199`")  # noqa: E501
    ...
    def status(self):
        ...
        :type:
            :class:`~ntnx_clustermgmt_py_client.models.clustermgmt.v4.config.PasswordStatus`
        """  # noqa: E501
    ...
    def system_type(self):
        ...
        :type:
            :class:`~ntnx_clustermgmt_py_client.models.clustermgmt.v4.config.SystemType`
        """  # noqa: E501
    ...
    def has_hsp_in_use(self):
        ...
        :type:
                :class:`~bool`
        """  # noqa: E501
        return self.__has_hsp_in_use

    @has_hsp_in_use.setter
    def has_hsp_in_use(self, has_hsp_in_use):
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(SystemUserPassword, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SystemUserPassword):
            return False
