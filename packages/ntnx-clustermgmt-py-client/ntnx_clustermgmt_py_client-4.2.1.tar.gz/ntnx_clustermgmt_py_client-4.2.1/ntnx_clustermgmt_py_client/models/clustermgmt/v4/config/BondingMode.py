...
class BondingMode(object):
    ...
    Allowed enum values:
        ...
        - _UNKNOWN
        - _REDACTED
        - NO_BOND: No bonding mode.
        - ACTIVE_BACKUP: Active backup bonding mode.
        - ACTIVE_ACTIVE: Active active bonding mode.
        - ACTIVE_ACTIVE_WITH_MAC_PINNING: Active active with MAC pinning bonding mode.
    """
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    NO_BOND = "NO_BOND"
    ...
    ACTIVE_ACTIVE_WITH_MAC_PINNING = "ACTIVE_ACTIVE_WITH_MAC_PINNING"
    ...
    def _initialize_object_type(self):
        return 'clustermgmt.v4.config.BondingMode'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(BondingMode, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BondingMode):
            return False
