...
class ManagedCluster(object):
    ...
    :param ext_id: (:attr:`ext_id`) Indicates the UUID of a cluster.
    :type ext_id: required
    
    
    :param is_compliant: (:attr:`is_compliant`) Indicates if the attached cluster is compliant with the cluster profile or not.
    :type is_compliant: 
    
    
    :param last_synced_time: (:attr:`last_synced_time`) The most recent date and time when the cluster profile was monitored across all attached clusters.
