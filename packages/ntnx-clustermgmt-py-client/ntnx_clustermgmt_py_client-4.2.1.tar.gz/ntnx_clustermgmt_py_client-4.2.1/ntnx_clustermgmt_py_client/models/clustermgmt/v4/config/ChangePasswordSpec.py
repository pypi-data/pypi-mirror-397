...
class ChangePasswordSpec(object):

    """Contains the required specifications for a password update operation.

    :param current_password: (:attr:`current_password`) Existing password of a user account.
    :type current_password: 
    
    
    :param new_password: (:attr:`new_password`) New password for a user account.
    ...
    def __init__(self, current_password=None, new_password=None, *args, **kwargs):  # noqa: E501
    ...
    def _initialize_object_type(self):
        return 'clustermgmt.v4.config.ChangePasswordSpec'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ChangePasswordSpec, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ChangePasswordSpec):
            return False
