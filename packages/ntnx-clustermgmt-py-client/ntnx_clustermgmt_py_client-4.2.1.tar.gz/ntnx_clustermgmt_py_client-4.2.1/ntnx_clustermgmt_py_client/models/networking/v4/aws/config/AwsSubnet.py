...
class AwsSubnet(ExternalizableAbstractModel):
    ...
    :param availability_zone: (:attr:`availability_zone`) Availability Zone in which resource is situated.
    ...
    def __init__(self, vpc_id=None, annotation=None, subnet_id=None, cidr=None, gateway_ip=None, cloud_type=None, availability_zone=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
    ...
    def cloud_type(self):
        ...
        :type:
            :class:`~ntnx_clustermgmt_py_client.models.networking.v4.aws.config.CloudType`
        """  # noqa: E501
