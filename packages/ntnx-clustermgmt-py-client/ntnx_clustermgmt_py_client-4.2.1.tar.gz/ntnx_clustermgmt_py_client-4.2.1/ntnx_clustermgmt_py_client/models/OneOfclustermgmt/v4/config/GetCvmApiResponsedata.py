...
class GetCvmApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'clustermgmt.v4.config.Cvm': 'clustermgmt.v4.config.Cvm',
    ...
    def _initialize_object_type(self):
        return 'OneOfclustermgmt.v4.config.GetCvmApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetCvmApiResponsedata.discriminator_value_class_map.values():
            return list(GetCvmApiResponsedata.discriminator_value_class_map.keys())[list(GetCvmApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetCvmApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetCvmApiResponsedata):
            return False
