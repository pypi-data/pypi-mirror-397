...
class UpdateDiskLEDStateTaskResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfclustermgmt.v4.config.UpdateDiskLEDStateTaskResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in UpdateDiskLEDStateTaskResponsedata.discriminator_value_class_map.values():
            return list(UpdateDiskLEDStateTaskResponsedata.discriminator_value_class_map.keys())[list(UpdateDiskLEDStateTaskResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(UpdateDiskLEDStateTaskResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateDiskLEDStateTaskResponsedata):
            return False
