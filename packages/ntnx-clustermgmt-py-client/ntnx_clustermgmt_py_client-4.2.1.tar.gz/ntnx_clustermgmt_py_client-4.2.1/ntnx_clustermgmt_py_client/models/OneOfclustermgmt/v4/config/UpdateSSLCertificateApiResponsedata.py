...
class UpdateSSLCertificateApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfclustermgmt.v4.config.UpdateSSLCertificateApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in UpdateSSLCertificateApiResponsedata.discriminator_value_class_map.values():
            return list(UpdateSSLCertificateApiResponsedata.discriminator_value_class_map.keys())[list(UpdateSSLCertificateApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(UpdateSSLCertificateApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateSSLCertificateApiResponsedata):
            return False
