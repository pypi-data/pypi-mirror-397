...
class PasswordManagerApi(object):
    """IGNORE:
    ...
    def change_system_user_password_by_id(self, extId, body, **kwargs):  # noqa: E501
        """Initiate password update for a system user

        >>> response = api.change_system_user_password_by_id(extId, body)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.change_system_user_password_by_id(extId, body, async_req=True)
        >>> result = thread.get()

        :param extId: External identifier of the system user password.
        :type extId:
            :class:`str`, required
        :param body: Contains the required specifications for a password update operation.
        :type body:
            :class:`~ntnx_clustermgmt_py_client.models.clustermgmt.v4.config.ChangePasswordSpec`, required
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::

                           async_req=True
        :return: An instance of class :class:`~ntnx_clustermgmt_py_client.models.clustermgmt.v4.config.ChangeSystemUserPasswordApiResponse`.
        ...
        if ('extId' not in params or params['extId'] is None):
            raise ValueError("Missing the required parameter `extId` when calling `change_system_user_password_by_id`")  # noqa: E501
        # verify the required parameter 'body' is set
        if ('body' not in params or params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `change_system_user_password_by_id`")  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/clustermgmt/v4.2/config/system-user-passwords/{extId}/$actions/change-password', 'POST',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
                    ...
                    response_type='clustermgmt.v4.config.ChangeSystemUserPasswordApiResponse',  # noqa: E501
    ...
    def list_system_user_passwords(self, _page=None, _limit=None, _filter=None, _orderby=None, _expand=None, _select=None, **kwargs):  # noqa: E501
        """List password status of system users

        >>> response = api.list_system_user_passwords((optional) _page, (optional) _limit, (optional) _filter, (optional) _orderby, (optional) _expand, (optional) _select)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.list_system_user_passwords(async_req=True)
        >>> result = thread.get()
        ...
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
                           ...
                           async_req=True
        :return: An instance of class :class:`~ntnx_clustermgmt_py_client.models.clustermgmt.v4.config.ListSystemUserPasswordsApiResponse`.
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/clustermgmt/v4.2/config/system-user-passwords', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
                    post_params=form_params,
                    files=local_var_files,
                    response_type='clustermgmt.v4.config.ListSystemUserPasswordsApiResponse',  # noqa: E501
                    auth_settings=auth_settings,
                    async_req=params.get('async_req'),
                    _return_http_data_only=params.get('_return_http_data_only'),
                    _preload_content=params.get('_preload_content', True),
