...
class NsServiceStateEnum(object):
    ...
    Allowed enum values:
        ...
        - _REDACTED
        - INIT: Initial state
        - CONFIGURED: Hosting of VIP succeeded
        - FAILED: Hosting of VIP failed
    """
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    INIT = "INIT"
    ...
    def _initialize_object_type(self):
        return 'clustermgmt.v4.config.NsServiceStateEnum'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(NsServiceStateEnum, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NsServiceStateEnum):
            return False
