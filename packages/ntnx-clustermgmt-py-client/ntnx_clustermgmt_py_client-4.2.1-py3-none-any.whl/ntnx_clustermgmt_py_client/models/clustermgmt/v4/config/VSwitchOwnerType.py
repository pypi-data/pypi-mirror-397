...
class VSwitchOwnerType(object):
    ...
    Allowed enum values:
        ...
        - _UNKNOWN
        - _REDACTED
        - PRISM_ELEMENT: Prism Element vswitch owner type.
        - PRISM_CENTRAL: Prism Central vswitch owner type.
    """
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    ...
    def _initialize_object_type(self):
        return 'clustermgmt.v4.config.VSwitchOwnerType'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VSwitchOwnerType, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VSwitchOwnerType):
            return False
