...
class CvmReconfigurationSpec(object):
    ...
    def __init__(self, num_vcpus=None, memory_size_bytes=None, *args, **kwargs):  # noqa: E501
    ...
    def _initialize_object_type(self):
        return 'clustermgmt.v4.config.CvmReconfigurationSpec'
    ...
    def num_vcpus(self, num_vcpus):
        if num_vcpus is not None and num_vcpus < 1:  # noqa: E501
            raise ValueError("Invalid value for `num_vcpus`, must be a value greater than or equal to `1`")  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(CvmReconfigurationSpec, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CvmReconfigurationSpec):
            return False
