...
class VirtualGpuConfig(object):
    ...
    :param is_in_use: (:attr:`is_in_use`) GPU in use. (**Default** False)
    :type is_in_use: 
    ...
    def device_name(self, device_name):
        if device_name is not None and len(device_name) > 128:
            raise ValueError("Invalid value for `device_name`, length must be less than or equal to `128`")  # noqa: E501
    ...
    @sbdf.setter
    def sbdf(self, sbdf):
        if sbdf is not None and len(sbdf) > 11:
            raise ValueError("Invalid value for `sbdf`, length must be less than or equal to `11`")  # noqa: E501
    ...
    def numa_node(self, numa_node):
        if numa_node is not None and len(numa_node) > 2:
            raise ValueError("Invalid value for `numa_node`, length must be less than or equal to `2`")  # noqa: E501
    ...
    def guest_driver_version(self, guest_driver_version):
        if guest_driver_version is not None and len(guest_driver_version) > 32:
            raise ValueError("Invalid value for `guest_driver_version`, length must be less than or equal to `32`")  # noqa: E501
