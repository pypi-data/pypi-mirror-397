...
from ntnx_clustermgmt_py_client.models.clustermgmt.v4.config.NodeLuksStatus import NodeLuksStatus  # noqa: F401,E501
...
class UnconfiguredNodeListItem(object):
    ...
    :param luks_status: (:attr:`luks_status`) 
    :type luks_status: 
    ...
    swagger_types = {
        ...
        'luks_status': 'clustermgmt.v4.config.NodeLuksStatus',
    ...
    def __init__(self, foundation_version=None, rackable_unit_serial=None, node_uuid=None, rackable_unit_max_nodes=None, current_network_interface=None, node_position=None, cvm_ip=None, current_cvm_vlan_tag=None, is_secure_booted=None, nos_version=None, cpu_type=None, hypervisor_type=None, hypervisor_version=None, interface_ipv6=None, cluster_id=None, attributes=None, rackable_unit_model=None, arch=None, hypervisor_ip=None, ipmi_ip=None, host_type=None, luks_status=None, *args, **kwargs):  # noqa: E501
        ...
        if luks_status is not None:
            self.__luks_status = luks_status
    ...
    @property
    def luks_status(self):
        """
        

        :type:
            :class:`~ntnx_clustermgmt_py_client.models.clustermgmt.v4.config.NodeLuksStatus`
        """  # noqa: E501
        return self.__luks_status

    @luks_status.setter
    def luks_status(self, luks_status):
