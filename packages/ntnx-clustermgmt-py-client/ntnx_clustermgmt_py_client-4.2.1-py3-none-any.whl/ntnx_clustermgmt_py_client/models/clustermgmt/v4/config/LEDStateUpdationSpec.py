...
class LEDStateUpdationSpec(object):

    """Request model for updating LED state of the Disk.

    :param is_engaged: (:attr:`is_engaged`) Indicates LED status of the Disk. It can either be on or off.
    :type is_engaged: required
    ...
    def __init__(self, is_engaged=None, *args, **kwargs):  # noqa: E501
        self.__is_engaged = None
        self.discriminator = None
        self.__is_engaged = is_engaged
        # populate hidden vars if not empty
        self._populate_hidden_vars(kwargs)

    def _initialize_object_type(self):
        return 'clustermgmt.v4.config.LEDStateUpdationSpec'
    ...
    @is_engaged.setter
    def is_engaged(self, is_engaged):
        if is_engaged is None:
            raise ValueError("Invalid value for `is_engaged`, must not be `None`")  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(LEDStateUpdationSpec, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LEDStateUpdationSpec):
            return False
