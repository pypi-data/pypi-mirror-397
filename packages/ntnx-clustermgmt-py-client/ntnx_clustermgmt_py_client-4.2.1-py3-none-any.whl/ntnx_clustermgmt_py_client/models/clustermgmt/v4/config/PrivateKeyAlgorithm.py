...
class PrivateKeyAlgorithm(object):
    ...
    def _initialize_object_type(self):
        return 'clustermgmt.v4.config.PrivateKeyAlgorithm'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(PrivateKeyAlgorithm, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PrivateKeyAlgorithm):
            return False
