...
from ntnx_clustermgmt_py_client.models.OneOfclustermgmt.v4.config.UpdateDiskLEDStateTaskResponsedata import UpdateDiskLEDStateTaskResponsedata  # noqa: F401,E501
from ntnx_clustermgmt_py_client.models.common.v1.response.ApiResponseMetadata import ApiResponseMetadata  # noqa: F401,E501

class UpdateDiskLEDStateTaskResponse(object):
    ...
    swagger_types = {
        ...
        'data': 'OneOfclustermgmt.v4.config.UpdateDiskLEDStateTaskResponsedata',
    ...
    def _initialize_object_type(self):
        return 'clustermgmt.v4.config.UpdateDiskLEDStateTaskResponse'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(UpdateDiskLEDStateTaskResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateDiskLEDStateTaskResponse):
            return False
