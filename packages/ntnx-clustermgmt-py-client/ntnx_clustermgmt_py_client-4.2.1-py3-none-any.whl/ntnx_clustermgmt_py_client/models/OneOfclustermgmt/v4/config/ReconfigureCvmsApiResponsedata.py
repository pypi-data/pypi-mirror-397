...
class ReconfigureCvmsApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfclustermgmt.v4.config.ReconfigureCvmsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ReconfigureCvmsApiResponsedata.discriminator_value_class_map.values():
            return list(ReconfigureCvmsApiResponsedata.discriminator_value_class_map.keys())[list(ReconfigureCvmsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ReconfigureCvmsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ReconfigureCvmsApiResponsedata):
            return False
