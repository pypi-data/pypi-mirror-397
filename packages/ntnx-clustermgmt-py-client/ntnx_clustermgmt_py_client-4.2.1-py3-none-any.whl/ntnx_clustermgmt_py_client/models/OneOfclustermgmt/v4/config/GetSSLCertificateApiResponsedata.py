...
class GetSSLCertificateApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'clustermgmt.v4.config.SSLCertificate': 'clustermgmt.v4.config.SSLCertificate',
    ...
    def _initialize_object_type(self):
        return 'OneOfclustermgmt.v4.config.GetSSLCertificateApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetSSLCertificateApiResponsedata.discriminator_value_class_map.values():
            return list(GetSSLCertificateApiResponsedata.discriminator_value_class_map.keys())[list(GetSSLCertificateApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetSSLCertificateApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetSSLCertificateApiResponsedata):
            return False
