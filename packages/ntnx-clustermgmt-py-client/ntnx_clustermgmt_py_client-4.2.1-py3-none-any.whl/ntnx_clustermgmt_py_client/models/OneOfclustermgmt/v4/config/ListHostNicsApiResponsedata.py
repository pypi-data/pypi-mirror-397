...
class ListHostNicsApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<clustermgmt.v4.config.HostNicProjection>': 'list[clustermgmt.v4.config.HostNicProjection]'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOfclustermgmt.v4.config.ListHostNicsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListHostNicsApiResponsedata.discriminator_value_class_map.values():
            return list(ListHostNicsApiResponsedata.discriminator_value_class_map.keys())[list(ListHostNicsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListHostNicsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListHostNicsApiResponsedata):
            return False
