...
class ListCvmsByClusterIdApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<clustermgmt.v4.config.Cvm>': 'list[clustermgmt.v4.config.Cvm]',
        'clustermgmt.v4.error.ErrorResponse': 'clustermgmt.v4.error.ErrorResponse',
        'List<clustermgmt.v4.config.CvmProjection>': 'list[clustermgmt.v4.config.CvmProjection]'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOfclustermgmt.v4.config.ListCvmsByClusterIdApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListCvmsByClusterIdApiResponsedata.discriminator_value_class_map.values():
            return list(ListCvmsByClusterIdApiResponsedata.discriminator_value_class_map.keys())[list(ListCvmsByClusterIdApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListCvmsByClusterIdApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListCvmsByClusterIdApiResponsedata):
            return False
