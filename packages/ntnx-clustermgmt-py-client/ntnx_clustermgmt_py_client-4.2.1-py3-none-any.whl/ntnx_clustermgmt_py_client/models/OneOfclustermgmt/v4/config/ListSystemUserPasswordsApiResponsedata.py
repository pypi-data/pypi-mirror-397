...
class ListSystemUserPasswordsApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<clustermgmt.v4.config.SystemUserPassword>': 'list[clustermgmt.v4.config.SystemUserPassword]',
        'clustermgmt.v4.error.ErrorResponse': 'clustermgmt.v4.error.ErrorResponse',
        'List<clustermgmt.v4.config.SystemUserPasswordProjection>': 'list[clustermgmt.v4.config.SystemUserPasswordProjection]'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOfclustermgmt.v4.config.ListSystemUserPasswordsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListSystemUserPasswordsApiResponsedata.discriminator_value_class_map.values():
            return list(ListSystemUserPasswordsApiResponsedata.discriminator_value_class_map.keys())[list(ListSystemUserPasswordsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListSystemUserPasswordsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListSystemUserPasswordsApiResponsedata):
            return False
