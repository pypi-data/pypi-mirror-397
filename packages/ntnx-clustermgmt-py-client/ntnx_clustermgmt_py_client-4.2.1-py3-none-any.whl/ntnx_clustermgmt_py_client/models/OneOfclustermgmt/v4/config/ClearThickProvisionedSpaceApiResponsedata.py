...
class ClearThickProvisionedSpaceApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfclustermgmt.v4.config.ClearThickProvisionedSpaceApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ClearThickProvisionedSpaceApiResponsedata.discriminator_value_class_map.values():
            return list(ClearThickProvisionedSpaceApiResponsedata.discriminator_value_class_map.keys())[list(ClearThickProvisionedSpaceApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ClearThickProvisionedSpaceApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ClearThickProvisionedSpaceApiResponsedata):
            return False
