...
class CvmsApi(object):
    ...
    def get_cvm_by_id(self, clusterExtId, extId, **kwargs):  # noqa: E501
        """Get the details of a specific CVM associated with a cluster

        >>> response = api.get_cvm_by_id(clusterExtId, extId)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.get_cvm_by_id(clusterExtId, extId, async_req=True)
        >>> result = thread.get()

        :param clusterExtId: Indicates the UUID of a cluster.
        :type clusterExtId:
            :class:`str`, required
        :param extId: External identifier for the CVM.
        :type extId:
            :class:`str`, required
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
                           ...
                           async_req=True
        :return: An instance of class :class:`~ntnx_clustermgmt_py_client.models.clustermgmt.v4.config.GetCvmApiResponse`.
        ...
        if ('clusterExtId' not in params or params['clusterExtId'] is None):
            raise ValueError("Missing the required parameter `clusterExtId` when calling `get_cvm_by_id`")  # noqa: E501
        # verify the required parameter 'extId' is set
        if ('extId' not in params or params['extId'] is None):
            raise ValueError("Missing the required parameter `extId` when calling `get_cvm_by_id`")  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/clustermgmt/v4.2/config/clusters/{clusterExtId}/cvms/{extId}', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
                    ...
                    response_type='clustermgmt.v4.config.GetCvmApiResponse',  # noqa: E501
    ...
    def list_cvmsby_cluster_id(self, clusterExtId, _page=None, _limit=None, _filter=None, _orderby=None, _select=None, **kwargs):  # noqa: E501
        """Get a list of CVMs associated with a cluster

        >>> response = api.list_cvmsby_cluster_id(clusterExtId, (optional) _page, (optional) _limit, (optional) _filter, (optional) _orderby, (optional) _select)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.list_cvmsby_cluster_id(clusterExtId, async_req=True)
        >>> result = thread.get()
        ...
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
                           ...
                           async_req=True
        :return: An instance of class :class:`~ntnx_clustermgmt_py_client.models.clustermgmt.v4.config.ListCvmsByClusterIdApiResponse`.
        ...
        # verify the required parameter 'clusterExtId' is set
        if ('clusterExtId' not in params or params['clusterExtId'] is None):
            raise ValueError("Missing the required parameter `clusterExtId` when calling `list_cvmsby_cluster_id`")  # noqa: E501
        ...
        extra_params.append('_preload_content')
        extra_params.append('_request_timeout')
        all_params = set(['clusterExtId', '_page', '_limit', '_filter', '_orderby', '_select'])
        all_params.update(extra_params)
        for key, val in six.iteritems(params):
            if val is not None and key.lower() not in self.__headers_to_skip and key not in all_params:
                if key.lower() == 'if_match'.lower():
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/clustermgmt/v4.2/config/clusters/{clusterExtId}/cvms', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
                    post_params=form_params,
                    files=local_var_files,
                    response_type='clustermgmt.v4.config.ListCvmsByClusterIdApiResponse',  # noqa: E501
                    auth_settings=auth_settings,
                    async_req=params.get('async_req'),
                    _return_http_data_only=params.get('_return_http_data_only'),
                    _preload_content=params.get('_preload_content', True),
    ...
    def reconfigure_cvms(self, clusterExtId, body, **kwargs):  # noqa: E501
        """Reconfigure CVMs within a cluster

        >>> response = api.reconfigure_cvms(clusterExtId, body)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.reconfigure_cvms(clusterExtId, body, async_req=True)
        >>> result = thread.get()

        :param clusterExtId: Indicates the UUID of a cluster.
        :type clusterExtId:
            :class:`str`, required
        :param body: Request body for reconfiguring CVMs in a cluster.
        :type body:
            :class:`~ntnx_clustermgmt_py_client.models.clustermgmt.v4.config.CvmReconfigurationSpec`, required
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::

                           async_req=True
        :return: An instance of class :class:`~ntnx_clustermgmt_py_client.models.clustermgmt.v4.config.ReconfigureCvmsApiResponse`.
        ...
        # verify the required parameter 'clusterExtId' is set
        if ('clusterExtId' not in params or params['clusterExtId'] is None):
            raise ValueError("Missing the required parameter `clusterExtId` when calling `reconfigure_cvms`")  # noqa: E501
        # verify the required parameter 'body' is set
        if ('body' not in params or params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `reconfigure_cvms`")  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/clustermgmt/v4.2/config/clusters/{clusterExtId}/cvms/$actions/reconfigure', 'POST',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
                    post_params=form_params,
                    files=local_var_files,
                    response_type='clustermgmt.v4.config.ReconfigureCvmsApiResponse',  # noqa: E501
                    auth_settings=auth_settings,
                    async_req=params.get('async_req'),
                    _return_http_data_only=params.get('_return_http_data_only'),
                    _preload_content=params.get('_preload_content', True),
