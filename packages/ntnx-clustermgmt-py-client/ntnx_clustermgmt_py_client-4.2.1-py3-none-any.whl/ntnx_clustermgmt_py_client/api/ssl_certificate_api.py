...
class SSLCertificateApi(object):
    ...
    def get_ssl_certificate(self, clusterExtId, **kwargs):  # noqa: E501
        """Get SSL certificate details for a specified cluster

        >>> response = api.get_ssl_certificate(clusterExtId)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.get_ssl_certificate(clusterExtId, async_req=True)
        >>> result = thread.get()

        :param clusterExtId: UUID of the cluster to which the host NIC belongs.
        :type clusterExtId:
            :class:`str`, required
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
                           ...
                           async_req=True
        :return: An instance of class :class:`~ntnx_clustermgmt_py_client.models.clustermgmt.v4.config.GetSSLCertificateApiResponse`.
        ...
        if ('clusterExtId' not in params or params['clusterExtId'] is None):
            raise ValueError("Missing the required parameter `clusterExtId` when calling `get_ssl_certificate`")  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/clustermgmt/v4.2/config/clusters/{clusterExtId}/ssl-certificate', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
                    ...
                    response_type='clustermgmt.v4.config.GetSSLCertificateApiResponse',  # noqa: E501
    ...
    def update_ssl_certificate(self, clusterExtId, body, **kwargs):  # noqa: E501
        """Update the SSL certificate for a specific cluster

        >>> response = api.update_ssl_certificate(clusterExtId, body)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.update_ssl_certificate(clusterExtId, body, async_req=True)
        >>> result = thread.get()
        ...
        :param body: 
        :type body:
            :class:`~ntnx_clustermgmt_py_client.models.clustermgmt.v4.config.SSLCertificate`, required
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::

                           async_req=True
        :return: An instance of class :class:`~ntnx_clustermgmt_py_client.models.clustermgmt.v4.config.UpdateSSLCertificateApiResponse`.
        ...
        # verify the required parameter 'clusterExtId' is set
        if ('clusterExtId' not in params or params['clusterExtId'] is None):
            raise ValueError("Missing the required parameter `clusterExtId` when calling `update_ssl_certificate`")  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/clustermgmt/v4.2/config/clusters/{clusterExtId}/ssl-certificate', 'PUT',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
                    post_params=form_params,
                    files=local_var_files,
                    response_type='clustermgmt.v4.config.UpdateSSLCertificateApiResponse',  # noqa: E501
                    auth_settings=auth_settings,
                    async_req=params.get('async_req'),
                    _return_http_data_only=params.get('_return_http_data_only'),
                    _preload_content=params.get('_preload_content', True),
