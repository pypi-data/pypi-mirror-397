...
class BmcApi(object):
    ...
    def get_bmc_info(self, clusterExtId, extId, **kwargs):  # noqa: E501
        ...
        :param clusterExtId: UUID of the cluster.
        :type clusterExtId:
            :class:`str`, required
        :param extId: UUID of the host.
        :type extId:
            :class:`str`, required
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/clustermgmt/v4.2/config/clusters/{clusterExtId}/hosts/{extId}/bmc-info', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def update_bmc_info(self, clusterExtId, extId, body, **kwargs):  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/clustermgmt/v4.2/config/clusters/{clusterExtId}/hosts/{extId}/bmc-info', 'PUT',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
