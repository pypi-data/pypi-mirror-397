...
class AcrossServerRoutesV1UserSchemasGroupInvite(BaseModel):
    """
    ...
    sender: UserInfo
    __properties: ClassVar[List[str]] = ["id", "group", "sender"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "group": GroupInviteGroupDetails.from_dict(obj["group"]) if obj.get("group") is not None else None,
