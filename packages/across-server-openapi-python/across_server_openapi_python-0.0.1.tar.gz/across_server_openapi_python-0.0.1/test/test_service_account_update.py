...
class TestServiceAccountUpdate(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ServiceAccountUpdate:
        """Test ServiceAccountUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ServiceAccountUpdate`
        """
        model = ServiceAccountUpdate()
        if include_optional:
    ...
    def testServiceAccountUpdate(self):
        """Test ServiceAccountUpdate"""
