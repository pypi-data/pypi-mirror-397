...
from across.sdk.v2.models.observation_create import ObservationCreate

class TestObservationCreate(unittest.TestCase):
    """ObservationCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ObservationCreate:
        """Test ObservationCreate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ObservationCreate`
        """
    ...
    def testObservationCreate(self):
        """Test ObservationCreate"""
