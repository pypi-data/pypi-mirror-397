...
try:
    from ezmsg.panel.__version__ import version as release
except ImportError:
    release = "unknown"
...
html_baseurl = "https://www.ezmsg.org/ezmsg-panel/"

html_theme_options = {
    "logo": {
        "text": f"ezmsg.panel {version}",
    ...
    "icon_links": [
        {
            "name": "GitHub",
            "url": "https://github.com/ezmsg-org/ezmsg-panel",
...
branch = "main"
code_url = f"https://github.com/ezmsg-org/ezmsg-panel/blob/{branch}/"
