...
def _process_table_blks_cnt_type(
    ...
    # mypy doesn't recognize that sub-setting an ArrayBIGINT returns an ArrayBIGINT
    # se we view-cast the result to shut it up; luckily, this appears to be costless
    return invdata_array[np.argsort(invdata_array[:, 0])].view(ArrayBIGINT)
