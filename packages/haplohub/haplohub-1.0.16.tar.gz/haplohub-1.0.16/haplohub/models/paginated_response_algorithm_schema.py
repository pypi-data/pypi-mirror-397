...
class PaginatedResponseAlgorithmSchema(BaseModel):
    """
    ...
    items: conlist(AlgorithmSchema) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaginatedResponseAlgorithmSchema:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaginatedResponseAlgorithmSchema:
        """Create an instance of PaginatedResponseAlgorithmSchema from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaginatedResponseAlgorithmSchema.parse_obj(obj)

        _obj = PaginatedResponseAlgorithmSchema.parse_obj(
            {
                "status": obj.get("status"),
                "total_count": obj.get("total_count"),
                "items": [AlgorithmSchema.from_dict(_item) for _item in obj.get("items")]
