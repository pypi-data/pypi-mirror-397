...
class ResultResponseAlgorithmSchema(BaseModel):
    """
    ResultResponseAlgorithmSchema
    """

    status: Optional[ResponseStatus] = None
    result: AlgorithmSchema = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResultResponseAlgorithmSchema:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResultResponseAlgorithmSchema:
        """Create an instance of ResultResponseAlgorithmSchema from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResultResponseAlgorithmSchema.parse_obj(obj)

        _obj = ResultResponseAlgorithmSchema.parse_obj(
            {
                "status": obj.get("status"),
                "result": AlgorithmSchema.from_dict(obj.get("result")) if obj.get("result") is not None else None,
            }
        )
        return _obj
