...
class GetTraitResponse(BaseModel):
    """
    GetTraitResponse
    """

    status: Optional[ResponseStatus] = None
    result: TraitSchema = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetTraitResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetTraitResponse:
        """Create an instance of GetTraitResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetTraitResponse.parse_obj(obj)

        _obj = GetTraitResponse.parse_obj(
            {
                "status": obj.get("status"),
                "result": TraitSchema.from_dict(obj.get("result")) if obj.get("result") is not None else None,
            }
        )
        return _obj
