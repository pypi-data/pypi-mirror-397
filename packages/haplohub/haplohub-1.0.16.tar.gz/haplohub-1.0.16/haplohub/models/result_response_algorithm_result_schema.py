...
class ResultResponseAlgorithmResultSchema(BaseModel):
    """
    ResultResponseAlgorithmResultSchema
    """

    status: Optional[ResponseStatus] = None
    result: AlgorithmResultSchema = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResultResponseAlgorithmResultSchema:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResultResponseAlgorithmResultSchema:
        """Create an instance of ResultResponseAlgorithmResultSchema from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResultResponseAlgorithmResultSchema.parse_obj(obj)

        _obj = ResultResponseAlgorithmResultSchema.parse_obj(
            {
                "status": obj.get("status"),
                "result": AlgorithmResultSchema.from_dict(obj.get("result")) if obj.get("result") is not None else None,
            }
        )
        return _obj
