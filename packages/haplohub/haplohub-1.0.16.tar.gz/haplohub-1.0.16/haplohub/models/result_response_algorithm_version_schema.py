...
class ResultResponseAlgorithmVersionSchema(BaseModel):
    """
    ResultResponseAlgorithmVersionSchema
    """

    status: Optional[ResponseStatus] = None
    result: AlgorithmVersionSchema = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResultResponseAlgorithmVersionSchema:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResultResponseAlgorithmVersionSchema:
        """Create an instance of ResultResponseAlgorithmVersionSchema from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResultResponseAlgorithmVersionSchema.parse_obj(obj)

        _obj = ResultResponseAlgorithmVersionSchema.parse_obj(
            {
                "status": obj.get("status"),
                "result": AlgorithmVersionSchema.from_dict(obj.get("result")) if obj.get("result") is not None else None,
            }
        )
        return _obj
