...
with haplohub.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete sample
        api_response = api_instance.delete_sample(cohort_id, sample_id, sample_external_id=sample_external_id)
...
with haplohub.ApiClient(configuration) as api_client:
    ...
    try:
        # Get sample
        api_response = api_instance.get_sample(cohort_id, sample_id, sample_external_id=sample_external_id)
...
with haplohub.ApiClient(configuration) as api_client:
    ...
    try:
        # Update sample
        api_response = api_instance.update_sample(cohort_id, sample_id, update_sample_request, sample_external_id=sample_external_id)
