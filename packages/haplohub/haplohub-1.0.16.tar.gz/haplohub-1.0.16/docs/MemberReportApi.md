...
with haplohub.ApiClient(configuration) as api_client:
    ...
    try:
        # Create member report
        api_response = api_instance.create_member_report(cohort_id, member_id, report_template_id, member_external_id=member_external_id, sample_id=sample_id, sample_external_id=sample_external_id)
