...
with haplohub.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete member
        api_response = api_instance.delete_member(cohort_id, member_id, member_external_id=member_external_id)
...
with haplohub.ApiClient(configuration) as api_client:
    ...
    try:
        # Get member
        api_response = api_instance.get_member(cohort_id, member_id, member_external_id=member_external_id)
...
with haplohub.ApiClient(configuration) as api_client:
    ...
    try:
        # Update member
        api_response = api_instance.update_member(cohort_id, member_id, update_member_request, member_external_id=member_external_id)
