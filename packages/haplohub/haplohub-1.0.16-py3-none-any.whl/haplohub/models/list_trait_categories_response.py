...
class ListTraitCategoriesResponse(BaseModel):
    """
    ...
    items: conlist(TraitCategorySchema) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTraitCategoriesResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTraitCategoriesResponse:
        """Create an instance of ListTraitCategoriesResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTraitCategoriesResponse.parse_obj(obj)

        _obj = ListTraitCategoriesResponse.parse_obj(
            {
                "status": obj.get("status"),
                "total_count": obj.get("total_count"),
                "items": [TraitCategorySchema.from_dict(_item) for _item in obj.get("items")]
