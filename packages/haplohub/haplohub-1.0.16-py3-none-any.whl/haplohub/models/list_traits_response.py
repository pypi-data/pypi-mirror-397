...
class ListTraitsResponse(BaseModel):
    ...
    items: conlist(TraitSchema) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTraitsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTraitsResponse:
        """Create an instance of ListTraitsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTraitsResponse.parse_obj(obj)

        _obj = ListTraitsResponse.parse_obj(
            {
                "status": obj.get("status"),
                "total_count": obj.get("total_count"),
                "items": [TraitSchema.from_dict(_item) for _item in obj.get("items")]
