...
class PaginatedResponseScoreSchema(BaseModel):
    """
    ...
    items: conlist(ScoreSchema) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaginatedResponseScoreSchema:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaginatedResponseScoreSchema:
        """Create an instance of PaginatedResponseScoreSchema from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaginatedResponseScoreSchema.parse_obj(obj)

        _obj = PaginatedResponseScoreSchema.parse_obj(
            {
                "status": obj.get("status"),
                "total_count": obj.get("total_count"),
                "items": [ScoreSchema.from_dict(_item) for _item in obj.get("items")]
