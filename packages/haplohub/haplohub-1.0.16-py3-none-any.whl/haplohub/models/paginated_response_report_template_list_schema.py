...
class PaginatedResponseReportTemplateListSchema(BaseModel):
    """
    ...
    items: conlist(ReportTemplateListSchema) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaginatedResponseReportTemplateListSchema:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaginatedResponseReportTemplateListSchema:
        """Create an instance of PaginatedResponseReportTemplateListSchema from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaginatedResponseReportTemplateListSchema.parse_obj(obj)

        _obj = PaginatedResponseReportTemplateListSchema.parse_obj(
            {
                "status": obj.get("status"),
                "total_count": obj.get("total_count"),
                "items": [ReportTemplateListSchema.from_dict(_item) for _item in obj.get("items")]
