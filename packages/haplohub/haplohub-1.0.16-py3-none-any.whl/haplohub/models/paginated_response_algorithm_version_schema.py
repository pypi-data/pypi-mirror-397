...
class PaginatedResponseAlgorithmVersionSchema(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaginatedResponseAlgorithmVersionSchema:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaginatedResponseAlgorithmVersionSchema:
        """Create an instance of PaginatedResponseAlgorithmVersionSchema from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaginatedResponseAlgorithmVersionSchema.parse_obj(obj)

        _obj = PaginatedResponseAlgorithmVersionSchema.parse_obj(
            {
