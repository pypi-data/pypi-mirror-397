...
class PaginatedResponseAlgorithmResultSchema(BaseModel):
    """
    ...
    items: conlist(AlgorithmResultSchema) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaginatedResponseAlgorithmResultSchema:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaginatedResponseAlgorithmResultSchema:
        """Create an instance of PaginatedResponseAlgorithmResultSchema from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaginatedResponseAlgorithmResultSchema.parse_obj(obj)

        _obj = PaginatedResponseAlgorithmResultSchema.parse_obj(
            {
                "status": obj.get("status"),
                "total_count": obj.get("total_count"),
                "items": [AlgorithmResultSchema.from_dict(_item) for _item in obj.get("items")]
