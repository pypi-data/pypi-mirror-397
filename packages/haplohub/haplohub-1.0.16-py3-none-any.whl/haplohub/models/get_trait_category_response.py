...
class GetTraitCategoryResponse(BaseModel):
    """
    GetTraitCategoryResponse
    """

    status: Optional[ResponseStatus] = None
    result: TraitCategorySchema = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetTraitCategoryResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetTraitCategoryResponse:
        """Create an instance of GetTraitCategoryResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetTraitCategoryResponse.parse_obj(obj)

        _obj = GetTraitCategoryResponse.parse_obj(
            {
                "status": obj.get("status"),
                "result": TraitCategorySchema.from_dict(obj.get("result")) if obj.get("result") is not None else None,
            }
        )
        return _obj
