...
class ResultResponseScoreSchema(BaseModel):
    """
    ResultResponseScoreSchema
    """

    status: Optional[ResponseStatus] = None
    result: ScoreSchema = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResultResponseScoreSchema:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResultResponseScoreSchema:
        """Create an instance of ResultResponseScoreSchema from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResultResponseScoreSchema.parse_obj(obj)

        _obj = ResultResponseScoreSchema.parse_obj(
            {
                "status": obj.get("status"),
                "result": ScoreSchema.from_dict(obj.get("result")) if obj.get("result") is not None else None,
            }
        )
        return _obj
