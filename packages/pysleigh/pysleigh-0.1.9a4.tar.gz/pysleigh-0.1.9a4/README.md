...
- Use `--project-root /path/to/advent-of-code-python` when invoking the CLI from outside your AoC repo so the built-in `PathConfig` can resolve inputs, answers, and article directories.
