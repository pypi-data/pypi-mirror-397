...
// IoTDB 路径管理
export const getIoTDBPaths = (params?: { path_pattern?: string }) => {
  return http.get(PORT1 + "/database/iotdb/paths", params);
};

export const clearIoTDBData = (params?: { path?: string; delete_path?: boolean }) => {
  return http.delete(PORT1 + "/database/iotdb/paths", params);
};
