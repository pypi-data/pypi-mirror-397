export default {
  ...
  dataBase: {
    ...
    clearAllData: "清理所有数据",
    clearData: "清理数据",
    clearAllDataConfirm: "确认清理所有 IoTDB 推理数据吗？此操作不可恢复！",
    clearPathDataConfirm: "确认清理路径【{path}】的数据吗？此操作不可恢复！",
    clearDataSuccess: "数据清理成功",
    deleteAllPaths: "删除所有路径",
    deletePath: "删除路径",
    deleteAllPathsConfirm: "确认删除所有 IoTDB 推理路径吗？此操作不可恢复，路径结构将被删除！",
    deletePathConfirm: "确认删除路径【{path}】吗？此操作不可恢复，路径结构将被删除！",
    deletePathSuccess: "路径删除成功",
    viewData: "查看数据"
  },
  scene: {
