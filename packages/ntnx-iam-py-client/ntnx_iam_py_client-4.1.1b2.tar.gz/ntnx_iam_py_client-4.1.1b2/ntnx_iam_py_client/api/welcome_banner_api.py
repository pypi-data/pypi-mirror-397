...
class WelcomeBannerApi(object):
    ...
    def get_welcome_banner(self, **kwargs):  # noqa: E501
        """Get welcome banner

        >>> response = api.get_welcome_banner()

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.get_welcome_banner(async_req=True)
        >>> result = thread.get()
        ...
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
                           ...
                           async_req=True
        :return: An instance of class :class:`~ntnx_iam_py_client.models.iam.v4.authn.GetWelcomeBannerApiResponse`.
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/iam/v4.1.b2/authn/welcome-banner', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
                    ...
                    response_type='iam.v4.authn.GetWelcomeBannerApiResponse',  # noqa: E501
    ...
    def update_welcome_banner(self, body, **kwargs):  # noqa: E501
        """Update welcome banner

        >>> response = api.update_welcome_banner(body)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.update_welcome_banner(body, async_req=True)
        >>> result = thread.get()

        :param body: Information for the update welcome banner request.
        :type body:
            :class:`~ntnx_iam_py_client.models.iam.v4.authn.WelcomeBanner`, required
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::

                           async_req=True
        :return: An instance of class :class:`~ntnx_iam_py_client.models.iam.v4.authn.UpdateWelcomeBannerApiResponse`.
        ...
        if ('body' not in params or params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `update_welcome_banner`")  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/iam/v4.1.b2/authn/welcome-banner', 'PUT',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
                    post_params=form_params,
                    files=local_var_files,
                    response_type='iam.v4.authn.UpdateWelcomeBannerApiResponse',  # noqa: E501
                    auth_settings=auth_settings,
                    async_req=params.get('async_req'),
                    _return_http_data_only=params.get('_return_http_data_only'),
                    _preload_content=params.get('_preload_content', True),
