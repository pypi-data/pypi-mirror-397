...
class SAMLIdentityProvidersApi(object):
    ...
    def create_saml_identity_provider(self, body, **kwargs):  # noqa: E501
        ...
        :param body: Information for the create SAML identity provider request.
        :type body:
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/iam/v4.1.b2/authn/saml-identity-providers', 'POST',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def delete_saml_identity_provider_by_id(self, extId, **kwargs):  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/iam/v4.1.b2/authn/saml-identity-providers/{extId}', 'DELETE',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def get_saml_identity_provider_by_id(self, extId, **kwargs):  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/iam/v4.1.b2/authn/saml-identity-providers/{extId}', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def get_saml_idp_sp_metadata_by_id(self, extId, **kwargs):  # noqa: E501
        """Downloads SP-Metadata for SAML identity provider.

        >>> response = api.get_saml_idp_sp_metadata_by_id(extId)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.get_saml_idp_sp_metadata_by_id(extId, async_req=True)
        >>> result = thread.get()
        ...
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
                           ...
                           async_req=True
        :return: An instance of class :class:`~ntnx_iam_py_client.models.iam.v4.authn.GetSamlIdpSpMetadataApiResponse`.
        ...
        # verify the required parameter 'extId' is set
        if ('extId' not in params or params['extId'] is None):
            raise ValueError("Missing the required parameter `extId` when calling `get_saml_idp_sp_metadata_by_id`")  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/iam/v4.1.b2/authn/saml-identity-providers/{extId}/sp-metadata', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
                    post_params=form_params,
                    files=local_var_files,
                    response_type='iam.v4.authn.GetSamlIdpSpMetadataApiResponse',  # noqa: E501
                    auth_settings=auth_settings,
                    async_req=params.get('async_req'),
                    _return_http_data_only=params.get('_return_http_data_only'),
                    _preload_content=params.get('_preload_content', True),
    ...
    def get_saml_sp_metadata(self, **kwargs):  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/iam/v4.1.b2/authn/saml-sp-metadata', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def list_saml_identity_providers(self, _page=None, _limit=None, _filter=None, _orderby=None, _select=None, **kwargs):  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/iam/v4.1.b2/authn/saml-identity-providers', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def update_saml_identity_provider_by_id(self, extId, body, **kwargs):  # noqa: E501
        ...
        :type extId:
            :class:`str`, required
        :param body: Information for the update SAML identity provider request.
        :type body:
            :class:`~ntnx_iam_py_client.models.iam.v4.authn.SamlIdentityProvider`, required
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/iam/v4.1.b2/authn/saml-identity-providers/{extId}', 'PUT',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
