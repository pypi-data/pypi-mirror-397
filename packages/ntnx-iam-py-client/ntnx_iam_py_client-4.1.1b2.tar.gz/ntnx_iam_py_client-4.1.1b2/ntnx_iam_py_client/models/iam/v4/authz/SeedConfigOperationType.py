...
class SeedConfigOperationType(object):
    ...
    Allowed enum values:
        ...
        - _UNKNOWN
        - _REDACTED
        - CREATE: A key type that is used to identify a service.
        - UPDATE: A combination of access key and secret key to sign an API request.
    """
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    CREATE = "CREATE"
    ...
    def _initialize_object_type(self):
        return 'iam.v4.authz.SeedConfigOperationType'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(SeedConfigOperationType, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SeedConfigOperationType):
            return False
