...
class UserAuthorizationPolicy(BaseAuthorizationPolicy):
    ...
    def _initialize_object_type(self):
        return 'iam.v4.authz.UserAuthorizationPolicy'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(UserAuthorizationPolicy, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UserAuthorizationPolicy):
            return False
