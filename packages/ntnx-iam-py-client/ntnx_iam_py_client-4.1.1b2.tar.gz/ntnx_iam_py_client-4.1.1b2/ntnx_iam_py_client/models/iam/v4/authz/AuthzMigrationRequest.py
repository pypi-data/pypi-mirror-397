...
from ntnx_iam_py_client.models.iam.v4.authz.AuthzMigrationType import AuthzMigrationType  # noqa: F401,E501

class AuthzMigrationRequest(object):

    """The authZ migration API request body.

    :param migration_type: (:attr:`migration_type`) 
    :type migration_type: required
    ...
    """  # noqa: E501
    swagger_types = {
        'migration_type': 'iam.v4.authz.AuthzMigrationType',
    ...
    def __init__(self, migration_type=None, *args, **kwargs):  # noqa: E501
        self.__migration_type = None
        self.discriminator = None
        self.__migration_type = migration_type
        # populate hidden vars if not empty
        self._populate_hidden_vars(kwargs)

    def _initialize_object_type(self):
        return 'iam.v4.authz.AuthzMigrationRequest'
    ...
    def migration_type(self):
        ...
        :type:
            :class:`~ntnx_iam_py_client.models.iam.v4.authz.AuthzMigrationType`
        """  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(AuthzMigrationRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AuthzMigrationRequest):
            return False
