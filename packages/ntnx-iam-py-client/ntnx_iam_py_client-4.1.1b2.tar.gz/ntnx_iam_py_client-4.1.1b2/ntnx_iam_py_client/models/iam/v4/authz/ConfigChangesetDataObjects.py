...
class ConfigChangesetDataObjects(object):

    """The changeset data corresponding to IAM configuration \"entity\".

    :param added_objects: (:attr:`added_objects`) Configuration changeset data for added legacyObjectList entries.
    :type added_objects: 
    
    
    :param removed_objects: (:attr:`removed_objects`) Configuration changeset data for removed legacyObjectList entries.
    :type removed_objects: 
    ...
    def __init__(self, added_objects=None, removed_objects=None, *args, **kwargs):  # noqa: E501
        self.__added_objects = None
        self.__removed_objects = None
        self.discriminator = None
        if added_objects is not None:
            self.__added_objects = added_objects
        if removed_objects is not None:
            self.__removed_objects = removed_objects
        # populate hidden vars if not empty
        self._populate_hidden_vars(kwargs)

    def _initialize_object_type(self):
        return 'iam.v4.authz.ConfigChangesetDataObjects'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ConfigChangesetDataObjects, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ConfigChangesetDataObjects):
            return False
