...
class SystemConfig(object):
    ...
    :param name_value_pair: (:attr:`name_value_pair`) Name Value Pair of the system configuration.
    :type name_value_pair: required
    
    
    :param last_updated_time: (:attr:`last_updated_time`) Last update time for the system configuration.
    ...
    """  # noqa: E501
    swagger_types = {
        'name_value_pair': 'list[common.v1.config.KVPair]',
    ...
    def __init__(self, name_value_pair=None, last_updated_time=None, *args, **kwargs):  # noqa: E501
        self.__name_value_pair = None
        self.__last_updated_time = None
        self.discriminator = None
        self.__name_value_pair = name_value_pair
    ...
    def name_value_pair(self):
        ...
        """  # noqa: E501
        return self.__name_value_pair

    @name_value_pair.setter
    def name_value_pair(self, name_value_pair):
        if name_value_pair is None:
            raise ValueError("Invalid value for `name_value_pair`, must not be `None`")  # noqa: E501
