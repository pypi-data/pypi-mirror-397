...
class UserConfiguration(object):
    ...
    :param user_object_class: (:attr:`user_object_class`) Object class in the OpenLDAP system that corresponds to the users.
    ...
    :param username_attribute: (:attr:`username_attribute`) Unique identifier for each user that can be used in authentication.
