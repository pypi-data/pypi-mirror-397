...
class BucketsAccessKeyStatusType(object):
    ...
    def _initialize_object_type(self):
        return 'iam.v4.authn.BucketsAccessKeyStatusType'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(BucketsAccessKeyStatusType, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BucketsAccessKeyStatusType):
            return False
