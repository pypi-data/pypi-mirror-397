...
from ntnx_iam_py_client.models.iam.v4.authz.RoleConfig import RoleConfig  # noqa: F401,E501

class SeedConfigRoleList(object):

    """The role objects that will be seeded.

    :param roles: (:attr:`roles`) The role objects that will be seeded.
    :type roles: 
    ...
    """  # noqa: E501
    swagger_types = {
        'roles': 'list[iam.v4.authz.RoleConfig]',
    ...
    def __init__(self, roles=None, *args, **kwargs):  # noqa: E501
        self.__roles = None
    ...
    def _initialize_object_type(self):
        return 'iam.v4.authz.SeedConfigRoleList'
    ...
    def roles(self):
        ...
        :type:
             list[ :class:`~ntnx_iam_py_client.models.iam.v4.authz.RoleConfig` ]
        """  # noqa: E501
        return self.__roles
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(SeedConfigRoleList, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SeedConfigRoleList):
            return False
