...
class ApiKeyDetails(object):
    ...
    def __init__(self, api_key=None, *args, **kwargs):  # noqa: E501
        self.__api_key = None
    ...
    def _initialize_object_type(self):
        return 'iam.v4.authn.ApiKeyDetails'
    ...
    def api_key(self, api_key):
        if api_key is not None and len(api_key) > 32:
            raise ValueError("Invalid value for `api_key`, length must be less than or equal to `32`")  # noqa: E501
        if api_key is not None and len(api_key) < 32:
            raise ValueError("Invalid value for `api_key`, length must be greater than or equal to `32`")  # noqa: E501
