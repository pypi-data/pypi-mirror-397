...
class ValidateCredentialsRequest(object):
    ...
    def _initialize_object_type(self):
        return 'iam.v4.authn.ValidateCredentialsRequest'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ValidateCredentialsRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ValidateCredentialsRequest):
            return False
