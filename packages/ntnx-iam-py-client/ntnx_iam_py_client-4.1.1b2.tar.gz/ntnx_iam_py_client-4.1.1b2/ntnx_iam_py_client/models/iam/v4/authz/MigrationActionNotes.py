...
class MigrationActionNotes(object):

    """Operation schema change-specific notes for capturing information to surface to the user to take relevant actions.

    :param notes: (:attr:`notes`) Specific detailed description around operation schema changes for the end user to understand the impact.
    :type notes: required
     max=1000 chars
    ...
    def __init__(self, notes=None, *args, **kwargs):  # noqa: E501
        self.__notes = None
    ...
    def _initialize_object_type(self):
        return 'iam.v4.authz.MigrationActionNotes'
    ...
    def notes(self, notes):
        ...
        if notes is not None and len(notes) > 1000:
            raise ValueError("Invalid value for `notes`, length must be less than or equal to `1000`")  # noqa: E501
        if notes is not None and not re.search('^[^<>;()&+%\/\\\\\"`]*$', notes):  # noqa: E501
            raise ValueError(r"Invalid value for `notes`, must be a follow pattern or equal to `/^[^<>;()&+%\/\\\\\"`]*$/`")  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(MigrationActionNotes, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MigrationActionNotes):
            return False
