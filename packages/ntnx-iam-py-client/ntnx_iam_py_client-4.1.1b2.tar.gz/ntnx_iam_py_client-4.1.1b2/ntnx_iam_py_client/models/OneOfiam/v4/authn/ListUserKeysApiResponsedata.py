...
class ListUserKeysApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<iam.v4.authn.Key>': 'list[iam.v4.authn.Key]',
    ...
    def _initialize_object_type(self):
        return 'OneOfiam.v4.authn.ListUserKeysApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListUserKeysApiResponsedata.discriminator_value_class_map.values():
            return list(ListUserKeysApiResponsedata.discriminator_value_class_map.keys())[list(ListUserKeysApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListUserKeysApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListUserKeysApiResponsedata):
            return False
