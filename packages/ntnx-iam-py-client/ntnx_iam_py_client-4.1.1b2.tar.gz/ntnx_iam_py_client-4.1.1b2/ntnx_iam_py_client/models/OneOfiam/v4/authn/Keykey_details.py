...
class Keykey_details(object):
    ...
    discriminator_value_class_map = {
        ...
        'iam.v4.authn.ApiKeyDetails': 'iam.v4.authn.ApiKeyDetails',
        'iam.v4.authn.ObjectKeyDetails': 'iam.v4.authn.ObjectKeyDetails'
    }

    ONE_OF_ITEM_DISCRIMINATOR_NAME = '$keyDetailsItemDiscriminator'
    ...
    def _initialize_object_type(self):
        return 'OneOfiam.v4.authn.Keykey_details'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in Keykey_details.discriminator_value_class_map.values():
            return list(Keykey_details.discriminator_value_class_map.keys())[list(Keykey_details.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(Keykey_details, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, Keykey_details):
            return False
