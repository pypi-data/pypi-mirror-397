...
class RevokeUserKeyApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'iam.v4.error.AppMessage': 'iam.v4.error.AppMessage',
    ...
    def _initialize_object_type(self):
        return 'OneOfiam.v4.authn.RevokeUserKeyApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in RevokeUserKeyApiResponsedata.discriminator_value_class_map.values():
            return list(RevokeUserKeyApiResponsedata.discriminator_value_class_map.keys())[list(RevokeUserKeyApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(RevokeUserKeyApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RevokeUserKeyApiResponsedata):
            return False
