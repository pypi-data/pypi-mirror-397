...
class GetWelcomeBannerApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfiam.v4.authn.GetWelcomeBannerApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetWelcomeBannerApiResponsedata.discriminator_value_class_map.values():
            return list(GetWelcomeBannerApiResponsedata.discriminator_value_class_map.keys())[list(GetWelcomeBannerApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetWelcomeBannerApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetWelcomeBannerApiResponsedata):
            return False
