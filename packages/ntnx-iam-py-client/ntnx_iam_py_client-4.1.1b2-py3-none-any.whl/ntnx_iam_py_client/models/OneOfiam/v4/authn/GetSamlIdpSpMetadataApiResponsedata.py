...
class GetSamlIdpSpMetadataApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfiam.v4.authn.GetSamlIdpSpMetadataApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetSamlIdpSpMetadataApiResponsedata.discriminator_value_class_map.values():
            return list(GetSamlIdpSpMetadataApiResponsedata.discriminator_value_class_map.keys())[list(GetSamlIdpSpMetadataApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetSamlIdpSpMetadataApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetSamlIdpSpMetadataApiResponsedata):
            return False
