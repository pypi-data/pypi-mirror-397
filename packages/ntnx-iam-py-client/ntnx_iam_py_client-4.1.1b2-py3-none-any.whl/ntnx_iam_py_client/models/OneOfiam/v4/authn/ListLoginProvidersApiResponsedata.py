...
class ListLoginProvidersApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<iam.v4.authn.LoginProvider>': 'list[iam.v4.authn.LoginProvider]',
    ...
    def _initialize_object_type(self):
        return 'OneOfiam.v4.authn.ListLoginProvidersApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListLoginProvidersApiResponsedata.discriminator_value_class_map.values():
            return list(ListLoginProvidersApiResponsedata.discriminator_value_class_map.keys())[list(ListLoginProvidersApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListLoginProvidersApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListLoginProvidersApiResponsedata):
            return False
