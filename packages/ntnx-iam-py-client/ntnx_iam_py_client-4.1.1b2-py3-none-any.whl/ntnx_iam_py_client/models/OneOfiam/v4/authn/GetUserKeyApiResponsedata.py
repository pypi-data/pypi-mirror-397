...
class GetUserKeyApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'iam.v4.authn.Key': 'iam.v4.authn.Key',
    ...
    def _initialize_object_type(self):
        return 'OneOfiam.v4.authn.GetUserKeyApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetUserKeyApiResponsedata.discriminator_value_class_map.values():
            return list(GetUserKeyApiResponsedata.discriminator_value_class_map.keys())[list(GetUserKeyApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetUserKeyApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetUserKeyApiResponsedata):
            return False
