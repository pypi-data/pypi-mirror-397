...
class UpdateWelcomeBannerApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'iam.v4.authn.WelcomeBanner': 'iam.v4.authn.WelcomeBanner',
    ...
    def _initialize_object_type(self):
        return 'OneOfiam.v4.authn.UpdateWelcomeBannerApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in UpdateWelcomeBannerApiResponsedata.discriminator_value_class_map.values():
            return list(UpdateWelcomeBannerApiResponsedata.discriminator_value_class_map.keys())[list(UpdateWelcomeBannerApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(UpdateWelcomeBannerApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateWelcomeBannerApiResponsedata):
            return False
