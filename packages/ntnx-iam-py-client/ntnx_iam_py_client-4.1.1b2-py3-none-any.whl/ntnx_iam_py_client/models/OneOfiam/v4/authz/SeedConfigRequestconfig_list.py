...
class SeedConfigRequestconfig_list(object):
    ...
    discriminator_value_class_map = {
        ...
        'iam.v4.authz.ClientConfig': 'iam.v4.authz.ClientConfig',
        'iam.v4.authz.SeedConfigEntityList': 'iam.v4.authz.SeedConfigEntityList',
        'iam.v4.authz.SeedConfigOperationList': 'iam.v4.authz.SeedConfigOperationList',
        'iam.v4.authz.SeedConfigRoleList': 'iam.v4.authz.SeedConfigRoleList',
        'iam.v4.authz.SeedConfigAuthorizationPolicyList': 'iam.v4.authz.SeedConfigAuthorizationPolicyList'
    }

    ONE_OF_ITEM_DISCRIMINATOR_NAME = '$configListItemDiscriminator'
    ...
    def _initialize_object_type(self):
        return 'OneOfiam.v4.authz.SeedConfigRequestconfig_list'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in SeedConfigRequestconfig_list.discriminator_value_class_map.values():
            return list(SeedConfigRequestconfig_list.discriminator_value_class_map.keys())[list(SeedConfigRequestconfig_list.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(SeedConfigRequestconfig_list, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SeedConfigRequestconfig_list):
            return False
