...
class ObjectsAuthSpec(object):

    """The specification needed to fetch the auth details.

    :param access_key: (:attr:`access_key`) The access key which is used to retrieve the auth details.
    ...
    def __init__(self, access_key=None, *args, **kwargs):  # noqa: E501
    ...
    def _initialize_object_type(self):
        return 'iam.v4.authn.ObjectsAuthSpec'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ObjectsAuthSpec, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ObjectsAuthSpec):
            return False
