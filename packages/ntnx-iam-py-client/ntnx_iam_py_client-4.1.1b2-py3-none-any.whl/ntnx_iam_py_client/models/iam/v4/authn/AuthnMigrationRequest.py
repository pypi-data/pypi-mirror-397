...
from ntnx_iam_py_client.models.iam.v4.authn.AuthnMigrationType import AuthnMigrationType  # noqa: F401,E501

class AuthnMigrationRequest(object):
    ...
    """  # noqa: E501
    swagger_types = {
        'migration_type': 'iam.v4.authn.AuthnMigrationType',
    ...
    def _initialize_object_type(self):
        return 'iam.v4.authn.AuthnMigrationRequest'
    ...
    def migration_type(self):
        ...
        :type:
            :class:`~ntnx_iam_py_client.models.iam.v4.authn.AuthnMigrationType`
        """  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(AuthnMigrationRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AuthnMigrationRequest):
            return False
