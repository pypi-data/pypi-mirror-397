...
class KeyMigrationSpec(object):

    """Migrate keys request.

    :param max_key_count: (:attr:`max_key_count`) Number of keys to be migrated in this API call.
    :type max_key_count: required
    ...
    def __init__(self, max_key_count=None, *args, **kwargs):  # noqa: E501
        self.__max_key_count = None
        self.discriminator = None
        self.__max_key_count = max_key_count
        # populate hidden vars if not empty
        self._populate_hidden_vars(kwargs)

    def _initialize_object_type(self):
        return 'iam.v4.authn.KeyMigrationSpec'
    ...
    def max_key_count(self):
        ...
        :type:
                :class:`~int`
        """  # noqa: E501
        return self.__max_key_count

    @max_key_count.setter
    def max_key_count(self, max_key_count):
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(KeyMigrationSpec, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, KeyMigrationSpec):
            return False
