...
class WelcomeBanner(object):

    """Welcome banner API.

    :param content: (:attr:`content`) Content of the welcome banner.
    :type content: 
     max=10000 chars
    
    :param is_enabled: (:attr:`is_enabled`) Flag to denote whether the welcome banner is enabled or not. (**Default** True)
    :type is_enabled: 
    
    
    :param created_time: (:attr:`created_time`) Creation time of the welcome banner.
    :type created_time: 
    
    
    :param last_updated_time: (:attr:`last_updated_time`) Last updated time of the welcome banner.
    ...
    def __init__(self, content=None, is_enabled=True, created_time=None, last_updated_time=None, *args, **kwargs):  # noqa: E501
        self.__content = None
    ...
    def _initialize_object_type(self):
        return 'iam.v4.authn.WelcomeBanner'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(WelcomeBanner, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WelcomeBanner):
            return False
