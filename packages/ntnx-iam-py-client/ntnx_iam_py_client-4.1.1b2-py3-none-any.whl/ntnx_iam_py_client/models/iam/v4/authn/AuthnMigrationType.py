...
class AuthnMigrationType(object):
    ...
    Allowed enum values:
        ...
        - _UNKNOWN
        - _REDACTED
        - HASH_OIDC_CLIENT_SECRET: The migration to remove secret and store secret hash for OIDC clients.
    """
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    HASH_OIDC_CLIENT_SECRET = "HASH_OIDC_CLIENT_SECRET"
    ...
    def _initialize_object_type(self):
        return 'iam.v4.authn.AuthnMigrationType'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(AuthnMigrationType, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AuthnMigrationType):
            return False
