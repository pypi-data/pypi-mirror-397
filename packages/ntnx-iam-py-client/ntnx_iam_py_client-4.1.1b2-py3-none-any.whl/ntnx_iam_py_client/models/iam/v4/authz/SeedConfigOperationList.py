...
from ntnx_iam_py_client.models.iam.v4.authz.OperationConfig import OperationConfig  # noqa: F401,E501

class SeedConfigOperationList(object):

    """The operation objects that will be seeded.

    :param operations: (:attr:`operations`) The operation objects that will be seeded.
    :type operations: 
    ...
    """  # noqa: E501
    swagger_types = {
        'operations': 'list[iam.v4.authz.OperationConfig]',
    ...
    def __init__(self, operations=None, *args, **kwargs):  # noqa: E501
    ...
    def _initialize_object_type(self):
        return 'iam.v4.authz.SeedConfigOperationList'
    ...
    def operations(self):
        ...
        :type:
             list[ :class:`~ntnx_iam_py_client.models.iam.v4.authz.OperationConfig` ]
        """  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(SeedConfigOperationList, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SeedConfigOperationList):
            return False
