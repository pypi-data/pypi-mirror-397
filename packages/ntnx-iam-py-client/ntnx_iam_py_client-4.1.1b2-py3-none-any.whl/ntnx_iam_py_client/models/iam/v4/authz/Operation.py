...
class Operation(ExternalizableAbstractModel):
    ...
    :param migration_action_notes: (:attr:`migration_action_notes`) 
    :type migration_action_notes: 
    ...
    def __init__(self, display_name=None, description=None, entity_type=None, client_name=None, created_time=None, last_updated_time=None, operation_type=None, related_operation_list=None, associated_endpoint_list=None, migration_action_notes=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
        ...
        self.__migration_action_notes = None
        ...
        if migration_action_notes is not None:
            self.__migration_action_notes = migration_action_notes
    ...
    @property
    def migration_action_notes(self):
        """
        

        :type:
            :class:`~ntnx_iam_py_client.models.iam.v4.authz.MigrationActionNotes`
        """  # noqa: E501
        return self.__migration_action_notes

    @migration_action_notes.setter
    def migration_action_notes(self, migration_action_notes):
