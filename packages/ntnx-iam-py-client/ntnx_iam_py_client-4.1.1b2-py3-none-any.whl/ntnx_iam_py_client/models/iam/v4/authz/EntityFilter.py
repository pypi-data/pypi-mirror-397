...
class EntityFilter(object):
    ...
    :param entity_filter: (:attr:`entity_filter`) Information of the entity filter present in the EntityFilter object.
    :type entity_filter: 
    ...
    def __init__(self, entity_filter=None, *args, **kwargs):  # noqa: E501
        self.__entity_filter = None
