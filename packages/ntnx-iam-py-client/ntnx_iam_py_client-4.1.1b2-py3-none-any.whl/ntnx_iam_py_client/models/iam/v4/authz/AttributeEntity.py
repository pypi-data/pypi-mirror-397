...
class AttributeEntity(ExternalizableAbstractModel):
    ...
    :param display_name: (:attr:`display_name`) Display name of the entity's attribute used in Authorization Policy filters.
    :type display_name: 
     min=1 chars, max=255 chars
    
    :param name: (:attr:`name`) Name of the entity's attribute used in Authorization Policy filters.
    :type name: 
     min=1 chars, max=255 chars
    ...
    def __init__(self, display_name=None, name=None, supported_operators=None, attribute_values=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
