...
class IdentityFilter(object):
    ...
    :param identity_filter: (:attr:`identity_filter`) Information of the identity filter present in the IdentityFilter object.
    :type identity_filter: 
    ...
    def __init__(self, identity_filter=None, *args, **kwargs):  # noqa: E501
        self.__identity_filter = None
        self.discriminator = None
        if identity_filter is not None:
            self.__identity_filter = identity_filter
    ...
    def identity_filter(self):
        ...
        :type:
                :class:`~object`
        """  # noqa: E501
        return self.__identity_filter

    @identity_filter.setter
    def identity_filter(self, identity_filter):
