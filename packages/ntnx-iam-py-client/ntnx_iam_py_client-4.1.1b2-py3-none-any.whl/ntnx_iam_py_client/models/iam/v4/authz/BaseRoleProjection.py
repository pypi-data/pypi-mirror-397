...
class BaseRoleProjection(BaseRole):
    ...
    def __init__(self, display_name=None, client_name=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
        BaseRole.__init__(self, display_name, client_name, ext_id, links, tenant_id, *args, **kwargs)
        self.discriminator = None

    def _initialize_object_type(self):
        return 'iam.v4.authz.BaseRoleProjection'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(BaseRoleProjection, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BaseRoleProjection):
            return False
