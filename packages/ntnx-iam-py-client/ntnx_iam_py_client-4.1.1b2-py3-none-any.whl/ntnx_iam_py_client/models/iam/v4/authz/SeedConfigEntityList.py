...
from ntnx_iam_py_client.models.iam.v4.authz.EntityConfig import EntityConfig  # noqa: F401,E501

class SeedConfigEntityList(object):

    """The entities config that will be seeded.

    :param entities: (:attr:`entities`) The entities config that will be seeded.
    :type entities: 
    ...
    """  # noqa: E501
    swagger_types = {
        'entities': 'list[iam.v4.authz.EntityConfig]',
    ...
    def _initialize_object_type(self):
        return 'iam.v4.authz.SeedConfigEntityList'
    ...
    def entities(self):
        ...
        :type:
             list[ :class:`~ntnx_iam_py_client.models.iam.v4.authz.EntityConfig` ]
        """  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(SeedConfigEntityList, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SeedConfigEntityList):
            return False
