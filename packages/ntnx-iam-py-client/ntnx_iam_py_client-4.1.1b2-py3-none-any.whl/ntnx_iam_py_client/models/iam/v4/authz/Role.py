...
class Role(BaseRole):
    ...
    :param operation_schema_change_impact: (:attr:`operation_schema_change_impact`) 
    :type operation_schema_change_impact: 
    ...
    def __init__(self, description=None, operations=None, accessible_clients=None, accessible_entity_types=None, accessible_clients_count=None, accessible_entity_types_count=None, assigned_users_count=None, assigned_user_groups_count=None, created_time=None, last_updated_time=None, created_by=None, is_system_defined=True, operation_schema_change_impact=None, display_name=None, client_name=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
        ...
        self.__operation_schema_change_impact = None
        ...
        if operation_schema_change_impact is not None:
            self.__operation_schema_change_impact = operation_schema_change_impact
    ...
    @property
    def operation_schema_change_impact(self):
        """
        

        :type:
            :class:`~ntnx_iam_py_client.models.iam.v4.authz.OperationSchemaChangeImpact`
        """  # noqa: E501
        return self.__operation_schema_change_impact

    @operation_schema_change_impact.setter
    def operation_schema_change_impact(self, operation_schema_change_impact):
