...
class AuthorizationPoliciesApi(object):
    ...
    def create_authorization_policy(self, body, **kwargs):  # noqa: E501
        ...
        :param body: Information for the create authorization policy request. It requires the role, identity and entities attributes.
        :type body:
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/iam/v4.1.b2/authz/authorization-policies', 'POST',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def delete_authorization_policy_by_id(self, extId, **kwargs):  # noqa: E501
        ...
        :param extId: External identifier for the role.
        :type extId:
            :class:`str`, required
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/iam/v4.1.b2/authz/authorization-policies/{extId}', 'DELETE',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def get_authorization_policy_by_id(self, extId, **kwargs):  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/iam/v4.1.b2/authz/authorization-policies/{extId}', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def list_authorization_policies(self, _page=None, _limit=None, _filter=None, _orderby=None, _expand=None, _select=None, **kwargs):  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/iam/v4.1.b2/authz/authorization-policies', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def update_authorization_policy_by_id(self, extId, body, **kwargs):  # noqa: E501
        ...
        :type extId:
            :class:`str`, required
        :param body: Information for the update authorization policy request.
        :type body:
            :class:`~ntnx_iam_py_client.models.iam.v4.authz.AuthorizationPolicy`, required
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/iam/v4.1.b2/authz/authorization-policies/{extId}', 'PUT',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
