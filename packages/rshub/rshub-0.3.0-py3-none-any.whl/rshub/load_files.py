...
class load_file:
    ...
    def list_files(self):
        try:
            ...
            self.outputdir = filestruct['output_dir']
    ...
    def load_outputs(self,filename = None, fGHz = None, inc_ang = None, var = None,
        ...
        if download_path is not None:
            ...
            full_url = os.path.join(self.url, 'projects/', self.task_path, output_dir, filename)
        ...
        if d_only is True:
            ...
            for file in files:
                ...
                full_url = os.path.join(self.url, 'projects/', self.task_path, self.outputdir, file)
                print(full_url)
                self.download_only(file,full_url,download_path)
