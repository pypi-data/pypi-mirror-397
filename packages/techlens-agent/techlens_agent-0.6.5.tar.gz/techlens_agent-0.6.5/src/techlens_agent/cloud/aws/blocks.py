...
import techlens_agent.cloud.aws.regions as r
...
def getBlocks(
    ...
    if not dry:
        ...
        session_regions = r.get_regions_for_session(right_session)

        s3 = right_session.client("s3", region_name=session_regions[0])
