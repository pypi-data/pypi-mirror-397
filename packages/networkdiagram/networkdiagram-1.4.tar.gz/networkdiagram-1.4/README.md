...
- **CPM Ready**: Built on a node structure supporting Early Start (ES), Late Start (LS), etc.
...
## Installation
pip install pynetworkdiagram

```bash

from pynetworkdiagram import Critical_Path_Method_Network

cpm = Critical_Path_Method_Network()
