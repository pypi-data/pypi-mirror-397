...
# Static methods
    ...
    def GetAll(model, property=Oasys.gRPC.defaultArg):
        """
        Returns a list of Airbag objects or properties for all of the airbags in a model in PRIMER.
        If the optional property argument is not given then a list of Airbag objects is returned.
        If the property argument is given, that property value for each airbag is returned in the list
        instead of a Airbag object
        ...
        property : string
            Optional. Name for property to get for all airbags in the model

        Returns
        -------
        list
            List of Airbag objects or properties
        """
    ...
    def GetFlagged(model, flag, property=Oasys.gRPC.defaultArg):
        ...
        If the optional property argument is not given then a list of Airbag objects is returned.
        If the property argument is given, then that property value for each airbag is returned in the list
        instead of a Airbag object
        ...
        property : string
            Optional. Name for property to get for all flagged airbags in the model
