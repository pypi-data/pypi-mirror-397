...
class InterpolationSpotweld(Oasys.gRPC.OasysItem, metaclass=InterpolationSpotweldType):
    _props = {'alpha1', 'alpha2', 'alpha3', 'bdmodel', 'beta', 'beta2', 'beta3', 'defc', 'dens', 'exfc', 'ffb', 'ffn', 'ffs', 'gamma', 'heading', 'include', 'intp', 'lcdexp', 'lcf', 'lcupf', 'lcupr', 'mfsfc', 'mrn', 'mrs', 'npfc', 'nsid', 'pid1', 'pid2', 'pidvb', 'r', 'rn', 'rs', 'scarn', 'scars', 'sropt', 'stiff', 'stiff2', 'stiff3', 'stiff4', 'stifp', 'thick', 'upfn', 'upfs', 'uprn', 'uprs'}
...
# Constructor
    def __init__(self, model, pid1, pid2, nsid, heading=Oasys.gRPC.defaultArg):
        handle = Oasys.PRIMER._connection.constructor(self.__class__.__name__, model, pid1, pid2, nsid, heading)
        ...
        heading : string
            Optional. Title for the constrained interpolation spotweld
...
# Static methods
    ...
    def GetAll(model, property=Oasys.gRPC.defaultArg):
        """
        Returns a list of InterpolationSpotweld objects or properties for all of the interpolation spotwelds in a model in PRIMER.
        If the optional property argument is not given then a list of InterpolationSpotweld objects is returned.
        If the property argument is given, that property value for each interpolation spotweld is returned in the list
        instead of a InterpolationSpotweld object
        ...
        property : string
            Optional. Name for property to get for all interpolation spotwelds in the model

        Returns
        -------
        list
            List of InterpolationSpotweld objects or properties
        """
    ...
    def GetFlagged(model, flag, property=Oasys.gRPC.defaultArg):
        ...
        If the optional property argument is not given then a list of InterpolationSpotweld objects is returned.
        If the property argument is given, then that property value for each interpolation spotweld is returned in the list
        instead of a InterpolationSpotweld object
        ...
        property : string
            Optional. Name for property to get for all flagged interpolation spotwelds in the model
