...
# Static methods
    ...
    def GetAll(model, property=Oasys.gRPC.defaultArg):
        """
        Returns a list of Vector objects or properties for all of the vectors in a model in PRIMER.
        If the optional property argument is not given then a list of Vector objects is returned.
        If the property argument is given, that property value for each vector is returned in the list
        ...
        property : string
            Optional. Name for property to get for all vectors in the model

        Returns
        -------
        list
            List of Vector objects or properties
        """
    ...
    def GetFlagged(model, flag, property=Oasys.gRPC.defaultArg):
        ...
        If the optional property argument is not given then a list of Vector objects is returned.
        If the property argument is given, then that property value for each vector is returned in the list
        instead of a Vector object
        ...
        property : string
            Optional. Name for property to get for all flagged vectors in the model
