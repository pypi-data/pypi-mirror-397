...
# Static methods
    ...
    def GetAll(model, property=Oasys.gRPC.defaultArg):
        """
        Returns a list of Sph objects or properties for all of the sphs in a model in PRIMER.
        If the optional property argument is not given then a list of Sph objects is returned.
        If the property argument is given, that property value for each sph is returned in the list
        instead of a Sph object
        ...
        property : string
            Optional. Name for property to get for all sphs in the model

        Returns
        -------
        list
            List of Sph objects or properties
        """
    ...
    def GetFlagged(model, flag, property=Oasys.gRPC.defaultArg):
        ...
        If the optional property argument is not given then a list of Sph objects is returned.
        If the property argument is given, then that property value for each sph is returned in the list
        instead of a Sph object
        ...
        property : string
            Optional. Name for property to get for all flagged sphs in the model
