...
# Static methods
    ...
    def GetAll(model, property=Oasys.gRPC.defaultArg):
        """
        Returns a list of LoadRigidBody objects or properties for all of the load rigidbodys in a model in PRIMER.
        If the optional property argument is not given then a list of LoadRigidBody objects is returned.
        If the property argument is given, that property value for each load rigidbody is returned in the list
        instead of a LoadRigidBody object
        ...
        property : string
            Optional. Name for property to get for all load rigidbodys in the model

        Returns
        -------
        list
            List of LoadRigidBody objects or properties
        """
    ...
    def GetFlagged(model, flag, property=Oasys.gRPC.defaultArg):
        ...
        If the optional property argument is not given then a list of LoadRigidBody objects is returned.
        If the property argument is given, then that property value for each load rigidbody is returned in the list
        instead of a LoadRigidBody object
        ...
        property : string
            Optional. Name for property to get for all flagged load rigidbodys in the model
