...
# Static methods
    ...
    def GetAll(model, property=Oasys.gRPC.defaultArg):
        """
        Returns a list of Slipring objects or properties for all of the sliprings in a model in PRIMER.
        If the optional property argument is not given then a list of Slipring objects is returned.
        If the property argument is given, that property value for each slipring is returned in the list
        instead of a Slipring object
        ...
        property : string
            Optional. Name for property to get for all sliprings in the model

        Returns
        -------
        list
            List of Slipring objects or properties
        """
    ...
    def GetFlagged(model, flag, property=Oasys.gRPC.defaultArg):
        ...
        If the optional property argument is not given then a list of Slipring objects is returned.
        If the property argument is given, then that property value for each slipring is returned in the list
        instead of a Slipring object
        ...
        property : string
            Optional. Name for property to get for all flagged sliprings in the model
