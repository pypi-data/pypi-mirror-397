...
# Static methods
    ...
    def GetAll(model, property=Oasys.gRPC.defaultArg):
        """
        Returns a list of Sensor objects or properties for all of the sensors in a model in PRIMER.
        If the optional property argument is not given then a list of Sensor objects is returned.
        If the property argument is given, that property value for each sensor is returned in the list
        instead of a Sensor object
        ...
        property : string
            Optional. Name for property to get for all sensors in the model

        Returns
        -------
        list
            List of Sensor objects or properties
        """
    ...
    def GetFlagged(model, flag, property=Oasys.gRPC.defaultArg):
        ...
        If the optional property argument is not given then a list of Sensor objects is returned.
        If the property argument is given, then that property value for each sensor is returned in the list
        instead of a Sensor object
        ...
        property : string
            Optional. Name for property to get for all flagged sensors in the model
