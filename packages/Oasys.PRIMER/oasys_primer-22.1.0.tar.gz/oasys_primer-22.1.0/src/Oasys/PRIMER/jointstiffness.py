...
# Static methods
    ...
    def GetAll(model, property=Oasys.gRPC.defaultArg):
        """
        Returns a list of JointStiffness objects or properties for all of the joint stiffnesss in a model in PRIMER.
        If the optional property argument is not given then a list of JointStiffness objects is returned.
        If the property argument is given, that property value for each joint stiffness is returned in the list
        instead of a JointStiffness object
        ...
        property : string
            Optional. Name for property to get for all joint stiffnesss in the model

        Returns
        -------
        list
            List of JointStiffness objects or properties
        """
    ...
    def GetFlagged(model, flag, property=Oasys.gRPC.defaultArg):
        ...
        If the optional property argument is not given then a list of JointStiffness objects is returned.
        If the property argument is given, then that property value for each joint stiffness is returned in the list
        instead of a JointStiffness object
        ...
        property : string
            Optional. Name for property to get for all flagged joint stiffnesss in the model
