...
# Static methods
    ...
    def GetAll(model, property=Oasys.gRPC.defaultArg):
        """
        Returns a list of Seatbelt1D objects or properties for all of the seatbelts in a model in PRIMER.
        If the optional property argument is not given then a list of Seatbelt1D objects is returned.
        If the property argument is given, that property value for each seatbelt is returned in the list
        instead of a Seatbelt1D object
        ...
        -------
        list
            List of Seatbelt1D objects or properties
        """
