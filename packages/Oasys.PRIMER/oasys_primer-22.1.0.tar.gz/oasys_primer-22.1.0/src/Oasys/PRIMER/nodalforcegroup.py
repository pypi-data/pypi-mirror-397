...
# Static methods
    ...
    def GetAll(model, property=Oasys.gRPC.defaultArg):
        """
        Returns a list of NodalForceGroup objects or properties for all of the nodal force groups in a model in PRIMER.
        If the optional property argument is not given then a list of NodalForceGroup objects is returned.
        If the property argument is given, that property value for each nodal force group is returned in the list
        instead of a NodalForceGroup object
        ...
        property : string
            Optional. Name for property to get for all nodal force groups in the model

        Returns
        -------
        list
            List of NodalForceGroup objects or properties
        """
    ...
    def GetFlagged(model, flag, property=Oasys.gRPC.defaultArg):
        ...
        If the optional property argument is not given then a list of NodalForceGroup objects is returned.
        If the property argument is given, then that property value for each nodal force group is returned in the list
        instead of a NodalForceGroup object
        ...
        property : string
            Optional. Name for property to get for all flagged nodal force groups in the model
