...
# Static methods
    ...
    def GetAll(model, property=Oasys.gRPC.defaultArg):
        """
        Returns a list of Group objects or properties for all of the groups in a model in PRIMER.
        If the optional property argument is not given then a list of Group objects is returned.
        If the property argument is given, that property value for each group is returned in the list
        instead of a Group object
        ...
        property : string
            Optional. Name for property to get for all groups in the model

        Returns
        -------
        list
            List of Group objects or properties
        """
    ...
    def GetFlagged(model, flag, property=Oasys.gRPC.defaultArg):
        ...
        If the optional property argument is not given then a list of Group objects is returned.
        If the property argument is given, then that property value for each group is returned in the list
        instead of a Group object
        ...
        property : string
            Optional. Name for property to get for all flagged groups in the model
