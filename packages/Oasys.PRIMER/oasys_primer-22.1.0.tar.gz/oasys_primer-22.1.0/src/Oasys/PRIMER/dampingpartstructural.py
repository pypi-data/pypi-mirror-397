...
class DampingPartStructuralType(type):
    _consts = {'PART', 'SET'}

    def __getattr__(cls, name):
        if name in DampingPartStructuralType._consts:
            return Oasys.PRIMER._connection.classGetter(cls.__name__, name)

        raise AttributeError("DampingPartStructural class attribute '{}' does not exist".format(name))


    def __setattr__(cls, name, value):
# If one of the constants we define then error
        if name in DampingPartStructuralType._consts:
            raise AttributeError("Cannot set DampingPartStructural class constant '{}'".format(name))

# Set the property locally
        cls.__dict__[name] = value


class DampingPartStructural(Oasys.gRPC.OasysItem, metaclass=DampingPartStructuralType):
...
# If one of the properties we define then get it
        if name in DampingPartStructural._props:
            return Oasys.PRIMER._connection.instanceGetter(self.__class__.__name__, self._handle, name)

# If one of the read only properties we define then get it
        if name in DampingPartStructural._rprops:
            return Oasys.PRIMER._connection.instanceGetter(self.__class__.__name__, self._handle, name)

        raise AttributeError("DampingPartStructural instance attribute '{}' does not exist".format(name))
...
# If one of the read only properties we define then error
        if name in DampingPartStructural._rprops:
            raise AttributeError("Cannot set read-only DampingPartStructural instance attribute '{}'".format(name))
...
# Constructor
    def __init__(self, model, type, id, coef=Oasys.gRPC.defaultArg):
        ...
        type : constant
            Damping part structural type. Can be
            DampingPartStructural.PART or
            DampingPartStructural.SET
        id : integer
            Part/part set id
        coef : float
            Optional. Structural damping coefficient
...
# Static methods
    ...
    def GetAll(model, property=Oasys.gRPC.defaultArg):
        ...
        If the optional property argument is not given then a list of DampingPartStructural objects is returned.
        If the property argument is given, that property value for each damping part structural is returned in the list
        instead of a DampingPartStructural object
        ...
        property : string
            Optional. Name for property to get for all damping part structurals in the model
    ...
    def GetFlagged(model, flag, property=Oasys.gRPC.defaultArg):
        ...
        If the optional property argument is not given then a list of DampingPartStructural objects is returned.
        If the property argument is given, then that property value for each damping part structural is returned in the list
        instead of a DampingPartStructural object
        ...
        property : string
            Optional. Name for property to get for all flagged damping part structurals in the model
    ...
    def Pick(prompt, limit=Oasys.gRPC.defaultArg, modal=Oasys.gRPC.defaultArg, button_text=Oasys.gRPC.defaultArg):
        ...
        limit : Model or Flag
            Optional. If the argument is a Model then only damping part structurals from that model can be picked.
            If the argument is a Flag then only damping part structurals that
            are flagged with limit can be selected.
            If omitted, or None, any damping part structurals from any model can be selected.
            from any model
        modal : boolean
    ...
    def Select(flag, prompt, limit=Oasys.gRPC.defaultArg, modal=Oasys.gRPC.defaultArg):
        ...
        prompt : string
            Text to display as a prompt to the user
        limit : Model or Flag
            Optional. If the argument is a Model then only damping part structurals from that model can be selected.
            If the argument is a Flag then only damping part structurals that
            are flagged with limit can be selected (limit should be different to flag).
            If omitted, or None, any damping part structurals can be selected.
            from any model
        modal : boolean
    ...
    def SketchFlagged(model, flag, redraw=Oasys.gRPC.defaultArg):
        """
        Sketches all of the flagged damping part structurals in the model. The damping part structurals will be sketched until you either call
        DampingPartStructural.Unsketch(),
        DampingPartStructural.UnsketchFlagged(),
        Model.UnsketchAll(),
        or delete the model
        ...
        redraw : boolean
            Optional. If model should be redrawn or not after the damping part structurals are sketched.
            If omitted redraw is true. If you want to sketch flagged damping part structurals several times and only
    ...
    def Total(model, exists=Oasys.gRPC.defaultArg):
        ...
        exists : boolean
            Optional. true if only existing damping part structurals should be counted. If false or omitted
    ...
    def UnsketchAll(model, redraw=Oasys.gRPC.defaultArg):
        ...
        model : Model
            Model that all damping part structurals will be unblanked in
        redraw : boolean
            Optional. If model should be redrawn or not after the damping part structurals are unsketched.
...
# Instance methods
    ...
    def GetParameter(self, prop):
        """
        Checks if a DampingPartStructural property is a parameter or not.
        Note that object properties that are parameters are normally returned as the integer or
        float parameter values as that is virtually always what the user would want. For this function to
        work the JavaScript interpreter must use the parameter name instead of the value. This can be done by setting
        the Options.property_parameter_names option to true
        before calling the function and then resetting it to false afterwards..
        This behaviour can also temporarily be switched by using the DampingPartStructural.ViewParameters()
    ...
    def Keyword(self):
        """
        Returns the keyword for this damping part structural (\*DAMPING_PART_STRUCTURAL).
        Note that a carriage return is not added.
        See also DampingPartStructural.KeywordCards()
    ...
    def KeywordCards(self):
        """
        Returns the keyword cards for the damping part structural.
        Note that a carriage return is not added.
        See also DampingPartStructural.Keyword()
    ...
    def Sketch(self, redraw=Oasys.gRPC.defaultArg):
        """
        Sketches the damping part structural. The damping part structural will be sketched until you either call
        DampingPartStructural.Unsketch(),
        DampingPartStructural.UnsketchAll(),
        Model.UnsketchAll(),
        or delete the model
        ...
        ----------
        redraw : boolean
            Optional. If model should be redrawn or not after the damping part structural is sketched.
            If omitted redraw is true. If you want to sketch several damping part structurals and only
            redraw after the last one then use false for redraw and call
            View.Redraw()
    ...
    def Unsketch(self, redraw=Oasys.gRPC.defaultArg):
        ...
        ----------
        redraw : boolean
            Optional. If model should be redrawn or not after the damping part structural is unsketched.
            If omitted redraw is true. If you want to unsketch several damping part structurals and only
            redraw after the last one then use false for redraw and call
            View.Redraw()
