...
class SectionType(type):
    _consts = {'ALE1D', 'ALE2D', 'BEAM', 'DISCRETE', 'IGA_SHELL', 'IGA_SOLID', 'POINT_SOURCE', 'SEATBELT', 'SHELL', 'SOLID', 'SPH', 'TSHELL'}
...
class Section(Oasys.gRPC.OasysItem, metaclass=SectionType):
    _props = {'a', 'aafac', 'aet', 'afac', 'aisc', 'aisc_label', 'ale', 'aleform', 'area', 'baselm', 'bfac', 'ca', 'cdl', 'cfac', 'cid', 'cl', 'cmid', 'cohoff', 'cohthk', 'colour', 'cslh', 'cst', 'd1', 'd2', 'd3', 'd4', 'd5', 'd6', 'death', 'dfac', 'dofn1', 'dofn2', 'domint', 'dr', 'dro', 'ds', 'dx', 'dy', 'dz', 'ecut', 'edgset', 'efac', 'efg', 'elform', 'ellipse', 'end', 'failcr', 'fd', 'fs', 'gaskett', 'hmax', 'hmin', 'hxcslh', 'hxini', 'hycslh', 'hyini', 'hzcslh', 'hzini', 'ibr', 'icomp', 'idam', 'idila', 'idim', 'idof', 'iebt', 'iform', 'ihgf', 'iken', 'iloc', 'include', 'iner', 'interaction', 'iovpr', 'iprstr', 'ips', 'ir', 'irl', 'irr', 'ispline', 'iss', 'ist', 'itaj', 'itb', 'ithelfm', 'itoff', 'itorm', 'itt', 'iunf', 'iw', 'iwr', 'iyr', 'izr', 'j', 'kd', 'kernel', 'label', 'lcidt', 'lcidvel', 'lcidvolr', 'lcmdot1', 'lcmdot2', 'lcmdot3', 'lcmdot4', 'lcmdot5', 'lcmdot6', 'lcmdot7', 'lcmdot8', 'lmc', 'lprint', 'lscale', 'marea', 'misc', 'mixture', 'nhsv', 'nidlc001', 'nidlc002', 'nidlc003', 'nip', 'nipp', 'nloc', 'nloc_1', 'nsloc', 'nsm', 'ntloc', 'nxdof', 'offset', 'peri', 'points', 'pr', 'print', 'propcr', 'propt', 'ptype', 'qr', 'rampt', 'rrcon', 'sa', 'scoor', 'secid', 'setyp', 'sf', 'shrf', 'smstep', 'spg', 'sphini', 'srcon', 'start', 'stime', 'stress', 'stretch', 'stype', 'swtime', 't', 't1', 't2', 't3', 't4', 'tdl', 'tensor', 'thermal', 'thick', 'title', 'toldef', 'transparency', 'trcon', 'ts1', 'ts2', 'tshear', 'tt1', 'tt2', 'user', 'v0', 'vol', 'xfem', 'ys', 'zs'}
...
# Static methods
    ...
    def GetAll(model, property=Oasys.gRPC.defaultArg):
        """
        Returns a list of Section objects or properties for all of the sections in a model in PRIMER.
        If the optional property argument is not given then a list of Section objects is returned.
        If the property argument is given, that property value for each section is returned in the list
        ...
        property : string
            Optional. Name for property to get for all sections in the model

        Returns
        -------
        list
            List of Section objects or properties
        """
    ...
    def GetFlagged(model, flag, property=Oasys.gRPC.defaultArg):
        ...
        If the optional property argument is not given then a list of Section objects is returned.
        If the property argument is given, then that property value for each section is returned in the list
        instead of a Section object
        ...
        property : string
            Optional. Name for property to get for all flagged sections in the model
