...
# Static methods
    ...
    def GetAll(model, property=Oasys.gRPC.defaultArg):
        """
        Returns a list of NodeSet objects or properties for all of the node sets in a model in PRIMER.
        If the optional property argument is not given then a list of NodeSet objects is returned.
        If the property argument is given, that property value for each node set is returned in the list
        instead of a NodeSet object
        ...
        -------
        list
            List of NodeSet objects or properties
        """
    ...
    def GetFlagged(model, flag, property=Oasys.gRPC.defaultArg):
        ...
        If the optional property argument is not given then a list of NodeSet objects is returned.
        If the property argument is given, then that property value for each node set is returned in the list
        instead of a NodeSet object
