...
class IGA3DBasisTransformXYZType(type):

    def __getattr__(cls, name):

        raise AttributeError("IGA3DBasisTransformXYZ class attribute '{}' does not exist".format(name))


class IGA3DBasisTransformXYZ(Oasys.gRPC.OasysItem, metaclass=IGA3DBasisTransformXYZType):
...
# If one of the properties we define then get it
        if name in IGA3DBasisTransformXYZ._props:
            return Oasys.PRIMER._connection.instanceGetter(self.__class__.__name__, self._handle, name)

# If one of the read only properties we define then get it
        if name in IGA3DBasisTransformXYZ._rprops:
            return Oasys.PRIMER._connection.instanceGetter(self.__class__.__name__, self._handle, name)

        raise AttributeError("IGA3DBasisTransformXYZ instance attribute '{}' does not exist".format(name))
...
# If one of the read only properties we define then error
        if name in IGA3DBasisTransformXYZ._rprops:
            raise AttributeError("Cannot set read-only IGA3DBasisTransformXYZ instance attribute '{}'".format(name))
...
# Constructor
    def __init__(self, model, details):
        ...
        ----------
        model : Model
            Model that IGA 3d basis transform xyz will be created in
        details : dict
...
# Static methods
    def Create(model, modal=Oasys.gRPC.defaultArg):
        ...
        ----------
        model : Model
            Model that the IGA 3D Basis Transform XYZ will be created in
        modal : boolean
    ...
    def First(model):
        ...
        ----------
        model : Model
            Model to get first IGA 3D Basis Transform XYZ in
    ...
    def FirstFreeLabel(model, layer=Oasys.gRPC.defaultArg):
        """
        Returns the first free IGA 3D Basis Transform XYZ label in the model.
        Also see IGA3DBasisTransformXYZ.LastFreeLabel(),
        IGA3DBasisTransformXYZ.NextFreeLabel() and
        Model.FirstFreeItemLabel()

        Parameters
        ----------
        model : Model
            Model to get first free IGA 3D Basis Transform XYZ label in
    ...
    def FlagAll(model, flag):
        ...
        ----------
        model : Model
            Model that all IGA 3D Basis Transform XYZs will be flagged in
        flag : Flag
    ...
    def GetAll(model, property=Oasys.gRPC.defaultArg):
        ...
        If the optional property argument is not given then a list of IGA3DBasisTransformXYZ objects is returned.
        If the property argument is given, that property value for each IGA 3D Basis Transform XYZ is returned in the list
        instead of a IGA3DBasisTransformXYZ object

        Parameters
        ----------
        model : Model
            Model to get IGA 3D Basis Transform XYZs from
        property : string
            Optional. Name for property to get for all IGA 3D Basis Transform XYZs in the model
    ...
    def GetFlagged(model, flag, property=Oasys.gRPC.defaultArg):
        ...
        If the optional property argument is not given then a list of IGA3DBasisTransformXYZ objects is returned.
        If the property argument is given, then that property value for each IGA 3D Basis Transform XYZ is returned in the list
        instead of a IGA3DBasisTransformXYZ object
        ...
        property : string
            Optional. Name for property to get for all flagged IGA 3D Basis Transform XYZs in the model
    ...
    def GetFromID(model, number):
        ...
        ----------
        model : Model
            Model to find the IGA 3D Basis Transform XYZ in
        number : integer
    ...
    def Last(model):
        ...
        ----------
        model : Model
            Model to get last IGA 3D Basis Transform XYZ in
    ...
    def LastFreeLabel(model, layer=Oasys.gRPC.defaultArg):
        """
        Returns the last free IGA 3D Basis Transform XYZ label in the model.
        Also see IGA3DBasisTransformXYZ.FirstFreeLabel(),
        IGA3DBasisTransformXYZ.NextFreeLabel() and
        ...
        ----------
        model : Model
            Model to get last free IGA 3D Basis Transform XYZ label in
        layer : Include number
            Optional. Include file (0 for the main file) to search for labels in (Equivalent to
    ...
    def NextFreeLabel(model, layer=Oasys.gRPC.defaultArg):
        """
        Returns the next free (highest+1) IGA 3D Basis Transform XYZ label in the model.
        Also see IGA3DBasisTransformXYZ.FirstFreeLabel(),
        IGA3DBasisTransformXYZ.LastFreeLabel() and
        Model.NextFreeItemLabel()

        Parameters
        ----------
        model : Model
            Model to get next free IGA 3D Basis Transform XYZ label in
        layer : Include number
            Optional. Include file (0 for the main file) to search for labels in (Equivalent to
    ...
    def RenumberAll(model, start):
        ...
        ----------
        model : Model
            Model that all IGA 3D Basis Transform XYZs will be renumbered in
        start : integer
    ...
    def RenumberFlagged(model, flag, start):
        ...
        ----------
        model : Model
            Model that all the flagged IGA 3D Basis Transform XYZs will be renumbered in
        flag : Flag
    ...
    def Select(flag, prompt, limit=Oasys.gRPC.defaultArg, modal=Oasys.gRPC.defaultArg):
        ...
        limit : Model or Flag
            Optional. If the argument is a Model then only IGA 3D Basis Transform XYZs from that model can be selected.
            If the argument is a Flag then only IGA 3D Basis Transform XYZs that
            are flagged with limit can be selected (limit should be different to flag).
            If omitted, or None, any IGA 3D Basis Transform XYZs can be selected.
            from any model
        modal : boolean
    ...
    def SketchFlagged(model, flag, redraw=Oasys.gRPC.defaultArg):
        ...
        IGA3DBasisTransformXYZ.Unsketch(),
        IGA3DBasisTransformXYZ.UnsketchFlagged(),
        Model.UnsketchAll(),
        or delete the model
        ...
        ----------
        model : Model
            Model that all the flagged IGA 3D Basis Transform XYZs will be sketched in
        flag : Flag
            Flag set on the IGA 3D Basis Transform XYZs that you want to sketch
        redraw : boolean
            Optional. If model should be redrawn or not after the IGA 3D Basis Transform XYZs are sketched.
            If omitted redraw is true. If you want to sketch flagged IGA 3D Basis Transform XYZs several times and only
    ...
    def Total(model, exists=Oasys.gRPC.defaultArg):
        ...
        exists : boolean
            Optional. true if only existing IGA 3D Basis Transform XYZs should be counted. If false or omitted
    ...
    def UnflagAll(model, flag):
        ...
        ----------
        model : Model
            Model that the defined flag for all IGA 3D Basis Transform XYZs will be unset in
        flag : Flag
    ...
    def UnsketchAll(model, redraw=Oasys.gRPC.defaultArg):
        ...
        ----------
        model : Model
            Model that all IGA 3D Basis Transform XYZs will be unblanked in
        redraw : boolean
            Optional. If model should be redrawn or not after the IGA 3D Basis Transform XYZs are unsketched.
    ...
    def UnsketchFlagged(model, flag, redraw=Oasys.gRPC.defaultArg):
        ...
        ----------
        model : Model
            Model that all IGA 3D Basis Transform XYZs will be unsketched in
        flag : Flag
...
# Instance methods
    def AssociateComment(self, comment):
        ...
        ----------
        comment : Comment
            Comment that will be attached to the IGA 3D Basis Transform XYZ
    ...
    def DetachComment(self, comment):
        ...
        ----------
        comment : Comment
            Comment that will be detached from the IGA 3D Basis Transform XYZ
    ...
    def GetParameter(self, prop):
        """
        Checks if a IGA3DBasisTransformXYZ property is a parameter or not.
        Note that object properties that are parameters are normally returned as the integer or
        float parameter values as that is virtually always what the user would want. For this function to
        work the JavaScript interpreter must use the parameter name instead of the value. This can be done by setting
        the Options.property_parameter_names option to true
        before calling the function and then resetting it to false afterwards..
        This behaviour can also temporarily be switched by using the IGA3DBasisTransformXYZ.ViewParameters()
    ...
    def Keyword(self):
        """
        Returns the keyword for this IGA 3d basis transform xyz (\*IGA_3D_BASIS_TRANSFORM_XYZ).
        Note that a carriage return is not added.
        See also IGA3DBasisTransformXYZ.KeywordCards()
    ...
    def KeywordCards(self):
        """
        Returns the keyword cards for the IGA 3d basis transform xyz.
        Note that a carriage return is not added.
        See also IGA3DBasisTransformXYZ.Keyword()
    ...
    def Sketch(self, redraw=Oasys.gRPC.defaultArg):
        ...
        IGA3DBasisTransformXYZ.Unsketch(),
        IGA3DBasisTransformXYZ.UnsketchAll(),
        Model.UnsketchAll(),
        or delete the model
        ...
        ----------
        redraw : boolean
            Optional. If model should be redrawn or not after the IGA 3D Basis Transform XYZ is sketched.
            If omitted redraw is true. If you want to sketch several IGA 3D Basis Transform XYZs and only
            redraw after the last one then use false for redraw and call
            View.Redraw()
    ...
    def Unsketch(self, redraw=Oasys.gRPC.defaultArg):
        ...
        ----------
        redraw : boolean
            Optional. If model should be redrawn or not after the IGA 3D Basis Transform XYZ is unsketched.
            If omitted redraw is true. If you want to unsketch several IGA 3D Basis Transform XYZs and only
            redraw after the last one then use false for redraw and call
            View.Redraw()
