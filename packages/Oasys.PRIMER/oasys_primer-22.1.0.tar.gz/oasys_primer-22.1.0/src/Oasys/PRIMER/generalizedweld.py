...
# Static methods
    ...
    def GetAll(model, property=Oasys.gRPC.defaultArg):
        """
        Returns a list of GeneralizedWeld objects or properties for all of the generalized welds in a model in PRIMER.
        If the optional property argument is not given then a list of GeneralizedWeld objects is returned.
        If the property argument is given, that property value for each generalized weld is returned in the list
        instead of a GeneralizedWeld object
        ...
        property : string
            Optional. Name for property to get for all generalized welds in the model

        Returns
        -------
        list
            List of GeneralizedWeld objects or properties
        """
    ...
    def GetFlagged(model, flag, property=Oasys.gRPC.defaultArg):
        ...
        If the optional property argument is not given then a list of GeneralizedWeld objects is returned.
        If the property argument is given, then that property value for each generalized weld is returned in the list
        instead of a GeneralizedWeld object
        ...
        property : string
            Optional. Name for property to get for all flagged generalized welds in the model
