...
async function main() {
  const mimeExtensionsMods = [
    ...
    __webpack_require__(42806),
    __webpack_require__(79046),
    __webpack_require__(67030),
  ];
  const mimeExtensions = await Promise.all(mimeExtensionsMods);

  // Load the base plugins available on all pages
  let baseMods = [
      __webpack_require__(95344),
  __webpack_require__(32254),
  __webpack_require__(93918),
  __webpack_require__(54142),
  __webpack_require__(94798),
  __webpack_require__(74558),
  __webpack_require__(16210),
  
      (__webpack_require__(11142)/* ["default"].filter */["default"].filter)(({id}) => [
...
'@jupyterlab/application-extension:top-spacer',
      ...
      (__webpack_require__(98050)/* ["default"].filter */["default"].filter)(({id}) => [
...
'@jupyterlab/apputils-extension:utilityCommands',
      ...
      __webpack_require__(71094),
  __webpack_require__(25630),
  
      (__webpack_require__(92448)/* ["default"].filter */["default"].filter)(({id}) => [
...
'@jupyterlab/completer-extension:manager',
      ...
      (__webpack_require__(84304)/* ["default"].filter */["default"].filter)(({id}) => [
...
'@jupyterlab/console-extension:tracker',
      ...
      (__webpack_require__(10054)/* ["default"].filter */["default"].filter)(({id}) => [
...
'@jupyterlab/docmanager-extension:manager',
      ...
      (__webpack_require__(20486)/* ["default"].filter */["default"].filter)(({id}) => [
       '@jupyterlab/documentsearch-extension:plugin',
      ].includes(id)),
      
      (__webpack_require__(7438)/* ["default"].filter */["default"].filter)(({id}) => [
       '@jupyterlab/filebrowser-extension:factory',
'@jupyterlab/filebrowser-extension:default-file-browser',
      ].includes(id)),
      
      (__webpack_require__(64090)/* ["default"].filter */["default"].filter)(({id}) => [
       '@jupyterlab/fileeditor-extension:plugin',
'@jupyterlab/fileeditor-extension:widget-factory',
      ].includes(id)),
      
      (__webpack_require__(49666)/* ["default"].filter */["default"].filter)(({id}) => [
       '@jupyterlab/help-extension:resources',
      ].includes(id)),
      __webpack_require__(88422),
  __webpack_require__(35900),
  __webpack_require__(23676),
  __webpack_require__(12000),
  
      (__webpack_require__(1846)/* ["default"].filter */["default"].filter)(({id}) => [
       '@jupyterlab/mainmenu-extension:plugin',
      ].includes(id)),
      __webpack_require__(79138),
  __webpack_require__(66504),
  __webpack_require__(39324),
  
      (__webpack_require__(21170)/* ["default"].filter */["default"].filter)(({id}) => [
...
'@jupyterlab/notebook-extension:widget-factory',
      ...
      __webpack_require__(41350),
  __webpack_require__(86058),
  __webpack_require__(38847),
  __webpack_require__(75966),
  __webpack_require__(8158),
  __webpack_require__(56070),
  __webpack_require__(53638),
  __webpack_require__(12624),
  __webpack_require__(59300),
  __webpack_require__(75332),
  ...
  switch (page) {
    ...
    case '/tree': {
      baseMods = baseMods.concat([
        __webpack_require__(96662),
  __webpack_require__(94138),
...
'@jupyterlab/filebrowser-extension:share-file',
      ...
      __webpack_require__(64926),
  
      (__webpack_require__(82356)/* ["default"].filter */["default"].filter)(({id}) => [
       '@jupyterlab/running-extension:plugin',
      ].includes(id)),
      __webpack_require__(44448),
    ...
    case '/notebooks': {
      baseMods = baseMods.concat([
        __webpack_require__(15010),
  __webpack_require__(96662),
  
      (__webpack_require__(5234)/* ["default"].filter */["default"].filter)(({id}) => [
...
'@jupyterlab/debugger-extension:display-registry',
      ...
      __webpack_require__(93182),
  __webpack_require__(11138),
...
'@jupyterlab/notebook-extension:update-raw-mimetype',
      ...
      (__webpack_require__(5048)/* ["default"].filter */["default"].filter)(({id}) => [
       '@jupyterlab/toc-extension:registry',
'@jupyterlab/toc-extension:tracker',
      ].includes(id)),
      
      (__webpack_require__(10728)/* ["default"].filter */["default"].filter)(({id}) => [
...
//# sourceMappingURL=1815.b68b1b57670401c6.js.map?v=b68b1b57670401c6