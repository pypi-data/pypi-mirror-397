...
API Endpoints:
    GET /api/v2/cmdb/log.syslogd4/setting - Get syslogd4 settings
    PUT /api/v2/cmdb/log.syslogd4/setting - Update syslogd4 settings
"""
...
class Syslogd4Setting:
    """Log Syslogd4 Setting endpoint (singleton)"""
