"""
FortiOS vipgrp API wrapper.
Provides access to /api/v2/cmdb/firewall/vipgrp endpoint.
"""
...
class Vipgrp:
    """
    Wrapper for firewall vipgrp API endpoint.

    Manages vipgrp configuration with full Swagger-spec parameter support.
    """

    def __init__(self, http_client: Any):
        """
        Initialize the Vipgrp wrapper.

        Args:
            http_client: The HTTP client for API communication
        """
        self._client = http_client
        self.path = "firewall/vipgrp"
    ...
    def list(
        ...
        **kwargs,
        ...
        """
        Retrieve a list of all vipgrp entries.
    ...
    def get(
        ...
        **kwargs,
        ...
        """
        Retrieve a specific vipgrp entry by its name.
