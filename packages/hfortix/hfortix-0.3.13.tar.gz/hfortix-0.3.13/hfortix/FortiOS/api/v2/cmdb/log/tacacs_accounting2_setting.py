...
This module provides access to the log.tacacs+accounting2/setting endpoint
for configuring TACACS+ accounting2 server settings.

API Path: log.tacacs+accounting2/setting
"""
...
class TacacsAccounting2Setting:
    """
    Interface for configuring TACACS+ accounting2 server settings.

    This class provides methods to manage TACACS+ accounting2 server configuration,
    ...
    Example usage:
        ...
        fgt.api.cmdb.log.tacacs_accounting2.setting.update(
            status='enable',
    ...
    def __init__(self, client: "HTTPClient") -> None:
        """
        Initialize the TacacsAccounting2Setting instance.

        Args:
            client: The HTTP client used to communicate with the FortiOS device
        """
        self._client = client
        self._endpoint = "log.tacacs+accounting2/setting"

    def get(self) -> Dict[str, Any]:
        """
        Retrieve current TACACS+ accounting2 server settings.

        Returns:
            Dictionary containing TACACS+ accounting2 server configuration

        Example:
            >>> result = fgt.api.cmdb.log.tacacs_accounting2.setting.get()
            >>> print(result['status'])
            'enable'
        """
        path = "log.tacacs+accounting2/setting"
    ...
    def update(
        ...
        **kwargs: Any,
        ...
        """
        Update TACACS+ accounting2 server settings.
