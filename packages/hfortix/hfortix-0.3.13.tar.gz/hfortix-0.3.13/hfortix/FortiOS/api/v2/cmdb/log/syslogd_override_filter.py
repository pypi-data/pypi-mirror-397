"""
FortiOS CMDB - Log Syslogd Override Filter

Override filters for remote syslog server.

API Endpoints:
    GET /api/v2/cmdb/log.syslogd/override-filter - Get syslogd override filter settings
    PUT /api/v2/cmdb/log.syslogd/override-filter - Update syslogd override filter settings
"""
...
class SyslogdOverrideFilter:
    """Log Syslogd Override Filter endpoint (singleton)"""
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        """
        Get syslogd override filter settings.
        ...
        path = "log.syslogd/override-filter"
    ...
    def update(
        ...
        **kwargs: Any,
        ...
        """
        Update syslogd override filter settings.
