...
API Endpoints:
    GET /api/v2/cmdb/log.syslogd3/setting - Get syslogd3 settings
    PUT /api/v2/cmdb/log.syslogd3/setting - Update syslogd3 settings
"""
...
class Syslogd3Setting:
    """Log Syslogd3 Setting endpoint (singleton)"""
