"""FortiOS CMDB - Firewall Internet Service Name

Configure Internet Service name.

Swagger paths (FortiOS 7.6.5):
    - /api/v2/cmdb/firewall/internet-service-name
    - /api/v2/cmdb/firewall/internet-service-name/{name}
