"""
FortiOS CMDB - Log Syslogd4 Override Setting

Override settings for remote syslog server.

API Endpoints:
    GET /api/v2/cmdb/log.syslogd4/override-setting - Get syslogd4 override settings
    PUT /api/v2/cmdb/log.syslogd4/override-setting - Update syslogd4 override settings
"""
...
class Syslogd4OverrideSetting:
    """Log Syslogd4 Override Setting endpoint (singleton)"""
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        """
        Get syslogd4 override settings.
        ...
        path = "log.syslogd4/override-setting"
    ...
    def update(
        ...
        **kwargs: Any,
        ...
        """
        Update syslogd4 override settings.
