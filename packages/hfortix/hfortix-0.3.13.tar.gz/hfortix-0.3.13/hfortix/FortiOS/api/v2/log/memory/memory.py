    ...
    def traffic_raw(
        ...
        **kwargs: Any,
        ...
        Example:
            ...
            >>> logs = fgt.log.memory.traffic_raw(
            ...     subtype='sniffer',
            ...     rows=50,
            ...     start=start_time,
            ...     end=end_time
