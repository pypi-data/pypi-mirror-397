"""
FortiOS CMDB - Log FortiAnalyzer Override Setting

Override settings for FortiAnalyzer in VDOMs.
...
class FortianalyzerOverrideSetting:
    ...
    def get(self, vdom: Optional[Union[str, bool]] = None, **kwargs: Any) -> dict[str, Any]:
        ...
        Returns:
            Dictionary containing FortiAnalyzer override settings
    ...
    def update(
        ...
        **kwargs: Any,
        ...
        Examples:
            >>> # Enable VDOM-specific FortiAnalyzer with server
            >>> fgt.api.cmdb.log.fortianalyzer_override_setting.update(
            ...     override='enable',
            ...     status='enable',
