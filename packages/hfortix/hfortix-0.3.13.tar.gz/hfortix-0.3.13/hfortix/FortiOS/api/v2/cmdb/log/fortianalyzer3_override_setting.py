"""
FortiOS CMDB - Log FortiAnalyzer3 Override Setting

Override settings for FortiAnalyzer (tertiary server) in VDOMs.

API Endpoints:
    GET /api/v2/cmdb/log.fortianalyzer3/override-setting - Get FortiAnalyzer3 override settings
    PUT /api/v2/cmdb/log.fortianalyzer3/override-setting - Update FortiAnalyzer3 override settings
"""
...
class Fortianalyzer3OverrideSetting:
    """Log FortiAnalyzer3 Override Setting endpoint (singleton)"""
    ...
    def get(self, vdom: Optional[Union[str, bool]] = None, **kwargs: Any) -> dict[str, Any]:
        """
        Get FortiAnalyzer3 override settings.
        ...
        Returns:
            Dictionary containing FortiAnalyzer3 override settings

        Examples:
            >>> settings = fgt.api.cmdb.log.fortianalyzer3_override_setting.get()
        """
        path = "log.fortianalyzer3/override-setting"
    ...
    def update(
        ...
        **kwargs: Any,
        ...
        """
        Update FortiAnalyzer3 override settings for VDOM-specific configuration.

        Args:
            data_dict: Complete configuration dictionary
            status: Enable/disable FortiAnalyzer3 logging (enable|disable)
            ...
            server: FortiAnalyzer3 server IP address or FQDN (string)
        ...
        Examples:
            >>> fgt.api.cmdb.log.fortianalyzer3_override_setting.update(
            ...     override='enable',
            ...     status='enable',
