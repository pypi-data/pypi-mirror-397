"""
FortiOS CMDB - Log FortiAnalyzer Override Filter

Override filters for FortiAnalyzer in VDOMs.

API Endpoints:
    GET /api/v2/cmdb/log.fortianalyzer/override-filter - Get FortiAnalyzer override filter settings
    PUT /api/v2/cmdb/log.fortianalyzer/override-filter - Update FortiAnalyzer override filter settings
"""
...
class FortianalyzerOverrideFilter:
    """Log FortiAnalyzer Override Filter endpoint (singleton)"""
    ...
    def get(self, vdom: Optional[Union[str, bool]] = None, **kwargs: Any) -> dict[str, Any]:
        """
        Get FortiAnalyzer override filter settings.
        ...
        Returns:
            Dictionary containing FortiAnalyzer override filter settings

        Examples:
            >>> settings = fgt.api.cmdb.log.fortianalyzer_override_filter.get()
        """
        path = "log.fortianalyzer/override-filter"
    ...
    def update(
        ...
        **kwargs: Any,
        ...
        """
        Update FortiAnalyzer override filter settings for VDOM-specific filtering.
        ...
        Examples:
            ...
            >>> fgt.api.cmdb.log.fortianalyzer_override_filter.update(
            ...     severity='error',
