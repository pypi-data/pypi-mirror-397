...
API Endpoints:
    GET /api/v2/cmdb/log.syslogd2/filter - Get syslogd2 filter settings
    PUT /api/v2/cmdb/log.syslogd2/filter - Update syslogd2 filter settings
"""
...
class Syslogd2Filter:
    """Log Syslogd2 Filter endpoint (singleton)"""
    ...
    def update(
        ...
        **kwargs: Any,
        ...
        """
        Update syslogd2 filter settings.
