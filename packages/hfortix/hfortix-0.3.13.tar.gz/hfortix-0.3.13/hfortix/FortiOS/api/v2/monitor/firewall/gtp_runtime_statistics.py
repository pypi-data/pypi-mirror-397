"""GTP runtime statistics operations."""
...
class GTPRuntimeStatistics:
    ...
    def list(self, data_dict: Optional[Dict[str, Any]] = None, **kwargs) -> Dict[str, Any]:
        ...
        Returns:
            Dictionary containing GTP runtime statistics

        Example:
            >>> fgt.api.monitor.firewall.gtp_runtime_statistics.list()
        """
        params = data_dict.copy() if data_dict else {}
        params.update(kwargs)
        return self._client.get("monitor", "/firewall/gtp-runtime-statistics", params=params)
