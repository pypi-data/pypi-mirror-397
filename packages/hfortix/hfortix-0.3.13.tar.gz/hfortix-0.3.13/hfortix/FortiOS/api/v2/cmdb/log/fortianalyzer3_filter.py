...
Filters for FortiAnalyzer (tertiary server).
...
class Fortianalyzer3Filter:
    ...
    def get(self, vdom: Optional[Union[str, bool]] = None, **kwargs: Any) -> dict[str, Any]:
        ...
        Returns:
            Dictionary containing FortiAnalyzer3 filter settings
    ...
    def update(
        ...
        **kwargs: Any,
        ...
        Examples:
            ...
            >>> fgt.api.cmdb.log.fortianalyzer3_filter.update(severity='warning')
        """
