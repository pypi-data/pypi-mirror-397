"""
TACACS+ accounting2 filter endpoint module.

This module provides access to the log.tacacs+accounting2/filter endpoint
for configuring which TACACS+ accounting events to log.

API Path: log.tacacs+accounting2/filter
"""
...
class TacacsAccounting2Filter:
    """
    Interface for configuring TACACS+ accounting2 filter settings.

    This class provides methods to manage TACACS+ accounting2 filter configuration,
    ...
    Example usage:
        ...
        fgt.api.cmdb.log.tacacs_accounting2.filter.update(
            login_audit='enable',
    ...
    def __init__(self, client: "HTTPClient") -> None:
        """
        Initialize the TacacsAccounting2Filter instance.

        Args:
            client: The HTTP client used to communicate with the FortiOS device
        """
        self._client = client
        self._endpoint = "log.tacacs+accounting2/filter"

    def get(self) -> Dict[str, Any]:
        """
        Retrieve current TACACS+ accounting2 filter configuration.

        Returns:
            Dictionary containing TACACS+ accounting2 filter settings

        Example:
            >>> result = fgt.api.cmdb.log.tacacs_accounting2.filter.get()
    ...
    def update(
        ...
        **kwargs: Any,
        ...
        """
        Update TACACS+ accounting2 filter configuration.
