...
class Fortianalyzer3Setting:
    """Log FortiAnalyzer3 Setting endpoint (singleton)"""
    ...
    def get(self, vdom: Optional[Union[str, bool]] = None, **kwargs: Any) -> dict[str, Any]:
        ...
        Returns:
            Dictionary containing FortiAnalyzer3 settings

        Examples:
            >>> settings = fgt.api.cmdb.log.fortianalyzer3_setting.get()
        """
    ...
    def update(
        ...
        **kwargs: Any,
        ...
        """
        Update FortiAnalyzer3 settings.
        ...
        Examples:
            >>> # Enable FortiAnalyzer3
            >>> fgt.api.cmdb.log.fortianalyzer3_setting.update(
            ...     status='enable',
