"""
FortiOS region API wrapper.
Provides access to /api/v2/cmdb/firewall/region endpoint.
"""
...
class Region:
    """
    Wrapper for firewall region API endpoint.

    Manages region configuration with full Swagger-spec parameter support.
    """
    ...
    def list(
        ...
        **kwargs,
        ...
        """
        Retrieve a list of all region entries.
    ...
    def get(
        ...
        **kwargs,
        ...
        """
        Retrieve a specific region entry by its id.
    ...
    def update(
        ...
        **kwargs,
        ...
        """
        Update an existing region entry.
