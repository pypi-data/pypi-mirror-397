"""
FortiOS CMDB - Log Syslogd4 Override Filter

Override filters for remote syslog server.

API Endpoints:
    GET /api/v2/cmdb/log.syslogd4/override-filter - Get syslogd4 override filter settings
    PUT /api/v2/cmdb/log.syslogd4/override-filter - Update syslogd4 override filter settings
"""
...
class Syslogd4OverrideFilter:
    """Log Syslogd4 Override Filter endpoint (singleton)"""
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        """
        Get syslogd4 override filter settings.
        ...
        path = "log.syslogd4/override-filter"
    ...
    def update(
        ...
        **kwargs: Any,
        ...
        """
        Update syslogd4 override filter settings.
