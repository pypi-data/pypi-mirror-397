...
if HAS_XBR and HAS_CRYPTOSIGN:
    ...
    from xbr._frealm import FederatedRealm, Seeder
    from xbr._secmod import EthereumKey, SecurityModuleMemory
...
class TestFederatedRealm(TestCase):
    ...
    def test_frealm_seeders(self):
        ...
        self.assertEqual(
            transports,
            ["wss://frealm1.example.com/ws", "wss://fr1.foobar.org/ws", "wss://public-frealm1.pierre.fr:443"],
        )
    ...
    def test_frealm_secmod(self):
        ...
        delegate_key = sm[0]
        client_key = sm[1]
        authextra = yield fr.seeders[0].create_authextra(
