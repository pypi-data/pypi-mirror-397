...
---
Module: 'machine' on micropython-v1.27.0-rp2-PIMORONI_PICOLIPO
"""
...
class USBDevice:
    ...
    class BUILTIN_CDC:
        ...
        itf_max: int = 2
        str_max: int = 5
        desc_dev: bytes = b"\x12\x01\x00\x02\xef\x02\x01@\x8a.\x02\x10\x00\x01\x01\x02\x03\x01"
...
class Pin:
    ...
    class board:
        ...
        VBUS_SENSE: Pin  ## = Pin(GPIO24, mode=ALT, pull=PULL_DOWN, alt=31)
        ...
        BAT_SENSE: Pin  ## = Pin(GPIO29, mode=ALT, pull=PULL_DOWN, alt=31)
        GP0: Pin  ## = Pin(GPIO0, mode=ALT, pull=PULL_DOWN, alt=31)
        BOOT: Pin  ## = Pin(GPIO23, mode=ALT, pull=PULL_DOWN, alt=31)
