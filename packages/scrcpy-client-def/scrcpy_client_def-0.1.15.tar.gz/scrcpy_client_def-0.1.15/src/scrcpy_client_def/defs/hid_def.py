...
from .sdl_def import SDL_BUTTON, SDL_BUTTON_LEFT, SDL_BUTTON_MIDDLE, SDL_BUTTON_RIGHT, SDL_BUTTON_X1, SDL_BUTTON_X2
...
class KeymodStateStore:
    ...
    def has_key(self, key: HIDKeymod) -> bool:
        return (self.key & key.value) != 0
