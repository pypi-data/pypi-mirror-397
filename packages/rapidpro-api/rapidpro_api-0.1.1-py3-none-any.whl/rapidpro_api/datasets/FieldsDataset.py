...
class FieldsDataset(BaseDataset):
    """
    A class to handle the Fields dataset.

    This class inherits from BaseDataset and is used to manage the Fields dataset.
    ...
    def __init__(self, workspace:Workspace = None,
        ...
        """
        Initialize a Flow Dataset object.
