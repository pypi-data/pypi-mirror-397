...
plot_with_std(
    ...
    mean_fitness.values,
    std_fitness.values,
    title="Structural Mutation (HELI) – Mean Best Fitness ± 1 STD (30 Seeds)",
    ylabel="Best Fitness (↓)",
    color="#d62728",
...
plot_with_std(
    ...
    title="Structural Mutation (HELI) – Mean Weight Count ± 1 STD (30 Seeds)",
    ylabel="Connections (log scale)",
    color="#d62728",
...
plot_with_std(
    ...
    title="Structural Mutation (HELI) – Mean Neuron Count ± 1 STD (30 Seeds)",
    ylabel="Neurons",
    color="#d62728",
