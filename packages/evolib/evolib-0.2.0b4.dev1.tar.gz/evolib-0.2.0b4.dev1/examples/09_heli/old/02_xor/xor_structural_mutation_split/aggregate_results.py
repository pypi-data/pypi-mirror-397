...
plot_with_std(
    ...
    mean_fitness.values,
    std_fitness.values,
    title="Structural Mutation with Split – Mean Best Fitness ± 1 STD (30 Seeds)",
    ylabel="Best Fitness (↓)",
    color="#ff7f0e",
...
plot_with_std(
    ...
    title="Structural Mutation with Split – Mean Weight Count ± 1 STD (30 Seeds)",
    ylabel="Connections",
    color="#ff7f0e",
...
plot_with_std(
    ...
    title="Structural Mutation with Split  – Mean Neuron Count ± 1 STD (30 Seeds)",
    ylabel="Neurons",
    color="#ff7f0e",
