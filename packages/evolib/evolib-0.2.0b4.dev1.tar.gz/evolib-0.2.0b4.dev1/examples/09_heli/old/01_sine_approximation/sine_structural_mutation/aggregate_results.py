...
plot_with_std(
    ...
    mean_fitness.values,
    std_fitness.values,
    title="Structural Mutation – Mean Best Fitness ± 1 STD (30 Seeds)",
    ylabel="Best Fitness (↓)",
    color="#2ca02c",
...
plot_with_std(
    ...
    title="Structural Mutation – Mean Number of Weights ± 1 STD (30 Seeds)",
    ylabel="Connections",
    color="#2ca02c",
...
plot_with_std(
    ...
    title="Structural Mutation – Mean Number of Neurons ± 1 STD (30 Seeds)",
    ylabel="Neurons",
    color="#2ca02c",
