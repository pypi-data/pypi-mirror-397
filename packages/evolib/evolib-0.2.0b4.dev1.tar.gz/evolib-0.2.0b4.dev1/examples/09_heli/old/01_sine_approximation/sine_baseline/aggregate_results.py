...
plot_with_std(
    ...
    mean_fitness.values,
    std_fitness.values,
    title="Baseline – Mean Best Fitness ± 1 STD (30 Seeds)",
    ylabel="Best Fitness (↓)",
    color="#1f77b4",
...
plot_with_std(
    ...
    title="Baseline – Mean Number of Weights ± 1 STD (30 Seeds)",
    ylabel="Weights",
    color="#1f77b4",
...
plot_with_std(
    ...
    title="Baseline – Mean Number of Neurons ± 1 STD (30 Seeds)",
    ylabel="Neurons",
    color="#1f77b4",
