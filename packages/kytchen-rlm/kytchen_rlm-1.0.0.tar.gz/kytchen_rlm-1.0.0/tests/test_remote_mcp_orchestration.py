...
from kytchen.mcp.local_server import KytchenMCPServerLocal, _RemoteServerHandle
from kytchen.recipe import RecipeConfig, DatasetInput, RecipeRunner
...
async def test_remote_calls_record_into_recipe_trace_and_evidence() -> None:
    ...
    assert runner.sauce, "expected sauce entry"
