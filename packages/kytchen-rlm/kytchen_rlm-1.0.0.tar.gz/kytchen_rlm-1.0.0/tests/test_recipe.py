"""Tests for the recipe/Kytchenfile module."""
...
class TestSauceBundle:
    """Tests for SauceBundle dataclass."""
    ...
    def test_add_sauce(self):
        ...
        bundle.sauce.append(item)
        assert len(bundle.sauce) == 1

    def test_compute_hash(self):
        """Compute bundle hash."""
        bundle = SauceBundle()
        bundle.sauce.append(SauceItem(
            source="search",
            line_range=None,
            pattern=None,
            snippet="test",
...
class TestKytchenfileIO:
    """Tests for loading and saving Kytchenfiles."""

    def test_save_load_json(self):
        """Save and load JSON Kytchenfile."""
        config = RecipeConfig(
            query="Find errors",
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            save_kytchenfile(config, path, format="json")

            loaded = load_kytchenfile(path)
    ...
    def test_load_nonexistent(self):
        ...
        with pytest.raises(FileNotFoundError):
            load_kytchenfile("/nonexistent/path.json")
