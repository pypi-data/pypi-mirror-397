    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.code_service_valideur is None and "code_service_valideur" in self.model_fields_set:
            _dict['codeServiceValideur'] = None

        # set to None if code_structure_valideur (nullable) is None
        # and model_fields_set contains the field
        if self.code_structure_valideur is None and "code_structure_valideur" in self.model_fields_set:
            _dict['codeStructureValideur'] = None
