...
class RequeteSoumissionFlux(BaseModel):
    """
    Requête pour soumettre une facture à une PDP/PA via AFNOR
    """ # noqa: E501
    nom_flux: StrictStr = Field(description="Nom du flux (ex: 'Facture 2025-001')")
    syntaxe_flux: Optional[SyntaxeFlux] = Field(default=None, description="Syntaxe du flux (CII pour Factur-X)")
    profil_flux: Optional[ProfilFlux] = None
    tracking_id: Optional[StrictStr] = None
    request_id: Optional[StrictStr] = None
    pdp_credentials: Optional[PDPCredentials] = None
    __properties: ClassVar[List[str]] = ["nom_flux", "syntaxe_flux", "profil_flux", "tracking_id", "request_id", "pdp_credentials"]
