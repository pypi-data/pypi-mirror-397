...
class ResultatAFNOR(BaseModel):
    """
    Résultat de la soumission à AFNOR PDP.
    """ # noqa: E501
    flow_id: StrictStr = Field(description="Identifiant du flux soumis")
    tracking_id: Optional[StrictStr] = None
    sha256: StrictStr = Field(description="Hash SHA-256 du fichier soumis")
    flow_syntax: StrictStr = Field(description="Syntaxe du flux")
    flow_profile: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["flow_id", "tracking_id", "sha256", "flow_syntax", "flow_profile"]
