...
class ConsulterStructureRequest(BaseModel):
    """
    ...
    code_langue: Optional[StrictStr] = Field(default='fr', description="Code langue (fr, en)")
    __properties: ClassVar[List[str]] = ["credentials", "id_structure_cpp", "code_langue"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "code_langue": obj.get("code_langue") if obj.get("code_langue") is not None else 'fr'
        })
        return _obj
