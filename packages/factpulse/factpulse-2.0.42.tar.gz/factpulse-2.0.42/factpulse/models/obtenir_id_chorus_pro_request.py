...
class ObtenirIdChorusProRequest(BaseModel):
    """
    Obtenir l'ID Chorus Pro depuis un SIRET.
    """ # noqa: E501
    credentials: Optional[ChorusProCredentials] = None
    siret: StrictStr = Field(description="SIRET de la structure (14 chiffres)")
    type_identifiant: Optional[StrictStr] = Field(default='SIRET', description="Type d'identifiant (SIRET, SIREN, UE_HORS_FRANCE, etc.)")
    __properties: ClassVar[List[str]] = ["credentials", "siret", "type_identifiant"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "siret": obj.get("siret"),
            "type_identifiant": obj.get("type_identifiant") if obj.get("type_identifiant") is not None else 'SIRET'
        })
        return _obj
