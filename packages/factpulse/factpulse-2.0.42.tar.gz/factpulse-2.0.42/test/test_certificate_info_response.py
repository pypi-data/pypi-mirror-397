...
class TestCertificateInfoResponse(unittest.TestCase):
    """CertificateInfoResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CertificateInfoResponse:
        """Test CertificateInfoResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CertificateInfoResponse`
        """
        model = CertificateInfoResponse()
        if include_optional:
    ...
    def testCertificateInfoResponse(self):
        """Test CertificateInfoResponse"""
