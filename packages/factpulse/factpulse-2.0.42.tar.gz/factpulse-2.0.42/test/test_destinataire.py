...
class TestDestinataire(unittest.TestCase):
    """Destinataire unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Destinataire:
        """Test Destinataire
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Destinataire`
        """
        model = Destinataire()
        if include_optional:
            return Destinataire(
