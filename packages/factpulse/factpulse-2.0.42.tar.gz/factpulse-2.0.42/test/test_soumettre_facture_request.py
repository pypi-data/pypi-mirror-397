...
class TestSoumettreFactureRequest(unittest.TestCase):
    """SoumettreFactureRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SoumettreFactureRequest:
        """Test SoumettreFactureRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SoumettreFactureRequest`
        """
        model = SoumettreFactureRequest()
        if include_optional:
            return SoumettreFactureRequest(
    ...
    def testSoumettreFactureRequest(self):
        """Test SoumettreFactureRequest"""
