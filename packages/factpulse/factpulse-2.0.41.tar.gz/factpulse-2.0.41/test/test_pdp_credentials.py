...
class TestPDPCredentials(unittest.TestCase):
    """PDPCredentials unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PDPCredentials:
        """Test PDPCredentials
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PDPCredentials`
        """
        model = PDPCredentials()
        if include_optional:
