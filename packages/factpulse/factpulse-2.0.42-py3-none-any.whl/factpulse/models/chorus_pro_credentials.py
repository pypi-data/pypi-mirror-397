...
class ChorusProCredentials(BaseModel):
    """
    ...
    """ # noqa: E501
    piste_client_id: StrictStr = Field(description="Client ID PISTE (portail API gouvernement)")
    piste_client_secret: StrictStr = Field(description="Client Secret PISTE")
    chorus_pro_login: StrictStr = Field(description="Login Chorus Pro")
    chorus_pro_password: StrictStr = Field(description="Mot de passe Chorus Pro")
    sandbox: Optional[StrictBool] = Field(default=True, description="Utiliser l'environnement sandbox (true) ou production (false)")
