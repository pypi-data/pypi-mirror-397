...
class ConsulterFactureRequest(BaseModel):
    """
    Consulter une facture.
    """ # noqa: E501
    credentials: Optional[ChorusProCredentials] = None
    identifiant_facture_cpp: StrictInt = Field(description="ID Chorus Pro de la facture")
    __properties: ClassVar[List[str]] = ["credentials", "identifiant_facture_cpp"]
