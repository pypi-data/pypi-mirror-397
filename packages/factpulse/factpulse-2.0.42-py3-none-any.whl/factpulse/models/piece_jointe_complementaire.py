...
class PieceJointeComplementaire(BaseModel):
    ...
    id: StrictInt
    id_liaison: StrictInt = Field(alias="idLiaison")
    numero_ligne_facture: StrictInt = Field(alias="numeroLigneFacture")
    type: StrictStr
    __properties: ClassVar[List[str]] = ["designation", "id", "idLiaison", "numeroLigneFacture", "type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "idLiaison": obj.get("idLiaison"),
            "numeroLigneFacture": obj.get("numeroLigneFacture"),
            "type": obj.get("type")
        })
        return _obj
