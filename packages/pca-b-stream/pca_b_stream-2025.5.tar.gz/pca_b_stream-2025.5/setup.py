...
ENTRY_POINTS = {
    "console_scripts": [
        f"pca2bstream={DESCRIPTION['IMPORT_NAME']}.cli:PCA2BStream",
        f"bstream2pca={DESCRIPTION['IMPORT_NAME']}.cli:BStream2PCA",
    ],
    "gui_scripts": [
        f"pca-b-stream={DESCRIPTION['IMPORT_NAME']}.nicegui.main:Main",
    ],
}
