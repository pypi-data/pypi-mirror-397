...
import json
import importlib
from lager.battery.battery_net import LibraryMissingError, DeviceNotFoundError, BatteryBackendError
...
def main() -> None:
    ...
    try:
        dispatcher = importlib.import_module("lager.battery.dispatcher")
