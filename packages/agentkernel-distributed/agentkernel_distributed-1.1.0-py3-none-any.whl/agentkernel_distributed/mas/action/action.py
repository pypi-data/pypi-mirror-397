...
class Action:
    """Proxy that orchestrates action components and their exposed methods."""
    ...
    async def post_init(self, controller: "BaseController", model_router: ModelRouter) -> None:
        ...
        Args:
            controller ("BaseController"): Controller coordinating module interactions.
    ...
    def get_component(self, name: Optional[str] = None) -> Optional[Union[ActionComponent, Dict[str, ActionComponent]]]:
        ...
        Args:
            name (Optional[str], optional): Component name to retrieve. When omitted, return the entire registry.
    ...
    def list_comp_methods_names(
        ...
        Args:
            ...
            annotation_type (Optional[str], optional): Filter methods by annotation type.
    ...
    async def get_agent_call_methods(
        ...
        Args:
            ...
            method_name (Optional[Union[str, List[str]]], optional): Optional single method or list of methods to filter results.
