"""Core abstractions for action components and plugins orchestration."""
...
class ActionComponent(ABC):
    ...
    async def forward(self, method_name: str, arguments: Optional[Dict[str, Any]] = None) -> ActionResult:
        ...
        Args:
            ...
            arguments (Optional[Dict[str, Any]], optional): Keyword arguments to pass to the method.
    ...
    def list_methods_names(self, annotation_type: Optional[str] = None) -> List[str]:
        ...
        Args:
            annotation_type (Optional[str], optional): Optional annotation type to filter by (e.g., "AgentCall", "ServiceCall").
    ...
    async def get_method(
        ...
        Args:
            method_name (Optional[Union[str, List[str]]], optional): Optional single method name or list of method names to fetch.
            annotation_type (Optional[str], optional): Optional annotation type to filter by (e.g., "AgentCall", "ServiceCall").
    ...
    async def add_method(
        ...
        Args:
            ...
            annotation (str): Annotation tag applied to the callable. Defaults to "AgentCall".
