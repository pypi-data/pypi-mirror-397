# packages/agentkernel-distributed/agentkernel_distributed/toolkit/logger/logger.py
...
def _get_default_log_config() -> Dict[str, Any]:
    ...
    Environment Variables:
        MAS_PROJECT_REL_PATH: The root package name of the user application.
                              Defaults to 'examples.distributed_test'.
    """
    app_package = os.environ.get("MAS_PROJECT_REL_PATH", "examples.distributed_test")
    ...
    return {
        ...
        "files": [
            ...
            {"name": "app_evaluation", "path": "logs/app/evaluation.log", "filter": f"{app_package}.evaluation"},
            {
                ...
                "filter": "agentkernel_distributed.mas.builder",
            },
            {"name": "mas_pod", "path": "logs/framework/mas/pod.log", "filter": "agentkernel_distributed.mas.pod"},
            {
                "name": "mas_controller",
                "path": "logs/framework/mas/controller.log",
                "filter": "agentkernel_distributed.mas.controller",
            },
            {
                "name": "mas_system",
                "path": "logs/framework/mas/system.log",
                "filter": "agentkernel_distributed.mas.system",
            },
            {
                "name": "mas_interface",
                "path": "logs/framework/mas/interface.log",
                "filter": "agentkernel_distributed.mas.interface",
            },
            {
                "name": "mas_agent",
                "path": "logs/framework/mas/agent.log",
                "filter": "agentkernel_distributed.mas.agent",
            },
            {
                "name": "mas_action",
                "path": "logs/framework/mas/action.log",
                "filter": "agentkernel_distributed.mas.action",
            },
            {
                "name": "mas_environment",
                "path": "logs/framework/mas/environment.log",
                "filter": "agentkernel_distributed.mas.environment",
            },
            {
                "name": "toolkit_models",
                "path": "logs/framework/toolkit/models.log",
                "filter": "agentkernel_distributed.toolkit.models",
            },
            {
                "name": "toolkit_storages",
                "path": "logs/framework/toolkit/storages.log",
                "filter": "agentkernel_distributed.toolkit.storages",
            },
            {
                "name": "toolkit_generation",
                "path": "logs/framework/toolkit/generation.log",
                "filter": "agentkernel_distributed.toolkit.generation",
            },
            {
                "name": "toolkit_utils",
                "path": "logs/framework/toolkit/utils.log",
                "filter": "agentkernel_distributed.toolkit.utils",
            },
            {
                "name": "framework_other",
                "path": "logs/framework/other.log",
                "filter": {
                    "include": ["agentkernel_distributed"],
                    "exclude": [
                        "agentkernel_distributed.mas",
                        "agentkernel_distributed.toolkit",
                    ],
                },
            },
        ],
...
def _internal_setup_logging(config: Dict[str, Any]) -> None:
    ...
    logging.getLogger("agentkernel_distributed").propagate = propagate
