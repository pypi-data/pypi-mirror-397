...
from .components.base import SystemComponent
...
class System:
    ...
    async def post_init(self, pod_manager: "BasePodManager") -> None:
        ...
        Args:
            pod_manager (BasePodManager): Pod manager coordinating the simulation.
        ...
        for name, component in self._components.items():
            ...
            if name == "messager":
                post_init_tasks.append(component.post_init.remote(pod_manager=pod_manager))
            else:
                post_init_tasks.append(component.post_init.remote())
