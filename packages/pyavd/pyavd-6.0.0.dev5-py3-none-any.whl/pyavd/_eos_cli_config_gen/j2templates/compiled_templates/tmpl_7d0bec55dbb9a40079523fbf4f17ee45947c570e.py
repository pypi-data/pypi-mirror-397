...
def root(context, missing=missing):
    ...
    for l_1_ethernet_interface in t_3((undefined(name='ethernet_interfaces') if l_0_ethernet_interfaces is missing else l_0_ethernet_interfaces), 'name'):
        ...
        if t_11(environment.getattr(environment.getattr(environment.getattr(l_1_ethernet_interface, 'transceiver'), 'media'), 'override')):
            ...
            yield '\n'
        if t_11(environment.getattr(environment.getattr(environment.getattr(l_1_ethernet_interface, 'transceiver'), 'power'), 'ignore'), True):
            pass
            yield '   transceiver power ignore\n'
        ...
        if t_11(environment.getattr(environment.getattr(l_1_ethernet_interface, 'transceiver'), 'frequency')):
            ...
            yield '\n'
        if t_11(environment.getattr(environment.getattr(environment.getattr(l_1_ethernet_interface, 'transceiver'), 'transmitter'), 'signal_power')):
            pass
            yield '   transceiver transmitter signal-power '
            yield str(t_6('%.2f', t_5(environment.getattr(environment.getattr(environment.getattr(l_1_ethernet_interface, 'transceiver'), 'transmitter'), 'signal_power'))))
            yield '\n'
        if t_11(environment.getattr(environment.getattr(environment.getattr(l_1_ethernet_interface, 'transceiver'), 'transmitter'), 'disabled'), True):
            pass
            yield '   transceiver transmitter disabled\n'
