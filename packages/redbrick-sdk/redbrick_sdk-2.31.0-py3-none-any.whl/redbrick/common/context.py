...
from redbrick.common.client import RBClient, RBClientImpl, RBClientLocal
...
class RBContextLocal(RBContext):
    """Basic context for accessing low level functionality."""

    def __init__(self, schema, context, url: str) -> None:
        """Construct RedBrick client singleton."""
        # pylint: disable=import-outside-toplevel, cyclic-import
        from redbrick.repo import (
            ExportRepoImpl,
        ...
        self.client = RBClientLocal(schema=schema, context=context, url=url)
