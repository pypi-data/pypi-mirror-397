...
<!-- Quick badges + links -->
[![Docs](https://img.shields.io/website?down_color=red&down_message=offline&up_message=online&url=https://flyingriverhorse.github.io/Skyulf)](https://flyingriverhorse.github.io/Skyulf) [![PyPI](https://img.shields.io/pypi/v/skyulf-core.svg)](https://pypi.org/project/skyulf-core) [![License](https://img.shields.io/github/license/flyingriverhorse/Skyulf)](LICENSE) [![Build Status](https://img.shields.io/github/actions/workflow/status/flyingriverhorse/Skyulf/ci.yml?branch=main)](https://github.com/flyingriverhorse/Skyulf/actions)
[![Python](https://img.shields.io/pypi/pyversions/skyulf-core.svg)](https://pypi.org/project/skyulf-core) [![Downloads](https://img.shields.io/pypi/dm/skyulf-core.svg)](https://pypi.org/project/skyulf-core) [![codecov](https://img.shields.io/codecov/c/github/flyingriverhorse/Skyulf.svg)](https://codecov.io/gh/flyingriverhorse/Skyulf) [![issues](https://img.shields.io/github/issues/flyingriverhorse/Skyulf.svg)](https://github.com/flyingriverhorse/Skyulf/issues) [![contributors](https://img.shields.io/github/contributors/flyingriverhorse/Skyulf.svg)](https://github.com/flyingriverhorse/Skyulf/graphs/contributors)

**Website & Documentation**

Visit the full documentation and project site for guides, API reference, and examples:

- Project site / docs: https://flyingriverhorse.github.io/Skyulf
