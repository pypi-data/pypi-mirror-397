...
USER_RAISE_PATTERN: Final[str] = r"RaiseException:\s(.*)"
"""Regex pattern to extract the message from custom RAISE EXCEPTION calls in PostgreSQL.

Matches error messages generated by PL/pgSQL `RAISE EXCEPTION` statements,
typically formatted as 'RaiseException: <message>'.

Captures:
    Group 1: The custom message or field identifier raised in the database.

Used by: `BasePsycopgTranslator._translate_user_raise`
Example: 'RaiseException: Invalid value for field: status' →
