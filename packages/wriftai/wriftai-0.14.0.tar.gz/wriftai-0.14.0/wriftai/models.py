...
class ModelsResource(Resource):
    ...
    def get(self, owner: str, name: str) -> ModelWithDetails:
        """Get a model.
    ...
    def create(self, params: CreateModelParams) -> ModelWithDetails:
        ...
        Returns:
            ModelWithDetails: The new model.
        """
    ...
    def update(
        ...
        Returns:
            ModelWithDetails: The updated model.
        """
        response = self._api.request(
            method="PATCH",
