...
class UserEndpoints:
    ...
    async def update_current_user(self, update_data: UserUpdate) -> UserResponse:
        ...
        response = await self._request(
            "PATCH", "/users/me", json_data=update_data.model_dump(exclude_unset=True)
        )
        return UserResponse(**response.json())
    ...
    async def create_user(self, create_data: UserCreate) -> UserResponse:
        ...
        """
        response = await self._request("POST", "/users/", json_data=create_data.model_dump())
        return UserResponse(**response.json())
    ...
    async def update_user(
        ...
        """
        response = await self._request(
            "PUT", f"/users/{user_id}", json_data=update_data.model_dump(exclude_unset=True)
        )
        return UserResponse(**response.json())
