...
class Sdk:
    ...
    def __init__(self):
        ...
        self.SC2_Cam.PCO_GetVersion_SDK.argtypes = [
            C.c_char_p,
            C.c_int,
            C.POINTER(C.c_int),
            C.POINTER(C.c_int),
    ...
    # -------------------------------------------------------------------------
    # PCO_CheckDeviceAvailability (for the moment intentionally not implemented)
    # -------------------------------------------------------------------------
    ...
    # -------------------------------------------------------------------------
    # PCO_GetGeneral (for the moment intentionally not implemented)
    # -------------------------------------------------------------------------
    ...
    # -------------------------------------------------------------------------
    # PCO_GetSensorStruct (for the moment intentionally not implemented)
    # -------------------------------------------------------------------------
    def get_sensor_struct(self):
        raise NotImplementedError
    # -------------------------------------------------------------------------
    # PCO_SetSensorStruct (for the moment intentionally not implemented)
    # -------------------------------------------------------------------------
    ...
    def set_pixel_rate(self, pixel_rate):
        ...
        if (error & 0x80000000) and not (error & 0x40000000): #Checks that we really have an error
            raise CameraException(sdk=self, code=error)
    ...
    # -------------------------------------------------------------------------
    # PCO_GetLookuptableInfo (for the moment intentionally not implemented)
    # -------------------------------------------------------------------------
    ...
    # -------------------------------------------------------------------------
    # PCO_GetActiveLookuptable (for the moment intentionally not implemented)
    # -------------------------------------------------------------------------
    ...
    # -------------------------------------------------------------------------
    # PCO_SetActiveLookuptable (for the moment intentionally not implemented)
    # -------------------------------------------------------------------------
    ...
    def get_sensor_dark_offset(self):
        ...
        return ret
    # -------------------------------------------------------------------------
    # PCO_GetTimingStruct (for the moment intentionally not implemented)
    # -------------------------------------------------------------------------
    ...
    # -------------------------------------------------------------------------
    # PCO_SetTimingStruct (for the moment intentionally not implemented)
    # -------------------------------------------------------------------------
    ...
    # -------------------------------------------------------------------------
    # PCO_GetPowerDownMode (for the moment intentionally not implemented)
    # -------------------------------------------------------------------------
    ...
    # -------------------------------------------------------------------------
    # PCO_SetPowerDownMode (for the moment intentionally not implemented)
    # -------------------------------------------------------------------------
    ...
    # -------------------------------------------------------------------------
    # PCO_GetUserPowerDownTime (for the moment intentionally not implemented)
    # -------------------------------------------------------------------------
    ...
    # -------------------------------------------------------------------------
    # PCO_SetUserPowerDownTime (for the moment intentionally not implemented)
    # -------------------------------------------------------------------------
    ...
    # -------------------------------------------------------------------------
    # PCO_GetModulationMode (for the moment intentionally not implemented)
    # -------------------------------------------------------------------------
    ...
    # -------------------------------------------------------------------------
    # PCO_SetModulationMode (for the moment intentionally not implemented)
    # -------------------------------------------------------------------------
    ...
    # -------------------------------------------------------------------------
    # PCO_GetRecordingStruct (for the moment intentionally not implemented)
    # -------------------------------------------------------------------------
    ...
    # -------------------------------------------------------------------------
    # PCO_SetRecordingStruct (for the moment intentionally not implemented)
    # -------------------------------------------------------------------------
    ...
    # -------------------------------------------------------------------------
    # PCO_GetMaxNumberOfImagesInSegment
    # -------------------------------------------------------------------------
    ...
    # -------------------------------------------------------------------------
    # PCO_GetImageEx
    # PCO_GetImage                                            (obsolete)
    # PCO_AddBufferEx
    # PCO_AddBuffer                                           (obsolete)
    # PCO_AddBufferExtern
    # PCO_CancelImages
    # PCO_RemoveBuffer                                        (obsolete)
    # PCO_GetPendingBuffer
    # PCO_WaitforBuffer
    # PCO_EnableSoftROI               (not recommended for new designs)
    # PCO_GetMetaData                 (not recommended for new designs)
    # -------------------------------------------------------------------------
    ...
    # -------------------------------------------------------------------------
    # PCO_GetCmosLineTiming                                   (pco.edge)
    # -------------------------------------------------------------------------
    ...
    # -------------------------------------------------------------------------
    # PCO_SetCmosLineTiming                                   (pco.edge)
    # -------------------------------------------------------------------------
    ...
    # -------------------------------------------------------------------------
    # PCO_GetCmosLineExposureDelay                            (pco.edge)
    # -------------------------------------------------------------------------
    ...
    # -------------------------------------------------------------------------
    # PCO_SetCmosLineExposureDelay                            (pco.edge)
    # -------------------------------------------------------------------------
    ...
    # -------------------------------------------------------------------------
    # PCO_SetTransferParametersAuto                           (pco.edge)
    # -------------------------------------------------------------------------
    ...
    # -------------------------------------------------------------------------
    # PCO_GetInterfaceOutputFormat                            (pco.edge)
    # -------------------------------------------------------------------------
    ...
    # -------------------------------------------------------------------------
    # PCO_SetInterfaceOutputFormat                            (pco.edge)
    # -------------------------------------------------------------------------
    ...
    # -------------------------------------------------------------------------
    # PCO_GetImageTransferMode                               (pco.dimax)
    def get_image_transfer_mode(self):
        raise NotImplementedError

    # PCO_SetImageTransferMode                               (pco.dimax)
    def set_image_transfer_mode(self):
        raise NotImplementedError

    # PCO_GetCDIMode                                         (pco.dimax)
    ...
    # PCO_GetPowerSaveMode                                   (pco.dimax)
    ...
    # PCO_SetPowerSaveMode                                   (pco.dimax)
    ...
    # PCO_GetBatteryStatus                                   (pco.dimax)
    ...
    def get_battery_status(self):
        ...
        return ret
    # -------------------------------------------------------------------------
    # PCO_GetInterfaceOutputFormat                (pco.dimax with HDSDI)
    # PCO_SetInterfaceOutputFormat                (pco.dimax with HDSDI)
    # PCO_PlayImagesFromSegmentHDSDI              (pco.dimax with HDSDI)
    ...
    # PCO_GetPlayPositionHDSDI                    (pco.dimax with HDSDI)
    ...
    # PCO_GetColorSettings                        (pco.dimax with HDSDI)
    ...
    # PCO_SetColorSettings                        (pco.dimax with HDSDI)
    ...
    # PCO_DoWhiteBalance                          (pco.dimax with HDSDI)
    ...
    # -------------------------------------------------------------------------
    # PCO_GetFlimModulationParameter
    # -------------------------------------------------------------------------
    ...
    # -------------------------------------------------------------------------
    # PCO_SetFlimModulationParameter
    # -------------------------------------------------------------------------
    ...
    # -------------------------------------------------------------------------
    # PCO_GetFlimMasterModulationFrequency
    # -------------------------------------------------------------------------
    ...
    # -------------------------------------------------------------------------
    # PCO_SetFlimMasterModulationFrequency
    # -------------------------------------------------------------------------
    ...
    # -------------------------------------------------------------------------
    # PCO_GetFlimPhaseSequenceParameter
    # -------------------------------------------------------------------------
    ...
    # -------------------------------------------------------------------------
    # PCO_SetFlimPhaseSequenceParameter
    # -------------------------------------------------------------------------
    ...
    # -------------------------------------------------------------------------
    # PCO_GetFlimImageProcessingFlow
    # -------------------------------------------------------------------------
    ...
    # -------------------------------------------------------------------------
    # PCO_SetFlimImageProcessingFlow
    # -------------------------------------------------------------------------
    ...
    # -------------------------------------------------------------------------
    # PCO_SendBirgerCommand
    # -------------------------------------------------------------------------
    def send_birger_command(self):
        raise NotImplementedError
    # -------------------------------------------------------------------------
    # PCO_GetIntensifiedGatingMode
    # -------------------------------------------------------------------------
    ...
    def get_version_info_sc2_cam(self):
        warnings.warn(
            'sdk.get_version_info_sc2_cam is deprecated and will be removed, please use get_version_sdk.'
        )
        return self.get_version_sdk()
    ...
    def get_version_sdk(self):
        ...
        error = self.SC2_Cam.PCO_GetVersion_SDK(pszName, iNameLength, iMajor, iMinor, iPatch, iBuild)
        duration = time.perf_counter() - time_start
        error_msg = self.get_error_text(error)
