# From https://github.com/pyutils/line_profiler/blob/a344928bc62a328e33c2f9baced2861be11c04b1/line_profiler/line_profiler.py
...
try:
    from line_profiler._line_profiler import LineProfiler as CLineProfiler
...
def load_ipython_extension(ip):
    ...
    from line_profiler.ipython_extension import LineProfilerMagics
...
class LineProfiler(CLineProfiler):
    ...
    def print_stats(
        ...
        show_text(
            ...
            sort=sort,
            rich=rich,
            show_timer_unit=show_timer_unit,
        )
...
def show_func(
    ...
    if (
        ...
        or is_ipython_kernel_cell(filename)
        # Fused modification: we trust linecache for getting the code
        or linecache.getlines(filename)
    ):
        ...
        nlines = (
            1 if not linenos else max(linenos) - min(min(linenos), start_lineno) + 1
        )
        sublines = [""] * nlines
...
def show_text(
    ...
    # Fused modification: allow turning off the Timer unit
    if show_timer_unit:
