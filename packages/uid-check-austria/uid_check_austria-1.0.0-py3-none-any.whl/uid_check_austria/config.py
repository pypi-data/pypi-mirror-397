...
Contents:
    ...
    * :func:`load_finanzonline_config` – loads FinanzOnline credentials and settings
    ...
    :mod:`uid_check_austria.__init__conf__` as LAYEREDCONF_* constants.
...
def _get_cache_dir() -> Path:
    ...
    Returns:
        ...
        - Linux: ~/.cache/uid-check-austria/
        - macOS: ~/Library/Caches/uid-check-austria/
        - Windows: %LOCALAPPDATA%/uid-check-austria/
    """
    import sys
