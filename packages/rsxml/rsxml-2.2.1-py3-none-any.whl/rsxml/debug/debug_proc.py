...
class ProcStats:
    ...
    def __init__(
        ...
        vms_raw: int,
        children: int,
        children_rss_raw: int,
        children_vms_raw: int,
    ):
        """_summary_
    ...
    def toString(self) -> str:
        ...
        return (
            ...
            f"cpu_percent: {math.ceil(self.cpu_percent)}, "
            f"mem_resident: {self.rss:.2f}Mb, "
            f"mem_virtual: {self.vms:.2f}Mb, "
            f"num_children: {self.children}, "
            f"mem_children_resident: {self.rss:.2f}Mb, "
            f"mem_children_virtual: {self.vms:.2f}Mb"
        )
...
class MemoryMonitor:
    ...
    def write_plot(self, imgpath: str):
        ...
        ax2 = plt_ax.twinx()
        #  ['datetime', 'cpu_percent', 'resident_memory', 'virtual_memory', 'children',
        #   'children_resident', 'children_virtual']
