...
class Project(RSObj):
    ...
    def __init__(
        ...
        Initializes a Project instance.
            ...
            Args:
                ...
                realizations (List[Realization], optional): The realizations associated with the project.
                                                            Defaults to None.
    ...
    def from_xml(xml_node: ET.Element, proj_path: str = None) -> Project:
        ...
        if project_bounds_find is None:
            log = Logger("Project")
            log.warning(
                "WARNING: No ProjectBounds.\n"
                "The project will load into the Riverscapes Data Exchange, but will be easier to discover "
                "if you add a ProjectBounds."
            )
        ...
        project = Project(
            ...
            warehouse=warehouse,
            # List comprehension on the result of find() will iterate over all the children of the node.
            # Do not wildcard!
