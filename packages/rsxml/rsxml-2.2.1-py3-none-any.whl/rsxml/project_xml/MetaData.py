...
# These must be updated here if the XSD changes
EXT_TYPES = ["warehouse", "project", "dataset"]
...
class MetaData:
    ...
    def __init__(
        self,
        values: List[Meta] | None = None,
        container_tag: str = "MetaData",
        inner_tag: str = "Meta",
    ) -> None:
        """
    ...
    def __eq__(self, other: MetaData) -> bool:
        ...
        return (
            ...
            and self.inner_tag == other.inner_tag
            and len(self._values) == len(other._values)
            and all([a == b for a, b in zip(self._values, other._values, strict=False)])
        )
