...
class Geopackage(Dataset):
    ...
    def __init__(
        ...
        name: str,
        path: str,
        layers: List[GeopackageLayer] | None = None,
...
class GeopackageLayer(RSObj):
    ...
    def __init__(
        ...
        Args:
            ...
            citation (str, optional): The citation information for the dataset. Defaults to None.
            meta_data (MetaData, optional): The metadata associated with the dataset. Defaults to None.
            lyr_type (str): The type of the dataset layer. This can be any string and it's used as a non-unique identifier
                            to help with business logic xpaths
    ...
    def __eq__(self, o: object) -> bool:
        if not isinstance(o, GeopackageLayer):
            return False
        return super().__eq__(o) and self.lyr_name == o.lyr_name and self.ds_type == o.ds_type and self.ext_ref == o.ext_ref
