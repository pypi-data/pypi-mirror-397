...
from rsxml.project_xml import Dataset, MetaData
...
class ProjectClasses(unittest.TestCase):
    ...
    def test_metadata(self):
        ...
        try:
            MetaData(values=[project_xml.Meta(name="test_key2", value="test_invalid_type", type="invalid_type")])
        ...
        try:
            MetaData(values=[project_xml.Meta(name="test_key2", value="test_invalid_ext", ext="invalid_ext")])
            # Should not be able to get here with invalid metadata
            self.fail("Expected ValueError")
        except ValueError:
            pass
