...
class FractureSetDescription:
    ...
    def __repr__(self) -> str:
        ...
    def add_observed_fracture(self, arg0: opengeode.lib64.opengeode_py_geometry.Point2D, arg1: opengeode.lib64.opengeode_py_geometry.Point2D) -> None:
        ...
    def string(self) -> str:
        """
...
class SpatialDomain2D:
    def __init__(self, domain: opengeode.lib64.opengeode_py_geometry.BoundingBox2D, buffer_size: float) -> None:
        """
...
class SpatialDomain3D:
    def __init__(self, domain: opengeode.lib64.opengeode_py_geometry.BoundingBox3D, buffer_size: float) -> None:
        """
                        Create a spatial domain composed of:
