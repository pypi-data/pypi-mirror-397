...
class TestControlMatcherNonNISTFrameworks:
    ...
    def test_get_variations_cis(self, mock_app_class, mock_api_class):
        ...
        # Test CIS variations (should be minimal since they're numeric)
        variations = matcher._get_control_id_variations("1.1.1")

        # CIS controls should only have the exact format
        assert variations == {"1.1.1"}
