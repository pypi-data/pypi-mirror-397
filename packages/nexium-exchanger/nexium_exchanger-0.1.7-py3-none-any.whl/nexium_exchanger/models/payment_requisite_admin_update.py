...
class PaymentRequisiteAdminUpdate(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "data", "owner_type", "owner_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PaymentRequisiteAdminUpdate from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PaymentRequisiteAdminUpdate from a dict"""
        if obj is None:
            return None
