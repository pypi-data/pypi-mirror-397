...
class PaymentAttachmentOut(BaseModel):
    ...
    url: StrictStr
    created_at: datetime
    __properties: ClassVar[List[str]] = ["id", "file_name", "content_type", "size", "url", "created_at"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PaymentAttachmentOut from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PaymentAttachmentOut from a dict"""
        if obj is None:
            return None
