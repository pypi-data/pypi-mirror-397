...
if TYPE_CHECKING:
    ...
    from ..models.ai_agent_input_transforms_messages_context_length_type_0 import (
        AiAgentInputTransformsMessagesContextLengthType0,
    )
    from ..models.ai_agent_input_transforms_messages_context_length_type_1 import (
        AiAgentInputTransformsMessagesContextLengthType1,
    )
...
class AiAgentInputTransforms:
    ...
    Attributes:
        ...
        streaming (Union['AiAgentInputTransformsStreamingType0', 'AiAgentInputTransformsStreamingType1', Unset]): Maps
            input parameters for a step. Can be a static value or a JavaScript expression that references previous results
            or flow inputs
        messages_context_length (Union['AiAgentInputTransformsMessagesContextLengthType0',
            'AiAgentInputTransformsMessagesContextLengthType1', Unset]): Maps input parameters for a step. Can be a static
    ...
    messages_context_length: Union[
        "AiAgentInputTransformsMessagesContextLengthType0", "AiAgentInputTransformsMessagesContextLengthType1", Unset
    ] = UNSET
    output_schema: Union[
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        messages_context_length: Union[Dict[str, Any], Unset]
        if isinstance(self.messages_context_length, Unset):
            messages_context_length = UNSET

        elif isinstance(self.messages_context_length, AiAgentInputTransformsMessagesContextLengthType0):
            messages_context_length = UNSET
            if not isinstance(self.messages_context_length, Unset):
                messages_context_length = self.messages_context_length.to_dict()
        ...
        if messages_context_length is not UNSET:
            field_dict["messages_context_length"] = messages_context_length
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_messages_context_length(
            data: object,
        ) -> Union[
            "AiAgentInputTransformsMessagesContextLengthType0",
            "AiAgentInputTransformsMessagesContextLengthType1",
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                _messages_context_length_type_0 = data
                messages_context_length_type_0: Union[Unset, AiAgentInputTransformsMessagesContextLengthType0]
                if isinstance(_messages_context_length_type_0, Unset):
                    messages_context_length_type_0 = UNSET
                else:
                    messages_context_length_type_0 = AiAgentInputTransformsMessagesContextLengthType0.from_dict(
                        _messages_context_length_type_0
                    )

                return messages_context_length_type_0
            except:  # noqa: E722
                pass
            if not isinstance(data, dict):
                raise TypeError()
            _messages_context_length_type_1 = data
            messages_context_length_type_1: Union[Unset, AiAgentInputTransformsMessagesContextLengthType1]
            if isinstance(_messages_context_length_type_1, Unset):
                messages_context_length_type_1 = UNSET
            else:
                messages_context_length_type_1 = AiAgentInputTransformsMessagesContextLengthType1.from_dict(
                    _messages_context_length_type_1
                )

            return messages_context_length_type_1

        messages_context_length = _parse_messages_context_length(d.pop("messages_context_length", UNSET))
        ...
        ai_agent_input_transforms = cls(
            ...
            streaming=streaming,
            messages_context_length=messages_context_length,
