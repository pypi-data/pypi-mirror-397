...
class AiAgentToolsItem:
    ...
    Attributes:
        ...
        value (Union['AiAgentToolsItemValueType0', 'AiAgentToolsItemValueType1']): The implementation of a tool. Can be
            a flow module (script/flow) or an MCP tool reference
