...
def get_version():
    ...
    version_file = os.path.join(BASEDIR, 'ovos_color_parser', 'version.py')
...
extra_files = package_files('ovos_color_parser')
...
setup(
    ...
    description='OpenVoiceOS\'s multilingual text color parsing and formatting library',
