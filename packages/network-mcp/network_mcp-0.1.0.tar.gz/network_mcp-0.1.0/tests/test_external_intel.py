...
def test_rdap_lookup_parses_basic_fields(mock_urlopen, mock_validate):
    ...
    mock_resp = MagicMock()
    mock_resp.read.return_value = b'{"handle":"TEST","country":"US","startAddress":"1.1.1.0","endAddress":"1.1.1.255"}'
...
def test_asn_lookup_parses_cymru_txt(mock_validate):
    ...
    fake_answers[0].__str__.return_value = '"13335 | 1.1.1.0/24 | AU | apnic | 2011-08-11 | CLOUDFLARENET"'
