...
setup(
    ...
    description="Static Application Security Testing for JavaScript, Python, Java, and C#",
    ...
    python_requires=">=3.8",
    keywords="sast security testing javascript python java csharp vulnerability scanner",
    entry_points={
        "console_scripts": [
