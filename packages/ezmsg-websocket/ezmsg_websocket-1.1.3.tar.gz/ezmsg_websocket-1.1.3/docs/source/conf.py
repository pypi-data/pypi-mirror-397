...
try:
    from ezmsg.websocket.__version__ import version as release
except ImportError:
    release = "unknown"
...
html_baseurl = "https://www.ezmsg.org/ezmsg-websocket/"

html_theme_options = {
    "logo": {
        "text": f"ezmsg.websocket {version}",
    ...
    "icon_links": [
        {
            "name": "GitHub",
            "url": "https://github.com/ezmsg-org/ezmsg-websocket",
...
branch = "main"
code_url = f"https://github.com/ezmsg-org/ezmsg-websocket/blob/{branch}/"
