...
BCM_CREATED_TAG_KEY = "BCM Created at"
...
class Cluster:
    ...
    def _get_created_at(self) -> str | None:
        ...
        if self.resource_group and self.resource_group.tags:
            created_at = self.resource_group.tags.get(BCM_CREATED_TAG_KEY)
        if not created_at and self.primary_head_node and self.primary_head_node.tags:
            created_at = self.primary_head_node.tags.get(BCM_CREATED_TAG_KEY)
