...
* src/keep_github_workflows_active/behaviors.py
* src/keep_github_workflows_active/cli.py
* src/keep_github_workflows_active/__main__.py
* src/keep_github_workflows_active/__init__.py
* src/keep_github_workflows_active/__init__conf__.py
* tests/test_cli.py
...
* **Location:** src/keep_github_workflows_active/behaviors.py
...
* **Location:** src/keep_github_workflows_active/__init__conf__.py
...
1. ``keep_github_workflows_active`` → prints CLI help (no default action).
2. ``keep_github_workflows_active hello`` → prints greeting.
3. ``keep_github_workflows_active fail`` → prints truncated traceback.
4. ``keep_github_workflows_active --traceback fail`` → prints full rich traceback.
5. ``python -m keep_github_workflows_active --traceback fail`` → matches console output.
