...
```bash
pip install healthsecure==0.2.0.post1
```
...
**v2 contracts are frozen** - See [STABILITY.md](STABILITY.md) for:

- Locked signal schema (v1 + v2 extensions)
