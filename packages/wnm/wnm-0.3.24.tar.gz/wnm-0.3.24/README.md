...
sudo /opt/wnm/.venv/bin/wnm --init --migrate_anm

# Or initialize fresh
sudo /opt/wnm/.venv/bin/wnm --init --rewards_address 0xYourEthereumAddress
```
...
# Add this line:
*/1 * * * * /opt/wnm/.venv/bin/wnm >> /var/log/wnm-cron.log 2>&1
```
