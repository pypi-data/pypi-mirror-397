"""migration_temporary_test_20251015_235048

Revision ID: 38b3af57ca90
Revises: 70db459055a2
Create Date: 2025-10-15 23:50:49.785571
...
revision: str = '38b3af57ca90'
down_revision: Union[str, Sequence[str], None] = '70db459055a2'
...
def upgrade() -> None:
    ...
    op.create_table('dataset_mapping_test_val',
    sa.Column('dataset_id', sa.Integer(), nullable=False),
    sa.Column('company_id', sa.Integer(), nullable=False),
    sa.Column('sku_id', sa.Integer(), nullable=False),
    sa.Column('sku_type', sa.Enum('known_sku', 'unknown_sku', 'unknown_store', 'unknown_product', 'unknown_company', name='skutype'), nullable=False),
    ...
    op.create_table('dataset_mapping_train',
    sa.Column('dataset_id', sa.Integer(), nullable=False),
    sa.Column('company_id', sa.Integer(), nullable=False),
    sa.Column('sku_id', sa.Integer(), nullable=False),
