"""create complete schema for new database

Revision ID: 1a0b9cd19b31
Revises: 5df859d3bc55
Create Date: 2025-09-19 19:17:07.592035
...
revision: str = '1a0b9cd19b31'
down_revision: Union[str, Sequence[str], None] = '5df859d3bc55'
...
def upgrade() -> None:
    ...
    info={'timescale': {'time_column': 'ts', 'space_column': 'product_id', 'number_partitions': 32, 'chunk_interval': '14 days', 'compression': {'enabled': True, 'segmentby': ['company_id', 'product_id', 'feature_id'], 'orderby': 'ts DESC', 'compress_after': '30 days'}, 'caggs': []}}
    )
    ...
    info={'timescale': {'time_column': 'ts', 'space_column': 'region_id', 'number_partitions': 16, 'chunk_interval': '14 days', 'compression': {'enabled': True, 'segmentby': ['company_id', 'region_id', 'feature_id'], 'orderby': 'ts DESC', 'compress_after': '30 days'}, 'caggs': []}}
    )
    ...
    info={'timescale': {'time_column': 'ts', 'space_column': 'store_id', 'number_partitions': 32, 'chunk_interval': '14 days', 'compression': {'enabled': True, 'segmentby': ['company_id', 'store_id', 'feature_id'], 'orderby': 'ts DESC', 'compress_after': '30 days'}, 'caggs': []}}
    )
    ...
    info={'timescale': {'time_column': 'valid_from', 'space_column': 'sku_id', 'number_partitions': 32, 'chunk_interval': '14 days', 'compression': {'enabled': True, 'segmentby': ['company_id', 'sku_id', 'expected_delivery_date'], 'orderby': 'valid_from DESC', 'compress_after': '30 days'}, 'caggs': []}}
    )
    ...
    info={'timescale': {'time_column': 'expected_delivery_date', 'space_column': 'sku_id', 'number_partitions': 32, 'chunk_interval': '14 days', 'compression': {'enabled': True, 'segmentby': ['company_id', 'sku_id'], 'orderby': 'expected_delivery_date DESC', 'compress_after': '30 days'}, 'caggs': []}}
    )
    ...
    info={'timescale': {'time_column': 'ts', 'space_column': 'sku_id', 'number_partitions': 32, 'chunk_interval': '14 days', 'compression': {'enabled': True, 'segmentby': ['company_id', 'sku_id', 'feature_id'], 'orderby': 'ts DESC', 'compress_after': '30 days'}, 'caggs': []}}
    )
    ...
    info={'timescale': {'time_column': 'order_date', 'space_column': 'sku_id', 'number_partitions': 32, 'chunk_interval': '14 days', 'compression': {'enabled': True, 'segmentby': ['company_id', 'sku_id'], 'orderby': 'order_date DESC', 'compress_after': '30 days'}, 'caggs': []}}
    )
    ...
    timescale_tables = [
        ('time_product_features', 'ts', 'product_id', 32),
        ('time_product_features_text', 'ts', 'product_id', 32),
        ('time_region_features', 'ts', 'region_id', 16),
        ('time_region_features_text', 'ts', 'region_id', 16),
        ('time_store_features', 'ts', 'store_id', 32),
        ('time_store_features_text', 'ts', 'store_id', 32),
        ('time_sku_features', 'ts', 'sku_id', 32),
        ('time_sku_features_text', 'ts', 'sku_id', 32),
        ('order_intake', 'order_date', 'sku_id', 32),
        ('expected_deliveries', 'expected_delivery_date', 'sku_id', 32),
        ('change_log_committed', 'valid_from', 'sku_id', 32),
        ('flags', 'ts', 'sku_id', 32)
    ]

    # Create hypertables
    for table_name, time_col, space_col, partitions in timescale_tables:
    ...
    compression_configs = [
        ('time_product_features', 'ts DESC', 'company_id,product_id,feature_id'),
        ('time_product_features_text', 'ts DESC', 'company_id,product_id,feature_id'),
        ('time_region_features', 'ts DESC', 'company_id,region_id,feature_id'),
        ('time_region_features_text', 'ts DESC', 'company_id,region_id,feature_id'),
        ('time_store_features', 'ts DESC', 'company_id,store_id,feature_id'),
        ('time_store_features_text', 'ts DESC', 'company_id,store_id,feature_id'),
        ('time_sku_features', 'ts DESC', 'company_id,sku_id,feature_id'),
        ('time_sku_features_text', 'ts DESC', 'company_id,sku_id,feature_id'),
        ('order_intake', 'order_date DESC', 'company_id,sku_id'),
        ('expected_deliveries', 'expected_delivery_date DESC', 'company_id,sku_id'),
        ('change_log_committed', 'valid_from DESC', 'company_id,sku_id,expected_delivery_date'),
        ('flags', 'ts DESC', 'company_id,sku_id,feature_id')
    ]

    # Set compression options
    for table_name, orderby, segmentby in compression_configs:
        bind.execute(sa.text(f"""
    ...
    for table_name, _, _ in compression_configs:
        bind.execute(sa.text(f"""
