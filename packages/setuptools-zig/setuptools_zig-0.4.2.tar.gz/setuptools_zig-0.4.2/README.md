...
setup(
    ...
    setup_requires=['setuptools-zig>-0.4'],  # or e.g. ['setuptools-zig>-0.4', 'ziglang==0.12.1'],
)
```
...
setup(
    ...
    setup_requires=['setuptools-zig>=0.4'],
)
```
