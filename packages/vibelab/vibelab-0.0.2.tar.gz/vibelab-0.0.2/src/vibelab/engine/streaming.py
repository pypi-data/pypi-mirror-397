...
class StreamingLog:
    ...
    def __post_init__(self) -> None:
        result_dir = get_results_dir() / str(self.result_id)
...
def get_streaming_log(result_id: int) -> StreamingLog | None:
...
def stream_log_file(result_id: int, poll_interval: float = 0.5) -> Generator[dict[str, object], None, None]:
    """
...
def cleanup_stream_files(result_id: int) -> None:
