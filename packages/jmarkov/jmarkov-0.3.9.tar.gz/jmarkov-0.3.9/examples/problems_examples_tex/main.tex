...
\chead{}%
\rhead{}%
\lfoot{Ejemplos de cadenas de Markov}%
\cfoot{} %\thepage}%
\rfoot{jmarkov}
...
\subfile{tex_folder/ctmc_rent_bike}
\noindent
\subsection*{Problema 2: Viajero en Europa}
\subfile{tex_folder/dtmc_viajero_europa}
\noindent
\noindent
\subsection*{Problema 3: Elefante del Circo}
\subfile{tex_folder/ctmc_elefante}
\noindent
\subsection*{Problema 4: Zapatos del Runner}
\subfile{tex_folder/dtmc_runner}
\noindent
\subsection*{Problema 5: Autos Eléctricos}
\subfile{tex_folder/ctmc_auto_eléctrico}
\noindent
\subsection*{Problema 6: Bus Rapid Transit}
\subfile{tex_folder/dtmc_brt_rio}
\noindent
