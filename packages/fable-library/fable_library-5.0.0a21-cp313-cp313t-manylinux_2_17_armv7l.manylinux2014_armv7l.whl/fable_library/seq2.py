...
def distinct[T](xs: IEnumerable_1[T], comparer: IEqualityComparer_1[Any]) -> IEnumerable_1[T]:
    def _arrow40(__unit: None = None, xs: Any = xs, comparer: Any = comparer) -> IEnumerable_1[T]:
    ...
    def _arrow46(
        ...
        with get_enumerator(xs) as enumerator:
            while enumerator.System_Collections_IEnumerator_MoveNext():
                ...
                def _arrow43(__unit: None = None) -> int32:
                    return out_arg
        ...
        def _arrow45(key_1: KEY | None = None) -> tuple[KEY, int32]:
    ...
    def _arrow50(
        ...
        with get_enumerator(xs) as enumerator:
            while enumerator.System_Collections_IEnumerator_MoveNext():
                ...
                def _arrow47(__unit: None = None) -> list[T]:
                    return out_arg
        ...
        def _arrow49(key_1: KEY | None = None) -> tuple[KEY, IEnumerable_1[T]]:
            return (key_1, get_item_from_dict(dict_1, key_1))
