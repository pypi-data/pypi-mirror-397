...
class PnmFileService:
    ...
    def upload_file(self, filename: FileName, data: bytes) -> UploadFileResponse:
        ...
        parser = PnmFileTypeObjectFetcher(processor.read_file()).get_parser()
        mac_address = parser.to_model().mac_address
        pnm_file_type: PnmFileType = parser.get_pnm_file_type()
