    ...
    def _add_routes(self) -> None:
        ...
        def get_mac_addresses() -> MacAddressSystemDescriptorResponse:  # noqa: B008
            ...
            **Retrieve All Registered MAC Addresses With Uploaded PNM Files**
            ...
            [API Guide](https://github.com/mgarcia01752/PyPNM/blob/main/docs/api/fast-api/file-manager/file-manager-api.md#1-get-all-registered-mac-addresses-with-pnm-files)
            """
