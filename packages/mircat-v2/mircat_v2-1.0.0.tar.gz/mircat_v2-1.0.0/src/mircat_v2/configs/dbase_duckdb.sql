...
CREATE TABLE IF NOT EXISTS radiomics (
                nifti VARCHAR, series_uid varchar(64), mrn VARCHAR, accession VARCHAR, series_name VARCHAR, series_number INTEGER, scan_date DATE, structure VARCHAR, transformation VARCHAR, feature_class VARCHAR, feature_name VARCHAR, feature_value REAL, PRIMARY KEY (nifti, structure, transformation, feature_class, feature_name)
            );