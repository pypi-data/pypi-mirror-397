...
![Salesforce Toolkit Header](assets/salesforce-toolkit.png)
...
[![PyPI version](https://badge.fury.io/py/salesforce-toolkit.svg)](https://badge.fury.io/py/salesforce-toolkit)
[![Python Version](https://img.shields.io/badge/python-3.8%2B-blue.svg)](https://pypi.org/project/salesforce-toolkit/)
...
```python
from salesforce_toolkit import (
    JWTAuthenticator,
    SalesforceClient,
    FieldMapper,
    SyncPipeline,
...
```python
from salesforce_toolkit import FieldMapper
...
```python
from salesforce_toolkit.logging import ContextLogger, setup_logger
...
```python
from salesforce_toolkit.utils import (
    sanitize_soql,
    build_soql_query,
...
- Portfolio: [Salesforce Toolkit Case Study](https://antoniotrento.net/portfolio/salesforce-toolkit/)
...
![GitHub stars](https://img.shields.io/github/stars/antonio-backend-projects/salesforce-toolkit?style=social)
![GitHub forks](https://img.shields.io/github/forks/antonio-backend-projects/salesforce-toolkit?style=social)
![GitHub issues](https://img.shields.io/github/issues/antonio-backend-projects/salesforce-toolkit/)
![GitHub pull requests](https://img.shields.io/github/issues-pr/antonio-backend-projects/salesforce-toolkit/)
