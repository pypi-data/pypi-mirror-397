...
This example demonstrates how to use the SyncPipeline to synchronize
data from an external source to Salesforce.
"""

from salesforce_toolkit import JWTAuthenticator, SalesforceClient, FieldMapper, SyncPipeline, SyncMode
from salesforce_toolkit.logging import setup_logger

logger = setup_logger("example_sync", console_colors=True)


def main():
    """Demonstrate data synchronization pipeline."""
    print("\n" + "="*80)
