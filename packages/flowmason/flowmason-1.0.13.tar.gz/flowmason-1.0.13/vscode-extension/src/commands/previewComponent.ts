...
export function registerPreviewComponentCommand(
...
function generateJsonSchema(fields: ParsedField[]): object {
...
function mapPythonTypeToJsonType(pythonType: string): string {
