 ...
 */
export type WebSocketEventType = 'connected' | 'subscribed' | 'unsubscribed' | 'error' | 'run_started' | 'run_completed' | 'run_failed' | 'stage_started' | 'stage_completed' | 'stage_failed' | 'execution_paused' | 'execution_resumed' | 'breakpoint_hit' | 'stream_start' | 'token_chunk' | 'stream_end' | 'ping' | 'pong';
/**
 ...
 */
export type WebSocketClientMessageType = 'subscribe' | 'unsubscribe' | 'ping' | 'pause' | 'resume' | 'step' | 'stop';
/**
