...
exports.FlowMasonHoverProvider = void 0;
const vscode = __importStar(require("vscode"));
class FlowMasonHoverProvider {
    constructor() {
    ...
    isWithinMatch(line, position, match) {
        ...
        return [
            ...
            // Field
            {
                ...
                getHover: () => {
                    ...
                    md.appendCodeblock('text: str = Field(description="Input text")\n' +
                        'count: int = Field(default=10, ge=1, le=100)\n' +
                        'items: List[str] = Field(default_factory=list)', 'python');
                    return md;
                }
            },
            // NodeContext
            {
                ...
                getHover: () => {
                    ...
                    md.appendCodeblock('# Generate text\n' +
            ...
            // upstream access
            {
                ...
                getHover: (match) => {
                    ...
                    md.appendCodeblock(`# Access the output object\n` +
                        `output = context.upstream["${stageName}"]\n\n` +
                        `# Access specific field\n` +
                        `value = context.upstream["${stageName}"].field_name`, 'python');
                    return md;
                }
            },
            // LLMConfig
...
exports.FlowMasonHoverProvider = FlowMasonHoverProvider;
