...
class TaegisSDKNotifications2Mutation:
    ...
    def acknowledge_notification(
        ...
        result = self.service.execute_mutation(
            ...
            output=build_output_string(NotificationAcknowledgment),
        )
        if result.get(endpoint) is not None:
    ...
    def create_notification_templates_mapping(
        ...
        result = self.service.execute_mutation(
            ...
            output=build_output_string(NotificationTemplatesMapping),
        )
        if result.get(endpoint) is not None:
    ...
    def create_notification_templates(
        ...
        result = self.service.execute_mutation(
            ...
            output=build_output_string(NotificationTemplate),
        )
        if result.get(endpoint) is not None:
