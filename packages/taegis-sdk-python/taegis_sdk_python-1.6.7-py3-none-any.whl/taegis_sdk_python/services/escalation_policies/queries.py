...
class TaegisSDKEscalationPoliciesQuery:
    ...
    def escalation_policy(
        ...
        result = self.service.execute_query(
            ...
            output=build_output_string(EscalationPolicy),
        )
    ...
    def escalation_policies(
        ...
        result = self.service.execute_query(
            ...
            output=build_output_string(EscalationPolicies),
        )
        if result.get(endpoint) is not None:
    ...
    def walk_escalation_policy(
        ...
        result = self.service.execute_query(
            ...
            output=build_output_string(EscalationPolicyStep),
        )
        if result.get(endpoint) is not None:
    ...
    def contact_method_options(
        ...
        result = self.service.execute_query(
            ...
            output=build_output_string(ContactMethods),
        )
        if result.get(endpoint) is not None:
