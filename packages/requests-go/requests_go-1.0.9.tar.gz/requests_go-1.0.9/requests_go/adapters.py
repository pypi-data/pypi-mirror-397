...
class TLSAdapter(BaseAdapter):
    ...
    Usage::
      ...
      >>> import requests_go
      >>> s = requests.Session()
      >>> tls_config = requests_go.tls_config.TLSConfig()
      >>> a = requests_go.adapters.TLSAdapter(tls_config=tls_config)
      >>> s.mount('https://', a)
    """
    ...
    def init_poolmanager(
        ...
        self.poolmanager.pool_classes_by_scheme = {
            "http": self._pool_factory,
            "https": self._pool_factory,
        }
    ...
    def send(
        ...
        try:
            ...
            raise TLSClientExeption(e, request=request)
