...
DAG_ID = 'filter-image-glue-pyspark-job'

LOGIC_MODULE = 'dwh.jobs.filter_images.filter_images_job_factory'
...
S3_DATA_SOURCE = Variable.get('S3_IMAGE_SOURCE', f's3://{DATA_BUCKET}/images/sink')
S3_DATA_SINK = Variable.get('S3_IMAGE_SINK', f's3://{DATA_BUCKET}/images/filtered')
