...
def parse_xml_action_v02(
    ...
    FN_REGEX_PATTERN = r"<function_never_used_51bce0c785ca2f68081bfa7d91973934=([^>]+)>(.*?)</function_never_used_51bce0c785ca2f68081bfa7d91973934>"
    function_matches = re.finditer(FN_REGEX_PATTERN, content, re.DOTALL)
    funciton_calls = []
    for fn_match in function_matches:
        FN_PARAM_REGEX_PATTERN = r"<parameter_never_used_51bce0c785ca2f68081bfa7d91973934=([^>]+)>(.*?)</parameter_never_used_51bce0c785ca2f68081bfa7d91973934>"
        fn_name = fn_match.group(1)
        fn_body = fn_match.group(2)
        ...
        funciton_calls.append({"name": fn_name, "arguments": arguments})
