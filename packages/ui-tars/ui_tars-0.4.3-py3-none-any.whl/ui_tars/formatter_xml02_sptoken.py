...
if __name__ == "__main__":
    # 测试工具调用
    test_calls = [{"function": {"name": "click", "arguments": {'point': {'x': 539, 'y': '130', 'z': [1, 2, 3]}}}},{"function": {"name": "click", "arguments": {'point': {'x': 539, 'y': '130', 'z': [1, 2, 3]}}}}]

    response = make_assistant_responses(test_calls)
    print(response)
    from action_parser import parse_xml_action_v02
    print(parse_xml_action_v02(response))