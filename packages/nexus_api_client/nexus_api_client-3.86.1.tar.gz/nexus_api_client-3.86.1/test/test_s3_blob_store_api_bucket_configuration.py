...
class TestS3BlobStoreApiBucketConfiguration(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> S3BlobStoreApiBucketConfiguration:
        """Test S3BlobStoreApiBucketConfiguration
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `S3BlobStoreApiBucketConfiguration`
        """
        model = S3BlobStoreApiBucketConfiguration()
        if include_optional:
