...
for idx, N_run in enumerate(N_runs):
    ...
    print(f"[{N_run:3d} Run(s)] Power Avg:    ENoB={result_power['enob']:5.2f}b, SNR={result_power['snr_db']:6.2f}dB, IMD2={result_power['imd2_db']:6.2f}dB, IMD3={result_power['imd3_db']:6.2f}dB")
