"""
Experiment G03: Sweep Quantization Bits
Analyze how quantization noise floor drops as ADC resolution increases.
Generates 8 plots for bits [2, 4, 6, 8, 10, 12, 14, 16].
"""
...
# 3. Define the Sweep List
# We want exactly 8 plots: 2, 4, 6, 8, 10, 12, 14, 16 bits
...
for idx, n_bits in enumerate(bits_sweep):
    # Generate Signal
    # Note: quant_range must be explicit to define LSB size correctly
    # Range is 0.0 to 1.0 (covering 0.5 +/- 0.49)
