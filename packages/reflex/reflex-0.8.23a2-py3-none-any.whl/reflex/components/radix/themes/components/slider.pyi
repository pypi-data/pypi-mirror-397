...
from reflex.vars.base import Var
on_value_event_spec = (passthrough_event_spec(list[float]), passthrough_event_spec(list[int]))

class Slider(RadixThemesComponent):

    @classmethod
    def create(cls, *children, as_child: Var[bool] | bool | None=None, size: Breakpoints[str, Literal['1', '2', '3']] | Literal['1', '2', '3'] | Var[Breakpoints[str, Literal['1', '2', '3']] | Literal['1', '2', '3']] | None=None, variant: Literal['classic', 'soft', 'surface'] | Var[Literal['classic', 'soft', 'surface']] | None=None, color_scheme: Literal['amber', 'blue', 'bronze', 'brown', 'crimson', 'cyan', 'gold', 'grass', 'gray', 'green', 'indigo', 'iris', 'jade', 'lime', 'mint', 'orange', 'pink', 'plum', 'purple', 'red', 'ruby', 'sky', 'teal', 'tomato', 'violet', 'yellow'] | Var[Literal['amber', 'blue', 'bronze', 'brown', 'crimson', 'cyan', 'gold', 'grass', 'gray', 'green', 'indigo', 'iris', 'jade', 'lime', 'mint', 'orange', 'pink', 'plum', 'purple', 'red', 'ruby', 'sky', 'teal', 'tomato', 'violet', 'yellow']] | None=None, high_contrast: Var[bool] | bool | None=None, radius: Literal['full', 'none', 'small'] | Var[Literal['full', 'none', 'small']] | None=None, default_value: Sequence[float | int] | Var[Sequence[float | int] | float | int] | float | int | None=None, value: Sequence[float | int] | Var[Sequence[float | int]] | None=None, name: Var[str] | str | None=None, width: Var[str | None] | str | None=None, min: Var[float | int] | float | int | None=None, max: Var[float | int] | float | int | None=None, step: Var[float | int] | float | int | None=None, disabled: Var[bool] | bool | None=None, orientation: Literal['horizontal', 'vertical'] | Var[Literal['horizontal', 'vertical']] | None=None, style: Sequence[Mapping[str, Any]] | Mapping[str, Any] | Var[Mapping[str, Any]] | Breakpoints | None=None, key: Any | None=None, id: Any | None=None, ref: Var | None=None, class_name: Any | None=None, custom_attrs: dict[str, Var | Any] | None=None, on_blur: Optional[EventType[()]]=None, on_change: Optional[Union[EventType[()] | EventType[list[float]], EventType[()] | EventType[list[int]]]]=None, on_click: Optional[EventType[()] | EventType[PointerEventInfo]]=None, on_context_menu: Optional[EventType[()] | EventType[PointerEventInfo]]=None, on_double_click: Optional[EventType[()] | EventType[PointerEventInfo]]=None, on_focus: Optional[EventType[()]]=None, on_mount: Optional[EventType[()]]=None, on_mouse_down: Optional[EventType[()]]=None, on_mouse_enter: Optional[EventType[()]]=None, on_mouse_leave: Optional[EventType[()]]=None, on_mouse_move: Optional[EventType[()]]=None, on_mouse_out: Optional[EventType[()]]=None, on_mouse_over: Optional[EventType[()]]=None, on_mouse_up: Optional[EventType[()]]=None, on_scroll: Optional[EventType[()]]=None, on_scroll_end: Optional[EventType[()]]=None, on_unmount: Optional[EventType[()]]=None, on_value_commit: Optional[Union[EventType[()] | EventType[list[float]], EventType[()] | EventType[list[int]]]]=None, **props) -> 'Slider':
