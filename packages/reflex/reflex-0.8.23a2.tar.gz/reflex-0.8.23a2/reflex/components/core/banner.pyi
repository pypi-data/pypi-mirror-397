...
from reflex.components.radix.themes.components.dialog import DialogContent, DialogRoot, DialogTitle
...
connect_errors = Var(_js_expr=CompileVars.CONNECT_ERROR, _var_data=connect_error_var_data)
connection_error = Var(_js_expr="((connectErrors.length > 0) ? connectErrors[connectErrors.length - 1].message : '')", _var_data=connect_error_var_data)
connection_errors_count = Var(_js_expr='connectErrors.length', _var_data=connect_error_var_data)
has_connection_errors = Var(_js_expr='(connectErrors.length > 0)', _var_data=connect_error_var_data).to(BooleanVar)
