...
class DataEditor(NoSSRComponent):
    ...
    @classmethod
    def create(cls, *children, rows: Var[int] | int | None=None, columns: Sequence[dict[str, Any]] | Var[Sequence[dict[str, Any]]] | None=None, data: Sequence[Sequence[Any]] | Var[Sequence[Sequence[Any]]] | None=None, get_cell_content: Var[str] | str | None=None, get_cells_for_selection: Var[bool] | bool | None=None, on_paste: Var[bool] | bool | None=None, draw_focus_ring: Var[bool] | bool | None=None, fixed_shadow_x: Var[bool] | bool | None=None, fixed_shadow_y: Var[bool] | bool | None=None, fill_handle: Var[bool] | bool | None=None, freeze_columns: Var[int] | int | None=None, group_header_height: Var[int] | int | None=None, header_height: Var[int] | int | None=None, max_column_auto_width: Var[int] | int | None=None, max_column_width: Var[int] | int | None=None, min_column_width: Var[int] | int | None=None, row_height: Var[int] | int | None=None, row_markers: Literal['both', 'checkbox', 'clickable-number', 'none', 'number'] | Var[Literal['both', 'checkbox', 'clickable-number', 'none', 'number']] | None=None, row_marker_start_index: Var[int] | int | None=None, row_marker_width: Var[int] | int | None=None, smooth_scroll_x: Var[bool] | bool | None=None, smooth_scroll_y: Var[bool] | bool | None=None, vertical_border: Var[bool] | bool | None=None, column_select: Literal['multi', 'none', 'single'] | Var[Literal['multi', 'none', 'single']] | None=None, prevent_diagonal_scrolling: Var[bool] | bool | None=None, overscroll_x: Var[int] | int | None=None, overscroll_y: Var[int] | int | None=None, scroll_offset_x: Var[int] | int | None=None, scroll_offset_y: Var[int] | int | None=None, theme: DataEditorTheme | Var[DataEditorTheme | dict] | dict | None=None, style: Sequence[Mapping[str, Any]] | Mapping[str, Any] | Var[Mapping[str, Any]] | Breakpoints | None=None, key: Any | None=None, id: Any | None=None, ref: Var | None=None, class_name: Any | None=None, custom_attrs: dict[str, Var | Any] | None=None, on_blur: Optional[EventType[()]]=None, on_cell_activated: Optional[EventType[()] | EventType[tuple[int, int]]]=None, on_cell_clicked: Optional[EventType[()] | EventType[tuple[int, int]]]=None, on_cell_context_menu: Optional[EventType[()] | EventType[tuple[int, int]]]=None, on_cell_edited: Optional[EventType[()] | EventType[tuple[int, int]] | EventType[tuple[int, int], GridCell]]=None, on_click: Optional[EventType[()] | EventType[PointerEventInfo]]=None, on_column_resize: Optional[EventType[()] | EventType[GridColumn] | EventType[GridColumn, int]]=None, on_context_menu: Optional[EventType[()] | EventType[PointerEventInfo]]=None, on_delete: Optional[EventType[()] | EventType[GridSelection]]=None, on_double_click: Optional[EventType[()] | EventType[PointerEventInfo]]=None, on_finished_editing: Optional[EventType[()] | EventType[Union[GridCell, None]] | EventType[Union[GridCell, None], tuple[int, int]]]=None, on_focus: Optional[EventType[()]]=None, on_group_header_clicked: Optional[EventType[()] | EventType[tuple[int, int]] | EventType[tuple[int, int], GridCell]]=None, on_group_header_context_menu: Optional[EventType[()] | EventType[int] | EventType[int, GroupHeaderClickedEventArgs]]=None, on_group_header_renamed: Optional[EventType[()] | EventType[str] | EventType[str, str]]=None, on_header_clicked: Optional[EventType[()] | EventType[tuple[int, int]]]=None, on_header_context_menu: Optional[EventType[()] | EventType[tuple[int, int]]]=None, on_header_menu_click: Optional[EventType[()] | EventType[int] | EventType[int, Rectangle]]=None, on_item_hovered: Optional[EventType[()] | EventType[tuple[int, int]]]=None, on_mount: Optional[EventType[()]]=None, on_mouse_down: Optional[EventType[()]]=None, on_mouse_enter: Optional[EventType[()]]=None, on_mouse_leave: Optional[EventType[()]]=None, on_mouse_move: Optional[EventType[()]]=None, on_mouse_out: Optional[EventType[()]]=None, on_mouse_over: Optional[EventType[()]]=None, on_mouse_up: Optional[EventType[()]]=None, on_row_appended: Optional[EventType[()]]=None, on_scroll: Optional[EventType[()]]=None, on_scroll_end: Optional[EventType[()]]=None, on_selection_cleared: Optional[EventType[()]]=None, on_unmount: Optional[EventType[()]]=None, **props) -> 'DataEditor':
