...
class TextField(ComponentNamespace):
    ...
    @staticmethod
    def __call__(*children, size: Breakpoints[str, Literal['1', '2', '3']] | Literal['1', '2', '3'] | Var[Breakpoints[str, Literal['1', '2', '3']] | Literal['1', '2', '3']] | None=None, variant: Literal['classic', 'soft', 'surface'] | Var[Literal['classic', 'soft', 'surface']] | None=None, color_scheme: Literal['amber', 'blue', 'bronze', 'brown', 'crimson', 'cyan', 'gold', 'grass', 'gray', 'green', 'indigo', 'iris', 'jade', 'lime', 'mint', 'orange', 'pink', 'plum', 'purple', 'red', 'ruby', 'sky', 'teal', 'tomato', 'violet', 'yellow'] | Var[Literal['amber', 'blue', 'bronze', 'brown', 'crimson', 'cyan', 'gold', 'grass', 'gray', 'green', 'indigo', 'iris', 'jade', 'lime', 'mint', 'orange', 'pink', 'plum', 'purple', 'red', 'ruby', 'sky', 'teal', 'tomato', 'violet', 'yellow']] | None=None, radius: Literal['full', 'large', 'medium', 'none', 'small'] | Var[Literal['full', 'large', 'medium', 'none', 'small']] | None=None, auto_complete: Var[bool] | bool | None=None, default_value: Var[str] | str | None=None, disabled: Var[bool] | bool | None=None, max_length: Var[int] | int | None=None, min_length: Var[int] | int | None=None, name: Var[str] | str | None=None, placeholder: Var[str] | str | None=None, read_only: Var[bool] | bool | None=None, required: Var[bool] | bool | None=None, type: Var[str] | str | None=None, value: Var[float | int | str] | float | int | str | None=None, list: Var[str] | str | None=None, accept: Var[str] | str | None=None, alt: Var[str] | str | None=None, auto_focus: Var[bool] | bool | None=None, capture: Literal['environment', 'user'] | Var[Literal['environment', 'user'] | bool] | bool | None=None, checked: Var[bool] | bool | None=None, default_checked: Var[bool] | bool | None=None, form: Var[str] | str | None=None, form_action: Var[str] | str | None=None, form_enc_type: Var[str] | str | None=None, form_method: Var[str] | str | None=None, form_no_validate: Var[bool] | bool | None=None, form_target: Var[str] | str | None=None, max: Var[float | int | str] | float | int | str | None=None, min: Var[float | int | str] | float | int | str | None=None, multiple: Var[bool] | bool | None=None, pattern: Var[str] | str | None=None, src: Var[str] | str | None=None, step: Var[float | int | str] | float | int | str | None=None, style: Sequence[Mapping[str, Any]] | Mapping[str, Any] | Var[Mapping[str, Any]] | Breakpoints | None=None, key: Any | None=None, id: Any | None=None, ref: Var | None=None, class_name: Any | None=None, custom_attrs: dict[str, Var | Any] | None=None, on_blur: Optional[EventType[()] | EventType[str]]=None, on_change: Optional[EventType[()] | EventType[str]]=None, on_click: Optional[EventType[()] | EventType[PointerEventInfo]]=None, on_context_menu: Optional[EventType[()] | EventType[PointerEventInfo]]=None, on_double_click: Optional[EventType[()] | EventType[PointerEventInfo]]=None, on_focus: Optional[EventType[()] | EventType[str]]=None, on_key_down: Optional[EventType[()] | EventType[str] | EventType[str, KeyInputInfo]]=None, on_key_up: Optional[EventType[()] | EventType[str] | EventType[str, KeyInputInfo]]=None, on_mount: Optional[EventType[()]]=None, on_mouse_down: Optional[EventType[()]]=None, on_mouse_enter: Optional[EventType[()]]=None, on_mouse_leave: Optional[EventType[()]]=None, on_mouse_move: Optional[EventType[()]]=None, on_mouse_out: Optional[EventType[()]]=None, on_mouse_over: Optional[EventType[()]]=None, on_mouse_up: Optional[EventType[()]]=None, on_scroll: Optional[EventType[()]]=None, on_scroll_end: Optional[EventType[()]]=None, on_unmount: Optional[EventType[()]]=None, **props) -> 'TextFieldRoot':
        """Create an Input component.
