...
class GetEventsResponse(BaseModel):
    ...
    milestones: Optional[List[Milestone]] = Field(default=None, description="Array of milestones related to the events.")
    cursor: StrictStr = Field(description="Pagination cursor for the next page. Empty if there are no more results.")
    __properties: ClassVar[List[str]] = ["events", "milestones", "cursor"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "events": [EventData.from_dict(_item) for _item in obj["events"]] if obj.get("events") is not None else None,
