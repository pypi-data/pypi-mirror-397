...
class GetQuotesResponse(BaseModel):
    ...
    cursor: Optional[StrictStr] = Field(default=None, description="Cursor for pagination to get the next page of results")
    __properties: ClassVar[List[str]] = ["quotes", "cursor"]
