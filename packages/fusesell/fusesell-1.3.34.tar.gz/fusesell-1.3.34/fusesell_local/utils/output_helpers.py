...
def _render_start_email_drafts(drafts: List[Dict[str, Any]]) -> str:
    """Render drafts in the compact start-sales style."""
    if not drafts:
        return "<div class='muted'>No email drafts generated.</div>"
    ...
    for idx, draft in enumerate(drafts, start=1):
        ...
        iframe_doc = (
            ...
            "<html><head><meta charset='utf-8'>"
            "<style>"
            "body{margin:16px;font-family:'Segoe UI','Helvetica Neue',Arial,sans-serif;color:#0f172a;"
...
def _render_start_sales_process_html(payload: Dict[str, Any], raw_json: str) -> str:
    ...
    draft_html = _render_start_email_drafts(drafts)
    ...
    style = (
        ...
        ".start-preview{margin-top:10px;border:1px solid #e2e8f0;border-radius:10px;overflow:hidden;background:#0f172a0d;}"
        ...
        ".html-iframe{width:100%;min-height:340px;border:1px solid #e2e8f0;border-radius:8px;margin-bottom:16px;}"
