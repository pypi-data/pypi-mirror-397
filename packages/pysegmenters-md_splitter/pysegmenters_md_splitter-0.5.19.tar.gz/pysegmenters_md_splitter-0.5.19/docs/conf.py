...
import pysegmenters_md_splitter


# -- Project information -----------------------------------------------------

project = "pysegmenters_md_splitter"
copyright = "2021, Olivier Terrier"
author = "Olivier Terrier"
version = pysegmenters_md_splitter.__version__
release = pysegmenters_md_splitter.__version__
...
apidoc_module_dir = os.path.dirname(pysegmenters_md_splitter.__file__)
