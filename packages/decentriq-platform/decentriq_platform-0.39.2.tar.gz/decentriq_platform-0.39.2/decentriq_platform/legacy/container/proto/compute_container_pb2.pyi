...
class ContainerWorkerConfiguration(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["configuration", b"configuration", "static", b"static"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["configuration", b"configuration", "static", b"static"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["configuration", b"configuration"]) -> typing.Literal["static"] | None: ...
...
class ProxyConfiguration(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["configuration", b"configuration", "domainAllowlist", b"domainAllowlist", "liberal", b"liberal"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["configuration", b"configuration", "domainAllowlist", b"domainAllowlist", "liberal", b"liberal"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["configuration", b"configuration"]) -> typing.Literal["liberal", "domainAllowlist"] | None: ...
...
class MountPoint(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["dependency", b"dependency", "path", b"path"]) -> None: ...
