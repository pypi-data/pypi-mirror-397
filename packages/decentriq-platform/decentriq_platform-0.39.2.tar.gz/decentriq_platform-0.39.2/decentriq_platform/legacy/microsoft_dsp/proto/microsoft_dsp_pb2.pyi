...
class SegmentInfo(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["code", b"code", "short_name", b"short_name"]) -> None: ...
...
class MicrosoftDspWorkerConfiguration(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["input", b"input", "member_info", b"member_info", "segment_info", b"segment_info"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["input", b"input", "member_info", b"member_info", "segment_info", b"segment_info"]) -> None: ...
