...
class Request(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["deltaRequest", b"deltaRequest", "deltaRequestV2", b"deltaRequestV2", "extensionMessage", b"extensionMessage", "request", b"request"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["deltaRequest", b"deltaRequest", "deltaRequestV2", b"deltaRequestV2", "extensionMessage", b"extensionMessage", "request", b"request"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["request", b"request"]) -> typing.Literal["deltaRequest", "extensionMessage", "deltaRequestV2"] | None: ...
...
class ExtensionMessage(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["name", b"name", "payload", b"payload"]) -> None: ...
...
class Response(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["response", b"response", "successfulResponse", b"successfulResponse", "unsuccessfulResponse", b"unsuccessfulResponse"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["response", b"response", "successfulResponse", b"successfulResponse", "unsuccessfulResponse", b"unsuccessfulResponse"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["response", b"response"]) -> typing.Literal["successfulResponse", "unsuccessfulResponse"] | None: ...
...
class DataNoncePubkey(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["data", b"data", "nonce", b"nonce", "pubkey", b"pubkey"]) -> None: ...
...
class DataNonce(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["data", b"data", "nonce", b"nonce"]) -> None: ...
...
class SealedEncryptedMessage(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["encryptedMessage", b"encryptedMessage"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["encryptedMessage", b"encryptedMessage", "sealingKeyParams", b"sealingKeyParams"]) -> None: ...
...
class EncryptionHeader(google.protobuf.message.Message):
    ...
    * VERSIONING
    ...
    def HasField(self, field_name: typing.Literal["chilyKey", b"chilyKey", "encryptionHeader", b"encryptionHeader"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["chilyKey", b"chilyKey", "encryptionHeader", b"encryptionHeader"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["encryptionHeader", b"encryptionHeader"]) -> typing.Literal["chilyKey"] | None: ...
...
class ChilyKey(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["encryptionNonce", b"encryptionNonce"]) -> None: ...
...
class ChunkHeader(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_untrustedContentSize", b"_untrustedContentSize", "untrustedContentSize", b"untrustedContentSize"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_untrustedContentSize", b"_untrustedContentSize", "extraEntropy", b"extraEntropy", "untrustedChunkContentSizes", b"untrustedChunkContentSizes", "untrustedContentSize", b"untrustedContentSize"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["_untrustedContentSize", b"_untrustedContentSize"]) -> typing.Literal["untrustedContentSize"] | None: ...
