...
class ExistingAnalyticsDcrBuilder:
    ...
    def _construct_computation_node_from_hl_representation(
        ...
        if "scripting" in node_fields:
            ...
            elif "snowflake" in import_connector_kind:
                config = import_connector.kind.root.snowflake
                compute_node_definition = SnowflakeImportConnectorDefinition._from_high_level(
                    name,
                    config,
                    credentials_dependency,
                )
