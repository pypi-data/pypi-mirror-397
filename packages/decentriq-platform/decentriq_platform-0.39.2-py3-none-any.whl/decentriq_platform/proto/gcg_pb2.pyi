...
class UserAuth(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["enclaveEndorsements", b"enclaveEndorsements", "pki", b"pki"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["enclaveEndorsements", b"enclaveEndorsements", "pki", b"pki"]) -> None: ...
...
class Pki(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["certChainPem", b"certChainPem", "idMac", b"idMac", "signature", b"signature"]) -> None: ...
...
class CreateDataRoomRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_dataRoomMetadata", b"_dataRoomMetadata", "_highLevelRepresentation", b"_highLevelRepresentation", "dataRoom", b"dataRoom", "dataRoomMetadata", b"dataRoomMetadata", "highLevelRepresentation", b"highLevelRepresentation"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_dataRoomMetadata", b"_dataRoomMetadata", "_highLevelRepresentation", b"_highLevelRepresentation", "dataRoom", b"dataRoom", "dataRoomMetadata", b"dataRoomMetadata", "highLevelRepresentation", b"highLevelRepresentation"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_dataRoomMetadata", b"_dataRoomMetadata"]) -> typing.Literal["dataRoomMetadata"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_highLevelRepresentation", b"_highLevelRepresentation"]) -> typing.Literal["highLevelRepresentation"] | None: ...
...
class CreateDataRoomResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["create_data_room_response", b"create_data_room_response", "dataRoomId", b"dataRoomId", "dataRoomValidationError", b"dataRoomValidationError"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["create_data_room_response", b"create_data_room_response", "dataRoomId", b"dataRoomId", "dataRoomValidationError", b"dataRoomValidationError"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["create_data_room_response", b"create_data_room_response"]) -> typing.Literal["dataRoomId", "dataRoomValidationError"] | None: ...
...
class DataRoomValidationError(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_attestationSpecificationId", b"_attestationSpecificationId", "_authenticationMethodId", b"_authenticationMethodId", "_computeNodeId", b"_computeNodeId", "_permissionIndex", b"_permissionIndex", "_userPermissionId", b"_userPermissionId", "attestationSpecificationId", b"attestationSpecificationId", "authenticationMethodId", b"authenticationMethodId", "computeNodeId", b"computeNodeId", "permissionIndex", b"permissionIndex", "userPermissionId", b"userPermissionId"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_attestationSpecificationId", b"_attestationSpecificationId", "_authenticationMethodId", b"_authenticationMethodId", "_computeNodeId", b"_computeNodeId", "_permissionIndex", b"_permissionIndex", "_userPermissionId", b"_userPermissionId", "attestationSpecificationId", b"attestationSpecificationId", "authenticationMethodId", b"authenticationMethodId", "computeNodeId", b"computeNodeId", "message", b"message", "permissionIndex", b"permissionIndex", "userPermissionId", b"userPermissionId"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_attestationSpecificationId", b"_attestationSpecificationId"]) -> typing.Literal["attestationSpecificationId"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_authenticationMethodId", b"_authenticationMethodId"]) -> typing.Literal["authenticationMethodId"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_computeNodeId", b"_computeNodeId"]) -> typing.Literal["computeNodeId"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_permissionIndex", b"_permissionIndex"]) -> typing.Literal["permissionIndex"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_userPermissionId", b"_userPermissionId"]) -> typing.Literal["userPermissionId"] | None: ...
...
class PublishDatasetToDataRoomRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["dataRoomId", b"dataRoomId", "datasetHash", b"datasetHash", "encryptionKey", b"encryptionKey", "leafId", b"leafId", "scope", b"scope"]) -> None: ...
...
class ExecuteComputeRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["computeNodeIds", b"computeNodeIds", "dataRoomId", b"dataRoomId", "isDryRun", b"isDryRun", "parameters", b"parameters", "scope", b"scope", "testDatasets", b"testDatasets"]) -> None: ...
...
class ExecuteDevelopmentComputeRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["computeNodeIds", b"computeNodeIds", "configurationCommitId", b"configurationCommitId", "isDryRun", b"isDryRun", "parameters", b"parameters", "scope", b"scope", "testDatasets", b"testDatasets"]) -> None: ...
...
class TestDataset(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["encryptionKey", b"encryptionKey", "manifestHash", b"manifestHash"]) -> None: ...
...
class JobStatusResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["completeComputeNodeIds", b"completeComputeNodeIds"]) -> None: ...
...
class GetResultsRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["computeNodeId", b"computeNodeId", "jobId", b"jobId"]) -> None: ...
...
class RetrieveDataRoomRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["dataRoomId", b"dataRoomId"]) -> None: ...
...
class RetrieveDataRoomResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_highLevelRepresentation", b"_highLevelRepresentation", "dataRoom", b"dataRoom", "highLevelRepresentation", b"highLevelRepresentation"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_highLevelRepresentation", b"_highLevelRepresentation", "commits", b"commits", "dataRoom", b"dataRoom", "highLevelRepresentation", b"highLevelRepresentation"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["_highLevelRepresentation", b"_highLevelRepresentation"]) -> typing.Literal["highLevelRepresentation"] | None: ...
...
class UpdateDataRoomStatusRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["dataRoomId", b"dataRoomId", "status", b"status"]) -> None: ...
...
class PublishedDataset(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["datasetHash", b"datasetHash", "leafId", b"leafId", "timestamp", b"timestamp", "user", b"user"]) -> None: ...
...
class RetrievePublishedDatasetsResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["publishedDatasets", b"publishedDatasets"]) -> None: ...
...
class RemovePublishedDatasetRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["dataRoomId", b"dataRoomId", "leafId", b"leafId"]) -> None: ...
...
class CreateConfigurationCommitRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_highLevelRepresentation", b"_highLevelRepresentation", "commit", b"commit", "highLevelRepresentation", b"highLevelRepresentation"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_highLevelRepresentation", b"_highLevelRepresentation", "commit", b"commit", "highLevelRepresentation", b"highLevelRepresentation"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["_highLevelRepresentation", b"_highLevelRepresentation"]) -> typing.Literal["highLevelRepresentation"] | None: ...
...
class CreateConfigurationCommitResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["commitId", b"commitId"]) -> None: ...
...
class MergeConfigurationCommitRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_newDataRoomHighLevelRepresentation", b"_newDataRoomHighLevelRepresentation", "newDataRoomHighLevelRepresentation", b"newDataRoomHighLevelRepresentation"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_newDataRoomHighLevelRepresentation", b"_newDataRoomHighLevelRepresentation", "approvalSignatures", b"approvalSignatures", "commitId", b"commitId", "newDataRoomHighLevelRepresentation", b"newDataRoomHighLevelRepresentation"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["_newDataRoomHighLevelRepresentation", b"_newDataRoomHighLevelRepresentation"]) -> typing.Literal["newDataRoomHighLevelRepresentation"] | None: ...
...
class RetrieveCurrentDataRoomConfigurationResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["configuration", b"configuration", "pin", b"pin"]) -> None: ...
...
class RetrieveConfigurationCommitApproversResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["approvers", b"approvers"]) -> None: ...
...
class CasAuxiliaryStateRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["_value", b"_value", "dataRoomId", b"dataRoomId", "index", b"index", "value", b"value"]) -> None: ...
...
class CasAuxiliaryStateResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_value", b"_value", "value", b"value"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_value", b"_value", "index", b"index", "success", b"success", "value", b"value"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["_value", b"_value"]) -> typing.Literal["value"] | None: ...
...
class AuxiliaryStateValue(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["index", b"index", "user", b"user", "value", b"value"]) -> None: ...
...
class DriverTaskConfig(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["driver_task_config", b"driver_task_config", "noop", b"noop", "staticContent", b"staticContent"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["driver_task_config", b"driver_task_config", "noop", b"noop", "staticContent", b"staticContent"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["driver_task_config", b"driver_task_config"]) -> typing.Literal["noop", "staticContent"] | None: ...
...
class RetrieveUsedAirlockQuotaResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["airlockQuotas", b"airlockQuotas"]) -> None: ...
...
class AirlockQuotaInfo(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["airlockNodeId", b"airlockNodeId", "quotaBytes", b"quotaBytes", "usedQuotaBytes", b"usedQuotaBytes"]) -> None: ...
...
class GetResultsSizeResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["sizeBytes", b"sizeBytes"]) -> None: ...
...
class GcgRequestV2(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["authenticated", b"authenticated", "request", b"request", "unauthenticated", b"unauthenticated"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["authenticated", b"authenticated", "request", b"request", "unauthenticated", b"unauthenticated"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["request", b"request"]) -> typing.Literal["unauthenticated", "authenticated"] | None: ...
...
class AuthenticatedRequest(google.protobuf.message.Message):
    ...
    RETRIEVERESULTENCRYPTIONKEY_FIELD_NUMBER: builtins.int
    EXPORTRESULTASDATASET_FIELD_NUMBER: builtins.int
    ...
    @property
    def retrieveResultEncryptionKey(self) -> global___RetrieveResultEncryptionKeyRequest: ...
    @property
    def exportResultAsDataset(self) -> global___ExportResultAsDatasetRequest: ...
    def __init__(
        self,
        *,
        accessToken: builtins.str = ...,
        ...
        retrieveResultEncryptionKey: global___RetrieveResultEncryptionKeyRequest | None = ...,
        exportResultAsDataset: global___ExportResultAsDatasetRequest | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["accessToken", b"accessToken", "apiToken", b"apiToken", "createApiToken", b"createApiToken", "createPolicy", b"createPolicy", "dcrAction", b"dcrAction", "deleteApiToken", b"deleteApiToken", "exportResultAsDataset", b"exportResultAsDataset", "getApiTokens", b"getApiTokens", "getVerificationKey", b"getVerificationKey", "request", b"request", "retrieveResultEncryptionKey", b"retrieveResultEncryptionKey", "secretStore", b"secretStore", "token", b"token"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["accessToken", b"accessToken", "apiToken", b"apiToken", "createApiToken", b"createApiToken", "createPolicy", b"createPolicy", "dcrAction", b"dcrAction", "deleteApiToken", b"deleteApiToken", "exportResultAsDataset", b"exportResultAsDataset", "getApiTokens", b"getApiTokens", "getVerificationKey", b"getVerificationKey", "request", b"request", "retrieveResultEncryptionKey", b"retrieveResultEncryptionKey", "secretStore", b"secretStore", "token", b"token"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["request", b"request"]) -> typing.Literal["createPolicy", "secretStore", "getVerificationKey", "dcrAction", "createApiToken", "getApiTokens", "deleteApiToken", "retrieveResultEncryptionKey", "exportResultAsDataset"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["token", b"token"]) -> typing.Literal["accessToken", "apiToken"] | None: ...
...
class AuthenticatedResponse(google.protobuf.message.Message):
    ...
    @property
    def retrieveResultEncryptionKey(self) -> global___RetrieveResultEncryptionKeyResponse: ...
    @property
    def exportResultAsDataset(self) -> global___ExportResultAsDatasetResponse: ...
    def __init__(
        self,
        *,
        ...
        retrieveResultEncryptionKey: global___RetrieveResultEncryptionKeyResponse | None = ...,
        exportResultAsDataset: global___ExportResultAsDatasetResponse | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["createApiToken", b"createApiToken", "createPolicy", b"createPolicy", "dcrAction", b"dcrAction", "deleteApiToken", b"deleteApiToken", "exportResultAsDataset", b"exportResultAsDataset", "getApiTokens", b"getApiTokens", "getVerificationKey", b"getVerificationKey", "response", b"response", "retrieveResultEncryptionKey", b"retrieveResultEncryptionKey", "secretStore", b"secretStore"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["createApiToken", b"createApiToken", "createPolicy", b"createPolicy", "dcrAction", b"dcrAction", "deleteApiToken", b"deleteApiToken", "exportResultAsDataset", b"exportResultAsDataset", "getApiTokens", b"getApiTokens", "getVerificationKey", b"getVerificationKey", "response", b"response", "retrieveResultEncryptionKey", b"retrieveResultEncryptionKey", "secretStore", b"secretStore"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["response", b"response"]) -> typing.Literal["createPolicy", "secretStore", "getVerificationKey", "dcrAction", "createApiToken", "getApiTokens", "deleteApiToken", "retrieveResultEncryptionKey", "exportResultAsDataset"] | None: ...
...
class UnauthenticatedRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["authentication", b"authentication", "request", b"request"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["authentication", b"authentication", "request", b"request"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["request", b"request"]) -> typing.Literal["authentication"] | None: ...
...
class AuthenticationRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["emailFinish", b"emailFinish", "emailStart", b"emailStart", "request", b"request"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["emailFinish", b"emailFinish", "emailStart", b"emailStart", "request", b"request"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["request", b"request"]) -> typing.Literal["emailStart", "emailFinish"] | None: ...
...
class AuthenticationResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["emailFinish", b"emailFinish", "emailStart", b"emailStart", "response", b"response"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["emailFinish", b"emailFinish", "emailStart", b"emailStart", "response", b"response"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["response", b"response"]) -> typing.Literal["emailStart", "emailFinish"] | None: ...
...
class EmailStartAuthenticationResponse(google.protobuf.message.Message):
    ...
    CORRELATIONID_FIELD_NUMBER: builtins.int
    correlationId: builtins.str
    def __init__(
        self,
        *,
        correlationId: builtins.str = ...,
    ) -> None: ...
    def ClearField(self, field_name: typing.Literal["correlationId", b"correlationId"]) -> None: ...
...
class EmailFinishAuthenticationRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["code", b"code", "email", b"email"]) -> None: ...
...
class EmailFinishAuthenticationResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["incorrectCode", b"incorrectCode", "notFound", b"notFound", "response", b"response", "success", b"success"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["incorrectCode", b"incorrectCode", "notFound", b"notFound", "response", b"response", "success", b"success"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["response", b"response"]) -> typing.Literal["incorrectCode", "notFound", "success"] | None: ...
...
class GcgSuccessfulResponseV2(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["authenticated", b"authenticated", "response", b"response", "unauthenticated", b"unauthenticated"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["authenticated", b"authenticated", "response", b"response", "unauthenticated", b"unauthenticated"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["response", b"response"]) -> typing.Literal["unauthenticated", "authenticated"] | None: ...
...
class UnauthenticatedResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["authentication", b"authentication", "response", b"response"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["authentication", b"authentication", "response", b"response"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["response", b"response"]) -> typing.Literal["authentication"] | None: ...
...
class GetVerificationKeyResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["verificationKey", b"verificationKey"]) -> None: ...
...
class CreatePolicyRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_scope", b"_scope", "policy", b"policy", "scope", b"scope"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_scope", b"_scope", "policy", b"policy", "scope", b"scope"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["_scope", b"_scope"]) -> typing.Literal["scope"] | None: ...
...
class CreatePolicyResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["policyId", b"policyId"]) -> None: ...
...
class DcrActionRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["action", b"action", "dataRoomId", b"dataRoomId"]) -> None: ...
...
class GetApiTokenResult(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["name", b"name", "token", b"token"]) -> None: ...
...
@typing.final
class RetrieveResultEncryptionKeyRequest(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor

    JOBID_FIELD_NUMBER: builtins.int
    TASKRESULTHASHHEX_FIELD_NUMBER: builtins.int
    jobId: builtins.str
    taskResultHashHex: builtins.str
    def __init__(
        self,
        *,
        jobId: builtins.str = ...,
    ...
    def ClearField(self, field_name: typing.Literal["jobId", b"jobId", "taskResultHashHex", b"taskResultHashHex"]) -> None: ...

global___RetrieveResultEncryptionKeyRequest = RetrieveResultEncryptionKeyRequest

@typing.final
class RetrieveResultEncryptionKeyResponse(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor

    MANIFESTHASHHEX_FIELD_NUMBER: builtins.int
    ENCRYPTIONKEY_FIELD_NUMBER: builtins.int
    manifestHashHex: builtins.str
    encryptionKey: builtins.bytes
    def __init__(
        self,
        *,
    ...
    def ClearField(self, field_name: typing.Literal["encryptionKey", b"encryptionKey", "manifestHashHex", b"manifestHashHex"]) -> None: ...

global___RetrieveResultEncryptionKeyResponse = RetrieveResultEncryptionKeyResponse

@typing.final
class ExportResultAsDatasetRequest(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
    ...
    @property
    def raw(self) -> global___RawExport: ...
    @property
    def zip(self) -> global___ZipExport: ...
    def __init__(
        self,
        *,
        jobId: builtins.str = ...,
        taskResultHashHex: builtins.str = ...,
        datasetName: builtins.str = ...,
        raw: global___RawExport | None = ...,
        zip: global___ZipExport | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["exportSpecification", b"exportSpecification", "raw", b"raw", "zip", b"zip"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["datasetName", b"datasetName", "exportSpecification", b"exportSpecification", "jobId", b"jobId", "raw", b"raw", "taskResultHashHex", b"taskResultHashHex", "zip", b"zip"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["exportSpecification", b"exportSpecification"]) -> typing.Literal["raw", "zip"] | None: ...

global___ExportResultAsDatasetRequest = ExportResultAsDatasetRequest

@typing.final
class RawExport(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
...
global___RawExport = RawExport

@typing.final
class ZipExport(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
...
global___ZipExport = ZipExport

@typing.final
class ExportResultAsDatasetResponse(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor

    MANIFESTHASHHEX_FIELD_NUMBER: builtins.int
    DATASETID_FIELD_NUMBER: builtins.int
    SECRETID_FIELD_NUMBER: builtins.int
    manifestHashHex: builtins.str
    datasetId: builtins.str
    ...
    def ClearField(self, field_name: typing.Literal["datasetId", b"datasetId", "manifestHashHex", b"manifestHashHex", "secretId", b"secretId"]) -> None: ...

global___ExportResultAsDatasetResponse = ExportResultAsDatasetResponse
