...
class BlockParams:
    ...
    def from_init_params(
        ...
        **kwargs: Any,
        ...
        stage_depths = (
            torch.diff(torch.tensor([d for d, t in enumerate(splits) if t])).int().tolist()
        )
...
class RegNet(nn.Module):
    def __init__(
        ...
        self.channel_counts = block_params.widths
...
def _regnet(
    ...
    model = RegNet(
        block_params, norm_layer=partial(nn.BatchNorm2d, eps=1e-05, momentum=0.1), **kwargs
    )
    if pretrained:
        if arch not in model_urls:
            raise ValueError(f"No checkpoint is available for model type {arch}")
        # Essentially, let rank 0 fetch the model first, which may trigger a download.
        # this prevents multiple processes/nodes from corrupting the cache
        barrier()
        if get_rank() == 0:
...
def regnet_y_400mf(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> RegNet:
    ...
    if pretrained:
        ...
        params = BlockParams.from_init_params(
            depth=14, w_0=32, w_a=27.89, w_m=2.09, group_width=32, se_ratio=0.25, **kwargs
        )
...
def regnet_y_800mf(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> RegNet:
    ...
    if pretrained:
        ...
        params = BlockParams.from_init_params(
            depth=16, w_0=64, w_a=38.84, w_m=2.4, group_width=32, se_ratio=0.25, **kwargs
        )
...
def regnet_y_1_6gf(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> RegNet:
    ...
    if pretrained:
        ...
        params = BlockParams.from_init_params(
            depth=27, w_0=64, w_a=26.71, w_m=2.65, group_width=32, se_ratio=0.25, **kwargs
        )
...
def regnet_y_3_2gf(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> RegNet:
    ...
    if pretrained:
        ...
        params = BlockParams.from_init_params(
            depth=21, w_0=64, w_a=42.63, w_m=2.66, group_width=32, se_ratio=0.25, **kwargs
        )
...
def regnet_y_8gf(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> RegNet:
    ...
    params = BlockParams.from_init_params(
        ...
        w_a=76.82,
        w_m=2.19,
        group_width=56 if pretrained else 64,
        se_ratio=0.25,
        **kwargs,
    )
...
def regnet_x_400mf(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> RegNet:
    ...
    if pretrained:
        ...
        params = BlockParams.from_init_params(
            depth=22, w_0=32, w_a=24.48, w_m=2.54, group_width=32, **kwargs
        )
...
def regnet_x_800mf(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> RegNet:
    ...
    if pretrained:
        ...
        params = BlockParams.from_init_params(
            depth=16, w_0=64, w_a=35.73, w_m=2.28, group_width=32, **kwargs
        )
...
def regnet_x_1_6gf(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> RegNet:
    ...
    if pretrained:
        ...
        params = BlockParams.from_init_params(
            depth=18, w_0=64, w_a=34.01, w_m=2.25, group_width=32, **kwargs
        )
...
def regnet_x_3_2gf(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> RegNet:
    ...
    if pretrained:
        ...
        params = BlockParams.from_init_params(
            depth=25, w_0=64, w_a=26.31, w_m=2.25, group_width=64, **kwargs
        )
...
def regnet_x_8gf(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> RegNet:
    ...
    if pretrained:
        ...
        params = BlockParams.from_init_params(
            depth=23, w_0=64, w_a=49.56, w_m=2.88, group_width=96, **kwargs
        )
