...
# Option A: Pass directory path directly
...
# Option B: Pass existing dataset object
dataset = carlib.CARDataset("/path/to/car/files", modality="audio", cache_in_memory=True)
loader = carlib.CARLoader(dataset, batch_size=32, shuffle=True, num_workers=4)
