...
class HitsMetadataHitsInner(_message.Message):
    __slots__ = ("x_type", "x_index", "x_id", "x_score", "x_explanation", "fields", "highlight", "inner_hits", "matched_queries", "x_nested", "x_ignored", "ignored_field_values", "x_shard", "x_node", "x_routing", "x_source", "x_seq_no", "x_primary_term", "x_version", "sort", "meta_fields")
