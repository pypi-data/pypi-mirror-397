...
class MLP(nn.Sequential):
    ...
    """
    def __init__(self, in_channels: int, hidden_channels: list[int], norm_layer: Callable[..., nn.Module] | None = None, activation_layer: Callable[..., nn.Module] | None = ..., inplace: bool | None = None, bias: bool = True, dropout: float = 0.0) -> None: ...
...
class SwinTransformerBlock(nn.Module):
    ...
    norm2: Incomplete
    mlp: Incomplete
    def __init__(self, dim: int, num_heads: int, window_size: list[int], shift_size: list[int], mlp_ratio: float = 4.0, dropout: float = 0.0, attention_dropout: float = 0.0, stochastic_depth_prob: float = 0.0, norm_layer: Callable[..., nn.Module] = ..., attn_layer: Callable[..., nn.Module] = ...) -> None: ...
    def forward(self, x: Tensor): ...
...
class SwinTransformer(nn.Module):
    ...
    flatten: Incomplete
    head: Incomplete
    def __init__(self, patch_size: list[int], embed_dim: int, depths: list[int], num_heads: list[int], window_size: list[int], mlp_ratio: float = 4.0, dropout: float = 0.0, attention_dropout: float = 0.0, stochastic_depth_prob: float = 0.1, num_classes: int = 1000, norm_layer: Callable[..., nn.Module] | None = None, block: Callable[..., nn.Module] | None = None, downsample_layer: Callable[..., nn.Module] = ..., feat_dim: int = 16) -> None: ...
    def forward(self, x): ...
