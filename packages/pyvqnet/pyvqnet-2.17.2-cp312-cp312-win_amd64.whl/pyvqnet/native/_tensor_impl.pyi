...
from .utils import maybe_wrap_dim as maybe_wrap_dim, maybe_wrap_dim_unsqueeze as maybe_wrap_dim_unsqueeze
...
class VQNet_Native_Impl_Backend:
    ...
    def shallow_copy_raw_data(self, other) -> None:
        """
        equal to self.data = other.data,self.data will be reference to other.data without autgorad infos.
        """
    @staticmethod
    def toCPU(self):
        """
        move internal data into cpu inplace.
        """
    to_cpu = toCPU
    @staticmethod
    def GPU(self, device=...): ...
    ...
    def isposinf(t): ...
    @staticmethod
    def masked_fill_(self, mask, value: float | int | complex): ...
    @staticmethod
    ...
    mp2d_forward = mp1d_forward
    ap1d_forward = mp1d_forward
    ap2d_forward = mp1d_forward
    @staticmethod
    ...
    @staticmethod
    def loss_forward(self, target, output): ...
    mse_forward = loss_forward
    cce_forward = mse_forward
    nll_loss_forward = mse_forward
    bce_forward = mse_forward
    cce_forward = mse_forward
    sce_forward = mse_forward
    @staticmethod
...
def linear_fw(_linear, x, weights, bias): ...
