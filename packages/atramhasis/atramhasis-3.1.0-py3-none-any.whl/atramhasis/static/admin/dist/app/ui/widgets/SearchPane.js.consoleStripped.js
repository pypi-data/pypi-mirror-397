...
define("app/ui/widgets/SearchPane", [
  ...
  return declare([_WidgetBase, _TemplatedMixin], {
    ...
    reload: function () {
       0 && console.debug('SearchPane::reload');
    ...
    _editProviders: function () {
       0 && console.debug('SearchPane::_editProviders');
