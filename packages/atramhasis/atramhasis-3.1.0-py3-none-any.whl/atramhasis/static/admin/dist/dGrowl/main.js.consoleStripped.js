require({cache:{
'url:dGrowl/main.html':"<div id=\"${id}\" class=\"dGrowl-main\">\n\t<ul data-dojo-attach-point=\"channelsN\"></ul>\n</div>\n"}});
define("dGrowl/main", [ "dojo/text", "dojo/_base/declare", "dijit/_WidgetBase", "dijit/_TemplatedMixin", "dojo/topic", "dojo/dom-construct", "dGrowl/NotificationNode", "dojo/query", "dojo/_base/lang", "dojo/dom-class", "dojo/text!./main.html"],
