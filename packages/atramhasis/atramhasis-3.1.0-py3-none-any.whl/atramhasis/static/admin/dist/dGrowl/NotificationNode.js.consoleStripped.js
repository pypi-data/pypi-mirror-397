require({cache:{
'url:dGrowl/NotificationNode.html':"<div id=\"${id}\" class=\"dGrowl-notification dGrowl-notification-${channel} ${stickyClass}\">\n\t<a href=\"#x\" class=\"dGrowl-close-btn\" data-dojo-attach-event=\"onclick:killme\">x</a>\n\t<span class=\"dGrowl-header\"><span class=\"dGrowl-title\">${!title}</span></span>\n\t<div class=\"dGrowl-message\">${!message}</div>\n</div>\n"}});
define("dGrowl/NotificationNode", [ "dojo/text", "dojo/_base/declare", "dijit/_WidgetBase", "dijit/_TemplatedMixin", "dojo/dom-construct", "dGrowl/NotificationNode", "dojo/dom-class", "dojo/_base/event", "dojo/_base/lang", "dojo/text!./NotificationNode.html"],
