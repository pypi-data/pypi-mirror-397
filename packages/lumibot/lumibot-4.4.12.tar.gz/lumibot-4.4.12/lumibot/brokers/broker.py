...
class Broker(ABC):
    ...
    def get_quote(self, asset: Asset, quote: Asset = None, exchange: str = None) -> Quote:
        ...
        """
        # Use keyword arguments to tolerate data sources that extend the signature (e.g. ThetaData backtesting).
        return self.data_source.get_quote(asset, quote=quote, exchange=exchange)
