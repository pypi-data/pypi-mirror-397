...
from ..proto import serving_pb2 as pb_serving
    ...
    **Using the Client:**
    ...
    def __create_provider(name, config, function, description, team, tags, properties):
        return Provider(
            ...
            team=team,
            config=config,
            tags=list(tags.tag) or [],
            properties=dict(properties.property.items()) or {},
        )
    ...
    def materialize_feature_view(
        ...
        **Example:**
        ...
        return feature_view._materialize(self._stub, use_super_admin_delete_override)
    ...
    def get_feature_view(self, name):
        ...
        """
        return FeatureView.get_by_name(self._stub, name)

    def get_stream_channel(self, name):
        """
        Get a stream channel by name.

        Args:
            name (str): The name of the stream channel.

        Returns:
            StreamChannel: The stream channel.
        """
        return StreamChannel.get(self._stub, name)
