...
mcp = FastMCP(
    name="mai-tai-mcp",
    instructions=(
        "MCP server for mai-tai, an AI agent collaboration platform. "
        "Use this to ask questions to humans when you need clarification, "
        "decisions, or information you don't have access to. "
        "The ask_human tool is the primary way to escalate questions."
    ),
)
