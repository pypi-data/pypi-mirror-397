...
| `MAI_TAI_PROJECT_ID` | Your project ID (optional) | `df944ea7-...` |

> **Note:** `MAI_TAI_SERVER` is also supported as an alias for `MAI_TAI_API_URL` for backwards compatibility.
...
```bash
MAI_TAI_API_KEY="your-key" MAI_TAI_SERVER="http://localhost:8000" \
