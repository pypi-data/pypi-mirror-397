...
Special parameter names (`input`, `reference`, `metadata`, `trace_data`, `latency`) auto-populate context fields. For other parameters, include them in the function signature.
