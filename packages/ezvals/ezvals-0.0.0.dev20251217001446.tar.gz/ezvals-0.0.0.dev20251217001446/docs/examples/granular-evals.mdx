...
Sometimes you can't parametrize. Each test case has unique logic—different ways of deriving ground truth, different validation. EZVals handles this naturally.
