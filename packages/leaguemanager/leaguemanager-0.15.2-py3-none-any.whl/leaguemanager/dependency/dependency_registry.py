...
class LeagueManager:
    ...
    Attributes:
        registry (Registry | None): An `svcs` Registry for managing services.
        loader (DynamicObjectLoader): A DynamicObjectLoader for loading specific objects.
        local_services_dir (Path): The root directory where any "services" can be found.
        ...
        sync_config (SQLAlchemySyncConfigT): Sync database configuration
    ...
    Example:
        ...
        ...     data
        ... )  # Create a new season (data is a dict with season details)
    ...
    async_config: SQLAlchemyAsyncConfigT = field(default=async_config)
    sync_config: SQLAlchemySyncConfigT = field(default=sync_config)
    ...
    def __attrs_post_init__(self):
        ...
        # Register db configs (using Advanced Alchemy configs)
        ...
        # Register session makers
        self.register_session_maker()
        self.register_async_session_maker()

        # Register importer and scheduler services
        ...
        # Register Advanced Alchemy db services
    ...
    # Use the `svcs` Container to provide objects registered above
