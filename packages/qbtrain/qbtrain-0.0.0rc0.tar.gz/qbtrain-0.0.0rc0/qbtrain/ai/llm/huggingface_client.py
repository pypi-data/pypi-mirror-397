...
from typing import Any, Deque, Dict, Generator, List, Optional, TYPE_CHECKING, Type
...
def _lazy_import_hfhub():
    # huggingface_hub is heavy; import only when needed
    return importlib.import_module("huggingface_hub")


def _lazy_import_transformers():
    # transformers is heavy; import only when needed
...
class HuggingFaceClient(LLMClient):
    ...
    param_display_names = {"models_dir": "Models Directory"}
    ...
    # Optional: kick off imports/model warmup after startup without blocking
        ...
        def _warm():
            ...
            if preload_model:
                try:
                    ...
                    # ignore if model isn't present yet
                    pass
