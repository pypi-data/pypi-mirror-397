...
from hestia_earth.utils.date import TimeUnit, diff_in, is_in_days
...
def validate_cycleDuration(cycle: dict):
    ...
    in days.
    """
    duration = diff_in(cycle.get("startDate"), cycle.get("endDate"), TimeUnit.DAY)
...
def validate_maximum_cycleDuration(cycle: dict):
    ...
    duration = diff_in(startDate, endDate, TimeUnit.DAY) if use_dates else cycleDuration
