...
TEMPLATE_PARAMS = {
    ...
    "features": ['smr_vsa4', 'tpsa', 'numhdonors', 'nhohcount', 'nbase', 'vsa_estate3', 'mollogp', 'smr_vsa3', 'peoe_vsa8', 'xc_4d', 'charge_centroid_distance', 'xc_4dv', 'vsa_estate4', 'peoe_vsa1', 'fr_imine', 'estate_vsa9', 'mi', 'molecular_volume_3d', 'fr_guanido', 'slogp_vsa2', 'nitrogen_span', 'slogp_vsa1', 'hba_hbd_ratio', 'asphericity', 'axp_5d', 'axp_0dv', 'estate_vsa4', 'vsa_estate2', 'molecular_axis_length', 'numsaturatedheterocycles', 'xc_3dv', 'minpartialcharge', 'axp_1d', 'chi1v', 'peoe_vsa10', 'fr_imidazole', 'fpdensitymorgan2', 'c3sp3', 'estate_vsa2', 'bcut2d_mrlow', 'kappa3', 'smr_vsa6', 'estate_vsa10', 'minabsestateindex', 'bcut2d_mwhi', 'tertiary_amine_count', 'maxestateindex', 'bcut2d_mrhi', 'molmr', 'qed', 'num_s_centers', 'vsa_estate6', 'peoe_vsa2', 'xp_4d', 'hallkieralpha', 'amphiphilic_moment', 'bcut2d_logplow', 'vsa_estate5', 'vsa_estate8', 'xp_1dv', 'vsa_estate7', 'mm', 'smr_vsa5', 'phi', 'amide_count', 'bcut2d_mwlow', 'bcut2d_chglo', 'xp_6d', 'slogp_vsa5', 'chi0n', 'xp_5d', 'axp_2d', 'xpc_5d', 'molecular_asymmetry', 'type_ii_pattern_count', 'smr_vsa1', 'axp_7d', 'xp_2d', 'estate_vsa3', 'xch_7d', 'xp_0dv', 'xc_5dv', 'mp', 'xp_7d', 'slogp_vsa4', 'axp_3d', 'maxabsestateindex', 'kappa2', 'numatomstereocenters', 'axp_7dv', 'chi3n', 'peoe_vsa9', 'axp_1dv', 'axp_3dv', 'maxabspartialcharge', 'vsa_estate9', 'mz', 'peoe_vsa7', 'axp_5dv', 'aromatic_interaction_score', 'axp_0d', 'xp_6dv', 'axp_2dv', 'fpdensitymorgan1', 'radius_of_gyration', 'xpc_4d', 'balabanj', 'xp_3d', 'estate_vsa1', 'sse', 'type_i_pattern_count', 'chi0', 'fr_al_oh', 'fr_ar_n', 'fpdensitymorgan3', 'estate_vsa8', 'xp_7dv', 'axp_6dv', 'slogp_vsa7', 'mv', 'axp_6d', 'peoe_vsa11', 'slogp_vsa3', 'numheterocycles', 'sp', 'estate_vsa6', 'numaromaticheterocycles', 'vsa_estate10', 'xch_4dv', 'chi2v', 'estate_vsa5', 'xp_5dv', 'kappa1', 'peoe_vsa3', 'bcut2d_chghi', 'bcut2d_logphi', 'smr_vsa10', 'axp_4dv', 'xch_7dv', 'chi4v', 'mare', 'xch_6dv', 'axp_4d', 'chi4n', 'smr_vsa9', 'mse', 'peoe_vsa6', 'sv', 'xp_2dv', 'xpc_4dv', 'estate_vsa7', 'smr_vsa7', 'bertzct', 'vsa_estate1', 'si', 'fractioncsp3', 'c1sp3', 'slogp_vsa6', 'sps', 'chi1', 'maxpartialcharge', 'xc_3d', 'minestateindex', 'avgipc', 'xpc_6d', 'xch_5dv', 'slogp_vsa10', 'hybratio', 'xc_5d', 'minabspartialcharge', 'c3sp2', 'mpe', 'fr_methoxy', 'spe', 'xpc_6dv', 'fr_hoccn', 'xch_5d', 'heavyatommolwt', 'c2sp3', 'xch_6d', 'num_r_centers', 'fr_ether', 'xpc_5dv', 'frac_defined_stereo', 'fr_nh0', 'xp_4dv', 'intramolecular_hbond_potential', 'xch_4d', 'xp_1d', 'peoe_vsa13', 'xc_6dv', 'chi1n', 'chi2n', 'xc_6d', 'c1sp2', 'c2sp2', 'num_stereocenters', 'chi3v', 'labuteasa', 'peoe_vsa12', 'numrotatablebonds', 'chi0v', 'numhacceptors', 'exactmolwt', 'fr_piperdine', 'sare', 'fr_aniline', 'numheteroatoms', 'naromatom', 'molwt', 'xch_3d', 'fr_urea', 'peoe_vsa4', 'fr_nh1', 'stereo_complexity', 'slogp_vsa11', 'fr_pyridine', 'xp_3dv', 'fr_amide', 'fr_nitrile', 'fcsp3', 'fr_al_oh_notert', 'fr_halogen', 'nocount', 'fr_ar_nh', 'xp_0d', 'fr_nhpyrrole', 'smr_vsa2', 'fr_ndealkylation2', 'numaliphaticheterocycles', 'numamidebonds', 'fr_aryl_methyl', 'numsaturatedrings', 'sm', 'slogp_vsa8', 'fr_thiazole', 'nacid', 'sz', 'num_defined_stereocenters', 'peoe_vsa5', 'fr_piperzine', 'numaromaticrings', 'fr_benzene', 'fr_oxazole', 'numvalenceelectrons', 'fr_sulfonamd', 'fr_ketone', 'numunspecifiedatomstereocenters'],
...
if __name__ == "__main__":
    ...
    if model_type == "classifier":
        ...
        # Add UQ columns to validation predictions
        ...
        # Add UQ columns to output
        uq_cols = [c for c in df_val.columns if c.startswith("q_") or c == "confidence"]
        output_columns += uq_cols
