...
class TunableFloat(BaseModel):
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['tunable_float']):
            raise ValueError("must be one of enum values ('tunable_float')")
        return value
    ...
    def scale_validate_enum(cls, value):
        ...
        if value not in set(['linear', 'log']):
            raise ValueError("must be one of enum values ('linear', 'log')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TunableFloat from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TunableFloat from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "type": obj.get("type") if obj.get("type") is not None else 'tunable_float',
            "min": obj.get("min"),
            "max": obj.get("max"),
            "scale": obj.get("scale")
        })
