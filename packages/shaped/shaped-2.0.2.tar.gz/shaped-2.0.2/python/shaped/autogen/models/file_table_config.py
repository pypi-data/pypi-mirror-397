...
class FileTableConfig(BaseModel):
    """
    Table config that reads data from a file path (e.g., S3, local file). Used for file-based connectors that need to be converted to table configs.
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default='file', description="Type discriminator for file-based config.")
    path: StrictStr = Field(description="File path (e.g., S3 URI or local path).")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FileTableConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FileTableConfig from a dict"""
        if obj is None:
            return None
