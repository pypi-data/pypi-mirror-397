...
class RecreateRollout(BaseModel):
    """
    RecreateRollout
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default='recreate', description="Rollout type discriminator.")
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['recreate']):
            raise ValueError("must be one of enum values ('recreate')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RecreateRollout from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RecreateRollout from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "type": obj.get("type") if obj.get("type") is not None else 'recreate'
        })
        return _obj
