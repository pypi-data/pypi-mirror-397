...
class DeploymentConfig(BaseModel):
    ...
    server: Optional[ServerConfig] = Field(default=None, description="Inference server process configuration.")
    ...
    __properties: ClassVar[List[str]] = ["data_tier", "rollout", "autoscaling", "server", "pagination", "online_store"]
