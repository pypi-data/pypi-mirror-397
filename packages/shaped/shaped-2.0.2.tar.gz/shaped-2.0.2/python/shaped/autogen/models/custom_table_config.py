...
class CustomTableConfig(BaseModel):
    ...
    CustomTableConfig
    """ # noqa: E501
    schema_type: Optional[StrictStr] = Field(default='CUSTOM', description="Schema type discriminator for custom datasets.")
    name: StrictStr = Field(description="Unique identifier for the custom dataset.")
    description: Optional[StrictStr] = None
    unique_keys: Optional[List[StrictStr]] = None
    s3_path: Optional[StrictStr] = None
    s3_format: Optional[StrictStr] = None
    column_schema: Optional[Dict[str, ValueType]] = None
    __properties: ClassVar[List[str]] = ["schema_type", "name", "description", "unique_keys", "s3_path", "s3_format", "column_schema"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CustomTableConfig from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if s3_path (nullable) is None
        # and model_fields_set contains the field
        if self.s3_path is None and "s3_path" in self.model_fields_set:
            _dict['s3_path'] = None

        # set to None if s3_format (nullable) is None
        # and model_fields_set contains the field
        if self.s3_format is None and "s3_format" in self.model_fields_set:
            _dict['s3_format'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CustomTableConfig from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "schema_type": obj.get("schema_type") if obj.get("schema_type") is not None else 'CUSTOM',
            "name": obj.get("name"),
            "description": obj.get("description"),
            "unique_keys": obj.get("unique_keys"),
            "s3_path": obj.get("s3_path"),
            "s3_format": obj.get("s3_format"),
