...
class ListEnginesResponse(BaseModel):
    ...
    ListEnginesResponse
    """ # noqa: E501
    engines: List[Engine] = Field(description="List of engines and their metadata.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListEnginesResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListEnginesResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "engines": [Engine.from_dict(_item) for _item in obj["engines"]] if obj.get("engines") is not None else None
        })
        return _obj
