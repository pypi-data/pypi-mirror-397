...
class InteractionConfig(BaseModel):
    ...
    InteractionConfig
    """ # noqa: E501
    label: Label = Field(description="Label definition for interaction outcomes.")
    created_at: StrictStr = Field(description="Column name for the interaction timestamp.")
    session_id: Optional[StrictStr] = None
    interaction_id: Optional[StrictStr] = None
    features: Optional[List[Feature]] = None
    __properties: ClassVar[List[str]] = ["label", "created_at", "session_id", "interaction_id", "features"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InteractionConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InteractionConfig from a dict"""
        if obj is None:
            return None
