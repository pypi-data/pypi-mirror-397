...
class LexicalSearchMode(BaseModel):
    """
    LexicalSearchMode
    """ # noqa: E501
    fuzziness_edit_distance: Optional[StrictInt] = Field(default=1, description="Maximum edit distance for fuzzy text matching.")
    type: Optional[StrictStr] = Field(default='lexical', description="Search mode type discriminator.")
    __properties: ClassVar[List[str]] = ["fuzziness_edit_distance", "type"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['lexical']):
            raise ValueError("must be one of enum values ('lexical')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LexicalSearchMode from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LexicalSearchMode from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "fuzziness_edit_distance": obj.get("fuzziness_edit_distance") if obj.get("fuzziness_edit_distance") is not None else 1,
            "type": obj.get("type") if obj.get("type") is not None else 'lexical'
        })
        return _obj
