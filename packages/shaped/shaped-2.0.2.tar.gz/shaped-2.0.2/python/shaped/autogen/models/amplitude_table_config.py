...
class AmplitudeTableConfig(BaseModel):
    """
    AmplitudeTableConfig
    """ # noqa: E501
    schema_type: Optional[StrictStr] = Field(default='AMPLITUDE', description="Schema type discriminator for Amplitude datasets.")
    name: StrictStr = Field(description="Unique identifier for the Amplitude dataset.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AmplitudeTableConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AmplitudeTableConfig from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "schema_type": obj.get("schema_type") if obj.get("schema_type") is not None else 'AMPLITUDE',
            "name": obj.get("name"),
