...
class ParameterDefinition(BaseModel):
    """
    Defines a single parameter that can be passed to an endpoint. These parameters are templates that can be passed into any of the configuration of the query pipeline.
    """ # noqa: E501
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "default": Default.from_dict(obj["default"]) if obj.get("default") is not None else None
        })
        return _obj
