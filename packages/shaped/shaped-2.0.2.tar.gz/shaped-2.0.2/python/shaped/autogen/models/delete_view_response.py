...
class DeleteViewResponse(BaseModel):
    ...
    DeleteViewResponse
    """ # noqa: E501
    message: StrictStr = Field(description="Confirmation message indicating view deletion status.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeleteViewResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeleteViewResponse from a dict"""
        if obj is None:
            return None
