...
class AWSPinpointTableConfig(BaseModel):
    """
    AWSPinpointTableConfig
    """ # noqa: E501
    schema_type: Optional[StrictStr] = Field(default='AWS_PINPOINT', description="Schema type discriminator for AWS Pinpoint datasets.")
    name: StrictStr = Field(description="Unique identifier for the AWS Pinpoint dataset.")
    description: Optional[StrictStr] = None
    tenant_aws_account_id: StrictStr = Field(description="AWS account ID for the tenant's Pinpoint instance.")
    __properties: ClassVar[List[str]] = ["schema_type", "name", "description", "tenant_aws_account_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AWSPinpointTableConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AWSPinpointTableConfig from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "schema_type": obj.get("schema_type") if obj.get("schema_type") is not None else 'AWS_PINPOINT',
            "name": obj.get("name"),
