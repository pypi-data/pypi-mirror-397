...
PARAMETERSVALUE_ANY_OF_SCHEMAS = ["List[bool]", "List[float]", "List[int]", "List[str]", "bool", "float", "int", "str"]
...
class ParametersValue(BaseModel):
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in ParametersValue with anyOf schemas: List[bool], List[float], List[int], List[str], bool, float, int, str. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into ParametersValue with anyOf schemas: List[bool], List[float], List[int], List[str], bool, float, int, str. Details: " + ", ".join(error_messages))
        else:
            return instance
