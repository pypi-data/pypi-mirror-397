...
class TunableInt(BaseModel):
    ...
    TunableInt
    """ # noqa: E501
    type: Optional[StrictStr] = 'tunable_int'
    min: StrictInt
    max: StrictInt
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['tunable_int']):
            raise ValueError("must be one of enum values ('tunable_int')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TunableInt from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TunableInt from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "type": obj.get("type") if obj.get("type") is not None else 'tunable_int',
            "min": obj.get("min"),
            "max": obj.get("max"),
            "scale": obj.get("scale")
        })
