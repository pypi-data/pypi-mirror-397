...
class EmbeddingConfig(BaseModel):
    ...
    EmbeddingConfig
    """ # noqa: E501
    name: StrictStr = Field(description="Unique identifier for the embedding.")
    encoder: Encoder
    __properties: ClassVar[List[str]] = ["name", "encoder"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of encoder
        if self.encoder:
            _dict['encoder'] = self.encoder.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "encoder": Encoder.from_dict(obj["encoder"]) if obj.get("encoder") is not None else None
        })
        return _obj
