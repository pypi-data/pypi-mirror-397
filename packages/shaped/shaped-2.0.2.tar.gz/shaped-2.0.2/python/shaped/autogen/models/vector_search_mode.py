...
class VectorSearchMode(BaseModel):
    """
    VectorSearchMode
    """ # noqa: E501
    text_embedding_ref: StrictStr = Field(description="Name of the text embedding to use for vector search.")
    type: Optional[StrictStr] = Field(default='vector', description="Search mode type discriminator.")
    __properties: ClassVar[List[str]] = ["text_embedding_ref", "type"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of VectorSearchMode from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of VectorSearchMode from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "text_embedding_ref": obj.get("text_embedding_ref"),
            "type": obj.get("type") if obj.get("type") is not None else 'vector'
        })
        return _obj
