...
class GlobalFilter(BaseModel):
    """
    A global filter. The source dataset must contain item identifiers.
    """ # noqa: E501
    ...
    type: Optional[StrictStr] = Field(default='global', description="Filter type discriminator.")
    __properties: ClassVar[List[str]] = ["item_id_column", "index_type", "type"]
