...
class TrainingConfig(BaseModel):
    ...
    models: Optional[List[TrainingConfigModelsInner]] = Field(default=None, description="List of scoring policy models to train.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "models": [TrainingConfigModelsInner.from_dict(_item) for _item in obj["models"]] if obj.get("models") is not None else None,
