...
class PrebuiltFilterStep(BaseModel):
    """
    PrebuiltFilterStep
    """ # noqa: E501
    filter_ref: StrictStr = Field(description="Reference to a prebuilt filter (e.g., ref:data.filters:name).")
    name: Optional[StrictStr] = None
    input_user_id: Optional[StrictStr] = None
    type: Optional[StrictStr] = Field(default='prebuilt', description="Filter step type discriminator.")
    __properties: ClassVar[List[str]] = ["filter_ref", "name", "input_user_id", "type"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['prebuilt']):
            raise ValueError("must be one of enum values ('prebuilt')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PrebuiltFilterStep from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PrebuiltFilterStep from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "filter_ref": obj.get("filter_ref"),
            "name": obj.get("name"),
            "input_user_id": obj.get("input_user_id"),
            "type": obj.get("type") if obj.get("type") is not None else 'prebuilt'
        })
        return _obj
