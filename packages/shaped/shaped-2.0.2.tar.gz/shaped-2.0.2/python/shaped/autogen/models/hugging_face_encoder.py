...
class HuggingFaceEncoder(BaseModel):
    """
    An encoder sourced directly from HuggingFace.
    """ # noqa: E501
    model_name: StrictStr = Field(description="HuggingFace model identifier (e.g., sentence-transformers/...).")
    user_fields: Optional[List[StrictStr]] = None
    item_fields: Optional[List[StrictStr]] = None
    type: Optional[StrictStr] = Field(default='hugging_face', description="Encoder type discriminator.")
    __properties: ClassVar[List[str]] = ["model_name", "user_fields", "item_fields", "type"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['hugging_face']):
            raise ValueError("must be one of enum values ('hugging_face')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of HuggingFaceEncoder from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if item_fields (nullable) is None
        # and model_fields_set contains the field
        if self.item_fields is None and "item_fields" in self.model_fields_set:
            _dict['item_fields'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of HuggingFaceEncoder from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "item_fields": obj.get("item_fields"),
            "type": obj.get("type") if obj.get("type") is not None else 'hugging_face'
        })
        return _obj
