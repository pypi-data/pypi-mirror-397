...
class AutoscalingConfig(BaseModel):
    """
    Configuration for horizontally scaling inference pods.
    """ # noqa: E501
    min_replicas: Optional[StrictInt] = Field(default=1, description="Minimum number of inference pod replicas.")
    max_replicas: Optional[StrictInt] = Field(default=20, description="Maximum number of inference pod replicas.")
    policy: Optional[Policy] = None
    __properties: ClassVar[List[str]] = ["min_replicas", "max_replicas", "policy"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "max_replicas": obj.get("max_replicas") if obj.get("max_replicas") is not None else 20,
