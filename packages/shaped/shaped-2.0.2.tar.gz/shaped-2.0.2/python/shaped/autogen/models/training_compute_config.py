...
class TrainingComputeConfig(BaseModel):
    ...
    """ # noqa: E501
    gpu_type: Optional[StrictStr] = Field(default='T4', description="GPU type for training (e.g., T4, A100).")
    ...
    use_kubetorch: Optional[StrictBool] = Field(default=False, description="Whether to use kubetorch for running remote jobs.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "use_kubetorch": obj.get("use_kubetorch") if obj.get("use_kubetorch") is not None else False
        })
        return _obj
