...
class SchemaConfig(BaseModel):
    ...
    SchemaConfig
    """ # noqa: E501
    user: Optional[EntityConfig] = None
    item: Optional[EntityConfig] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "user": EntityConfig.from_dict(obj["user"]) if obj.get("user") is not None else None,
            "item": EntityConfig.from_dict(obj["item"]) if obj.get("item") is not None else None,
            "interaction": InteractionConfig.from_dict(obj["interaction"]) if obj.get("interaction") is not None else None
        })
        return _obj
