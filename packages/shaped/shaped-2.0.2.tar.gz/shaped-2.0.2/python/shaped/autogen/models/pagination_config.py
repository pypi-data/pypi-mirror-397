...
class PaginationConfig(BaseModel):
    """
    Configuration for the pagination store.
    """ # noqa: E501
    page_expiration_in_seconds: Optional[StrictInt] = Field(default=0, description="Time in seconds before pagination state expires. 0 disables pagination.")
    __properties: ClassVar[List[str]] = ["page_expiration_in_seconds"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "page_expiration_in_seconds": obj.get("page_expiration_in_seconds") if obj.get("page_expiration_in_seconds") is not None else 0
        })
        return _obj
