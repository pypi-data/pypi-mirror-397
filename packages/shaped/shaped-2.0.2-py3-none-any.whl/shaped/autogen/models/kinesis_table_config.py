...
class KinesisTableConfig(BaseModel):
    """
    KinesisTableConfig
    """ # noqa: E501
    schema_type: Optional[StrictStr] = Field(default='KINESIS', description="Schema type discriminator for Kinesis datasets.")
    name: StrictStr = Field(description="Unique identifier for the Kinesis dataset.")
    ...
    __properties: ClassVar[List[str]] = ["schema_type", "name", "description", "unique_keys", "column_schema", "tenant_aws_account_id"]
    ...
    def schema_type_validate_enum(cls, value):
        ...
        if value not in set(['KINESIS']):
            raise ValueError("must be one of enum values ('KINESIS')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of KinesisTableConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of KinesisTableConfig from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "schema_type": obj.get("schema_type") if obj.get("schema_type") is not None else 'KINESIS',
            "name": obj.get("name"),
