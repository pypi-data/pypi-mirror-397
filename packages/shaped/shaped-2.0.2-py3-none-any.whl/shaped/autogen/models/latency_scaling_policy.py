...
class LatencyScalingPolicy(BaseModel):
    """
    LatencyScalingPolicy
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default='latency', description="Scaling policy type discriminator.")
    target_seconds: Optional[Union[StrictFloat, StrictInt]] = Field(default=0.5, description="Target latency in seconds for scaling decisions.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["type", "target_seconds"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['latency']):
            raise ValueError("must be one of enum values ('latency')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LatencyScalingPolicy from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LatencyScalingPolicy from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "type": obj.get("type") if obj.get("type") is not None else 'latency',
            "target_seconds": obj.get("target_seconds") if obj.get("target_seconds") is not None else 0.5
        })
