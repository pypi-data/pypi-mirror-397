...
class CandidateIdsRetrieveStep(BaseModel):
    """
    Retrieves a specific list of entity IDs (candidate items for reranking). Useful for reranking scenarios where you want to score/reorder a specific set of items.
    """ # noqa: E501
    item_ids: List[Any] = Field(description="List of entity IDs to retrieve (e.g., ['item1', 'item2', 'item3']).")
    limit: Optional[StrictInt] = None
    name: Optional[StrictStr] = None
    type: Optional[StrictStr] = Field(default='candidate_ids', description="Retrieve step type discriminator.")
    __properties: ClassVar[List[str]] = ["item_ids", "limit", "name", "type"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['candidate_ids']):
            raise ValueError("must be one of enum values ('candidate_ids')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CandidateIdsRetrieveStep from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CandidateIdsRetrieveStep from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "limit": obj.get("limit"),
            "name": obj.get("name"),
            "type": obj.get("type") if obj.get("type") is not None else 'candidate_ids'
        })
        return _obj
