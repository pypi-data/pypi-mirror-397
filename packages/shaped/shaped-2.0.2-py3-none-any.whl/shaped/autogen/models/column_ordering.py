...
class ColumnOrdering(BaseModel):
    """
    ColumnOrdering
    """ # noqa: E501
    name: StrictStr = Field(description="Column name to order by.")
    ascending: Optional[StrictBool] = Field(default=True, description="Whether to sort in ascending order.")
    nulls_first: Optional[StrictBool] = Field(default=False, description="Whether to place null values first.")
    __properties: ClassVar[List[str]] = ["name", "ascending", "nulls_first"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ColumnOrdering from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ColumnOrdering from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "nulls_first": obj.get("nulls_first") if obj.get("nulls_first") is not None else False
        })
        return _obj
