...
class TunableBool(BaseModel):
    """
    TunableBool
    """ # noqa: E501
    type: Optional[StrictStr] = 'tunable_bool'
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['tunable_bool']):
            raise ValueError("must be one of enum values ('tunable_bool')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TunableBool from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TunableBool from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "type": obj.get("type") if obj.get("type") is not None else 'tunable_bool'
        })
        return _obj
