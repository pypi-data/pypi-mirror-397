...
class StepExplanation(BaseModel):
    """
    Explanation for a single pipeline step.
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["step_name", "step_type", "input_count", "output_count", "filtered_count", "execution_time_ms", "metadata"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StepExplanation from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StepExplanation from a dict"""
        if obj is None:
            return None
