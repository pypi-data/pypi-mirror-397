...
HIDDENSIZE1_ANY_OF_SCHEMAS = ["TunableIntCategorical", "int"]

class HiddenSize1(BaseModel):
    """
    Size of the hidden layers in the transformer.
    """
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = HiddenSize1.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in HiddenSize1 with anyOf schemas: TunableIntCategorical, int. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into HiddenSize1 with anyOf schemas: TunableIntCategorical, int. Details: " + ", ".join(error_messages))
        else:
            return instance
