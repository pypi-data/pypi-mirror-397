...
BM25_ANY_OF_SCHEMAS = ["TunableBool", "bool"]

class Bm25(BaseModel):
    """
    Whether to use BM25 weighting scheme.
    """
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in Bm25 with anyOf schemas: TunableBool, bool. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into Bm25 with anyOf schemas: TunableBool, bool. Details: " + ", ".join(error_messages))
        else:
            return instance
