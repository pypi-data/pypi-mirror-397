...
class SegmentTableConfig(BaseModel):
    """
    SegmentTableConfig
    """ # noqa: E501
    schema_type: Optional[StrictStr] = Field(default='SEGMENT', description="Schema type discriminator for Segment datasets.")
    name: StrictStr = Field(description="Unique identifier for the Segment dataset.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SegmentTableConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SegmentTableConfig from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "schema_type": obj.get("schema_type") if obj.get("schema_type") is not None else 'SEGMENT',
            "name": obj.get("name"),
