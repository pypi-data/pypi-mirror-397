...
class UserAttributePoolingEncoder(BaseModel):
    """
    Creates a query vector by encoding the user's attributes. This can only be used with a content or text embedding.  Can optionally provide user features directly via input_user_features, which will be merged with features from input_user_id.
    """ # noqa: E501
    input_user_id: Optional[StrictStr] = None
    input_user_features: Optional[Dict[str, Any]] = None
    type: Optional[StrictStr] = Field(default='user_attribute_pooling', description="Encoder type discriminator.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["input_user_id", "input_user_features", "type"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['user_attribute_pooling']):
            raise ValueError("must be one of enum values ('user_attribute_pooling')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserAttributePoolingEncoder from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserAttributePoolingEncoder from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type") if obj.get("type") is not None else 'user_attribute_pooling'
        })
