...
class TableInsertArguments(BaseModel):
    """
    TableInsertArguments
    """ # noqa: E501
    data: List[Optional[Dict[str, Any]]] = Field(description="List of dictionaries representing rows to insert.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TableInsertArguments from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TableInsertArguments from a dict"""
        if obj is None:
            return None
