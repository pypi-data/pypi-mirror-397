...
NUMHEADS_ANY_OF_SCHEMAS = ["TunableIntCategorical", "int"]

class NumHeads(BaseModel):
    """
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = NumHeads.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in NumHeads with anyOf schemas: TunableIntCategorical, int. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into NumHeads with anyOf schemas: TunableIntCategorical, int. Details: " + ", ".join(error_messages))
        else:
            return instance
