...
class TableInsertResponse(BaseModel):
    ...
    TableInsertResponse
    """ # noqa: E501
    message: StrictStr = Field(description="Results of the insert operation.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TableInsertResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TableInsertResponse from a dict"""
        if obj is None:
            return None
