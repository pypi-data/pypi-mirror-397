...
ENGINESCHEMAUSERINNER_ANY_OF_SCHEMAS = ["Feature", "Label"]

class EngineSchemaUserInner(BaseModel):
    """
    EngineSchemaUserInner
    """

    # data type: Feature
    anyof_schema_1_validator: Optional[Feature] = None
    # data type: Label
    anyof_schema_2_validator: Optional[Label] = None
    if TYPE_CHECKING:
        actual_instance: Optional[Union[Feature, Label]] = None
    else:
        actual_instance: Any = None
    any_of_schemas: Set[str] = { "Feature", "Label" }
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = EngineSchemaUserInner.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in EngineSchemaUserInner with anyOf schemas: Feature, Label. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into EngineSchemaUserInner with anyOf schemas: Feature, Label. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], Feature, Label]]:
