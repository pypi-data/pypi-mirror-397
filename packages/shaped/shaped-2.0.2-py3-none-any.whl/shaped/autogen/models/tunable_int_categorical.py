...
class TunableIntCategorical(BaseModel):
    """
    TunableIntCategorical
    """ # noqa: E501
    type: Optional[StrictStr] = 'tunable_int_categorical'
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['tunable_int_categorical']):
            raise ValueError("must be one of enum values ('tunable_int_categorical')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TunableIntCategorical from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TunableIntCategorical from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "type": obj.get("type") if obj.get("type") is not None else 'tunable_int_categorical',
