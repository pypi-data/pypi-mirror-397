...
class FilterRetrieveStep(BaseModel):
    """
    Retrieves entities by filtering without ordering. Useful for simple data queries that select specific columns and filter them.
    """ # noqa: E501
    ...
    type: Optional[StrictStr] = Field(default='filter', description="Retrieve step type discriminator.")
    __properties: ClassVar[List[str]] = ["where", "limit", "name", "type"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FilterRetrieveStep from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FilterRetrieveStep from a dict"""
        if obj is None:
            return None
