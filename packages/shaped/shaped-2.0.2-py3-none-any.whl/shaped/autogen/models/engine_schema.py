...
class EngineSchema(BaseModel):
    ...
    EngineSchema
    """ # noqa: E501
    user: List[EngineSchemaUserInner] = Field(description="User features and labels in the engine schema.")
    item: List[EngineSchemaUserInner] = Field(description="Item features and labels in the engine schema.")
    interaction: List[EngineSchemaUserInner] = Field(description="Interaction features and labels in the engine schema.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "user": [EngineSchemaUserInner.from_dict(_item) for _item in obj["user"]] if obj.get("user") is not None else None,
            "item": [EngineSchemaUserInner.from_dict(_item) for _item in obj["item"]] if obj.get("item") is not None else None,
            "interaction": [EngineSchemaUserInner.from_dict(_item) for _item in obj["interaction"]] if obj.get("interaction") is not None else None
        })
        return _obj
