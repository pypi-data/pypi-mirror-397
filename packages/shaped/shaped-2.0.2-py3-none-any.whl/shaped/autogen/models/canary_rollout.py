...
class CanaryRollout(BaseModel):
    ...
    CanaryRollout
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default='canary', description="Rollout type discriminator.")
    evaluation_period_minutes: Optional[StrictInt] = Field(default=10, description="Time in minutes to evaluate canary before full rollout.")
    __properties: ClassVar[List[str]] = ["type", "evaluation_period_minutes"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['canary']):
            raise ValueError("must be one of enum values ('canary')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CanaryRollout from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CanaryRollout from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "type": obj.get("type") if obj.get("type") is not None else 'canary',
            "evaluation_period_minutes": obj.get("evaluation_period_minutes") if obj.get("evaluation_period_minutes") is not None else 10
        })
        return _obj
