...
class SavedQueryInfoResponse(BaseModel):
    """
    Response model for saved query information.
    """ # noqa: E501
    name: StrictStr = Field(description="The name of the saved query.")
    params: List[StrictStr] = Field(description="List of parameter names that this query accepts.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SavedQueryInfoResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SavedQueryInfoResponse from a dict"""
        if obj is None:
            return None
