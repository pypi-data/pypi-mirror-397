...
class TuningConfig(BaseModel):
    """
    Configuration for the hyperparameter tuning orchestrator.
    """ # noqa: E501
    total_jobs: Optional[StrictInt] = Field(default=30, description="Total number of hyperparameter tuning jobs.")
    parallel_jobs: Optional[StrictInt] = Field(default=10, description="Number of tuning jobs to run in parallel.")
    __properties: ClassVar[List[str]] = ["total_jobs", "parallel_jobs"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TuningConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TuningConfig from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "total_jobs": obj.get("total_jobs") if obj.get("total_jobs") is not None else 30,
            "parallel_jobs": obj.get("parallel_jobs") if obj.get("parallel_jobs") is not None else 10
        })
        return _obj
