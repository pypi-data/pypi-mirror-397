...
class RudderstackTableConfig(BaseModel):
    """
    RudderstackTableConfig
    """ # noqa: E501
    schema_type: Optional[StrictStr] = Field(default='RUDDERSTACK', description="Schema type discriminator for Rudderstack datasets.")
    name: StrictStr = Field(description="Unique identifier for the Rudderstack dataset.")
    description: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["schema_type", "name", "description"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RudderstackTableConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RudderstackTableConfig from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "schema_type": obj.get("schema_type") if obj.get("schema_type") is not None else 'RUDDERSTACK',
            "name": obj.get("name"),
