...
class CandidateRetrievalStrategy(str, Enum):
    """
    ...
    TEST_IIDS = 'test_iids'
    ALL_IIDS = 'all_iids'
    NEGATIVE_SAMPLED_IIDS = 'negative_sampled_iids'
    NONE = 'none'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CandidateRetrievalStrategy from a JSON string"""
