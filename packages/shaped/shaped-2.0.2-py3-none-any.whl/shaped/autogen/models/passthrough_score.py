...
class PassthroughScore(BaseModel):
    """
    A simple step that uses the raw retrieval scores.
    """ # noqa: E501
    name: Optional[StrictStr] = None
    type: Optional[StrictStr] = Field(default='passthrough', description="Score step type discriminator.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PassthroughScore from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PassthroughScore from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "type": obj.get("type") if obj.get("type") is not None else 'passthrough'
        })
        return _obj
