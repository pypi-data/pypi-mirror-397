...
ATTRIBUTEVALUE_ANY_OF_SCHEMAS = ["bool", "float", "int", "str"]

class AttributeValue(BaseModel):
    """
    The attribute value being ranked. This is the actual value of the attribute (e.g., 'electronics', 29.99, etc.).
    """
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in AttributeValue with anyOf schemas: bool, float, int, str. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into AttributeValue with anyOf schemas: bool, float, int, str. Details: " + ", ".join(error_messages))
        else:
            return instance
