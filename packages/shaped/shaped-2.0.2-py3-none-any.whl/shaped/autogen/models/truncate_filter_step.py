...
class TruncateFilterStep(BaseModel):
    """
    TruncateFilterStep
    """ # noqa: E501
    name: Optional[StrictStr] = None
    max_length: Optional[StrictInt] = Field(default=500, description="Maximum number of items to keep after truncation.")
    type: Optional[StrictStr] = Field(default='truncate', description="Filter step type discriminator.")
    __properties: ClassVar[List[str]] = ["name", "max_length", "type"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TruncateFilterStep from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TruncateFilterStep from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "max_length": obj.get("max_length") if obj.get("max_length") is not None else 500,
            "type": obj.get("type") if obj.get("type") is not None else 'truncate'
        })
        return _obj
