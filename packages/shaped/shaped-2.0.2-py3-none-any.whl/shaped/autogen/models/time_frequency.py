...
TIMEFREQUENCY_ANY_OF_SCHEMAS = ["TunableString", "str"]
...
class TimeFrequency(BaseModel):
    ...
    if TYPE_CHECKING:
        actual_instance: Optional[Union[TunableString, str]] = None
    else:
        actual_instance: Any = None
    any_of_schemas: Set[str] = { "TunableString", "str" }
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = TimeFrequency.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in TimeFrequency with anyOf schemas: TunableString, str. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into TimeFrequency with anyOf schemas: TunableString, str. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], TunableString, str]]:
