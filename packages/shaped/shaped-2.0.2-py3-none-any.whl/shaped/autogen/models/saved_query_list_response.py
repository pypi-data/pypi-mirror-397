...
class SavedQueryListResponse(BaseModel):
    """
    Response model for listing saved queries.
    """ # noqa: E501
    queries: List[StrictStr] = Field(description="List of available saved query names.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SavedQueryListResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SavedQueryListResponse from a dict"""
        if obj is None:
            return None
