...
class NoOpConfig(BaseModel):
    ...
    NoOpConfig
    """ # noqa: E501
    policy_type: Optional[StrictStr] = 'no-op'
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NoOpConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NoOpConfig from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "policy_type": obj.get("policy_type") if obj.get("policy_type") is not None else 'no-op',
            "name": obj.get("name")
        })
