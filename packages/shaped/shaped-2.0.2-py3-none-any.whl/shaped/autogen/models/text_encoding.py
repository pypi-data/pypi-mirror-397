...
TEXTENCODING_ANY_OF_SCHEMAS = ["TunableBool", "bool"]
...
class TextEncoding(BaseModel):
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = TextEncoding.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in TextEncoding with anyOf schemas: TunableBool, bool. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into TextEncoding with anyOf schemas: TunableBool, bool. Details: " + ", ".join(error_messages))
        else:
            return instance
