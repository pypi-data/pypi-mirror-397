...
class LightSailPostDeploy:
    ...
    def __init__(self, container_service_name, region, domains=None, profile="default"):
        if domains is None:  # avoid mutable default list
            domains = []
    ...
    def static_execute(domain, container_service_name, region='ca-central-1', profile='default'):
        lightSailDeploy = LightSailPostDeploy(domains=[domain], container_service_name=container_service_name, region=region, profile=profile)
