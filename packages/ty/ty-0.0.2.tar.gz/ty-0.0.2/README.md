...
<p align="center">
  <img alt="Shows a bar chart with benchmark results." width="500px" src="https://raw.githubusercontent.com/astral-sh/ty/0.0.2/docs/assets/ty-benchmark-cli.svg">
</p>
...
To install ty, see the [installation](https://github.com/astral-sh/ty/blob/0.0.2/installation.md) documentation.

To add the ty language server to your editor, see the [editor integration](https://github.com/astral-sh/ty/blob/0.0.2/editors.md) guide.
...
See the
[contributing guide](https://github.com/astral-sh/ty/blob/0.0.2/CONTRIBUTING.md) for more details.
...
ty is licensed under the MIT license ([LICENSE](https://github.com/astral-sh/ty/blob/0.0.2/LICENSE) or
