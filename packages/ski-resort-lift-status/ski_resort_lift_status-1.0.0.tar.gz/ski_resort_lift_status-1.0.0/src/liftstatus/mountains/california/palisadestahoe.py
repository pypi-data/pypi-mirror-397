...
class PalisadesTahoe(liftstatus.apis.alterra.AlterraMountain):
    """Implementation of :class:`liftstatus.Mountain` for Palisades Tahoe, CA"""

    def __init__(self, session: requests.Session = requests.Session()):
        super().__init__(
            name="Palisades Tahoe",
            server_url="https://v4.mtnfeed.com/resorts/palisades-tahoe.json",
    ...
    def _map_lift_type(self, lift):
        ...
        if lift['LiftIcon'] in ['funitel']:
            return liftstatus.LiftType.FUN
        if lift['LiftIcon'] in ['tram']:
