...
class CrestedButte(liftstatus.apis.epic.EpicMountain):
    """Implementation of :class:`liftstatus.Mountain` for Crested Butte, CO"""
    
    def __init__(self, session: requests.Session = requests.Session()):
        super().__init__(
            name="Crested Butte",
            server_url="https://www.skicb.com/the-mountain/mountain-conditions/lift-and-terrain-status.aspx",
