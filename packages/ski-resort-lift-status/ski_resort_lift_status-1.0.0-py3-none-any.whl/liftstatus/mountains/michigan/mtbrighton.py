...
class MountBrighton(liftstatus.apis.epic.EpicMountain):
    """Implementation of :class:`liftstatus.Mountain` for Mount Brighton, MI"""
    
    def __init__(self, session: requests.Session = requests.Session()):
        super().__init__(
            name="Mt. Brighton",
            server_url="https://www.mtbrighton.com/the-mountain/mountain-conditions/lift-and-terrain-status.aspx",
    ...
    def _map_lift_type(self, lift):
        ...
        if lift['Type'] in ['conveyor', 'tow', 't-bar']:
