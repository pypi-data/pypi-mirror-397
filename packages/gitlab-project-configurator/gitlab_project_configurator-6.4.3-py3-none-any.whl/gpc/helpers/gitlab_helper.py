...
def is_bot_user_for_project_member(name):
    ...
    project_bot_pattern = r"^project_\d+_bot_[a-zA-Z0-9]+$"
    gitlab_security_bot_pattern = r"^gitlab_security_policy_project_\d+_bot_[a-zA-Z0-9]+$"

    return bool(re.match(project_bot_pattern, name)) or bool(
        re.match(gitlab_security_bot_pattern, name)
    )
