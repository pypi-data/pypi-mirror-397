...
class SalesforceAdapter(BaseOAuthAdapter):
    """Salesforce OAuth 2.0 adapter - placeholder for implementation"""
    
    def __init__(self, client_id: str = "{{SALESFORCE_CLIENT_ID}}", client_secret: str = "{{SALESFORCE_CLIENT_SECRET}}"):
    ...
    async def get_authorization_url(self, state: str, redirect_uri: str, scopes: Optional[list[str]] = None) -> str:
        raise NotImplementedError("SalesforceAdapter requires implementation")
