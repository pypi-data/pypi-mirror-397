...
class MigrationIntentAPI:
    ...
    def set_solution_migration_intent(
        ...
        """
        Mark a WABA for migration (legacy endpoint).

        This is the older endpoint for marking a WABA for migration.
        Use create_migration_intent() for the newer API.

        Args:
            waba_id: The WABA ID to mark for migration
            solution_id: The destination multi-partner solution ID
        ...
        logger.info(
            "Setting solution migration intent (legacy)",
            extra={"waba_id": waba_id, "solution_id": solution_id},
        )
