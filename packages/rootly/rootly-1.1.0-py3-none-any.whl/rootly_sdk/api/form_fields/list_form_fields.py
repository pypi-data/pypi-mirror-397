...
def _get_kwargs(
    *,
    include: Union[Unset, ListFormFieldsInclude] = UNSET,
...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[FormFieldList]:
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Response[FormFieldList]:
    return Response(
