...
from ..models.update_heartbeat_data_type import UpdateHeartbeatDataType, check_update_heartbeat_data_type
...
class UpdateHeartbeatData:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        type_ = check_update_heartbeat_data_type(d.pop("type"))
