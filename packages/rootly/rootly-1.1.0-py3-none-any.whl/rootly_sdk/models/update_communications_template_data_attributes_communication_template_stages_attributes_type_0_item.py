...
T = TypeVar("T", bound="UpdateCommunicationsTemplateDataAttributesCommunicationTemplateStagesAttributesType0Item")


@_attrs_define
class UpdateCommunicationsTemplateDataAttributesCommunicationTemplateStagesAttributesType0Item:
    """
    Attributes:
        id (Union[None, Unset, str]): ID of the communication template stage
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_communications_template_data_attributes_communication_template_stages_attributes_type_0_item = cls(
            id=id,
        ...
        update_communications_template_data_attributes_communication_template_stages_attributes_type_0_item.additional_properties = d
        return update_communications_template_data_attributes_communication_template_stages_attributes_type_0_item
