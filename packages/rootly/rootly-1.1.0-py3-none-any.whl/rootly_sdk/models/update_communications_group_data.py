...
from ..models.update_communications_group_data_type import (
    UpdateCommunicationsGroupDataType,
    check_update_communications_group_data_type,
)
...
class UpdateCommunicationsGroupData:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        type_ = check_update_communications_group_data_type(d.pop("type"))
