...
class NewAlertRouteDataAttributesRulesItemDestinationsItem:
    """
    Attributes:
        target_type (NewAlertRouteDataAttributesRulesItemDestinationsItemTargetType): The type of the target
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        new_alert_route_data_attributes_rules_item_destinations_item.additional_properties = d
