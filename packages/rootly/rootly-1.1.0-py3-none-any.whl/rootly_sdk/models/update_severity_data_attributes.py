...
class UpdateSeverityDataAttributes:
    ...
    severity: Union[Unset, UpdateSeverityDataAttributesSeverity] = UNSET
    color: Union[None, Unset, str] = UNSET
    position: Union[None, Unset, int] = UNSET
    notify_emails: Union[None, Unset, list[str]] = UNSET
    slack_channels: Union[None, Unset, list["UpdateSeverityDataAttributesSlackChannelsType0Item"]] = UNSET
    slack_aliases: Union[None, Unset, list["UpdateSeverityDataAttributesSlackAliasesType0Item"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        severity: Union[Unset, UpdateSeverityDataAttributesSeverity]
        ...
        def _parse_slack_channels(
            data: object,
        ) -> Union[None, Unset, list["UpdateSeverityDataAttributesSlackChannelsType0Item"]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(Union[None, Unset, list["UpdateSeverityDataAttributesSlackChannelsType0Item"]], data)

        slack_channels = _parse_slack_channels(d.pop("slack_channels", UNSET))

        def _parse_slack_aliases(
            data: object,
        ) -> Union[None, Unset, list["UpdateSeverityDataAttributesSlackAliasesType0Item"]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(Union[None, Unset, list["UpdateSeverityDataAttributesSlackAliasesType0Item"]], data)
