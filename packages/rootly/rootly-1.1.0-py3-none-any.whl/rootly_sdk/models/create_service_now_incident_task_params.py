...
class CreateServiceNowIncidentTaskParams:
    ...
    title: str
    task_type: Union[Unset, CreateServiceNowIncidentTaskParamsTaskType] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        priority: Union[Unset, CreateServiceNowIncidentTaskParamsPriority]
        ...
        completion: Union[Unset, CreateServiceNowIncidentTaskParamsCompletion]
