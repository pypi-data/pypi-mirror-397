...
from ..models.new_alerts_source_data_attributes_alert_source_urgency_rules_attributes_item_conditionable_type import (
...
class NewAlertsSourceDataAttributesAlertSourceUrgencyRulesAttributesItem:
    ...
    conditionable_type: Union[
        Unset, NewAlertsSourceDataAttributesAlertSourceUrgencyRulesAttributesItemConditionableType
    ] = UNSET
    conditionable_id: Union[None, Unset, str] = UNSET
    kind: Union[Unset, NewAlertsSourceDataAttributesAlertSourceUrgencyRulesAttributesItemKind] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_operator, Unset):
            ...
            operator = check_new_alerts_source_data_attributes_alert_source_urgency_rules_attributes_item_operator(
                _operator
            )
        ...
        kind: Union[Unset, NewAlertsSourceDataAttributesAlertSourceUrgencyRulesAttributesItemKind]
        if isinstance(_kind, Unset):
            kind = UNSET
        else:
            kind = check_new_alerts_source_data_attributes_alert_source_urgency_rules_attributes_item_kind(_kind)
