...
from ..models.alerts_source_sourceable_attributes_type_0_field_mappings_attributes_item_field import (
    AlertsSourceSourceableAttributesType0FieldMappingsAttributesItemField,
    check_alerts_source_sourceable_attributes_type_0_field_mappings_attributes_item_field,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="AlertsSourceSourceableAttributesType0FieldMappingsAttributesItem")
...
class AlertsSourceSourceableAttributesType0FieldMappingsAttributesItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_field, Unset):
            ...
            field = check_alerts_source_sourceable_attributes_type_0_field_mappings_attributes_item_field(_field)

        json_path = d.pop("json_path", UNSET)

        alerts_source_sourceable_attributes_type_0_field_mappings_attributes_item = cls(
            field=field,
            json_path=json_path,
        )

        alerts_source_sourceable_attributes_type_0_field_mappings_attributes_item.additional_properties = d
        return alerts_source_sourceable_attributes_type_0_field_mappings_attributes_item
