...
T = TypeVar("T", bound="NewIncidentSubStatusDataAttributes")


@_attrs_define
class NewIncidentSubStatusDataAttributes:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        new_incident_sub_status_data_attributes = cls(
            sub_status_id=sub_status_id,
            assigned_at=assigned_at,
            assigned_by_user_id=assigned_by_user_id,
        )

        return new_incident_sub_status_data_attributes
