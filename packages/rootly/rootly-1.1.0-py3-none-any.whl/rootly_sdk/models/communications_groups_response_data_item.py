...
from ..models.communications_groups_response_data_item_type import (
    CommunicationsGroupsResponseDataItemType,
    check_communications_groups_response_data_item_type,
)
...
class CommunicationsGroupsResponseDataItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = check_communications_groups_response_data_item_type(d.pop("type"))
