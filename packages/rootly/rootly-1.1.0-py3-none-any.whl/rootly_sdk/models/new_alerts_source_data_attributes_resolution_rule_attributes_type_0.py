...
class NewAlertsSourceDataAttributesResolutionRuleAttributesType0:
    ...
    condition_type: Union[Unset, NewAlertsSourceDataAttributesResolutionRuleAttributesType0ConditionType] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        condition_type: Union[Unset, NewAlertsSourceDataAttributesResolutionRuleAttributesType0ConditionType]
