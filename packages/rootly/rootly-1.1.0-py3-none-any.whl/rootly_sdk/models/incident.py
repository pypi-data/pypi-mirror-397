...
class Incident:
    ...
    zoom_meeting_global_dial_in_numbers: Union[None, Unset, list[str]] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        zoom_meeting_global_dial_in_numbers: Union[None, Unset, list[str]]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_zoom_meeting_global_dial_in_numbers(data: object) -> Union[None, Unset, list[str]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
