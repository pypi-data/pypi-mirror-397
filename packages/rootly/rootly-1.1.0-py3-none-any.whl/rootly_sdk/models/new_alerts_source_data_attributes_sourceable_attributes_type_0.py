...
class NewAlertsSourceDataAttributesSourceableAttributesType0:
    ...
    Attributes:
        ...
        field_mappings_attributes (Union[Unset,
            list['NewAlertsSourceDataAttributesSourceableAttributesType0FieldMappingsAttributesItem']]): Specify rules to
            auto resolve alerts
    """
    ...
    field_mappings_attributes: Union[
        Unset, list["NewAlertsSourceDataAttributesSourceableAttributesType0FieldMappingsAttributesItem"]
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        new_alerts_source_data_attributes_sourceable_attributes_type_0.additional_properties = d
