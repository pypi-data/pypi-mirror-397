...
from ..models.update_schedule_rotation_data_type import (
    UpdateScheduleRotationDataType,
    check_update_schedule_rotation_data_type,
)
...
class UpdateScheduleRotationData:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        type_ = check_update_schedule_rotation_data_type(d.pop("type"))
