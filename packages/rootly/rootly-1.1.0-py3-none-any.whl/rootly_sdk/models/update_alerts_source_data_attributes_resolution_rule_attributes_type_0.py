...
class UpdateAlertsSourceDataAttributesResolutionRuleAttributesType0:
    ...
    condition_type: Union[Unset, UpdateAlertsSourceDataAttributesResolutionRuleAttributesType0ConditionType] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        condition_type: Union[Unset, UpdateAlertsSourceDataAttributesResolutionRuleAttributesType0ConditionType]
