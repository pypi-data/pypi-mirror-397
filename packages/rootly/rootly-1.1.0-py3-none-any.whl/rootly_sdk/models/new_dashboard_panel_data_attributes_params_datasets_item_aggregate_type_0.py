...
class NewDashboardPanelDataAttributesParamsDatasetsItemAggregateType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        new_dashboard_panel_data_attributes_params_datasets_item_aggregate_type_0 = cls(
            operation=operation,
            key=key,
            cumulative=cumulative,
        )

        new_dashboard_panel_data_attributes_params_datasets_item_aggregate_type_0.additional_properties = d
        return new_dashboard_panel_data_attributes_params_datasets_item_aggregate_type_0
