...
from ..models.new_alert_routing_rule_data_attributes_destination_target_type import (
    ...
    check_new_alert_routing_rule_data_attributes_destination_target_type,
)
...
class NewAlertRoutingRuleDataAttributesDestination:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        target_type = check_new_alert_routing_rule_data_attributes_destination_target_type(d.pop("target_type"))
