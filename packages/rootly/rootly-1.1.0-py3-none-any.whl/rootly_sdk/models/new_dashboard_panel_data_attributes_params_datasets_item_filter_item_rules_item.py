...
class NewDashboardPanelDataAttributesParamsDatasetsItemFilterItemRulesItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_operation, Unset):
            ...
            operation = check_new_dashboard_panel_data_attributes_params_datasets_item_filter_item_rules_item_operation(
                _operation
            )
        ...
        if isinstance(_condition, Unset):
            ...
            condition = check_new_dashboard_panel_data_attributes_params_datasets_item_filter_item_rules_item_condition(
                _condition
            )
