...
from ..models.live_call_router_list_data_item_type import (
    LiveCallRouterListDataItemType,
    check_live_call_router_list_data_item_type,
)
...
class LiveCallRouterListDataItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = check_live_call_router_list_data_item_type(d.pop("type"))
