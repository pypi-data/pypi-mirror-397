...
from ..models.form_field_response_data_type import FormFieldResponseDataType, check_form_field_response_data_type
...
class FormFieldResponseData:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = check_form_field_response_data_type(d.pop("type"))
