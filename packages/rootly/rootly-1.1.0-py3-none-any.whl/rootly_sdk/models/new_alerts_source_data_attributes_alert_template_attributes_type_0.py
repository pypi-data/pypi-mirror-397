...
T = TypeVar("T", bound="NewAlertsSourceDataAttributesAlertTemplateAttributesType0")
...
class NewAlertsSourceDataAttributesAlertTemplateAttributesType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        new_alerts_source_data_attributes_alert_template_attributes_type_0 = cls(
            title=title,
            description=description,
            external_url=external_url,
        )

        new_alerts_source_data_attributes_alert_template_attributes_type_0.additional_properties = d
        return new_alerts_source_data_attributes_alert_template_attributes_type_0
