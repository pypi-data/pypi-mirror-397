...
if TYPE_CHECKING:
    from ..models.update_alerts_source_data_attributes_sourceable_attributes_type_0_field_mappings_attributes_item import (
        UpdateAlertsSourceDataAttributesSourceableAttributesType0FieldMappingsAttributesItem,
    )


T = TypeVar("T", bound="UpdateAlertsSourceDataAttributesSourceableAttributesType0")


@_attrs_define
class UpdateAlertsSourceDataAttributesSourceableAttributesType0:
    ...
    Attributes:
        ...
        field_mappings_attributes (Union[Unset,
            list['UpdateAlertsSourceDataAttributesSourceableAttributesType0FieldMappingsAttributesItem']]): Specify rules to
            auto resolve alerts
    """
    ...
    field_mappings_attributes: Union[
        Unset, list["UpdateAlertsSourceDataAttributesSourceableAttributesType0FieldMappingsAttributesItem"]
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for field_mappings_attributes_item_data in _field_mappings_attributes or []:
            field_mappings_attributes_item = (
                UpdateAlertsSourceDataAttributesSourceableAttributesType0FieldMappingsAttributesItem.from_dict(
        ...
        update_alerts_source_data_attributes_sourceable_attributes_type_0 = cls(
        ...
        update_alerts_source_data_attributes_sourceable_attributes_type_0.additional_properties = d
        return update_alerts_source_data_attributes_sourceable_attributes_type_0
