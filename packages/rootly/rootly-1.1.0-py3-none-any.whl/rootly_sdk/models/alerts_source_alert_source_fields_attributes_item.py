...
T = TypeVar("T", bound="AlertsSourceAlertSourceFieldsAttributesItem")


@_attrs_define
class AlertsSourceAlertSourceFieldsAttributesItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        alerts_source_alert_source_fields_attributes_item = cls(
            alert_field_id=alert_field_id,
            template_body=template_body,
        )

        alerts_source_alert_source_fields_attributes_item.additional_properties = d
        return alerts_source_alert_source_fields_attributes_item
