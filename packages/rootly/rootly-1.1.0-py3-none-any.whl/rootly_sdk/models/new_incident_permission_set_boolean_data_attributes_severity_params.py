...
T = TypeVar("T", bound="NewIncidentPermissionSetBooleanDataAttributesSeverityParams")


@_attrs_define
class NewIncidentPermissionSetBooleanDataAttributesSeverityParams:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        new_incident_permission_set_boolean_data_attributes_severity_params = cls(
        ...
        new_incident_permission_set_boolean_data_attributes_severity_params.additional_properties = d
        return new_incident_permission_set_boolean_data_attributes_severity_params
