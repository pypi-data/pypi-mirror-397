...
from ..models.update_catalog_field_data_type import UpdateCatalogFieldDataType, check_update_catalog_field_data_type
...
class UpdateCatalogFieldData:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        type_ = check_update_catalog_field_data_type(d.pop("type"))
