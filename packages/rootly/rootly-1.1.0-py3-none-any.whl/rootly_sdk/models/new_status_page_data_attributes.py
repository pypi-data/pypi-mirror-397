...
class NewStatusPageDataAttributes:
    ...
    show_uptime_last_days: Union[Unset, NewStatusPageDataAttributesShowUptimeLastDays] = UNSET
    success_message: Union[None, Unset, str] = UNSET
    failure_message: Union[None, Unset, str] = UNSET
    authentication_method: Union[Unset, NewStatusPageDataAttributesAuthenticationMethod] = "none"
    ...
    saml_name_identifier_format: Union[Unset, NewStatusPageDataAttributesSamlNameIdentifierFormat] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        show_uptime_last_days: Union[Unset, NewStatusPageDataAttributesShowUptimeLastDays]
        ...
        authentication_method: Union[Unset, NewStatusPageDataAttributesAuthenticationMethod]
        ...
        saml_name_identifier_format: Union[Unset, NewStatusPageDataAttributesSamlNameIdentifierFormat]
