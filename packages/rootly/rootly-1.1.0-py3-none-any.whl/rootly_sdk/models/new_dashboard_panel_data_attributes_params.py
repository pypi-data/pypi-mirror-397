...
class NewDashboardPanelDataAttributesParams:
    ...
    display: Union[Unset, NewDashboardPanelDataAttributesParamsDisplay] = UNSET
    ...
    datasets: Union[Unset, list["NewDashboardPanelDataAttributesParamsDatasetsItem"]] = UNSET
