...
from ..models.post_mortem_template_list_data_item_type import (
    PostMortemTemplateListDataItemType,
    check_post_mortem_template_list_data_item_type,
)
...
class PostMortemTemplateListDataItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = check_post_mortem_template_list_data_item_type(d.pop("type"))
