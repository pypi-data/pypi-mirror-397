...
T = TypeVar("T", bound="DashboardPanelParams")
...
class DashboardPanelParams:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_display, Unset):
            ...
            display = check_dashboard_panel_params_display(_display)
        ...
        dashboard_panel_params.additional_properties = d
        return dashboard_panel_params
