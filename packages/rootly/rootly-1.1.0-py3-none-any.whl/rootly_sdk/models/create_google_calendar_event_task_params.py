...
class CreateGoogleCalendarEventTaskParams:
    ...
    summary: str
    description: str
    task_type: Union[Unset, CreateGoogleCalendarEventTaskParamsTaskType] = UNSET
    ...
    conference_solution_key: Union[Unset, CreateGoogleCalendarEventTaskParamsConferenceSolutionKey] = UNSET
    post_to_incident_timeline: Union[Unset, bool] = UNSET
    post_to_slack_channels: Union[Unset, list["CreateGoogleCalendarEventTaskParamsPostToSlackChannelsItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        conference_solution_key: Union[Unset, CreateGoogleCalendarEventTaskParamsConferenceSolutionKey]
