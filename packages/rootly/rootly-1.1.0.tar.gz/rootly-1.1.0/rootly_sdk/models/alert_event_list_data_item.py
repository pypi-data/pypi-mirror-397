...
from ..models.alert_event_list_data_item_type import AlertEventListDataItemType, check_alert_event_list_data_item_type
...
class AlertEventListDataItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = check_alert_event_list_data_item_type(d.pop("type"))
