...
class UpdatePulseDataAttributes:
    ...
    labels: Union[Unset, list[Union["UpdatePulseDataAttributesLabelsItemType0", None]]] = UNSET
    refs: Union[Unset, list[Union["UpdatePulseDataAttributesRefsItemType0", None]]] = UNSET
