...
from ..models.webhooks_endpoint_list_data_item_type import (
    WebhooksEndpointListDataItemType,
    check_webhooks_endpoint_list_data_item_type,
)
...
class WebhooksEndpointListDataItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = check_webhooks_endpoint_list_data_item_type(d.pop("type"))
