...
class CreateZendeskTicketTaskParams:
    ...
    kind: CreateZendeskTicketTaskParamsKind
    subject: str
    task_type: Union[Unset, CreateZendeskTicketTaskParamsTaskType] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        priority: Union[Unset, CreateZendeskTicketTaskParamsPriority]
        ...
        completion: Union[Unset, CreateZendeskTicketTaskParamsCompletion]
