...
T = TypeVar("T", bound="SubStatusResponseData")


@_attrs_define
class SubStatusResponseData:
    """
    Attributes:
        id (str): Unique ID of the sub_status
        type_ (SubStatusResponseDataType):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sub_status_response_data = cls(
            id=id,
            type_=type_,
            attributes=attributes,
        )

        sub_status_response_data.additional_properties = d
        return sub_status_response_data
