...
T = TypeVar("T", bound="IncidentEventFunctionalityResponseData")


@_attrs_define
class IncidentEventFunctionalityResponseData:
    """
    Attributes:
        id (str): Unique ID of the incident event functionality
        type_ (IncidentEventFunctionalityResponseDataType):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = check_incident_event_functionality_response_data_type(d.pop("type"))

        attributes = IncidentEventFunctionality.from_dict(d.pop("attributes"))

        incident_event_functionality_response_data = cls(
            id=id,
            type_=type_,
            attributes=attributes,
        )

        incident_event_functionality_response_data.additional_properties = d
        return incident_event_functionality_response_data
