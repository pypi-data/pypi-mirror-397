...
from ..models.workflow_list_data_item_type import WorkflowListDataItemType, check_workflow_list_data_item_type
...
class WorkflowListDataItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = check_workflow_list_data_item_type(d.pop("type"))
