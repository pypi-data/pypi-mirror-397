...
from ..models.alert_field_list_data_item_type import AlertFieldListDataItemType, check_alert_field_list_data_item_type
...
class AlertFieldListDataItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = check_alert_field_list_data_item_type(d.pop("type"))
