...
T = TypeVar("T", bound="UpdateIncidentPermissionSetResourceDataAttributesSeverityParams")
...
class UpdateIncidentPermissionSetResourceDataAttributesSeverityParams:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_incident_permission_set_resource_data_attributes_severity_params = cls(
