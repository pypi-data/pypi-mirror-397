...
T = TypeVar("T", bound="AlertGroupResponseData")


@_attrs_define
class AlertGroupResponseData:
    """
    Attributes:
        id (str): Unique ID of the alert group
        type_ (AlertGroupResponseDataType):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        alert_group_response_data = cls(
            id=id,
            type_=type_,
            attributes=attributes,
        )

        alert_group_response_data.additional_properties = d
        return alert_group_response_data
