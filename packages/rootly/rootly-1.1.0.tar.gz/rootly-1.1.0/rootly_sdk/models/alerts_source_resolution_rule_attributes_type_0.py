...
class AlertsSourceResolutionRuleAttributesType0:
    ...
    Attributes:
        ...
        condition_type (Union[Unset, AlertsSourceResolutionRuleAttributesType0ConditionType]): The type of condition to
            evaluate to apply auto resolution rule
        identifier_matchable_type (Union[Unset, AlertsSourceResolutionRuleAttributesType0IdentifierMatchableType]): The
            type of the identifier matchable
        ...
        identifier_reference_kind (Union[Unset, AlertsSourceResolutionRuleAttributesType0IdentifierReferenceKind]): The
            kind of the identifier reference
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_identifier_matchable_type, Unset):
            ...
            identifier_matchable_type = check_alerts_source_resolution_rule_attributes_type_0_identifier_matchable_type(
        ...
        if isinstance(_identifier_reference_kind, Unset):
            ...
            identifier_reference_kind = check_alerts_source_resolution_rule_attributes_type_0_identifier_reference_kind(
        ...
        for conditions_attributes_item_data in _conditions_attributes or []:
            conditions_attributes_item = AlertsSourceResolutionRuleAttributesType0ConditionsAttributesItem.from_dict(
