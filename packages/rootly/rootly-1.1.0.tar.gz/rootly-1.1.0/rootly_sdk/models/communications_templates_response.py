...
T = TypeVar("T", bound="CommunicationsTemplatesResponse")
...
class CommunicationsTemplatesResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = CommunicationsTemplatesResponseDataItem.from_dict(data_item_data)
        ...
        return communications_templates_response
