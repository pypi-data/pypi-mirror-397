...
from ..models.incident_event_list_data_item_type import (
    IncidentEventListDataItemType,
    check_incident_event_list_data_item_type,
)
...
class IncidentEventListDataItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = check_incident_event_list_data_item_type(d.pop("type"))
