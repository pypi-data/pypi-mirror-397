...
from ..models.update_incident_form_field_selection_data_type import (
    UpdateIncidentFormFieldSelectionDataType,
    check_update_incident_form_field_selection_data_type,
)
...
class UpdateIncidentFormFieldSelectionData:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        type_ = check_update_incident_form_field_selection_data_type(d.pop("type"))
