...
T = TypeVar("T", bound="NewSeverityDataAttributes")


@_attrs_define
class NewSeverityDataAttributes:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_slack_channels(
            ...
            try:
                ...
                for slack_channels_type_0_item_data in _slack_channels_type_0:
                    slack_channels_type_0_item = NewSeverityDataAttributesSlackChannelsType0Item.from_dict(
        ...
        def _parse_slack_aliases(
            ...
            try:
                ...
                for slack_aliases_type_0_item_data in _slack_aliases_type_0:
                    slack_aliases_type_0_item = NewSeverityDataAttributesSlackAliasesType0Item.from_dict(
        ...
        return new_severity_data_attributes
