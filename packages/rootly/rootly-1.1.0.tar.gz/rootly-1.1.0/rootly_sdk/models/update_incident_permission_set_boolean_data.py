...
from ..models.update_incident_permission_set_boolean_data_type import (
    UpdateIncidentPermissionSetBooleanDataType,
    check_update_incident_permission_set_boolean_data_type,
)
...
class UpdateIncidentPermissionSetBooleanData:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        type_ = check_update_incident_permission_set_boolean_data_type(d.pop("type"))
