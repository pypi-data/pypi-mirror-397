...
T = TypeVar("T", bound="UpdateIncidentPermissionSetBooleanDataAttributesSeverityParams")


@_attrs_define
class UpdateIncidentPermissionSetBooleanDataAttributesSeverityParams:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_incident_permission_set_boolean_data_attributes_severity_params = cls(
        ...
        update_incident_permission_set_boolean_data_attributes_severity_params.additional_properties = d
        return update_incident_permission_set_boolean_data_attributes_severity_params
