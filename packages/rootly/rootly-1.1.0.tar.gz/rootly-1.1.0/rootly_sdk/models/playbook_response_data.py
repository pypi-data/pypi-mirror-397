...
from ..models.playbook_response_data_type import PlaybookResponseDataType, check_playbook_response_data_type
...
class PlaybookResponseData:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = check_playbook_response_data_type(d.pop("type"))
