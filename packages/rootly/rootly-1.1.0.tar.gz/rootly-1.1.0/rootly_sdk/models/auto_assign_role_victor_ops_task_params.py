...
T = TypeVar("T", bound="AutoAssignRoleVictorOpsTaskParams")


@_attrs_define
class AutoAssignRoleVictorOpsTaskParams:
    """
    Attributes:
    ...
    team: "AutoAssignRoleVictorOpsTaskParamsTeam"
    task_type: Union[Unset, AutoAssignRoleVictorOpsTaskParamsTaskType] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        auto_assign_role_victor_ops_task_params.additional_properties = d
        return auto_assign_role_victor_ops_task_params
