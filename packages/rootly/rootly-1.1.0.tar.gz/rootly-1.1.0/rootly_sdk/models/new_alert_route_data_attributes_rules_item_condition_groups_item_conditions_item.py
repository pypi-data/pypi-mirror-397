...
from ..models.new_alert_route_data_attributes_rules_item_condition_groups_item_conditions_item_conditionable_type import (
...
from ..models.new_alert_route_data_attributes_rules_item_condition_groups_item_conditions_item_property_field_condition_type import (
...
from ..models.new_alert_route_data_attributes_rules_item_condition_groups_item_conditions_item_property_field_type import (
...
T = TypeVar("T", bound="NewAlertRouteDataAttributesRulesItemConditionGroupsItemConditionsItem")


@_attrs_define
class NewAlertRouteDataAttributesRulesItemConditionGroupsItemConditionsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        property_field_condition_type = check_new_alert_route_data_attributes_rules_item_condition_groups_item_conditions_item_property_field_condition_type(
        ...
        if isinstance(_conditionable_type, Unset):
            ...
            conditionable_type = check_new_alert_route_data_attributes_rules_item_condition_groups_item_conditions_item_conditionable_type(
                _conditionable_type
            )
        ...
        new_alert_route_data_attributes_rules_item_condition_groups_item_conditions_item = cls(
            property_field_condition_type=property_field_condition_type,
            property_field_type=property_field_type,
        ...
        new_alert_route_data_attributes_rules_item_condition_groups_item_conditions_item.additional_properties = d
        return new_alert_route_data_attributes_rules_item_condition_groups_item_conditions_item
