...
from ..models.alerts_source_resolution_rule_attributes_type_0_conditions_attributes_item_conditionable_type import (
    AlertsSourceResolutionRuleAttributesType0ConditionsAttributesItemConditionableType,
    check_alerts_source_resolution_rule_attributes_type_0_conditions_attributes_item_conditionable_type,
)
from ..models.alerts_source_resolution_rule_attributes_type_0_conditions_attributes_item_kind import (
    AlertsSourceResolutionRuleAttributesType0ConditionsAttributesItemKind,
    check_alerts_source_resolution_rule_attributes_type_0_conditions_attributes_item_kind,
)
from ..models.alerts_source_resolution_rule_attributes_type_0_conditions_attributes_item_operator import (
    AlertsSourceResolutionRuleAttributesType0ConditionsAttributesItemOperator,
    check_alerts_source_resolution_rule_attributes_type_0_conditions_attributes_item_operator,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="AlertsSourceResolutionRuleAttributesType0ConditionsAttributesItem")
...
class AlertsSourceResolutionRuleAttributesType0ConditionsAttributesItem:
    ...
    operator: Union[Unset, AlertsSourceResolutionRuleAttributesType0ConditionsAttributesItemOperator] = UNSET
    ...
    kind: Union[Unset, AlertsSourceResolutionRuleAttributesType0ConditionsAttributesItemKind] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        operator: Union[Unset, AlertsSourceResolutionRuleAttributesType0ConditionsAttributesItemOperator]
        if isinstance(_operator, Unset):
            operator = UNSET
        else:
            operator = check_alerts_source_resolution_rule_attributes_type_0_conditions_attributes_item_operator(
                _operator
            )
        ...
        kind: Union[Unset, AlertsSourceResolutionRuleAttributesType0ConditionsAttributesItemKind]
        if isinstance(_kind, Unset):
            kind = UNSET
        else:
            kind = check_alerts_source_resolution_rule_attributes_type_0_conditions_attributes_item_kind(_kind)

        alerts_source_resolution_rule_attributes_type_0_conditions_attributes_item = cls(
            field=field,
            operator=operator,
            value=value,
        ...
        alerts_source_resolution_rule_attributes_type_0_conditions_attributes_item.additional_properties = d
        return alerts_source_resolution_rule_attributes_type_0_conditions_attributes_item
