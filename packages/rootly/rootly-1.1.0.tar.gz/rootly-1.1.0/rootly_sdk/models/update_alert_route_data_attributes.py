...
if TYPE_CHECKING:
    from ..models.update_alert_route_data_attributes_rules_item import UpdateAlertRouteDataAttributesRulesItem


T = TypeVar("T", bound="UpdateAlertRouteDataAttributes")


@_attrs_define
class UpdateAlertRouteDataAttributes:
    """
    Attributes:
        ...
        rules (Union[Unset, list['UpdateAlertRouteDataAttributesRulesItem']]):
    """
    ...
    rules: Union[Unset, list["UpdateAlertRouteDataAttributesRulesItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for rules_item_data in _rules or []:
            rules_item = UpdateAlertRouteDataAttributesRulesItem.from_dict(rules_item_data)

            rules.append(rules_item)

        update_alert_route_data_attributes = cls(
            name=name,
            enabled=enabled,
        ...
        return update_alert_route_data_attributes
