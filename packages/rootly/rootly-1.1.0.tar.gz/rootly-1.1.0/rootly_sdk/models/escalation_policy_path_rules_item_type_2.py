...
from ..models.escalation_policy_path_rules_item_type_2_operator import (
    EscalationPolicyPathRulesItemType2Operator,
    check_escalation_policy_path_rules_item_type_2_operator,
)
from ..models.escalation_policy_path_rules_item_type_2_rule_type import (
...
class EscalationPolicyPathRulesItemType2:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        rule_type = check_escalation_policy_path_rules_item_type_2_rule_type(d.pop("rule_type"))
