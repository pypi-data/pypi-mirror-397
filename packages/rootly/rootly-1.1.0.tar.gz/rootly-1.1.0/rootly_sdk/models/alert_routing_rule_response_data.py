...
from ..models.alert_routing_rule_response_data_type import (
    AlertRoutingRuleResponseDataType,
    check_alert_routing_rule_response_data_type,
)
...
class AlertRoutingRuleResponseData:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = check_alert_routing_rule_response_data_type(d.pop("type"))
