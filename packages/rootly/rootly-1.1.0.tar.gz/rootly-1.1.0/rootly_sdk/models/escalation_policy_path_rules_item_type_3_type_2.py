...
@_attrs_define
class EscalationPolicyPathRulesItemType3Type2:
    """
    Attributes:
        rule_type (EscalationPolicyPathRulesItemType3Type2RuleType): The type of the escalation path rule
        json_path (str): JSON path to extract value from payload
        operator (EscalationPolicyPathRulesItemType3Type2Operator): How JSON path value should be matched
        value (str): Value with which JSON path value should be matched
    """

    rule_type: EscalationPolicyPathRulesItemType3Type2RuleType
    json_path: str
    operator: EscalationPolicyPathRulesItemType3Type2Operator
    value: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        escalation_policy_path_rules_item_type_3_type_2 = cls(
            rule_type=rule_type,
            json_path=json_path,
            operator=operator,
            value=value,
        ...
        escalation_policy_path_rules_item_type_3_type_2.additional_properties = d
        return escalation_policy_path_rules_item_type_3_type_2
