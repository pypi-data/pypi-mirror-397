...
class EscalationPolicyBusinessHoursType0:
    ...
    time_zone: Union[Unset, EscalationPolicyBusinessHoursType0TimeZone] = UNSET
    days: Union[None, Unset, list[EscalationPolicyBusinessHoursType0DaysType0Item]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        time_zone: Union[Unset, EscalationPolicyBusinessHoursType0TimeZone]
        if isinstance(_time_zone, Unset):
            time_zone = UNSET
        else:
            time_zone = check_escalation_policy_business_hours_type_0_time_zone(_time_zone)

        def _parse_days(data: object) -> Union[None, Unset, list[EscalationPolicyBusinessHoursType0DaysType0Item]]:
            if data is None:
                return data
            ...
            try:
                ...
                pass
            return cast(Union[None, Unset, list[EscalationPolicyBusinessHoursType0DaysType0Item]], data)
