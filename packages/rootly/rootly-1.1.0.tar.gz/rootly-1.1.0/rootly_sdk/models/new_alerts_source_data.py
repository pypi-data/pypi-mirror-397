...
from ..models.new_alerts_source_data_type import NewAlertsSourceDataType, check_new_alerts_source_data_type
...
class NewAlertsSourceData:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        type_ = check_new_alerts_source_data_type(d.pop("type"))
