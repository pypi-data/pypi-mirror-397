...
from ..models.on_call_role_list_data_item_type import OnCallRoleListDataItemType, check_on_call_role_list_data_item_type
...
class OnCallRoleListDataItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = check_on_call_role_list_data_item_type(d.pop("type"))
