...
T = TypeVar("T", bound="PostMortemTemplateResponseData")


@_attrs_define
class PostMortemTemplateResponseData:
    """
    Attributes:
        id (str): Unique ID of the post_mortem_template
        type_ (PostMortemTemplateResponseDataType):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = check_post_mortem_template_response_data_type(d.pop("type"))

        attributes = PostMortemTemplate.from_dict(d.pop("attributes"))

        post_mortem_template_response_data = cls(
            id=id,
            type_=type_,
            attributes=attributes,
        )

        post_mortem_template_response_data.additional_properties = d
        return post_mortem_template_response_data
