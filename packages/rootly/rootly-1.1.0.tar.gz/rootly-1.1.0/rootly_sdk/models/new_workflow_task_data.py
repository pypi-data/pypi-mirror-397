...
from ..models.new_workflow_task_data_type import NewWorkflowTaskDataType, check_new_workflow_task_data_type
...
class NewWorkflowTaskData:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        type_ = check_new_workflow_task_data_type(d.pop("type"))
