...
@_attrs_define
class EscalationPolicyPathRulesItemType1:
    """
    Attributes:
        rule_type (EscalationPolicyPathRulesItemType1RuleType): The type of the escalation path rule
        within_working_hour (bool): Whether the escalation path should be used within working hours
    """

    rule_type: EscalationPolicyPathRulesItemType1RuleType
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        escalation_policy_path_rules_item_type_1 = cls(
            rule_type=rule_type,
            within_working_hour=within_working_hour,
        )
