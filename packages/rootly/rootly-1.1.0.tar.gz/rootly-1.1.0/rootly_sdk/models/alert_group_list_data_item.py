...
from ..models.alert_group_list_data_item_type import AlertGroupListDataItemType, check_alert_group_list_data_item_type
...
class AlertGroupListDataItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = check_alert_group_list_data_item_type(d.pop("type"))
