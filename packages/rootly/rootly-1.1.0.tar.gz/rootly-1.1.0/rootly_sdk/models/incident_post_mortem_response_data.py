...
from ..models.incident_post_mortem_response_data_type import (
    IncidentPostMortemResponseDataType,
    check_incident_post_mortem_response_data_type,
)
...
class IncidentPostMortemResponseData:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = check_incident_post_mortem_response_data_type(d.pop("type"))
