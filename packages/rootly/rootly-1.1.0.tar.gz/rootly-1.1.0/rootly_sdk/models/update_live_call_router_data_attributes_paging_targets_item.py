...
@_attrs_define
class UpdateLiveCallRouterDataAttributesPagingTargetsItem:
    """
    Attributes:
        id (str): The ID of paging target
        type_ (UpdateLiveCallRouterDataAttributesPagingTargetsItemType): The type of the paging target
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = check_update_live_call_router_data_attributes_paging_targets_item_type(d.pop("type"))

        alert_urgency_id = d.pop("alert_urgency_id")

        update_live_call_router_data_attributes_paging_targets_item = cls(
            id=id,
            type_=type_,
            alert_urgency_id=alert_urgency_id,
        )
