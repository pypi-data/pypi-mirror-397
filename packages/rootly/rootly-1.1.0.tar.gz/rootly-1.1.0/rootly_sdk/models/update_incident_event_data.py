...
from ..models.update_incident_event_data_type import UpdateIncidentEventDataType, check_update_incident_event_data_type
...
class UpdateIncidentEventData:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        type_ = check_update_incident_event_data_type(d.pop("type"))
