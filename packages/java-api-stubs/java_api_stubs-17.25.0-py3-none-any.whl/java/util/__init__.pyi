...
class Base64(Object):
    class Decoder(Object):
        def decode(
            self,
            arg: Union[str, unicode, ByteBuffer, List[int]],
    ...
    class Encoder(Object):
        ...
        def encodeToString(self, src: List[int]) -> Union[str, unicode]: ...
...
class Calendar(Object):
    ...
    @staticmethod
    def getAvailableCalendarTypes() -> Set[Union[str, unicode]]: ...
    @staticmethod
...
class TimeZone(Object):
    ...
    def setID(self, ID: Union[str, unicode]) -> None: ...
...
class UUID(Object):
    ...
    @staticmethod
    def fromString(name: Union[str, unicode]) -> UUID: ...
