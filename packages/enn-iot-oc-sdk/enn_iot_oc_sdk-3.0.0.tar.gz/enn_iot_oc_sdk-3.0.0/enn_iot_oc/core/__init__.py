...
def set_token(auth_token: str, csrf_token: str) -> None:
    ...
    print(f"Authentication set - auth_token: {auth_token[:10]}..., csrf_token: {csrf_token[:10]}...")
...
def set_biz(context: BizContext) -> None:
    ...
    print(f"Business context set - eo_id: {context.eo_id}, instance_id: {context.instance_id}")
