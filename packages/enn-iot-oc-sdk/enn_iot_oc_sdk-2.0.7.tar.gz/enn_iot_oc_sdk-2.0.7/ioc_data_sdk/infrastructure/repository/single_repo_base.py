...
class SingleRepoBase(Generic[T], ABC):
    """
    base class for single-row repositories
    ...
    def find(self) -> Optional[T]:
        ...
        """
        print(f"Finding single row for model: {self.model_code}")
        ...
        print(f"No data found for {self.model_code}, returning None")
        return None
    ...
    def save(self, entity: T) -> None:
       ...
       implementation of save() method
        ...
        """
        print(f"Saving entity for model: {self.model_code}")
