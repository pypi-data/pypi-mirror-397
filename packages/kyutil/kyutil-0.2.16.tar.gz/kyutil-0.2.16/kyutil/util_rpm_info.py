...
def cmp_repo(iso, base_iso, log_handler=None):
    ...
    Returns:
        [
            {
                "iso_nvr": "libubsan-static-7.3.0-2020033101.58.p02.ky10.x86_64.rpm",
                "ijo_nvf": "libubsan-static-7.3.0-2020033101.58.p01.ky10.x86_64.rpm",
                "need": "upgrade"  # downgrade、delete、add
                "pkg_iso": ['libubsan-static-7.3.0-2020033101.58.p02.ky10.x86_64.rpm'],
                "pkg_ijo": ['libubsan-static-7.3.0-2020033101.58.p01.ky10.x86_64.rpm']
            },
        ]
        @param iso:
        @param base_iso:
    ...
    rim_iso = load_repodata_src2rpm(repo_dir_1, iso.is_pungi)
    rim_base = load_repodata_src2rpm(repo_dir_2, base_iso.is_pungi)
