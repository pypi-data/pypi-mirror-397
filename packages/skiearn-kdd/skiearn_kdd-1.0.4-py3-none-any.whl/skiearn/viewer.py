...
DOCS = {
    ...
    '14': {
        ...
        'topics': 'Complete ML pipeline, feature selection, imbalanced data, hyperparameters'
    },
    '15': {
        'file': 'doc1.txt',
        'title': 'Original KDD Documentation 📄',
        'topics': 'Complete original documentation, all topics combined'
    },
    'r': {
        'file': 'README.txt',
...
def view_all_files():
    ...
    for key in sorted([k for k in DOCS.keys() if k.isdigit()], key=int):
        ...
        if key != '15':  # Don't prompt after last file
