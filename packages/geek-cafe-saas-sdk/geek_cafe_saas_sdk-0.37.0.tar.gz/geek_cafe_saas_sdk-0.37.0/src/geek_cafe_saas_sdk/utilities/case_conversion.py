...
class CaseConverter:
    ...
    Usage:
        ...
        data = {"user_name": "John", "created_at": "2024-01-01"}
    ...
    def convert_keys(
        ...
        return CaseConverter._convert_keys_recursive(data, convert_func, deep)
    ...
    def _convert_keys_recursive(
        ...
        if isinstance(data, dict):
            ...
            for key, value in data.items():
                ...
                new_dict[new_key] = (
                    CaseConverter._convert_keys_recursive(value, convert_func, deep)
                    if deep
                    else value
                )
            return new_dict
            ...
            return [
                (
                    CaseConverter._convert_keys_recursive(item, convert_func, deep)
                    if deep
                    else item
                )
                for item in data
