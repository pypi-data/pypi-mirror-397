...
def success_response(
    ...
    convert_to_camel_case: bool = True,
    start_time: Optional[float] = None,
) -> Dict[str, Any]:
    """
    Create a successful API Gateway response with optional camelCase conversion.

    Args:
        data: Response data to include in body
        status_code: HTTP status code (default: 200)
        message: Optional success message
        convert_to_camel_case: If True, converts snake_case to camelCase for frontend (default: True)
    ...
    """
    # Convert data to camelCase for UI consumption (if requested)
...
def service_result_to_response(
    ...
    Args:
        ...
        convert_to_camel_case: If True, converts response to camelCase (default: True)
    ...
    if result.success:
        ...
        return success_response(data, success_status, convert_to_camel_case=convert_to_camel_case, start_time=start_time)
    else:
