<a id="types-boto3-arc-region-switch"></a>
...
[boto3 ARCRegionswitch 1.42.13](https://pypi.org/project/boto3/) compatible
...
1. Run mypy-boto3-builder in your package root directory:
   `uvx --with 'boto3==1.42.13' mypy-boto3-builder`
...
list_route53_health_checks_in_region_paginator: ListRoute53HealthChecksInRegionPaginator = (
    client.get_paginator("list_route53_health_checks_in_region")
)
