...
from cloudbase_agent.agents import BaseAgent
...
class CrewAIAgent(BaseAgent):
    ...
    def __init__(self, name: str, description: str, flow: Flow, fix_event_ids: bool = True):
    ...
    async def run(self, run_input: RunAgentInput) -> AsyncGenerator[BaseEvent, None]:
        ...
        Example:
            Running the agent::
                ...
                agent = CrewAIAgent(name="CrewBot", description="...", flow=flow)
