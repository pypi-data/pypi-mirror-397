...
ENTRY_POINTS = {
    "console_scripts": [
        f"daccuracy={DESCRIPTION['IMPORT_NAME']}.cli.main:Main",
        f"two-d-labeled-slices-to-3d={DESCRIPTION['IMPORT_NAME']}.cli.two_d_labeled_slices_to_3d:Main",
    ],
    "gui_scripts": [
        f"daccuracy-ui={DESCRIPTION['IMPORT_NAME']}.nicegui.main:Main",
    ],
}
...
def Version() -> str:
    ...
    if isinstance(output, str) and r.fullmatch(r"20[0-9]{2}\.[1-9][0-9]*", output):
        return output
