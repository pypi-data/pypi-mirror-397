...
def init_tracing(
    ...
    try:
        from opentelemetry import trace  # type: ignore[unresolved-import]
        from opentelemetry.sdk.resources import SERVICE_NAME, Resource  # type: ignore[unresolved-import]
        from opentelemetry.sdk.trace import TracerProvider  # type: ignore[unresolved-import]
        from opentelemetry.sdk.trace.export import BatchSpanProcessor  # type: ignore[unresolved-import]
    ...
    if otlp_endpoint or otlp_protocol:
        ...
        if protocol in ("grpc", ""):
            try:
                from opentelemetry.exporter.otlp.proto.grpc.trace_exporter import (  # type: ignore[unresolved-import]
                    OTLPSpanExporter,
                )
