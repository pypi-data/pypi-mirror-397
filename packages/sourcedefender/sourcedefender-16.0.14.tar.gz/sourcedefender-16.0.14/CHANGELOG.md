## 16.0.14
- Added --debug flag for encrypt command to allow debugging of encrypted code at runtime (requires allow_debugging in license).
- Added --tracebacks flag for encrypt command to show full tracebacks for encrypted code at runtime (requires allow_tracebacks in license).
- Fixed allow_debugging setting not being respected for VSCode debugger and other debuggers attached at import time.
