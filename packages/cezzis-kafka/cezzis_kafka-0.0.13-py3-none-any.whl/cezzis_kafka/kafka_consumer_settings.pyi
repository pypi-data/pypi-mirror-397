...
class KafkaConsumerSettings:
    ...
    def __init__(self, consumer_id: int, bootstrap_servers: str, consumer_group: str, topic_name: str, num_consumers: int = 1, max_poll_interval_ms: int = 300000, auto_offset_reset: str = 'earliest') -> None: ...
