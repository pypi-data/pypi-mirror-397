...
if __name__ == "__main__":
    ...
    parser.add_argument("--limited", action="store_true",
                        help="Use limited search (1,2,3-layer combos + all layers) instead of exhaustive")
    parser.add_argument("--contiguous", action="store_true",
                        help="Use contiguous search (adjacent layers only) - fastest option")
    parser.add_argument("--max-combo-size", type=int, default=3,
                        help="Max combination size for limited search (default: 3)")
