...
class GetBatchAsyncInferDetailPayload:
    ...
    succeeded_request_num: int
    failed_request_num: int
    created_at: str
    user_email: str
    progress: float
    description: str = ""
    ...
    def from_dict(cls, data: Dict) -> 'GetBatchAsyncInferDetailPayload':
        return cls(
            ...
            error_file_path=data.get("error_file_path", ""),
            ...
            succeeded_request_num=data.get("succeeded_request_num", 0),
            failed_request_num=data.get("failed_request_num", 0),
            max_waiting_hour=data.get("max_waiting_hour", 24),
            created_at=data.get("created_at", ""),
