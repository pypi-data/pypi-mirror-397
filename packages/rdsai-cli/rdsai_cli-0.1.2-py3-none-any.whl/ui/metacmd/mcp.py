...
def _mcp_list(app: ShellREPL):
    ...
    console.print(table)
    console.print()
    console.print("[dim]Commands: /mcp view <name>, /mcp connect <name>, /mcp disconnect <name>, /mcp enable <name>, /mcp disable <name>[/dim]")
...
async def _mcp_reload(app: ShellREPL):
    ...
    try:
        ...
        console.print(f"[green]✓[/green] Reloaded. {len(new_config.servers)} servers configured, {len(enabled_servers)} enabled.")
