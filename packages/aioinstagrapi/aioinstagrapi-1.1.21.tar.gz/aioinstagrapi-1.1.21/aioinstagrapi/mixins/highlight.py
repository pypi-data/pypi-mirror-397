...
from aioinstagrapi.exceptions import HighlightNotFound
from aioinstagrapi.extractors import extract_highlight_v1
from aioinstagrapi.models import Highlight
...
class HighlightMixin:
    ...
    async def user_highlights_v1(self, user_id: str, amount: int = 0) -> List[Highlight]:
        """
    ...
    async def user_highlights(self, user_id: str, amount: int = 0) -> List[Highlight]:
        """
