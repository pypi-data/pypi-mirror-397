...
class ClientNoGifPermissions(ClientError):
    """Raised due to lack of gif permissions on comments"""

class NoGifPermissions(ClientError):
    """Raised due to lack of gif permissions on comments"""
...
class ClientSuspended(ClientError):
    """Raised due to suspended account"""
...
class GenericComments(PrivateError):
    pass

class CommentsDisabledError(PrivateError):
    pass
...
class ScrapingBlock(PrivateError):
    pass

class InternalServerError(PrivateError):
    pass
