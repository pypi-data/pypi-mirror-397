...
from aioinstagrapi.models import Location, Media, Usertag
from aioinstagrapi.utils import date_time_original, dumps
...
class UploadAlbumMixin:
    async def album_upload(
        ...
        for attempt in range(50):
            ...
            try:
                configured = (configure_handler or await self.album_configure)(
