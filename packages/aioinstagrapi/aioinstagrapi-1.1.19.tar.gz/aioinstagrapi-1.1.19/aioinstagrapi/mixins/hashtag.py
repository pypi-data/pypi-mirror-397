...
class HashtagMixin:
    ...
    async def hashtag_info(self, name: str) -> Hashtag:
        ...
        try:
            ...
            # such this - https://github.com/subzeroid/aioinstagrapi/issues/364
