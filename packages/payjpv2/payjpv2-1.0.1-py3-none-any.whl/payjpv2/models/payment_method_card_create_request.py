...
class PaymentMethodCardCreateRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["customer_id", "billing_details", "metadata", "type", "card"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "card": PaymentMethodCreateCardDetailsRequest.from_dict(obj["card"]) if obj.get("card") is not None else None
        })
        return _obj
