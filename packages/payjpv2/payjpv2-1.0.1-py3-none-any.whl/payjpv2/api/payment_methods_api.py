...
class PaymentMethodsApi:
    ...
    def _create_payment_method_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if payment_method_create_request is not None:
            _body_params = payment_method_create_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v2/payment_methods',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _get_payment_method_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v2/payment_methods/{payment_method_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_payment_method_by_card(
        self,
        card_id: StrictStr,
        *,
        request_timeout: Union[
        ...
        _param = self._get_payment_method_by_card_serialize(
            card_id=card_id,
            _request_auth=request_auth,
            _content_type='application/json',
            _headers=headers,
    ...
    @validate_call
    def get_payment_method_by_card_with_http_info(
        self,
        card_id: StrictStr,
        *,
        request_timeout: Union[
    ...
    @validate_call
    def get_payment_method_by_card_without_preload_content(
        self,
        card_id: StrictStr,
        *,
        request_timeout: Union[
    ...
    def _get_payment_method_by_card_serialize(
        self,
        card_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v2/payment_methods/cards/{card_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def update_payment_method(
        ...
        *,
        ...
        :param payment_method_id: (required)
        :type payment_method_id: str
        :param payment_method_update_request: (required)
        :type payment_method_update_request: PaymentMethodUpdateRequest
        :param request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_payment_method_serialize(
            payment_method_id=payment_method_id,
            payment_method_update_request=payment_method_update_request,
            _request_auth=request_auth,
            _content_type='application/json',
            _headers=headers,
            _idempotency_key=idempotency_key,
    ...
    def _update_payment_method_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if payment_method_update_request is not None:
            _body_params = payment_method_update_request
