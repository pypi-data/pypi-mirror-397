...
class PaymentRefundsApi:
    ...
    def create_payment_refund(
        self,
        payment_refund_create_request: PaymentRefundCreateRequest,
        *,
        ...
        :param payment_refund_create_request: (required)
        :type payment_refund_create_request: PaymentRefundCreateRequest
        ...
        _param = self._create_payment_refund_serialize(
            payment_refund_create_request=payment_refund_create_request,
    ...
    @validate_call
    def create_payment_refund_with_http_info(
        self,
        payment_refund_create_request: PaymentRefundCreateRequest,
        *,
        request_timeout: Union[
    ...
    @validate_call
    def create_payment_refund_without_preload_content(
        self,
        payment_refund_create_request: PaymentRefundCreateRequest,
        *,
        request_timeout: Union[
    ...
    def _create_payment_refund_serialize(
        self,
        payment_refund_create_request,
        _request_auth,
        _content_type,
        _headers,
        _idempotency_key,
        ...
        if payment_refund_create_request is not None:
            _body_params = payment_refund_create_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v2/payment_refunds',
    ...
    def get_all_payment_refunds(
        ...
        *,
        ...
        _param = self._get_all_payment_refunds_serialize(
            limit=limit,
    ...
    @validate_call
    def get_all_payment_refunds_with_http_info(
        self,
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="取得するデータの最大件数")] = None,
        starting_after: Annotated[Optional[StrictStr], Field(description="このIDより後のデータを取得")] = None,
        ending_before: Annotated[Optional[StrictStr], Field(description="このIDより前のデータを取得")] = None,
    ...
    @validate_call
    def get_all_payment_refunds_without_preload_content(
        self,
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="取得するデータの最大件数")] = None,
        starting_after: Annotated[Optional[StrictStr], Field(description="このIDより後のデータを取得")] = None,
        ending_before: Annotated[Optional[StrictStr], Field(description="このIDより前のデータを取得")] = None,
    ...
    def _get_all_payment_refunds_serialize(
        self,
        limit,
        starting_after,
        ending_before,
    ...
    def get_payment_refund(
        ...
        *,
        ...
        :param payment_refund_id: (required)
        :type payment_refund_id: str
        :param request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def _get_payment_refund_serialize(
        ...
        if payment_refund_id is not None:
            _path_params['payment_refund_id'] = payment_refund_id
        # process the query parameters
        # process the header parameters
        # process the form parameters
        # process the body parameter
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v2/payment_refunds/{payment_refund_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def update_payment_refund(
        self,
        payment_refund_id: StrictStr,
        payment_refund_update_request: PaymentRefundUpdateRequest,
        *,
        request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param payment_refund_id: (required)
        :type payment_refund_id: str
        :param payment_refund_update_request: (required)
        :type payment_refund_update_request: PaymentRefundUpdateRequest
        :param request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_payment_refund_serialize(
            payment_refund_id=payment_refund_id,
            payment_refund_update_request=payment_refund_update_request,
            _request_auth=request_auth,
            _content_type='application/json',
            _headers=headers,
            _idempotency_key=idempotency_key,
    ...
    @validate_call
    def update_payment_refund_with_http_info(
        self,
        payment_refund_id: StrictStr,
        payment_refund_update_request: PaymentRefundUpdateRequest,
        *,
    ...
    @validate_call
    def update_payment_refund_without_preload_content(
        self,
        payment_refund_id: StrictStr,
        payment_refund_update_request: PaymentRefundUpdateRequest,
        *,
    ...
    def _update_payment_refund_serialize(
        self,
        payment_refund_id,
        payment_refund_update_request,
        _request_auth,
        _content_type,
        _headers,
        _idempotency_key,
        ...
        # process the form parameters
        # process the body parameter
        if payment_refund_update_request is not None:
            _body_params = payment_refund_update_request
