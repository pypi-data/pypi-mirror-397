...
class TestSetupFlowCreateRequest(unittest.TestCase):
    """SetupFlowCreateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SetupFlowCreateRequest:
        """Test SetupFlowCreateRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SetupFlowCreateRequest`
        """
    ...
    def testSetupFlowCreateRequest(self):
        """Test SetupFlowCreateRequest"""
