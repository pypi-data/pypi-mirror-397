...
class StatementURLResponse(BaseModel):
    """
    ...
    def object_validate_enum(cls, value):
        ...
        if value not in set(['statement_url']):
            raise ValueError("must be one of enum values ('statement_url')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "object": obj.get("object") if obj.get("object") is not None else 'statement_url',
            "url": obj.get("url"),
