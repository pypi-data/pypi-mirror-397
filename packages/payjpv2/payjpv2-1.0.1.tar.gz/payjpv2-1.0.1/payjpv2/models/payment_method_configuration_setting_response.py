...
class PaymentMethodConfigurationSettingResponse(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "display_preference": PaymentMethodConfigurationDisplayPreference.from_dict(obj["display_preference"]) if obj.get("display_preference") is not None else None
        })
        return _obj
