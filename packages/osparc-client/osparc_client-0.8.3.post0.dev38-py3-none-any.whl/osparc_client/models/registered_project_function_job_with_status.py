...
class RegisteredProjectFunctionJobWithStatus(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["title", "description", "function_uid", "inputs", "outputs", "function_class", "uid", "created_at", "status", "project_job_id", "job_creation_task_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RegisteredProjectFunctionJobWithStatus from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RegisteredProjectFunctionJobWithStatus from a dict"""
        if obj is None:
            return None
