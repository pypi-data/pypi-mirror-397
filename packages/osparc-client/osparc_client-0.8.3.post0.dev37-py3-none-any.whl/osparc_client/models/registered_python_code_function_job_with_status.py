...
class RegisteredPythonCodeFunctionJobWithStatus(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["title", "description", "function_uid", "inputs", "outputs", "function_class", "uid", "created_at", "status"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RegisteredPythonCodeFunctionJobWithStatus from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RegisteredPythonCodeFunctionJobWithStatus from a dict"""
        if obj is None:
            return None
