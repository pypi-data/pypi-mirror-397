...
class RegisteredSolverFunction(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["function_class", "title", "description", "input_schema", "output_schema", "default_inputs", "uid", "created_at", "modified_at", "solver_key", "solver_version"]
