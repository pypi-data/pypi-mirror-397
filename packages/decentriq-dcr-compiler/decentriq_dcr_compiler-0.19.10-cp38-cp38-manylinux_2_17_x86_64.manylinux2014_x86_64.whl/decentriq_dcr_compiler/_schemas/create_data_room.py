...
#   filename:  create_data_room.json
...
class CreateDataRoom2(BaseModel):
    kind: Kind
...
class CreateDataRoom(RootModel[CreateDataRoom2]):
    root: CreateDataRoom2 = Field(..., title='CreateDataRoom')
