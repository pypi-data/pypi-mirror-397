...
Welcome to ``nwp500-python`` contributor's guide.
...
If you experience bugs or general issues with ``nwp500-python``, please have a look
...
You can help improve ``nwp500-python`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``nwp500-python`` documentation uses Sphinx_ as its main documentation compiler.
...
that any documentation update is done in the same way was a code contribution.
   ...
   .. tip::
      ...
      propose changes in ``nwp500-python``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n nwp500-python python=3 six virtualenv pytest pytest-cov
    conda activate nwp500-python
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:eman/nwp500-python.git
    cd nwp500-python
...
.. _repository: https://github.com/eman/nwp500-python
.. _issue tracker: https://github.com/eman/nwp500-python/issues
