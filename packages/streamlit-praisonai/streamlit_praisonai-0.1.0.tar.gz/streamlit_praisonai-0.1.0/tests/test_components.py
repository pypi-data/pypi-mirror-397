"""Streamlit PraisonAI Components Tests - TDD"""
...
class TestPraisonAIChatComponent:
    """Test PraisonAI chat component."""

    def test_chat_function_exists(self):
        from streamlit_praisonai import praisonai_chat
        assert praisonai_chat is not None
        assert callable(praisonai_chat)
