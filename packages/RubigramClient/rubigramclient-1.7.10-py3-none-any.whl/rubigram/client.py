...
class Client(Methods):
    ...
    Parameters:
        ...
        timeout (float, optional):
            Total timeout for HTTP requests in seconds. Defaults to 30.0.

        connect_timeout (float, optional):
            Connection establishment timeout in seconds. Defaults to 10.0.

        read_timeout (float, optional):
            Socket read timeout in seconds. Defaults to 20.0.
