...
class GrpcBindingServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_GrpcBindingServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
        "grpc_binding.GrpcBinding", rpc_method_handlers
    )
