"""Test the Claude Agent SDK instrumentation."""
...
class TestClaudeAgentSdkInstrumentation(BaseLocalOtel):
    """Test the Claude Agent SDK instrumentation."""

    @pytest.mark.asyncio
    async def test_basic(self) -> None:
        """Test basic Claude Agent SDK instrumentation."""
        ...
        assert llm_call.name == "Claude Agent SDK Response"
    ...
    def test_llm_tools_extraction(self) -> None:
        ...
        from atla_insights.frameworks.instrumentors.claude_agent_sdk import _get_llm_tools
