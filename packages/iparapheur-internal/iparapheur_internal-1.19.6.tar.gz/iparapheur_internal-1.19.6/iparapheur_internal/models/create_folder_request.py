...
class CreateFolderRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "dueDate", "metadata", "draftCreationDate", "type", "subtype", "originUser", "originDesk", "finalDesk", "isReadByCurrentUser", "state", "legacyId", "typeId", "subtypeId", "stepList", "documentList", "signatureProofList", "readByUserIds", "variableDesksIds", "detachedSignaturesMapping", "visibility", "readByCurrentUser"]
