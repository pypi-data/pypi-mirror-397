...
class CurrentUserApi:
    ...
    @validate_call
    def get_administered_desks_for_tenant(
        self,
        tenant_id: StrictStr,
        ...
        Returns every desks administered by this user for this tenant.
        ...
        _param = self._get_administered_desks_for_tenant_serialize(
            tenant_id=tenant_id,
            page=page,
            size=size,
            sort=sort,
    ...
    @validate_call
    def get_administered_desks_for_tenant_with_http_info(
        self,
        tenant_id: StrictStr,
        page: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Zero-based page index (0..N)")] = None,
        size: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="The size of the page to be returned")] = None,
    ...
    @validate_call
    def get_administered_desks_for_tenant_without_preload_content(
        self,
        tenant_id: StrictStr,
        page: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Zero-based page index (0..N)")] = None,
        size: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="The size of the page to be returned")] = None,
    ...
    def _get_administered_desks_for_tenant_serialize(
        self,
        tenant_id,
        page,
        size,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/internal/currentUser/administeredDesksForTenant/{tenantId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_administered_desks_for_tenant_by_user(
        self,
        ...
        size: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="The size of the page to be returned")] = None,
        sort: Annotated[Optional[List[StrictStr]], Field(description="Sorting criteria in the format: property,(asc|desc). Default sort order is ascending. Multiple sort criteria are supported.")] = None,
        search_term: Annotated[Optional[StrictStr], Field(description="Searching by user")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        Returns every desks associated with a user administered by the current user for a given tenant.
        ...
        :param sort: Sorting criteria in the format: property,(asc|desc). Default sort order is ascending. Multiple sort criteria are supported.
        :type sort: List[str]
        :param search_term: Searching by user
        :type search_term: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._get_administered_desks_for_tenant_by_user_serialize(
            tenant_id=tenant_id,
    ...
    @validate_call
    def get_administered_desks_for_tenant_by_user_with_http_info(
        self,
        tenant_id: Annotated[StrictStr, Field(description="Tenant id")],
        collapse_all: Annotated[Optional[StrictBool], Field(description="Collapse (or expand) desks in the tree hierarchy.")] = None,
        reverse_id_list: Annotated[Optional[List[StrictStr]], Field(description="Reversed ID list. * If `collapseAll` is `true`, children of given desk IDs will be retrieved. * If `collapseAll` is `false`, children of given desk IDs won't be retrieved. ")] = None,
    ...
    @validate_call
    def get_administered_desks_for_tenant_by_user_without_preload_content(
        self,
        tenant_id: Annotated[StrictStr, Field(description="Tenant id")],
        collapse_all: Annotated[Optional[StrictBool], Field(description="Collapse (or expand) desks in the tree hierarchy.")] = None,
        reverse_id_list: Annotated[Optional[List[StrictStr]], Field(description="Reversed ID list. * If `collapseAll` is `true`, children of given desk IDs will be retrieved. * If `collapseAll` is `false`, children of given desk IDs won't be retrieved. ")] = None,
    ...
    def _get_administered_desks_for_tenant_by_user_serialize(
        self,
        tenant_id,
        collapse_all,
        reverse_id_list,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/internal/currentUser/administeredDesksByUserForTenant/{tenantId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
