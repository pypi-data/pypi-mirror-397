...
class CapacityUpdateType(object):
    ...
    Allowed enum values:
        ...
        - _UNKNOWN
        - _REDACTED
        - INCREASE: Percentage specified in the capacity update workload (adjusted) states an increase in workload.
        - DECREASE: Percentage specified in the capacity update workload (adjusted) states a decrease in workload.
    """
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    INCREASE = "INCREASE"
    ...
    def _initialize_object_type(self):
        return 'aiops.v4.config.CapacityUpdateType'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(CapacityUpdateType, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CapacityUpdateType):
            return False
