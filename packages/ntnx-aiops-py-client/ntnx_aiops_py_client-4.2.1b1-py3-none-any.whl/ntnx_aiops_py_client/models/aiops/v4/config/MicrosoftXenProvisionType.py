...
class MicrosoftXenProvisionType(object):
    ...
    Allowed enum values:
        ...
        - _UNKNOWN
        - _REDACTED
        - VM_CLONE: Indicates Microsoft Xen workload provision type: VM clone.
    """
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    VM_CLONE = "VM_CLONE"
    ...
    def _initialize_object_type(self):
        return 'aiops.v4.config.MicrosoftXenProvisionType'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(MicrosoftXenProvisionType, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MicrosoftXenProvisionType):
            return False
