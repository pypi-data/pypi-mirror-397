...
from ntnx_aiops_py_client.models.OneOfaiops.v4.config.GenerateRecommendationApiResponsedata import GenerateRecommendationApiResponsedata  # noqa: F401,E501
from ntnx_aiops_py_client.models.common.v1.response.ApiResponseMetadata import ApiResponseMetadata  # noqa: F401,E501

class GenerateRecommendationApiResponse(object):
    ...
    swagger_types = {
        ...
        'data': 'OneOfaiops.v4.config.GenerateRecommendationApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'aiops.v4.config.GenerateRecommendationApiResponse'
    ...
    def data(self):
        ...
        :type:
                :class:`~ntnx_aiops_py_client.models.prism.v4.config.TaskReference` | 
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GenerateRecommendationApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GenerateRecommendationApiResponse):
            return False
