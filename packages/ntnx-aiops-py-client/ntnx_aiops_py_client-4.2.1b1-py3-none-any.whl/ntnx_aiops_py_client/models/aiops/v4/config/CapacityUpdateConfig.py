...
from ntnx_aiops_py_client.models.aiops.v4.config.CapacityUpdateType import CapacityUpdateType  # noqa: F401,E501

class CapacityUpdateConfig(object):

    """CapacityUpdateConfig workload.

    :param percentage_change: (:attr:`percentage_change`) Percentage change in demand in case of capacity update workload.
    :type percentage_change: required
    
    
    :param change_type: (:attr:`change_type`) 
    :type change_type: required
    ...
    swagger_types = {
        ...
        'change_type': 'aiops.v4.config.CapacityUpdateType',
    ...
    def __init__(self, percentage_change=None, change_type=None, *args, **kwargs):  # noqa: E501
        self.__percentage_change = None
    ...
    def _initialize_object_type(self):
        return 'aiops.v4.config.CapacityUpdateConfig'
    ...
    def percentage_change(self, percentage_change):
        if percentage_change is None:
            raise ValueError("Invalid value for `percentage_change`, must not be `None`")  # noqa: E501
    ...
    def change_type(self):
        ...
        :type:
            :class:`~ntnx_aiops_py_client.models.aiops.v4.config.CapacityUpdateType`
        """  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(CapacityUpdateConfig, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CapacityUpdateConfig):
            return False
