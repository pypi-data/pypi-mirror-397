...
class SqlTransactionType(object):
    ...
    Allowed enum values:
        ...
        - _UNKNOWN
        - _REDACTED
        - OLAP: SQL instance is for Online Analytical Processing (OLAP).
        - OLTP: SQL instance is for Online Transaction Processing (OLTP).
    """
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    OLAP = "OLAP"
    ...
    def _initialize_object_type(self):
        return 'aiops.v4.config.SqlTransactionType'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(SqlTransactionType, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SqlTransactionType):
            return False
