...
from ntnx_aiops_py_client.models.aiops.v4.config.DataStoreConfig import DataStoreConfig  # noqa: F401,E501
from ntnx_aiops_py_client.models.aiops.v4.config.NodeConfig import NodeConfig  # noqa: F401,E501

class ClusterConfig(object):

    """Cluster specification.

    :param data_store_config: (:attr:`data_store_config`) 
    :type data_store_config: 
    
    
    :param node_configs: (:attr:`node_configs`) List containing the metadata about the nodes in a cluster. Nodes can be user added or existing.
    :type node_configs: 
    ...
    """  # noqa: E501
    swagger_types = {
        'data_store_config': 'aiops.v4.config.DataStoreConfig',
        'node_configs': 'list[aiops.v4.config.NodeConfig]',
    ...
    def __init__(self, data_store_config=None, node_configs=None, *args, **kwargs):  # noqa: E501
        self.__data_store_config = None
        self.__node_configs = None
        self.discriminator = None
        if data_store_config is not None:
            self.__data_store_config = data_store_config
        if node_configs is not None:
            self.__node_configs = node_configs
        # populate hidden vars if not empty
        self._populate_hidden_vars(kwargs)

    def _initialize_object_type(self):
        return 'aiops.v4.config.ClusterConfig'
    ...
    def data_store_config(self):
        ...
        :type:
            :class:`~ntnx_aiops_py_client.models.aiops.v4.config.DataStoreConfig`
        """  # noqa: E501
        return self.__data_store_config
    ...
    def node_configs(self):
        ...
        :type:
             list[ :class:`~ntnx_aiops_py_client.models.aiops.v4.config.NodeConfig` ]
        """  # noqa: E501
