...
class ReplicationFactor(object):
    ...
    Allowed enum values:
        ...
        - _UNKNOWN
        - _REDACTED
        - RF_2: At least two nodes in a cluster should hold the data.
        - RF_3: At least three nodes in a cluster should hold the data.
    """
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    RF_2 = "RF_2"
    ...
    def _initialize_object_type(self):
        return 'aiops.v4.config.ReplicationFactor'
