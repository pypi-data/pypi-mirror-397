...
class VdiUserType(object):
    ...
    Allowed enum values:
        ...
        - _UNKNOWN
        - _REDACTED
        - TASK_WORKER: Indicates VDI user type as Task Worker.
        - KNOWLEDGE_WORKER: Indicates VDI user type as Knowledge Worker.
        - POWER_USER: Indicates VDI user type as Power User.
        - DEVELOPER: Indicates VDI user type as Developer.
    """
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    ...
    def _initialize_object_type(self):
        return 'aiops.v4.config.VdiUserType'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VdiUserType, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VdiUserType):
            return False
