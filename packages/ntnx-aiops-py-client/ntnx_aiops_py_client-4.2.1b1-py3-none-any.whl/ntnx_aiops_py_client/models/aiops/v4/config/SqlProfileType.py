...
class SqlProfileType(object):
    ...
    Allowed enum values:
        ...
        - _UNKNOWN
        - _REDACTED
        - SMALL: SQL database size is small.
        - MEDIUM: SQL database size is medium.
        - LARGE: SQL database size is large.
    """
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    SMALL = "SMALL"
    ...
    def _initialize_object_type(self):
        return 'aiops.v4.config.SqlProfileType'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(SqlProfileType, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SqlProfileType):
            return False
