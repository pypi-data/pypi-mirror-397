...
class XenOperatingSystem(object):
    ...
    Allowed enum values:
        ...
        - _UNKNOWN
        - _REDACTED
        - WINDOWS_2012R2: Indicates operating system Windows 2012R2.
        - WINDOWS_2008R2: Indicates operating system Windows 2008R2.
    """
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    WINDOWS_2012R2 = "WINDOWS_2012R2"
    WINDOWS_2008R2 = "WINDOWS_2008R2"
    ...
    def _initialize_object_type(self):
        return 'aiops.v4.config.XenOperatingSystem'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(XenOperatingSystem, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, XenOperatingSystem):
            return False
