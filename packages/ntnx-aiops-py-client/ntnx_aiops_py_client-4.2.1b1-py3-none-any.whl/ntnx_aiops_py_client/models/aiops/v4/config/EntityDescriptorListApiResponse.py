...
from ntnx_aiops_py_client.models.OneOfaiops.v4.config.EntityDescriptorListApiResponsedata import EntityDescriptorListApiResponsedata  # noqa: F401,E501
from ntnx_aiops_py_client.models.common.v1.response.ApiResponseMetadata import ApiResponseMetadata  # noqa: F401,E501

class EntityDescriptorListApiResponse(object):
    ...
    swagger_types = {
        ...
        'data': 'OneOfaiops.v4.config.EntityDescriptorListApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'aiops.v4.config.EntityDescriptorListApiResponse'
    ...
    def data(self):
        ...
        :type:
                :class:`~ntnx_aiops_py_client.models.aiops.v4.config.EntityDescriptor` | 
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(EntityDescriptorListApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EntityDescriptorListApiResponse):
            return False
