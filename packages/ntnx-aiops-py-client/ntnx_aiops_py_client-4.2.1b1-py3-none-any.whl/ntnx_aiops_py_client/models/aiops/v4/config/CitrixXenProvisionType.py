...
class CitrixXenProvisionType(object):
    ...
    Allowed enum values:
        ...
        - _UNKNOWN
        - _REDACTED
        - PVS: Indicates Citrix Xen workload provision type: PVS.
        - MCS: Indicates Citrix Xen workload provision type: MCS.
    """
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    PVS = "PVS"
    ...
    def _initialize_object_type(self):
        return 'aiops.v4.config.CitrixXenProvisionType'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(CitrixXenProvisionType, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CitrixXenProvisionType):
            return False
