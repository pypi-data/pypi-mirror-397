...
class EntityType(ExternalizableAbstractModel):

    """

    :param entity_type_name: (:attr:`entity_type_name`) Entity type of the data supported for a given source. For example VM, cluster etc.
    ...
    def __init__(self, entity_type_name=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
        ExternalizableAbstractModel.__init__(self, ext_id, links, tenant_id, *args, **kwargs)
        self.__entity_type_name = None
        self.discriminator = None
        if entity_type_name is not None:
            self.__entity_type_name = entity_type_name

    def _initialize_object_type(self):
        return 'aiops.v4.config.EntityType'
    ...
    def entity_type_name(self):
        ...
        :type:
                :class:`~str`
        """  # noqa: E501
        return self.__entity_type_name

    @entity_type_name.setter
    def entity_type_name(self, entity_type_name):
        if entity_type_name is not None and len(entity_type_name) > 50:
            raise ValueError("Invalid value for `entity_type_name`, length must be less than or equal to `50`")  # noqa: E501
