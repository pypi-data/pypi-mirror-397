...
class VdiVendor(object):
    ...
    Allowed enum values:
        ...
        - _UNKNOWN
        - _REDACTED
        - VIEW: Indicates VDI workload vendor View.
        - XEN_DESKTOP: Indicates VDI workload vendor XenDesktop.
    """
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    VIEW = "VIEW"
    XEN_DESKTOP = "XEN_DESKTOP"
    ...
    def _initialize_object_type(self):
        return 'aiops.v4.config.VdiVendor'
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VdiVendor):
            return False
