...
class CapacityType(object):
    ...
    Allowed enum values:
        ...
        - _UNKNOWN
        - _REDACTED
        - ORIGINAL: Original capacity type.
        - ONE_NODE_FAILURE: One node failure capacity type.
        - BLOCK_AWARENESS: Capacity type with block awareness.
        - AUTO_DETECT: Capacity type with auto detect selected.
    """
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    ORIGINAL = "ORIGINAL"
    ONE_NODE_FAILURE = "ONE_NODE_FAILURE"
    ...
    def _initialize_object_type(self):
        return 'aiops.v4.config.CapacityType'
