...
class StrList(object):
    ...
    :param str_list: (:attr:`str_list`) Value is a list of strings.
    :type str_list: required
    ...
    def __init__(self, str_list=None, *args, **kwargs):  # noqa: E501
        self.__str_list = None
        self.discriminator = None
        self.__str_list = str_list
        # populate hidden vars if not empty
        self._populate_hidden_vars(kwargs)

    def _initialize_object_type(self):
        return 'aiops.v4.stats.StrList'
    ...
    def str_list(self, str_list):
        if str_list is None:
            raise ValueError("Invalid value for `str_list`, must not be `None`")  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StrList):
            return False
