...
from ntnx_aiops_py_client.models.OneOfaiops.v4.stats.Pointvalue import Pointvalue  # noqa: F401,E501

class Point(object):

    """

    :param value: (:attr:`value`) The data point value at the specified timestamp, this value can either be an integer, boolean, string, double, or a list of these types.
    :type value: 
    
    
    :param timestamp: (:attr:`timestamp`) The timestamp of the metric value.
    :type timestamp: 
    ...
    """  # noqa: E501
    swagger_types = {
        'value': 'OneOfaiops.v4.stats.Pointvalue',
        'timestamp': 'datetime',
    ...
    def value(self):
        ...
        :type:
                :class:`~ntnx_aiops_py_client.models.aiops.v4.stats.StrVal` | 
                :class:`~ntnx_aiops_py_client.models.aiops.v4.stats.BoolVal` | 
                :class:`~ntnx_aiops_py_client.models.aiops.v4.stats.IntVal` | 
                :class:`~ntnx_aiops_py_client.models.aiops.v4.stats.DoubleVal` | 
                :class:`~ntnx_aiops_py_client.models.aiops.v4.stats.StrList` | 
                :class:`~ntnx_aiops_py_client.models.aiops.v4.stats.BoolList` | 
                :class:`~ntnx_aiops_py_client.models.aiops.v4.stats.IntList` | 
                :class:`~ntnx_aiops_py_client.models.aiops.v4.stats.DoubleList`
        """  # noqa: E501
        return self.__value
