...
class EntityListApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<aiops.v4.stats.Entity>': 'list[aiops.v4.stats.Entity]',
    ...
    def _initialize_object_type(self):
        return 'OneOfaiops.v4.stats.EntityListApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in EntityListApiResponsedata.discriminator_value_class_map.values():
            return list(EntityListApiResponsedata.discriminator_value_class_map.keys())[list(EntityListApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(EntityListApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EntityListApiResponsedata):
            return False
