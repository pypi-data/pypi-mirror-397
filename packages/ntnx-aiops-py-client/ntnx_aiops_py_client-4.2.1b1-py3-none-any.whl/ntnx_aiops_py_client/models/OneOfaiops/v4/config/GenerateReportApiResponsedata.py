...
class GenerateReportApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfaiops.v4.config.GenerateReportApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GenerateReportApiResponsedata.discriminator_value_class_map.values():
            return list(GenerateReportApiResponsedata.discriminator_value_class_map.keys())[list(GenerateReportApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GenerateReportApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GenerateReportApiResponsedata):
            return False
