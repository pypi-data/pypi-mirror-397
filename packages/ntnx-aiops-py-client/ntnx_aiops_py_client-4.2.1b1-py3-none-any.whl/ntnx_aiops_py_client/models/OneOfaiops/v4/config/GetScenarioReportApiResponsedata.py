...
class GetScenarioReportApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfaiops.v4.config.GetScenarioReportApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetScenarioReportApiResponsedata.discriminator_value_class_map.values():
            return list(GetScenarioReportApiResponsedata.discriminator_value_class_map.keys())[list(GetScenarioReportApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetScenarioReportApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetScenarioReportApiResponsedata):
            return False
