...
class CreateSimulationApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'aiops.v4.config.Simulation': 'aiops.v4.config.Simulation',
    ...
    def _initialize_object_type(self):
        return 'OneOfaiops.v4.config.CreateSimulationApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in CreateSimulationApiResponsedata.discriminator_value_class_map.values():
            return list(CreateSimulationApiResponsedata.discriminator_value_class_map.keys())[list(CreateSimulationApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(CreateSimulationApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateSimulationApiResponsedata):
            return False
