...
class UpdateSimulationApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<aiops.v4.error.AppMessage>': 'list[aiops.v4.error.AppMessage]',
    ...
    def _initialize_object_type(self):
        return 'OneOfaiops.v4.config.UpdateSimulationApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in UpdateSimulationApiResponsedata.discriminator_value_class_map.values():
            return list(UpdateSimulationApiResponsedata.discriminator_value_class_map.keys())[list(UpdateSimulationApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(UpdateSimulationApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateSimulationApiResponsedata):
            return False
