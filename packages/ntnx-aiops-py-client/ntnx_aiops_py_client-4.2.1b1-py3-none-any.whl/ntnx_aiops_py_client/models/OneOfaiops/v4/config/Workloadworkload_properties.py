...
class Workloadworkload_properties(object):
    ...
    discriminator_value_class_map = {
        ...
        'aiops.v4.config.SqlWorkload': 'aiops.v4.config.SqlWorkload',
        'aiops.v4.config.VmWorkload': 'aiops.v4.config.VmWorkload',
        'aiops.v4.config.VdiWorkload': 'aiops.v4.config.VdiWorkload',
        'aiops.v4.config.SplunkWorkload': 'aiops.v4.config.SplunkWorkload',
        'aiops.v4.config.CitrixXenWorkload': 'aiops.v4.config.CitrixXenWorkload',
        'aiops.v4.config.MicrosoftXenWorkload': 'aiops.v4.config.MicrosoftXenWorkload',
        'aiops.v4.config.CapacityUpdateConfig': 'aiops.v4.config.CapacityUpdateConfig',
        'aiops.v4.config.VmCategoryWorkload': 'aiops.v4.config.VmCategoryWorkload'
    }

    ONE_OF_ITEM_DISCRIMINATOR_NAME = '$workloadPropertiesItemDiscriminator'
    ...
    def _initialize_object_type(self):
        return 'OneOfaiops.v4.config.Workloadworkload_properties'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in Workloadworkload_properties.discriminator_value_class_map.values():
            return list(Workloadworkload_properties.discriminator_value_class_map.keys())[list(Workloadworkload_properties.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(Workloadworkload_properties, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, Workloadworkload_properties):
            return False
