...
class GetScenarioApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'aiops.v4.config.Scenario': 'aiops.v4.config.Scenario',
    ...
    def _initialize_object_type(self):
        return 'OneOfaiops.v4.config.GetScenarioApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetScenarioApiResponsedata.discriminator_value_class_map.values():
            return list(GetScenarioApiResponsedata.discriminator_value_class_map.keys())[list(GetScenarioApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetScenarioApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetScenarioApiResponsedata):
            return False
