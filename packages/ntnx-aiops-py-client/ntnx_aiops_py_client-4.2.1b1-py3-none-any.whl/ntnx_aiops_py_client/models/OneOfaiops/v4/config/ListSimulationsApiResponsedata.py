...
class ListSimulationsApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<aiops.v4.config.Simulation>': 'list[aiops.v4.config.Simulation]',
        'aiops.v4.error.ErrorResponse': 'aiops.v4.error.ErrorResponse',
        'List<aiops.v4.config.SimulationProjection>': 'list[aiops.v4.config.SimulationProjection]'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOfaiops.v4.config.ListSimulationsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListSimulationsApiResponsedata.discriminator_value_class_map.values():
            return list(ListSimulationsApiResponsedata.discriminator_value_class_map.keys())[list(ListSimulationsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListSimulationsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListSimulationsApiResponsedata):
            return False
