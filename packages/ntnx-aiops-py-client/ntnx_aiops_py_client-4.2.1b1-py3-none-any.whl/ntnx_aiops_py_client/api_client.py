...
from ntnx_aiops_py_client import rest
...
class ApiClient(object):
    ...
    # Populated if multiple schemas exist with the same name
        'aiops.v4.stats.DoubleList' : 'DoubleList',
        'aiops.v4.stats.IntList' : 'IntList',
        'aiops.v4.config.GetScenarioReportApiResponse' : 'GetScenarioReportApiResponse',
        'aiops.v4.config.SimulatedVmResourceSpecProjection' : 'SimulatedVmResourceSpecProjection',
        'common.v1.config.IPv4Address' : 'IPv4Address',
        'OneOfaiops.v4.config.GetScenarioApiResponsedata' : 'GetScenarioApiResponsedata',
        'common.v1.stats.DownSamplingOperator' : 'DownSamplingOperator',
        'aiops.v4.config.GenerateRecommendationApiResponse' : 'GenerateRecommendationApiResponse',
        'common.v1.config.Flag' : 'Flag',
        'aiops.v4.config.MicrosoftXenWorkload' : 'MicrosoftXenWorkload',
        'OneOfaiops.v4.config.DeleteSimulationApiResponsedata' : 'DeleteSimulationApiResponsedata',
        'aiops.v4.config.SqlProfileType' : 'SqlProfileType',
        'aiops.v4.clusterMetrics.Cluster' : 'Cluster',
        'aiops.v4.config.EntityDescriptor' : 'EntityDescriptor',
        'aiops.v4.config.ListSimulationsApiResponse' : 'ListSimulationsApiResponse',
        'aiops.v4.config.VmWorkload' : 'VmWorkload',
        'aiops.v4.stats.StrList' : 'StrList',
        'prism.v4.config.TaskReference' : 'TaskReference',
        'OneOfaiops.v4.config.Workloadworkload_properties' : 'Workloadworkload_properties',
        'aiops.v4.stats.Entity' : 'Entity',
        'aiops.v4.stats.Point' : 'Point',
        'aiops.v4.config.Scenario' : 'Scenario',
        'aiops.v4.clusterMetrics.Node' : 'Node',
        'aiops.v4.stats.Metric' : 'Metric',
        'OneOfaiops.v4.config.EntityDescriptorListApiResponsedata' : 'EntityDescriptorListApiResponsedata',
        'aiops.v4.config.GenerateRunwayApiResponse' : 'GenerateRunwayApiResponse',
        'aiops.v4.config.CitrixXenWorkloadVendor' : 'CitrixXenWorkloadVendor',
        'aiops.v4.stats.BoolList' : 'BoolList',
        'OneOfaiops.v4.error.ErrorResponseerror' : 'ErrorResponseerror',
        'OneOfaiops.v4.stats.EntityListApiResponsedata' : 'EntityListApiResponsedata',
        'aiops.v4.config.NodeConfig' : 'NodeConfig',
        'aiops.v4.config.SimulationProjection' : 'SimulationProjection',
        'aiops.v4.config.ValueRange' : 'ValueRange',
        'aiops.v4.config.NodeSource' : 'NodeSource',
        'OneOfaiops.v4.config.EntityTypeListApiResponsedata' : 'EntityTypeListApiResponsedata',
        'aiops.v4.config.VdiWorkload' : 'VdiWorkload',
        'aiops.v4.config.DeleteSimulationApiResponse' : 'DeleteSimulationApiResponse',
        'aiops.v4.clusterMetrics.NodeProjection' : 'NodeProjection',
        'aiops.v4.config.SqlWorkload' : 'SqlWorkload',
        'aiops.v4.error.ErrorResponse' : 'ErrorResponse',
        'aiops.v4.config.ClusterConfig' : 'ClusterConfig',
        'common.v1.config.MapOfStringWrapper' : 'MapOfStringWrapper',
        'aiops.v4.clusterMetrics.VmProjection' : 'VmProjection',
        'aiops.v4.config.SqlTransactionType' : 'SqlTransactionType',
        'common.v1.response.ApiResponseMetadata' : 'ApiResponseMetadata',
        'aiops.v4.config.MetricDescriptor' : 'MetricDescriptor',
        'aiops.v4.error.SchemaValidationError' : 'SchemaValidationError',
        'aiops.v4.config.ResourceCapacity' : 'ResourceCapacity',
        'aiops.v4.config.CreateScenarioApiResponse' : 'CreateScenarioApiResponse',
        'aiops.v4.config.CapacityType' : 'CapacityType',
        'OneOfaiops.v4.config.GenerateRecommendationApiResponsedata' : 'GenerateRecommendationApiResponsedata',
        'aiops.v4.config.GenerateReportApiResponse' : 'GenerateReportApiResponse',
        'OneOfaiops.v4.config.CreateScenarioApiResponsedata' : 'CreateScenarioApiResponsedata',
        'OneOfaiops.v4.stats.Pointvalue' : 'Pointvalue',
        'aiops.v4.config.ClusterType' : 'ConfigClusterType',
        'aiops.v4.config.PolicyType' : 'PolicyType',
        'common.v1.response.ExternalizableAbstractModel' : 'ExternalizableAbstractModel',
        'aiops.v4.config.VdiProvisionType' : 'VdiProvisionType',
        'OneOfaiops.v4.config.GenerateReportApiResponsedata' : 'GenerateReportApiResponsedata',
        'aiops.v4.config.DataStoreConfig' : 'DataStoreConfig',
        'aiops.v4.config.XenWorkload' : 'XenWorkload',
        'common.v1.config.Message' : 'Message',
        'aiops.v4.config.XfitPolicy' : 'XfitPolicy',
        'aiops.v4.config.EntityDescriptorListApiResponse' : 'EntityDescriptorListApiResponse',
        'aiops.v4.config.EntityTypeListApiResponse' : 'EntityTypeListApiResponse',
        'aiops.v4.config.CitrixXenProvisionType' : 'CitrixXenProvisionType',
        'aiops.v4.stats.TimeSeries' : 'TimeSeries',
        'OneOfaiops.v4.config.SourceListApiResponsedata' : 'SourceListApiResponsedata',
        'aiops.v4.config.SplunkWorkload' : 'SplunkWorkload',
        'OneOfcommon.v1.config.KVPairvalue' : 'KVPairvalue',
        'aiops.v4.config.CapacityUpdateConfig' : 'CapacityUpdateConfig',
        'aiops.v4.config.GetSimulationApiResponse' : 'GetSimulationApiResponse',
        'OneOfaiops.v4.config.CreateSimulationApiResponsedata' : 'CreateSimulationApiResponsedata',
        'OneOfaiops.v4.config.UpdateSimulationApiResponsedata' : 'UpdateSimulationApiResponsedata',
        'aiops.v4.config.Vendor' : 'Vendor',
        'aiops.v4.config.VdiVendor' : 'VdiVendor',
        'aiops.v4.config.VdiUserType' : 'VdiUserType',
        'aiops.v4.clusterMetrics.Vm' : 'Vm',
        'aiops.v4.config.XfitPolicyProjection' : 'XfitPolicyProjection',
        'aiops.v4.common.ClusterType' : 'CommonClusterType',
        'aiops.v4.config.ScenarioProjection' : 'ScenarioProjection',
        'aiops.v4.config.UpdateSimulationApiResponse' : 'UpdateSimulationApiResponse',
        'common.v1.config.MessageSeverity' : 'MessageSeverity',
        'aiops.v4.config.CapacityUnit' : 'CapacityUnit',
        'aiops.v4.config.CitrixXenWorkload' : 'CitrixXenWorkload',
        'aiops.v4.error.SchemaValidationErrorMessage' : 'SchemaValidationErrorMessage',
        'aiops.v4.config.EntityType' : 'EntityType',
        'aiops.v4.config.SimulatedVmResourceSpec' : 'SimulatedVmResourceSpec',
        'OneOfaiops.v4.config.GetSimulationApiResponsedata' : 'GetSimulationApiResponsedata',
        'aiops.v4.clusterMetrics.ClusterMetrics' : 'ClusterMetrics',
        'OneOfaiops.v4.config.ListScenariosApiResponsedata' : 'ListScenariosApiResponsedata',
        'aiops.v4.config.SourceListApiResponse' : 'SourceListApiResponse',
        'aiops.v4.config.EntityDetail' : 'EntityDetail',
        'OneOfaiops.v4.config.DeleteScenarioApiResponsedata' : 'DeleteScenarioApiResponsedata',
        'common.v1.response.ApiLink' : 'ApiLink',
        'aiops.v4.config.GetScenarioApiResponse' : 'GetScenarioApiResponse',
        'aiops.v4.config.ReplicationFactor' : 'ReplicationFactor',
        'aiops.v4.config.UpdateScenarioApiResponse' : 'UpdateScenarioApiResponse',
        'OneOfaiops.v4.config.UpdateScenarioApiResponsedata' : 'UpdateScenarioApiResponsedata',
        'aiops.v4.stats.BoolVal' : 'BoolVal',
        'aiops.v4.stats.EntityListApiResponse' : 'EntityListApiResponse',
        'OneOfaiops.v4.config.GenerateRunwayApiResponsedata' : 'GenerateRunwayApiResponsedata',
        'aiops.v4.config.ListScenariosApiResponse' : 'ListScenariosApiResponse',
        'aiops.v4.stats.StrVal' : 'StrVal',
        'aiops.v4.error.AppMessage' : 'AppMessage',
        'aiops.v4.config.VmCategoryWorkload' : 'VmCategoryWorkload',
        'aiops.v4.config.Source' : 'Source',
        'aiops.v4.config.ValueType' : 'ValueType',
        'aiops.v4.config.MicrosoftXenWorkloadVendor' : 'MicrosoftXenWorkloadVendor',
        'aiops.v4.config.CreateSimulationApiResponse' : 'CreateSimulationApiResponse',
        'aiops.v4.config.Workload' : 'Workload',
        'OneOfaiops.v4.config.ListSimulationsApiResponsedata' : 'ListSimulationsApiResponsedata',
        'aiops.v4.stats.IntVal' : 'IntVal',
        'common.v1.config.TenantAwareModel' : 'TenantAwareModel',
        'aiops.v4.config.XenOperatingSystem' : 'XenOperatingSystem',
        'aiops.v4.config.Runway' : 'Runway',
        'aiops.v4.config.MicrosoftXenProvisionType' : 'MicrosoftXenProvisionType',
        'aiops.v4.stats.DoubleVal' : 'DoubleVal',
        'aiops.v4.config.DeleteScenarioApiResponse' : 'DeleteScenarioApiResponse',
        'OneOfaiops.v4.config.GetScenarioReportApiResponsedata' : 'GetScenarioReportApiResponsedata',
        'aiops.v4.clusterMetrics.ClusterProjection' : 'ClusterProjection',
        'aiops.v4.config.CapacityUpdateType' : 'CapacityUpdateType',
        'aiops.v4.config.Simulation' : 'Simulation',
    ...
    def negotiate_version(self, auth_settings):
        ...
        """
        try:
            response = self.__call_api('/api/aiops/unversioned/info', 'OPTIONS',
                                        response_type = 'object', auth_settings = auth_settings)
            if response is not None and "data" in response:
                server_version = response["data"]
                minimum_supported_version = "v4.2.b1"
    ...
    def __call_api(
        ...
        if response_data.status == 401:
            ...
            if response_data.status == 401:
                raise ntnx_aiops_py_client.rest.ApiException(http_resp=response_data)
    ...
    def __deserialize_response(self, response, response_type):
        ...
        :type response: :class:`~ntnx_aiops_py_client.rest.RESTResponse`, required
    ...
    def _call_api(self, resource_path, method,
        ...
        :param _request_timeout: Timeout setting for this request. It needs to be a pair (list) of
            ...
            the timeouts will be derived from the :class:`~ntnx_aiops_py_client.configuration.Configuration`.
    ...
    def __deserialize_file(self, response):
        ...
        :param response: :class:`~ntnx_aiops_py_client.rest.RESTResponse`
        :return: File path
        """
    ...
    def __deserialize_date(self, string):
        ...
        :param string:
        :type string: str
        :raises :class:`~ntnx_aiops_py_client.rest.ApiException` if provided string is not a valid date
        :return: date object
        """
    ...
    def __deserialize_datatime(self, string):
        ...
        :raises :class:`~ntnx_aiops_py_client.rest.ApiException` if provided string is not a valid datetime
    ...
    def __getattr(self, name):
        if name in self.DUPLICATE_SCHEMA_MAPPING:
            return getattr(ntnx_aiops_py_client.models, self.DUPLICATE_SCHEMA_MAPPING[name])
        if hasattr(ntnx_aiops_py_client.models, name.split('.')[-1]):
            return getattr(ntnx_aiops_py_client.models, name.split('.')[-1])
        else:
            return getattr(ntnx_aiops_py_client.models, name)
