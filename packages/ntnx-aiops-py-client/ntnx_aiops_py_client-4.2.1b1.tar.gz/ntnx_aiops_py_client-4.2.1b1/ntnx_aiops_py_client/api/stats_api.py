...
class StatsApi(object):
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/aiops/v4.2.b1/config/sources/{sourceExtId}/entity-descriptors', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def get_entity_metrics_v4(self, sourceExtId, extId, _startTime, _endTime, _page=None, _limit=None, _samplingInterval=None, _statType=None, _filter=None, _orderby=None, **kwargs):  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/aiops/v4.2.b1/stats/sources/{sourceExtId}/entities/{extId}', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def get_entity_types_v4(self, sourceExtId, **kwargs):  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/aiops/v4.2.b1/config/sources/{sourceExtId}/entity-types', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def get_sources_v4(self, **kwargs):  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/aiops/v4.2.b1/config/sources', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
