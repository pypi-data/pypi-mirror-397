...
class IntList(object):
    ...
    :param int_list: (:attr:`int_list`) Value is a list of integers.
    :type int_list: required
    ...
    def __init__(self, int_list=None, *args, **kwargs):  # noqa: E501
        self.__int_list = None
    ...
    def int_list(self, int_list):
        if int_list is None:
            raise ValueError("Invalid value for `int_list`, must not be `None`")  # noqa: E501
