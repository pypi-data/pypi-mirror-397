...
class SimulatedVmResourceSpec(object):
    ...
    def _initialize_object_type(self):
        return 'aiops.v4.config.SimulatedVmResourceSpec'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(SimulatedVmResourceSpec, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SimulatedVmResourceSpec):
            return False
