...
class PolicyType(object):
    ...
    Allowed enum values:
        ...
        - _UNKNOWN
        - _REDACTED
        - INEFFICIENCY_EXCLUSION: Policy to exclude entities from the inefficiency calculations.
        - ANOMALY_EXCLUSION: Policy to exclude entities from the anomaly detections.
    """
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    INEFFICIENCY_EXCLUSION = "INEFFICIENCY_EXCLUSION"
    ANOMALY_EXCLUSION = "ANOMALY_EXCLUSION"
    ...
    def _initialize_object_type(self):
        return 'aiops.v4.config.PolicyType'
