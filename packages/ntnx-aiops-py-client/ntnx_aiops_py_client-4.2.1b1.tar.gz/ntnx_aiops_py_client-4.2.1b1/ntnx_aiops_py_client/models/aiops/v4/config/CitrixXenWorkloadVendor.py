...
class CitrixXenWorkloadVendor(object):
    ...
    Allowed enum values:
        ...
        - _UNKNOWN
        - _REDACTED
        - XEN_APP: Indicates Citrix Xen workload vendor type: XenApp.
    """
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    XEN_APP = "XEN_APP"
    ...
    def _initialize_object_type(self):
        return 'aiops.v4.config.CitrixXenWorkloadVendor'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(CitrixXenWorkloadVendor, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CitrixXenWorkloadVendor):
            return False
