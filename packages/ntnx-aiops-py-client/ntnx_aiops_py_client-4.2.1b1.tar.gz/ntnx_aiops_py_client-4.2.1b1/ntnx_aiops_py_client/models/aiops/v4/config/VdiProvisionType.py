...
class VdiProvisionType(object):
    ...
    Allowed enum values:
        ...
        - _UNKNOWN
        - _REDACTED
        - FULL_CLONES: Indicates VDI workload provision type as Full Clones.
        - V2V_P2V: Indicates VDI workload provision type as V2V/P2V.
        - PROVISIONING_SERVICES: Indicates VDI workload provision type as Provisioning Services.
        - MACHINE_CREATION_SERVICES: Indicates VDI workload provision type as Machine Creation Services.
        - LINKED_CLONES: Indicates VDI workload provision type as Linked Clones.
    """
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    FULL_CLONES = "FULL_CLONES"
    V2V_P2V = "V2V_P2V"
    PROVISIONING_SERVICES = "PROVISIONING_SERVICES"
    MACHINE_CREATION_SERVICES = "MACHINE_CREATION_SERVICES"
    LINKED_CLONES = "LINKED_CLONES"
    ...
    def _initialize_object_type(self):
        return 'aiops.v4.config.VdiProvisionType'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VdiProvisionType, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VdiProvisionType):
            return False
