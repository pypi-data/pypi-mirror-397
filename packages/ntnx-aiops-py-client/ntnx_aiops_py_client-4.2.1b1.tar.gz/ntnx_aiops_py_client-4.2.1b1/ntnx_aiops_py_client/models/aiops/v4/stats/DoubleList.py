...
class DoubleList(object):
    ...
    :param double_list: (:attr:`double_list`) Value is a list of doubles.
    :type double_list: required
    ...
    def __init__(self, double_list=None, *args, **kwargs):  # noqa: E501
        self.__double_list = None
        self.discriminator = None
        self.__double_list = double_list
        # populate hidden vars if not empty
        self._populate_hidden_vars(kwargs)

    def _initialize_object_type(self):
        return 'aiops.v4.stats.DoubleList'
    ...
    def double_list(self):
        ...
        :type:
            list[ :class:`~float` ]
        """  # noqa: E501
        return self.__double_list

    @double_list.setter
    def double_list(self, double_list):
        if double_list is None:
            raise ValueError("Invalid value for `double_list`, must not be `None`")  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DoubleList):
            return False
