...
class MicrosoftXenWorkloadVendor(object):
    ...
    Allowed enum values:
        ...
        - _UNKNOWN
        - _REDACTED
        - MICROSOFT_RDSH: Indicates Microsoft Xen workload vendor type: Microsoft RDSH.
    """
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    MICROSOFT_RDSH = "MICROSOFT_RDSH"
    ...
    def _initialize_object_type(self):
        return 'aiops.v4.config.MicrosoftXenWorkloadVendor'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(MicrosoftXenWorkloadVendor, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MicrosoftXenWorkloadVendor):
            return False
