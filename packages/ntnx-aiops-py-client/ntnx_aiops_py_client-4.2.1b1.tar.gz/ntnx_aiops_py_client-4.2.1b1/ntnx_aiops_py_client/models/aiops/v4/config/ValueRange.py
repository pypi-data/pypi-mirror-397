...
class ValueRange(object):
    ...
    :param min: (:attr:`min`) Minimum value in the value range.
    :type min: 
    
    
    :param max: (:attr:`max`) Maximum value in the value range.
    :type max: 
    ...
    def __init__(self, min=None, max=None, *args, **kwargs):  # noqa: E501
        self.__min = None
        self.__max = None
    ...
    def _initialize_object_type(self):
        return 'aiops.v4.config.ValueRange'
