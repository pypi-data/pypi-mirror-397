...
from ntnx_aiops_py_client.models.OneOfaiops.v4.config.UpdateSimulationApiResponsedata import UpdateSimulationApiResponsedata  # noqa: F401,E501
from ntnx_aiops_py_client.models.common.v1.response.ApiResponseMetadata import ApiResponseMetadata  # noqa: F401,E501

class UpdateSimulationApiResponse(object):
    ...
    swagger_types = {
        ...
        'data': 'OneOfaiops.v4.config.UpdateSimulationApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'aiops.v4.config.UpdateSimulationApiResponse'
    ...
    def data(self):
        ...
        :type:
                :class:`~ntnx_aiops_py_client.models.aiops.v4.error.AppMessage` | 
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(UpdateSimulationApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateSimulationApiResponse):
            return False
