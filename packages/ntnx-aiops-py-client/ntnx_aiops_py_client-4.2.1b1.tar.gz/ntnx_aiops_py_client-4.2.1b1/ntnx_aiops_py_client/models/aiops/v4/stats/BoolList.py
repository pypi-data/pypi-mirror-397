...
class BoolList(object):
    ...
    :param bool_list: (:attr:`bool_list`) Value is a list of booleans.
    :type bool_list: required
    ...
    def __init__(self, bool_list=None, *args, **kwargs):  # noqa: E501
        self.__bool_list = None
    ...
    def _initialize_object_type(self):
        return 'aiops.v4.stats.BoolList'
    ...
    @bool_list.setter
    def bool_list(self, bool_list):
        if bool_list is None:
            raise ValueError("Invalid value for `bool_list`, must not be `None`")  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BoolList):
            return False
