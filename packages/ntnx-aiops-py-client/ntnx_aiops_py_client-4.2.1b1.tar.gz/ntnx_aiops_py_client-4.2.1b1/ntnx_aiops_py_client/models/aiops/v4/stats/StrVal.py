...
class StrVal(object):
    ...
    :param str_value: (:attr:`str_value`) Value is string.
    :type str_value: required
    ...
    def __init__(self, str_value=None, *args, **kwargs):  # noqa: E501
    ...
    def str_value(self, str_value):
        if str_value is None:
            raise ValueError("Invalid value for `str_value`, must not be `None`")  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StrVal):
            return False
