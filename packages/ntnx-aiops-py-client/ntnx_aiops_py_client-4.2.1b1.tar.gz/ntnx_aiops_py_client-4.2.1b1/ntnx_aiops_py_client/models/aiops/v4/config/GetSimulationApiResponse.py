...
from ntnx_aiops_py_client.models.OneOfaiops.v4.config.GetSimulationApiResponsedata import GetSimulationApiResponsedata  # noqa: F401,E501
from ntnx_aiops_py_client.models.common.v1.response.ApiResponseMetadata import ApiResponseMetadata  # noqa: F401,E501

class GetSimulationApiResponse(object):
    ...
    swagger_types = {
        ...
        'data': 'OneOfaiops.v4.config.GetSimulationApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'aiops.v4.config.GetSimulationApiResponse'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetSimulationApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetSimulationApiResponse):
            return False
