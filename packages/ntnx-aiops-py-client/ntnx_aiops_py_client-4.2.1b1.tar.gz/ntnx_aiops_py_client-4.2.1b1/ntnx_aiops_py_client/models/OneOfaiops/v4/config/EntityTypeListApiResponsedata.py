...
class EntityTypeListApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<aiops.v4.config.EntityType>': 'list[aiops.v4.config.EntityType]',
    ...
    def _initialize_object_type(self):
        return 'OneOfaiops.v4.config.EntityTypeListApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in EntityTypeListApiResponsedata.discriminator_value_class_map.values():
            return list(EntityTypeListApiResponsedata.discriminator_value_class_map.keys())[list(EntityTypeListApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(EntityTypeListApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EntityTypeListApiResponsedata):
            return False
