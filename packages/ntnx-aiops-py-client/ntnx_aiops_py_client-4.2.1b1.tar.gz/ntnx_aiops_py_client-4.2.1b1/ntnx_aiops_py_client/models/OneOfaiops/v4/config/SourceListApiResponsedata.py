...
class SourceListApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<aiops.v4.config.Source>': 'list[aiops.v4.config.Source]',
    ...
    def _initialize_object_type(self):
        return 'OneOfaiops.v4.config.SourceListApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in SourceListApiResponsedata.discriminator_value_class_map.values():
            return list(SourceListApiResponsedata.discriminator_value_class_map.keys())[list(SourceListApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(SourceListApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SourceListApiResponsedata):
            return False
