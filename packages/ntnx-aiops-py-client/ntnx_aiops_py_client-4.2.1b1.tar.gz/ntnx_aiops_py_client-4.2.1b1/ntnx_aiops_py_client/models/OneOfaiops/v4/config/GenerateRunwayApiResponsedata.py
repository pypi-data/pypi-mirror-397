...
class GenerateRunwayApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfaiops.v4.config.GenerateRunwayApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GenerateRunwayApiResponsedata.discriminator_value_class_map.values():
            return list(GenerateRunwayApiResponsedata.discriminator_value_class_map.keys())[list(GenerateRunwayApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GenerateRunwayApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GenerateRunwayApiResponsedata):
            return False
