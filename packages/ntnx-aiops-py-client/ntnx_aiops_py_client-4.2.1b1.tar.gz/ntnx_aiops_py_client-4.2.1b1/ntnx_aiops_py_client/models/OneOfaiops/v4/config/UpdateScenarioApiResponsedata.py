...
class UpdateScenarioApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfaiops.v4.config.UpdateScenarioApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in UpdateScenarioApiResponsedata.discriminator_value_class_map.values():
            return list(UpdateScenarioApiResponsedata.discriminator_value_class_map.keys())[list(UpdateScenarioApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(UpdateScenarioApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateScenarioApiResponsedata):
            return False
