...
class ListScenariosApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<aiops.v4.config.Scenario>': 'list[aiops.v4.config.Scenario]',
        'aiops.v4.error.ErrorResponse': 'aiops.v4.error.ErrorResponse',
        'List<aiops.v4.config.ScenarioProjection>': 'list[aiops.v4.config.ScenarioProjection]'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOfaiops.v4.config.ListScenariosApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListScenariosApiResponsedata.discriminator_value_class_map.values():
            return list(ListScenariosApiResponsedata.discriminator_value_class_map.keys())[list(ListScenariosApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListScenariosApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListScenariosApiResponsedata):
            return False
