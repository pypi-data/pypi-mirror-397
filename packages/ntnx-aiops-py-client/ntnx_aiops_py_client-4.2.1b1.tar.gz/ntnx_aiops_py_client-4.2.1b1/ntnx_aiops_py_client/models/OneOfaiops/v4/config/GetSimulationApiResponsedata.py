...
class GetSimulationApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfaiops.v4.config.GetSimulationApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetSimulationApiResponsedata.discriminator_value_class_map.values():
            return list(GetSimulationApiResponsedata.discriminator_value_class_map.keys())[list(GetSimulationApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetSimulationApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetSimulationApiResponsedata):
            return False
