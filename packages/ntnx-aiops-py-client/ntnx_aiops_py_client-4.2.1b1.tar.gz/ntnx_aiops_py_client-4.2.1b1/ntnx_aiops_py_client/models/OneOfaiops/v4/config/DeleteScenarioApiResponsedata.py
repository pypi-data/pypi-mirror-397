...
class DeleteScenarioApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfaiops.v4.config.DeleteScenarioApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in DeleteScenarioApiResponsedata.discriminator_value_class_map.values():
            return list(DeleteScenarioApiResponsedata.discriminator_value_class_map.keys())[list(DeleteScenarioApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(DeleteScenarioApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteScenarioApiResponsedata):
            return False
