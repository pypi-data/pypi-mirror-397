...
class EntityDescriptorListApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<aiops.v4.config.EntityDescriptor>': 'list[aiops.v4.config.EntityDescriptor]',
    ...
    def _initialize_object_type(self):
        return 'OneOfaiops.v4.config.EntityDescriptorListApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in EntityDescriptorListApiResponsedata.discriminator_value_class_map.values():
            return list(EntityDescriptorListApiResponsedata.discriminator_value_class_map.keys())[list(EntityDescriptorListApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(EntityDescriptorListApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EntityDescriptorListApiResponsedata):
            return False
