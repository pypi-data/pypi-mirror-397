...
def main():
    ...
    if os.path.exists(audio_file):
        combinations = [
            ("indus-stt-v1", False, "Valid - Non-Streaming"),
            ("indus-stt-v1", True, "Invalid - Streaming=True requires indus-stt-hi-en"),
            ("indus-stt-hi-en", False, "Valid - Non-Streaming"),
            ("indus-stt-hi-en", True, "Valid - Streaming"),
        ]
...
def performance_metrics_with_params():
    ...
    configs = [
        ("indus-stt-v1", False, None),
        ("indus-stt-hi-en", False, "hindi"),
        ("indus-stt-hi-en", True, "hindi"), # indus-stt-v1/True is now invalid, replaced with indus-stt-hi-en/True
    ]
...
def comprehensive_test():
    ...
    scenarios = [
        ("Indus-STT-V1 / Non-Streaming", "indus-stt-v1", False, None, True),
        ("Indus-STT-V1 / Streaming", "indus-stt-v1", True, None, False), # Invalid
        ("Indus-STT-Hi-En / Non-Streaming", "indus-stt-hi-en", False, "hindi", True),
        ("Indus-STT-Hi-En / Streaming", "indus-stt-hi-en", True, "hindi", True),
    ]
