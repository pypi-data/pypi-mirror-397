...
FTIGNORE_FILENAME = ".ftignore"
ROOT_FILENAME = "connector.py"
MAX_RECORDS_IN_BATCH = 100
MAX_BATCH_SIZE_IN_BYTES = 100000 # 100 KB
QUEUE_SIZE = 100
NO_RENAMING_ENFORCED = os.getenv("NO_RENAMING_ENFORCED", "false").lower() == "true"
...
VALID_COMMANDS = ["version", "init", "debug", "deploy", "reset"]
...
UTF_8 = "utf-8"
GITHUB_REPO = "fivetran/fivetran_connector_sdk"
GITHUB_BRANCH = "main"
AI_AGENTS = {
...
TEMPLATE_CONNECTOR_PATH = "template_connector"
