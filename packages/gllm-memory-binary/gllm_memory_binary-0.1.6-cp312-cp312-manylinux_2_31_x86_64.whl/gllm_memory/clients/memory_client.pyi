...
class BaseMemoryClient(ABC):
    ...
    async def add(self, user_id: str, agent_id: str, messages: list[Message] = None, scopes: set[MemoryScope] = None, metadata: dict[str, str] = None, infer: bool = True, is_important: bool = False) -> list[Chunk]:
        ...
        """
    @abstractmethod
    async def search(self, query: str, user_id: str | None = None, agent_id: str | None = None, scopes: set[MemoryScope] | None = None, metadata: dict[str, str] | None = None, threshold: float | None = 0.3, top_k: int | None = 10, include_important: bool = False) -> list[Chunk]:
