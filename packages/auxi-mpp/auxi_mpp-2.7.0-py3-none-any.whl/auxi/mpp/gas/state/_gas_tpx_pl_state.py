...
class GasTpxpLState(MaterialState):
    """
    Temperature, pressure, composition and gas geometry state for a gas.
    ...
    def check_model(self) -> Self:
        ...
        if len(self.compounds) < 3:
            raise ValueError("Three or more components should be provided.")
