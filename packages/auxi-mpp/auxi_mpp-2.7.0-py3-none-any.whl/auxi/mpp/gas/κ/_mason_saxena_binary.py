...
class MasonSaxenaBinary(Model[floatPositiveOrZero, floatPositiveOrZero, dict[str, floatFraction]]):
    """
    Binary gas thermal conductivity mixing rule by Mason and Saxena (1958), applied to unary models by Chung et al. (1988), Lemmon and Jacobsen (2004), Assael et al. (2011), and Huber et al. (2012).
    ...
    def calculate(
        ...
        """
        Calculate the thermal conductivty of a binary gas.

        Args:
            T: System temperature. [K]
            p: System pressure. [Pa]
            x: Chemical composition dictionary. [mol/mol] Eg. {"CO": 0.5, "N2": 0.5}.
