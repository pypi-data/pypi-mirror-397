...
from auxi.mpp.gas.Vm._clapeyron_binary import ClapeyronBinary
...
def test_clapeyron_binary(temperature: float, pressure: float, composition: dict[str, float]):
    """Test temperature and composition limits."""
    with warnings.catch_warnings():
        warnings.simplefilter("ignore")
        model = ClapeyronBinary()
...
def test_clapeyron_binary_errors(temperature: float, pressure: float, composition: dict[str, float]):
