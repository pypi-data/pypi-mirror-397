...
temperature_limits = [(298, 101325, {"CO2": 0.5, "CO": 0.5}), (2500, 101325, {"CO2": 0.5, "CO": 0.5})]

# positive test pressure tests
pressure_limits = [(1200, 50662.5, {"CO2": 0.5, "CO": 0.5}), (1200, 202650, {"CO2": 0.5, "CO": 0.5})]

# compilation of binary tests
binary_testing_inputs = temperature_limits + pressure_limits + composition_limits_binary

# error tests
temperature_limits_err = [(2501, 101325, {"CO2": 0.5, "CO": 0.5}), (297, 101325, {"CO2": 0.5, "H2O": 0.5})]
pressure_limits_err = [(1200, 50662, {"CO2": 0.5, "CO": 0.5}), (1200, 202651, {"CO2": 0.5, "H2O": 0.5})]
component_number_err = [(1200, 101325, {"CO2": 1.0}), (1200, 101325, {"CO2": 0.4, "H2O": 0.4, "CO": 0.2})]
