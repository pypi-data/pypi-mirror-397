...
class Macros:
    ...
    def get_wap_id(self):
        if indbt__wap_id is None:
            raise ValueError("WAP ID is not set")
        return indbt__wap_id
...
class UxpDatePropCalculator:
    ...
    def generate_date_properties(self, start_date: indbt__datetime, end_date: indbt__datetime, timezone: str = "US/Pacific") -> indbt__Dict[str, indbt__Any]:
        ...
        # Args: start_date (naive datetime), end_date (naive datetime), timezone (default: US/Pacific with DST)
        # Returns: Dictionary with date properties including timezone-aware epoch timestamps
        # Get DST-aware timezone objects for start and end dates
        ...
        # Apply timezone information to create timezone-aware datetimes
