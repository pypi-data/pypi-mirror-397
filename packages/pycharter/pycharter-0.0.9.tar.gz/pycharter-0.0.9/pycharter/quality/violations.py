...
from pycharter.runtime_validator.validator import ValidationResult
...
class ViolationTracker:
    ...
    def __init__(self, store=None, db_session: Optional["Session"] = None):
        ...
        Args:
            store: Optional metadata store (for backward compatibility)
            ...
            for field_violation in violation.field_violations:
                ...
                if deduplicate:
                    ...
                    if existing:
                        ...
                        # Update record_data if it has changed
                        if violation.record_data:
                            existing.record_data = violation.record_data
                ...
                violation_model = QualityViolationModel(
                    ...
                    additional_metadata=violation.metadata,
                )
