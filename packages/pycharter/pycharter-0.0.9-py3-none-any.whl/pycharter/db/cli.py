...
def _get_db_url(database_url: Optional[str] = None, required: bool = True) -> Optional[str]:
    ...
    if required and not db_url:
        ...
        print("   Provide as argument or set PYCHARTER_DATABASE_URL environment variable")
    return db_url
...
def main():
    ...
    init_parser.add_argument("database_url", nargs="?", help="Database connection string")
