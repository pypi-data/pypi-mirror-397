...
>>> from polarspark.serializers import MarshalSerializer
...
from polarspark import cloudpickle
from polarspark.util import print_exec
...
class CartesianDeserializer(Serializer):
    ...
    Due to polarspark batching we cannot simply use the result of the Java RDD cartesian,
...
class PairDeserializer(Serializer):
    ...
    Due to polarspark batching we cannot simply use the result of the Java RDD zip,
