...
# from polarspark.serializers import read_int, CPickleSerializer
from polarspark.errors import PySparkRuntimeError

if TYPE_CHECKING:
    from polarspark._typing import SupportsIAdd  # noqa: F401
...
def _deserialize_accumulator(
    ...
    from polarspark.accumulators import _accumulatorRegistry
