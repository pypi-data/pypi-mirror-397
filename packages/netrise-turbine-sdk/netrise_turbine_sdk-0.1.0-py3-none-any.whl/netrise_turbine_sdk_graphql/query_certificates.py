...
class QueryCertificatesCertificates(BaseModel):
    typename__: Literal["CertificateConnection"] = Field(alias="__typename")
...
class QueryCertificatesCertificatesEdges(BaseModel):
    typename__: Literal["CertificateEdge"] = Field(alias="__typename")
    cursor: str
    node: Optional["QueryCertificatesCertificatesEdgesNode"]


class QueryCertificatesCertificatesEdgesNode(BaseModel):
    typename__: Literal["CertificateNode"] = Field(alias="__typename")
