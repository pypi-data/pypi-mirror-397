...
class timescoping_signed_high_pass(Operator):
    ...
    def __init__(
        ...
        super().__init__(
            name="core::timescoping::signed_high_pass",
            config=config,
            server=server,
            inputs_type=InputsTimescopingSignedHighPass,
            outputs_type=OutputsTimescopingSignedHighPass,
        )
...
class InputsTimescopingSignedHighPass(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._both: Input[bool] = Input(
            timescoping_signed_high_pass._spec().input_pin(2), 2, op, -1
        )
