...
class OutputsFieldBandPass(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._field: Output[Field] = Output(
            field_band_pass._spec().output_pin(0), 0, op
        )
