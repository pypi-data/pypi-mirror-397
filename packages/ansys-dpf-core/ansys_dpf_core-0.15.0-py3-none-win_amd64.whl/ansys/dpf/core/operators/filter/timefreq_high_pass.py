...
class InputsTimefreqHighPass(_Inputs):
    """Intermediate class used to connect user inputs to
    timefreq_high_pass operator.
...
class OutputsTimefreqHighPass(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(timefreq_high_pass._spec().outputs, op)
        self._time_freq_support: Output[TimeFreqSupport] = Output(
            timefreq_high_pass._spec().output_pin(0), 0, op
        )
        self._outputs.append(self._time_freq_support)
        self._scoping: Output[Scoping] = Output(
            timefreq_high_pass._spec().output_pin(1), 1, op
        )
