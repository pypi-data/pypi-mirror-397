...
class timescoping_low_pass(Operator):
    ...
    def __init__(
        ...
        super().__init__(
            name="core::timescoping::low_pass",
            config=config,
            server=server,
            inputs_type=InputsTimescopingLowPass,
            outputs_type=OutputsTimescopingLowPass,
        )
...
class OutputsTimescopingLowPass(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(timescoping_low_pass._spec().outputs, op)
        self._scoping: Output[Scoping] = Output(
            timescoping_low_pass._spec().output_pin(0), 0, op
        )
