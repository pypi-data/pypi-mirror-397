...
class InputsIdenticalGenericDataContainers(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._generic_data_containerA: Input[GenericDataContainer] = Input(
            identical_generic_data_containers._spec().input_pin(0), 0, op, -1
        )
        self._inputs.append(self._generic_data_containerA)
        self._generic_data_containerB: Input[GenericDataContainer] = Input(
    ...
    @property
    def generic_data_containerA(self) -> Input[GenericDataContainer]:
    ...
    @property
    def generic_data_containerB(self) -> Input[GenericDataContainer]:
