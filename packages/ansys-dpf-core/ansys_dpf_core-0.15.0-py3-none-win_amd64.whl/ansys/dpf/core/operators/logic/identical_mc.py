...
class InputsIdenticalMc(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._meshes_containerA: Input[MeshesContainer] = Input(
            identical_mc._spec().input_pin(0), 0, op, -1
        )
        self._inputs.append(self._meshes_containerA)
        self._meshes_containerB: Input[MeshesContainer] = Input(
            identical_mc._spec().input_pin(1), 1, op, -1
        )
        self._inputs.append(self._meshes_containerB)
        self._small_value: Input[float] = Input(
            identical_mc._spec().input_pin(2), 2, op, -1
        )
        self._inputs.append(self._small_value)
        self._tolerance: Input[float] = Input(
            identical_mc._spec().input_pin(3), 3, op, -1
        )
        self._inputs.append(self._tolerance)
        self._compare_auxiliary: Input[bool] = Input(
            identical_mc._spec().input_pin(4), 4, op, -1
        )
        self._inputs.append(self._compare_auxiliary)

    @property
    def meshes_containerA(self) -> Input[MeshesContainer]:
    ...
    @property
    def meshes_containerB(self) -> Input[MeshesContainer]:
...
class OutputsIdenticalMc(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._message: Output[str] = Output(identical_mc._spec().output_pin(1), 1, op)
