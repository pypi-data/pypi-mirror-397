...
class InputsEnrichMaterials(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._MaterialContainer: Input = Input(
            enrich_materials._spec().input_pin(0), 0, op, -1
        )
        self._inputs.append(self._MaterialContainer)
        self._streams: Input[StreamsContainer | FieldsContainer] = Input(
    ...
    @property
    def streams(self) -> Input[StreamsContainer | FieldsContainer]:
...
class OutputsEnrichMaterials(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._MaterialContainer: Output[bool] = Output(
            enrich_materials._spec().output_pin(0), 0, op
        )
        self._outputs.append(self._MaterialContainer)

    @property
    def MaterialContainer(self) -> Output[bool]:
