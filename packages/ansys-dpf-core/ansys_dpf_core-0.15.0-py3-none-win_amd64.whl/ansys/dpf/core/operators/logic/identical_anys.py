...
class OutputsIdenticalAnys(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._included: Output[bool] = Output(
            identical_anys._spec().output_pin(0), 0, op
        )
        self._outputs.append(self._included)
        self._message: Output[str] = Output(identical_anys._spec().output_pin(1), 1, op)
        self._outputs.append(self._message)

    @property
    def included(self) -> Output[bool]:
