...
class InputsMinByComponent(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._use_absolute_value: Input[bool] = Input(
            min_by_component._spec().input_pin(0), 0, op, -1
        )
        self._inputs.append(self._use_absolute_value)
        self._field1: Input[Field | FieldsContainer] = Input(
            min_by_component._spec().input_pin(1), 1, op, 0
        )
        self._inputs.append(self._field1)
        self._field2: Input[Field | FieldsContainer] = Input(
            min_by_component._spec().input_pin(2), 2, op, 1
        )
        self._inputs.append(self._field2)

    @property
    def use_absolute_value(self) -> Input[bool]:
    ...
    @property
    def field1(self) -> Input[Field | FieldsContainer]:
    ...
    @property
    def field2(self) -> Input[Field | FieldsContainer]:
...
class OutputsMinByComponent(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._field: Output[Field] = Output(
            min_by_component._spec().output_pin(0), 0, op
        )
