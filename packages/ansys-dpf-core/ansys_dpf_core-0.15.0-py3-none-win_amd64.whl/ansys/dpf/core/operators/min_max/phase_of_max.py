...
class OutputsPhaseOfMax(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._field: Output[Field] = Output(phase_of_max._spec().output_pin(0), 0, op)
