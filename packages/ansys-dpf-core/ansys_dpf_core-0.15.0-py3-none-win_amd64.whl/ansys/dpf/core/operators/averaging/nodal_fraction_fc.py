...
class InputsNodalFractionFc(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._mesh: Input[MeshedRegion] = Input(
            nodal_fraction_fc._spec().input_pin(1), 1, op, -1
        )
        self._inputs.append(self._mesh)
        self._scoping: Input[Scoping] = Input(
            nodal_fraction_fc._spec().input_pin(3), 3, op, -1
        )
        self._inputs.append(self._scoping)
        self._denominator: Input[FieldsContainer] = Input(
            nodal_fraction_fc._spec().input_pin(6), 6, op, -1
        )
...
class OutputsNodalFractionFc(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Output[FieldsContainer] = Output(
            nodal_fraction_fc._spec().output_pin(0), 0, op
        )
