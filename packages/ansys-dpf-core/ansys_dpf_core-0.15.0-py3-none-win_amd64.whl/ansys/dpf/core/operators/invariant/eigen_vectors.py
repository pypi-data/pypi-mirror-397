...
class InputsEigenVectors(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._field: Input[FieldsContainer | Field] = Input(
            eigen_vectors._spec().input_pin(0), 0, op, -1
        )
        self._inputs.append(self._field)

    @property
    def field(self) -> Input[FieldsContainer | Field]:
...
class OutputsEigenVectors(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._field: Output[Field] = Output(eigen_vectors._spec().output_pin(0), 0, op)
