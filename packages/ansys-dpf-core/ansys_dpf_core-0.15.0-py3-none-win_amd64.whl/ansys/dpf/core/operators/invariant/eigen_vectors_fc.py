...
class eigen_vectors_fc(Operator):
    ...
    def __init__(self, fields_container=None, config=None, server=None):
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsEigenVectorsFc,
            outputs_type=OutputsEigenVectorsFc,
        )
...
class InputsEigenVectorsFc(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Input[FieldsContainer | Field] = Input(
            eigen_vectors_fc._spec().input_pin(0), 0, op, -1
        )
...
class OutputsEigenVectorsFc(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Output[FieldsContainer] = Output(
            eigen_vectors_fc._spec().output_pin(0), 0, op
        )
