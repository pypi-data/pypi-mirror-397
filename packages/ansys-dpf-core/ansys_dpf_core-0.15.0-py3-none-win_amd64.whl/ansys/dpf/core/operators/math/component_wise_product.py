...
class InputsComponentWiseProduct(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fieldA: Input[Field | FieldsContainer] = Input(
            component_wise_product._spec().input_pin(0), 0, op, -1
        )
        self._inputs.append(self._fieldA)
        self._fieldB: Input[Field | FieldsContainer] = Input(
            component_wise_product._spec().input_pin(1), 1, op, -1
        )
...
class OutputsComponentWiseProduct(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._field: Output[Field] = Output(
            component_wise_product._spec().output_pin(0), 0, op
        )
