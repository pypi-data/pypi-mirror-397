...
class InputsAddConstantFc(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Input[FieldsContainer] = Input(
            add_constant_fc._spec().input_pin(0), 0, op, -1
        )
        self._inputs.append(self._fields_container)
        self._weights: Input[float] = Input(
            add_constant_fc._spec().input_pin(1), 1, op, -1
        )
...
class OutputsAddConstantFc(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Output[FieldsContainer] = Output(
            add_constant_fc._spec().output_pin(0), 0, op
        )
