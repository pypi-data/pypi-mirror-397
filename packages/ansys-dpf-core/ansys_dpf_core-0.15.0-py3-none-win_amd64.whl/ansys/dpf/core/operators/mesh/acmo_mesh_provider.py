...
class InputsAcmoMeshProvider(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._assembly_mesh: Input = Input(
            acmo_mesh_provider._spec().input_pin(0), 0, op, -1
        )
        self._inputs.append(self._assembly_mesh)
        self._unit: Input[str] = Input(
            acmo_mesh_provider._spec().input_pin(1), 1, op, -1
        )
...
class OutputsAcmoMeshProvider(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._meshes_container: Output[MeshesContainer] = Output(
            acmo_mesh_provider._spec().output_pin(0), 0, op
        )
