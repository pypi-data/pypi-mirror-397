...
class InputsBeamProperties(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._streams: Input[StreamsContainer] = Input(
            beam_properties._spec().input_pin(3), 3, op, -1
        )
        self._inputs.append(self._streams)
        self._data_sources: Input[DataSources] = Input(
            beam_properties._spec().input_pin(4), 4, op, -1
        )
...
class OutputsBeamProperties(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._mesh_out: Output[MeshedRegion] = Output(
            beam_properties._spec().output_pin(0), 0, op
        )
        self._outputs.append(self._mesh_out)
        self._field_type_section_id: Output[Field] = Output(
            beam_properties._spec().output_pin(1), 1, op
        )
        self._outputs.append(self._field_type_section_id)
        self._field_area: Output[Field] = Output(
            beam_properties._spec().output_pin(2), 2, op
        )
        self._outputs.append(self._field_area)
        self._field_moment_inertia: Output[Field] = Output(
            beam_properties._spec().output_pin(3), 3, op
        )
        self._outputs.append(self._field_moment_inertia)
        self._field_geometry: Output[Field] = Output(
            beam_properties._spec().output_pin(4), 4, op
        )
        self._outputs.append(self._field_geometry)
        self._field_young_modulus: Output[Field] = Output(
            beam_properties._spec().output_pin(5), 5, op
        )
        self._outputs.append(self._field_young_modulus)
        self._field_poisson_ratio: Output[Field] = Output(
            beam_properties._spec().output_pin(6), 6, op
        )
        self._outputs.append(self._field_poisson_ratio)
        self._field_shear_modulus: Output[Field] = Output(
            beam_properties._spec().output_pin(7), 7, op
        )
        self._outputs.append(self._field_shear_modulus)
        self._field_beam_length: Output[Field] = Output(
            beam_properties._spec().output_pin(8), 8, op
        )
        self._outputs.append(self._field_beam_length)
        self._field_torsion_constant: Output[Field] = Output(
            beam_properties._spec().output_pin(9), 9, op
        )
        self._outputs.append(self._field_torsion_constant)
        self._field_warping_constant: Output[Field] = Output(
            beam_properties._spec().output_pin(10), 10, op
        )
        self._outputs.append(self._field_warping_constant)
        self._field_offset_type: Output[Field] = Output(
            beam_properties._spec().output_pin(11), 11, op
        )
        self._outputs.append(self._field_offset_type)
        self._field_offset_y: Output[Field] = Output(
            beam_properties._spec().output_pin(12), 12, op
        )
        self._outputs.append(self._field_offset_y)
        self._field_offset_z: Output[Field] = Output(
            beam_properties._spec().output_pin(13), 13, op
        )
        self._outputs.append(self._field_offset_z)

    @property
    def mesh_out(self) -> Output[MeshedRegion]:
    ...
    @property
    def field_type_section_id(self) -> Output[Field]:
    ...
    @property
    def field_area(self) -> Output[Field]:
    ...
    @property
    def field_moment_inertia(self) -> Output[Field]:
    ...
    @property
    def field_geometry(self) -> Output[Field]:
    ...
    @property
    def field_young_modulus(self) -> Output[Field]:
    ...
    @property
    def field_poisson_ratio(self) -> Output[Field]:
    ...
    @property
    def field_shear_modulus(self) -> Output[Field]:
    ...
    @property
    def field_beam_length(self) -> Output[Field]:
    ...
    @property
    def field_torsion_constant(self) -> Output[Field]:
    ...
    @property
    def field_warping_constant(self) -> Output[Field]:
    ...
    @property
    def field_offset_type(self) -> Output[Field]:
    ...
    @property
    def field_offset_y(self) -> Output[Field]:
    ...
    @property
    def field_offset_z(self) -> Output[Field]:
