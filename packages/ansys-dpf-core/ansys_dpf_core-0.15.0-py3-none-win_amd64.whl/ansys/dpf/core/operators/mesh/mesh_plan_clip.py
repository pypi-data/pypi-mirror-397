...
class InputsMeshPlanClip(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._mesh_or_field: Input[MeshedRegion | Field] = Input(
            mesh_plan_clip._spec().input_pin(0), 0, op, -1
        )
        self._inputs.append(self._mesh_or_field)
        self._normal: Input[Field] = Input(
            mesh_plan_clip._spec().input_pin(1), 1, op, -1
        )
        self._inputs.append(self._normal)
        self._origin: Input[Field] = Input(
            mesh_plan_clip._spec().input_pin(2), 2, op, -1
        )
        self._inputs.append(self._origin)

    @property
    def mesh_or_field(self) -> Input[MeshedRegion | Field]:
...
class OutputsMeshPlanClip(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._mesh: Output[MeshedRegion] = Output(
            mesh_plan_clip._spec().output_pin(2), 2, op
        )
