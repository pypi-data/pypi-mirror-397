...
class InputsKmeansClustering(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._clusters_number: Input[int] = Input(
            kmeans_clustering._spec().input_pin(0), 0, op, -1
        )
        self._inputs.append(self._clusters_number)
        self._formula: Input[str] = Input(
            kmeans_clustering._spec().input_pin(1), 1, op, -1
        )
    ...
    @property
    def clusters_number(self) -> Input[int]:
...
class OutputsKmeansClustering(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._scoping_clusters: Output[ScopingsContainer] = Output(
            kmeans_clustering._spec().output_pin(0), 0, op
        )
        self._outputs.append(self._scoping_clusters)

    @property
    def scoping_clusters(self) -> Output[ScopingsContainer]:
