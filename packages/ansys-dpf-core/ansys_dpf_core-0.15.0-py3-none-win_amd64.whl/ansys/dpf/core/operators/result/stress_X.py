...
class stress_X(Operator):
    r"""Read/compute element nodal component stresses XX normal component (00
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsStressX,
            outputs_type=OutputsStressX,
        )
    ...
    def _spec() -> Specification:
        description = r"""Read/compute element nodal component stresses XX normal component (00
component) by calling the readers defined by the datasources. Regarding
the requested location and the input mesh scoping, the result location
can be Nodal/ElementalNodal/Elemental.
"""
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="SX", server=server)

    @property
    def inputs(self) -> InputsStressX:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsStressX.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsStressX:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsStressX.
        """
...
class OutputsStressX(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Output[FieldsContainer] = Output(
            stress_X._spec().output_pin(0), 0, op
        )
