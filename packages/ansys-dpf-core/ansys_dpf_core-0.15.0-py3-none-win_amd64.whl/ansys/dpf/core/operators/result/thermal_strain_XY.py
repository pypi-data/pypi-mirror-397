...
class thermal_strain_XY(Operator):
    r"""Read/compute element nodal component thermal strains XY shear component
    ...
    def _spec() -> Specification:
        description = r"""Read/compute element nodal component thermal strains XY shear component
(01 component) by calling the readers defined by the datasources.
Regarding the requested location and the input mesh scoping, the result
location can be Nodal/ElementalNodal/Elemental.
"""
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="ETHXY", server=server)

    @property
    def inputs(self) -> InputsThermalStrainXy:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsThermalStrainXy.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsThermalStrainXy:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsThermalStrainXy.
        """
        return self._outputs


class InputsThermalStrainXy(_Inputs):
    """Intermediate class used to connect user inputs to
    thermal_strain_XY operator.
...
class OutputsThermalStrainXy(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(thermal_strain_XY._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            thermal_strain_XY._spec().output_pin(0), 0, op
        )
