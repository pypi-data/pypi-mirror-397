...
class joint_moment_reaction(Operator):
    r"""Read/compute joint moment reaction by calling the readers defined by the
    datasources.
    ...
    def _spec() -> Specification:
        description = r"""Read/compute joint moment reaction by calling the readers defined by the
datasources.
"""
        spec = Specification(
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="JML", server=server)

    @property
    def inputs(self) -> InputsJointMomentReaction:
...
class InputsJointMomentReaction(_Inputs):
    ...
    joint_moment_reaction operator.
...
class OutputsJointMomentReaction(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(joint_moment_reaction._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            joint_moment_reaction._spec().output_pin(0), 0, op
        )
