...
class stress_Y(Operator):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsStressY,
            outputs_type=OutputsStressY,
        )
...
"""
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="SY", server=server)

    @property
    def inputs(self) -> InputsStressY:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsStressY.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsStressY:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsStressY.
        """
...
class OutputsStressY(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Output[FieldsContainer] = Output(
            stress_Y._spec().output_pin(0), 0, op
        )
