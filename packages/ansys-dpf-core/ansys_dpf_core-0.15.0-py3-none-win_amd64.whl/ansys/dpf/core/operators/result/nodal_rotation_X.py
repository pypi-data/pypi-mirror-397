...
class nodal_rotation_X(Operator):
    r"""Read/compute nodal rotation X component of the vector (1st component) by
    ...
    >>> op = dpf.operators.result.nodal_rotation_X()
    ...
    def _spec() -> Specification:
        description = r"""Read/compute nodal rotation X component of the vector (1st component) by
calling the readers defined by the datasources.
"""
        spec = Specification(
    ...
    @property
    def inputs(self) -> InputsNodalRotationX:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsNodalRotationX.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsNodalRotationX:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsNodalRotationX.
        """
        return self._outputs


class InputsNodalRotationX(_Inputs):
    """Intermediate class used to connect user inputs to
    nodal_rotation_X operator.
...
class OutputsNodalRotationX(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(nodal_rotation_X._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            nodal_rotation_X._spec().output_pin(0), 0, op
        )
