...
class creep_strain_XY(Operator):
    r"""Read/compute element nodal component creep strains XY shear component
    ...
    >>> op = dpf.operators.result.creep_strain_XY()
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsCreepStrainXy,
            outputs_type=OutputsCreepStrainXy,
        )
    ...
    def _spec() -> Specification:
        description = r"""Read/compute element nodal component creep strains XY shear component
(01 component) by calling the readers defined by the datasources.
Regarding the requested location and the input mesh scoping, the result
location can be Nodal/ElementalNodal/Elemental.
"""
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="EPCRXY", server=server)

    @property
    def inputs(self) -> InputsCreepStrainXy:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsCreepStrainXy.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsCreepStrainXy:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsCreepStrainXy.
        """
        return self._outputs


class InputsCreepStrainXy(_Inputs):
    """Intermediate class used to connect user inputs to
    creep_strain_XY operator.
...
class OutputsCreepStrainXy(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(creep_strain_XY._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            creep_strain_XY._spec().output_pin(0), 0, op
        )
