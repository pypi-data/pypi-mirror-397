...
class plastic_strain_XY(Operator):
    r"""Read/compute element nodal component plastic strains XY shear component
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsPlasticStrainXy,
            outputs_type=OutputsPlasticStrainXy,
        )
    ...
    def _spec() -> Specification:
        description = r"""Read/compute element nodal component plastic strains XY shear component
(01 component) by calling the readers defined by the datasources.
Regarding the requested location and the input mesh scoping, the result
location can be Nodal/ElementalNodal/Elemental.
"""
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="EPPLXY", server=server)

    @property
    def inputs(self) -> InputsPlasticStrainXy:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsPlasticStrainXy.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsPlasticStrainXy:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsPlasticStrainXy.
        """
...
class OutputsPlasticStrainXy(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Output[FieldsContainer] = Output(
            plastic_strain_XY._spec().output_pin(0), 0, op
        )
