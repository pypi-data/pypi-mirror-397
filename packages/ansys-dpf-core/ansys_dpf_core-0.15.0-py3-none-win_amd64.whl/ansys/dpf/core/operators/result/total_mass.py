...
class total_mass(Operator):
    ...
    def _spec() -> Specification:
        description = r"""Reads total mass from mode file.
"""
        spec = Specification(
            ...
            map_input_pin_spec={
                4: PinSpecification(
                    ...
                    optional=False,
                    document=r"""Data sources (must contain at least one mode file).""",
                ),
            },
            map_output_pin_spec={
                0: PinSpecification(
                    ...
                    type_names=["double"],
                    optional=False,
                    document=r"""the unit should be grabbed from the rst file""",
                ),
            },
        )
        return spec
    ...
    @property
    def inputs(self) -> InputsTotalMass:
