...
class stress_principal_3(Operator):
    r"""Read/compute element nodal component stresses 3rd principal component by
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsStressPrincipal3,
            outputs_type=OutputsStressPrincipal3,
        )
    ...
    def _spec() -> Specification:
        description = r"""Read/compute element nodal component stresses 3rd principal component by
calling the readers defined by the datasources and computing its eigen
values. This operation is independent of the coordinate system unless
averaging across elements is requested, in which case a rotation to the
global coordinate system is performed.
"""
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="S3", server=server)

    @property
    def inputs(self) -> InputsStressPrincipal3:
...
class OutputsStressPrincipal3(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Output[FieldsContainer] = Output(
            stress_principal_3._spec().output_pin(0), 0, op
        )
