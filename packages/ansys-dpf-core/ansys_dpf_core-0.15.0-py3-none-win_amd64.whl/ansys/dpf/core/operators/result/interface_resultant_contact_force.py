...
class interface_resultant_contact_force(Operator):
    r"""Read Interface Resultant Contact Force (LSDyna) by calling the readers
    ...
    def _spec() -> Specification:
        description = r"""Read Interface Resultant Contact Force (LSDyna) by calling the readers
defined by the datasources.
"""
        spec = Specification(
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="R_CFR", server=server)

    @property
    def inputs(self) -> InputsInterfaceResultantContactForce:
...
class InputsInterfaceResultantContactForce(_Inputs):
    ...
    interface_resultant_contact_force operator.
    ...
    def __init__(self, op: Operator):
        ...
        self._streams_container: Input[StreamsContainer] = Input(
            interface_resultant_contact_force._spec().input_pin(3), 3, op, -1
        )
        self._inputs.append(self._streams_container)
        self._data_sources: Input[DataSources] = Input(
            interface_resultant_contact_force._spec().input_pin(4), 4, op, -1
        )
        self._inputs.append(self._data_sources)
        self._entity_scoping: Input[Scoping] = Input(
            interface_resultant_contact_force._spec().input_pin(6), 6, op, -1
        )
        self._inputs.append(self._entity_scoping)
        self._unit_system: Input[int | str | UnitSystem] = Input(
            interface_resultant_contact_force._spec().input_pin(50), 50, op, -1
        )
...
class OutputsInterfaceResultantContactForce(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Output[FieldsContainer] = Output(
            interface_resultant_contact_force._spec().output_pin(0), 0, op
        )
