...
class InputsComputeStressZ(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._scoping: Input[Scoping] = Input(
            compute_stress_Z._spec().input_pin(1), 1, op, -1
        )
        ...
        self._data_sources: Input[DataSources] = Input(
            compute_stress_Z._spec().input_pin(4), 4, op, -1
        )
        ...
        self._strain: Input[FieldsContainer | Field] = Input(
            compute_stress_Z._spec().input_pin(10), 10, op, -1
        )
...
class OutputsComputeStressZ(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Output[FieldsContainer] = Output(
            compute_stress_Z._spec().output_pin(0), 0, op
        )
