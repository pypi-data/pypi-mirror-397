...
class stress_XY(Operator):
    r"""Read/compute element nodal component stresses XY shear component (01
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsStressXy,
            outputs_type=OutputsStressXy,
        )
    ...
    def _spec() -> Specification:
        description = r"""Read/compute element nodal component stresses XY shear component (01
component) by calling the readers defined by the datasources. Regarding
the requested location and the input mesh scoping, the result location
can be Nodal/ElementalNodal/Elemental.
"""
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="SXY", server=server)

    @property
    def inputs(self) -> InputsStressXy:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsStressXy.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsStressXy:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsStressXy.
        """
...
class OutputsStressXy(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Output[FieldsContainer] = Output(
            stress_XY._spec().output_pin(0), 0, op
        )
