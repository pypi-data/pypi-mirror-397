...
class magnetic_flux_density_Z(Operator):
    r"""Read/compute Magnetic Flux Density Z component of the vector (3rd
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsMagneticFluxDensityZ,
            outputs_type=OutputsMagneticFluxDensityZ,
        )
    ...
    def _spec() -> Specification:
        description = r"""Read/compute Magnetic Flux Density Z component of the vector (3rd
component) by calling the readers defined by the datasources. Regarding
the requested location and the input mesh scoping, the result location
can be Nodal/ElementalNodal/Elemental.
"""
    ...
    @property
    def inputs(self) -> InputsMagneticFluxDensityZ:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsMagneticFluxDensityZ.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsMagneticFluxDensityZ:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsMagneticFluxDensityZ.
        """
...
class InputsMagneticFluxDensityZ(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._mesh: Input[MeshedRegion | MeshesContainer] = Input(
            magnetic_flux_density_Z._spec().input_pin(7), 7, op, -1
        )
