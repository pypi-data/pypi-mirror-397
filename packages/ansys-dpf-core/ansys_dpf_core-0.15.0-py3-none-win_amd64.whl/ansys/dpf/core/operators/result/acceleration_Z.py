...
class acceleration_Z(Operator):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsAccelerationZ,
            outputs_type=OutputsAccelerationZ,
        )
...
class OutputsAccelerationZ(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Output[FieldsContainer] = Output(
            acceleration_Z._spec().output_pin(0), 0, op
        )
