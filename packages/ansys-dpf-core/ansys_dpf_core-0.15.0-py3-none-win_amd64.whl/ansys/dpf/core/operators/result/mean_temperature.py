...
class mean_temperature(Operator):
    r"""Read Mean Temperature by calling the readers defined by the datasources.
    ...
    >>> op = dpf.operators.result.mean_temperature()
    ...
    def _spec() -> Specification:
        description = r"""Read Mean Temperature by calling the readers defined by the datasources.
"""
        spec = Specification(
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="TEMP_A", server=server)

    @property
    def inputs(self) -> InputsMeanTemperature:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsMeanTemperature.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsMeanTemperature:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsMeanTemperature.
        """
        return self._outputs


class InputsMeanTemperature(_Inputs):
    """Intermediate class used to connect user inputs to
    mean_temperature operator.
...
class OutputsMeanTemperature(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(mean_temperature._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            mean_temperature._spec().output_pin(0), 0, op
        )
