...
class beam_t_shear_force(Operator):
    r"""Read Beam T/Z Shear Force by calling the readers defined by the
    datasources.
    ...
    def _spec() -> Specification:
        description = r"""Read Beam T/Z Shear Force by calling the readers defined by the
datasources.
"""
        spec = Specification(
...
class OutputsBeamTShearForce(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Output[FieldsContainer] = Output(
            beam_t_shear_force._spec().output_pin(0), 0, op
        )
