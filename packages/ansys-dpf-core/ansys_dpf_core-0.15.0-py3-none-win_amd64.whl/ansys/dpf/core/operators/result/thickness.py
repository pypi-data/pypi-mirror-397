...
class thickness(Operator):
    r"""Read/compute thickness by calling the readers defined by the
    datasources.
    ...
    def _spec() -> Specification:
        description = r"""Read/compute thickness by calling the readers defined by the
datasources.
"""
        spec = Specification(
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="thickness", server=server)

    @property
    def inputs(self) -> InputsThickness:
...
class OutputsThickness(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Output[FieldsContainer] = Output(
            thickness._spec().output_pin(0), 0, op
        )
