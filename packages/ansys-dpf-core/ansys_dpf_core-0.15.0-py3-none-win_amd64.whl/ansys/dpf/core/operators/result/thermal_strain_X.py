...
class thermal_strain_X(Operator):
    ...
    >>> op = dpf.operators.result.thermal_strain_X()
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsThermalStrainX,
            outputs_type=OutputsThermalStrainX,
        )
...
"""
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="ETHX", server=server)

    @property
    def inputs(self) -> InputsThermalStrainX:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsThermalStrainX.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsThermalStrainX:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsThermalStrainX.
        """
        return self._outputs


class InputsThermalStrainX(_Inputs):
    """Intermediate class used to connect user inputs to
    thermal_strain_X operator.
...
class OutputsThermalStrainX(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(thermal_strain_X._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            thermal_strain_X._spec().output_pin(0), 0, op
        )
