...
class magnetic_flux_density_X(Operator):
    r"""Read/compute Magnetic Flux Density X component of the vector (1st
    ...
    def _spec() -> Specification:
        description = r"""Read/compute Magnetic Flux Density X component of the vector (1st
component) by calling the readers defined by the datasources. Regarding
the requested location and the input mesh scoping, the result location
can be Nodal/ElementalNodal/Elemental.
"""
    ...
    @property
    def inputs(self) -> InputsMagneticFluxDensityX:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsMagneticFluxDensityX.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsMagneticFluxDensityX:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsMagneticFluxDensityX.
        """
...
class InputsMagneticFluxDensityX(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._mesh: Input[MeshedRegion | MeshesContainer] = Input(
            magnetic_flux_density_X._spec().input_pin(7), 7, op, -1
        )
