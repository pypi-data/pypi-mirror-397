...
"""
        spec = Specification(
            ...
            map_input_pin_spec={
                ...
                2: PinSpecification(
                    ...
                    optional=True,
                    document=r"""This pin contains file csv or field of beam's end condition defined by the user. If no input at this pin found, it would take end conditions value of all beams as 1""",
                ),
                3: PinSpecification(
                    name="streams",
                ...
                6: PinSpecification(
                    ...
                    type_names=["double"],
                    optional=True,
                    document=r"""partial factor for resistance of members to instability assessed by member checks. Default value: 1.0""",
                ),
                7: PinSpecification(
                    name="mesh",
                ...
                12: PinSpecification(
                    ...
                    type_names=["bool"],
                    optional=True,
                    document=r"""Selection of fabrication's type if there are beams I in the structure. TRUE: Rolled Section, False: Welded Section. Default: Rolled Section.""",
                ),
            },
            map_output_pin_spec={
                0: PinSpecification(
                    ...
                    type_names=["fields_container"],
                    optional=False,
                    document=r"""Linear summation of the utilization ratios in all members submitted under a combination of both bending and compression. These factors should be less than 1 and positive.""",
                ),
            },
        )
        return spec
    ...
    @property
    def inputs(self) -> InputsMembersInLinearCompressionBendingNotCertified:
...
class InputsMembersInLinearCompressionBendingNotCertified(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._field_end_condition: Input[DataSources | Field] = Input(
        ...
        self._manufacture: Input[bool] = Input(
        ...
        self._axial_force: Input[FieldsContainer] = Input(
        ...
        self._fabrication_type: Input[bool] = Input(
    ...
    @property
    def field_end_condition(self) -> Input[DataSources | Field]:
    ...
    @property
    def manufacture(self) -> Input[bool]:
    ...
    @property
    def axial_force(self) -> Input[FieldsContainer]:
    ...
    @property
    def fabrication_type(self) -> Input[bool]:
...
class OutputsMembersInLinearCompressionBendingNotCertified(_Outputs):
    ...
    @property
    def buckling_resistance_linear_summation_utilization_ratios(
        self,
    ) -> Output[FieldsContainer]:
        r"""Allows to get buckling_resistance_linear_summation_utilization_ratios output of the operator
