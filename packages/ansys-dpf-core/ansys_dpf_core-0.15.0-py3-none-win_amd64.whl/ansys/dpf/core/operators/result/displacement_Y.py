...
class displacement_Y(Operator):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsDisplacementY,
            outputs_type=OutputsDisplacementY,
        )
...
class OutputsDisplacementY(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Output[FieldsContainer] = Output(
            displacement_Y._spec().output_pin(0), 0, op
        )
