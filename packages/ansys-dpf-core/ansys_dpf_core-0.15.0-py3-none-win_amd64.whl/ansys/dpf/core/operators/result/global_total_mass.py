...
class global_total_mass(Operator):
    r"""Read Global Total Mass (LSDyna) by calling the readers defined by the
    datasources.
    ...
    def _spec() -> Specification:
        description = r"""Read Global Total Mass (LSDyna) by calling the readers defined by the
datasources.
"""
        spec = Specification(
    ...
    @property
    def inputs(self) -> InputsGlobalTotalMass:
...
class InputsGlobalTotalMass(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._data_sources: Input[DataSources] = Input(
            global_total_mass._spec().input_pin(4), 4, op, -1
        )
        self._inputs.append(self._data_sources)
        self._unit_system: Input[int | str | UnitSystem] = Input(
            global_total_mass._spec().input_pin(50), 50, op, -1
        )
...
class OutputsGlobalTotalMass(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Output[FieldsContainer] = Output(
            global_total_mass._spec().output_pin(0), 0, op
        )
