...
class reaction_force(Operator):
    r"""Read/compute nodal reaction forces by calling the readers defined by the
    datasources.
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsReactionForce,
            outputs_type=OutputsReactionForce,
        )
    ...
    def _spec() -> Specification:
        description = r"""Read/compute nodal reaction forces by calling the readers defined by the
datasources.
"""
        spec = Specification(
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="RF", server=server)

    @property
    def inputs(self) -> InputsReactionForce:
...
class OutputsReactionForce(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Output[FieldsContainer] = Output(
            reaction_force._spec().output_pin(0), 0, op
        )
