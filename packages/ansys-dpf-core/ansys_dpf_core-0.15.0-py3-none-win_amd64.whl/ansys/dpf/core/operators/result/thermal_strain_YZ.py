...
class thermal_strain_YZ(Operator):
    r"""Read/compute element nodal component thermal strains YZ shear component
    ...
    >>> op = dpf.operators.result.thermal_strain_YZ()
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsThermalStrainYz,
            outputs_type=OutputsThermalStrainYz,
        )
    ...
    def _spec() -> Specification:
        description = r"""Read/compute element nodal component thermal strains YZ shear component
(12 component) by calling the readers defined by the datasources.
Regarding the requested location and the input mesh scoping, the result
location can be Nodal/ElementalNodal/Elemental.
"""
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="ETHYZ", server=server)

    @property
    def inputs(self) -> InputsThermalStrainYz:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsThermalStrainYz.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsThermalStrainYz:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsThermalStrainYz.
        """
        return self._outputs


class InputsThermalStrainYz(_Inputs):
    """Intermediate class used to connect user inputs to
    thermal_strain_YZ operator.
...
class OutputsThermalStrainYz(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(thermal_strain_YZ._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            thermal_strain_YZ._spec().output_pin(0), 0, op
        )
