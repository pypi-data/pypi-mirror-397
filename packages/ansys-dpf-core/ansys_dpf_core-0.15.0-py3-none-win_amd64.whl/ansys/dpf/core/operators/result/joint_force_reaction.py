...
class joint_force_reaction(Operator):
    r"""Read/compute joint force reaction by calling the readers defined by the
    datasources.
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsJointForceReaction,
            outputs_type=OutputsJointForceReaction,
        )
    ...
    def _spec() -> Specification:
        description = r"""Read/compute joint force reaction by calling the readers defined by the
datasources.
"""
        spec = Specification(
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="JFL", server=server)

    @property
    def inputs(self) -> InputsJointForceReaction:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsJointForceReaction.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsJointForceReaction:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsJointForceReaction.
        """
        return self._outputs


class InputsJointForceReaction(_Inputs):
    """Intermediate class used to connect user inputs to
    joint_force_reaction operator.
...
class OutputsJointForceReaction(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(joint_force_reaction._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            joint_force_reaction._spec().output_pin(0), 0, op
        )
