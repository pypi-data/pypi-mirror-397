...
class OutputsDivLighthillTensor(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(div_lighthill_tensor._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            div_lighthill_tensor._spec().output_pin(0), 0, op
        )
