...
class temperature(Operator):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsTemperature,
            outputs_type=OutputsTemperature,
        )
...
class OutputsTemperature(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Output[FieldsContainer] = Output(
            temperature._spec().output_pin(0), 0, op
        )
