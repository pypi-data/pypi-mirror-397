...
class incremental_energy(Operator):
    r"""Read/compute incremental energy (magnetics) by calling the readers
    ...
    def _spec() -> Specification:
        description = r"""Read/compute incremental energy (magnetics) by calling the readers
defined by the datasources.
"""
        spec = Specification(
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="ENG_INC", server=server)

    @property
    def inputs(self) -> InputsIncrementalEnergy:
...
class OutputsIncrementalEnergy(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Output[FieldsContainer] = Output(
            incremental_energy._spec().output_pin(0), 0, op
        )
