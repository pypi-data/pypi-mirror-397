...
class InputsComputeTotalStrain3(_Inputs):
...
class OutputsComputeTotalStrain3(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(compute_total_strain_3._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            compute_total_strain_3._spec().output_pin(0), 0, op
        )
