...
class heat_flux_X(Operator):
    r"""Read/compute heat flux X component of the vector (1st component) by
    ...
    def _spec() -> Specification:
        description = r"""Read/compute heat flux X component of the vector (1st component) by
calling the readers defined by the datasources. Regarding the requested
location and the input mesh scoping, the result location can be
Nodal/ElementalNodal/Elemental.
"""
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="TFX", server=server)

    @property
    def inputs(self) -> InputsHeatFluxX:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsHeatFluxX.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsHeatFluxX:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsHeatFluxX.
        """
...
class OutputsHeatFluxX(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Output[FieldsContainer] = Output(
            heat_flux_X._spec().output_pin(0), 0, op
        )
