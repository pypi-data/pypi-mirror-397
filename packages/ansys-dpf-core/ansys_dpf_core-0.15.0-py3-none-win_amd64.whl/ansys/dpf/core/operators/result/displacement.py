...
class displacement(Operator):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsDisplacement,
            outputs_type=OutputsDisplacement,
        )
...
class InputsDisplacement(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._sectors_to_expand: Input[Scoping | ScopingsContainer] = Input(
            displacement._spec().input_pin(18), 18, op, -1
        )
        self._inputs.append(self._sectors_to_expand)
        self._phi: Input[float] = Input(displacement._spec().input_pin(19), 19, op, -1)
...
class OutputsDisplacement(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Output[FieldsContainer] = Output(
            displacement._spec().output_pin(0), 0, op
        )
