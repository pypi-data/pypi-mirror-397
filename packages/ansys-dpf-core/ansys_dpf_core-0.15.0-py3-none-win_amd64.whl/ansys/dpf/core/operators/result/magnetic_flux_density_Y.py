...
class magnetic_flux_density_Y(Operator):
    r"""Read/compute Magnetic Flux Density Y component of the vector (2nd
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsMagneticFluxDensityY,
            outputs_type=OutputsMagneticFluxDensityY,
        )
    ...
    def _spec() -> Specification:
        description = r"""Read/compute Magnetic Flux Density Y component of the vector (2nd
component) by calling the readers defined by the datasources. Regarding
the requested location and the input mesh scoping, the result location
can be Nodal/ElementalNodal/Elemental.
"""
    ...
    @property
    def inputs(self) -> InputsMagneticFluxDensityY:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsMagneticFluxDensityY.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsMagneticFluxDensityY:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsMagneticFluxDensityY.
        """
...
class InputsMagneticFluxDensityY(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._mesh: Input[MeshedRegion | MeshesContainer] = Input(
            magnetic_flux_density_Y._spec().input_pin(7), 7, op, -1
        )
