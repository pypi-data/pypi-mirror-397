...
class nodal_rotation_Z(Operator):
    r"""Read/compute nodal rotation Z component of the vector (3rd component) by
    ...
    >>> op = dpf.operators.result.nodal_rotation_Z()
    ...
    def _spec() -> Specification:
        description = r"""Read/compute nodal rotation Z component of the vector (3rd component) by
calling the readers defined by the datasources.
"""
        spec = Specification(
    ...
    @property
    def inputs(self) -> InputsNodalRotationZ:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsNodalRotationZ.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsNodalRotationZ:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsNodalRotationZ.
        """
        return self._outputs


class InputsNodalRotationZ(_Inputs):
    """Intermediate class used to connect user inputs to
    nodal_rotation_Z operator.
...
class OutputsNodalRotationZ(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(nodal_rotation_Z._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            nodal_rotation_Z._spec().output_pin(0), 0, op
        )
