...
class superficial_velocity(Operator):
    r"""Read Superficial Velocity by calling the readers defined by the
    datasources.
    ...
    >>> op = dpf.operators.result.superficial_velocity()
    ...
    def _spec() -> Specification:
        description = r"""Read Superficial Velocity by calling the readers defined by the
datasources.
"""
        spec = Specification(
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="V_SUP", server=server)

    @property
    def inputs(self) -> InputsSuperficialVelocity:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsSuperficialVelocity.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsSuperficialVelocity:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsSuperficialVelocity.
        """
        return self._outputs


class InputsSuperficialVelocity(_Inputs):
    """Intermediate class used to connect user inputs to
    superficial_velocity operator.
...
class OutputsSuperficialVelocity(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(superficial_velocity._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            superficial_velocity._spec().output_pin(0), 0, op
        )
