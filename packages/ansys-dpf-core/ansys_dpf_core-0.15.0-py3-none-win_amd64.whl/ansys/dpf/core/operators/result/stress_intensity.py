...
class stress_intensity(Operator):
    ...
    >>> op = dpf.operators.result.stress_intensity()
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsStressIntensity,
            outputs_type=OutputsStressIntensity,
        )
...
"""
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="S_intensity", server=server)

    @property
    def inputs(self) -> InputsStressIntensity:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsStressIntensity.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsStressIntensity:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsStressIntensity.
        """
        return self._outputs


class InputsStressIntensity(_Inputs):
    """Intermediate class used to connect user inputs to
    stress_intensity operator.
...
class OutputsStressIntensity(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(stress_intensity._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            stress_intensity._spec().output_pin(0), 0, op
        )
