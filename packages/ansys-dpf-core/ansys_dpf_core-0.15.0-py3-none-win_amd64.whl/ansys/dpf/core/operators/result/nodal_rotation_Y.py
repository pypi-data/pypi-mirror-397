...
class nodal_rotation_Y(Operator):
    r"""Read/compute nodal rotation Y component of the vector (2nd component) by
    ...
    >>> op = dpf.operators.result.nodal_rotation_Y()
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsNodalRotationY,
            outputs_type=OutputsNodalRotationY,
        )
    ...
    def _spec() -> Specification:
        description = r"""Read/compute nodal rotation Y component of the vector (2nd component) by
calling the readers defined by the datasources.
"""
        spec = Specification(
    ...
    @property
    def inputs(self) -> InputsNodalRotationY:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsNodalRotationY.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsNodalRotationY:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsNodalRotationY.
        """
        return self._outputs


class InputsNodalRotationY(_Inputs):
    """Intermediate class used to connect user inputs to
    nodal_rotation_Y operator.
...
class OutputsNodalRotationY(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(nodal_rotation_Y._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            nodal_rotation_Y._spec().output_pin(0), 0, op
        )
