...
class normal_contact_force(Operator):
    r"""Read/compute normal contact force by calling the readers defined by the
    datasources.
    ...
    def _spec() -> Specification:
        description = r"""Read/compute normal contact force by calling the readers defined by the
datasources.
"""
        spec = Specification(
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="CFFNOR", server=server)

    @property
    def inputs(self) -> InputsNormalContactForce:
...
class OutputsNormalContactForce(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(normal_contact_force._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            normal_contact_force._spec().output_pin(0), 0, op
        )
