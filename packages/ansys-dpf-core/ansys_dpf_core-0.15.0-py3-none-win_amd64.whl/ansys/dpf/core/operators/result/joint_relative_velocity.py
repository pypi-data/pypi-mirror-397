...
class joint_relative_velocity(Operator):
    r"""Read/compute joint relative velocity by calling the readers defined by
    the datasources.
    ...
    def _spec() -> Specification:
        description = r"""Read/compute joint relative velocity by calling the readers defined by
the datasources.
"""
        spec = Specification(
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="JV", server=server)

    @property
    def inputs(self) -> InputsJointRelativeVelocity:
...
class InputsJointRelativeVelocity(_Inputs):
    ...
    joint_relative_velocity operator.
...
class OutputsJointRelativeVelocity(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(joint_relative_velocity._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            joint_relative_velocity._spec().output_pin(0), 0, op
        )
