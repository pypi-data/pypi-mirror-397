...
class modal_acceleration(Operator):
    r"""Read/compute modal acceleration by calling the readers defined by the
    datasources.
    ...
    def _spec() -> Specification:
        description = r"""Read/compute modal acceleration by calling the readers defined by the
datasources.
"""
        spec = Specification(
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="MAF", server=server)

    @property
    def inputs(self) -> InputsModalAcceleration:
...
class InputsModalAcceleration(_Inputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(modal_acceleration._spec().inputs, op)
...
class OutputsModalAcceleration(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(modal_acceleration._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            modal_acceleration._spec().output_pin(0), 0, op
        )
