...
class elastic_strain_XY(Operator):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsElasticStrainXy,
            outputs_type=OutputsElasticStrainXy,
        )
...
class OutputsElasticStrainXy(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Output[FieldsContainer] = Output(
            elastic_strain_XY._spec().output_pin(0), 0, op
        )
