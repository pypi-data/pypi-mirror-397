...
class InputsComputeInvariantTermsRbd(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._center_of_mass: Input[FieldsContainer] = Input(
            compute_invariant_terms_rbd._spec().input_pin(4), 4, op, -1
        )
        self._inputs.append(self._center_of_mass)
        self._inertia_relief: Input[FieldsContainer] = Input(
        ...
        self._nod: Input = Input(
            compute_invariant_terms_rbd._spec().input_pin(8), 8, op, -1
        )
        self._inputs.append(self._nod)
        self._constraint_mode_check: Input[bool] = Input(
    ...
    @property
    def center_of_mass(self) -> Input[FieldsContainer]:
    ...
    @property
    def inertia_relief(self) -> Input[FieldsContainer]:
    ...
    @property
    def constraint_mode_check(self) -> Input[bool]:
...
class OutputsComputeInvariantTermsRbd(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._v_trsf: Output = Output(
            compute_invariant_terms_rbd._spec().output_pin(5), 5, op
        )
        self._outputs.append(self._v_trsf)
        self._k_mat: Output[Field] = Output(
            compute_invariant_terms_rbd._spec().output_pin(6), 6, op
        )
        ...
        self._c_mat: Output[Field] = Output(
            compute_invariant_terms_rbd._spec().output_pin(8), 8, op
        )
        self._outputs.append(self._c_mat)
        self._rhs: Output[Field] = Output(
            compute_invariant_terms_rbd._spec().output_pin(9), 9, op
        )
        self._outputs.append(self._rhs)
        self._dn: Output = Output(
            compute_invariant_terms_rbd._spec().output_pin(10), 10, op
        )
        ...
        self._drn: Output = Output(
            compute_invariant_terms_rbd._spec().output_pin(12), 12, op
        )
        ...
        self._dnx_y: Output = Output(
            compute_invariant_terms_rbd._spec().output_pin(14), 14, op
        )
        self._outputs.append(self._dnx_y)
        self._dny_y: Output = Output(
            compute_invariant_terms_rbd._spec().output_pin(15), 15, op
        )
        self._outputs.append(self._dny_y)
        self._dnz_y: Output = Output(
            compute_invariant_terms_rbd._spec().output_pin(16), 16, op
        )
        self._outputs.append(self._dnz_y)
        self._dyx_n: Output = Output(
            compute_invariant_terms_rbd._spec().output_pin(17), 17, op
        )
        self._outputs.append(self._dyx_n)
        self._dyy_n: Output = Output(
            compute_invariant_terms_rbd._spec().output_pin(18), 18, op
        )
        self._outputs.append(self._dyy_n)
        self._dyz_n: Output = Output(
            compute_invariant_terms_rbd._spec().output_pin(19), 19, op
        )
        self._outputs.append(self._dyz_n)
        self._dnxn: Output = Output(
            compute_invariant_terms_rbd._spec().output_pin(20), 20, op
        )
        self._outputs.append(self._dnxn)
        self._dnyn: Output = Output(
            compute_invariant_terms_rbd._spec().output_pin(21), 21, op
        )
        self._outputs.append(self._dnyn)
        self._dnzn: Output = Output(
            compute_invariant_terms_rbd._spec().output_pin(22), 22, op
        )
