...
class fluid_velocity(Operator):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsFluidVelocity,
            outputs_type=OutputsFluidVelocity,
        )
...
class InputsFluidVelocity(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._mesh: Input[MeshedRegion | MeshesContainer] = Input(
            fluid_velocity._spec().input_pin(7), 7, op, -1
        )
...
class OutputsFluidVelocity(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Output[FieldsContainer] = Output(
            fluid_velocity._spec().output_pin(0), 0, op
        )
