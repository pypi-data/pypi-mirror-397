...
class turbulent_kinetic_energy(Operator):
    r"""Read Turbulent Kinetic Energy (k) by calling the readers defined by the
    datasources.
    ...
    def _spec() -> Specification:
        description = r"""Read Turbulent Kinetic Energy (k) by calling the readers defined by the
datasources.
"""
        spec = Specification(
    ...
    @property
    def inputs(self) -> InputsTurbulentKineticEnergy:
...
class InputsTurbulentKineticEnergy(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._mesh: Input[MeshedRegion | MeshesContainer] = Input(
            turbulent_kinetic_energy._spec().input_pin(7), 7, op, -1
        )
