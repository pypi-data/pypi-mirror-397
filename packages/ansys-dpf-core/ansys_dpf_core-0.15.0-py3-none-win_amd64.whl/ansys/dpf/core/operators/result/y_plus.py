...
class y_plus(Operator):
    ...
    >>> op = dpf.operators.result.y_plus()
    ...
    def _spec() -> Specification:
        description = r"""Read Y Plus (y+) by calling the readers defined by the datasources.
"""
        spec = Specification(
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="YPLUS", server=server)

    @property
    def inputs(self) -> InputsYPlus:
...
class OutputsYPlus(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(y_plus._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            y_plus._spec().output_pin(0), 0, op
        )
