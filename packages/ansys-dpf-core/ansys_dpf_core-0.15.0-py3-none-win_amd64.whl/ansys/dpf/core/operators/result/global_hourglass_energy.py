...
class global_hourglass_energy(Operator):
    r"""Read Global Hourglass Energy (LSDyna) by calling the readers defined by
    the datasources.
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsGlobalHourglassEnergy,
            outputs_type=OutputsGlobalHourglassEnergy,
        )
    ...
    def _spec() -> Specification:
        description = r"""Read Global Hourglass Energy (LSDyna) by calling the readers defined by
the datasources.
"""
        spec = Specification(
    ...
    @property
    def inputs(self) -> InputsGlobalHourglassEnergy:
...
class InputsGlobalHourglassEnergy(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._unit_system: Input[int | str | UnitSystem] = Input(
            global_hourglass_energy._spec().input_pin(50), 50, op, -1
        )
