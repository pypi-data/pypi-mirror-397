...
class creep_strain_YZ(Operator):
    r"""Read/compute element nodal component creep strains YZ shear component
    ...
    >>> op = dpf.operators.result.creep_strain_YZ()
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsCreepStrainYz,
            outputs_type=OutputsCreepStrainYz,
        )
    ...
    def _spec() -> Specification:
        description = r"""Read/compute element nodal component creep strains YZ shear component
(12 component) by calling the readers defined by the datasources.
Regarding the requested location and the input mesh scoping, the result
location can be Nodal/ElementalNodal/Elemental.
"""
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="EPCRYZ", server=server)

    @property
    def inputs(self) -> InputsCreepStrainYz:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsCreepStrainYz.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsCreepStrainYz:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsCreepStrainYz.
        """
        return self._outputs


class InputsCreepStrainYz(_Inputs):
    """Intermediate class used to connect user inputs to
    creep_strain_YZ operator.
...
class OutputsCreepStrainYz(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(creep_strain_YZ._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            creep_strain_YZ._spec().output_pin(0), 0, op
        )
