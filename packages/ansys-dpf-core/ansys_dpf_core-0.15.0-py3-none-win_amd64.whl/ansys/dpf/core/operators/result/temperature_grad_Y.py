...
class temperature_grad_Y(Operator):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsTemperatureGradY,
            outputs_type=OutputsTemperatureGradY,
        )
...
"""
    ...
    @property
    def inputs(self) -> InputsTemperatureGradY:
...
class InputsTemperatureGradY(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._time_scoping: Input[Scoping | int | float | Field] = Input(
            temperature_grad_Y._spec().input_pin(0), 0, op, -1
        )
        self._inputs.append(self._time_scoping)
        self._mesh_scoping: Input[ScopingsContainer | Scoping] = Input(
            temperature_grad_Y._spec().input_pin(1), 1, op, -1
        )
        ...
        self._data_sources: Input[DataSources] = Input(
            temperature_grad_Y._spec().input_pin(4), 4, op, -1
        )
        ...
        self._mesh: Input[MeshedRegion | MeshesContainer] = Input(
            temperature_grad_Y._spec().input_pin(7), 7, op, -1
        )
        ...
        self._read_cyclic: Input[int] = Input(
            temperature_grad_Y._spec().input_pin(14), 14, op, -1
        )
        self._inputs.append(self._read_cyclic)
        self._read_beams: Input[bool] = Input(
            temperature_grad_Y._spec().input_pin(22), 22, op, -1
        )
...
class OutputsTemperatureGradY(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Output[FieldsContainer] = Output(
            temperature_grad_Y._spec().output_pin(0), 0, op
        )
