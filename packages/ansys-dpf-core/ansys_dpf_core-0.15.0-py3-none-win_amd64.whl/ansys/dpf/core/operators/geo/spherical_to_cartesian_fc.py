...
class spherical_to_cartesian_fc(Operator):
    ...
    def __init__(self, fields_container=None, config=None, server=None):
        super().__init__(
            name="spherical_to_cartesian_fc",
            config=config,
            server=server,
...
class InputsSphericalToCartesianFc(_Inputs):
    ...
    spherical_to_cartesian_fc operator.
    ...
    def __init__(self, op: Operator):
        super().__init__(spherical_to_cartesian_fc._spec().inputs, op)
        self._fields_container: Input[FieldsContainer] = Input(
            spherical_to_cartesian_fc._spec().input_pin(0), 0, op, -1
        )
...
class OutputsSphericalToCartesianFc(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(spherical_to_cartesian_fc._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            spherical_to_cartesian_fc._spec().output_pin(0), 0, op
        )
