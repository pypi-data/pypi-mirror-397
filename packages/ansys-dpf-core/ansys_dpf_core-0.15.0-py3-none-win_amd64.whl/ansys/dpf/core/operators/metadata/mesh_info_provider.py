...
class InputsMeshInfoProvider(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._time_scoping: Input[int] = Input(
            mesh_info_provider._spec().input_pin(0), 0, op, -1
        )
        ...
        self._data_sources: Input[DataSources] = Input(
            mesh_info_provider._spec().input_pin(4), 4, op, -1
        )
...
class OutputsMeshInfoProvider(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._mesh_info: Output[GenericDataContainer] = Output(
            mesh_info_provider._spec().output_pin(0), 0, op
        )
        self._outputs.append(self._mesh_info)

    @property
    def mesh_info(self) -> Output[GenericDataContainer]:
