...
class txt_to_data_tree(Operator):
    ...
    def _spec() -> Specification:
        description = r"""Reads a txt file or string to a DataTree
"""
        spec = Specification(
    ...
    @property
    def inputs(self) -> InputsTxtToDataTree:
...
class InputsTxtToDataTree(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._string_or_path: Input[str | DataSources] = Input(
            txt_to_data_tree._spec().input_pin(0), 0, op, -1
        )
...
class OutputsTxtToDataTree(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._data_tree: Output[DataTree] = Output(
            txt_to_data_tree._spec().output_pin(0), 0, op
        )
