...
class InputsStringDeserializer(_Inputs):
    ...
    @property
    def serialized_string1(self) -> Input[str]:
    ...
    @property
    def serialized_string2(self) -> Input[str]:
...
class OutputsStringDeserializer(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._any_output1: Output[Any] = Output(
            string_deserializer._spec().output_pin(1), 1, op
        )
        self._outputs.append(self._any_output1)
        self._any_output2: Output[Any] = Output(
            string_deserializer._spec().output_pin(2), 2, op
        )
        self._outputs.append(self._any_output2)

    @property
    def any_output1(self) -> Output[Any]:
    ...
    @property
    def any_output2(self) -> Output[Any]:
