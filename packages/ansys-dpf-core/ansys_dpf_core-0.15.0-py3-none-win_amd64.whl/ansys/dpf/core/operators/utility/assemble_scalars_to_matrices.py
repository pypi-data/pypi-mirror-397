...
class InputsAssembleScalarsToMatrices(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._xx: Input[Field] = Input(
            assemble_scalars_to_matrices._spec().input_pin(0), 0, op, -1
        )
        self._inputs.append(self._xx)
        self._yy: Input[Field] = Input(
            assemble_scalars_to_matrices._spec().input_pin(1), 1, op, -1
        )
        self._inputs.append(self._yy)
        self._zz: Input[Field] = Input(
            assemble_scalars_to_matrices._spec().input_pin(2), 2, op, -1
        )
        self._inputs.append(self._zz)
        self._xy: Input[Field] = Input(
            assemble_scalars_to_matrices._spec().input_pin(3), 3, op, -1
        )
        self._inputs.append(self._xy)
        self._yz: Input[Field] = Input(
            assemble_scalars_to_matrices._spec().input_pin(4), 4, op, -1
        )
        self._inputs.append(self._yz)
        self._xz: Input[Field] = Input(
            assemble_scalars_to_matrices._spec().input_pin(5), 5, op, -1
        )
        self._inputs.append(self._xz)
        self._yx: Input[Field] = Input(
            assemble_scalars_to_matrices._spec().input_pin(6), 6, op, -1
        )
        self._inputs.append(self._yx)
        self._zy: Input[Field] = Input(
            assemble_scalars_to_matrices._spec().input_pin(7), 7, op, -1
        )
        self._inputs.append(self._zy)
        self._zx: Input[Field] = Input(
            assemble_scalars_to_matrices._spec().input_pin(8), 8, op, -1
        )
...
class OutputsAssembleScalarsToMatrices(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._field: Output[Field] = Output(
            assemble_scalars_to_matrices._spec().output_pin(0), 0, op
        )
