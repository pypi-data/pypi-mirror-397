...
class OutputsExtractSubSc(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._scopings_container: Output[ScopingsContainer] = Output(
            extract_sub_sc._spec().output_pin(0), 0, op
        )
        self._outputs.append(self._scopings_container)

    @property
    def scopings_container(self) -> Output[ScopingsContainer]:
