...
class merge_weighted_fields_containers(Operator):
    r"""Assembles a set of fields containers into a unique one, applying a
    ...
    def _spec() -> Specification:
        description = r"""Assembles a set of fields containers into a unique one, applying a
weight on the sum of the fields.
"""
        spec = Specification(
    ...
    @property
    def inputs(self) -> InputsMergeWeightedFieldsContainers:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsMergeWeightedFieldsContainers.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsMergeWeightedFieldsContainers:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsMergeWeightedFieldsContainers.
        """
...
class InputsMergeWeightedFieldsContainers(_Inputs):
    ...
    @property
    def merged_fields_support(self) -> Input:
        r"""Allows to connect merged_fields_support input to the operator.
    ...
    @property
    def merged_fields_containers_support(self) -> Input:
        r"""Allows to connect merged_fields_containers_support input to the operator.
    ...
    @property
    def fields_containers1(self) -> Input[FieldsContainer]:
    ...
    @property
    def fields_containers2(self) -> Input[FieldsContainer]:
...
class OutputsMergeWeightedFieldsContainers(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._merged_fields_container: Output[FieldsContainer] = Output(
            merge_weighted_fields_containers._spec().output_pin(0), 0, op
        )
        self._outputs.append(self._merged_fields_container)

    @property
    def merged_fields_container(self) -> Output[FieldsContainer]:
        r"""Allows to get merged_fields_container output of the operator
