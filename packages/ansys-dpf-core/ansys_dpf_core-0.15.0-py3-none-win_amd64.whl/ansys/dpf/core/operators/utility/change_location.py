...
class InputsChangeLocation(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._field: Input[Field] = Input(
            change_location._spec().input_pin(0), 0, op, -1
        )
        self._inputs.append(self._field)
        self._new_location: Input[str] = Input(
            change_location._spec().input_pin(1), 1, op, -1
        )
...
class OutputsChangeLocation(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._field: Output[Field] = Output(
            change_location._spec().output_pin(0), 0, op
        )
