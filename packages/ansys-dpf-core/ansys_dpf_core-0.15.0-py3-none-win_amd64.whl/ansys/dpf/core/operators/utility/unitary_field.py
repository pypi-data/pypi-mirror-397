...
class unitary_field(Operator):
    r"""Takes a field and returns another field of scalars in the same location
    ...
    def _spec() -> Specification:
        description = r"""Takes a field and returns another field of scalars in the same location
and scoping as the input field.
"""
        spec = Specification(
    ...
    @property
    def inputs(self) -> InputsUnitaryField:
...
class InputsUnitaryField(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._field: Input[Field | FieldsContainer] = Input(
            unitary_field._spec().input_pin(0), 0, op, -1
        )
