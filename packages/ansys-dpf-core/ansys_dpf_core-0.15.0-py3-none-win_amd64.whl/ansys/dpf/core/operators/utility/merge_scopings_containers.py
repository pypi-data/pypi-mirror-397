...
class InputsMergeScopingsContainers(_Inputs):
    ...
    @property
    def scopings_containers2(self) -> Input[ScopingsContainer]:
...
class OutputsMergeScopingsContainers(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._merged_scopings_container: Output[ScopingsContainer] = Output(
            merge_scopings_containers._spec().output_pin(0), 0, op
        )
        self._outputs.append(self._merged_scopings_container)

    @property
    def merged_scopings_container(self) -> Output[ScopingsContainer]:
