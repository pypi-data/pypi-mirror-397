...
class remote_operator_instantiate(Operator):
    ...
    and an address) for a given protocol registered in the streams. A
    ...
    def _spec() -> Specification:
        description = r"""Create a local image of an existing remote operator (identified by an id
and an address) for a given protocol registered in the streams. A
workflow is created with this operator and returned in output
"""
        spec = Specification(
            ...
            map_input_pin_spec={
                ...
                1: PinSpecification(
                    ...
                    type_names=["int32"],
                    optional=False,
                    document=r"""pin number of the output to name""",
                ),
                3: PinSpecification(
                ...
                5: PinSpecification(
                    ...
                    type_names=["string"],
                    optional=False,
                    document=r"""output's name of the workflow to return""",
                ),
            },
            map_output_pin_spec={
                0: PinSpecification(
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        return Operator.default_config(
            name="remote_operator_instantiate", server=server
        )

    @property
    def inputs(self) -> InputsRemoteOperatorInstantiate:
