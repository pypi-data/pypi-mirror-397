...
class remote_workflow_instantiate(Operator):
    r"""Sends a local workflow to a remote process (and keep a local image of
    it) or create a local image of an existing remote workflow (identified
    ...
    def _spec() -> Specification:
        description = r"""Sends a local workflow to a remote process (and keep a local image of
it) or create a local image of an existing remote workflow (identified
by an id and an address) for a given protocol registered in the streams.
"""
        spec = Specification(
            ...
            map_input_pin_spec={
                0: PinSpecification(
                    ...
                    optional=False,
                    document=r"""local workflow to push to a remote or id of a remote workflow""",
                ),
                3: PinSpecification(
            ...
            map_output_pin_spec={
                0: PinSpecification(
                    ...
                    type_names=["workflow"],
                    optional=False,
                    document=r"""remote workflow containing an image of the remote workflow and the protocols streams""",
                ),
            },
        )
        return spec
    ...
    @property
    def inputs(self) -> InputsRemoteWorkflowInstantiate:
...
class InputsRemoteWorkflowInstantiate(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._workflow_to_send: Input[Workflow | int] = Input(
    ...
    @property
    def workflow_to_send(self) -> Input[Workflow | int]:
        r"""Allows to connect workflow_to_send input to the operator.
