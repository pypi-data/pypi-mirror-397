...
class InputsWindowHanningFc(_Inputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(window_hanning_fc._spec().inputs, op)
        self._fields_container: Input[FieldsContainer] = Input(
            window_hanning_fc._spec().input_pin(0), 0, op, -1
        )
...
class OutputsWindowHanningFc(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(window_hanning_fc._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            window_hanning_fc._spec().output_pin(0), 0, op
        )
