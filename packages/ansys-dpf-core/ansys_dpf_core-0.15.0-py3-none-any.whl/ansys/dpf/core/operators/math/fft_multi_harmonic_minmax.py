...
class InputsFftMultiHarmonicMinmax(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._rpm_scoping: Input[Scoping] = Input(
...
class OutputsFftMultiHarmonicMinmax(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._field_min: Output[FieldsContainer] = Output(
            fft_multi_harmonic_minmax._spec().output_pin(0), 0, op
        )
        self._outputs.append(self._field_min)
        self._field_max: Output[FieldsContainer] = Output(
            fft_multi_harmonic_minmax._spec().output_pin(1), 1, op
        )
        self._outputs.append(self._field_max)
        self._all_fields: Output[FieldsContainer] = Output(
