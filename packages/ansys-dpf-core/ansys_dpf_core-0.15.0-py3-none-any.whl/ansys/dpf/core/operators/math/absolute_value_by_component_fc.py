...
class InputsAbsoluteValueByComponentFc(_Inputs):
    ...
    absolute_value_by_component_fc operator.
    ...
    def __init__(self, op: Operator):
        super().__init__(absolute_value_by_component_fc._spec().inputs, op)
        self._fields_container: Input[FieldsContainer] = Input(
            absolute_value_by_component_fc._spec().input_pin(0), 0, op, -1
        )
...
class OutputsAbsoluteValueByComponentFc(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(absolute_value_by_component_fc._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            absolute_value_by_component_fc._spec().output_pin(0), 0, op
        )
