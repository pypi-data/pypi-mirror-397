...
class InputsScaleFc(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Input[FieldsContainer] = Input(
            scale_fc._spec().input_pin(0), 0, op, -1
        )
        self._inputs.append(self._fields_container)
        self._weights: Input[float | Field | FieldsContainer] = Input(
            scale_fc._spec().input_pin(1), 1, op, -1
        )
        self._inputs.append(self._weights)
        self._boolean: Input[bool] = Input(scale_fc._spec().input_pin(2), 2, op, -1)
        self._inputs.append(self._boolean)
        self._algorithm: Input[int] = Input(scale_fc._spec().input_pin(3), 3, op, -1)
    ...
    @property
    def weights(self) -> Input[float | Field | FieldsContainer]:
...
class OutputsScaleFc(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Output[FieldsContainer] = Output(
            scale_fc._spec().output_pin(0), 0, op
        )
