        ...
        spec = Specification(
            ...
            map_input_pin_spec={
                1: PinSpecification(
                    ...
                    optional=True,
                    document=r"""Element Type ids to recover used by the solver. If not set, all available element types are recovered.""",
                ),
                3: PinSpecification(
                    name="streams",
                ...
                200: PinSpecification(
                    ...
                    type_names=["int32"],
                    optional=True,
                    document=r"""Get the output as a GenericDataContainer (pin value 1, default) or as a PropertyField (pin value 2).""",
                ),
            },
            map_output_pin_spec={
                0: PinSpecification(
