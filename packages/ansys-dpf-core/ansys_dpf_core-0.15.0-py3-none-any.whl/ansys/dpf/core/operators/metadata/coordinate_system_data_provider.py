...
class InputsCoordinateSystemDataProvider(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._solver_coordinate_system_ids: Input[int] = Input(
    ...
    @property
    def solver_coordinate_system_ids(self) -> Input[int]:
...
class OutputsCoordinateSystemDataProvider(_Outputs):
    ...
    @property
    def coordinate_system_data2(self) -> Output[GenericDataContainer]:
