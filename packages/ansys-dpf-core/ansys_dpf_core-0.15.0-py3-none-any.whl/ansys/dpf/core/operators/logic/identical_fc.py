...
class OutputsIdenticalFc(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._message: Output[str] = Output(identical_fc._spec().output_pin(1), 1, op)
