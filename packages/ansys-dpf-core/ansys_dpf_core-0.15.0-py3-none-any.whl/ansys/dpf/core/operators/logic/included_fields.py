...
class OutputsIncludedFields(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._included: Output[bool] = Output(
            included_fields._spec().output_pin(0), 0, op
        )
        self._outputs.append(self._included)
        self._message: Output[str] = Output(
            included_fields._spec().output_pin(1), 1, op
        )
