...
class InputsMeshProvider(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._time_scoping: Input[int] = Input(
            mesh_provider._spec().input_pin(0), 0, op, -1
        )
        self._inputs.append(self._time_scoping)
        self._streams_container: Input[StreamsContainer] = Input(
            mesh_provider._spec().input_pin(3), 3, op, -1
        )
        self._inputs.append(self._streams_container)
        self._data_sources: Input[DataSources] = Input(
            mesh_provider._spec().input_pin(4), 4, op, -1
        )
        self._inputs.append(self._data_sources)
        self._read_cyclic: Input[int] = Input(
            mesh_provider._spec().input_pin(14), 14, op, -1
        )
        self._inputs.append(self._read_cyclic)
        self._region_scoping: Input[Scoping | int] = Input(
            mesh_provider._spec().input_pin(25), 25, op, -1
        )
        self._inputs.append(self._region_scoping)
        self._laziness: Input[DataTree] = Input(
            mesh_provider._spec().input_pin(200), 200, op, -1
        )
        self._inputs.append(self._laziness)

    @property
    def time_scoping(self) -> Input[int]:
    ...
    @property
    def laziness(self) -> Input[DataTree]:
...
class OutputsMeshProvider(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._mesh: Output[MeshedRegion] = Output(
            mesh_provider._spec().output_pin(0), 0, op
        )
