...
class InputsDecimateMesh(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._mesh: Input[MeshedRegion] = Input(
            decimate_mesh._spec().input_pin(0), 0, op, -1
        )
        self._inputs.append(self._mesh)
        self._preservation_ratio: Input[float] = Input(
            decimate_mesh._spec().input_pin(1), 1, op, -1
        )
        self._inputs.append(self._preservation_ratio)
        self._aggressiveness: Input[int] = Input(
            decimate_mesh._spec().input_pin(2), 2, op, -1
        )
    ...
    @property
    def preservation_ratio(self) -> Input[float]:
    ...
    @property
    def aggressiveness(self) -> Input[int]:
...
class OutputsDecimateMesh(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._mesh: Output[MeshedRegion] = Output(
            decimate_mesh._spec().output_pin(0), 0, op
        )
