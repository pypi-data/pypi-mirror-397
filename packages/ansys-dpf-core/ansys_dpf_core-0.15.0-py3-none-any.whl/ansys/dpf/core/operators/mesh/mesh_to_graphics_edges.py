...
class InputsMeshToGraphicsEdges(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._include_mid_nodes: Input[bool] = Input(
        ...
        self._mesh: Input[MeshedRegion] = Input(
            mesh_to_graphics_edges._spec().input_pin(7), 7, op, -1
        )
    ...
    @property
    def include_mid_nodes(self) -> Input[bool]:
...
class OutputsMeshToGraphicsEdges(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._nodes: Output[Field] = Output(
            mesh_to_graphics_edges._spec().output_pin(0), 0, op
        )
        self._outputs.append(self._nodes)
        self._connectivity: Output[PropertyField] = Output(
            mesh_to_graphics_edges._spec().output_pin(2), 2, op
        )
