...
class merge_materials(Operator):
    ...
    def _spec() -> Specification:
        description = r"""Assembles a set of materials into a unique one.
"""
        spec = Specification(
    ...
    @property
    def inputs(self) -> InputsMergeMaterials:
...
class InputsMergeMaterials(_Inputs):
    ...
    @property
    def materials1(self) -> Input:
        r"""Allows to connect materials1 input to the operator.
    ...
    @property
    def materials2(self) -> Input:
        r"""Allows to connect materials2 input to the operator.
...
class OutputsMergeMaterials(_Outputs):
    ...
    @property
    def merged_materials(self) -> Output:
        r"""Allows to get merged_materials output of the operator
