...
class InputsMergeDataTree(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._data_tree1: Input[DataTree] = Input(
            merge_data_tree._spec().input_pin(0), 0, op, 0
        )
        self._inputs.append(self._data_tree1)
        self._data_tree2: Input[DataTree] = Input(
            merge_data_tree._spec().input_pin(1), 1, op, 1
        )
        self._inputs.append(self._data_tree2)

    @property
    def data_tree1(self) -> Input[DataTree]:
    ...
    @property
    def data_tree2(self) -> Input[DataTree]:
...
class OutputsMergeDataTree(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._any: Output[Any] = Output(merge_data_tree._spec().output_pin(0), 0, op)
