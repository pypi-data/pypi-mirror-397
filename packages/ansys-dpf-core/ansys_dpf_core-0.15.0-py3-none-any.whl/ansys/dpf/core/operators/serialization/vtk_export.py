...
class vtk_export(Operator):
    ...
    def _spec() -> Specification:
        description = r"""Write the input field and fields container into a given vtk path
"""
        spec = Specification(
            ...
            map_input_pin_spec={
                -1: PinSpecification(
                    ...
                    type_names=["int32"],
                    optional=True,
                    document=r"""Either export volume elements in the mesh with their fields with value 0 or faces elements in the mesh with their fields with value 1 (default is 0)""",
                ),
                0: PinSpecification(
                    name="file_path",
                    type_names=["string"],
                    optional=False,
                    document=r"""path with vtk extension were the export occurs""",
                ),
                1: PinSpecification(
                    name="mesh",
    ...
    @property
    def inputs(self) -> InputsVtkExport:
