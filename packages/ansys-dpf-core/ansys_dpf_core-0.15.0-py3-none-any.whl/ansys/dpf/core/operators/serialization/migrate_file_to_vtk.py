...
class InputsMigrateFileToVtk(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._output_filename: Input[str] = Input(
        ...
        self._data_sources: Input[DataSources] = Input(
            migrate_file_to_vtk._spec().input_pin(4), 4, op, -1
        )
        self._inputs.append(self._data_sources)

    @property
    def output_filename(self) -> Input[str]:
...
class OutputsMigrateFileToVtk(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._data_sources: Output[DataSources] = Output(
            migrate_file_to_vtk._spec().output_pin(0), 0, op
        )
