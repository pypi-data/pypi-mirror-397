...
class rms_temperature(Operator):
    r"""Read RMS Temperature by calling the readers defined by the datasources.
    ...
    >>> op = dpf.operators.result.rms_temperature()
    ...
    def _spec() -> Specification:
        description = r"""Read RMS Temperature by calling the readers defined by the datasources.
"""
        spec = Specification(
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="TEMP_RMS", server=server)

    @property
    def inputs(self) -> InputsRmsTemperature:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsRmsTemperature.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsRmsTemperature:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsRmsTemperature.
        """
        return self._outputs


class InputsRmsTemperature(_Inputs):
    """Intermediate class used to connect user inputs to
    rms_temperature operator.
...
class OutputsRmsTemperature(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(rms_temperature._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            rms_temperature._spec().output_pin(0), 0, op
        )
