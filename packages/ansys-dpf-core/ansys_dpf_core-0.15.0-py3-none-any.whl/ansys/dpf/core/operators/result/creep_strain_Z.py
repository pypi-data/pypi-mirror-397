...
class creep_strain_Z(Operator):
    r"""Read/compute element nodal component creep strains ZZ normal component
    ...
    >>> op = dpf.operators.result.creep_strain_Z()
    ...
    def _spec() -> Specification:
        description = r"""Read/compute element nodal component creep strains ZZ normal component
(22 component) by calling the readers defined by the datasources.
Regarding the requested location and the input mesh scoping, the result
location can be Nodal/ElementalNodal/Elemental.
"""
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="EPCRZ", server=server)

    @property
    def inputs(self) -> InputsCreepStrainZ:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsCreepStrainZ.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsCreepStrainZ:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsCreepStrainZ.
        """
        return self._outputs


class InputsCreepStrainZ(_Inputs):
    """Intermediate class used to connect user inputs to
    creep_strain_Z operator.
...
class OutputsCreepStrainZ(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(creep_strain_Z._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            creep_strain_Z._spec().output_pin(0), 0, op
        )
