...
class gasket_stress_X(Operator):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsGasketStressX,
            outputs_type=OutputsGasketStressX,
        )
...
class InputsGasketStressX(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._mesh: Input[MeshedRegion | MeshesContainer] = Input(
            gasket_stress_X._spec().input_pin(7), 7, op, -1
        )
        ...
        self._read_cyclic: Input[int] = Input(
            gasket_stress_X._spec().input_pin(14), 14, op, -1
        )
...
class OutputsGasketStressX(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Output[FieldsContainer] = Output(
            gasket_stress_X._spec().output_pin(0), 0, op
        )
