...
class elastic_strain_X(Operator):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsElasticStrainX,
            outputs_type=OutputsElasticStrainX,
        )
...
class OutputsElasticStrainX(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Output[FieldsContainer] = Output(
            elastic_strain_X._spec().output_pin(0), 0, op
        )
