...
class plastic_strain_XZ(Operator):
    r"""Read/compute element nodal component plastic strains XZ shear component
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsPlasticStrainXz,
            outputs_type=OutputsPlasticStrainXz,
        )
    ...
    def _spec() -> Specification:
        description = r"""Read/compute element nodal component plastic strains XZ shear component
(02 component) by calling the readers defined by the datasources.
Regarding the requested location and the input mesh scoping, the result
location can be Nodal/ElementalNodal/Elemental.
"""
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="EPPLXZ", server=server)

    @property
    def inputs(self) -> InputsPlasticStrainXz:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsPlasticStrainXz.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsPlasticStrainXz:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsPlasticStrainXz.
        """
...
class OutputsPlasticStrainXz(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Output[FieldsContainer] = Output(
            plastic_strain_XZ._spec().output_pin(0), 0, op
        )
