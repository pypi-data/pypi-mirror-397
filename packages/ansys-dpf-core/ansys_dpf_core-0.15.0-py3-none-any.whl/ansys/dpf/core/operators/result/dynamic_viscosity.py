...
class OutputsDynamicViscosity(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(dynamic_viscosity._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            dynamic_viscosity._spec().output_pin(0), 0, op
        )
