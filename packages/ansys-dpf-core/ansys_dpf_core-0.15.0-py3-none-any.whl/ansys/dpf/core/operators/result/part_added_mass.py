...
class part_added_mass(Operator):
    r"""Read Part Added Mass (LSDyna) by calling the readers defined by the
    datasources.
    ...
    def _spec() -> Specification:
        description = r"""Read Part Added Mass (LSDyna) by calling the readers defined by the
datasources.
"""
        spec = Specification(
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="M_ENG_AM", server=server)

    @property
    def inputs(self) -> InputsPartAddedMass:
...
class OutputsPartAddedMass(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Output[FieldsContainer] = Output(
            part_added_mass._spec().output_pin(0), 0, op
        )
