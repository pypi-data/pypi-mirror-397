...
class rms_velocity(Operator):
    r"""Read RMS Velocity by calling the readers defined by the datasources.
    ...
    >>> op = dpf.operators.result.rms_velocity()
    ...
    def _spec() -> Specification:
        description = r"""Read RMS Velocity by calling the readers defined by the datasources.
"""
        spec = Specification(
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="V_RMS", server=server)

    @property
    def inputs(self) -> InputsRmsVelocity:
...
class OutputsRmsVelocity(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(rms_velocity._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            rms_velocity._spec().output_pin(0), 0, op
        )
