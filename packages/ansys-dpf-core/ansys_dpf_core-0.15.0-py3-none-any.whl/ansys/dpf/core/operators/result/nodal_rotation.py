...
class nodal_rotation(Operator):
    r"""Read/compute nodal rotation by calling the readers defined by the
    datasources.
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsNodalRotation,
            outputs_type=OutputsNodalRotation,
        )
    ...
    def _spec() -> Specification:
        description = r"""Read/compute nodal rotation by calling the readers defined by the
datasources.
"""
        spec = Specification(
    ...
    @property
    def inputs(self) -> InputsNodalRotation:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsNodalRotation.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsNodalRotation:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsNodalRotation.
        """
        return self._outputs


class InputsNodalRotation(_Inputs):
    """Intermediate class used to connect user inputs to
    nodal_rotation operator.
...
class OutputsNodalRotation(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(nodal_rotation._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            nodal_rotation._spec().output_pin(0), 0, op
        )
