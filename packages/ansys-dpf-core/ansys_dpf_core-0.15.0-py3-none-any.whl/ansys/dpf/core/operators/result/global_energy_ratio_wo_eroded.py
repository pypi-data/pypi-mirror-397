...
class global_energy_ratio_wo_eroded(Operator):
    r"""Read Global Energy ratio without Eroded Energy (LSDyna) by calling the
    ...
    def _spec() -> Specification:
        description = r"""Read Global Energy ratio without Eroded Energy (LSDyna) by calling the
readers defined by the datasources.
"""
        spec = Specification(
    ...
    @property
    def inputs(self) -> InputsGlobalEnergyRatioWoEroded:
