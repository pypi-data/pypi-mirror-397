...
class acceleration_X(Operator):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsAccelerationX,
            outputs_type=OutputsAccelerationX,
        )
...
class OutputsAccelerationX(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Output[FieldsContainer] = Output(
            acceleration_X._spec().output_pin(0), 0, op
        )
