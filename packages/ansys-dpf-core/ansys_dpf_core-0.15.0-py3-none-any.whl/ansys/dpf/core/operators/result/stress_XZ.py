...
class stress_XZ(Operator):
    r"""Read/compute element nodal component stresses XZ shear component (02
    ...
    def _spec() -> Specification:
        description = r"""Read/compute element nodal component stresses XZ shear component (02
component) by calling the readers defined by the datasources. Regarding
the requested location and the input mesh scoping, the result location
can be Nodal/ElementalNodal/Elemental.
"""
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="SXZ", server=server)

    @property
    def inputs(self) -> InputsStressXz:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsStressXz.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsStressXz:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsStressXz.
        """
...
class OutputsStressXz(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Output[FieldsContainer] = Output(
            stress_XZ._spec().output_pin(0), 0, op
        )
