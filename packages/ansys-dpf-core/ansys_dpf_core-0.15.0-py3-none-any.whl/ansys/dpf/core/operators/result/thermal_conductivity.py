...
class thermal_conductivity(Operator):
    r"""Read Thermal Conductivity by calling the readers defined by the
    datasources.
    ...
    >>> op = dpf.operators.result.thermal_conductivity()
    ...
    def _spec() -> Specification:
        description = r"""Read Thermal Conductivity by calling the readers defined by the
datasources.
"""
        spec = Specification(
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="KT", server=server)

    @property
    def inputs(self) -> InputsThermalConductivity:
...
class OutputsThermalConductivity(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(thermal_conductivity._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            thermal_conductivity._spec().output_pin(0), 0, op
        )
