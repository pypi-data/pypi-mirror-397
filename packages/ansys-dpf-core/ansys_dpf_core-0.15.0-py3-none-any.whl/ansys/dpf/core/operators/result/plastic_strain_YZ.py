...
class plastic_strain_YZ(Operator):
    r"""Read/compute element nodal component plastic strains YZ shear component
    ...
    def _spec() -> Specification:
        description = r"""Read/compute element nodal component plastic strains YZ shear component
(12 component) by calling the readers defined by the datasources.
Regarding the requested location and the input mesh scoping, the result
location can be Nodal/ElementalNodal/Elemental.
"""
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="EPPLYZ", server=server)

    @property
    def inputs(self) -> InputsPlasticStrainYz:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsPlasticStrainYz.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsPlasticStrainYz:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsPlasticStrainYz.
        """
...
class OutputsPlasticStrainYz(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Output[FieldsContainer] = Output(
            plastic_strain_YZ._spec().output_pin(0), 0, op
        )
