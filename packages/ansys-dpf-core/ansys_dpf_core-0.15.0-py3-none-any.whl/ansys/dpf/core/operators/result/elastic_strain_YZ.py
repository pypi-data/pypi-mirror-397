...
class elastic_strain_YZ(Operator):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsElasticStrainYz,
            outputs_type=OutputsElasticStrainYz,
        )
...
class OutputsElasticStrainYz(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Output[FieldsContainer] = Output(
            elastic_strain_YZ._spec().output_pin(0), 0, op
        )
