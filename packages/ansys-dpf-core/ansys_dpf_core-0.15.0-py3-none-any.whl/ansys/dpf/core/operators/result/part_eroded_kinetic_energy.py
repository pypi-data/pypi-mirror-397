...
class part_eroded_kinetic_energy(Operator):
    r"""Read Part Eroded Kinetic Energy (LSDyna) by calling the readers defined
    by the datasources.
    ...
    def _spec() -> Specification:
        description = r"""Read Part Eroded Kinetic Energy (LSDyna) by calling the readers defined
by the datasources.
"""
        spec = Specification(
    ...
    @property
    def inputs(self) -> InputsPartErodedKineticEnergy:
