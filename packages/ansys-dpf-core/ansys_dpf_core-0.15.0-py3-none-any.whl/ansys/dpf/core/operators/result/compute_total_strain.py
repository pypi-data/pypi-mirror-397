...
class compute_total_strain(Operator):
    ...
    def __init__(
        ...
        super().__init__(
            name="compute_total_strain",
            config=config,
            server=server,
            inputs_type=InputsComputeTotalStrain,
            outputs_type=OutputsComputeTotalStrain,
        )
...
class OutputsComputeTotalStrain(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(compute_total_strain._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            compute_total_strain._spec().output_pin(0), 0, op
        )
