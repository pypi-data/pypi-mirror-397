...
class OutputsEpsilon(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(epsilon._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            epsilon._spec().output_pin(0), 0, op
        )
