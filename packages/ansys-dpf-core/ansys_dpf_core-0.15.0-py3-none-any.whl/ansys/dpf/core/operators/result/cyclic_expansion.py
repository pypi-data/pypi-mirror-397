...
class InputsCyclicExpansion(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._time_scoping: Input[Scoping] = Input(
            cyclic_expansion._spec().input_pin(0), 0, op, -1
        )
        self._inputs.append(self._time_scoping)
        self._mesh_scoping: Input[ScopingsContainer | Scoping] = Input(
            cyclic_expansion._spec().input_pin(1), 1, op, -1
        )
        self._inputs.append(self._mesh_scoping)
        self._fields_container: Input[FieldsContainer] = Input(
            cyclic_expansion._spec().input_pin(2), 2, op, -1
        )
        self._inputs.append(self._fields_container)
        self._harmonic_index: Input[int] = Input(
            cyclic_expansion._spec().input_pin(3), 3, op, -1
        )
        ...
        self._phi: Input[float] = Input(
            cyclic_expansion._spec().input_pin(19), 19, op, -1
        )
    ...
    @property
    def harmonic_index(self) -> Input[int]:
    ...
    @property
    def normalization_factor(self) -> Input[float]:
    ...
    @property
    def merge_stages(self) -> Input[bool]:
...
class OutputsCyclicExpansion(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Output[FieldsContainer] = Output(
            cyclic_expansion._spec().output_pin(0), 0, op
        )
