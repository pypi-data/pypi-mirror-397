...
class static_pressure(Operator):
    r"""Read Static Pressure by calling the readers defined by the datasources.
    ...
    >>> op = dpf.operators.result.static_pressure()
    ...
    def _spec() -> Specification:
        description = r"""Read Static Pressure by calling the readers defined by the datasources.
"""
        spec = Specification(
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="P_S", server=server)

    @property
    def inputs(self) -> InputsStaticPressure:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsStaticPressure.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsStaticPressure:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsStaticPressure.
        """
        return self._outputs


class InputsStaticPressure(_Inputs):
    """Intermediate class used to connect user inputs to
    static_pressure operator.
...
class OutputsStaticPressure(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(static_pressure._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            static_pressure._spec().output_pin(0), 0, op
        )
