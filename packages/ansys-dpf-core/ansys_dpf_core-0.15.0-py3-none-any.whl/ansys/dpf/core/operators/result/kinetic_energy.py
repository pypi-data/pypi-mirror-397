...
class InputsKineticEnergy(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._read_cyclic: Input[int] = Input(
            kinetic_energy._spec().input_pin(14), 14, op, -1
        )
        ...
        self._phi: Input[float] = Input(
            kinetic_energy._spec().input_pin(19), 19, op, -1
        )
...
class OutputsKineticEnergy(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Output[FieldsContainer] = Output(
            kinetic_energy._spec().output_pin(0), 0, op
        )
