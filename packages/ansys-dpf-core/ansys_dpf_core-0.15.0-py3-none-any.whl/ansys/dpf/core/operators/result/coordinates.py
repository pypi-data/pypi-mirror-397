...
class coordinates(Operator):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsCoordinates,
            outputs_type=OutputsCoordinates,
        )
...
class OutputsCoordinates(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(coordinates._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            coordinates._spec().output_pin(0), 0, op
        )
