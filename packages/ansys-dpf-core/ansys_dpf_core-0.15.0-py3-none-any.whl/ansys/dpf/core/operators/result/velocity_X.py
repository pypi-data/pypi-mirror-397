...
class velocity_X(Operator):
    r"""Read/compute nodal velocities X component of the vector (1st component)
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsVelocityX,
            outputs_type=OutputsVelocityX,
        )
    ...
    def _spec() -> Specification:
        description = r"""Read/compute nodal velocities X component of the vector (1st component)
by calling the readers defined by the datasources.
"""
        spec = Specification(
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="VX", server=server)

    @property
    def inputs(self) -> InputsVelocityX:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsVelocityX.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsVelocityX:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsVelocityX.
        """
...
class OutputsVelocityX(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Output[FieldsContainer] = Output(
            velocity_X._spec().output_pin(0), 0, op
        )
