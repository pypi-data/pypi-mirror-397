...
class InputsAcceleration(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._sectors_to_expand: Input[Scoping | ScopingsContainer] = Input(
            acceleration._spec().input_pin(18), 18, op, -1
        )
        self._inputs.append(self._sectors_to_expand)
        self._phi: Input[float] = Input(acceleration._spec().input_pin(19), 19, op, -1)
...
class OutputsAcceleration(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Output[FieldsContainer] = Output(
            acceleration._spec().output_pin(0), 0, op
        )
