...
class poynting_vector(Operator):
    ...
    def _spec() -> Specification:
        description = r"""Compute the Poynting Vector
"""
        spec = Specification(
            ...
            map_input_pin_spec={
                ...
                4: PinSpecification(
                    ...
                    optional=True,
                    document=r"""the mesh region in this pin have to be boundary or skin mesh""",
                ),
                5: PinSpecification(
                    name="int32",
                    type_names=["int32"],
                    optional=True,
                    document=r"""load step number, if it's specified, the Poynting Vector is computed only on the substeps of this step""",
                ),
            },
            map_output_pin_spec={
                0: PinSpecification(
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="PoyntingVector", server=server)

    @property
    def inputs(self) -> InputsPoyntingVector:
