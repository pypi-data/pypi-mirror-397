...
class interface_contact_moment(Operator):
    r"""Read Interface Contact Moment (LSDyna) by calling the readers defined by
    the datasources.
    ...
    def _spec() -> Specification:
        description = r"""Read Interface Contact Moment (LSDyna) by calling the readers defined by
the datasources.
"""
        spec = Specification(
    ...
    @property
    def inputs(self) -> InputsInterfaceContactMoment:
