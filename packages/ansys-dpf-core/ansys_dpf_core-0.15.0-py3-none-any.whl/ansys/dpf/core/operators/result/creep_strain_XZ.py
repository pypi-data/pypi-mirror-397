...
class creep_strain_XZ(Operator):
    r"""Read/compute element nodal component creep strains XZ shear component
    ...
    >>> op = dpf.operators.result.creep_strain_XZ()
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsCreepStrainXz,
    ...
    def _spec() -> Specification:
        description = r"""Read/compute element nodal component creep strains XZ shear component
(02 component) by calling the readers defined by the datasources.
Regarding the requested location and the input mesh scoping, the result
location can be Nodal/ElementalNodal/Elemental.
"""
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="EPCRXZ", server=server)

    @property
    def inputs(self) -> InputsCreepStrainXz:
...
class OutputsCreepStrainXz(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(creep_strain_XZ._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            creep_strain_XZ._spec().output_pin(0), 0, op
        )
