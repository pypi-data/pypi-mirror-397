...
class stress_Z(Operator):
    r"""Read/compute element nodal component stresses ZZ normal component (22
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsStressZ,
            outputs_type=OutputsStressZ,
        )
    ...
    def _spec() -> Specification:
        description = r"""Read/compute element nodal component stresses ZZ normal component (22
component) by calling the readers defined by the datasources. Regarding
the requested location and the input mesh scoping, the result location
can be Nodal/ElementalNodal/Elemental.
"""
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="SZ", server=server)

    @property
    def inputs(self) -> InputsStressZ:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsStressZ.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsStressZ:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsStressZ.
        """
...
class OutputsStressZ(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Output[FieldsContainer] = Output(
            stress_Z._spec().output_pin(0), 0, op
        )
