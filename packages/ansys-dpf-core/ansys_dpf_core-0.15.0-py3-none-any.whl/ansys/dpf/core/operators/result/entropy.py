...
class entropy(Operator):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsEntropy,
            outputs_type=OutputsEntropy,
        )
...
class OutputsEntropy(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(entropy._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            entropy._spec().output_pin(0), 0, op
        )
