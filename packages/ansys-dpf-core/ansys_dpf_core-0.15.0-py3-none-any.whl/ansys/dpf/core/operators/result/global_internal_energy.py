...
class global_internal_energy(Operator):
    r"""Read Global Internal Energy (LSDyna) by calling the readers defined by
    the datasources.
    ...
    def _spec() -> Specification:
        description = r"""Read Global Internal Energy (LSDyna) by calling the readers defined by
the datasources.
"""
        spec = Specification(
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="GLOB_ENG_IE", server=server)

    @property
    def inputs(self) -> InputsGlobalInternalEnergy:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsGlobalInternalEnergy.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsGlobalInternalEnergy:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsGlobalInternalEnergy.
        """
        return self._outputs


class InputsGlobalInternalEnergy(_Inputs):
    """Intermediate class used to connect user inputs to
    global_internal_energy operator.
    ...
    def __init__(self, op: Operator):
        ...
        self._unit_system: Input[int | str | UnitSystem] = Input(
            global_internal_energy._spec().input_pin(50), 50, op, -1
        )
...
class OutputsGlobalInternalEnergy(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(global_internal_energy._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            global_internal_energy._spec().output_pin(0), 0, op
        )
