...
class InputsComputeTotalStrainZ(_Inputs):
    ...
    compute_total_strain_Z operator.
...
class OutputsComputeTotalStrainZ(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(compute_total_strain_Z._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            compute_total_strain_Z._spec().output_pin(0), 0, op
        )
