...
class mach_number(Operator):
    r"""Read Mach Number by calling the readers defined by the datasources.
    ...
    >>> op = dpf.operators.result.mach_number()
    ...
    def _spec() -> Specification:
        description = r"""Read Mach Number by calling the readers defined by the datasources.
"""
        spec = Specification(
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="MACH", server=server)

    @property
    def inputs(self) -> InputsMachNumber:
...
class OutputsMachNumber(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(mach_number._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            mach_number._spec().output_pin(0), 0, op
        )
