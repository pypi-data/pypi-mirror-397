...
class OutputsDensity(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(density._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            density._spec().output_pin(0), 0, op
        )
