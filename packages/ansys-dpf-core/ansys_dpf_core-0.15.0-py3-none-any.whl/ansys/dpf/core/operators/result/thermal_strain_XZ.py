...
class thermal_strain_XZ(Operator):
    r"""Read/compute element nodal component thermal strains XZ shear component
    ...
    >>> op = dpf.operators.result.thermal_strain_XZ()
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsThermalStrainXz,
            outputs_type=OutputsThermalStrainXz,
        )
    ...
    def _spec() -> Specification:
        description = r"""Read/compute element nodal component thermal strains XZ shear component
(02 component) by calling the readers defined by the datasources.
Regarding the requested location and the input mesh scoping, the result
location can be Nodal/ElementalNodal/Elemental.
"""
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="ETHXZ", server=server)

    @property
    def inputs(self) -> InputsThermalStrainXz:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsThermalStrainXz.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsThermalStrainXz:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsThermalStrainXz.
        """
        return self._outputs


class InputsThermalStrainXz(_Inputs):
    """Intermediate class used to connect user inputs to
    thermal_strain_XZ operator.
...
class OutputsThermalStrainXz(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(thermal_strain_XZ._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            thermal_strain_XZ._spec().output_pin(0), 0, op
        )
