...
class velocity_Y(Operator):
    r"""Read/compute nodal velocities Y component of the vector (2nd component)
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsVelocityY,
            outputs_type=OutputsVelocityY,
        )
    ...
    def _spec() -> Specification:
        description = r"""Read/compute nodal velocities Y component of the vector (2nd component)
by calling the readers defined by the datasources.
"""
        spec = Specification(
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="VY", server=server)

    @property
    def inputs(self) -> InputsVelocityY:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsVelocityY.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsVelocityY:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsVelocityY.
        """
...
class OutputsVelocityY(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Output[FieldsContainer] = Output(
            velocity_Y._spec().output_pin(0), 0, op
        )
