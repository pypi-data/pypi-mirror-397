...
class compute_total_strain_1(Operator):
    ...
    def __init__(
        ...
        super().__init__(
            name="compute_total_strain_1",
            config=config,
            server=server,
            inputs_type=InputsComputeTotalStrain1,
            outputs_type=OutputsComputeTotalStrain1,
        )
...
class InputsComputeTotalStrain1(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._scoping: Input[Scoping] = Input(
            compute_total_strain_1._spec().input_pin(1), 1, op, -1
        )
        ...
        self._nonlinear: Input[int] = Input(
            compute_total_strain_1._spec().input_pin(6), 6, op, -1
        )
