...
class compute_total_strain_YZ(Operator):
    ...
    def __init__(
        ...
        super().__init__(
            name="compute_total_strain_YZ",
            config=config,
            server=server,
            inputs_type=InputsComputeTotalStrainYz,
            outputs_type=OutputsComputeTotalStrainYz,
        )
...
class InputsComputeTotalStrainYz(_Inputs):
    ...
    compute_total_strain_YZ operator.
...
class OutputsComputeTotalStrainYz(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(compute_total_strain_YZ._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            compute_total_strain_YZ._spec().output_pin(0), 0, op
        )
