...
class rms_static_pressure(Operator):
    r"""Read RMS Static Pressure by calling the readers defined by the
    datasources.
    ...
    >>> op = dpf.operators.result.rms_static_pressure()
    ...
    def _spec() -> Specification:
        description = r"""Read RMS Static Pressure by calling the readers defined by the
datasources.
"""
        spec = Specification(
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="P_SRMS", server=server)

    @property
    def inputs(self) -> InputsRmsStaticPressure:
...
class OutputsRmsStaticPressure(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(rms_static_pressure._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            rms_static_pressure._spec().output_pin(0), 0, op
        )
