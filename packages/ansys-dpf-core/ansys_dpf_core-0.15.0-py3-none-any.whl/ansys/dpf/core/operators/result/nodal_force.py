...
class nodal_force(Operator):
    r"""Read/compute nodal forces by calling the readers defined by the
    datasources.
    ...
    def _spec() -> Specification:
        description = r"""Read/compute nodal forces by calling the readers defined by the
datasources.
"""
        spec = Specification(
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="F", server=server)

    @property
    def inputs(self) -> InputsNodalForce:
...
class OutputsNodalForce(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Output[FieldsContainer] = Output(
            nodal_force._spec().output_pin(0), 0, op
        )
