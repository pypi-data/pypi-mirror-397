...
class plastic_strain_Y(Operator):
    r"""Read/compute element nodal component plastic strains YY normal component
    ...
    def _spec() -> Specification:
        description = r"""Read/compute element nodal component plastic strains YY normal component
(11 component) by calling the readers defined by the datasources.
Regarding the requested location and the input mesh scoping, the result
location can be Nodal/ElementalNodal/Elemental.
"""
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="EPPLY", server=server)

    @property
    def inputs(self) -> InputsPlasticStrainY:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsPlasticStrainY.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsPlasticStrainY:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsPlasticStrainY.
        """
...
class OutputsPlasticStrainY(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Output[FieldsContainer] = Output(
            plastic_strain_Y._spec().output_pin(0), 0, op
        )
