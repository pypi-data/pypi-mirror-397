...
class elastic_strain_XZ(Operator):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsElasticStrainXz,
            outputs_type=OutputsElasticStrainXz,
        )
...
class OutputsElasticStrainXz(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Output[FieldsContainer] = Output(
            elastic_strain_XZ._spec().output_pin(0), 0, op
        )
