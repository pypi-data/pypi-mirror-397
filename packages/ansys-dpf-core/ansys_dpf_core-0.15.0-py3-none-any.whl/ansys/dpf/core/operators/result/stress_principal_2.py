...
class stress_principal_2(Operator):
    r"""Read/compute element nodal component stresses 2nd principal component by
    ...
    def _spec() -> Specification:
        description = r"""Read/compute element nodal component stresses 2nd principal component by
calling the readers defined by the datasources and computing its eigen
values. This operation is independent of the coordinate system unless
averaging across elements is requested, in which case a rotation to the
global coordinate system is performed.
"""
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="S2", server=server)

    @property
    def inputs(self) -> InputsStressPrincipal2:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsStressPrincipal2.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsStressPrincipal2:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsStressPrincipal2.
        """
...
class OutputsStressPrincipal2(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Output[FieldsContainer] = Output(
            stress_principal_2._spec().output_pin(0), 0, op
        )
