...
class volume_fraction(Operator):
    r"""Read Volume Fraction by calling the readers defined by the datasources.
    ...
    >>> op = dpf.operators.result.volume_fraction()
    ...
    def _spec() -> Specification:
        description = r"""Read Volume Fraction by calling the readers defined by the datasources.
"""
        spec = Specification(
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="VOF", server=server)

    @property
    def inputs(self) -> InputsVolumeFraction:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsVolumeFraction.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsVolumeFraction:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsVolumeFraction.
        """
        return self._outputs


class InputsVolumeFraction(_Inputs):
    """Intermediate class used to connect user inputs to
    volume_fraction operator.
...
class OutputsVolumeFraction(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(volume_fraction._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            volume_fraction._spec().output_pin(0), 0, op
        )
