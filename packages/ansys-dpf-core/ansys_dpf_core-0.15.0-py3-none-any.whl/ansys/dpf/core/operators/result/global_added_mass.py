...
class global_added_mass(Operator):
    r"""Read Global Added Mass (LSDyna) by calling the readers defined by the
    datasources.
    ...
    >>> op = dpf.operators.result.global_added_mass()
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsGlobalAddedMass,
            outputs_type=OutputsGlobalAddedMass,
        )
    ...
    def _spec() -> Specification:
        description = r"""Read Global Added Mass (LSDyna) by calling the readers defined by the
datasources.
"""
        spec = Specification(
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="GLOB_AM", server=server)

    @property
    def inputs(self) -> InputsGlobalAddedMass:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsGlobalAddedMass.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsGlobalAddedMass:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsGlobalAddedMass.
        """
        return self._outputs


class InputsGlobalAddedMass(_Inputs):
    """Intermediate class used to connect user inputs to
    global_added_mass operator.
    ...
    def __init__(self, op: Operator):
        super().__init__(global_added_mass._spec().inputs, op)
        self._streams_container: Input[StreamsContainer] = Input(
            global_added_mass._spec().input_pin(3), 3, op, -1
        )
        self._inputs.append(self._streams_container)
        self._data_sources: Input[DataSources] = Input(
            global_added_mass._spec().input_pin(4), 4, op, -1
        )
        self._inputs.append(self._data_sources)
        self._unit_system: Input[int | str | UnitSystem] = Input(
            global_added_mass._spec().input_pin(50), 50, op, -1
        )
...
class OutputsGlobalAddedMass(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(global_added_mass._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            global_added_mass._spec().output_pin(0), 0, op
        )
