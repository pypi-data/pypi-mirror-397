...
class InputsBeamAxialStress(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._unit_system: Input[int | str | UnitSystem] = Input(
            beam_axial_stress._spec().input_pin(50), 50, op, -1
        )
...
class OutputsBeamAxialStress(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(beam_axial_stress._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            beam_axial_stress._spec().output_pin(0), 0, op
        )
