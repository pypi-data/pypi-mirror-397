...
class compute_total_strain_Y(Operator):
    ...
    def __init__(
        ...
        super().__init__(
            name="compute_total_strain_Y",
            config=config,
            server=server,
            inputs_type=InputsComputeTotalStrainY,
...
class InputsComputeTotalStrainY(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._scoping: Input[Scoping] = Input(
            compute_total_strain_Y._spec().input_pin(1), 1, op, -1
        )
        ...
        self._nonlinear: Input[int] = Input(
            compute_total_strain_Y._spec().input_pin(6), 6, op, -1
        )
