...
class total_contact_force(Operator):
    r"""Read/compute total contact force by calling the readers defined by the
    datasources.
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsTotalContactForce,
            outputs_type=OutputsTotalContactForce,
        )
    ...
    def _spec() -> Specification:
        description = r"""Read/compute total contact force by calling the readers defined by the
datasources.
"""
        spec = Specification(
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="CFFTOT", server=server)

    @property
    def inputs(self) -> InputsTotalContactForce:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsTotalContactForce.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsTotalContactForce:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsTotalContactForce.
        """
        return self._outputs


class InputsTotalContactForce(_Inputs):
    """Intermediate class used to connect user inputs to
    total_contact_force operator.
...
class OutputsTotalContactForce(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(total_contact_force._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            total_contact_force._spec().output_pin(0), 0, op
        )
