...
class raw_reaction_force(Operator):
    r"""Read/compute F vector from the finite element problem KU=F by calling
    the readers defined by the datasources.
    ...
    def _spec() -> Specification:
        description = r"""Read/compute F vector from the finite element problem KU=F by calling
the readers defined by the datasources.
"""
        spec = Specification(
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="RFTOT", server=server)

    @property
    def inputs(self) -> InputsRawReactionForce:
...
class OutputsRawReactionForce(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Output[FieldsContainer] = Output(
            raw_reaction_force._spec().output_pin(0), 0, op
        )
