...
class joint_relative_rotation(Operator):
    r"""Read/compute joint relative rotation by calling the readers defined by
    the datasources.
    ...
    def _spec() -> Specification:
        description = r"""Read/compute joint relative rotation by calling the readers defined by
the datasources.
"""
        spec = Specification(
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="JR", server=server)

    @property
    def inputs(self) -> InputsJointRelativeRotation:
...
class InputsJointRelativeRotation(_Inputs):
    ...
    joint_relative_rotation operator.
...
class OutputsJointRelativeRotation(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(joint_relative_rotation._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            joint_relative_rotation._spec().output_pin(0), 0, op
        )
