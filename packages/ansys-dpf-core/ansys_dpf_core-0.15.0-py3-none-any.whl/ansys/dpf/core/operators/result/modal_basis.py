...
class modal_basis(Operator):
    r"""Read/compute modal basis by calling the readers defined by the
    datasources.
    ...
    def _spec() -> Specification:
        description = r"""Read/compute modal basis by calling the readers defined by the
datasources.
"""
        spec = Specification(
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="ModalBasis", server=server)

    @property
    def inputs(self) -> InputsModalBasis:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsModalBasis.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsModalBasis:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsModalBasis.
        """
...
class OutputsModalBasis(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Output[FieldsContainer] = Output(
            modal_basis._spec().output_pin(0), 0, op
        )
