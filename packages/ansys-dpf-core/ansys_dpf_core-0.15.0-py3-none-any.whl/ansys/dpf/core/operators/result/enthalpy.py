...
class OutputsEnthalpy(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(enthalpy._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            enthalpy._spec().output_pin(0), 0, op
        )
