...
class velocity(Operator):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsVelocity,
            outputs_type=OutputsVelocity,
        )
    ...
    def _spec() -> Specification:
        description = r"""Read/compute nodal velocities by calling the readers defined by the
datasources.
"""
        spec = Specification(
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="V", server=server)

    @property
    def inputs(self) -> InputsVelocity:
