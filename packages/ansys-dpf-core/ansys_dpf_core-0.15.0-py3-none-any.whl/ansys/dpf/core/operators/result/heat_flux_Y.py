...
class heat_flux_Y(Operator):
    r"""Read/compute heat flux Y component of the vector (2nd component) by
    ...
    def _spec() -> Specification:
        description = r"""Read/compute heat flux Y component of the vector (2nd component) by
calling the readers defined by the datasources. Regarding the requested
location and the input mesh scoping, the result location can be
Nodal/ElementalNodal/Elemental.
"""
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="TFY", server=server)

    @property
    def inputs(self) -> InputsHeatFluxY:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsHeatFluxY.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsHeatFluxY:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsHeatFluxY.
        """
...
class OutputsHeatFluxY(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Output[FieldsContainer] = Output(
            heat_flux_Y._spec().output_pin(0), 0, op
        )
