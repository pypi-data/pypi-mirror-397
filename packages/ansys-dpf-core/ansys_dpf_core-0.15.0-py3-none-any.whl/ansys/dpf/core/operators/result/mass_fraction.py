...
class mass_fraction(Operator):
    r"""Read Mass Fraction by calling the readers defined by the datasources.
    ...
    def _spec() -> Specification:
        description = r"""Read Mass Fraction by calling the readers defined by the datasources.
"""
        spec = Specification(
    ...
    @property
    def inputs(self) -> InputsMassFraction:
...
class OutputsMassFraction(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Output[FieldsContainer] = Output(
            mass_fraction._spec().output_pin(0), 0, op
        )
