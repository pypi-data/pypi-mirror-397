...
class stress_principal_1(Operator):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsStressPrincipal1,
...
"""
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="S1", server=server)

    @property
    def inputs(self) -> InputsStressPrincipal1:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsStressPrincipal1.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsStressPrincipal1:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsStressPrincipal1.
        """
...
class InputsStressPrincipal1(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._mesh: Input[MeshedRegion | MeshesContainer] = Input(
            stress_principal_1._spec().input_pin(7), 7, op, -1
        )
        self._inputs.append(self._mesh)
        self._requested_location: Input[str] = Input(
            stress_principal_1._spec().input_pin(9), 9, op, -1
        )
        self._inputs.append(self._requested_location)
        self._read_cyclic: Input[int] = Input(
            stress_principal_1._spec().input_pin(14), 14, op, -1
        )
        self._inputs.append(self._read_cyclic)
        self._read_beams: Input[bool] = Input(
            stress_principal_1._spec().input_pin(22), 22, op, -1
        )
...
class OutputsStressPrincipal1(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Output[FieldsContainer] = Output(
            stress_principal_1._spec().output_pin(0), 0, op
        )
