...
class thermal_strain_Z(Operator):
    r"""Read/compute element nodal component thermal strains ZZ normal component
    ...
    >>> op = dpf.operators.result.thermal_strain_Z()
    ...
    def _spec() -> Specification:
        description = r"""Read/compute element nodal component thermal strains ZZ normal component
(22 component) by calling the readers defined by the datasources.
Regarding the requested location and the input mesh scoping, the result
location can be Nodal/ElementalNodal/Elemental.
"""
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="ETHZ", server=server)

    @property
    def inputs(self) -> InputsThermalStrainZ:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsThermalStrainZ.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsThermalStrainZ:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsThermalStrainZ.
        """
        return self._outputs


class InputsThermalStrainZ(_Inputs):
    """Intermediate class used to connect user inputs to
    thermal_strain_Z operator.
...
class OutputsThermalStrainZ(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(thermal_strain_Z._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            thermal_strain_Z._spec().output_pin(0), 0, op
        )
