...
class omega(Operator):
    r"""Read Turbulent Specific Dissipation Rate (omega) by calling the readers
    ...
    def _spec() -> Specification:
        description = r"""Read Turbulent Specific Dissipation Rate (omega) by calling the readers
defined by the datasources.
"""
        spec = Specification(
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="OME", server=server)

    @property
    def inputs(self) -> InputsOmega:
...
class OutputsOmega(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(omega._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            omega._spec().output_pin(0), 0, op
        )
