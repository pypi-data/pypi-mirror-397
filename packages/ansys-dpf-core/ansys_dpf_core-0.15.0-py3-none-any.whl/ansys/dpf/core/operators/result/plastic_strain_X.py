...
class plastic_strain_X(Operator):
    r"""Read/compute element nodal component plastic strains XX normal component
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsPlasticStrainX,
            outputs_type=OutputsPlasticStrainX,
        )
    ...
    def _spec() -> Specification:
        description = r"""Read/compute element nodal component plastic strains XX normal component
(00 component) by calling the readers defined by the datasources.
Regarding the requested location and the input mesh scoping, the result
location can be Nodal/ElementalNodal/Elemental.
"""
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="EPPLX", server=server)

    @property
    def inputs(self) -> InputsPlasticStrainX:
...
class OutputsPlasticStrainX(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Output[FieldsContainer] = Output(
            plastic_strain_X._spec().output_pin(0), 0, op
        )
