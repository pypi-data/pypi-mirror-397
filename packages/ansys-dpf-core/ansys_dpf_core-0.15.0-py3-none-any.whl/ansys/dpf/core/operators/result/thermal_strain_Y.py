...
class thermal_strain_Y(Operator):
    r"""Read/compute element nodal component thermal strains YY normal component
    ...
    >>> op = dpf.operators.result.thermal_strain_Y()
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsThermalStrainY,
            outputs_type=OutputsThermalStrainY,
        )
    ...
    def _spec() -> Specification:
        description = r"""Read/compute element nodal component thermal strains YY normal component
(11 component) by calling the readers defined by the datasources.
Regarding the requested location and the input mesh scoping, the result
location can be Nodal/ElementalNodal/Elemental.
"""
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="ETHY", server=server)

    @property
    def inputs(self) -> InputsThermalStrainY:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsThermalStrainY.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsThermalStrainY:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsThermalStrainY.
        """
        return self._outputs


class InputsThermalStrainY(_Inputs):
    """Intermediate class used to connect user inputs to
    thermal_strain_Y operator.
...
class OutputsThermalStrainY(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(thermal_strain_Y._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            thermal_strain_Y._spec().output_pin(0), 0, op
        )
