...
class raw_displacement(Operator):
    r"""Read/compute U vector from the finite element problem KU=F by calling
    ...
    def _spec() -> Specification:
        description = r"""Read/compute U vector from the finite element problem KU=F by calling
the readers defined by the datasources.
"""
        spec = Specification(
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="UTOT", server=server)

    @property
    def inputs(self) -> InputsRawDisplacement:
...
class OutputsRawDisplacement(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Output[FieldsContainer] = Output(
            raw_displacement._spec().output_pin(0), 0, op
        )
