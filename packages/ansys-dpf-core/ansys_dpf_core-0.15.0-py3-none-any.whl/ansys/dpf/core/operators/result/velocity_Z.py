...
class velocity_Z(Operator):
    r"""Read/compute nodal velocities Z component of the vector (3rd component)
    ...
    def _spec() -> Specification:
        description = r"""Read/compute nodal velocities Z component of the vector (3rd component)
by calling the readers defined by the datasources.
"""
        spec = Specification(
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="VZ", server=server)

    @property
    def inputs(self) -> InputsVelocityZ:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsVelocityZ.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsVelocityZ:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsVelocityZ.
        """
...
class OutputsVelocityZ(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Output[FieldsContainer] = Output(
            velocity_Z._spec().output_pin(0), 0, op
        )
