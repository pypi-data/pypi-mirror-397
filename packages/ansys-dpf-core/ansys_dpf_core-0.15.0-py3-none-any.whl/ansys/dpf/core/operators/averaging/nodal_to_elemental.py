...
class nodal_to_elemental(Operator):
    ...
    def __init__(
        ...
        super().__init__(
            name="nodal_to_elemental",
            config=config,
            server=server,
            inputs_type=InputsNodalToElemental,
            outputs_type=OutputsNodalToElemental,
        )
...
class InputsNodalToElemental(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._field: Input[Field | FieldsContainer] = Input(
            nodal_to_elemental._spec().input_pin(0), 0, op, -1
        )
        self._inputs.append(self._field)
        self._mesh_scoping: Input[Scoping] = Input(
            nodal_to_elemental._spec().input_pin(1), 1, op, -1
        )
...
class OutputsNodalToElemental(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._field: Output[Field] = Output(
            nodal_to_elemental._spec().output_pin(0), 0, op
        )
