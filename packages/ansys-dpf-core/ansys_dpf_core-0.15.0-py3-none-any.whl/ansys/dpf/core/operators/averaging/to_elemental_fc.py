...
class InputsToElementalFc(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Input[FieldsContainer] = Input(
            to_elemental_fc._spec().input_pin(0), 0, op, -1
        )
        self._inputs.append(self._fields_container)
        self._mesh: Input[MeshedRegion] = Input(
            to_elemental_fc._spec().input_pin(1), 1, op, -1
        )
        self._inputs.append(self._mesh)
        self._mesh_scoping: Input[Scoping] = Input(
            to_elemental_fc._spec().input_pin(3), 3, op, -1
        )
        self._inputs.append(self._mesh_scoping)
        self._smoothen_values: Input[bool] = Input(
            to_elemental_fc._spec().input_pin(7), 7, op, -1
        )
        ...
        self._shell_layer: Input[int] = Input(
            to_elemental_fc._spec().input_pin(27), 27, op, -1
        )
    ...
    @property
    def smoothen_values(self) -> Input[bool]:
...
class OutputsToElementalFc(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Output[FieldsContainer] = Output(
            to_elemental_fc._spec().output_pin(0), 0, op
        )
