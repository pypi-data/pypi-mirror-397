...
class InputsNodalDifferenceFc(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Input[FieldsContainer] = Input(
            nodal_difference_fc._spec().input_pin(0), 0, op, -1
        )
        self._inputs.append(self._fields_container)
        self._mesh: Input[MeshedRegion | MeshesContainer] = Input(
            nodal_difference_fc._spec().input_pin(1), 1, op, -1
        )
        self._inputs.append(self._mesh)
        self._scoping: Input[Scoping | ScopingsContainer] = Input(
            nodal_difference_fc._spec().input_pin(3), 3, op, -1
        )
...
class OutputsNodalDifferenceFc(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Output[FieldsContainer] = Output(
            nodal_difference_fc._spec().output_pin(0), 0, op
        )
