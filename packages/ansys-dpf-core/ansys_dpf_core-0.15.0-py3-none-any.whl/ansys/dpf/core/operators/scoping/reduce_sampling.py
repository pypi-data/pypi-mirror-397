...
class InputsReduceSampling(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._mesh_scoping: Input[Scoping] = Input(
            reduce_sampling._spec().input_pin(0), 0, op, -1
        )
        self._inputs.append(self._mesh_scoping)
        self._denominator: Input[int] = Input(
            reduce_sampling._spec().input_pin(1), 1, op, -1
        )
    ...
    @property
    def denominator(self) -> Input[int]:
...
class OutputsReduceSampling(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._mesh_scoping: Output[Scoping] = Output(
            reduce_sampling._spec().output_pin(0), 0, op
        )
