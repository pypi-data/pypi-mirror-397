...
class on_mesh_property(Operator):
    ...
    def __init__(
        ...
        super().__init__(
            name="meshscoping_provider_by_prop",
            config=config,
            server=server,
...
class OutputsOnMeshProperty(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._mesh_scoping: Output[Scoping] = Output(
            on_mesh_property._spec().output_pin(0), 0, op
        )
