...
from ...models.toggle_schedule_request import ToggleScheduleRequest
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/streamline/automations/{automation_id}/schedule/toggle".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        automation_id (str):
        body (ToggleScheduleRequest): Schema for toggling schedule.
