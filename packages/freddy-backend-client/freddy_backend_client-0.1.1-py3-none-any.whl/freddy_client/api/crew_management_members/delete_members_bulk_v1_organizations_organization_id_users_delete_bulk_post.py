...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/organizations/{organization_id}/users/delete-bulk".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Delete Members Bulk
     ...
     Bulk delete organization members with partial failure handling.

    Requires:
    - User must be authenticated
    - User must be a member of the organization
    - User must have Admin or Owner role
    - Organization owner will be skipped automatically
    ...
    Args:
        ...
        body (BulkDeleteRequest): Schema for bulk delete request.
