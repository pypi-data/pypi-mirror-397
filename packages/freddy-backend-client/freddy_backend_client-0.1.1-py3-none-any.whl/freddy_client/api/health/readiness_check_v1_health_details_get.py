...
from ...models.detailed_health_check import DetailedHealthCheck
...
) -> DetailedHealthCheck | None:
    if response.status_code == 200:
        response_200 = DetailedHealthCheck.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    - Limit enforcement system status
