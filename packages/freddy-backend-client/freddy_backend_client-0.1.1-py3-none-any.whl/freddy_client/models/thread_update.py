...
if TYPE_CHECKING:
    from ..models.thread_update_metadata_type_0 import ThreadUpdateMetadataType0
...
class ThreadUpdate:
    ...
    Attributes:
        ...
        metadata (None | ThreadUpdateMetadataType0 | Unset): Custom key-value pairs (max 16 pairs, keys ≤64 chars,
            values ≤512 chars)
    ...
    metadata: None | ThreadUpdateMetadataType0 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.metadata, Unset):
            metadata = UNSET
        elif isinstance(self.metadata, ThreadUpdateMetadataType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_metadata(data: object) -> None | ThreadUpdateMetadataType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                metadata_type_0 = ThreadUpdateMetadataType0.from_dict(data)

                return metadata_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | ThreadUpdateMetadataType0 | Unset, data)
