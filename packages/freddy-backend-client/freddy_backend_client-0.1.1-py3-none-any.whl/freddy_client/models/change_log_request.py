...
T = TypeVar("T", bound="ChangeLogRequest")


@_attrs_define
class ChangeLogRequest:
    """Schema for requesting change logs with pagination.

    Attributes:
        skip (int | Unset): Number of records to skip Default: 0.
        take (int | Unset): Number of records to return (max 100) Default: 50.
        start_date (datetime.datetime | None | Unset): Filter logs from this date
        end_date (datetime.datetime | None | Unset): Filter logs until this date
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        change_log_request.additional_properties = d
        return change_log_request
