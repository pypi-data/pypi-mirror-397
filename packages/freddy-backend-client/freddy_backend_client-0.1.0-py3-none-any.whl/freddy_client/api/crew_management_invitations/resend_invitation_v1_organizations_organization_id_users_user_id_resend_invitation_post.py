...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/organizations/{organization_id}/users/{user_id}/resend-invitation".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Resend Invitation
     ...
     Resend invitation to a single user.
    ...
    Args:
        ...
        user_id (str): User ID (usr_...) or OrganizationUser ID (orgusr_...) to resend invitation
            to
