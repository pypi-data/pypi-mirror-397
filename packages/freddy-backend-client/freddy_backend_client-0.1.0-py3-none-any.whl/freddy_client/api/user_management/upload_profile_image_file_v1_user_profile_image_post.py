...
from ...models.body_upload_profile_image_file_v1_user_profile_image_post import (
...
def _get_kwargs(
    *,
    body: BodyUploadProfileImageFileV1UserProfileImagePost,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Accepts image file upload (multipart/form-data) and processes it into
    ...
    **Errors:**
    ...
    - 422: Invalid file type, file too large, or corrupted image
