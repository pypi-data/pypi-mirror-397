...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": "/v1/organizations/{organization_id}/users/{user_id}/delete".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Delete Member
     ...
     Soft delete a single organization member.
    ...
    Raises:
        ValidationException: If attempting to delete owner
