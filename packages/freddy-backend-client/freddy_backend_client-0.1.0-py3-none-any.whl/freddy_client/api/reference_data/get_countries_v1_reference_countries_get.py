...
) -> list[CountryResponse] | None:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = CountryResponse.from_dict(response_200_item_data)
...
def sync_detailed(
    *,
    ...
    Returns a comprehensive list of countries with ISO codes, currency information,
    phone codes, and geographic data.

    **Returns:**
    - List of country objects with:
