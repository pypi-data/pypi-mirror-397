...
T = TypeVar("T", bound="OrganizationLimits")
...
class OrganizationLimits:
    ...
    Attributes:
        ...
        monthly_limit (float | None | Unset): Monthly limit in CHF
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        organization_limits.additional_properties = d
