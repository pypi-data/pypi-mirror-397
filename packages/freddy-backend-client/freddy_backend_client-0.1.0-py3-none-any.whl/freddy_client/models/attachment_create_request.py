...
T = TypeVar("T", bound="AttachmentCreateRequest")


@_attrs_define
class AttachmentCreateRequest:
    """Request schema for attaching an entity to a rule.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        attachment_create_request.additional_properties = d
        return attachment_create_request
