...
if TYPE_CHECKING:
    from ..models.assistant_response_logit_bias_type_0 import (
        AssistantResponseLogitBiasType0,
    )
    from ..models.assistant_response_metadata_type_0 import (
        AssistantResponseMetadataType0,
    )
    from ..models.assistant_response_system_message_type_0_item import (
        AssistantResponseSystemMessageType0Item,
    )
    from ..models.assistant_response_text_config_type_0 import (
        AssistantResponseTextConfigType0,
    )
    from ..models.assistant_response_tool_capabilities_type_0 import (
...
class AssistantResponse:
    ...
    Attributes:
        ...
        system_message (list[AssistantResponseSystemMessageType0Item] | None | Unset): System messages
        ...
        logit_bias (AssistantResponseLogitBiasType0 | None | Unset): Logit bias
        ...
        metadata (AssistantResponseMetadataType0 | None | Unset): Custom metadata
        text_config (AssistantResponseTextConfigType0 | None | Unset): Text configuration
        deleted_at (int | None | Unset): Deletion timestamp
        ...
        rule_ids (list[str] | None | Unset): Attached rule IDs
        tool_capabilities (AssistantResponseToolCapabilitiesType0 | None | Unset): Tool capabilities (computed)
    """
    ...
    system_message: list[AssistantResponseSystemMessageType0Item] | None | Unset = UNSET
    ...
    logit_bias: AssistantResponseLogitBiasType0 | None | Unset = UNSET
    ...
    metadata: AssistantResponseMetadataType0 | None | Unset = UNSET
    text_config: AssistantResponseTextConfigType0 | None | Unset = UNSET
    ...
    tool_capabilities: AssistantResponseToolCapabilitiesType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.logit_bias, Unset):
            logit_bias = UNSET
        elif isinstance(self.logit_bias, AssistantResponseLogitBiasType0):
        ...
        if isinstance(self.metadata, Unset):
            metadata = UNSET
        elif isinstance(self.metadata, AssistantResponseMetadataType0):
        ...
        if isinstance(self.text_config, Unset):
            text_config = UNSET
        elif isinstance(self.text_config, AssistantResponseTextConfigType0):
        ...
        tool_capabilities: dict[str, Any] | None | Unset
        if isinstance(self.tool_capabilities, Unset):
            tool_capabilities = UNSET
        elif isinstance(self.tool_capabilities, AssistantResponseToolCapabilitiesType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_system_message(
            data: object,
        ) -> list[AssistantResponseSystemMessageType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for system_message_type_0_item_data in _system_message_type_0:
                    system_message_type_0_item = (
                        AssistantResponseSystemMessageType0Item.from_dict(
                ...
                pass
            return cast(
                list[AssistantResponseSystemMessageType0Item] | None | Unset, data
            )
        ...
        def _parse_logit_bias(
            data: object,
        ) -> AssistantResponseLogitBiasType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                logit_bias_type_0 = AssistantResponseLogitBiasType0.from_dict(data)

                return logit_bias_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(AssistantResponseLogitBiasType0 | None | Unset, data)
        ...
        def _parse_metadata(
            data: object,
        ) -> AssistantResponseMetadataType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                metadata_type_0 = AssistantResponseMetadataType0.from_dict(data)

                return metadata_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(AssistantResponseMetadataType0 | None | Unset, data)

        metadata = _parse_metadata(d.pop("metadata", UNSET))

        def _parse_text_config(
            data: object,
        ) -> AssistantResponseTextConfigType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                text_config_type_0 = AssistantResponseTextConfigType0.from_dict(data)

                return text_config_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(AssistantResponseTextConfigType0 | None | Unset, data)
        ...
        def _parse_tool_capabilities(
            data: object,
        ) -> AssistantResponseToolCapabilitiesType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                tool_capabilities_type_0 = (
                    AssistantResponseToolCapabilitiesType0.from_dict(data)
                )

                return tool_capabilities_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(AssistantResponseToolCapabilitiesType0 | None | Unset, data)

        tool_capabilities = _parse_tool_capabilities(d.pop("tool_capabilities", UNSET))
