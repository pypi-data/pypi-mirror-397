...
def from_mne_epochs(
    ...
    --------
    >>> import mne
    >>> from nimbus_pysdk.compat import from_mne_epochs
...
def to_mne_epochs(
    ...
    Examples
    --------
    >>> from nimbus_pysdk.compat import from_mne_epochs, to_mne_epochs
...
def extract_bandpower_features(
    ...
    Examples
    --------
    >>> from nimbus_pysdk.compat import extract_bandpower_features
    ...
    try:
        ...
        raise ImportError(
            ...
            "Install with: pip install nimbus-pysdk[all] (or pip install scipy)"
        ) from e
...
def create_bci_pipeline(
    ...
    **model_kwargs,
    ...
    ----------
    model_class : class
        Nimbus classifier class (NimbusLDA, NimbusGMM, NimbusSoftmax).
    ...
    **model_kwargs
    ...
    >>> from nimbus_pysdk.compat import create_bci_pipeline
