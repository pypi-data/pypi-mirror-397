...
However, we recommend installing the pre-release version, 1.0.0a1, since it has many improvements over version 0.1.0. 
You can install version 1.0.0a1 with the following command:
```bash
