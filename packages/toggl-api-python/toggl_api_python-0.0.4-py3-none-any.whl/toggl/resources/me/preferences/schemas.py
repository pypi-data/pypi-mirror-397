...
class AlphaFeatures(ResponseBase):
...
class DefaultProjectTask(ResponseBase):
    project_id: int = Field(description="Project ID")
    task_id: int | None = Field(description="Task ID", default=None)
    workspace_id: int = Field(description="Workspace ID")

class MacOSAutoTrackingRules(ResponseBase):
    id: str
    keyword: str
    project_id: int
    task_id: int
...
class MacOSShowHideTogglKeyboardShortcut(ResponseBase):
    key: int
    modifiers: int
    
class MacOSStopContinueKeyboardShortcut(ResponseBase):
    key: int
    modifiers: int

class PomodoroBreakProject(ResponseBase):
    id: int
    workspace_id: int


class PomodoroBreakTag(ResponseBase):
    id: int
    workspace_id: int

class WindowsAutoTrackingRules(ResponseBase):
    billable: bool
    description: str
    enabled: bool
    id: str
...
class WindowsShowHideTogglKeyboardShortcut(ResponseBase):
    key: int
    modifiers: int
    
class WindowsStopContinueKeyboardShortcut(ResponseBase):
    key: int
    modifiers: int

class WindowsStopStartKeyboardShortcut(ResponseBase):
    key: int
    modifiers: int

class WorkoutDefaultProject(ResponseBase):
    id: int
    workspace_id: int


class WorkoutDefaultTag(ResponseBase):
    id: int
    workspace_id: int


class Preferences(ResponseBase):
