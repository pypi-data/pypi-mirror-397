...
if(NOT mim_solvers_FOUND)
  set(skip_this_file FALSE)
endif()
if(skip_this_file)
  foreach(component ${mim_solvers_FIND_COMPONENTS})
    if(NOT "mim_solvers_${component}_FOUND")
      set(skip_this_file FALSE)
    endif()
  endforeach()
endif()
...
set("mim_solvers_INCLUDE_DIRS" "${PACKAGE_PREFIX_DIR}/include")
set("MIM_SOLVERS_INCLUDE_DIRS" "${PACKAGE_PREFIX_DIR}/include")
set("mim_solvers_DOXYGENDOCDIR" "${PACKAGE_PREFIX_DIR}/share/doc/mim_solvers/doxygen-html")
set("MIM_SOLVERS_DOXYGENDOCDIR" "${PACKAGE_PREFIX_DIR}/share/doc/mim_solvers/doxygen-html")
set("mim_solvers_DEPENDENCIES" "crocoddyl;proxsuite")
set("mim_solvers_PKG_CONFIG_DEPENDENCIES" "")
...
set("_mim_solvers_PKG_CONFIG_LIBDIR" "${pcfiledir}/../../lib")
set("_mim_solvers_PKG_CONFIG_LIBS_LIST" "")
if(_mim_solvers_PKG_CONFIG_LIBS_LIST)
  string(FIND ${_mim_solvers_PKG_CONFIG_LIBS_LIST} ", " _is_comma_space)
  while(_is_comma_space GREATER -1)
    string(REPLACE ", " "," _mim_solvers_PKG_CONFIG_LIBS_LIST "${_mim_solvers_PKG_CONFIG_LIBS_LIST}")
    string(FIND ${_mim_solvers_PKG_CONFIG_LIBS_LIST} ", " _is_comma_space)
  endwhile()
  string(REPLACE " " ";" _mim_solvers_PKG_CONFIG_LIBS_LIST "${_mim_solvers_PKG_CONFIG_LIBS_LIST}")
  set(LIBDIR_HINTS ${_mim_solvers_PKG_CONFIG_LIBDIR})
  foreach(component ${_mim_solvers_PKG_CONFIG_LIBS_LIST})
  ...
  endforeach()
endif(_mim_solvers_PKG_CONFIG_LIBS_LIST)

set("mim_solvers_LIBRARIES" ${_PACKAGE_CONFIG_LIBRARIES})
set("MIM_SOLVERS_LIBRARIES" ${_PACKAGE_CONFIG_LIBRARIES})
...
if(${CMAKE_VERSION} VERSION_LESS "3.15.0")
  find_package(crocoddyl 3.0.0 REQUIRED)
  find_package(proxsuite REQUIRED)
else()
  find_dependency(crocoddyl 3.0.0 REQUIRED)
  find_dependency(proxsuite REQUIRED)
endif()

IF(COMMAND ADD_REQUIRED_DEPENDENCY)
  FOREACH(pkgcfg_dep ${mim_solvers_PKG_CONFIG_DEPENDENCIES})
...
include("${CMAKE_CURRENT_LIST_DIR}/mim_solversTargets.cmake")
...
foreach(component ${mim_solvers_FIND_COMPONENTS})
  ...
  if(EXISTS ${comp_file})
    ...
    set(mim_solvers_${component}_FOUND FALSE)
  endif()
  if(mim_solvers_${component}_FOUND)
    message(STATUS "mim_solvers: ${component} found.")
  else()
    if(mim_solvers_FIND_REQUIRED_${component})
      message(FATAL_ERROR "mim_solvers: ${component} not found.")
    else()
      message(STATUS "mim_solvers: ${component} not found.")
    endif()
  endif()
endforeach()
check_required_components("mim_solvers")
