...
async def convert_file_url_example():
    ...
    """
    result = await client.call_tool("convert_file_url", {"url": urls, "enable_ocr": True})
...
async def get_api_status_example():
    ...
    # 获取使用帮助
    help_text = await client.read_resource("help://usage")
    print(f"使用帮助: {help_text}...")  # 显示前 100 个字符
