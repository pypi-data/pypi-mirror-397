...
def validate_boxed_answer(solution_str: Optional[str], ground_truth: Optional[str]) -> bool:
    if ground_truth is None:
        raise Exception("Ground truth answer is required for validation.")
    if not solution_str:
        return False
    ...
    return any(
        [
            grade_answer_mathd(given_answer, ground_truth),
            grade_answer_sympy(given_answer, ground_truth),
        ]
    )
