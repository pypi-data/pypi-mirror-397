...
LANGUAGES: List[Dict[str, str]] = [
    ...
    {"name": "塞尔维亚文（cyrillic)", "description": "Serbian(cyrillic)", "code": "rs_cyrillic"},
...
def get_language_by_code(code: str) -> Dict[str, str]:
    """根据语言代码获取语言信息。"""
    FALLBACK_LANGUAGE = {"name": "未知语言", "description": "Unknown Language", "code": code}
    return LANGUAGES_DICT.get(code, FALLBACK_LANGUAGE)
