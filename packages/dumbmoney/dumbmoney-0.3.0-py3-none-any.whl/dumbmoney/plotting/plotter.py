    ...
    **kwargs
    ...
    if indicators:
      if not panels or len(panels) < len(indicators):
        raise ValueError("Length of panels list must match length of indicators list.")
      ...
      for i, ind in enumerate(indicators):
        ...
        palettes[panel] = palettes[panel][ind.values.shape[1]:] + palettes[panel][:ind.values.shape[1]]
