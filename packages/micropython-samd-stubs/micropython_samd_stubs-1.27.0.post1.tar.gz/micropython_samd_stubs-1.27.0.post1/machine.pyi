...
---
Module: 'machine' on micropython-v1.27.0-samd-SEEED_WIO_TERMINAL
"""
...
"""Reset causes."""
SOFT_RESET: Final[int] = 64
"""Reset causes."""
PWRON_RESET: Final[int] = 1
"""Reset causes."""
DEEPSLEEP_RESET: Final[int] = 128
"""Reset causes."""
WDT_RESET: Final[int] = 32
"""Reset causes."""
ATTN_0DB: int = ...
...
class Pin:
    ...
    """Selects the pin mode."""
    LOW_POWER: Final[int] = 0
    PULL_DOWN: Final[int] = 2
    """\
    Selects whether there is a pull up/down resistor.  Use the value
    ``None`` for no pull.
    """
    PULL_OFF: Final[int] = 0
    PULL_UP: Final[int] = 1
    """\
    Selects whether there is a pull up/down resistor.  Use the value
    ``None`` for no pull.
    ...
    class board:
        ...
        SCL: Pin  ## = Pin(Pin.cpu.PA12, mode=IN, pull=PULL_OFF)
        SDA: Pin  ## = Pin(Pin.cpu.PA13, mode=IN, pull=PULL_OFF)
