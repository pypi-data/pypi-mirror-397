...
@dataclass_json
@dataclass
class V4VpcListSubnetRequest(CtyunOpenAPIRequest):
    regionID: str  # 资源池 ID
    vpcID: str  # VPC 的 ID
...
@dataclass_json
@dataclass
class V4VpcListSubnetResponse(CtyunOpenAPIResponse):
    statusCode: Optional[int] = None  # 返回状态码（800为成功，900为失败）
    errorCode: Optional[str] = None  # 错误码，为product.module.code三段式码
    error: Optional[str] = None  # 错误码，为product.module.code三段式码
    message: Optional[str] = None  # 失败时的错误描述，一般为英文描述
    description: Optional[str] = None  # 失败时的错误描述，一般为中文描述
    returnObj: Optional['V4VpcListSubnetReturnObj'] = None  # 成功时返回的数据
...
@dataclass_json
@dataclass
class V4VpcListSubnetReturnObj:
    subnets: Optional[List['V4VpcListSubnetReturnObjSubnets']] = None  # subnets 组


@dataclass_json
@dataclass
class V4VpcListSubnetReturnObjSubnets:
    ...
    ipv6Info: Optional['V4VpcListSubnetReturnObjSubnetsIpv6Info'] = None  # ipv6 信息


@dataclass_json
@dataclass
class V4VpcListSubnetReturnObjSubnetsIpv6Info:
    ipv6SegmentPoolId: Optional[str] = None  # ipv6 segment pool id
    ipv6Provider: Optional[str] = None  # provider
    vpcIpv6PrefixLen: Optional[int] = None  # ipv6 前缀长度
    subnetIpv6PrefixLen: Optional[int] = None  # 子网 ipv6 前缀长度
