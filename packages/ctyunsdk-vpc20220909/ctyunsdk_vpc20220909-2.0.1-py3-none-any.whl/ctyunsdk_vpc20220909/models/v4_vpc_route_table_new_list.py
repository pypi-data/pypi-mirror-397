...
@dataclass_json
@dataclass
class V4VpcRouteTableNewListRequest(CtyunOpenAPIRequest):
    regionID: str  # 区域id
...
@dataclass_json
@dataclass
class V4VpcRouteTableNewListResponse(CtyunOpenAPIResponse):
    statusCode: Optional[int] = None  # 返回状态码（800为成功，900为失败）
    errorCode: Optional[str] = None  # 错误码，为product.module.code三段式码
    error: Optional[str] = None  # 错误码，为product.module.code三段式码
    message: Optional[str] = None  # 失败时的错误描述，一般为英文描述
    description: Optional[str] = None  # 失败时的错误描述，一般为中文描述
    returnObj: Optional['V4VpcRouteTableNewListReturnObj'] = None  # 成功时返回的数据
...
@dataclass_json
@dataclass
class V4VpcRouteTableNewListReturnObj:
    routeTables: Optional[List['V4VpcRouteTableNewListReturnObjRouteTables']] = None  # 路由列表
...
@dataclass_json
@dataclass
class V4VpcRouteTableNewListReturnObjRouteTables:
    ...
    type: Optional[int] = None  # 路由表类型:0-子网路由表，2-网关路由表
    ipv4Gw: Optional['V4VpcRouteTableNewListReturnObjRouteTablesIpv4Gw'] = None  # 绑定的IPv4网关信息（未绑定时未null）
...
@dataclass_json
@dataclass
class V4VpcRouteTableNewListReturnObjRouteTablesIpv4Gw:
