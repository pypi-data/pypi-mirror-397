...
@dataclass_json
@dataclass
class V4PortsUpdateRequest(CtyunOpenAPIRequest):
    ...
    securityGroupIDs: Optional[List[str]] = None  # 安全组列表
    privateIpDnsNameEnabled: Optional[int] = None  # 是否开启 dns
    sanityCheck: Optional[str] = None  # sanityCheck
...
@dataclass_json
@dataclass
class V4PortsUpdateResponse(CtyunOpenAPIResponse):
