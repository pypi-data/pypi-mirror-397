...
@dataclass_json
@dataclass
class V4VpcUpdateSubnetIpv6StatusRequest(CtyunOpenAPIRequest):
    regionID: str  # 资源池 ID
    ...
    vpcIpv6CIDR: Optional[str] = None  # vpc的ipv6 CIDR
    ipv6CIDR: Optional[str] = None  # 子网的ipv6 CIDR
...
@dataclass_json
@dataclass
class V4VpcUpdateSubnetIpv6StatusResponse(CtyunOpenAPIResponse):
