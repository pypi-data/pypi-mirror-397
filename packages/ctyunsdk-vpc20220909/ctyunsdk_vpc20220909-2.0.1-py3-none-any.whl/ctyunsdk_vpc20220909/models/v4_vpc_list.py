...
@dataclass_json
@dataclass
class V4VpcListRequest(CtyunOpenAPIRequest):
    regionID: str  # 资源池 ID
    ...
    pageSize: Optional[int] = None  # 分页查询时每页的行数，最大值为 200，默认值为 10。
...
@dataclass_json
@dataclass
class V4VpcListResponse(CtyunOpenAPIResponse):
    statusCode: Optional[int] = None  # 返回状态码（800为成功，900为失败）
    errorCode: Optional[str] = None  # 错误码，为product.module.code三段式码
    error: Optional[str] = None  # 错误码，为product.module.code三段式码
    message: Optional[str] = None  # 失败时的错误描述，一般为英文描述
    description: Optional[str] = None  # 失败时的错误描述，一般为中文描述
    returnObj: Optional['V4VpcListReturnObj'] = None  # 成功时返回的数据
...
@dataclass_json
@dataclass
class V4VpcListReturnObj:
    vpcs: Optional[List['V4VpcListReturnObjVpcs']] = None  # vpc 组


@dataclass_json
@dataclass
class V4VpcListReturnObjVpcs:
    ...
    vni: Optional[int] = None  # vni
    createdAt: Optional[str] = None  # 创建时间
    updatedAt: Optional[str] = None  # 更新时间
    dnsHostnamesEnabled: Optional[int] = None  # 开启 dns host name 解析
