...
@dataclass_json
@dataclass
class V4VpcQuerySecurityGroupsRequest(CtyunOpenAPIRequest):
    regionID: str
    vpcID: Optional[str] = None
    queryContent: Optional[str] = None
    projectID: Optional[str] = None  # 0
...
@dataclass_json
@dataclass
class V4VpcQuerySecurityGroupsResponse(CtyunOpenAPIResponse):
    statusCode: Optional[int] = None  # 返回状态码（800为成功，900为失败）
    errorCode: Optional[str] = None  # 错误码，为product.module.code三段式码
    error: Optional[str] = None  # 错误码，为product.module.code三段式码
    message: Optional[str] = None  # 失败时的错误描述，一般为英文描述
    description: Optional[str] = None  # 失败时的错误描述，一般为中文描述
    returnObj: Optional[List['V4VpcQuerySecurityGroupsReturnObj']] = None  # 成功时返回的数据
...
@dataclass_json
@dataclass
class V4VpcQuerySecurityGroupsReturnObj:
    ...
    securityGroupRuleList: Optional[List['V4VpcQuerySecurityGroupsReturnObjSecurityGroupRuleList']] = None  # 安全组规则信息


@dataclass_json
@dataclass
class V4VpcQuerySecurityGroupsReturnObjSecurityGroupRuleList:
