...
class IsingClient:
    ...
    def upload_file_to_oss(self, file_path_or_bytes, original_filename=None):
        ...
        try:
            ...
            signature_data = requests.get(f"{self.base_url}/files/getPostSignatureForOssUpload", headers=headers).json()
            ...
            file_key = f"{signature_data['dir']}{file_uuid}/{original_filename}"
