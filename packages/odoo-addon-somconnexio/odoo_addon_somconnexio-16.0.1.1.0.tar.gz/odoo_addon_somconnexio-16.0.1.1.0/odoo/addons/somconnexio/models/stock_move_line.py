...
class StockMoveLine(models.Model):
    ...
    def _get_similar_move_lines(self):
        ...
        if picking_id:
            lines |= picking_id.move_line_ids.filtered(
                ...
                and (ml.lot_id or ml.lot_name or ml.lot_router_mac)
            )
        return lines
    ...
    def onchange_router_mac(self):
        """
        When the user is encoding a move line for a tracked product,
        we apply some logic to help him. This includes:
            ...
            if self.lot_router_mac:
                ...
                if self.lot_router_mac:
                    ...
                    if not self.env["stock.production.lot"].check_mac_address(
                        ...
                        message = _("The MAC address is wrong.")
                    elif (
                        counter.get(self.lot_router_mac.upper())
                        and counter[self.lot_router_mac.upper()] > 0
                    ):
                        message = _(
