...
class TestStockProductionLot(SCTestCase):
    ...
    def test_valid_mac_address(self):
        ...
        self.assertEqual(stock_production_lot.router_mac_address, mac_address)
    ...
    def test_lot_name_get(self):
        ...
        self.assertEqual(
            stock_production_lot.name_get(), [(stock_production_lot.id, "def")]
        )
    ...
    def test_upper_mac_address(self):
        ...
        self.assertEqual(stock_production_lot.router_mac_address, mac_address.upper())
    ...
    def test_unique_mac_address(self):
        ...
        self.assertTrue(stock_production_lot)
