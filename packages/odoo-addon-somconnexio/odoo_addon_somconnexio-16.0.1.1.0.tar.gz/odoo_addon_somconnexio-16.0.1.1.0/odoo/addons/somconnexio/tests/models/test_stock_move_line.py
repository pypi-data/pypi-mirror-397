...
class TestStockProductionLot(SCTestCase):
    ...
    def test_onchange_valid_router_mac(self):
        ...
        self.assertFalse(move1.move_line_ids[0].onchange_router_mac())
        move1._action_done()
        self.assertEqual(move1.move_line_ids[0].lot_id.router_mac_address, lot1_mac)
        self.assertEqual(move1.move_line_ids[1].lot_id.router_mac_address, lot2_mac)
    ...
    def test_onchange_qty_1_router_mac(self):
        ...
        self.assertEqual(move1.move_line_ids[0].qty_done, 1)
