...
export async function sendErrorReport(error) {
    ...
    try {
        ...
        createToast('icon-close',  gettext("An error has occurred, it has been reported to the system administrator"));
    } catch (error2) {
        ...
        createToast('icon-close', gettext("An error has occurred, reporting the error also failed"));
    }
}
