...
class Visualiser {
    ...
    toggleSetting() {
        ...
        if (Setting.VISUALISER.checked) {
            createToast('chart-bar', gettext("Visualiser enabled"), gettext("Visualiser disabled"));
        } else {
            createToast('chart-bar', gettext("Visualiser disabled"), gettext("Visualiser enabled"));
        }
    }
