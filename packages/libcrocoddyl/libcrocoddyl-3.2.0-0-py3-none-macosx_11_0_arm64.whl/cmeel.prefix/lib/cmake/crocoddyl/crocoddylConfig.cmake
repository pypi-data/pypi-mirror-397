...
set("CROCODDYL_DOXYGENDOCDIR" "${PACKAGE_PREFIX_DIR}/share/doc/crocoddyl/doxygen-html")
set("crocoddyl_DEPENDENCIES" "pinocchio;example-robot-data;Boost")
...
set("_crocoddyl_PKG_CONFIG_LIBS_LIST" "-lcrocoddyl -lboost_filesystem")
...
if(${CMAKE_VERSION} VERSION_LESS "3.15.0")
  ...
  find_package(pinocchio 3.1.0 REQUIRED)
  find_package(example-robot-data 4.0.9 REQUIRED)
  find_package(Boost 1.65 REQUIRED COMPONENTS filesystem serialization)
else()
  SET(Boost_USE_STATIC_LIBS OFF)
  SET(Boost_USE_MULTITHREADED ON)
  SET(Boost_NO_BOOST_CMAKE ON)
  find_dependency(pinocchio 3.1.0 REQUIRED)
  find_dependency(example-robot-data 4.0.9 REQUIRED)
  find_dependency(Boost 1.65 REQUIRED COMPONENTS filesystem serialization)
endif()
