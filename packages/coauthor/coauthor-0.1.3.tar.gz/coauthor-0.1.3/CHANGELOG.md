...
- Added Jira watcher option `workflows[].watch.jira.disable_ssl_verification` to
  optionally disable TLS certificate verification when connecting to Jira.
