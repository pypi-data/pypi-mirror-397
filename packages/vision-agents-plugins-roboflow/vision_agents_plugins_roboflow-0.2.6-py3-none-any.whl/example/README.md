...
- Automatically asks LLM for an update once the ball is detected.
...
4. The video feed will show bounding boxes around detected objects
5. When the ball is detected, the Agent will ask the LLM to describe the situation on the field.
