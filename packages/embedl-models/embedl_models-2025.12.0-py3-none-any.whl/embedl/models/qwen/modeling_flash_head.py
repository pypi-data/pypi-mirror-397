...
"""Custom Qwen model with FlashHead."""

import os

from transformers.models.qwen3 import Qwen3Config as Config
from transformers.models.qwen3 import Qwen3ForCausalLM as Model

from embedl.models import ERROR_MSG
from embedl.models.flash_head import FlashHead, get_flash_head_parameters


class FlashHeadQwen3Config(Config):
    """Qwen config with FlashHead."""
...
class FlashHeadQwen3ForCausalLM(Model):
    """Qwen model with FlashHead."""

    config_class = FlashHeadQwen3Config
