...
"""Custom Llama model with FlashHead."""

import os

from transformers.models.llama import LlamaConfig as Config
from transformers.models.llama import LlamaForCausalLM as Model

from embedl.models import ERROR_MSG
from embedl.models.flash_head import FlashHead, get_flash_head_parameters


class FlashHeadLlamaConfig(Config):
    """Llama config with FlashHead."""
...
class FlashHeadLlamaForCausalLM(Model):
    """Llama model with FlashHead."""

    config_class = FlashHeadLlamaConfig
