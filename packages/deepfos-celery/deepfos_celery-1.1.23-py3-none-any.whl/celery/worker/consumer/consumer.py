...
class Consumer:
    ...
    def __init__(self, on_task_request,
                 ...
                 channel_health_check_interval=0, **kwargs):
        self.app = app
        ...
        self.channel_health_check_interval = channel_health_check_interval
    ...
    def connect(self):
        ...
        if self.hub:
            setattr(conn.transport, 'health_check_interval',
                self.channel_health_check_interval)
