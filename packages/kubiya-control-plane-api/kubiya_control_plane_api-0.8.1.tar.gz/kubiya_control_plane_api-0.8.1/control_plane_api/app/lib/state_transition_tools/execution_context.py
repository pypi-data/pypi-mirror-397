...
class ExecutionContextTools(BasePlanningTools):
    """
    ...
    def __init__(
        ...
        """
        super().__init__(base_url=base_url, organization_id=organization_id, timeout=timeout)
        self.name = "execution_context_tools"
