...
class ContextGraphSearchTools(Toolkit):
    ...
    def __init__(
        ...
        **kwargs
        ...
        if api_base:
            ...
            # Try to fetch from control plane client config
            self.api_base = self._fetch_graph_url_from_control_plane() or "https://graph.kubiya.ai"
    ...
    def _get_or_create_dataset(self) -> str:
        ...
        try:
            ...
            result = self._make_request("POST", "/api/v1/datasets", body=create_body)
    ...
    def store_memory(
        ...
        Example:
            ...
            store_memory("Production database is read-only on weekends", metadata={"category": "policy"})
        """
        try:
            dataset_id = self._get_or_create_dataset()

            # API expects dataset_id as query param and context/metadata in body
            body = {
            ...
            result = self._make_request("POST", "/api/v1/memory/store", params=params, body=body)
    ...
    def recall_memory(
        ...
        try:
            ...
            # Use semantic search endpoint (/api/v1/search) which searches across all accessible memories
            ...
            result = self._make_request("POST", "/api/v1/search", body=body)
    ...
    def ingest_knowledge(
        ...
        try:
            ...
            result = self._make_request("POST", "/api/v1/knowledge", body=body)
    ...
    def process_dataset(
        ...
        **Important**: This operation can take 10-60 seconds depending on dataset size.
        ...
        try:
            ...
            result = self._make_request("POST", "/api/v1/cognify", body=body)
