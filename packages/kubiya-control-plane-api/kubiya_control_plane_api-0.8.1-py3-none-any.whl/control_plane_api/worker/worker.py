            ...
            if single_execution_mode:
                ...
                async def monitor_and_shutdown():
                    ...
                    while elapsed < max_runtime:
                            ...
                            async with httpx.AsyncClient(timeout=10.0) as http_client:
                                ...
                                if response.status_code == 200:
                                    ...
                                    for execution in executions:
                                        ...
                                        # If we've seen an execution and it's now in a terminal/waiting state, we're done
                                        if execution_seen and exec_id == execution_id:
                                            if exec_status in ["completed", "failed", "waiting_for_input", "cancelled"]:
                        ...
                        # Check again if we should exit the loop
                        if execution_seen and execution_id:
                            # We've found our execution, continuing to monitor
                            pass
                    else:
                        # Timeout reached
                    ...
                    logger.info("single_execution_triggering_shutdown", elapsed_seconds=elapsed)
