...
DEFAULT_MODELS = [
    ...
    ModelConfig(
        ...
        alias="gpt-oss-120b",
        temperature=0.2,
        input_price=0.0,  # Internal IBM usage
        output_price=0.0,
    ),
]
...
class VibeConfig(BaseSettings):
    ...
    context_injection: bool = True  # Enable VIBE-ANALYSIS context injection
    ...
    def _check_api_backend_compatibility(self) -> VibeConfig:
        try:
            ...
            # WatsonX backend handles its own validation
            if provider.backend == Backend.WATSONX:
                return self
