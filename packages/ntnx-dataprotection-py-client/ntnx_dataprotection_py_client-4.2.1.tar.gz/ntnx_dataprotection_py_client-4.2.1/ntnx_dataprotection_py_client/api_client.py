...
class ApiClient(object):
    ...
    # Populated if multiple schemas exist with the same name
        'OneOfdataprotection.v4.config.GetRecoveryPlanJobApiResponsedata' : 'GetRecoveryPlanJobApiResponsedata',
        ...
        'dataprotection.v4.config.RecycleBinEntry' : 'RecycleBinEntry',
        'dataprotection.v4.error.SchemaValidationError' : 'SchemaValidationError',
        'dataprotection.v4.config.RootCauseAnalysis' : 'RootCauseAnalysis',
        ...
        'OneOfdataprotection.v4.content.GetVssMetadataApiResponsedata' : 'GetVssMetadataApiResponsedata',
        ...
        'dataprotection.v4.config.GetRecoveryPlanJobApiResponse' : 'GetRecoveryPlanJobApiResponse',
        'dataprotection.v4.operations.PlannedFailoverSpec' : 'PlannedFailoverSpec',
        ...
        'dataprotection.v4.config.ClusterInfoApiResponse' : 'ClusterInfoApiResponse',
        ...
        'dataprotection.v4.operations.CleanupRecoveryPlanResourcesApiResponse' : 'CleanupRecoveryPlanResourcesApiResponse',
        'vmm.v4.ahv.config.VmRestoreVirtualEthernetNicOverrideSpec' : 'VmRestoreVirtualEthernetNicOverrideSpec',
        'OneOfdataprotection.v4.config.DeleteRecoveryPlanJobApiResponsedata' : 'DeleteRecoveryPlanJobApiResponsedata',
        ...
        'dataprotection.v4.config.RecoveryPlanJobExecutionStatus' : 'RecoveryPlanJobExecutionStatus',
        'dataprotection.v4.content.GetVssMetadataClusterDiscoverSpec' : 'GetVssMetadataClusterDiscoverSpec',
        'dataprotection.v4.config.HypervisorType' : 'HypervisorType',
        'OneOfdataprotection.v4.operations.UnplannedFailoverRecoveryPlanApiResponsedata' : 'UnplannedFailoverRecoveryPlanApiResponsedata',
        'dataprotection.v4.config.PhaseSummary' : 'PhaseSummary',
        'vmm.v4.ahv.config.SubnetReference' : 'SubnetReference',
        'dataprotection.v4.config.AhvVmOverrideSpec' : 'AhvVmOverrideSpec',
        'OneOfdataprotection.v4.operations.TestFailoverRecoveryPlanApiResponsedata' : 'TestFailoverRecoveryPlanApiResponsedata',
        ...
        'OneOfdataprotection.v4.content.ComputeChangedRegionsClusterDiscoverSpecreference_disk_recovery_point' : 'ComputeChangedRegionsClusterDiscoverSpecreference_disk_recovery_point',
        'dataprotection.v4.config.FailoverDirection' : 'FailoverDirection',
        ...
        'dataprotection.v4.operations.UnplannedFailoverRecoveryPlanApiResponse' : 'UnplannedFailoverRecoveryPlanApiResponse',
        ...
        'dataprotection.v4.content.VmDiskRecoveryPointReference' : 'VmDiskRecoveryPointReference',
        'dataprotection.v4.config.RecoveryPlanValidationErrorProjection' : 'RecoveryPlanValidationErrorProjection',
        'OneOfdataprotection.v4.config.ListRecoveryPlanJobsApiResponsedata' : 'ListRecoveryPlanJobsApiResponsedata',
        'dataprotection.v4.config.RecoveryPointRepositoryProjection' : 'RecoveryPointRepositoryProjection',
        'dataprotection.v4.config.RecycleBinVmProjection' : 'RecycleBinVmProjection',
        ...
        'dataprotection.v4.config.RecoveryPlanJobExecutionStepProjection' : 'RecoveryPlanJobExecutionStepProjection',
        ...
        'dataprotection.v4.config.StageSummary' : 'StageSummary',
        'dataprotection.v4.config.AzureBlobStorageContainer' : 'AzureBlobStorageContainer',
        'dataprotection.v4.common.ClusterInfo' : 'ClusterInfo',
        'OneOfdataprotection.v4.config.DeleteConsistencyGroupApiResponsedata' : 'DeleteConsistencyGroupApiResponsedata',
        'dataprotection.v4.config.ListRecoveryPlanJobExecutionStepsApiResponse' : 'ListRecoveryPlanJobExecutionStepsApiResponse',
        ...
        'dataprotection.v4.config.DeleteRecoveryPlanJobApiResponse' : 'DeleteRecoveryPlanJobApiResponse',
        'common.v1.response.ApiLink' : 'ApiLink',
        'dataprotection.v4.config.NutanixObjectsBucket' : 'NutanixObjectsBucket',
        'dataprotection.v4.config.RecoveryPlanValidationError' : 'RecoveryPlanValidationError',
        'dataprotection.v4.config.RecoveryPlanJob' : 'RecoveryPlanJob',
        'dataprotection.v4.config.ConsistencyGroup' : 'ConsistencyGroup',
        'vmm.v4.ahv.config.OwnerReference' : 'OwnerReference',
        'vmm.v4.ahv.config.VmConfigOverrideSpecification' : 'VmConfigOverrideSpecification',
        'dataprotection.v4.config.RecycleBinVm' : 'RecycleBinVm',
        'dataprotection.v4.config.VolumeGroupOverrideSpec' : 'VolumeGroupOverrideSpec',
        'OneOfdataprotection.v4.config.ListRecoveryPlanJobValidationErrorsApiResponsedata' : 'ListRecoveryPlanJobValidationErrorsApiResponsedata',
        'dataprotection.v4.content.ComputeChangedRegionsClusterDiscoverSpec' : 'ComputeChangedRegionsClusterDiscoverSpec',
        'dataprotection.v4.content.ChangedVolumeGroupRegionsApiResponse' : 'ChangedVolumeGroupRegionsApiResponse',
        'dataprotection.v4.config.CreationTimeRange' : 'CreationTimeRange',
        'dataprotection.v4.config.VmRecoveryPointRestoreOverride' : 'VmRecoveryPointRestoreOverride',
        'dataprotection.v4.config.ErrorMessage' : 'ErrorMessage',
        'dataprotection.v4.config.Summary' : 'Summary',
        'dataprotection.v4.config.GetRecoveryPointApiResponse' : 'GetRecoveryPointApiResponse',
        'dataprotection.v4.content.ChangedVmRegionsApiResponse' : 'ChangedVmRegionsApiResponse',
        ...
        'OneOfdataprotection.v4.content.ComputeChangedRegionsClusterDiscoverSpecdisk_recovery_point' : 'ComputeChangedRegionsClusterDiscoverSpecdisk_recovery_point',
        'dataprotection.v4.config.RecoveryPointProjection' : 'RecoveryPointProjection',
        'common.v1.config.Flag' : 'Flag',
        'dataprotection.v4.config.ErrorGroup' : 'ErrorGroup',
        ...
        'OneOfdataprotection.v4.config.VmRecoveryPointapplication_consistent_properties' : 'VmRecoveryPointapplication_consistent_properties',
        'dataprotection.v4.content.ClusterDiscoverSpec' : 'ClusterDiscoverSpec',
        'dataprotection.v4.config.GetConsistencyGroupApiResponse' : 'GetConsistencyGroupApiResponse',
        'common.v1.config.EntityReference' : 'CommonConfigEntityReference',
        'dataprotection.v4.common.RecoveryPointStatus' : 'RecoveryPointStatus',
        'OneOfdataprotection.v4.operations.PlannedFailoverRecoveryPlanApiResponsedata' : 'PlannedFailoverRecoveryPlanApiResponsedata',
        'dataprotection.v4.config.EntityReference' : 'DataprotectionConfigEntityReference',
        'dataprotection.v4.config.ExecutionStepResult' : 'ExecutionStepResult',
        'dataprotection.v4.operations.PlannedFailoverRecoveryPlanApiResponse' : 'PlannedFailoverRecoveryPlanApiResponse',
        'dataprotection.v4.common.BaseVmRecoveryPoint' : 'BaseVmRecoveryPoint',
        'dataprotection.v4.config.RecycleBinVolumeGroupProjection' : 'RecycleBinVolumeGroupProjection',
        'dataprotection.v4.content.GetVssMetadataApiResponse' : 'GetVssMetadataApiResponse',
        'dataprotection.v4.operations.ValidateRecoveryPlanApiResponse' : 'ValidateRecoveryPlanApiResponse',
        'dataprotection.v4.config.SiteProtectionInfo' : 'SiteProtectionInfo',
        'dataprotection.v4.config.GetVmRecoveryPointApiResponse' : 'GetVmRecoveryPointApiResponse',
        ...
        'OneOfdataprotection.v4.config.VmRecoveryPointRestoreOverridevm_override_spec' : 'VmRecoveryPointRestoreOverridevm_override_spec',
        'dataprotection.v4.config.RecoveryPointReplicateApiResponse' : 'RecoveryPointReplicateApiResponse',
        'dataprotection.v4.content.VmRecoveryPointChangedRegionsComputeSpec' : 'VmRecoveryPointChangedRegionsComputeSpec',
        'dataprotection.v4.config.RecycleBinVolumeGroup' : 'RecycleBinVolumeGroup',
        'vmm.v4.ahv.config.OwnershipInfo' : 'OwnershipInfo',
        'dataprotection.v4.content.VolumeGroupDiskRecoveryPointReference' : 'VolumeGroupDiskRecoveryPointReference',
        'dataprotection.v4.config.RecoveryPlanJobProjection' : 'RecoveryPlanJobProjection',
        'dataprotection.v4.config.OperationType' : 'OperationType',
        'dataprotection.v4.content.FileWrapper' : 'FileWrapper',
        'dataprotection.v4.config.RecoveryPlanActionType' : 'RecoveryPlanActionType',
        'OneOfdataprotection.v4.config.ExecutionStepResultresult' : 'ExecutionStepResultresult',
        ...
        'dataprotection.v4.config.RecoveryPlanJobPhaseType' : 'RecoveryPlanJobPhaseType',
        'vmm.v4.ahv.config.VmRestoreGuestToolsSpecification' : 'VmRestoreGuestToolsSpecification',
        'dataprotection.v4.content.RegionType' : 'RegionType',
        'OneOfdataprotection.v4.content.ChangedVolumeGroupRegionsApiResponsedata' : 'ChangedVolumeGroupRegionsApiResponsedata',
        'dataprotection.v4.config.CreateRecoveryPointApiResponse' : 'CreateRecoveryPointApiResponse',
        'OneOfdataprotection.v4.config.ListRecoveryPlanJobExecutionStepsApiResponsedata' : 'ListRecoveryPlanJobExecutionStepsApiResponsedata',
        ...
        'dataprotection.v4.config.ListRecoveryPlanJobsApiResponse' : 'ListRecoveryPlanJobsApiResponse',
        ...
        'dataprotection.v4.content.VolumeGroupDiskRecoveryPointClusterDiscoverSpec' : 'VolumeGroupDiskRecoveryPointClusterDiscoverSpec',
        'dataprotection.v4.config.HostReference' : 'HostReference',
        'dataprotection.v4.config.RecoveryInfo' : 'RecoveryInfo',
        'dataprotection.v4.operations.TestFailoverSpec' : 'TestFailoverSpec',
        'dataprotection.v4.operations.ValidateSpec' : 'ValidateSpec',
        'vmm.v4.ahv.config.VmRestoreNicConfigSpecification' : 'VmRestoreNicConfigSpecification',
        'dataprotection.v4.config.SynchronousReplicationRole' : 'SynchronousReplicationRole',
        'OneOfcommon.v1.config.KVPairvalue' : 'KVPairvalue',
        'vmm.v4.ahv.config.CategoryReference' : 'CategoryReference',
        'dataprotection.v4.config.HostType' : 'HostType',
        'OneOfdataprotection.v4.config.ListDPClusterCapabilitiesApiResponsedata' : 'ListDPClusterCapabilitiesApiResponsedata',
        'dataprotection.v4.config.ForceDeleteAllRecoveryPointsSpec' : 'ForceDeleteAllRecoveryPointsSpec',
        'OneOfdataprotection.v4.content.ClusterDiscoverSpecspec' : 'ClusterDiscoverSpecspec',
        'dataprotection.v4.config.Severity' : 'Severity',
        'dataprotection.v4.error.AppMessage' : 'AppMessage',
        'dataprotection.v4.operations.TestFailoverRecoveryPlanApiResponse' : 'TestFailoverRecoveryPlanApiResponse',
        'dataprotection.v4.config.DataProtectionClusterCapabilityProjection' : 'DataProtectionClusterCapabilityProjection',
        'dataprotection.v4.config.RecoveryPlanJobExecutionStep' : 'RecoveryPlanJobExecutionStep',
        'dataprotection.v4.config.ObjectStorageType' : 'ObjectStorageType',
        'common.v1.config.MessageSeverity' : 'MessageSeverity',
        'OneOfdataprotection.v4.config.ClusterInfoApiResponsedata' : 'ClusterInfoApiResponsedata',
        'dataprotection.v4.operations.UnplannedFailoverSpec' : 'UnplannedFailoverSpec',
        'OneOfdataprotection.v4.operations.ValidateRecoveryPlanApiResponsedata' : 'ValidateRecoveryPlanApiResponsedata',
        'dataprotection.v4.config.ListRecoveryPlanJobValidationErrorsApiResponse' : 'ListRecoveryPlanJobValidationErrorsApiResponse',
        'vmm.v4.ahv.config.GuestStaticIpSpec' : 'GuestStaticIpSpec',
        'OneOfdataprotection.v4.config.GetVmRecoveryPointApiResponsedata' : 'GetVmRecoveryPointApiResponsedata',
        'dataprotection.v4.config.DeleteRecoveryPointApiResponse' : 'DeleteRecoveryPointApiResponse',
        'dataprotection.v4.content.VolumeGroupRecoveryPointChangedRegionsComputeSpec' : 'VolumeGroupRecoveryPointChangedRegionsComputeSpec',
        'dataprotection.v4.config.EntityRecoveryResult' : 'EntityRecoveryResult',
        'dataprotection.v4.config.Capability' : 'Capability',
        'dataprotection.v4.operations.BaseRecoveryPlanActionSpec' : 'BaseRecoveryPlanActionSpec',
        'dataprotection.v4.config.ListDPClusterCapabilitiesApiResponse' : 'ListDPClusterCapabilitiesApiResponse',
        'dataprotection.v4.content.DiskRecoveryPointReference' : 'DiskRecoveryPointReference',
        'OneOfdataprotection.v4.content.ChangedVmRegionsApiResponsedata' : 'ChangedVmRegionsApiResponsedata',
        ...
        'dataprotection.v4.config.ExecutionStepEntityReference' : 'ExecutionStepEntityReference',
        ...
        'dataprotection.v4.content.BaseRecoveryPointSpec' : 'BaseRecoveryPointSpec',
        ...
        'dataprotection.v4.config.DataProtectionClusterCapability' : 'DataProtectionClusterCapability',
        'dataprotection.v4.content.ChangedRegion' : 'ChangedRegion',
        'common.v1.config.IPAddress' : 'IPAddress',
        'common.v1.config.TenantAwareModel' : 'TenantAwareModel',
        'dataprotection.v4.config.ExecutionStepEntityType' : 'ExecutionStepEntityType',
        ...
        'dataprotection.v4.content.VmDiskRecoveryPointClusterDiscoverSpec' : 'VmDiskRecoveryPointClusterDiscoverSpec',
        'dataprotection.v4.config.ProtectedEntityType' : 'ProtectedEntityType',
        'OneOfdataprotection.v4.operations.CleanupRecoveryPlanResourcesApiResponsedata' : 'CleanupRecoveryPlanResourcesApiResponsedata',
        'dataprotection.v4.config.RecoveryPointRepository' : 'RecoveryPointRepository',
        'dataprotection.v4.content.ClusterDiscoverOperation' : 'ClusterDiscoverOperation',
        'dataprotection.v4.config.DataProtectionCapabilityName' : 'DataProtectionCapabilityName'
    }
    ...
    def negotiate_version(self, auth_settings):
        ...
        """
        try:
            response = self.__call_api('/api/dataprotection/unversioned/info', 'OPTIONS',
