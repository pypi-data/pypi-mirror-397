...
class GetVssMetadataClusterDiscoverSpec(object):
    ...
    def _initialize_object_type(self):
        return 'dataprotection.v4.content.GetVssMetadataClusterDiscoverSpec'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetVssMetadataClusterDiscoverSpec, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetVssMetadataClusterDiscoverSpec):
            return False
