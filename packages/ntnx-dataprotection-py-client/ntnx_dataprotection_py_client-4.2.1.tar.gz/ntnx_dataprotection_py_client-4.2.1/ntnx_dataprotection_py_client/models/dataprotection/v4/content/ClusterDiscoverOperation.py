...
class ClusterDiscoverOperation(object):
    ...
    Allowed enum values:
        ...
        - _UNKNOWN
        - _REDACTED
        - GET_VSS_METADATA: Get VSS metadata operation type for the discover cluster API.
        - COMPUTE_CHANGED_REGIONS: Compute changed regions operation type for the discover cluster API.
    """
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    GET_VSS_METADATA = "GET_VSS_METADATA"
    COMPUTE_CHANGED_REGIONS = "COMPUTE_CHANGED_REGIONS"
    ...
    def _initialize_object_type(self):
        return 'dataprotection.v4.content.ClusterDiscoverOperation'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ClusterDiscoverOperation, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ClusterDiscoverOperation):
            return False
