...
class RecoveryPointRestorationSpec(object):
    ...
    :param vm_recovery_point_restore_overrides: (:attr:`vm_recovery_point_restore_overrides`) List of specifications to restore a specific VM recovery points that are a part of the top-level recovery point. A specific VM recovery point can be selected for restore by specifying its external identifier along with override specification (if any).
    :type vm_recovery_point_restore_overrides: 
    
    
    :param volume_group_recovery_point_restore_overrides: (:attr:`volume_group_recovery_point_restore_overrides`) List of specifications to restore a specific volume group recovery points that are a part of the top-level recovery point. A specific volume group recovery point can be selected for restore by specifying its external identifier along with override specification (if any).
