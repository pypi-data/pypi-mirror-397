...
from ntnx_dataprotection_py_client.models.OneOfdataprotection.v4.operations.ValidateRecoveryPlanApiResponsedata import ValidateRecoveryPlanApiResponsedata  # noqa: F401,E501
...
class ValidateRecoveryPlanApiResponse(object):
    ...
    swagger_types = {
        ...
        'data': 'OneOfdataprotection.v4.operations.ValidateRecoveryPlanApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'dataprotection.v4.operations.ValidateRecoveryPlanApiResponse'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ValidateRecoveryPlanApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ValidateRecoveryPlanApiResponse):
            return False
