...
from ntnx_dataprotection_py_client.models.dataprotection.v4.config.DisasterRecoveryLocation import DisasterRecoveryLocation  # noqa: F401,E501
...
class RecoveryPointProjection(RecoveryPoint):
    ...
    :param owner_ext_id: (:attr:`owner_ext_id`) A read only field inserted into the recovery point at the time of recovery point creation, indicating the external identifier of the user who created this recovery point.
    :type owner_ext_id: 
    
    
    :param location_references: (:attr:`location_references`) List of location references where the recovery point is presently located.
    :type location_references: 
    
    
    :param vm_recovery_points: (:attr:`vm_recovery_points`) List of VM recovery point that are a part of the specified top-level recovery point. Note that a recovery point can contain a maximum number of 32 entities. These entities can be a combination of VMs and volume groups.
    :type vm_recovery_points: 
    
    
    :param volume_group_recovery_points: (:attr:`volume_group_recovery_points`) List of volume group recovery point that are a part of the specified top-level recovery point. Note that a recovery point can contain a maximum number of 32 entities. These entities can be a combination of VMs and volume groups.
    :type volume_group_recovery_points: 
    
    
    :param is_secure: (:attr:`is_secure`) Indicates whether the recovery point is secure. Approvals are necessary for the manual deletion of secure recovery points.
    :type is_secure: 
    
    
    :param source_location: (:attr:`source_location`) 
    ...
    :param total_exclusive_usage_bytes: (:attr:`total_exclusive_usage_bytes`) Indicates the total exclusive usage of this recovery point, which is the total space that could be reclaimed after deleting this recovery point.
    :type total_exclusive_usage_bytes: 
    ...
    swagger_types = {
        ...
        'is_secure': 'bool',
        'source_location': 'dataprotection.v4.config.DisasterRecoveryLocation',
        ...
        'total_exclusive_usage_bytes': 'int',
        'ext_id': 'str',
    ...
    attribute_map = {
        ...
        'total_exclusive_usage_bytes': 'totalExclusiveUsageBytes',
        'ext_id': 'extId',
        'links': 'links',
        'tenant_id': 'tenantId',
        '_reserved': '$reserved',
    ...
    def __init__(self, owner_ext_id=None, location_references=None, vm_recovery_points=None, volume_group_recovery_points=None, is_secure=None, source_location=None, location_agnostic_id=None, name=None, creation_time=None, expiration_time=None, status=None, recovery_point_type=None, total_exclusive_usage_bytes=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
        RecoveryPoint.__init__(self, owner_ext_id, location_references, vm_recovery_points, volume_group_recovery_points, is_secure, source_location, location_agnostic_id, name, creation_time, expiration_time, status, recovery_point_type, total_exclusive_usage_bytes, ext_id, links, tenant_id, *args, **kwargs)
