...
from ntnx_dataprotection_py_client.models.dataprotection.v4.config.SynchronousReplicationRole import SynchronousReplicationRole  # noqa: F401,E501
...
class SiteProtectionInfo(object):
    ...
    :param synchronous_replication_role: (:attr:`synchronous_replication_role`) 
    :type synchronous_replication_role: 
    ...
    swagger_types = {
        ...
        'synchronous_replication_role': 'dataprotection.v4.config.SynchronousReplicationRole',
    ...
    attribute_map = {
        ...
        'synchronous_replication_role': 'synchronousReplicationRole',
        '_reserved': '$reserved',
    ...
    def __init__(self, recovery_info=None, location_reference=None, synchronous_replication_role=None, *args, **kwargs):  # noqa: E501
        self.__recovery_info = None
        self.__location_reference = None
        self.__synchronous_replication_role = None
        ...
        if synchronous_replication_role is not None:
            self.__synchronous_replication_role = synchronous_replication_role
    ...
    @property
    def synchronous_replication_role(self):
        """
        

        :type:
            :class:`~ntnx_dataprotection_py_client.models.dataprotection.v4.config.SynchronousReplicationRole`
        """  # noqa: E501
        return self.__synchronous_replication_role

    @synchronous_replication_role.setter
    def synchronous_replication_role(self, synchronous_replication_role):
