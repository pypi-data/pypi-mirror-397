...
from ntnx_dataprotection_py_client.models.dataprotection.v4.config.CreationTimeRange import CreationTimeRange  # noqa: F401,E501

class ForceDeleteAllRecoveryPointsSpec(object):

    """Specification for force deleting recovery points across specified clusters within a given time range.

    :param cluster_ext_ids: (:attr:`cluster_ext_ids`) 
    :type cluster_ext_ids: 
    
    
    :param time_range: (:attr:`time_range`) 
    :type time_range: 
    ...
    swagger_types = {
        ...
        'time_range': 'dataprotection.v4.config.CreationTimeRange',
    ...
    def __init__(self, cluster_ext_ids=None, time_range=None, *args, **kwargs):  # noqa: E501
        self.__cluster_ext_ids = None
        self.__time_range = None
    ...
    def _initialize_object_type(self):
        return 'dataprotection.v4.config.ForceDeleteAllRecoveryPointsSpec'
    ...
    def time_range(self):
        ...
        :type:
            :class:`~ntnx_dataprotection_py_client.models.dataprotection.v4.config.CreationTimeRange`
        """  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ForceDeleteAllRecoveryPointsSpec, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ForceDeleteAllRecoveryPointsSpec):
            return False
