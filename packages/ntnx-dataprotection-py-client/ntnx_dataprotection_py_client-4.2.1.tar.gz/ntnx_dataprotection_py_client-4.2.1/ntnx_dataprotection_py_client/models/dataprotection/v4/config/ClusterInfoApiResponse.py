...
from ntnx_dataprotection_py_client.models.OneOfdataprotection.v4.config.ClusterInfoApiResponsedata import ClusterInfoApiResponsedata  # noqa: F401,E501
...
class ClusterInfoApiResponse(object):
    ...
    swagger_types = {
        ...
        'data': 'OneOfdataprotection.v4.config.ClusterInfoApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'dataprotection.v4.config.ClusterInfoApiResponse'
    ...
    def data(self):
        ...
        :type:
                :class:`~ntnx_dataprotection_py_client.models.dataprotection.v4.common.ClusterInfo` | 
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ClusterInfoApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ClusterInfoApiResponse):
            return False
