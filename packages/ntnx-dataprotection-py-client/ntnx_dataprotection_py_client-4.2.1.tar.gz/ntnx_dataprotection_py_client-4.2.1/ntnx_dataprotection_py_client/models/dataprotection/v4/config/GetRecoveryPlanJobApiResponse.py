...
from ntnx_dataprotection_py_client.models.OneOfdataprotection.v4.config.GetRecoveryPlanJobApiResponsedata import GetRecoveryPlanJobApiResponsedata  # noqa: F401,E501
...
class GetRecoveryPlanJobApiResponse(object):
    ...
    swagger_types = {
        ...
        'data': 'OneOfdataprotection.v4.config.GetRecoveryPlanJobApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'dataprotection.v4.config.GetRecoveryPlanJobApiResponse'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetRecoveryPlanJobApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetRecoveryPlanJobApiResponse):
            return False
