...
class CreationTimeRange(object):
    ...
    :param first_creation_time: (:attr:`first_creation_time`) Start of the time range. Recovery points created after this time are considered.
    :type first_creation_time: 
    
    
    :param last_creation_time: (:attr:`last_creation_time`) End of the time range. Recovery points created before this time are considered.
    :type last_creation_time: 
    ...
    attribute_map = {
        'first_creation_time': 'firstCreationTime',
        'last_creation_time': 'lastCreationTime',
        '_reserved': '$reserved',
    ...
    def __init__(self, first_creation_time=None, last_creation_time=None, *args, **kwargs):  # noqa: E501
        self.__first_creation_time = None
        self.__last_creation_time = None
        self.discriminator = None
        if first_creation_time is not None:
            self.__first_creation_time = first_creation_time
        if last_creation_time is not None:
            self.__last_creation_time = last_creation_time
        # populate hidden vars if not empty
        self._populate_hidden_vars(kwargs)

    def _initialize_object_type(self):
        return 'dataprotection.v4.config.CreationTimeRange'
    ...
    def first_creation_time(self):
        ...
        :type:
                :class:`~datetime`
        """  # noqa: E501
        return self.__first_creation_time

    @first_creation_time.setter
    def first_creation_time(self, first_creation_time):
    ...
    def last_creation_time(self):
        ...
        :type:
                :class:`~datetime`
        """  # noqa: E501
        return self.__last_creation_time

    @last_creation_time.setter
    def last_creation_time(self, last_creation_time):
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(CreationTimeRange, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreationTimeRange):
            return False
