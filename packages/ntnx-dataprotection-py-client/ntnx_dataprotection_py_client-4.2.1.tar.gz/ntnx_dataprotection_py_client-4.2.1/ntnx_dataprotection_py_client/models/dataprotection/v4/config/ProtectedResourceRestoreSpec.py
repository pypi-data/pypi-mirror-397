...
class ProtectedResourceRestoreSpec(object):
    ...
    :param cluster_ext_id: (:attr:`cluster_ext_id`) The external identifier of the cluster on which the entity has valid restorable time ranges. The restored entity is created on the same cluster.
    :type cluster_ext_id: required
    
    
    :param restore_time: (:attr:`restore_time`) UTC date and time in ISO 8601 format representing the time from when the state of the entity should be restored. This must be a valid time within the restorable time ranges for the protected resource.
    :type restore_time: 
