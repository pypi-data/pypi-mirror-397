...
class VmDiskRecoveryPointReference(DiskRecoveryPointReference):

    """Reference to the disk recovery point that is a part of a VM recovery point.

    :param vm_recovery_point_ext_id: (:attr:`vm_recovery_point_ext_id`) The external identifier that can be used to identify a VM recovery point.
    ...
    def __init__(self, vm_recovery_point_ext_id=None, recovery_point_ext_id=None, disk_recovery_point_ext_id=None, *args, **kwargs):  # noqa: E501
    ...
    def _initialize_object_type(self):
        return 'dataprotection.v4.content.VmDiskRecoveryPointReference'
