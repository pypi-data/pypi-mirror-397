...
from ntnx_dataprotection_py_client.models.OneOfdataprotection.v4.config.DeleteRecoveryPlanJobApiResponsedata import DeleteRecoveryPlanJobApiResponsedata  # noqa: F401,E501
...
class DeleteRecoveryPlanJobApiResponse(object):
    ...
    swagger_types = {
        ...
        'data': 'OneOfdataprotection.v4.config.DeleteRecoveryPlanJobApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'dataprotection.v4.config.DeleteRecoveryPlanJobApiResponse'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(DeleteRecoveryPlanJobApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteRecoveryPlanJobApiResponse):
            return False
