...
from ntnx_dataprotection_py_client.models.dataprotection.v4.config.ExecutionStepEntityType import ExecutionStepEntityType  # noqa: F401,E501

class ExecutionStepEntityReference(object):

    """Entity reference model for execution step affected entities.

    :param ext_id: (:attr:`ext_id`) External identifier of the entity.
    :type ext_id: 
    ...
    swagger_types = {
        'ext_id': 'str',
        'name': 'str',
        'entity_type': 'dataprotection.v4.config.ExecutionStepEntityType',
    ...
    def __init__(self, ext_id=None, name=None, entity_type=None, *args, **kwargs):  # noqa: E501
        self.__ext_id = None
        self.__name = None
    ...
    def _initialize_object_type(self):
        return 'dataprotection.v4.config.ExecutionStepEntityReference'
    ...
    def entity_type(self):
        ...
        :type:
            :class:`~ntnx_dataprotection_py_client.models.dataprotection.v4.config.ExecutionStepEntityType`
        """  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ExecutionStepEntityReference, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ExecutionStepEntityReference):
            return False
