...
class RootCauseAnalysis(object):
    ...
    :param cause: (:attr:`cause`) Cause of the validation errors or warnings.
    :type cause: 
    
    
    :param resolutions: (:attr:`resolutions`) Steps to resolve the errors or warnings.
    :type resolutions: 
    
    
    :param impacts: (:attr:`impacts`) List of impacts of the errors or warnings raised.
    :type impacts: 
    ...
    def __init__(self, cause=None, resolutions=None, impacts=None, *args, **kwargs):  # noqa: E501
        self.__cause = None
    ...
    def _initialize_object_type(self):
        return 'dataprotection.v4.config.RootCauseAnalysis'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(RootCauseAnalysis, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RootCauseAnalysis):
            return False
