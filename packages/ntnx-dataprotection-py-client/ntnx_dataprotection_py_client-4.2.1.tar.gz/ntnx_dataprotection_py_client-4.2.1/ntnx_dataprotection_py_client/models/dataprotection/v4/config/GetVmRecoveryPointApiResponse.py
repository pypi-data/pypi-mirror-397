...
from ntnx_dataprotection_py_client.models.OneOfdataprotection.v4.config.GetVmRecoveryPointApiResponsedata import GetVmRecoveryPointApiResponsedata  # noqa: F401,E501
...
class GetVmRecoveryPointApiResponse(object):
    ...
    swagger_types = {
        ...
        'data': 'OneOfdataprotection.v4.config.GetVmRecoveryPointApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'dataprotection.v4.config.GetVmRecoveryPointApiResponse'
    ...
    def data(self):
        ...
        :type:
                :class:`~ntnx_dataprotection_py_client.models.dataprotection.v4.config.VmRecoveryPoint` | 
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetVmRecoveryPointApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetVmRecoveryPointApiResponse):
            return False
