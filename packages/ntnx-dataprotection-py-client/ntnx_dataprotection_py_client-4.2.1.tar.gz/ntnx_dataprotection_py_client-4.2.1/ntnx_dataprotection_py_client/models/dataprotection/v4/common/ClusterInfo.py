...
from ntnx_dataprotection_py_client.models.common.v1.config.IPAddress import IPAddress  # noqa: F401,E501

class ClusterInfo(object):

    """It contains a redirect IP and a certificate. Use the certificate to invoke the compute changed regions endpoint. Set the certificate as a header when invoking the CBT endpoint with NTNX_IGW_SESSION='CERTIFICATE'.

    :param jwt_token: (:attr:`jwt_token`) JWT token in string format. This token must be set as a session cookie while making the second call for CBT/VSS.
    :type jwt_token: 
    
    
    :param cluster_ip: (:attr:`cluster_ip`) 
    :type cluster_ip: 
    ...
    swagger_types = {
        'jwt_token': 'str',
        'cluster_ip': 'common.v1.config.IPAddress',
    ...
    def __init__(self, jwt_token=None, cluster_ip=None, *args, **kwargs):  # noqa: E501
        self.__jwt_token = None
        self.__cluster_ip = None
    ...
    def jwt_token(self):
        """
        JWT token in string format. This token must be set as a session cookie while making the second call for CBT/VSS.
    ...
    def cluster_ip(self):
        ...
        :type:
            :class:`~ntnx_dataprotection_py_client.models.common.v1.config.IPAddress`
        """  # noqa: E501
