...
class ClusterInfoApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'dataprotection.v4.common.ClusterInfo': 'dataprotection.v4.common.ClusterInfo',
    ...
    def _initialize_object_type(self):
        return 'OneOfdataprotection.v4.config.ClusterInfoApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ClusterInfoApiResponsedata.discriminator_value_class_map.values():
            return list(ClusterInfoApiResponsedata.discriminator_value_class_map.keys())[list(ClusterInfoApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ClusterInfoApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ClusterInfoApiResponsedata):
            return False
