...
class ClusterDiscoverSpecspec(object):
    ...
    discriminator_value_class_map = {
        ...
        'dataprotection.v4.content.GetVssMetadataClusterDiscoverSpec': 'dataprotection.v4.content.GetVssMetadataClusterDiscoverSpec',
        'dataprotection.v4.content.ComputeChangedRegionsClusterDiscoverSpec': 'dataprotection.v4.content.ComputeChangedRegionsClusterDiscoverSpec'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOfdataprotection.v4.content.ClusterDiscoverSpecspec'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ClusterDiscoverSpecspec.discriminator_value_class_map.values():
            return list(ClusterDiscoverSpecspec.discriminator_value_class_map.keys())[list(ClusterDiscoverSpecspec.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ClusterDiscoverSpecspec, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ClusterDiscoverSpecspec):
            return False
