...
class ListRecoveryPlanJobsApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<dataprotection.v4.config.RecoveryPlanJob>': 'list[dataprotection.v4.config.RecoveryPlanJob]',
        'dataprotection.v4.error.ErrorResponse': 'dataprotection.v4.error.ErrorResponse',
        'List<dataprotection.v4.config.RecoveryPlanJobProjection>': 'list[dataprotection.v4.config.RecoveryPlanJobProjection]'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOfdataprotection.v4.config.ListRecoveryPlanJobsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListRecoveryPlanJobsApiResponsedata.discriminator_value_class_map.values():
            return list(ListRecoveryPlanJobsApiResponsedata.discriminator_value_class_map.keys())[list(ListRecoveryPlanJobsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListRecoveryPlanJobsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListRecoveryPlanJobsApiResponsedata):
            return False
