...
class VmRecoveryPointRestoreOverridevm_override_spec(object):
    ...
    ONE_OF_ITEM_DISCRIMINATOR_NAME = '$vmOverrideSpecItemDiscriminator'
    ...
    def _initialize_object_type(self):
        return 'OneOfdataprotection.v4.config.VmRecoveryPointRestoreOverridevm_override_spec'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in VmRecoveryPointRestoreOverridevm_override_spec.discriminator_value_class_map.values():
            return list(VmRecoveryPointRestoreOverridevm_override_spec.discriminator_value_class_map.keys())[list(VmRecoveryPointRestoreOverridevm_override_spec.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VmRecoveryPointRestoreOverridevm_override_spec, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VmRecoveryPointRestoreOverridevm_override_spec):
            return False
