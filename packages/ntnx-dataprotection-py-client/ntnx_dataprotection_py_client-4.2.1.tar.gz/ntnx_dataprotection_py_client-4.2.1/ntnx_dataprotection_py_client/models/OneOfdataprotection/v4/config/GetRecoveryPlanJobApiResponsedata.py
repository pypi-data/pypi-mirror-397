...
class GetRecoveryPlanJobApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'dataprotection.v4.config.RecoveryPlanJob': 'dataprotection.v4.config.RecoveryPlanJob',
    ...
    def _initialize_object_type(self):
        return 'OneOfdataprotection.v4.config.GetRecoveryPlanJobApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetRecoveryPlanJobApiResponsedata.discriminator_value_class_map.values():
            return list(GetRecoveryPlanJobApiResponsedata.discriminator_value_class_map.keys())[list(GetRecoveryPlanJobApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetRecoveryPlanJobApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetRecoveryPlanJobApiResponsedata):
            return False
