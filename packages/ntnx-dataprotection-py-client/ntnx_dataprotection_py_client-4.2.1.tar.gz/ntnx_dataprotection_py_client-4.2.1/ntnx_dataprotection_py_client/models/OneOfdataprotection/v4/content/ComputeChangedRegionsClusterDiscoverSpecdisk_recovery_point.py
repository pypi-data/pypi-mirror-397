...
class ComputeChangedRegionsClusterDiscoverSpecdisk_recovery_point(object):
    ...
    ONE_OF_ITEM_DISCRIMINATOR_NAME = '$diskRecoveryPointItemDiscriminator'
    ...
    def _initialize_object_type(self):
        return 'OneOfdataprotection.v4.content.ComputeChangedRegionsClusterDiscoverSpecdisk_recovery_point'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ComputeChangedRegionsClusterDiscoverSpecdisk_recovery_point.discriminator_value_class_map.values():
            return list(ComputeChangedRegionsClusterDiscoverSpecdisk_recovery_point.discriminator_value_class_map.keys())[list(ComputeChangedRegionsClusterDiscoverSpecdisk_recovery_point.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ComputeChangedRegionsClusterDiscoverSpecdisk_recovery_point, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ComputeChangedRegionsClusterDiscoverSpecdisk_recovery_point):
            return False
