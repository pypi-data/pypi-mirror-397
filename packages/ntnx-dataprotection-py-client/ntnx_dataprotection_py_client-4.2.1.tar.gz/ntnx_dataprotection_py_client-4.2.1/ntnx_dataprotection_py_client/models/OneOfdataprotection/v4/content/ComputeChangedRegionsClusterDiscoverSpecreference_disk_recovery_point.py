...
class ComputeChangedRegionsClusterDiscoverSpecreference_disk_recovery_point(object):
    ...
    discriminator_value_class_map = {
        ...
        'dataprotection.v4.content.VmDiskRecoveryPointReference': 'dataprotection.v4.content.VmDiskRecoveryPointReference',
        'dataprotection.v4.content.VolumeGroupDiskRecoveryPointReference': 'dataprotection.v4.content.VolumeGroupDiskRecoveryPointReference'
    }

    ONE_OF_ITEM_DISCRIMINATOR_NAME = '$referenceDiskRecoveryPointItemDiscriminator'
    ...
    def _initialize_object_type(self):
        return 'OneOfdataprotection.v4.content.ComputeChangedRegionsClusterDiscoverSpecreference_disk_recovery_point'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ComputeChangedRegionsClusterDiscoverSpecreference_disk_recovery_point.discriminator_value_class_map.values():
            return list(ComputeChangedRegionsClusterDiscoverSpecreference_disk_recovery_point.discriminator_value_class_map.keys())[list(ComputeChangedRegionsClusterDiscoverSpecreference_disk_recovery_point.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ComputeChangedRegionsClusterDiscoverSpecreference_disk_recovery_point, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ComputeChangedRegionsClusterDiscoverSpecreference_disk_recovery_point):
            return False
