...
from ntnx_dataprotection_py_client.models.vmm.v4.ahv.config.OwnerReference import OwnerReference  # noqa: F401,E501

class OwnershipInfo(object):

    """Ownership information for the VM.

    :param owner: (:attr:`owner`) 
    :type owner: 
    ...
    """  # noqa: E501
    swagger_types = {
        'owner': 'vmm.v4.ahv.config.OwnerReference',
    ...
    def __init__(self, owner=None, *args, **kwargs):  # noqa: E501
        self.__owner = None
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.ahv.config.OwnershipInfo'
    ...
    def owner(self):
        ...
        :type:
            :class:`~ntnx_dataprotection_py_client.models.vmm.v4.ahv.config.OwnerReference`
        """  # noqa: E501
        return self.__owner
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(OwnershipInfo, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OwnershipInfo):
            return False
