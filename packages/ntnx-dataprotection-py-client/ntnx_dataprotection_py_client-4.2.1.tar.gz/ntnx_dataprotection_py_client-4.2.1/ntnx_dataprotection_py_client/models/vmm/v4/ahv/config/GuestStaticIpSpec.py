...
class GuestStaticIpSpec(object):

    """

    :param ipv4_address: (:attr:`ipv4_address`) 
    :type ipv4_address: 
    
    
    :param gateway_ipv4_address_list: (:attr:`gateway_ipv4_address_list`) List of gateway IPv4 addresses to override for the guest NIC's particular static IP.
    :type gateway_ipv4_address_list: 
    ...
    """  # noqa: E501
    swagger_types = {
        'ipv4_address': 'common.v1.config.IPv4Address',
        'gateway_ipv4_address_list': 'list[common.v1.config.IPv4Address]',
    ...
    attribute_map = {
        ...
        'gateway_ipv4_address_list': 'gatewayIpv4AddressList',
        '_reserved': '$reserved',
    ...
    def __init__(self, ipv4_address=None, gateway_ipv4_address_list=None, *args, **kwargs):  # noqa: E501
        self.__ipv4_address = None
        self.__gateway_ipv4_address_list = None
        self.discriminator = None
        if ipv4_address is not None:
            self.__ipv4_address = ipv4_address
        if gateway_ipv4_address_list is not None:
            self.__gateway_ipv4_address_list = gateway_ipv4_address_list
        # populate hidden vars if not empty
        self._populate_hidden_vars(kwargs)

    def _initialize_object_type(self):
        return 'vmm.v4.ahv.config.GuestStaticIpSpec'
    ...
    @property
    def gateway_ipv4_address_list(self):
        """
        List of gateway IPv4 addresses to override for the guest NIC's particular static IP.

        :type:
             list[ :class:`~ntnx_dataprotection_py_client.models.common.v1.config.IPv4Address` ]
        """  # noqa: E501
        return self.__gateway_ipv4_address_list

    @gateway_ipv4_address_list.setter
    def gateway_ipv4_address_list(self, gateway_ipv4_address_list):
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GuestStaticIpSpec, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GuestStaticIpSpec):
            return False
