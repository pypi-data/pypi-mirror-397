...
class VmRestoreIpv4ConfigOverrideSpec(object):
    ...
    def __init__(self, ip_address=None, secondary_ip_address_list=None, *args, **kwargs):  # noqa: E501
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.ahv.config.VmRestoreIpv4ConfigOverrideSpec'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VmRestoreIpv4ConfigOverrideSpec, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VmRestoreIpv4ConfigOverrideSpec):
            return False
