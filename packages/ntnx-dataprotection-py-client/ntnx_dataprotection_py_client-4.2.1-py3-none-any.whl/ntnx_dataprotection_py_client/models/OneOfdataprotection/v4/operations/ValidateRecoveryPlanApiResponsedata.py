...
class ValidateRecoveryPlanApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfdataprotection.v4.operations.ValidateRecoveryPlanApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ValidateRecoveryPlanApiResponsedata.discriminator_value_class_map.values():
            return list(ValidateRecoveryPlanApiResponsedata.discriminator_value_class_map.keys())[list(ValidateRecoveryPlanApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ValidateRecoveryPlanApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ValidateRecoveryPlanApiResponsedata):
            return False
