...
class PlannedFailoverRecoveryPlanApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfdataprotection.v4.operations.PlannedFailoverRecoveryPlanApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in PlannedFailoverRecoveryPlanApiResponsedata.discriminator_value_class_map.values():
            return list(PlannedFailoverRecoveryPlanApiResponsedata.discriminator_value_class_map.keys())[list(PlannedFailoverRecoveryPlanApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(PlannedFailoverRecoveryPlanApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PlannedFailoverRecoveryPlanApiResponsedata):
            return False
