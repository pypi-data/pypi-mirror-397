...
class DeleteRecoveryPlanJobApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfdataprotection.v4.config.DeleteRecoveryPlanJobApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in DeleteRecoveryPlanJobApiResponsedata.discriminator_value_class_map.values():
            return list(DeleteRecoveryPlanJobApiResponsedata.discriminator_value_class_map.keys())[list(DeleteRecoveryPlanJobApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(DeleteRecoveryPlanJobApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteRecoveryPlanJobApiResponsedata):
            return False
