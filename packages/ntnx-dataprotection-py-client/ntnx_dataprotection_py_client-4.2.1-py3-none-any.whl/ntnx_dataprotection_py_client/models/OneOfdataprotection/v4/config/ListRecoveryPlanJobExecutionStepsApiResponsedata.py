...
class ListRecoveryPlanJobExecutionStepsApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<dataprotection.v4.config.RecoveryPlanJobExecutionStep>': 'list[dataprotection.v4.config.RecoveryPlanJobExecutionStep]',
        'dataprotection.v4.error.ErrorResponse': 'dataprotection.v4.error.ErrorResponse',
        'List<dataprotection.v4.config.RecoveryPlanJobExecutionStepProjection>': 'list[dataprotection.v4.config.RecoveryPlanJobExecutionStepProjection]'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOfdataprotection.v4.config.ListRecoveryPlanJobExecutionStepsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListRecoveryPlanJobExecutionStepsApiResponsedata.discriminator_value_class_map.values():
            return list(ListRecoveryPlanJobExecutionStepsApiResponsedata.discriminator_value_class_map.keys())[list(ListRecoveryPlanJobExecutionStepsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListRecoveryPlanJobExecutionStepsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListRecoveryPlanJobExecutionStepsApiResponsedata):
            return False
