...
class RecoveryPointReplicateApiResponsedata(object):
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in RecoveryPointReplicateApiResponsedata.discriminator_value_class_map.values():
            return list(RecoveryPointReplicateApiResponsedata.discriminator_value_class_map.keys())[list(RecoveryPointReplicateApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(RecoveryPointReplicateApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RecoveryPointReplicateApiResponsedata):
            return False
