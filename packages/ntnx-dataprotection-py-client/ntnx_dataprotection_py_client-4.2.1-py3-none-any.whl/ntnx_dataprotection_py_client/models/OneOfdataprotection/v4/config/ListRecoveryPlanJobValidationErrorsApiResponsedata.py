...
class ListRecoveryPlanJobValidationErrorsApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<dataprotection.v4.config.RecoveryPlanValidationError>': 'list[dataprotection.v4.config.RecoveryPlanValidationError]',
        'dataprotection.v4.error.ErrorResponse': 'dataprotection.v4.error.ErrorResponse',
        'List<dataprotection.v4.config.RecoveryPlanValidationErrorProjection>': 'list[dataprotection.v4.config.RecoveryPlanValidationErrorProjection]'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOfdataprotection.v4.config.ListRecoveryPlanJobValidationErrorsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListRecoveryPlanJobValidationErrorsApiResponsedata.discriminator_value_class_map.values():
            return list(ListRecoveryPlanJobValidationErrorsApiResponsedata.discriminator_value_class_map.keys())[list(ListRecoveryPlanJobValidationErrorsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListRecoveryPlanJobValidationErrorsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListRecoveryPlanJobValidationErrorsApiResponsedata):
            return False
