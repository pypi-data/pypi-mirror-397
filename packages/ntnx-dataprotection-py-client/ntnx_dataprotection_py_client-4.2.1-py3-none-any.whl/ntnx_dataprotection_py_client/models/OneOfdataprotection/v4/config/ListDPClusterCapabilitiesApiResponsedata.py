...
class ListDPClusterCapabilitiesApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<dataprotection.v4.config.DataProtectionClusterCapability>': 'list[dataprotection.v4.config.DataProtectionClusterCapability]',
        'dataprotection.v4.error.ErrorResponse': 'dataprotection.v4.error.ErrorResponse',
        'List<dataprotection.v4.config.DataProtectionClusterCapabilityProjection>': 'list[dataprotection.v4.config.DataProtectionClusterCapabilityProjection]'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOfdataprotection.v4.config.ListDPClusterCapabilitiesApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListDPClusterCapabilitiesApiResponsedata.discriminator_value_class_map.values():
            return list(ListDPClusterCapabilitiesApiResponsedata.discriminator_value_class_map.keys())[list(ListDPClusterCapabilitiesApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListDPClusterCapabilitiesApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListDPClusterCapabilitiesApiResponsedata):
            return False
