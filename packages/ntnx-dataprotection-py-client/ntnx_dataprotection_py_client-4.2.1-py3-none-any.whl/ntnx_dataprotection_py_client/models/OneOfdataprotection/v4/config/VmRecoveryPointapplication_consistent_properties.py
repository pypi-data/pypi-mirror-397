...
class VmRecoveryPointapplication_consistent_properties(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfdataprotection.v4.config.VmRecoveryPointapplication_consistent_properties'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in VmRecoveryPointapplication_consistent_properties.discriminator_value_class_map.values():
            return list(VmRecoveryPointapplication_consistent_properties.discriminator_value_class_map.keys())[list(VmRecoveryPointapplication_consistent_properties.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VmRecoveryPointapplication_consistent_properties, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VmRecoveryPointapplication_consistent_properties):
            return False
