...
class ProtectedResourcePromoteApiResponsedata(object):
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ProtectedResourcePromoteApiResponsedata.discriminator_value_class_map.values():
            return list(ProtectedResourcePromoteApiResponsedata.discriminator_value_class_map.keys())[list(ProtectedResourcePromoteApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ProtectedResourcePromoteApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ProtectedResourcePromoteApiResponsedata):
            return False
