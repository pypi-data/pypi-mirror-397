...
class ExecutionStepResultresult(object):
    ...
    discriminator_value_class_map = {
        ...
        'dataprotection.v4.config.EntityRecoveryResult': 'dataprotection.v4.config.EntityRecoveryResult'
    }

    ONE_OF_ITEM_DISCRIMINATOR_NAME = '$resultItemDiscriminator'
    ...
    def _initialize_object_type(self):
        return 'OneOfdataprotection.v4.config.ExecutionStepResultresult'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ExecutionStepResultresult.discriminator_value_class_map.values():
            return list(ExecutionStepResultresult.discriminator_value_class_map.keys())[list(ExecutionStepResultresult.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ExecutionStepResultresult, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ExecutionStepResultresult):
            return False
