...
class ChangedVolumeGroupRegionsApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<dataprotection.v4.content.ChangedRegion>': 'list[dataprotection.v4.content.ChangedRegion]',
    ...
    def _initialize_object_type(self):
        return 'OneOfdataprotection.v4.content.ChangedVolumeGroupRegionsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ChangedVolumeGroupRegionsApiResponsedata.discriminator_value_class_map.values():
            return list(ChangedVolumeGroupRegionsApiResponsedata.discriminator_value_class_map.keys())[list(ChangedVolumeGroupRegionsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ChangedVolumeGroupRegionsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ChangedVolumeGroupRegionsApiResponsedata):
            return False
