...
from ntnx_dataprotection_py_client.models.dataprotection.v4.content.RegionType import RegionType  # noqa: F401,E501

class ChangedRegion(object):
    ...
    swagger_types = {
        'offset': 'int',
        'length': 'int',
        'region_type': 'dataprotection.v4.content.RegionType',
    ...
    def _initialize_object_type(self):
        return 'dataprotection.v4.content.ChangedRegion'
    ...
    def region_type(self):
        ...
        :type:
            :class:`~ntnx_dataprotection_py_client.models.dataprotection.v4.content.RegionType`
        """  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ChangedRegion, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ChangedRegion):
            return False
