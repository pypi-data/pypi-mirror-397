...
class BaseRecoveryPointSpec(object):
    ...
    def __init__(self, reference_recovery_point_ext_id=None, reference_disk_recovery_point_ext_id=None, *args, **kwargs):  # noqa: E501
    ...
    def _initialize_object_type(self):
        return 'dataprotection.v4.content.BaseRecoveryPointSpec'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(BaseRecoveryPointSpec, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BaseRecoveryPointSpec):
            return False
