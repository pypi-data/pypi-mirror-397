...
from ntnx_dataprotection_py_client.models.dataprotection.v4.content.VmDiskRecoveryPointClusterDiscoverSpec import VmDiskRecoveryPointClusterDiscoverSpec  # noqa: F401,E501

class VmRecoveryPointChangedRegionsComputeSpec(VmDiskRecoveryPointClusterDiscoverSpec):
    ...
    :param offset: (:attr:`offset`) The start offset value to compute the changed region. If the value is not provided, then the difference is executed from the offset of 0. Note: the start offset might automatically align to a system-defined block boundary.
    :type offset: 
    
    
    :param length: (:attr:`length`) The length to compute the changed region. If the value is not provided, then the difference is performed from the start offset to the end of the disk. Note: the end offset might automatically align to a system-defined block boundary.
    :type length: 
    ...
    def __init__(self, offset=None, length=None, block_size_byte=None, reference_vm_recovery_point_ext_id=None, reference_recovery_point_ext_id=None, reference_disk_recovery_point_ext_id=None, *args, **kwargs):  # noqa: E501
        VmDiskRecoveryPointClusterDiscoverSpec.__init__(self, reference_vm_recovery_point_ext_id, reference_recovery_point_ext_id, reference_disk_recovery_point_ext_id, *args, **kwargs)
        self.__offset = None
        self.__length = None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VmRecoveryPointChangedRegionsComputeSpec, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VmRecoveryPointChangedRegionsComputeSpec):
            return False
