...
class VmDiskRecoveryPointClusterDiscoverSpec(BaseRecoveryPointSpec):
    ...
    :param reference_vm_recovery_point_ext_id: (:attr:`reference_vm_recovery_point_ext_id`) The external identifier that can be used to identify a VM recovery point.
    ...
    def __init__(self, reference_vm_recovery_point_ext_id=None, reference_recovery_point_ext_id=None, reference_disk_recovery_point_ext_id=None, *args, **kwargs):  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VmDiskRecoveryPointClusterDiscoverSpec, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VmDiskRecoveryPointClusterDiscoverSpec):
            return False
