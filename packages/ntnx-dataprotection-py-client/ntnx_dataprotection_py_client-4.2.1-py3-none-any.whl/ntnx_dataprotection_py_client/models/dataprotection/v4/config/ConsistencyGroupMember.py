...
class ConsistencyGroupMember(object):
    ...
    def entity_type(self):
        ...
        :type:
            :class:`~ntnx_dataprotection_py_client.models.dataprotection.v4.config.ConsistencyGroupMemberType`
        """  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ConsistencyGroupMember, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ConsistencyGroupMember):
            return False
