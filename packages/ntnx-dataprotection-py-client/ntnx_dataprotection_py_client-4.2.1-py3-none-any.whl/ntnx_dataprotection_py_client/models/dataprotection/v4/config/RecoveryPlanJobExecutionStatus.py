...
class RecoveryPlanJobExecutionStatus(object):
    ...
    Allowed enum values:
        ...
        - _UNKNOWN
        - _REDACTED
        - SUCCEEDED: Operation is completed successfully.
        - RUNNING: Operation is running.
        - ABORTED: Operation is aborted.
        - FAILED: Operation is failed.
        - QUEUED: Operation is queued.
        - SUCCEEDED_WITH_VALIDATION_WARNING: Operation is completed but with some validation warnings.
    """
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    SUCCEEDED = "SUCCEEDED"
    ...
    FAILED = "FAILED"
    QUEUED = "QUEUED"
    SUCCEEDED_WITH_VALIDATION_WARNING = "SUCCEEDED_WITH_VALIDATION_WARNING"
    ...
    def _initialize_object_type(self):
        return 'dataprotection.v4.config.RecoveryPlanJobExecutionStatus'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(RecoveryPlanJobExecutionStatus, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RecoveryPlanJobExecutionStatus):
            return False
