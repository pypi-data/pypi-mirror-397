...
class DeleteConsistencyGroupApiResponse(object):
    ...
    swagger_types = {
        ...
        'data': 'OneOfdataprotection.v4.config.DeleteConsistencyGroupApiResponsedata',
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(DeleteConsistencyGroupApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteConsistencyGroupApiResponse):
            return False
