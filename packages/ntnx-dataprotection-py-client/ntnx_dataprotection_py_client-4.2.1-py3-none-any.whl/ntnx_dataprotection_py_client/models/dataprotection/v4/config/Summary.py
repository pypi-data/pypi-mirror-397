...
class Summary(object):
    ...
    :param percentage_complete: (:attr:`percentage_complete`) The completed percentage of this phase in the recovery plan job.
    ...
    def __init__(self, status=None, percentage_complete=None, *args, **kwargs):  # noqa: E501
        self.__status = None
    ...
    def _initialize_object_type(self):
        return 'dataprotection.v4.config.Summary'
