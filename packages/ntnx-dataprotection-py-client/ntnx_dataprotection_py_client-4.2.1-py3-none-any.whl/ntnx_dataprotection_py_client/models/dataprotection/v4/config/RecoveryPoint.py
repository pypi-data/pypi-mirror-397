...
class RecoveryPoint(BaseRecoveryPoint):
    ...
    def __init__(self, owner_ext_id=None, location_references=None, vm_recovery_points=None, volume_group_recovery_points=None, is_secure=None, source_location=None, location_agnostic_id=None, name=None, creation_time=None, expiration_time=None, status=None, recovery_point_type=None, total_exclusive_usage_bytes=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
        BaseRecoveryPoint.__init__(self, location_agnostic_id, name, creation_time, expiration_time, status, recovery_point_type, total_exclusive_usage_bytes, ext_id, links, tenant_id, *args, **kwargs)
    ...
    def source_location(self):
        ...
        :type:
            :class:`~ntnx_dataprotection_py_client.models.dataprotection.v4.config.DisasterRecoveryLocation`
        """  # noqa: E501
