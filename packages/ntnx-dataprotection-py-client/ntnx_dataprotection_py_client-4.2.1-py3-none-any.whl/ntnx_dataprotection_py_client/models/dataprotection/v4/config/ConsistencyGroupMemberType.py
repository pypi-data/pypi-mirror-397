...
class ConsistencyGroupMemberType(object):
    ...
    Allowed enum values:
        ...
        - _UNKNOWN
        - _REDACTED
        - VM: Entity of type VM that is part of a consistency group.
        - VOLUME_GROUP: Entity of type volume group that is included in a consistency group.
    """
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    VM = "VM"
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ConsistencyGroupMemberType, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ConsistencyGroupMemberType):
            return False
