...
from ntnx_dataprotection_py_client.models.OneOfdataprotection.v4.config.ExecutionStepResultresult import ExecutionStepResultresult  # noqa: F401,E501

class ExecutionStepResult(object):

    """Resulted output for an execution of a step.

    :param result: (:attr:`result`) Resulted output for an execution of a step.
    ...
    """  # noqa: E501
    swagger_types = {
        'result': 'OneOfdataprotection.v4.config.ExecutionStepResultresult',
    ...
    def _initialize_object_type(self):
        return 'dataprotection.v4.config.ExecutionStepResult'
    ...
    def result(self):
        ...
        :type:
                :class:`~ntnx_dataprotection_py_client.models.dataprotection.v4.config.EntityRecoveryResult`
        """  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ExecutionStepResult, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ExecutionStepResult):
            return False
