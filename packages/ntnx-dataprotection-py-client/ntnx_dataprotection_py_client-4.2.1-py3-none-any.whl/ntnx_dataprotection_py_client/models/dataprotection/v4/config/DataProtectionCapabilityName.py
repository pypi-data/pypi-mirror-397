...
class DataProtectionCapabilityName(object):
    ...
    Allowed enum values:
        ...
        - _UNKNOWN
        - _REDACTED
        - SUPPORTS_NEAR_SYNC: Indicates if the cluster supports near sync replication. Near sync replication is a type of replication that  provides a lower recovery point objective (RPO) than traditional asynchronous replication.

    """
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    SUPPORTS_NEAR_SYNC = "SUPPORTS_NEAR_SYNC"
    ...
    def _initialize_object_type(self):
        return 'dataprotection.v4.config.DataProtectionCapabilityName'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(DataProtectionCapabilityName, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DataProtectionCapabilityName):
            return False
