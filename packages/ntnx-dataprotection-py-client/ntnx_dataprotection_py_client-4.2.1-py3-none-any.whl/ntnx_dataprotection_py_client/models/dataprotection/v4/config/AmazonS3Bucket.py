...
class AmazonS3Bucket(object):
    ...
    def bucket_name(self, bucket_name):
        if bucket_name is not None and len(bucket_name) > 256:
            raise ValueError("Invalid value for `bucket_name`, length must be less than or equal to `256`")  # noqa: E501
    ...
    def region_name(self, region_name):
        if region_name is not None and len(region_name) > 256:
            raise ValueError("Invalid value for `region_name`, length must be less than or equal to `256`")  # noqa: E501
