...
class VolumeGroupRecoveryPoint(ExternalizableAbstractModel):
    ...
    :param volume_group_categories: (:attr:`volume_group_categories`) Category key-value pairs associated with the volume group at the time of recovery point creation. The category key and value are separated by '/'. For example, a category with key 'dept' and value 'hr' is represented as 'dept/hr'.
    ...
    def __init__(self, consistency_group_ext_id=None, location_agnostic_id=None, volume_group_ext_id=None, volume_group_categories=None, disk_recovery_points=None, total_exclusive_usage_bytes=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
        ...
        self.__total_exclusive_usage_bytes = None
        ...
        if total_exclusive_usage_bytes is not None:
            self.__total_exclusive_usage_bytes = total_exclusive_usage_bytes
    ...
    @property
    def total_exclusive_usage_bytes(self):
        """
        ...
        :type:
                :class:`~int`
        """  # noqa: E501
        return self.__total_exclusive_usage_bytes

    @total_exclusive_usage_bytes.setter
    def total_exclusive_usage_bytes(self, total_exclusive_usage_bytes):
