...
class DisasterRecoveryLocation(object):
    ...
    :param domain_manager_ext_id: (:attr:`domain_manager_ext_id`) External identifier of the Prism Central (also known as the Domain Manager) where the recovery point was first created.
    :type domain_manager_ext_id: required
    
    
    :param cluster_ext_ids: (:attr:`cluster_ext_ids`) External identifier of the clusters associated with the recovery point at source Prism Central.
    :type cluster_ext_ids: required
    ...
    def __init__(self, domain_manager_ext_id=None, cluster_ext_ids=None, *args, **kwargs):  # noqa: E501
    ...
    def cluster_ext_ids(self, cluster_ext_ids):
        if cluster_ext_ids is None:
            raise ValueError("Invalid value for `cluster_ext_ids`, must not be `None`")  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(DisasterRecoveryLocation, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DisasterRecoveryLocation):
            return False
