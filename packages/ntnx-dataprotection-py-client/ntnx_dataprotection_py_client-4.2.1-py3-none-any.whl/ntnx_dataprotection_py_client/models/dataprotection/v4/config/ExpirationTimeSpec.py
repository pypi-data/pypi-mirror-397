...
class ExpirationTimeSpec(object):
    ...
    :param expiration_time: (:attr:`expiration_time`) The UTC date and time in ISO-8601 format when the current recovery point expires . If not specified, the recovery point never expires.
