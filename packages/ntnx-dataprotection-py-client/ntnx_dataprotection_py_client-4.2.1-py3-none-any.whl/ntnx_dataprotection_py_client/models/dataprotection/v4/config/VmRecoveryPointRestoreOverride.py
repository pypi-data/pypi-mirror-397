...
from ntnx_dataprotection_py_client.models.OneOfdataprotection.v4.config.VmRecoveryPointRestoreOverridevm_override_spec import VmRecoveryPointRestoreOverridevm_override_spec  # noqa: F401,E501

class VmRecoveryPointRestoreOverride(object):

    """

    :param vm_recovery_point_ext_id: (:attr:`vm_recovery_point_ext_id`) External identifier of a VM recovery point, that is a part of the top-level recovery point.
    :type vm_recovery_point_ext_id: 
    
    
    :param is_strict_mode: (:attr:`is_strict_mode`) If set to true, any VM configuration that cannot be restored or overridden, is dropped or reset to the system defaults and the corresponding warnings are returned. If set to False, the restore operation runs in the normal mode where any failures are raised as errors and the VM is not restored until the issues are fixed. Only applicable for AHV VMs. (**Default** False)
    :type is_strict_mode: 
    
    
    :param vm_override_spec: (:attr:`vm_override_spec`) AHV/ESXi specific VM restore override specifications.
    :type vm_override_spec: 
    ...
    swagger_types = {
        ...
        'is_strict_mode': 'bool',
        'vm_override_spec': 'OneOfdataprotection.v4.config.VmRecoveryPointRestoreOverridevm_override_spec',
    ...
    attribute_map = {
        ...
        'vm_override_spec': 'vmOverrideSpec',
        '_reserved': '$reserved',
    ...
    def __init__(self, vm_recovery_point_ext_id=None, is_strict_mode=False, vm_override_spec=None, *args, **kwargs):  # noqa: E501
        self.__vm_recovery_point_ext_id = None
        self.__is_strict_mode = None
        self.__vm_override_spec = None
        ...
        if vm_override_spec is not None:
            self.__vm_override_spec = vm_override_spec
    ...
    def vm_override_spec(self):
        ...
        """  # noqa: E501
        return self.__vm_override_spec

    @vm_override_spec.setter
    def vm_override_spec(self, vm_override_spec):
