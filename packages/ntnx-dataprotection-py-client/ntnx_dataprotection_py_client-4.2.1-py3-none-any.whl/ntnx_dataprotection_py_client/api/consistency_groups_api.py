...
class ConsistencyGroupsApi(object):
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/dataprotection/v4.2/config/consistency-groups', 'POST',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def delete_consistency_group_by_id(self, extId, **kwargs):  # noqa: E501
        ...
        :param extId: The external identifier used to retrieve the consistency group.
        :type extId:
            :class:`str`, required
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/dataprotection/v4.2/config/consistency-groups/{extId}', 'DELETE',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def get_consistency_group_by_id(self, extId, **kwargs):  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/dataprotection/v4.2/config/consistency-groups/{extId}', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def list_consistency_groups(self, _page=None, _limit=None, _filter=None, _orderby=None, _select=None, **kwargs):  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/dataprotection/v4.2/config/consistency-groups', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def update_consistency_group_by_id(self, extId, body, **kwargs):  # noqa: E501
        ...
        :type extId:
            :class:`str`, required
        :param body: The following details are required to update the consistency group.
        :type body:
            :class:`~ntnx_dataprotection_py_client.models.dataprotection.v4.config.ConsistencyGroup`, required
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/dataprotection/v4.2/config/consistency-groups/{extId}', 'PUT',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
