...
class DataProtectionClusterCapabilitiesApi(object):
    """IGNORE:
    ...
    def list_data_protection_cluster_capabilities(self, _page=None, _limit=None, _filter=None, _orderby=None, _select=None, **kwargs):  # noqa: E501
        """Get data protection cluster capabilities

        >>> response = api.list_data_protection_cluster_capabilities((optional) _page, (optional) _limit, (optional) _filter, (optional) _orderby, (optional) _select)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.list_data_protection_cluster_capabilities(async_req=True)
        >>> result = thread.get()
        ...
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
                           ...
                           async_req=True
        :return: An instance of class :class:`~ntnx_dataprotection_py_client.models.dataprotection.v4.config.ListDPClusterCapabilitiesApiResponse`.
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/dataprotection/v4.2/config/cluster-capabilities', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
                    ...
                    response_type='dataprotection.v4.config.ListDPClusterCapabilitiesApiResponse',  # noqa: E501
