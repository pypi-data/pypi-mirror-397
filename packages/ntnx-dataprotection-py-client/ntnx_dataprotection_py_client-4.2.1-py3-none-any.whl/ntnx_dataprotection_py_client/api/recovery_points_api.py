...
class RecoveryPointsApi(object):
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/dataprotection/v4.2/config/recovery-points', 'POST',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def delete_recovery_point_by_id(self, extId, **kwargs):  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/dataprotection/v4.2/config/recovery-points/{extId}', 'DELETE',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def discover_cluster_for_recovery_point_id(self, extId, body, **kwargs):  # noqa: E501
        ...
        :type extId:
            :class:`str`, required
        :param body: Request body containing recovery point specifications for discovering the cluster.
        :type body:
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/dataprotection/v4.2/config/recovery-points/{extId}/$actions/discover-cluster', 'POST',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def get_recovery_point_by_id(self, extId, **kwargs):  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/dataprotection/v4.2/config/recovery-points/{extId}', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def get_vm_recovery_point_by_id(self, recoveryPointExtId, extId, **kwargs):  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/dataprotection/v4.2/config/recovery-points/{recoveryPointExtId}/vm-recovery-points/{extId}', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def get_vss_metadata_by_vm_recovery_point_id(self, recoveryPointExtId, vmRecoveryPointExtId, **kwargs):  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/dataprotection/v4.2/content/recovery-points/{recoveryPointExtId}/vm-recovery-points/{vmRecoveryPointExtId}/vss-metadata', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def list_recovery_points(self, X_Cluster_Id=None, _page=None, _limit=None, _filter=None, _orderby=None, _select=None, **kwargs):  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/dataprotection/v4.2/config/recovery-points', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def replicate_recovery_point(self, extId, body, **kwargs):  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/dataprotection/v4.2/config/recovery-points/{extId}/$actions/replicate', 'POST',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def restore_recovery_point(self, extId, body=None, **kwargs):  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/dataprotection/v4.2/config/recovery-points/{extId}/$actions/restore', 'POST',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def set_recovery_point_expiration_time(self, extId, body, **kwargs):  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/dataprotection/v4.2/config/recovery-points/{extId}/$actions/set-expiration-time', 'POST',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def vm_recovery_point_compute_changed_regions(self, recoveryPointExtId, vmRecoveryPointExtId, extId, body, **kwargs):  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/dataprotection/v4.2/content/recovery-points/{recoveryPointExtId}/vm-recovery-points/{vmRecoveryPointExtId}/disk-recovery-points/{extId}/$actions/compute-changed-regions', 'POST',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def volume_group_recovery_point_compute_changed_regions(self, recoveryPointExtId, volumeGroupRecoveryPointExtId, extId, body, **kwargs):  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/dataprotection/v4.2/content/recovery-points/{recoveryPointExtId}/volume-group-recovery-points/{volumeGroupRecoveryPointExtId}/disk-recovery-points/{extId}/$actions/compute-changed-regions', 'POST',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
