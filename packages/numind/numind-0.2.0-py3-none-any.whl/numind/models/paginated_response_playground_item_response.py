...
class PaginatedResponsePlaygroundItemResponse(BaseModel):
    """
    ...
    items: Optional[List[PlaygroundItemResponse]] = Field(
        ...
        _obj = cls.model_validate(
            {
                ...
                "items": [
                    PlaygroundItemResponse.from_dict(_item) for _item in obj["items"]
                ]
