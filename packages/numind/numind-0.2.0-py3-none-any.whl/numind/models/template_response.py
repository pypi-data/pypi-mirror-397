...
class TemplateResponse(BaseModel):
    ...
    result: Dict[str, Any] = Field(description="Template in NuExtract format.")
    ...
    error: Optional[InferenceValidationError] = Field(
        default=None,
        description="Inference result validation error if the result does not conform to the NuExtract template format.",
    )
