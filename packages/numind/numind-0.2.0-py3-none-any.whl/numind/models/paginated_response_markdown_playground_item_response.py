...
class PaginatedResponseMarkdownPlaygroundItemResponse(BaseModel):
    """
    ...
    items: Optional[List[MarkdownPlaygroundItemResponse]] = Field(
        ...
        _obj = cls.model_validate(
            {
                ...
                "items": [
                    MarkdownPlaygroundItemResponse.from_dict(_item)
