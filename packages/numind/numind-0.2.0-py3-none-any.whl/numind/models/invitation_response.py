...
class InvitationResponse(BaseModel):
    ...
    id: StrictStr = Field(description="identifier of this invitation")
    email: StrictStr = Field(description="email of the person invited")
    roles: Optional[List[StrictStr]] = Field(
        default=None, description="roles associated with this invitation"
    )
    __properties: ClassVar[List[str]] = ["id", "email", "roles"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"id": obj.get("id"), "email": obj.get("email"), "roles": obj.get("roles")}
        )
        return _obj
