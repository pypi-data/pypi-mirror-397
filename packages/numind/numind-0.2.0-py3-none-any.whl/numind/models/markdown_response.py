...
class MarkdownResponse(BaseModel):
    ...
    result: Optional[StrictStr] = Field(
        default=None, description="Result of NuMarkdown model"
    )
    thinking_trace: Optional[StrictStr] = Field(
        default=None, description="Reasoning of NuMarkdown model", alias="thinkingTrace"
    )
    raw_model_output: StrictStr = Field(
        description="Full inference result as returned by the model",
