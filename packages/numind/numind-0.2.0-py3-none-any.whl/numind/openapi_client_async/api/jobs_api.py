...
class JobsApi:
    ...
    async def get_api_jobs_jobid(
        ...
        """
        (Deprecated) get_api_jobs_jobid

          Get details of a specific job by its unique identifier together with input data and results.  This endpoint retrieves the complete information about an asynchronous job, including its status, input data, and output results if completed.  #### Response:  For completed inference jobs, the output data will contain what would normally be returned by the corresponding non-async endpoint,  such as extraction results for inference jobs.  #### Error Responses: `404 Not Found` - If a job with the specified ID does not exist.  `403 Forbidden` - If the user does not have permission to access this job.
        ...
        :return: Returns the result object.
        """  # noqa: E501
        warnings.warn("GET /api/jobs/{jobId} is deprecated.", DeprecationWarning)
    ...
    @validate_call
    async def get_api_jobs_jobid_with_http_info(
        self,
        job_id: Annotated[StrictStr, Field(description="Unique job identifier.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def get_api_jobs_jobid_without_preload_content(
        self,
        job_id: Annotated[StrictStr, Field(description="Unique job identifier.")],
        _request_timeout: Union[
            None,
    ...
    def _get_api_jobs_jobid_serialize(
        self,
        job_id,
        _request_auth,
        _content_type,
