...
class ContentExtractionApi:
    ...
    @validate_call
    async def get_api_content_extraction_jobs_contentextractionjobid(
        self,
    ...
    @validate_call
    async def get_api_content_extraction_jobs_contentextractionjobid_with_http_info(
        self,
        content_extraction_job_id: Annotated[
            StrictStr, Field(description="Unique content extraction job identifier.")
        ],
    ...
    @validate_call
    async def get_api_content_extraction_jobs_contentextractionjobid_without_preload_content(
        self,
        content_extraction_job_id: Annotated[
            StrictStr, Field(description="Unique content extraction job identifier.")
        ],
