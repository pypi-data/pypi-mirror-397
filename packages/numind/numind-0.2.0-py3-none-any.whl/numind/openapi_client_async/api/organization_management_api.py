...
class OrganizationManagementApi:
    ...
    @validate_call
    async def delete_api_organizations_organizationid(
        self,
    ...
    @validate_call
    async def delete_api_organizations_organizationid_with_http_info(
        self,
        organization_id: Annotated[
            StrictStr, Field(description="identifier for the organization")
        ],
    ...
    @validate_call
    async def delete_api_organizations_organizationid_without_preload_content(
        self,
        organization_id: Annotated[
            StrictStr, Field(description="identifier for the organization")
        ],
    ...
    @validate_call
    async def delete_api_organizations_organizationid_members_invitations_invitationid(
        self,
        organization_id: Annotated[
            StrictStr, Field(description="identifier for the organization")
        ],
    ...
    @validate_call
    async def delete_api_organizations_organizationid_members_invitations_invitationid_with_http_info(
        self,
        organization_id: Annotated[
            StrictStr, Field(description="identifier for the organization")
        ],
    ...
    @validate_call
    async def delete_api_organizations_organizationid_members_invitations_invitationid_without_preload_content(
        self,
        organization_id: Annotated[
            StrictStr, Field(description="identifier for the organization")
        ],
    ...
    @validate_call
    async def delete_api_organizations_organizationid_members_userid(
        self,
        organization_id: Annotated[
            StrictStr, Field(description="identifier for the organization")
        ],
    ...
    @validate_call
    async def delete_api_organizations_organizationid_members_userid_with_http_info(
        self,
        organization_id: Annotated[
            StrictStr, Field(description="identifier for the organization")
        ],
    ...
    @validate_call
    async def delete_api_organizations_organizationid_members_userid_without_preload_content(
        self,
        organization_id: Annotated[
            StrictStr, Field(description="identifier for the organization")
        ],
    ...
    @validate_call
    async def get_api_organizations(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def get_api_organizations_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def get_api_organizations_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def get_api_organizations_organizationid_members(
        self,
        organization_id: Annotated[
            StrictStr, Field(description="identifier for the organization")
        ],
    ...
    @validate_call
    async def get_api_organizations_organizationid_members_with_http_info(
        self,
        organization_id: Annotated[
            StrictStr, Field(description="identifier for the organization")
        ],
    ...
    @validate_call
    async def get_api_organizations_organizationid_members_without_preload_content(
        self,
        organization_id: Annotated[
            StrictStr, Field(description="identifier for the organization")
        ],
    ...
    @validate_call
    async def get_api_organizations_organizationid_members_invitations(
        self,
        organization_id: Annotated[
            StrictStr, Field(description="identifier for the organization")
        ],
    ...
    @validate_call
    async def get_api_organizations_organizationid_members_invitations_with_http_info(
        self,
        organization_id: Annotated[
            StrictStr, Field(description="identifier for the organization")
        ],
    ...
    @validate_call
    async def get_api_organizations_organizationid_members_invitations_without_preload_content(
        self,
        organization_id: Annotated[
            StrictStr, Field(description="identifier for the organization")
        ],
    ...
    @validate_call
    async def post_api_organizations(
        self,
    ...
    @validate_call
    async def post_api_organizations_with_http_info(
        self,
        create_organization_request: CreateOrganizationRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def post_api_organizations_without_preload_content(
        self,
        create_organization_request: CreateOrganizationRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def post_api_organizations_organizationid_members(
        self,
        organization_id: Annotated[
            StrictStr, Field(description="identifier for the organization")
        ],
    ...
    @validate_call
    async def post_api_organizations_organizationid_members_with_http_info(
        self,
        organization_id: Annotated[
            StrictStr, Field(description="identifier for the organization")
        ],
    ...
    @validate_call
    async def post_api_organizations_organizationid_members_without_preload_content(
        self,
        organization_id: Annotated[
            StrictStr, Field(description="identifier for the organization")
        ],
    ...
    @validate_call
    async def put_api_organizations_organizationid(
        self,
        organization_id: Annotated[
            StrictStr, Field(description="identifier for the organization")
        ],
    ...
    @validate_call
    async def put_api_organizations_organizationid_with_http_info(
        self,
        organization_id: Annotated[
            StrictStr, Field(description="identifier for the organization")
        ],
    ...
    @validate_call
    async def put_api_organizations_organizationid_without_preload_content(
        self,
        organization_id: Annotated[
            StrictStr, Field(description="identifier for the organization")
        ],
