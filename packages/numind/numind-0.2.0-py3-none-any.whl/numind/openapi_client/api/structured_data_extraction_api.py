...
class StructuredDataExtractionApi:
    ...
    @validate_call
    def get_api_structured_extraction_jobs_structuredextractionjobid(
        self,
    ...
    @validate_call
    def get_api_structured_extraction_jobs_structuredextractionjobid_with_http_info(
        self,
        structured_extraction_job_id: Annotated[
            StrictStr, Field(description="Unique structured extraction job identifier.")
        ],
    ...
    @validate_call
    def get_api_structured_extraction_jobs_structuredextractionjobid_without_preload_content(
        self,
        structured_extraction_job_id: Annotated[
            StrictStr, Field(description="Unique structured extraction job identifier.")
        ],
