...
class TemplateGenerationApi:
    ...
    @validate_call
    def get_api_template_generation_jobs_templatejobid(
        self,
    ...
    @validate_call
    def get_api_template_generation_jobs_templatejobid_with_http_info(
        self,
        template_job_id: Annotated[
            StrictStr, Field(description="Unique template job identifier.")
        ],
    ...
    @validate_call
    def get_api_template_generation_jobs_templatejobid_without_preload_content(
        self,
        template_job_id: Annotated[
            StrictStr, Field(description="Unique template job identifier.")
        ],
