...
class InferenceDeprecatedApi:
    ...
    @validate_call
    def post_api_infer_template_async(
        self,
        template_request: TemplateRequest,
        timeout: Annotated[
            Optional[StrictStr],
    ...
    @validate_call
    def post_api_infer_template_async_with_http_info(
        self,
        template_request: TemplateRequest,
        timeout: Annotated[
            Optional[StrictStr],
    ...
    @validate_call
    def post_api_infer_template_async_without_preload_content(
        self,
        template_request: TemplateRequest,
        timeout: Annotated[
            Optional[StrictStr],
    ...
    @validate_call
    def post_api_infer_template_async_document_documentid(
        self,
    ...
    @validate_call
    def post_api_infer_template_async_document_documentid_with_http_info(
        self,
        document_id: Annotated[
            StrictStr, Field(description="Unique document identifier.")
        ],
    ...
    @validate_call
    def post_api_infer_template_async_document_documentid_without_preload_content(
        self,
        document_id: Annotated[
            StrictStr, Field(description="Unique document identifier.")
        ],
    ...
    @validate_call
    def post_api_projects_projectid_infer_document_async_documentid(
        self,
    ...
    @validate_call
    def post_api_projects_projectid_infer_document_async_documentid_with_http_info(
        self,
        project_id: Annotated[
            StrictStr, Field(description="Unique project identifier.")
        ],
    ...
    @validate_call
    def post_api_projects_projectid_infer_document_async_documentid_without_preload_content(
        self,
        project_id: Annotated[
            StrictStr, Field(description="Unique project identifier.")
        ],
    ...
    @validate_call
    def post_api_projects_projectid_infer_text_async(
        self,
        project_id: Annotated[
            StrictStr, Field(description="Unique project identifier.")
        ],
    ...
    @validate_call
    def post_api_projects_projectid_infer_text_async_with_http_info(
        self,
        project_id: Annotated[
            StrictStr, Field(description="Unique project identifier.")
        ],
    ...
    @validate_call
    def post_api_projects_projectid_infer_text_async_without_preload_content(
        self,
        project_id: Annotated[
            StrictStr, Field(description="Unique project identifier.")
        ],
