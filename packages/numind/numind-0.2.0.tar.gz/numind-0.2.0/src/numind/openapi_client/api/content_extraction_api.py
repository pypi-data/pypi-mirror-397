...
class ContentExtractionApi:
    ...
    @validate_call
    def get_api_content_extraction_jobs_contentextractionjobid(
        self,
        ...
        get_api_content_extraction_jobs_contentextractionjobid
          ...
          Get content extraction result of a specific job by its unique identifier.  #### Response:  Returns a markdown string representing the extracted content.  #### Error Responses: `404 Not Found` - If a content extraction job with the specified ID does not exist.  `403 Forbidden` - If the user does not have permission to access this job.
    ...
    @validate_call
    def get_api_content_extraction_jobs_contentextractionjobid_with_http_info(
        self,
        content_extraction_job_id: Annotated[
            StrictStr, Field(description="Unique content extraction job identifier.")
        ],
    ...
    @validate_call
    def get_api_content_extraction_jobs_contentextractionjobid_without_preload_content(
        self,
        content_extraction_job_id: Annotated[
            StrictStr, Field(description="Unique content extraction job identifier.")
        ],
    ...
    def _get_api_content_extraction_jobs_contentextractionjobid_serialize(
        ...
        if content_extraction_job_id is not None:
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/api/content-extraction/jobs/{contentExtractionJobId}",
    ...
    @validate_call
    def post_api_content_extraction_jobs(
        self,
    ...
    @validate_call
    def post_api_content_extraction_jobs_with_http_info(
        self,
        file: Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]],
        temperature: Annotated[
            Optional[
    ...
    @validate_call
    def post_api_content_extraction_jobs_without_preload_content(
        self,
        file: Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]],
        temperature: Annotated[
            Optional[
    ...
    def _post_api_content_extraction_jobs_serialize(
        ...
        return self.api_client.param_serialize(
            method="POST",
            resource_path="/api/content-extraction/jobs",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
