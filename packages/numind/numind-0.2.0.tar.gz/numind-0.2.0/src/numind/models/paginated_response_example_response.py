...
class PaginatedResponseExampleResponse(BaseModel):
    """
    PaginatedResponseExampleResponse
    """

    total_count: StrictInt = Field(
        description="Total number of items available.", alias="totalCount"
    )
    skip: StrictInt = Field(description="Number of items skipped.")
    per_page: StrictInt = Field(
        description="Number of items per page.", alias="perPage"
    )
    items: Optional[List[ExampleResponse]] = Field(
        default=None, description="List of items."
    )
    __properties: ClassVar[List[str]] = ["totalCount", "skip", "perPage", "items"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "items": [ExampleResponse.from_dict(_item) for _item in obj["items"]]
