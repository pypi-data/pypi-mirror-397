...
class CreateApiKey(BaseModel):
    ...
    maybe_orga: Optional[StrictStr] = Field(default=None, alias="maybeOrga")
    name: StrictStr
    __properties: ClassVar[List[str]] = ["maybeOrga", "name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"maybeOrga": obj.get("maybeOrga"), "name": obj.get("name")}
        )
        return _obj
