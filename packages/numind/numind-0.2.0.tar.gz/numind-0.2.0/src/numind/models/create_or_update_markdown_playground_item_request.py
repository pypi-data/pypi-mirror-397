...
class CreateOrUpdateMarkdownPlaygroundItemRequest(BaseModel):
    """
    ...
    result: StrictStr = Field(description="Markdown result.")
    thinking_trace: StrictStr = Field(
        description="Thinking/reasoning process.", alias="thinkingTrace"
    )
    ...
    output_tokens: Optional[StrictInt] = Field(
        default=None,
        description="Output tokens used for extraction.",
        alias="outputTokens",
    )
    input_tokens: Optional[StrictInt] = Field(
        default=None,
        description="Input tokens used for extraction.",
        alias="inputTokens",
    )
