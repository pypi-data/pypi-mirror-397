# numind.openapi_client.PlaygroundDeprecatedApi

All URIs are relative to *https://nuextract.ai*

Method | HTTP request | Description
------------- | ------------- | -------------
[**delete_api_projects_projectid_playground_playgrounditemid**](PlaygroundDeprecatedApi.md#delete_api_projects_projectid_playground_playgrounditemid) | **DELETE** /api/projects/{projectId}/playground/{playgroundItemId} | 
[**get_api_projects_projectid_playground**](PlaygroundDeprecatedApi.md#get_api_projects_projectid_playground) | **GET** /api/projects/{projectId}/playground | 
[**get_api_projects_projectid_playground_playgrounditemid**](PlaygroundDeprecatedApi.md#get_api_projects_projectid_playground_playgrounditemid) | **GET** /api/projects/{projectId}/playground/{playgroundItemId} | 
[**post_api_projects_projectid_playground**](PlaygroundDeprecatedApi.md#post_api_projects_projectid_playground) | **POST** /api/projects/{projectId}/playground | 
[**put_api_projects_projectid_playground_playgrounditemid**](PlaygroundDeprecatedApi.md#put_api_projects_projectid_playground_playgrounditemid) | **PUT** /api/projects/{projectId}/playground/{playgroundItemId} | 
...
with numind.openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = numind.openapi_client.PlaygroundDeprecatedApi(api_client)
    ...
    try:
        ...
        print("Exception when calling PlaygroundDeprecatedApi->delete_api_projects_projectid_playground_playgrounditemid: %s\n" % e)
```
...
with numind.openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of PlaygroundDeprecatedApi->get_api_projects_projectid_playground:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PlaygroundDeprecatedApi->get_api_projects_projectid_playground: %s\n" % e)
```
...
with numind.openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of PlaygroundDeprecatedApi->get_api_projects_projectid_playground_playgrounditemid:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PlaygroundDeprecatedApi->get_api_projects_projectid_playground_playgrounditemid: %s\n" % e)
```
...
with numind.openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of PlaygroundDeprecatedApi->post_api_projects_projectid_playground:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PlaygroundDeprecatedApi->post_api_projects_projectid_playground: %s\n" % e)
```
...
with numind.openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of PlaygroundDeprecatedApi->put_api_projects_projectid_playground_playgrounditemid:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PlaygroundDeprecatedApi->put_api_projects_projectid_playground_playgrounditemid: %s\n" % e)
```
