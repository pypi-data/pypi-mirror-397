...
class TestCreateMarkdownProjectRequest(unittest.TestCase):
    """CreateMarkdownProjectRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateMarkdownProjectRequest:
        """
        Test CreateMarkdownProjectRequest
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included
        """
        # uncomment below to create an instance of `CreateMarkdownProjectRequest`
        """
        model = CreateMarkdownProjectRequest()
        if include_optional:
    ...
    def testCreateMarkdownProjectRequest(self):
        """Test CreateMarkdownProjectRequest"""
