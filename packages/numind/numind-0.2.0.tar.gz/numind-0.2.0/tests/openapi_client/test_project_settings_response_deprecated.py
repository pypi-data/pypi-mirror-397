...
class TestProjectSettingsResponseDeprecated(unittest.TestCase):
    """ProjectSettingsResponseDeprecated unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectSettingsResponseDeprecated:
        """
        Test ProjectSettingsResponseDeprecated
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included
        """
        # uncomment below to create an instance of `ProjectSettingsResponseDeprecated`
        """
        model = ProjectSettingsResponseDeprecated()
        if include_optional:
            return ProjectSettingsResponseDeprecated(
                temperature = 0.0,
    ...
    def testProjectSettingsResponseDeprecated(self):
        """Test ProjectSettingsResponseDeprecated"""
