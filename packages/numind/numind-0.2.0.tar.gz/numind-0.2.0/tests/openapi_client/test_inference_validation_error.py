...
class TestInferenceValidationError(unittest.TestCase):
    """InferenceValidationError unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InferenceValidationError:
        """
        Test InferenceValidationError
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included
        """
        # uncomment below to create an instance of `InferenceValidationError`
        """
        model = InferenceValidationError()
        if include_optional:
    ...
    def testInferenceValidationError(self):
        """Test InferenceValidationError"""
