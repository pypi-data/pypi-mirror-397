...
from numind.openapi_client.api.content_extraction_api import ContentExtractionApi
...
class TestContentExtractionApi(unittest.TestCase):
    ...
    def test_get_api_content_extraction_jobs_contentextractionjobid(self) -> None:
        """Test case for get_api_content_extraction_jobs_contentextractionjobid"""

    def test_post_api_content_extraction_jobs(self) -> None:
