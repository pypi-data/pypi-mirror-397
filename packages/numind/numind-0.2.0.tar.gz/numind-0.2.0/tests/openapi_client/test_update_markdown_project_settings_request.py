...
class TestUpdateMarkdownProjectSettingsRequest(unittest.TestCase):
    """UpdateMarkdownProjectSettingsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateMarkdownProjectSettingsRequest:
        """
        Test UpdateMarkdownProjectSettingsRequest
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included
        """
        # uncomment below to create an instance of `UpdateMarkdownProjectSettingsRequest`
        """
        model = UpdateMarkdownProjectSettingsRequest()
        if include_optional:
    ...
    def testUpdateMarkdownProjectSettingsRequest(self):
        """Test UpdateMarkdownProjectSettingsRequest"""
