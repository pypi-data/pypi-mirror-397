...
class TestCreateOrUpdateMarkdownPlaygroundItemRequest(unittest.TestCase):
    """CreateOrUpdateMarkdownPlaygroundItemRequest unit test stubs"""
    ...
    def make_instance(
        ...
        """
        Test CreateOrUpdateMarkdownPlaygroundItemRequest
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included
        """
        # uncomment below to create an instance of `CreateOrUpdateMarkdownPlaygroundItemRequest`
        """
        model = CreateOrUpdateMarkdownPlaygroundItemRequest()
        if include_optional:
            return CreateOrUpdateMarkdownPlaygroundItemRequest(
                owner_organization = '',
                document_id = '',
                result = '',
                thinking_trace = '',
    ...
    def testCreateOrUpdateMarkdownPlaygroundItemRequest(self):
        """Test CreateOrUpdateMarkdownPlaygroundItemRequest"""
