...
class TestUpdateMarkdownProjectRequest(unittest.TestCase):
    """UpdateMarkdownProjectRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateMarkdownProjectRequest:
        """
        Test UpdateMarkdownProjectRequest
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included
        """
        # uncomment below to create an instance of `UpdateMarkdownProjectRequest`
        """
        model = UpdateMarkdownProjectRequest()
        if include_optional:
            return UpdateMarkdownProjectRequest(
                name = '',
                description = ''
            )
        else:
    ...
    def testUpdateMarkdownProjectRequest(self):
        """Test UpdateMarkdownProjectRequest"""
