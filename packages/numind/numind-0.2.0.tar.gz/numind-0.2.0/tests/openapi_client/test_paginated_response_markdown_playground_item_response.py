...
class TestPaginatedResponseMarkdownPlaygroundItemResponse(unittest.TestCase):
    """PaginatedResponseMarkdownPlaygroundItemResponse unit test stubs"""
    ...
    def make_instance(
        ...
        """
        Test PaginatedResponseMarkdownPlaygroundItemResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included
        """
        # uncomment below to create an instance of `PaginatedResponseMarkdownPlaygroundItemResponse`
        """
        model = PaginatedResponseMarkdownPlaygroundItemResponse()
        if include_optional:
            return PaginatedResponseMarkdownPlaygroundItemResponse(
                total_count = 56,
                skip = 56,
                per_page = 56,
                items = [
                    numind.models.markdown_playground_item_response.MarkdownPlaygroundItemResponse(
                        id = '', 
                        project_id = '', 
                        owner_user = '', 
                        document_info = null, 
    ...
    def testPaginatedResponseMarkdownPlaygroundItemResponse(self):
        """Test PaginatedResponseMarkdownPlaygroundItemResponse"""
