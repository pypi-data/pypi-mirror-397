...
class TestExtractionResponseDeprecated(unittest.TestCase):
    """ExtractionResponseDeprecated unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExtractionResponseDeprecated:
        """
        Test ExtractionResponseDeprecated
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included
        """
        # uncomment below to create an instance of `ExtractionResponseDeprecated`
        """
        model = ExtractionResponseDeprecated()
        if include_optional:
            return ExtractionResponseDeprecated(
                result = None,
    ...
    def testExtractionResponseDeprecated(self):
        """Test ExtractionResponseDeprecated"""
