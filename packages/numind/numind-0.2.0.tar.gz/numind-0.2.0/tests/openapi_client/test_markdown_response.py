...
class TestMarkdownResponse(unittest.TestCase):
    """MarkdownResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MarkdownResponse:
        """
        ...
        """
        # uncomment below to create an instance of `MarkdownResponse`
        """
        model = MarkdownResponse()
        if include_optional:
