...
class TestPlaygroundItemResponse(unittest.TestCase):
    """PlaygroundItemResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PlaygroundItemResponse:
        """
        Test PlaygroundItemResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included
        """
        # uncomment below to create an instance of `PlaygroundItemResponse`
        """
        model = PlaygroundItemResponse()
        if include_optional:
    ...
    def testPlaygroundItemResponse(self):
        """Test PlaygroundItemResponse"""
