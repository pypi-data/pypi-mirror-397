...
class TestMarkdownProjectSettingsResponse(unittest.TestCase):
    """MarkdownProjectSettingsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MarkdownProjectSettingsResponse:
        """
        Test MarkdownProjectSettingsResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included
        """
        # uncomment below to create an instance of `MarkdownProjectSettingsResponse`
        """
        model = MarkdownProjectSettingsResponse()
        if include_optional:
    ...
    def testMarkdownProjectSettingsResponse(self):
        """Test MarkdownProjectSettingsResponse"""
