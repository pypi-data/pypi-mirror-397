...
class TestContentExtractionProjectManagementApi(unittest.TestCase):
    """ContentExtractionProjectManagementApi unit test stubs"""

    def setUp(self) -> None:
        self.api = ContentExtractionProjectManagementApi()
