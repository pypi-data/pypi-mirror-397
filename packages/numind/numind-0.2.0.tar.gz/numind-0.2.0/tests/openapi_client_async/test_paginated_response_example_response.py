...
class TestPaginatedResponseExampleResponse(unittest.TestCase):
    """PaginatedResponseExampleResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedResponseExampleResponse:
        """
        Test PaginatedResponseExampleResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included
        """
        # uncomment below to create an instance of `PaginatedResponseExampleResponse`
        """
        model = PaginatedResponseExampleResponse()
        if include_optional:
            return PaginatedResponseExampleResponse(
                total_count = 56,
                skip = 56,
                per_page = 56,
                items = [
                    numind.models.example_response.ExampleResponse(
                        id = '', 
                        project_id = '', 
                        owner_user = '', 
                        document_info = null, 
    ...
    def testPaginatedResponseExampleResponse(self):
        """Test PaginatedResponseExampleResponse"""
