...
class TestCreateOrUpdatePlaygroundItemRequest(unittest.TestCase):
    """CreateOrUpdatePlaygroundItemRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateOrUpdatePlaygroundItemRequest:
        """
        Test CreateOrUpdatePlaygroundItemRequest
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included
        """
        # uncomment below to create an instance of `CreateOrUpdatePlaygroundItemRequest`
        """
        model = CreateOrUpdatePlaygroundItemRequest()
        if include_optional:
    ...
    def testCreateOrUpdatePlaygroundItemRequest(self):
        """Test CreateOrUpdatePlaygroundItemRequest"""
