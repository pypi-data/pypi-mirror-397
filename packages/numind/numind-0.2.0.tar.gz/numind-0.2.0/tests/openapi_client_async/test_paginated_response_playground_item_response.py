...
class TestPaginatedResponsePlaygroundItemResponse(unittest.TestCase):
    """PaginatedResponsePlaygroundItemResponse unit test stubs"""
    ...
    def make_instance(
        ...
        """
        Test PaginatedResponsePlaygroundItemResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included
        """
        # uncomment below to create an instance of `PaginatedResponsePlaygroundItemResponse`
        """
        model = PaginatedResponsePlaygroundItemResponse()
        if include_optional:
            return PaginatedResponsePlaygroundItemResponse(
                total_count = 56,
                skip = 56,
                per_page = 56,
                items = [
                    numind.models.playground_item_response.PlaygroundItemResponse(
                        id = '', 
                        project_id = '', 
                        owner_user = '', 
                        document_info = null, 
    ...
    def testPaginatedResponsePlaygroundItemResponse(self):
        """Test PaginatedResponsePlaygroundItemResponse"""
