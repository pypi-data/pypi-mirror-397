...
class TestMarkdownProjectResponse(unittest.TestCase):
    """MarkdownProjectResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MarkdownProjectResponse:
        """
        Test MarkdownProjectResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included
        """
        # uncomment below to create an instance of `MarkdownProjectResponse`
        """
        model = MarkdownProjectResponse()
        if include_optional:
            return MarkdownProjectResponse(
                id = '',
                name = '',
                description = '',
                owner_user = '',
    ...
    def testMarkdownProjectResponse(self):
        """Test MarkdownProjectResponse"""
