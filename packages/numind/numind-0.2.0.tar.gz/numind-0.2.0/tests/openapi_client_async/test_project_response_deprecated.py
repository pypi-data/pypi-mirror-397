...
class TestProjectResponseDeprecated(unittest.TestCase):
    """ProjectResponseDeprecated unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectResponseDeprecated:
        """
        Test ProjectResponseDeprecated
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included
        """
        # uncomment below to create an instance of `ProjectResponseDeprecated`
        """
        model = ProjectResponseDeprecated()
        if include_optional:
            return ProjectResponseDeprecated(
                id = '',
                name = '',
                description = '',
                ...
                lock_state = True,
                shared = True,
                settings = numind.models.project_settings_response_deprecated.ProjectSettingsResponseDeprecated(
                    temperature = 0.0, 
    ...
    def testProjectResponseDeprecated(self):
        """Test ProjectResponseDeprecated"""
