...
from numind.openapi_client_async.api.content_extraction_api import ContentExtractionApi


class TestContentExtractionApi(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_get_api_content_extraction_jobs_contentextractionjobid(self) -> None:
        """Test case for get_api_content_extraction_jobs_contentextractionjobid"""

    async def test_post_api_content_extraction_jobs(self) -> None:
        """Test case for post_api_content_extraction_jobs"""
