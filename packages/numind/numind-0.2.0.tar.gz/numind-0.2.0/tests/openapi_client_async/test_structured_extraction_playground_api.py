...
class TestStructuredExtractionPlaygroundApi(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_delete_api_structured_extraction_structuredextractionprojectid_playground_structuredextractionplaygrounditemid(
        self,
    ) -> None:
    ...
    async def test_get_api_structured_extraction_structuredextractionprojectid_playground(
        self,
    ) -> None:
        """Test case for get_api_structured_extraction_structuredextractionprojectid_playground"""

    async def test_get_api_structured_extraction_structuredextractionprojectid_playground_structuredextractionplaygrounditemid(
        self,
    ) -> None:
    ...
    async def test_post_api_structured_extraction_structuredextractionprojectid_playground(
        self,
    ) -> None:
        """Test case for post_api_structured_extraction_structuredextractionprojectid_playground"""

    async def test_put_api_structured_extraction_structuredextractionprojectid_playground_structuredextractionplaygrounditemid(
        self,
    ) -> None:
