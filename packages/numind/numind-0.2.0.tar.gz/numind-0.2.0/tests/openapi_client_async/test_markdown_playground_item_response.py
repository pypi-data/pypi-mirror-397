...
class TestMarkdownPlaygroundItemResponse(unittest.TestCase):
    """MarkdownPlaygroundItemResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MarkdownPlaygroundItemResponse:
        """
        Test MarkdownPlaygroundItemResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included
        """
        # uncomment below to create an instance of `MarkdownPlaygroundItemResponse`
        """
        model = MarkdownPlaygroundItemResponse()
        if include_optional:
            return MarkdownPlaygroundItemResponse(
                id = '',
                project_id = '',
                owner_user = '',
                document_info = None,
    ...
    def testMarkdownPlaygroundItemResponse(self):
        """Test MarkdownPlaygroundItemResponse"""
