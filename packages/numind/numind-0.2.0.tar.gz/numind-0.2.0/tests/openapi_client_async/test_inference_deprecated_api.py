...
class TestInferenceDeprecatedApi(unittest.IsolatedAsyncioTestCase):
    """InferenceDeprecatedApi unit test stubs"""

    async def asyncSetUp(self) -> None:
        self.api = InferenceDeprecatedApi()
    ...
    async def test_post_api_infer_template_async_document_documentid(self) -> None:
