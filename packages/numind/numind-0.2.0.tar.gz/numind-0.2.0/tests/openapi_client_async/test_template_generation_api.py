...
class TestTemplateGenerationApi(unittest.IsolatedAsyncioTestCase):
    """TemplateGenerationApi unit test stubs"""

    async def asyncSetUp(self) -> None:
        self.api = TemplateGenerationApi()

    async def asyncTearDown(self) -> None:
        await self.api.api_client.close()

    async def test_get_api_template_generation_jobs_templatejobid(self) -> None:
        """Test case for get_api_template_generation_jobs_templatejobid"""
