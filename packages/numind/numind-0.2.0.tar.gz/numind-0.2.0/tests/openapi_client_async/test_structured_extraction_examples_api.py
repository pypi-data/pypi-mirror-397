...
class TestStructuredExtractionExamplesApi(unittest.IsolatedAsyncioTestCase):
    """StructuredExtractionExamplesApi unit test stubs"""

    async def asyncSetUp(self) -> None:
        self.api = StructuredExtractionExamplesApi()

    async def asyncTearDown(self) -> None:
        await self.api.api_client.close()

    async def test_delete_api_structured_extraction_structuredextractionprojectid_examples_structuredextractionexampleid(
        self,
    ) -> None:
        """Test case for delete_api_structured_extraction_structuredextractionprojectid_examples_structuredextractionexampleid"""

    async def test_get_api_structured_extraction_structuredextractionprojectid_examples(
        self,
    ) -> None:
        """Test case for get_api_structured_extraction_structuredextractionprojectid_examples"""

    async def test_get_api_structured_extraction_structuredextractionprojectid_examples_structuredextractionexampleid(
        self,
    ) -> None:
        """Test case for get_api_structured_extraction_structuredextractionprojectid_examples_structuredextractionexampleid"""

    async def test_post_api_structured_extraction_structuredextractionprojectid_examples(
        self,
    ) -> None:
        """Test case for post_api_structured_extraction_structuredextractionprojectid_examples"""

    async def test_put_api_structured_extraction_structuredextractionprojectid_examples_structuredextractionexampleid(
        self,
    ) -> None:
