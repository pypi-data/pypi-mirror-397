...
class TestStructuredDataExtractionApi(unittest.IsolatedAsyncioTestCase):
    """StructuredDataExtractionApi unit test stubs"""

    async def asyncSetUp(self) -> None:
        self.api = StructuredDataExtractionApi()

    async def asyncTearDown(self) -> None:
        await self.api.api_client.close()

    async def test_get_api_structured_extraction_jobs_structuredextractionjobid(
        self,
    ) -> None:
    ...
    async def test_post_api_structured_extraction_structuredextractionprojectid_jobs(
        self,
    ) -> None:
