...
class AsyncConnection:
    ...
    async def fetch(self, query: str, *args: Any, timeout: Optional[float] = None) -> list[tuple[Any, ...]]:
        """Fetch all rows."""
        try:
    ...
    async def fetchrow(self, query: str, *args: Any, timeout: Optional[float] = None) -> Optional[tuple[Any, ...]]:
        """Fetch one row."""
        try:
...
class AsyncCursor:
    ...
    async def execute(self, query: str, parameters: Optional[Sequence[Any]] = None) -> "AsyncCursor":
        """
        Execute a query.
        ...
        try:
            ...
            if records:
                self._description = [
                    (key, 0, None, None, None, None, None)
