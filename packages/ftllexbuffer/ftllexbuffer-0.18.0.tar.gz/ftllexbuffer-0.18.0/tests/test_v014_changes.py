...
class TestASTVisitorSlots:
    ...
    def test_ast_visitor_has_slots(self) -> None:
        ...
        assert "_dispatch_cache" in ASTVisitor.__slots__
    ...
    def test_ast_visitor_dispatch_cache_exists(self) -> None:
        """ASTVisitor has _dispatch_cache attribute."""
        visitor = ASTVisitor()

        assert hasattr(visitor, "_dispatch_cache")
        assert isinstance(visitor._dispatch_cache, dict)
