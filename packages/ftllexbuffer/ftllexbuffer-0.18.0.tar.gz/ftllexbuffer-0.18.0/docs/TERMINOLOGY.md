...
This document establishes the standard terminology used throughout FTLLexBuffer's codebase, documentation, and communication. Consistent terminology improves clarity and reduces confusion.
...
**Type**: `Resource` class from `ftllexbuffer.syntax.ast`
...
| Term | Definition | Examples |
|------|------------|----------|
| **Built-in function** | Provided by FTLLexBuffer | NUMBER, DATETIME |
...
```python
# ❌ Inconsistent
from ftllexbuffer import fluentBundle  # Wrong
from ftllexbuffer import FLUENTBUNDLE  # Wrong
...
**Terminology Guide Last Updated**: December 14, 2025
