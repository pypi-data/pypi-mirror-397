...
# Separator between date and time components in combined patterns.
# Note: CLDR provides locale-specific dateTimeFormat patterns that may use
# different separators (comma, 'at', etc.). Current implementation uses space
# which works for >99% of locales. Full CLDR dateTimeFormat integration would
