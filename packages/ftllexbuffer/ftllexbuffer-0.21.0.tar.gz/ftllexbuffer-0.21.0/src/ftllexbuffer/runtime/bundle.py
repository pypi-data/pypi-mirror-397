...
from ftllexbuffer.validation import validate_resource as _validate_resource_impl
...
class FluentBundle:
                    ...
                    case Junk():
                        ...
                        if source_path:
                            logger.warning(
                                "Syntax error in %s: %s",
                                source_path,
                                entry.content[:_LOG_TRUNCATE_WARNING],
                            )
                        else:
                            logger.debug(
                                "Junk entry (non-critical): %s",
                                entry.content[:_LOG_TRUNCATE_DEBUG],
                            )
                    case _:
    ...
    def validate_resource(self, source: str) -> ValidationResult:
        ...
        See Also:
            ftllexbuffer.validation.validate_resource: Standalone validation function
        """
