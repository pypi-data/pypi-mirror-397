...
New in FTLLexBuffer 0.4.0: Function introspection API for discovering and
...
if __name__ == "__main__":
    print("\n")
    print("#" * 70)
    print("# FTLLexBuffer Function Introspection API Examples")
    print("# New in v0.4.0")
    print("#" * 70)
    ...
    print("\nAPI Reference: https://github.com/resoltico/ftllexbuffer")
    print("=" * 70)
    print()
