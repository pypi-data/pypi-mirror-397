...
### Analysis (`from ftllexbuffer.analysis import ...`)
```python
from ftllexbuffer.analysis import detect_cycles
from ftllexbuffer.analysis.graph import build_dependency_graph
```

### Validation (`from ftllexbuffer.validation import ...`)
```python
from ftllexbuffer.validation import validate_resource
```
...
ftllexbuffer/
  ...
  runtime/
    ...
    resolver.py            # FluentResolver, MAX_RESOLUTION_DEPTH
    functions.py           # Built-in functions, FunctionRegistry, create_default_registry
  parsing/
