...
from ftllexbuffer.runtime import FluentBundle, FluentResolver, create_default_registry
...
""")
    ...
    def test_circular_reference_direct_check(self) -> None:
        """Resolver's circular reference detection in _resolution_stack."""
        ...
        # Manually add to resolution stack to simulate circular reference
        ...
        try:
            # Now attempting to resolve "test" again should detect circular reference
            ...
            # Clean up thread-local stack to avoid polluting other tests
            stack.clear()
