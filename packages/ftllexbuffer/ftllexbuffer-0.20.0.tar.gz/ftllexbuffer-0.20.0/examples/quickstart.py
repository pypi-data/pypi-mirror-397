"""Quickstart example for ftllexbuffer.

This example demonstrates basic usage of ftllexbuffer for localization.
...
bundle.add_resource("""
hello = Hello, World!
welcome = Welcome to ftllexbuffer!
""")
...
print(result)
# Output: Welcome to ftllexbuffer!
...
print(result)
# Output: FTLLexBuffer Demo - Best-in-class FTL localization for Python
...
print("\n" + "=" * 50)
print("Example 9: Factory Methods (v0.13.0+)")
print("=" * 50)

# create() validates locale early and returns a bundle
# Useful when you want validation before adding resources
factory_bundle = FluentBundle.create("en", use_isolating=False)
factory_bundle.add_resource("""
app-title = My Application
app-version = Version { $version }
""")

result, _ = factory_bundle.format_pattern("app-title")
print(result)
# Output: My Application

result, _ = factory_bundle.format_pattern("app-version", {"version": "0.13.0"})
print(result)
...
with FluentBundle.create("en", use_isolating=False) as ctx_bundle:
