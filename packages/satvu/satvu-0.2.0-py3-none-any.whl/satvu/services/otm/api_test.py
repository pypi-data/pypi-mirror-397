...
Generated from OpenAPI spec version 2.320.3.
...
class TestOtmService:
    ...
    def setup(self, backend):
        ...
        # Construct base URL for the otm service
    ...
    def test_get_tasking_orders_200(
        self,
        backend,
        response_data,
    ):
        ...
        result = self.sdk.otm.get_tasking_orders(
    ...
    def test_get_tasking_orders_422_error(
        self,
        backend,
        response_data,
    ):
        ...
        with pytest.raises(ClientError) as exc_info:
            self.sdk.otm.get_tasking_orders(
                contract_id=contract_id,
            )
    ...
    def test_post_tasking_orders_201(
        self,
        backend,
        response_data,
        body_data,
        ...
        result = self.sdk.otm.post_tasking_orders(
            contract_id=contract_id,
            body=body,
        )
    ...
    def test_post_tasking_orders_400_error(
        self,
        backend,
        response_data,
        body_data,
        ...
        with pytest.raises(ClientError) as exc_info:
            self.sdk.otm.post_tasking_orders(
                contract_id=contract_id,
                body=body,
            )
    ...
    def test_post_tasking_orders_402_error(
        self,
        backend,
        response_data,
        body_data,
        ...
        # HTTP 402 should raise ClientError
        with pytest.raises(ClientError) as exc_info:
            self.sdk.otm.post_tasking_orders(
                contract_id=contract_id,
                body=body,
    ...
    def test_post_tasking_orders_403_error(
        self,
        backend,
        response_data,
        body_data,
    ...
    def test_post_tasking_orders_422_error(
        self,
        backend,
        response_data,
        body_data,
    ...
    def test_post_tasking_orders_500_error(
        self,
        backend,
        response_data,
        body_data,
    ...
    def test_get_tasking_order_200(
        self,
        backend,
        response_data,
    ):
    ...
    def test_get_tasking_order_404_error(
        self,
        backend,
        response_data,
    ):
        ...
        with pytest.raises(ClientError) as exc_info:
            self.sdk.otm.get_tasking_order(
                contract_id=contract_id,
                order_id=order_id,
            )
    ...
    def test_get_tasking_order_422_error(
        self,
        backend,
        response_data,
    ):
    ...
    def test_edit_tasking_order_200(
        self,
        backend,
        response_data,
        body_data,
    ...
    def test_edit_tasking_order_404_error(
        self,
        backend,
        response_data,
        body_data,
    ...
    def test_edit_tasking_order_422_error(
        self,
        backend,
        response_data,
        body_data,
    ...
    def test_cancel_tasking_order_404_error(
        self,
        backend,
        response_data,
    ):
    ...
    def test_cancel_tasking_order_409_error(
        self,
        backend,
        response_data,
    ):
    ...
    def test_cancel_tasking_order_422_error(
        self,
        backend,
        response_data,
    ):
    ...
    def test_cancel_tasking_order_500_error(
        self,
        backend,
        response_data,
    ):
    ...
    @pook.on
    def test_cancel_tasking_order_204_no_content(
        self,
        backend,
    ):
        """
    ...
    def test_download_tasking_order_200(
        self,
        backend,
        response_data,
    ):
    ...
    def test_download_tasking_order_422_error(
        self,
        backend,
        response_data,
    ):
    ...
    def test_get_order_task_details_200(
        self,
        backend,
        response_data,
    ):
    ...
    def test_get_order_task_details_422_error(
        self,
        backend,
        response_data,
    ):
    ...
    def test_get_tasking_feasibility_requests_200(
        self,
        backend,
        response_data,
    ):
        ...
        result = self.sdk.otm.get_tasking_feasibility_requests(
            contract_id=contract_id,
        )
    ...
    def test_get_tasking_feasibility_requests_422_error(
        self,
        backend,
        response_data,
    ):
        ...
        # HTTP 422 should raise ClientError
        with pytest.raises(ClientError) as exc_info:
            self.sdk.otm.get_tasking_feasibility_requests(
                contract_id=contract_id,
            )
    ...
    def test_post_tasking_feasibility_202(
        self,
        backend,
        response_data,
        body_data,
    ...
    def test_post_tasking_feasibility_403_error(
        ...
        # HTTP 403 should raise ClientError
        with pytest.raises(ClientError) as exc_info:
            self.sdk.otm.post_tasking_feasibility(
                contract_id=contract_id,
                body=body,
            )
    ...
    def test_get_tasking_feasibility_request_200(
        self,
        backend,
        response_data,
    ):
    ...
    def test_get_tasking_feasibility_request_404_error(
        self,
        backend,
        response_data,
    ):
        ...
        # HTTP 404 should raise ClientError
        with pytest.raises(ClientError) as exc_info:
            self.sdk.otm.get_tasking_feasibility_request(
                contract_id=contract_id,
                id=id,
            )
    ...
    def test_get_tasking_feasibility_request_422_error(
        self,
        backend,
        response_data,
    ):
    ...
    def test_get_tasking_feasibility_response_200(
        self,
        backend,
        response_data,
    ):
    ...
    def test_get_tasking_feasibility_response_404_error(
        self,
        backend,
        response_data,
    ):
    ...
    def test_get_tasking_feasibility_response_422_error(
        self,
        backend,
        response_data,
    ):
    ...
    def test_get_unplanned_outages_200(
        self,
        backend,
        response_data,
    ):
        ...
        result = self.sdk.otm.get_unplanned_outages(
            contract_id=contract_id,
        )
    ...
    def test_get_unplanned_outages_422_error(
        self,
        backend,
        response_data,
    ):
        ...
        # HTTP 422 should raise ClientError
        with pytest.raises(ClientError) as exc_info:
            self.sdk.otm.get_unplanned_outages(
                contract_id=contract_id,
            )
