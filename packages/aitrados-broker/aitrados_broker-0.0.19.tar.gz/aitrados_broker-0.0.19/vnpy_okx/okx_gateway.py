...
class RestApi(RestClient):
    ...
    def get_full_symbol(self,data:dict,contract: ContractData):
        if data["instFamily"]:
        ...
        return FullSymbolGenerator.crypto(symbol,contract)
    ...
    def on_query_contract(self, packet: dict, request: Request) -> None:
        ...
        for d in data:
            ...
            self.get_full_symbol(d,contract)
