...
async def main():
    ...
    model = os.getenv("LLM_MODEL", "ollama::gemma3:latest")
    ...
    for pref in preferences:
        ...
        response = await agent.send_message(f"Please remember this: {pref}")
    ...
    # Skip cleanup by default in automated tests (check if running interactively)
    import sys
    ...
    if sys.stdin.isatty():
        ...
        print("\nℹ️  Non-interactive mode: Memory preserved for next run")
