...
async def main():
    ...
    response = await agent.send_message("What's the weather in London?")
    print(f"Agent: {response}")

    print("\nUser: How about Paris?")
    response = await agent.send_message("How about Paris?")
    print(f"Agent: {response}")

    print("\nUser: What environment are you running in?")
    response = await agent.send_message("What environment are you running in?")
    print(f"Agent: {response}")
