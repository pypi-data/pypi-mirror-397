...
async def main():
    ...
    print("=" * 60)
    print("Using agent.send_message() directly\n")
    ...
    response = await weather_agent.send_message("What's the weather in London?")
    ...
    response = await weather_agent.send_message("How about Paris?")
    print(f"Agent: {response}\n")
    ...
    response = await weather_agent.send_message(
    ...
    print("  ✓ Direct messaging - agent.send_message()")
