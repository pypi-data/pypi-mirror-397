...
class BaseLanguageModel(nn.Module, ABC):
    ...
    def _init_weights(self, module: nn.Module) -> None:
        ...
        This uses a normal distribution with std=0.02 for linear/embedding layers
        and zeros for biases, which has been proven effective for transformer models
        and helps prevent exploding/vanishing gradients.
        
        Args:
            module: The module to initialize.
        """
        if isinstance(module, nn.Linear):
            # GPT-2 style: normal distribution with std=0.02
    ...
    def init_weights(self) -> None:
        ...
        Call this at the end of your model's __init__ to apply
        proper initialization for stable training.
        
        Example:
            >>> class MyGPT(BaseLanguageModel):
            ...     def __init__(self, ...):
            ...         super().__init__()
            ...         # ... define layers ...
            ...         self.init_weights()  # Call at the end
        """
