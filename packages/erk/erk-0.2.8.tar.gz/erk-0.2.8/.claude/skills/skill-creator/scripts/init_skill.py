...
This skill includes example resource directories that demonstrate how to organize
...
- PDF skill: `fill_fillable_fields.py`, `extract_form_field_info.py` - utilities for
  PDF manipulation
...
Claude for patching or environment adjustments.
...
guides, or any detailed information that Claude should reference while working.
