...
class PX4(Drone):
    def __init__(self, name, uri="tcp:localhost:5760", odometry_source="mocap", SETPOINT_INTERVAL=0.01, **kwargs):
        super().__init__(name, **kwargs)
        self.odometry_source = odometry_source

        self.safety_distance = 0.15

        self.connection = mavutil.mavlink_connection(uri, source_component=13)
