...
class Simulator:
    ...
    def register_client(self, client, initial_position=None, parameter_path=None):
        ...
        client._odometry_callback(time.time(), self.state.states[drone_id].position, self.state.states[drone_id].orientation, self.state.states[drone_id].linear_velocity, {})
        ...
        async with websockets.connect(uri) as websocket:
            ...
            while True:
                ...
                for i, client in enumerate(self.clients):
                    client._mocap_callback(time.time(), self.state.states[i].position, self.state.states[i].orientation, self.state.states[i].linear_velocity, {})
...
class SimulatedDrone(Drone):
    def __init__(self, simulator, initial_position=None, parameter_path=None, **kwargs):
        ...
        self.id = simulator.register_client(self, initial_position=initial_position, parameter_path=parameter_path)
