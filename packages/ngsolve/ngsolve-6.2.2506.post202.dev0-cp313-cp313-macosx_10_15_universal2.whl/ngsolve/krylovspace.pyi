...
class LinearSolver(ngsolve.la.BaseMatrix):
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('ax', 'plt', 'fig', 'mat', 'ress', 'callback', 'display', 'sol', '_final_residual', 'tol', 'maxiter', 'iterations', 'callback_sol', 'residuals', 'atol', 'pre', 'plotrates', 'printrates', 'clear_output', 'its')
