...
self.mantarix_js = {}; // namespace for Python global functions

self.initPyodide = async function () {
    self.pyodide = await loadPyodide();
    self.pyodide.registerJsModule("mantarix_js", mantarix_js);
    mantarix_js.documentUrl = documentUrl;
  ...
  `);
    ...
    await self.mantarix_js.start_connection(self.receiveCallback);
