...
from mantarix.utils import is_pyodide
...
class MantarixAppManager:
    ...
    def __init__(self):
        ...
        self.__temp_dirs = {}
        self.__executor = ThreadPoolExecutor(thread_name_prefix="mantarix_fastapi")
    ...
    async def start(self):
        ...
        if not self.__evict_sessions_task:
            logger.info("Starting up Mantarix App Manager")
    ...
    async def shutdown(self):
        """
        Cleanup temporary Mantarix resources on application shutdown.
        """
        logger.info("Shutting down Mantarix App Manager")
...
app_manager = MantarixAppManager()
