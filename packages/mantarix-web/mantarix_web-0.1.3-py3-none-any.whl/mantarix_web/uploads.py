...
logger = logging.getLogger(mantarix_web.__name__)
...
def get_upload_signature(
    ...
    env_secret_key = os.getenv("MANTARIX_SECRET_KEY")
    if env_secret_key:
        secret_key = env_secret_key
    if not secret_key:
        raise Exception(
            "Specify secret_key parameter or set MANTARIX_SECRET_KEY environment variable to enable uploads."
        )
