...
print(f"  As timestamp: {datetime.datetime.fromtimestamp(value_big_endian / 1_000_000, tz=datetime.timezone.utc)}")
...
print(f"When PyArrow writes to Parquet, it uses native byte order")
