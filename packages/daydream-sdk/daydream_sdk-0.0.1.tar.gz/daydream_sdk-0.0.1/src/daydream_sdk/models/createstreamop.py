...
PipelineIDTypedDict = PipelineIDEnum
r"""ID of the processing pipeline to use for this stream"""


PipelineID = PipelineIDEnum
r"""ID of the processing pipeline to use for this stream"""


CreateStreamModelID = Literal[
...
CreateStreamPrompt2TypedDict = TypeAliasType(
    "CreateStreamPrompt2TypedDict", Union[str, float]
)


CreateStreamPrompt2 = TypeAliasType("CreateStreamPrompt2", Union[str, float])


CreateStreamPrompt1TypedDict = TypeAliasType(
    "CreateStreamPrompt1TypedDict", Union[str, List[List[CreateStreamPrompt2TypedDict]]]
)
r"""Text prompt describing the desired image. Can be a single string or weighted list of (prompt, weight) tuples."""


CreateStreamPrompt1 = TypeAliasType(
    "CreateStreamPrompt1", Union[str, List[List[CreateStreamPrompt2]]]
)
r"""Text prompt describing the desired image. Can be a single string or weighted list of (prompt, weight) tuples."""


CreateStreamPromptInterpolationMethod = Literal[
    "linear",
    "slerp",
]
...
class CreateStreamLoraDictTypedDict(TypedDict):
    r"""Dictionary mapping LoRA model paths to their weights for fine-tuning the base model."""


class CreateStreamLoraDict(BaseModel):
    r"""Dictionary mapping LoRA model paths to their weights for fine-tuning the base model."""


CreateStreamSeed2TypedDict = TypeAliasType(
    "CreateStreamSeed2TypedDict", Union[int, float]
)


CreateStreamSeed2 = TypeAliasType("CreateStreamSeed2", Union[int, float])


CreateStreamSeed1TypedDict = TypeAliasType(
    "CreateStreamSeed1TypedDict", Union[int, List[List[CreateStreamSeed2TypedDict]]]
)
r"""Random seed for generation. Can be a single integer or weighted list of (seed, weight) tuples."""


CreateStreamSeed1 = TypeAliasType(
    "CreateStreamSeed1", Union[int, List[List[CreateStreamSeed2]]]
)
r"""Random seed for generation. Can be a single integer or weighted list of (seed, weight) tuples."""


CreateStreamSeedInterpolationMethod = Literal[
    "linear",
    "slerp",
]
...
CreateStreamControlnetModelID = Literal[
...
class CreateStreamControlnetTypedDict(TypedDict):
    model_id: CreateStreamControlnetModelID
    r"""⚠️ NOTE: ControlNet model_ids must be unique. Additionally, they must be compatible with the selected base model."""
...
class CreateStreamControlnet(BaseModel):
    model_id: CreateStreamControlnetModelID
    r"""⚠️ NOTE: ControlNet model_ids must be unique. Additionally, they must be compatible with the selected base model."""
...
CreateStreamWeightType = Literal[
    "linear",
    "ease in",
    "ease out",
    "ease in-out",
...
class CreateStreamIPAdapterTypedDict(TypedDict):
    r"""IP adapter — Turns on IP-Adapter style conditioning and is fully hot-swappable. Available for SDXL, SDXL-faceid, SD1.5"""

    scale: float
    enabled: bool
    type: NotRequired[CreateStreamType]
    r"""Type of IP adapter. Use 'faceid' for SDXL-faceid models, 'regular' for others"""
    weight_type: NotRequired[CreateStreamWeightType]
    r"""Weight interpolation method for IP adapter style conditioning. Controls how the style influence changes throughout the generation process."""


class CreateStreamIPAdapter(BaseModel):
    r"""IP adapter — Turns on IP-Adapter style conditioning and is fully hot-swappable. Available for SDXL, SDXL-faceid, SD1.5"""
    ...
    type: Optional[CreateStreamType] = None
    r"""Type of IP adapter. Use 'faceid' for SDXL-faceid models, 'regular' for others"""

    weight_type: Optional[CreateStreamWeightType] = None
    r"""Weight interpolation method for IP adapter style conditioning. Controls how the style influence changes throughout the generation process."""


class PipelineParamsTypedDict(TypedDict):
    r"""Configuration parameters for the selected pipeline"""

    model_id: NotRequired[CreateStreamModelID]
    r"""Base U-Net model to use for generation. Default: \"stabilityai/sd-turbo\" """
    prompt: NotRequired[CreateStreamPrompt1TypedDict]
    r"""Text prompt describing the desired image. Can be a single string or weighted list of (prompt, weight) tuples."""
    prompt_interpolation_method: NotRequired[CreateStreamPromptInterpolationMethod]
    r"""Method for interpolating between multiple prompts. Slerp provides smoother transitions than linear."""
    ...
    lora_dict: NotRequired[Nullable[CreateStreamLoraDictTypedDict]]
    r"""Dictionary mapping LoRA model paths to their weights for fine-tuning the base model."""
    ...
    seed: NotRequired[CreateStreamSeed1TypedDict]
    r"""Random seed for generation. Can be a single integer or weighted list of (seed, weight) tuples."""
    seed_interpolation_method: NotRequired[CreateStreamSeedInterpolationMethod]
    r"""Method for interpolating between multiple seeds. Slerp provides smoother transitions than linear."""
    ...
    controlnets: NotRequired[List[CreateStreamControlnetTypedDict]]
    ...
    ip_adapter: NotRequired[CreateStreamIPAdapterTypedDict]
    r"""IP adapter — Turns on IP-Adapter style conditioning and is fully hot-swappable. Available for SDXL, SDXL-faceid, SD1.5"""
...
class PipelineParams(BaseModel):
    ...
    model_id: Optional[CreateStreamModelID] = None
    r"""Base U-Net model to use for generation. Default: \"stabilityai/sd-turbo\" """

    prompt: Optional[CreateStreamPrompt1] = None
    r"""Text prompt describing the desired image. Can be a single string or weighted list of (prompt, weight) tuples."""

    prompt_interpolation_method: Optional[CreateStreamPromptInterpolationMethod] = None
    r"""Method for interpolating between multiple prompts. Slerp provides smoother transitions than linear."""
    ...
    lora_dict: OptionalNullable[CreateStreamLoraDict] = UNSET
    r"""Dictionary mapping LoRA model paths to their weights for fine-tuning the base model."""
    ...
    seed: Optional[CreateStreamSeed1] = None
    r"""Random seed for generation. Can be a single integer or weighted list of (seed, weight) tuples."""

    seed_interpolation_method: Optional[CreateStreamSeedInterpolationMethod] = None
    r"""Method for interpolating between multiple seeds. Slerp provides smoother transitions than linear."""
    ...
    controlnets: Optional[List[CreateStreamControlnet]] = None
    r"""List of ControlNet configurations for guided generation. Each ControlNet provides different types of conditioning (pose, edges, depth, etc.). Dynamic updates limited to conditioning_scale changes only; cannot add new ControlNets or change model_id/preprocessor/params without reload."""

    ip_adapter: Optional[CreateStreamIPAdapter] = None
    r"""IP adapter — Turns on IP-Adapter style conditioning and is fully hot-swappable. Available for SDXL, SDXL-faceid, SD1.5"""
...
class CreateStreamRequestTypedDict(TypedDict):
    pipeline_id: NotRequired[PipelineIDTypedDict]
    r"""ID of the processing pipeline to use for this stream"""
    pipeline_params: NotRequired[PipelineParamsTypedDict]
    r"""Configuration parameters for the selected pipeline"""
