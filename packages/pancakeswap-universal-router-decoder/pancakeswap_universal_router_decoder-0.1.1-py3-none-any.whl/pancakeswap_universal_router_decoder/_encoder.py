...
from pancakeswap_universal_router_decoder._abi_builder import ABIMap
from pancakeswap_universal_router_decoder._constants import (
    _router_abi,
    _ur_address,
)
from pancakeswap_universal_router_decoder._enums import (
    _RouterConstant,
    FunctionRecipient,
    MiscFunctions,
    RouterFunction,
...
from pancakeswap_universal_router_decoder.utils import (
    compute_gas_fees,
...
class _Encoder:
    ...
    def v4_pool_key(
        ...
        :param pool_manager: pool manager address, default is no pool manager, ie "0x0000000000000000000000000000000000000000"
        :param fee: pool fee in percentage * 10000 (ex: 3000 for 0.3%)
        :param parameters: encoded parameters for the pool
