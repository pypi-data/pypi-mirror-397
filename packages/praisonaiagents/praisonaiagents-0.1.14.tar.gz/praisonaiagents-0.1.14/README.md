...
|-----------|---------------|----------|
| **PraisonAI** | **3.84** | **1.00x (fastest)** |
| OpenAI Agents SDK | 5.83 | 1.52x |
| Agno | 6.18 | 1.61x |
| PraisonAI (LiteLLM) | 7.50 | 1.96x |
| PydanticAI | 227.54 | 59.31x |
| LangGraph | 4,334.06 | 1,130x |
| CrewAI | 16,050.83 | 4,184x |
