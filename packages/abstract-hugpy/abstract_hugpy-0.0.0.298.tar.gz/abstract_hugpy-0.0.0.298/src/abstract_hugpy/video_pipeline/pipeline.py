...
from abstract_utilities import get_video_id
class VideoPipeline:
    def __init__(
        self,
    ...
    def get_video_url(self):
        ...
        return record.get('video_url') or record.get("info").get('original_url')
        # === INFO / ALL ===
    def get_video_id(self):
        rawdata = self.get_rawdata()
        record = get_video_record(self.video_id, hide_audio=True) or {}
        video_url = self.get_video_url()
        return record.get('video_id') or get_video_id(video_url) or rawdata.get('video_id')
...
def get_local_db_data(
    ...
    p = VideoPipeline(video_url=url,video_id=str(video_id))
