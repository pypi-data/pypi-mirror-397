...
def get_video_record(video_id=None, video_url = None,hide_audio: bool = True,**kwargs):
    video_id = video_id or get_video_id(video_url)
    hugpyDb_mgr = getHugpyDbManager(**kwargs)
    return hugpyDb_mgr.get_video_record(video_id=video_id, hide_audio=hide_audio)
