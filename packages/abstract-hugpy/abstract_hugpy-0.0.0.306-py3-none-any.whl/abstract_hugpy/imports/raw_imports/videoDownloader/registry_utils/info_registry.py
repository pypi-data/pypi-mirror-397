...
class infoRegistry(metaclass=SingletonMeta):
    ...
    def _upsert(self, video_id,**data):
        ...
        self.db_mgr.upsert_video(video_id,**data)


    def get_video_info(self, url=None, video_id=None, video_path=None, force_refresh=False,hide_audio=True):
...
def get_video_record(url=None, video_id=None, video_path=None, force_refresh=False,hide_audio=True,video_root=None, documents_root=None, flat_layout: bool = False,**kwargs):
    info_registry = get_info_registry(video_root=video_root, documents_root=documents_root, flat_layout=flat_layout)
