...
class KeyBasedAuthCredential(object):
    ...
    def _initialize_object_type(self):
        return 'security.v4.config.KeyBasedAuthCredential'
    ...
    def credential(self):
        ...
        :type:
            :class:`~ntnx_security_py_client.models.security.v4.config.KeyBasedAuth`
        """  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(KeyBasedAuthCredential, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, KeyBasedAuthCredential):
            return False
