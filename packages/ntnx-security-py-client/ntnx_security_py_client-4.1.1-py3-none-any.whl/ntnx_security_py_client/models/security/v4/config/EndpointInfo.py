...
class EndpointInfo(object):
    ...
    :param port: (:attr:`port`) Port on which the External Key Manager server runs.
    :type port: required
    ...
    def __init__(self, ip_address=None, port=None, *args, **kwargs):  # noqa: E501
    ...
    def _initialize_object_type(self):
        return 'security.v4.config.EndpointInfo'
