...
from ntnx_security_py_client.models.security.v4.management.ApprovalPolicy import ApprovalPolicy  # noqa: F401,E501
...
class ApprovalPolicyProjection(ApprovalPolicy):
    ...
    def __init__(self, name=None, description=None, approver_groups=None, secured_policies=None, last_updated_by=None, last_update_time=None, is_update_pending=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
        ApprovalPolicy.__init__(self, name, description, approver_groups, secured_policies, last_updated_by, last_update_time, is_update_pending, ext_id, links, tenant_id, *args, **kwargs)
        self.discriminator = None

    def _initialize_object_type(self):
        return 'security.v4.management.ApprovalPolicyProjection'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ApprovalPolicyProjection, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ApprovalPolicyProjection):
            return False
