...
class IssueSummary(object):
    ...
    :param current_issue_count: (:attr:`current_issue_count`) The number of current issues of similar type.
    :type current_issue_count: 
    
    
    :param trends: (:attr:`trends`) Historical data containing how many issues were present and when
    :type trends: 
    ...
    def __init__(self, current_issue_count=None, trends=None, *args, **kwargs):  # noqa: E501
        self.__current_issue_count = None
        self.__trends = None
        self.discriminator = None
        if current_issue_count is not None:
            self.__current_issue_count = current_issue_count
    ...
    def _initialize_object_type(self):
        return 'security.v4.report.IssueSummary'
    ...
    def current_issue_count(self):
        ...
        :type:
                :class:`~int`
        """  # noqa: E501
        return self.__current_issue_count

    @current_issue_count.setter
    def current_issue_count(self, current_issue_count):
    ...
    def trends(self):
        ...
        :type:
             list[ :class:`~ntnx_security_py_client.models.security.v4.report.TrendValue` ]
        """  # noqa: E501
