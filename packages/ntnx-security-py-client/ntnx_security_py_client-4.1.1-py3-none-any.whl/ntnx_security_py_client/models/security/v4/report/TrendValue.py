...
class TrendValue(object):

    """Historical data containing how many issues were present and when

    :param count: (:attr:`count`) The number of previous issues at that date
    :type count: 
    
    
    :param timestamp: (:attr:`timestamp`) Date value for trends
    :type timestamp: 
    ...
    def __init__(self, count=None, timestamp=None, *args, **kwargs):  # noqa: E501
        self.__count = None
    ...
    def _initialize_object_type(self):
        return 'security.v4.report.TrendValue'
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TrendValue):
            return False
