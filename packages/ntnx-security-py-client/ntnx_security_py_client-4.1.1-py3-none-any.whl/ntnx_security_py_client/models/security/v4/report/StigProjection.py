...
from ntnx_security_py_client.models.security.v4.report.Stig import Stig  # noqa: F401,E501
from ntnx_security_py_client.models.security.v4.report.StigStatus import StigStatus  # noqa: F401,E501

class StigProjection(Stig):
    ...
    def __init__(self, title=None, rule_id=None, stig_version=None, identifiers=None, affected_clusters=None, severity=None, status=None, comments=None, fix_text=None, benchmark_id=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
        Stig.__init__(self, title, rule_id, stig_version, identifiers, affected_clusters, severity, status, comments, fix_text, benchmark_id, ext_id, links, tenant_id, *args, **kwargs)
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(StigProjection, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StigProjection):
            return False
