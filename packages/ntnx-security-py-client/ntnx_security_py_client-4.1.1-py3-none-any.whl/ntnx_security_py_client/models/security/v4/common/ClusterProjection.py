...
from ntnx_security_py_client.models.security.v4.common.Cluster import Cluster  # noqa: F401,E501
...
class ClusterProjection(Cluster):
    ...
    :param cluster_name: (:attr:`cluster_name`) Human readable name of the cluster.
    :type cluster_name: 
     max=199 chars
    ...
    def __init__(self, cluster_ext_id=None, cluster_name=None, *args, **kwargs):  # noqa: E501
        Cluster.__init__(self, cluster_ext_id, cluster_name, *args, **kwargs)
        self.discriminator = None

    def _initialize_object_type(self):
        return 'security.v4.common.ClusterProjection'
