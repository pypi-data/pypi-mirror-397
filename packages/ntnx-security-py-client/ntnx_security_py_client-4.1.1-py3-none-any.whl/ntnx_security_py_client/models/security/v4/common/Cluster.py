...
class Cluster(object):
    ...
    def _initialize_object_type(self):
        return 'security.v4.common.Cluster'
    ...
    def cluster_name(self, cluster_name):
        if cluster_name is not None and len(cluster_name) > 199:
            raise ValueError("Invalid value for `cluster_name`, length must be less than or equal to `199`")  # noqa: E501
