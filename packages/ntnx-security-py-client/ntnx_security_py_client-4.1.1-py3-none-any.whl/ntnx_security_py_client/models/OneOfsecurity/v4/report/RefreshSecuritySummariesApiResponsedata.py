...
class RefreshSecuritySummariesApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfsecurity.v4.report.RefreshSecuritySummariesApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in RefreshSecuritySummariesApiResponsedata.discriminator_value_class_map.values():
            return list(RefreshSecuritySummariesApiResponsedata.discriminator_value_class_map.keys())[list(RefreshSecuritySummariesApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(RefreshSecuritySummariesApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RefreshSecuritySummariesApiResponsedata):
            return False
