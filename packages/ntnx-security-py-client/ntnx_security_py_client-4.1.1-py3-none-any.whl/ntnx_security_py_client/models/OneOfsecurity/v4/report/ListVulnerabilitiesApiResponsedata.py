...
class ListVulnerabilitiesApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<security.v4.report.Vulnerability>': 'list[security.v4.report.Vulnerability]',
        'security.v4.error.ErrorResponse': 'security.v4.error.ErrorResponse',
        'List<security.v4.report.VulnerabilityProjection>': 'list[security.v4.report.VulnerabilityProjection]'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOfsecurity.v4.report.ListVulnerabilitiesApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListVulnerabilitiesApiResponsedata.discriminator_value_class_map.values():
            return list(ListVulnerabilitiesApiResponsedata.discriminator_value_class_map.keys())[list(ListVulnerabilitiesApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListVulnerabilitiesApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListVulnerabilitiesApiResponsedata):
            return False
