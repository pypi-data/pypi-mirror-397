...
class GetApprovalPolicyApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'security.v4.management.ApprovalPolicy': 'security.v4.management.ApprovalPolicy',
    ...
    def _initialize_object_type(self):
        return 'OneOfsecurity.v4.management.GetApprovalPolicyApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetApprovalPolicyApiResponsedata.discriminator_value_class_map.values():
            return list(GetApprovalPolicyApiResponsedata.discriminator_value_class_map.keys())[list(GetApprovalPolicyApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetApprovalPolicyApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetApprovalPolicyApiResponsedata):
            return False
