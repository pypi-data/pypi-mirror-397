...
class UpdateCredentialApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfsecurity.v4.config.UpdateCredentialApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in UpdateCredentialApiResponsedata.discriminator_value_class_map.values():
            return list(UpdateCredentialApiResponsedata.discriminator_value_class_map.keys())[list(UpdateCredentialApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(UpdateCredentialApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateCredentialApiResponsedata):
            return False
