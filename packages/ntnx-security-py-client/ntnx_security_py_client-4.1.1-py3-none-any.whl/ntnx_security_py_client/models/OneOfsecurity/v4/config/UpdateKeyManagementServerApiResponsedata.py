...
class UpdateKeyManagementServerApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfsecurity.v4.config.UpdateKeyManagementServerApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in UpdateKeyManagementServerApiResponsedata.discriminator_value_class_map.values():
            return list(UpdateKeyManagementServerApiResponsedata.discriminator_value_class_map.keys())[list(UpdateKeyManagementServerApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(UpdateKeyManagementServerApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateKeyManagementServerApiResponsedata):
            return False
