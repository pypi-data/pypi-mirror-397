...
class Credentialcredential_details(object):
    ...
    discriminator_value_class_map = {
        ...
        'security.v4.config.BmcCredential': 'security.v4.config.BmcCredential',
    ...
    ONE_OF_ITEM_DISCRIMINATOR_NAME = '$credentialDetailsItemDiscriminator'
    ...
    def _initialize_object_type(self):
        return 'OneOfsecurity.v4.config.Credentialcredential_details'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in Credentialcredential_details.discriminator_value_class_map.values():
            return list(Credentialcredential_details.discriminator_value_class_map.keys())[list(Credentialcredential_details.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(Credentialcredential_details, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, Credentialcredential_details):
            return False
