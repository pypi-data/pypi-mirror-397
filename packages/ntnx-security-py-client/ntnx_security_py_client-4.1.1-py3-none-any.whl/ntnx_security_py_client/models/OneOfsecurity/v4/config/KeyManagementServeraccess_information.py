...
class KeyManagementServeraccess_information(object):
    ...
    discriminator_value_class_map = {
        ...
        'security.v4.config.AzureAccessInformation': 'security.v4.config.AzureAccessInformation',
        'security.v4.config.KmipAccessInformation': 'security.v4.config.KmipAccessInformation'
    }

    ONE_OF_ITEM_DISCRIMINATOR_NAME = '$accessInformationItemDiscriminator'
    ...
    def _initialize_object_type(self):
        return 'OneOfsecurity.v4.config.KeyManagementServeraccess_information'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in KeyManagementServeraccess_information.discriminator_value_class_map.values():
            return list(KeyManagementServeraccess_information.discriminator_value_class_map.keys())[list(KeyManagementServeraccess_information.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(KeyManagementServeraccess_information, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, KeyManagementServeraccess_information):
            return False
