...
class ListCredentialsApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<security.v4.config.Credential>': 'list[security.v4.config.Credential]',
    ...
    def _initialize_object_type(self):
        return 'OneOfsecurity.v4.config.ListCredentialsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListCredentialsApiResponsedata.discriminator_value_class_map.values():
            return list(ListCredentialsApiResponsedata.discriminator_value_class_map.keys())[list(ListCredentialsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListCredentialsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListCredentialsApiResponsedata):
            return False
