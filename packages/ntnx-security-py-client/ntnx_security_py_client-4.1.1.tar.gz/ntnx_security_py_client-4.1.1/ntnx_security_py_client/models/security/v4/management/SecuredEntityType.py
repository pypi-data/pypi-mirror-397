...
class SecuredEntityType(object):
    ...
    Allowed enum values:
        ...
        - _UNKNOWN
        - _REDACTED
        - RECOVERY_POINT: Secured entity of type Recovery Point.
        - APPROVAL_POLICY: Secured entity of type Approval Policy.
    """
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    ...
    def _initialize_object_type(self):
        return 'security.v4.management.SecuredEntityType'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(SecuredEntityType, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SecuredEntityType):
            return False
