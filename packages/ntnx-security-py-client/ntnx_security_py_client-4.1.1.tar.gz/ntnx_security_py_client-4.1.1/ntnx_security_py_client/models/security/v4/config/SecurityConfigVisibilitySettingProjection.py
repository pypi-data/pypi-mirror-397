...
from ntnx_security_py_client.models.security.v4.config.SecurityConfigVisibilitySetting import SecurityConfigVisibilitySetting  # noqa: F401,E501

class SecurityConfigVisibilitySettingProjection(SecurityConfigVisibilitySetting):
    ...
    def __init__(self, is_high_strength_password_visible=None, is_aide_visible=None, is_scma_visible=None, is_secure_boot_visible=None, is_network_segmentation_visible=None, is_cluster_lockdown_visible=None, is_log_forwarding_visible=None, is_defense_consent_banner_visible=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
        SecurityConfigVisibilitySetting.__init__(self, is_high_strength_password_visible, is_aide_visible, is_scma_visible, is_secure_boot_visible, is_network_segmentation_visible, is_cluster_lockdown_visible, is_log_forwarding_visible, is_defense_consent_banner_visible, ext_id, links, tenant_id, *args, **kwargs)
        self.discriminator = None

    def _initialize_object_type(self):
        return 'security.v4.config.SecurityConfigVisibilitySettingProjection'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(SecurityConfigVisibilitySettingProjection, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SecurityConfigVisibilitySettingProjection):
            return False
