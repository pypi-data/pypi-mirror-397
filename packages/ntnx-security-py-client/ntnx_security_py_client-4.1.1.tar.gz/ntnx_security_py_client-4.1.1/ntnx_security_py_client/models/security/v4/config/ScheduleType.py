...
class ScheduleType(object):
    ...
    Allowed enum values:
        ...
        - _UNKNOWN
        - _REDACTED
        - HOURLY: Schedule per hour.
        - DAILY: Schedule per day.
        - WEEKLY: Schedule per week.
        - MONTHLY: Schedule per month.
    """
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    HOURLY = "HOURLY"
    ...
    def _initialize_object_type(self):
        return 'security.v4.config.ScheduleType'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ScheduleType, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ScheduleType):
            return False
