...
class SoftwareType(object):
    ...
    Allowed enum values:
        ...
        - _UNKNOWN
        - _REDACTED
        - PC: Software Type Prism Central
        - AOS: Software Type Prism Element
        - AHV: Software Type AHV
    """
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    PC = "PC"
    ...
    def _initialize_object_type(self):
        return 'security.v4.report.SoftwareType'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(SoftwareType, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SoftwareType):
            return False
