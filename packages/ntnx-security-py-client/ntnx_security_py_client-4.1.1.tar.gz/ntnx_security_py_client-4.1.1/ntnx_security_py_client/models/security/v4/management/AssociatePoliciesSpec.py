...
class AssociatePoliciesSpec(object):

    """Specifications required to associate secured policies with an approval policy.

    :param secured_policies: (:attr:`secured_policies`) Specification of the configured approval policy.
    :type secured_policies: required
    ...
    def __init__(self, secured_policies=None, *args, **kwargs):  # noqa: E501
    ...
    def _initialize_object_type(self):
        return 'security.v4.management.AssociatePoliciesSpec'
    ...
    def secured_policies(self, secured_policies):
        if secured_policies is None:
            raise ValueError("Invalid value for `secured_policies`, must not be `None`")  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(AssociatePoliciesSpec, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AssociatePoliciesSpec):
            return False
