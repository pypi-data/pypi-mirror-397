...
from ntnx_security_py_client.models.security.v4.management.PolicyType import PolicyType  # noqa: F401,E501

class SecuredPolicy(object):

    """Contains all the required information for secured protection policy.

    :param policy_ext_id: (:attr:`policy_ext_id`) External identifier of the policy associated with an approval policy.
    :type policy_ext_id: required
    ...
    swagger_types = {
        'policy_ext_id': 'str',
        'policy_type': 'security.v4.management.PolicyType',
    ...
    def __init__(self, policy_ext_id=None, policy_type=None, *args, **kwargs):  # noqa: E501
    ...
    def _initialize_object_type(self):
        return 'security.v4.management.SecuredPolicy'
    ...
    def policy_ext_id(self, policy_ext_id):
        if policy_ext_id is None:
            raise ValueError("Invalid value for `policy_ext_id`, must not be `None`")  # noqa: E501
    ...
    def policy_type(self):
        ...
        :type:
            :class:`~ntnx_security_py_client.models.security.v4.management.PolicyType`
        """  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(SecuredPolicy, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SecuredPolicy):
            return False
