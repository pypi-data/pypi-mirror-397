...
from ntnx_security_py_client.models.OneOfsecurity.v4.config.ListCredentialsApiResponsedata import ListCredentialsApiResponsedata  # noqa: F401,E501
from ntnx_security_py_client.models.common.v1.response.ApiResponseMetadata import ApiResponseMetadata  # noqa: F401,E501

class ListCredentialsApiResponse(object):
    ...
    swagger_types = {
        ...
        'data': 'OneOfsecurity.v4.config.ListCredentialsApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'security.v4.config.ListCredentialsApiResponse'
    ...
    def data(self):
        ...
        :type:
                :class:`~ntnx_security_py_client.models.security.v4.config.Credential` | 
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListCredentialsApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListCredentialsApiResponse):
            return False
