...
class ListStigsApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<security.v4.report.Stig>': 'list[security.v4.report.Stig]',
        'security.v4.error.ErrorResponse': 'security.v4.error.ErrorResponse',
        'List<security.v4.report.StigProjection>': 'list[security.v4.report.StigProjection]'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOfsecurity.v4.report.ListStigsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListStigsApiResponsedata.discriminator_value_class_map.values():
            return list(ListStigsApiResponsedata.discriminator_value_class_map.keys())[list(ListStigsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListStigsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListStigsApiResponsedata):
            return False
