...
class ListSecuritySummariesApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<security.v4.report.SecuritySummary>': 'list[security.v4.report.SecuritySummary]',
        'security.v4.error.ErrorResponse': 'security.v4.error.ErrorResponse',
        'List<security.v4.report.SecuritySummaryProjection>': 'list[security.v4.report.SecuritySummaryProjection]'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOfsecurity.v4.report.ListSecuritySummariesApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListSecuritySummariesApiResponsedata.discriminator_value_class_map.values():
            return list(ListSecuritySummariesApiResponsedata.discriminator_value_class_map.keys())[list(ListSecuritySummariesApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListSecuritySummariesApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListSecuritySummariesApiResponsedata):
            return False
