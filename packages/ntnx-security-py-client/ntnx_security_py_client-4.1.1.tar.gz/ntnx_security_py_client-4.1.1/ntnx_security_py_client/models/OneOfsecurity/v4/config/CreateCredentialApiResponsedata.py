...
class CreateCredentialApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfsecurity.v4.config.CreateCredentialApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in CreateCredentialApiResponsedata.discriminator_value_class_map.values():
            return list(CreateCredentialApiResponsedata.discriminator_value_class_map.keys())[list(CreateCredentialApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(CreateCredentialApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateCredentialApiResponsedata):
            return False
