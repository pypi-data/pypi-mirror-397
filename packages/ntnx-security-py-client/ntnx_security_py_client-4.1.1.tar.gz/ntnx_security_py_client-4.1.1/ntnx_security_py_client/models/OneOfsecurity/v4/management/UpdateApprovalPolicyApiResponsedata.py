...
class UpdateApprovalPolicyApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfsecurity.v4.management.UpdateApprovalPolicyApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in UpdateApprovalPolicyApiResponsedata.discriminator_value_class_map.values():
            return list(UpdateApprovalPolicyApiResponsedata.discriminator_value_class_map.keys())[list(UpdateApprovalPolicyApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(UpdateApprovalPolicyApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateApprovalPolicyApiResponsedata):
            return False
