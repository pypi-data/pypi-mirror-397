...
class GetKeyManagementServerApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'security.v4.config.KeyManagementServer': 'security.v4.config.KeyManagementServer',
    ...
    def _initialize_object_type(self):
        return 'OneOfsecurity.v4.config.GetKeyManagementServerApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetKeyManagementServerApiResponsedata.discriminator_value_class_map.values():
            return list(GetKeyManagementServerApiResponsedata.discriminator_value_class_map.keys())[list(GetKeyManagementServerApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetKeyManagementServerApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetKeyManagementServerApiResponsedata):
            return False
