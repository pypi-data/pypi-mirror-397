...
class ErrorResponseerror(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<security.v4.error.AppMessage>': 'list[security.v4.error.AppMessage]',
        'security.v4.error.SchemaValidationError': 'security.v4.error.SchemaValidationError'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOfsecurity.v4.error.ErrorResponseerror'
