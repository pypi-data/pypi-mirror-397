...
class ListApprovalPoliciesApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<security.v4.management.ApprovalPolicy>': 'list[security.v4.management.ApprovalPolicy]',
        'security.v4.error.ErrorResponse': 'security.v4.error.ErrorResponse',
        'List<security.v4.management.ApprovalPolicyProjection>': 'list[security.v4.management.ApprovalPolicyProjection]'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOfsecurity.v4.management.ListApprovalPoliciesApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListApprovalPoliciesApiResponsedata.discriminator_value_class_map.values():
            return list(ListApprovalPoliciesApiResponsedata.discriminator_value_class_map.keys())[list(ListApprovalPoliciesApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListApprovalPoliciesApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListApprovalPoliciesApiResponsedata):
            return False
