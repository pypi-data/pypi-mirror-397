...
class CreateKeyManagementServerApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfsecurity.v4.config.CreateKeyManagementServerApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in CreateKeyManagementServerApiResponsedata.discriminator_value_class_map.values():
            return list(CreateKeyManagementServerApiResponsedata.discriminator_value_class_map.keys())[list(CreateKeyManagementServerApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(CreateKeyManagementServerApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateKeyManagementServerApiResponsedata):
            return False
