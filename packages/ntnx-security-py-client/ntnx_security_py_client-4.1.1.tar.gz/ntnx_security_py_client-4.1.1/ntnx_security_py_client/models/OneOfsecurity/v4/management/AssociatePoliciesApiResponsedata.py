...
class AssociatePoliciesApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfsecurity.v4.management.AssociatePoliciesApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in AssociatePoliciesApiResponsedata.discriminator_value_class_map.values():
            return list(AssociatePoliciesApiResponsedata.discriminator_value_class_map.keys())[list(AssociatePoliciesApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(AssociatePoliciesApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AssociatePoliciesApiResponsedata):
            return False
