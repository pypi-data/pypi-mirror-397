...
class ListStigSummariesApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<security.v4.report.StigSummary>': 'list[security.v4.report.StigSummary]',
        'security.v4.error.ErrorResponse': 'security.v4.error.ErrorResponse',
        'List<security.v4.report.StigSummaryProjection>': 'list[security.v4.report.StigSummaryProjection]'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOfsecurity.v4.report.ListStigSummariesApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListStigSummariesApiResponsedata.discriminator_value_class_map.values():
            return list(ListStigSummariesApiResponsedata.discriminator_value_class_map.keys())[list(ListStigSummariesApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListStigSummariesApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListStigSummariesApiResponsedata):
            return False
