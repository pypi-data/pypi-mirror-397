...
class ListKeyManagementServersApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<security.v4.config.KeyManagementServer>': 'list[security.v4.config.KeyManagementServer]',
    ...
    def _initialize_object_type(self):
        return 'OneOfsecurity.v4.config.ListKeyManagementServersApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListKeyManagementServersApiResponsedata.discriminator_value_class_map.values():
            return list(ListKeyManagementServersApiResponsedata.discriminator_value_class_map.keys())[list(ListKeyManagementServersApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListKeyManagementServersApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListKeyManagementServersApiResponsedata):
            return False
