...
class GetCredentialApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'security.v4.config.Credential': 'security.v4.config.Credential',
    ...
    def _initialize_object_type(self):
        return 'OneOfsecurity.v4.config.GetCredentialApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetCredentialApiResponsedata.discriminator_value_class_map.values():
            return list(GetCredentialApiResponsedata.discriminator_value_class_map.keys())[list(GetCredentialApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetCredentialApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetCredentialApiResponsedata):
            return False
