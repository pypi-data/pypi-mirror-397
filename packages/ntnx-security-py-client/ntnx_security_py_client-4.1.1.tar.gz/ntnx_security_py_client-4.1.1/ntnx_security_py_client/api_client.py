...
from ntnx_security_py_client import rest
...
class ApiClient(object):
    ...
    # Populated if multiple schemas exist with the same name
        'security.v4.management.AssociatePoliciesSpec' : 'AssociatePoliciesSpec',
        'common.v1.config.IPv4Address' : 'IPv4Address',
        'OneOfsecurity.v4.report.ListSecuritySummariesApiResponsedata' : 'ListSecuritySummariesApiResponsedata',
        'common.v1.config.FQDN' : 'FQDN',
        'security.v4.management.SecuredEntityType' : 'SecuredEntityType',
        'common.v1.config.IPv6Address' : 'IPv6Address',
        'OneOfsecurity.v4.config.DeleteCredentialApiResponsedata' : 'DeleteCredentialApiResponsedata',
        'security.v4.config.KeyManagementServer' : 'KeyManagementServer',
        'security.v4.config.BmcCredential' : 'BmcCredential',
        'common.v1.config.Flag' : 'Flag',
        'security.v4.config.UpdateKeyManagementServerApiResponse' : 'UpdateKeyManagementServerApiResponse',
        'security.v4.error.SchemaValidationError' : 'SchemaValidationError',
        'OneOfsecurity.v4.config.ListKeyManagementServersApiResponsedata' : 'ListKeyManagementServersApiResponsedata',
        'OneOfsecurity.v4.report.ListVulnerabilitiesApiResponsedata' : 'ListVulnerabilitiesApiResponsedata',
        'security.v4.config.VcenterCredential' : 'VcenterCredential',
        'OneOfsecurity.v4.config.UpdateKeyManagementServerApiResponsedata' : 'UpdateKeyManagementServerApiResponsedata',
        'security.v4.report.StigSecuritySummary' : 'StigSecuritySummary',
        'security.v4.report.StigProjection' : 'StigProjection',
        'prism.v4.config.TaskReference' : 'TaskReference',
        'security.v4.management.ApprovalPolicy' : 'ApprovalPolicy',
        'security.v4.management.PolicyType' : 'PolicyType',
        'iam.v4.authn.BucketsAccessKey' : 'BucketsAccessKey',
        'security.v4.management.EventType' : 'EventType',
        'security.v4.common.Cluster' : 'Cluster',
        'security.v4.report.ListSecuritySummariesApiResponse' : 'ListSecuritySummariesApiResponse',
        'security.v4.config.UpdateCredentialApiResponse' : 'UpdateCredentialApiResponse',
        'iam.v4.authn.CreationType' : 'CreationType',
        'security.v4.report.IssueSummary' : 'IssueSummary',
        'OneOfsecurity.v4.config.DeleteKeyManagementServerApiResponsedata' : 'DeleteKeyManagementServerApiResponsedata',
        'security.v4.config.DeleteCredentialApiResponse' : 'DeleteCredentialApiResponse',
        'security.v4.report.Stig' : 'Stig',
        'security.v4.report.ListVulnerabilitiesApiResponse' : 'ListVulnerabilitiesApiResponse',
        'iam.v4.authn.UserType' : 'UserType',
        'security.v4.common.Timescale' : 'Timescale',
        'security.v4.config.KmipAccessInformation' : 'KmipAccessInformation',
        'OneOfsecurity.v4.config.KeyManagementServeraccess_information' : 'KeyManagementServeraccess_information',
        'security.v4.report.SecuritySummaryProjection' : 'SecuritySummaryProjection',
        'security.v4.report.Severity' : 'Severity',
        'common.v1.config.MapOfStringWrapper' : 'MapOfStringWrapper',
        'security.v4.report.SecurityConfigSummary' : 'SecurityConfigSummary',
        'common.v1.config.IPAddressOrFQDN' : 'IPAddressOrFQDN',
        'security.v4.management.AssociatePoliciesApiResponse' : 'AssociatePoliciesApiResponse',
        'security.v4.error.SchemaValidationErrorMessage' : 'SchemaValidationErrorMessage',
        'security.v4.report.SecuritySummary' : 'SecuritySummary',
        ...
        'security.v4.management.UpdateApprovalPolicyApiResponse' : 'UpdateApprovalPolicyApiResponse',
        'iam.v4.authn.User' : 'User',
        'security.v4.config.SecurityConfigVisibilitySettingProjection' : 'SecurityConfigVisibilitySettingProjection',
        'OneOfsecurity.v4.management.CreateApprovalPolicyApiResponsedata' : 'CreateApprovalPolicyApiResponsedata',
        'security.v4.config.SecurityConfigVisibilitySetting' : 'SecurityConfigVisibilitySetting',
        'security.v4.management.ApproverGroup' : 'ApproverGroup',
        'security.v4.report.ListStigsApiResponse' : 'ListStigsApiResponse',
        'OneOfsecurity.v4.management.AssociatePoliciesApiResponsedata' : 'AssociatePoliciesApiResponsedata',
        'common.v1.config.BasicAuth' : 'BasicAuth',
        'common.v1.response.ExternalizableAbstractModel' : 'ExternalizableAbstractModel',
        'OneOfsecurity.v4.report.RefreshSecuritySummariesApiResponsedata' : 'RefreshSecuritySummariesApiResponsedata',
        'OneOfsecurity.v4.config.GetKeyManagementServerApiResponsedata' : 'GetKeyManagementServerApiResponsedata',
        'security.v4.config.ExternalSshAccessConfig' : 'ExternalSshAccessConfig',
        'security.v4.config.KeyBasedAuthCredential' : 'KeyBasedAuthCredential',
        'security.v4.config.ScheduleType' : 'ScheduleType',
        'security.v4.report.ListStigSummariesApiResponse' : 'ListStigSummariesApiResponse',
        'common.v1.config.Message' : 'Message',
        'OneOfsecurity.v4.error.ErrorResponseerror' : 'ErrorResponseerror',
        'security.v4.management.GetApprovalPolicyApiResponse' : 'GetApprovalPolicyApiResponse',
        'security.v4.management.ListApprovalPoliciesApiResponse' : 'ListApprovalPoliciesApiResponse',
        'security.v4.report.RefreshSecuritySummariesApiResponse' : 'RefreshSecuritySummariesApiResponse',
        'OneOfsecurity.v4.management.UpdateApprovalPolicyApiResponsedata' : 'UpdateApprovalPolicyApiResponsedata',
        'security.v4.config.ListCredentialsApiResponse' : 'ListCredentialsApiResponse',
        'security.v4.report.SoftwareType' : 'SoftwareType',
        'security.v4.config.CreateKeyManagementServerApiResponse' : 'CreateKeyManagementServerApiResponse',
        'security.v4.management.CreateApprovalPolicyApiResponse' : 'CreateApprovalPolicyApiResponse',
        'OneOfcommon.v1.config.KVPairvalue' : 'KVPairvalue',
        'OneOfsecurity.v4.config.UpdateCredentialApiResponsedata' : 'UpdateCredentialApiResponsedata',
        'security.v4.config.IntersightCredential' : 'IntersightCredential',
        'OneOfsecurity.v4.config.Credentialcredential_details' : 'Credentialcredential_details',
        'security.v4.report.StigSummaryProjection' : 'StigSummaryProjection',
        'security.v4.management.ApprovalPolicyProjection' : 'ApprovalPolicyProjection',
        'security.v4.error.ErrorResponse' : 'ErrorResponse',
        'security.v4.config.BasicAuthCredential' : 'BasicAuthCredential',
        'security.v4.config.DeleteKeyManagementServerApiResponse' : 'DeleteKeyManagementServerApiResponse',
        'security.v4.config.SecurityConfigProjection' : 'SecurityConfigProjection',
        'security.v4.config.Credential' : 'Credential',
        'security.v4.config.ListKeyManagementServersApiResponse' : 'ListKeyManagementServersApiResponse',
        'security.v4.report.StigSummary' : 'StigSummary',
        'security.v4.report.TrendValue' : 'TrendValue',
        'common.v1.config.MessageSeverity' : 'MessageSeverity',
        'security.v4.report.VulnerabilityDetail' : 'VulnerabilityDetail',
        'security.v4.config.GetKeyManagementServerApiResponse' : 'GetKeyManagementServerApiResponse',
        'security.v4.config.KeyBasedAuth' : 'KeyBasedAuth',
        'security.v4.config.ExternalSshAccessConfigProjection' : 'ExternalSshAccessConfigProjection',
        'security.v4.common.ClusterProjection' : 'ClusterProjection',
        'common.v1.response.ApiLink' : 'ApiLink',
        'security.v4.config.GetCredentialApiResponse' : 'GetCredentialApiResponse',
        'security.v4.report.VulnerabilitySummary' : 'VulnerabilitySummary',
        'security.v4.report.StigStatus' : 'StigStatus',
        'OneOfsecurity.v4.management.ListApprovalPoliciesApiResponsedata' : 'ListApprovalPoliciesApiResponsedata',
        'security.v4.config.CreateCredentialApiResponse' : 'CreateCredentialApiResponse',
        'OneOfsecurity.v4.config.CreateKeyManagementServerApiResponsedata' : 'CreateKeyManagementServerApiResponsedata',
        'security.v4.config.AzureAccessInformation' : 'AzureAccessInformation',
        'security.v4.error.AppMessage' : 'AppMessage',
        'security.v4.report.Vulnerability' : 'Vulnerability',
        'OneOfsecurity.v4.management.GetApprovalPolicyApiResponsedata' : 'GetApprovalPolicyApiResponsedata',
        'security.v4.config.SecurityConfig' : 'SecurityConfig',
        'OneOfsecurity.v4.config.GetCredentialApiResponsedata' : 'GetCredentialApiResponsedata',
        'OneOfsecurity.v4.report.ListStigsApiResponsedata' : 'ListStigsApiResponsedata',
        'security.v4.config.EndpointInfo' : 'EndpointInfo',
        'security.v4.management.SecuredPolicy' : 'SecuredPolicy',
        'OneOfsecurity.v4.config.CreateCredentialApiResponsedata' : 'CreateCredentialApiResponsedata',
        'common.v1.config.TenantAwareModel' : 'TenantAwareModel',
        'security.v4.management.SecurityValidationSpec' : 'SecurityValidationSpec',
        'OneOfsecurity.v4.config.ListCredentialsApiResponsedata' : 'ListCredentialsApiResponsedata',
        'iam.v4.authn.UserStatusType' : 'UserStatusType',
        'OneOfsecurity.v4.report.ListStigSummariesApiResponsedata' : 'ListStigSummariesApiResponsedata',
        'security.v4.report.VulnerabilityProjection' : 'VulnerabilityProjection',
    ...
    def negotiate_version(self, auth_settings):
        ...
        """
        try:
            response = self.__call_api('/api/security/unversioned/info', 'OPTIONS',
                                        response_type = 'object', auth_settings = auth_settings)
            if response is not None and "data" in response:
                server_version = response["data"]
                minimum_supported_version = "v4.1"
                ...
                self.negotiated_version = None
                self.configuration.negotiation_completed = False
        except ntnx_security_py_client.rest.ApiException as e:
    ...
    def __call_api(
        ...
        if response_data.status == 401:
            ...
            if response_data.status == 401:
                raise ntnx_security_py_client.rest.ApiException(http_resp=response_data)
    ...
    def __deserialize_response(self, response, response_type):
        ...
        :type response: :class:`~ntnx_security_py_client.rest.RESTResponse`, required
    ...
    def _call_api(self, resource_path, method,
        ...
        :param _request_timeout: Timeout setting for this request. It needs to be a pair (list) of
            ...
            the timeouts will be derived from the :class:`~ntnx_security_py_client.configuration.Configuration`.
    ...
    def __deserialize_file(self, response):
        ...
        :param response: :class:`~ntnx_security_py_client.rest.RESTResponse`
        :return: File path
        """
    ...
    def __deserialize_date(self, string):
        ...
        :param string:
        :type string: str
        :raises :class:`~ntnx_security_py_client.rest.ApiException` if provided string is not a valid date
        :return: date object
        """
    ...
    def __deserialize_datatime(self, string):
        ...
        :raises :class:`~ntnx_security_py_client.rest.ApiException` if provided string is not a valid datetime
    ...
    def __getattr(self, name):
        if name in self.DUPLICATE_SCHEMA_MAPPING:
            return getattr(ntnx_security_py_client.models, self.DUPLICATE_SCHEMA_MAPPING[name])
        if hasattr(ntnx_security_py_client.models, name.split('.')[-1]):
            return getattr(ntnx_security_py_client.models, name.split('.')[-1])
        else:
            return getattr(ntnx_security_py_client.models, name)
