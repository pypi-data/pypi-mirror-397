...
class VulnerabilitiesApi(object):
    ...
    def list_vulnerabilities(self, _page=None, _limit=None, _filter=None, _orderby=None, _select=None, **kwargs):  # noqa: E501
        """Get the vulnerability information

        >>> response = api.list_vulnerabilities((optional) _page, (optional) _limit, (optional) _filter, (optional) _orderby, (optional) _select)
        ...
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
                           ...
                           async_req=True
        :return: An instance of class :class:`~ntnx_security_py_client.models.security.v4.report.ListVulnerabilitiesApiResponse`.
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/security/v4.1/report/vulnerabilities', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
                    ...
                    response_type='security.v4.report.ListVulnerabilitiesApiResponse',  # noqa: E501
