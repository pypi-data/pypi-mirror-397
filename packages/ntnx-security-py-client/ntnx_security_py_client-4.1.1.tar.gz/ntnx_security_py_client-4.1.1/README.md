# Python Client For Nutanix Security APIs
...
api_client = ntnx_security_py_client.ApiClient(allow_version_negotiation=False)
```
...
This library has a full set of [API Reference Documentation](https://developers.nutanix.com/sdk-reference?namespace=security&version=v4.1&language=python). This documentation is auto-generated, and the location may change.
