...
class V5NotificationsSettingsSettingsIdPutRequest(BaseModel):
    """
    V5NotificationsSettingsSettingsIdPutRequest
    """ # noqa: E501
    event_type: Optional[StrictStr] = Field(default=None, alias="eventType")
    event_configuration: Optional[Dict[str, Any]] = Field(default=None, description="Settings specific to the event type. Currently accepts an empty object {}. This object will be extended in future releases to support event-specific configuration options.", alias="eventConfiguration")
    ...
    __properties: ClassVar[List[str]] = ["eventType", "eventConfiguration", "enabled", "channelIds"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V5NotificationsSettingsSettingsIdPutRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V5NotificationsSettingsSettingsIdPutRequest from a dict"""
        if obj is None:
            return None
