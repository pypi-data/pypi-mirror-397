...
class JobError(BaseModel):
    ...
    occurred_at: datetime = Field(description="Timestamp when the error occurred", alias="occurredAt")
    screenshot: Optional[StrictStr] = Field(default=None, description="URL to error screenshot if available")
    context: Optional[Dict[str, Any]] = Field(default=None, description="Additional error context")
    __properties: ClassVar[List[str]] = ["errorCode", "message", "occurredAt", "screenshot", "context"]
