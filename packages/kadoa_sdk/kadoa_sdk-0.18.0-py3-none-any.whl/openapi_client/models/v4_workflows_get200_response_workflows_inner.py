...
class V4WorkflowsGet200ResponseWorkflowsInner(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "description", "state", "displayState", "userId", "createdAt", "tags", "limit", "finishedAt", "startedAt", "jobId", "dataKey", "location", "runCosts", "runState", "totalRecords", "url", "urls", "browserActions", "navigationMode", "maxDepth", "maxPages", "schema", "templateName", "templateId", "errors", "dataValidation", "validationStatistics", "monitoring", "notificationConfig"]
