...
class MonitoringConfig(BaseModel):
    ...
    conditions: Optional[Any] = Field(default=None, description="Condition group with logical operator and conditions")
    __properties: ClassVar[List[str]] = ["enabled", "fields", "channels", "conditions"]
