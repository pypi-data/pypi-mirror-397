...
class Location(BaseModel):
    ...
    """ # noqa: E501
    type: StrictStr = Field(description="Location type")
    iso_code: Optional[StrictStr] = Field(default=None, description="Country ISO code for manual location", alias="isoCode")
