...
class CreateCrawlerConfigResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["url", "startUrls", "pathsFilterIn", "pathsFilterOut", "proxyType", "proxyCountry", "timeout", "maxDepth", "maxPages", "maxMatches", "concurrency", "strictDomain", "loadImages", "safeMode", "callbackUrl", "processDuringCrawl", "crawlMethod", "matchThreshold", "blueprint", "extractionOptions", "navigationOptions", "artifactOptions", "configId", "userId", "createdAt"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateCrawlerConfigResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateCrawlerConfigResponse from a dict"""
        if obj is None:
            return None
