...
class AgenticWorkflow(BaseModel):
    ...
    entity: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(default=None, description="Optional: Entity name for agentic extraction")
    ...
    __properties: ClassVar[List[str]] = ["urls", "navigationMode", "name", "description", "tags", "limit", "location", "monitoring", "interval", "schedules", "bypassPreview", "autoStart", "interactions", "dataValidationEnabled", "additionalData", "maxPages", "maxDepth", "pathsFilterIn", "pathsFilterOut", "userPrompt", "schemaId", "entity", "fields"]
