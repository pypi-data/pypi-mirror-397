...
class WorkflowWithExistingSchema(BaseModel):
    """
    ...
    schema_id: StrictStr = Field(description="ID of an existing schema configuration. Use this to reference a previously defined schema without re-defining extraction fields", alias="schemaId")
    __properties: ClassVar[List[str]] = ["urls", "navigationMode", "name", "description", "tags", "limit", "location", "monitoring", "interval", "schedules", "bypassPreview", "autoStart", "interactions", "dataValidationEnabled", "additionalData", "maxPages", "maxDepth", "pathsFilterIn", "pathsFilterOut", "schemaId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WorkflowWithExistingSchema from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WorkflowWithExistingSchema from a dict"""
        if obj is None:
            return None
