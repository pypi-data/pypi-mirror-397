...
class V4WorkflowsWorkflowIdAuditlogGet200Response(BaseModel):
    ...
    pagination: V4WorkflowsWorkflowIdAuditlogGet200ResponsePagination
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pagination": V4WorkflowsWorkflowIdAuditlogGet200ResponsePagination.from_dict(obj["pagination"]) if obj.get("pagination") is not None else None
        })
        return _obj
