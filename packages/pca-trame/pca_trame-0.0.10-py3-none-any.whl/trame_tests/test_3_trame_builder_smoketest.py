...
class SmokeTest(unittest.TestCase):
    ...
    files = [
        ("src/trame_tests/data/dummy.md", 23),
        ...
        ("src/trame_tests/data/nav_et_trigo.md", 25),
    ]
    ...
    def test_dumm(self):
        ...
        self.assertIsInstance(trame.pieces[21], BlockQuote)
        # self.assertIsInstance(trame.pieces[22], BlockQuote)
        # self.assertIsInstance(trame.pieces[23], BlockQuote)
