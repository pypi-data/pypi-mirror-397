...
def clean_text_nodes(element: PageElement) -> str:
    ...
    # NOTE: on 2025-19-12 Tags only were printed
    # print(type(element))
    ...
    # NOTE: do not erase
    # if str(cleaned) != str(element):
    #     import difflib
    #     differ = difflib.Differ()
    #     diff = differ.compare(str(cleaned).split(), str(element).split())
    #     print("\n".join(diff))
    ...
    #     str1 = str(element)
    #     str2 = str(cleaned)
    #     diff = unified_diff(str1.splitlines(), str2.splitlines(), lineterm="")
    #     print("\n".join(diff))
