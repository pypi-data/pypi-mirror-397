...
from swh.graph.libs.luigi.topology import *  # noqa
from swh.graph.luigi.compressed_graph import *  # noqa
from swh.graph.luigi.subdataset import *  # noqa
from swh.provenance.luigi import *  # noqa

from .aggregate_datasets import *  # noqa
from .blobs_datasets import *  # noqa
from .file_names import *  # noqa
from .impact import *  # noqa
from .origin_contributors import *  # noqa


class UploadExportAndCompressedGraphToS3(luigi.Task):
    """Uploads the local dataset export to s3, then the compressed graph to S3.

    It will create automatically the missing local dataset or compressed graph if
    missing.
    ...
    Example invocation::
        ...
        luigi --local-scheduler --module swh.graph.luigi \
            UploadExportAndCompressedGraphToS3 \
    ...
    def requires(self):
        """Returns instances of :class:`swh.export.luigi.UploadExportToS3`,
        ...
        from swh.export.luigi import UploadExportToS3
        from swh.graph.luigi.compressed_graph import UploadGraphToS3
...
class RunNewGraph(luigi.Task):
    ...
    def requires(self) -> List[luigi.Task]:
        """Returns instances of :class:`swh.export.luigi.RunExportAll` and
        :class:`swh.export.luigi.UploadExportAndCompressedGraphToS3`, which
        recursively depend on the whole export and compression pipeline.
        Also runs some of the derived datasets through
        :class:`swh.datasets.topology.UploadGenerationsToS3` and
        :class:`swh.datasets.aggregate_datasets.RunAggregatedDatasets`.
        """
        from swh.export.luigi import RunExportAll
        from swh.graph.libs.luigi.topology import UploadGenerationsToS3
