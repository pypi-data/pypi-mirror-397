...
class SpatialForceVector(SpatialForceVectorBase):
    ...
    def asCrossProductMatrix(self):
        return _iDynTree.SpatialForceVector_asCrossProductMatrix(self)
...
class IJoint(object):
    ...
    def isSphericalJoint(self):
        return _iDynTree.IJoint_isSphericalJoint(self)
    ...
    def asSphericalJoint(self):
        return _iDynTree.IJoint_asSphericalJoint(self)
...
class MovableJointImpl4_3(IJoint):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")

    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined - class is abstract")
    __repr__ = _swig_repr
    __swig_destroy__ = _iDynTree.delete_MovableJointImpl4_3

    def getNrOfPosCoords(self):
        return _iDynTree.MovableJointImpl4_3_getNrOfPosCoords(self)

    def getNrOfDOFs(self):
        return _iDynTree.MovableJointImpl4_3_getNrOfDOFs(self)

    def setIndex(self, _index):
        return _iDynTree.MovableJointImpl4_3_setIndex(self, _index)

    def getIndex(self):
        return _iDynTree.MovableJointImpl4_3_getIndex(self)

    def setPosCoordsOffset(self, _offset):
        return _iDynTree.MovableJointImpl4_3_setPosCoordsOffset(self, _offset)

    def getPosCoordsOffset(self):
        return _iDynTree.MovableJointImpl4_3_getPosCoordsOffset(self)

    def setDOFsOffset(self, _offset):
        return _iDynTree.MovableJointImpl4_3_setDOFsOffset(self, _offset)

    def getDOFsOffset(self):
        return _iDynTree.MovableJointImpl4_3_getDOFsOffset(self)

# Register MovableJointImpl4_3 in _iDynTree:
_iDynTree.MovableJointImpl4_3_swigregister(MovableJointImpl4_3)
...
class SphericalJoint(MovableJointImpl4_3):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, *args):
        _iDynTree.SphericalJoint_swiginit(self, _iDynTree.new_SphericalJoint(*args))
    __swig_destroy__ = _iDynTree.delete_SphericalJoint

    def clone(self):
        return _iDynTree.SphericalJoint_clone(self)

    def setAttachedLinks(self, link1, link2):
        return _iDynTree.SphericalJoint_setAttachedLinks(self, link1, link2)

    def setRestTransform(self, link1_X_link2):
        return _iDynTree.SphericalJoint_setRestTransform(self, link1_X_link2)

    def getFirstAttachedLink(self):
        return _iDynTree.SphericalJoint_getFirstAttachedLink(self)

    def getSecondAttachedLink(self):
        return _iDynTree.SphericalJoint_getSecondAttachedLink(self)

    def getRestTransform(self, child, parent):
        return _iDynTree.SphericalJoint_getRestTransform(self, child, parent)

    def getTransform(self, jntPos, child, parent):
        return _iDynTree.SphericalJoint_getTransform(self, jntPos, child, parent)

    def getTransformDerivative(self, jntPos, child, parent, posCoord_i):
        return _iDynTree.SphericalJoint_getTransformDerivative(self, jntPos, child, parent, posCoord_i)

    def getMotionSubspaceVector(self, *args):
        return _iDynTree.SphericalJoint_getMotionSubspaceVector(self, *args)

    def computeChildPosVelAcc(self, jntPos, jntVel, jntAcc, linkPositions, linkVels, linkAccs, child, parent):
        return _iDynTree.SphericalJoint_computeChildPosVelAcc(self, jntPos, jntVel, jntAcc, linkPositions, linkVels, linkAccs, child, parent)

    def computeChildVel(self, jntPos, jntVel, linkVels, child, parent):
        return _iDynTree.SphericalJoint_computeChildVel(self, jntPos, jntVel, linkVels, child, parent)

    def computeChildVelAcc(self, jntPos, jntVel, jntAcc, linkVels, linkAccs, child, parent):
        return _iDynTree.SphericalJoint_computeChildVelAcc(self, jntPos, jntVel, jntAcc, linkVels, linkAccs, child, parent)

    def computeChildAcc(self, jntPos, jntVel, linkVels, jntAcc, linkAccs, child, parent):
        return _iDynTree.SphericalJoint_computeChildAcc(self, jntPos, jntVel, linkVels, jntAcc, linkAccs, child, parent)

    def computeChildBiasAcc(self, jntPos, jntVel, linkVels, linkBiasAccs, child, parent):
        return _iDynTree.SphericalJoint_computeChildBiasAcc(self, jntPos, jntVel, linkVels, linkBiasAccs, child, parent)

    def computeJointTorque(self, jntPos, internalWrench, linkThatAppliesWrench, linkOnWhichWrenchIsApplied, jntTorques):
        return _iDynTree.SphericalJoint_computeJointTorque(self, jntPos, internalWrench, linkThatAppliesWrench, linkOnWhichWrenchIsApplied, jntTorques)

    def hasPosLimits(self):
        return _iDynTree.SphericalJoint_hasPosLimits(self)

    def enablePosLimits(self, enable):
        return _iDynTree.SphericalJoint_enablePosLimits(self, enable)

    def getPosLimits(self, _index, min, max):
        return _iDynTree.SphericalJoint_getPosLimits(self, _index, min, max)

    def getMinPosLimit(self, _index):
        return _iDynTree.SphericalJoint_getMinPosLimit(self, _index)

    def getMaxPosLimit(self, _index):
        return _iDynTree.SphericalJoint_getMaxPosLimit(self, _index)

    def setPosLimits(self, _index, min, max):
        return _iDynTree.SphericalJoint_setPosLimits(self, _index, min, max)

    def getJointDynamicsType(self):
        return _iDynTree.SphericalJoint_getJointDynamicsType(self)

    def setJointDynamicsType(self, enable):
        return _iDynTree.SphericalJoint_setJointDynamicsType(self, enable)

    def setDamping(self, _index, damping):
        return _iDynTree.SphericalJoint_setDamping(self, _index, damping)

    def setStaticFriction(self, _index, staticFriction):
        return _iDynTree.SphericalJoint_setStaticFriction(self, _index, staticFriction)

    def getDamping(self, _index):
        return _iDynTree.SphericalJoint_getDamping(self, _index)

    def getStaticFriction(self, _index):
        return _iDynTree.SphericalJoint_getStaticFriction(self, _index)

    def getPositionDerivativeVelocityJacobian(self, jntPos, jac):
        return _iDynTree.SphericalJoint_getPositionDerivativeVelocityJacobian(self, jntPos, jac)

    def setJointPosCoordsToRest(self, jntPos):
        return _iDynTree.SphericalJoint_setJointPosCoordsToRest(self, jntPos)

    def normalizeJointPosCoords(self, jntPos):
        return _iDynTree.SphericalJoint_normalizeJointPosCoords(self, jntPos)

    def setJointCenter(self, link, center):
        return _iDynTree.SphericalJoint_setJointCenter(self, link, center)

    def getJointCenter(self, link):
        return _iDynTree.SphericalJoint_getJointCenter(self, link)

# Register SphericalJoint in _iDynTree:
_iDynTree.SphericalJoint_swigregister(SphericalJoint)
...
class FreeFloatingMassMatrixDerivative(MatrixDynSize):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, *args):
        _iDynTree.FreeFloatingMassMatrixDerivative_swiginit(self, _iDynTree.new_FreeFloatingMassMatrixDerivative(*args))

    def resize(self, model):
        return _iDynTree.FreeFloatingMassMatrixDerivative_resize(self, model)
    __swig_destroy__ = _iDynTree.delete_FreeFloatingMassMatrixDerivative

# Register FreeFloatingMassMatrixDerivative in _iDynTree:
_iDynTree.FreeFloatingMassMatrixDerivative_swigregister(FreeFloatingMassMatrixDerivative)
class FreeFloatingCoriolisMatrix(MatrixDynSize):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, *args):
        _iDynTree.FreeFloatingCoriolisMatrix_swiginit(self, _iDynTree.new_FreeFloatingCoriolisMatrix(*args))

    def resize(self, model):
        return _iDynTree.FreeFloatingCoriolisMatrix_resize(self, model)
    __swig_destroy__ = _iDynTree.delete_FreeFloatingCoriolisMatrix

# Register FreeFloatingCoriolisMatrix in _iDynTree:
_iDynTree.FreeFloatingCoriolisMatrix_swigregister(FreeFloatingCoriolisMatrix)
...
def CoriolisMatrixAlgorithm(model, traversal, linkPos, linkVels, linkCRBIs, coriolisMatrix, massMatrix, massMatrixDerivative):
    return _iDynTree.CoriolisMatrixAlgorithm(model, traversal, linkPos, linkVels, linkCRBIs, coriolisMatrix, massMatrix, massMatrixDerivative)
...
class KinDynComputations(object):
    ...
    def getCoriolisAndMassMatrices(self, *args):
        return _iDynTree.KinDynComputations_getCoriolisAndMassMatrices(self, *args)
    ...
    def inverseDynamicsInertialParametersRegressor(self, baseFrameAcc, s_ddot, baseForceAndJointTorquesRegressor):
        return _iDynTree.KinDynComputations_inverseDynamicsInertialParametersRegressor(self, baseFrameAcc, s_ddot, baseForceAndJointTorquesRegressor)
