...
def build_root_status_html(safe_status, cert_info, recent_requests, server_port, firefox_diagnosis=None, ca_details=None):
    ...
    <body>
        ...
        (function() {{
            ...
            setTimeout(function() {{
                fetch('https://127.0.0.1:{server_port}/_health', {{ 
                    method: 'GET', 
                    mode: 'cors', 
                    cache: 'no-store',
                    credentials: 'omit'
