...
class Preference:
    ...
    def daily_cost_euros(self, Pheat: list[float], modes: list[int] | None = None, kWh_price: float = 0.13) -> float:
    ...
    def assess(self, Pheater: list[float], temperatures: list[float], CO2_concentrations: list[float], occupancies: tuple[list[float]], hours: list[int] | None = None, modes: list[float] | None = None) -> float:
    ...
    def print_assessment(self, datetimes: list[datetime], PHVAC: list[float], temperatures: list[float], CO2_concentrations: list[float], occupancies: list[float], action_sets: tuple[list[float]] | None = None, modes: list[float] | None = None, list_extreme_hours: bool = False) -> None:
