...
async def get_jwt_token() -> str:
    ...
    try:
        ...
        form_data.add_field("username", INNAGUMA_USERNAME)
        form_data.add_field("passwd", INNAGUMA_PASSWORD)
        form_data.add_field("efgroup", "authentication")
        form_data.add_field("efevent", "requestJWTToken")
        form_data.add_field("payload-options", json.dumps({"site": INNAGUMA_SITE}))
...
async def search_innaguma(query: str, page: int = 1, order: str = "relevance", ctx: Context) -> dict:
    """
