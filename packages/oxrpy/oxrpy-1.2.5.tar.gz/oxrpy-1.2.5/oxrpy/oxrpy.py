...
class OxfordAPI:
    def __init__(self, server_id: str, server_key: str, timeout: int = 10, rate_limit: Optional[float] = 0.2):
        """
        ...
        Args:
            ...
            rate_limit (Optional[float]): Minimum time between requests in seconds. 
                Set to None to disable automatic rate limiting. Default is 0.2 (5 requests/sec).
        """
