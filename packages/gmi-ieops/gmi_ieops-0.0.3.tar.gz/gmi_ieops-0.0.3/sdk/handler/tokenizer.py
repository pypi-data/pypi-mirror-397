...
class TokenizerBase(ABC):
    ...
    @abstractmethod
    def encode(self, msg: Union[str, List[Dict[str, str]], List[List[Dict[str, str]]]]) -> Union[str, List[int], List[str], List[List[int]], BatchEncoding]: # type: ignore
        """encode interface"""
        pass
    @abstractmethod
    def decode(self, token_ids: Union[int, List[int], "np.ndarray", "torch.Tensor"]) -> str: # type: ignore
        """decode interface"""
        pass
...
class TokenizerPool():
    ...
    @staticmethod
    def _encode_worker(msg: Union[List[Dict[str, str]], List[List[Dict[str, str]]]]) -> Union[str, List[int], List[str], List[List[int]], BatchEncoding]: # type: ignore
        ...
        return _worker_tokenizer.encode(msg) # type: ignore
    ...
    async def encode(self, msg: Union[List[Dict[str, str]], List[List[Dict[str, str]]]]) -> Union[str, List[int], List[str], List[List[int]], BatchEncoding]: # type: ignore
        ...
        try:
            return await self._loop.run_in_executor(self._process_pool, self._encode_worker, msg) # type: ignore
        except Exception as e:
