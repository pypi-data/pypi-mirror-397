...
VERIFICATION_GROUPS = {
    ...
    'tensorflow': VerificationGroup(
        name='tensorflow',
        packages={'tensorflow', 'tensorboard', 'tensorflow-estimator', 
                 'keras', 'tf-keras'},
    ...
    'jupyter': VerificationGroup(
        name='jupyter',
        packages={'jupyter', 'jupyter-core', 'jupyter-client', 'jupyterlab',
    ...
    'django': VerificationGroup(
        name='django',
        packages={'django', 'django-rest-framework', 'djangorestframework',
