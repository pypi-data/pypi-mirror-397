...
class GridScalarFunctionExpliciter2D:
    def __init__(self, arg0: opengeode.bin.opengeode_py_mesh.Grid2D, arg1: str) -> None:
        ...
    def add_one_scalar_isovalue(self, arg0: float) -> None:
        ...
    def add_scalar_isovalues(self, arg0: list[float]) -> None:
        ...
    def build_section(self) -> opengeode.bin.opengeode_py_model.Section:
        ...
class GridScalarFunctionExpliciter3D:
    def __init__(self, arg0: opengeode.bin.opengeode_py_mesh.Grid3D, arg1: str) -> None:
        ...
    def add_one_scalar_isovalue(self, arg0: float) -> None:
        ...
    def add_scalar_isovalues(self, arg0: list[float]) -> None:
        ...
    def build_brep(self) -> opengeode.bin.opengeode_py_model.BRep:
        ...
...
class ImplicitStructuralModelHorizonExpliciter:
    def __init__(self, arg0: opengeode_geosciences.bin.opengeode_geosciences_py_implicit.ImplicitStructuralModel) -> None:
        ...
    def build(self) -> None:
        ...
    def explicit_all_horizons(self) -> None:
        ...
    def explicit_horizon(self, arg0: opengeode_geosciences.bin.opengeode_geosciences_py_explicit.Horizon3D) -> None:
        ...
class SolidMeshScalarFunctionExpliciter:
    def __init__(self, arg0: opengeode.bin.opengeode_py_mesh.TetrahedralSolid3D, arg1: str) -> None:
        ...
    def add_one_scalar_isovalue(self, arg0: float) -> None:
        ...
    def add_scalar_isovalues(self, arg0: list[float]) -> None:
