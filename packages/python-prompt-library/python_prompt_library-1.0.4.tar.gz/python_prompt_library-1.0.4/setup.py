...
setup(
    ...
    description="A Python prompt library to consolidate libraries and utility scripts",
    long_description=open("README.md").read(),
    long_description_content_type="text/markdown",
    url="https://github.com/ryan-gutkowski_LPLA/Python_Prompt_Library",
    packages=find_packages(),
    install_requires=[],  # required libraries needed by scripts (requests, numpy, pandas, etc)
    classifiers=[
