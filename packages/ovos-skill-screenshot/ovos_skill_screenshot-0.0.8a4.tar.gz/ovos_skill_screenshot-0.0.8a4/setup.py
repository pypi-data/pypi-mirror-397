...
URL = "https://github.com/OpenVoiceOS/ovos-skill-screenshot"
SKILL_CLAZZ = "ScreenshotSkill"  # needs to match __init__.py class name
PYPI_NAME = "ovos-skill-screenshot"  # pip install PYPI_NAME
