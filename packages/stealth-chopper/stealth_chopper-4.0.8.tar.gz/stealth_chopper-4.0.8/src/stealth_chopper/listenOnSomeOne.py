...
async def launch_wireshark(interface, target_ip, exclude_ips, url_file="src/stealth_chopper/assets/url_file.txt", output_file=None):
    """
...
async def main(target_ip, interface, default_gateway, exclude_ips):
    ...
    await asyncio.gather(
        ...
        launch_wireshark(interface, target_ip, exclude_ips, "src/stealth_chopper/assets/url_file.txt")
    )
