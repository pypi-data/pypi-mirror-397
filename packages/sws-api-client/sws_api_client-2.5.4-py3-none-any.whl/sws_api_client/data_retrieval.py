        ...
        if not data_processed:
            ...
            try:
                ...
                if task_response.info.outcome == "SUCCESS":
                    ...
                    logger.info("Plugin task created successfully for %s %s", entity_type, entity_id)
                    metadata_info["retrieval_method"] = "plugin_task"
                    metadata_info["execution_time_seconds"] = time() - start_time
                    return {"data": plugin_resp, "metadata": metadata_info, "success": True}
