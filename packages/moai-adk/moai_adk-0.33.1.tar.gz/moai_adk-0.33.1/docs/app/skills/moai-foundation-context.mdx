---
title: "Enterprise Context & Session Management"
description: "Unified context optimization and session state management for Claude Code with 200K token budget management, session persistence, and multi-agent handoff protocols."
---
