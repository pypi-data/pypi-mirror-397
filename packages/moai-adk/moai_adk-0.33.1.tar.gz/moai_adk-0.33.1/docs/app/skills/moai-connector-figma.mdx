...
description: "Primary Focus: Design systems, component libraries, design tokens, documentation. Best For: UI/UX design, design system creation, component documentation, design handoff. Key Tools: Figma 20"
---
...
**Skill Name**: moai-connector-figma
