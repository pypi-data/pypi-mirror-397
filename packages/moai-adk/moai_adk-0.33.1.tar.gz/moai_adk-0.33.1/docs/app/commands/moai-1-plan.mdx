---
title: "MoAI-ADK Step 1: Establish a plan (Plan)"
description: "/moai:1-plan - Always make a plan first and then proceed"
---
...
**Allowed Tools**: Task, AskUserQuestion, Skill, TodoWrite, Read, Bash
**Model**: sonnet
...
- [/moai:0-project](/commands/moai-0-project) - Initialize new project

- [/moai:2-run](/commands/moai-2-run) - Execute TDD implementation
- [/moai:3-sync](/commands/moai-3-sync) - Sync documentation
- [/moai:9-feedback](/commands/moai-9-feedback) - Submit feedback
