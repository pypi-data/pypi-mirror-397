...
class CoreV1Rule(BaseModel):
    ...
    metrics: Optional[CoreV1RuleMetrics] = Field(default=None, description="Rule-related metrics")
    spec: CoreV1RuleSpec = Field(description="The rule configuration.")
    status: Optional[CoreV1ResourceStatus] = None
    __properties: ClassVar[List[str]] = ["apiVersion", "kind", "metadata", "metrics", "spec", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "metrics": CoreV1RuleMetrics.from_dict(obj["metrics"]) if obj.get("metrics") is not None else None,
