...
class CoreV1PostRuleMetricsRequest(BaseModel):
    """
    CoreV1PostRuleMetricsRequest
    """ # noqa: E501
    job_name: StrictStr = Field(description="Name of the associated Job", alias="jobName")
    job_id: StrictInt = Field(description="The job' ID.", alias="jobId")
    ...
    exec_results: Optional[List[CoreV1PostRuleMetricsRequestExecResultsInner]] = Field(default=None, alias="execResults")
    __properties: ClassVar[List[str]] = ["jobName", "jobId", "operationalAlertCount", "failedResourceNames", "execResults"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CoreV1PostRuleMetricsRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CoreV1PostRuleMetricsRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "execResults": [CoreV1PostRuleMetricsRequestExecResultsInner.from_dict(_item) for _item in obj["execResults"]] if obj.get("execResults") is not None else None
        })
        return _obj
