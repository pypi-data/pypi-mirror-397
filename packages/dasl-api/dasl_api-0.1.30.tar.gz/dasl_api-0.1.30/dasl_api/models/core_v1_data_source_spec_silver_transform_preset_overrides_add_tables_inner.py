...
class CoreV1DataSourceSpecSilverTransformPresetOverridesAddTablesInner(BaseModel):
    ...
    name: Optional[StrictStr] = Field(default=None, description="The name of the table to add. Note that only one entry is allowed per table name, ignoring catalog.schema if specified. ")
    ...
    fields: Optional[List[CoreV1DataSourceFieldSpec]] = None
