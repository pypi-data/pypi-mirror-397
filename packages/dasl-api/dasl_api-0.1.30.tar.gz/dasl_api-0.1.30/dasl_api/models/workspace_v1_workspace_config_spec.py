...
class WorkspaceV1WorkspaceConfigSpec(BaseModel):
    ...
    dasl_storage_path: StrictStr = Field(description="The path to a directory where Lakewatch can store internal files and state. ", alias="daslStoragePath")
    dasl_custom_presets_path: Optional[StrictStr] = Field(default=None, description="A path to a user catalog volume where the user can store custom preset to be made available via the Lakewatch UI. ", alias="daslCustomPresetsPath")
