...
class CoreV1DatasourceDraftSummaryList(BaseModel):
    """
    The response for listing Datasource draft summaries. 
    """ # noqa: E501
    ...
    items: List[CoreV1DatasourceDraftSummary] = Field(description="A list of Datasource draft summaries")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CoreV1DatasourceDraftSummaryList from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CoreV1DatasourceDraftSummaryList from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "items": [CoreV1DatasourceDraftSummary.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "kind": obj.get("kind"),
