...
class DbuiV1VerifyAuthResponse(BaseModel):
    ...
    is_admin: StrictBool = Field(description="Indicates whether this token has admin privileges in the Lakewatch workspace.", alias="isAdmin")
    dasl_workspace_id: StrictStr = Field(description="The Lakewatch workspace ID this token authed against.", alias="daslWorkspaceId")
