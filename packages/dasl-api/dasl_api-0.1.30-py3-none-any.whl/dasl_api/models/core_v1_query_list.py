...
class CoreV1QueryList(BaseModel):
    """
    The response for GET queries containing a detailed list of queries in the account. 
    """ # noqa: E501
    ...
    items: List[CoreV1Query] = Field(description="A list of Queries")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CoreV1QueryList from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CoreV1QueryList from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "items": [CoreV1Query.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "kind": obj.get("kind"),
