...
class CoreV1QueryLookupRequest(BaseModel):
    ...
    version: Optional[StrictInt] = Field(default=None, description="The specific version of the query to run a lookup against. Will target the latest version if not provided. ")
