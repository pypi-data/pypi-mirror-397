...
class CoreV1DatasourceDraft(BaseModel):
    """
    A DatasourceDraft resource for staging Datasource configurations before they are finalized and reconciled. This is a non-reconcilable resource. Note that this is primarily to support the UI and is not the expected DataSource creation flow in the CLI or python client. 
    """ # noqa: E501
    ...
    spec: CoreV1DatasourceDraftSpec = Field(description="The draft specification containing the Datasource configuration and optional metadata.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CoreV1DatasourceDraft from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CoreV1DatasourceDraft from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "spec": CoreV1DatasourceDraftSpec.from_dict(obj["spec"]) if obj.get("spec") is not None else None
        })
        return _obj
