...
class SecurityPolicyOptions(object):
    ...
    :param is_ipv6_traffic_allowed: (:attr:`is_ipv6_traffic_allowed`) If enabled, IPv6 traffic is allowed regardless of policy configuration. If disabled, IPv6 traffic will follow the policy configuration (if isIpv6AddressScope is enabled). (**Default** False)
    :type is_ipv6_traffic_allowed: 
    
    
    :param is_hitlog_enabled: (:attr:`is_hitlog_enabled`) If Hitlog is enabled. (**Default** False)
