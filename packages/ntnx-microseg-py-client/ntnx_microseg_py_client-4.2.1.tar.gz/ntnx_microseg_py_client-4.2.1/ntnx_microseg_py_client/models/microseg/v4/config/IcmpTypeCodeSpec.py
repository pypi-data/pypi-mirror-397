...
class IcmpTypeCodeSpec(object):
    ...
    @type.setter
    def type(self, type):
        if type is not None and type > 43:  # noqa: E501
            raise ValueError("Invalid value for `type`, must be a value less than or equal to `43`")  # noqa: E501
    ...
    @code.setter
    def code(self, code):
        if code is not None and code > 15:  # noqa: E501
            raise ValueError("Invalid value for `code`, must be a value less than or equal to `15`")  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(IcmpTypeCodeSpec, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IcmpTypeCodeSpec):
            return False
