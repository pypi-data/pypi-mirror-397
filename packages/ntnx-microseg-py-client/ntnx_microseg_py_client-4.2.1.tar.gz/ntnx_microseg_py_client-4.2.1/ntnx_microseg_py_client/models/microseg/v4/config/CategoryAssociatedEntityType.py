...
class CategoryAssociatedEntityType(object):
    ...
    def _initialize_object_type(self):
        return 'microseg.v4.config.CategoryAssociatedEntityType'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(CategoryAssociatedEntityType, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CategoryAssociatedEntityType):
            return False
