...
class IcmpV6TypeCodeSpec(object):
    ...
    def _initialize_object_type(self):
        return 'microseg.v4.config.IcmpV6TypeCodeSpec'
    ...
    @type.setter
    def type(self, type):
        if type is not None and type > 201:  # noqa: E501
            raise ValueError("Invalid value for `type`, must be a value less than or equal to `201`")  # noqa: E501
    ...
    @code.setter
    def code(self, code):
        if code is not None and code > 10:  # noqa: E501
            raise ValueError("Invalid value for `code`, must be a value less than or equal to `10`")  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(IcmpV6TypeCodeSpec, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IcmpV6TypeCodeSpec):
            return False
