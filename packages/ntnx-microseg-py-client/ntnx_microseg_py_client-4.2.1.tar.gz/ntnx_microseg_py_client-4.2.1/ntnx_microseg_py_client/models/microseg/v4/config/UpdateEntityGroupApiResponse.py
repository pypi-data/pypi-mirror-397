...
from ntnx_microseg_py_client.models.OneOfmicroseg.v4.config.UpdateEntityGroupApiResponsedata import UpdateEntityGroupApiResponsedata  # noqa: F401,E501
from ntnx_microseg_py_client.models.common.v1.response.ApiResponseMetadata import ApiResponseMetadata  # noqa: F401,E501

class UpdateEntityGroupApiResponse(object):
    ...
    swagger_types = {
        ...
        'data': 'OneOfmicroseg.v4.config.UpdateEntityGroupApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'microseg.v4.config.UpdateEntityGroupApiResponse'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(UpdateEntityGroupApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateEntityGroupApiResponse):
            return False
