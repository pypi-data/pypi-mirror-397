...
from ntnx_microseg_py_client.models.OneOfmicroseg.v4.config.CreateEntityGroupApiResponsedata import CreateEntityGroupApiResponsedata  # noqa: F401,E501
from ntnx_microseg_py_client.models.common.v1.response.ApiResponseMetadata import ApiResponseMetadata  # noqa: F401,E501

class CreateEntityGroupApiResponse(object):
    ...
    swagger_types = {
        ...
        'data': 'OneOfmicroseg.v4.config.CreateEntityGroupApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'microseg.v4.config.CreateEntityGroupApiResponse'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(CreateEntityGroupApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateEntityGroupApiResponse):
            return False
