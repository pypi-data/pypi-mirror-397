...
class IpRange(object):
    ...
    :param ipv4_ranges: (:attr:`ipv4_ranges`) List of IP range containing start and end IP.
    :type ipv4_ranges: 
    ...
    """  # noqa: E501
    swagger_types = {
        'ipv4_ranges': 'list[microseg.v4.config.IPv4Range]',
    ...
    def __init__(self, ipv4_ranges=None, *args, **kwargs):  # noqa: E501
        self.__ipv4_ranges = None
        self.discriminator = None
        if ipv4_ranges is not None:
            self.__ipv4_ranges = ipv4_ranges
        # populate hidden vars if not empty
        self._populate_hidden_vars(kwargs)

    def _initialize_object_type(self):
        return 'microseg.v4.config.IpRange'
    ...
    @ipv4_ranges.setter
    def ipv4_ranges(self, ipv4_ranges):
