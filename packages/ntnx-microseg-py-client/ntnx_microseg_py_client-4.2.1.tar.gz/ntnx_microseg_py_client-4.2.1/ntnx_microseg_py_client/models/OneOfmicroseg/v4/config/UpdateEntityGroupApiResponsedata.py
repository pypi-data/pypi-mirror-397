...
class UpdateEntityGroupApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfmicroseg.v4.config.UpdateEntityGroupApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in UpdateEntityGroupApiResponsedata.discriminator_value_class_map.values():
            return list(UpdateEntityGroupApiResponsedata.discriminator_value_class_map.keys())[list(UpdateEntityGroupApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(UpdateEntityGroupApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateEntityGroupApiResponsedata):
            return False
