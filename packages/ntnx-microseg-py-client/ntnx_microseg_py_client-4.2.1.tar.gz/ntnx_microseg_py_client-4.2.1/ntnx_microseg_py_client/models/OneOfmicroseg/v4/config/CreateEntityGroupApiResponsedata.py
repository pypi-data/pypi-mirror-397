...
class CreateEntityGroupApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfmicroseg.v4.config.CreateEntityGroupApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in CreateEntityGroupApiResponsedata.discriminator_value_class_map.values():
            return list(CreateEntityGroupApiResponsedata.discriminator_value_class_map.keys())[list(CreateEntityGroupApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(CreateEntityGroupApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateEntityGroupApiResponsedata):
            return False
