...
class DeleteEntityGroupApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfmicroseg.v4.config.DeleteEntityGroupApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in DeleteEntityGroupApiResponsedata.discriminator_value_class_map.values():
            return list(DeleteEntityGroupApiResponsedata.discriminator_value_class_map.keys())[list(DeleteEntityGroupApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(DeleteEntityGroupApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteEntityGroupApiResponsedata):
            return False
