...
class GetEntityGroupApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'microseg.v4.config.EntityGroup': 'microseg.v4.config.EntityGroup',
    ...
    def _initialize_object_type(self):
        return 'OneOfmicroseg.v4.config.GetEntityGroupApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetEntityGroupApiResponsedata.discriminator_value_class_map.values():
            return list(GetEntityGroupApiResponsedata.discriminator_value_class_map.keys())[list(GetEntityGroupApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetEntityGroupApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetEntityGroupApiResponsedata):
            return False
