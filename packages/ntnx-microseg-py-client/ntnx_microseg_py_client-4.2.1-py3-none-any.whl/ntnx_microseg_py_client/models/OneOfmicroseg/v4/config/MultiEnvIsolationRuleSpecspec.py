...
class MultiEnvIsolationRuleSpecspec(object):
    ...
    discriminator_value_class_map = {
        ...
        'microseg.v4.config.AllToAllIsolationGroup': 'microseg.v4.config.AllToAllIsolationGroup'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOfmicroseg.v4.config.MultiEnvIsolationRuleSpecspec'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in MultiEnvIsolationRuleSpecspec.discriminator_value_class_map.values():
            return list(MultiEnvIsolationRuleSpecspec.discriminator_value_class_map.keys())[list(MultiEnvIsolationRuleSpecspec.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(MultiEnvIsolationRuleSpecspec, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MultiEnvIsolationRuleSpecspec):
            return False
