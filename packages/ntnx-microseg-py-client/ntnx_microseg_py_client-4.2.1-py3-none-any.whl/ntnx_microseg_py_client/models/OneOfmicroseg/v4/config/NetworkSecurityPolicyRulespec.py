...
class NetworkSecurityPolicyRulespec(object):
    ...
    discriminator_value_class_map = {
        ...
        'microseg.v4.config.MultiEnvIsolationRuleSpec': 'microseg.v4.config.MultiEnvIsolationRuleSpec'
    }
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in NetworkSecurityPolicyRulespec.discriminator_value_class_map.values():
            return list(NetworkSecurityPolicyRulespec.discriminator_value_class_map.keys())[list(NetworkSecurityPolicyRulespec.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(NetworkSecurityPolicyRulespec, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NetworkSecurityPolicyRulespec):
            return False
