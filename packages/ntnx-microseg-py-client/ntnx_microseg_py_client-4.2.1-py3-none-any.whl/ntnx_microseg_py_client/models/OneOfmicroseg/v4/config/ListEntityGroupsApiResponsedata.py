...
class ListEntityGroupsApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<microseg.v4.config.EntityGroup>': 'list[microseg.v4.config.EntityGroup]',
    ...
    def _initialize_object_type(self):
        return 'OneOfmicroseg.v4.config.ListEntityGroupsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListEntityGroupsApiResponsedata.discriminator_value_class_map.values():
            return list(ListEntityGroupsApiResponsedata.discriminator_value_class_map.keys())[list(ListEntityGroupsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListEntityGroupsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListEntityGroupsApiResponsedata):
            return False
