...
class AllowedType(object):
    ...
    Allowed enum values:
        ...
        - KUBE_PODS: Kubernetes pods.
        - KUBE_SERVICE: Kubernetes service.
    ...
    def _initialize_object_type(self):
        return 'microseg.v4.config.AllowedType'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(AllowedType, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AllowedType):
            return False
