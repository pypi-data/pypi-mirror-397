...
from ntnx_microseg_py_client.models.OneOfmicroseg.v4.config.GetEntityGroupApiResponsedata import GetEntityGroupApiResponsedata  # noqa: F401,E501
from ntnx_microseg_py_client.models.common.v1.response.ApiResponseMetadata import ApiResponseMetadata  # noqa: F401,E501

class GetEntityGroupApiResponse(object):
    ...
    swagger_types = {
        ...
        'data': 'OneOfmicroseg.v4.config.GetEntityGroupApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'microseg.v4.config.GetEntityGroupApiResponse'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetEntityGroupApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetEntityGroupApiResponse):
            return False
