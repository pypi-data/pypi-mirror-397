...
class AllowedSelectBy(object):
    ...
    Allowed enum values:
        ...
        - _UNKNOWN
        - _REDACTED
        - CATEGORY_EXT_ID: Category external identifier.
        - EXT_ID: External identifier.
        - NAME: Name.
        - LABELS: Labels.
        - IP_VALUES: IP address.
    """
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    ...
    def _initialize_object_type(self):
        return 'microseg.v4.config.AllowedSelectBy'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(AllowedSelectBy, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AllowedSelectBy):
            return False
