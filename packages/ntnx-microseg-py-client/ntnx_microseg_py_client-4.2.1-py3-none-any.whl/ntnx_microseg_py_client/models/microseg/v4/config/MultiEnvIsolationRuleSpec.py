...
from ntnx_microseg_py_client.models.OneOfmicroseg.v4.config.MultiEnvIsolationRuleSpecspec import MultiEnvIsolationRuleSpecspec  # noqa: F401,E501

class MultiEnvIsolationRuleSpec(object):

    """A rule for specifying that multiple environments should be isolated from each other.

    :param spec: (:attr:`spec`) Multi environment isolation rule spec.
    :type spec: required
    ...
    """  # noqa: E501
    swagger_types = {
        'spec': 'OneOfmicroseg.v4.config.MultiEnvIsolationRuleSpecspec',
    ...
    def _initialize_object_type(self):
        return 'microseg.v4.config.MultiEnvIsolationRuleSpec'
    ...
    def spec(self):
        ...
        :type:
                :class:`~ntnx_microseg_py_client.models.microseg.v4.config.AllToAllIsolationGroup`
        """  # noqa: E501
        return self.__spec
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(MultiEnvIsolationRuleSpec, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MultiEnvIsolationRuleSpec):
            return False
