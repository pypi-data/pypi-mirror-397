...
class NetworkSecurityPolicyExportSpec(object):

    """Network Security Policy Export that provides the capability to export only the selected Network Security Policies.

    :param policy_references: (:attr:`policy_references`) List of Network Security Policy external identifiers for export.
    ...
    def __init__(self, policy_references=None, *args, **kwargs):  # noqa: E501
    ...
    def _initialize_object_type(self):
        return 'microseg.v4.config.NetworkSecurityPolicyExportSpec'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(NetworkSecurityPolicyExportSpec, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NetworkSecurityPolicyExportSpec):
            return False
