...
class ServiceGroup(ExternalizableAbstractModel):
    ...
    :param creation_time: (:attr:`creation_time`) The timestamp when the Service Group was created.
    :type creation_time: 
    
    
    :param last_update_time: (:attr:`last_update_time`) The timestamp when the Service Group was last updated.
    ...
    def __init__(self, name=None, description=None, is_system_defined=None, tcp_services=None, udp_services=None, icmp_services=None, icmp_v6_services=None, policy_references=None, created_by=None, creation_time=None, last_update_time=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
