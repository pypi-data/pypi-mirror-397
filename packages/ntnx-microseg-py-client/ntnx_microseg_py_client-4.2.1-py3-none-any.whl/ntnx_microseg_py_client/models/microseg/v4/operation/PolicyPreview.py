...
class PolicyPreview(ExternalizableAbstractModel):
    ...
    """  # noqa: E501
    swagger_types = {
        'new_policy_spec': 'microseg.v4.config.NetworkSecurityPolicy',
        'system_generated_policies': 'list[microseg.v4.config.NetworkSecurityPolicy]',
        'ext_id': 'str',
    ...
    attribute_map = {
        'new_policy_spec': 'newPolicySpec',
        'system_generated_policies': 'systemGeneratedPolicies',
        'ext_id': 'extId',
        'links': 'links',
        'tenant_id': 'tenantId',
        '_reserved': '$reserved',
    ...
    def __init__(self, new_policy_spec=None, system_generated_policies=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
        ExternalizableAbstractModel.__init__(self, ext_id, links, tenant_id, *args, **kwargs)
        self.__new_policy_spec = None
        self.__system_generated_policies = None
    ...
    def new_policy_spec(self):
        ...
        """  # noqa: E501
        return self.__new_policy_spec

    @new_policy_spec.setter
    ...
    def system_generated_policies(self, system_generated_policies):
