...
class TotalPolicyCount(object):
    ...
    attribute_map = {
        ...
        'policy_type_counts_summary': 'policyTypeCountsSummary',
        '_reserved': '$reserved',
    ...
    def __init__(self, total_counts_summary=None, policy_type_counts_summary=None, *args, **kwargs):  # noqa: E501
        self.__total_counts_summary = None
        self.__policy_type_counts_summary = None
