...
NAME = "RF-SAM-2"
VERSION = "1.0.1"
DESCRIPTION = "SAM 2: Segment Anything in Images and Videos - Roboflow package"
URL = "https://github.com/roboflow/sam2"
AUTHOR = "Meta AI"
...
setup(
    ...
    license=LICENSE,
    packages=find_packages(exclude=("notebooks", "training")),
