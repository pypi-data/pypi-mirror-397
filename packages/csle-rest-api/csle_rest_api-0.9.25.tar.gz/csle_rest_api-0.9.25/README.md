...
| `/emulation-executions/<execution_id>/five-g-core-manager?token=<valid_token>&emulation=<emulation>`  | Start/stop 5G core managers of an emulation execution          | `POST`                                  |
| `/emulation-executions/<execution_id>/five-g-cu-manager?token=<valid_token>&emulation=<emulation>`    | Start/stop 5G CU managers of an emulation execution            | `POST`                                  |
| `/emulation-executions/<execution_id>/five-g-du-manager?token=<valid_token>&emulation=<emulation>`    | Start/stop 5G DU managers of an emulation execution            | `POST`                                  |
| `/emulation-executions/<execution_id>/five-g-core?token=<valid_token>&emulation=<emulation>`          | Start/stop 5G Cores of an emulation execution                  | `POST`                                  |
| `/emulation-executions/<execution_id>/five-g-cu?token=<valid_token>&emulation=<emulation>`            | Start/stop 5G CUs of an emulation execution                    | `POST`                                  |
| `/emulation-executions/<execution_id>/five-g-du?token=<valid_token>&emulation=<emulation>`            | Start/stop 5G DUs of an emulation execution                    | `POST`                                  |
| `/emulation-executions/<execution_id>/five-g-ue?token=<valid_token>&emulation=<emulation>`            | Start/stop 5G UEs of an emulation execution                    | `POST`                                  |
...
| `/logs/five-g-core-manager?token=<valid_token>&emulation=<emulation_name>&executionid=<execution_id>` | Get logs of a specific 5G core manager                         | `POST`                                  |
| `/logs/five-g-cu-manager?token=<valid_token>&emulation=<emulation_name>&executionid=<execution_id>`   | Get logs of a specific 5G CU manager                           | `POST`                                  |
| `/logs/five-g-du-manager?token=<valid_token>&emulation=<emulation_name>&executionid=<execution_id>`   | Get logs of a specific 5G DU manager                           | `POST`                                  |
| `/logs/five-g-core?token=<valid_token>&emulation=<emulation_name>&executionid=<execution_id>`         | Get logs of a specific 5G Core                                 | `POST`                                  |
| `/logs/five-g-cu?token=<valid_token>&emulation=<emulation_name>&executionid=<execution_id>`           | Get logs of a specific 5G CU                                   | `POST`                                  |
| `/logs/five-g-du?token=<valid_token>&emulation=<emulation_name>&executionid=<execution_id>`           | Get logs of a specific 5G DU                                   | `POST`                                  |
| `/logs/five-g-ue?token=<valid_token>&emulation=<emulation_name>&executionid=<execution_id>`           | Get logs of a specific 5G UE                                   | `POST`                                  |
