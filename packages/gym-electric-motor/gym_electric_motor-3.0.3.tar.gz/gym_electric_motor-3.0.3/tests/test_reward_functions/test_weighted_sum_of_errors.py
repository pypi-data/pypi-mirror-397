...
class TestWeightedSumOfErrors(TestRewardFunction):
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            [
                DummyPhysicalSystem(state_length=2),
                dict(dummy_state_0=2),
                np.array([2, 0]),
            ],
        ],
    )
    ...
    @pytest.mark.parametrize(
        ["ps", "violation_reward", "gamma", "expected_vr"],
        [
    ...
    @pytest.mark.parametrize(
        ["ps", "reward_weights", "normed_rw", "expected_rw"],
        [
            ...
            [
                DummyPhysicalSystem(state_length=3),
                2,
                True,
