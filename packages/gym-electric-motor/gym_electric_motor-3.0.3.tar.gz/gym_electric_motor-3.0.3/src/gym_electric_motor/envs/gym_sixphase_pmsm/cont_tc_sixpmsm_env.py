...
class ContTorqueControlSixPhasePermanentMagnetSynchronousMotorEnv(ElectricMotorEnvironment):
   """
    Description:
        Environment to simulate an abc-domain continuous control set torque controlled six phase permanent magnet synchr. motor.
    ...
    Default Components:
        ...
        - Constraints: :py:class:`.SquaredConstraint` on the currents  ``'i_sd', 'i_sq', 'i_sx', 'i_sy'``
