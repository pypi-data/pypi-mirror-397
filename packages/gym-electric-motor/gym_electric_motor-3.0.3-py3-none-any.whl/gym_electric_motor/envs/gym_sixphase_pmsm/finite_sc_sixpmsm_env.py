...
class FiniteSpeedControlSixPhasePermanentMagnetSynchronousMotorEnv(ElectricMotorEnvironment):
   """
    Description:
        Environment to simulate Finite control set speed controlled six phase permanent magnet synchr. motor.
