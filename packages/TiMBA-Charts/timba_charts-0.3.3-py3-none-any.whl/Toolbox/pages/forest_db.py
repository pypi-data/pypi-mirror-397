        ...
        app_layout = dbc.Container(
            ...
            children=[
                                    ...
                                    children=[
                                        html.Div(
                                            ...
                                            children=[
                                                ...
                                                dcc.Download(id="fdb_download-dataframe-csv")
                                            ]
                                        )
                                    ]
                                )
                    ...
                    [
                        ...
                        dbc.Col(
                            dbc.Card(
                                ...
                                children=[
                                    html.H5("Forest Placeholder Lineplot", className="card-title mb-3"),
                                    dcc.Graph(id='fdb_trend-graph', figure={},
                            ...
                            html.Div(
                                children=[
                                    dbc.Card(
                                        ...
                                        children=[
                                            html.H5("Forest Placeholder Barplot", className="card-title mb-3"),
                                            dcc.Graph(
                                                id='fdb_region-graph',
                                                figure={},
                                    ...
                                    dbc.Card(
                                        ...
                                        children=[
                                            html.H5("Forest Placeholder Worldmap", className="card-title mb-3"),
                                            dcc.Graph(
                                                id='fdb_scatter-graph',
                                                figure={},
                                                style={'flex': '1', 'minHeight': '250px'}
                                            )
                                        ]
                ...
                dbc.Row(
                    [
                        dbc.Col(
                            dbc.Button("← Overview Dashboard", color="primary", href="/",
