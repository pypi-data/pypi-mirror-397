    ...
    async def red_delete_data_for_user(  # pyright: ignore[reportIncompatibleMethodOverride]
        ...
        *,
        ...
        match requester:
            ...
            # The owner requested data deletion for a user, or the bot is configured to be more strict when a user requests data deletion.
        ...
        *,
        ...
        if isinstance(types, list):
            ...
            for moderation_type in self.moderation_type_registry.classes():
                if await self.sentinel_config.type_show_in_history.get(guild=str(guild.discord_id), moderation_type=moderation_type.key) is True:
