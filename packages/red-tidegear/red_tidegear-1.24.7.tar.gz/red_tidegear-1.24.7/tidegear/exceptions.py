...
class TidegearError(Exception):
    ...
    @overload
    async def send(self, messageable: discord.abc.Messageable, /, func: Callable[[str], str] = ..., **kwargs: Any) -> discord.Message: ...
    @overload
    async def send(self, messageable: discord.Interaction, /, func: Callable[[str], str] = ..., **kwargs: Any) -> None: ...
