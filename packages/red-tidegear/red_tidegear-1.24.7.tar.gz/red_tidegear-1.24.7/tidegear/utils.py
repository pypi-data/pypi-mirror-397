...
async def send_error(
    messageable: discord.abc.Messageable, /, content: str | None = ..., func: Callable[[str], str] = ..., **kwargs: Any
) -> discord.Message: ...
@overload
async def send_error(messageable: discord.Interaction, /, content: str | None = ..., func: Callable[[str], str] = ..., **kwargs: Any) -> None: ...
...
async def send_error(
    ...
    **kwargs: Any,
    ...
    if isinstance(messageable, discord.Interaction):
        try:
            await messageable.response.send_message(content=content, **kwargs)
        except discord.InteractionResponded:
            await messageable.followup.send(content=content, **kwargs)  # pyright: ignore[reportCallIssue, reportArgumentType]
        return None
