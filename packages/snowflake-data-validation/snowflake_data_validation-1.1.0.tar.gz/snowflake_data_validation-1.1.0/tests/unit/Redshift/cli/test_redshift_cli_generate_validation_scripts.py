...
class TestRedshiftCLIGenerateValidationScripts:
    ...
    def test_generate_validation_scripts_success(
        self, mock_orchestrator_class, mock_create_env
    ):
...
"""
        ...
        try:
            ...
            assert (
                "Validation script generation completed successfully!" in result.output
            )
    ...
    def test_generate_validation_scripts_file_not_found_error(self, mock_config_loader):
