...
class ListConfigFieldV1(object):
    ...
    """
    swagger_types = {
        'element_config_field': 'ConfigFieldV1',
        'element_type': 'str',
        'max_item_count': 'int',
        'min_item_count': 'int'
    }
    ...
    attribute_map = {
        'element_config_field': 'elementConfigField',
        'element_type': 'elementType',
        'max_item_count': 'maxItemCount',
        'min_item_count': 'minItemCount'
    }

    def __init__(self, element_config_field=None, element_type=None, max_item_count=None, min_item_count=None):
        """
        ListConfigFieldV1 - a model defined in Swagger
        """

        self._element_config_field = None
        self._element_type = None
        self._max_item_count = None
        self._min_item_count = None

        if element_config_field is not None:
          self.element_config_field = element_config_field
    ...
    @property
    def element_config_field(self):
        """
        Gets the element_config_field of this ListConfigFieldV1.

        :return: The element_config_field of this ListConfigFieldV1.
        :rtype: ConfigFieldV1
        """
        return self._element_config_field

    @element_config_field.setter
    def element_config_field(self, element_config_field):
        """
        Sets the element_config_field of this ListConfigFieldV1.

        :param element_config_field: The element_config_field of this ListConfigFieldV1.
        :type: ConfigFieldV1
        """

        self._element_config_field = element_config_field
