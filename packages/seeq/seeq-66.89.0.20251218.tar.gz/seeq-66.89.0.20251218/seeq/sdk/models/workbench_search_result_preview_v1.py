...
class WorkbenchSearchResultPreviewV1(object):
    ...
    def __init__(self, ancestors=None, created_at=None, creator=None, data=None, description=None, effective_permissions=None, headline=None, id=None, is_archived=False, is_corporate=False, is_pinned=False, is_unmodifiable=False, locked=False, name=None, owner=None, parent_folder_id=None, project_type=None, renderer=None, shared_at=None, type=None, updated_at=None, workbook_id=None, worksheet_id=None):
        """
    ...
    def project_type(self):
        """
        Gets the project_type of this WorkbenchSearchResultPreviewV1.
        Project type of the item

        :return: The project_type of this WorkbenchSearchResultPreviewV1.
        :rtype: str
        """
    ...
    def project_type(self, project_type):
        """
        Sets the project_type of this WorkbenchSearchResultPreviewV1.
        Project type of the item

        :param project_type: The project_type of this WorkbenchSearchResultPreviewV1.
        :type: str
        """
