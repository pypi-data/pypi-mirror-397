...
class ItemFinderInputV1(object):
    ...
    def __init__(self, cron_schedule=None, description=None, enabled=True, fixed_list_searches=None, hierarchy_searches=None, include_hierarchy=False, name=None, property_searches=None, scaling_table_uuid_column_searches=None, scoped_to=None, searches=None, stored_table_searches=None, timezone=None):
        """
    ...
    def stored_table_searches(self):
        """
        Gets the stored_table_searches of this ItemFinderInputV1.
        The list of searches based on stored table values and properties

        :return: The stored_table_searches of this ItemFinderInputV1.
    ...
    def stored_table_searches(self, stored_table_searches):
        """
        Sets the stored_table_searches of this ItemFinderInputV1.
        The list of searches based on stored table values and properties

        :param stored_table_searches: The stored_table_searches of this ItemFinderInputV1.
