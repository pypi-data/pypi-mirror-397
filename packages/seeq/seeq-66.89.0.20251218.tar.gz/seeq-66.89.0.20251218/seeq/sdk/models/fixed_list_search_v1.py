...
class FixedListSearchV1(object):
    ...
    def __init__(self, is_include=None, item_ids=None, search_order=None, search_type=None):
        """
    ...
    def search_order(self):
        """
        Gets the search_order of this FixedListSearchV1.
        The priority of this search. Lower values have higher priority. When the same item appears in multiple searches, the search with the lowest order value wins. If multiple searches have the same order value (or if not specified), the search with the lexicographically lower ID wins (deterministic).

        :return: The search_order of this FixedListSearchV1.
        :rtype: int
        """
    ...
    def search_order(self, search_order):
        """
        Sets the search_order of this FixedListSearchV1.
        The priority of this search. Lower values have higher priority. When the same item appears in multiple searches, the search with the lowest order value wins. If multiple searches have the same order value (or if not specified), the search with the lexicographically lower ID wins (deterministic).

        :param search_order: The search_order of this FixedListSearchV1.
        :type: int
        """
