...
class ScalingTableUUIDColumnSearchV1(object):
    ...
    def __init__(self, column_definition_id=None, is_include=None, row_ids=None, search_order=None, search_type=None, table_definition_id=None, types=None):
        """
    ...
    def search_order(self):
        """
        Gets the search_order of this ScalingTableUUIDColumnSearchV1.
        ...
        :return: The search_order of this ScalingTableUUIDColumnSearchV1.
        :rtype: int
        """
    ...
    def search_order(self, search_order):
        """
        Sets the search_order of this ScalingTableUUIDColumnSearchV1.
        The order in which this search should be executed. When the same item appears in multiple searches, the search with the highest order value wins. If not specified, searches are ordered by their creation time (UUID).

        :param search_order: The search_order of this ScalingTableUUIDColumnSearchV1.
        :type: int
        """
