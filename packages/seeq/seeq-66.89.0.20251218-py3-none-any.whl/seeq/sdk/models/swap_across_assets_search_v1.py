...
class SwapAcrossAssetsSearchV1(object):
    ...
    def __init__(self, is_include=None, root_asset_id=None, search_order=None, search_type=None, swap_item_id=None):
        """
    ...
    def search_order(self):
        """
        Gets the search_order of this SwapAcrossAssetsSearchV1.
        ...
        :return: The search_order of this SwapAcrossAssetsSearchV1.
        :rtype: int
        """
    ...
    def search_order(self, search_order):
        """
        Sets the search_order of this SwapAcrossAssetsSearchV1.
        The order in which this search should be executed. When the same item appears in multiple searches, the search with the highest order value wins. If not specified, searches are ordered by their creation time (UUID).

        :param search_order: The search_order of this SwapAcrossAssetsSearchV1.
        :type: int
        """
