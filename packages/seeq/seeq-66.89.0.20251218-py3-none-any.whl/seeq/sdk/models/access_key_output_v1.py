...
class AccessKeyOutputV1(object):
    ...
    def __init__(self, created_at=None, description=None, effective_permissions=None, expiry=None, id=None, is_admin=False, is_archived=False, is_redacted=False, key_id=None, last_used=None, name=None, password=None, status_message=None, translation_key=None, type=None, user_id=None):
        """
    ...
    def expiry(self):
        """
        Gets the expiry of this AccessKeyOutputV1.
        The expiry of the API Key; applicable only for Application Service Principals

        :return: The expiry of this AccessKeyOutputV1.
        :rtype: str
        """
        return self._expiry
    ...
    def expiry(self, expiry):
        """
        Sets the expiry of this AccessKeyOutputV1.
        The expiry of the API Key; applicable only for Application Service Principals

        :param expiry: The expiry of this AccessKeyOutputV1.
        :type: str
        """
