...
class FormulasApi(object):
    ...
    @deprecated(reason="This API is experimental and may change or be removed in future releases without prior notice.")
    def formula_explainer_markdown(self, **kwargs):
        """
        A simple summary of Seeq Formula item that shows details about the execution plan. This endpoint is experimental and may change in future releases.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        to be invoked when receiving the response.
        >>> def callback_function(response):
        >>>     pprint(response)
        >>>
        >>> thread = api.formula_explainer_markdown(id=id_value, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.formula_explainer_markdown_with_http_info(**kwargs)
        else:
            (data) = self.formula_explainer_markdown_with_http_info(**kwargs)
            return data

    @deprecated(reason="This API is experimental and may change or be removed in future releases without prior notice.")
    def formula_explainer_markdown_with_http_info(self, **kwargs):
        """
        A simple summary of Seeq Formula item that shows details about the execution plan. This endpoint is experimental and may change in future releases.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.formula_explainer_markdown_with_http_info(id=id_value, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method formula_explainer_markdown" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `formula_explainer_markdown`")
        ...
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.\
            select_header_accept(['application/vnd.seeq.v1+json', 'text/markdown'])
        ...
        return self.api_client.call_api('/formulas/explainer/{id}/markdown', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
