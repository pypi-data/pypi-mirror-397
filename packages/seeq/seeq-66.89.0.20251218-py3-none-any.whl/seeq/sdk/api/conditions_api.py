...
class ConditionsApi(object):
    ...
    @deprecated(reason="")
    def condition_table(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.condition_table(body=body_value, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.condition_table_with_http_info(**kwargs)
        else:
            (data) = self.condition_table_with_http_info(**kwargs)
            return data

    @deprecated(reason="")
    def condition_table_with_http_info(self, **kwargs):
        """
        Generate a condition table based on the table specified by id
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.condition_table_with_http_info(body=body_value, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method condition_table" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `condition_table`")
        ...
        return self.api_client.call_api('/conditions/conditionTable', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
