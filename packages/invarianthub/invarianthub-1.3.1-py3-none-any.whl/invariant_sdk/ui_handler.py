#!/usr/bin/env python3
"""
ui_handler.py — Invariant Web UI request handler.
...
try:
    ...
    from .ui_pages import render_main_page, render_graph3d_page
except ImportError:
    ...
    from invariant_sdk.ui_pages import render_main_page, render_graph3d_page
...
class UIHandler(BaseHTTPRequestHandler):
    ...
    def serve_graph3d_page(self, query_string: str = ""):
        ...
        self.send_html(render_graph3d_page())
