...
from extendedstim.tools.GaloisTools import shift, distance, solve
import galois


class DoubleBivariantBicycleCode(LinearCode):
    __slots__=['gamma','l','m','a_x_list','a_y_list','b_x_list','b_y_list']
...
if __name__ == '__main__':
    code=DoubleBivariantBicycleCode(3,5,1,[2,0],[0,1],[0,0],[2,0])
    print(code.distance)
