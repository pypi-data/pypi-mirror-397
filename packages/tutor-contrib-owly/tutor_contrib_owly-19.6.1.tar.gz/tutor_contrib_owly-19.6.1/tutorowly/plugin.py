...
hooks.Filters.CONFIG_UNIQUE.add_items(
    [
        ...
        # Prefix your setting names with 'OWLY_'.
        # For example:
        ### ("OWLY_SECRET_KEY", "{{ 24|random_string }}"),
    ]
)
...
for service, template_path in MY_INIT_TASKS:
    full_path: str = str(
        importlib_resources.files("tutorowly")
...
hooks.Filters.ENV_TEMPLATE_ROOTS.add_items(
    ...
    [
        str(importlib_resources.files("tutorowly") / "templates"),
    ]
)
...
# For each file in tutorowly/patches,
...
#   $ tutor local do say-hi --name="Andres Gonzalez"
...
### hooks.Filters.CLI_COMMANDS.add_item(owly)
