...
async def deploy(
    ...
    if not no_push:
        ...
        logger.info("Source image is updated")
...
@async_
async def up(env: str, ref: str | None = None, context: str | None = None, env_file: str | None = None) -> None:
...
@async_
async def auth(api: str | None) -> None:
    import webbrowser
