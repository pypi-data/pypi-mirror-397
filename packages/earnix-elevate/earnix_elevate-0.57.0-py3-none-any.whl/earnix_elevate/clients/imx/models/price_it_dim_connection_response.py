...
class PriceItDimConnectionResponse(ConnectionResponse):
    """
    ...
    auth: Optional[OAuthResponse] = None
    __properties = [
        "read",
        "write",
        "id",
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PriceItDimConnectionResponse:
        """Create an instance of PriceItDimConnectionResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PriceItDimConnectionResponse:
        """Create an instance of PriceItDimConnectionResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PriceItDimConnectionResponse.parse_obj(obj)

        _obj = PriceItDimConnectionResponse.parse_obj(
            {
