...
class RFQOperations:
    ...
    def send_rfq(
        ...
        *,
        ...
        result = self._subaccount._private_api.send_rfq(params)
        return result
    ...
    def get_rfqs(
        ...
        *,
        ...
        result = self._subaccount._private_api.get_rfqs(params)
        return result
    ...
    def cancel_rfq(self, *, rfq_id: str) -> Result:
        ...
        result = self._subaccount._private_api.cancel_rfq(params)
        return result
    ...
    def cancel_batch_rfqs(
        ...
        *,
        ...
        result = self._subaccount._private_api.cancel_batch_rfqs(params)
        return result
    ...
    def poll_rfqs(
        ...
        *,
        ...
        result = self._subaccount._private_api.poll_rfqs(params)
        return result
    ...
    def send_quote(
        ...
        *,
        ...
        result = self._subaccount._private_api.send_quote(params)
        return result
    ...
    def cancel_quote(self, quote_id: str) -> PrivateCancelQuoteResultSchema:
        ...
        result = self._subaccount._private_api.cancel_quote(params)
        return result
    ...
    def cancel_batch_quotes(
        ...
        *,
        ...
        result = self._subaccount._private_api.cancel_batch_quotes(params)
        return result
    ...
    def get_quotes(
        ...
        *,
        ...
        result = self._subaccount._private_api.get_quotes(params)
        return result
    ...
    def poll_quotes(
        ...
        *,
        ...
        result = self._subaccount._private_api.poll_quotes(params)
        return result
    ...
    def execute_quote(
        ...
        *,
        ...
        result = self._subaccount._private_api.execute_quote(params)
        return result
    ...
    def get_best_quote(
        ...
        result = self._subaccount._private_api.rfq_get_best_quote(params)
        return result
