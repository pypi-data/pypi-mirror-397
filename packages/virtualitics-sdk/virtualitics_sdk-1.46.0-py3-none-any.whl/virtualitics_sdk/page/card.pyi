...
class Card:
    ...
    :param page_update_required: Whether to require running the page update. IMPORTANT, developer must set to False once the update has run to their desired state.
    ...
    **EXAMPLE:**
    ...
    @validate_types
    def __init__(self, title: str, content: list[Element | Row], subtitle: str = '', description: str = '', _id: str | None = None, show_title: bool = True, show_description: bool = True, page_update: PageUpdateCallback | None = None, page_update_required: bool = False, update_elems: str | list[str] | None = None, updater_text: str | None = None, filters: list[InputElement] | None = None, filter_update: Callable | None = None, show_comments: bool = False, show_export: bool = False, show_share: bool = False, info_content: str | None = None) -> None: ...
...
class Container(Card):
    ...
    **EXAMPLE:**
    ...
    def __init__(self, title: str, content: list[Element | Row], subtitle: str = '', description: str = '', _id: str | None = None, show_description: bool = True, page_update: Callable | None = None, page_update_required: bool = False, update_elems: str | list[str] | None = None, updater_text: str | None = None, filters: list[InputElement] | None = None, filter_update: Callable | None = None, show_comments: bool = False, show_export: bool = False, show_share: bool = False, size: DrilldownSize = ..., visible: bool = False, on_close: PageUpdateCallback | None = None) -> None: ...
    def to_json(self) -> dict: ...
