...
class Table(Element):
    ...
    :param on_edit_update: Updater function. Allows execution of a function after the table\'s contents get saved after an edit.
