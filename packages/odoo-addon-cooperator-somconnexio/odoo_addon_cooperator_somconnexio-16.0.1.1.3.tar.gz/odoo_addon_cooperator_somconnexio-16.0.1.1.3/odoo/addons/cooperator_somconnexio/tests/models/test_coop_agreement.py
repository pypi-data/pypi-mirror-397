...
class CoopAgreementTest(SCTestCase):
    def setUp(self, *args, **kwargs):
        ...
        self.router_lot = self.env["stock.lot"].create(
            {
    ...
    def test_coop_agreement_right_product(self):
        self.assertTrue(
            self.env["contract.contract"].create(self.contract_broadband_args)
        )
    ...
    def test_coop_agreement_copy(self):
        ...
        self.assertEqual(new_coop_agreement.code, "new code")
