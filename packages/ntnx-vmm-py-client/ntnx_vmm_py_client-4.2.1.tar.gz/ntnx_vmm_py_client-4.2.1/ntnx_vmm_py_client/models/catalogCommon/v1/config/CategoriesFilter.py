...
from ntnx_vmm_py_client.models.catalogCommon.v1.config.CategoriesMatchType import CategoriesMatchType  # noqa: F401,E501
...
class CategoriesFilter(object):
    ...
    :param category_ext_ids: (:attr:`category_ext_ids`) Filter to match entities based on the provided categories.
    :type category_ext_ids: required
    ...
    """  # noqa: E501
    swagger_types = {
        'type': 'catalogCommon.v1.config.CategoriesMatchType',
    ...
    def __init__(self, type=None, category_ext_ids=None, *args, **kwargs):  # noqa: E501
        self.__type = None
    ...
    def _initialize_object_type(self):
        return 'catalogCommon.v1.config.CategoriesFilter'
    ...
    def type(self):
        ...
        :type:
            :class:`~ntnx_vmm_py_client.models.catalogCommon.v1.config.CategoriesMatchType`
        """  # noqa: E501
        return self.__type
    ...
    def category_ext_ids(self, category_ext_ids):
        if category_ext_ids is None:
            raise ValueError("Invalid value for `category_ext_ids`, must not be `None`")  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(CategoriesFilter, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CategoriesFilter):
            return False
