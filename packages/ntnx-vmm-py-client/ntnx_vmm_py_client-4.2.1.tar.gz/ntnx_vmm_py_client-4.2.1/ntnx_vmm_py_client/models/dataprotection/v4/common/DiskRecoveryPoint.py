...
class DiskRecoveryPoint(object):
    ...
    :param disk_ext_id: (:attr:`disk_ext_id`) Disk external identifier which is captured as a part of this recovery point.
    :type disk_ext_id: 
    ...
    def _initialize_object_type(self):
        return 'dataprotection.v4.common.DiskRecoveryPoint'
