...
class UpgradeVmGuestToolsApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.ahv.config.UpgradeVmGuestToolsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in UpgradeVmGuestToolsApiResponsedata.discriminator_value_class_map.values():
            return list(UpgradeVmGuestToolsApiResponsedata.discriminator_value_class_map.keys())[list(UpgradeVmGuestToolsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(UpgradeVmGuestToolsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpgradeVmGuestToolsApiResponsedata):
            return False
