...
class RemoveVmDiskCustomAttributesApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.ahv.config.RemoveVmDiskCustomAttributesApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in RemoveVmDiskCustomAttributesApiResponsedata.discriminator_value_class_map.values():
            return list(RemoveVmDiskCustomAttributesApiResponsedata.discriminator_value_class_map.keys())[list(RemoveVmDiskCustomAttributesApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(RemoveVmDiskCustomAttributesApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RemoveVmDiskCustomAttributesApiResponsedata):
            return False
