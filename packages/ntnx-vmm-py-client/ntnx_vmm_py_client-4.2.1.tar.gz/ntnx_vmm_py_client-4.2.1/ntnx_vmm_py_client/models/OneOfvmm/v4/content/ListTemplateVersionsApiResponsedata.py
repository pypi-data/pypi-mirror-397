...
class ListTemplateVersionsApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<vmm.v4.content.TemplateVersionSpec>': 'list[vmm.v4.content.TemplateVersionSpec]',
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.content.ListTemplateVersionsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListTemplateVersionsApiResponsedata.discriminator_value_class_map.values():
            return list(ListTemplateVersionsApiResponsedata.discriminator_value_class_map.keys())[list(ListTemplateVersionsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListTemplateVersionsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListTemplateVersionsApiResponsedata):
            return False
