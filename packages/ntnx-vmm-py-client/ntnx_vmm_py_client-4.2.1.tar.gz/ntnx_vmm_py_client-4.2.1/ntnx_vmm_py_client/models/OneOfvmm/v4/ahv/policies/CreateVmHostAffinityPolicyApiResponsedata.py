...
class CreateVmHostAffinityPolicyApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.ahv.policies.CreateVmHostAffinityPolicyApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in CreateVmHostAffinityPolicyApiResponsedata.discriminator_value_class_map.values():
            return list(CreateVmHostAffinityPolicyApiResponsedata.discriminator_value_class_map.keys())[list(CreateVmHostAffinityPolicyApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(CreateVmHostAffinityPolicyApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateVmHostAffinityPolicyApiResponsedata):
            return False
