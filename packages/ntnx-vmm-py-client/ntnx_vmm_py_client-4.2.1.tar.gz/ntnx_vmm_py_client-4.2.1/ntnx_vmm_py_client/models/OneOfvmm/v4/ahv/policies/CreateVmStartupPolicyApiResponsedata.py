...
class CreateVmStartupPolicyApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.ahv.policies.CreateVmStartupPolicyApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in CreateVmStartupPolicyApiResponsedata.discriminator_value_class_map.values():
            return list(CreateVmStartupPolicyApiResponsedata.discriminator_value_class_map.keys())[list(CreateVmStartupPolicyApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(CreateVmStartupPolicyApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateVmStartupPolicyApiResponsedata):
            return False
