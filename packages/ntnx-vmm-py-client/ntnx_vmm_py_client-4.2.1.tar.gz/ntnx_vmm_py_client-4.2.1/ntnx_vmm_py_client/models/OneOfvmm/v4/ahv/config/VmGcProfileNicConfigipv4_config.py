...
class VmGcProfileNicConfigipv4_config(object):
    ...
    discriminator_value_class_map = {
        ...
        'vmm.v4.ahv.config.VmGcProfileUseDhcp': 'vmm.v4.ahv.config.VmGcProfileUseDhcp',
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.ahv.config.VmGcProfileNicConfigipv4_config'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in VmGcProfileNicConfigipv4_config.discriminator_value_class_map.values():
            return list(VmGcProfileNicConfigipv4_config.discriminator_value_class_map.keys())[list(VmGcProfileNicConfigipv4_config.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VmGcProfileNicConfigipv4_config, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VmGcProfileNicConfigipv4_config):
            return False
