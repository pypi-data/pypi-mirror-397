...
class Imagechecksum(object):
    ...
    discriminator_value_class_map = {
        ...
        'vmm.v4.content.ImageSha1Checksum': 'vmm.v4.content.ImageSha1Checksum',
        'vmm.v4.content.ImageSha256Checksum': 'vmm.v4.content.ImageSha256Checksum'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.content.Imagechecksum'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in Imagechecksum.discriminator_value_class_map.values():
            return list(Imagechecksum.discriminator_value_class_map.keys())[list(Imagechecksum.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(Imagechecksum, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, Imagechecksum):
            return False
