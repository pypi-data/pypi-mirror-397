...
class UpdateTemplateApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.content.UpdateTemplateApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in UpdateTemplateApiResponsedata.discriminator_value_class_map.values():
            return list(UpdateTemplateApiResponsedata.discriminator_value_class_map.keys())[list(UpdateTemplateApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(UpdateTemplateApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateTemplateApiResponsedata):
            return False
