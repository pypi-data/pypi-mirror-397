...
class VmGcProfileSysprepParamsworkgroup_or_domain_info(object):
    ...
    discriminator_value_class_map = {
        ...
        'vmm.v4.ahv.config.VmGcProfileWorkgroup': 'vmm.v4.ahv.config.VmGcProfileWorkgroup',
        'vmm.v4.ahv.config.VmGcProfileDomainSettings': 'vmm.v4.ahv.config.VmGcProfileDomainSettings'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.ahv.config.VmGcProfileSysprepParamsworkgroup_or_domain_info'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in VmGcProfileSysprepParamsworkgroup_or_domain_info.discriminator_value_class_map.values():
            return list(VmGcProfileSysprepParamsworkgroup_or_domain_info.discriminator_value_class_map.keys())[list(VmGcProfileSysprepParamsworkgroup_or_domain_info.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VmGcProfileSysprepParamsworkgroup_or_domain_info, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VmGcProfileSysprepParamsworkgroup_or_domain_info):
            return False
