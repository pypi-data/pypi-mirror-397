...
class GetCdRomApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.ahv.config.GetCdRomApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetCdRomApiResponsedata.discriminator_value_class_map.values():
            return list(GetCdRomApiResponsedata.discriminator_value_class_map.keys())[list(GetCdRomApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetCdRomApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetCdRomApiResponsedata):
            return False
