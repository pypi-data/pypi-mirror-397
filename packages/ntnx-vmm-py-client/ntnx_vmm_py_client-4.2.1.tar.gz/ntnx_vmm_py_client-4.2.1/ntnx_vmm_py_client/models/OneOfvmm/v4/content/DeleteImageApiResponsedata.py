...
class DeleteImageApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.content.DeleteImageApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in DeleteImageApiResponsedata.discriminator_value_class_map.values():
            return list(DeleteImageApiResponsedata.discriminator_value_class_map.keys())[list(DeleteImageApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(DeleteImageApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteImageApiResponsedata):
            return False
