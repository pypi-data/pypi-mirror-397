...
class CreateVMRecoveryPointApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.ahv.config.CreateVMRecoveryPointApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in CreateVMRecoveryPointApiResponsedata.discriminator_value_class_map.values():
            return list(CreateVMRecoveryPointApiResponsedata.discriminator_value_class_map.keys())[list(CreateVMRecoveryPointApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(CreateVMRecoveryPointApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateVMRecoveryPointApiResponsedata):
            return False
