...
class VmGcProfileLocaleSettingsOverrideSpecuser_locale(object):
    ...
    ONE_OF_ITEM_DISCRIMINATOR_NAME = '$userLocaleItemDiscriminator'
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.ahv.config.VmGcProfileLocaleSettingsOverrideSpecuser_locale'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in VmGcProfileLocaleSettingsOverrideSpecuser_locale.discriminator_value_class_map.values():
            return list(VmGcProfileLocaleSettingsOverrideSpecuser_locale.discriminator_value_class_map.keys())[list(VmGcProfileLocaleSettingsOverrideSpecuser_locale.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VmGcProfileLocaleSettingsOverrideSpecuser_locale, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VmGcProfileLocaleSettingsOverrideSpecuser_locale):
            return False
