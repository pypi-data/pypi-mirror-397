...
class ListSerialPortsApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.ahv.config.ListSerialPortsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListSerialPortsApiResponsedata.discriminator_value_class_map.values():
            return list(ListSerialPortsApiResponsedata.discriminator_value_class_map.keys())[list(ListSerialPortsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListSerialPortsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListSerialPortsApiResponsedata):
            return False
