...
class InsertVmGuestToolsApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.ahv.config.InsertVmGuestToolsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in InsertVmGuestToolsApiResponsedata.discriminator_value_class_map.values():
            return list(InsertVmGuestToolsApiResponsedata.discriminator_value_class_map.keys())[list(InsertVmGuestToolsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(InsertVmGuestToolsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InsertVmGuestToolsApiResponsedata):
            return False
