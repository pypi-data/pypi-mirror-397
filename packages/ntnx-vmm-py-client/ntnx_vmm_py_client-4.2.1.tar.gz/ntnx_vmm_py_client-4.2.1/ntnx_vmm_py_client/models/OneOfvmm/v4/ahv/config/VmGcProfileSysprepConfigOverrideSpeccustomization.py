...
class VmGcProfileSysprepConfigOverrideSpeccustomization(object):
    ...
    discriminator_value_class_map = {
        ...
        'vmm.v4.ahv.config.VmGcProfileSysprepParamsOverrideSpec': 'vmm.v4.ahv.config.VmGcProfileSysprepParamsOverrideSpec',
        'vmm.v4.ahv.config.VmGcProfileAnswerFileOverrideSpec': 'vmm.v4.ahv.config.VmGcProfileAnswerFileOverrideSpec'
    }

    ONE_OF_ITEM_DISCRIMINATOR_NAME = '$customizationItemDiscriminator'
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.ahv.config.VmGcProfileSysprepConfigOverrideSpeccustomization'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in VmGcProfileSysprepConfigOverrideSpeccustomization.discriminator_value_class_map.values():
            return list(VmGcProfileSysprepConfigOverrideSpeccustomization.discriminator_value_class_map.keys())[list(VmGcProfileSysprepConfigOverrideSpeccustomization.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VmGcProfileSysprepConfigOverrideSpeccustomization, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VmGcProfileSysprepConfigOverrideSpeccustomization):
            return False
