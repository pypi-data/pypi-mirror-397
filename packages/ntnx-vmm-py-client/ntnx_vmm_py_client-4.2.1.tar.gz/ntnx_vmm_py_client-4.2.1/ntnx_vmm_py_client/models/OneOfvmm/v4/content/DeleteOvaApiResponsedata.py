...
class DeleteOvaApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.content.DeleteOvaApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in DeleteOvaApiResponsedata.discriminator_value_class_map.values():
            return list(DeleteOvaApiResponsedata.discriminator_value_class_map.keys())[list(DeleteOvaApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(DeleteOvaApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteOvaApiResponsedata):
            return False
