...
class ReEnforceVmHostAffinityPolicyApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.ahv.policies.ReEnforceVmHostAffinityPolicyApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ReEnforceVmHostAffinityPolicyApiResponsedata.discriminator_value_class_map.values():
            return list(ReEnforceVmHostAffinityPolicyApiResponsedata.discriminator_value_class_map.keys())[list(ReEnforceVmHostAffinityPolicyApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ReEnforceVmHostAffinityPolicyApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ReEnforceVmHostAffinityPolicyApiResponsedata):
            return False
