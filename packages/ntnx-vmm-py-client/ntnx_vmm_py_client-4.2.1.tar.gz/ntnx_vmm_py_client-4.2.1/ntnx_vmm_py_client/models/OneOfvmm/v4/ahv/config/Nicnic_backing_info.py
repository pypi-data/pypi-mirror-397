...
class Nicnic_backing_info(object):
    ...
    discriminator_value_class_map = {
        ...
        'vmm.v4.ahv.config.VirtualEthernetNic': 'vmm.v4.ahv.config.VirtualEthernetNic',
        'vmm.v4.ahv.config.SriovNic': 'vmm.v4.ahv.config.SriovNic',
        'vmm.v4.ahv.config.DpOffloadNic': 'vmm.v4.ahv.config.DpOffloadNic'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.ahv.config.Nicnic_backing_info'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in Nicnic_backing_info.discriminator_value_class_map.values():
            return list(Nicnic_backing_info.discriminator_value_class_map.keys())[list(Nicnic_backing_info.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(Nicnic_backing_info, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, Nicnic_backing_info):
            return False
