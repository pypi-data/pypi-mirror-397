...
class EnableVmDiskHydrationApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.ahv.config.EnableVmDiskHydrationApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in EnableVmDiskHydrationApiResponsedata.discriminator_value_class_map.values():
            return list(EnableVmDiskHydrationApiResponsedata.discriminator_value_class_map.keys())[list(EnableVmDiskHydrationApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(EnableVmDiskHydrationApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EnableVmDiskHydrationApiResponsedata):
            return False
