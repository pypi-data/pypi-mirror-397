...
class VmGcProfileNicConfigOverrideSpecipv4_config(object):
    ...
    discriminator_value_class_map = {
        ...
        'vmm.v4.ahv.config.VmGcProfileUseDhcpOverrideSpec': 'vmm.v4.ahv.config.VmGcProfileUseDhcpOverrideSpec',
        'vmm.v4.ahv.config.VmGcProfileNicIpv4ConfigOverrideSpec': 'vmm.v4.ahv.config.VmGcProfileNicIpv4ConfigOverrideSpec'
    }

    ONE_OF_ITEM_DISCRIMINATOR_NAME = '$ipv4ConfigItemDiscriminator'
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.ahv.config.VmGcProfileNicConfigOverrideSpecipv4_config'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in VmGcProfileNicConfigOverrideSpecipv4_config.discriminator_value_class_map.values():
            return list(VmGcProfileNicConfigOverrideSpecipv4_config.discriminator_value_class_map.keys())[list(VmGcProfileNicConfigOverrideSpecipv4_config.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VmGcProfileNicConfigOverrideSpecipv4_config, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VmGcProfileNicConfigOverrideSpecipv4_config):
            return False
