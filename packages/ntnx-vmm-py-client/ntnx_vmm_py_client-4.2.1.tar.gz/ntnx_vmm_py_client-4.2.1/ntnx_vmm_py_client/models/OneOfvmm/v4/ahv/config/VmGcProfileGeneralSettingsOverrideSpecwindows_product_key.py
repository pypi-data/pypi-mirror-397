...
class VmGcProfileGeneralSettingsOverrideSpecwindows_product_key(object):
    ...
    discriminator_value_class_map = {
        ...
        'vmm.v4.ahv.config.VmGcProfileWindowsProductKey': 'vmm.v4.ahv.config.VmGcProfileWindowsProductKey',
        'vmm.v4.ahv.config.VmGcProfileDiscardSettings': 'vmm.v4.ahv.config.VmGcProfileDiscardSettings'
    }

    ONE_OF_ITEM_DISCRIMINATOR_NAME = '$windowsProductKeyItemDiscriminator'
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.ahv.config.VmGcProfileGeneralSettingsOverrideSpecwindows_product_key'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in VmGcProfileGeneralSettingsOverrideSpecwindows_product_key.discriminator_value_class_map.values():
            return list(VmGcProfileGeneralSettingsOverrideSpecwindows_product_key.discriminator_value_class_map.keys())[list(VmGcProfileGeneralSettingsOverrideSpecwindows_product_key.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VmGcProfileGeneralSettingsOverrideSpecwindows_product_key, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VmGcProfileGeneralSettingsOverrideSpecwindows_product_key):
            return False
