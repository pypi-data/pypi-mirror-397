...
class GetOvaApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'vmm.v4.content.Ova': 'vmm.v4.content.Ova',
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.content.GetOvaApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetOvaApiResponsedata.discriminator_value_class_map.values():
            return list(GetOvaApiResponsedata.discriminator_value_class_map.keys())[list(GetOvaApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetOvaApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetOvaApiResponsedata):
            return False
