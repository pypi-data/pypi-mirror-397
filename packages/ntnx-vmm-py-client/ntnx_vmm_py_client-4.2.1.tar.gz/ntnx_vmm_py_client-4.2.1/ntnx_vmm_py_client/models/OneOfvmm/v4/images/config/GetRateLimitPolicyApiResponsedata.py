...
class GetRateLimitPolicyApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'vmm.v4.images.config.RateLimitPolicy': 'vmm.v4.images.config.RateLimitPolicy',
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.images.config.GetRateLimitPolicyApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetRateLimitPolicyApiResponsedata.discriminator_value_class_map.values():
            return list(GetRateLimitPolicyApiResponsedata.discriminator_value_class_map.keys())[list(GetRateLimitPolicyApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetRateLimitPolicyApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetRateLimitPolicyApiResponsedata):
            return False
