...
class GetVmRecoveryPointApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'vmm.v4.ahv.config.VmRecoveryPoint': 'vmm.v4.ahv.config.VmRecoveryPoint',
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.ahv.config.GetVmRecoveryPointApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetVmRecoveryPointApiResponsedata.discriminator_value_class_map.values():
            return list(GetVmRecoveryPointApiResponsedata.discriminator_value_class_map.keys())[list(GetVmRecoveryPointApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetVmRecoveryPointApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetVmRecoveryPointApiResponsedata):
            return False
