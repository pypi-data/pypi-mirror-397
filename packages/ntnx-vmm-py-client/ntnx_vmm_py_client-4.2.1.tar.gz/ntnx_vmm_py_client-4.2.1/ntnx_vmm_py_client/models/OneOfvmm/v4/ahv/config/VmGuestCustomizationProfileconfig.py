...
class VmGuestCustomizationProfileconfig(object):
    ...
    discriminator_value_class_map = {
        ...
        'vmm.v4.ahv.config.VmGcProfileSysprepConfig': 'vmm.v4.ahv.config.VmGcProfileSysprepConfig'
    }

    ONE_OF_ITEM_DISCRIMINATOR_NAME = '$configItemDiscriminator'
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.ahv.config.VmGuestCustomizationProfileconfig'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in VmGuestCustomizationProfileconfig.discriminator_value_class_map.values():
            return list(VmGuestCustomizationProfileconfig.discriminator_value_class_map.keys())[list(VmGuestCustomizationProfileconfig.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VmGuestCustomizationProfileconfig, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VmGuestCustomizationProfileconfig):
            return False
