...
class ListCdRomsApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.ahv.config.ListCdRomsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListCdRomsApiResponsedata.discriminator_value_class_map.values():
            return list(ListCdRomsApiResponsedata.discriminator_value_class_map.keys())[list(ListCdRomsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListCdRomsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListCdRomsApiResponsedata):
            return False
