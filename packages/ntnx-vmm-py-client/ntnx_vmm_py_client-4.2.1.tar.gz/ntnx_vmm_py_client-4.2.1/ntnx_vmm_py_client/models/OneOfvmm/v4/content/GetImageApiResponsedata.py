...
class GetImageApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'vmm.v4.content.Image': 'vmm.v4.content.Image',
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.content.GetImageApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetImageApiResponsedata.discriminator_value_class_map.values():
            return list(GetImageApiResponsedata.discriminator_value_class_map.keys())[list(GetImageApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetImageApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetImageApiResponsedata):
            return False
