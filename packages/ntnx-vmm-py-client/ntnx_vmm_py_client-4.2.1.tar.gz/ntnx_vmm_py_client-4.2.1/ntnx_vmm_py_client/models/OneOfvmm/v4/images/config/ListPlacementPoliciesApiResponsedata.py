...
class ListPlacementPoliciesApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<vmm.v4.images.config.PlacementPolicy>': 'list[vmm.v4.images.config.PlacementPolicy]',
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.images.config.ListPlacementPoliciesApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListPlacementPoliciesApiResponsedata.discriminator_value_class_map.values():
            return list(ListPlacementPoliciesApiResponsedata.discriminator_value_class_map.keys())[list(ListPlacementPoliciesApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListPlacementPoliciesApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListPlacementPoliciesApiResponsedata):
            return False
