...
class ListVmRecoveryPointsApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<vmm.v4.ahv.config.VmRecoveryPoint>': 'list[vmm.v4.ahv.config.VmRecoveryPoint]',
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.ahv.config.ListVmRecoveryPointsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListVmRecoveryPointsApiResponsedata.discriminator_value_class_map.values():
            return list(ListVmRecoveryPointsApiResponsedata.discriminator_value_class_map.keys())[list(ListVmRecoveryPointsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListVmRecoveryPointsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListVmRecoveryPointsApiResponsedata):
            return False
