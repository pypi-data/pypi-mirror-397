...
class VmHostAffinityPolicyVmComplianceStatecompliance_status(object):
    ...
    discriminator_value_class_map = {
        ...
        'vmm.v4.ahv.policies.CompliantVmHostAffinityPolicy': 'vmm.v4.ahv.policies.CompliantVmHostAffinityPolicy',
        'vmm.v4.ahv.policies.NonCompliantVmHostAffinityPolicy': 'vmm.v4.ahv.policies.NonCompliantVmHostAffinityPolicy',
        'vmm.v4.ahv.policies.PendingVmHostAffinityPolicy': 'vmm.v4.ahv.policies.PendingVmHostAffinityPolicy'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.ahv.policies.VmHostAffinityPolicyVmComplianceStatecompliance_status'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in VmHostAffinityPolicyVmComplianceStatecompliance_status.discriminator_value_class_map.values():
            return list(VmHostAffinityPolicyVmComplianceStatecompliance_status.discriminator_value_class_map.keys())[list(VmHostAffinityPolicyVmComplianceStatecompliance_status.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VmHostAffinityPolicyVmComplianceStatecompliance_status, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VmHostAffinityPolicyVmComplianceStatecompliance_status):
            return False
