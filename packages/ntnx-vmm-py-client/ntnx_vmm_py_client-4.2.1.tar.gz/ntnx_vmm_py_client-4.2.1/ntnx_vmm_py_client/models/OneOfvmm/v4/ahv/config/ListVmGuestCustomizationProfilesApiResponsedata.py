...
class ListVmGuestCustomizationProfilesApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<vmm.v4.ahv.config.VmGuestCustomizationProfile>': 'list[vmm.v4.ahv.config.VmGuestCustomizationProfile]',
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.ahv.config.ListVmGuestCustomizationProfilesApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListVmGuestCustomizationProfilesApiResponsedata.discriminator_value_class_map.values():
            return list(ListVmGuestCustomizationProfilesApiResponsedata.discriminator_value_class_map.keys())[list(ListVmGuestCustomizationProfilesApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListVmGuestCustomizationProfilesApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListVmGuestCustomizationProfilesApiResponsedata):
            return False
