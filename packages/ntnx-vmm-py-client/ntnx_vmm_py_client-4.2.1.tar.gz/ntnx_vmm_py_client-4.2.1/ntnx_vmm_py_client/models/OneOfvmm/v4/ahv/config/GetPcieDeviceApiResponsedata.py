...
class GetPcieDeviceApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'vmm.v4.ahv.config.PcieDevice': 'vmm.v4.ahv.config.PcieDevice',
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.ahv.config.GetPcieDeviceApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetPcieDeviceApiResponsedata.discriminator_value_class_map.values():
            return list(GetPcieDeviceApiResponsedata.discriminator_value_class_map.keys())[list(GetPcieDeviceApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetPcieDeviceApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetPcieDeviceApiResponsedata):
            return False
