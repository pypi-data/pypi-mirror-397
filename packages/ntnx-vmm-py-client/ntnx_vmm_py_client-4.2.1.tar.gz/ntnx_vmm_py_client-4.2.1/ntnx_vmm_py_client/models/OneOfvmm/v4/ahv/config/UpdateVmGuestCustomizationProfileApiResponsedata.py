...
class UpdateVmGuestCustomizationProfileApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.ahv.config.UpdateVmGuestCustomizationProfileApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in UpdateVmGuestCustomizationProfileApiResponsedata.discriminator_value_class_map.values():
            return list(UpdateVmGuestCustomizationProfileApiResponsedata.discriminator_value_class_map.keys())[list(UpdateVmGuestCustomizationProfileApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(UpdateVmGuestCustomizationProfileApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateVmGuestCustomizationProfileApiResponsedata):
            return False
