...
class PublishTemplateApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.content.PublishTemplateApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in PublishTemplateApiResponsedata.discriminator_value_class_map.values():
            return list(PublishTemplateApiResponsedata.discriminator_value_class_map.keys())[list(PublishTemplateApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(PublishTemplateApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PublishTemplateApiResponsedata):
            return False
