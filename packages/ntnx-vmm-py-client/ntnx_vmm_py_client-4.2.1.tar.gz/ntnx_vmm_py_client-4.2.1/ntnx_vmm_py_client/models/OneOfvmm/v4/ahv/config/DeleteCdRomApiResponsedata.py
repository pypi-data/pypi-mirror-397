...
class DeleteCdRomApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.ahv.config.DeleteCdRomApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in DeleteCdRomApiResponsedata.discriminator_value_class_map.values():
            return list(DeleteCdRomApiResponsedata.discriminator_value_class_map.keys())[list(DeleteCdRomApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(DeleteCdRomApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteCdRomApiResponsedata):
            return False
