...
class EnableVmCdRomHydrationApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.ahv.config.EnableVmCdRomHydrationApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in EnableVmCdRomHydrationApiResponsedata.discriminator_value_class_map.values():
            return list(EnableVmCdRomHydrationApiResponsedata.discriminator_value_class_map.keys())[list(EnableVmCdRomHydrationApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(EnableVmCdRomHydrationApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EnableVmCdRomHydrationApiResponsedata):
            return False
