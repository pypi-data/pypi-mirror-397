...
class StartConditionpower_state_criteria(object):
    ...
    discriminator_value_class_map = {
        ...
        'vmm.v4.ahv.policies.PowerStateCriteriaPowerOn': 'vmm.v4.ahv.policies.PowerStateCriteriaPowerOn',
        'vmm.v4.ahv.policies.PowerStateCriteriaGuestBootup': 'vmm.v4.ahv.policies.PowerStateCriteriaGuestBootup'
    }

    ONE_OF_ITEM_DISCRIMINATOR_NAME = '$powerStateCriteriaItemDiscriminator'
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.ahv.policies.StartConditionpower_state_criteria'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in StartConditionpower_state_criteria.discriminator_value_class_map.values():
            return list(StartConditionpower_state_criteria.discriminator_value_class_map.keys())[list(StartConditionpower_state_criteria.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(StartConditionpower_state_criteria, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StartConditionpower_state_criteria):
            return False
