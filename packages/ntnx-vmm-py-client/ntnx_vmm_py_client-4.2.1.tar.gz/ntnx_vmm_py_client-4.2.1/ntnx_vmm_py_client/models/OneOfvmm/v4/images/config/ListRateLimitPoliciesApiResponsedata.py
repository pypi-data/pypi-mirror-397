...
class ListRateLimitPoliciesApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<vmm.v4.images.config.RateLimitPolicy>': 'list[vmm.v4.images.config.RateLimitPolicy]',
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.images.config.ListRateLimitPoliciesApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListRateLimitPoliciesApiResponsedata.discriminator_value_class_map.values():
            return list(ListRateLimitPoliciesApiResponsedata.discriminator_value_class_map.keys())[list(ListRateLimitPoliciesApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListRateLimitPoliciesApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListRateLimitPoliciesApiResponsedata):
            return False
