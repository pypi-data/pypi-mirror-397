...
class GetVmGuestCustomizationProfileApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'vmm.v4.ahv.config.VmGuestCustomizationProfile': 'vmm.v4.ahv.config.VmGuestCustomizationProfile',
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.ahv.config.GetVmGuestCustomizationProfileApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetVmGuestCustomizationProfileApiResponsedata.discriminator_value_class_map.values():
            return list(GetVmGuestCustomizationProfileApiResponsedata.discriminator_value_class_map.keys())[list(GetVmGuestCustomizationProfileApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetVmGuestCustomizationProfileApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetVmGuestCustomizationProfileApiResponsedata):
            return False
