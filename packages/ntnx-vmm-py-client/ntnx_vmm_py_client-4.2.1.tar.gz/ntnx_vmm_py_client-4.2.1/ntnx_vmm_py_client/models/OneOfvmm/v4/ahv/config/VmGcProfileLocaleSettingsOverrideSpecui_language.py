...
class VmGcProfileLocaleSettingsOverrideSpecui_language(object):
    ...
    ONE_OF_ITEM_DISCRIMINATOR_NAME = '$uiLanguageItemDiscriminator'
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.ahv.config.VmGcProfileLocaleSettingsOverrideSpecui_language'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in VmGcProfileLocaleSettingsOverrideSpecui_language.discriminator_value_class_map.values():
            return list(VmGcProfileLocaleSettingsOverrideSpecui_language.discriminator_value_class_map.keys())[list(VmGcProfileLocaleSettingsOverrideSpecui_language.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VmGcProfileLocaleSettingsOverrideSpecui_language, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VmGcProfileLocaleSettingsOverrideSpecui_language):
            return False
