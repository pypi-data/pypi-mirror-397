...
class ListTemplatePlacementPoliciesApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<vmm.v4.config.TemplatePlacementPolicy>': 'list[vmm.v4.config.TemplatePlacementPolicy]',
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.config.ListTemplatePlacementPoliciesApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListTemplatePlacementPoliciesApiResponsedata.discriminator_value_class_map.values():
            return list(ListTemplatePlacementPoliciesApiResponsedata.discriminator_value_class_map.keys())[list(ListTemplatePlacementPoliciesApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListTemplatePlacementPoliciesApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListTemplatePlacementPoliciesApiResponsedata):
            return False
