...
class VmGcProfileGeneralSettingscomputer_name(object):
    ...
    discriminator_value_class_map = {
        ...
        'vmm.v4.ahv.config.VmGcProfileUseVmName': 'vmm.v4.ahv.config.VmGcProfileUseVmName',
        'vmm.v4.ahv.config.VmGcProfileMustProvideDuringDeployment': 'vmm.v4.ahv.config.VmGcProfileMustProvideDuringDeployment'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.ahv.config.VmGcProfileGeneralSettingscomputer_name'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in VmGcProfileGeneralSettingscomputer_name.discriminator_value_class_map.values():
            return list(VmGcProfileGeneralSettingscomputer_name.discriminator_value_class_map.keys())[list(VmGcProfileGeneralSettingscomputer_name.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VmGcProfileGeneralSettingscomputer_name, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VmGcProfileGeneralSettingscomputer_name):
            return False
