...
class CrossClusterMigrateVmApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.ahv.config.CrossClusterMigrateVmApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in CrossClusterMigrateVmApiResponsedata.discriminator_value_class_map.values():
            return list(CrossClusterMigrateVmApiResponsedata.discriminator_value_class_map.keys())[list(CrossClusterMigrateVmApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(CrossClusterMigrateVmApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CrossClusterMigrateVmApiResponsedata):
            return False
