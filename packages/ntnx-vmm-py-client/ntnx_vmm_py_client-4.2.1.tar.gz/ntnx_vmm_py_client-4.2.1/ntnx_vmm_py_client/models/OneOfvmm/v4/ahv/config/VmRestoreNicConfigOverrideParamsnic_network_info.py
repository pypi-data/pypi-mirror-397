...
class VmRestoreNicConfigOverrideParamsnic_network_info(object):
    ...
    discriminator_value_class_map = {
        ...
        'vmm.v4.ahv.config.VmRestoreVirtualEthernetNicNetworkInfoOverrideSpec': 'vmm.v4.ahv.config.VmRestoreVirtualEthernetNicNetworkInfoOverrideSpec'
    }

    ONE_OF_ITEM_DISCRIMINATOR_NAME = '$nicNetworkInfoItemDiscriminator'
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.ahv.config.VmRestoreNicConfigOverrideParamsnic_network_info'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in VmRestoreNicConfigOverrideParamsnic_network_info.discriminator_value_class_map.values():
            return list(VmRestoreNicConfigOverrideParamsnic_network_info.discriminator_value_class_map.keys())[list(VmRestoreNicConfigOverrideParamsnic_network_info.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VmRestoreNicConfigOverrideParamsnic_network_info, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VmRestoreNicConfigOverrideParamsnic_network_info):
            return False
