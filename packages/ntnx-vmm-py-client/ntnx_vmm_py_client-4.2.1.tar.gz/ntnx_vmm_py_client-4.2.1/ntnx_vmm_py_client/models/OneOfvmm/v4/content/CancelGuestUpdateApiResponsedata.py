...
class CancelGuestUpdateApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.content.CancelGuestUpdateApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in CancelGuestUpdateApiResponsedata.discriminator_value_class_map.values():
            return list(CancelGuestUpdateApiResponsedata.discriminator_value_class_map.keys())[list(CancelGuestUpdateApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(CancelGuestUpdateApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CancelGuestUpdateApiResponsedata):
            return False
