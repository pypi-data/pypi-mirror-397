...
class VmGcProfileSysprepConfigcustomization(object):
    ...
    discriminator_value_class_map = {
        ...
        'vmm.v4.ahv.config.VmGcProfileSysprepParams': 'vmm.v4.ahv.config.VmGcProfileSysprepParams',
        'vmm.v4.ahv.config.VmGcProfileAnswerFile': 'vmm.v4.ahv.config.VmGcProfileAnswerFile'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.ahv.config.VmGcProfileSysprepConfigcustomization'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in VmGcProfileSysprepConfigcustomization.discriminator_value_class_map.values():
            return list(VmGcProfileSysprepConfigcustomization.discriminator_value_class_map.keys())[list(VmGcProfileSysprepConfigcustomization.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VmGcProfileSysprepConfigcustomization, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VmGcProfileSysprepConfigcustomization):
            return False
