...
from ntnx_vmm_py_client.models.OneOfvmm.v4.ahv.config.AddVmDiskCustomAttributesApiResponsedata import AddVmDiskCustomAttributesApiResponsedata  # noqa: F401,E501
from ntnx_vmm_py_client.models.common.v1.response.ApiResponseMetadata import ApiResponseMetadata  # noqa: F401,E501

class AddVmDiskCustomAttributesApiResponse(object):
    ...
    swagger_types = {
        ...
        'data': 'OneOfvmm.v4.ahv.config.AddVmDiskCustomAttributesApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.ahv.config.AddVmDiskCustomAttributesApiResponse'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(AddVmDiskCustomAttributesApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AddVmDiskCustomAttributesApiResponse):
            return False
