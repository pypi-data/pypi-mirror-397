...
class ADSFDiskMigrationPlan(object):
    ...
    :param vm_disks: (:attr:`vm_disks`) The disks included in the migration plan.
    :type vm_disks: 
    ...
    swagger_types = {
        ...
        'vm_disks': 'list[vmm.v4.ahv.config.MigrateDiskReference]',
