...
class VmGcProfileMustProvideDuringDeployment(object):
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.ahv.config.VmGcProfileMustProvideDuringDeployment'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VmGcProfileMustProvideDuringDeployment, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VmGcProfileMustProvideDuringDeployment):
            return False
