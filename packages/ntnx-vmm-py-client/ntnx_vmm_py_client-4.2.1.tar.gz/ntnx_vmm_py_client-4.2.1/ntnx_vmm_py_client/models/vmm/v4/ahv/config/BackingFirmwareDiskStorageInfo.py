...
class BackingFirmwareDiskStorageInfo(object):
    ...
    def __init__(self, storage_container=None, *args, **kwargs):  # noqa: E501
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.ahv.config.BackingFirmwareDiskStorageInfo'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(BackingFirmwareDiskStorageInfo, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BackingFirmwareDiskStorageInfo):
            return False
