...
class SuspendPlacementPolicyConfig(object):
    ...
    :param should_cancel_running_tasks: (:attr:`should_cancel_running_tasks`) Boolean to indicate whether tasks running to enforce the image placement policy should be suspended. (**Default** False)
    :type should_cancel_running_tasks: 
    ...
    attribute_map = {
        'should_cancel_running_tasks': 'shouldCancelRunningTasks',
        '_reserved': '$reserved',
    ...
    def __init__(self, should_cancel_running_tasks=False, *args, **kwargs):  # noqa: E501
        self.__should_cancel_running_tasks = None
        self.discriminator = None
        if should_cancel_running_tasks is not None:
            self.__should_cancel_running_tasks = should_cancel_running_tasks
        # populate hidden vars if not empty
        self._populate_hidden_vars(kwargs)

    def _initialize_object_type(self):
        return 'vmm.v4.images.config.SuspendPlacementPolicyConfig'
    ...
    @property
    def should_cancel_running_tasks(self):
        """
        ...
        :type:
                :class:`~bool`
        """  # noqa: E501
        return self.__should_cancel_running_tasks

    @should_cancel_running_tasks.setter
    def should_cancel_running_tasks(self, should_cancel_running_tasks):
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(SuspendPlacementPolicyConfig, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SuspendPlacementPolicyConfig):
            return False
