...
class OvaSha256Checksum(object):

    """The SHA256 checksum of an OVA.

    :param hex_digest: (:attr:`hex_digest`) The SHA256 digest of an OVA file in hexadecimal format.
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.content.OvaSha256Checksum'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(OvaSha256Checksum, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OvaSha256Checksum):
            return False
