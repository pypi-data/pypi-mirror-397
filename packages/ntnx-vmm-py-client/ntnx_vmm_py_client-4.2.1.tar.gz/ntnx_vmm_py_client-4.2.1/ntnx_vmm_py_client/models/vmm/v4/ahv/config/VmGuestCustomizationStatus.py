...
class VmGuestCustomizationStatus(object):
    ...
    Allowed enum values:
        ...
        - _UNKNOWN
        - _REDACTED
        - PENDING: The Guest Customization process is pending and would be attempted on the next power-on of the VM.
    """
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    PENDING = "PENDING"
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.ahv.config.VmGuestCustomizationStatus'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VmGuestCustomizationStatus, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VmGuestCustomizationStatus):
            return False
