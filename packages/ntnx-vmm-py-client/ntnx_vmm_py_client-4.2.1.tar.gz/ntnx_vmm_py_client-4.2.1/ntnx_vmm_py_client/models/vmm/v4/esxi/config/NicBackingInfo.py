...
class NicBackingInfo(object):
    ...
    :param is_connected: (:attr:`is_connected`) Indicates whether the NIC is connected or not. Default is True.
    :type is_connected: 
    ...
    def __init__(self, mac_address=None, is_connected=None, adapter_type=None, *args, **kwargs):  # noqa: E501
