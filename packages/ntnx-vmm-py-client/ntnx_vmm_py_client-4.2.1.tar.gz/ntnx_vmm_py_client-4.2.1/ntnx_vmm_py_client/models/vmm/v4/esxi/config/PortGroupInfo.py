...
class PortGroupInfo(object):

    """Information about the virtual network in the datacenter.

    :param name: (:attr:`name`) Name of the Port Group.
    :type name: 
     max=128 chars
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.esxi.config.PortGroupInfo'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(PortGroupInfo, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PortGroupInfo):
            return False
