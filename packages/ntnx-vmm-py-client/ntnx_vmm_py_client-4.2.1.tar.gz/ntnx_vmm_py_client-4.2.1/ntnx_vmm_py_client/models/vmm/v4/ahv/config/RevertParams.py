...
from ntnx_vmm_py_client.models.vmm.v4.ahv.config.VmRevertOverrideSpec import VmRevertOverrideSpec  # noqa: F401,E501

class RevertParams(object):

    """Input for the VM revert operation. Specify the VM Recovery Point ID to which the VM would be reverted.

    :param vm_recovery_point_ext_id: (:attr:`vm_recovery_point_ext_id`) The external identifier of the VM Recovery Point.
    :type vm_recovery_point_ext_id: required
    
    
    :param override_spec: (:attr:`override_spec`) 
    :type override_spec: 
    ...
    swagger_types = {
        ...
        'override_spec': 'vmm.v4.ahv.config.VmRevertOverrideSpec',
    ...
    def __init__(self, vm_recovery_point_ext_id=None, override_spec=None, *args, **kwargs):  # noqa: E501
        self.__vm_recovery_point_ext_id = None
        self.__override_spec = None
        self.discriminator = None
        self.__vm_recovery_point_ext_id = vm_recovery_point_ext_id
        if override_spec is not None:
            self.__override_spec = override_spec
        # populate hidden vars if not empty
        self._populate_hidden_vars(kwargs)

    def _initialize_object_type(self):
        return 'vmm.v4.ahv.config.RevertParams'
    ...
    def vm_recovery_point_ext_id(self, vm_recovery_point_ext_id):
        if vm_recovery_point_ext_id is None:
            raise ValueError("Invalid value for `vm_recovery_point_ext_id`, must not be `None`")  # noqa: E501
    ...
    def override_spec(self):
        ...
        :type:
            :class:`~ntnx_vmm_py_client.models.vmm.v4.ahv.config.VmRevertOverrideSpec`
        """  # noqa: E501
        return self.__override_spec

    @override_spec.setter
    def override_spec(self, override_spec):
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(RevertParams, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RevertParams):
            return False
