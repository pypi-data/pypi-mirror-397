...
class UpdateCustomAttributesParams(object):

    """List of custom attributes to be added/removed.

    :param custom_attributes: (:attr:`custom_attributes`) List of custom attributes to be added/removed.
    :type custom_attributes: required
    ...
    def __init__(self, custom_attributes=None, *args, **kwargs):  # noqa: E501
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.ahv.config.UpdateCustomAttributesParams'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(UpdateCustomAttributesParams, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateCustomAttributesParams):
            return False
