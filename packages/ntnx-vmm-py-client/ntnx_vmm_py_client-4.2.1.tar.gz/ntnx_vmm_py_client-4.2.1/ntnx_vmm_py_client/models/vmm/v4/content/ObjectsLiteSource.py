...
class ObjectsLiteSource(object):

    """The object details for creating an image or OVA.

    :param key: (:attr:`key`) Key that identifies the source object in the bucket. The resource implies the bucket, 'vmm-images' for Image and 'vmm-ovas' for OVA.
    :type key: required
    ...
    def __init__(self, key=None, *args, **kwargs):  # noqa: E501
        self.__key = None
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.content.ObjectsLiteSource'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ObjectsLiteSource, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ObjectsLiteSource):
            return False
