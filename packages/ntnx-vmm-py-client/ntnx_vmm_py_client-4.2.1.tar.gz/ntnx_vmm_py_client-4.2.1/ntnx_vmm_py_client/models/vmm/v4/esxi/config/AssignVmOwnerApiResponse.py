...
from ntnx_vmm_py_client.models.OneOfvmm.v4.esxi.config.AssignVmOwnerApiResponsedata import AssignVmOwnerApiResponsedata  # noqa: F401,E501
from ntnx_vmm_py_client.models.common.v1.response.ApiResponseMetadata import ApiResponseMetadata  # noqa: F401,E501

class AssignVmOwnerApiResponse(object):
    ...
    swagger_types = {
        ...
        'data': 'OneOfvmm.v4.esxi.config.AssignVmOwnerApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.esxi.config.AssignVmOwnerApiResponse'
    ...
    def _to_dict(self, sanitize):
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if attr_type.startswith('OneOf'):
                type = getattr(ntnx_vmm_py_client.models, 'EsxiConfigAssignVmOwnerApiResponse')
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(AssignVmOwnerApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AssignVmOwnerApiResponse):
            return False
