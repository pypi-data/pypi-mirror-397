...
from ntnx_vmm_py_client.models.OneOfvmm.v4.esxi.config.UpgradeNutanixGuestToolsApiResponsedata import UpgradeNutanixGuestToolsApiResponsedata  # noqa: F401,E501
from ntnx_vmm_py_client.models.common.v1.response.ApiResponseMetadata import ApiResponseMetadata  # noqa: F401,E501

class UpgradeNutanixGuestToolsApiResponse(object):
    ...
    swagger_types = {
        ...
        'data': 'OneOfvmm.v4.esxi.config.UpgradeNutanixGuestToolsApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.esxi.config.UpgradeNutanixGuestToolsApiResponse'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(UpgradeNutanixGuestToolsApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpgradeNutanixGuestToolsApiResponse):
            return False
