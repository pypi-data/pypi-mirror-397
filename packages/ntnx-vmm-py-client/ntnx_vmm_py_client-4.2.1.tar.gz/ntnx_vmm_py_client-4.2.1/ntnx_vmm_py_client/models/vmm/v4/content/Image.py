...
class Image(ExternalizableAbstractModel):
    ...
    :param owner_name: (:attr:`owner_name`) Name of the owner of the image.
    :type owner_name: 
    ...
    def __init__(self, name=None, description=None, type=None, checksum=None, size_bytes=None, source=None, category_ext_ids=None, cluster_location_ext_ids=None, create_time=None, last_update_time=None, owner_ext_id=None, owner_name=None, placement_policy_status=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
