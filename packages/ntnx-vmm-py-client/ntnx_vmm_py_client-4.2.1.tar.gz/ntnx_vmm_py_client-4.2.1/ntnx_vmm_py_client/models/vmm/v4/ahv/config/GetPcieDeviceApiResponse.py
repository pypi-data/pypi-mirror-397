...
from ntnx_vmm_py_client.models.OneOfvmm.v4.ahv.config.GetPcieDeviceApiResponsedata import GetPcieDeviceApiResponsedata  # noqa: F401,E501
from ntnx_vmm_py_client.models.common.v1.response.ApiResponseMetadata import ApiResponseMetadata  # noqa: F401,E501

class GetPcieDeviceApiResponse(object):
    ...
    swagger_types = {
        ...
        'data': 'OneOfvmm.v4.ahv.config.GetPcieDeviceApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.ahv.config.GetPcieDeviceApiResponse'
    ...
    def data(self):
        ...
        :type:
                :class:`~ntnx_vmm_py_client.models.vmm.v4.ahv.config.PcieDevice` | 
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetPcieDeviceApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetPcieDeviceApiResponse):
            return False
