...
from ntnx_vmm_py_client.models.vmm.v4.ahv.config.ProjectReference import ProjectReference  # noqa: F401,E501
...
from ntnx_vmm_py_client.models.vmm.v4.ahv.config.VmGuestCustomizationStatus import VmGuestCustomizationStatus  # noqa: F401,E501
...
class Vm(ExternalizableAbstractModel):
    ...
    :param enabled_cpu_features: (:attr:`enabled_cpu_features`) The list of additional CPU features to be enabled.
    ...
    :param custom_attributes: (:attr:`custom_attributes`) A collection of user-defined key/value pairs as strings in the format 'key:value' representing custom attributes of the VM.
    :type custom_attributes: 
    
    
    :param vm_guest_customization_status: (:attr:`vm_guest_customization_status`) 
    :type vm_guest_customization_status: 
    ...
    swagger_types = {
        ...
        'project': 'vmm.v4.ahv.config.ProjectReference',
        ...
        'vm_guest_customization_status': 'vmm.v4.ahv.config.VmGuestCustomizationStatus',
        'ext_id': 'str',
    ...
    attribute_map = {
        ...
        'vm_guest_customization_status': 'vmGuestCustomizationStatus',
        'ext_id': 'extId',
        'links': 'links',
        'tenant_id': 'tenantId',
        '_reserved': '$reserved',
    ...
    def __init__(self, name=None, description=None, create_time=None, update_time=None, source=None, num_sockets=None, num_cores_per_socket=None, num_threads_per_core=None, num_numa_nodes=None, memory_size_bytes=None, is_vcpu_hard_pinning_enabled=None, is_cpu_passthrough_enabled=None, enabled_cpu_features=None, is_memory_overcommit_enabled=None, is_gpu_console_enabled=None, is_cpu_hotplug_enabled=None, is_scsi_controller_enabled=None, generation_uuid=None, bios_uuid=None, categories=None, project=None, ownership_info=None, host=None, cluster=None, availability_zone=None, guest_customization=None, guest_tools=None, hardware_clock_timezone='UTC', is_branding_enabled=None, boot_config=None, is_vga_console_enabled=None, machine_type=None, power_state=None, vtpm_config=None, is_agent_vm=None, apc_config=None, is_live_migrate_capable=None, is_cross_cluster_migration_in_progress=None, storage_config=None, disks=None, cd_roms=None, nics=None, gpus=None, serial_ports=None, protection_type=None, protection_policy_state=None, pcie_devices=None, custom_attributes=None, vm_guest_customization_status=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
        ...
        self.__vm_guest_customization_status = None
        ...
        if vm_guest_customization_status is not None:
            self.__vm_guest_customization_status = vm_guest_customization_status
    ...
    def project(self):
        ...
        :type:
            :class:`~ntnx_vmm_py_client.models.vmm.v4.ahv.config.ProjectReference`
        """  # noqa: E501
    ...
    @property
    def vm_guest_customization_status(self):
        """
        

        :type:
            :class:`~ntnx_vmm_py_client.models.vmm.v4.ahv.config.VmGuestCustomizationStatus`
        """  # noqa: E501
        return self.__vm_guest_customization_status

    @vm_guest_customization_status.setter
    def vm_guest_customization_status(self, vm_guest_customization_status):
