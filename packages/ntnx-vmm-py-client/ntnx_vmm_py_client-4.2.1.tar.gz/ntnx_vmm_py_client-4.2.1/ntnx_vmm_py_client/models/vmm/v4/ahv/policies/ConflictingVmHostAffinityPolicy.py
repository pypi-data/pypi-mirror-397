...
class ConflictingVmHostAffinityPolicy(object):
    ...
    :param ext_id: (:attr:`ext_id`) The external ID (UUID) of the conflicting VM-host affinity policy which is applied on the VM.
    :type ext_id: 
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.ahv.policies.ConflictingVmHostAffinityPolicy'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ConflictingVmHostAffinityPolicy, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ConflictingVmHostAffinityPolicy):
            return False
