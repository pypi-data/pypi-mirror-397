...
class VmGcProfileWindowsProductKey(object):
    ...
    :param value: (:attr:`value`) Windows product key value.
    :type value: required
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.ahv.config.VmGcProfileWindowsProductKey'
    ...
    def value(self, value):
        ...
        if value is not None and not re.search('^[A-Z0-9]{5}(-[A-Z0-9]{5}){4}$', value):  # noqa: E501
            raise ValueError(r"Invalid value for `value`, must be a follow pattern or equal to `/^[A-Z0-9]{5}(-[A-Z0-9]{5}){4}$/`")  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VmGcProfileWindowsProductKey, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VmGcProfileWindowsProductKey):
            return False
