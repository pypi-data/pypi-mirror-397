...
class TemplatePublishSpec(object):

    """

    :param version_id: (:attr:`version_id`) The active version of a template. The active version is the default version for creating VMs from the template or during guest OS updates. 
    ...
    def __init__(self, version_id=None, *args, **kwargs):  # noqa: E501
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.content.TemplatePublishSpec'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(TemplatePublishSpec, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TemplatePublishSpec):
            return False
