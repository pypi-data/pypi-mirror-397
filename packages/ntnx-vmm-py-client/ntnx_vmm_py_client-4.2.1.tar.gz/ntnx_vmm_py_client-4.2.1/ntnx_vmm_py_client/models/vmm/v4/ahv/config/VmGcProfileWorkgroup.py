...
class VmGcProfileWorkgroup(object):

    """Details of the workgroup to apply to the computer during Windows Setup.

    :param name: (:attr:`name`) Name of workgroup to be applied to the computer when joining the workgroup. It must be a valid NetBIOS name.
    :type name: required
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.ahv.config.VmGcProfileWorkgroup'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VmGcProfileWorkgroup, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VmGcProfileWorkgroup):
            return False
