...
from ntnx_vmm_py_client.models.OneOfvmm.v4.content.GetOvaApiResponsedata import GetOvaApiResponsedata  # noqa: F401,E501
from ntnx_vmm_py_client.models.common.v1.response.ApiResponseMetadata import ApiResponseMetadata  # noqa: F401,E501

class GetOvaApiResponse(object):
    ...
    swagger_types = {
        ...
        'data': 'OneOfvmm.v4.content.GetOvaApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.content.GetOvaApiResponse'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetOvaApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetOvaApiResponse):
            return False
