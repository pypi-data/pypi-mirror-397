...
from ntnx_vmm_py_client.models.vmm.v4.ahv.config.VirtualEthernetNicModel import VirtualEthernetNicModel  # noqa: F401,E501

class VirtualEthernetNic(object):
    ...
    """  # noqa: E501
    swagger_types = {
        'model': 'vmm.v4.ahv.config.VirtualEthernetNicModel',
        'mac_address': 'str',
        'is_connected': 'bool',
        'num_queues': 'int',
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.ahv.config.VirtualEthernetNic'
    ...
    def model(self):
        ...
        :type:
            :class:`~ntnx_vmm_py_client.models.vmm.v4.ahv.config.VirtualEthernetNicModel`
        """  # noqa: E501
        return self.__model
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VirtualEthernetNic, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VirtualEthernetNic):
            return False
