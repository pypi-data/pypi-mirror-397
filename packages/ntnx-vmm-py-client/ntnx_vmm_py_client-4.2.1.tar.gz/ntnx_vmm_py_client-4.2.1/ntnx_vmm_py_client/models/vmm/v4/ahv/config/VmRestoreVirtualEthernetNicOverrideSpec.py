...
class VmRestoreVirtualEthernetNicOverrideSpec(object):
    ...
    def __init__(self, mac_address=None, *args, **kwargs):  # noqa: E501
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.ahv.config.VmRestoreVirtualEthernetNicOverrideSpec'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VmRestoreVirtualEthernetNicOverrideSpec, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VmRestoreVirtualEthernetNicOverrideSpec):
            return False
