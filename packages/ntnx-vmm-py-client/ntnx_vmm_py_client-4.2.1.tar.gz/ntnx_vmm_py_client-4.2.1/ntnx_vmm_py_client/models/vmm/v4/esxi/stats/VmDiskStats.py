...
class VmDiskStats(ExternalizableAbstractModel):

    """A collection of VM disk stats.

    :param vm_ext_id: (:attr:`vm_ext_id`) The VM external ID associated with the VM Disk stats.
    :type vm_ext_id: 
    ...
    swagger_types = {
        'vm_ext_id': 'str',
        'stats': 'list[vmm.v4.esxi.stats.VmDiskStatsTuple]',
        'ext_id': 'str',
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.esxi.stats.VmDiskStats'
    ...
    def stats(self):
        ...
        :type:
             list[ :class:`~ntnx_vmm_py_client.models.vmm.v4.esxi.stats.VmDiskStatsTuple` ]
        """  # noqa: E501
        return self.__stats
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VmDiskStats, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VmDiskStats):
            return False
