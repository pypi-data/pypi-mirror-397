...
class CdRomBackingInfo(object):
    ...
    def __init__(self, disk_ext_id=None, storage_container=None, *args, **kwargs):  # noqa: E501
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.esxi.config.CdRomBackingInfo'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(CdRomBackingInfo, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CdRomBackingInfo):
            return False
