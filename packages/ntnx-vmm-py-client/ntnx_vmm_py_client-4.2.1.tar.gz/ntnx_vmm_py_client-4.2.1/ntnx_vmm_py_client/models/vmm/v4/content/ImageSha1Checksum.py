...
class ImageSha1Checksum(object):

    """The SHA1 checksum of an image.

    :param hex_digest: (:attr:`hex_digest`) The SHA1 digest of an image file in hexadecimal format.
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.content.ImageSha1Checksum'
    ...
    def hex_digest(self, hex_digest):
        ...
        if hex_digest is not None and not re.search('^([a-fA-F0-9]{40})$', hex_digest):  # noqa: E501
            raise ValueError(r"Invalid value for `hex_digest`, must be a follow pattern or equal to `/^([a-fA-F0-9]{40})$/`")  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ImageSha1Checksum, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ImageSha1Checksum):
            return False
