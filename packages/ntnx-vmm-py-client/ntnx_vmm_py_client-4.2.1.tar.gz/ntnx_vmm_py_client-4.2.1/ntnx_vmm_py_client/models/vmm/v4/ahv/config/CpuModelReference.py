...
class CpuModelReference(object):
    ...
    :param ext_id: (:attr:`ext_id`) The globally unique identifier of the CPU model associated with the VM.
    :type ext_id: 
    
    
    :param name: (:attr:`name`) Name of the CPU model associated with the VM.
    :type name: 
     max=64 chars
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.ahv.config.CpuModelReference'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(CpuModelReference, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CpuModelReference):
            return False
