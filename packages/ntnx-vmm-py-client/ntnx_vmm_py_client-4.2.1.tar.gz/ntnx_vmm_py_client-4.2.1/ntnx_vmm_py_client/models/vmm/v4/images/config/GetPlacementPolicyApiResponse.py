...
from ntnx_vmm_py_client.models.OneOfvmm.v4.images.config.GetPlacementPolicyApiResponsedata import GetPlacementPolicyApiResponsedata  # noqa: F401,E501
from ntnx_vmm_py_client.models.common.v1.response.ApiResponseMetadata import ApiResponseMetadata  # noqa: F401,E501

class GetPlacementPolicyApiResponse(object):
    ...
    swagger_types = {
        ...
        'data': 'OneOfvmm.v4.images.config.GetPlacementPolicyApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.images.config.GetPlacementPolicyApiResponse'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetPlacementPolicyApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetPlacementPolicyApiResponse):
            return False
