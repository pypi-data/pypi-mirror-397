...
class TemplateVersionSpec(ExternalizableAbstractModel):
    ...
    :param guest_customization_profile: (:attr:`guest_customization_profile`) 
    :type guest_customization_profile: 
    ...
    swagger_types = {
        ...
        'guest_customization_profile': 'vmm.v4.ahv.config.VmGcProfileReference',
        'ext_id': 'str',
    ...
    attribute_map = {
        ...
        'guest_customization_profile': 'guestCustomizationProfile',
        'ext_id': 'extId',
        'links': 'links',
        'tenant_id': 'tenantId',
        '_reserved': '$reserved',
    ...
    def __init__(self, version_name=None, version_description=None, vm_spec=None, create_time=None, created_by=None, version_source=None, version_source_discriminator=None, is_active_version=True, is_gc_override_enabled=None, cluster_location_ext_ids=None, guest_customization_profile=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
        ...
        self.__guest_customization_profile = None
        ...
        if guest_customization_profile is not None:
            self.__guest_customization_profile = guest_customization_profile
    ...
    @property
    def guest_customization_profile(self):
        """
        ...
        """  # noqa: E501
        return self.__guest_customization_profile

    @guest_customization_profile.setter
    def guest_customization_profile(self, guest_customization_profile):
