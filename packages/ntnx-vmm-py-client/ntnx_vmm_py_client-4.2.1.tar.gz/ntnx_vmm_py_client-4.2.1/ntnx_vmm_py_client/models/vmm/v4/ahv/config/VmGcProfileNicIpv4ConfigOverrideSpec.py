...
class VmGcProfileNicIpv4ConfigOverrideSpec(object):
    ...
    :param default_gateways: (:attr:`default_gateways`) Override value for default gateways. This overrides the default gateway configuration from the referenced profile.
    :type default_gateways: 
    ...
    def __init__(self, ip_address=None, default_gateways=None, *args, **kwargs):  # noqa: E501
        self.__ip_address = None
        self.__default_gateways = None
        self.discriminator = None
        if ip_address is not None:
            self.__ip_address = ip_address
        if default_gateways is not None:
            self.__default_gateways = default_gateways
        # populate hidden vars if not empty
        self._populate_hidden_vars(kwargs)

    def _initialize_object_type(self):
        return 'vmm.v4.ahv.config.VmGcProfileNicIpv4ConfigOverrideSpec'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VmGcProfileNicIpv4ConfigOverrideSpec, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VmGcProfileNicIpv4ConfigOverrideSpec):
            return False
