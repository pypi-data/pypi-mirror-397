...
from ntnx_vmm_py_client.models.vmm.v4.content.UrlBasicAuth import UrlBasicAuth  # noqa: F401,E501

class OvaUrlSource(object):

    """URL to create an OVA.

    :param url: (:attr:`url`) The URL that can be used to download an OVA.
    :type url: required
    
    
    :param should_allow_insecure_url: (:attr:`should_allow_insecure_url`) Ignore the certificate errors if the value is true. Default is false. (**Default** False)
    :type should_allow_insecure_url: 
    
    
    :param basic_auth: (:attr:`basic_auth`) 
    :type basic_auth: 
    ...
    swagger_types = {
        ...
        'basic_auth': 'vmm.v4.content.UrlBasicAuth',
    ...
    attribute_map = {
        'url': 'url',
        'should_allow_insecure_url': 'shouldAllowInsecureUrl',
    ...
    def __init__(self, url=None, should_allow_insecure_url=False, basic_auth=None, *args, **kwargs):  # noqa: E501
        self.__url = None
        self.__should_allow_insecure_url = None
        self.__basic_auth = None
        self.discriminator = None
        self.__url = url
        if should_allow_insecure_url is not None:
            self.__should_allow_insecure_url = should_allow_insecure_url
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.content.OvaUrlSource'
    ...
    @property
    def should_allow_insecure_url(self):
        """
        ...
        :type:
                :class:`~bool`
        """  # noqa: E501
        return self.__should_allow_insecure_url

    @should_allow_insecure_url.setter
    def should_allow_insecure_url(self, should_allow_insecure_url):
    ...
    def basic_auth(self):
        ...
        :type:
            :class:`~ntnx_vmm_py_client.models.vmm.v4.content.UrlBasicAuth`
        """  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(OvaUrlSource, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OvaUrlSource):
            return False
