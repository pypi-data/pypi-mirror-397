...
class NicProfileReference(object):

    """Reference to a NIC profile.

    :param ext_id: (:attr:`ext_id`) Globally unique identifier of a NIC profile. It should be of type UUID.
    :type ext_id: 
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.ahv.config.NicProfileReference'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(NicProfileReference, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NicProfileReference):
            return False
