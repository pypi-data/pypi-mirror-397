...
from ntnx_vmm_py_client.models.vmm.v4.ahv.config.PcieDeviceReference import PcieDeviceReference  # noqa: F401,E501

class PcieDeviceInfo(object):

    """Information about the attached PCIe device to the VM.

    :param device: (:attr:`device`) 
    :type device: 
    ...
    """  # noqa: E501
    swagger_types = {
        'device': 'vmm.v4.ahv.config.PcieDeviceReference',
    ...
    def __init__(self, device=None, *args, **kwargs):  # noqa: E501
        self.__device = None
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.ahv.config.PcieDeviceInfo'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(PcieDeviceInfo, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PcieDeviceInfo):
            return False
