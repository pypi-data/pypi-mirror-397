...
class HostPcieDeviceReference(object):

    """Reference to the host PCIe device.

    :param ext_id: (:attr:`ext_id`) Globally unique identifier of the host PCIe device. It should be of type UUID.
    :type ext_id: 
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.ahv.config.HostPcieDeviceReference'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(HostPcieDeviceReference, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, HostPcieDeviceReference):
            return False
