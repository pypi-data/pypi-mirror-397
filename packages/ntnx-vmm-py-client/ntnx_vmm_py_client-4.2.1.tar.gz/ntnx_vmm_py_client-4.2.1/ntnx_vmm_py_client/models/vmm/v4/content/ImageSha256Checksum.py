...
class ImageSha256Checksum(object):

    """The SHA256 checksum of an image.

    :param hex_digest: (:attr:`hex_digest`) The SHA256 digest of an image file in hexadecimal format.
    :type hex_digest: required
    ...
    def __init__(self, hex_digest=None, *args, **kwargs):  # noqa: E501
        self.__hex_digest = None
        self.discriminator = None
        self.__hex_digest = hex_digest
        # populate hidden vars if not empty
        self._populate_hidden_vars(kwargs)

    def _initialize_object_type(self):
        return 'vmm.v4.content.ImageSha256Checksum'
    ...
    @hex_digest.setter
    def hex_digest(self, hex_digest):
        if hex_digest is None:
            raise ValueError("Invalid value for `hex_digest`, must not be `None`")  # noqa: E501
        if hex_digest is not None and not re.search('^([a-fA-F0-9]{64})$', hex_digest):  # noqa: E501
            raise ValueError(r"Invalid value for `hex_digest`, must be a follow pattern or equal to `/^([a-fA-F0-9]{64})$/`")  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ImageSha256Checksum, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ImageSha256Checksum):
            return False
