...
from ntnx_vmm_py_client.models.OneOfvmm.v4.esxi.config.ResetVmApiResponsedata import ResetVmApiResponsedata  # noqa: F401,E501
from ntnx_vmm_py_client.models.common.v1.response.ApiResponseMetadata import ApiResponseMetadata  # noqa: F401,E501

class ResetVmApiResponse(object):
    ...
    swagger_types = {
        ...
        'data': 'OneOfvmm.v4.esxi.config.ResetVmApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.esxi.config.ResetVmApiResponse'
    ...
    def _to_dict(self, sanitize):
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if attr_type.startswith('OneOf'):
                type = getattr(ntnx_vmm_py_client.models, 'EsxiConfigResetVmApiResponse')
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ResetVmApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ResetVmApiResponse):
            return False
