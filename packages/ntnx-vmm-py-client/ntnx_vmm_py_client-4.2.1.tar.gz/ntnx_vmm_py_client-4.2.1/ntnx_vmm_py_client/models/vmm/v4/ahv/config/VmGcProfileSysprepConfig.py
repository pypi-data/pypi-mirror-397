...
from ntnx_vmm_py_client.models.OneOfvmm.v4.ahv.config.VmGcProfileSysprepConfigcustomization import VmGcProfileSysprepConfigcustomization  # noqa: F401,E501

class VmGcProfileSysprepConfig(object):

    """Configuration of the VM Guest Customization Profile for customization of a Windows guest operating system.

    :param customization: (:attr:`customization`) Either specify the values for the parameters or an unattend XML file.
    ...
    """  # noqa: E501
    swagger_types = {
        'customization': 'OneOfvmm.v4.ahv.config.VmGcProfileSysprepConfigcustomization',
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.ahv.config.VmGcProfileSysprepConfig'
    ...
    def customization(self):
        ...
        :type:
                :class:`~ntnx_vmm_py_client.models.vmm.v4.ahv.config.VmGcProfileSysprepParams` | 
                :class:`~ntnx_vmm_py_client.models.vmm.v4.ahv.config.VmGcProfileAnswerFile`
        """  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VmGcProfileSysprepConfig, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VmGcProfileSysprepConfig):
            return False
