...
from ntnx_vmm_py_client.models.vmm.v4.esxi.config.CdRomBusType import CdRomBusType  # noqa: F401,E501

class CdRomAddress(object):

    """CD-ROM address.

    :param bus_type: (:attr:`bus_type`) 
    :type bus_type: 
    
    
    :param index: (:attr:`index`) Device index on the bus. This field is ignored unless the bus details are specified.
    :type index: 
    ...
    """  # noqa: E501
    swagger_types = {
        'bus_type': 'vmm.v4.esxi.config.CdRomBusType',
        'index': 'int',
    ...
    def __init__(self, bus_type=None, index=None, *args, **kwargs):  # noqa: E501
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.esxi.config.CdRomAddress'
    ...
    def bus_type(self):
        ...
        :type:
            :class:`~ntnx_vmm_py_client.models.vmm.v4.esxi.config.CdRomBusType`
        """  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(CdRomAddress, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CdRomAddress):
            return False
