...
from ntnx_vmm_py_client.models.OneOfvmm.v4.ahv.config.DeleteNicApiResponsedata import DeleteNicApiResponsedata  # noqa: F401,E501
from ntnx_vmm_py_client.models.common.v1.response.ApiResponseMetadata import ApiResponseMetadata  # noqa: F401,E501

class DeleteNicApiResponse(object):
    ...
    swagger_types = {
        ...
        'data': 'OneOfvmm.v4.ahv.config.DeleteNicApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.ahv.config.DeleteNicApiResponse'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(DeleteNicApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteNicApiResponse):
            return False
