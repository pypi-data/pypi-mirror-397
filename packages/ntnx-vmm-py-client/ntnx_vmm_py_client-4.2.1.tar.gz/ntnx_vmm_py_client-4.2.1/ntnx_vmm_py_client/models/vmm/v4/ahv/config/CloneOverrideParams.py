...
class CloneOverrideParams(object):
    ...
    def __init__(self, name=None, num_sockets=None, num_cores_per_socket=None, num_threads_per_core=None, memory_size_bytes=None, nics=None, boot_config=None, guest_customization=None, guest_customization_profile_config=None, *args, **kwargs):  # noqa: E501
        self.__name = None
