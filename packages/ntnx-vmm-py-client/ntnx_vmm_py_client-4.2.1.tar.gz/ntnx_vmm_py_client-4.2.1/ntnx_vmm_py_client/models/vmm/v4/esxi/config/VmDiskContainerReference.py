...
class VmDiskContainerReference(object):
    ...
    :param ext_id: (:attr:`ext_id`) A globally unique identifier of a VM disk container. It should be of type UUID.
    :type ext_id: 
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.esxi.config.VmDiskContainerReference'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VmDiskContainerReference, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VmDiskContainerReference):
            return False
