...
from ntnx_vmm_py_client.models.OneOfvmm.v4.content.DeployOvaApiResponsedata import DeployOvaApiResponsedata  # noqa: F401,E501
from ntnx_vmm_py_client.models.common.v1.response.ApiResponseMetadata import ApiResponseMetadata  # noqa: F401,E501

class DeployOvaApiResponse(object):

    """REST response for all response codes in API path /vmm/v4.2/content/ovas/{extId}/$actions/deploy Post operation
    ...
    swagger_types = {
        ...
        'data': 'OneOfvmm.v4.content.DeployOvaApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.content.DeployOvaApiResponse'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(DeployOvaApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeployOvaApiResponse):
            return False
