...
class RateLimitPolicy(ExternalizableAbstractModel):
    ...
    :param owner_name: (:attr:`owner_name`) Name of the owner of the rate limit policy.
    :type owner_name: 
    ...
    def __init__(self, name=None, description=None, rate_limit_kbps=None, cluster_entity_filter=None, create_time=None, last_update_time=None, owner_ext_id=None, owner_name=None, matching_cluster_ext_ids=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
