...
class VmStatsTupleProjection(VmStatsTuple):
    ...
    :param physical_memory_allocated_bytes: (:attr:`physical_memory_allocated_bytes`) Physical memory allocated to VM in bytes.
    :type physical_memory_allocated_bytes: 
    ...
    swagger_types = {
        ...
        'physical_memory_allocated_bytes': 'int',
    ...
    attribute_map = {
        ...
        'physical_memory_allocated_bytes': 'physicalMemoryAllocatedBytes',
        '_reserved': '$reserved',
