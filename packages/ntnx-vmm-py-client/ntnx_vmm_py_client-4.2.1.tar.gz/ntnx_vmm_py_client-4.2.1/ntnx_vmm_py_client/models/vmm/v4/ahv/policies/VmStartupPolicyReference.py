...
class VmStartupPolicyReference(object):

    """The reference of the VM startup policy.

    :param ext_id: (:attr:`ext_id`) The external ID (UUID) of the host.
    :type ext_id: 
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.ahv.policies.VmStartupPolicyReference'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VmStartupPolicyReference, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VmStartupPolicyReference):
            return False
