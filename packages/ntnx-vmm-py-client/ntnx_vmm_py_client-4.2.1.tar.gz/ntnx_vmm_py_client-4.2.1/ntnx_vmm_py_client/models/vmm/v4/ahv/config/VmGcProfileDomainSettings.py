...
from ntnx_vmm_py_client.models.vmm.v4.ahv.config.VmGcProfileDomainCredentials import VmGcProfileDomainCredentials  # noqa: F401,E501

class VmGcProfileDomainSettings(object):
    ...
    """  # noqa: E501
    swagger_types = {
        'credentials': 'vmm.v4.ahv.config.VmGcProfileDomainCredentials',
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.ahv.config.VmGcProfileDomainSettings'
    ...
    def credentials(self):
        ...
        :type:
            :class:`~ntnx_vmm_py_client.models.vmm.v4.ahv.config.VmGcProfileDomainCredentials`
        """  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VmGcProfileDomainSettings, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VmGcProfileDomainSettings):
            return False
