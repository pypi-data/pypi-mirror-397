...
from ntnx_vmm_py_client.models.OneOfvmm.v4.ahv.config.CreateSerialPortApiResponsedata import CreateSerialPortApiResponsedata  # noqa: F401,E501
from ntnx_vmm_py_client.models.common.v1.response.ApiResponseMetadata import ApiResponseMetadata  # noqa: F401,E501

class CreateSerialPortApiResponse(object):
    ...
    swagger_types = {
        ...
        'data': 'OneOfvmm.v4.ahv.config.CreateSerialPortApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.ahv.config.CreateSerialPortApiResponse'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(CreateSerialPortApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateSerialPortApiResponse):
            return False
