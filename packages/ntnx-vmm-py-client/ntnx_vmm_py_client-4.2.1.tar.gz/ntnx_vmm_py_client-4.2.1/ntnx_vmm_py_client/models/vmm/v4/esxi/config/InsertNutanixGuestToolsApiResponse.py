...
from ntnx_vmm_py_client.models.OneOfvmm.v4.esxi.config.InsertNutanixGuestToolsApiResponsedata import InsertNutanixGuestToolsApiResponsedata  # noqa: F401,E501
from ntnx_vmm_py_client.models.common.v1.response.ApiResponseMetadata import ApiResponseMetadata  # noqa: F401,E501

class InsertNutanixGuestToolsApiResponse(object):
    ...
    swagger_types = {
        ...
        'data': 'OneOfvmm.v4.esxi.config.InsertNutanixGuestToolsApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.esxi.config.InsertNutanixGuestToolsApiResponse'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(InsertNutanixGuestToolsApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InsertNutanixGuestToolsApiResponse):
            return False
