...
class PlacementPolicy(ExternalizableAbstractModel):
    ...
    :param owner_name: (:attr:`owner_name`) Name of the owner of the image placement policy.
    :type owner_name: 
    ...
    def __init__(self, name=None, description=None, placement_type=None, image_entity_filter=None, cluster_entity_filter=None, enforcement_state=None, create_time=None, last_update_time=None, owner_ext_id=None, owner_name=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
