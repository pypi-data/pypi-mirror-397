...
class TemplateVmReference(object):

    """The template VM reference model.

    :param ext_id: (:attr:`ext_id`) The identifier of a VM.
    ...
    def __init__(self, ext_id=None, guest_customization_profile=None, guest_customization=None, *args, **kwargs):  # noqa: E501
        self.__ext_id = None
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.content.TemplateVmReference'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(TemplateVmReference, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TemplateVmReference):
            return False
