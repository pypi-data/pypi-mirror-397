...
from ntnx_vmm_py_client.models.vmm.v4.ahv.config.VmGcProfileConfig import VmGcProfileConfig  # noqa: F401,E501

class VmConfigOverride(object):
    ...
    :type num_threads_per_core: 
     ...
     min=1,
    :param memory_size_bytes: (:attr:`memory_size_bytes`) (VmMemorySizeBytesDescription)
    ...
    :param guest_customization_profile_config: (:attr:`guest_customization_profile_config`) 
    :type guest_customization_profile_config: 
    ...
    swagger_types = {
        ...
        'guest_customization_profile_config': 'vmm.v4.ahv.config.VmGcProfileConfig',
    ...
    attribute_map = {
        ...
        'guest_customization_profile_config': 'guestCustomizationProfileConfig',
        '_reserved': '$reserved',
    ...
    def __init__(self, name=None, num_sockets=None, num_cores_per_socket=None, num_threads_per_core=None, memory_size_bytes=None, nics=None, guest_customization=None, guest_customization_profile_config=None, *args, **kwargs):  # noqa: E501
        self.__name = None
        ...
        self.__guest_customization_profile_config = None
        ...
        if guest_customization_profile_config is not None:
            self.__guest_customization_profile_config = guest_customization_profile_config
        # populate hidden vars if not empty
        self._populate_hidden_vars(kwargs)

    def _initialize_object_type(self):
        return 'vmm.v4.content.VmConfigOverride'
    ...
    @property
    def guest_customization_profile_config(self):
        """
        

        :type:
            :class:`~ntnx_vmm_py_client.models.vmm.v4.ahv.config.VmGcProfileConfig`
        """  # noqa: E501
        return self.__guest_customization_profile_config

    @guest_customization_profile_config.setter
    def guest_customization_profile_config(self, guest_customization_profile_config):
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VmConfigOverride, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VmConfigOverride):
            return False
