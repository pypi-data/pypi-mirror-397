...
class Template(ExternalizableAbstractModel):
    ...
    :param category_ext_ids: (:attr:`category_ext_ids`) List of category external identifiers for a VM Template.
    ...
    def __init__(self, template_name=None, template_description=None, template_version_spec=None, guest_update_status=None, create_time=None, update_time=None, created_by=None, updated_by=None, category_ext_ids=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
