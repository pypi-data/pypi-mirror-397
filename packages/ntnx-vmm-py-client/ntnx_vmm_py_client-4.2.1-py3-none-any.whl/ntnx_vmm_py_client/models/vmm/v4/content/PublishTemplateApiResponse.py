...
from ntnx_vmm_py_client.models.OneOfvmm.v4.content.PublishTemplateApiResponsedata import PublishTemplateApiResponsedata  # noqa: F401,E501
from ntnx_vmm_py_client.models.common.v1.response.ApiResponseMetadata import ApiResponseMetadata  # noqa: F401,E501

class PublishTemplateApiResponse(object):

    """REST response for all response codes in API path /vmm/v4.2/content/templates/{extId}/$actions/publish Post operation
    ...
    swagger_types = {
        ...
        'data': 'OneOfvmm.v4.content.PublishTemplateApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.content.PublishTemplateApiResponse'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(PublishTemplateApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PublishTemplateApiResponse):
            return False
