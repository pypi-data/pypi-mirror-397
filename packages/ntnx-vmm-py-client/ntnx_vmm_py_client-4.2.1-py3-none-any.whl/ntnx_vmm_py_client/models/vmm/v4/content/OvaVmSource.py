...
class OvaVmSource(object):

    """VM to export an OVA.

    :param vm_ext_id: (:attr:`vm_ext_id`) The identifier of a VM to be exported to an OVA.
    :type vm_ext_id: required
    
    
    :param disk_file_format: (:attr:`disk_file_format`) 
    :type disk_file_format: required
    ...
    swagger_types = {
        'vm_ext_id': 'str',
        'disk_file_format': 'vmm.v4.content.OvaDiskFormat',
    ...
    def __init__(self, vm_ext_id=None, disk_file_format=None, *args, **kwargs):  # noqa: E501
        self.__vm_ext_id = None
        self.__disk_file_format = None
        self.discriminator = None
        self.__vm_ext_id = vm_ext_id
        self.__disk_file_format = disk_file_format
        # populate hidden vars if not empty
        self._populate_hidden_vars(kwargs)

    def _initialize_object_type(self):
        return 'vmm.v4.content.OvaVmSource'
    ...
    def disk_file_format(self):
        ...
        """  # noqa: E501
        return self.__disk_file_format

    @disk_file_format.setter
    def disk_file_format(self, disk_file_format):
        if disk_file_format is None:
            raise ValueError("Invalid value for `disk_file_format`, must not be `None`")  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(OvaVmSource, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OvaVmSource):
            return False
