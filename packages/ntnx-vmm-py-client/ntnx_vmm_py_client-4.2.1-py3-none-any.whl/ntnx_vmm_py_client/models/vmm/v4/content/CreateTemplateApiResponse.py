...
from ntnx_vmm_py_client.models.OneOfvmm.v4.content.CreateTemplateApiResponsedata import CreateTemplateApiResponsedata  # noqa: F401,E501
from ntnx_vmm_py_client.models.common.v1.response.ApiResponseMetadata import ApiResponseMetadata  # noqa: F401,E501

class CreateTemplateApiResponse(object):

    """REST response for all response codes in API path /vmm/v4.2/content/templates Post operation
    ...
    swagger_types = {
        ...
        'data': 'OneOfvmm.v4.content.CreateTemplateApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.content.CreateTemplateApiResponse'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(CreateTemplateApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateTemplateApiResponse):
            return False
