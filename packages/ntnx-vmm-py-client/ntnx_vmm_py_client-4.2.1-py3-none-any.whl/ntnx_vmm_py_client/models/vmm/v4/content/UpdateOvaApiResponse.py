...
from ntnx_vmm_py_client.models.OneOfvmm.v4.content.UpdateOvaApiResponsedata import UpdateOvaApiResponsedata  # noqa: F401,E501
from ntnx_vmm_py_client.models.common.v1.response.ApiResponseMetadata import ApiResponseMetadata  # noqa: F401,E501

class UpdateOvaApiResponse(object):

    """REST response for all response codes in API path /vmm/v4.2/content/ovas/{extId} Put operation
    ...
    swagger_types = {
        ...
        'data': 'OneOfvmm.v4.content.UpdateOvaApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.content.UpdateOvaApiResponse'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(UpdateOvaApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateOvaApiResponse):
            return False
