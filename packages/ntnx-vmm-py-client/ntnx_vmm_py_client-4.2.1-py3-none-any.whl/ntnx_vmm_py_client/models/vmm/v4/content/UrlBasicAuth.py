...
class UrlBasicAuth(object):

    """Basic authentication credentials for image source HTTP/S URL.

    :param username: (:attr:`username`) Username for basic authentication.
    :type username: required
     min=1 chars, max=1000 chars
    
    :param password: (:attr:`password`) Password for basic authentication.
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.content.UrlBasicAuth'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(UrlBasicAuth, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UrlBasicAuth):
            return False
