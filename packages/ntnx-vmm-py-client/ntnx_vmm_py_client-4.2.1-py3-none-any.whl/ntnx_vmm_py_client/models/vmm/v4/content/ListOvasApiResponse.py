...
from ntnx_vmm_py_client.models.OneOfvmm.v4.content.ListOvasApiResponsedata import ListOvasApiResponsedata  # noqa: F401,E501
from ntnx_vmm_py_client.models.common.v1.response.ApiResponseMetadata import ApiResponseMetadata  # noqa: F401,E501

class ListOvasApiResponse(object):

    """REST response for all response codes in API path /vmm/v4.2/content/ovas Get operation
    ...
    swagger_types = {
        ...
        'data': 'OneOfvmm.v4.content.ListOvasApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.content.ListOvasApiResponse'
    ...
    def data(self):
        ...
        :type:
                :class:`~ntnx_vmm_py_client.models.vmm.v4.content.Ova` | 
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListOvasApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListOvasApiResponse):
            return False
