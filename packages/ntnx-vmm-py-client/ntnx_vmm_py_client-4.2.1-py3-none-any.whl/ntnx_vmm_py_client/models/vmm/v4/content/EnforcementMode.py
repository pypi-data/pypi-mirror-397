...
class EnforcementMode(object):
    ...
    Allowed enum values:
        ...
        - ENFORCEMENT_FAILED: The image placement policy enforcement by the backend service has failed.
    """
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    ENFORCING = "ENFORCING"
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.content.EnforcementMode'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(EnforcementMode, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EnforcementMode):
            return False
