...
from ntnx_vmm_py_client.models.vmm.v4.esxi.config.IpAddressInfo import IpAddressInfo  # noqa: F401,E501
from ntnx_vmm_py_client.models.vmm.v4.esxi.config.PortGroupInfo import PortGroupInfo  # noqa: F401,E501
...
class NicNetworkInfo(object):
    ...
    :param port_group_info: (:attr:`port_group_info`) 
    :type port_group_info: 
    
    
    :param ip_address_info: (:attr:`ip_address_info`) 
    :type ip_address_info: 
    ...
    """  # noqa: E501
    swagger_types = {
        'port_group_info': 'vmm.v4.esxi.config.PortGroupInfo',
        'ip_address_info': 'vmm.v4.esxi.config.IpAddressInfo',
    ...
    def __init__(self, port_group_info=None, ip_address_info=None, *args, **kwargs):  # noqa: E501
        self.__port_group_info = None
        self.__ip_address_info = None
        self.discriminator = None
        if port_group_info is not None:
            self.__port_group_info = port_group_info
        if ip_address_info is not None:
            self.__ip_address_info = ip_address_info
        # populate hidden vars if not empty
        self._populate_hidden_vars(kwargs)

    def _initialize_object_type(self):
        return 'vmm.v4.esxi.config.NicNetworkInfo'
    ...
    @property
    def port_group_info(self):
        """
        

        :type:
            :class:`~ntnx_vmm_py_client.models.vmm.v4.esxi.config.PortGroupInfo`
        """  # noqa: E501
        return self.__port_group_info

    @port_group_info.setter
    def port_group_info(self, port_group_info):
    ...
    def ip_address_info(self):
        ...
        :type:
            :class:`~ntnx_vmm_py_client.models.vmm.v4.esxi.config.IpAddressInfo`
        """  # noqa: E501
        return self.__ip_address_info
