...
from ntnx_vmm_py_client.models.OneOfvmm.v4.esxi.config.ListVmsApiResponsedata import ListVmsApiResponsedata  # noqa: F401,E501
from ntnx_vmm_py_client.models.common.v1.response.ApiResponseMetadata import ApiResponseMetadata  # noqa: F401,E501

class ListVmsApiResponse(object):
    ...
    swagger_types = {
        ...
        'data': 'OneOfvmm.v4.esxi.config.ListVmsApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.esxi.config.ListVmsApiResponse'
    ...
    def _to_dict(self, sanitize):
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if attr_type.startswith('OneOf'):
                type = getattr(ntnx_vmm_py_client.models, 'EsxiConfigListVmsApiResponse')
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListVmsApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListVmsApiResponse):
            return False
