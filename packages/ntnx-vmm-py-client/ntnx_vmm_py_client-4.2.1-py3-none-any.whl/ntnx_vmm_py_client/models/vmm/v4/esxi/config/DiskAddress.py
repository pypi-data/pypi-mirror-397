...
from ntnx_vmm_py_client.models.vmm.v4.esxi.config.DiskBusType import DiskBusType  # noqa: F401,E501
...
class DiskAddress(object):
    ...
    """  # noqa: E501
    swagger_types = {
        'bus_type': 'vmm.v4.esxi.config.DiskBusType',
        'index': 'int',
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.esxi.config.DiskAddress'
    ...
    def bus_type(self):
        ...
        :type:
            :class:`~ntnx_vmm_py_client.models.vmm.v4.esxi.config.DiskBusType`
        """  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(DiskAddress, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DiskAddress):
            return False
