...
from ntnx_vmm_py_client.models.OneOfvmm.v4.esxi.config.DisassociateCategoriesApiResponsedata import DisassociateCategoriesApiResponsedata  # noqa: F401,E501
from ntnx_vmm_py_client.models.common.v1.response.ApiResponseMetadata import ApiResponseMetadata  # noqa: F401,E501

class DisassociateCategoriesApiResponse(object):
    ...
    swagger_types = {
        ...
        'data': 'OneOfvmm.v4.esxi.config.DisassociateCategoriesApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.esxi.config.DisassociateCategoriesApiResponse'
    ...
    def _to_dict(self, sanitize):
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if attr_type.startswith('OneOf'):
                type = getattr(ntnx_vmm_py_client.models, 'EsxiConfigDisassociateCategoriesApiResponse')
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(DisassociateCategoriesApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DisassociateCategoriesApiResponse):
            return False
