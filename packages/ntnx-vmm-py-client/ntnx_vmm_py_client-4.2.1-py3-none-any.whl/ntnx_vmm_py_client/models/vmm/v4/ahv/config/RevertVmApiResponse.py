...
from ntnx_vmm_py_client.models.OneOfvmm.v4.ahv.config.RevertVmApiResponsedata import RevertVmApiResponsedata  # noqa: F401,E501
...
class RevertVmApiResponse(object):
    ...
    swagger_types = {
        ...
        'data': 'OneOfvmm.v4.ahv.config.RevertVmApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.ahv.config.RevertVmApiResponse'
    ...
    def _to_dict(self, sanitize):
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if attr_type.startswith('OneOf'):
                type = getattr(ntnx_vmm_py_client.models, 'AhvConfigRevertVmApiResponse')
