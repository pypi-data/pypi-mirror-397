...
class VirtualEthernetNicNetworkInfo(object):
    ...
    def __init__(self, nic_type=None, network_function_chain=None, network_function_nic_type=None, subnet=None, vlan_mode=None, trunked_vlans=None, should_allow_unknown_macs=None, ipv4_config=None, ipv4_info=None, ipv6_info=None, *args, **kwargs):  # noqa: E501
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.ahv.config.VirtualEthernetNicNetworkInfo'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VirtualEthernetNicNetworkInfo, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VirtualEthernetNicNetworkInfo):
            return False
