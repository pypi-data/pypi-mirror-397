...
class VmGcProfileReference(object):

    """Reference to a VM Guest Customization profile.

    :param ext_id: (:attr:`ext_id`) The external ID (UUID) of the VM Guest Customization profile.
    :type ext_id: 
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.ahv.config.VmGcProfileReference'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VmGcProfileReference, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VmGcProfileReference):
            return False
