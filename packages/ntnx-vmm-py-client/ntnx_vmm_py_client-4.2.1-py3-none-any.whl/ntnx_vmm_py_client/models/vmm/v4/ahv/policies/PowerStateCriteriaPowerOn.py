...
class PowerStateCriteriaPowerOn(object):
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.ahv.policies.PowerStateCriteriaPowerOn'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(PowerStateCriteriaPowerOn, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PowerStateCriteriaPowerOn):
            return False
