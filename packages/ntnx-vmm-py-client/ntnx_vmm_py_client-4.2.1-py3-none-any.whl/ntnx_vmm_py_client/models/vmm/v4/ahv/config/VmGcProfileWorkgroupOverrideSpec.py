...
class VmGcProfileWorkgroupOverrideSpec(object):

    """Override specification for workgroup settings. This overrides the workgroup configuration from the referenced profile.

    :param name: (:attr:`name`) Override value for workgroup name. This overrides the workgroup name from the referenced profile. It must be a valid NetBIOS name.
    :type name: required
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.ahv.config.VmGcProfileWorkgroupOverrideSpec'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VmGcProfileWorkgroupOverrideSpec, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VmGcProfileWorkgroupOverrideSpec):
            return False
