...
class VmGcProfileLocaleSettingOverride(object):
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.ahv.config.VmGcProfileLocaleSettingOverride'
    ...
    def value(self, value):
        ...
        if value is not None and not re.search('^[a-zA-Z]{1,8}(-[a-zA-Z0-9]{1,8})*$', value):  # noqa: E501
            raise ValueError(r"Invalid value for `value`, must be a follow pattern or equal to `/^[a-zA-Z]{1,8}(-[a-zA-Z0-9]{1,8})*$/`")  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VmGcProfileLocaleSettingOverride, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VmGcProfileLocaleSettingOverride):
            return False
