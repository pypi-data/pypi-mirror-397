...
class VolumeDiskReference(object):

    """Reference to a Volume Disk.

    :param disk_ext_id: (:attr:`disk_ext_id`) An external identifier of the Volume disk. It should be of type UUID.
    :type disk_ext_id: 
    
    
    :param volume_group_ext_id: (:attr:`volume_group_ext_id`) The external identifier of the Volume Group. It should be of type UUID.
    ...
    def __init__(self, disk_ext_id=None, volume_group_ext_id=None, *args, **kwargs):  # noqa: E501
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.ahv.config.VolumeDiskReference'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VolumeDiskReference, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VolumeDiskReference):
            return False
