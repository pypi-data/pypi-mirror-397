...
class VirtualEthernetNicModel(object):
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.ahv.config.VirtualEthernetNicModel'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VirtualEthernetNicModel, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VirtualEthernetNicModel):
            return False
