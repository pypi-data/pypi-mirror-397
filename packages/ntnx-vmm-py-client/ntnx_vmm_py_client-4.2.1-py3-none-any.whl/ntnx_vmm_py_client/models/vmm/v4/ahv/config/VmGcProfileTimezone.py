...
class VmGcProfileTimezone(object):
    ...
    :param value: (:attr:`value`) Timezone value.
    :type value: required
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.ahv.config.VmGcProfileTimezone'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VmGcProfileTimezone, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VmGcProfileTimezone):
            return False
