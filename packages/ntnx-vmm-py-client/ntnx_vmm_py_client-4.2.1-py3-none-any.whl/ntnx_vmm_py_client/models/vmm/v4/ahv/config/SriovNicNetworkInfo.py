...
class SriovNicNetworkInfo(object):

    """Networking information object for an SR-IOV NIC.

    :param vlan_id: (:attr:`vlan_id`) VLAN ID for the SR-IOV NIC.
    :type vlan_id: 
    ...
    def __init__(self, vlan_id=None, *args, **kwargs):  # noqa: E501
        self.__vlan_id = None
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.ahv.config.SriovNicNetworkInfo'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(SriovNicNetworkInfo, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SriovNicNetworkInfo):
            return False
