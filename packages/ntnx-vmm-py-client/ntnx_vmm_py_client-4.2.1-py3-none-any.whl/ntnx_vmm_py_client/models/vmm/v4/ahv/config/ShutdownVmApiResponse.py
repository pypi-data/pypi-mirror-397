...
from ntnx_vmm_py_client.models.OneOfvmm.v4.ahv.config.ShutdownVmApiResponsedata import ShutdownVmApiResponsedata  # noqa: F401,E501
...
class ShutdownVmApiResponse(object):
    ...
    swagger_types = {
        ...
        'data': 'OneOfvmm.v4.ahv.config.ShutdownVmApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.ahv.config.ShutdownVmApiResponse'
    ...
    def _to_dict(self, sanitize):
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if attr_type.startswith('OneOf'):
                type = getattr(ntnx_vmm_py_client.models, 'AhvConfigShutdownVmApiResponse')
