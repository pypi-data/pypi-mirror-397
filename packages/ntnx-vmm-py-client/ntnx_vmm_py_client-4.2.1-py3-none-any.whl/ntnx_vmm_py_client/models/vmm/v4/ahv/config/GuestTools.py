...
from ntnx_vmm_py_client.models.vmm.v4.ahv.config.GuestInfo import GuestInfo  # noqa: F401,E501
from ntnx_vmm_py_client.models.vmm.v4.ahv.config.NgtCapability import NgtCapability  # noqa: F401,E501
...
class GuestTools(object):
    ...
    :param guest_os_version: (:attr:`guest_os_version`) Version of the operating system on the VM. This object is now deprecated. If both deprecated and new objects are present, the new object GuestInfo/GuestOsFullName takes precedence.
    ...
    :param is_vm_mobility_drivers_installed: (:attr:`is_vm_mobility_drivers_installed`) Indicates whether the VM mobility drivers are installed on the VM or not. This object is now deprecated. If both deprecated and new objects are present, the new object GuestInfoVmMobilityDriversInstalledDescription takes precedence.
    :type is_vm_mobility_drivers_installed: 
    
    
    :param is_communication_active_over_serial_port: (:attr:`is_communication_active_over_serial_port`) Indicates whether the Nutanix Guest Tools communication over Serial Port is active or not.
    :type is_communication_active_over_serial_port: 
    
    
    :param guest_info: (:attr:`guest_info`) 
    :type guest_info: 
    ...
    swagger_types = {
        ...
        'is_communication_active_over_serial_port': 'bool',
        'guest_info': 'vmm.v4.ahv.config.GuestInfo',
    ...
    attribute_map = {
        ...
        'is_communication_active_over_serial_port': 'isCommunicationActiveOverSerialPort',
    ...
    def __init__(self, version=None, is_installed=None, is_enabled=None, is_iso_inserted=None, capabilities=None, available_version=None, guest_os_version=None, is_reachable=None, is_vss_snapshot_capable=None, is_vm_mobility_drivers_installed=None, is_communication_active_over_serial_port=None, guest_info=None, *args, **kwargs):  # noqa: E501
        self.__version = None
        ...
        self.__is_communication_active_over_serial_port = None
        self.__guest_info = None
        ...
        if is_communication_active_over_serial_port is not None:
            self.__is_communication_active_over_serial_port = is_communication_active_over_serial_port
        if guest_info is not None:
            self.__guest_info = guest_info
    ...
    def capabilities(self):
        ...
        :type:
             list[ :class:`~ntnx_vmm_py_client.models.vmm.v4.ahv.config.NgtCapability` ]
        """  # noqa: E501
    ...
    @property
    def is_communication_active_over_serial_port(self):
        """
        ...
        :type:
                :class:`~bool`
        """  # noqa: E501
        return self.__is_communication_active_over_serial_port

    @is_communication_active_over_serial_port.setter
    def is_communication_active_over_serial_port(self, is_communication_active_over_serial_port):
    ...
    def guest_info(self):
        ...
        :type:
            :class:`~ntnx_vmm_py_client.models.vmm.v4.ahv.config.GuestInfo`
        """  # noqa: E501
        return self.__guest_info
