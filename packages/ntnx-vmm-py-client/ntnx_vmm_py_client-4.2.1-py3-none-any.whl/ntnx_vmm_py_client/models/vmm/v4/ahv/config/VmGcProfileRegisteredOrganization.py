...
class VmGcProfileRegisteredOrganization(object):

    """Name of the organization of the end user.

    :param value: (:attr:`value`) Registered organization value.
    :type value: required
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.ahv.config.VmGcProfileRegisteredOrganization'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VmGcProfileRegisteredOrganization, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VmGcProfileRegisteredOrganization):
            return False
