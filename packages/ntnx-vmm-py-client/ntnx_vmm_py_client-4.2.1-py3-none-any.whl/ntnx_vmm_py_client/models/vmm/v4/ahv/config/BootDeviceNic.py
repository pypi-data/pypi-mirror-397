...
class BootDeviceNic(object):

    """The NIC that will be used to boot the VM.

    :param mac_address: (:attr:`mac_address`) Mac address of the NIC that will be used to boot the VM.
    :type mac_address: 
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.ahv.config.BootDeviceNic'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(BootDeviceNic, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BootDeviceNic):
            return False
