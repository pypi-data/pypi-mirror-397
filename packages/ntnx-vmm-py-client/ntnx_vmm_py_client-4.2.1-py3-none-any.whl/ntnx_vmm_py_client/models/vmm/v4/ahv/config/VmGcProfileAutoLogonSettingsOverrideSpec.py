...
class VmGcProfileAutoLogonSettingsOverrideSpec(object):
    ...
    :param logon_count: (:attr:`logon_count`) Override value for the number of automatic logons allowed. This overrides the logon count from the referenced profile.
    :type logon_count: 
    ...
    def __init__(self, logon_count=None, *args, **kwargs):  # noqa: E501
        ...
        if logon_count is not None:
            self.__logon_count = logon_count
        # populate hidden vars if not empty
        self._populate_hidden_vars(kwargs)

    def _initialize_object_type(self):
        return 'vmm.v4.ahv.config.VmGcProfileAutoLogonSettingsOverrideSpec'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VmGcProfileAutoLogonSettingsOverrideSpec, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VmGcProfileAutoLogonSettingsOverrideSpec):
            return False
