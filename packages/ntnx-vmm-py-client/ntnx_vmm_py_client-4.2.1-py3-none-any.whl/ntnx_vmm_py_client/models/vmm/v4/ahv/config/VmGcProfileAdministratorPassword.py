...
class VmGcProfileAdministratorPassword(object):

    """Password to be configured for built-in Administrator account.

    :param value: (:attr:`value`) Administrator password value.
    :type value: required
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.ahv.config.VmGcProfileAdministratorPassword'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VmGcProfileAdministratorPassword, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VmGcProfileAdministratorPassword):
            return False
