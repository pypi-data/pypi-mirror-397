...
class OvaVmConfigOverrideSpec(object):
    ...
    def __init__(self, name=None, num_sockets=None, num_cores_per_socket=None, num_threads_per_core=None, memory_size_bytes=None, nics=None, cd_roms=None, categories=None, *args, **kwargs):  # noqa: E501
        self.__name = None
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.ahv.config.OvaVmConfigOverrideSpec'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(OvaVmConfigOverrideSpec, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OvaVmConfigOverrideSpec):
            return False
