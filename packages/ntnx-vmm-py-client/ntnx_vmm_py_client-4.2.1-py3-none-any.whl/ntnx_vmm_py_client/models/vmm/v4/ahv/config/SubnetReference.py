...
class SubnetReference(object):

    """Network identifier for this adapter. Only valid if nic_type is NORMAL_NIC or DIRECT_NIC.

    :param ext_id: (:attr:`ext_id`) The globally unique identifier of a subnet of type UUID.
    :type ext_id: 
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.ahv.config.SubnetReference'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(SubnetReference, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SubnetReference):
            return False
