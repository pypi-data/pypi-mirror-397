...
class VolumeDiskRecoveryPointReference(object):

    """Reference to a disk Recovery Point of a Volume disk.

    :param disk_recovery_point_ext_id: (:attr:`disk_recovery_point_ext_id`) An external identifier of the Volume disk Recovery Point. It should be of type UUID.
    :type disk_recovery_point_ext_id: 
    
    
    :param volume_group_recovery_point_ext_id: (:attr:`volume_group_recovery_point_ext_id`) The external identifier of the Volume Group Recovery Point. It should be of type UUID.
    ...
    def __init__(self, disk_recovery_point_ext_id=None, volume_group_recovery_point_ext_id=None, *args, **kwargs):  # noqa: E501
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.ahv.config.VolumeDiskRecoveryPointReference'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VolumeDiskRecoveryPointReference, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VolumeDiskRecoveryPointReference):
            return False
