...
class VmDiskRecoveryPointReference(object):

    """Reference to a Disk Recovery Point of a VM disk.

    :param disk_recovery_point_ext_id: (:attr:`disk_recovery_point_ext_id`) An external identifier of the Disk Recovery Point for a VM disk. It should be of type UUID.
    :type disk_recovery_point_ext_id: 
    
    
    :param vm_recovery_point_ext_id: (:attr:`vm_recovery_point_ext_id`) A globally unique identifier of a VM recovery point. It should be of type UUID.
    ...
    def __init__(self, disk_recovery_point_ext_id=None, vm_recovery_point_ext_id=None, *args, **kwargs):  # noqa: E501
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.ahv.config.VmDiskRecoveryPointReference'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VmDiskRecoveryPointReference, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VmDiskRecoveryPointReference):
            return False
