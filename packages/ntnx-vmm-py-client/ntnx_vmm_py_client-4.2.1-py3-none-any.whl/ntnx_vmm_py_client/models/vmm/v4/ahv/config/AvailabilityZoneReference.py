...
class AvailabilityZoneReference(object):

    """Reference to an availability zone.

    :param ext_id: (:attr:`ext_id`) The globally unique identifier of an availability zone type UUID.
    :type ext_id: 
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.ahv.config.AvailabilityZoneReference'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(AvailabilityZoneReference, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AvailabilityZoneReference):
            return False
