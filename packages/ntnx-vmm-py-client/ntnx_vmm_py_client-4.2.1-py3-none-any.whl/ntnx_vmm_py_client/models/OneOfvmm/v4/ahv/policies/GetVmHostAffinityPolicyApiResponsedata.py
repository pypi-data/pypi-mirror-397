...
class GetVmHostAffinityPolicyApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'vmm.v4.ahv.policies.VmHostAffinityPolicy': 'vmm.v4.ahv.policies.VmHostAffinityPolicy',
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.ahv.policies.GetVmHostAffinityPolicyApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetVmHostAffinityPolicyApiResponsedata.discriminator_value_class_map.values():
            return list(GetVmHostAffinityPolicyApiResponsedata.discriminator_value_class_map.keys())[list(GetVmHostAffinityPolicyApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetVmHostAffinityPolicyApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetVmHostAffinityPolicyApiResponsedata):
            return False
