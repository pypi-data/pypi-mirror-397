...
class GenerateConsoleTokenApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.ahv.config.GenerateConsoleTokenApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GenerateConsoleTokenApiResponsedata.discriminator_value_class_map.values():
            return list(GenerateConsoleTokenApiResponsedata.discriminator_value_class_map.keys())[list(GenerateConsoleTokenApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GenerateConsoleTokenApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GenerateConsoleTokenApiResponsedata):
            return False
