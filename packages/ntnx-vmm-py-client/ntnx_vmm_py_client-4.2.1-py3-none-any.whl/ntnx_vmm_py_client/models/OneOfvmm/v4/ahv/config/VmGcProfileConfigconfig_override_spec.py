...
class VmGcProfileConfigconfig_override_spec(object):
    ...
    discriminator_value_class_map = {
        ...
        'vmm.v4.ahv.config.VmGcProfileSysprepConfigOverrideSpec': 'vmm.v4.ahv.config.VmGcProfileSysprepConfigOverrideSpec'
    }

    ONE_OF_ITEM_DISCRIMINATOR_NAME = '$configOverrideSpecItemDiscriminator'
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.ahv.config.VmGcProfileConfigconfig_override_spec'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in VmGcProfileConfigconfig_override_spec.discriminator_value_class_map.values():
            return list(VmGcProfileConfigconfig_override_spec.discriminator_value_class_map.keys())[list(VmGcProfileConfigconfig_override_spec.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VmGcProfileConfigconfig_override_spec, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VmGcProfileConfigconfig_override_spec):
            return False
