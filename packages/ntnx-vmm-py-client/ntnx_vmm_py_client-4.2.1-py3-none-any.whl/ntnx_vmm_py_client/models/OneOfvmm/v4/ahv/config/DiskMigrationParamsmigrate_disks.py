...
class DiskMigrationParamsmigrate_disks(object):
    ...
    discriminator_value_class_map = {
        ...
        'vmm.v4.ahv.config.MigrationPlans': 'vmm.v4.ahv.config.MigrationPlans',
        'vmm.v4.ahv.config.AllDisksMigrationPlan': 'vmm.v4.ahv.config.AllDisksMigrationPlan'
    }

    ONE_OF_ITEM_DISCRIMINATOR_NAME = '$migrateDisksItemDiscriminator'
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.ahv.config.DiskMigrationParamsmigrate_disks'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in DiskMigrationParamsmigrate_disks.discriminator_value_class_map.values():
            return list(DiskMigrationParamsmigrate_disks.discriminator_value_class_map.keys())[list(DiskMigrationParamsmigrate_disks.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(DiskMigrationParamsmigrate_disks, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DiskMigrationParamsmigrate_disks):
            return False
