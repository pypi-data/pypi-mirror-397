...
class VmGcProfileLocaleSettingsOverrideSpecsystem_locale(object):
    ...
    discriminator_value_class_map = {
        ...
        'vmm.v4.ahv.config.VmGcProfileLocaleSettingOverride': 'vmm.v4.ahv.config.VmGcProfileLocaleSettingOverride',
        'vmm.v4.ahv.config.VmGcProfileDiscardSettings': 'vmm.v4.ahv.config.VmGcProfileDiscardSettings'
    }

    ONE_OF_ITEM_DISCRIMINATOR_NAME = '$systemLocaleItemDiscriminator'
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.ahv.config.VmGcProfileLocaleSettingsOverrideSpecsystem_locale'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in VmGcProfileLocaleSettingsOverrideSpecsystem_locale.discriminator_value_class_map.values():
            return list(VmGcProfileLocaleSettingsOverrideSpecsystem_locale.discriminator_value_class_map.keys())[list(VmGcProfileLocaleSettingsOverrideSpecsystem_locale.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VmGcProfileLocaleSettingsOverrideSpecsystem_locale, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VmGcProfileLocaleSettingsOverrideSpecsystem_locale):
            return False
