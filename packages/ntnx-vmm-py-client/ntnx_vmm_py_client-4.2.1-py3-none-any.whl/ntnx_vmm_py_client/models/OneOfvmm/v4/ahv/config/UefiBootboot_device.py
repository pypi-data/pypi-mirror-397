...
class UefiBootboot_device(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.ahv.config.UefiBootboot_device'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in UefiBootboot_device.discriminator_value_class_map.values():
            return list(UefiBootboot_device.discriminator_value_class_map.keys())[list(UefiBootboot_device.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(UefiBootboot_device, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UefiBootboot_device):
            return False
