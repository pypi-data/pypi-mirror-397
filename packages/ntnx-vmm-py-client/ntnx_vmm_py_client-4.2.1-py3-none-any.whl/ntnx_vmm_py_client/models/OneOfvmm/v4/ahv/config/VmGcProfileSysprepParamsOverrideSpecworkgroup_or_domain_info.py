...
class VmGcProfileSysprepParamsOverrideSpecworkgroup_or_domain_info(object):
    ...
    discriminator_value_class_map = {
        ...
        'vmm.v4.ahv.config.VmGcProfileWorkgroupOverrideSpec': 'vmm.v4.ahv.config.VmGcProfileWorkgroupOverrideSpec',
        'vmm.v4.ahv.config.VmGcProfileDomainSettingsOverrideSpec': 'vmm.v4.ahv.config.VmGcProfileDomainSettingsOverrideSpec',
        'vmm.v4.ahv.config.VmGcProfileDiscardSettings': 'vmm.v4.ahv.config.VmGcProfileDiscardSettings'
    }

    ONE_OF_ITEM_DISCRIMINATOR_NAME = '$workgroupOrDomainInfoItemDiscriminator'
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.ahv.config.VmGcProfileSysprepParamsOverrideSpecworkgroup_or_domain_info'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in VmGcProfileSysprepParamsOverrideSpecworkgroup_or_domain_info.discriminator_value_class_map.values():
            return list(VmGcProfileSysprepParamsOverrideSpecworkgroup_or_domain_info.discriminator_value_class_map.keys())[list(VmGcProfileSysprepParamsOverrideSpecworkgroup_or_domain_info.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VmGcProfileSysprepParamsOverrideSpecworkgroup_or_domain_info, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VmGcProfileSysprepParamsOverrideSpecworkgroup_or_domain_info):
            return False
