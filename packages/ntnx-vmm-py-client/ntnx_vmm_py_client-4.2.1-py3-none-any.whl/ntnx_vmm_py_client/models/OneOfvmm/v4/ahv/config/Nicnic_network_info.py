...
class Nicnic_network_info(object):
    ...
    discriminator_value_class_map = {
        ...
        'vmm.v4.ahv.config.VirtualEthernetNicNetworkInfo': 'vmm.v4.ahv.config.VirtualEthernetNicNetworkInfo',
        'vmm.v4.ahv.config.SriovNicNetworkInfo': 'vmm.v4.ahv.config.SriovNicNetworkInfo',
        'vmm.v4.ahv.config.DpOffloadNicNetworkInfo': 'vmm.v4.ahv.config.DpOffloadNicNetworkInfo'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.ahv.config.Nicnic_network_info'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in Nicnic_network_info.discriminator_value_class_map.values():
            return list(Nicnic_network_info.discriminator_value_class_map.keys())[list(Nicnic_network_info.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(Nicnic_network_info, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, Nicnic_network_info):
            return False
