...
class CreateVmGuestCustomizationProfileApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.ahv.config.CreateVmGuestCustomizationProfileApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in CreateVmGuestCustomizationProfileApiResponsedata.discriminator_value_class_map.values():
            return list(CreateVmGuestCustomizationProfileApiResponsedata.discriminator_value_class_map.keys())[list(CreateVmGuestCustomizationProfileApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(CreateVmGuestCustomizationProfileApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateVmGuestCustomizationProfileApiResponsedata):
            return False
