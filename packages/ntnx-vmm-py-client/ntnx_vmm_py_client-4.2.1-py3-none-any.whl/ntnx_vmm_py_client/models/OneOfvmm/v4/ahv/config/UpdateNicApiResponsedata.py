...
class UpdateNicApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.ahv.config.UpdateNicApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in UpdateNicApiResponsedata.discriminator_value_class_map.values():
            return list(UpdateNicApiResponsedata.discriminator_value_class_map.keys())[list(UpdateNicApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(UpdateNicApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateNicApiResponsedata):
            return False
