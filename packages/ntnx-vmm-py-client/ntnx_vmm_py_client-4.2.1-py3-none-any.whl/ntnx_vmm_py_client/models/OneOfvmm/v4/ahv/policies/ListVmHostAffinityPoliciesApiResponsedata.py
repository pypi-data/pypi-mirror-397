...
class ListVmHostAffinityPoliciesApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<vmm.v4.ahv.policies.VmHostAffinityPolicy>': 'list[vmm.v4.ahv.policies.VmHostAffinityPolicy]',
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.ahv.policies.ListVmHostAffinityPoliciesApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListVmHostAffinityPoliciesApiResponsedata.discriminator_value_class_map.values():
            return list(ListVmHostAffinityPoliciesApiResponsedata.discriminator_value_class_map.keys())[list(ListVmHostAffinityPoliciesApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListVmHostAffinityPoliciesApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListVmHostAffinityPoliciesApiResponsedata):
            return False
