...
class VmStartupPolicyNonCompliantVmnon_compliance_reason(object):
    ...
    discriminator_value_class_map = {
        ...
        'vmm.v4.ahv.policies.VmStartupPolicyClusterNotSupported': 'vmm.v4.ahv.policies.VmStartupPolicyClusterNotSupported',
        'vmm.v4.ahv.policies.VmStartupPolicyNgtNotEnabled': 'vmm.v4.ahv.policies.VmStartupPolicyNgtNotEnabled',
        'vmm.v4.ahv.policies.VmStartupPolicyHaNotSupported': 'vmm.v4.ahv.policies.VmStartupPolicyHaNotSupported'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.ahv.policies.VmStartupPolicyNonCompliantVmnon_compliance_reason'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in VmStartupPolicyNonCompliantVmnon_compliance_reason.discriminator_value_class_map.values():
            return list(VmStartupPolicyNonCompliantVmnon_compliance_reason.discriminator_value_class_map.keys())[list(VmStartupPolicyNonCompliantVmnon_compliance_reason.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VmStartupPolicyNonCompliantVmnon_compliance_reason, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VmStartupPolicyNonCompliantVmnon_compliance_reason):
            return False
