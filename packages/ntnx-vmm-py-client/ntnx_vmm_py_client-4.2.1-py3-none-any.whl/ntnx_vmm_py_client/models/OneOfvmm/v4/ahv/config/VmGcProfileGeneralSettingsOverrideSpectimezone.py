...
class VmGcProfileGeneralSettingsOverrideSpectimezone(object):
    ...
    discriminator_value_class_map = {
        ...
        'vmm.v4.ahv.config.VmGcProfileTimezone': 'vmm.v4.ahv.config.VmGcProfileTimezone',
        'vmm.v4.ahv.config.VmGcProfileDiscardSettings': 'vmm.v4.ahv.config.VmGcProfileDiscardSettings'
    }

    ONE_OF_ITEM_DISCRIMINATOR_NAME = '$timezoneItemDiscriminator'
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.ahv.config.VmGcProfileGeneralSettingsOverrideSpectimezone'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in VmGcProfileGeneralSettingsOverrideSpectimezone.discriminator_value_class_map.values():
            return list(VmGcProfileGeneralSettingsOverrideSpectimezone.discriminator_value_class_map.keys())[list(VmGcProfileGeneralSettingsOverrideSpectimezone.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VmGcProfileGeneralSettingsOverrideSpectimezone, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VmGcProfileGeneralSettingsOverrideSpectimezone):
            return False
