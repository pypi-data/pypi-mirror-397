...
class PcieDevicebacking_info(object):
    ...
    discriminator_value_class_map = {
        ...
        'vmm.v4.ahv.config.PcieDeviceReference': 'vmm.v4.ahv.config.PcieDeviceReference'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.ahv.config.PcieDevicebacking_info'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in PcieDevicebacking_info.discriminator_value_class_map.values():
            return list(PcieDevicebacking_info.discriminator_value_class_map.keys())[list(PcieDevicebacking_info.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(PcieDevicebacking_info, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PcieDevicebacking_info):
            return False
