...
class VmStartupPolicyVmComplianceStatecompliance_status(object):
    ...
    discriminator_value_class_map = {
        ...
        'vmm.v4.ahv.policies.VmStartupPolicyCompliantVm': 'vmm.v4.ahv.policies.VmStartupPolicyCompliantVm',
        'vmm.v4.ahv.policies.VmStartupPolicyPendingVm': 'vmm.v4.ahv.policies.VmStartupPolicyPendingVm',
        'vmm.v4.ahv.policies.VmStartupPolicyNonCompliantVm': 'vmm.v4.ahv.policies.VmStartupPolicyNonCompliantVm'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.ahv.policies.VmStartupPolicyVmComplianceStatecompliance_status'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in VmStartupPolicyVmComplianceStatecompliance_status.discriminator_value_class_map.values():
            return list(VmStartupPolicyVmComplianceStatecompliance_status.discriminator_value_class_map.keys())[list(VmStartupPolicyVmComplianceStatecompliance_status.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VmStartupPolicyVmComplianceStatecompliance_status, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VmStartupPolicyVmComplianceStatecompliance_status):
            return False
