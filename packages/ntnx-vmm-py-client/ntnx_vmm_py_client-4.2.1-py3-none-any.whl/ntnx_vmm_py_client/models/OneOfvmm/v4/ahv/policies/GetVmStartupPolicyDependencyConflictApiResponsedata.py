...
class GetVmStartupPolicyDependencyConflictApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'vmm.v4.ahv.policies.DependencyConflict': 'vmm.v4.ahv.policies.DependencyConflict',
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.ahv.policies.GetVmStartupPolicyDependencyConflictApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetVmStartupPolicyDependencyConflictApiResponsedata.discriminator_value_class_map.values():
            return list(GetVmStartupPolicyDependencyConflictApiResponsedata.discriminator_value_class_map.keys())[list(GetVmStartupPolicyDependencyConflictApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetVmStartupPolicyDependencyConflictApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetVmStartupPolicyDependencyConflictApiResponsedata):
            return False
