...
class VmGcProfileGeneralSettingsOverrideSpecregistered_organization(object):
    ...
    discriminator_value_class_map = {
        ...
        'vmm.v4.ahv.config.VmGcProfileRegisteredOrganization': 'vmm.v4.ahv.config.VmGcProfileRegisteredOrganization',
        'vmm.v4.ahv.config.VmGcProfileDiscardSettings': 'vmm.v4.ahv.config.VmGcProfileDiscardSettings'
    }

    ONE_OF_ITEM_DISCRIMINATOR_NAME = '$registeredOrganizationItemDiscriminator'
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.ahv.config.VmGcProfileGeneralSettingsOverrideSpecregistered_organization'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in VmGcProfileGeneralSettingsOverrideSpecregistered_organization.discriminator_value_class_map.values():
            return list(VmGcProfileGeneralSettingsOverrideSpecregistered_organization.discriminator_value_class_map.keys())[list(VmGcProfileGeneralSettingsOverrideSpecregistered_organization.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VmGcProfileGeneralSettingsOverrideSpecregistered_organization, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VmGcProfileGeneralSettingsOverrideSpecregistered_organization):
            return False
