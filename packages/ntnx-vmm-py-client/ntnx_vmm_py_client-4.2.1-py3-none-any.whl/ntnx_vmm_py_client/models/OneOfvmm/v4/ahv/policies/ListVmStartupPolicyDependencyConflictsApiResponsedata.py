...
class ListVmStartupPolicyDependencyConflictsApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<vmm.v4.ahv.policies.DependencyConflict>': 'list[vmm.v4.ahv.policies.DependencyConflict]',
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.ahv.policies.ListVmStartupPolicyDependencyConflictsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListVmStartupPolicyDependencyConflictsApiResponsedata.discriminator_value_class_map.values():
            return list(ListVmStartupPolicyDependencyConflictsApiResponsedata.discriminator_value_class_map.keys())[list(ListVmStartupPolicyDependencyConflictsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListVmStartupPolicyDependencyConflictsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListVmStartupPolicyDependencyConflictsApiResponsedata):
            return False
