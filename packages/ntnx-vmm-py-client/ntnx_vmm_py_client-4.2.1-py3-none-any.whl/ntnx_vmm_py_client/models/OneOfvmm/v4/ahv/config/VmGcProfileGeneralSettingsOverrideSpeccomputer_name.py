...
class VmGcProfileGeneralSettingsOverrideSpeccomputer_name(object):
    ...
    discriminator_value_class_map = {
        ...
        'vmm.v4.ahv.config.VmGcProfileComputerName': 'vmm.v4.ahv.config.VmGcProfileComputerName',
        'vmm.v4.ahv.config.VmGcProfileUseVmNameOverrideSpec': 'vmm.v4.ahv.config.VmGcProfileUseVmNameOverrideSpec',
        'vmm.v4.ahv.config.VmGcProfileDiscardSettings': 'vmm.v4.ahv.config.VmGcProfileDiscardSettings'
    }

    ONE_OF_ITEM_DISCRIMINATOR_NAME = '$computerNameItemDiscriminator'
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.ahv.config.VmGcProfileGeneralSettingsOverrideSpeccomputer_name'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in VmGcProfileGeneralSettingsOverrideSpeccomputer_name.discriminator_value_class_map.values():
            return list(VmGcProfileGeneralSettingsOverrideSpeccomputer_name.discriminator_value_class_map.keys())[list(VmGcProfileGeneralSettingsOverrideSpeccomputer_name.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VmGcProfileGeneralSettingsOverrideSpeccomputer_name, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VmGcProfileGeneralSettingsOverrideSpeccomputer_name):
            return False
