...
class CreateCdRomApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.ahv.config.CreateCdRomApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in CreateCdRomApiResponsedata.discriminator_value_class_map.values():
            return list(CreateCdRomApiResponsedata.discriminator_value_class_map.keys())[list(CreateCdRomApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(CreateCdRomApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateCdRomApiResponsedata):
            return False
