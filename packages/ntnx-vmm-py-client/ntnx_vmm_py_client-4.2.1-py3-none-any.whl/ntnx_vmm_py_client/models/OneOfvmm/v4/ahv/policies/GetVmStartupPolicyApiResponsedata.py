...
class GetVmStartupPolicyApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'vmm.v4.ahv.policies.VmStartupPolicy': 'vmm.v4.ahv.policies.VmStartupPolicy',
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.ahv.policies.GetVmStartupPolicyApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetVmStartupPolicyApiResponsedata.discriminator_value_class_map.values():
            return list(GetVmStartupPolicyApiResponsedata.discriminator_value_class_map.keys())[list(GetVmStartupPolicyApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetVmStartupPolicyApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetVmStartupPolicyApiResponsedata):
            return False
