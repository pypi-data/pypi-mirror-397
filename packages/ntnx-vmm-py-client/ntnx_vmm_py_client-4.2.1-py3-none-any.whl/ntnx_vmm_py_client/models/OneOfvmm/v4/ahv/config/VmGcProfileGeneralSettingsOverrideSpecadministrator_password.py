...
class VmGcProfileGeneralSettingsOverrideSpecadministrator_password(object):
    ...
    discriminator_value_class_map = {
        ...
        'vmm.v4.ahv.config.VmGcProfileAdministratorPassword': 'vmm.v4.ahv.config.VmGcProfileAdministratorPassword',
        'vmm.v4.ahv.config.VmGcProfileDiscardSettings': 'vmm.v4.ahv.config.VmGcProfileDiscardSettings'
    }

    ONE_OF_ITEM_DISCRIMINATOR_NAME = '$administratorPasswordItemDiscriminator'
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.ahv.config.VmGcProfileGeneralSettingsOverrideSpecadministrator_password'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in VmGcProfileGeneralSettingsOverrideSpecadministrator_password.discriminator_value_class_map.values():
            return list(VmGcProfileGeneralSettingsOverrideSpecadministrator_password.discriminator_value_class_map.keys())[list(VmGcProfileGeneralSettingsOverrideSpecadministrator_password.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VmGcProfileGeneralSettingsOverrideSpecadministrator_password, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VmGcProfileGeneralSettingsOverrideSpecadministrator_password):
            return False
