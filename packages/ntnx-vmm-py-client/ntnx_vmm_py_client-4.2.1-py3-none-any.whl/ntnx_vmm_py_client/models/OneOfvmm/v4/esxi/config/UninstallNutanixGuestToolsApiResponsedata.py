...
class UninstallNutanixGuestToolsApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.esxi.config.UninstallNutanixGuestToolsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in UninstallNutanixGuestToolsApiResponsedata.discriminator_value_class_map.values():
            return list(UninstallNutanixGuestToolsApiResponsedata.discriminator_value_class_map.keys())[list(UninstallNutanixGuestToolsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(UninstallNutanixGuestToolsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UninstallNutanixGuestToolsApiResponsedata):
            return False
