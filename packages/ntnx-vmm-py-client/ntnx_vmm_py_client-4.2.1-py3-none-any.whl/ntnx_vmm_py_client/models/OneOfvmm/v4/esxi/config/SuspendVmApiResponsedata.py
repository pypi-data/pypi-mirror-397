...
class SuspendVmApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.esxi.config.SuspendVmApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in SuspendVmApiResponsedata.discriminator_value_class_map.values():
            return list(SuspendVmApiResponsedata.discriminator_value_class_map.keys())[list(SuspendVmApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(SuspendVmApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SuspendVmApiResponsedata):
            return False
