...
class RebootGuestOSApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.esxi.config.RebootGuestOSApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in RebootGuestOSApiResponsedata.discriminator_value_class_map.values():
            return list(RebootGuestOSApiResponsedata.discriminator_value_class_map.keys())[list(RebootGuestOSApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(RebootGuestOSApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RebootGuestOSApiResponsedata):
            return False
