...
class GetTemplateVersionApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'vmm.v4.content.TemplateVersionSpec': 'vmm.v4.content.TemplateVersionSpec',
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.content.GetTemplateVersionApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetTemplateVersionApiResponsedata.discriminator_value_class_map.values():
            return list(GetTemplateVersionApiResponsedata.discriminator_value_class_map.keys())[list(GetTemplateVersionApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetTemplateVersionApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetTemplateVersionApiResponsedata):
            return False
