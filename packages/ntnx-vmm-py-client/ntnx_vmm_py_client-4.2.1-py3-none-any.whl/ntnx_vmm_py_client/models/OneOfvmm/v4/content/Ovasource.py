...
class Ovasource(object):
    ...
    discriminator_value_class_map = {
        ...
        'vmm.v4.content.OvaUrlSource': 'vmm.v4.content.OvaUrlSource',
        'vmm.v4.content.OvaVmSource': 'vmm.v4.content.OvaVmSource',
        'vmm.v4.content.ObjectsLiteSource': 'vmm.v4.content.ObjectsLiteSource'
    }

    ONE_OF_ITEM_DISCRIMINATOR_NAME = '$sourceItemDiscriminator'
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.content.Ovasource'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in Ovasource.discriminator_value_class_map.values():
            return list(Ovasource.discriminator_value_class_map.keys())[list(Ovasource.discriminator_value_class_map.values()).index(disc)]
        return None
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, Ovasource):
            return False
