...
class DeployTemplateApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.content.DeployTemplateApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in DeployTemplateApiResponsedata.discriminator_value_class_map.values():
            return list(DeployTemplateApiResponsedata.discriminator_value_class_map.keys())[list(DeployTemplateApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(DeployTemplateApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeployTemplateApiResponsedata):
            return False
