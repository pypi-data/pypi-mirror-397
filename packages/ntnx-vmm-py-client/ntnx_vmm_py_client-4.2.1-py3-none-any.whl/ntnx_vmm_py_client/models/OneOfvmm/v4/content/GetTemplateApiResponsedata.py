...
class GetTemplateApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'vmm.v4.content.Template': 'vmm.v4.content.Template',
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.content.GetTemplateApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetTemplateApiResponsedata.discriminator_value_class_map.values():
            return list(GetTemplateApiResponsedata.discriminator_value_class_map.keys())[list(GetTemplateApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetTemplateApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetTemplateApiResponsedata):
            return False
