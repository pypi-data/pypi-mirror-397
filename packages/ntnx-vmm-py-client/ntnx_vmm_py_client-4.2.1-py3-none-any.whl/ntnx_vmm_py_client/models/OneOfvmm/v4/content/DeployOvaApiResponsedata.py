...
class DeployOvaApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.content.DeployOvaApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in DeployOvaApiResponsedata.discriminator_value_class_map.values():
            return list(DeployOvaApiResponsedata.discriminator_value_class_map.keys())[list(DeployOvaApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(DeployOvaApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeployOvaApiResponsedata):
            return False
