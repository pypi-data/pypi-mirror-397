...
class ListOvasApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<vmm.v4.content.Ova>': 'list[vmm.v4.content.Ova]',
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.content.ListOvasApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListOvasApiResponsedata.discriminator_value_class_map.values():
            return list(ListOvasApiResponsedata.discriminator_value_class_map.keys())[list(ListOvasApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListOvasApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListOvasApiResponsedata):
            return False
