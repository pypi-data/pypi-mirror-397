...
class ListTemplatesApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<vmm.v4.content.Template>': 'list[vmm.v4.content.Template]',
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.content.ListTemplatesApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListTemplatesApiResponsedata.discriminator_value_class_map.values():
            return list(ListTemplatesApiResponsedata.discriminator_value_class_map.keys())[list(ListTemplatesApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListTemplatesApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListTemplatesApiResponsedata):
            return False
