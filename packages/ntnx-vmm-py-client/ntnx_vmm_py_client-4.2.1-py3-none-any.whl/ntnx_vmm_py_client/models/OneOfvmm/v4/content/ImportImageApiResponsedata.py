...
class ImportImageApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.content.ImportImageApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ImportImageApiResponsedata.discriminator_value_class_map.values():
            return list(ImportImageApiResponsedata.discriminator_value_class_map.keys())[list(ImportImageApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ImportImageApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ImportImageApiResponsedata):
            return False
