...
class Ovachecksum(object):
    ...
    discriminator_value_class_map = {
        ...
        'vmm.v4.content.OvaSha1Checksum': 'vmm.v4.content.OvaSha1Checksum',
        'vmm.v4.content.OvaSha256Checksum': 'vmm.v4.content.OvaSha256Checksum'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.content.Ovachecksum'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in Ovachecksum.discriminator_value_class_map.values():
            return list(Ovachecksum.discriminator_value_class_map.keys())[list(Ovachecksum.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(Ovachecksum, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, Ovachecksum):
            return False
