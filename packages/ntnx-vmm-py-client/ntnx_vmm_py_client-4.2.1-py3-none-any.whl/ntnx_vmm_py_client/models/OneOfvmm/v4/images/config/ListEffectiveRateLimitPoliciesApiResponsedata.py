...
class ListEffectiveRateLimitPoliciesApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<vmm.v4.images.config.EffectiveRateLimitPolicy>': 'list[vmm.v4.images.config.EffectiveRateLimitPolicy]',
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.images.config.ListEffectiveRateLimitPoliciesApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListEffectiveRateLimitPoliciesApiResponsedata.discriminator_value_class_map.values():
            return list(ListEffectiveRateLimitPoliciesApiResponsedata.discriminator_value_class_map.keys())[list(ListEffectiveRateLimitPoliciesApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListEffectiveRateLimitPoliciesApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListEffectiveRateLimitPoliciesApiResponsedata):
            return False
