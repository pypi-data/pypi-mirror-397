...
class CreateRateLimitPolicyApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.images.config.CreateRateLimitPolicyApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in CreateRateLimitPolicyApiResponsedata.discriminator_value_class_map.values():
            return list(CreateRateLimitPolicyApiResponsedata.discriminator_value_class_map.keys())[list(CreateRateLimitPolicyApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(CreateRateLimitPolicyApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateRateLimitPolicyApiResponsedata):
            return False
