...
class GetPlacementPolicyApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'vmm.v4.images.config.PlacementPolicy': 'vmm.v4.images.config.PlacementPolicy',
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.images.config.GetPlacementPolicyApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetPlacementPolicyApiResponsedata.discriminator_value_class_map.values():
            return list(GetPlacementPolicyApiResponsedata.discriminator_value_class_map.keys())[list(GetPlacementPolicyApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetPlacementPolicyApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetPlacementPolicyApiResponsedata):
            return False
