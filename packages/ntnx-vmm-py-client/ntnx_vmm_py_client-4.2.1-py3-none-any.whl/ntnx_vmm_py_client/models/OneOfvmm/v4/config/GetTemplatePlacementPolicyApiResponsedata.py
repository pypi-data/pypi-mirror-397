...
class GetTemplatePlacementPolicyApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'vmm.v4.config.TemplatePlacementPolicy': 'vmm.v4.config.TemplatePlacementPolicy',
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.config.GetTemplatePlacementPolicyApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetTemplatePlacementPolicyApiResponsedata.discriminator_value_class_map.values():
            return list(GetTemplatePlacementPolicyApiResponsedata.discriminator_value_class_map.keys())[list(GetTemplatePlacementPolicyApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetTemplatePlacementPolicyApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetTemplatePlacementPolicyApiResponsedata):
            return False
