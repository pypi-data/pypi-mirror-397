...
class BaseRecoveryPoint(ExternalizableAbstractModel):
    ...
    def __init__(self, location_agnostic_id=None, name=None, creation_time=None, expiration_time=None, status=None, recovery_point_type=None, total_exclusive_usage_bytes=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
