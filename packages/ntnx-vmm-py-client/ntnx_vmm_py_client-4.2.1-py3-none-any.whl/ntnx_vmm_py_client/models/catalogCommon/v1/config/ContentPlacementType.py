...
class ContentPlacementType(object):
    ...
    Allowed enum values:
        ...
        - _UNKNOWN
        - _REDACTED
        - SOFT: Soft placement policy.
Entities can be placed on clusters beyond those mandated by the placement policy.
    ...
    def _initialize_object_type(self):
        return 'catalogCommon.v1.config.ContentPlacementType'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ContentPlacementType, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ContentPlacementType):
            return False
