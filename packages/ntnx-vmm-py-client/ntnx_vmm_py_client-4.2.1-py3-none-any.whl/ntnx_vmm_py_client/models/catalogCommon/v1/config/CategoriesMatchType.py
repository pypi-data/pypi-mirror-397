...
class CategoriesMatchType(object):
    ...
    Allowed enum values:
        ...
        - _UNKNOWN
        - _REDACTED
        - CATEGORIES_MATCH_ALL: The policy only applies to the entities matching all the categories attached to the policy.
        - CATEGORIES_MATCH_ANY: The policy only applies to the entities matching a subset of categories attached to the policy.
    """
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    CATEGORIES_MATCH_ALL = "CATEGORIES_MATCH_ALL"
    CATEGORIES_MATCH_ANY = "CATEGORIES_MATCH_ANY"
    ...
    def _initialize_object_type(self):
        return 'catalogCommon.v1.config.CategoriesMatchType'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(CategoriesMatchType, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CategoriesMatchType):
            return False
