...
class BaseVmRecoveryPointapplication_consistent_properties(object):
    ...
    discriminator_value_class_map = {
        ...
        'dataprotection.v4.common.VssProperties': 'dataprotection.v4.common.VssProperties'
    }

    ONE_OF_ITEM_DISCRIMINATOR_NAME = '$applicationConsistentPropertiesItemDiscriminator'
    ...
    def _initialize_object_type(self):
        return 'OneOfdataprotection.v4.common.BaseVmRecoveryPointapplication_consistent_properties'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in BaseVmRecoveryPointapplication_consistent_properties.discriminator_value_class_map.values():
            return list(BaseVmRecoveryPointapplication_consistent_properties.discriminator_value_class_map.keys())[list(BaseVmRecoveryPointapplication_consistent_properties.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(BaseVmRecoveryPointapplication_consistent_properties, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BaseVmRecoveryPointapplication_consistent_properties):
            return False
