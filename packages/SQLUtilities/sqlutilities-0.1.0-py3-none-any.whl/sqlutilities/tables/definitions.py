...
class ColumnDefinition:
    ...
    time_precision: Optional[int] = None  # For temporal types (0-9, where 0=second, 3=millisecond, 6=microsecond, 9=nanosecond)
    ...
    def full_data_type(self, ) -> str:
        ...
        return COLUMNDTYPE.to_sql_string(datatype=self.data_type, target_dialect=self.dialect,
                                         size_spec=(self.precision, self.scale) if isinstance(self.precision, int) and isinstance(self.scale, int) else self.precision if isinstance(self.precision, int) else self.length if isinstance(self.length, (int | str)) else None)
    ...
    def is_string_type(self) -> bool:
        ...
        string_types = {
            ...
            COLUMNDTYPE.NVARCHAR, COLUMNDTYPE.NCHAR, COLUMNDTYPE.CHARACTER,
            COLUMNDTYPE.LONGTEXT, COLUMNDTYPE.MEDIUMTEXT, COLUMNDTYPE.TINYTEXT,
            COLUMNDTYPE.VARCHAR2, COLUMNDTYPE.NVARCHAR2, COLUMNDTYPE.NCLOB
        }
