...
try:
    ...
    from errors.patterns import ErrorPattern, ErrorCategory, RetryPolicy
except ImportError:
    from ..core.enums import SQLDialect
...
class SQLErrorRegistry:
    ...
    def get_retry_delay(self, 
                       ...
                       driver_name: str, 
                       error: Exception, 
                       error_message: Optional[str] = None) -> Optional[float]:
        """
...
def classify_sql_error(dialect: SQLDialect, 
                      driver_name: str, 
                      error: Exception, 
                      error_message: Optional[str] = None) -> Optional[ErrorPattern]:
    """
...
def is_sql_error_retryable(dialect: SQLDialect, 
                          driver_name: str, 
                          error: Exception, 
                          error_message: Optional[str] = None) -> bool:
    """
