...
from typing import Dict, Any, List, Optional, Union, Literal, NamedTuple, Tuple, TYPE_CHECKING
from .enums import SQLDialect, DatabaseObjectType
...
class COLUMNDTYPE(Enum):
    ...
    SMALLINT = ("smallint", {
        ...
        "max_precision": None,
        "time_zone_support": False,
        "supported_dialects": [SQLDialect.POSTGRES, SQLDialect.SQLSERVER, SQLDialect.MYSQL, SQLDialect.SQLITE, SQLDialect.REDSHIFT],
        "min_value": -32768,
        "max_value": 32767,
        "optimal_type": int,
        "format_hints": {
    ...
    DECIMAL = ("decimal", {
        ...
        "time_zone_support": False,
        "supported_dialects": [SQLDialect.ORACLE, SQLDialect.POSTGRES, SQLDialect.SQLSERVER, SQLDialect.MYSQL, SQLDialect.SQLITE, SQLDialect.BIGQUERY, SQLDialect.REDSHIFT],
        ...
        "dialect_overrides": {
            SQLDialect.ORACLE: ("NUMBER", None)  # Oracle uses NUMBER instead of DECIMAL
        }
    })
    NUMERIC = ("numeric", {
        "category": "numeric_decimal",
    ...
    FLOAT = ("float", {
        ...
        "min_value": -3.4028235e+38,  # Single precision by default
        "max_value": 3.4028235e+38,
        "optimal_type": float,
        "format_hints": {
            "precision_type": "approximate",
            "scientific_notation_ok": True,
            "inf_nan_support": True
        },
        "sql_parameters": {
            ...
            "alternate_formats": {
                "with_precision": "{type_name}({precision})"  # FLOAT(precision)
            }
        },
        "dialect_overrides": {
    ...
    CHAR = ("char", {
        ...
        "max_precision": 8000,
        "time_zone_support": False,
        "supported_dialects": [SQLDialect.ORACLE, SQLDialect.POSTGRES, SQLDialect.SQLSERVER, SQLDialect.MYSQL, SQLDialect.SQLITE, SQLDialect.REDSHIFT],
        "min_value": None,
        "max_value": None,
        "optimal_type": str,
        "format_hints": {
        ...
        "dialect_overrides": {
            SQLDialect.BIGQUERY: ("STRING", None)  # BigQuery uses STRING instead of CHAR
        },
        "special_properties": {
            SQLDialect.MYSQL: {
                "max_bytes": 255,
    ...
    CHARACTER = ("character", {
        ...
        "max_precision": 8000,
        "time_zone_support": False,
        "supported_dialects": [SQLDialect.ORACLE, SQLDialect.POSTGRES, SQLDialect.SQLSERVER, SQLDialect.MYSQL, SQLDialect.SQLITE],
        "min_value": None,
        "max_value": None,
        "optimal_type": str,
        "format_hints": {
    ...
    VARCHAR = ("varchar", {
        ...
        "format_hints": {
            "encoding": "utf-8",
            "escape_chars": True,
            "null_handling": "empty_string_as_null"
        },
        "sql_parameters": {
        ...
        "special_properties": {
            ...
            SQLDialect.SQLSERVER: {
                ...
                "format_hints": {"encoding": "utf-16", "use_nvarchar_for_unicode": True, "supports_max": True, "varchar_max_for_large_text": True}
            },
            SQLDialect.ORACLE: {
                "max_bytes": 4000,
    ...
    NVARCHAR = ("nvarchar", {
        ...
        "special_properties": {
            SQLDialect.SQLSERVER: {
                ...
                "format_hints": {"encoding": "utf-16", "unicode_support": True, "supports_max": True, "nvarchar_max_for_large_text": True}
            }
        },
        "dialect_overrides": {
    ...
    TEXT = ("text", {
        ...
        "special_properties": {
            ...
            SQLDialect.POSTGRES: {
                ...
                "format_hints": {"encoding": "utf-8", "unlimited_practical_size": True, "streaming_recommended": True}
            },
            SQLDialect.SQLITE: {
                "max_bytes": 1000000000,  # 1GB limit
    ...
    DATE = ("date", {
        ...
        "max_precision": None,
        "time_zone_support": False,
        "supported_dialects": [SQLDialect.ORACLE, SQLDialect.POSTGRES, SQLDialect.SQLSERVER, SQLDialect.MYSQL, SQLDialect.BIGQUERY, SQLDialect.REDSHIFT],
        ...
        "dialect_overrides": {
            SQLDialect.SQLITE: ("TEXT", None)  # SQLite doesn't have native DATE
        },
        "special_properties": {
            SQLDialect.MYSQL: {
            ...
            SQLDialect.ORACLE: {
                ...
                "format_hints": {"iso_format": "YYYY-MM-DD", "century_handling": True, "bc_support": True, "use_native_date": True}
            },
            SQLDialect.POSTGRES: {
    ...
    TIME = ("time", {
        ...
        "max_precision": 6,
        "time_zone_support": False,
        "supported_dialects": [SQLDialect.POSTGRES, SQLDialect.SQLSERVER, SQLDialect.MYSQL, SQLDialect.SQLITE, SQLDialect.BIGQUERY,
                                SQLDialect.REDSHIFT],
        "min_value": "00:00:00",
    ...
    TIMESTAMP = ("timestamp", {
        ...
        "max_precision": 6,
        "time_zone_support": False,
        "supported_dialects": [SQLDialect.ORACLE, SQLDialect.POSTGRES, SQLDialect.MYSQL, SQLDialect.SQLITE, SQLDialect.BIGQUERY, SQLDialect.REDSHIFT],
    ...
    TIMESTAMP_WITH_TIME_ZONE = ("TIMESTAMP WITH TIME ZONE", {
        ...
        "sql_parameters": {
            ...
            "alternate_formats": {
                "precision_only": "TIMESTAMP({precision}) WITH TIME ZONE"
            }
        },
        "dialect_overrides": {
            SQLDialect.SQLSERVER: ("DATETIMEOFFSET", None),
    ...
    TIMESTAMP_WITHOUT_TIME_ZONE = ("TIMESTAMP WITHOUT TIME ZONE", {
        ...
        "sql_parameters": {
            ...
            "alternate_formats": {
                "precision_only": "TIMESTAMP({precision}) WITHOUT TIME ZONE"
            }
        },
        "dialect_overrides": {
            SQLDialect.SQLSERVER: ("DATETIME2", None),
    ...
    TIME_WITH_TIME_ZONE = ("TIME WITH TIME ZONE", {
        ...
        "sql_parameters": {
            ...
            "alternate_formats": {
                "precision_only": "TIME({precision}) WITH TIME ZONE"
            }
        },
        "dialect_overrides": {
            SQLDialect.SQLSERVER: ("TIME", None),
    ...
    TIME_WITHOUT_TIME_ZONE = ("TIME WITHOUT TIME ZONE", {
        ...
        "sql_parameters": {
            ...
            "alternate_formats": {
                "precision_only": "TIME({precision}) WITHOUT TIME ZONE"
            }
        },
        "dialect_overrides": {
            SQLDialect.SQLSERVER: ("TIME", None),
    ...
    @classmethod
    def get_dialect_compatible_type(cls, datatype: 'COLUMNDTYPE', target_dialect: SQLDialect) -> Tuple['COLUMNDTYPE', Any]:
        """
        ...
        raise ValueError(f"Data type {datatype.name_value} is not supported by dialect {target_dialect.name_value}. And there is no published crosswalking method for it.")
                

    @classmethod
    def to_sql_string(cls, 
    ...
    @classmethod
    def _parse_size_spec(cls, size_spec: Union[int, Tuple[int, ...], str, None], 
                        sql_params: Dict[str, Any]) -> Tuple[Optional[int], Optional[int], Optional[int]]:
    ...
    @classmethod
    def _format_sql_type(cls, format_string: str, size_spec: Union[int, Tuple[int, ...], str, None], 
                        sql_params: Dict[str, Any]) -> str:
...
class Column_Type(NamedTuple):
    ...
    def validate_identifier(self, identifier: str, correction_method: Literal['encapsulate', 'normalize'] = 'normalize') -> Dict[str, Any]:
        """
        ...
        return SQL_DIALECT_REGISTRY.validate_identifier(identifier=identifier,
...
class TemporalPrecision:
    ...
    @classmethod
    def get_byte_size(cls, precision_name: PrecisionLevel, dialect: SQLDialect,
                     data_type: COLUMNDTYPE = COLUMNDTYPE.TIMESTAMP) -> Optional[int]:
        """
        ...
        return 8 if dialect_enum in [SQLDialect.POSTGRES, SQLDialect.SQLITE,
                                   SQLDialect.BIGQUERY, SQLDialect.REDSHIFT] else None
