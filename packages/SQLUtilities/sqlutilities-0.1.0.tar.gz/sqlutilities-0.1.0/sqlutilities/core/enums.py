...
class DatabaseObjectType(Enum):
    ...
    def get_core_objects(cls) -> List['DatabaseObjectType']:
        ...
        """
        return [
            cls.TABLE, cls.COLUMN, cls.VIEW, cls.INDEX, cls.CONSTRAINT,
            cls.SEQUENCE, cls.PROCEDURE, cls.FUNCTION, cls.TRIGGER
        ]
    ...
    def get_constraint_types(cls) -> List['DatabaseObjectType']:
        ...
        """
        return [
            cls.CONSTRAINT, cls.PRIMARY_KEY, cls.FOREIGN_KEY,
            cls.UNIQUE_CONSTRAINT, cls.CHECK_CONSTRAINT,
            cls.NOT_NULL_CONSTRAINT, cls.DEFAULT_CONSTRAINT
        ]
    ...
    def get_index_types(cls) -> List['DatabaseObjectType']:
        ...
        """
        return [
            cls.INDEX, cls.UNIQUE_INDEX, cls.CLUSTERED_INDEX,
            cls.NONCLUSTERED_INDEX, cls.PARTIAL_INDEX, cls.FUNCTIONAL_INDEX
        ]
...
class SQLDialect(Enum):
    ...
    _POSTGRES_CONFIG = {
        ...
        'if_exists': [DatabaseObjectType.DATABASE, DatabaseObjectType.SCHEMA, DatabaseObjectType.TABLE,
                      DatabaseObjectType.VIEW, DatabaseObjectType.INDEX, DatabaseObjectType.FUNCTION,
                      DatabaseObjectType.PROCEDURE, DatabaseObjectType.SEQUENCE],
        'if_not_exists': [DatabaseObjectType.DATABASE, DatabaseObjectType.SCHEMA, DatabaseObjectType.TABLE,
                          DatabaseObjectType.VIEW, DatabaseObjectType.INDEX, DatabaseObjectType.FUNCTION,
                          DatabaseObjectType.PROCEDURE, DatabaseObjectType.SEQUENCE],
    ...
    MYSQL = ("mysql", "MySQL", {
        ...
        'quoted_identifiers': True,
        'if_exists': [DatabaseObjectType.TABLE, DatabaseObjectType.VIEW, DatabaseObjectType.INDEX, 
                      DatabaseObjectType.FUNCTION, DatabaseObjectType.PROCEDURE, DatabaseObjectType.TRIGGER, 
                      DatabaseObjectType.DATABASE],
        'if_not_exists': [DatabaseObjectType.TABLE, DatabaseObjectType.VIEW, DatabaseObjectType.INDEX, 
                          DatabaseObjectType.DATABASE, DatabaseObjectType.TRIGGER],
        'quoted_case_sensitive': True,
    ...
    BIGQUERY = ("bigquery", "Google BigQuery", {
        ...
        'quoted_identifiers': True,
        'if_exists': [DatabaseObjectType.TABLE, DatabaseObjectType.VIEW, DatabaseObjectType.SCHEMA, 
                      DatabaseObjectType.COLUMN],
        'if_not_exists': [DatabaseObjectType.TABLE, DatabaseObjectType.VIEW, DatabaseObjectType.SCHEMA, 
                          DatabaseObjectType.COLUMN],
        'quoted_case_sensitive': False,
        ...
        'special_rules': {
            DatabaseObjectType.COLUMN: {'max_length': 300}
        },
    }, 'bigquery')
