...
from typing import Dict, Set, List, Any, Optional, Union, Literal, TYPE_CHECKING
...
from CoreUtilities import get_logger, LogLevel, camel_to_snake_case
...
class SQL_DIALECT_REGISTRY:
    ...
    _DIALECT_OBJECTS: Dict[SQLDialect, Set[DatabaseObjectType]] = {
                SQLDialect.ORACLE: {
                    DatabaseObjectType.TABLE, DatabaseObjectType.COLUMN, DatabaseObjectType.VIEW, 
                    DatabaseObjectType.MATERIALIZED_VIEW, DatabaseObjectType.SCHEMA, DatabaseObjectType.INDEX, 
                    DatabaseObjectType.UNIQUE_INDEX, DatabaseObjectType.CONSTRAINT, DatabaseObjectType.PRIMARY_KEY, 
                    DatabaseObjectType.FOREIGN_KEY, DatabaseObjectType.UNIQUE_CONSTRAINT, DatabaseObjectType.CHECK_CONSTRAINT,
                    DatabaseObjectType.SEQUENCE, DatabaseObjectType.PROCEDURE, DatabaseObjectType.FUNCTION,
                    DatabaseObjectType.TRIGGER, DatabaseObjectType.PACKAGE, DatabaseObjectType.TYPE,
                    DatabaseObjectType.USER, DatabaseObjectType.ROLE, DatabaseObjectType.TABLESPACE,
                    DatabaseObjectType.SYNONYM, DatabaseObjectType.VIRTUAL_COLUMN
                },
                SQLDialect.POSTGRES: {
                    DatabaseObjectType.TABLE, DatabaseObjectType.COLUMN, DatabaseObjectType.VIEW, 
                    DatabaseObjectType.MATERIALIZED_VIEW, DatabaseObjectType.SCHEMA, DatabaseObjectType.INDEX, 
                    DatabaseObjectType.UNIQUE_INDEX, DatabaseObjectType.PARTIAL_INDEX, DatabaseObjectType.FUNCTIONAL_INDEX,
                    DatabaseObjectType.CONSTRAINT, DatabaseObjectType.PRIMARY_KEY, DatabaseObjectType.FOREIGN_KEY,
                    DatabaseObjectType.UNIQUE_CONSTRAINT, DatabaseObjectType.CHECK_CONSTRAINT,
                    DatabaseObjectType.SEQUENCE, DatabaseObjectType.PROCEDURE, DatabaseObjectType.FUNCTION,
                    DatabaseObjectType.TRIGGER, DatabaseObjectType.TYPE, DatabaseObjectType.DOMAIN,
                    DatabaseObjectType.AGGREGATE, DatabaseObjectType.USER, DatabaseObjectType.ROLE,
                    DatabaseObjectType.RULE, DatabaseObjectType.OPERATOR, DatabaseObjectType.CAST
                },
                SQLDialect.SQLSERVER: {
                    DatabaseObjectType.TABLE, DatabaseObjectType.COLUMN, DatabaseObjectType.VIEW, 
                    DatabaseObjectType.SCHEMA, DatabaseObjectType.INDEX, DatabaseObjectType.UNIQUE_INDEX, 
                    DatabaseObjectType.CLUSTERED_INDEX, DatabaseObjectType.NONCLUSTERED_INDEX, 
                    DatabaseObjectType.CONSTRAINT, DatabaseObjectType.PRIMARY_KEY, DatabaseObjectType.FOREIGN_KEY,
                    DatabaseObjectType.UNIQUE_CONSTRAINT, DatabaseObjectType.CHECK_CONSTRAINT,
                    DatabaseObjectType.DEFAULT_CONSTRAINT, DatabaseObjectType.IDENTITY,
                    DatabaseObjectType.PROCEDURE, DatabaseObjectType.FUNCTION, DatabaseObjectType.TRIGGER,
                    DatabaseObjectType.TYPE, DatabaseObjectType.USER, DatabaseObjectType.ROLE,
                    DatabaseObjectType.PARTITION, DatabaseObjectType.TEMPORAL_TABLE, 
                    DatabaseObjectType.COMPUTED_COLUMN
                },
                SQLDialect.MYSQL: {
                    DatabaseObjectType.TABLE, DatabaseObjectType.COLUMN, DatabaseObjectType.VIEW, 
                    DatabaseObjectType.DATABASE, DatabaseObjectType.INDEX, DatabaseObjectType.UNIQUE_INDEX, 
                    DatabaseObjectType.CONSTRAINT, DatabaseObjectType.PRIMARY_KEY, DatabaseObjectType.FOREIGN_KEY,
                    DatabaseObjectType.UNIQUE_CONSTRAINT, DatabaseObjectType.CHECK_CONSTRAINT,
                    DatabaseObjectType.PROCEDURE, DatabaseObjectType.FUNCTION, DatabaseObjectType.TRIGGER,
                    DatabaseObjectType.USER, DatabaseObjectType.ROLE, DatabaseObjectType.TEMPORARY_TABLE,
                    DatabaseObjectType.VIRTUAL_COLUMN
                },
                SQLDialect.SQLITE: {
                    DatabaseObjectType.TABLE, DatabaseObjectType.COLUMN, DatabaseObjectType.VIEW, 
                    DatabaseObjectType.INDEX, DatabaseObjectType.UNIQUE_INDEX, DatabaseObjectType.TRIGGER,
                    DatabaseObjectType.TEMPORARY_TABLE, DatabaseObjectType.SYSTEM_TABLE
                },
                SQLDialect.BIGQUERY: {
                    DatabaseObjectType.TABLE, DatabaseObjectType.COLUMN, DatabaseObjectType.VIEW, 
                    DatabaseObjectType.MATERIALIZED_VIEW, DatabaseObjectType.SCHEMA, DatabaseObjectType.DATABASE,
                    DatabaseObjectType.FUNCTION, DatabaseObjectType.PROCEDURE, DatabaseObjectType.TYPE,
                    DatabaseObjectType.USER, DatabaseObjectType.ROLE, DatabaseObjectType.PARTITION,
                    DatabaseObjectType.CONSTRAINT, DatabaseObjectType.PRIMARY_KEY, DatabaseObjectType.FOREIGN_KEY,
                    DatabaseObjectType.TEMPORARY_TABLE, DatabaseObjectType.COMMENT, DatabaseObjectType.DATASET,
                    DatabaseObjectType.EXTERNAL_TABLE
                },
                SQLDialect.REDSHIFT: {
                    DatabaseObjectType.TABLE, DatabaseObjectType.COLUMN, DatabaseObjectType.VIEW, 
                    DatabaseObjectType.MATERIALIZED_VIEW, DatabaseObjectType.SCHEMA, DatabaseObjectType.DATABASE,
                    DatabaseObjectType.INDEX, DatabaseObjectType.CONSTRAINT, DatabaseObjectType.PRIMARY_KEY, 
                    DatabaseObjectType.FOREIGN_KEY, DatabaseObjectType.UNIQUE_CONSTRAINT, DatabaseObjectType.CHECK_CONSTRAINT,
                    DatabaseObjectType.NOT_NULL_CONSTRAINT, DatabaseObjectType.FUNCTION, DatabaseObjectType.PROCEDURE,
                    DatabaseObjectType.USER, DatabaseObjectType.ROLE, DatabaseObjectType.TEMPORARY_TABLE,
                    DatabaseObjectType.COMMENT, DatabaseObjectType.TYPE, DatabaseObjectType.EXTERNAL_TABLE,
                    DatabaseObjectType.DISTRIBUTION_KEY, DatabaseObjectType.SORT_KEY
                }
            }
        # Common SQL Standard Reserved Words (shared across most dialects)
    _COMMON_RESERVED_WORDS: Set[str] = {
                'SELECT', 'FROM', 'WHERE', 'INSERT', 'UPDATE', 'DELETE', 'CREATE', 'DROP', 'ALTER',
                'TABLE', 'VIEW', 'INDEX', 'DATABASE', 'SCHEMA', 'COLUMN', 'PRIMARY', 'KEY', 'FOREIGN',
                'UNIQUE', 'NOT', 'NULL', 'DEFAULT', 'CHECK', 'CONSTRAINT', 'REFERENCES', 'ON',
                'INNER', 'LEFT', 'RIGHT', 'OUTER', 'JOIN', 'UNION', 'ALL', 'DISTINCT', 'ORDER', 'BY',
                'GROUP', 'HAVING', 'LIMIT', 'OFFSET', 'AS', 'AND', 'OR', 'IN', 'EXISTS', 'BETWEEN',
                'LIKE', 'IS', 'CASE', 'WHEN', 'THEN', 'ELSE', 'END', 'IF', 'BEGIN', 'COMMIT',
                'ROLLBACK', 'TRANSACTION', 'GRANT', 'REVOKE', 'USER', 'ROLE', 'PRIVILEGE',
                'INTEGER', 'INT', 'BIGINT', 'SMALLINT', 'DECIMAL', 'NUMERIC', 'FLOAT', 'REAL',
                'DOUBLE', 'CHAR', 'VARCHAR', 'TEXT', 'DATE', 'TIME', 'TIMESTAMP', 'BOOLEAN',
                'TRUE', 'FALSE', 'UNKNOWN'
            }

        # Oracle-specific reserved words
    _ORACLE_RESERVED_WORDS: Set[str] = _COMMON_RESERVED_WORDS | {
                    'ACCESS', 'ADD', 'ADMIN', 'AFTER', 'ANALYZE', 'ARCHIVE', 'ARCHIVELOG', 'AUDIT',
                    'BACKUP', 'BECOME', 'BEFORE', 'BLOCK', 'BODY', 'CACHE', 'CANCEL', 'CASCADE',
                    'CHANGE', 'CHECKPOINT', 'CLUSTER', 'COBOL', 'COMMENT', 'COMPILE', 'COMPRESS',
                    'CONNECT', 'CONTENTS', 'CONTINUE', 'CONTROLFILE', 'CURSOR', 'CYCLE', 'DATAFILE',
                    'DBA', 'DEBUGOFF', 'DEBUGON', 'DECLARE', 'DISABLE', 'DISMOUNT', 'DUMP', 'EACH',
                    'ENABLE', 'EVENTS', 'EXCEPT', 'EXCEPTIONS', 'EXCLUSIVE', 'EXECUTE', 'EXIT',
                    'EXPLAIN', 'EXTENT', 'EXTERNALLY', 'FETCH', 'FILE', 'FLUSH', 'FOR', 'FORCE',
                    'FORTRAN', 'FOUND', 'FREELIST', 'FREELISTS', 'FUNCTION', 'GOTO', 'GROUPS',
                    'IDENTIFIED', 'IMMEDIATE', 'INCLUDING', 'INCREMENT', 'INITIAL', 'INITRANS',
                    'INSTANCE', 'INTERSECT', 'INTO', 'INVALIDATE', 'ISOLATION', 'LAYER', 'LEVEL',
                    'LINK', 'LISTS', 'LOCK', 'LOGFILE', 'LONG', 'LOOP', 'MANAGE', 'MANUAL',
                    'MAXDATAFILES', 'MAXINSTANCES', 'MAXLOGFILES', 'MAXLOGHISTORY', 'MAXLOGMEMBERS',
                    'MAXTRANS', 'MAXVALUE', 'MERGE', 'MINEXTENTS', 'MINVALUE', 'MOUNT', 'MOVE',
                    'NEXT', 'NOARCHIVELOG', 'NOAUDIT', 'NOCACHE', 'NOCYCLE', 'NOMAXVALUE',
                    'NOMINVALUE', 'NONE', 'NOORDER', 'NORESETLOGS', 'NORMAL', 'NOSORT', 'NOWAIT',
                    'OPTIMAL', 'OPTION', 'OVER', 'PACKAGE', 'PARALLEL', 'PARTITION', 'PCTFREE',
                    'PCTINCREASE', 'PCTUSED', 'PLAN', 'PLI', 'PRECISION', 'PRIOR', 'PRIVATE',
                    'PROCEDURE', 'PROFILE', 'PUBLIC', 'QUOTA', 'READ', 'RECOVER', 'REFERENCING',
                    'RENAME', 'REPLACE', 'RESETLOGS', 'RESOURCE', 'RESTRICTED', 'RETURN', 'REUSE',
                    'ROW', 'ROWID', 'ROWNUM', 'ROWS', 'SAVEPOINT', 'SCN', 'SEGMENT', 'SEQUENCE',
                    'SERIALIZABLE', 'SESSION', 'SHARE', 'SHARED', 'SIZE', 'SNAPSHOT', 'SORT',
                    'SQL', 'SQLCODE', 'SQLERROR', 'STATEMENT', 'STATISTICS', 'STOP', 'STORAGE',
                    'SUCCESSFUL', 'SWITCH', 'SYNONYM', 'SYSDATE', 'SYSTEM', 'TABLES', 'TABLESPACE',
                    'TEMPORARY', 'THREAD', 'TO', 'TRACING', 'TRIGGER', 'TRUNCATE', 'TYPE', 'UID',
                    'UNDER', 'UNLIMITED', 'UNTIL', 'USE', 'USING', 'VALIDATE', 'VALUES', 'WHENEVER',
                    'WHILE', 'WITH', 'WORK', 'WRITE', 'ZONE'
                }
    ...
    _POSTGRES_RESERVED_WORDS: Set[str] = _COMMON_RESERVED_WORDS | {
            ...
            'ALSO', 'ALTER', 'ALWAYS', 'ANALYSE', 'ANALYZE', 'ANY', 'ARRAY', 'ASSERTION',
            'ASSIGNMENT', 'ASYMMETRIC', 'AT', 'ATTRIBUTE', 'AUTHORIZATION', 'BACKWARD',
            'BEFORE', 'BIGINT', 'BINARY', 'BIT', 'BOOLEAN', 'BOTH', 'CACHE', 'CALLED',
            'CASCADE', 'CASCADED', 'CAST', 'CATALOG', 'CHAIN', 'CHARACTERISTICS', 'CHECK',
            ...
            'COST', 'CROSS', 'CSV', 'CURRENT', 'CURSOR', 'CYCLE', 'DATA', 'DATABASE',
            'DAY', 'DEALLOCATE', 'DECLARE', 'DEFAULT', 'DEFAULTS', 'DEFERRABLE', 'DEFERRED',
            'DEFINER', 'DELETE', 'DELIMITER', 'DELIMITERS', 'DISABLE', 'DISCARD',
            'DISTINCT', 'DO', 'DOCUMENT', 'DOMAIN', 'DOUBLE', 'DROP', 'EACH', 'ENABLE',
            ...
            'FORCE', 'FOREIGN', 'FORWARD', 'FREEZE', 'FULL', 'FUNCTION', 'FUNCTIONS',
            'GLOBAL', 'GRANTED', 'GREATEST', 'GROUPING', 'HANDLER', 'HEADER', 'HOLD',
            'HOUR', 'IDENTITY', 'IF', 'ILIKE', 'IMMEDIATE', 'IMMUTABLE', 'IMPLICIT',
            'INCLUDING', 'INCREMENT', 'INHERITS', 'INITIALLY', 'INLINE', 'INPUT',
            'INSENSITIVE', 'INSERT', 'INSTEAD', 'INTERSECT', 'INTERVAL', 'INTO',
            'INVOKER', 'ISOLATION', 'JSON', 'JSONB', 'KEY', 'LABEL', 'LANGUAGE', 'LARGE',
            'LAST', 'LATERAL', 'LEADING', 'LEAKPROOF', 'LEAST', 'LEVEL', 'LISTEN', 'LOAD',
            'LOCAL', 'LOCATION', 'LOCK', 'MAPPING', 'MATCH', 'MATERIALIZED', 'MAXVALUE',
            'METHOD', 'MINUTE', 'MINVALUE', 'MODE', 'MONTH', 'MOVE', 'NAME', 'NAMES',
            'NATIONAL', 'NATURAL', 'NCHAR', 'NEXT', 'NO', 'NONE', 'NOTIFY', 'NOWAIT',
            'NULLIF', 'NULLS', 'OBJECT', 'OF', 'OFF', 'OIDS', 'OPERATOR', 'OPTION',
            'OPTIONS', 'ORDINALITY', 'OUT', 'OUTER', 'OVER', 'OVERLAPS', 'OVERLAY',
            'OWNED', 'OWNER', 'PARALLEL', 'PARSER', 'PARTIAL', 'PARTITION', 'PASSING',
            'PASSWORD', 'PATH', 'PLANS', 'POLICY', 'POSITION', 'PRECEDING', 'PREPARE',
            'PREPARED', 'PRESERVE', 'PRIOR', 'PRIVILEGES', 'PROCEDURAL', 'PROCEDURE',
            'PROGRAM', 'QUOTE', 'RANGE', 'READ', 'REAL', 'REASSIGN', 'RECHECK', 'RECURSIVE',
            ...
            'SAVEPOINT', 'SCHEMA', 'SCROLL', 'SEARCH', 'SECOND', 'SECURITY', 'SELECT',
            'SEQUENCE', 'SEQUENCES', 'SERIALIZABLE', 'SERVER', 'SESSION', 'SET', 'SETOF',
            'SETS', 'SHARE', 'SHOW', 'SIMILAR', 'SIMPLE', 'SKIP', 'SMALLINT', 'SNAPSHOT',
            'SOME', 'STABLE', 'STANDALONE', 'START', 'STATEMENT', 'STATISTICS', 'STDIN',
            'STDOUT', 'STORAGE', 'STRICT', 'STRIP', 'SUBSTRING', 'SYMMETRIC', 'SYSID',
            'SYSTEM', 'TABLE', 'TABLES', 'TABLESPACE', 'TEMP', 'TEMPLATE', 'TEMPORARY',
            'TEXT', 'TIES', 'TIME', 'TIMESTAMP', 'TO', 'TRAILING', 'TRANSACTION', 'TREAT',
            'TRIGGER', 'TRIM', 'TRUE', 'TRUNCATE', 'TRUSTED', 'TYPE', 'TYPES', 'UNBOUNDED',
    ...
    _REDSHIFT_RESERVED_WORDS: Set[str] = _COMMON_RESERVED_WORDS | {
            ...
            'OFFSET', 'OID', 'OLD', 'ON', 'ONLY', 'OPEN', 'OR', 'ORDER', 'OUTER',
            'OVERLAPS', 'PARALLEL', 'PARTITION', 'PERCENT', 'PERMISSIONS', 'PLACING',
            'PRIMARY', 'RAW', 'READRATIO', 'RECOVER', 'REFERENCES', 'RESPECT', 'REJECTLOG',
            'RESORT', 'RESTORE', 'RIGHT', 'SELECT', 'SESSION_USER', 'SIMILAR', 'SNAPSHOT',
            'SOME', 'SYSDATE', 'SYSTEM', 'TABLE', 'TAG', 'TDES', 'TEXT255', 'TEXT32K',
            'THEN', 'TIMESTAMP', 'TO', 'TOP', 'TRAILING', 'TRUE', 'TRUNCATECOLUMNS',
            'UNION', 'UNIQUE', 'USER', 'USING', 'VERBOSE', 'WALLET', 'WHEN', 'WHERE',
            'WITH', 'WITHOUT'
        }
    ...
    @classmethod
    def get(cls, dialect: SQLDialect, property_name: Literal['objects', 'reserved_words', 'drivers', 'context_exemptions', 'identifier_rules']) -> Any:
    ...
    def is_reserved_word(cls, dialect: SQLDialect, context: DatabaseObjectType, identifier: str) -> bool:
        ...
        if identifier.strip().upper() in cls.get(dialect, 'reserved_words').difference(cls.get(dialect, 'context_exemptions').get(context, set())):
    ...
    @staticmethod
    def validate_identifier(dialect: SQLDialect,
                            identifier: str,
                            context: DatabaseObjectType,
                            correction_method: Literal['encapsulate', 'normalize'] = 'normalize',
                            default_prefix_correction: str = 'col_') -> Dict[str, Any]:
        """
        ...
        reserved_prefix_match = re.search(r'^' + r'|'.join(rules.get('reserved_prefixes', [])), output.get('final', ''), re.IGNORECASE)
        ...
        if reserved_prefix_match or (valid_start_char is None):
            ...
            if correction_method == 'encapsulate':
                ...
                logger.debug(f"Identifier '{output.get('final', '')}' starts with {'reserved' if reserved_prefix_match else 'invalid first character'} {reserved_prefix_match.group() if isinstance(reserved_prefix_match, re.Match) else output.get('final', '')[:1]}. Suggestion: either rename identifier or apply autoformatting to maximize compatibility.", emoji="🚨")
            else:
                output['final'] = formatted_replacement + output.get('final', '')
                
                assert re.search(r'^' + r'|'.join(rules.get('reserved_prefixes', [])), output.get('final', ''), re.IGNORECASE) is None, f"Identifier prefix replacement {output.get('final', '')} starts with reserved prefix"

                logger.debug(f"Identifier '{output.get('final', '')}' starts with {'reserved' if reserved_prefix_match else 'invalid first character'} {reserved_prefix_match.group() if isinstance(reserved_prefix_match, re.Match) else output.get('final', '')[:1]}. {formatted_replacement} prefix added", emoji="🔧")
        ...
        if (rules.get('case_sensitive', False) or isinstance(rules.get('case_conversion', None), str)):
            consider_encapsulate: bool = rules.get('quoted_case_sensitive', False) and (output.get('correction_applied', '') != 'encapsulated') and (correction_method == 'encapsulate')
            ...
            if rules.get('case_conversion') == 'upper':
                if not output.get('final', '').isupper():
                    if consider_encapsulate:
                        ...
                        logger.debug(f"Applied case conversion to upper: '{identifier}' -> '{output.get('final', '')}'", emoji="🔠")
            else:
                if not output.get('final', '').islower():
                    if consider_encapsulate:
                        ...
                        logger.debug(f"Applied case conversion to lower: '{identifier}' -> '{output.get('final', '')}'", emoji="🔠")
        ...
        if SQL_DIALECT_REGISTRY.is_reserved_word(dialect, context, output.get('final', '')):
            ...
            if (correction_method == 'encapsulate'):
                ...
                logger.debug(f"Identifier '{output.get('final', '')}' Is a reserved word. Suggestion: Rename identifier.", emoji="🚨")
                if (output.get('correction_applied', '') != 'encapsulated'):
                    output['final'] = SQL_DIALECT_REGISTRY._encapsulate_identifier(dialect, output.get('final', ''))
                    output['correction_applied'] = 'encapsulated'
            else:
                # If encapsulation is not allowed, append suffix
                output['final'] = output.get('final', '') + ('_col'.upper() if rules.get('case_conversion') == 'upper' else '_col')
                logger.warning(f"Identifier '{output.get('final', '')}' is a reserved word in {dialect.description} for {context.description}. Added _col suffix for safety", emoji="🔧")
               
        # Step 6: Check for general invalid characters
        valid_raw = re.search(rules.get('allowed_chars', {}).get('raw', r'^.+$'), output.get('final', ''))
        invalid_encapsulated = re.search(r'|'.join(rules.get('allowed_chars', {}).get('encapsulated', [r'^.+$'])), output.get('final', ''))
        ...
        if valid_raw or ((invalid_encapsulated is None) and (output.get('correction_applied', '') == 'encapsulated')):
            ...
            if invalid_encapsulated is not None:
                logger.debug(f"Identifier '{output.get('final', '')}' contains invalid characters. Encapsulated to preserve original identifier after removal of invalid characters.", emoji="🚨")
                output['final'] = re.sub(r'|'.join(rules.get('allowed_chars', {}).get('encapsulated', [r'^.+$'])), '', output.get('final', ''))
            ...
            logger.debug(f"Identifier '{output.get('final', '')}' has invalid characters in {dialect.description}. Stripped invalid characters {output.get('final', '')} --> {temp}", emoji="🔧")
        ...
        if max_length is not None and len(output.get('final', '')) > max_length:
            ...
            if output.get('correction_applied', '') == 'encapsulated':
                # If encapsulation is allowed, encapsulate the identifier
                output['final'] = output.get('final', '')[:max_length - 1] + output['final'][-1] # to preserve the encapsulation
            else:
                # If encapsulation is not allowed, truncate the identifier
                output['final'] = output.get('final', '')[:max_length]

            logger.debug(f"Identifier '{output.get('final', '')}' exceeds max length {max_length} by {len(output.get('final', '')) - max_length}. Truncated to {output.get('final', '')}", emoji="✂️")
        ...
        if not isinstance(output.get('correction_applied', None), str) and (output.get('final', '') != output.get('original', '')):
    ...
    def retrieve_datatypes(dialect: SQLDialect) -> Dict[str, Dict[str, OrderedDict]]:
        ...
        result = {
            ...
            "character": {
                ...
                "variable_length": OrderedDict(),
                "large_text": OrderedDict()
            },
            "datetime": {
                "time_zone_support": OrderedDict(),
                "no_time_zone": OrderedDict(),
                "intervals": OrderedDict()
            },
            "binary": {
                "fixed_length": OrderedDict(),
                "variable_length": OrderedDict(), 
                "large_objects": OrderedDict()
            },
            "boolean": {
                "boolean_types": OrderedDict()
            },
            "specialized": {
                "json": OrderedDict(),
                "xml": OrderedDict(),
