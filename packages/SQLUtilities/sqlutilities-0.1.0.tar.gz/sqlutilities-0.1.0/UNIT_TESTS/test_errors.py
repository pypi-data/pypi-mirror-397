...
class TestErrorPatterns:
    ...
    def test_error_patterns_have_dialect_keys(self, all_dialects):
        ...
        for dialect in all_dialects:
            ...
            has_patterns = (
                dialect in ERROR_PATTERNS or
                dialect in TRANSIENT_ERROR_PATTERNS or
                dialect in CONNECTION_ERROR_PATTERNS
            )
...
class TestSQLErrorRegistry:
    ...
    def test_error_registry_has_classify_method(self):
        ...
        has_classify = any(method in registry_methods for method in
                          ['classify', 'classify_error', 'get_error_type'])
    ...
    def test_error_registry_has_is_transient_method(self):
        ...
        has_transient_check = any(method in registry_methods for method in
                                  ['is_transient', 'is_transient_error'])

        assert has_transient_check, \
            "SQLErrorRegistry should have transient error check method"
    ...
    def test_error_registry_has_is_retryable_method(self):
        ...
        has_retryable_check = any(method in registry_methods for method in
                                   ['is_retryable', 'should_retry', 'can_retry'])

        assert has_retryable_check, \
            "SQLErrorRegistry should have retryable error check method"
