...
class TestAPIKeys:
    ...
    def test_method_list(self, client: CnosHub) -> None:
        api_key = client.admin.projects.api_keys.list(
    ...
    def test_raw_response_list(self, client: CnosHub) -> None:
        response = client.admin.projects.api_keys.with_raw_response.list(
            project_id="project_id",
        )
    ...
    def test_streaming_response_list(self, client: CnosHub) -> None:
        with client.admin.projects.api_keys.with_streaming_response.list(
            project_id="project_id",
        ) as response:
    ...
    def test_path_params_list(self, client: CnosHub) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `project_id` but received ''"):
            client.admin.projects.api_keys.with_raw_response.list(
                project_id="",
            )
...
class TestAsyncAPIKeys:
    ...
    async def test_method_list(self, async_client: AsyncCnosHub) -> None:
        api_key = await async_client.admin.projects.api_keys.list(
            project_id="project_id",
        )
    ...
    async def test_raw_response_list(self, async_client: AsyncCnosHub) -> None:
        response = await async_client.admin.projects.api_keys.with_raw_response.list(
            project_id="project_id",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncCnosHub) -> None:
        async with async_client.admin.projects.api_keys.with_streaming_response.list(
            project_id="project_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_list(self, async_client: AsyncCnosHub) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `project_id` but received ''"):
            await async_client.admin.projects.api_keys.with_raw_response.list(
                project_id="",
            )
