...
class TestMembers:
    ...
    def test_method_create(self, client: CnosHub) -> None:
        member = client.admin.orgs.members.create(
            user_id="user_id",
            org_id="org_id",
        )
    ...
    def test_raw_response_create(self, client: CnosHub) -> None:
        response = client.admin.orgs.members.with_raw_response.create(
            user_id="user_id",
            org_id="org_id",
        )
    ...
    def test_streaming_response_create(self, client: CnosHub) -> None:
        with client.admin.orgs.members.with_streaming_response.create(
            user_id="user_id",
            org_id="org_id",
        ) as response:
    ...
    def test_path_params_create(self, client: CnosHub) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_id` but received ''"):
            client.admin.orgs.members.with_raw_response.create(
                user_id="user_id",
                org_id="",
            )
    ...
    def test_method_list(self, client: CnosHub) -> None:
        member = client.admin.orgs.members.list(
            org_id="org_id",
        )
    ...
    def test_raw_response_list(self, client: CnosHub) -> None:
        response = client.admin.orgs.members.with_raw_response.list(
            org_id="org_id",
        )
    ...
    def test_streaming_response_list(self, client: CnosHub) -> None:
        with client.admin.orgs.members.with_streaming_response.list(
            org_id="org_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_list(self, client: CnosHub) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_id` but received ''"):
            client.admin.orgs.members.with_raw_response.list(
                org_id="",
            )
    ...
    def test_method_delete(self, client: CnosHub) -> None:
        member = client.admin.orgs.members.delete(
            user_id="user_id",
            org_id="org_id",
        )
    ...
    def test_raw_response_delete(self, client: CnosHub) -> None:
        response = client.admin.orgs.members.with_raw_response.delete(
            user_id="user_id",
            org_id="org_id",
        )
    ...
    def test_streaming_response_delete(self, client: CnosHub) -> None:
        with client.admin.orgs.members.with_streaming_response.delete(
            user_id="user_id",
            org_id="org_id",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_delete(self, client: CnosHub) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_id` but received ''"):
            client.admin.orgs.members.with_raw_response.delete(
                user_id="user_id",
                org_id="",
            )
    ...
    def test_method_history(self, client: CnosHub) -> None:
        member = client.admin.orgs.members.history(
            user_id="user_id",
            org_id="org_id",
        )
    ...
    def test_raw_response_history(self, client: CnosHub) -> None:
        response = client.admin.orgs.members.with_raw_response.history(
            user_id="user_id",
            org_id="org_id",
        )
    ...
    def test_streaming_response_history(self, client: CnosHub) -> None:
        with client.admin.orgs.members.with_streaming_response.history(
            user_id="user_id",
            org_id="org_id",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_history(self, client: CnosHub) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_id` but received ''"):
            client.admin.orgs.members.with_raw_response.history(
                user_id="user_id",
                org_id="",
            )
...
class TestAsyncMembers:
    ...
    async def test_method_create(self, async_client: AsyncCnosHub) -> None:
        member = await async_client.admin.orgs.members.create(
            user_id="user_id",
            org_id="org_id",
        )
        assert_matches_type(MemberCreateResponse, member, path=["response"])
    ...
    async def test_raw_response_create(self, async_client: AsyncCnosHub) -> None:
        response = await async_client.admin.orgs.members.with_raw_response.create(
            user_id="user_id",
            org_id="org_id",
        )
    ...
    async def test_streaming_response_create(self, async_client: AsyncCnosHub) -> None:
        async with async_client.admin.orgs.members.with_streaming_response.create(
            user_id="user_id",
            org_id="org_id",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_create(self, async_client: AsyncCnosHub) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_id` but received ''"):
            await async_client.admin.orgs.members.with_raw_response.create(
                user_id="user_id",
                org_id="",
            )
    ...
    async def test_method_list(self, async_client: AsyncCnosHub) -> None:
        member = await async_client.admin.orgs.members.list(
            org_id="org_id",
        )
    ...
    async def test_raw_response_list(self, async_client: AsyncCnosHub) -> None:
        response = await async_client.admin.orgs.members.with_raw_response.list(
            org_id="org_id",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncCnosHub) -> None:
        async with async_client.admin.orgs.members.with_streaming_response.list(
            org_id="org_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_list(self, async_client: AsyncCnosHub) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_id` but received ''"):
            await async_client.admin.orgs.members.with_raw_response.list(
                org_id="",
            )
    ...
    async def test_method_delete(self, async_client: AsyncCnosHub) -> None:
        member = await async_client.admin.orgs.members.delete(
            user_id="user_id",
            org_id="org_id",
        )
        assert member is None
    ...
    async def test_raw_response_delete(self, async_client: AsyncCnosHub) -> None:
        response = await async_client.admin.orgs.members.with_raw_response.delete(
            user_id="user_id",
            org_id="org_id",
        )
    ...
    async def test_streaming_response_delete(self, async_client: AsyncCnosHub) -> None:
        async with async_client.admin.orgs.members.with_streaming_response.delete(
            user_id="user_id",
            org_id="org_id",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_delete(self, async_client: AsyncCnosHub) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_id` but received ''"):
            await async_client.admin.orgs.members.with_raw_response.delete(
                user_id="user_id",
                org_id="",
            )
    ...
    async def test_method_history(self, async_client: AsyncCnosHub) -> None:
        member = await async_client.admin.orgs.members.history(
            user_id="user_id",
            org_id="org_id",
        )
    ...
    async def test_raw_response_history(self, async_client: AsyncCnosHub) -> None:
        response = await async_client.admin.orgs.members.with_raw_response.history(
            user_id="user_id",
            org_id="org_id",
        )
    ...
    async def test_streaming_response_history(self, async_client: AsyncCnosHub) -> None:
        async with async_client.admin.orgs.members.with_streaming_response.history(
            user_id="user_id",
            org_id="org_id",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_history(self, async_client: AsyncCnosHub) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_id` but received ''"):
            await async_client.admin.orgs.members.with_raw_response.history(
                user_id="user_id",
                org_id="",
            )
