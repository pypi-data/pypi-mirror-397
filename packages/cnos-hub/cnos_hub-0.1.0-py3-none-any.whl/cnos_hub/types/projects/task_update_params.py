...
__all__ = [
    ...
    "RunnerTaskRunnerCnosArgsFromTaskArgsBindingCustom",
...
class TaskUpdateParams(TypedDict, total=False):
    ...
    description: str
    """Updated description (use `Patch::Null` to clear)."""

    name: Optional[str]
    """Updated name."""

    retry: Optional[TaskRetryPolicyParam]
    """Updated retry policy."""

    run_as: Optional[TaskRunAsParam]
    """Updated synthetic principal."""
...
class RunnerTaskRunnerCnosArgsFromTaskArgsBindingCustom(TypedDict, total=False):
    """Pass a custom static value as arguments."""

    custom: Required[Iterable[Dict[str, object]]]
    """Pass a custom static value as arguments."""


RunnerTaskRunnerCnosArgsFrom: TypeAlias = Union[
    Literal["empty", "event_envelope", "schedule_payload", "manual_payload"],
    RunnerTaskRunnerCnosArgsFromTaskArgsBindingCustom,
]
