...
__all__ = ["ExecuteCreateParams", "Args", "ArgsExecuteArgsJson", "ArgsExecuteArgsCnon", "ArgsExecuteArgsBin"]


class ExecuteCreateParams(TypedDict, total=False):
    function: Required[str]
    """
    Fully-qualified function name to invoke (e.g.,
    ...
    """Desired result encoding. Defaults to binary (base64-wrapped) when omitted."""
...
class ArgsExecuteArgsJson(TypedDict, total=False):
    ...
    json: Required[Union[Iterable[Dict[str, object]], Dict[str, Dict[str, object]]]]
