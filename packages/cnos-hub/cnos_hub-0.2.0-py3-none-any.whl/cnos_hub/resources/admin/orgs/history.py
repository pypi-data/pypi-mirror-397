...
from ....types.admin.orgs import history_list_params
from ....types.admin.orgs.history_list_response import HistoryListResponse
...
class HistoryResource(SyncAPIResource):
    ...
    def list(
        ...
        *,
    ...
    ) -> SyncPage[HistoryListResponse]:
        """
        List revision history for an organization.
        ...
        return self._get_api_list(
            f"/v1/admin/orgs/{org_id}/history",
            page=SyncPage[HistoryListResponse],
...
class AsyncHistoryResource(AsyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        extra_body: Body | None = None,
        timeout: float | httpx.Timeout | None | NotGiven = not_given,
    ) -> AsyncPaginator[HistoryListResponse, AsyncPage[HistoryListResponse]]:
        """
        List revision history for an organization.
        ...
        return self._get_api_list(
            f"/v1/admin/orgs/{org_id}/history",
            page=AsyncPage[HistoryListResponse],
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
