...
from ....types.admin.orgs import member_list_params, member_create_params
from ....types.admin.orgs.member_list_response import MemberListResponse
from ....types.admin.orgs.member_create_response import MemberCreateResponse
...
class MembersResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        return self._post(
            f"/v1/admin/orgs/{org_id}/members/{user_id}",
