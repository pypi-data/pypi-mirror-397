...
from ....types.admin import api_key_list_params, api_key_create_params, api_key_list_for_project_params
...
from ....types.admin.api_key_list_for_project_response import APIKeyListForProjectResponse
...
class APIKeysResource(SyncAPIResource):
    ...
    def list_for_project(
        ...
        *,
        ...
        extra_body: Body | None = None,
        timeout: float | httpx.Timeout | None | NotGiven = not_given,
    ) -> SyncPage[APIKeyListForProjectResponse]:
        """
        Args:
          cursor: Pagination cursor
        ...
        return self._get_api_list(
            ...
            page=SyncPage[APIKeyListForProjectResponse],
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
                ...
                query=maybe_transform(
                    ...
                    api_key_list_for_project_params.APIKeyListForProjectParams,
                ),
            ),
            model=APIKeyListForProjectResponse,
        )
...
class AsyncAPIKeysResource(AsyncAPIResource):
    ...
    def list_for_project(
        ...
        *,
        ...
        extra_body: Body | None = None,
        timeout: float | httpx.Timeout | None | NotGiven = not_given,
    ) -> AsyncPaginator[APIKeyListForProjectResponse, AsyncPage[APIKeyListForProjectResponse]]:
        """
        Args:
          cursor: Pagination cursor
        ...
        return self._get_api_list(
            f"/v1/admin/projects/{project_id}/api-keys",
            page=AsyncPage[APIKeyListForProjectResponse],
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
...
class APIKeysResourceWithRawResponse:
    def __init__(self, api_keys: APIKeysResource) -> None:
        ...
        self.list_for_project = to_raw_response_wrapper(
            api_keys.list_for_project,
        )
...
class AsyncAPIKeysResourceWithRawResponse:
    def __init__(self, api_keys: AsyncAPIKeysResource) -> None:
        ...
        self.list_for_project = async_to_raw_response_wrapper(
            api_keys.list_for_project,
        )
...
class APIKeysResourceWithStreamingResponse:
    def __init__(self, api_keys: APIKeysResource) -> None:
        ...
        self.list_for_project = to_streamed_response_wrapper(
            api_keys.list_for_project,
        )
...
class AsyncAPIKeysResourceWithStreamingResponse:
    def __init__(self, api_keys: AsyncAPIKeysResource) -> None:
        ...
        self.list_for_project = async_to_streamed_response_wrapper(
            api_keys.list_for_project,
        )
