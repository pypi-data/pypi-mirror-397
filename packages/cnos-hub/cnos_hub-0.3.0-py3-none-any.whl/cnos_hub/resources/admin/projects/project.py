...
from ....types.admin.projects import project_update_params, project_history_params
from ....types.admin.projects.project_update_response import ProjectUpdateResponse
from ....types.admin.projects.project_history_response import ProjectHistoryResponse
from ....types.admin.projects.project_retrieve_response import ProjectRetrieveResponse
...
class ProjectResource(SyncAPIResource):
    ...
    def update(
        ...
        *,
        ...
        status: Optional[Literal["active", "readonly", "deleted"]] | Omit = omit,
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        # The extra values given here take precedence over values defined on the client or passed to this method.
        extra_headers: Headers | None = None,
        extra_query: Query | None = None,
    ...
    def history(
        ...
        *,
        ...
        extra_body: Body | None = None,
        timeout: float | httpx.Timeout | None | NotGiven = not_given,
    ) -> SyncPage[ProjectHistoryResponse]:
        """
        List revision history for a project.
        ...
        return self._get_api_list(
            f"/v1/admin/projects/{project_id}/history",
            page=SyncPage[ProjectHistoryResponse],
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    project_history_params.ProjectHistoryParams,
                ),
            ),
            model=ProjectHistoryResponse,
        )
...
class AsyncProjectResource(AsyncAPIResource):
    ...
    def history(
        ...
        *,
        ...
        extra_body: Body | None = None,
        timeout: float | httpx.Timeout | None | NotGiven = not_given,
    ) -> AsyncPaginator[ProjectHistoryResponse, AsyncPage[ProjectHistoryResponse]]:
        """
        List revision history for a project.
        ...
        return self._get_api_list(
            f"/v1/admin/projects/{project_id}/history",
            page=AsyncPage[ProjectHistoryResponse],
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
