...
class TestOrgs:
    ...
    def test_method_create(self, client: CnosHub) -> None:
        ...
        assert_matches_type(Organization, org, path=["response"])
    ...
    def test_raw_response_create(self, client: CnosHub) -> None:
        response = client.admin.orgs.with_raw_response.create(
            name="name",
        )
    ...
    def test_raw_response_retrieve(self, client: CnosHub) -> None:
        response = client.admin.orgs.with_raw_response.retrieve(
            "org_id",
        )
    ...
    def test_raw_response_update(self, client: CnosHub) -> None:
        response = client.admin.orgs.with_raw_response.update(
            org_id="org_id",
        )
    ...
    def test_method_list(self, client: CnosHub) -> None:
        org = client.admin.orgs.list()
        assert_matches_type(SyncPage[OrgListResponse], org, path=["response"])
    ...
    def test_raw_response_delete(self, client: CnosHub) -> None:
        response = client.admin.orgs.with_raw_response.delete(
            "org_id",
        )
    ...
    def test_streaming_response_delete(self, client: CnosHub) -> None:
        with client.admin.orgs.with_streaming_response.delete(
            "org_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_delete(self, client: CnosHub) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_id` but received ''"):
            client.admin.orgs.with_raw_response.delete(
                "",
            )
...
class TestAsyncOrgs:
    ...
    async def test_raw_response_create(self, async_client: AsyncCnosHub) -> None:
        response = await async_client.admin.orgs.with_raw_response.create(
            name="name",
        )
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncCnosHub) -> None:
        response = await async_client.admin.orgs.with_raw_response.retrieve(
            "org_id",
        )
    ...
    async def test_raw_response_update(self, async_client: AsyncCnosHub) -> None:
        response = await async_client.admin.orgs.with_raw_response.update(
            org_id="org_id",
        )
    ...
    async def test_method_list(self, async_client: AsyncCnosHub) -> None:
        org = await async_client.admin.orgs.list()
        assert_matches_type(AsyncPage[OrgListResponse], org, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncCnosHub) -> None:
        response = await async_client.admin.orgs.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncCnosHub) -> None:
        async with async_client.admin.orgs.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_delete(self, async_client: AsyncCnosHub) -> None:
        org = await async_client.admin.orgs.delete(
            "org_id",
        )
        assert org is None
    ...
    async def test_raw_response_delete(self, async_client: AsyncCnosHub) -> None:
        response = await async_client.admin.orgs.with_raw_response.delete(
            "org_id",
        )
    ...
    async def test_streaming_response_delete(self, async_client: AsyncCnosHub) -> None:
        async with async_client.admin.orgs.with_streaming_response.delete(
            "org_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_delete(self, async_client: AsyncCnosHub) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_id` but received ''"):
            await async_client.admin.orgs.with_raw_response.delete(
                "",
            )
