...
class PlatformProperties(BaseModel):
    ...
    type: Optional[StrictStr] = Field(default=None, description="Type of the platform")
    status: Optional[StrictStr] = Field(default=None, description="Status of the platform")
    config: Optional[Dict[str, Any]] = Field(default=None, description="Configuration data for the platform")
    tags: Optional[List[StrictStr]] = Field(default=None, description="Tags for categorizing the platform")
    __properties: ClassVar[List[str]] = ["id", "name", "url", "description", "loginUrl", "type", "status", "config", "tags"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in PlatformProperties) in the input: " + _key)
