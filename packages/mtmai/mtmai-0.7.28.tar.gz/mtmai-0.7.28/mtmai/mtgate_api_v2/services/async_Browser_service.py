...
async def BrowserOpen(api_config_override: Optional[APIConfig] = None, *, data: Dict[str, Any]) -> Dict[str, Any]:
...
async def BrowserUpsert(
    api_config_override: Optional[APIConfig] = None, *, data: BrowserCreateReq
) -> BrowserCreateResult:
    api_config = api_config_override if api_config_override else APIConfig()
