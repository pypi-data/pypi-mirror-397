...
from mtmai.mtlibs.instagrapi.exceptions import CollectionNotFound
from mtmai.mtlibs.instagrapi.extractors import extract_collection, extract_media_v1
from mtmai.mtlibs.instagrapi.types import Collection, Media
