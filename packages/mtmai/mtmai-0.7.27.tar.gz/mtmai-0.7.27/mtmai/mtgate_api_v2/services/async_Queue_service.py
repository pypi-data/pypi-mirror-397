...
async def QueuePull(api_config_override: Optional[APIConfig] = None, *, data: WorkerPullRequest) -> WorkerPullResp:
...
async def QueueAck(api_config_override: Optional[APIConfig] = None, *, data: WorkerAckRequest) -> WorkerAckResp:
    api_config = api_config_override if api_config_override else APIConfig()
