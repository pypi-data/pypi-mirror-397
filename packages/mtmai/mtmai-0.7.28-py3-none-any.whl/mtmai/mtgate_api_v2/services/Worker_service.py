...
def WorkerUp(api_config_override: Optional[APIConfig] = None, *, data: WorkerUpRequest) -> WorkerUpResp:
...
def WorkerCheck(api_config_override: Optional[APIConfig] = None, *, id: Any) -> WorkerCheckResult:
    api_config = api_config_override if api_config_override else APIConfig()
