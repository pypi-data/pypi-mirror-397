...
T = TypeVar("T", bound="McpApiHelloResponse200Paginate")


@_attrs_define
class McpApiHelloResponse200Paginate:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        mcp_api_hello_response_200_paginate = cls(
            total=total,
            page=page,
            page_size=page_size,
        ...
        mcp_api_hello_response_200_paginate.additional_properties = d
        return mcp_api_hello_response_200_paginate
