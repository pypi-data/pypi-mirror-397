...
@click.option("--cache-mode", "-c", type=click.Choice(["enabled", "bypass", "disabled", "read_only", "write_only"]), default="bypass", help="Cache mode for crawling")
@click.option("--question", "-q", help="Ask a question about the crawled content")
@click.option("--verbose", "-v", is_flag=True)
@click.option("--profile", "-p", help="Use a specific browser profile (by name)")
def crawl_cmd(url: str, browser_config: str, crawler_config: str, filter_config: str,
           extraction_config: str, json_extract: str, schema: str, browser: Dict, crawler: Dict,
           output: str, output_file: str, cache_mode: str, question: str, verbose: bool, profile: str):
...
Always return valid, properly formatted JSON."""
        ...
        crawler_cfg.cache_mode = cache_mode_map.get(cache_mode, CacheMode.BYPASS)
...
@click.option("--crawler", "-c", type=str, callback=parse_key_values, help="Crawler parameters as key1=value1,key2=value2")
@click.option("--output", "-o", type=click.Choice(["all", "json", "markdown", "md", "markdown-fit", "md-fit"]), default="all")
@click.option("--cache-mode", type=click.Choice(["enabled", "bypass", "disabled", "read_only", "write_only"]), default="bypass", help="Cache mode for crawling")
@click.option("--question", "-q", help="Ask a question about the crawled content")
@click.option("--verbose", "-v", is_flag=True)
@click.option("--profile", "-p", help="Use a specific browser profile (by name)")
def default(url: str, example: bool, browser_config: str, crawler_config: str, filter_config: str,
        extraction_config: str, json_extract: str, schema: str, browser: Dict, crawler: Dict,
        output: str, cache_mode: str, question: str, verbose: bool, profile: str):
