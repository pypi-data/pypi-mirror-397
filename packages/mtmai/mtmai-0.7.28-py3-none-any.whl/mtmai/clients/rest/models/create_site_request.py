...
class CreateSiteRequest(BaseModel):
    ...
    host: Optional[StrictStr] = Field(default=None, description="入站域名(指定绑定入站域名)")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in CreateSiteRequest) in the input: " + _key)
