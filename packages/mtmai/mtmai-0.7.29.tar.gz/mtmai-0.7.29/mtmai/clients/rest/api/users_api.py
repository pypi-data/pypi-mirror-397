...
from typing_extensions import Annotated
from mtmai.clients.rest.models.users_create201_response import UsersCreate201Response
from mtmai.clients.rest.models.users_create_request import UsersCreateRequest
from mtmai.clients.rest.models.users_list200_response import UsersList200Response
from mtmai.clients.rest.models.users_update_request import UsersUpdateRequest
...
class UsersApi:
    ...
    async def users_create(
        self,
        users_create_request: Optional[UsersCreateRequest] = None,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "UsersCreate201Response",
            '400': "A2AGetAgentCard404Response",
        }
    ...
    async def users_create_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[UsersCreate201Response]:
        """users_create
    ...
    def _users_create_serialize(
        ...
        if users_create_request is not None:
            _body_params = users_create_request
    ...
    async def users_delete(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '204': None,
            '404': "A2AGetAgentCard404Response",
        }
        response_data = await self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
