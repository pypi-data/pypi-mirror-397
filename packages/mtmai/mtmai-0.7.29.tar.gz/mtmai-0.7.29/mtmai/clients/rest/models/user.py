...
class User(BaseModel):
    ...
    avatar_url: Optional[StrictStr] = Field(default=None, description="The user's avatar URL, typically from OAuth provider like GitHub", alias="avatarUrl")
    role: UserRole = Field(description="The user's role in the system")
    __properties: ClassVar[List[str]] = ["metadata", "name", "email", "emailVerified", "hasPassword", "emailHash", "userToken", "avatarUrl", "role"]
