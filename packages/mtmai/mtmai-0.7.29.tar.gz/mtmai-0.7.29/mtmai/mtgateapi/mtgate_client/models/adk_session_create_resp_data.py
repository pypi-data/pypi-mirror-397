...
T = TypeVar("T", bound="AdkSessionCreateRespData")


@_attrs_define
class AdkSessionCreateRespData:
    """
    Attributes:
        state (Any):
        id (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        adk_session_create_resp_data = cls(
            state=state,
            id=id,
            app_name=app_name,
            user_id=user_id,
        ...
        adk_session_create_resp_data.additional_properties = d
        return adk_session_create_resp_data
