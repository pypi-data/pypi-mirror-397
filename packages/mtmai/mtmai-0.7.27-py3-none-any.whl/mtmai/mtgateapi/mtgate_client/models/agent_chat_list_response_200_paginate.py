...
T = TypeVar("T", bound="AgentChatListResponse200Paginate")


@_attrs_define
class AgentChatListResponse200Paginate:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        agent_chat_list_response_200_paginate = cls(
            total=total,
            page=page,
            page_size=page_size,
        ...
        agent_chat_list_response_200_paginate.additional_properties = d
        return agent_chat_list_response_200_paginate
