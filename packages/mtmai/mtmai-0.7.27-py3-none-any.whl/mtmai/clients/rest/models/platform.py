...
class Platform(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["metadata", "id", "name", "url", "description", "loginUrl", "type", "status", "config", "tags"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in Platform) in the input: " + _key)
