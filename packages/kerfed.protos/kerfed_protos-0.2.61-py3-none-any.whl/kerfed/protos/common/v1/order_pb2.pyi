...
class OrderState(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["emails", b"emails", "errors", b"errors", "events", b"events", "is_paid", b"is_paid", "is_processing", b"is_processing"]) -> None: ...
