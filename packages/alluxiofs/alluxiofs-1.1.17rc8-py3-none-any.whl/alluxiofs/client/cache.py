...
class CachedFileReader:
    ...
    def _parallel_download_file(
        ...
        if self.alluxio_client.config.s3_api_http_ip is not None:
            worker_host = self.alluxio_client.config.s3_api_http_ip
    ...
    def get_blocks_prefetch(self, offset=0, length=-1, file_size=None, prefetch_policy=None):
