...
class AlluxioClient:
    ...
    def read_file_range(self, file_path, alluxio_path, offset=0, length=-1, prefetch_policy=None):
    ...
    def _all_file_range_generator(
        ...
        try:
            if self.config.s3_api_http_ip is not None:
                worker_host = self.config.s3_api_http_ip
