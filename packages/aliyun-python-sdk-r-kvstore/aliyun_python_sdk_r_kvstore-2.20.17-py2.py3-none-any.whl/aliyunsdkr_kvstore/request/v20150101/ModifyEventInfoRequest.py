...
class ModifyEventInfoRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'R-kvstore', '2015-01-01', 'ModifyEventInfo','redisa')
	...
	def get_EventAction(self): # String
		return self.get_query_params().get('EventAction')

	def set_EventAction(self, EventAction):  # String
		self.add_query_param('EventAction', EventAction)
