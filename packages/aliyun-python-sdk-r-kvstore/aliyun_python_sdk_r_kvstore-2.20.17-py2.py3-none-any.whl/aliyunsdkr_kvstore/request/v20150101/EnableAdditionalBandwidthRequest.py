...
class EnableAdditionalBandwidthRequest(RpcRequest):
	...
	def get_BandWidthBurst(self): # Boolean
		return self.get_query_params().get('BandWidthBurst')

	def set_BandWidthBurst(self, BandWidthBurst):  # Boolean
		self.add_query_param('BandWidthBurst', BandWidthBurst)
