...
class CreateTairKVCacheVNodeRequest(RpcRequest):
	...
	def get_ElasticTimeRange(self): # String
		return self.get_query_params().get('ElasticTimeRange')

	def set_ElasticTimeRange(self, ElasticTimeRange):  # String
		self.add_query_param('ElasticTimeRange', ElasticTimeRange)
	...
	def get_VNodeType(self): # String
		return self.get_query_params().get('VNodeType')

	def set_VNodeType(self, VNodeType):  # String
		self.add_query_param('VNodeType', VNodeType)
