...
class V1ExtranetsIdApplyPostRequest(BaseModel):
    ...
    """ # noqa: E501
    target_devices: Optional[List[StrictInt]] = Field(default=None, alias="targetDevices")
    __properties: ClassVar[List[str]] = ["targetDevices"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "targetDevices": obj.get("targetDevices")
        })
        return _obj
