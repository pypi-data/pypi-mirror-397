...
class ManaV2B2bSiteInformation(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of policer_site_lists
        if self.policer_site_lists:
            _dict['policerSiteLists'] = self.policer_site_lists.to_dict()
        # override the default output from pydantic by calling `to_dict()` of policer_sites
        if self.policer_sites:
            _dict['policerSites'] = self.policer_sites.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "bwAllocationSiteLists": obj.get("bwAllocationSiteLists"),
            "bwAllocationSites": obj.get("bwAllocationSites"),
            "policerSiteLists": ManaV2Policer.from_dict(obj["policerSiteLists"]) if obj.get("policerSiteLists") is not None else None,
            "policerSites": ManaV2Policer.from_dict(obj["policerSites"]) if obj.get("policerSites") is not None else None,
