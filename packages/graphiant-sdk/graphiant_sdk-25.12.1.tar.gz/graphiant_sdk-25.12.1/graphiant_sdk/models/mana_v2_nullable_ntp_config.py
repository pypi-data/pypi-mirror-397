...
class ManaV2NullableNtpConfig(BaseModel):
    """
    ManaV2NullableNtpConfig
    """ # noqa: E501
    config: Optional[ManaV2NtpConfig] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "config": ManaV2NtpConfig.from_dict(obj["config"]) if obj.get("config") is not None else None
        })
        return _obj
