...
class StatsmonExtranetServiceHealth(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "customerPrefixHealth": StatsmonExtranetPrefixHealth.from_dict(obj["customerPrefixHealth"]) if obj.get("customerPrefixHealth") is not None else None,
            "overallHealth": obj.get("overallHealth"),
            "producerPrefixHealth": StatsmonExtranetPrefixHealth.from_dict(obj["producerPrefixHealth"]) if obj.get("producerPrefixHealth") is not None else None
        })
        return _obj
