...
class TestIamEnterprisePermissions(unittest.TestCase):
    """IamEnterprisePermissions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IamEnterprisePermissions:
        """Test IamEnterprisePermissions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IamEnterprisePermissions`
        """
        model = IamEnterprisePermissions()
        if include_optional:
            return IamEnterprisePermissions(
    ...
    def testIamEnterprisePermissions(self):
        """Test IamEnterprisePermissions"""
