...
setup(name='querycraft',
      ...
      install_requires=['requests>=2.24.0', 'argparse>=1.4.0', 'openai>=2.9.0', 'tincan>=1.0.0',
                        'psycopg2-binary>=2.9.9', 'sqlglot>=25.6.1', 'mysql-connector-python>=9.0.0',
                        'ollama>=0.4.7', 'hugchat>=0.4.19', 'SQLAlchemy>=2.0.40','keyboard>=0.13.5',
                        'sqlglot==25.33.0'],
      entry_points={'console_scripts': ['pgsql-sbs = querycraft.sqlsbs:pgsql',
                                        ...
                                        'sbs = querycraft.sqlsbs:main','admin-sbs = querycraft.sqlsbs:admin']},
      include_package_data=True,
      package_data={'querycraft': ['data/*','config/*','cookies/*','cache/*','templates/*']},
