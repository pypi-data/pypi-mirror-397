...
const activate = async (app, tracker, themeManager, workerRegistry, externalCommandRegistry, collaborativeContentProvider, settingRegistry, translator) => {
    let settings = null;
    ...
    if (collaborativeContentProvider) {
        collaborativeContentProvider.sharedModelFactory.registerDocumentFactory('stl', stlSharedModelFactory);
    }
