...
The library supports extensive configuration for any environment:
...
config = LibraryConfig(
    ...
    # Custom branding (use your own prefix)
    env_prefix="MYAPP_",              # Default: "MEDHA_"
    api_prefix="/my-access-api",      # Default: "/access"
    project_name="My Access Control", # Default: "Access Control Library"
...
export MYAPP_API_PREFIX="/my-api"
...
- [Configuration Reference](docs/configuration.md) - All 40+ configurable parameters
- [Security Guide](docs/security.md) - Security best practices
- [Troubleshooting](docs/troubleshooting.md) - Common issues and solutions
- [API Reference](docs/LIBRARY_API_REFERENCE.md) - Complete API documentation
...
```bash
git clone https://github.com/medhaone-analytics/medha-one-access.git
cd medha-one-access
pip install -e .[dev]
