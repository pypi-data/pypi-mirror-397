...
class LicenseValidator:
    """
    Validates license keys with the Kytte licensing server.

    Usage:
        validator = LicenseValidator(
            license_key="kytte_lic_pro_xxx",
            license_server_url="https://license.kytte.io"
        )
    ...
    DEFAULT_LICENSE_SERVER = "https://license.kytte.io"
