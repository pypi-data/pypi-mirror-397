...
async def _fill_cvv_payment(
    ...
    logger.info(f'支付详情页面，官网订单号<{pre_order_number}>获取成功')
    ...
    return pre_order_number, actual_payment_amount.get("amount")
...
async def order_payment_callback(
    ...
    pre_order_number, actual_payment_amount = await _fill_cvv_payment(
    ...
    return pre_order_number, actual_payment_amount
