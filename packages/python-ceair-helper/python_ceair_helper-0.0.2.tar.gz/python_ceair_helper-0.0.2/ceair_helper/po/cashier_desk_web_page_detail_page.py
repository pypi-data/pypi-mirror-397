...
class CVVPaymentPage(BasePo):
    ...
    async def get_expiration_month_dropdown(self, timeout: float = 5.0) -> Locator:
        ...
        :return:
        """
        selector: str = '//form[@class="ceair-form ceair-form--label-top"]//div[@class="ceair-select-selection"]//span[@class="ceair-select-selected-value __web-inspector-hide-shortcut__"]'
        return await self.get_locator(selector=selector, timeout=timeout)
    ...
    async def get_country_dropdown(self, timeout: float = 5.0) -> Locator:
        ...
        :return:
        """
        selector: str = '(//form[@class="ceair-form ceair-form--label-top"]//div[@class="ceair-select-selection"]//span[@class="ceair-select-selected-value" and normalize-space(text())="-"])[2]'
        return await self.get_locator(selector=selector, timeout=timeout)
