...
ERROR_DICT = {
    ...
    8: ("READ_ONLY", "A write operation when read only."),
    9: ("INVALID_VALUE", "The value is invalid."),
    10: ("NOT_IDLE", "Handel is not idle so could not complete the request."),
    11: ("NOT_ACTIVE", "Handel is idle so could not complete the request."),
    12: ("THREAD_ERROR", "Thread related error."),
    13: ("PROTOCOL_ERROR", "Protocol related error."),
    14: ("ALREADY_OPEN", "Already open."),
    201: (
        "UNKNOWN_DECIMATION",
