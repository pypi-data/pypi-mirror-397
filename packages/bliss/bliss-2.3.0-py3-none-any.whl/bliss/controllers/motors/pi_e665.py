...
class PI_E665(pi_gcs.Communication, pi_gcs.Recorder, Controller):
    """
    Bliss controller for Piezo equiped with a E816 communication board
    - E-665
    """
    ...
    def __init__(self, *args, **kwargs):
        ...
        # No hardware access
        pi_gcs.Communication.__init__(self, gcs_version=1)
    ...
    def start_one(self, motion):
        ...
        axis = motion.axis
        target_pos = float(f"{motion.target_pos:.3f}")
        _cmd = f"MOV {axis.channel} {target_pos}"
        self.command(_cmd)
    ...
    def stop(self, axis):
        ...
        * all 3 commands generate (by default) a 'Disable Error 10'.
        ...
        """
        log_debug(self, "stop requested (NOTHING DONE)")
