...
class _ClientPacker(Packer):
    ...
    pack_dev_ushort = pack_dev_int
    pack_dev_ulong = pack_dev_int
    ...
    pack_dev_ulongarr = pack_dev_intarr
...
class _ClientUnPacker(Unpacker):
    ...
    unpack_dev_ushort = unpack_dev_int
    unpack_dev_ulong = unpack_dev_int
    ...
    unpack_dev_ulongarr = unpack_dev_intarr
...
class Client:
    ...
    def _get_packer(self, dev_type):
        dev = {
            ...
            DEV_TYPE.USHORT: self._connection.packer.pack_dev_ushort,
            DEV_TYPE.LONG: self._connection.packer.pack_dev_int,
            DEV_TYPE.ULONG: self._connection.packer.pack_dev_ulong,
            ...
            DEV_TYPE.ULONGARR: self._connection.packer.pack_dev_ulongarr,
            DEV_TYPE.FLOATARR: self._connection.packer.pack_dev_floatarr,
            DEV_TYPE.DOUBLEARR: self._connection.packer.pack_dev_doublearr,
            DEV_TYPE.STRINGARR: self._connection.packer.pack_dev_stringarr,
        }
        try:
            return dev[dev_type]
        except KeyError:
    ...
    def _get_unpacker(self, dev_type):
        dev = {
            ...
            DEV_TYPE.USHORT: self._connection.unpacker.unpack_dev_ushort,
            DEV_TYPE.LONG: self._connection.unpacker.unpack_dev_int,
            DEV_TYPE.ULONG: self._connection.unpacker.unpack_dev_ulong,
            ...
            DEV_TYPE.ULONGARR: self._connection.unpacker.unpack_dev_ulongarr,
            ...
            DEV_TYPE.STRINGARR: self._connection.unpacker.unpack_dev_stringarr,
        }
        try:
            return dev[dev_type]
        except KeyError:
