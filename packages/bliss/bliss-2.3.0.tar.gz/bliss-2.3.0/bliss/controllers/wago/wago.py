...
MODULES_CONFIG = {
    ...
    "750-362": [0, 0, 0, 0, 2, 2, "cpu", "Wago PLC Ethernet/IP"],
    "750-363": [0, 0, 0, 0, 2, 2, "cpu", "Wago PLC Ethernet/IP"],
    "750-842": [0, 0, 0, 0, 2, 2, "cpu", "Wago PLC Ethernet/IP"],
    "750-852": [0, 0, 0, 0, 2, 2, "cpu", "Wago PLC Ethernet/IP"],
    ...
    "750-458": [0, 0, 8, 0, 8, 8, "thc", "8 Channel Ktype Thermocouple Input"],
    ...
    "750-474": [0, 0, 2, 0, 2, 2, "fs4-20", "2 Channel 4/20mA 15bit Input"],
    ...
    "750-511": [0, 0, 0, 2, 2, 2, "fs10", "2 Channel 24V Output"],
    ...
    "750-534": [0, 8, 0, 0, 8, 8, "digital", "8 Channel Digital Output"],
...
class Wago(SamplingCounterController):
    ...
    def _get_capability(self, capability: type[Capability]) -> Capability:
        if capability == MenuCapability:
            from .menu import WagoMenuCapability

            return WagoMenuCapability()
        return None
    ...
    def interlock_upload(self, ask=True):
        ...
        if are_equal:
            ...
            if yes_no == "YES":
                upload(self.controller, self._interlocks_on_beacon, self.modules_config)
                # double check
                interlocks_on_plc = download(self.controller, self.modules_config)
                are_equal, _ = compare(self._interlocks_on_beacon, interlocks_on_plc)
                if are_equal:
