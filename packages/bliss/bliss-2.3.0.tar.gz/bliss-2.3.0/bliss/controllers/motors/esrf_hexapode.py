...
.. code-block:: yaml
    ...
    plugin: emotion
    class: esrf_hexapode
    tango_name: d23/hexapode/mirror
...
class esrf_hexapode(Controller, HasMetadataForScan):
    ...
    def info(self, menu=False):
        """Return a string information about hexapode positions
    ...
    def hexa_show(self, menu=False):
        ...
        if menu:
            ...
            show_dialog(msg_widget, title=msg_title)
        else:
            print("")
    ...
    def hexa_set_ref_pos(self):
        ...
        if rep is not False:
            ...
            rep = show_dialog(dlg, title=f"{self.name}: Save New Reference Position ?")
    ...
    def menu(self):
        ...
        * calculate and check positions.
        ...
        menu_not_implemented = UserMsg(label="Command Not Implemented")
        ...
        while not fin:
            ...
            if not rep:
                ...
                if rep[menu_choice] not in (1, 2, 3, 4, 5):
                    show_dialog(menu_not_implemented)
