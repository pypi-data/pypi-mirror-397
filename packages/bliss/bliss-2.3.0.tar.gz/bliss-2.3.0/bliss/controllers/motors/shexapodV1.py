...
"""
Module implementing V1 of the Symetrie hexapod protocol.
Used by shexapod.py
"""
...
class HexapodProtocolV1(BaseHexapodProtocol):
    ...
    def virtual_home(self, pose):
        set_pos_cmd = "&2 Q71=%f Q72=%f Q73=%f Q74=%f Q75=%f Q76=%f Q20=42" % (
            pose.tx,
            pose.ty,
            pose.tz,
            pose.rx,
        ...
        err = self.wait_command()
        if err != 0:
            raise HexapodV1Error("Virtual homing failed")
