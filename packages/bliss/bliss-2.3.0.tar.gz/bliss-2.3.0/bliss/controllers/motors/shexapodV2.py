...
"""
Module implementing V2 of the Symetrie hexapod protocol.
Used by shexapod.py
"""
...
"""
    ...
    def __read_loop(self):
        while True:
            try:
                reply = self.comm._readline(timeout=-1).decode()  # infinite timeout
    ...
    def dump(self):
        ...
        try:
            ...
            coordinate_system = self._user_and_object_cs
        ...
        user_cs = coordinate_system["user_cs"]
        object_cs = coordinate_system["object_cs"]
