...
"""
Set of versions of the Lima2 C++ Xpcs pipeline that this Processing class supports.
...
class Processing(Settings, HasRoi):
    ...
    def __init__(self, config, pipeline: services.Pipeline):
        self._device = None
        self._params = pipeline.default_params(processing_name="LimaProcessingXpcs")
    ...
    @setting_property(default=100)
    def nb_fill_factor_buffer(self):
        return self._params["buffers"]["nb_fill_factor_buffer"]

    @nb_fill_factor_buffer.setter
    @typecheck
    def nb_fill_factor_buffer(self, value: int):
        self._params["buffers"]["nb_fill_factor_buffer"] = value
