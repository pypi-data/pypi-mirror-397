...
def peak2(x: numpy.ndarray, y: numpy.ndarray) -> tuple[float, float]:
...
def trough2(x: numpy.ndarray, y: numpy.ndarray) -> tuple[float, float]:
...
def cen(x: numpy.ndarray, y: numpy.ndarray) -> tuple[float, float]:
