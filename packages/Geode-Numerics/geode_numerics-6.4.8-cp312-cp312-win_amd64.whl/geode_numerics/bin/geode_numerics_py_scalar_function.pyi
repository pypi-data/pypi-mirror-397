...
class ComputationGrid2D(opengeode.bin.opengeode_py_mesh.LightRegularGrid2D):
    def __init__(self, arg0: opengeode.bin.opengeode_py_geometry.Point2D, arg1: typing.Annotated[list[int], pybind11_stubgen.typing_ext.FixedSize(2)], arg2: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(2)]) -> None:
        ...
class ComputationGrid3D(opengeode.bin.opengeode_py_mesh.LightRegularGrid3D):
...
class DataConstraintsManager2D:
    def data_point_position(self, arg0: int) -> opengeode.bin.opengeode_py_geometry.Point2D:
        ...
...
class DataConstraintsManager3D:
    def data_point_position(self, arg0: int) -> opengeode.bin.opengeode_py_geometry.Point3D:
        ...
    def data_point_value(self, arg0: int) -> float:
        ...
    def data_point_weight(self, arg0: int) -> float:
...
class DataPointsManager2D(DataConstraintsManager2D):
    def __init__(self) -> None:
        ...
    def add_data_point(self, arg0: opengeode.bin.opengeode_py_geometry.Point2D, arg1: float, arg2: float) -> int:
        ...
    ...
    def data_point_weight(self, arg0: int) -> float:
        ...
    def data_points(self) -> opengeode.bin.opengeode_py_mesh.PointSet2D:
        ...
    def data_points_mean_value(self) -> float:
        ...
...
class DataPointsManager3D(DataConstraintsManager3D):
    def __init__(self) -> None:
        ...
    def add_data_point(self, arg0: opengeode.bin.opengeode_py_geometry.Point3D, arg1: float, arg2: float) -> int:
        ...
    def change_data_point_value(self, arg0: int, arg1: float) -> None:
        ...
    def change_data_point_weight(self, arg0: int, arg1: float) -> None:
    ...
    def data_point_weight(self, arg0: int) -> float:
        ...
    def data_points(self) -> opengeode.bin.opengeode_py_mesh.PointSet3D:
        ...
    def data_points_mean_value(self) -> float:
        ...
    def load_data_points(self, arg0: str) -> None:
