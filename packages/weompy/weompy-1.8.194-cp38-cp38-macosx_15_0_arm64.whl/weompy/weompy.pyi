...
class Baudrate:
    ...
    __members__: typing.ClassVar[dict[str, weompy.Baudrate]]  # value = {'B_115200': <Baudrate.B_115200: 4>, 'B_921600': <Baudrate.B_921600: 7>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class Image:
    ...
    def getSensorSerial(self) -> str:
        ...
    def getSensorSerialNumber(self) -> typing_extensions.Annotated[list[int], pybind11_stubgen.typing_ext.FixedSize(3)]:
        ...
...
class Palette:
    ...
    def __getstate__(self) -> tuple:
        ...
    def __init__(self, arg0: str, arg1: typing_extensions.Annotated[list[typing_extensions.Annotated[list[int], pybind11_stubgen.typing_ext.FixedSize(3)]], pybind11_stubgen.typing_ext.FixedSize(256)]) -> None:
        ...
    def __repr__(self) -> str:
        ...
    def __setstate__(self, arg0: tuple) -> None:
    ...
    def getName(self) -> str:
        ...
    def getRgb(self) -> typing_extensions.Annotated[list[typing_extensions.Annotated[list[int], pybind11_stubgen.typing_ext.FixedSize(3)]], pybind11_stubgen.typing_ext.FixedSize(256)]:
        ...
    def getYCbCr(self) -> typing_extensions.Annotated[list[typing_extensions.Annotated[list[int], pybind11_stubgen.typing_ext.FixedSize(3)]], pybind11_stubgen.typing_ext.FixedSize(256)]:
        ...
