...
class ErrorResponseerror(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<volumes.v4.error.AppMessage>': 'list[volumes.v4.error.AppMessage]',
        'volumes.v4.error.SchemaValidationError': 'volumes.v4.error.SchemaValidationError'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOfvolumes.v4.error.ErrorResponseerror'
