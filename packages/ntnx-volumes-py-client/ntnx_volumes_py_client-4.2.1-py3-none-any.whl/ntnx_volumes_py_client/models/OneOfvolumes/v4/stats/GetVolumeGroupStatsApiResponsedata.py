...
class GetVolumeGroupStatsApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'volumes.v4.stats.VolumeGroupStats': 'volumes.v4.stats.VolumeGroupStats',
    ...
    def _initialize_object_type(self):
        return 'OneOfvolumes.v4.stats.GetVolumeGroupStatsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetVolumeGroupStatsApiResponsedata.discriminator_value_class_map.values():
            return list(GetVolumeGroupStatsApiResponsedata.discriminator_value_class_map.keys())[list(GetVolumeGroupStatsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetVolumeGroupStatsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetVolumeGroupStatsApiResponsedata):
            return False
