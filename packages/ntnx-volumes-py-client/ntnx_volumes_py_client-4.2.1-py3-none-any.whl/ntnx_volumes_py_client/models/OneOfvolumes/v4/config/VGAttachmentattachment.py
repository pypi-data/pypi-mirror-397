...
class VGAttachmentattachment(object):
    ...
    discriminator_value_class_map = {
        ...
        'volumes.v4.config.VmAttachment': 'volumes.v4.config.VmAttachment',
        'volumes.v4.config.IscsiClientAttachment': 'volumes.v4.config.IscsiClientAttachment',
        'volumes.v4.config.NvmfClientAttachment': 'volumes.v4.config.NvmfClientAttachment'
    }

    ONE_OF_ITEM_DISCRIMINATOR_NAME = '$attachmentItemDiscriminator'
    ...
    def _initialize_object_type(self):
        return 'OneOfvolumes.v4.config.VGAttachmentattachment'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in VGAttachmentattachment.discriminator_value_class_map.values():
            return list(VGAttachmentattachment.discriminator_value_class_map.keys())[list(VGAttachmentattachment.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VGAttachmentattachment, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VGAttachmentattachment):
            return False
