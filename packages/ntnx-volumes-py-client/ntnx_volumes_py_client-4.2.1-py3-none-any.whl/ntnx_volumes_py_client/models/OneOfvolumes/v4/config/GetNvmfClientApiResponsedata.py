...
class GetNvmfClientApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'volumes.v4.config.NvmfClient': 'volumes.v4.config.NvmfClient',
    ...
    def _initialize_object_type(self):
        return 'OneOfvolumes.v4.config.GetNvmfClientApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetNvmfClientApiResponsedata.discriminator_value_class_map.values():
            return list(GetNvmfClientApiResponsedata.discriminator_value_class_map.keys())[list(GetNvmfClientApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetNvmfClientApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetNvmfClientApiResponsedata):
            return False
