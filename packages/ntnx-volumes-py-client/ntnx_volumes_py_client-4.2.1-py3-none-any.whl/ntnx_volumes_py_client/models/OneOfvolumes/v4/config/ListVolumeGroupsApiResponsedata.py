...
class ListVolumeGroupsApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<volumes.v4.config.VolumeGroup>': 'list[volumes.v4.config.VolumeGroup]',
        'volumes.v4.error.ErrorResponse': 'volumes.v4.error.ErrorResponse',
        'List<volumes.v4.config.VolumeGroupProjection>': 'list[volumes.v4.config.VolumeGroupProjection]'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOfvolumes.v4.config.ListVolumeGroupsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListVolumeGroupsApiResponsedata.discriminator_value_class_map.values():
            return list(ListVolumeGroupsApiResponsedata.discriminator_value_class_map.keys())[list(ListVolumeGroupsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListVolumeGroupsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListVolumeGroupsApiResponsedata):
            return False
