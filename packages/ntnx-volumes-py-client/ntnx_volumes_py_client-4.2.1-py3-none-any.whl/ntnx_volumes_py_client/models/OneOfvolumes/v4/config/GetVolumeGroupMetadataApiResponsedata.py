...
class GetVolumeGroupMetadataApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'common.v1.config.Metadata': 'common.v1.config.Metadata',
    ...
    def _initialize_object_type(self):
        return 'OneOfvolumes.v4.config.GetVolumeGroupMetadataApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetVolumeGroupMetadataApiResponsedata.discriminator_value_class_map.values():
            return list(GetVolumeGroupMetadataApiResponsedata.discriminator_value_class_map.keys())[list(GetVolumeGroupMetadataApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetVolumeGroupMetadataApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetVolumeGroupMetadataApiResponsedata):
            return False
