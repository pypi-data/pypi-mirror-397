...
class UpdateVolumeDiskApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfvolumes.v4.config.UpdateVolumeDiskApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in UpdateVolumeDiskApiResponsedata.discriminator_value_class_map.values():
            return list(UpdateVolumeDiskApiResponsedata.discriminator_value_class_map.keys())[list(UpdateVolumeDiskApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(UpdateVolumeDiskApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateVolumeDiskApiResponsedata):
            return False
