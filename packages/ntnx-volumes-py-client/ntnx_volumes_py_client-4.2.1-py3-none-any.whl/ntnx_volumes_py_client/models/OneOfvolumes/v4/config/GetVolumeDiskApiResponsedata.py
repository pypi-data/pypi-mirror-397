...
class GetVolumeDiskApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'volumes.v4.config.VolumeDisk': 'volumes.v4.config.VolumeDisk',
    ...
    def _initialize_object_type(self):
        return 'OneOfvolumes.v4.config.GetVolumeDiskApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetVolumeDiskApiResponsedata.discriminator_value_class_map.values():
            return list(GetVolumeDiskApiResponsedata.discriminator_value_class_map.keys())[list(GetVolumeDiskApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetVolumeDiskApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetVolumeDiskApiResponsedata):
            return False
