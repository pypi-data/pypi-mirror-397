...
class GetIscsiClientApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'volumes.v4.config.IscsiClient': 'volumes.v4.config.IscsiClient',
    ...
    def _initialize_object_type(self):
        return 'OneOfvolumes.v4.config.GetIscsiClientApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetIscsiClientApiResponsedata.discriminator_value_class_map.values():
            return list(GetIscsiClientApiResponsedata.discriminator_value_class_map.keys())[list(GetIscsiClientApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetIscsiClientApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetIscsiClientApiResponsedata):
            return False
