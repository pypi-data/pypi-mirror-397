...
class ListVmAttachmentsApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<volumes.v4.config.VmAttachment>': 'list[volumes.v4.config.VmAttachment]',
        'volumes.v4.error.ErrorResponse': 'volumes.v4.error.ErrorResponse',
        'List<volumes.v4.config.VmAttachmentProjection>': 'list[volumes.v4.config.VmAttachmentProjection]'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOfvolumes.v4.config.ListVmAttachmentsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListVmAttachmentsApiResponsedata.discriminator_value_class_map.values():
            return list(ListVmAttachmentsApiResponsedata.discriminator_value_class_map.keys())[list(ListVmAttachmentsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListVmAttachmentsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListVmAttachmentsApiResponsedata):
            return False
