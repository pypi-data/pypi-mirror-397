...
class ListExternalIscsiAttachmentsApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<volumes.v4.config.IscsiClientAttachment>': 'list[volumes.v4.config.IscsiClientAttachment]',
        'volumes.v4.error.ErrorResponse': 'volumes.v4.error.ErrorResponse',
        'List<volumes.v4.config.IscsiClientAttachmentProjection>': 'list[volumes.v4.config.IscsiClientAttachmentProjection]'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOfvolumes.v4.config.ListExternalIscsiAttachmentsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListExternalIscsiAttachmentsApiResponsedata.discriminator_value_class_map.values():
            return list(ListExternalIscsiAttachmentsApiResponsedata.discriminator_value_class_map.keys())[list(ListExternalIscsiAttachmentsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListExternalIscsiAttachmentsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListExternalIscsiAttachmentsApiResponsedata):
            return False
