...
class VolumeGroupMetadata(object):
    ...
    def __init__(self, owner_reference=None, category_ids=None, *args, **kwargs):  # noqa: E501
        self.__owner_reference = None
        self.__category_ids = None
        self.discriminator = None
        if owner_reference is not None:
            self.__owner_reference = owner_reference
    ...
    def _initialize_object_type(self):
        return 'volumes.v4.config.VolumeGroupMetadata'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VolumeGroupMetadata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VolumeGroupMetadata):
            return False
