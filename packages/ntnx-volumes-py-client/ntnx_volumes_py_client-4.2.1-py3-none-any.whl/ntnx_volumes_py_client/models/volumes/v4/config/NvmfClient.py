...
class NvmfClient(ExternalizableAbstractModel):
    ...
    :param nvmf_initiator_name: (:attr:`nvmf_initiator_name`) NVMe-TCP client qualified name.
    :type nvmf_initiator_name: 
     max=68 chars
    
    :param attached_targets: (:attr:`attached_targets`) List of all subsystems connected to a NVMe-TCP client.
    :type attached_targets: 
    
    
    :param cluster_reference: (:attr:`cluster_reference`) The UUID of the cluster that hosts the NVMe-TCP client.
