...
class ClientAccess(object):
    ...
    Allowed enum values:
        ...
        - _UNKNOWN
        - _REDACTED
        - NONE: Allows access to Volume Group only, with no access to any of the client.
        - ISCSI_CLIENT: Allows access to Volume Group and iSCSI client.
        - VM_CLIENT: Allows access to Volume Group and VM client.
    """
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    NONE = "NONE"
    ...
    def _initialize_object_type(self):
        return 'volumes.v4.config.ClientAccess'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ClientAccess, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ClientAccess):
            return False
