...
from ntnx_volumes_py_client.models.volumes.v4.config.FlashMode import FlashMode  # noqa: F401,E501

class DiskStorageFeatures(object):
    ...
    :param flash_mode: (:attr:`flash_mode`) 
    :type flash_mode: 
    ...
    """  # noqa: E501
    swagger_types = {
        'flash_mode': 'volumes.v4.config.FlashMode',
    ...
    def _initialize_object_type(self):
        return 'volumes.v4.config.DiskStorageFeatures'
    ...
    def flash_mode(self):
        ...
        :type:
            :class:`~ntnx_volumes_py_client.models.volumes.v4.config.FlashMode`
        """  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(DiskStorageFeatures, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DiskStorageFeatures):
            return False
