...
class CategoryEntityReferences(object):
    ...
    :param categories: (:attr:`categories`) The category to be associated/disassociated with the Volume Group. This is a mandatory field.
    :type categories: 
    ...
    def _initialize_object_type(self):
        return 'volumes.v4.config.CategoryEntityReferences'
    ...
    def categories(self):
        ...
        :type:
             list[ :class:`~ntnx_volumes_py_client.models.common.v1.config.EntityReference` ]
        """  # noqa: E501
