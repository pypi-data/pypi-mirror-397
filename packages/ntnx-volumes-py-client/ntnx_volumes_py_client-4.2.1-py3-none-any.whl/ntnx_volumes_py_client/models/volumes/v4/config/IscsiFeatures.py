...
class IscsiFeatures(object):
    ...
    :param target_secret: (:attr:`target_secret`) Target secret in case of a CHAP authentication. This field must only be provided in case the authentication type is not set to CHAP. This is an optional field and it cannot be retrieved once configured.
    :type target_secret: 
    ...
    def __init__(self, target_secret=None, enabled_authentications=None, *args, **kwargs):  # noqa: E501
    ...
    def _initialize_object_type(self):
        return 'volumes.v4.config.IscsiFeatures'
