...
from ntnx_volumes_py_client.models.volumes.v4.config.IscsiClient import IscsiClient  # noqa: F401,E501
...
class IscsiClientProjection(IscsiClient):
    ...
    def __init__(self, cluster_projection=None, iscsi_initiator_name=None, iscsi_initiator_network_id=None, client_secret=None, enabled_authentications=None, attached_targets=None, num_virtual_targets=None, cluster_reference=None, attachment_site=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
        IscsiClient.__init__(self, iscsi_initiator_name, iscsi_initiator_network_id, client_secret, enabled_authentications, attached_targets, num_virtual_targets, cluster_reference, attachment_site, ext_id, links, tenant_id, *args, **kwargs)
    ...
    def _initialize_object_type(self):
        return 'volumes.v4.config.IscsiClientProjection'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(IscsiClientProjection, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IscsiClientProjection):
            return False
