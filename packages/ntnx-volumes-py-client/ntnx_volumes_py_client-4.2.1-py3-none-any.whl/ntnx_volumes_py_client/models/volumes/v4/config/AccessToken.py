...
class AccessToken(object):
    ...
    :param jwt_token: (:attr:`jwt_token`) JWT token in string format. This token must be set as a session cookie while making V2 API call for Volume Groups.
    :type jwt_token: 
    ...
    def __init__(self, jwt_token=None, *args, **kwargs):  # noqa: E501
    ...
    def _initialize_object_type(self):
        return 'volumes.v4.config.AccessToken'
