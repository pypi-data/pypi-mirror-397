...
class TimeValuePair(object):
    ...
    :param timestamp: (:attr:`timestamp`) Timestamp is returned in Epoch format.
    :type timestamp: 
    
    
    :param value: (:attr:`value`) Value of the stat at the corresponding timestamp value represented in Int64 format.
    :type value: 
    ...
    def _initialize_object_type(self):
        return 'volumes.v4.stats.TimeValuePair'
