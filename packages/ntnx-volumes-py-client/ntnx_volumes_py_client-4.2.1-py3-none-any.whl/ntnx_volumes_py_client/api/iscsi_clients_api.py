...
class IscsiClientsApi(object):
    ...
    def get_iscsi_client_by_id(self, extId, **kwargs):  # noqa: E501
        """Fetch an iSCSI client details

        >>> response = api.get_iscsi_client_by_id(extId)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.get_iscsi_client_by_id(extId, async_req=True)
        >>> result = thread.get()

        :param extId: The external identifier of an iSCSI client.
        :type extId:
            :class:`str`, required
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
                           ...
                           async_req=True
        :return: An instance of class :class:`~ntnx_volumes_py_client.models.volumes.v4.config.GetIscsiClientApiResponse`.
        ...
        if ('extId' not in params or params['extId'] is None):
            raise ValueError("Missing the required parameter `extId` when calling `get_iscsi_client_by_id`")  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/volumes/v4.2/config/iscsi-clients/{extId}', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
                    ...
                    response_type='volumes.v4.config.GetIscsiClientApiResponse',  # noqa: E501
    ...
    def list_iscsi_clients(self, _page=None, _limit=None, _filter=None, _orderby=None, _expand=None, _select=None, **kwargs):  # noqa: E501
        """List all the iSCSI clients

        >>> response = api.list_iscsi_clients((optional) _page, (optional) _limit, (optional) _filter, (optional) _orderby, (optional) _expand, (optional) _select)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.list_iscsi_clients(async_req=True)
        >>> result = thread.get()
        ...
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
                           ...
                           async_req=True
        :return: An instance of class :class:`~ntnx_volumes_py_client.models.volumes.v4.config.ListIscsiClientsApiResponse`.
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/volumes/v4.2/config/iscsi-clients', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
                    post_params=form_params,
                    files=local_var_files,
                    response_type='volumes.v4.config.ListIscsiClientsApiResponse',  # noqa: E501
                    auth_settings=auth_settings,
                    async_req=params.get('async_req'),
                    _return_http_data_only=params.get('_return_http_data_only'),
                    _preload_content=params.get('_preload_content', True),
    ...
    def update_iscsi_client_by_id(self, extId, body, **kwargs):  # noqa: E501
        """Update an iSCSI client

        >>> response = api.update_iscsi_client_by_id(extId, body)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.update_iscsi_client_by_id(extId, body, async_req=True)
        >>> result = thread.get()
        ...
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
                           ...
                           async_req=True
        :return: An instance of class :class:`~ntnx_volumes_py_client.models.volumes.v4.config.UpdateIscsiClientApiResponse`.
        ...
        # verify the required parameter 'extId' is set
        if ('extId' not in params or params['extId'] is None):
            raise ValueError("Missing the required parameter `extId` when calling `update_iscsi_client_by_id`")  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/volumes/v4.2/config/iscsi-clients/{extId}', 'PUT',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
                    post_params=form_params,
                    files=local_var_files,
                    response_type='volumes.v4.config.UpdateIscsiClientApiResponse',  # noqa: E501
                    auth_settings=auth_settings,
                    async_req=params.get('async_req'),
                    _return_http_data_only=params.get('_return_http_data_only'),
                    _preload_content=params.get('_preload_content', True),
