...
class TargetParam(object):
    ...
    :type num_virtual_targets: 
     ...
     min=1, max=32
    :param iscsi_target_name: (:attr:`iscsi_target_name`) Name of the iSCSI target that the iSCSI client is connected to. This is a read-only field.
    :type iscsi_target_name: 
     max=512 chars
    ...
    def __init__(self, num_virtual_targets=None, iscsi_target_name=None, *args, **kwargs):  # noqa: E501
    ...
    def _initialize_object_type(self):
        return 'volumes.v4.config.TargetParam'
    ...
    def iscsi_target_name(self, iscsi_target_name):
        if iscsi_target_name is not None and len(iscsi_target_name) > 512:
            raise ValueError("Invalid value for `iscsi_target_name`, length must be less than or equal to `512`")  # noqa: E501
