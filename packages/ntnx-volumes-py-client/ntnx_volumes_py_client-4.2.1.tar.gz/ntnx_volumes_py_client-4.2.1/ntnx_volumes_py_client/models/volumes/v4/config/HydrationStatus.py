...
class HydrationStatus(object):
    ...
    Allowed enum values:
        ...
        - _UNKNOWN
        - _REDACTED
        - IN_PROGRESS: The Volume Group is being hydrated.
        - COMPLETE: The volume group has been successfully hydrated.
        - FAIL: Hydration process for the Volume Group has irrecoverably failed.
    """
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    ...
    def _initialize_object_type(self):
        return 'volumes.v4.config.HydrationStatus'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(HydrationStatus, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, HydrationStatus):
            return False
