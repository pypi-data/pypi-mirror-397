...
from ntnx_volumes_py_client.models.volumes.v4.config.HydrationStatus import HydrationStatus  # noqa: F401,E501
...
from ntnx_volumes_py_client.models.volumes.v4.config.VGAttachment import VGAttachment  # noqa: F401,E501
...
class VolumeGroup(ExternalizableAbstractModel):
    ...
    :param attachments: (:attr:`attachments`) List of attachments for a Volume Group.
    :type attachments: 
    
    
    :param hydration_status: (:attr:`hydration_status`) 
    :type hydration_status: 
    ...
    swagger_types = {
        ...
        'attachments': 'list[volumes.v4.config.VGAttachment]',
        'hydration_status': 'volumes.v4.config.HydrationStatus',
        'ext_id': 'str',
    ...
    def __init__(self, name=None, description=None, should_load_balance_vm_attachments=False, sharing_status=None, target_prefix=None, target_name=None, enabled_authentications=None, iscsi_features=None, created_by=None, cluster_reference=None, storage_features=None, usage_type=None, attachment_type=None, protocol=None, is_hidden=False, disks=None, attachments=None, hydration_status=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
        ...
        if hydration_status is not None:
            self.__hydration_status = hydration_status
    ...
    def attachments(self):
        ...
        :type:
             list[ :class:`~ntnx_volumes_py_client.models.volumes.v4.config.VGAttachment` ]
        """  # noqa: E501
    ...
    def hydration_status(self):
        ...
        :type:
            :class:`~ntnx_volumes_py_client.models.volumes.v4.config.HydrationStatus`
        """  # noqa: E501
        return self.__hydration_status

    @hydration_status.setter
    def hydration_status(self, hydration_status):
