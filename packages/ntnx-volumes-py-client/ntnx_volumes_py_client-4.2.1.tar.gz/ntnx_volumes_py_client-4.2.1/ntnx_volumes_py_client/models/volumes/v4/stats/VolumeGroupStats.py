...
class VolumeGroupStats(ExternalizableAbstractModel):
    ...
    :param hydration_remaining_bytes: (:attr:`hydration_remaining_bytes`) Number of bytes that are left to hydrate the Volume Group.
    :type hydration_remaining_bytes: 
    ...
    swagger_types = {
        ...
        'hydration_remaining_bytes': 'list[volumes.v4.stats.TimeValuePair]',
        'ext_id': 'str',
    ...
    attribute_map = {
        ...
        'hydration_remaining_bytes': 'hydrationRemainingBytes',
        'ext_id': 'extId',
        'links': 'links',
        'tenant_id': 'tenantId',
        '_reserved': '$reserved',
    ...
    def __init__(self, volume_group_ext_id=None, controller_user_bytes=None, controller_num_iops=None, controller_num_read_iops=None, controller_num_write_iops=None, controller_io_bandwidth_k_bps=None, controller_read_io_bandwidth_k_bps=None, controller_write_io_bandwidth_k_bps=None, controller_avg_io_latency_usecs=None, controller_avg_read_io_latency_usecs=None, controller_avg_write_io_latency_usecs=None, hydration_remaining_bytes=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
        ...
        self.__hydration_remaining_bytes = None
        ...
        if hydration_remaining_bytes is not None:
            self.__hydration_remaining_bytes = hydration_remaining_bytes
    ...
    @property
    def hydration_remaining_bytes(self):
        """
        ...
        :type:
             list[ :class:`~ntnx_volumes_py_client.models.volumes.v4.stats.TimeValuePair` ]
        """  # noqa: E501
        return self.__hydration_remaining_bytes

    @hydration_remaining_bytes.setter
    def hydration_remaining_bytes(self, hydration_remaining_bytes):
