...
class RevertSpec(object):

    """Specify the Volume Group recovery point ID to which the Volume Group would be reverted.

    :param volume_group_recovery_point_ext_id: (:attr:`volume_group_recovery_point_ext_id`) The external identifier of the Volume Group recovery point. This is a mandatory field.
    :type volume_group_recovery_point_ext_id: required
    ...
    def __init__(self, volume_group_recovery_point_ext_id=None, *args, **kwargs):  # noqa: E501
    ...
    def _initialize_object_type(self):
        return 'volumes.v4.config.RevertSpec'
    ...
    def volume_group_recovery_point_ext_id(self, volume_group_recovery_point_ext_id):
        if volume_group_recovery_point_ext_id is None:
            raise ValueError("Invalid value for `volume_group_recovery_point_ext_id`, must not be `None`")  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RevertSpec):
            return False
