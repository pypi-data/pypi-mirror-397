...
class FlashMode(object):
    ...
    :param is_enabled: (:attr:`is_enabled`) This field will indicate whether flash mode is enabled or not. (**Default** False)
    :type is_enabled: 
    ...
    def __init__(self, is_enabled=False, *args, **kwargs):  # noqa: E501
    ...
    def _initialize_object_type(self):
        return 'volumes.v4.config.FlashMode'
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FlashMode):
            return False
