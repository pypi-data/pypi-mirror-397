...
class IscsiClientAttachment(object):
    ...
    :param ext_id: (:attr:`ext_id`) The external identifier of an iSCSI client.
    :type ext_id: 
    ...
    def __init__(self, ext_id=None, cluster_reference=None, *args, **kwargs):  # noqa: E501
        self.__ext_id = None
    ...
    def _initialize_object_type(self):
        return 'volumes.v4.config.IscsiClientAttachment'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(IscsiClientAttachment, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IscsiClientAttachment):
            return False
