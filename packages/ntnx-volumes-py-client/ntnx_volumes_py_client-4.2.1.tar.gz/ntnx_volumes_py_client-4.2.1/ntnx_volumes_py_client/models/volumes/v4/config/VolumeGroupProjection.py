...
class VolumeGroupProjection(VolumeGroup):
    ...
    def __init__(self, cluster_projection=None, volume_group_metadata_projection=None, name=None, description=None, should_load_balance_vm_attachments=False, sharing_status=None, target_prefix=None, target_name=None, enabled_authentications=None, iscsi_features=None, created_by=None, cluster_reference=None, storage_features=None, usage_type=None, attachment_type=None, protocol=None, is_hidden=False, disks=None, attachments=None, hydration_status=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
        VolumeGroup.__init__(self, name, description, should_load_balance_vm_attachments, sharing_status, target_prefix, target_name, enabled_authentications, iscsi_features, created_by, cluster_reference, storage_features, usage_type, attachment_type, protocol, is_hidden, disks, attachments, hydration_status, ext_id, links, tenant_id, *args, **kwargs)
