...
class AttachIscsiClientApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfvolumes.v4.config.AttachIscsiClientApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in AttachIscsiClientApiResponsedata.discriminator_value_class_map.values():
            return list(AttachIscsiClientApiResponsedata.discriminator_value_class_map.keys())[list(AttachIscsiClientApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(AttachIscsiClientApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AttachIscsiClientApiResponsedata):
            return False
