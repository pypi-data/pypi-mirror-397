...
class ListCategoryAssociationsApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<volumes.v4.config.CategoryDetails>': 'list[volumes.v4.config.CategoryDetails]',
    ...
    def _initialize_object_type(self):
        return 'OneOfvolumes.v4.config.ListCategoryAssociationsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListCategoryAssociationsApiResponsedata.discriminator_value_class_map.values():
            return list(ListCategoryAssociationsApiResponsedata.discriminator_value_class_map.keys())[list(ListCategoryAssociationsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListCategoryAssociationsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListCategoryAssociationsApiResponsedata):
            return False
