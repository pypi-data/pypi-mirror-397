...
class DetachVmApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfvolumes.v4.config.DetachVmApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in DetachVmApiResponsedata.discriminator_value_class_map.values():
            return list(DetachVmApiResponsedata.discriminator_value_class_map.keys())[list(DetachVmApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(DetachVmApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DetachVmApiResponsedata):
            return False
