...
class GetVolumeGroupApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'volumes.v4.config.VolumeGroup': 'volumes.v4.config.VolumeGroup',
    ...
    def _initialize_object_type(self):
        return 'OneOfvolumes.v4.config.GetVolumeGroupApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetVolumeGroupApiResponsedata.discriminator_value_class_map.values():
            return list(GetVolumeGroupApiResponsedata.discriminator_value_class_map.keys())[list(GetVolumeGroupApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetVolumeGroupApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetVolumeGroupApiResponsedata):
            return False
