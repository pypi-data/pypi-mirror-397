...
class AssociateCategoryApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfvolumes.v4.config.AssociateCategoryApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in AssociateCategoryApiResponsedata.discriminator_value_class_map.values():
            return list(AssociateCategoryApiResponsedata.discriminator_value_class_map.keys())[list(AssociateCategoryApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(AssociateCategoryApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AssociateCategoryApiResponsedata):
            return False
