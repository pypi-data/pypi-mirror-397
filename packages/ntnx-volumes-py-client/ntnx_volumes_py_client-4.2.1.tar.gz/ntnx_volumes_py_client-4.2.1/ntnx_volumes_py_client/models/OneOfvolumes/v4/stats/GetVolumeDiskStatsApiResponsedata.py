...
class GetVolumeDiskStatsApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'volumes.v4.stats.VolumeDiskStats': 'volumes.v4.stats.VolumeDiskStats',
    ...
    def _initialize_object_type(self):
        return 'OneOfvolumes.v4.stats.GetVolumeDiskStatsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetVolumeDiskStatsApiResponsedata.discriminator_value_class_map.values():
            return list(GetVolumeDiskStatsApiResponsedata.discriminator_value_class_map.keys())[list(GetVolumeDiskStatsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetVolumeDiskStatsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetVolumeDiskStatsApiResponsedata):
            return False
