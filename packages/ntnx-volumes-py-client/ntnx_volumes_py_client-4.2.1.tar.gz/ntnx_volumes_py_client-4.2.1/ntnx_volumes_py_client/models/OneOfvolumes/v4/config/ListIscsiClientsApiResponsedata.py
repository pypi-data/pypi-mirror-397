...
class ListIscsiClientsApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<volumes.v4.config.IscsiClient>': 'list[volumes.v4.config.IscsiClient]',
        'volumes.v4.error.ErrorResponse': 'volumes.v4.error.ErrorResponse',
        'List<volumes.v4.config.IscsiClientProjection>': 'list[volumes.v4.config.IscsiClientProjection]'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOfvolumes.v4.config.ListIscsiClientsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListIscsiClientsApiResponsedata.discriminator_value_class_map.values():
            return list(ListIscsiClientsApiResponsedata.discriminator_value_class_map.keys())[list(ListIscsiClientsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListIscsiClientsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListIscsiClientsApiResponsedata):
            return False
