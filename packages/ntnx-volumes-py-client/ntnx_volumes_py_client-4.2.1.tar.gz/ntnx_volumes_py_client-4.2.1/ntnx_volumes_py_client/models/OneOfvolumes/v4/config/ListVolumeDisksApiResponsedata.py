...
class ListVolumeDisksApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<volumes.v4.config.VolumeDisk>': 'list[volumes.v4.config.VolumeDisk]',
        'volumes.v4.error.ErrorResponse': 'volumes.v4.error.ErrorResponse',
        'List<volumes.v4.config.VolumeDiskProjection>': 'list[volumes.v4.config.VolumeDiskProjection]'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOfvolumes.v4.config.ListVolumeDisksApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListVolumeDisksApiResponsedata.discriminator_value_class_map.values():
            return list(ListVolumeDisksApiResponsedata.discriminator_value_class_map.keys())[list(ListVolumeDisksApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListVolumeDisksApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListVolumeDisksApiResponsedata):
            return False
