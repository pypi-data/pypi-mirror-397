...
class ListNvmfClientsApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<volumes.v4.config.NvmfClient>': 'list[volumes.v4.config.NvmfClient]',
        'volumes.v4.error.ErrorResponse': 'volumes.v4.error.ErrorResponse',
        'List<volumes.v4.config.NvmfClientProjection>': 'list[volumes.v4.config.NvmfClientProjection]'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOfvolumes.v4.config.ListNvmfClientsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListNvmfClientsApiResponsedata.discriminator_value_class_map.values():
            return list(ListNvmfClientsApiResponsedata.discriminator_value_class_map.keys())[list(ListNvmfClientsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListNvmfClientsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListNvmfClientsApiResponsedata):
            return False
