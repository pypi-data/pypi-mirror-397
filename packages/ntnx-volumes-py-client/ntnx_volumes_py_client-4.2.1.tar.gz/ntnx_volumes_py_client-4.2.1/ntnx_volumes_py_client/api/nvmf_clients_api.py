...
class NvmfClientsApi(object):
    ...
    def get_nvmf_client_by_id(self, extId, **kwargs):  # noqa: E501
        """Get a NVMe-TCP client details

        >>> response = api.get_nvmf_client_by_id(extId)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.get_nvmf_client_by_id(extId, async_req=True)
        >>> result = thread.get()

        :param extId: The external identifier of the NVMe-TCP client.
        :type extId:
            :class:`str`, required
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
                           ...
                           async_req=True
        :return: An instance of class :class:`~ntnx_volumes_py_client.models.volumes.v4.config.GetNvmfClientApiResponse`.
        ...
        if ('extId' not in params or params['extId'] is None):
            raise ValueError("Missing the required parameter `extId` when calling `get_nvmf_client_by_id`")  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/volumes/v4.2/config/nvmf-clients/{extId}', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
                    ...
                    response_type='volumes.v4.config.GetNvmfClientApiResponse',  # noqa: E501
    ...
    def list_nvmf_clients(self, _page=None, _limit=None, _filter=None, _orderby=None, _expand=None, _select=None, **kwargs):  # noqa: E501
        """List all NVMe-TCP clients

        >>> response = api.list_nvmf_clients((optional) _page, (optional) _limit, (optional) _filter, (optional) _orderby, (optional) _expand, (optional) _select)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.list_nvmf_clients(async_req=True)
        >>> result = thread.get()
        ...
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
                           ...
                           async_req=True
        :return: An instance of class :class:`~ntnx_volumes_py_client.models.volumes.v4.config.ListNvmfClientsApiResponse`.
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/volumes/v4.2/config/nvmf-clients', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
                    post_params=form_params,
                    files=local_var_files,
                    response_type='volumes.v4.config.ListNvmfClientsApiResponse',  # noqa: E501
                    auth_settings=auth_settings,
                    async_req=params.get('async_req'),
                    _return_http_data_only=params.get('_return_http_data_only'),
                    _preload_content=params.get('_preload_content', True),
