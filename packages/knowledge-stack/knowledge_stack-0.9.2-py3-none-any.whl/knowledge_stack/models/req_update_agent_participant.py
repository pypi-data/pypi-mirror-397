...
class ReqUpdateAgentParticipant(BaseModel):
    """
    Request schema for updating an agent participant.
    """ # noqa: E501
    ...
    url: Optional[StrictStr] = Field(default=None, description="The URL of the agent")
    api_key: Optional[StrictStr] = Field(default=None, description="The API key of the agent")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ReqUpdateAgentParticipant from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ReqUpdateAgentParticipant from a dict"""
        if obj is None:
            return None
