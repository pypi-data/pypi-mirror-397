...
class ChunkLineage(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["chunk_id", "generation_reasoning"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChunkLineage from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChunkLineage from a dict"""
        if obj is None:
            return None
