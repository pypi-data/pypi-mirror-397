...
class ReqCreateUserParticipant(BaseModel):
    """
    Request schema for creating a user participant.
    """ # noqa: E501
    ...
    email: StrictStr = Field(description="Email address (required for USER type)")
    idp_user_id: StrictStr = Field(description="IdP user ID (optional for USER type)")
    ...
    __properties: ClassVar[List[str]] = ["name", "description", "email", "idp_user_id", "role", "read_only_paths", "read_write_paths"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ReqCreateUserParticipant from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ReqCreateUserParticipant from a dict"""
        if obj is None:
            return None
