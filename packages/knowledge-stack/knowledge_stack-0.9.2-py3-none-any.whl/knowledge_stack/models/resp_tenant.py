...
class RespTenant(BaseModel):
    ...
    settings: Dict[str, Any] = Field(description="Tenant settings that allows arbitrary keys.")
    deleted_at: Optional[datetime] = Field(default=None, description="Deletion timestamp if tenant is deleted")
