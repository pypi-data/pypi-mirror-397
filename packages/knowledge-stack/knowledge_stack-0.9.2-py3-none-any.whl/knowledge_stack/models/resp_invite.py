...
class RespInvite(BaseModel):
    ...
    Invite information.
    """ # noqa: E501
    id: UUID = Field(description="Invite identifier")
    tenant_id: UUID = Field(description="Tenant identifier")
    email: StrictStr = Field(description="Invitee email")
    status: InviteStatus = Field(description="Invite status")
    accepted_at: Optional[datetime] = Field(default=None, description="Timestamp when invite was accepted")
