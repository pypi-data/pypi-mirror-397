...
*AuthApi* | [**create_default_tenant_with_user_admin**](docs/AuthApi.md#create_default_tenant_with_user_admin) | **POST** /api/v1/auth/tenant/default | Create default tenant with user admin
*AuthApi* | [**create_ksidp_pw_user**](docs/AuthApi.md#create_ksidp_pw_user) | **POST** /api/v1/auth/ksidp/user/create_pw_user | Create Ksidp Pw User Handler
...
*AuthApi* | [**get_ksidp_user**](docs/AuthApi.md#get_ksidp_user) | **GET** /api/v1/auth/ksidp/user | Get Ksidp User Handler
*AuthApi* | [**initiate_ksidp_flow**](docs/AuthApi.md#initiate_ksidp_flow) | **POST** /api/v1/auth/idp/ks/initiate | Initiate KS IdP flow
*AuthApi* | [**ksidp_oauth_callback**](docs/AuthApi.md#ksidp_oauth_callback) | **GET** /api/v1/auth/oauth/callback | KS IdP OAuth callback
...
*AuthApi* | [**list_tenants_for_user**](docs/AuthApi.md#list_tenants_for_user) | **GET** /api/v1/auth/tenant | List tenants for a user
...
*AuthApi* | [**refresh_user_access_token**](docs/AuthApi.md#refresh_user_access_token) | **POST** /api/v1/auth/token/uat/refresh | Refresh user access token
*AuthApi* | [**verify_ksidp_user_email**](docs/AuthApi.md#verify_ksidp_user_email) | **POST** /api/v1/auth/ksidp/user/verify_email | Verify Ksidp User Email Handler
...
*DocumentsApi* | [**retry_ingest_document**](docs/DocumentsApi.md#retry_ingest_document) | **PUT** /api/v1/tenant/{tenant_id}/documents/{document_id}/ingest | Retry Ingest Document
...
*TenantThreadsApi* | [**resume_thread_agent_token**](docs/TenantThreadsApi.md#resume_thread_agent_token) | **POST** /api/v1/tenant/{tenant_id}/threads/{thread_id}/agent-token | Resume thread by refreshing agent thread token
...
*ThreadTurnsApi* | [**list_thread_turns**](docs/ThreadTurnsApi.md#list_thread_turns) | **GET** /api/v1/tenant/{tenant_id}/threads/{thread_id}/turns | List thread turns
...
## Documentation For Models
 ...
 - [BaseParticipant](docs/BaseParticipant.md)
 - [BaseRespDelete](docs/BaseRespDelete.md)
 - [Category](docs/Category.md)
 - [ChunkLineage](docs/ChunkLineage.md)
 ...
 - [PaginatedResponseRespTurn](docs/PaginatedResponseRespTurn.md)
 - [ParticipantType](docs/ParticipantType.md)
 - [ProcessingStage](docs/ProcessingStage.md)
 - [PublicRespChunkMetadata](docs/PublicRespChunkMetadata.md)
 - [RelevantFolderPath](docs/RelevantFolderPath.md)
 - [RelevantTag](docs/RelevantTag.md)
 - [ReqCreateAgentParticipant](docs/ReqCreateAgentParticipant.md)
 - [ReqCreateDefaultTenant](docs/ReqCreateDefaultTenant.md)
 ...
 - [RespParticipant](docs/RespParticipant.md)
 - [RespParticipantIdentity](docs/RespParticipantIdentity.md)
 ...
 - [RespTurn](docs/RespTurn.md)
 - [RespTurnCreate](docs/RespTurnCreate.md)
 - [RespUserIdentity](docs/RespUserIdentity.md)
 - [SearchChunkMetadata](docs/SearchChunkMetadata.md)
 ...
 - [ThreadAgentTokenResponse](docs/ThreadAgentTokenResponse.md)
