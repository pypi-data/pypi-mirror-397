...
class RespTenantCreate(BaseModel):
    """
    Response returned after creating a tenant.
    """ # noqa: E501
    ...
    api_key: StrictStr = Field(description="Tenant API key")
    __properties: ClassVar[List[str]] = ["id", "organization_id", "name", "description", "api_key"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RespTenantCreate from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RespTenantCreate from a dict"""
        if obj is None:
            return None
