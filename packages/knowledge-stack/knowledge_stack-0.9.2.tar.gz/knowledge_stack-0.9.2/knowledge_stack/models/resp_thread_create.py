...
class RespThreadCreate(BaseModel):
    """
    RespThreadCreate
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["agent_id", "agent_name", "agent_url", "agent_thread_token", "thread_id", "title", "description", "created_at", "updated_at"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RespThreadCreate from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RespThreadCreate from a dict"""
        if obj is None:
            return None
