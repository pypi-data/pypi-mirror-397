...
class RespChunk(BaseModel):
    ...
    chunk_metadata: Optional[PublicRespChunkMetadata] = Field(default=None, description="Chunk metadata")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "chunk_metadata": PublicRespChunkMetadata.from_dict(obj["chunk_metadata"]) if obj.get("chunk_metadata") is not None else None,
