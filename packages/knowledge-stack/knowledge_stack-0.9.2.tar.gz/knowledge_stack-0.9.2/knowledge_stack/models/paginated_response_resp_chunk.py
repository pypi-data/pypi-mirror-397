...
class PaginatedResponseRespChunk(BaseModel):
    """
    PaginatedResponseRespChunk
    """ # noqa: E501
    items: List[RespChunk] = Field(description="List of items")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PaginatedResponseRespChunk from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PaginatedResponseRespChunk from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "items": [RespChunk.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "total": obj.get("total"),
            "limit": obj.get("limit"),
