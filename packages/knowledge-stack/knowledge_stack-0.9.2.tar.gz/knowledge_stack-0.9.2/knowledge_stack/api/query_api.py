...
class QueryApi:
    ...
    def ask(
        ...
        retrieve_only: Annotated[Optional[StrictBool], Field(description="Whether to retrieve only the chunks or to answer the question")] = None,
        ...
        """(Deprecated) DEPRECATED: Use the new search endpoint instead

        Query documents in the vector database using semantic search.  This endpoint searches for semantically similar chunks in the vector database and returns the most relevant results based on the provided query.

        :param tenant_id: The tenant ID (required)
        :type tenant_id: str
        :param req_search_chunks: (required)
        :type req_search_chunks: ReqSearchChunks
        :param retrieve_only: Whether to retrieve only the chunks or to answer the question
        :type retrieve_only: bool
        ...
        """ # noqa: E501
        warnings.warn("POST /api/v1/tenant/{tenant_id}/query/ask is deprecated.", DeprecationWarning)
    ...
    def _ask_serialize(
        ...
        if retrieve_only is not None:
            ...
            _query_params.append(('retrieve_only', retrieve_only))
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/tenant/{tenant_id}/query/ask',
