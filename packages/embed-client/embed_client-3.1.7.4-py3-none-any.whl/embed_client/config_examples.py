...
def get_http_token_config(host: str = "localhost", port: int = 8001, api_key: str = "test-token-123") -> Dict[str, Any]:
    """
...
def get_https_token_config(
    ...
    Returns:
        Configuration dictionary
    """
    config = ClientConfig.create_https_token_config(host, port, api_key, cert_file, key_file, ca_cert_file)
    return config.get_all()
