...
async def demonstrate_specific_client_creation():
    ...
    # mTLS client
    client = ClientFactory.create_mtls_client("https://localhost", "client_cert.pem", "client_key.pem", 8001)
...
async def demonstrate_ssl_configuration():
    ...
    client = create_client("https://localhost", 8001, verify_mode="CERT_REQUIRED", check_hostname=False)
