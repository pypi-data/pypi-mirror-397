...
class ClientFactory:
    ...
    def create_client(
        ...
        **kwargs,
        ...
        security_mode = ClientFactory.detect_security_mode(base_url, auth_method, ssl_enabled, **kwargs)
    ...
    def create_http_client(base_url: str, port: int = 8001, **kwargs) -> EmbeddingServiceAsyncClient:
        ...
        return ClientFactory.create_client(base_url, port, auth_method="none", ssl_enabled=False, **kwargs)
    ...
    def create_http_token_client(
        ...
        return ClientFactory.create_client(base_url, port, auth_method=auth_method, ssl_enabled=False, **kwargs)

    @staticmethod
    def create_https_client(base_url: str, port: int = 8001, **kwargs) -> EmbeddingServiceAsyncClient:
        """Create HTTPS client (no authentication, with SSL)."""
        return ClientFactory.create_client(base_url, port, auth_method="none", ssl_enabled=True, **kwargs)
    ...
    def create_https_token_client(
        ...
        return ClientFactory.create_client(base_url, port, auth_method=auth_method, ssl_enabled=True, **kwargs)
    ...
    def from_environment() -> EmbeddingServiceAsyncClient:
        ...
        return ClientFactory.create_client(base_url, port, auth_method=auth_method, ssl_enabled=ssl_enabled)
...
def detect_security_mode(
    ...
    **kwargs,
    ...
    """
    return ClientFactory.detect_security_mode(base_url, auth_method, ssl_enabled, cert_file, key_file, **kwargs)
