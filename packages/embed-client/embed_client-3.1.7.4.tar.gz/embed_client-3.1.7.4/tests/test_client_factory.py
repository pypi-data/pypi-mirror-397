...
class TestClientFactory:
    ...
    def test_detect_security_mode_http_token(self):
        ...
        mode = ClientFactory.detect_security_mode("http://localhost", auth_method="api_key")
    ...
    def test_detect_security_mode_https_token(self):
        ...
        mode = ClientFactory.detect_security_mode("https://localhost", auth_method="api_key")
        assert mode == SecurityMode.HTTPS_TOKEN

    def test_detect_security_mode_mtls(self):
        """Test detection of mTLS mode."""
        mode = ClientFactory.detect_security_mode("https://localhost", cert_file="cert.pem", key_file="key.pem")
    ...
    def test_detect_security_mode_ssl_disabled_override(self):
        ...
        mode = ClientFactory.detect_security_mode("https://localhost", ssl_enabled=False)
        assert mode == SecurityMode.HTTP
    ...
    def test_create_client_https_token(self, mock_client_class):
        ...
        client = ClientFactory.create_client("https://localhost", 8001, auth_method="api_key", api_key="test_key")
    ...
    def test_create_client_mtls(self, mock_client_class):
        ...
        client = ClientFactory.create_client("https://localhost", 8001, cert_file="cert.pem", key_file="key.pem")
    ...
    def test_create_config_for_mode_http(self):
        ...
        config = ClientFactory._create_config_for_mode(SecurityMode.HTTP, "http://localhost", 8001, None, False)
    ...
    def test_create_config_for_mode_https(self):
        ...
        config = ClientFactory._create_config_for_mode(SecurityMode.HTTPS, "https://localhost", 8001, None, True)
    ...
    def test_create_auth_config_api_key_with_header(self):
        ...
        config = ClientFactory._create_auth_config("api_key", api_key="test_key", api_key_header="X-API-Key")
    ...
    def test_create_auth_config_jwt(self):
        ...
        config = ClientFactory._create_auth_config("jwt", jwt_secret="secret", jwt_username="user", jwt_password="pass")
    ...
    def test_create_auth_config_basic(self):
        ...
        config = ClientFactory._create_auth_config("basic", username="user", password="pass")
    ...
    def test_create_auth_config_certificate(self):
        ...
        config = ClientFactory._create_auth_config("certificate", cert_file="cert.pem", key_file="key.pem")
    ...
    def test_create_ssl_config_with_ca_cert(self):
        ...
        config = ClientFactory._create_ssl_config(SecurityMode.HTTPS, True, ca_cert_file="ca.pem")
    ...
    def test_create_ssl_config_mtls(self):
        ...
        config = ClientFactory._create_ssl_config(SecurityMode.MTLS, True, cert_file="cert.pem", key_file="key.pem")
    ...
    def test_create_http_token_client(self, mock_client_class):
        ...
        client = ClientFactory.create_http_token_client("http://localhost", 8001, "api_key", api_key="test_key")
    ...
    def test_create_https_token_client(self, mock_client_class):
        ...
        client = ClientFactory.create_https_token_client("https://localhost", 8001, "api_key", api_key="test_key")
    ...
    def test_create_mtls_client(self, mock_client_class):
        ...
        client = ClientFactory.create_mtls_client("https://localhost", "cert.pem", "key.pem", 8001)
...
class TestConvenienceFunctions:
    ...
    def test_detect_security_mode_function(self, mock_detect_mode):
        ...
        mock_detect_mode.assert_called_once_with("https://localhost", None, None, None, None)
        assert mode == SecurityMode.HTTPS
...
class TestIntegration:
    ...
    def test_security_mode_detection_comprehensive(self):
        ...
        for case in test_cases:
            ...
            mode = ClientFactory.detect_security_mode(base_url, auth_method, ssl_enabled, cert_file, key_file, **kwargs)
