...
def _generate_pdf_from_html(html, output_path=None):
    ...
    options = {
        # ✅ Desactiva acceso local (evita OpenPrinter)
        'disable-local-file-access': None,  # ← clave: usar None, no True/False
        'page-size': 'Letter',
        'encoding': 'UTF-8',
        'margin-top': '1.5cm',
        'margin-right': '1cm',
        'margin-left': '1cm',
        'margin-bottom': '15mm',
        'quiet': '',  # silencia logs innecesarios
        # ✅ Opciones adicionales para evitar errores en Windows
        'disable-javascript': '',
        'disable-external-links': '',
        'disable-images': '',  # ← quítalo si necesitas imágenes
        'no-pdf-compression': '',
