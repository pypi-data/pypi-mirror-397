...
modify the contents of the `src/robert_test_24/lib/` and `examples/` directories.
...
```sh
$ pip install git+ssh://git@github.com/RobertCraigie/robert-test-24-python.git
```
...
You can release to package managers by using [the `Publish PyPI` GitHub action](https://www.github.com/RobertCraigie/robert-test-24-python/actions/workflows/publish-pypi.yml). This requires a setup organization or repository secret to be set up.

### Publish manually

If you need to manually release a package, you can run the `bin/publish-pypi` script
