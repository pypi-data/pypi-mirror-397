...
__all__ = ["CorporaCorpusQueryParams", "api_empty"]


class CorporaCorpusQueryParams(TypedDict, total=False):
    query: Required[str]
    ...
    Filter for `Chunk` and `Document` metadata. Each `MetadataFilter` object should
