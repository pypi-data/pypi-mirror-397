...
__all__ = [
    "BatchUpdateGenerateContentBatchUpdateEmbedContentBatchParams",
    "InputConfig",
    "InputConfigRequests",
...
class BatchUpdateGenerateContentBatchUpdateEmbedContentBatchParams(TypedDict, total=False):
...
class InputConfigRequestsRequest(TypedDict, total=False):
    ...
    request: Required[EmbedContentRequestParam]
