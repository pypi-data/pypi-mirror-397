...
from ....types.beta.tuned_models import operation_list_operations_params, operation_retrieve_operation_params
...
class OperationsResource(SyncAPIResource):
    ...
    def list_operations(
        ...
        tuned_model: str,
        *,
        api_empty: operation_list_operations_params.api_empty | Omit = omit,
        ...
        return self._get(
            f"/v1beta/tunedModels/{tuned_model}/operations",
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    operation_list_operations_params.OperationListOperationsParams,
                ),
            ),
    ...
    def retrieve_operation(
        ...
        *,
        tuned_model: str,
        api_empty: operation_retrieve_operation_params.api_empty | Omit = omit,
        alt: Literal["json", "media", "proto"] | Omit = omit,
        callback: str | Omit = omit,
        pretty_print: bool | Omit = omit,
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        ...
        return self._get(
            f"/v1beta/tunedModels/{tuned_model}/operations/{operation}",
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
                ...
                query=maybe_transform(
                    ...
                    operation_retrieve_operation_params.OperationRetrieveOperationParams,
                ),
            ),
            cast_to=Operation,
        )
...
class OperationsResourceWithRawResponse:
    def __init__(self, operations: OperationsResource) -> None:
        ...
        self.list_operations = to_raw_response_wrapper(
            operations.list_operations,
        )
        self.retrieve_operation = to_raw_response_wrapper(
            operations.retrieve_operation,
        )
...
class AsyncOperationsResourceWithRawResponse:
    def __init__(self, operations: AsyncOperationsResource) -> None:
        ...
        self.list_operations = async_to_raw_response_wrapper(
            operations.list_operations,
        )
        self.retrieve_operation = async_to_raw_response_wrapper(
            operations.retrieve_operation,
        )
...
class OperationsResourceWithStreamingResponse:
    def __init__(self, operations: OperationsResource) -> None:
        ...
        self.list_operations = to_streamed_response_wrapper(
            operations.list_operations,
        )
        self.retrieve_operation = to_streamed_response_wrapper(
            operations.retrieve_operation,
        )
...
class AsyncOperationsResourceWithStreamingResponse:
    def __init__(self, operations: AsyncOperationsResource) -> None:
        ...
        self.list_operations = async_to_streamed_response_wrapper(
            operations.list_operations,
        )
        self.retrieve_operation = async_to_streamed_response_wrapper(
            operations.retrieve_operation,
        )
