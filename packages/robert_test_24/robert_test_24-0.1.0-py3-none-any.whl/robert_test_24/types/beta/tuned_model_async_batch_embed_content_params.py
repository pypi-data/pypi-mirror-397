...
from .embed_content_batch_param import EmbedContentBatchParam

__all__ = ["TunedModelAsyncBatchEmbedContentParams", "api_empty"]


class TunedModelAsyncBatchEmbedContentParams(TypedDict, total=False):
    batch: Required[EmbedContentBatchParam]
