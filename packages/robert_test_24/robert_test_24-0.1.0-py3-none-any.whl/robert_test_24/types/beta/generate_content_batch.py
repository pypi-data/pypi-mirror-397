...
__all__ = ["GenerateContentBatch", "InputConfig", "InputConfigRequests", "InputConfigRequestsRequest", "BatchStats"]
...
class GenerateContentBatch(BaseModel):
...
from .generate_content_request import GenerateContentRequest
