...
__all__ = ["PermissionRetrievePermissionParams", "api_empty"]


class PermissionRetrievePermissionParams(TypedDict, total=False):
    tuned_model: Required[Annotated[str, PropertyInfo(alias="tunedModel")]]
