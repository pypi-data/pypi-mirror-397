...
__all__ = ["UploadGetOperationStatusParams", "api_empty"]


class UploadGetOperationStatusParams(TypedDict, total=False):
    rag_stores_id: Required[Annotated[str, PropertyInfo(alias="ragStoresId")]]
