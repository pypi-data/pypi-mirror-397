...
__all__ = ["RagStoreDeleteParams", "api_empty"]


class RagStoreDeleteParams(TypedDict, total=False):
    ...
    If set to true, any `Document`s and objects related to this `RagStore` will also
    be deleted.
