...
//
extern Result bao_closeDB(long long dbH);

// bao_dbQuery executes the specified query on the database connection identified by the given handle.
//
extern Result bao_dbQuery(long long dbH, char* queryC, char* argsC);
...
//
extern Result bao_create(long long dbH, char* idC, char* storeC, char* settingsC);

// bao_open opens an existing stash with the specified identity, author and URL. The function returns a handle to the bao.
//
extern Result bao_open(long long dbH, char* idC, char* urlC, char* authorC);

// bao_close closes the specified safe.
//
extern Result bao_close(long long sH);

// bao_syncAccess sets and optionally flushes access rights for the specified bao.
//
extern Result bao_syncAccess(long long sH, int optionsC, char* changesC);

// bao_getAccess returns the users and access rights for the specified group.
//
extern Result bao_getAccess(long long sH, char* group);

// bao_getGroups returns the groups for the specified user.
//
extern Result bao_getGroups(long long sH, char* userC);
extern Result bao_sync(long long sH, char* groupsC);

// bao_listGroups returns all the groups in the stack
//
extern Result bao_listGroups(long long sH);

// bao_waitFiles completes the read and write operations for the specified files in the bao.
//
extern Result bao_waitFiles(long long sH, char* fileIdsC);

// bao_setAttribute sets an attribute for the current user
//
extern Result bao_setAttribute(long long sH, int options, char* nameC, char* valueC);

// bao_getAttribute gets an attribute for the specified user
//
extern Result bao_getAttribute(long long sH, char* nameC, char* authorC);

// bao_getAttributes gets all attributes for the specified user
//
extern Result bao_getAttributes(long long sH, char* authorC);

// bao_readDir reads the specified directory from the bao.
//
extern Result bao_readDir(long long sH, char* dir, long long after, long long fromId, int limit);

// bao_stat returns the file information for the specified file in the bao.
//
extern Result bao_stat(long long sH, char* name);

// bao_getGroup returns the group name of the specified file.
//
extern Result bao_getGroup(long long sH, char* name);
...
//
extern Result bao_getAuthor(long long sH, char* name);

// bao_read reads the specified file from the bao.
//
extern Result bao_read(long long sH, char* name, char* destC, long long options);

// bao_write writes the specified file to the bao.
//
extern Result bao_write(long long sH, char* destC, char* sourceC, char* groupC, Data attrsC, long long options);

// bao_delete deletes the specified file from the bao.
//
extern Result bao_delete(long long sH, char* nameC, GoInt options);

// stassh_allocatedSize returns the allocated size of the specified bao.
//
extern Result bao_allocatedSize(long long sH);
