...
//
extern Result bao_create(long long int dbH, char* idC, char* storeC, char* settingsC);

// bao_open opens an existing stash with the specified identity, author and URL. The function returns a handle to the bao.
//
extern Result bao_open(long long int dbH, char* idC, char* urlC, char* authorC);
