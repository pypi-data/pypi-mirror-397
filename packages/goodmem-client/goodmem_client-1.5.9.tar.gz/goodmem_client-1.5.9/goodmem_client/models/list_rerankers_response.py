...
class ListRerankersResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["rerankers"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListRerankersResponse from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in rerankers (list)
        _items = []
        if self.rerankers:
            for _item_rerankers in self.rerankers:
                if _item_rerankers:
                    _items.append(_item_rerankers.to_dict())
            _dict['rerankers'] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListRerankersResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "rerankers": [RerankerResponse.from_dict(_item) for _item in obj["rerankers"]] if obj.get("rerankers") is not None else None
        })
        return _obj
