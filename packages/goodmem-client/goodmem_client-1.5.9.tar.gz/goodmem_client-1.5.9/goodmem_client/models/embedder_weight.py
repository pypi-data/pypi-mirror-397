...
class EmbedderWeight(BaseModel):
    ...
    weight: Union[StrictFloat, StrictInt] = Field(description="The weight to apply to this embedder's results. Can be positive, negative, or zero.")
    __properties: ClassVar[List[str]] = ["embedderId", "weight"]
