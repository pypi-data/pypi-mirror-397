...
class CreateLLMResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["llm", "statuses"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "llm": LLMResponse.from_dict(obj["llm"]) if obj.get("llm") is not None else None,
            "statuses": [GoodMemStatus.from_dict(_item) for _item in obj["statuses"]] if obj.get("statuses") is not None else None
        })
        return _obj
