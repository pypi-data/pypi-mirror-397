...
# Suppress Pydantic warnings for fields that shadow BaseModel methods (#412)
# Multiple models have a 'validate' field that shadows an attribute in parent "BaseModel"
warnings.filterwarnings(
    "ignore",
    message='.*Field name "validate" in .* shadows an attribute in parent "BaseModel".*',
