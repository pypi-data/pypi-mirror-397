...
*AdministrationApi* | [**drain_server**](docs/AdministrationApi.md#drain_server) | **POST** /v1/admin:drain | Request the server to enter drain mode
*AdministrationApi* | [**purge_background_jobs**](docs/AdministrationApi.md#purge_background_jobs) | **POST** /v1/admin/background-jobs:purge | Purge completed background jobs
*AdministrationApi* | [**reload_license**](docs/AdministrationApi.md#reload_license) | **POST** /v1/admin/license:reload | Reload the active license from disk
...
*MemoriesApi* | [**batch_create_memory**](docs/MemoriesApi.md#batch_create_memory) | **POST** /v1/memories:batchCreate | Create multiple memories in a batch
*MemoriesApi* | [**batch_delete_memory**](docs/MemoriesApi.md#batch_delete_memory) | **POST** /v1/memories:batchDelete | Delete multiple memories by ID
*MemoriesApi* | [**batch_get_memory**](docs/MemoriesApi.md#batch_get_memory) | **POST** /v1/memories:batchGet | Get multiple memories by ID
...
*MemoriesApi* | [**get_memory_content**](docs/MemoriesApi.md#get_memory_content) | **GET** /v1/memories/{id}/content | Download memory content
...
*SystemApi* | [**get_system_info**](docs/SystemApi.md#get_system_info) | **GET** /v1/system/info | Retrieve server build metadata
...
## Documentation For Models
 ...
 - [ActiveLicenseMetadata](docs/ActiveLicenseMetadata.md)
 - [AdminDrainRequest](docs/AdminDrainRequest.md)
 - [AdminDrainResponse](docs/AdminDrainResponse.md)
 - [AdminPurgeJobsRequest](docs/AdminPurgeJobsRequest.md)
 - [AdminPurgeJobsResponse](docs/AdminPurgeJobsResponse.md)
 - [AdminReloadLicenseResponse](docs/AdminReloadLicenseResponse.md)
 - [ApiKeyAuth](docs/ApiKeyAuth.md)
 - **[ApiKeyResponse](docs/ApiKeyResponse.md)** - API key metadata and information
 - [BackgroundJobAttempt](docs/BackgroundJobAttempt.md)
 - [BackgroundJobSummary](docs/BackgroundJobSummary.md)
 ...
 - [BatchMemoryResponse](docs/BatchMemoryResponse.md)
 - [BatchMemoryResult](docs/BatchMemoryResult.md)
 ...
 - [EndpointAuthentication](docs/EndpointAuthentication.md)
 - [ErrorDetail](docs/ErrorDetail.md)
 - [GcpAdcAuth](docs/GcpAdcAuth.md)
 ...
 - [ProcessingHistory](docs/ProcessingHistory.md)
