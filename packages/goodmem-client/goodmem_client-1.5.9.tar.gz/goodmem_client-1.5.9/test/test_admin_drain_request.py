...
class TestAdminDrainRequest(unittest.TestCase):
    """AdminDrainRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AdminDrainRequest:
        """Test AdminDrainRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AdminDrainRequest`
        """
        model = AdminDrainRequest()
        if include_optional:
            return AdminDrainRequest(
                timeout_sec = 56,
                reason = '',
    ...
    def testAdminDrainRequest(self):
        """Test AdminDrainRequest"""
