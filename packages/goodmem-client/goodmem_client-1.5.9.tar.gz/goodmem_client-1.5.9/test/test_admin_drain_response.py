...
class TestAdminDrainResponse(unittest.TestCase):
    """AdminDrainResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AdminDrainResponse:
        """Test AdminDrainResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AdminDrainResponse`
        """
        model = AdminDrainResponse()
        if include_optional:
            return AdminDrainResponse(
                state = '',
                quiesced = True,
                message = ''
            )
    ...
    def testAdminDrainResponse(self):
        """Test AdminDrainResponse"""
