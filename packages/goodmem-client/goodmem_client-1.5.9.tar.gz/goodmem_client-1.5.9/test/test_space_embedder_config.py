...
class TestSpaceEmbedderConfig(unittest.TestCase):
    """SpaceEmbedderConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SpaceEmbedderConfig:
        """Test SpaceEmbedderConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SpaceEmbedderConfig`
        """
        model = SpaceEmbedderConfig()
        if include_optional:
            return SpaceEmbedderConfig(
    ...
    def testSpaceEmbedderConfig(self):
        """Test SpaceEmbedderConfig"""
