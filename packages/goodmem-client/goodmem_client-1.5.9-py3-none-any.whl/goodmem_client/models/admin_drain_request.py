...
class AdminDrainRequest(BaseModel):
    ...
    wait_for_quiesce: Optional[StrictBool] = Field(default=None, alias="waitForQuiesce")
    __properties: ClassVar[List[str]] = ["timeoutSec", "reason", "waitForQuiesce"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "waitForQuiesce": obj.get("waitForQuiesce")
        })
        return _obj
