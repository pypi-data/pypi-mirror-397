...
class SecretReference(BaseModel):
    ...
    SecretReference
    """ # noqa: E501
    uri: Optional[StrictStr] = Field(default=None, description="URI identifying where the secret can be resolved (e.g., vault://, env://)")
    hints: Optional[Dict[str, StrictStr]] = Field(default=None, description="Optional metadata to help resolvers decode the secret (e.g., {\"encoding\":\"base64\"})")
    __properties: ClassVar[List[str]] = ["uri", "hints"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if hints (nullable) is None
        # and model_fields_set contains the field
        if self.hints is None and "hints" in self.model_fields_set:
            _dict['hints'] = None
