...
class SpaceEmbedderConfig(BaseModel):
    ...
    """ # noqa: E501
    embedder_id: StrictStr = Field(description="The unique identifier for the embedder to associate with the space.", alias="embedderId")
    ...
    __properties: ClassVar[List[str]] = ["embedderId", "defaultRetrievalWeight"]
