...
class GcpAdcAuth(BaseModel):
    ...
    """ # noqa: E501
    scopes: Optional[List[StrictStr]] = Field(default=None, description="Additional OAuth scopes. Empty list falls back to the default cloud-platform scope.")
    quota_project_id: Optional[StrictStr] = Field(default=None, description="Optional quota project used for billing", alias="quotaProjectId")
    __properties: ClassVar[List[str]] = ["scopes", "quotaProjectId"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if quota_project_id (nullable) is None
        # and model_fields_set contains the field
        if self.quota_project_id is None and "quota_project_id" in self.model_fields_set:
            _dict['quotaProjectId'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "quotaProjectId": obj.get("quotaProjectId")
        })
        return _obj
