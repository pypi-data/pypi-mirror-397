...
class LLMResponse(BaseModel):
    ...
    """ # noqa: E501
    llm_id: StrictStr = Field(description="Unique identifier of the LLM", alias="llmId")
    ...
    api_path: StrictStr = Field(description="API path for chat/completions request", alias="apiPath")
    ...
    client_config: Optional[Dict[str, Dict[str, Any]]] = Field(default=None, description="Provider-specific client configuration", alias="clientConfig")
    owner_id: StrictStr = Field(description="Owner ID of the LLM", alias="ownerId")
    ...
    created_by_id: StrictStr = Field(description="ID of the user who created the LLM", alias="createdById")
    updated_by_id: StrictStr = Field(description="ID of the user who last updated the LLM", alias="updatedById")
    __properties: ClassVar[List[str]] = ["llmId", "displayName", "description", "providerType", "endpointUrl", "apiPath", "modelIdentifier", "supportedModalities", "labels", "version", "monitoringEndpoint", "capabilities", "defaultSamplingParams", "maxContextLength", "clientConfig", "ownerId", "createdAt", "updatedAt", "createdById", "updatedById"]
