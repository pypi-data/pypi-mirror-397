...
class AdminReloadLicenseResponse(BaseModel):
    ...
    active_license: Optional[ActiveLicenseMetadata] = Field(default=None, alias="activeLicense")
    __properties: ClassVar[List[str]] = ["status", "message", "activeLicense"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of active_license
        if self.active_license:
            _dict['activeLicense'] = self.active_license.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "activeLicense": ActiveLicenseMetadata.from_dict(obj["activeLicense"]) if obj.get("activeLicense") is not None else None
        })
        return _obj
