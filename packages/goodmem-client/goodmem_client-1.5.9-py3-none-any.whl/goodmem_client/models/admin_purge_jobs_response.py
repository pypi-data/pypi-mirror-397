...
class AdminPurgeJobsResponse(BaseModel):
    ...
    """ # noqa: E501
    jobs_purged: StrictInt = Field(alias="jobsPurged")
    attempts_purged: StrictInt = Field(alias="attemptsPurged")
    references_purged: StrictInt = Field(alias="referencesPurged")
    dry_run: StrictBool = Field(alias="dryRun")
    __properties: ClassVar[List[str]] = ["jobsPurged", "attemptsPurged", "referencesPurged", "dryRun"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "jobsPurged": obj.get("jobsPurged"),
            "attemptsPurged": obj.get("attemptsPurged"),
            "referencesPurged": obj.get("referencesPurged"),
