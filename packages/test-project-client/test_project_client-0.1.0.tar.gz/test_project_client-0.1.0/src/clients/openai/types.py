...
class CreateImageEditRequest(BaseModel):
    model_config = ConfigDict(populate_by_name=True)
        ...
        None    )
        model: Union[str, Literal[&quot;dall-e-2&quot;, &quot;gpt-image-1&quot;, &quot;gpt-image-1-mini&quot;]] = Field(
        None    )
        n: Optional[int] = Field(
        None    )
...
class CreateImageRequest(BaseModel):
    model_config = ConfigDict(populate_by_name=True)
        ...
        prompt: str = Field(
        ...    )
        model: Union[str, Literal[&quot;dall-e-2&quot;, &quot;dall-e-3&quot;, &quot;gpt-image-1&quot;, &quot;gpt-image-1-mini&quot;]] = Field(
        None    )
        n: Optional[int] = Field(
        None    )
...
class ImageGenTool(BaseModel):
    ...
    model_config = ConfigDict(populate_by_name=True)
        ...
        ..., alias="type"    )
        model: Literal[&quot;gpt-image-1&quot;, &quot;gpt-image-1-mini&quot;] = Field(
        None    )
        quality: Literal[&quot;low&quot;, &quot;medium&quot;, &quot;high&quot;, &quot;auto&quot;] = Field(
        None    )
        size: Literal[&quot;1024x1024&quot;, &quot;1024x1536&quot;, &quot;1536x1024&quot;, &quot;auto&quot;] = Field(
