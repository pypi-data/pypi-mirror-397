"""
Layer 2 Agent: Environment-based business logic wrapper for openai
...
from src.clients.openai.primitives_agent import PrimitivesAgent
from src.business.context import ServiceContext


class BusinessAgent:
    """
    Agent-ready wrapper for openai business logic (Layer 2).
    ...
    def __init__(
        ...
        self._ctx.openai = self.primitives.raw
