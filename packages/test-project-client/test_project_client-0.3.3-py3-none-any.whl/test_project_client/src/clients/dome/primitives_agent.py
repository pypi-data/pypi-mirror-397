...
class PrimitivesAgent:
    ...
    def __init__(
        ...
        self.base_url = base_url or os.environ.get("DOME_BASE_URL", "https://api.example.com")
    ...
    async def get_matching_markets_sports_structured(
        ...
        Args:
            polymarket_market_slug: The Polymarket market slug(s) to find matching markets for. To get multiple markets at once, provide the query param multiple times with different slugs. Can not be combined with kalshi_event_ticker.            kalshi_event_ticker: The Kalshi event ticker(s) to find matching markets for. To get multiple markets at once, provide the query param multiple times with different tickers. Can not be combined with polymarket_market_slug.            response_model: Optional Pydantic model to parse the response into
    ...
    async def get_matching_markets_sports_by_sport_structured(
        ...
        Args:
            sport: The sport to find matching markets for            date: The date to find matching markets for in YYYY-MM-DD format            response_model: Optional Pydantic model to parse the response into
