"""
Layer 2 Agent: Environment-based business logic wrapper for middesk
...
from src.clients.middesk.primitives_agent import PrimitivesAgent
from src.business.context import ServiceContext


class BusinessAgent:
    """
    Agent-ready wrapper for middesk business logic (Layer 2).
    ...
    def __init__(
        ...
        self.base_url = base_url or os.environ.get("MIDDESK_BASE_URL", "https://api.example.com")
        ...
        self._ctx.middesk = self.primitives.raw
