...
class PrimitivesAgent:
    ...
    async def update_business_structured(
        ...
        Update Business
        Args:
            business_id: business_id            body: Request body
            response_model: Optional Pydantic model to parse the response into
    ...
    async def retrieve_a_monitor_structured(
        ...
        Retrieve a Monitor
        Args:
            business_id: business_id            response_model: Optional Pydantic model to parse the response into
    ...
    async def retrieve_webhook_structured(
        ...
        Retrieve Webhook
        Args:
            webhook_id: webhook_id            response_model: Optional Pydantic model to parse the response into
