...
class RawAgent:
    ...
    def __init__(
        ...
        self.base_url = base_url or os.environ.get("OPENAI_BASE_URL", "https://api.example.com")
        ...
        self._fine-tuning = FineTuningClient(
            base_url=self.base_url,
            token=self.api_key
        )
        ...
        self._audit logs = AuditLogsClient(
            base_url=self.base_url,
            token=self.api_key
        )
        ...
        self._group organization role assignments = GroupOrganizationRoleAssignmentsClient(
            base_url=self.base_url,
            token=self.api_key
        )
        self._group users = GroupUsersClient(
            base_url=self.base_url,
            token=self.api_key
        )
        ...
        self._project groups = ProjectGroupsClient(
            base_url=self.base_url,
            token=self.api_key
        )
        ...
        self._user organization role assignments = UserOrganizationRoleAssignmentsClient(
            base_url=self.base_url,
            token=self.api_key
        )
        self._project group role assignments = ProjectGroupRoleAssignmentsClient(
            base_url=self.base_url,
            token=self.api_key
        )
        self._project user role assignments = ProjectUserRoleAssignmentsClient(
            base_url=self.base_url,
            token=self.api_key
        )
        ...
        self._vector stores = VectorStoresClient(
            base_url=self.base_url,
            token=self.api_key
        )
    ...
    async def modify_assistant(self, assistant_id: str, body: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def create_thread_and_run(self, body: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def modify_thread(self, thread_id: str, body: Dict[str, Any]) -> Dict[str, Any]:
        """Modifies a thread."""
    ...
    async def list_messages(self, thread_id: str, limit: int = None, order: Literal[&quot;asc&quot;, &quot;desc&quot;] = None, after: str = None, before: str = None, run_id: str = None) -> Dict[str, Any]:
    ...
    async def create_message(self, thread_id: str, body: Dict[str, Any]) -> Dict[str, Any]:
        """Create a message."""
    ...
    async def modify_message(self, thread_id: str, message_id: str, body: Dict[str, Any]) -> Dict[str, Any]:
        """Modifies a message."""
    ...
    async def create_run(self, thread_id: str, include: List[Literal[&quot;step_details.tool_calls[*].file_search.results[*].content&quot;]] = None, body: Dict[str, Any]) -> Dict[str, Any]:
        """Create a run."""
    ...
    async def modify_run(self, thread_id: str, run_id: str, body: Dict[str, Any]) -> Dict[str, Any]:
        """Modifies a run."""
    ...
    async def list_run_steps(self, thread_id: str, run_id: str, limit: int = None, order: Literal[&quot;asc&quot;, &quot;desc&quot;] = None, after: str = None, before: str = None, include: List[Literal[&quot;step_details.tool_calls[*].file_search.results[*].content&quot;]] = None) -> Dict[str, Any]:
    ...
    async def get_run_step(self, thread_id: str, run_id: str, step_id: str, include: List[Literal[&quot;step_details.tool_calls[*].file_search.results[*].content&quot;]] = None) -> Dict[str, Any]:
        """Retrieves a run step."""
        return await self._assistants.get_run_step(thread_id=thread_id, run_id=run_id, step_id=step_id, include=include)

    async def submit_tool_ouputs_to_run(self, thread_id: str, run_id: str, body: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def create_transcription(self) -> Dict[str, Any]:
        """Transcribes audio into the input language."""
        return await self._audio.create_transcription()

    async def create_translation(self) -> Dict[str, Any]:
    ...
    async def create_voice_consent(self) -> Dict[str, Any]:
        """Upload a voice consent recording."""
        return await self._audio.create_voice_consent()

    async def get_voice_consent(self, consent_id: str) -> Dict[str, Any]:
        """Retrieves a voice consent recording."""
        return await self._audio.get_voice_consent(consent_id=consent_id)

    async def update_voice_consent(self, consent_id: str, body: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def list_chat_completions(self, model: str = None, metadata: Dict[str, str] = None, after: str = None, limit: int = None, order: Literal[&quot;asc&quot;, &quot;desc&quot;] = None) -> Dict[str, Any]:
...
created with the `store` parameter set to `true` can be deleted."""
    ...
    async def get_chat_completion_messages(self, completion_id: str, after: str = None, limit: int = None, order: Literal[&quot;asc&quot;, &quot;desc&quot;] = None) -> Dict[str, Any]:
...
returned."""
    ...
    async def create_container(self, body: Dict[str, Any]) -> Dict[str, Any]:
        """Create Container"""
        return await self._default.create_container(body=body)

    async def retrieve_container(self, container_id: str) -> Dict[str, Any]:
        """Retrieve Container"""
    ...
    async def create_container_file(self, container_id: str) -> Dict[str, Any]:
        """Create a Container File

You can send either a multipart/form-data request with the raw file content, or a JSON request with a file ID."""
        return await self._default.create_container_file(container_id=container_id)

    async def retrieve_container_file(self, container_id: str, file_id: str) -> Dict[str, Any]:
    ...
    async def getinputtokencounts(self, body: Dict[str, Any]) -> Dict[str, Any]:
        """Get input token counts"""
        return await self._default.getinputtokencounts(body=body)

    async def compactconversation(self, body: Dict[str, Any]) -> Dict[str, Any]:
        """Compact conversation"""
        return await self._default.compactconversation(body=body)

    async def cancel_chat_session_method(self, session_id: str) -> Dict[str, Any]:
        """Cancel a ChatKit session"""
        return await self._default.cancel_chat_session_method(session_id=session_id)

    async def create_chat_session_method(self, body: CreateChatSessionRequest) -> Dict[str, Any]:
        """Create a ChatKit session"""
        return await self._default.create_chat_session_method(body=body)

    async def list_thread_items_method(self, thread_id: str, limit: int = None, order: Literal[&quot;asc&quot;, &quot;desc&quot;] = None, after: str = None, before: str = None) -> Dict[str, Any]:
    ...
    async def get_thread_method(self, thread_id: str) -> Dict[str, Any]:
        """Retrieve a ChatKit thread"""
        return await self._default.get_thread_method(thread_id=thread_id)

    async def delete_thread_method(self, thread_id: str) -> Dict[str, Any]:
        """Delete a ChatKit thread"""
        return await self._default.delete_thread_method(thread_id=thread_id)

    async def list_threads_method(self, limit: int = None, order: Literal[&quot;asc&quot;, &quot;desc&quot;] = None, after: str = None, before: str = None, user: str = None) -> Dict[str, Any]:
    ...
    async def create_conversation_items(self, conversation_id: str, include: List[Literal[&quot;file_search_call.results&quot;, &quot;web_search_call.results&quot;, &quot;web_search_call.action.sources&quot;, &quot;message.input_image.image_url&quot;, &quot;computer_call_output.output.image_url&quot;, &quot;code_interpreter_call.outputs&quot;, &quot;reasoning.encrypted_content&quot;, &quot;message.output_text.logprobs&quot;]] = None, body: Any) -> Dict[str, Any]:
    ...
    async def list_evals(self, after: str = None, limit: int = None, order: Literal[&quot;asc&quot;, &quot;desc&quot;] = None, order_by: Literal[&quot;created_at&quot;, &quot;updated_at&quot;] = None) -> Dict[str, Any]:
        """List evaluations for a project."""
        return await self._evals.list_evals(after=after, limit=limit, order=order, order_by=order_by)

    async def create_eval(self, body: CreateEvalRequest) -> Dict[str, Any]:
...
For more information, see the [Evals guide](https://platform.openai.com/docs/guides/evals)."""
    ...
    async def get_eval(self, eval_id: str) -> Dict[str, Any]:
        """Get an evaluation by ID."""
        return await self._evals.get_eval(eval_id=eval_id)

    async def update_eval(self, eval_id: str, body: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def get_eval_runs(self, eval_id: str, after: str = None, limit: int = None, order: Literal[&quot;asc&quot;, &quot;desc&quot;] = None, status: Literal[&quot;queued&quot;, &quot;in_progress&quot;, &quot;completed&quot;, &quot;canceled&quot;, &quot;failed&quot;] = None) -> Dict[str, Any]:
        """Get a list of runs for an evaluation."""
        return await self._evals.get_eval_runs(eval_id=eval_id, after=after, limit=limit, order=order, status=status)

    async def create_eval_run(self, eval_id: str, body: CreateEvalRunRequest) -> Dict[str, Any]:
        """Kicks off a new run for a given evaluation, specifying the data source, and what model configuration to use to test. The datasource will be validated against the schema specified in the config of the evaluation."""
        return await self._evals.create_eval_run(eval_id=eval_id, body=body)

    async def get_eval_run(self, eval_id: str, run_id: str) -> Dict[str, Any]:
        """Get an evaluation run by ID."""
        return await self._evals.get_eval_run(eval_id=eval_id, run_id=run_id)

    async def cancel_eval_run(self, eval_id: str, run_id: str) -> Dict[str, Any]:
    ...
    async def get_eval_run_output_items(self, eval_id: str, run_id: str, after: str = None, limit: int = None, status: Literal[&quot;fail&quot;, &quot;pass&quot;] = None, order: Literal[&quot;asc&quot;, &quot;desc&quot;] = None) -> Dict[str, Any]:
    ...
    async def get_eval_run_output_item(self, eval_id: str, run_id: str, output_item_id: str) -> Dict[str, Any]:
...
storage limits."""
    ...
    async def run_grader(self, body: RunGraderRequest) -> Dict[str, Any]:
        """Run a grader."""
        return await self._fine-tuning.run_grader(body=body)

    async def validate_grader(self, body: ValidateGraderRequest) -> Dict[str, Any]:
        """Validate a grader."""
        return await self._fine-tuning.validate_grader(body=body)
...
Organization owners can use this endpoint to view all permissions for a fine-tuned model checkpoint."""
        return await self._fine-tuning.list_fine_tuning_checkpoint_permissions(fine_tuned_model_checkpoint=fine_tuned_model_checkpoint, project_id=project_id, after=after, limit=limit, order=order)
...
This enables organization owners to share fine-tuned models with other projects in their organization."""
        return await self._fine-tuning.create_fine_tuning_checkpoint_permission(fine_tuned_model_checkpoint=fine_tuned_model_checkpoint, body=body)
...
Organization owners can use this endpoint to delete a permission for a fine-tuned model checkpoint."""
        return await self._fine-tuning.delete_fine_tuning_checkpoint_permission(fine_tuned_model_checkpoint=fine_tuned_model_checkpoint, permission_id=permission_id)
    ...
    async def list_paginated_fine_tuning_jobs(self, after: str = None, limit: int = None, metadata: Optional[Dict[str, str]] = None) -> Dict[str, Any]:
        ...
        return await self._fine-tuning.list_paginated_fine_tuning_jobs(after=after, limit=limit, metadata=metadata)

    async def create_fine_tuning_job(self, body: Dict[str, Any]) -> Dict[str, Any]:
        """Creates a fine-tuning job which begins the process of creating a new model from a given dataset.

Response includes details of the enqueued job including job status and the name of the fine-tuned models once complete.

[Learn more about fine-tuning](https://platform.openai.com/docs/guides/model-optimization)"""
        return await self._fine-tuning.create_fine_tuning_job(body=body)

    async def retrieve_fine_tuning_job(self, fine_tuning_job_id: str) -> Dict[str, Any]:
        """Get info about a fine-tuning job.

[Learn more about fine-tuning](https://platform.openai.com/docs/guides/model-optimization)"""
        return await self._fine-tuning.retrieve_fine_tuning_job(fine_tuning_job_id=fine_tuning_job_id)

    async def cancel_fine_tuning_job(self, fine_tuning_job_id: str) -> Dict[str, Any]:
        """Immediately cancel a fine-tune job."""
        return await self._fine-tuning.cancel_fine_tuning_job(fine_tuning_job_id=fine_tuning_job_id)

    async def list_fine_tuning_job_checkpoints(self, fine_tuning_job_id: str, after: str = None, limit: int = None) -> Dict[str, Any]:
        """List checkpoints for a fine-tuning job."""
        return await self._fine-tuning.list_fine_tuning_job_checkpoints(fine_tuning_job_id=fine_tuning_job_id, after=after, limit=limit)

    async def list_fine_tuning_events(self, fine_tuning_job_id: str, after: str = None, limit: int = None) -> Dict[str, Any]:
        """Get status updates for a fine-tuning job."""
        return await self._fine-tuning.list_fine_tuning_events(fine_tuning_job_id=fine_tuning_job_id, after=after, limit=limit)

    async def pause_fine_tuning_job(self, fine_tuning_job_id: str) -> Dict[str, Any]:
        """Pause a fine-tune job."""
        return await self._fine-tuning.pause_fine_tuning_job(fine_tuning_job_id=fine_tuning_job_id)

    async def resume_fine_tuning_job(self, fine_tuning_job_id: str) -> Dict[str, Any]:
        """Resume a fine-tune job."""
        return await self._fine-tuning.resume_fine_tuning_job(fine_tuning_job_id=fine_tuning_job_id)
    # ─────────────────────────────────────────────────────────────────────────────
    # Images operations
    # ─────────────────────────────────────────────────────────────────────────────

    async def create_image_edit(self) -> Dict[str, Any]:
        """Creates an edited or extended image given one or more source images and a prompt. This endpoint only supports `gpt-image-1` and `dall-e-2`."""
        return await self._images.create_image_edit()

    async def create_image(self, body: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def create_image_variation(self) -> Dict[str, Any]:
    ...
    async def retrieve_model(self, model: str) -> Dict[str, Any]:
...
more in the [moderation guide](https://platform.openai.com/docs/guides/moderation)."""
    ...
    async def list_audit_logs(self, effective_at: Dict[str, Any] = None, project_ids: List[str] = None, event_types: List[Literal[&quot;api_key.created&quot;, &quot;api_key.updated&quot;, &quot;api_key.deleted&quot;, &quot;certificate.created&quot;, &quot;certificate.updated&quot;, &quot;certificate.deleted&quot;, &quot;certificates.activated&quot;, &quot;certificates.deactivated&quot;, &quot;checkpoint.permission.created&quot;, &quot;checkpoint.permission.deleted&quot;, &quot;external_key.registered&quot;, &quot;external_key.removed&quot;, &quot;group.created&quot;, &quot;group.updated&quot;, &quot;group.deleted&quot;, &quot;invite.sent&quot;, &quot;invite.accepted&quot;, &quot;invite.deleted&quot;, &quot;ip_allowlist.created&quot;, &quot;ip_allowlist.updated&quot;, &quot;ip_allowlist.deleted&quot;, &quot;ip_allowlist.config.activated&quot;, &quot;ip_allowlist.config.deactivated&quot;, &quot;login.succeeded&quot;, &quot;login.failed&quot;, &quot;logout.succeeded&quot;, &quot;logout.failed&quot;, &quot;organization.updated&quot;, &quot;project.created&quot;, &quot;project.updated&quot;, &quot;project.archived&quot;, &quot;project.deleted&quot;, &quot;rate_limit.updated&quot;, &quot;rate_limit.deleted&quot;, &quot;resource.deleted&quot;, &quot;tunnel.created&quot;, &quot;tunnel.updated&quot;, &quot;tunnel.deleted&quot;, &quot;role.created&quot;, &quot;role.updated&quot;, &quot;role.deleted&quot;, &quot;role.assignment.created&quot;, &quot;role.assignment.deleted&quot;, &quot;scim.enabled&quot;, &quot;scim.disabled&quot;, &quot;service_account.created&quot;, &quot;service_account.updated&quot;, &quot;service_account.deleted&quot;, &quot;user.added&quot;, &quot;user.updated&quot;, &quot;user.deleted&quot;]] = None, actor_ids: List[str] = None, actor_emails: List[str] = None, resource_ids: List[str] = None, limit: int = None, after: str = None, before: str = None) -> Dict[str, Any]:
        ...
        return await self._audit logs.list_audit_logs(effective_at=effective_at, project_ids=project_ids, event_types=event_types, actor_ids=actor_ids, actor_emails=actor_emails, resource_ids=resource_ids, limit=limit, after=after, before=before)
    # ─────────────────────────────────────────────────────────────────────────────
...
idempotently deactivate up to 10 certificates at a time."""
    ...
    async def list_group_role_assignments(self, group_id: str, limit: int = None, after: str = None, order: Literal[&quot;asc&quot;, &quot;desc&quot;] = None) -> Dict[str, Any]:
        ...
        return await self._group organization role assignments.list_group_role_assignments(group_id=group_id, limit=limit, after=after, order=order)

    async def assign_group_role(self, group_id: str, body: Dict[str, Any]) -> Dict[str, Any]:
        """Assigns an organization role to a group within the organization."""
        return await self._group organization role assignments.assign_group_role(group_id=group_id, body=body)

    async def unassign_group_role(self, group_id: str, role_id: str) -> Dict[str, Any]:
        """Unassigns an organization role from a group within the organization."""
        return await self._group organization role assignments.unassign_group_role(group_id=group_id, role_id=role_id)
    # ─────────────────────────────────────────────────────────────────────────────
    ...
    async def list_group_users(self, group_id: str, limit: int = None, after: str = None, order: Literal[&quot;asc&quot;, &quot;desc&quot;] = None) -> Dict[str, Any]:
        ...
        return await self._group users.list_group_users(group_id=group_id, limit=limit, after=after, order=order)

    async def add_group_user(self, group_id: str, body: Dict[str, Any]) -> Dict[str, Any]:
        """Adds a user to a group."""
        return await self._group users.add_group_user(group_id=group_id, body=body)

    async def remove_group_user(self, group_id: str, user_id: str) -> Dict[str, Any]:
        """Removes a user from a group."""
        return await self._group users.remove_group_user(group_id=group_id, user_id=user_id)
    # ─────────────────────────────────────────────────────────────────────────────
    # Invites operations
    # ─────────────────────────────────────────────────────────────────────────────
    ...
    async def list_project_groups(self, project_id: str, limit: int = None, after: str = None, order: Literal[&quot;asc&quot;, &quot;desc&quot;] = None) -> Dict[str, Any]:
        ...
        return await self._project groups.list_project_groups(project_id=project_id, limit=limit, after=after, order=order)

    async def add_project_group(self, project_id: str, body: Dict[str, Any]) -> Dict[str, Any]:
        """Grants a group access to a project."""
        return await self._project groups.add_project_group(project_id=project_id, body=body)

    async def remove_project_group(self, project_id: str, group_id: str) -> Dict[str, Any]:
        """Revokes a group&#39;s access to a project."""
        return await self._project groups.remove_project_group(project_id=project_id, group_id=group_id)
    # ─────────────────────────────────────────────────────────────────────────────
    # Roles operations
    # ─────────────────────────────────────────────────────────────────────────────
    ...
    async def list_user_role_assignments(self, user_id: str, limit: int = None, after: str = None, order: Literal[&quot;asc&quot;, &quot;desc&quot;] = None) -> Dict[str, Any]:
        ...
        return await self._user organization role assignments.list_user_role_assignments(user_id=user_id, limit=limit, after=after, order=order)

    async def assign_user_role(self, user_id: str, body: Dict[str, Any]) -> Dict[str, Any]:
        """Assigns an organization role to a user within the organization."""
        return await self._user organization role assignments.assign_user_role(user_id=user_id, body=body)

    async def unassign_user_role(self, user_id: str, role_id: str) -> Dict[str, Any]:
        """Unassigns an organization role from a user within the organization."""
        return await self._user organization role assignments.unassign_user_role(user_id=user_id, role_id=role_id)
    # ─────────────────────────────────────────────────────────────────────────────
    ...
    async def list_project_group_role_assignments(self, project_id: str, group_id: str, limit: int = None, after: str = None, order: Literal[&quot;asc&quot;, &quot;desc&quot;] = None) -> Dict[str, Any]:
        ...
        return await self._project group role assignments.list_project_group_role_assignments(project_id=project_id, group_id=group_id, limit=limit, after=after, order=order)

    async def assign_project_group_role(self, project_id: str, group_id: str, body: Dict[str, Any]) -> Dict[str, Any]:
        """Assigns a project role to a group within a project."""
        return await self._project group role assignments.assign_project_group_role(project_id=project_id, group_id=group_id, body=body)

    async def unassign_project_group_role(self, project_id: str, group_id: str, role_id: str) -> Dict[str, Any]:
        """Unassigns a project role from a group within a project."""
        return await self._project group role assignments.unassign_project_group_role(project_id=project_id, group_id=group_id, role_id=role_id)
    # ─────────────────────────────────────────────────────────────────────────────
    ...
    async def list_project_user_role_assignments(self, project_id: str, user_id: str, limit: int = None, after: str = None, order: Literal[&quot;asc&quot;, &quot;desc&quot;] = None) -> Dict[str, Any]:
        ...
        return await self._project user role assignments.list_project_user_role_assignments(project_id=project_id, user_id=user_id, limit=limit, after=after, order=order)

    async def assign_project_user_role(self, project_id: str, user_id: str, body: Dict[str, Any]) -> Dict[str, Any]:
        """Assigns a project role to a user within a project."""
        return await self._project user role assignments.assign_project_user_role(project_id=project_id, user_id=user_id, body=body)

    async def unassign_project_user_role(self, project_id: str, user_id: str, role_id: str) -> Dict[str, Any]:
        """Unassigns a project role from a user within a project."""
        return await self._project user role assignments.unassign_project_user_role(project_id=project_id, user_id=user_id, role_id=role_id)
    # ─────────────────────────────────────────────────────────────────────────────
    # Realtime operations
    # ─────────────────────────────────────────────────────────────────────────────
...
WebRTC."""
    ...
    async def create_realtime_client_secret(self, body: RealtimeClientSecretCreationRequest) -> Dict[str, Any]:
        """Create a Realtime client secret with an associated session configuration."""
        return await self._realtime.create_realtime_client_secret(body=body)

    async def create_realtime_session(self, body: Dict[str, Any]) -> Dict[str, Any]:
...
[Learn more](https://platform.openai.com/docs/guides/background)."""
    ...
    async def create_upload(self, body: Dict[str, Any]) -> Dict[str, Any]:
...
File](https://platform.openai.com/docs/api-reference/files/create)."""
    ...
    async def complete_upload(self, upload_id: str, body: Dict[str, Any]) -> Dict[str, Any]:
...
The number of bytes uploaded upon completion must match the number of bytes initially specified when creating the Upload object. No Parts may be added after an Upload is completed."""
    ...
    async def add_upload_part(self, upload_id: str) -> Dict[str, Any]:
...
It is possible to add multiple Parts in parallel. You can decide the intended order of the Parts when you [complete the Upload](https://platform.openai.com/docs/api-reference/uploads/complete)."""
    ...
    async def list_vector_stores(self, limit: int = None, order: Literal[&quot;asc&quot;, &quot;desc&quot;] = None, after: str = None, before: str = None) -> Dict[str, Any]:
        """Returns a list of vector stores."""
        return await self._vector stores.list_vector_stores(limit=limit, order=order, after=after, before=before)

    async def create_vector_store(self, body: Dict[str, Any]) -> Dict[str, Any]:
        """Create a vector store."""
        return await self._vector stores.create_vector_store(body=body)

    async def get_vector_store(self, vector_store_id: str) -> Dict[str, Any]:
        """Retrieves a vector store."""
        return await self._vector stores.get_vector_store(vector_store_id=vector_store_id)

    async def modify_vector_store(self, vector_store_id: str, body: Dict[str, Any]) -> Dict[str, Any]:
        """Modifies a vector store."""
        return await self._vector stores.modify_vector_store(vector_store_id=vector_store_id, body=body)

    async def delete_vector_store(self, vector_store_id: str) -> Dict[str, Any]:
        """Delete a vector store."""
        return await self._vector stores.delete_vector_store(vector_store_id=vector_store_id)

    async def create_vector_store_file_batch(self, vector_store_id: str, body: Dict[str, Any]) -> Dict[str, Any]:
        """Create a vector store file batch."""
        return await self._vector stores.create_vector_store_file_batch(vector_store_id=vector_store_id, body=body)

    async def get_vector_store_file_batch(self, vector_store_id: str, batch_id: str) -> Dict[str, Any]:
        """Retrieves a vector store file batch."""
        return await self._vector stores.get_vector_store_file_batch(vector_store_id=vector_store_id, batch_id=batch_id)

    async def cancel_vector_store_file_batch(self, vector_store_id: str, batch_id: str) -> Dict[str, Any]:
        """Cancel a vector store file batch. This attempts to cancel the processing of files in this batch as soon as possible."""
        return await self._vector stores.cancel_vector_store_file_batch(vector_store_id=vector_store_id, batch_id=batch_id)

    async def list_files_in_vector_store_batch(self, vector_store_id: str, batch_id: str, limit: int = None, order: Literal[&quot;asc&quot;, &quot;desc&quot;] = None, after: str = None, before: str = None, filter: Literal[&quot;in_progress&quot;, &quot;completed&quot;, &quot;failed&quot;, &quot;cancelled&quot;] = None) -> Dict[str, Any]:
        """Returns a list of vector store files in a batch."""
        return await self._vector stores.list_files_in_vector_store_batch(vector_store_id=vector_store_id, batch_id=batch_id, limit=limit, order=order, after=after, before=before, filter=filter)

    async def list_vector_store_files(self, vector_store_id: str, limit: int = None, order: Literal[&quot;asc&quot;, &quot;desc&quot;] = None, after: str = None, before: str = None, filter: Literal[&quot;in_progress&quot;, &quot;completed&quot;, &quot;failed&quot;, &quot;cancelled&quot;] = None) -> Dict[str, Any]:
        """Returns a list of vector store files."""
        return await self._vector stores.list_vector_store_files(vector_store_id=vector_store_id, limit=limit, order=order, after=after, before=before, filter=filter)

    async def create_vector_store_file(self, vector_store_id: str, body: Dict[str, Any]) -> Dict[str, Any]:
        """Create a vector store file by attaching a [File](https://platform.openai.com/docs/api-reference/files) to a [vector store](https://platform.openai.com/docs/api-reference/vector-stores/object)."""
        return await self._vector stores.create_vector_store_file(vector_store_id=vector_store_id, body=body)

    async def get_vector_store_file(self, vector_store_id: str, file_id: str) -> Dict[str, Any]:
        """Retrieves a vector store file."""
        return await self._vector stores.get_vector_store_file(vector_store_id=vector_store_id, file_id=file_id)

    async def update_vector_store_file_attributes(self, vector_store_id: str, file_id: str, body: Dict[str, Any]) -> Dict[str, Any]:
        """Update attributes on a vector store file."""
        return await self._vector stores.update_vector_store_file_attributes(vector_store_id=vector_store_id, file_id=file_id, body=body)
    ...
    async def delete_vector_store_file(self, vector_store_id: str, file_id: str) -> Dict[str, Any]:
        ...
        return await self._vector stores.delete_vector_store_file(vector_store_id=vector_store_id, file_id=file_id)

    async def retrieve_vector_store_file_content(self, vector_store_id: str, file_id: str) -> Dict[str, Any]:
        """Retrieve the parsed contents of a vector store file."""
        return await self._vector stores.retrieve_vector_store_file_content(vector_store_id=vector_store_id, file_id=file_id)

    async def search_vector_store(self, vector_store_id: str, body: Dict[str, Any]) -> Dict[str, Any]:
        """Search a vector store for relevant chunks based on a query and file attributes filter."""
        return await self._vector stores.search_vector_store(vector_store_id=vector_store_id, body=body)
    # ─────────────────────────────────────────────────────────────────────────────
    # Videos operations
    # ─────────────────────────────────────────────────────────────────────────────
    ...
    async def create_video(self, body: CreateVideoRequest) -> Dict[str, Any]:
        """Create a video"""
    ...
    async def retrieve_video_content(self, video_id: str, variant: Literal[&quot;video&quot;, &quot;thumbnail&quot;, &quot;spritesheet&quot;] = None) -> Dict[str, Any]:
        """Download video content"""
        return await self._videos.retrieve_video_content(video_id=video_id, variant=variant)

    async def create_video_remix(self, video_id: str, body: CreateVideoRemixRequest) -> Dict[str, Any]:
