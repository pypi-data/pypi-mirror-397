...
class DevicePostgres(Command, Device):
    ...
    def exec_no_dir(self, command: str, state: ReplState):
        ...
        return Pods.exec(pod, container, state.namespace, command, show_out=True)
    ...
    def exec_with_dir(self, command: str, session_just_created: bool, state: ReplState):
        ...
        return [Pods.exec(pod, container, state.namespace, command, show_out=not session_just_created, shell='bash')]
