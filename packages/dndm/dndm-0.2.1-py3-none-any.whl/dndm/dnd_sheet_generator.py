...
def fill_sheet(character_data,savepath):
    ...
    # Class (Below Name)
    draw.text((620, 115), character_data["class"], font=sub_font, fill=text_color)
    draw.text((620, 175), character_data["race"], font=sub_font, fill=text_color)
    draw.text((865, 115), character_data["background"], font=sub_font, fill=text_color)
    draw.text((865, 175), character_data["alignment"], font=sub_font, fill=text_color)
