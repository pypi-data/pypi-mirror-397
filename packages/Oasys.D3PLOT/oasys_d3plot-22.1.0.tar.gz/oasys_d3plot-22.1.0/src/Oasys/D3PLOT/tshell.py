...
# Static methods
    ...
    def GetAll(model, property=Oasys.gRPC.defaultArg):
        """
        Returns a list of Tshell objects or properties for all of the tshells in the model.
        If the optional property argument is not given then a list of Tshell objects is returned.
        If the property argument is given, that property value for each tshell is returned in the list
        ...
        property : string
            Optional. Name for property to get for all tshells in the model

        Returns
        -------
        list
            List of :py:class:`Tshell <Tshell>` objects or properties
        """
    ...
    def GetFlagged(model, flag, property=Oasys.gRPC.defaultArg):
        ...
        property : string
            Optional. Name for property to get for all flagged tshells in the model
    ...
    def TotalDeleted(model):
        """
        Returns the total number of thick shells that have been deleted in
