...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="jarvis-runtime")
    ...
    common.add_argument("--tool-registry-url", default=os.getenv("JARVIS_TOOL_REGISTRY_URL", "http://127.0.0.1:8000"))
