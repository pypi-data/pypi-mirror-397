...
**Geographic Personalization**
   ...
   .. code-block:: python
      ...
      high_cost_areas = ["CA", "NY"]  # High-cost states

      # Note: Location-based personalization can be handled via customer metadata
      if customer_metadata and customer_metadata.state_id in high_cost_areas:
