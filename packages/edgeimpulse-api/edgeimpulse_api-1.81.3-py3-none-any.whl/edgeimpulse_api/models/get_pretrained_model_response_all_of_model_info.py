...
class GetPretrainedModelResponseAllOfModelInfo(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> GetPretrainedModelResponseAllOfModelInfo:
        ...
        _obj = GetPretrainedModelResponseAllOfModelInfo.construct(**{
            ...
            "model": OneOfDeployPretrainedModelModelClassificationDeployPretrainedModelModelRegressionDeployPretrainedModelModelObjectDetectionDeployPretrainedModelModelFreeform.from_dict(obj.get("model")) if obj.get("model") is not None else None
        })
        return _obj
