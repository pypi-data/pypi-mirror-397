...
- **[PyEvaluatorManagerDict (Deprecated!!)](./adtools/evaluator/py_evaluator.py#L273-L431)**
    - **Deprecated!!** Use `PyEvaluatorSharedMemory` or `PyEvaluatorRay` instead.
...
- **[PyEvaluatorSharedMemory](./adtools/evaluator/py_evaluator.py#L426-L617) (Recommend)**
...
### 3.2 Parser for Prompt Construction
...
### 3.3 Secure Code Evaluation using Evaluators

When evaluating code generated by LLMs, safety and reliability are critical:

```python
import time
from adtools import PyEvaluatorSharedMemory
