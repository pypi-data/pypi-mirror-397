...
class ReportConfig(BaseModel):
    ...
    Attributes:
        report_type: Type of report to generate (e.g., "basic")
...
class Config(BaseModel):
    ...
    def create_report(self, report_type: str = "basic", output_format: str = "pdf"):
        ...
        Args:
            ...
            output_format: Output format for the report - "pdf" or "docx" (default: "pdf")
        """
        self.report = ReportConfig(report_type=report_type, output_format=output_format)
