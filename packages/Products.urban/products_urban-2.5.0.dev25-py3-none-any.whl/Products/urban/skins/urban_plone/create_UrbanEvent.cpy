## Controller Python Script "create_UrbanEvent"
...
##parameters=id=None,urban_event_infos=None,script_id=None,
##title=
...
event_config_uid, type_name = urban_event_infos.split('|')
...
if type_name in context.portal_factory.getFactoryTypes():
    ...
    if state.getStatus() != 'success_no_edit':
        ...
        new_url = new_url + '&urbaneventtypes=' + event_config_uid
