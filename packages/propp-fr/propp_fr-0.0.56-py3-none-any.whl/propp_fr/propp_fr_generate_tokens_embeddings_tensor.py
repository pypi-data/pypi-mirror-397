from transformers import AutoTokenizer, AutoModel, MT5EncoderModel, AutoTokenizer
import torch
import numpy as np
...
def load_tokenizer_and_embedding_model(model_name):
    ...
    Supports encoder-only transformers and mT5 (encoder).
    """
    ...
    if "mt5" in model_name.lower():
        # mT5 is encoder-decoder → we ONLY want the encoder
