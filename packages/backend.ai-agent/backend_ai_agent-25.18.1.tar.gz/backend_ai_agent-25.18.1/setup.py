...
""",
        """backend.ai-kernel-binary==25.18.1
""",
        """backend.ai-kernel-helper==25.18.1
""",
        """backend.ai-kernel==25.18.1
""",
...
""",
    ...
    'packages': (
        ...
        'ai.backend.agent.dependencies',
        'ai.backend.agent.dependencies.bootstrap',
        'ai.backend.agent.dependencies.infrastructure',
        'ai.backend.agent.docker',
        'ai.backend.agent.docker.metadata',
        'ai.backend.agent.dummy',
        'ai.backend.agent.errors',
        'ai.backend.agent.health',
        'ai.backend.agent.kernel_registry',
        'ai.backend.agent.kernel_registry.container',
        'ai.backend.agent.kernel_registry.loader',
        'ai.backend.agent.kernel_registry.pickle',
        'ai.backend.agent.kernel_registry.recovery',
        'ai.backend.agent.kernel_registry.writer',
        'ai.backend.agent.kubernetes',
        'ai.backend.agent.metrics',
        'ai.backend.agent.observer',
        'ai.backend.agent.plugin',
        'ai.backend.agent.scratch',
