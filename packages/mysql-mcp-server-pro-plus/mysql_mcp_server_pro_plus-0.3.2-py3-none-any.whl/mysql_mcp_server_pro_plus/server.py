...
@mcp.tool()
async def execute_sql(query: str, reasoning: Optional[str] = None) -> str:
    """Execute an SQL query on the MySQL server.

    Args:
        query: The SQL query to execute
        reasoning: Optional reasoning/description for the query (ignored, for compatibility)
    """
    global _db_manager, _security_validator
...
@mcp.tool()
async def list_tables(reasoning: Optional[str] = None) -> str:
    """List all tables in the database.
    
    Args:
        reasoning: Optional reasoning/description (ignored, for compatibility)
    """
    global _db_manager
