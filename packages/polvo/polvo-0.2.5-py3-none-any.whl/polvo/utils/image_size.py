# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/01g_utils.image_size.ipynb.

# %% auto 0
__all__ = ['FILE_UNKNOWN', 'types', 'BMP', 'GIF', 'ICO', 'JPEG', 'PNG', 'TIFF', 'image_fields', 'UnknownImageFormat', 'Image',
           'image_size', 'image_size_from_bytesio', 'get_image_metadata', 'get_image_metadata_from_bytesio']

# %% ../../nbs/01g_utils.image_size.ipynb 2
"""
...
# %% ../../nbs/01g_utils.image_size.ipynb 3
import collections, json, os, io, struct

# %% ../../nbs/01g_utils.image_size.ipynb 5
FILE_UNKNOWN = "Sorry, don't know how to get size for this file."

class UnknownImageFormat(Exception):
    pass

# %% ../../nbs/01g_utils.image_size.ipynb 6
...
# %% ../../nbs/01g_utils.image_size.ipynb 7
...
# %% ../../nbs/01g_utils.image_size.ipynb 8
...
def image_size_from_bytesio(input, size):
    """
    Return (width, height) for a given img file content - no external
    dependencies except the os and struct builtin modules
