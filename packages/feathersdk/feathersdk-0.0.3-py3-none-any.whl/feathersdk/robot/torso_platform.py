...
class EZMotionTorsoPlatform(TorsoPlatform):
    ...
    def __init__(self, motors_manager: MotorsManager, can_interface: Optional[str], config: dict):
        self.cfg = config
        self.motors_map = {}
    ...
    def _on_target_reached(self):
        ...
        overwrite_file(self.calibration_file_path, ["finished_moving", str(self.curr_height)])
        self.shutdown()
    ...
    def _on_recalibrated(self):
        ...
        self._set_reference_position(self.current_position, self.curr_height)
        self.healthy_state = True
        overwrite_file(self.calibration_file_path, ["recalibrated", str(self.curr_height)])
    ...
    def set_control_mode(self, control_mode: EZMotionControlMode):
        ...
        self._safe_command(EZMotionCommands.SET_CONTROL_MODE.value, control_mode.value)
