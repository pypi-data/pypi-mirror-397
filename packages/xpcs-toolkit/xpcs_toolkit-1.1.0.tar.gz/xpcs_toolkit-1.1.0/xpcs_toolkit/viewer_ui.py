...
class Ui_mainWindow:
    def setupUi(self, mainWindow):
        ...
        self.saxs2d_autolevel = QCheckBox(self.groupBox_3)
        self.saxs2d_autolevel.setObjectName("saxs2d_autolevel")
        self.saxs2d_autolevel.setChecked(True)

        self.gridLayout_40.addWidget(self.saxs2d_autolevel, 1, 9, 1, 1)
        ...
        self.gridLayout_40.addWidget(self.pushButton_plot_saxs2d, 1, 11, 1, 1)
        ...
        self.gridLayout_40.addWidget(self.saxs2d_rotate, 1, 10, 1, 1)

        self.spinBox_saxs2d_selection = QSpinBox(self.groupBox_3)
        self.spinBox_saxs2d_selection.setObjectName("spinBox_saxs2d_selection")
        self.spinBox_saxs2d_selection.setMaximum(99999)

        self.gridLayout_40.addWidget(self.spinBox_saxs2d_selection, 0, 11, 1, 1)

        self.horizontalSlider_saxs2d_selection = QSlider(self.groupBox_3)
        self.horizontalSlider_saxs2d_selection.setObjectName(
            "horizontalSlider_saxs2d_selection"
        )
        self.horizontalSlider_saxs2d_selection.setOrientation(Qt.Orientation.Horizontal)

        self.gridLayout_40.addWidget(
            self.horizontalSlider_saxs2d_selection, 0, 1, 1, 10
        )
        ...
        self.stab_legend_loc.addItem("")
        self.stab_legend_loc.addItem("")
        self.stab_legend_loc.setObjectName("stab_legend_loc")
        ...
        self.btn_export_diffusion.setObjectName("btn_export_diffusion")
        ...
        self.comboBox_twotime_selection.setObjectName("comboBox_twotime_selection")
        ...
        self.horizontalSlider_twotime_selection.setObjectName(
            "horizontalSlider_twotime_selection"
        )
        self.horizontalSlider_twotime_selection.setOrientation(
        ...
        self.checkBox_twotime_autolevel.setObjectName("checkBox_twotime_autolevel")
        ...
        QWidget.setTabOrder(self.saxs2d_display, self.g2_c2fit)
        ...
        self.horizontalSlider_saxs2d_selection.valueChanged.connect(
            self.spinBox_saxs2d_selection.setValue
        )
        self.spinBox_saxs2d_selection.valueChanged.connect(
            self.horizontalSlider_saxs2d_selection.setValue
        )
        self.horizontalSlider_twotime_selection.valueChanged.connect(
            self.comboBox_twotime_selection.setCurrentIndex
        )
        self.comboBox_twotime_selection.currentIndexChanged.connect(
            self.horizontalSlider_twotime_selection.setValue
        )
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.saxs2d_autolevel.setText(
            QCoreApplication.translate("mainWindow", "autolevel", None)
        )
        ...
        self.saxs1d_legend_loc.setItemText(
            0, QCoreApplication.translate("mainWindow", "upper right", None)
        )
        self.saxs1d_legend_loc.setItemText(
            1, QCoreApplication.translate("mainWindow", "upper center", None)
        )
        self.saxs1d_legend_loc.setItemText(
            2, QCoreApplication.translate("mainWindow", "upper left", None)
        )
        self.saxs1d_legend_loc.setItemText(
            3, QCoreApplication.translate("mainWindow", "center right", None)
        )
        self.saxs1d_legend_loc.setItemText(
            4, QCoreApplication.translate("mainWindow", "center", None)
        )
        self.saxs1d_legend_loc.setItemText(
            5, QCoreApplication.translate("mainWindow", "center left", None)
        )
        self.saxs1d_legend_loc.setItemText(
            6, QCoreApplication.translate("mainWindow", "lower right", None)
        )
        self.saxs1d_legend_loc.setItemText(
            7, QCoreApplication.translate("mainWindow", "lower center", None)
        )
        self.saxs1d_legend_loc.setItemText(
            8, QCoreApplication.translate("mainWindow", "lower left", None)
        )
        ...
        self.stab_legend_loc.setItemText(
            0, QCoreApplication.translate("mainWindow", "upper right", None)
        )
        self.stab_legend_loc.setItemText(
            1, QCoreApplication.translate("mainWindow", "upper center", None)
        ...
        self.label_4.setText(QCoreApplication.translate("mainWindow", "t  (s)", None))
        ...
        self.g2_tauto.setText(QCoreApplication.translate("mainWindow", "auto", None))
        self.g2_qauto.setText(QCoreApplication.translate("mainWindow", "auto", None))
        ...
        self.btn_export_diffusion.setText(
            QCoreApplication.translate("mainWindow", "export", None)
        )
        # if QT_CONFIG(tooltip)
        self.btn_export_diffusion.setToolTip(
            QCoreApplication.translate(
                "mainWindow", "Export power law fitting results to text files", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.tabWidget.setTabText(
        ...
        self.checkBox_twotime_autolevel.setText(
            QCoreApplication.translate("mainWindow", "autolevel", None)
        )
        self.tabWidget.setTabText(
