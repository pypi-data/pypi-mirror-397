...
- <code title="get /customers">client.customers.<a href="./src/autumn/resources/customers.py">list</a>(\*\*<a href="src/autumn/types/customer_list_params.py">params</a>) -> <a href="./src/autumn/types/customer_list_response.py">CustomerListResponse</a></code>
...
```python
from autumn.types import BalanceUpdateResponse
```
