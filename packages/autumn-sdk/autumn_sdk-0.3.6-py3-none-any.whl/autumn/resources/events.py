...
class EventsResource(SyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        time_range: event_list_params.TimeRange | Omit = omit,
        ...
        Args:
          ...
          starting_after: Cursor for pagination. Use next_cursor from previous response.

          time_range: Filter events by time range
    ...
    def aggregate(
        ...
        *,
        customer_id: str,
        feature_id: Union[str, SequenceNotStr[str]],
        bin_size: Literal["day", "hour"] | Omit = omit,
