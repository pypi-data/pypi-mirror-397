...
class CalibrationStageParams(StageParams):
    """ StageParams implementation for the calibration phase.
    ...
    * ``xm``.
    ...
    def background(
        ...
        Returns:
            tuple[list[str], QtfSeries, BackgroundEngine]:
            * Names of the series used.
            * Series.
            * Background engine.
        """
        # Get config values
        engine = self._get_background_engine_from_config(
        ...
        self._validate_series_for_background(engine, series, allow_none_values)
    ...
    def bt(
        ...
        if background is None:
            ...
            if res is None:
                ...
                background, = res
        self._validate_series_for_background(background, donors,
                                             allow_none_values)
    ...
    def de(
        ...
        if background is None:
            ...
            if res is None:
                ...
                background, = res
        self._validate_series_for_background(background, acceptors,
                                             allow_none_values)
    ...
    def xm(
        ...
        Returns:
            tuple[str, QtfSeries, float | None, float | None, \
            BackgroundEngine | None, tuple[float, float], bool, int]:
            * Name of the series.
            * Series to use.
            * Alpha BT value.
            * Delta DE value.
