...
class CliView:
    """ Handles the display of the **QuanTI-FRET** application in CLI mode.
    ...
    def __init__(self, iom: IOManager):
        ...
        Creates the differents stages views.

        Args:
            iom (IOManager): IOManager used in the view to get the fret and
                calibration :any:`IOPhaseManager` who will get the informations
                to display.
        """
