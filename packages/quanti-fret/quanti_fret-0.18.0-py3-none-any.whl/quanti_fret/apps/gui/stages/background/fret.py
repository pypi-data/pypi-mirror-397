...
class BackgroundFretWidget(QWidget):
    ...
    This consists in 3 boxes:

    * *Calibration value*: Show the value of the background of the calibration
      phase. It is disabled if floating background is activated.
    * *Floating Background*: Lets the user choose to use or not the floating
      background.
    * *Mode*: Let the user choose the mode for the floating background. It is
      disabled if floating background is not activated.
    """
    ...
    def _updateSettings(self) -> None:
        """ Enable or Disable the mode box and the calibration box.
        """
