...
class QtfMainWidget(QWidget):
    ...
    It contains a ``QTabWidget`` with one tab for the **Calibration** phase,
    and one tab for the **Fret** phase.

    It also provide, at the bottom of the application, a button to open the
    online doc, alongside the version of **QuanTI-FRET** currently used.
    """
