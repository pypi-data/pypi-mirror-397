...
class StageOutputWidget(QWidget):
    """ Widget handling the output folder settings for a given phase.

    It contains:

    * A :any:`PathWidget` allowing the selection of the output folder.
    * A ``QCheckBox`` to let the user decide of the settings
      ``clean_before_run``.
    """
    ...
    def __init__(
        ...
        Args:
            ...
            dialogFileFilter (str, optional): Filter to select specific file
                type. Default is ``''``.
        """
