...
class EvalRunDatasetV2(BaseModel):
    ...
    dataset_summary: Dict[str, Any] = Field(default_factory=dict, description="数据集摘要")
    metrics_summary: Dict[str, Any] = Field(default_factory=dict, description="指标摘要")
    ...
    viz_summary: Dict[str, Any] = Field(default_factory=dict, description="可视化摘要")
