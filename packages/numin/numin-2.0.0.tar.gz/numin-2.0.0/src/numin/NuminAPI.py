...
class NuminAPI():
    ...
    def run_backtest(self, user_strategy, date=None, val_data=None, val_df=None,result_type="results"):
        print("Numin v1 only runs on local data specify val_data a csv file")
        """
    ...
    def get_data_for_month(self,year,month,batch_size=4,window_size=100,target_type='rank'):
        ...
        Dimension of each day is 100,50. Returns tensor of shape [batch_size,100,50 for features.
        Targets are next day returns of shape [batch_size,50]
        """
