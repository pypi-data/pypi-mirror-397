    ...
    if country == 'QAT':
        ...
        if id_number and serial_number:
            ...
            if id_number == id_number_from_sr_no:
                ...
                try:
                    back_img_base64_content = base64.b64encode(back_img).decode("utf-8")

                    back_face_locations, back_face_encodings = load_and_process_image_deepface(back_img_base64_content)
