...
class ModelServiceApi:
    ...
    def model_service_get_model(
        self,
        name_5: Annotated[str, Field(strict=True, description="Required. The name of the Model to retrieve.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param name_5: Required. The name of the Model to retrieve. (required)
        :type name_5: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
