...
class OperationServiceApi:
    ...
    def operation_service_get_operation(
        self,
        name_6: Annotated[str, Field(strict=True, description="Required. The name of the Operation to retrieve.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param name_6: Required. The name of the Operation to retrieve. (required)
        :type name_6: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
