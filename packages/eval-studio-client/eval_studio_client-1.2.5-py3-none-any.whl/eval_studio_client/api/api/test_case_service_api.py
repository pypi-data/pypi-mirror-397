...
class TestCaseServiceApi:
    ...
    def test_case_service_get_test_case(
        self,
        name_8: Annotated[str, Field(strict=True, description="The name of the TestCase to retrieve. Format: tests/<UUID>/testCases/<UUID>")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param name_8: The name of the TestCase to retrieve. Format: tests/<UUID>/testCases/<UUID> (required)
        :type name_8: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
