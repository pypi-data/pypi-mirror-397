...
class TestClassServiceApi:
    ...
    def test_class_service_get_test_class(
        self,
        name_9: Annotated[str, Field(strict=True, description="The name of the TestClass to retrieve. Format: testClasses/<UUID>")],
        ...
        :param name_9: The name of the TestClass to retrieve. Format: testClasses/<UUID> (required)
        :type name_9: str
