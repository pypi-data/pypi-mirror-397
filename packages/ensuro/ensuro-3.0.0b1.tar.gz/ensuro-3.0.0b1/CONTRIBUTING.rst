...
Welcome to ``ensuro`` contributor's guide.
...
If you experience bugs or general issues with ``ensuro``, please have a look
...
You can help improve ``ensuro`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``ensuro`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``ensuro``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n ensuro python=3 six virtualenv pytest pytest-cov
    conda activate ensuro
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/ensuro.git
    cd ensuro
...
#. Install |pre-commit|_::
   ...
   ``ensuro`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/ensuro
.. _issue tracker: https://github.com/<USERNAME>/ensuro/issues
.. <-- end -->
