...
def update_mantarix_view_icon(exe_path, icon_path):
    print("Updating Mantarix View icon", exe_path, icon_path)
...
def update_mantarix_view_version_info(
    ...
    print("Updating Mantarix View version info", exe_path)
