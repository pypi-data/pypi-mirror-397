...
from mantarix.utils import safe_tar_extractall
...
def unpack_app_bundle(tar_path):
    ...
    return os.path.join(bin_dir, "Mantarix.app")


def update_mantarix_view_icon(app_path, icon_path):
    print("Updating Mantarix View icon", app_path, icon_path)
...
def update_mantarix_view_version_info(
    app_path,
    bundle_id,
    product_name,
    product_version,
    ...
    print("Updating Mantarix View plist", app_path)
