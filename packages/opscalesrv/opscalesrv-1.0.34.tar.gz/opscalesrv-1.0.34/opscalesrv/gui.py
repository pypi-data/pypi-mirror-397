...
import opscalesrv
from opscalesrv import load_opscalesrv_config
    ...
    def load_config():
        ...
        if os.path.exists(config_path):
            with open(config_path, 'r') as f:
                return json.load(f)
        return {"allowed_hosts": [], "serial": {}, "settings": {}}
...
class ANPRSettingsDialog(QDialog):
    def __init__(self, parent=None):
        ...
        self.tag_edit.textChanged.connect(lambda: self.update_val('tag', self.tag_edit.text()))
        ...
        form_layout.addRow(T("lbl_tag"), self.tag_edit)
    ...
    def block_signals_form(self, block):
        ...
        self.tag_edit.blockSignals(block)
    ...
    def on_camera_changed(self, text):
        ...
        self.tag_edit.setText(str(data.get('tag', '')))
