...
GEMMA_FACT_GENERATOR = Prompt(
    metadata=PromptMetadata(
        ...
        domain=Domain.PROMPT_EVALS,
        description="Generates atomic, verifiable agricultural facts for user query",
        tags=["generation", "fact-extraction", "knowledge-extraction", "agricultural-facts"]
    ),
    system_prompt="""You are an agricultural fact generator specialized in farming practices. Your task is to generate atomic, verifiable facts for user query and convert them into structured agricultural knowledge.
