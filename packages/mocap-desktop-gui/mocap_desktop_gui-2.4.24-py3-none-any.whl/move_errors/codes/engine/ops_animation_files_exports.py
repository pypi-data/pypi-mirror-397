...
class OpsAnimationFilesExportsOperationErrorCodes(BaseEngineOpsErrorCode, Enum):
    """Operation error codes."""
    ...
    def operation_name(cls) -> OperationNames:
        ...
        """
        return OperationNames.OPS_ANIMATION_FILES_EXPORTS
