...
class OpsDownloadDatasetOperationErrorCodes(BaseEngineOpsErrorCode, Enum):
    """Operation error codes."""
    ...
    MV_060_070_0999 = (
        ...
        "MV_060_070_0999",
        True,
        "There has been an issue with the cloud services",
    )
    ...
    def operation_name(cls) -> OperationNames:
        ...
        """
        return OperationNames.OPS_DOWNLOAD_DATASET
