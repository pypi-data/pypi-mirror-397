...
class SimpleSimulatedAnnealing[T](SimulatedAnnealing[T]):
    ...
    def __init__(
            ...
            temperature: Iterable[float] | float | tuple[float, float] | TemperatureFunction = 1000.0,
    ...
    def _parse_temperature(
        ...
        match temperature:
            case[temperature, cooling_rate]: return ExponentialCooling(temperature, cooling_rate)
