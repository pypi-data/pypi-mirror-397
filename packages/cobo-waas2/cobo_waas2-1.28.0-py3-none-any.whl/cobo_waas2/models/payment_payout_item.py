...
class PaymentPayoutItem(BaseModel):
    ...
    token_id: Optional[StrictStr] = Field(default=None, description="The token id of the payout item.")
    chain_id: Optional[StrictStr] = Field(default=None, description="The ID of the blockchain network on which the payout item occurred.")
    amount: StrictStr = Field(description="The payout item token_id amount. ")
    status: PaymentPayoutItemStatus
    source_account: StrictStr
    transactions: Optional[List[PaymentTransaction]] = Field(default=None, description="An array of transactions associated with this payout item request. Each transaction represents a separate blockchain operation related to the payout item process.")
