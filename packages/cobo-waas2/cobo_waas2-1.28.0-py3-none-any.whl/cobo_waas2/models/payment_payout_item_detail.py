...
class PaymentPayoutItemDetail(BaseModel):
    ...
    token_id: Optional[StrictStr] = Field(default=None, description="The token id of the payout.")
    ...
    amount: StrictStr = Field(description="The payout token_id amount. ")
    status: PaymentPayoutStatus
    transactions: Optional[List[PaymentTransaction]] = Field(default=None, description="An array of transactions associated with this payout request. Each transaction represents a separate blockchain operation related to the payout process.")
