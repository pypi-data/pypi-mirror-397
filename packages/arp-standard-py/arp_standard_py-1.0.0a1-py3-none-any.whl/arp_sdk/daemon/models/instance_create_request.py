...
if TYPE_CHECKING:
  ...
  from ..models.instance_create_request_labels import InstanceCreateRequestLabels
...
class InstanceCreateRequest:
    """ 
        Attributes:
            ...
            labels (InstanceCreateRequestLabels | Unset):
     """
    ...
    labels: InstanceCreateRequestLabels | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_labels,  Unset):
            ...
            labels = InstanceCreateRequestLabels.from_dict(_labels)
