...
if TYPE_CHECKING:
  from ..models.runtime_profile_defaults_env import RuntimeProfileDefaultsEnv





T = TypeVar("T", bound="RuntimeProfileDefaults")
...
class RuntimeProfileDefaults:
    """ 
        Attributes:
            args (list[str] | Unset):
            env (RuntimeProfileDefaultsEnv | Unset):
    ...
    env: RuntimeProfileDefaultsEnv | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_env,  Unset):
            ...
            env = RuntimeProfileDefaultsEnv.from_dict(_env)
        ...
        runtime_profile_defaults = cls(
            args=args,
            env=env,
            tool_registry_url=tool_registry_url,
        )

        return runtime_profile_defaults
